...
GLOBAL_STR(str189, "%%%d");
GLOBAL_STR(str190, "%d\n");
GLOBAL_STR(str191, "%s %d %7s ");
GLOBAL_STR(str192, "\n");
GLOBAL_STR(str193, "Fatal error in posix.fork()");
GLOBAL_STR(str194, "%d\n");
GLOBAL_STR(str195, "%%%d");
GLOBAL_STR(str196, "  ");
GLOBAL_STR(str197, "%s %d %7s ");
GLOBAL_STR(str198, "\n");
GLOBAL_STR(str199, "Pipeline in state %s");
GLOBAL_STR(str200, "\n");
GLOBAL_STR(str201, "[process debug info]\n");
GLOBAL_STR(str202, "\n");
GLOBAL_STR(str203, "[pipeline debug info]\n");
GLOBAL_STR(str204, "osh: PID %d stopped, but osh didn't start it");
GLOBAL_STR(str205, "");
GLOBAL_STR(str206, "");
GLOBAL_STR(str207, "[PID %d] Stopped");
GLOBAL_STR(str208, "");
GLOBAL_STR(str209, "main");
GLOBAL_STR(str210, "osh usage error: %s");
GLOBAL_STR(str211, "%s-usage");
GLOBAL_STR(str212, "Oil");
GLOBAL_STR(str213, "main");
GLOBAL_STR(str214, "oil");
GLOBAL_STR(str215, "oil:all");
GLOBAL_STR(str216, "--one-pass-parse requires noexec (-n)");
GLOBAL_STR(str217, "completion");
GLOBAL_STR(str218, "history");
GLOBAL_STR(str219, "");
GLOBAL_STR(str220, "OSH_DEBUG_DIR");
GLOBAL_STR(str221, "%d-osh.log");
GLOBAL_STR(str222, "Writing logs to %r");
GLOBAL_STR(str223, "OSH_HIJACK_SHEBANG");
GLOBAL_STR(str224, "");
GLOBAL_STR(str225, "OSH_CRASH_DUMP_DIR");
GLOBAL_STR(str226, "");
GLOBAL_STR(str227, "");
GLOBAL_STR(str228, "osh: Couldn't open %r: %s");
GLOBAL_STR(str229, "/proc/%d/status");
GLOBAL_STR(str230, "--parser-mem-dump can only be used with -n");
GLOBAL_STR(str231, "/proc/%d/status");
GLOBAL_STR(str232, " \t\n\"'><=;|&(:");
GLOBAL_STR(str233, "/");
GLOBAL_STR(str234, "PATH");
GLOBAL_STR(str235, ":");
GLOBAL_STR(str236, "got invalid option %r");
GLOBAL_STR(str237, "got invalid option %r");
GLOBAL_STR(str238, "invalid option %r (try -O or shopt)");
GLOBAL_STR(str239, "SHELLOPTS");
GLOBAL_STR(str240, ":");
GLOBAL_STR(str241, "Syntax options must be set at the top level (outside any function)");
GLOBAL_STR(str242, "Warning: set -o verbose not implemented");
GLOBAL_STR(str243, "SHELLOPTS");
GLOBAL_STR(str244, "%s:%s");
GLOBAL_STR(str245, "SHELLOPTS");
GLOBAL_STR(str246, ":");
GLOBAL_STR(str247, ":");
GLOBAL_STR(str248, "SHELLOPTS");
GLOBAL_STR(str249, "oil:basic");
GLOBAL_STR(str250, "oil:all");
GLOBAL_STR(str251, "strict:all");
GLOBAL_STR(str252, "set %so %s");
GLOBAL_STR(str253, "-");
GLOBAL_STR(str254, "+");
GLOBAL_STR(str255, "oil:basic");
GLOBAL_STR(str256, "oil:all");
GLOBAL_STR(str257, "strict:all");
GLOBAL_STR(str258, "got invalid option %r");
GLOBAL_STR(str259, "shopt -%s %s");
GLOBAL_STR(str260, "s");
GLOBAL_STR(str261, "u");
GLOBAL_STR(str262, "<_ArgFrame %s %d at %x>");
GLOBAL_STR(str263, "Can't determine working directory: %s");
GLOBAL_STR(str264, "IFS");
GLOBAL_STR(str265, "UID");
GLOBAL_STR(str266, "EUID");
GLOBAL_STR(str267, "PPID");
GLOBAL_STR(str268, "HOSTNAME");
GLOBAL_STR(str269, "OSTYPE");
GLOBAL_STR(str270, "OPTIND");
GLOBAL_STR(str271, "1");
GLOBAL_STR(str272, "PS4");
GLOBAL_STR(str273, "${SHX_indent}${SHX_punct}${SHX_pid_str} ");
GLOBAL_STR(str274, "COMP_WORDBREAKS");
GLOBAL_STR(str275, "SHELLOPTS");
GLOBAL_STR(str276, "SHELLOPTS");
GLOBAL_STR(str277, "");
GLOBAL_STR(str278, "SHELLOPTS");
GLOBAL_STR(str279, "PWD");
GLOBAL_STR(str280, "PWD");
GLOBAL_STR(str281, "PWD");
GLOBAL_STR(str282, "PATH");
GLOBAL_STR(str283, "PATH");
GLOBAL_STR(str284, "/bin:/usr/bin");
GLOBAL_STR(str285, "OIL_VERSION");
GLOBAL_STR(str286, "PWD");
GLOBAL_STR(str287, "PS1");
GLOBAL_STR(str288, "PS1");
GLOBAL_STR(str289, "\\s-\\v\\$ ");
GLOBAL_STR(str290, "");
GLOBAL_STR(str291, "<Mem");
GLOBAL_STR(str292, "  -- %d --");
GLOBAL_STR(str293, "  %s %s");
GLOBAL_STR(str294, ">");
GLOBAL_STR(str295, "\n");
GLOBAL_STR(str296, "\n");
GLOBAL_STR(str297, "Warning: span_id undefined in SetCurrentSpanId");
GLOBAL_STR(str298, "setref requires a nameref (:out param)");
GLOBAL_STR(str299, "nameref %r is undefined");
GLOBAL_STR(str300, "nameref %r contains invalid variable name %r");
GLOBAL_STR(str301, "Circular nameref %s");
GLOBAL_STR(str302, " -> ");
GLOBAL_STR(str303, "__");
GLOBAL_STR(str304, "Can't assign to readonly value %r");
GLOBAL_STR(str305, "Only strings can be exported");
GLOBAL_STR(str306, "nameref must be a string");
GLOBAL_STR(str307, "Can't assign to readonly array");
GLOBAL_STR(str308, "Can't assign to items in a string");
GLOBAL_STR(str309, "Value of type %s can't be indexed");
GLOBAL_STR(str310, "Can't assign to readonly associative array");
GLOBAL_STR(str311, "ARGV");
GLOBAL_STR(str312, "_status");
GLOBAL_STR(str313, "_this_dir");
GLOBAL_STR(str314, "PIPESTATUS");
GLOBAL_STR(str315, "_pipeline_status");
GLOBAL_STR(str316, "_process_sub_status");
GLOBAL_STR(str317, "BASH_REMATCH");
GLOBAL_STR(str318, "FUNCNAME");
GLOBAL_STR(str319, "source");
GLOBAL_STR(str320, "BASH_SOURCE");
GLOBAL_STR(str321, "BASH_LINENO");
GLOBAL_STR(str322, "0");
GLOBAL_STR(str323, "LINENO");
GLOBAL_STR(str324, "BASHPID");
GLOBAL_STR(str325, "Can't unset readonly variable %r");
GLOBAL_STR(str326, "%r isn't an array");
GLOBAL_STR(str327, "$%s isn't defined");
GLOBAL_STR(str328, "$%s should be a string");
GLOBAL_STR(str329, "$%s should be a string, got %s");
GLOBAL_STR(str330, "$%s doesn't look like an integer, got %r");
GLOBAL_STR(str331, "EOF");
GLOBAL_STR(str332, "/");
GLOBAL_STR(str333, "~");
GLOBAL_STR(str334, "  ");
GLOBAL_STR(str335, "\n  ");
...
GLOBAL_STR(str340, "~");
GLOBAL_STR(str341, "\n");
GLOBAL_STR(str342, "[ interactive ]");
GLOBAL_STR(str343, "[ headless ]");
GLOBAL_STR(str344, "[ -c flag ]");
GLOBAL_STR(str345, "[ stdin%s ]");
GLOBAL_STR(str346, "[ %s word at ? ]");
GLOBAL_STR(str347, "[ %s word at line %d of %s ]");
GLOBAL_STR(str348, "?");
GLOBAL_STR(str349, "?");
GLOBAL_STR(str350, "line %d of %s");
GLOBAL_STR(str351, "[ var %s at %s ]");
GLOBAL_STR(str352, "[ expansion of alias %r ]");
GLOBAL_STR(str353, "[ %s in %s ]");
GLOBAL_STR(str354, "[??? no location ???] %s%s\n");
GLOBAL_STR(str355, "%s:%d: %s%s\n");
GLOBAL_STR(str356, "");
GLOBAL_STR(str357, "");
GLOBAL_STR(str358, "");
GLOBAL_STR(str359, "errexit PID %d: ");
GLOBAL_STR(str360, "none");
GLOBAL_STR(str361, "AST not printed.");
GLOBAL_STR(str362, "text");
GLOBAL_STR(str363, "abbrev-text");
GLOBAL_STR(str364, "html");
GLOBAL_STR(str365, "abbrev-html");
GLOBAL_STR(str366, "abbrev-");
GLOBAL_STR(str367, "\n");
GLOBAL_STR(str368, "\n");
GLOBAL_STR(str369, "-");
GLOBAL_STR(str370, "_");
GLOBAL_STR(str371, "<_Attributes %s>");
GLOBAL_STR(str372, "<args.Reader %r %d>");
GLOBAL_STR(str373, "expected argument to %r");
GLOBAL_STR(str374, "-");
GLOBAL_STR(str375, "expected integer after %s, got %r");
GLOBAL_STR(str376, "-");
GLOBAL_STR(str377, "got invalid integer for %s: %s");
GLOBAL_STR(str378, "-");
GLOBAL_STR(str379, "expected number after %r, got %r");
GLOBAL_STR(str380, "-");
GLOBAL_STR(str381, "got invalid float for %s: %s");
GLOBAL_STR(str382, "-");
GLOBAL_STR(str383, "got invalid argument %r to %r, expected one of: %s");
GLOBAL_STR(str384, "-");
GLOBAL_STR(str385, "|");
GLOBAL_STR(str386, "0");
GLOBAL_STR(str387, "F");
GLOBAL_STR(str388, "false");
GLOBAL_STR(str389, "False");
GLOBAL_STR(str390, "1");
GLOBAL_STR(str391, "T");
GLOBAL_STR(str392, "true");
GLOBAL_STR(str393, "Talse");
GLOBAL_STR(str394, "got invalid argument to boolean flag: %r");
GLOBAL_STR(str395, "-");
GLOBAL_STR(str396, "-");
GLOBAL_STR(str397, "Invalid option %r");
GLOBAL_STR(str398, "Expected argument for action");
GLOBAL_STR(str399, "Invalid action name %r");
GLOBAL_STR(str400, "--");
GLOBAL_STR(str401, "--");
GLOBAL_STR(str402, "=");
GLOBAL_STR(str403, "got invalid flag %r");
GLOBAL_STR(str404, "-");
GLOBAL_STR(str405, "0");
GLOBAL_STR(str406, "Z");
GLOBAL_STR(str407, "-");
GLOBAL_STR(str408, "doesn't accept flag %s");
GLOBAL_STR(str409, "-");
GLOBAL_STR(str410, "+");
GLOBAL_STR(str411, "+");
GLOBAL_STR(str412, "doesn't accept option %s");
GLOBAL_STR(str413, "+");
GLOBAL_STR(str414, "-");
GLOBAL_STR(str415, "--");
GLOBAL_STR(str416, "--");
...
GLOBAL_STR(str418, "-");
GLOBAL_STR(str419, "+");
GLOBAL_STR(str420, "got invalid flag %r");
GLOBAL_STR(str421, "-");
GLOBAL_STR(str422, "<LineLexer at pos %d of line %r (id = %d)>");
GLOBAL_STR(str423, "");
GLOBAL_STR(str424, "");
GLOBAL_STR(str425, "");
GLOBAL_STR(str426, "");
GLOBAL_STR(str427, "<Trail %s %s %s %s>");
GLOBAL_STR(str428, "");
GLOBAL_STR(str429, "Here docs aren't allowed in expressions");
GLOBAL_STR(str430, "\n");
GLOBAL_STR(str431, "Expected an expression");
GLOBAL_STR(str432, "Expected an expression");
GLOBAL_STR(str433, "Too many typed args (expected one expression)");
GLOBAL_STR(str434, "Expected block argument");
GLOBAL_STR(str435, "Too many typed args (expected one block)");
GLOBAL_STR(str436, "Use === to be exact, or ~== to convert types");
GLOBAL_STR(str437, "");
GLOBAL_STR(str438, " (%s)");
GLOBAL_STR(str439, "Unexpected token in expression mode%s");
GLOBAL_STR(str440, "Syntax error in expression (near %s)");
GLOBAL_STR(str441, "alnum");
GLOBAL_STR(str442, "cntrl");
GLOBAL_STR(str443, "lower");
GLOBAL_STR(str444, "space");
GLOBAL_STR(str445, "alpha");
GLOBAL_STR(str446, "digit");
GLOBAL_STR(str447, "print");
GLOBAL_STR(str448, "upper");
GLOBAL_STR(str449, "blank");
GLOBAL_STR(str450, "graph");
GLOBAL_STR(str451, "punct");
GLOBAL_STR(str452, "xdigit");
GLOBAL_STR(str453, "Range start/end shouldn't have more than one character");
GLOBAL_STR(str454, "Write singleton tuples with tup(), not a trailing comma");
GLOBAL_STR(str455, "testlist_comp");
GLOBAL_STR(str456, "obj.field isn't valid, but obj.method() is");
GLOBAL_STR(str457, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str458, "Can't assign to this expression");
GLOBAL_STR(str459, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str460, "Expr");
GLOBAL_STR(str461, "Block");
GLOBAL_STR(str462, "proc param types should be Expr or Block");
GLOBAL_STR(str463, "TODO");
GLOBAL_STR(str464, "dot");
...
GLOBAL_STR(str469, "%start");
GLOBAL_STR(str470, "%end");
GLOBAL_STR(str471, "dot");
GLOBAL_STR(str472, "Unexpected token %r in regex");
GLOBAL_STR(str473, "%s-%s");
GLOBAL_STR(str474, "ERE can't express code point %d");
GLOBAL_STR(str475, "Perl classes can't be negated in ERE");
GLOBAL_STR(str476, "%s");
GLOBAL_STR(str477, "POSIX classes can't be negated in ERE");
GLOBAL_STR(str478, "[:%s:]");
GLOBAL_STR(str479, ".");
GLOBAL_STR(str480, "^");
GLOBAL_STR(str481, "$");
GLOBAL_STR(str482, "|");
GLOBAL_STR(str483, "POSIX EREs don't have groups without capture, so this node needs () around it.");
GLOBAL_STR(str484, "+");
GLOBAL_STR(str485, "*");
GLOBAL_STR(str486, "?");
GLOBAL_STR(str487, "{%s}");
...
GLOBAL_STR(str498, "^");
GLOBAL_STR(str499, "]");
GLOBAL_STR(str500, "The [ operator doesn't apply to this expression");
GLOBAL_STR(str501, "Expected ]]");
GLOBAL_STR(str502, "Unexpected trailing word %s");
GLOBAL_STR(str503, "Invalid argument to unary operator");
GLOBAL_STR(str504, "Expected ), got %s");
GLOBAL_STR(str505, "Unexpected token in boolean expression (%s)");
GLOBAL_STR(str506, "");
GLOBAL_STR(str507, "Expected %d, got %d");
GLOBAL_STR(str508, "Step can't be 0");
GLOBAL_STR(str509, "Invalid step %d for ascending integer range");
GLOBAL_STR(str510, "Invalid step %d for descending integer range");
GLOBAL_STR(str511, "Invalid step %d for ascending character range");
GLOBAL_STR(str512, "Invalid step %d for descending character range");
GLOBAL_STR(str513, "Mismatched cases in character range");
GLOBAL_STR(str514, "");
GLOBAL_STR(str515, "0");
GLOBAL_STR(str516, "0");
GLOBAL_STR(str517, "g");
...
GLOBAL_STR(str554, ")");
GLOBAL_STR(str555, "");
GLOBAL_STR(str556, "export_");
GLOBAL_STR(str557, "doesn't accept -f because it's dangerous.  (The code can usually be restructured with 'source')");
GLOBAL_STR(str558, "doesn't accept RHS with -n");
GLOBAL_STR(str559, "Got -a but RHS isn't an array");
GLOBAL_STR(str560, "Got -A but RHS isn't an associative array");
GLOBAL_STR(str561, "readonly");
GLOBAL_STR(str562, "new_var");
GLOBAL_STR(str563, "with -f expects function names");
GLOBAL_STR(str564, "declare -f %s");
GLOBAL_STR(str565, "-");
GLOBAL_STR(str566, "-");
GLOBAL_STR(str567, "-");
GLOBAL_STR(str568, "+");
GLOBAL_STR(str569, "+");
GLOBAL_STR(str570, "+");
GLOBAL_STR(str571, "unset");
GLOBAL_STR(str572, "Invalid shift argument %r");
GLOBAL_STR(str573, "got too many arguments");
GLOBAL_STR(str574, "eval");
GLOBAL_STR(str575, "requires code string");
GLOBAL_STR(str576, "requires exactly 1 argument");
GLOBAL_STR(str577, " ");
GLOBAL_STR(str578, "eval");
GLOBAL_STR(str579, "eval");
GLOBAL_STR(str580, "source");
GLOBAL_STR(str581, "missing required argument");
GLOBAL_STR(str582, "source %r failed: %s");
GLOBAL_STR(str583, "source");
GLOBAL_STR(str584, "command");
GLOBAL_STR(str585, "Can't run assignment builtin recursively");
GLOBAL_STR(str586, "%r isn't a shell builtin");
GLOBAL_STR(str587, "runproc");
GLOBAL_STR(str588, "requires arguments");
GLOBAL_STR(str589, "runproc: no proc named %r");
GLOBAL_STR(str590, "try_");
GLOBAL_STR(str591, "'try' expected a command to run");
GLOBAL_STR(str592, "(original failure)");
GLOBAL_STR(str593, "");
GLOBAL_STR(str594, "status %d when --allow-status-01");
GLOBAL_STR(str595, ":");
GLOBAL_STR(str596, "function");
GLOBAL_STR(str597, "alias");
GLOBAL_STR(str598, "builtin");
GLOBAL_STR(str599, "builtin");
GLOBAL_STR(str600, "builtin");
GLOBAL_STR(str601, "keyword");
GLOBAL_STR(str602, "keyword");
GLOBAL_STR(str603, "file");
GLOBAL_STR(str604, "type");
GLOBAL_STR(str605, "type: %r not found");
GLOBAL_STR(str606, "file");
GLOBAL_STR(str607, "file");
GLOBAL_STR(str608, "%s is a %s");
GLOBAL_STR(str609, "function");
GLOBAL_STR(str610, "");
GLOBAL_STR(str611, "");
GLOBAL_STR(str612, "\r\n");
GLOBAL_STR(str613, "\n");
...
GLOBAL_STR(str615, "");
GLOBAL_STR(str616, "");
GLOBAL_STR(str617, "read error: %s");
GLOBAL_STR(str618, "read");
GLOBAL_STR(str619, "_line");
GLOBAL_STR(str620, ":");
GLOBAL_STR(str621, "got extra argument");
GLOBAL_STR(str622, "--qsn can only be used with --line");
GLOBAL_STR(str623, "_all");
GLOBAL_STR(str624, ":");
GLOBAL_STR(str625, "got extra argument");
GLOBAL_STR(str626, "--qsn not implemented yet");
GLOBAL_STR(str627, "read -t isn't implemented (except t=0)");
GLOBAL_STR(str628, "REPLY");
GLOBAL_STR(str629, "REPLY");
GLOBAL_STR(str630, "");
GLOBAL_STR(str631, ":");
GLOBAL_STR(str632, "mapfile");
GLOBAL_STR(str633, "MAPFILE");
GLOBAL_STR(str634, ":");
GLOBAL_STR(str635, "mapfile: read() error: %s");
GLOBAL_STR(str636, "\n");
GLOBAL_STR(str637, "cd");
GLOBAL_STR(str638, "HOME");
GLOBAL_STR(str639, "HOME");
GLOBAL_STR(str640, "-");
GLOBAL_STR(str641, "OLDPWD");
GLOBAL_STR(str642, "PWD");
GLOBAL_STR(str643, "cd %r: %s");
GLOBAL_STR(str644, "PWD");
GLOBAL_STR(str645, "OLDPWD");
GLOBAL_STR(str646, "%2d  %s");
GLOBAL_STR(str647, " ");
GLOBAL_STR(str648, "pushd: no other directory");
GLOBAL_STR(str649, "got too many arguments");
GLOBAL_STR(str650, "pushd: %r: %s");
GLOBAL_STR(str651, "HOME");
GLOBAL_STR(str652, "PWD");
GLOBAL_STR(str653, "popd: directory stack is empty");
GLOBAL_STR(str654, "popd: %r: %s");
GLOBAL_STR(str655, "PWD");
GLOBAL_STR(str656, "got extra argument");
GLOBAL_STR(str657, "HOME");
GLOBAL_STR(str658, "dirs");
GLOBAL_STR(str659, "HOME");
GLOBAL_STR(str660, "pwd");
GLOBAL_STR(str661, "_devbuild/help/groups.txt");
GLOBAL_STR(str662, "help");
GLOBAL_STR(str663, "help");
GLOBAL_STR(str664, "_devbuild/help/%s");
GLOBAL_STR(str665, "no help topics match %r");
GLOBAL_STR(str666, "osh I/O error: %s");
GLOBAL_STR(str667, "# +");
GLOBAL_STR(str668, "osh printf doesn't support the %r flag");
GLOBAL_STR(str669, "eEfFgG");
GLOBAL_STR(str670, "osh printf doesn't support floating point");
GLOBAL_STR(str671, "c");
GLOBAL_STR(str672, "osh printf doesn't support single characters (bytes)");
GLOBAL_STR(str673, "Invalid printf format character");
GLOBAL_STR(str674, "Expected a printf format character");
GLOBAL_STR(str675, "%");
GLOBAL_STR(str676, "");
GLOBAL_STR(str677, "printf got invalid width %r");
GLOBAL_STR(str678, "0");
GLOBAL_STR(str679, "");
GLOBAL_STR(str680, "printf got invalid precision %r");
GLOBAL_STR(str681, "");
GLOBAL_STR(str682, "s");
GLOBAL_STR(str683, "q");
GLOBAL_STR(str684, "b");
GLOBAL_STR(str685, "");
GLOBAL_STR(str686, "diouxX");
GLOBAL_STR(str687, "'\"");
GLOBAL_STR(str688, "printf expected an integer, got %r");
GLOBAL_STR(str689, "TZ");
GLOBAL_STR(str690, "TZ");
GLOBAL_STR(str691, "ouxX");
GLOBAL_STR(str692, "Can't format negative number %d with %%%s");
GLOBAL_STR(str693, "o");
GLOBAL_STR(str694, "x");
GLOBAL_STR(str695, "X");
GLOBAL_STR(str696, "0");
...
GLOBAL_STR(str705, "requires a format string");
GLOBAL_STR(str706, "printf");
GLOBAL_STR(str707, "");
...
GLOBAL_STR(str764, "expected a block");
GLOBAL_STR(str765, "Can't append array to string");
GLOBAL_STR(str766, "Can't append string to array");
GLOBAL_STR(str767, "Assignment builtin %r not configured");
GLOBAL_STR(str768, "%r ");
GLOBAL_STR(str769, "Command");
GLOBAL_STR(str770, "Assignment");
GLOBAL_STR(str771, "Subshell");
GLOBAL_STR(str772, "Pipeline");
GLOBAL_STR(str773, "%s failed with status %d");
GLOBAL_STR(str774, "Redirect filename can't be empty");
GLOBAL_STR(str775, "Redirect descriptor can't be empty");
GLOBAL_STR(str776, "-");
GLOBAL_STR(str777, "-");
GLOBAL_STR(str778, "Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
GLOBAL_STR(str779, "\n");
GLOBAL_STR(str780, "Unknown redirect op");
GLOBAL_STR(str781, "Unknown redirect type");
GLOBAL_STR(str782, "strict_errexit only allows simple commands (got %s). Hint: use 'try'.");
GLOBAL_STR(str783, "strict_errexit only allows a single command.  Hint: use 'try'.");
GLOBAL_STR(str784, "strict_errexit only allows simple commands (got %s). Hint: use 'try'.");
GLOBAL_STR(str785, "ShAssignment builtins don't accept blocks");
GLOBAL_STR(str786, "|& isn't supported");
GLOBAL_STR(str787, "%r expected a number, got %r");
GLOBAL_STR(str788, "Invalid control flow at top level");
GLOBAL_STR(str789, "warning: ");
GLOBAL_STR(str790, "Function %s was already defined (redefine_proc)");
GLOBAL_STR(str791, "Proc %s was already defined (redefine_proc)");
GLOBAL_STR(str792, "trap");
GLOBAL_STR(str793, "failglob: ");
GLOBAL_STR(str794, "Loop and control flow can't be in different processes");
GLOBAL_STR(str795, "fatal: ");
GLOBAL_STR(str796, "EXIT");
GLOBAL_STR(str797, "trap EXIT");
GLOBAL_STR(str798, "__");
GLOBAL_STR(str799, ":");
GLOBAL_STR(str800, "Invalid argument %r.  Expected a name starting with :");
GLOBAL_STR(str801, "No value provided for param %r");
GLOBAL_STR(str802, "proc %r expected %d arguments, but got %d");
GLOBAL_STR(str803, "Unexpected %r (in function call)");
GLOBAL_STR(str804, "Attempted to exit from completion hook.");
GLOBAL_STR(str805, "Couldn't find terminator for here doc that starts here");
GLOBAL_STR(str806, "\t");
GLOBAL_STR(str807, "Invalid here doc delimiter");
GLOBAL_STR(str808, "+");
GLOBAL_STR(str809, "+");
GLOBAL_STR(str810, "+");
GLOBAL_STR(str811, "%d != %d");
GLOBAL_STR(str812, "array place");
GLOBAL_STR(str813, "Environment binding shouldn't look like an array assignment");
GLOBAL_STR(str814, "+");
GLOBAL_STR(str815, "Expected = in environment binding, got +=");
GLOBAL_STR(str816, "Environment bindings can't contain array literals");
GLOBAL_STR(str817, "procs and shell functions can't be nested");
GLOBAL_STR(str818, "%r was already declared");
GLOBAL_STR(str819, "%r hasn't been declared");
GLOBAL_STR(str820, "Can't modify constant %r");
GLOBAL_STR(str821, "Expected word type %s, got %s");
GLOBAL_STR(str822, "{");
GLOBAL_STR(str823, "}");
GLOBAL_STR(str824, "Invalid token after redirect operator");
GLOBAL_STR(str825, "Space required before (");
GLOBAL_STR(str826, "Unexpected left paren (might need a space before it)");
GLOBAL_STR(str827, "Empty arg list not allowed");
GLOBAL_STR(str828, "TODO: Parse Redirect");
GLOBAL_STR(str829, " ");
GLOBAL_STR(str830, " ");
GLOBAL_STR(str831, "line IDs %d != %d");
GLOBAL_STR(str832, " ");
GLOBAL_STR(str833, "");
GLOBAL_STR(str834, "Unexpected typed args");
GLOBAL_STR(str835, "=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
GLOBAL_STR(str836, "name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
GLOBAL_STR(str837, "Unexpected typed args");
GLOBAL_STR(str838, "Unexpected typed args");
GLOBAL_STR(str839, "Control flow shouldn't have redirects");
GLOBAL_STR(str840, "Control flow shouldn't have environment bindings");
GLOBAL_STR(str841, "Unexpected argument to %r");
GLOBAL_STR(str842, "Invalid word in for loop");
GLOBAL_STR(str843, "Invalid word after for expression");
GLOBAL_STR(str844, "Loop variable name should be a constant");
GLOBAL_STR(str845, "Invalid loop variable name");
GLOBAL_STR(str846, "Unexpected word after for loop variable");
GLOBAL_STR(str847, "Expected ;; or esac");
GLOBAL_STR(str848, "Unexpected word while parsing compound command");
GLOBAL_STR(str849, "Invalid function name");
GLOBAL_STR(str850, "Expected ) in function definition");
GLOBAL_STR(str851, "Invalid KSH-style function name");
GLOBAL_STR(str852, "Unexpected word when parsing command");
GLOBAL_STR(str853, "Unexpected right brace");
GLOBAL_STR(str854, "Unexpected EOF while parsing command");
GLOBAL_STR(str855, "Invalid word while parsing command");
GLOBAL_STR(str856, "Invalid word while parsing command line");
GLOBAL_STR(str857, "Invalid word while parsing command list");
GLOBAL_STR(str858, "Unterminated here doc began here");
GLOBAL_STR(str859, "\\");
GLOBAL_STR(str860, "*");
GLOBAL_STR(str861, "?");
GLOBAL_STR(str862, "[");
...
GLOBAL_STR(str866, "\\?*+{}^$.()|");
GLOBAL_STR(str867, "\\");
GLOBAL_STR(str868, "Unexpected escaped character %r");
GLOBAL_STR(str869, "");
GLOBAL_STR(str870, "");
GLOBAL_STR(str871, "Malformed character class; treating as literal");
GLOBAL_STR(str872, "Got unescaped right bracket");
GLOBAL_STR(str873, "Got unescaped trailing backslash");
GLOBAL_STR(str874, ".|^$()+*?[]{}\\");
GLOBAL_STR(str875, "\\");
GLOBAL_STR(str876, "\\");
GLOBAL_STR(str877, "\\[");
...
GLOBAL_STR(str889, "]");
GLOBAL_STR(str890, "");
GLOBAL_STR(str891, "Error expanding glob %r: %s");
GLOBAL_STR(str892, "-");
GLOBAL_STR(str893, "<Error: unbalanced \\[ and \\]> ");
GLOBAL_STR(str894, "$");
GLOBAL_STR(str895, "#");
GLOBAL_STR(str896, "$");
GLOBAL_STR(str897, "hostname");
GLOBAL_STR(str898, "user");
GLOBAL_STR(str899, "\u0001");
GLOBAL_STR(str900, "\u0002");
GLOBAL_STR(str901, "$");
GLOBAL_STR(str902, "$");
GLOBAL_STR(str903, "u");
GLOBAL_STR(str904, "user");
GLOBAL_STR(str905, "h");
GLOBAL_STR(str906, "hostname");
GLOBAL_STR(str907, ".");
GLOBAL_STR(str908, "H");
GLOBAL_STR(str909, "hostname");
GLOBAL_STR(str910, "s");
GLOBAL_STR(str911, "v");
GLOBAL_STR(str912, "A");
GLOBAL_STR(str913, "%H:%M");
GLOBAL_STR(str914, "D");
GLOBAL_STR(str915, "%X");
GLOBAL_STR(str916, "w");
GLOBAL_STR(str917, "PWD");
GLOBAL_STR(str918, "HOME");
GLOBAL_STR(str919, "<Error: %s>");
GLOBAL_STR(str920, "W");
GLOBAL_STR(str921, "PWD");
GLOBAL_STR(str922, "<Error: PWD is not a string> ");
GLOBAL_STR(str923, "<Error: \\%s not implemented in $PS1> ");
GLOBAL_STR(str924, "$");
GLOBAL_STR(str925, "\\$");
GLOBAL_STR(str926, "Invalid token %r");
GLOBAL_STR(str927, "");
GLOBAL_STR(str928, "");
GLOBAL_STR(str929, "<ERROR: Can't parse PS1: %s>");
GLOBAL_STR(str930, "osh");
GLOBAL_STR(str931, "PS1");
GLOBAL_STR(str932, "$ ");
GLOBAL_STR(str933, "PROMPT_COMMAND");
GLOBAL_STR(str934, "Undefined variable %r");
GLOBAL_STR(str935, "Can't use [] on value of type %s");
GLOBAL_STR(str936, "");
GLOBAL_STR(str937, "Can't use [] on value of type %s");
GLOBAL_STR(str938, "");
GLOBAL_STR(str939, "dynamic place");
GLOBAL_STR(str940, "got invalid place expression");
GLOBAL_STR(str941, "expected a var name.  shopt -s eval_unsafe_arith allows a[i]");
GLOBAL_STR(str942, "Invalid var ref");
GLOBAL_STR(str943, "0x");
GLOBAL_STR(str944, "Invalid hex constant %r");
GLOBAL_STR(str945, "0");
GLOBAL_STR(str946, "Invalid octal constant %r");
GLOBAL_STR(str947, "#");
GLOBAL_STR(str948, "#");
GLOBAL_STR(str949, "Invalid base for numeric constant %r");
GLOBAL_STR(str950, "a");
GLOBAL_STR(str951, "A");
GLOBAL_STR(str952, "@");
GLOBAL_STR(str953, "_");
GLOBAL_STR(str954, "Invalid digits for numeric constant %r");
GLOBAL_STR(str955, "Digits %r out of range for base %d");
GLOBAL_STR(str956, "Parse error in recursive arithmetic");
GLOBAL_STR(str957, "Invalid integer constant %r");
GLOBAL_STR(str958, "Invalid integer constant %r");
GLOBAL_STR(str959, "Invalid integer constant %r");
GLOBAL_STR(str960, "Undefined value in arithmetic context");
GLOBAL_STR(str961, "Expected a value convertible to integer, got %s");
GLOBAL_STR(str962, "0");
GLOBAL_STR(str963, "Undefined variable %r");
GLOBAL_STR(str964, "Divide by zero");
GLOBAL_STR(str965, "Divide by zero");
GLOBAL_STR(str966, "Expected array or assoc in index expression, got %s");
GLOBAL_STR(str967, "Divide by zero");
GLOBAL_STR(str968, "Divide by zero");
GLOBAL_STR(str969, "Exponent can't be less than zero");
GLOBAL_STR(str970, "Associative array keys must be strings: $x 'x' \"$x\" etc.");
GLOBAL_STR(str971, "Invalid place to modify");
GLOBAL_STR(str972, "%s isn't implemented");
GLOBAL_STR(str973, "Invalid regex %r: %s");
GLOBAL_STR(str974, " \t\n");
GLOBAL_STR(str975, "IFS");
GLOBAL_STR(str976, "IFS shouldn't be an array");
GLOBAL_STR(str977, " \t\n");
GLOBAL_STR(str978, "IFS");
GLOBAL_STR(str979, " ");
GLOBAL_STR(str980, "");
GLOBAL_STR(str981, "IFS shouldn't be an array");
GLOBAL_STR(str982, "\\");
GLOBAL_STR(str983, "\\");
GLOBAL_STR(str984, "Invalid transition from %r with %r");
GLOBAL_STR(str985, "\u00ef\u00bf\u00bd");
GLOBAL_STR(str986, "");
GLOBAL_STR(str987, "Incomplete UTF-8 character");
GLOBAL_STR(str988, "Invalid UTF-8 continuation byte");
GLOBAL_STR(str989, "Invalid start of UTF-8 character");
GLOBAL_STR(str990, "");
...
GLOBAL_STR(str998, "");
GLOBAL_STR(str999, "<_GlobReplacer regex %r r %r>");
GLOBAL_STR(str1000, "(%s)");
GLOBAL_STR(str1001, "Error matching regex %r: %s");
GLOBAL_STR(str1002, "^");
GLOBAL_STR(str1003, "$");
GLOBAL_STR(str1004, "\r");
GLOBAL_STR(str1005, "<INVALID CR>");
GLOBAL_STR(str1006, "\n");
GLOBAL_STR(str1007, "<INVALID NEWLINE>");
GLOBAL_STR(str1008, " `~!$&*()[]{}\\|;'\"<>?");
GLOBAL_STR(str1009, "Left-hand side of this assignment is invalid");
GLOBAL_STR(str1010, "Token can't be used in prefix position");
GLOBAL_STR(str1011, "Token can't be used in infix position");
GLOBAL_STR(str1012, "Parser expected %s, got %s");
GLOBAL_STR(str1013, "Unexpected end of input");
GLOBAL_STR(str1014, "");
GLOBAL_STR(str1015, "");
GLOBAL_STR(str1016, " \t");
GLOBAL_STR(str1017, "\n");
...
GLOBAL_STR(str1019, "\n");
GLOBAL_STR(str1020, "\n");
GLOBAL_STR(str1021, "BASH_SOURCE");
GLOBAL_STR(str1022, "FUNCNAME");
GLOBAL_STR(str1023, "BASH_LINENO");
GLOBAL_STR(str1024, "0");
GLOBAL_STR(str1025, "0");
GLOBAL_STR(str1026, "^([a-zA-Z_][a-zA-Z0-9_]*)((=|\\+=)(.*))?$");
GLOBAL_STR(str1027, "Assignment builtin expected NAME=value, got %r");
GLOBAL_STR(str1028, "+");
GLOBAL_STR(str1029, "\\");
GLOBAL_STR(str1030, "\\\\");
GLOBAL_STR(str1031, "");
GLOBAL_STR(str1032, "");
GLOBAL_STR(str1033, "The length index of a array slice can't be negative: %d");
GLOBAL_STR(str1034, "Can't slice associative arrays");
GLOBAL_STR(str1035, "i");
GLOBAL_STR(str1036, "e");
GLOBAL_STR(str1037, "f");
GLOBAL_STR(str1038, "n");
GLOBAL_STR(str1039, "u");
GLOBAL_STR(str1040, "x");
GLOBAL_STR(str1041, "C");
GLOBAL_STR(str1042, "");
GLOBAL_STR(str1043, "~");
GLOBAL_STR(str1044, "HOME");
GLOBAL_STR(str1045, "Error expanding tilde (e.g. invalid user)");
GLOBAL_STR(str1046, "Can't assign to special variable");
GLOBAL_STR(str1047, "unset variable %r");
GLOBAL_STR(str1048, "warning: ");
GLOBAL_STR(str1049, "-1");
GLOBAL_STR(str1050, "a[i] not allowed without shopt -s eval_unsafe_arith");
GLOBAL_STR(str1051, "Indirect expansion of array");
GLOBAL_STR(str1052, "Indirect expansion of assoc array");
GLOBAL_STR(str1053, "extended globs not supported in ${x//GLOB/}");
GLOBAL_STR(str1054, "");
GLOBAL_STR(str1055, "warning: ");
GLOBAL_STR(str1056, "");
GLOBAL_STR(str1057, "\u0001");
GLOBAL_STR(str1058, "");
GLOBAL_STR(str1059, "\u0002");
GLOBAL_STR(str1060, "");
GLOBAL_STR(str1061, "Can't use @P on %s");
GLOBAL_STR(str1062, " ");
GLOBAL_STR(str1063, "Can't use @Q on %s");
GLOBAL_STR(str1064, "a");
GLOBAL_STR(str1065, "A");
GLOBAL_STR(str1066, "r");
GLOBAL_STR(str1067, "x");
GLOBAL_STR(str1068, "n");
GLOBAL_STR(str1069, "");
GLOBAL_STR(str1070, "Var op %r not implemented");
GLOBAL_STR(str1071, "Can't index string with @");
GLOBAL_STR(str1072, "Can't index string with *");
GLOBAL_STR(str1073, "Can't index string %r with integer");
GLOBAL_STR(str1074, "");
GLOBAL_STR(str1075, "");
GLOBAL_STR(str1076, "$");
GLOBAL_STR(str1077, "Undefined variable %r");
GLOBAL_STR(str1078, "Undefined array %r");
GLOBAL_STR(str1079, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str1080, "Test operation not allowed with ${!array[@]}");
GLOBAL_STR(str1081, "Not implemented");
GLOBAL_STR(str1082, "Illegal array word part (strict_array)");
GLOBAL_STR(str1083, " ");
GLOBAL_STR(str1084, "");
GLOBAL_STR(str1085, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str1086, "@(");
GLOBAL_STR(str1087, "|");
GLOBAL_STR(str1088, ")");
GLOBAL_STR(str1089, "Extended globs and arrays can't appear in the same word");
GLOBAL_STR(str1090, "*");
GLOBAL_STR(str1091, "Unexpected array literal");
GLOBAL_STR(str1092, "Unexpected associative array literal");
GLOBAL_STR(str1093, "Can't splice %r");
GLOBAL_STR(str1094, "");
GLOBAL_STR(str1095, "");
GLOBAL_STR(str1096, "Extended glob %r matched no files");
GLOBAL_STR(str1097, "Extended glob not allowed in this word");
GLOBAL_STR(str1098, "");
GLOBAL_STR(str1099, "This word should yield a string, but it contains an array");
GLOBAL_STR(str1100, " ");
...
GLOBAL_STR(str1104, "");
GLOBAL_STR(str1105, "");
GLOBAL_STR(str1106, "<Runtime error: %s>");
GLOBAL_STR(str1107, "<I/O error: %s>");
GLOBAL_STR(str1108, "<Ctrl-C>");
GLOBAL_STR(str1109, "");
GLOBAL_STR(str1110, "");
GLOBAL_STR(str1111, "");
GLOBAL_STR(str1112, "");
GLOBAL_STR(str1113, "Pattern %r matched no files");
GLOBAL_STR(str1114, "");
GLOBAL_STR(str1115, "LHS array not allowed in assignment builtin");
GLOBAL_STR(str1116, "+");
GLOBAL_STR(str1117, "-");
GLOBAL_STR(str1118, "+");
GLOBAL_STR(str1119, "f");
GLOBAL_STR(str1120, "F");
GLOBAL_STR(str1121, "Pattern %r matched no files");
GLOBAL_STR(str1122, "");
GLOBAL_STR(str1123, "__NO_COMMAND_SUB__");
GLOBAL_STR(str1124, "__NO_PROCESS_SUB__");
GLOBAL_STR(str1125, "Expected : or } in slice");
GLOBAL_STR(str1126, "Pattern in ${x/pat/replace} must not be empty");
GLOBAL_STR(str1127, "Expected } after replacement string, got %s");
GLOBAL_STR(str1128, "Expected } or / to close pattern");
GLOBAL_STR(str1129, "Expected ] to close subscript");
GLOBAL_STR(str1130, "Expected } to close ${");
GLOBAL_STR(str1131, "Expected } to close ${");
GLOBAL_STR(str1132, "Expected a constant argument");
GLOBAL_STR(str1133, "Expected } to close ${");
GLOBAL_STR(str1134, "Expected } to close ${");
GLOBAL_STR(str1135, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1136, "VOp2");
GLOBAL_STR(str1137, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1138, "VOp3");
GLOBAL_STR(str1139, "Expected } to close ${");
GLOBAL_STR(str1140, "Expected } after length expression");
GLOBAL_STR(str1141, "TODO: ${.myproc builtin sub}");
GLOBAL_STR(str1142, "Unexpected token in ${}");
GLOBAL_STR(str1143, "\\");
GLOBAL_STR(str1144, "Strings with backslashes should look like r'\\n' or $'\\n'");
GLOBAL_STR(str1145, "Use \\xhh or \\u{...} instead of octal escapes in Oil strings");
GLOBAL_STR(str1146, "Invalid hex escape in Oil string (must be \\xHH)");
GLOBAL_STR(str1147, "Invalid char escape in C-style string literal");
GLOBAL_STR(str1148, "Unexpected EOF in single-quoted string that began here");
GLOBAL_STR(str1149, "\"");
GLOBAL_STR(str1150, "'");
GLOBAL_STR(str1151, "Unexpected EOF reading extended glob that began here");
GLOBAL_STR(str1152, "Invalid char escape in double quoted string");
GLOBAL_STR(str1153, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1154, "Invalid backtick: use $(cmd) or \\` in Oil strings");
GLOBAL_STR(str1155, "Unexpected EOF reading double-quoted string that began here");
GLOBAL_STR(str1156, "Use $(cmd) instead of backticks (parse_backticks)");
GLOBAL_STR(str1157, "Unexpected EOF while looking for closing backtick");
GLOBAL_STR(str1158, "");
GLOBAL_STR(str1159, "backticks");
GLOBAL_STR(str1160, "Invalid proc name %s");
GLOBAL_STR(str1161, "Unexpected token after arithmetic expression (%s != %s)");
GLOBAL_STR(str1162, "Expected second ) to end arith sub");
GLOBAL_STR(str1163, "Expected second ) to end arith statement");
GLOBAL_STR(str1164, "Expected ; here");
GLOBAL_STR(str1165, "Expected ; here");
GLOBAL_STR(str1166, "Expected ) to end for loop expression");
GLOBAL_STR(str1167, "Expected ( after =");
GLOBAL_STR(str1168, "Unexpected token in array literal");
GLOBAL_STR(str1169, "Expected associative array pair");
GLOBAL_STR(str1170, "Invalid char escape (parse_backslash)");
GLOBAL_STR(str1171, "Unexpected token after array literal");
GLOBAL_STR(str1172, "Unexpected token after array splice");
GLOBAL_STR(str1173, "TODO: @{.myproc builtin sub}");
GLOBAL_STR(str1174, "Literal @ starting a word must be quoted (parse_at_all)");
GLOBAL_STR(str1175, "/");
GLOBAL_STR(str1176, "next_byte %r");
GLOBAL_STR(str1177, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1178, "Unexpected token after @()");
GLOBAL_STR(str1179, "Word has unbalanced { }.  Maybe add a space or quote it like \\{");
GLOBAL_STR(str1180, "Unexpected parts after triple quoted string");
GLOBAL_STR(str1181, "Unexpected token while parsing arithmetic: %r");
GLOBAL_STR(str1182, "Invalid blank line in multiline mode");
GLOBAL_STR(str1183, "r");
GLOBAL_STR(str1184, "Unhandled: %s (%s)");
GLOBAL_STR(str1185, "Invalid var ref");
GLOBAL_STR(str1186, "Expected end of var ref");
GLOBAL_STR(str1187, "Invalid lex state %s");
GLOBAL_STR(str1188, "");
GLOBAL_STR(str1189, "");
GLOBAL_STR(str1190, "");
GLOBAL_STR(str1191, "");
...
GLOBAL_STR(str1195, "");
GLOBAL_STR(str1196, "");
GLOBAL_STR(str1197, "Compound shouldn't be empty");
GLOBAL_STR(str1198, "/");
GLOBAL_STR(str1199, "/");
GLOBAL_STR(str1200, "");
GLOBAL_STR(str1201, "EOF");
GLOBAL_STR(str1202, "typ");
GLOBAL_STR(str1203, "tok");
GLOBAL_STR(str1204, "children");
GLOBAL_STR(str1205, "-");
GLOBAL_STR(str1206, "with %d children");
GLOBAL_STR(str1207, "");
GLOBAL_STR(str1208, "(PNode %s %s %s)");
GLOBAL_STR(str1209, "&");
GLOBAL_STR(str1210, "&amp;");
GLOBAL_STR(str1211, "<");
GLOBAL_STR(str1212, "&lt;");
...
GLOBAL_STR(str1234, "/");
GLOBAL_STR(str1235, " \n\r\t");
GLOBAL_STR(str1236, "Unexpected token in QSN string");
GLOBAL_STR(str1237, "Expected closing single quote in QSN string");
GLOBAL_STR(str1238, "Unexpected data after closing quote");
GLOBAL_STR(str1239, "Unexpected token after QSN string");
GLOBAL_STR(str1240, "\\'\r\n\t\u0000");
GLOBAL_STR(str1241, "$'");
GLOBAL_STR(str1242, "'");
GLOBAL_STR(str1243, "'");
...
GLOBAL_STR(str1258, "\\r");
GLOBAL_STR(str1259, "\t");
GLOBAL_STR(str1260, "\\t");
GLOBAL_STR(str1261, "\u0000");
GLOBAL_STR(str1262, "\\x00");
GLOBAL_STR(str1263, "\\0");
GLOBAL_STR(str1264, "");
GLOBAL_STR(str1265, "");
GLOBAL_STR(str1266, "");
GLOBAL_STR(str1267, "\\");
...
GLOBAL_STR(str1274, "\\r");
GLOBAL_STR(str1275, "\t");
GLOBAL_STR(str1276, "\\t");
GLOBAL_STR(str1277, "\u0000");
GLOBAL_STR(str1278, "\\x00");
GLOBAL_STR(str1279, "\\0");
GLOBAL_STR(str1280, "");
GLOBAL_STR(str1281, "!");
GLOBAL_STR(str1282, "--");
GLOBAL_STR(str1283, "--dir");
GLOBAL_STR(str1284, "--exists");
GLOBAL_STR(str1285, "--file");
GLOBAL_STR(str1286, "--symlink");
GLOBAL_STR(str1287, "Expected unary operator, got %r (2 args)");
GLOBAL_STR(str1288, "-a");
GLOBAL_STR(str1289, "-o");
GLOBAL_STR(str1290, "!");
GLOBAL_STR(str1291, "(");
GLOBAL_STR(str1292, ")");
GLOBAL_STR(str1293, "Expected binary operator, got %r (3 args)");
GLOBAL_STR(str1294, "should be invoked as 'test' (simple_test_builtin)");
GLOBAL_STR(str1295, "]");
GLOBAL_STR(str1296, "missing closing ]");
GLOBAL_STR(str1297, "should only have 3 arguments or fewer (simple_test_builtin)");
GLOBAL_STR(str1298, "!");
GLOBAL_STR(str1299, "(");
GLOBAL_STR(str1300, ")");
GLOBAL_STR(str1301, "(test) ");
GLOBAL_STR(str1302, "(test) ");
...
inline Str* fmt55(Str* a0, int a1, Str* a2) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const(" ", 1);
  gBuf.format_d(a1);
...
inline Str* fmt63(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.write_const("osh: Couldn't open ", 19);
  gBuf.format_r(a0);
  gBuf.write_const(": ", 2);
...
inline Str* fmt75(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.write_const("nameref ", 8);
  gBuf.format_r(a0);
...
inline Str* fmt90(Str* a0, int a1, Str* a2) {
  gBuf.reset();
  gBuf.write_const("[ ", 2);
  gBuf.format_s(a0);
...
inline Str* fmt91(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt96(Str* a0, int a1, Str* a2, Str* a3) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const(":", 1);
  gBuf.format_d(a1);
...
inline Str* fmt119(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("-", 1);
  gBuf.format_s(a1);
...
inline Str* fmt138(int a0, int a1) {
  gBuf.reset();
...
inline Str* fmt151(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt176(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt177(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt179(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.write_const("alias ", 6);
  gBuf.format_s(a0);
  gBuf.write_const("=", 1);
...
inline Str* fmt181(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("=", 1);
  gBuf.format_s(a1);
...
inline Str* fmt193(Str* a0, int a1) {
  gBuf.reset();
  gBuf.format_s(a0);
...
inline Str* fmt205(Str* a0, int a1, int a2) {
  gBuf.reset();
  gBuf.write_const("proc ", 5);
  gBuf.format_r(a0);
...
inline Str* fmt209(int a0, int a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const(" != ", 4);
  gBuf.format_d(a1);
...
inline Str* fmt217(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt249(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt263(Str* a0, int a1) {
  gBuf.reset();
...
inline Str* fmt276(Str* a0, Str* a1, syntax_asdl::word_t* a2) {
  gBuf.reset();
...
inline Str* fmt350(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt373(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("/", 1);
  gBuf.format_s(a1);
...
void ExternalProgram::_Exec(Str* argv0_path, List<Str*>* argv, int argv0_spid, Dict<Str*, Str*>* environ, bool should_retry) {
    ...
    if (ok) {
      try {
        ...
        if (match::ShouldHijack(line)) {
          ...
          println_stderr(fmt45(argv0_path));
        }
        else {
          ;  // pass
        }
  ...
  try {
    ...
    this->errfmt->Print_(fmt46(argv0_path, pyutil::strerror(e)), argv0_spid);
    if (e->errno == EACCES) {
      status = 126;
    }
    else {
...
void SubProgramThunk::Run() {
  ...
  try {
    ...
    println_stderr(fmt49(pyutil::strerror(e)));
    status = 2;
  }
  posix::_exit(status);
}
...
void Process::DisplayJob(int job_id, mylib::Writer* f, int style) {
  ...
  if (job_id == -1) {
    ...
    job_id_str = fmt50(job_id);
  }
  if (style == STYLE_PID_ONLY) {
    f->write(fmt51(this->pid));
  }
  else {
    f->write(fmt52(job_id_str, this->pid, _JobStateStr(this->state)));
...
int Process::Start(runtime_asdl::trace_t* why) {
  ...
  pid = posix::fork();
  if (pid < 0) {
    throw Alloc<RuntimeError>(str193);
  }
  else {
    if (pid == 0) {
...
void Pipeline::DisplayJob(int job_id, mylib::Writer* f, int style) {
  ...
  if (style == STYLE_PID_ONLY) {
    f->write(fmt53(this->procs->index_(0)->pid));
  }
  else {
    i = 0;
    for (ListIter<process::Process*> it(this->procs); !it.Done(); it.Next(), ++i) {
      ...
      StackRoots _for({&proc    });
      if (i == 0) {
        job_id_str = fmt54(job_id);
      }
      else {
        job_id_str = str196;
        f->write(fmt55(job_id_str, proc->pid, _JobStateStr(proc->state)));
...
void Pipeline::DebugPrint() {
  print(fmt56(_JobStateStr(this->state)));
}
...
runtime_asdl::cmd_value__Argv* MakeBuiltinArgv(List<Str*>* argv1) {
  ...
  argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str208});
  argv->extend(argv1);
  return Alloc<cmd_value::Argv>(argv, list_repeat(runtime::NO_SPID, len(argv)), nullptr);
}
...
int Main(Str* lang, args::Reader* arg_r, Dict<Str*, Str*>* environ, bool login_shell, pyutil::_ResourceLoader* loader, void* line_input) {
  ...
  arg_r->Next();
  try {
    attrs = flag_spec::ParseMore(str209, arg_r);
  }
  catch (error::Usage* e) {
    println_stderr(fmt59(e->msg));
    return 2;
  }
  flag = Alloc<arg_types::main>(attrs->attrs);
  arena = Alloc<alloc::Arena>();
  ...
  help_builtin = Alloc<builtin_misc::Help>(loader, errfmt);
  if (flag->help) {
    help_builtin->Run(MakeBuiltinArgv(Alloc<List<Str*>>(std::initializer_list<Str*>{fmt60(lang)})));
    return 0;
  }
  if (flag->version) {
    pyutil::ShowAppVersion(str212, loader);
    return 0;
  }
  no_str = nullptr;
  debug_stack = Alloc<List<state::DebugFrame*>>();
  if (arg_r->AtEnd()) {
    ...
    dollar0 = arg_r->Peek();
    frame0 = Alloc<state::DebugFrame>(dollar0, str213, no_str, state::LINE_ZERO, 0, 0);
    debug_stack->append(frame0);
  }
  frame1 = Alloc<state::DebugFrame>(no_str, no_str, no_str, runtime::NO_SPID, 0, 0);
  debug_stack->append(frame1);
  ...
  if (str_equals(lang, str214)) {
    mutable_opts->SetShoptOption(str215, true);
  }
  builtin_pure::SetShellOpts(mutable_opts, attrs->opt_changes, attrs->shopt_changes);
  aliases = Alloc<Dict<Str*, Str*>>();
  oil_grammar = nullptr;
  ...
  parse_ctx->Init_OnePassParse(flag->one_pass_parse);
  comp_arena = Alloc<alloc::Arena>();
  comp_arena->PushSource(Alloc<source::Unused>(str217));
  trail1 = Alloc<parse_lib::Trail>();
  comp_ctx = Alloc<parse_lib::ParseContext>(comp_arena, parse_opts, aliases, oil_grammar);
  comp_ctx->Init_Trail(trail1);
  comp_ctx->Init_OnePassParse(true);
  hist_arena = Alloc<alloc::Arena>();
  hist_arena->PushSource(Alloc<source::Unused>(str218));
  trail2 = Alloc<parse_lib::Trail>();
  hist_ctx = Alloc<parse_lib::ParseContext>(hist_arena, parse_opts, aliases, oil_grammar);
  hist_ctx->Init_Trail(trail2);
  cmd_deps = Alloc<cmd_eval::Deps>();
  ...
  my_pid = posix::getpid();
  debug_path = str219;
  debug_dir = environ->get(str220);
  if (flag->debug_file != nullptr) {
    debug_path = flag->debug_file;
  }
  else {
    if (debug_dir != nullptr) {
      debug_path = os_path::join(debug_dir, fmt61(my_pid));
    }
  }
  if (len(debug_path)) {
    throw Alloc<NotImplementedError>();
  ...
  cmd_deps->debug_f = debug_f;
  if (len(debug_path)) {
    println_stderr(fmt62(debug_path));
  }
  if (flag->xtrace_to_debug_file) {
    trace_f = debug_f;
  }
  ...
  waiter = Alloc<process::Waiter>(job_state, exec_opts, sig_state, tracer);
  fd_state->waiter = waiter;
  interp = environ->get(str223, str224);
  search_path = Alloc<state::SearchPath>(mem);
  ext_prog = Alloc<process::ExternalProgram>(interp, fd_state, errfmt, debug_f);
  splitter = Alloc<split::SplitContext>(mem);
  crash_dump_dir = environ->get(str225, str226);
  cmd_deps->dumper = Alloc<dev::CrashDumper>(crash_dump_dir);
  dir_stack = Alloc<state::DirStack>();
  builtins = Alloc<Dict<int, vm::_Builtin*>>();
  modules = Alloc<Dict<Str*, bool>>();
  ...
  if (flag->c != nullptr) {
    ...
    if (flag->i) {
      ...
      if (script_name == nullptr) {
        stdin = mylib::Stdin();
        arena->PushSource(Alloc<source::Stdin>(str227));
        line_reader = Alloc<reader::FileLineReader>(stdin, arena);
      }
      else {
        arena->PushSource(Alloc<source::MainFile>(script_name));
        try {
          ...
          println_stderr(fmt63(script_name, pyutil::strerror(e)));
          return 1;
        }
        line_reader = Alloc<reader::FileLineReader>(f, arena);
      }
...
Str* SearchPath::Lookup(Str* name, bool exec_required) {
  ...
  val = this->mem->GetValue(str234);
  UP_val = val;
  if (val->tag_() == value_e::Str) {
    value__Str* val = static_cast<value__Str*>(UP_val);
    path_list = val->s->split(str235);
  }
  else {
...
void MutableOpts::Init() {
  ...
  UP_shellopts = this->mem->GetValue(str239);
...
int MutableOpts::ErrExitDisabledSpanId() {
  ...
  overlay = this->opt_stacks->index_(option_i::errexit);
  if ((overlay == nullptr or len(overlay) == 0)) {
    return runtime::NO_SPID;
  }
  else {
    was_on = (this->opt0_array->index_(option_i::errexit) or list_contains(overlay, true));
    if ((was_on and !overlay->index_(-1))) {
...
void MutableOpts::SetOption(Str* opt_name, bool b) {
  ...
  UP_val = this->mem->GetValue(str243);
  value__Str* val = static_cast<value__Str*>(UP_val);
  shellopts = val->s;
  if (b) {
    if (!str_contains(shellopts, opt_name)) {
      new_val = Alloc<value::Str>(fmt69(shellopts, opt_name));
    ...
    if (str_contains(shellopts, opt_name)) {
      ...
      for (ListIter<Str*> it(shellopts->split(str246)); !it.Done(); it.Next()) {
        Str* n = it.Value();
        if (!(str_equals(n, opt_name))) {
          names->append(n);
        }
      }
      new_val = Alloc<value::Str>(str247->join(names));
      this->mem->InternalSetGlobal(str248, new_val);
    }
  }
}
...
void MutableOpts::ShowOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    b = this->Get(opt_num);
    print(fmt70(b ? str253 : str254, opt_name));
  }
}
...
void MutableOpts::ShowShoptOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<int> it(opt_nums); !it.Done(); it.Next()) {
    ...
    print(fmt72(b ? str260 : str261, consts::OptionName(opt_num)));
  }
}
...
void _InitDefaults(state::Mem* mem) {
  ...
  SetGlobalString(mem, str264, split::DEFAULT_IFS);
  SetGlobalString(mem, str265, str(posix::getuid()));
  SetGlobalString(mem, str266, str(posix::geteuid()));
  SetGlobalString(mem, str267, str(posix::getppid()));
  SetGlobalString(mem, str268, libc::gethostname());
  SetGlobalString(mem, str269, pyos::OsType());
  SetGlobalString(mem, str270, str271);
  SetGlobalString(mem, str272, str273);
  SetGlobalString(mem, str274, _READLINE_DELIMS);
}
...
void _InitVarsFromEnv(state::Mem* mem, Dict<Str*, Str*>* environ) {
  ...
  val = mem->GetValue(str275);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str276, str277);
  }
  mem->SetValue(Alloc<lvalue::Named>(str278), nullptr, scope_e::GlobalOnly, SetReadOnly);
  val = mem->GetValue(str279);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str280, _GetWorkingDir());
  }
  mem->SetValue(Alloc<lvalue::Named>(str281), nullptr, scope_e::GlobalOnly, SetExport);
...
void InitMem(state::Mem* mem, Dict<Str*, Str*>* environ, Str* version_str) {
  ...
  SetGlobalString(mem, str285, version_str);
  _InitDefaults(mem);
  _InitVarsFromEnv(mem, environ);
  val = mem->GetValue(str286);
...
void InitInteractive(state::Mem* mem) {
  ...
  if (mem->GetValue(str287)->tag_() == value_e::Undef) {
    SetGlobalString(mem, str288, str289);
  }
}
...
Mem::Mem(Str* dollar0, List<Str*>* argv, alloc::Arena* arena, List<state::DebugFrame*>* debug_stack) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Mem)) {
  ...
  this->line_num = Alloc<value::Str>(str290);
...
Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> Mem::_ResolveNameOrRef(Str* name, runtime_asdl::scope_t which_scopes, bool is_setref, List<Str*>* ref_trail) {
  ...
  if (ref_trail == nullptr) {
    ...
    if (list_contains(ref_trail, new_name)) {
      e_die(fmt76(str302->join(ref_trail)));
    }
  }
  ...
  switch (lval->tag_()) {
    case lvalue_e::Named: {
      ...
      if (keyword_id == Id::KW_SetRef) {
        lval->name = str_concat(str303, lval->name);
      }
    ...
    case lvalue_e::Indexed: {
      ...
      e_die(fmt80(ui::ValType(cell->val)), left_spid);
    }
      break;
    case lvalue_e::Keyed: {
      lvalue__Keyed* lval = static_cast<lvalue__Keyed*>(UP_lval);
...
runtime_asdl::value_t* Mem::GetValue(Str* name, runtime_asdl::scope_t which_scopes) {
  ...
  if (str_equals(name, str312)) {
    return Alloc<value::Str>(str(this->last_status->index_(-1)));
  }
  ...
  if ((str_equals(name, str314) || str_equals(name, str315))) {
...
bool Mem::Unset(runtime_asdl::lvalue_t* lval, runtime_asdl::scope_t which_scopes) {
  ...
  if (cell->readonly) {
    throw Alloc<error::Runtime>(fmt82(var_name));
  }
  switch (lval->tag_()) {
    case lvalue_e::Named: {
    ...
    case lvalue_e::Indexed: {
      ...
      if (val->tag_() != value_e::MaybeStrArray) {
        throw Alloc<error::Runtime>(fmt83(var_name));
      }
      value__MaybeStrArray* val = static_cast<value__MaybeStrArray*>(UP_val);
      strs = val->strs;
      n = len(strs);
...
Str* GetString(state::Mem* mem, Str* name) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      throw Alloc<error::Runtime>(fmt84(name));
    }
      break;
    case value_e::Str: {
      ...
      break;
    default: {
      throw Alloc<error::Runtime>(fmt85(name));
    }
  }
}
...
int GetInteger(state::Mem* mem, Str* name) {
  ...
  val = mem->GetValue(name);
  if (val->tag_() != value_e::Str) {
    throw Alloc<error::Runtime>(fmt86(name, ui::ValType(val)));
  }
  ...
  try {
    ...
    throw Alloc<error::Runtime>(fmt87(name, s));
  }
  return i;
}
...
Str* PrettyDir(Str* dir_name, Str* home_dir) {
  ...
  if (home_dir != nullptr) {
    if ((str_equals(dir_name, home_dir) or dir_name->startswith(str_concat(home_dir, str332)))) {
      return str_concat(str333, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    StackRoots _for({&c  });
    buf->write(str_equals(c, str336) ? str337 : str338);
  }
  buf->write(str339);
  buf->write(str_repeat(str340, (length - 1)));
  buf->write(str341);
  ...
  switch (src->tag_()) {
    ...
    case source_e::ArgvWord: {
      ...
      if (src->span_id == runtime::NO_SPID) {
        ...
        s = fmt90(src->what, line_num, outer_source);
      }
    }
      break;
    case source_e::Variable: {
      ...
      if (src->span_id == runtime::NO_SPID) {
        ...
        line_num = arena->GetLineNumber(span->line_id);
        outer_source = GetLineSourceString(arena, span->line_id, quote_filename);
        where = fmt91(line_num, outer_source);
      }
      s = fmt92(var_name, where);
    }
      break;
    case source_e::Alias: {
...
void _PrintWithSpanId(Str* prefix, Str* msg, int span_id, alloc::Arena* arena, bool show_code) {
  ...
  f->write(fmt96(source_str, line_num, prefix, msg));
}
...
void ErrorFormatter::Print_(Str* msg, int span_id) {
  ...
  _PrintWithSpanId(str356, msg, span_id, this->arena, true);
}
...
void ErrorFormatter::PrintMessage(Str* msg, int span_id) {
  ...
  _PrintWithSpanId(str357, msg, span_id, this->arena, false);
}
...
void PrintAst(syntax_asdl::command_t* node, arg_types::main* flag) {
  ...
  if (maybe_str_equals(flag->ast_format, str360)) {
    println_stderr(str361);
  }
  else {
    f = mylib::Stdout();
    ...
    if ((maybe_str_equals(afmt, str362) || maybe_str_equals(afmt, str363))) {
      ...
      if ((maybe_str_equals(afmt, str364) || maybe_str_equals(afmt, str365))) {
...
void _Attributes::Set(Str* name, runtime_asdl::value_t* val) {
  ...
  name = name->replace(str369, str370);
...
bool SetAttachedBool::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  if (attached_arg != nullptr) {
    if ((str_equals(attached_arg, str386) || str_equals(attached_arg, str387) || str_equals(attached_arg, str388) || str_equals(attached_arg, str389))) {
      b = false;
    }
    else {
      if ((str_equals(attached_arg, str390) || str_equals(attached_arg, str391) || str_equals(attached_arg, str392) || str_equals(attached_arg, str393))) {
        b = true;
      }
      else {
        e_usage(fmt98(attached_arg));
      }
    }
  }
  else {
...
bool SetOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str395);
...
args::_Attributes* Parse(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str400)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if ((len(spec->actions_long) and arg->startswith(str401))) {
      pos = arg->find(str402, 2);
      if (pos == -1) {
        suffix = nullptr;
      ...
      if ((arg->startswith(str404) and len(arg) > 1)) {
        n = len(arg);
        for (int i = 1; i < n; ++i) {
          ch = arg->index_(i);
          if (str_equals(ch, str405)) {
            ch = str406;
          }
          if (list_contains(spec->plus_flags, ch)) {
            out->Set(ch, Alloc<value::Str>(str407));
            continue;
          }
        ...
        if ((len(spec->plus_flags) and (arg->startswith(str410) and len(arg) > 1))) {
          n = len(arg);
          for (int i = 1; i < n; ++i) {
            ch = arg->index_(i);
            if (list_contains(spec->plus_flags, ch)) {
              out->Set(ch, Alloc<value::Str>(str411));
              continue;
            }
            e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
          }
...
args::_Attributes* ParseLikeEcho(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    chars = arg->slice(1);
    if ((arg->startswith(str414) and len(chars))) {
      done = false;
...
args::_Attributes* ParseMore(flag_spec::_FlagSpecAndMore* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str415)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if (arg->startswith(str416)) {
    ...
    if (((arg->startswith(str418) or arg->startswith(str419)) and len(arg) > 1)) {
      char0 = arg->index_(0);
...
int LineLexer::GetSpanIdForEof() {
  int line_id;
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str423, 0);
  }
  else {
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str425, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = Alloc<Token>(id_, span_id, str426);
      return t;
    }
...
lexer::Lexer* ParseContext::MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = Alloc<lexer::LineLexer>(str428, this->arena);
    ...
    if (n == 1) {
      ...
      switch (arg->tag_()) {
        ...
        case expr_e::CommandSub: {
          ...
          break;
        default: {
          e_usage(fmt104(), arg_list->spids->index_(0));
        }
      }
    }
    else {
      e_usage(fmt105(), arg_list->spids->index_(0));
    }
  }
}
...
int _Classify(grammar::Grammar* gr, syntax_asdl::Token* tok) {
  ...
  if (tok->id == Id::Unknown_Tok) {
    ...
    type_str = fmt107(ui::PrettyId(tok->id));
  }
  p_die(fmt108(type_str), tok);
}
...
Tuple2<pnode::PNode*, syntax_asdl::Token*> ExprParser::Parse(lexer::Lexer* lexer, int start_symbol) {
  ...
  try {
    ...
    p_die(fmt109(ui::PrettyId(e->tok->id)), e->tok);
  }
...
GLOBAL_LIST(Str*, 12, POSIX_CLASSES, {str441 COMMA str442 COMMA str443 COMMA str444 COMMA str445 COMMA str446 COMMA str447 COMMA str448 COMMA str449 COMMA str450 COMMA str451 COMMA str452});
Str* RANGE_POINT_TOO_LONG = str453;
int NT_OFFSET = 256;
...
syntax_asdl::expr_t* Transformer::_Tuple(List<pnode::PNode*>* children) {
  ...
  if (n == 2) {
    p_die(fmt110(), children->index_(1)->tok);
  }
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw Alloc<NotImplementedError>(str455);
  }
  if (id0 == Id::Op_LBracket) {
    elts = Alloc<List<syntax_asdl::expr_t*>>();
    for (int i = 0; i < n; i += 2) {
  ...
  for (int i = 0; i < n; i += 2) {
    ...
    if (tag == expr_e::Var) {
      ...
      if ((tag == place_expr_e::Var || tag == place_expr_e::Subscript || tag == place_expr_e::Attribute)) {
        ...
        p_die(fmt112(), p->tok ? p->tok : nullptr);
      }
    }
  }
  return places;
  ...
  while (i < n) {
    ...
    if ((prefix and prefix->id == Id::Expr_At)) {
      ...
      if (typ == nullptr) {
        ...
        if ((typ->val != str460 && typ->val != str461)) {
          p_die(fmt113(), typ);
        }
...
syntax_asdl::re_t* Transformer::_NameInRegex(syntax_asdl::Token* negated_tok, syntax_asdl::Token* tok) {
  ...
  val = tok->val;
  if (maybe_str_equals(val, str464)) {
    if (negated_tok) {
      p_die(fmt114(), tok);
    }
    return tok;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((str_equals(tok->val, str469) || str_equals(tok->val, str470) || str_equals(tok->val, str471))) {
        return tok;
      }
      p_die(fmt118(tok->val), tok);
    }
...
void _ClassLiteralToPosixEre(syntax_asdl::class_literal_term_t* term, List<Str*>* parts) {
  ...
  if (tag == class_literal_term_e::CodePoint) {
    ...
    if (code_point < 128) {
      ...
      e_die(fmt120(code_point), term->spid);
    }
    return ;
  }
  if (tag == class_literal_term_e::PerlClass) {
    ...
    if (term->negated) {
      e_die(fmt121(), term->negated->span_id);
    }
    else {
      pat = fmt122(chars);
    }
  ...
  if (tag == class_literal_term_e::PosixClass) {
    ...
    n = term->name;
    if (term->negated) {
      e_die(fmt123(), term->negated->span_id);
    }
    else {
      pat = fmt124(n);
    }
...
void AsPosixEre(syntax_asdl::re_t* node, List<Str*>* parts) {
  ...
  if (tag == re_e::Repeat) {
    ...
    if (op_tag == re_repeat_e::Num) {
      ...
      parts->append(fmt126(op->times->val));
      return ;
    }
    if (op_tag == re_repeat_e::Range) {
      re_repeat__Range* op = static_cast<re_repeat__Range*>(UP_op);
      lower = op->lower ? op->lower->val : str488;
      upper = op->upper ? op->upper->val : str489;
      parts->append(fmt127(lower, upper));
      return ;
    }
...
syntax_asdl::bool_expr_t* BoolParser::ParseForBuiltin() {
  ...
  if (this->bool_id != Id::Eof_Real) {
    p_die(fmt134(word_::Pretty(this->cur_word)), this->cur_word);
  }
  return node;
}
...
syntax_asdl::bool_expr_t* BoolParser::ParseFactor() {
  ...
  if (this->bool_id == Id::Op_LParen) {
    ...
    if (this->bool_id != Id::Op_RParen) {
      p_die(fmt136(word_::Pretty(this->cur_word)), this->cur_word);
    }
    this->_Next();
    return node;
  }
  p_die(fmt137(ui::PrettyId(this->bool_id)), this->cur_word);
}
...
Str* _RangeParser::_Eat(int token_type) {
  ...
  if (this->token_type != token_type) {
    throw Alloc<_NotARange>(fmt138(token_type, this->token_type));
  }
  val = this->token_val;
  this->_Next();
  return val;
...
syntax_asdl::word_part__BracedRange* _RangeParser::Parse() {
  ...
  if (this->token_type == Id::Range_Int) {
    ...
    if (this->token_type == Id::Range_Char) {
      ...
      if (upper1 != upper2) {
        p_die(fmt144(), this->span_id);
      }
    }
    else {
      throw Alloc<_NotARange>(str514);
    }
  }
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  flag = attrs->attrs;
  tmp_g = flag->get(str517);
  tmp_a = flag->get(str518);
  tmp_A = flag->get(str519);
  ...
  flag_A = (tmp_A and tmp_A->tag_() == value_e::Bool) ? static_cast<value__Bool*>(tmp_A)->b : false;
  tmp_n = flag->get(str520);
  tmp_r = flag->get(str521);
  tmp_x = flag->get(str522);
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if ((maybe_str_equals(flag_n, str524) and !cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_n, str525) and cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str526) and !cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str527) and cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str528) and !cell->exported)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str529) and cell->exported)) {
      continue;
    }
    ...
    if (print_flags) {
      ...
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str536, str537->join(flags), str538, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str539, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (has_holes) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str542, name, str543, str(i), str544, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str546, str547->join(body), str548}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str550, key_quoted, str551, value_quoted}));
          }
          if (len(body) > 0) {
            decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str552, str553->join(body), str554}));
          }
        }
        else {
          ;  // pass
...
int Readonly::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str561, arg_r);
...
int NewVar::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str562, arg_r);
  ...
  flags_to_clear = 0;
  if (maybe_str_equals(arg->x, str568)) {
    flags |= state::ClearExport;
  }
  if (maybe_str_equals(arg->r, str569)) {
    flags |= state::ClearReadOnly;
  }
  if (maybe_str_equals(arg->n, str570)) {
...
int Eval::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str574, cmd_val);
  arg_r = tup0.at1();
  if (this->exec_opts->simple_eval_builtin()) {
    Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str575);
    code_str = tup1.at0();
    eval_spid = tup1.at1();
    if (!arg_r->AtEnd()) {
      e_usage(str576);
    ...
    code_str = str577->join(arg_r->Rest());
    eval_spid = cmd_val->arg_spids->index_(0);
  }
  line_reader = reader::StringLineReader(code_str, this->arena);
  c_parser = this->parse_ctx->MakeOshParser(line_reader);
  src = Alloc<source::ArgvWord>(str578, eval_spid);
  {  // with
    dev::ctx_Tracer ctx(this->tracer, str579, nullptr);
...
int Source::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str580, cmd_val);
  arg_r = tup2.at1();
  path = arg_r->Peek();
  if (path == nullptr) {
    e_usage(str581);
  ...
  try {
    ...
    this->errfmt->Print_(fmt151(path, pyutil::strerror(e)), cmd_val->arg_spids->index_(1));
    return 1;
  }
  try {
    try {
      ...
      c_parser = this->parse_ctx->MakeOshParser(line_reader);
      {  // with
        dev::ctx_Tracer ctx(this->tracer, str583, cmd_val->argv);
...
int Command::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup3 = flag_spec::ParseCmdVal(str584, cmd_val);
  attrs = tup3.at0();
  arg_r = tup3.at1();
...
int Builtin::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (to_run == consts::NO_INDEX) {
    ...
    if (consts::LookupAssignBuiltin(name) != consts::NO_INDEX) {
      this->errfmt->Print_(str585, span_id);
    }
    else {
      this->errfmt->Print_(fmt152(name), span_id);
    }
    return 1;
  }
...
int RunProc::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str587, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
  ...
  spids = tup6.at1();
  if (len(argv) == 0) {
    throw Alloc<error::Usage>(str588, runtime::NO_SPID);
  }
  name = argv->index_(0);
  if (!dict_contains(this->procs, name)) {
...
int Try::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup7 = flag_spec::ParseCmdVal(str590, cmd_val);
  attrs = tup7.at0();
  arg_r = tup7.at1();
  ...
  if ((arg->allow_status_01 and (status != 0 && status != 1))) {
    if (failure_spid != runtime::NO_SPID) {
      this->errfmt->Print_(str592, failure_spid);
      this->errfmt->StderrLine(str593);
    }
    throw Alloc<error::FatalRuntime>(fmt155(status), spids->index_(0), status);
  }
  if (arg->assign != nullptr) {
    var_name = arg->assign;
    if (var_name->startswith(str595)) {
              ...
              if (consts::IsControlFlow(name)) {
                ...
                if (consts::IsKeyword(name)) {
                  ...
                  if (resolved == nullptr) {
                    ...
                    kind = (Alloc<Tuple2<Str*, Str*>>(str603, resolved));
                  }
                }
              }
            }
...
int Type::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseCmdVal(str604, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
...
int Read::_Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str618, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
  ...
  if (arg->line) {
    ...
    next_spid = tup8.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str621, next_spid);
    }
  ...
  if (arg->all) {
    ...
    next_spid = tup10.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str625, next_spid);
    }
...
int MapFile::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup13 = flag_spec::ParseCmdVal(str632, cmd_val);
  attrs = tup13.at0();
  arg_r = tup13.at1();
  ...
  while (true) {
    ...
    if ((arg->t and line->endswith(str636))) {
      line = line->slice(0, -1);
    }
    lines->append(line);
  }
...
int Cd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str637, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  ...
  if (str_equals(dest_dir, str640)) {
    try {
      dest_dir = state::GetString(this->mem, str641);
      print(dest_dir);
    }
    catch (error::Runtime* e) {
      this->errfmt->Print_(e->UserErrorString());
  ...
  try {
    pwd = state::GetString(this->mem, str642);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    return 1;
  ...
  state::ExportGlobalString(this->mem, str644, real_dest_dir);
  ...
  if (block) {
    ...
    state::ExportGlobalString(this->mem, str645, pwd);
...
int Pushd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  dest_dir = os_path::abspath(cmd_val->argv->index_(1));
  err_num = pyos::Chdir(dest_dir);
  if (err_num != 0) {
    this->errfmt->Print_(fmt162(dest_dir, posix::strerror(err_num)), cmd_val->arg_spids->index_(1));
    return 1;
  }
  this->dir_stack->Push(dest_dir);
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str651));
  state::ExportGlobalString(this->mem, str652, dest_dir);
...
bool _PopDirStack(state::Mem* mem, state::DirStack* dir_stack, ui::ErrorFormatter* errfmt) {
  ...
  if (dest_dir == nullptr) {
    errfmt->Print_(str653);
    return false;
  }
  err_num = pyos::Chdir(dest_dir);
  if (err_num != 0) {
    errfmt->Print_(fmt163(dest_dir, posix::strerror(err_num)));
    return false;
  }
  state::SetGlobalString(mem, str655, dest_dir);
  mem->SetPwd(dest_dir);
  return true;
}
...
int Popd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->arg_spids) > 1) {
    e_usage(fmt164(), cmd_val->arg_spids->index_(1));
  }
  if (!_PopDirStack(this->mem, this->dir_stack, this->errfmt)) {
    return 1;
  }
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str657));
  return 0;
}
...
int Dirs::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup17 = flag_spec::ParseCmdVal(str658, cmd_val);
  attrs = tup17.at0();
  arg_r = tup17.at1();
  arg = Alloc<arg_types::dirs>(attrs->attrs);
  home_dir = state::MaybeString(this->mem, str659);
  style = SINGLE_LINE;
  if (arg->l) {
    home_dir = nullptr;
  }
...
int Pwd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup18 = flag_spec::ParseCmdVal(str660, cmd_val);
  attrs = tup18.at0();
  arg_r = tup18.at1();
...
List<Str*>* Help::_Groups() {
  ...
  contents = this->loader->Get(str661);
...
int Help::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup19 = flag_spec::ParseCmdVal(str662, cmd_val);
  attrs = tup19.at0();
  arg_r = tup19.at1();
  ...
  try {
    contents = this->loader->Get(fmt165(topic));
  }
  catch (IOError*) {
    this->errfmt->Print_(fmt166(topic), blame_spid);
    return 1;
  }
  print(contents);
  return 0;
  ...
  while (true) {
    ...
    if (n < 0) {
      if (err_num == EINTR) {
        ...
        e_die(fmt167(posix::strerror(err_num)), 2);
      }
    }
    else {
      if (n == 0) {
...
syntax_asdl::printf_part_t* _FormatStringParser::_ParseFormatStr() {
  ...
  while ((this->token_type == Id::Format_Flag || this->token_type == Id::Format_Zero)) {
    ...
    if (str_contains(str667, flag)) {
      p_die(fmt168(flag), this->cur_token);
    }
  ...
  if ((this->token_type == Id::Format_Type || this->token_type == Id::Format_Time)) {
    ...
    if (str_contains(str669, part->type->val)) {
      p_die(fmt169(), part->type);
    }
    if (maybe_str_equals(part->type->val, str671)) {
      p_die(fmt170(), part->type);
    }
  }
  else {
        ...
        if (part->tag_() == printf_part_e::Percent) {
          ...
          if (part->width) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt173(width_str), width_spid);
              return 1;
            }
          }
          precision = -1;
          if (part->precision) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt174(precision_str), precision_spid);
              return 1;
            }
          }
          if (arg_index < num_args) {
          ...
          if (str_equals(typ, str682)) {
            ...
            if (str_equals(typ, str683)) {
              ...
              if (str_equals(typ, str684)) {
                ...
                s = str685->join(c_parts);
              }
              else {
                if ((part->type->id == Id::Format_Time or str_contains(str686, typ))) {
                  try {
                    d = to_int(s);
                  }
                  catch (ValueError*) {
                    if ((len(s) >= 1 and str_contains(str687, s->index_(0)))) {
                  ...
                  if (part->type->id == Id::Format_Time) {
                    ...
                    if ((d < 0 and str_contains(str691, typ))) {
                      e_die(fmt176(d, typ), part->type->span_id);
                    }
                    if (str_equals(typ, str693)) {
                      s = mylib::octal(d);
                    }
                    else {
                      if (str_equals(typ, str694)) {
                        s = mylib::hex_lower(d);
                      }
                      else {
                        if (str_equals(typ, str695)) {
                          s = mylib::hex_upper(d);
                        }
                        else {
                          s = str(d);
                    ...
                    zero_pad = 0;
                    if ((width >= 0 and list_contains(flags, str696))) {
                      zero_pad = 1;
                    }
                    else {
                    ...
                    if (zero_pad) {
                      negative = str_equals(s->index_(0), str697);
                      if (negative) {
                        digits = s->slice(1);
                        sign = str698;
                        if (zero_pad == 1) {
                      ...
                      s = str_concat(sign, digits->rjust(n, str700));
                    }
                  }
                }
                else {
          ...
          if (width >= 0) {
            if (list_contains(flags, str701)) {
              s = s->ljust(width, str702);
            }
            else {
              s = s->rjust(width, str703);
            }
          }
          out->append(s);
        }
...
int Printf::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup1 = flag_spec::ParseCmdVal(str704, cmd_val);
  attrs = tup1.at0();
  arg_r = tup1.at1();
  arg = Alloc<arg_types::printf>(attrs->attrs);
  Tuple2<Str*, int> tup2 = arg_r->ReadRequired2(str705);
  fmt = tup2.at0();
  fmt_spid = tup2.at1();
  ...
  if (dict_contains(this->parse_cache, fmt)) {
    ...
    {  // with
      alloc::ctx_Location ctx(arena, Alloc<source::ArgvWord>(str706, fmt_spid));
...
int Alias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    ...
    if (alias_exp == nullptr) {
      ...
      if (alias_exp == nullptr) {
        this->errfmt->Print_(fmt178(name), cmd_val->arg_spids->index_(i));
        status = 1;
      }
      else {
        print(fmt179(name, alias_exp));
      }
    }
    else {
...
int UnAlias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    ...
    if (dict_contains(this->aliases, name)) {
      ...
      this->errfmt->Print_(fmt180(name), cmd_val->arg_spids->index_(i));
      status = 1;
    }
  }
  return status;
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->argv) == 1) {
    ...
    for (ListIter<Str*> it(sorted(mapping)); !it.Done(); it.Next()) {
      ...
      code_str = fmt181(name, qsn::maybe_shell_encode(str_val));
      print(code_str);
    }
    return 0;
  }
...
int Shopt::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str718, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
...
int Hash::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str720, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
...
Tuple2<int, Str*> _GetOpts(Dict<Str*, bool>* spec, List<Str*>* argv, builtin_pure::GetOptsState* my_state, ui::ErrorFormatter* errfmt) {
  ...
  if (spec->index_(flag_char)) {
    if (more_chars) {
      ...
      if (optarg == nullptr) {
        my_state->Fail();
        errfmt->Print_(fmt184(current));
        tmp = Alloc<List<Str*>>();
        for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
          Str* a = it.Value();
          tmp->append(qsn::maybe_shell_encode(a));
        }
        println_stderr(fmt185(str736->join(tmp)));
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<Str*, int> tup7 = arg_r->ReadRequired2(str740);
  var_name = tup7.at0();
  var_spid = tup7.at1();
  ...
  if (match::IsValidVarName(var_name)) {
    ...
    throw Alloc<error::Usage>(fmt186(var_name), var_spid);
  }
  return status;
}
...
int Echo::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseLikeEcho(str742, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
...
int Module::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseCmdVal(str747, cmd_val);
  arg_r = tup11.at1();
  Tuple2<Str*, int> tup12 = arg_r->ReadRequired2(str748);
  name = tup12.at0();
  if (dict_contains(this->modules, name)) {
    if (this->exec_opts->redefine_module()) {
      this->errfmt->PrintMessage(fmt187(name));
      return 0;
    }
    else {
      return 1;
  ...
  if (str_equals(arg, str751)) {
    ...
    if (UP_actual->tag_() == value_e::Str) {
      ...
      if (maybe_str_equals(actual, expected)) {
        ...
        this->errfmt->Print_(fmt188(expected, actual), e_spid);
        return 1;
      }
    }
    else {
      this->errfmt->Print_(fmt189(expected), e_spid);
      return 1;
    }
  }
...
int Shvar::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str759, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  block = typed_args::GetOneBlock(cmd_val->typed_args);
  if (!block) {
  ...
  for (ListIter<Str*> it(args); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup17 = mylib::split_once(arg, str762);
    name = tup17.at0();
    s = tup17.at1();
    if (s == nullptr) {
...
int CommandEvaluator::_RunAssignBuiltin(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  if (builtin_func == nullptr) {
    e_die(fmt191(cmd_val->argv->index_(0)), cmd_val->arg_spids->index_(0));
  }
  try {
    try {
      status = builtin_func->Run(cmd_val);
      ...
      this->errfmt->PrefixPrint(e->msg, fmt192(arg0), e->span_id);
      status = 2;
    }
  }
  catch (std::exception) { }  return status;
    ...
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          t = val->s;
          if (len(t) == 0) {
            throw Alloc<error::RedirectEval>(str775, arg_word);
            return nullptr;
          }
          try {
            if (maybe_str_equals(t, str776)) {
              result->arg = Alloc<redirect_arg::CloseFd>();
            }
            else {
              if (str_equals(t->index_(-1), str777)) {
            ...
            throw Alloc<error::RedirectEval>(fmt194(t), arg_word);
            return nullptr;
          }
          return result;
        }
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = Alloc<redirect_arg::HereDoc>(str_concat(val->s, str779));
            return result;
          }
          else {
            throw Alloc<AssertionError>();
...
void CommandEvaluator::_StrictErrExit(syntax_asdl::command_t* node) {
  ...
  if (_HasManyStatuses(node)) {
    ...
    e_die(fmt195(node_str), location::SpanForCommand(node));
  }
}
...
void CommandEvaluator::_StrictErrExitList(List<syntax_asdl::command_t*>* node_list) {
  ...
  if (len(node_list) > 1) {
    e_die(fmt196(), location::SpanForCommand(node_list->index_(0)));
  }
  node = node_list->index_(0);
  if (_HasManyStatuses(node)) {
    node_str = ui::CommandType(node);
    e_die(fmt197(node_str), location::SpanForCommand(node));
  }
}
  ...
  switch (node->tag_()) {
    case command_e::Simple: {
      ...
      if (UP_cmd_val->tag_() == cmd_value_e::Argv) {
        ...
        if (node->block) {
          e_die(fmt198(), node->block->spids->index_(0));
        }
        cmd_value__Assign* cmd_val = static_cast<cmd_value__Assign*>(UP_cmd_val);
      }
    ...
    case command_e::Pipeline: {
      ...
      if (len(node->stderr_indices)) {
        e_die(fmt199(), node->spids->index_(0));
      }
      if (node->negated) {
    ...
    case command_e::ControlFlow: {
      ...
      if (node->arg_word) {
        ...
        if ((len(str_val->s) == 0 and !this->exec_opts->strict_control_flow())) {
          ...
          try {
            ...
            e_die(fmt200(node->token->val, str_val->s), node->arg_word);
          }
        }
      }
      else {
      ...
      if (ok) {
        ...
        if (this->exec_opts->strict_control_flow()) {
          ...
          this->errfmt->PrefixPrint(msg, str789, tok->span_id);
          status = 0;
        }
      }
    }
    ...
    case command_e::ShFunction: {
      ...
      if ((dict_contains(this->procs, node->name) and !this->exec_opts->redefine_proc())) {
        e_die(fmt201(node->name), node->spids->index_(1));
      }
    ...
    case command_e::Proc: {
      ...
      if ((dict_contains(this->procs, node->name->val) and !this->exec_opts->redefine_proc())) {
        e_die(fmt202(node->name->val), node->name->span_id);
      }
      defaults = nullptr;
      ...
      if (this->shell_ex->PushRedirects(redirects)) {
        {  // with
          ...
          try {
            ...
            this->errfmt->PrettyPrintError(e, str793);
            status = 1;
            check_errexit = true;
          }
        }
...
Tuple2<bool, bool> CommandEvaluator::ExecuteAndCatch(syntax_asdl::command_t* node, int cmd_flags) {
  ...
  try {
    ...
    if ((cmd_flags & RaiseControlFlow)) {
      ...
      if (e->IsReturn()) {
        ...
        this->errfmt->Print_(str794, e->token->span_id);
        is_fatal = true;
        status = 1;
      }
    }
  ...
  if (err) {
    ...
    if (is_errexit) {
      ...
      this->errfmt->PrettyPrintError(err, str795);
    }
  }
...
void CommandEvaluator::MaybeRunExitTrap(List<int>* mut_status) {
  ...
  handler = this->traps->get(str796);
  if (handler) {
    {  // with
      dev::ctx_Tracer ctx(this->tracer, str797, nullptr);
  ...
  {  // with
    ...
    if (UP_sig->tag_() == proc_sig_e::Closed) {
      ...
      for (ListIter<syntax_asdl::UntypedParam*> it(sig->untyped); !it.Done(); it.Next(), ++i) {
        ...
        if (i < n_args) {
          ...
          if (is_out_param) {
            param_name = str_concat(str798, param_name);
            if (!arg_str->startswith(str799)) {
              e_die(fmt203(arg_str));
            }
      ...
      if (sig->rest) {
        ...
        if (n_args > n_params) {
          this->errfmt->Print_(fmt205(proc->name, n_params, n_args), arg0_spid);
          return 2;
        }
      }
    }
    try {
      ...
      if (e->IsReturn()) {
        ...
        e_die(fmt206(e->token->val), e->token);
      }
    }
    catch (error::FatalRuntime* e) {
      this->dumper->MaybeCollect(this, e);
...
int CommandEvaluator::RunFuncForCompletion(runtime_asdl::Proc* proc, List<Str*>* argv) {
  ...
  try {
    ...
    this->errfmt->Print_(str804, e->token->span_id);
    status = 1;
  }
  return status;
}
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index_(i), str806))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index_(-2), str808)) {
    ...
    if ((left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse)) {
      var_name = left_token->val->slice(0, -1);
      if (str_equals(close_token->val->index_(-2), str809)) {
        op = assign_op_e::PlusEqual;
      }
      else {
        op = assign_op_e::Equal;
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        var_name = left_token->val->slice(0, -1);
        if (str_equals(close_token->val->index_(-2), str810)) {
          op = assign_op_e::PlusEqual;
        }
        else {
          op = assign_op_e::Equal;
        ...
        if (span1->line_id == span2->line_id) {
          ...
          throw Alloc<NotImplementedError>(fmt209(span1->line_id, span2->line_id));
        }
        a_parser = parse_ctx->MakeArithParser(code_str);
        src = Alloc<source::Reparsed>(str812, left_token->span_id, close_token->span_id);
        {  // with
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    w = tup6->at3();
    if (left_token->id != Id::Lit_VarLike) {
      p_die(fmt210(), left_token);
    }
    if (str_equals(left_token->val->index_(-2), str814)) {
      p_die(fmt211(), left_token);
    }
    var_name = left_token->val->slice(0, -1);
    n = len(w->parts);
    if (part_offset == n) {
...
void CommandParser::_Eat(int c_id) {
  ...
  msg = fmt217(ui::PrettyId(c_id), ui::PrettyId(actual_id));
  this->_Eat2(c_id, msg);
}
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index_(0), str822)) {
    pos = op_val->find(str823);
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    i += 1;
    if (!alias_exp->endswith(str829)) {
      expanded->append(str830);
      break;
    }
  }
  if (len(expanded) == 0) {
  ...
  while (i < n) {
    ...
    expanded->append(str832);
    i += 1;
  }
  code_str = str833->join(expanded);
  line_reader = reader::StringLineReader(code_str, this->arena);
  ...
  if (kind == Kind::ControlFlow) {
    ...
    if (len(suffix_words) == 1) {
      ...
      if (len(suffix_words) == 2) {
        ...
        p_die(fmt231(kw_token->val), suffix_words->index_(2));
      }
    }
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    ...
    if (str_equals(c, str859)) {
      ...
      if ((str_equals(c, str860) or str_equals(c, str861))) {
        return true;
      }
      else {
        if (str_equals(c, str862)) {
          left_bracket = true;
        }
        else {
          if ((str_equals(c, str863) and left_bracket)) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  ...
  return pyutil::BackslashEscape(s, str865);
}
Str* ERE_META_CHARS = str866;
...
Str* GlobUnescape(Str* s) {
  ...
  while (i < n) {
    c = s->index_(i);
    if ((str_equals(c, str867) and i != (n - 1))) {
      i += 1;
      c2 = s->index_(i);
...
Str* _PromptEvaluatorCache::Get(Str* name) {
  ...
  if (str_equals(name, str894)) {
    value = this->_GetEuid() == 0 ? str895 : str896;
  }
  else {
        ...
        if (id_ == Id::PS_LBrace) {
          ...
          if (id_ == Id::PS_RBrace) {
            ...
            if (id_ == Id::PS_Subst) {
              ...
              if (str_equals(ch, str901)) {
                ...
                if (str_equals(ch, str903)) {
                  ...
                  if (str_equals(ch, str905)) {
                    hostname = this->cache->Get(str906);
                    Tuple2<Str*, Str*> tup1 = mylib::split_once(hostname, str907);
                    r = tup1.at0();
                  }
                  else {
                    if (str_equals(ch, str908)) {
                      r = this->cache->Get(str909);
                    }
                    else {
                      if (str_equals(ch, str910)) {
                        ...
                        if (str_equals(ch, str911)) {
                          ...
                          if (str_equals(ch, str912)) {
                            now = time_::time();
                            r = time_::strftime(str913, time_::localtime(now));
                          }
                          else {
                            if (str_equals(ch, str914)) {
                              ...
                              if (str_equals(ch, str916)) {
                                try {
                                  pwd = state::GetString(this->mem, str917);
                                  home = state::MaybeString(this->mem, str918);
                                  r = ui::PrettyDir(pwd, home);
                                }
                                catch (error::Runtime* e) {
                                  r = fmt250(e->UserErrorString());
                                }
                              }
                              else {
                                if (str_equals(ch, str920)) {
                                  val = this->mem->GetValue(str921);
                                  if (val->tag_() == value_e::Str) {
                                    value__Str* str_val = static_cast<value__Str*>(val);
              ...
              ret->append(r->replace(str924, str925));
            }
            else {
              throw Alloc<AssertionError>();
            }
...
Str* Evaluator::EvalPrompt(runtime_asdl::value_t* UP_val) {
  ...
  if (ps1_word == nullptr) {
    ...
    try {
      ...
      ps1_word = word_::ErrorWord(fmt252(e->UserErrorString()));
    }
...
Str* Evaluator::EvalFirstPrompt() {
  ...
  if (str_equals(this->lang, str930)) {
    val = this->mem->GetValue(str931);
    return this->EvalPrompt(val);
  }
  else {
    return str_concat(this->lang, str932);
  }
}
Str* PROMPT_COMMAND = str933;
    ...
    case lvalue_e::Indexed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          break;
        default: {
          e_die(fmt254(ui::ValType(val)));
        }
      }
      s = word_eval::GetArrayItem(array_val->strs, lval->index);
      if (s == nullptr) {
        val = Alloc<value::Str>(str936);
      }
      else {
        val = Alloc<value::Str>(s);
      }
    ...
    case lvalue_e::Keyed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::AssocArray: {
          ...
          break;
        default: {
          e_die(fmt255(ui::ValType(val)));
        }
      }
      s = assoc_val->d->get(lval->key);
      if (s == nullptr) {
        val = Alloc<value::Str>(str938);
      }
      else {
        val = Alloc<value::Str>(s);
      }
...
runtime_asdl::lvalue_t* UnsafeArith::ParseLValue(Str* s, int span_id) {
  ...
  {  // with
    alloc::ctx_Location ctx(this->arena, Alloc<source::ArgvWord>(str939, span_id));
...
int ArithEvaluator::_StringToInteger(Str* s, int span_id) {
  ...
  if (s->startswith(str943)) {
    try {
      integer = to_int(s, 16);
    }
    catch (ValueError*) {
      e_strict(fmt259(s), span_id);
    }
    return integer;
  }
  if (s->startswith(str945)) {
    try {
      integer = to_int(s, 8);
    }
    catch (ValueError*) {
      e_strict(fmt260(s), span_id);
    }
    return integer;
  }
  if (str_contains(s, str947)) {
    Tuple2<Str*, Str*> tup0 = mylib::split_once(s, str948);
    b = tup0.at0();
    digits = tup0.at1();
    try {
      base = to_int(b);
    ...
    for (StrIter it(digits); !it.Done(); it.Next()) {
      ...
      StackRoots _for({&ch    });
      if (IsLower(ch)) {
        digit = ((ord(ch) - ord(str950)) + 10);
      }
      else {
        if (IsUpper(ch)) {
          digit = ((ord(ch) - ord(str951)) + 36);
        }
        else {
          if (str_equals(ch, str952)) {
            ...
            if (str_equals(ch, str953)) {
              ...
              if (ch->isdigit()) {
                ...
                e_strict(fmt262(digits), span_id);
              }
            }
          }
        }
      ...
      if (digit >= base) {
        e_strict(fmt263(digits, base), span_id);
      }
    ...
    if ((this->exec_opts->eval_unsafe_arith() and this->parse_ctx)) {
      ...
      {  // with
        ...
        try {
          ...
          this->errfmt->PrettyPrintError(e);
          e_die(fmt264(), e->span_id);
        }
      }
      if (node2->tag_() == arith_expr_e::Word) {
        e_die(fmt265(s), span_id);
      }
      else {
      ...
      if ((len(s->strip()) == 0 or match::IsValidVarName(s))) {
        e_strict(fmt266(s), span_id);
      }
      else {
        e_die(fmt267(s), span_id);
      }
    }
  }
  return integer;
...
int ArithEvaluator::_ValToIntOrError(runtime_asdl::value_t* val, int span_id) {
  ...
  e_die(fmt269(ui::ValType(val)), span_id);
}
  ...
  if (((val->tag_() == value_e::MaybeStrArray || val->tag_() == value_e::AssocArray) and lval->tag_() == lvalue_e::Named)) {
    ...
    if (word_eval::ShouldArrayDecay(named_lval->name, this->exec_opts)) {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (val->tag_() == value_e::AssocArray) {
          lval = Alloc<lvalue::Keyed>(named_lval->name, str962);
        }
      }
        ...
        if (op_id == Id::Arith_Minus) {
          ...
          if (op_id == Id::Arith_Star) {
            ...
            if (op_id == Id::Arith_Slash) {
              if (rhs == 0) {
                e_die(fmt272(), location::SpanForArithExpr(node->right));
              }
              ret = (lhs / rhs);
            }
            else {
              if (op_id == Id::Arith_Percent) {
                if (rhs == 0) {
                  e_die(fmt273(), location::SpanForArithExpr(node->right));
                }
                ret = (lhs % rhs);
              }
              else {
  ...
  switch (node->tag_()) {
    ...
    case bool_expr_e::Unary: {
      ...
      if (arg_type == bool_arg_type_e::Other) {
        ...
        e_die(fmt275(ui::PrettyId(op_id)));
      }
      throw Alloc<AssertionError>();
    }
      break;
      ...
      if (arg_type == bool_arg_type_e::Str) {
        ...
        if (op_id == Id::BoolBinary_EqualTilde) {
          try {
            ...
            msg = e->message;
            e_die(fmt276(s2, msg, node->right), 2);
          }
          if (matches == nullptr) {
            return false;
          }
...
Str* SplitContext::GetJoinChar() {
  ...
  val = this->mem->GetValue(str978, scope_e::Dynamic);
  UP_val = val;
  switch (val->tag_()) {
    case value_e::Undef: {
      return str979;
...
_BaseSplitter::_BaseSplitter(Str* escape_chars) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(_BaseSplitter)) {
  this->escape_chars = str_concat(escape_chars, str982);
}
    ...
    if (i < n) {
      ...
      if (str_contains(ws_chars, c)) {
        ...
        if (str_contains(other_chars, c)) {
          ...
          if ((allow_escape and str_equals(c, str983))) {
...
Str* Utf8Encode(int code) {
  ...
  return str986->join(tmp);
}
Str* INCOMPLETE_CHAR = str987;
Str* INVALID_CONT = str988;
Str* INVALID_START = str989;
        ...
        if (tok->id == Id::VOp1_Comma) {
          ...
          if (tok->id == Id::VOp1_DComma) {
            if (!(str_equals(arg, str992))) {
              e_die(fmt278(ui::PrettyId(tok->id)), tok);
            }
            return s->lower();
          }
          else {
            if (tok->id == Id::VOp1_Caret) {
              if (!(str_equals(arg, str994))) {
                e_die(fmt279(ui::PrettyId(tok->id)), tok);
              }
              if (len(s)) {
              ...
              if (tok->id == Id::VOp1_DCaret) {
                if (!(str_equals(arg, str996))) {
                  e_die(fmt280(ui::PrettyId(tok->id)), tok);
                }
                return s->upper();
              }
              else {
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Slash) {
    try {
      ...
      msg = e->message;
      e_die(fmt282(regex, msg), this->slash_spid);
    }
  }
  if (op->replace_mode == Id::Lit_Pound) {
    regex = str_concat(str1002, regex);
  }
  else {
    if (op->replace_mode == Id::Lit_Percent) {
      regex = str_concat(regex, str1003);
    }
  }
...
Str* ShellQuoteB(Str* s) {
  ...
  s = s->replace(str1004, str1005)->replace(str1006, str1007);
  return pyutil::BackslashEscape(s, str1008);
}
...
void TdopParser::Eat(int token_type) {
  if (!this->AtToken(token_type)) {
    p_die(fmt286(ui::PrettyId(token_type), ui::PrettyId(this->op_id)), this->cur_word);
  }
  this->Next();
}
...
int QUOTE_ERE = (1 << 6);
GLOBAL_LIST(Str*, 3, _STRING_AND_ARRAY, {str1021 COMMA str1022 COMMA str1023});
...
runtime_asdl::value_t* DecayArray(runtime_asdl::value_t* val) {
  ...
  if (val->tag_() == value_e::MaybeStrArray) {
    ...
    if (val->tag_() == value_e::AssocArray) {
      value__AssocArray* assoc_val = static_cast<value__AssocArray*>(val);
      s = dict_contains(assoc_val->d, str1024) ? assoc_val->d->index_(str1025) : nullptr;
    }
    else {
      throw Alloc<AssertionError>();
    }
...
runtime_asdl::assign_arg* _SplitAssignArg(Str* arg, int word_spid) {
  ...
  if (m == nullptr) {
    e_die(fmt288(arg), word_spid);
  }
  var_name = m->index_(1);
  op = m->index_(3);
  if (len(op)) {
    val = Alloc<value::Str>(m->index_(4));
    append = str_equals(op->index_(0), str1028);
  }
  else {
    val = nullptr;
    append = false;
...
Str* _BackslashEscape(Str* s) {
  ...
  return s->replace(str1029, str1030);
}
...
runtime_asdl::part_value_t* _ValueToPartValue(runtime_asdl::value_t* val, bool quoted) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      return Alloc<part_value::String>(str1031, quoted, !quoted);
    }
      break;
    case value_e::Str: {
      value__Str* val = static_cast<value__Str*>(UP_val);
...
Str* TildeEvaluator::Eval(syntax_asdl::Token* token) {
  ...
  if (maybe_str_equals(token->val, str1043)) {
    val = this->mem->GetValue(str1044);
    UP_val = val;
    if (val->tag_() == value_e::Str) {
      value__Str* val = static_cast<value__Str*>(UP_val);
      return val->s;
      ...
      if ((tok->id == Id::VTest_ColonEquals || tok->id == Id::VTest_Equals)) {
        ...
        if ((tok->id == Id::VTest_ColonQMark || tok->id == Id::VTest_QMark)) {
          if (is_falsey) {
            ...
            e_die(fmt292(error_str), blame_token);
          }
          else {
            return false;
          }
    ...
    case value_e::Str: {
      ...
      try {
        ...
        if (this->exec_opts->strict_word_eval()) {
          ...
          this->errfmt->PrettyPrintError(e, str1048);
          return Alloc<value::Str>(str1049);
        }
      }
    }
      break;
...
runtime_asdl::value_t* AbstractWordEvaluator::_Slice(runtime_asdl::value_t* val, syntax_asdl::suffix_op__Slice* op, Str* var_name, syntax_asdl::braced_var_sub* part) {
  ...
  try {
    ...
    if (this->exec_opts->strict_word_eval()) {
      ...
      this->errfmt->PrettyPrintError(e, str1055);
      switch (val->tag_()) {
        case value_e::Str: {
          val = Alloc<value::Str>(str1056);
        }
          break;
        case value_e::MaybeStrArray: {
  ...
  if (op_id == Id::VOp0_P) {
    switch (val->tag_()) {
      case value_e::Str: {
        ...
        p = prompt->replace(str1057, str1058)->replace(str1059, str1060);
        result = Alloc<value::Str>(p);
      }
        break;
      default: {
        e_die(fmt295(ui::ValType(val)));
      }
    }
  }
  else {
    if (op_id == Id::VOp0_Q) {
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          result = Alloc<value::Str>(str1062->join(tmp));
        }
          break;
        default: {
          e_die(fmt296(ui::ValType(val)));
        }
      }
    }
    else {
      if (op_id == Id::VOp0_a) {
        ...
        result = Alloc<value::Str>(str1069->join(chars));
      }
      else {
        e_die(fmt297(op->val), op);
      }
    }
  }
...
runtime_asdl::value_t* AbstractWordEvaluator::_ArrayIndex(runtime_asdl::value_t* val, syntax_asdl::braced_var_sub* part, runtime_asdl::VTestPlace* vtest_place) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      ...
      break;
    case value_e::Str: {
      e_die(fmt300(part->token->val), part->token);
    }
      break;
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* array_val = static_cast<value__MaybeStrArray*>(UP_val);
...
void AbstractWordEvaluator::_EvalDoubleQuoted(List<syntax_asdl::word_part_t*>* parts, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  if (len(parts) == 0) {
    v = Alloc<part_value::String>(str1074, true, false);
    part_vals->append(v);
    return ;
  }
  for (ListIter<syntax_asdl::word_part_t*> it(parts); !it.Done(); it.Next()) {
...
runtime_asdl::value_t* AbstractWordEvaluator::_EmptyStrOrError(runtime_asdl::value_t* val, syntax_asdl::Token* token) {
  ...
  if (!this->exec_opts->nounset()) {
    return Alloc<value::Str>(str1075);
  }
  name = token->val->startswith(str1076) ? token->val->slice(1) : token->val;
  e_die(fmt301(name), token);
}
...
void AbstractWordEvaluator::_EvalExtGlob(syntax_asdl::word_part__ExtGlob* part, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  part_vals->append(Alloc<part_value::String>(str1088, false, false));
}
    ...
    case word_e::Compound: {
      ...
      if (has_extglob) {
        if (to_bool((eval_flags & EXTGLOB_FILES))) {
          ...
          glob_pat = str1094->join(glob_parts);
          fnmatch_pat = str1095->join(fnmatch_parts);
          results = Alloc<List<Str*>>();
          n = this->globber->ExpandExtended(glob_pat, fnmatch_pat, results);
          if (n < 0) {
            span_id = word_::LeftMostSpanForWord(w);
            throw Alloc<error::FailGlob>(fmt312(fnmatch_pat), span_id);
          }
      ...
      break;
    case word_e::Empty: {
      part_vals->append(Alloc<part_value::String>(str1098, quoted, !quoted));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, int eval_flags) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return Alloc<value::Str>(str1102);
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  part_vals = Alloc<List<runtime_asdl::part_value_t*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
  ...
  return Alloc<value::Str>(str1103->join(strs));
}
...
Tuple2<runtime_asdl::value__Str*, bool> AbstractWordEvaluator::EvalWordToPattern(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return (Tuple2<runtime_asdl::value__Str*, bool>(Alloc<value::Str>(str1104), false));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  has_extglob = false;
  part_vals = Alloc<List<runtime_asdl::part_value_t*>>();
  ...
  return (Tuple2<runtime_asdl::value__Str*, bool>(Alloc<value::Str>(str1105->join(strs)), has_extglob));
}
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalForPlugin(syntax_asdl::compound_word* w) {
  ...
  {  // with
    ...
    try {
      ...
      val = Alloc<value::Str>(fmt316(e->UserErrorString()));
    }
    catch (_OSError* e) {
      val = Alloc<value::Str>(fmt317(pyutil::strerror(e)));
    }
    catch (KeyboardInterrupt*) {
      val = Alloc<value::Str>(str1108);
    }
  }
  return val;
}
...
runtime_asdl::value_t* AbstractWordEvaluator::EvalRhsWord(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return Alloc<value::Str>(str1109);
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  if (len(w->parts) == 1) {
...
void AbstractWordEvaluator::_EvalWordFrame(List<Tuple3<Str*, bool, bool>*>* frame, List<Str*>* argv) {
  ...
  for (ListIter<Str*> it(args); !it.Done(); it.Next()) {
    ...
    if (glob_::LooksLikeGlob(a)) {
      ...
      if (n < 0) {
        throw Alloc<error::FailGlob>(fmt318(a), runtime::NO_SPID);
      }
    }
    else {
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index_(-2), str1116)) {
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        StackRoots _for({&arg      });
        if ((arg->startswith(str1117) or arg->startswith(str1118))) {
          flags->append(arg);
          flag_spids->append(word_spid);
          if ((str_contains(arg, str1119) or str_contains(arg, str1120))) {
            eval_to_pairs = false;
          }
        }
        else {
...
runtime_asdl::cmd_value_t* AbstractWordEvaluator::SimpleEvalWordSequence2(List<syntax_asdl::compound_word*>* words, bool allow_assign) {
  ...
  for (ListIter<syntax_asdl::compound_word*> it(words); !it.Done(); it.Next(), ++i) {
    ...
    if (glob_::LooksLikeStaticGlob(w)) {
      ...
      if (num_appended < 0) {
        throw Alloc<error::FailGlob>(fmt320(val->s), word_spid);
      }
...
runtime_asdl::part_value__String* CompletionWordEvaluator::_EvalProcessSub(syntax_asdl::command_sub* cs_part) {
  ...
  return Alloc<part_value::String>(str1124, true, false);
}
...
syntax_asdl::suffix_op__PatSub* WordParser::_ReadPatSubVarOp() {
  ...
  if (this->token_type == Id::Lit_Slash) {
    ...
    this->_Peek();
    if (this->token_type != Id::Right_DollarBrace) {
      p_die(fmt323(ui::PrettyId(this->token_type)), this->cur_token);
    }
          ...
          if (op_kind == Kind::VOp2) {
            if (this->token_type == Id::VOp2_Slash) {
              ...
              if (this->token_type == Id::VOp2_Colon) {
                ...
                p_die(fmt331(str1136), this->cur_token);
              }
            }
          }
          else {
            if (op_kind == Kind::VOp3) {
              if (allow_query) {
                ...
                p_die(fmt332(str1138), this->cur_token);
              }
            }
          }
        }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool is_oil_expr) {
  ...
  while (num_end_tokens < expected_end_tokens) {
    ...
    if ((this->token_kind == Kind::Lit || this->token_kind == Kind::Char)) {
      tok = this->cur_token;
      if ((no_backslashes and str_contains(tok->val, str1143))) {
        p_die(fmt337(), tok);
      }
      if (is_oil_expr) {
...
syntax_asdl::word_part_t* WordParser::_ReadUnquotedLeftParts(bool try_triple_quote, List<bool>* triple_out) {
  ...
  if ((this->token_type == Id::Left_SingleQuote || this->token_type == Id::Left_RSingleQuote || this->token_type == Id::Left_DollarSingleQuote)) {
    ...
    if ((try_triple_quote and len(sq_part->tokens) == 0)) {
      if (str_equals(this->lexer->ByteLookAhead(), str1150)) {
        this->_Next(lex_mode_e::ShCommand);
        this->_Peek();
  ...
  if ((left_id == Id::Left_DollarParen || left_id == Id::Left_AtParen || left_id == Id::Left_ProcSubIn || left_id == Id::Left_ProcSubOut)) {
    ...
    if ((left_id == Id::Left_Backtick and this->parse_ctx->one_pass_parse)) {
      ...
      if (left_id == Id::Left_Backtick) {
        ...
        right_spid = this->cur_token->span_id;
        code_str = str1158->join(parts);
        arena = this->parse_ctx->arena;
        line_reader = reader::StringLineReader(code_str, arena);
        c_parser = this->parse_ctx->MakeOshParser(line_reader);
        src = Alloc<source::Reparsed>(str1159, left_spid, right_spid);
        {  // with
          alloc::ctx_Location ctx(arena, src);
...
void WordParser::ParseProc(syntax_asdl::command__Proc* node) {
  ...
  if (this->token_type != Id::Lit_Chars) {
    p_die(fmt349(ui::PrettyToken(this->cur_token, this->arena)), this->cur_token);
  }
...
syntax_asdl::arith_expr_t* WordParser::_ReadArithExpr(int end_id) {
  ...
  if ((end_id != Id::Undefined_Tok and cur_id != end_id)) {
    p_die(fmt350(ui::PrettyId(cur_id), ui::PrettyId(end_id)), this->a_parser->cur_word);
  }
  return anode;
}
...
syntax_asdl::command__ForExpr* WordParser::ReadForExpression() {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt353(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
  if (cur_id == Id::Arith_Semi) {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt354(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
            ...
            if (this->token_type == Id::Lit_Dollar) {
              if (!this->parse_opts->parse_dollar()) {
                if ((num_parts == 0 and lex_mode == lex_mode_e::ShCommand)) {
                  ...
                  if (str_equals(next_byte, str1175)) {
                    println_stderr(fmt364(next_byte));
                  }
                }
...
Tuple2<syntax_asdl::word_t*, bool> WordParser::_ReadArithWord() {
  ...
  this->_Peek();
  if (this->token_kind == Kind::Unknown) {
    p_die(fmt369(this->cur_token->val), this->cur_token);
  }
  else {
    if (this->token_kind == Kind::Eof) {
          ...
          if ((this->token_kind == Kind::VSub || this->token_kind == Kind::Lit || this->token_kind == Kind::History || this->token_kind == Kind::Left || this->token_kind == Kind::KW || this->token_kind == Kind::ControlFlow || this->token_kind == Kind::BoolUnary || this->token_kind == Kind::BoolBinary || this->token_kind == Kind::ExtGlob)) {
            if (this->token_type == Id::Lit_Pound) {
              ...
              if (this->token_type == Id::Lit_TPound) {
                ...
                if ((this->parse_opts->parse_raw_string() and (this->token_type == Id::Lit_Chars and maybe_str_equals(this->cur_token->val, str1183)))) {
...
syntax_asdl::braced_var_sub* WordParser::ParseVarRef() {
  ...
  this->_Peek();
  if (this->token_kind != Kind::VSub) {
    p_die(fmt371(), this->cur_token);
  }
  part = this->_ParseVarOf();
  this->_Peek();
  if (this->token_type != Id::Eof_Real) {
    p_die(fmt372(), this->cur_token);
  }
  return part;
}
  ...
  switch (part->tag_()) {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str1191, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str1192->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str1195, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str1196->join(strs), quoted));
}
...
syntax_asdl::compound_word* TildeDetect(syntax_asdl::word_t* UP_w) {
  ...
  if ((id_ == Id::Lit_Chars and static_cast<Token*>(part1)->val->startswith(str1198))) {
    new_parts->extend(w->parts->slice(1));
    return Alloc<compound_word>(new_parts);
  }
  return nullptr;
...
void TildeDetectAssign(syntax_asdl::compound_word* w) {
  ...
  for (int i = 0; i < n; ++i) {
    ...
    if ((do_expand and LiteralId(cur) == Id::Lit_TildeLike)) {
      ...
      if (next_part) {
        is_tilde = (LiteralId(next_part) == Id::Lit_Colon or (LiteralId(next_part) == Id::Lit_Chars and static_cast<Token*>(next_part)->val->startswith(str1199)));
      }
      else {
        is_tilde = true;
      }
...
Str* join(Str* s1, Str* s2) {
  ...
  if ((s2->startswith(str1217) or len(s1) == 0)) {
    return s2;
  }
  if (s1->endswith(str1218)) {
...
Tuple2<Str*, Str*> _splitext(Str* p, Str* sep, Str* extsep) {
  ...
  return (Tuple2<Str*, Str*>(p, str1221));
}
...
Str* normpath(Str* path) {
  ...
  slash = str1224;
  dot = str1225;
  if (str_equals(path, str1226)) {
    return dot;
  }
  initial_slashes = path->startswith(str1227);
  if ((initial_slashes and (path->startswith(str1228) and !path->startswith(str1229)))) {
    initial_slashes = 2;
  }
  comps = path->split(str1230);
  new_comps = Alloc<List<Str*>>();
  for (ListIter<Str*> it(comps); !it.Done(); it.Next()) {
    Str* comp = it.Value();
    StackRoots _for({&comp  });
    if ((len(comp) == 0 or str_equals(comp, str1231))) {
      continue;
    }
    if ((!(str_equals(comp, str1232)) or ((initial_slashes == 0 and len(new_comps) == 0) or (len(new_comps) and str_equals(new_comps->index_(-1), str1233))))) {
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if ((str_contains(str1240, ch) or IsUnprintableLow(ch))) {
        quote = 2;
        break;
      }
    }
  ...
  return str_concat(prefix, str1244->join(parts));
}
          ...
          if (str_equals(byte, str1257)) {
            ...
            if (str_equals(byte, str1259)) {
              ...
              if (str_equals(byte, str1261)) {
                part = shell_compat ? str1262 : str1263;
              }
              else {
            ...
            if (str_equals(byte, str1273)) {
              ...
              if (str_equals(byte, str1275)) {
                ...
                if (str_equals(byte, str1277)) {
                  out = shell_compat ? str1278 : str1279;
                }
                else {
                  if (IsUnprintableLow(byte)) {
...
syntax_asdl::word__String* _StringWordEmitter::ReadWord(types_asdl::lex_mode_t unused_lex_mode) {
  ...
  if (this->i == this->n) {
    w = Alloc<word::String>(Id::Eof_Real, str1280, runtime::NO_SPID);
    return w;
  }
    ...
    if (maybe_str_equals(s0, str1283)) {
      ...
      if (maybe_str_equals(s0, str1284)) {
        ...
        if (maybe_str_equals(s0, str1285)) {
          ...
          if (maybe_str_equals(s0, str1286)) {
...
syntax_asdl::bool_expr_t* _ThreeArgs(builtin_bracket::_StringWordEmitter* w_parser) {
  ...
  if (maybe_str_equals(w1->s, str1289)) {
    return Alloc<bool_expr::LogicalOr>(Alloc<bool_expr::WordTest>(w0), Alloc<bool_expr::WordTest>(w2));
  }
  if (maybe_str_equals(w0->s, str1290)) {
    w_parser->Rewind(2);
    child = _TwoArgs(w_parser);
    return Alloc<bool_expr::LogicalNot>(child);
  }
  if ((maybe_str_equals(w0->s, str1291) and maybe_str_equals(w2->s, str1292))) {
    return Alloc<bool_expr::WordTest>(w1);
  }
  p_die(fmt379(w1->s), w1);
}
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    ...
    strs = cmd_val->argv;
    if ((!strs or !(str_equals(strs->index_(-1), str1295)))) {
      this->errfmt->Print_(str1296, cmd_val->arg_spids->index_(0));
      return 2;
    }
    cmd_val->argv->pop();
  ...
  try {
    ...
    if (n == 4) {
      a0 = w_parser->Peek(0);
      if (str_equals(a0, str1298)) {
        w_parser->Read();
        child = _ThreeArgs(w_parser);
        bool_node = Alloc<bool_expr::LogicalNot>(child);
      }
      else {
        if ((str_equals(a0, str1299) and str_equals(w_parser->Peek(3), str1300))) {
          w_parser->Read();
          bool_node = _TwoArgs(w_parser);
        }
        else {
  ...
  try {
    ...
    this->errfmt->PrettyPrintError(e, str1302);
    return 2;
  }
  status = b ? 0 : 1;
  return status;

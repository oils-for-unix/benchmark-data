...
GLOBAL_STR(gVersion, "0.29.0");

GLOBAL_LIST(STRICT_ALL, int, 10, {37 COMMA 38 COMMA 39 COMMA 40 COMMA 41 COMMA 45 COMMA 42 COMMA 36 COMMA 44 COMMA 43});
GLOBAL_LIST(YSH_UPGRADE, int, 25, {57 COMMA 56 COMMA 62 COMMA 1 COMMA 64 COMMA 4 COMMA 63 COMMA 2 COMMA 5 COMMA 46 COMMA 49 COMMA 50 COMMA 51 COMMA 48 COMMA 52 COMMA 47 COMMA 54 COMMA 53 COMMA 3 COMMA 58 COMMA 61 COMMA 55 COMMA 6 COMMA 60 COMMA 59});
GLOBAL_LIST(YSH_ALL, int, 50, {57 COMMA 56 COMMA 62 COMMA 1 COMMA 79 COMMA 64 COMMA 4 COMMA 63 COMMA 74 COMMA 75 COMMA 2 COMMA 5 COMMA 46 COMMA 65 COMMA 66 COMMA 67 COMMA 73 COMMA 49 COMMA 50 COMMA 72 COMMA 68 COMMA 71 COMMA 51 COMMA 48 COMMA 69 COMMA 52 COMMA 47 COMMA 70 COMMA 54 COMMA 53 COMMA 3 COMMA 58 COMMA 61 COMMA 76 COMMA 77 COMMA 78 COMMA 55 COMMA 37 COMMA 38 COMMA 39 COMMA 40 COMMA 41 COMMA 45 COMMA 42 COMMA 36 COMMA 44 COMMA 43 COMMA 6 COMMA 60 COMMA 59});
GLOBAL_LIST(DEFAULT_TRUE, int, 16, {27 COMMA 28 COMMA 56 COMMA 29 COMMA 79 COMMA 17 COMMA 18 COMMA 66 COMMA 67 COMMA 73 COMMA 72 COMMA 68 COMMA 71 COMMA 69 COMMA 70 COMMA 60});
GLOBAL_LIST(PARSE_OPTION_NUMS, int, 20, {79 COMMA 46 COMMA 65 COMMA 66 COMMA 67 COMMA 73 COMMA 49 COMMA 50 COMMA 72 COMMA 68 COMMA 71 COMMA 51 COMMA 48 COMMA 69 COMMA 52 COMMA 47 COMMA 70 COMMA 54 COMMA 53 COMMA 36});
GLOBAL_LIST(SHOPT_OPTION_NUMS, int, 102, {27 COMMA 28 COMMA 34 COMMA 35 COMMA 33 COMMA 32 COMMA 84 COMMA 85 COMMA 86 COMMA 87 COMMA 88 COMMA 89 COMMA 90 COMMA 83 COMMA 57 COMMA 91 COMMA 56 COMMA 92 COMMA 93 COMMA 22 COMMA 29 COMMA 62 COMMA 24 COMMA 94 COMMA 79 COMMA 23 COMMA 20 COMMA 95 COMMA 19 COMMA 64 COMMA 96 COMMA 97 COMMA 98 COMMA 99 COMMA 81 COMMA 100 COMMA 101 COMMA 82 COMMA 102 COMMA 25 COMMA 26 COMMA 4 COMMA 63 COMMA 103 COMMA 18 COMMA 104 COMMA 105 COMMA 106 COMMA 107 COMMA 108 COMMA 109 COMMA 74 COMMA 75 COMMA 110 COMMA 21 COMMA 5 COMMA 46 COMMA 65 COMMA 66 COMMA 67 COMMA 73 COMMA 49 COMMA 50 COMMA 72 COMMA 68 COMMA 71 COMMA 51 COMMA 48 COMMA 69 COMMA 52 COMMA 47 COMMA 70 COMMA 54 COMMA 53 COMMA 58 COMMA 80 COMMA 111 COMMA 112 COMMA 30 COMMA 31 COMMA 113 COMMA 114 COMMA 61 COMMA 76 COMMA 77 COMMA 78 COMMA 55 COMMA 115 COMMA 37 COMMA 38 COMMA 39 COMMA 40 COMMA 41 COMMA 45 COMMA 42 COMMA 36 COMMA 44 COMMA 43 COMMA 6 COMMA 116 COMMA 60 COMMA 59});
...
GLOBAL_LIST(VISIBLE_SHOPT_NUMS, int, 65, {27 COMMA 28 COMMA 34 COMMA 35 COMMA 33 COMMA 32 COMMA 57 COMMA 56 COMMA 22 COMMA 29 COMMA 62 COMMA 24 COMMA 79 COMMA 23 COMMA 20 COMMA 19 COMMA 64 COMMA 25 COMMA 26 COMMA 4 COMMA 63 COMMA 18 COMMA 74 COMMA 75 COMMA 21 COMMA 5 COMMA 46 COMMA 65 COMMA 66 COMMA 67 COMMA 73 COMMA 49 COMMA 50 COMMA 72 COMMA 68 COMMA 71 COMMA 51 COMMA 48 COMMA 69 COMMA 52 COMMA 47 COMMA 70 COMMA 54 COMMA 53 COMMA 58 COMMA 30 COMMA 31 COMMA 61 COMMA 76 COMMA 77 COMMA 78 COMMA 55 COMMA 37 COMMA 38 COMMA 39 COMMA 40 COMMA 41 COMMA 45 COMMA 42 COMMA 36 COMMA 44 COMMA 43 COMMA 6 COMMA 60 COMMA 59});
...
option_asdl::option_t OptionNum(BigStr* s) {
  ...
  case 'e':
    ...
    if (length == 14 && memcmp("expand_aliases", data, 14) == 0) return 79;
    break;
  case 'f':
    if (length == 8 && memcmp("failglob", data, 8) == 0) return 19;
    if (length == 15 && memcmp("for_loop_frames", data, 15) == 0) return 64;
    break;
  case 'h':
  ...
  case 'i':
    ...
    if (length == 16 && memcmp("init_ysh_globals", data, 16) == 0) return 63;
    break;
  case 'l':
  ...
  case 'n':
    ...
    if (length == 11 && memcmp("no_exported", data, 11) == 0) return 74;
    if (length == 15 && memcmp("no_init_globals", data, 15) == 0) return 75;
    break;
  case 'p':
    ...
    if (length == 12 && memcmp("parse_at_all", data, 12) == 0) return 65;
    if (length == 15 && memcmp("parse_backslash", data, 15) == 0) return 66;
    if (length == 15 && memcmp("parse_backticks", data, 15) == 0) return 67;
    if (length == 12 && memcmp("parse_dollar", data, 12) == 0) return 68;
    if (length == 13 && memcmp("parse_ignored", data, 13) == 0) return 69;
    if (length == 14 && memcmp("parse_sh_arith", data, 14) == 0) return 70;
    if (length == 12 && memcmp("parse_dparen", data, 12) == 0) return 71;
    if (length == 14 && memcmp("parse_dbracket", data, 14) == 0) return 72;
    if (length == 15 && memcmp("parse_bare_word", data, 15) == 0) return 73;
    break;
  case 'r':
  ...
  case 's':
    ...
    if (length == 11 && memcmp("simple_echo", data, 11) == 0) return 76;
    if (length == 19 && memcmp("simple_eval_builtin", data, 19) == 0) return 77;
    if (length == 19 && memcmp("simple_test_builtin", data, 19) == 0) return 78;
    break;
  case 'v':
...
option_asdl::option_t UnimplOptionNum(BigStr* s) {
  ...
  switch (data[0]) {
  case 'a':
    if (length == 17 && memcmp("assoc_expand_once", data, 17) == 0) return 84;
    if (length == 6 && memcmp("autocd", data, 6) == 0) return 85;
    break;
  case 'c':
    if (length == 7 && memcmp("cmdhist", data, 7) == 0) return 83;
    if (length == 11 && memcmp("cdable_vars", data, 11) == 0) return 86;
    if (length == 7 && memcmp("cdspell", data, 7) == 0) return 87;
    if (length == 9 && memcmp("checkhash", data, 9) == 0) return 88;
    if (length == 9 && memcmp("checkjobs", data, 9) == 0) return 89;
    if (length == 12 && memcmp("checkwinsize", data, 12) == 0) return 90;
    if (length == 18 && memcmp("complete_fullquote", data, 18) == 0) return 91;
    break;
  case 'd':
    if (length == 9 && memcmp("direxpand", data, 9) == 0) return 92;
    if (length == 8 && memcmp("dirspell", data, 8) == 0) return 93;
    break;
  case 'e':
    if (length == 8 && memcmp("execfail", data, 8) == 0) return 94;
    if (length == 8 && memcmp("extquote", data, 8) == 0) return 95;
    break;
  case 'f':
    if (length == 13 && memcmp("force_fignore", data, 13) == 0) return 96;
    break;
  case 'g':
    if (length == 15 && memcmp("globasciiranges", data, 15) == 0) return 97;
    if (length == 8 && memcmp("globstar", data, 8) == 0) return 98;
    if (length == 10 && memcmp("gnu_errfmt", data, 10) == 0) return 99;
    break;
  case 'h':
    if (length == 10 && memcmp("histappend", data, 10) == 0) return 81;
    if (length == 12 && memcmp("hostcomplete", data, 12) == 0) return 82;
    if (length == 10 && memcmp("histreedit", data, 10) == 0) return 100;
    if (length == 10 && memcmp("histverify", data, 10) == 0) return 101;
    if (length == 9 && memcmp("huponexit", data, 9) == 0) return 102;
    break;
  case 'i':
    if (length == 20 && memcmp("interactive_comments", data, 20) == 0) return 103;
    break;
  case 'l':
    if (length == 7 && memcmp("lithist", data, 7) == 0) return 104;
    if (length == 16 && memcmp("localvar_inherit", data, 16) == 0) return 105;
    if (length == 14 && memcmp("localvar_unset", data, 14) == 0) return 106;
    if (length == 11 && memcmp("login_shell", data, 11) == 0) return 107;
    break;
  case 'm':
    if (length == 8 && memcmp("mailwarn", data, 8) == 0) return 108;
    break;
  case 'n':
    if (length == 23 && memcmp("no_empty_cmd_completion", data, 23) == 0) return 109;
    if (length == 10 && memcmp("nocaseglob", data, 10) == 0) return 110;
    break;
  case 'p':
    if (length == 8 && memcmp("progcomp", data, 8) == 0) return 80;
    if (length == 14 && memcmp("progcomp_alias", data, 14) == 0) return 111;
    if (length == 10 && memcmp("promptvars", data, 10) == 0) return 112;
    break;
  case 'r':
    if (length == 16 && memcmp("restricted_shell", data, 16) == 0) return 113;
    break;
  case 's':
    if (length == 13 && memcmp("shift_verbose", data, 13) == 0) return 114;
    if (length == 10 && memcmp("sourcepath", data, 10) == 0) return 115;
    break;
  case 'x':
    if (length == 8 && memcmp("xpg_echo", data, 8) == 0) return 116;
    break;
  }
...
GLOBAL_STR(kOptionName_63, "init_ysh_globals");
GLOBAL_STR(kOptionName_64, "for_loop_frames");
GLOBAL_STR(kOptionName_65, "parse_at_all");
GLOBAL_STR(kOptionName_66, "parse_backslash");
GLOBAL_STR(kOptionName_67, "parse_backticks");
GLOBAL_STR(kOptionName_68, "parse_dollar");
GLOBAL_STR(kOptionName_69, "parse_ignored");
GLOBAL_STR(kOptionName_70, "parse_sh_arith");
GLOBAL_STR(kOptionName_71, "parse_dparen");
GLOBAL_STR(kOptionName_72, "parse_dbracket");
GLOBAL_STR(kOptionName_73, "parse_bare_word");
GLOBAL_STR(kOptionName_74, "no_exported");
GLOBAL_STR(kOptionName_75, "no_init_globals");
GLOBAL_STR(kOptionName_76, "simple_echo");
GLOBAL_STR(kOptionName_77, "simple_eval_builtin");
GLOBAL_STR(kOptionName_78, "simple_test_builtin");
GLOBAL_STR(kOptionName_79, "expand_aliases");
GLOBAL_STR(kOptionName_80, "progcomp");
GLOBAL_STR(kOptionName_81, "histappend");
GLOBAL_STR(kOptionName_82, "hostcomplete");
GLOBAL_STR(kOptionName_83, "cmdhist");
GLOBAL_STR(kOptionName_84, "assoc_expand_once");
GLOBAL_STR(kOptionName_85, "autocd");
GLOBAL_STR(kOptionName_86, "cdable_vars");
GLOBAL_STR(kOptionName_87, "cdspell");
GLOBAL_STR(kOptionName_88, "checkhash");
GLOBAL_STR(kOptionName_89, "checkjobs");
GLOBAL_STR(kOptionName_90, "checkwinsize");
GLOBAL_STR(kOptionName_91, "complete_fullquote");
GLOBAL_STR(kOptionName_92, "direxpand");
GLOBAL_STR(kOptionName_93, "dirspell");
GLOBAL_STR(kOptionName_94, "execfail");
GLOBAL_STR(kOptionName_95, "extquote");
GLOBAL_STR(kOptionName_96, "force_fignore");
GLOBAL_STR(kOptionName_97, "globasciiranges");
GLOBAL_STR(kOptionName_98, "globstar");
GLOBAL_STR(kOptionName_99, "gnu_errfmt");
GLOBAL_STR(kOptionName_100, "histreedit");
GLOBAL_STR(kOptionName_101, "histverify");
GLOBAL_STR(kOptionName_102, "huponexit");
GLOBAL_STR(kOptionName_103, "interactive_comments");
GLOBAL_STR(kOptionName_104, "lithist");
GLOBAL_STR(kOptionName_105, "localvar_inherit");
GLOBAL_STR(kOptionName_106, "localvar_unset");
GLOBAL_STR(kOptionName_107, "login_shell");
GLOBAL_STR(kOptionName_108, "mailwarn");
GLOBAL_STR(kOptionName_109, "no_empty_cmd_completion");
GLOBAL_STR(kOptionName_110, "nocaseglob");
GLOBAL_STR(kOptionName_111, "progcomp_alias");
GLOBAL_STR(kOptionName_112, "promptvars");
GLOBAL_STR(kOptionName_113, "restricted_shell");
GLOBAL_STR(kOptionName_114, "shift_verbose");
GLOBAL_STR(kOptionName_115, "sourcepath");
GLOBAL_STR(kOptionName_116, "xpg_echo");

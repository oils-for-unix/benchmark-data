...
GLOBAL_STR(gVersion, "0.24.0");

GLOBAL_LIST(STRICT_ALL, int, 10, {35 COMMA 36 COMMA 37 COMMA 38 COMMA 39 COMMA 43 COMMA 40 COMMA 34 COMMA 42 COMMA 41});
GLOBAL_LIST(YSH_UPGRADE, int, 23, {55 COMMA 54 COMMA 60 COMMA 1 COMMA 4 COMMA 2 COMMA 5 COMMA 44 COMMA 47 COMMA 48 COMMA 49 COMMA 46 COMMA 50 COMMA 45 COMMA 52 COMMA 51 COMMA 3 COMMA 56 COMMA 59 COMMA 53 COMMA 6 COMMA 58 COMMA 57});
GLOBAL_LIST(YSH_ALL, int, 48, {55 COMMA 54 COMMA 60 COMMA 1 COMMA 75 COMMA 4 COMMA 70 COMMA 71 COMMA 2 COMMA 5 COMMA 44 COMMA 61 COMMA 62 COMMA 63 COMMA 69 COMMA 47 COMMA 48 COMMA 68 COMMA 64 COMMA 67 COMMA 49 COMMA 46 COMMA 65 COMMA 50 COMMA 45 COMMA 66 COMMA 52 COMMA 51 COMMA 3 COMMA 56 COMMA 59 COMMA 72 COMMA 73 COMMA 74 COMMA 53 COMMA 35 COMMA 36 COMMA 37 COMMA 38 COMMA 39 COMMA 43 COMMA 40 COMMA 34 COMMA 42 COMMA 41 COMMA 6 COMMA 58 COMMA 57});
GLOBAL_LIST(DEFAULT_TRUE, int, 16, {25 COMMA 26 COMMA 54 COMMA 27 COMMA 75 COMMA 17 COMMA 18 COMMA 62 COMMA 63 COMMA 69 COMMA 68 COMMA 64 COMMA 67 COMMA 65 COMMA 66 COMMA 58});
GLOBAL_LIST(PARSE_OPTION_NUMS, int, 20, {75 COMMA 44 COMMA 61 COMMA 62 COMMA 63 COMMA 69 COMMA 47 COMMA 48 COMMA 68 COMMA 64 COMMA 67 COMMA 49 COMMA 46 COMMA 65 COMMA 50 COMMA 45 COMMA 66 COMMA 52 COMMA 51 COMMA 34});
GLOBAL_LIST(SHOPT_OPTION_NUMS, int, 100, {25 COMMA 26 COMMA 32 COMMA 33 COMMA 31 COMMA 30 COMMA 80 COMMA 81 COMMA 82 COMMA 83 COMMA 84 COMMA 85 COMMA 86 COMMA 79 COMMA 55 COMMA 87 COMMA 54 COMMA 88 COMMA 89 COMMA 90 COMMA 27 COMMA 60 COMMA 22 COMMA 91 COMMA 75 COMMA 92 COMMA 20 COMMA 93 COMMA 19 COMMA 94 COMMA 95 COMMA 96 COMMA 97 COMMA 77 COMMA 98 COMMA 99 COMMA 78 COMMA 100 COMMA 23 COMMA 24 COMMA 4 COMMA 101 COMMA 18 COMMA 102 COMMA 103 COMMA 104 COMMA 105 COMMA 106 COMMA 107 COMMA 70 COMMA 71 COMMA 108 COMMA 21 COMMA 5 COMMA 44 COMMA 61 COMMA 62 COMMA 63 COMMA 69 COMMA 47 COMMA 48 COMMA 68 COMMA 64 COMMA 67 COMMA 49 COMMA 46 COMMA 65 COMMA 50 COMMA 45 COMMA 66 COMMA 52 COMMA 51 COMMA 56 COMMA 76 COMMA 109 COMMA 110 COMMA 28 COMMA 29 COMMA 111 COMMA 112 COMMA 59 COMMA 72 COMMA 73 COMMA 74 COMMA 53 COMMA 113 COMMA 35 COMMA 36 COMMA 37 COMMA 38 COMMA 39 COMMA 43 COMMA 40 COMMA 34 COMMA 42 COMMA 41 COMMA 6 COMMA 114 COMMA 58 COMMA 57});
...
option_asdl::option_t OptionNum(BigStr* s) {
  ...
  case '_':
    ...
    if (length == 13 && memcmp("_running_trap", data, 13) == 0) return 30;
    if (length == 12 && memcmp("_running_hay", data, 12) == 0) return 31;
    if (length == 14 && memcmp("_no_debug_trap", data, 14) == 0) return 32;
    if (length == 12 && memcmp("_no_err_trap", data, 12) == 0) return 33;
    break;
  case 'c':
    if (length == 19 && memcmp("command_sub_errexit", data, 19) == 0) return 55;
    break;
  case 'd':
    if (length == 13 && memcmp("dynamic_scope", data, 13) == 0) return 27;
    if (length == 8 && memcmp("dashglob", data, 8) == 0) return 54;
    break;
  case 'e':
    ...
    if (length == 7 && memcmp("env_obj", data, 7) == 0) return 60;
    if (length == 14 && memcmp("expand_aliases", data, 14) == 0) return 75;
    break;
  case 'f':
  ...
  case 'i':
    ...
    if (length == 21 && memcmp("ignore_shopt_not_impl", data, 21) == 0) return 24;
    break;
  case 'l':
  ...
  case 'n':
    ...
    if (length == 11 && memcmp("no_exported", data, 11) == 0) return 70;
    if (length == 15 && memcmp("no_init_globals", data, 15) == 0) return 71;
    break;
  case 'p':
    if (length == 8 && memcmp("pipefail", data, 8) == 0) return 3;
    if (length == 5 && memcmp("posix", data, 5) == 0) return 13;
    if (length == 8 && memcmp("parse_at", data, 8) == 0) return 44;
    if (length == 10 && memcmp("parse_proc", data, 10) == 0) return 45;
    if (length == 10 && memcmp("parse_func", data, 10) == 0) return 46;
    if (length == 11 && memcmp("parse_brace", data, 11) == 0) return 47;
    if (length == 13 && memcmp("parse_bracket", data, 13) == 0) return 48;
    if (length == 12 && memcmp("parse_equals", data, 12) == 0) return 49;
    if (length == 11 && memcmp("parse_paren", data, 11) == 0) return 50;
    if (length == 16 && memcmp("parse_ysh_string", data, 16) == 0) return 51;
    if (length == 18 && memcmp("parse_triple_quote", data, 18) == 0) return 52;
    if (length == 16 && memcmp("process_sub_fail", data, 16) == 0) return 56;
    if (length == 12 && memcmp("parse_at_all", data, 12) == 0) return 61;
    if (length == 15 && memcmp("parse_backslash", data, 15) == 0) return 62;
    if (length == 15 && memcmp("parse_backticks", data, 15) == 0) return 63;
    if (length == 12 && memcmp("parse_dollar", data, 12) == 0) return 64;
    if (length == 13 && memcmp("parse_ignored", data, 13) == 0) return 65;
    if (length == 14 && memcmp("parse_sh_arith", data, 14) == 0) return 66;
    if (length == 12 && memcmp("parse_dparen", data, 12) == 0) return 67;
    if (length == 14 && memcmp("parse_dbracket", data, 14) == 0) return 68;
    if (length == 15 && memcmp("parse_bare_word", data, 15) == 0) return 69;
    break;
  case 'r':
    if (length == 14 && memcmp("redefine_const", data, 14) == 0) return 28;
    if (length == 15 && memcmp("redefine_source", data, 15) == 0) return 29;
    break;
  case 's':
    if (length == 18 && memcmp("strict_parse_slice", data, 18) == 0) return 34;
    if (length == 11 && memcmp("strict_argv", data, 11) == 0) return 35;
    if (length == 12 && memcmp("strict_arith", data, 12) == 0) return 36;
    if (length == 12 && memcmp("strict_array", data, 12) == 0) return 37;
    if (length == 19 && memcmp("strict_control_flow", data, 19) == 0) return 38;
    if (length == 14 && memcmp("strict_errexit", data, 14) == 0) return 39;
    if (length == 14 && memcmp("strict_nameref", data, 14) == 0) return 40;
    if (length == 16 && memcmp("strict_word_eval", data, 16) == 0) return 41;
    if (length == 12 && memcmp("strict_tilde", data, 12) == 0) return 42;
    if (length == 11 && memcmp("strict_glob", data, 11) == 0) return 43;
    if (length == 16 && memcmp("simple_word_eval", data, 16) == 0) return 53;
    if (length == 17 && memcmp("sigpipe_status_ok", data, 17) == 0) return 59;
    if (length == 11 && memcmp("simple_echo", data, 11) == 0) return 72;
    if (length == 19 && memcmp("simple_eval_builtin", data, 19) == 0) return 73;
    if (length == 19 && memcmp("simple_test_builtin", data, 19) == 0) return 74;
    break;
  case 'v':
  ...
  case 'x':
    ...
    if (length == 11 && memcmp("xtrace_rich", data, 11) == 0) return 57;
    if (length == 14 && memcmp("xtrace_details", data, 14) == 0) return 58;
    break;
  }
...
option_asdl::option_t UnimplOptionNum(BigStr* s) {
  ...
  switch (data[0]) {
  case 'a':
    if (length == 17 && memcmp("assoc_expand_once", data, 17) == 0) return 80;
    if (length == 6 && memcmp("autocd", data, 6) == 0) return 81;
    break;
  case 'c':
    if (length == 7 && memcmp("cmdhist", data, 7) == 0) return 79;
    if (length == 11 && memcmp("cdable_vars", data, 11) == 0) return 82;
    if (length == 7 && memcmp("cdspell", data, 7) == 0) return 83;
    if (length == 9 && memcmp("checkhash", data, 9) == 0) return 84;
    if (length == 9 && memcmp("checkjobs", data, 9) == 0) return 85;
    if (length == 12 && memcmp("checkwinsize", data, 12) == 0) return 86;
    if (length == 18 && memcmp("complete_fullquote", data, 18) == 0) return 87;
    break;
  case 'd':
    if (length == 9 && memcmp("direxpand", data, 9) == 0) return 88;
    if (length == 8 && memcmp("dirspell", data, 8) == 0) return 89;
    if (length == 7 && memcmp("dotglob", data, 7) == 0) return 90;
    break;
  case 'e':
  ...
  case 'g':
    ...
    break;
  case 'h':
    if (length == 10 && memcmp("histappend", data, 10) == 0) return 77;
    if (length == 12 && memcmp("hostcomplete", data, 12) == 0) return 78;
  ...
  case 'n':
    ...
    break;
  case 'p':
    if (length == 8 && memcmp("progcomp", data, 8) == 0) return 76;
...
GLOBAL_STR(kOptionName_24, "ignore_shopt_not_impl");
...
GLOBAL_STR(kOptionName_28, "redefine_const");
GLOBAL_STR(kOptionName_29, "redefine_source");
GLOBAL_STR(kOptionName_30, "_running_trap");
GLOBAL_STR(kOptionName_31, "_running_hay");
GLOBAL_STR(kOptionName_32, "_no_debug_trap");
GLOBAL_STR(kOptionName_33, "_no_err_trap");
GLOBAL_STR(kOptionName_34, "strict_parse_slice");
GLOBAL_STR(kOptionName_35, "strict_argv");
GLOBAL_STR(kOptionName_36, "strict_arith");
GLOBAL_STR(kOptionName_37, "strict_array");
GLOBAL_STR(kOptionName_38, "strict_control_flow");
GLOBAL_STR(kOptionName_39, "strict_errexit");
GLOBAL_STR(kOptionName_40, "strict_nameref");
GLOBAL_STR(kOptionName_41, "strict_word_eval");
GLOBAL_STR(kOptionName_42, "strict_tilde");
GLOBAL_STR(kOptionName_43, "strict_glob");
GLOBAL_STR(kOptionName_44, "parse_at");
GLOBAL_STR(kOptionName_45, "parse_proc");
GLOBAL_STR(kOptionName_46, "parse_func");
GLOBAL_STR(kOptionName_47, "parse_brace");
GLOBAL_STR(kOptionName_48, "parse_bracket");
GLOBAL_STR(kOptionName_49, "parse_equals");
GLOBAL_STR(kOptionName_50, "parse_paren");
GLOBAL_STR(kOptionName_51, "parse_ysh_string");
GLOBAL_STR(kOptionName_52, "parse_triple_quote");
GLOBAL_STR(kOptionName_53, "simple_word_eval");
GLOBAL_STR(kOptionName_54, "dashglob");
GLOBAL_STR(kOptionName_55, "command_sub_errexit");
GLOBAL_STR(kOptionName_56, "process_sub_fail");
GLOBAL_STR(kOptionName_57, "xtrace_rich");
GLOBAL_STR(kOptionName_58, "xtrace_details");
GLOBAL_STR(kOptionName_59, "sigpipe_status_ok");
GLOBAL_STR(kOptionName_60, "env_obj");
GLOBAL_STR(kOptionName_61, "parse_at_all");
GLOBAL_STR(kOptionName_62, "parse_backslash");
GLOBAL_STR(kOptionName_63, "parse_backticks");
GLOBAL_STR(kOptionName_64, "parse_dollar");
GLOBAL_STR(kOptionName_65, "parse_ignored");
GLOBAL_STR(kOptionName_66, "parse_sh_arith");
GLOBAL_STR(kOptionName_67, "parse_dparen");
GLOBAL_STR(kOptionName_68, "parse_dbracket");
GLOBAL_STR(kOptionName_69, "parse_bare_word");
GLOBAL_STR(kOptionName_70, "no_exported");
GLOBAL_STR(kOptionName_71, "no_init_globals");
GLOBAL_STR(kOptionName_72, "simple_echo");
GLOBAL_STR(kOptionName_73, "simple_eval_builtin");
GLOBAL_STR(kOptionName_74, "simple_test_builtin");
GLOBAL_STR(kOptionName_75, "expand_aliases");
GLOBAL_STR(kOptionName_76, "progcomp");
GLOBAL_STR(kOptionName_77, "histappend");
GLOBAL_STR(kOptionName_78, "hostcomplete");
GLOBAL_STR(kOptionName_79, "cmdhist");
GLOBAL_STR(kOptionName_80, "assoc_expand_once");
GLOBAL_STR(kOptionName_81, "autocd");
GLOBAL_STR(kOptionName_82, "cdable_vars");
GLOBAL_STR(kOptionName_83, "cdspell");
GLOBAL_STR(kOptionName_84, "checkhash");
GLOBAL_STR(kOptionName_85, "checkjobs");
GLOBAL_STR(kOptionName_86, "checkwinsize");
GLOBAL_STR(kOptionName_87, "complete_fullquote");
GLOBAL_STR(kOptionName_88, "direxpand");
GLOBAL_STR(kOptionName_89, "dirspell");
GLOBAL_STR(kOptionName_90, "dotglob");

...
GLOBAL_STR(str280, "OIL_VERSION");
GLOBAL_STR(str281, "PWD");
GLOBAL_STR(str282, "PS1");
GLOBAL_STR(str283, "PS1");
GLOBAL_STR(str284, "\\s-\\v\\$ ");
GLOBAL_STR(str285, "");
GLOBAL_STR(str286, "<Mem");
GLOBAL_STR(str287, "  -- %d --");
GLOBAL_STR(str288, "  %s %s");
GLOBAL_STR(str289, ">");
GLOBAL_STR(str290, "\n");
GLOBAL_STR(str291, "\n");
GLOBAL_STR(str292, "Warning: span_id undefined in SetCurrentSpanId");
GLOBAL_STR(str293, "setref requires a nameref (:out param)");
GLOBAL_STR(str294, "nameref %r is undefined");
GLOBAL_STR(str295, "nameref %r contains invalid variable name %r");
GLOBAL_STR(str296, "Circular nameref %s");
GLOBAL_STR(str297, " -> ");
GLOBAL_STR(str298, "__");
GLOBAL_STR(str299, "Can't assign to readonly value %r");
GLOBAL_STR(str300, "Only strings can be exported");
GLOBAL_STR(str301, "nameref must be a string");
GLOBAL_STR(str302, "Can't assign to readonly array");
GLOBAL_STR(str303, "Can't assign to items in a string");
GLOBAL_STR(str304, "Value of type %s can't be indexed");
GLOBAL_STR(str305, "Can't assign to readonly associative array");
GLOBAL_STR(str306, "ARGV");
GLOBAL_STR(str307, "_status");
GLOBAL_STR(str308, "_this_dir");
GLOBAL_STR(str309, "PIPESTATUS");
GLOBAL_STR(str310, "_pipeline_status");
GLOBAL_STR(str311, "_process_sub_status");
GLOBAL_STR(str312, "BASH_REMATCH");
GLOBAL_STR(str313, "FUNCNAME");
GLOBAL_STR(str314, "source");
GLOBAL_STR(str315, "BASH_SOURCE");
GLOBAL_STR(str316, "BASH_LINENO");
GLOBAL_STR(str317, "0");
GLOBAL_STR(str318, "LINENO");
GLOBAL_STR(str319, "BASHPID");
GLOBAL_STR(str320, "Can't unset readonly variable %r");
GLOBAL_STR(str321, "%r isn't an array");
GLOBAL_STR(str322, "$%s isn't defined");
GLOBAL_STR(str323, "$%s should be a string");
GLOBAL_STR(str324, "$%s should be a string, got %s");
GLOBAL_STR(str325, "$%s doesn't look like an integer, got %r");
GLOBAL_STR(str326, "EOF");
GLOBAL_STR(str327, "/");
GLOBAL_STR(str328, "~");
GLOBAL_STR(str329, "  ");
GLOBAL_STR(str330, "\n  ");
...
GLOBAL_STR(str335, "~");
GLOBAL_STR(str336, "\n");
GLOBAL_STR(str337, "[ interactive ]");
GLOBAL_STR(str338, "[ headless ]");
GLOBAL_STR(str339, "[ -c flag ]");
GLOBAL_STR(str340, "[ stdin%s ]");
GLOBAL_STR(str341, "[ %s word at ? ]");
GLOBAL_STR(str342, "[ %s word at line %d of %s ]");
GLOBAL_STR(str343, "?");
GLOBAL_STR(str344, "?");
GLOBAL_STR(str345, "line %d of %s");
GLOBAL_STR(str346, "[ var %s at %s ]");
GLOBAL_STR(str347, "[ expansion of alias %r ]");
GLOBAL_STR(str348, "[ %s in %s ]");
GLOBAL_STR(str349, "[??? no location ???] %s%s\n");
GLOBAL_STR(str350, "%s:%d: %s%s\n");
GLOBAL_STR(str351, "");
GLOBAL_STR(str352, "");
GLOBAL_STR(str353, "");
GLOBAL_STR(str354, "errexit PID %d: ");
GLOBAL_STR(str355, "none");
GLOBAL_STR(str356, "AST not printed.");
GLOBAL_STR(str357, "text");
GLOBAL_STR(str358, "abbrev-text");
GLOBAL_STR(str359, "html");
GLOBAL_STR(str360, "abbrev-html");
GLOBAL_STR(str361, "abbrev-");
GLOBAL_STR(str362, "\n");
GLOBAL_STR(str363, "\n");
GLOBAL_STR(str364, "-");
GLOBAL_STR(str365, "_");
GLOBAL_STR(str366, "<_Attributes %s>");
GLOBAL_STR(str367, "<args.Reader %r %d>");
GLOBAL_STR(str368, "expected argument to %r");
GLOBAL_STR(str369, "-");
GLOBAL_STR(str370, "expected integer after %s, got %r");
GLOBAL_STR(str371, "-");
GLOBAL_STR(str372, "got invalid integer for %s: %s");
GLOBAL_STR(str373, "-");
GLOBAL_STR(str374, "expected number after %r, got %r");
GLOBAL_STR(str375, "-");
GLOBAL_STR(str376, "got invalid float for %s: %s");
GLOBAL_STR(str377, "-");
GLOBAL_STR(str378, "got invalid argument %r to %r, expected one of: %s");
GLOBAL_STR(str379, "-");
GLOBAL_STR(str380, "|");
GLOBAL_STR(str381, "0");
GLOBAL_STR(str382, "F");
GLOBAL_STR(str383, "false");
GLOBAL_STR(str384, "False");
GLOBAL_STR(str385, "1");
GLOBAL_STR(str386, "T");
GLOBAL_STR(str387, "true");
GLOBAL_STR(str388, "Talse");
GLOBAL_STR(str389, "got invalid argument to boolean flag: %r");
GLOBAL_STR(str390, "-");
GLOBAL_STR(str391, "-");
GLOBAL_STR(str392, "Invalid option %r");
GLOBAL_STR(str393, "Expected argument for action");
GLOBAL_STR(str394, "Invalid action name %r");
GLOBAL_STR(str395, "--");
GLOBAL_STR(str396, "--");
GLOBAL_STR(str397, "=");
...
GLOBAL_STR(str401, "Z");
GLOBAL_STR(str402, "-");
GLOBAL_STR(str403, "doesn't accept flag %s");
GLOBAL_STR(str404, "-");
GLOBAL_STR(str405, "+");
GLOBAL_STR(str406, "+");
GLOBAL_STR(str407, "doesn't accept option %s");
GLOBAL_STR(str408, "+");
GLOBAL_STR(str409, "-");
GLOBAL_STR(str410, "--");
GLOBAL_STR(str411, "--");
GLOBAL_STR(str412, "got invalid flag %r");
GLOBAL_STR(str413, "-");
GLOBAL_STR(str414, "+");
GLOBAL_STR(str415, "got invalid flag %r");
GLOBAL_STR(str416, "-");
GLOBAL_STR(str417, "<LineLexer at pos %d of line %r (id = %d)>");
GLOBAL_STR(str418, "");
GLOBAL_STR(str419, "");
GLOBAL_STR(str420, "");
GLOBAL_STR(str421, "");
GLOBAL_STR(str422, "<Trail %s %s %s %s>");
GLOBAL_STR(str423, "");
GLOBAL_STR(str424, "Here docs aren't allowed in expressions");
GLOBAL_STR(str425, "\n");
GLOBAL_STR(str426, "Expected an expression");
GLOBAL_STR(str427, "Expected an expression");
GLOBAL_STR(str428, "Too many typed args (expected one expression)");
GLOBAL_STR(str429, "Expected block argument");
GLOBAL_STR(str430, "Too many typed args (expected one block)");
GLOBAL_STR(str431, "Use === to be exact, or ~== to convert types");
GLOBAL_STR(str432, "");
GLOBAL_STR(str433, " (%s)");
GLOBAL_STR(str434, "Unexpected token in expression mode%s");
GLOBAL_STR(str435, "Syntax error in expression (near %s)");
GLOBAL_STR(str436, "alnum");
GLOBAL_STR(str437, "cntrl");
GLOBAL_STR(str438, "lower");
GLOBAL_STR(str439, "space");
GLOBAL_STR(str440, "alpha");
GLOBAL_STR(str441, "digit");
GLOBAL_STR(str442, "print");
GLOBAL_STR(str443, "upper");
GLOBAL_STR(str444, "blank");
GLOBAL_STR(str445, "graph");
GLOBAL_STR(str446, "punct");
GLOBAL_STR(str447, "xdigit");
GLOBAL_STR(str448, "Range start/end shouldn't have more than one character");
GLOBAL_STR(str449, "Write singleton tuples with tup(), not a trailing comma");
GLOBAL_STR(str450, "testlist_comp");
GLOBAL_STR(str451, "obj.field isn't valid, but obj.method() is");
GLOBAL_STR(str452, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str453, "Can't assign to this expression");
GLOBAL_STR(str454, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str455, "Expr");
GLOBAL_STR(str456, "Block");
GLOBAL_STR(str457, "proc param types should be Expr or Block");
GLOBAL_STR(str458, "TODO");
GLOBAL_STR(str459, "dot");
GLOBAL_STR(str460, "Can't negate this symbol");
GLOBAL_STR(str461, "%r isn't a character class");
GLOBAL_STR(str462, "Can't negate this symbol");
GLOBAL_STR(str463, "%r isn't a character class");
GLOBAL_STR(str464, "%start");
GLOBAL_STR(str465, "%end");
GLOBAL_STR(str466, "dot");
GLOBAL_STR(str467, "Unexpected token %r in regex");
GLOBAL_STR(str468, "%s-%s");
GLOBAL_STR(str469, "ERE can't express code point %d");
GLOBAL_STR(str470, "Perl classes can't be negated in ERE");
GLOBAL_STR(str471, "%s");
GLOBAL_STR(str472, "POSIX classes can't be negated in ERE");
GLOBAL_STR(str473, "[:%s:]");
GLOBAL_STR(str474, ".");
GLOBAL_STR(str475, "^");
GLOBAL_STR(str476, "$");
GLOBAL_STR(str477, "|");
GLOBAL_STR(str478, "POSIX EREs don't have groups without capture, so this node needs () around it.");
GLOBAL_STR(str479, "+");
GLOBAL_STR(str480, "*");
GLOBAL_STR(str481, "?");
GLOBAL_STR(str482, "{%s}");
...
GLOBAL_STR(str493, "^");
GLOBAL_STR(str494, "]");
GLOBAL_STR(str495, "The [ operator doesn't apply to this expression");
GLOBAL_STR(str496, "Expected ]]");
GLOBAL_STR(str497, "Unexpected trailing word %s");
GLOBAL_STR(str498, "Invalid argument to unary operator");
GLOBAL_STR(str499, "Expected ), got %s");
GLOBAL_STR(str500, "Unexpected token in boolean expression (%s)");
GLOBAL_STR(str501, "");
GLOBAL_STR(str502, "Expected %d, got %d");
GLOBAL_STR(str503, "Step can't be 0");
GLOBAL_STR(str504, "Invalid step %d for ascending integer range");
GLOBAL_STR(str505, "Invalid step %d for descending integer range");
GLOBAL_STR(str506, "Invalid step %d for ascending character range");
GLOBAL_STR(str507, "Invalid step %d for descending character range");
GLOBAL_STR(str508, "Mismatched cases in character range");
GLOBAL_STR(str509, "");
GLOBAL_STR(str510, "0");
GLOBAL_STR(str511, "0");
GLOBAL_STR(str512, "g");
...
GLOBAL_STR(str549, ")");
GLOBAL_STR(str550, "");
GLOBAL_STR(str551, "export_");
GLOBAL_STR(str552, "doesn't accept -f because it's dangerous.  (The code can usually be restructured with 'source')");
GLOBAL_STR(str553, "doesn't accept RHS with -n");
GLOBAL_STR(str554, "Got -a but RHS isn't an array");
GLOBAL_STR(str555, "Got -A but RHS isn't an associative array");
GLOBAL_STR(str556, "readonly");
GLOBAL_STR(str557, "new_var");
GLOBAL_STR(str558, "with -f expects function names");
GLOBAL_STR(str559, "declare -f %s");
GLOBAL_STR(str560, "-");
GLOBAL_STR(str561, "-");
GLOBAL_STR(str562, "-");
GLOBAL_STR(str563, "+");
GLOBAL_STR(str564, "+");
GLOBAL_STR(str565, "+");
GLOBAL_STR(str566, "unset");
GLOBAL_STR(str567, "Invalid shift argument %r");
GLOBAL_STR(str568, "got too many arguments");
GLOBAL_STR(str569, "eval");
GLOBAL_STR(str570, "requires code string");
GLOBAL_STR(str571, "requires exactly 1 argument");
GLOBAL_STR(str572, " ");
GLOBAL_STR(str573, "eval");
GLOBAL_STR(str574, "eval");
GLOBAL_STR(str575, "source");
GLOBAL_STR(str576, "missing required argument");
GLOBAL_STR(str577, "source %r failed: %s");
GLOBAL_STR(str578, "source");
GLOBAL_STR(str579, "command");
GLOBAL_STR(str580, "Can't run assignment builtin recursively");
GLOBAL_STR(str581, "%r isn't a shell builtin");
GLOBAL_STR(str582, "runproc");
GLOBAL_STR(str583, "requires arguments");
GLOBAL_STR(str584, "runproc: no proc named %r");
GLOBAL_STR(str585, "try_");
GLOBAL_STR(str586, "'try' expected a command to run");
GLOBAL_STR(str587, "(original failure)");
GLOBAL_STR(str588, "");
GLOBAL_STR(str589, "status %d when --allow-status-01");
GLOBAL_STR(str590, ":");
GLOBAL_STR(str591, "function");
GLOBAL_STR(str592, "alias");
GLOBAL_STR(str593, "builtin");
GLOBAL_STR(str594, "builtin");
GLOBAL_STR(str595, "builtin");
GLOBAL_STR(str596, "keyword");
GLOBAL_STR(str597, "keyword");
GLOBAL_STR(str598, "file");
GLOBAL_STR(str599, "type");
GLOBAL_STR(str600, "type: %r not found");
GLOBAL_STR(str601, "file");
GLOBAL_STR(str602, "file");
GLOBAL_STR(str603, "%s is a %s");
GLOBAL_STR(str604, "function");
GLOBAL_STR(str605, "");
GLOBAL_STR(str606, "");
GLOBAL_STR(str607, "\r\n");
GLOBAL_STR(str608, "\n");
...
GLOBAL_STR(str610, "");
GLOBAL_STR(str611, "");
GLOBAL_STR(str612, "read error: %s");
GLOBAL_STR(str613, "read");
GLOBAL_STR(str614, "_line");
GLOBAL_STR(str615, ":");
GLOBAL_STR(str616, "got extra argument");
GLOBAL_STR(str617, "--qsn can only be used with --line");
GLOBAL_STR(str618, "_all");
GLOBAL_STR(str619, ":");
GLOBAL_STR(str620, "got extra argument");
GLOBAL_STR(str621, "--qsn not implemented yet");
GLOBAL_STR(str622, "read -t isn't implemented (except t=0)");
GLOBAL_STR(str623, "REPLY");
GLOBAL_STR(str624, "REPLY");
GLOBAL_STR(str625, "");
GLOBAL_STR(str626, ":");
GLOBAL_STR(str627, "mapfile");
GLOBAL_STR(str628, "MAPFILE");
GLOBAL_STR(str629, ":");
GLOBAL_STR(str630, "mapfile: read() error: %s");
GLOBAL_STR(str631, "\n");
GLOBAL_STR(str632, "cd");
GLOBAL_STR(str633, "HOME");
GLOBAL_STR(str634, "HOME");
GLOBAL_STR(str635, "-");
GLOBAL_STR(str636, "OLDPWD");
GLOBAL_STR(str637, "PWD");
GLOBAL_STR(str638, "cd %r: %s");
GLOBAL_STR(str639, "PWD");
GLOBAL_STR(str640, "OLDPWD");
GLOBAL_STR(str641, "%2d  %s");
GLOBAL_STR(str642, " ");
GLOBAL_STR(str643, "pushd: no other directory");
GLOBAL_STR(str644, "got too many arguments");
GLOBAL_STR(str645, "pushd: %r: %s");
GLOBAL_STR(str646, "HOME");
GLOBAL_STR(str647, "PWD");
GLOBAL_STR(str648, "popd: directory stack is empty");
GLOBAL_STR(str649, "popd: %r: %s");
GLOBAL_STR(str650, "PWD");
GLOBAL_STR(str651, "got extra argument");
GLOBAL_STR(str652, "HOME");
GLOBAL_STR(str653, "dirs");
GLOBAL_STR(str654, "HOME");
GLOBAL_STR(str655, "pwd");
GLOBAL_STR(str656, "_devbuild/help/groups.txt");
GLOBAL_STR(str657, "help");
GLOBAL_STR(str658, "help");
GLOBAL_STR(str659, "_devbuild/help/%s");
GLOBAL_STR(str660, "no help topics match %r");
GLOBAL_STR(str661, "osh I/O error: %s");
GLOBAL_STR(str662, "# +");
GLOBAL_STR(str663, "osh printf doesn't support the %r flag");
GLOBAL_STR(str664, "eEfFgG");
GLOBAL_STR(str665, "osh printf doesn't support floating point");
GLOBAL_STR(str666, "c");
GLOBAL_STR(str667, "osh printf doesn't support single characters (bytes)");
GLOBAL_STR(str668, "Invalid printf format character");
GLOBAL_STR(str669, "Expected a printf format character");
GLOBAL_STR(str670, "%");
GLOBAL_STR(str671, "");
GLOBAL_STR(str672, "printf got invalid width %r");
GLOBAL_STR(str673, "0");
GLOBAL_STR(str674, "");
GLOBAL_STR(str675, "printf got invalid precision %r");
GLOBAL_STR(str676, "");
GLOBAL_STR(str677, "s");
GLOBAL_STR(str678, "q");
GLOBAL_STR(str679, "b");
GLOBAL_STR(str680, "");
GLOBAL_STR(str681, "diouxX");
GLOBAL_STR(str682, "'\"");
GLOBAL_STR(str683, "printf expected an integer, got %r");
GLOBAL_STR(str684, "TZ");
GLOBAL_STR(str685, "TZ");
GLOBAL_STR(str686, "ouxX");
GLOBAL_STR(str687, "Can't format negative number %d with %%%s");
GLOBAL_STR(str688, "o");
GLOBAL_STR(str689, "x");
GLOBAL_STR(str690, "X");
GLOBAL_STR(str691, "0");
...
GLOBAL_STR(str697, " ");
GLOBAL_STR(str698, " ");
GLOBAL_STR(str699, "printf");
GLOBAL_STR(str700, "requires a format string");
GLOBAL_STR(str701, "printf");
GLOBAL_STR(str702, "");
GLOBAL_STR(str703, "alias");
GLOBAL_STR(str704, "alias %s=%r");
GLOBAL_STR(str705, "=");
GLOBAL_STR(str706, "No alias named %r");
GLOBAL_STR(str707, "alias %s=%r");
GLOBAL_STR(str708, "unalias");
GLOBAL_STR(str709, "requires an argument");
GLOBAL_STR(str710, "No alias named %r");
GLOBAL_STR(str711, "%s=%s");
GLOBAL_STR(str712, "set");
GLOBAL_STR(str713, "shopt");
GLOBAL_STR(str714, "got invalid option %r");
GLOBAL_STR(str715, "hash");
GLOBAL_STR(str716, "got extra arguments after -r");
GLOBAL_STR(str717, "hash: %r not found");
GLOBAL_STR(str718, ":");
GLOBAL_STR(str719, "OPTIND");
GLOBAL_STR(str720, "OPTIND");
GLOBAL_STR(str721, "OPTARG");
GLOBAL_STR(str722, "OPTARG");
GLOBAL_STR(str723, "");
GLOBAL_STR(str724, "?");
GLOBAL_STR(str725, "-");
GLOBAL_STR(str726, "-");
GLOBAL_STR(str727, "?");
GLOBAL_STR(str728, "?");
GLOBAL_STR(str729, "getopts: option %r requires an argument.");
GLOBAL_STR(str730, "(getopts argv: %s)");
GLOBAL_STR(str731, " ");
GLOBAL_STR(str732, "?");
GLOBAL_STR(str733, "");
GLOBAL_STR(str734, "requires an argspec");
GLOBAL_STR(str735, "requires the name of a variable to set");
GLOBAL_STR(str736, "got invalid variable name %r");
GLOBAL_STR(str737, "echo");
GLOBAL_STR(str738, "");
GLOBAL_STR(str739, "takes at most one arg when simple_echo is on (hint: add quotes)");
GLOBAL_STR(str740, " ");
GLOBAL_STR(str741, "\n");
GLOBAL_STR(str742, "module");
GLOBAL_STR(str743, "requires a name");
GLOBAL_STR(str744, "(interactive) Reloading module %r");
GLOBAL_STR(str745, "expected 'bin' or 'dialect'");
GLOBAL_STR(str746, "dialect");
GLOBAL_STR(str747, "expected dialect name");
GLOBAL_STR(str748, "_DIALECT");
GLOBAL_STR(str749, "Expected dialect %r, got %r");
GLOBAL_STR(str750, "Expected dialect %r");
GLOBAL_STR(str751, "bin");
GLOBAL_STR(str752, "bin %s");
GLOBAL_STR(str753, "expected 'bin' or 'dialect'");
GLOBAL_STR(str754, "shvar");
GLOBAL_STR(str755, "expected a block");
GLOBAL_STR(str756, "Expected name=value");
GLOBAL_STR(str757, "=");
GLOBAL_STR(str758, "Expected name=value");
GLOBAL_STR(str759, "expected a block");
GLOBAL_STR(str760, "Can't append array to string");
GLOBAL_STR(str761, "Can't append string to array");
GLOBAL_STR(str762, "Assignment builtin %r not configured");
GLOBAL_STR(str763, "%r ");
GLOBAL_STR(str764, "");
GLOBAL_STR(str765, "Command");
GLOBAL_STR(str766, "Assignment");
GLOBAL_STR(str767, "Subshell");
GLOBAL_STR(str768, "Pipeline");
GLOBAL_STR(str769, "%s failed with status %d");
GLOBAL_STR(str770, "Redirect filename can't be empty");
GLOBAL_STR(str771, "Redirect descriptor can't be empty");
GLOBAL_STR(str772, "-");
GLOBAL_STR(str773, "-");
GLOBAL_STR(str774, "Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
GLOBAL_STR(str775, "\n");
GLOBAL_STR(str776, "Unknown redirect op");
GLOBAL_STR(str777, "Unknown redirect type");
GLOBAL_STR(str778, "strict_errexit only allows simple commands (got %s). Hint: use 'try'.");
GLOBAL_STR(str779, "strict_errexit only allows a single command.  Hint: use 'try'.");
GLOBAL_STR(str780, "strict_errexit only allows simple commands (got %s). Hint: use 'try'.");
GLOBAL_STR(str781, "ShAssignment builtins don't accept blocks");
GLOBAL_STR(str782, "|& isn't supported");
GLOBAL_STR(str783, "%r expected a number, got %r");
GLOBAL_STR(str784, "Invalid control flow at top level");
GLOBAL_STR(str785, "warning: ");
GLOBAL_STR(str786, "Function %s was already defined (redefine_proc)");
GLOBAL_STR(str787, "Proc %s was already defined (redefine_proc)");
GLOBAL_STR(str788, "trap");
GLOBAL_STR(str789, "failglob: ");
GLOBAL_STR(str790, "Loop and control flow can't be in different processes");
GLOBAL_STR(str791, "fatal: ");
GLOBAL_STR(str792, "EXIT");
GLOBAL_STR(str793, "trap EXIT");
GLOBAL_STR(str794, "__");
GLOBAL_STR(str795, ":");
GLOBAL_STR(str796, "Invalid argument %r.  Expected a name starting with :");
GLOBAL_STR(str797, "No value provided for param %r");
GLOBAL_STR(str798, "proc %r expected %d arguments, but got %d");
GLOBAL_STR(str799, "Unexpected %r (in function call)");
GLOBAL_STR(str800, "Attempted to exit from completion hook.");
GLOBAL_STR(str801, "Couldn't find terminator for here doc that starts here");
GLOBAL_STR(str802, "\t");
GLOBAL_STR(str803, "Invalid here doc delimiter");
GLOBAL_STR(str804, "+");
GLOBAL_STR(str805, "+");
GLOBAL_STR(str806, "+");
GLOBAL_STR(str807, "%d != %d");
GLOBAL_STR(str808, "array place");
GLOBAL_STR(str809, "Environment binding shouldn't look like an array assignment");
GLOBAL_STR(str810, "+");
GLOBAL_STR(str811, "Expected = in environment binding, got +=");
GLOBAL_STR(str812, "Environment bindings can't contain array literals");
GLOBAL_STR(str813, "procs and shell functions can't be nested");
GLOBAL_STR(str814, "%r was already declared");
GLOBAL_STR(str815, "%r hasn't been declared");
GLOBAL_STR(str816, "Can't modify constant %r");
GLOBAL_STR(str817, "Expected word type %s, got %s");
GLOBAL_STR(str818, "{");
GLOBAL_STR(str819, "}");
GLOBAL_STR(str820, "Invalid token after redirect operator");
GLOBAL_STR(str821, "Space required before (");
GLOBAL_STR(str822, "Unexpected left paren (might need a space before it)");
GLOBAL_STR(str823, "Empty arg list not allowed");
GLOBAL_STR(str824, "TODO: Parse Redirect");
GLOBAL_STR(str825, " ");
GLOBAL_STR(str826, " ");
GLOBAL_STR(str827, "line IDs %d != %d");
GLOBAL_STR(str828, " ");
GLOBAL_STR(str829, "");
GLOBAL_STR(str830, "Unexpected typed args");
GLOBAL_STR(str831, "=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
GLOBAL_STR(str832, "name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
GLOBAL_STR(str833, "Unexpected typed args");
GLOBAL_STR(str834, "Unexpected typed args");
GLOBAL_STR(str835, "Control flow shouldn't have redirects");
GLOBAL_STR(str836, "Control flow shouldn't have environment bindings");
GLOBAL_STR(str837, "Unexpected argument to %r");
GLOBAL_STR(str838, "Invalid word in for loop");
GLOBAL_STR(str839, "Invalid word after for expression");
GLOBAL_STR(str840, "Loop variable name should be a constant");
GLOBAL_STR(str841, "Invalid loop variable name");
GLOBAL_STR(str842, "Unexpected word after for loop variable");
GLOBAL_STR(str843, "Expected ;; or esac");
GLOBAL_STR(str844, "Unexpected word while parsing compound command");
GLOBAL_STR(str845, "Invalid function name");
GLOBAL_STR(str846, "Expected ) in function definition");
GLOBAL_STR(str847, "Invalid KSH-style function name");
GLOBAL_STR(str848, "Unexpected word when parsing command");
GLOBAL_STR(str849, "Unexpected right brace");
GLOBAL_STR(str850, "Unexpected EOF while parsing command");
GLOBAL_STR(str851, "Invalid word while parsing command");
GLOBAL_STR(str852, "Invalid word while parsing command line");
GLOBAL_STR(str853, "Invalid word while parsing command list");
GLOBAL_STR(str854, "Unterminated here doc began here");
GLOBAL_STR(str855, "\\");
GLOBAL_STR(str856, "*");
GLOBAL_STR(str857, "?");
GLOBAL_STR(str858, "[");
...
GLOBAL_STR(str862, "\\?*+{}^$.()|");
GLOBAL_STR(str863, "\\");
GLOBAL_STR(str864, "Unexpected escaped character %r");
GLOBAL_STR(str865, "");
GLOBAL_STR(str866, "");
GLOBAL_STR(str867, "Malformed character class; treating as literal");
GLOBAL_STR(str868, "Got unescaped right bracket");
GLOBAL_STR(str869, "Got unescaped trailing backslash");
GLOBAL_STR(str870, ".|^$()+*?[]{}\\");
GLOBAL_STR(str871, "\\");
GLOBAL_STR(str872, "\\");
GLOBAL_STR(str873, "\\[");
...
GLOBAL_STR(str885, "]");
GLOBAL_STR(str886, "");
GLOBAL_STR(str887, "Error expanding glob %r: %s");
GLOBAL_STR(str888, "-");
GLOBAL_STR(str889, "<Error: unbalanced \\[ and \\]> ");
GLOBAL_STR(str890, "$");
GLOBAL_STR(str891, "#");
GLOBAL_STR(str892, "$");
GLOBAL_STR(str893, "hostname");
GLOBAL_STR(str894, "user");
GLOBAL_STR(str895, "\u0001");
GLOBAL_STR(str896, "\u0002");
GLOBAL_STR(str897, "$");
GLOBAL_STR(str898, "$");
GLOBAL_STR(str899, "u");
GLOBAL_STR(str900, "user");
GLOBAL_STR(str901, "h");
GLOBAL_STR(str902, "hostname");
GLOBAL_STR(str903, ".");
GLOBAL_STR(str904, "H");
...
GLOBAL_STR(str907, "v");
GLOBAL_STR(str908, "A");
GLOBAL_STR(str909, "%H:%M");
GLOBAL_STR(str910, "D");
GLOBAL_STR(str911, "%X");
GLOBAL_STR(str912, "w");
GLOBAL_STR(str913, "PWD");
GLOBAL_STR(str914, "HOME");
GLOBAL_STR(str915, "<Error: %s>");
GLOBAL_STR(str916, "W");
GLOBAL_STR(str917, "PWD");
GLOBAL_STR(str918, "<Error: PWD is not a string> ");
GLOBAL_STR(str919, "<Error: \\%s not implemented in $PS1> ");
GLOBAL_STR(str920, "$");
GLOBAL_STR(str921, "\\$");
GLOBAL_STR(str922, "Invalid token %r");
GLOBAL_STR(str923, "");
GLOBAL_STR(str924, "");
GLOBAL_STR(str925, "<ERROR: Can't parse PS1: %s>");
GLOBAL_STR(str926, "osh");
GLOBAL_STR(str927, "PS1");
GLOBAL_STR(str928, "$ ");
GLOBAL_STR(str929, "PROMPT_COMMAND");
GLOBAL_STR(str930, "Undefined variable %r");
GLOBAL_STR(str931, "Can't use [] on value of type %s");
GLOBAL_STR(str932, "");
GLOBAL_STR(str933, "Can't use [] on value of type %s");
GLOBAL_STR(str934, "");
GLOBAL_STR(str935, "dynamic place");
GLOBAL_STR(str936, "got invalid place expression");
GLOBAL_STR(str937, "expected a var name.  shopt -s eval_unsafe_arith allows a[i]");
GLOBAL_STR(str938, "Invalid var ref");
GLOBAL_STR(str939, "0x");
GLOBAL_STR(str940, "Invalid hex constant %r");
GLOBAL_STR(str941, "0");
GLOBAL_STR(str942, "Invalid octal constant %r");
GLOBAL_STR(str943, "#");
GLOBAL_STR(str944, "#");
GLOBAL_STR(str945, "Invalid base for numeric constant %r");
GLOBAL_STR(str946, "a");
GLOBAL_STR(str947, "A");
GLOBAL_STR(str948, "@");
GLOBAL_STR(str949, "_");
GLOBAL_STR(str950, "Invalid digits for numeric constant %r");
GLOBAL_STR(str951, "Digits %r out of range for base %d");
GLOBAL_STR(str952, "Parse error in recursive arithmetic");
GLOBAL_STR(str953, "Invalid integer constant %r");
GLOBAL_STR(str954, "Invalid integer constant %r");
GLOBAL_STR(str955, "Invalid integer constant %r");
GLOBAL_STR(str956, "Undefined value in arithmetic context");
GLOBAL_STR(str957, "Expected a value convertible to integer, got %s");
GLOBAL_STR(str958, "0");
GLOBAL_STR(str959, "Undefined variable %r");
GLOBAL_STR(str960, "Divide by zero");
GLOBAL_STR(str961, "Divide by zero");
GLOBAL_STR(str962, "Expected array or assoc in index expression, got %s");
GLOBAL_STR(str963, "Divide by zero");
GLOBAL_STR(str964, "Divide by zero");
GLOBAL_STR(str965, "Exponent can't be less than zero");
GLOBAL_STR(str966, "Associative array keys must be strings: $x 'x' \"$x\" etc.");
GLOBAL_STR(str967, "Invalid place to modify");
GLOBAL_STR(str968, "%s isn't implemented");
GLOBAL_STR(str969, "Invalid regex %r: %s");
GLOBAL_STR(str970, " \t\n");
GLOBAL_STR(str971, "IFS");
GLOBAL_STR(str972, "IFS shouldn't be an array");
GLOBAL_STR(str973, " \t\n");
GLOBAL_STR(str974, "IFS");
GLOBAL_STR(str975, " ");
GLOBAL_STR(str976, "");
GLOBAL_STR(str977, "IFS shouldn't be an array");
GLOBAL_STR(str978, "\\");
GLOBAL_STR(str979, "\\");
GLOBAL_STR(str980, "Invalid transition from %r with %r");
GLOBAL_STR(str981, "\u00ef\u00bf\u00bd");
GLOBAL_STR(str982, "");
GLOBAL_STR(str983, "Incomplete UTF-8 character");
GLOBAL_STR(str984, "Invalid UTF-8 continuation byte");
GLOBAL_STR(str985, "Invalid start of UTF-8 character");
GLOBAL_STR(str986, "");
GLOBAL_STR(str987, "%s can't have an argument");
GLOBAL_STR(str988, "");
GLOBAL_STR(str989, "%s can't have an argument");
GLOBAL_STR(str990, "");
GLOBAL_STR(str991, "%s can't have an argument");
GLOBAL_STR(str992, "");
GLOBAL_STR(str993, "%s can't have an argument");
GLOBAL_STR(str994, "");
GLOBAL_STR(str995, "<_GlobReplacer regex %r r %r>");
GLOBAL_STR(str996, "(%s)");
GLOBAL_STR(str997, "Error matching regex %r: %s");
GLOBAL_STR(str998, "^");
GLOBAL_STR(str999, "$");
GLOBAL_STR(str1000, "\r");
GLOBAL_STR(str1001, "<INVALID CR>");
GLOBAL_STR(str1002, "\n");
GLOBAL_STR(str1003, "<INVALID NEWLINE>");
GLOBAL_STR(str1004, " `~!$&*()[]{}\\|;'\"<>?");
GLOBAL_STR(str1005, "Left-hand side of this assignment is invalid");
GLOBAL_STR(str1006, "Token can't be used in prefix position");
GLOBAL_STR(str1007, "Token can't be used in infix position");
GLOBAL_STR(str1008, "Parser expected %s, got %s");
GLOBAL_STR(str1009, "Unexpected end of input");
GLOBAL_STR(str1010, "");
GLOBAL_STR(str1011, "");
GLOBAL_STR(str1012, " \t");
GLOBAL_STR(str1013, "\n");
...
GLOBAL_STR(str1015, "\n");
GLOBAL_STR(str1016, "\n");
GLOBAL_STR(str1017, "BASH_SOURCE");
GLOBAL_STR(str1018, "FUNCNAME");
GLOBAL_STR(str1019, "BASH_LINENO");
GLOBAL_STR(str1020, "0");
GLOBAL_STR(str1021, "0");
GLOBAL_STR(str1022, "^([a-zA-Z_][a-zA-Z0-9_]*)((=|\\+=)(.*))?$");
GLOBAL_STR(str1023, "Assignment builtin expected NAME=value, got %r");
GLOBAL_STR(str1024, "+");
GLOBAL_STR(str1025, "\\");
GLOBAL_STR(str1026, "\\\\");
GLOBAL_STR(str1027, "");
GLOBAL_STR(str1028, "");
GLOBAL_STR(str1029, "The length index of a array slice can't be negative: %d");
GLOBAL_STR(str1030, "Can't slice associative arrays");
GLOBAL_STR(str1031, "i");
GLOBAL_STR(str1032, "e");
GLOBAL_STR(str1033, "f");
GLOBAL_STR(str1034, "n");
GLOBAL_STR(str1035, "u");
GLOBAL_STR(str1036, "x");
GLOBAL_STR(str1037, "C");
GLOBAL_STR(str1038, "");
GLOBAL_STR(str1039, "~");
GLOBAL_STR(str1040, "HOME");
GLOBAL_STR(str1041, "Error expanding tilde (e.g. invalid user)");
GLOBAL_STR(str1042, "Can't assign to special variable");
GLOBAL_STR(str1043, "unset variable %r");
GLOBAL_STR(str1044, "warning: ");
GLOBAL_STR(str1045, "-1");
GLOBAL_STR(str1046, "a[i] not allowed without shopt -s eval_unsafe_arith");
GLOBAL_STR(str1047, "Indirect expansion of array");
GLOBAL_STR(str1048, "Indirect expansion of assoc array");
GLOBAL_STR(str1049, "extended globs not supported in ${x//GLOB/}");
GLOBAL_STR(str1050, "");
GLOBAL_STR(str1051, "warning: ");
GLOBAL_STR(str1052, "");
GLOBAL_STR(str1053, "\u0001");
GLOBAL_STR(str1054, "");
GLOBAL_STR(str1055, "\u0002");
GLOBAL_STR(str1056, "");
GLOBAL_STR(str1057, "Can't use @P on %s");
GLOBAL_STR(str1058, " ");
GLOBAL_STR(str1059, "Can't use @Q on %s");
GLOBAL_STR(str1060, "a");
GLOBAL_STR(str1061, "A");
GLOBAL_STR(str1062, "r");
GLOBAL_STR(str1063, "x");
GLOBAL_STR(str1064, "n");
GLOBAL_STR(str1065, "");
GLOBAL_STR(str1066, "Var op %r not implemented");
GLOBAL_STR(str1067, "Can't index string with @");
GLOBAL_STR(str1068, "Can't index string with *");
GLOBAL_STR(str1069, "Can't index string %r with integer");
GLOBAL_STR(str1070, "");
GLOBAL_STR(str1071, "");
GLOBAL_STR(str1072, "$");
GLOBAL_STR(str1073, "Undefined variable %r");
GLOBAL_STR(str1074, "Undefined array %r");
GLOBAL_STR(str1075, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str1076, "Test operation not allowed with ${!array[@]}");
GLOBAL_STR(str1077, "Not implemented");
GLOBAL_STR(str1078, "Illegal array word part (strict_array)");
GLOBAL_STR(str1079, " ");
GLOBAL_STR(str1080, "");
GLOBAL_STR(str1081, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str1082, "@(");
GLOBAL_STR(str1083, "|");
GLOBAL_STR(str1084, ")");
GLOBAL_STR(str1085, "Extended globs and arrays can't appear in the same word");
GLOBAL_STR(str1086, "*");
GLOBAL_STR(str1087, "Unexpected array literal");
GLOBAL_STR(str1088, "Unexpected associative array literal");
GLOBAL_STR(str1089, "Can't splice %r");
GLOBAL_STR(str1090, "");
GLOBAL_STR(str1091, "");
GLOBAL_STR(str1092, "Extended glob %r matched no files");
GLOBAL_STR(str1093, "Extended glob not allowed in this word");
GLOBAL_STR(str1094, "");
GLOBAL_STR(str1095, "This word should yield a string, but it contains an array");
GLOBAL_STR(str1096, " ");
GLOBAL_STR(str1097, "extended glob not allowed in this word");
GLOBAL_STR(str1098, "");
GLOBAL_STR(str1099, "");
GLOBAL_STR(str1100, "");
GLOBAL_STR(str1101, "");
GLOBAL_STR(str1102, "<Runtime error: %s>");
GLOBAL_STR(str1103, "<I/O error: %s>");
GLOBAL_STR(str1104, "<Ctrl-C>");
GLOBAL_STR(str1105, "");
GLOBAL_STR(str1106, "");
GLOBAL_STR(str1107, "");
GLOBAL_STR(str1108, "");
GLOBAL_STR(str1109, "Pattern %r matched no files");
GLOBAL_STR(str1110, "");
GLOBAL_STR(str1111, "LHS array not allowed in assignment builtin");
GLOBAL_STR(str1112, "+");
GLOBAL_STR(str1113, "-");
GLOBAL_STR(str1114, "+");
GLOBAL_STR(str1115, "f");
GLOBAL_STR(str1116, "F");
GLOBAL_STR(str1117, "Pattern %r matched no files");
GLOBAL_STR(str1118, "");
GLOBAL_STR(str1119, "__NO_COMMAND_SUB__");
GLOBAL_STR(str1120, "__NO_PROCESS_SUB__");
GLOBAL_STR(str1121, "Expected : or } in slice");
GLOBAL_STR(str1122, "Pattern in ${x/pat/replace} must not be empty");
GLOBAL_STR(str1123, "Expected } after replacement string, got %s");
GLOBAL_STR(str1124, "Expected } or / to close pattern");
GLOBAL_STR(str1125, "Expected ] to close subscript");
GLOBAL_STR(str1126, "Expected } to close ${");
GLOBAL_STR(str1127, "Expected } to close ${");
GLOBAL_STR(str1128, "Expected a constant argument");
GLOBAL_STR(str1129, "Expected } to close ${");
GLOBAL_STR(str1130, "Expected } to close ${");
GLOBAL_STR(str1131, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1132, "VOp2");
GLOBAL_STR(str1133, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1134, "VOp3");
GLOBAL_STR(str1135, "Expected } to close ${");
GLOBAL_STR(str1136, "Expected } after length expression");
GLOBAL_STR(str1137, "TODO: ${.myproc builtin sub}");
GLOBAL_STR(str1138, "Unexpected token in ${}");
GLOBAL_STR(str1139, "\\");
GLOBAL_STR(str1140, "Strings with backslashes should look like r'\\n' or $'\\n'");
GLOBAL_STR(str1141, "Use \\xhh or \\u{...} instead of octal escapes in Oil strings");
GLOBAL_STR(str1142, "Invalid hex escape in Oil string (must be \\xHH)");
GLOBAL_STR(str1143, "Invalid char escape in C-style string literal");
GLOBAL_STR(str1144, "Unexpected EOF in single-quoted string that began here");
GLOBAL_STR(str1145, "\"");
GLOBAL_STR(str1146, "'");
GLOBAL_STR(str1147, "Unexpected EOF reading extended glob that began here");
GLOBAL_STR(str1148, "Invalid char escape in double quoted string");
GLOBAL_STR(str1149, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1150, "Invalid backtick: use $(cmd) or \\` in Oil strings");
GLOBAL_STR(str1151, "Unexpected EOF reading double-quoted string that began here");
GLOBAL_STR(str1152, "Use $(cmd) instead of backticks (parse_backticks)");
GLOBAL_STR(str1153, "Unexpected EOF while looking for closing backtick");
GLOBAL_STR(str1154, "");
GLOBAL_STR(str1155, "backticks");
GLOBAL_STR(str1156, "Invalid proc name %s");
GLOBAL_STR(str1157, "Unexpected token after arithmetic expression (%s != %s)");
GLOBAL_STR(str1158, "Expected second ) to end arith sub");
GLOBAL_STR(str1159, "Expected second ) to end arith statement");
GLOBAL_STR(str1160, "Expected ; here");
GLOBAL_STR(str1161, "Expected ; here");
GLOBAL_STR(str1162, "Expected ) to end for loop expression");
GLOBAL_STR(str1163, "Expected ( after =");
GLOBAL_STR(str1164, "Unexpected token in array literal");
GLOBAL_STR(str1165, "Expected associative array pair");
GLOBAL_STR(str1166, "Invalid char escape (parse_backslash)");
GLOBAL_STR(str1167, "Unexpected token after array literal");
GLOBAL_STR(str1168, "Unexpected token after array splice");
GLOBAL_STR(str1169, "TODO: @{.myproc builtin sub}");
GLOBAL_STR(str1170, "Literal @ starting a word must be quoted (parse_at_all)");
GLOBAL_STR(str1171, "/");
GLOBAL_STR(str1172, "next_byte %r");
GLOBAL_STR(str1173, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1174, "Unexpected token after @()");
GLOBAL_STR(str1175, "Word has unbalanced { }.  Maybe add a space or quote it like \\{");
GLOBAL_STR(str1176, "Unexpected parts after triple quoted string");
GLOBAL_STR(str1177, "Unexpected token while parsing arithmetic: %r");
GLOBAL_STR(str1178, "Invalid blank line in multiline mode");
GLOBAL_STR(str1179, "r");
GLOBAL_STR(str1180, "Unhandled: %s (%s)");
GLOBAL_STR(str1181, "Invalid var ref");
GLOBAL_STR(str1182, "Expected end of var ref");
GLOBAL_STR(str1183, "Invalid lex state %s");
GLOBAL_STR(str1184, "");
GLOBAL_STR(str1185, "");
GLOBAL_STR(str1186, "");
GLOBAL_STR(str1187, "");
...
GLOBAL_STR(str1191, "");
GLOBAL_STR(str1192, "");
GLOBAL_STR(str1193, "Compound shouldn't be empty");
GLOBAL_STR(str1194, "/");
GLOBAL_STR(str1195, "/");
GLOBAL_STR(str1196, "");
GLOBAL_STR(str1197, "EOF");
GLOBAL_STR(str1198, "typ");
GLOBAL_STR(str1199, "tok");
GLOBAL_STR(str1200, "children");
GLOBAL_STR(str1201, "-");
GLOBAL_STR(str1202, "with %d children");
GLOBAL_STR(str1203, "");
GLOBAL_STR(str1204, "(PNode %s %s %s)");
GLOBAL_STR(str1205, "&");
GLOBAL_STR(str1206, "&amp;");
GLOBAL_STR(str1207, "<");
GLOBAL_STR(str1208, "&lt;");
...
GLOBAL_STR(str1230, "/");
GLOBAL_STR(str1231, " \n\r\t");
GLOBAL_STR(str1232, "Unexpected token in QSN string");
GLOBAL_STR(str1233, "Expected closing single quote in QSN string");
GLOBAL_STR(str1234, "Unexpected data after closing quote");
GLOBAL_STR(str1235, "Unexpected token after QSN string");
GLOBAL_STR(str1236, "\\'\r\n\t\u0000");
GLOBAL_STR(str1237, "$'");
GLOBAL_STR(str1238, "'");
GLOBAL_STR(str1239, "'");
...
GLOBAL_STR(str1251, "\n");
GLOBAL_STR(str1252, "\\n");
GLOBAL_STR(str1253, "\r");
GLOBAL_STR(str1254, "\\r");
GLOBAL_STR(str1255, "\t");
GLOBAL_STR(str1256, "\\t");
GLOBAL_STR(str1257, "\u0000");
GLOBAL_STR(str1258, "\\x00");
GLOBAL_STR(str1259, "\\0");
GLOBAL_STR(str1260, "");
GLOBAL_STR(str1261, "");
GLOBAL_STR(str1262, "");
GLOBAL_STR(str1263, "\\");
...
GLOBAL_STR(str1267, "\n");
GLOBAL_STR(str1268, "\\n");
GLOBAL_STR(str1269, "\r");
GLOBAL_STR(str1270, "\\r");
GLOBAL_STR(str1271, "\t");
GLOBAL_STR(str1272, "\\t");
GLOBAL_STR(str1273, "\u0000");
GLOBAL_STR(str1274, "\\x00");
GLOBAL_STR(str1275, "\\0");
GLOBAL_STR(str1276, "");
GLOBAL_STR(str1277, "!");
GLOBAL_STR(str1278, "--");
GLOBAL_STR(str1279, "--dir");
GLOBAL_STR(str1280, "--exists");
GLOBAL_STR(str1281, "--file");
GLOBAL_STR(str1282, "--symlink");
GLOBAL_STR(str1283, "Expected unary operator, got %r (2 args)");
GLOBAL_STR(str1284, "-a");
GLOBAL_STR(str1285, "-o");
GLOBAL_STR(str1286, "!");
GLOBAL_STR(str1287, "(");
GLOBAL_STR(str1288, ")");
GLOBAL_STR(str1289, "Expected binary operator, got %r (3 args)");
GLOBAL_STR(str1290, "should be invoked as 'test' (simple_test_builtin)");
GLOBAL_STR(str1291, "]");
GLOBAL_STR(str1292, "missing closing ]");
GLOBAL_STR(str1293, "should only have 3 arguments or fewer (simple_test_builtin)");
GLOBAL_STR(str1294, "!");
GLOBAL_STR(str1295, "(");
GLOBAL_STR(str1296, ")");
GLOBAL_STR(str1297, "(test) ");
GLOBAL_STR(str1298, "(test) ");
...
void InitMem(state::Mem* mem, Dict<Str*, Str*>* environ, Str* version_str) {
  ...
  SetGlobalString(mem, str280, version_str);
  _InitDefaults(mem);
  _InitVarsFromEnv(mem, environ);
  val = mem->GetValue(str281);
...
void InitInteractive(state::Mem* mem) {
  ...
  if (mem->GetValue(str282)->tag_() == value_e::Undef) {
    SetGlobalString(mem, str283, str284);
  }
}
...
Mem::Mem(Str* dollar0, List<Str*>* argv, alloc::Arena* arena, List<state::DebugFrame*>* debug_stack) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Mem)) {
  ...
  this->line_num = Alloc<value::Str>(str285);
...
Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> Mem::_ResolveNameOrRef(Str* name, runtime_asdl::scope_t which_scopes, bool is_setref, List<Str*>* ref_trail) {
  ...
  if (ref_trail == nullptr) {
    ...
    if (list_contains(ref_trail, new_name)) {
      e_die(fmt73(str297->join(ref_trail)));
    }
  }
  ...
  switch (lval->tag_()) {
    case lvalue_e::Named: {
      ...
      if (keyword_id == Id::KW_SetRef) {
        lval->name = str_concat(str298, lval->name);
      }
...
runtime_asdl::value_t* Mem::GetValue(Str* name, runtime_asdl::scope_t which_scopes) {
  ...
  if ((str_equals(name, str309) || str_equals(name, str310))) {
...
Str* PrettyDir(Str* dir_name, Str* home_dir) {
  ...
  if (home_dir != nullptr) {
    if ((str_equals(dir_name, home_dir) or dir_name->startswith(str_concat(home_dir, str327)))) {
      return str_concat(str328, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    StackRoots _for({&c  });
    buf->write(str_equals(c, str331) ? str332 : str333);
  }
  buf->write(str334);
  buf->write(str_repeat(str335, (length - 1)));
  buf->write(str336);
...
void ErrorFormatter::Print_(Str* msg, int span_id) {
  ...
  _PrintWithSpanId(str351, msg, span_id, this->arena, true);
}
...
void ErrorFormatter::PrintMessage(Str* msg, int span_id) {
  ...
  _PrintWithSpanId(str352, msg, span_id, this->arena, false);
}
...
void PrintAst(syntax_asdl::command_t* node, arg_types::main* flag) {
  ...
  if (maybe_str_equals(flag->ast_format, str355)) {
    println_stderr(str356);
  }
  else {
    f = mylib::Stdout();
    afmt = flag->ast_format;
    if ((maybe_str_equals(afmt, str357) || maybe_str_equals(afmt, str358))) {
      ast_f = fmt::DetectConsoleOutput(f);
    }
    else {
      if ((maybe_str_equals(afmt, str359) || maybe_str_equals(afmt, str360))) {
...
void _Attributes::Set(Str* name, runtime_asdl::value_t* val) {
  ...
  name = name->replace(str364, str365);
...
bool SetAttachedBool::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  if (attached_arg != nullptr) {
    if ((str_equals(attached_arg, str381) || str_equals(attached_arg, str382) || str_equals(attached_arg, str383) || str_equals(attached_arg, str384))) {
      b = false;
    }
    else {
      if ((str_equals(attached_arg, str385) || str_equals(attached_arg, str386) || str_equals(attached_arg, str387) || str_equals(attached_arg, str388))) {
        b = true;
      }
      else {
...
bool SetOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str390);
...
bool SetNamedOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str391);
  arg_r->Next();
  arg = arg_r->Peek();
  if (arg == nullptr) {
...
args::_Attributes* Parse(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str395)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if ((len(spec->actions_long) and arg->startswith(str396))) {
      pos = arg->find(str397, 2);
      if (pos == -1) {
        suffix = nullptr;
      ...
      if ((arg->startswith(str399) and len(arg) > 1)) {
        n = len(arg);
        for (int i = 1; i < n; ++i) {
          ch = arg->index(i);
          if (str_equals(ch, str400)) {
            ch = str401;
          }
          if (list_contains(spec->plus_flags, ch)) {
            out->Set(ch, Alloc<value::Str>(str402));
            continue;
          }
        ...
        if ((len(spec->plus_flags) and (arg->startswith(str405) and len(arg) > 1))) {
          n = len(arg);
          for (int i = 1; i < n; ++i) {
            ch = arg->index(i);
            if (list_contains(spec->plus_flags, ch)) {
              out->Set(ch, Alloc<value::Str>(str406));
              continue;
            }
            e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
          }
...
args::_Attributes* ParseLikeEcho(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    chars = arg->slice(1);
    if ((arg->startswith(str409) and len(chars))) {
      done = false;
...
args::_Attributes* ParseMore(flag_spec::_FlagSpecAndMore* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str410)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if (arg->startswith(str411)) {
    ...
    if (((arg->startswith(str413) or arg->startswith(str414)) and len(arg) > 1)) {
      char0 = arg->index(0);
...
int LineLexer::GetSpanIdForEof() {
  int line_id;
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str418, 0);
  }
  else {
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str420, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = Alloc<Token>(id_, span_id, str421);
      return t;
    }
...
lexer::Lexer* ParseContext::MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = Alloc<lexer::LineLexer>(str423, this->arena);
...
GLOBAL_LIST(Str*, 12, POSIX_CLASSES, {str436 COMMA str437 COMMA str438 COMMA str439 COMMA str440 COMMA str441 COMMA str442 COMMA str443 COMMA str444 COMMA str445 COMMA str446 COMMA str447});
Str* RANGE_POINT_TOO_LONG = str448;
int NT_OFFSET = 256;
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw Alloc<NotImplementedError>(str450);
  }
  if (id0 == Id::Op_LBracket) {
    elts = Alloc<List<syntax_asdl::expr_t*>>();
    for (int i = 0; i < n; i += 2) {
  ...
  while (i < n) {
    ...
    if ((prefix and prefix->id == Id::Expr_At)) {
      ...
      if (typ == nullptr) {
        ...
        if ((typ->val != str455 && typ->val != str456)) {
          p_die(fmt110(), typ);
        }
...
syntax_asdl::re_t* Transformer::_NameInRegex(syntax_asdl::Token* negated_tok, syntax_asdl::Token* tok) {
  ...
  val = tok->val;
  if (maybe_str_equals(val, str459)) {
    if (negated_tok) {
      p_die(fmt111(), tok);
    }
    return tok;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((str_equals(tok->val, str464) || str_equals(tok->val, str465) || str_equals(tok->val, str466))) {
        return tok;
      }
...
void AsPosixEre(syntax_asdl::re_t* node, List<Str*>* parts) {
  ...
  if (tag == re_e::Repeat) {
    ...
    if (op_tag == re_repeat_e::Range) {
      ...
      lower = op->lower ? op->lower->val : str483;
      upper = op->upper ? op->upper->val : str484;
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  flag = attrs->attrs;
  tmp_g = flag->get(str512);
  tmp_a = flag->get(str513);
  tmp_A = flag->get(str514);
  ...
  flag_A = (tmp_A and tmp_A->tag_() == value_e::Bool) ? static_cast<value__Bool*>(tmp_A)->b : false;
  tmp_n = flag->get(str515);
  tmp_r = flag->get(str516);
  tmp_x = flag->get(str517);
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if ((maybe_str_equals(flag_n, str519) and !cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_n, str520) and cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str521) and !cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str522) and cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str523) and !cell->exported)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str524) and cell->exported)) {
      continue;
    }
    ...
    if (print_flags) {
      ...
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str531, str532->join(flags), str533, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str534, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (has_holes) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str537, name, str538, str(i), str539, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str541, str542->join(body), str543}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str545, key_quoted, str546, value_quoted}));
          }
          if (len(body) > 0) {
            decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str547, str548->join(body), str549}));
          }
        }
        else {
          ;  // pass
...
int Export::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r->Next();
  attrs = flag_spec::Parse(str551, arg_r);
...
int Readonly::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str556, arg_r);
...
int NewVar::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str557, arg_r);
  ...
  flags = 0;
  if (maybe_str_equals(arg->x, str560)) {
    flags |= state::SetExport;
  }
  if (maybe_str_equals(arg->r, str561)) {
    flags |= state::SetReadOnly;
  }
  if (maybe_str_equals(arg->n, str562)) {
...
int Unset::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str566, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
...
int Eval::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->exec_opts->simple_eval_builtin()) {
    Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str570);
    code_str = tup1.at0();
    eval_spid = tup1.at1();
    if (!arg_r->AtEnd()) {
      e_usage(str571);
    ...
    code_str = str572->join(arg_r->Rest());
    eval_spid = cmd_val->arg_spids->index(0);
  }
  line_reader = reader::StringLineReader(code_str, this->arena);
  c_parser = this->parse_ctx->MakeOshParser(line_reader);
  src = Alloc<source::ArgvWord>(str573, eval_spid);
  {  // with
    dev::ctx_Tracer ctx(this->tracer, str574, nullptr);
...
int Source::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str575, cmd_val);
  arg_r = tup2.at1();
  path = arg_r->Peek();
  if (path == nullptr) {
    e_usage(str576);
  ...
  try {
    try {
      ...
      c_parser = this->parse_ctx->MakeOshParser(line_reader);
      {  // with
        dev::ctx_Tracer ctx(this->tracer, str578, cmd_val->argv);
...
int Command::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup3 = flag_spec::ParseCmdVal(str579, cmd_val);
  attrs = tup3.at0();
  arg_r = tup3.at1();
...
int Builtin::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (to_run == consts::NO_INDEX) {
    ...
    if (consts::LookupAssignBuiltin(name) != consts::NO_INDEX) {
      this->errfmt->Print_(str580, span_id);
    }
    else {
...
int RunProc::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str582, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
  ...
  spids = tup6.at1();
  if (len(argv) == 0) {
    throw Alloc<error::Usage>(str583, runtime::NO_SPID);
  }
  name = argv->index(0);
  if (!dict_contains(this->procs, name)) {
...
int Try::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup7 = flag_spec::ParseCmdVal(str585, cmd_val);
  attrs = tup7.at0();
  arg_r = tup7.at1();
  ...
  if ((arg->allow_status_01 and (status != 0 && status != 1))) {
    if (failure_spid != runtime::NO_SPID) {
      this->errfmt->Print_(str587, failure_spid);
      this->errfmt->StderrLine(str588);
    }
    throw Alloc<error::FatalRuntime>(fmt152(status), spids->index(0), status);
  }
  if (arg->assign != nullptr) {
    var_name = arg->assign;
    if (var_name->startswith(str590)) {
...
List<Tuple2<Str*, Str*>*>* _ResolveNames(List<Str*>* names, Dict<Str*, runtime_asdl::Proc*>* funcs, Dict<Str*, Str*>* aliases, state::SearchPath* search_path) {
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if (dict_contains(funcs, name)) {
      kind = (Alloc<Tuple2<Str*, Str*>>(str591, name));
    }
    else {
      if (dict_contains(aliases, name)) {
        kind = (Alloc<Tuple2<Str*, Str*>>(str592, name));
      }
      else {
        if (consts::LookupNormalBuiltin(name) != 0) {
          kind = (Alloc<Tuple2<Str*, Str*>>(str593, name));
        }
        else {
              ...
              if (consts::IsControlFlow(name)) {
                ...
                if (consts::IsKeyword(name)) {
                  ...
                  if (resolved == nullptr) {
                    ...
                    kind = (Alloc<Tuple2<Str*, Str*>>(str598, resolved));
                  }
                }
              }
            }
...
int Type::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseCmdVal(str599, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  for (ListIter<Tuple2<Str*, Str*>*> it(r); !it.Done(); it.Next()) {
    ...
    if (kind == nullptr) {
      ...
      if (arg->t) {
        ...
        if (arg->p) {
          if (str_equals(kind, str601)) {
            print(name);
          }
        }
        else {
          if (arg->P) {
            if (str_equals(kind, str602)) {
              print(name);
            }
            else {
...
int Read::_Line(arg_types::read* arg, Str* var_name) {
  ...
  if (!arg->with_eol) {
    if (line->endswith(str607)) {
      line = line->slice(0, -2);
    }
    else {
      if (line->endswith(str608)) {
        line = line->slice(0, -1);
      }
    }
  }
  if ((arg->q and line->startswith(str609))) {
    arena = this->parse_ctx->arena;
    line_reader = reader::StringLineReader(line, arena);
    lexer = this->parse_ctx->MakeLexer(line_reader);
    try {
      {  // with
        alloc::ctx_Location ctx(arena, Alloc<source::Stdin>(str610));
...
int Read::_Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str613, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
  ...
  if (arg->line) {
    ...
    next_spid = tup8.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str616, next_spid);
    }
  ...
  if (arg->all) {
    ...
    next_spid = tup10.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str620, next_spid);
    }
...
int MapFile::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup13 = flag_spec::ParseCmdVal(str627, cmd_val);
  attrs = tup13.at0();
  arg_r = tup13.at1();
  ...
  while (true) {
    ...
    if ((arg->t and line->endswith(str631))) {
      line = line->slice(0, -1);
    }
    lines->append(line);
  }
...
int Cd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str632, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  ...
  arg_spid = tup16.at1();
  if (dest_dir == nullptr) {
    val = this->mem->GetValue(str633);
    try {
      dest_dir = state::GetString(this->mem, str634);
    }
    catch (error::Runtime* e) {
  ...
  if (str_equals(dest_dir, str635)) {
    try {
      dest_dir = state::GetString(this->mem, str636);
      print(dest_dir);
    }
    catch (error::Runtime* e) {
      this->errfmt->Print_(e->UserErrorString());
  ...
  try {
    pwd = state::GetString(this->mem, str637);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    return 1;
  ...
  state::ExportGlobalString(this->mem, str639, real_dest_dir);
  ...
  if (block) {
    ...
    state::ExportGlobalString(this->mem, str640, pwd);
...
int Pushd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str646));
  state::ExportGlobalString(this->mem, str647, dest_dir);
...
bool _PopDirStack(state::Mem* mem, state::DirStack* dir_stack, ui::ErrorFormatter* errfmt) {
  ...
  state::SetGlobalString(mem, str650, dest_dir);
  mem->SetPwd(dest_dir);
  return true;
}
...
int Popd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str652));
  return 0;
}
...
int Dirs::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup17 = flag_spec::ParseCmdVal(str653, cmd_val);
  attrs = tup17.at0();
  arg_r = tup17.at1();
  arg = Alloc<arg_types::dirs>(attrs->attrs);
  home_dir = state::MaybeString(this->mem, str654);
  style = SINGLE_LINE;
  if (arg->l) {
    home_dir = nullptr;
  }
...
int Pwd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup18 = flag_spec::ParseCmdVal(str655, cmd_val);
  attrs = tup18.at0();
  arg_r = tup18.at1();
...
List<Str*>* Help::_Groups() {
  ...
  contents = this->loader->Get(str656);
...
int Help::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup19 = flag_spec::ParseCmdVal(str657, cmd_val);
  attrs = tup19.at0();
  arg_r = tup19.at1();
...
syntax_asdl::printf_part_t* _FormatStringParser::_ParseFormatStr() {
  ...
  if ((this->token_type == Id::Format_Type || this->token_type == Id::Format_Time)) {
    ...
    if (str_contains(str664, part->type->val)) {
      p_die(fmt166(), part->type);
    }
    if (maybe_str_equals(part->type->val, str666)) {
    ...
    for (ListIter<syntax_asdl::printf_part_t*> it(parts); !it.Done(); it.Next()) {
      ...
      if (part->tag_() == printf_part_e::Literal) {
        ...
        if (part->tag_() == printf_part_e::Percent) {
          ...
          typ = part->type->val;
          if (str_equals(typ, str677)) {
            if (precision >= 0) {
              s = s->slice(0, precision);
            }
          }
          else {
            if (str_equals(typ, str678)) {
              s = qsn::maybe_shell_encode(s);
            }
            else {
              if (str_equals(typ, str679)) {
                ...
                s = str680->join(c_parts);
              }
              else {
                if ((part->type->id == Id::Format_Time or str_contains(str681, typ))) {
                  try {
                    d = to_int(s);
                  }
                  catch (ValueError*) {
                    if ((len(s) >= 1 and str_contains(str682, s->index(0)))) {
                  ...
                  if (part->type->id == Id::Format_Time) {
                    ...
                    if ((d < 0 and str_contains(str686, typ))) {
                      e_die(fmt173(d, typ), part->type->span_id);
                    }
                    if (str_equals(typ, str688)) {
                      s = mylib::octal(d);
                    }
                    else {
                      if (str_equals(typ, str689)) {
                        s = mylib::hex_lower(d);
                      }
                      else {
                        if (str_equals(typ, str690)) {
                          s = mylib::hex_upper(d);
                        }
                        else {
                          s = str(d);
                    ...
                    zero_pad = 0;
                    if ((width >= 0 and list_contains(flags, str691))) {
                      zero_pad = 1;
                    }
                    else {
                    ...
                    if (zero_pad) {
                      negative = str_equals(s->index(0), str692);
                      if (negative) {
                        digits = s->slice(1);
                        sign = str693;
                        if (zero_pad == 1) {
                      ...
                      s = str_concat(sign, digits->rjust(n, str695));
                    }
                  }
                }
                else {
          ...
          if (width >= 0) {
            if (list_contains(flags, str696)) {
              s = s->ljust(width, str697);
            }
            else {
              s = s->rjust(width, str698);
            }
          }
          out->append(s);
        }
...
int Printf::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup1 = flag_spec::ParseCmdVal(str699, cmd_val);
  attrs = tup1.at0();
  arg_r = tup1.at1();
  arg = Alloc<arg_types::printf>(attrs->attrs);
  Tuple2<Str*, int> tup2 = arg_r->ReadRequired2(str700);
  fmt = tup2.at0();
  fmt_spid = tup2.at1();
  ...
  if (dict_contains(this->parse_cache, fmt)) {
    ...
    {  // with
      alloc::ctx_Location ctx(arena, Alloc<source::ArgvWord>(str701, fmt_spid));
...
int Alias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str703, cmd_val);
  arg_r = tup0.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup1 = mylib::split_once(arg, str705);
    name = tup1.at0();
    alias_exp = tup1.at1();
...
int UnAlias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str708, cmd_val);
  arg_r = tup2.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
    e_usage(str709);
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  arg = flag_spec::ParseMore(str712, arg_r);
  if (arg->show_options) {
...
int Shopt::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str713, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
...
int Hash::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str715, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
...
Dict<Str*, bool>* _ParseOptSpec(Str* spec_str) {
  ...
  while (true) {
    ...
    if (str_equals(spec_str->index(i), str718)) {
      spec->set(ch, true);
      i += 1;
    }
  }
...
int GetOptsState::_OptInd() {
  int result;
  try {
    result = state::GetInteger(this->mem, str719);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    result = -1;
...
void GetOptsState::IncIndex() {
  state::BuiltinSetString(this->mem, str720, str((this->_optind + 1)));
}

void GetOptsState::SetArg(Str* optarg) {
  StackRoots _roots({&optarg});

  state::BuiltinSetString(this->mem, str721, optarg);
}

void GetOptsState::Fail() {
  state::BuiltinSetString(this->mem, str722, str723);
}
...
Tuple2<int, Str*> _GetOpts(Dict<Str*, bool>* spec, List<Str*>* argv, builtin_pure::GetOptsState* my_state, ui::ErrorFormatter* errfmt) {
  ...
  if (current == nullptr) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str724));
  }
  if ((!current->startswith(str725) or str_equals(current, str726))) {
    my_state->Fail();
  ...
  if (!dict_contains(spec, flag_char)) {
    return (Tuple2<int, Str*>(0, str728));
  }
  if (spec->index(flag_char)) {
    if (more_chars) {
      ...
      if (optarg == nullptr) {
        ...
        println_stderr(fmt182(str731->join(tmp)));
        return (Tuple2<int, Str*>(0, str732));
      }
    }
    my_state->IncIndex();
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  spec_str = arg_r->ReadRequired(str734);
  Tuple2<Str*, int> tup7 = arg_r->ReadRequired2(str735);
  var_name = tup7.at0();
  var_spid = tup7.at1();
...
int Echo::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseLikeEcho(str737, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  if (arg->e) {
    ...
    for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
      ...
      new_argv->append(str738->join(parts));
      if (backslash_c) {
        break;
      }
    }
...
int Module::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseCmdVal(str742, cmd_val);
  arg_r = tup11.at1();
  Tuple2<Str*, int> tup12 = arg_r->ReadRequired2(str743);
  name = tup12.at0();
...
int Use::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_spid = tup13.at1();
  if (arg == nullptr) {
    throw Alloc<error::Usage>(str745, runtime::NO_SPID);
  }
  arg_r->Next();
  if (str_equals(arg, str746)) {
    Tuple2<Str*, int> tup14 = arg_r->Peek2();
    expected = tup14.at0();
    e_spid = tup14.at1();
    if (expected == nullptr) {
      throw Alloc<error::Usage>(str747, runtime::NO_SPID);
    }
    UP_actual = this->mem->GetValue(str748, scope_e::Dynamic);
  ...
  throw Alloc<error::Usage>(str753, arg_spid);
}
...
int Shvar::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str754, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  block = typed_args::GetOneBlock(cmd_val->typed_args);
  if (!block) {
  ...
  arg_spids = tup16.at1();
  if (len(args) == 0) {
    throw Alloc<error::Usage>(str756, runtime::NO_SPID);
  }
  i = 0;
  for (ListIter<Str*> it(args); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup17 = mylib::split_once(arg, str757);
    name = tup17.at0();
    s = tup17.at1();
    if (s == nullptr) {
      throw Alloc<error::Usage>(str758, arg_spids->index(i));
    }
  ...
  switch (arg->tag_()) {
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        filename = val->s;
        if (len(filename) == 0) {
          throw Alloc<error::RedirectEval>(str770, arg_word);
        }
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          t = val->s;
          if (len(t) == 0) {
            throw Alloc<error::RedirectEval>(str771, arg_word);
            return nullptr;
          }
          try {
            if (maybe_str_equals(t, str772)) {
              result->arg = Alloc<redirect_arg::CloseFd>();
            }
            else {
              if (str_equals(t->index(-1), str773)) {
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = Alloc<redirect_arg::HereDoc>(str_concat(val->s, str775));
            return result;
          }
          else {
            throw Alloc<AssertionError>();
    ...
    case command_e::ControlFlow: {
      ...
      if (ok) {
        ...
        if (this->exec_opts->strict_control_flow()) {
          ...
          this->errfmt->PrefixPrint(msg, str785, tok->span_id);
          status = 0;
        }
      }
    }
    ...
    {  // with
      ...
      for (ListIter<syntax_asdl::command_t*> it(to_run); !it.Done(); it.Next()) {
        ...
        {  // with
          ...
          {  // with
            dev::ctx_Tracer ctx(this->tracer, str788, nullptr);
      ...
      if (this->shell_ex->PushRedirects(redirects)) {
        {  // with
          ...
          try {
            ...
            this->errfmt->PrettyPrintError(e, str789);
            status = 1;
            check_errexit = true;
          }
        }
...
Tuple2<bool, bool> CommandEvaluator::ExecuteAndCatch(syntax_asdl::command_t* node, int cmd_flags) {
  ...
  try {
    ...
    if ((cmd_flags & RaiseControlFlow)) {
      ...
      if (e->IsReturn()) {
        ...
        this->errfmt->Print_(str790, e->token->span_id);
        is_fatal = true;
        status = 1;
      }
    }
  ...
  if (err) {
    ...
    if (is_errexit) {
      ...
      this->errfmt->PrettyPrintError(err, str791);
    }
  }
...
void CommandEvaluator::MaybeRunExitTrap(List<int>* mut_status) {
  ...
  handler = this->traps->get(str792);
  if (handler) {
    {  // with
      dev::ctx_Tracer ctx(this->tracer, str793, nullptr);
    ...
    if (UP_sig->tag_() == proc_sig_e::Closed) {
      ...
      for (ListIter<syntax_asdl::UntypedParam*> it(sig->untyped); !it.Done(); it.Next(), ++i) {
        ...
        if (i < n_args) {
          ...
          if (is_out_param) {
            param_name = str_concat(str794, param_name);
            if (!arg_str->startswith(str795)) {
...
int CommandEvaluator::RunFuncForCompletion(runtime_asdl::Proc* proc, List<Str*>* argv) {
  ...
  try {
    ...
    this->errfmt->Print_(str800, e->token->span_id);
    status = 1;
  }
  return status;
}
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index(i), str802))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index(-2), str804)) {
    ...
    if ((left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse)) {
      var_name = left_token->val->slice(0, -1);
      if (str_equals(close_token->val->index(-2), str805)) {
        op = assign_op_e::PlusEqual;
      }
      else {
        op = assign_op_e::Equal;
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        var_name = left_token->val->slice(0, -1);
        if (str_equals(close_token->val->index(-2), str806)) {
          op = assign_op_e::PlusEqual;
        }
        else {
          op = assign_op_e::Equal;
        ...
        src = Alloc<source::Reparsed>(str808, left_token->span_id, close_token->span_id);
        {  // with
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    if (str_equals(left_token->val->index(-2), str810)) {
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index(0), str818)) {
    pos = op_val->find(str819);
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    i += 1;
    if (!alias_exp->endswith(str825)) {
      expanded->append(str826);
      break;
    }
  }
  if (len(expanded) == 0) {
  ...
  while (i < n) {
    ...
    expanded->append(str828);
    i += 1;
  }
  code_str = str829->join(expanded);
  line_reader = reader::StringLineReader(code_str, this->arena);
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if (str_equals(c, str855)) {
      i += 1;
    }
    else {
      if ((str_equals(c, str856) or str_equals(c, str857))) {
        return true;
      }
      else {
        if (str_equals(c, str858)) {
          ...
          if ((str_equals(c, str859) and left_bracket)) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  ...
  return pyutil::BackslashEscape(s, str861);
}
Str* ERE_META_CHARS = str862;
...
Str* GlobUnescape(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if ((str_equals(c, str863) and i != (n - 1))) {
      i += 1;
      c2 = s->index(i);
      ...
      if (tag == glob_part_e::Operator) {
        ...
        if (tag == glob_part_e::CharClass) {
          ...
          for (ListIter<Str*> it(part->strs); !it.Done(); it.Next()) {
            Str* s = it.Value();
            StackRoots _for({&s          });
            if (str_equals(s, str881)) {
              literal_hyphen = true;
              continue;
            }
            if (str_equals(s, str882)) {
...
Str* _PromptEvaluatorCache::Get(Str* name) {
  ...
  if (str_equals(name, str890)) {
    value = this->_GetEuid() == 0 ? str891 : str892;
  }
  else {
      ...
      if (id_ == Id::PS_Octal3) {
        ...
        if (id_ == Id::PS_LBrace) {
          ...
          if (id_ == Id::PS_RBrace) {
            ...
            if (id_ == Id::PS_Subst) {
              ch = value->index(1);
              if (str_equals(ch, str897)) {
                r = this->cache->Get(str898);
              }
              else {
                if (str_equals(ch, str899)) {
                  r = this->cache->Get(str900);
                }
                else {
                  if (str_equals(ch, str901)) {
                    hostname = this->cache->Get(str902);
                    Tuple2<Str*, Str*> tup1 = mylib::split_once(hostname, str903);
                    r = tup1.at0();
                  }
                  else {
                    if (str_equals(ch, str904)) {
                      r = this->cache->Get(str905);
                    }
                    else {
                      if (str_equals(ch, str906)) {
                        r = this->lang;
                      }
                      else {
                        if (str_equals(ch, str907)) {
                          ...
                          if (str_equals(ch, str908)) {
                            now = time_::time();
                            r = time_::strftime(str909, time_::localtime(now));
                          }
                          else {
                            if (str_equals(ch, str910)) {
                              ...
                              if (str_equals(ch, str912)) {
                                try {
                                  pwd = state::GetString(this->mem, str913);
                                  home = state::MaybeString(this->mem, str914);
              ...
              ret->append(r->replace(str920, str921));
            }
            else {
              throw Alloc<AssertionError>();
            }
...
Str* Evaluator::EvalFirstPrompt() {
  ...
  if (str_equals(this->lang, str926)) {
    val = this->mem->GetValue(str927);
    return this->EvalPrompt(val);
  }
  else {
    return str_concat(this->lang, str928);
  }
}
Str* PROMPT_COMMAND = str929;
...
runtime_asdl::lvalue_t* UnsafeArith::ParseLValue(Str* s, int span_id) {
  ...
  {  // with
    alloc::ctx_Location ctx(this->arena, Alloc<source::ArgvWord>(str935, span_id));
...
int ArithEvaluator::_StringToInteger(Str* s, int span_id) {
  ...
  if (str_contains(s, str943)) {
    Tuple2<Str*, Str*> tup0 = mylib::split_once(s, str944);
    b = tup0.at0();
    digits = tup0.at1();
    try {
      base = to_int(b);
    ...
    for (StrIter it(digits); !it.Done(); it.Next()) {
      ...
      StackRoots _for({&ch    });
      if (IsLower(ch)) {
        digit = ((ord(ch) - ord(str946)) + 10);
      }
      else {
        if (IsUpper(ch)) {
          digit = ((ord(ch) - ord(str947)) + 36);
        }
        else {
          if (str_equals(ch, str948)) {
            digit = 62;
          }
          else {
            if (str_equals(ch, str949)) {
              digit = 63;
            }
            else {
              if (ch->isdigit()) {
  ...
  if (((val->tag_() == value_e::MaybeStrArray || val->tag_() == value_e::AssocArray) and lval->tag_() == lvalue_e::Named)) {
    ...
    if (word_eval::ShouldArrayDecay(named_lval->name, this->exec_opts)) {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (val->tag_() == value_e::AssocArray) {
          lval = Alloc<lvalue::Keyed>(named_lval->name, str958);
        }
      }
...
split::IfsSplitter* SplitContext::_GetSplitter(Str* ifs) {
  ...
  if (ifs == nullptr) {
    val = this->mem->GetValue(str971, scope_e::Dynamic);
    UP_val = val;
    switch (val->tag_()) {
      case value_e::Undef: {
        ifs = DEFAULT_IFS;
...
_BaseSplitter::_BaseSplitter(Str* escape_chars) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(_BaseSplitter)) {
  this->escape_chars = str_concat(escape_chars, str978);
}
    ...
    if (i < n) {
      ...
      if (str_contains(ws_chars, c)) {
        ...
        if (str_contains(other_chars, c)) {
          ...
          if ((allow_escape and str_equals(c, str979))) {
...
Str* Utf8Encode(int code) {
  ...
  return str982->join(tmp);
}
Str* INCOMPLETE_CHAR = str983;
Str* INVALID_CONT = str984;
Str* INVALID_START = str985;
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Pound) {
    regex = str_concat(str998, regex);
  }
  else {
    if (op->replace_mode == Id::Lit_Percent) {
      regex = str_concat(regex, str999);
    }
  }
...
Str* ShellQuoteB(Str* s) {
  ...
  s = s->replace(str1000, str1001)->replace(str1002, str1003);
  return pyutil::BackslashEscape(s, str1004);
}
...
int QUOTE_ERE = (1 << 6);
GLOBAL_LIST(Str*, 3, _STRING_AND_ARRAY, {str1017 COMMA str1018 COMMA str1019});
...
runtime_asdl::value_t* DecayArray(runtime_asdl::value_t* val) {
  ...
  if (val->tag_() == value_e::MaybeStrArray) {
    ...
    if (val->tag_() == value_e::AssocArray) {
      value__AssocArray* assoc_val = static_cast<value__AssocArray*>(val);
      s = dict_contains(assoc_val->d, str1020) ? assoc_val->d->index(str1021) : nullptr;
    }
    else {
      throw Alloc<AssertionError>();
    }
...
runtime_asdl::assign_arg* _SplitAssignArg(Str* arg, int word_spid) {
  ...
  if (len(op)) {
    ...
    append = str_equals(op->index(0), str1024);
  }
  else {
    val = nullptr;
    append = false;
...
Str* _BackslashEscape(Str* s) {
  ...
  return s->replace(str1025, str1026);
}
...
runtime_asdl::part_value_t* _ValueToPartValue(runtime_asdl::value_t* val, bool quoted) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      return Alloc<part_value::String>(str1027, quoted, !quoted);
    }
      break;
    case value_e::Str: {
      value__Str* val = static_cast<value__Str*>(UP_val);
...
Str* _GetDollarHyphen(optview::Exec* exec_opts) {
  ...
  chars = Alloc<List<Str*>>();
  if (exec_opts->interactive()) {
    chars->append(str1031);
  }
  if (exec_opts->errexit()) {
    chars->append(str1032);
  }
  if (exec_opts->noglob()) {
    chars->append(str1033);
  }
  if (exec_opts->noexec()) {
...
Str* TildeEvaluator::Eval(syntax_asdl::Token* token) {
  ...
  if (maybe_str_equals(token->val, str1039)) {
    val = this->mem->GetValue(str1040);
    UP_val = val;
    if (val->tag_() == value_e::Str) {
      value__Str* val = static_cast<value__Str*>(UP_val);
      return val->s;
    ...
    case value_e::Str: {
      ...
      try {
        ...
        if (this->exec_opts->strict_word_eval()) {
          ...
          this->errfmt->PrettyPrintError(e, str1044);
          return Alloc<value::Str>(str1045);
        }
      }
    }
      break;
...
runtime_asdl::value_t* AbstractWordEvaluator::_Slice(runtime_asdl::value_t* val, syntax_asdl::suffix_op__Slice* op, Str* var_name, syntax_asdl::braced_var_sub* part) {
  ...
  try {
    ...
    if (this->exec_opts->strict_word_eval()) {
      ...
      this->errfmt->PrettyPrintError(e, str1051);
      switch (val->tag_()) {
        case value_e::Str: {
          val = Alloc<value::Str>(str1052);
        }
          break;
        case value_e::MaybeStrArray: {
  ...
  if (op_id == Id::VOp0_P) {
    switch (val->tag_()) {
      case value_e::Str: {
        ...
        p = prompt->replace(str1053, str1054)->replace(str1055, str1056);
    ...
    if (op_id == Id::VOp0_Q) {
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          result = Alloc<value::Str>(str1058->join(tmp));
        }
          break;
        default: {
      ...
      if (op_id == Id::VOp0_a) {
        ...
        switch (val->tag_()) {
          case value_e::MaybeStrArray: {
            chars->append(str1060);
          }
            break;
          case value_e::AssocArray: {
            chars->append(str1061);
          }
            break;
        }
        if (var_name != nullptr) {
        ...
        result = Alloc<value::Str>(str1065->join(chars));
      }
      else {
...
void AbstractWordEvaluator::_EvalDoubleQuoted(List<syntax_asdl::word_part_t*>* parts, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  if (len(parts) == 0) {
    v = Alloc<part_value::String>(str1070, true, false);
    part_vals->append(v);
    return ;
  }
  for (ListIter<syntax_asdl::word_part_t*> it(parts); !it.Done(); it.Next()) {
...
runtime_asdl::value_t* AbstractWordEvaluator::_EmptyStrOrError(runtime_asdl::value_t* val, syntax_asdl::Token* token) {
  ...
  if (!this->exec_opts->nounset()) {
    return Alloc<value::Str>(str1071);
  }
  name = token->val->startswith(str1072) ? token->val->slice(1) : token->val;
...
void AbstractWordEvaluator::_EvalExtGlob(syntax_asdl::word_part__ExtGlob* part, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  for (ListIter<syntax_asdl::compound_word*> it(part->arms); !it.Done(); it.Next(), ++i) {
    ...
    StackRoots _for({&w  });
    if (i != 0) {
      part_vals->append(Alloc<part_value::String>(str1083, false, false));
    }
    this->_EvalWordToParts(w, part_vals, EXTGLOB_NESTED);
  }
  part_vals->append(Alloc<part_value::String>(str1084, false, false));
}
    ...
    case word_e::Compound: {
      ...
      if (has_extglob) {
        if (to_bool((eval_flags & EXTGLOB_FILES))) {
          ...
          glob_pat = str1090->join(glob_parts);
          fnmatch_pat = str1091->join(fnmatch_parts);
          results = Alloc<List<Str*>>();
      ...
      break;
    case word_e::Empty: {
      part_vals->append(Alloc<part_value::String>(str1094, quoted, !quoted));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, int eval_flags) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return Alloc<value::Str>(str1098);
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  part_vals = Alloc<List<runtime_asdl::part_value_t*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
  ...
  return Alloc<value::Str>(str1099->join(strs));
}
...
Tuple2<runtime_asdl::value__Str*, bool> AbstractWordEvaluator::EvalWordToPattern(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return (Tuple2<runtime_asdl::value__Str*, bool>(Alloc<value::Str>(str1100), false));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  has_extglob = false;
  part_vals = Alloc<List<runtime_asdl::part_value_t*>>();
  ...
  return (Tuple2<runtime_asdl::value__Str*, bool>(Alloc<value::Str>(str1101->join(strs)), has_extglob));
}
...
runtime_asdl::value_t* AbstractWordEvaluator::EvalRhsWord(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return Alloc<value::Str>(str1105);
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  if (len(w->parts) == 1) {
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index(-2), str1112)) {
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        StackRoots _for({&arg      });
        if ((arg->startswith(str1113) or arg->startswith(str1114))) {
          flags->append(arg);
          flag_spids->append(word_spid);
          if ((str_contains(arg, str1115) or str_contains(arg, str1116))) {
            eval_to_pairs = false;
          }
        }
        else {
...
runtime_asdl::part_value__String* CompletionWordEvaluator::_EvalProcessSub(syntax_asdl::command_sub* cs_part) {
  ...
  return Alloc<part_value::String>(str1120, true, false);
}
          ...
          if (op_kind == Kind::VOp2) {
            if (this->token_type == Id::VOp2_Slash) {
              ...
              if (this->token_type == Id::VOp2_Colon) {
                ...
                p_die(fmt328(str1132), this->cur_token);
              }
            }
          }
          else {
            if (op_kind == Kind::VOp3) {
              if (allow_query) {
                ...
                p_die(fmt329(str1134), this->cur_token);
              }
            }
          }
        }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool is_oil_expr) {
  ...
  while (num_end_tokens < expected_end_tokens) {
    ...
    if ((this->token_kind == Kind::Lit || this->token_kind == Kind::Char)) {
      tok = this->cur_token;
      if ((no_backslashes and str_contains(tok->val, str1139))) {
        p_die(fmt334(), tok);
      }
      if (is_oil_expr) {
...
syntax_asdl::word_part_t* WordParser::_ReadUnquotedLeftParts(bool try_triple_quote, List<bool>* triple_out) {
  ...
  if ((this->token_type == Id::Left_DoubleQuote || this->token_type == Id::Left_DollarDoubleQuote)) {
    ...
    if ((try_triple_quote and len(dq_part->parts) == 0)) {
      if (str_equals(this->lexer->ByteLookAhead(), str1145)) {
  ...
  if ((this->token_type == Id::Left_SingleQuote || this->token_type == Id::Left_RSingleQuote || this->token_type == Id::Left_DollarSingleQuote)) {
    ...
    if ((try_triple_quote and len(sq_part->tokens) == 0)) {
      if (str_equals(this->lexer->ByteLookAhead(), str1146)) {
        this->_Next(lex_mode_e::ShCommand);
        this->_Peek();
  ...
  if ((left_id == Id::Left_DollarParen || left_id == Id::Left_AtParen || left_id == Id::Left_ProcSubIn || left_id == Id::Left_ProcSubOut)) {
    ...
    if ((left_id == Id::Left_Backtick and this->parse_ctx->one_pass_parse)) {
      ...
      if (left_id == Id::Left_Backtick) {
        ...
        right_spid = this->cur_token->span_id;
        code_str = str1154->join(parts);
        arena = this->parse_ctx->arena;
        line_reader = reader::StringLineReader(code_str, arena);
        c_parser = this->parse_ctx->MakeOshParser(line_reader);
        src = Alloc<source::Reparsed>(str1155, left_spid, right_spid);
        {  // with
          alloc::ctx_Location ctx(arena, src);
            ...
            if (this->token_type == Id::Lit_Dollar) {
              if (!this->parse_opts->parse_dollar()) {
                if ((num_parts == 0 and lex_mode == lex_mode_e::ShCommand)) {
                  ...
                  if (str_equals(next_byte, str1171)) {
          ...
          if ((this->token_kind == Kind::VSub || this->token_kind == Kind::Lit || this->token_kind == Kind::History || this->token_kind == Kind::Left || this->token_kind == Kind::KW || this->token_kind == Kind::ControlFlow || this->token_kind == Kind::BoolUnary || this->token_kind == Kind::BoolBinary || this->token_kind == Kind::ExtGlob)) {
            if (this->token_type == Id::Lit_Pound) {
              ...
              if (this->token_type == Id::Lit_TPound) {
                ...
                if ((this->parse_opts->parse_raw_string() and (this->token_type == Id::Lit_Chars and maybe_str_equals(this->cur_token->val, str1179)))) {
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1184, false));
    }
      break;
    case word_part_e::AssocArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1185, false));
    }
      break;
    case word_part_e::Literal: {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str1187, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str1188->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
    ...
    case word_part_e::FuncCall: 
    case word_part_e::ExprSub: {
      return (Tuple3<bool, Str*, bool>(false, str1189, false));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() != word_e::Compound) {
    return (Tuple3<bool, Str*, bool>(false, str1190, quoted));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  strs = Alloc<List<Str*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str1191, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str1192->join(strs), quoted));
}
...
syntax_asdl::compound_word* TildeDetect(syntax_asdl::word_t* UP_w) {
  ...
  if ((id_ == Id::Lit_Chars and static_cast<Token*>(part1)->val->startswith(str1194))) {
    new_parts->extend(w->parts->slice(1));
    return Alloc<compound_word>(new_parts);
  }
  return nullptr;
...
void TildeDetectAssign(syntax_asdl::compound_word* w) {
  ...
  for (int i = 0; i < n; ++i) {
    ...
    if ((do_expand and LiteralId(cur) == Id::Lit_TildeLike)) {
      ...
      if (next_part) {
        is_tilde = (LiteralId(next_part) == Id::Lit_Colon or (LiteralId(next_part) == Id::Lit_Chars and static_cast<Token*>(next_part)->val->startswith(str1195)));
      }
      else {
        is_tilde = true;
      }
...
Str* escape(Str* s) {
  ...
  s = s->replace(str1205, str1206);
  s = s->replace(str1207, str1208);
  s = s->replace(str1209, str1210);
  return s;
}
...
Str* join(Str* s1, Str* s2) {
  ...
  if ((s2->startswith(str1213) or len(s1) == 0)) {
    return s2;
  }
  if (s1->endswith(str1214)) {
...
Tuple2<Str*, Str*> _splitext(Str* p, Str* sep, Str* extsep) {
  ...
  return (Tuple2<Str*, Str*>(p, str1217));
}
...
Str* normpath(Str* path) {
  ...
  slash = str1220;
  dot = str1221;
  if (str_equals(path, str1222)) {
    return dot;
  }
  initial_slashes = path->startswith(str1223);
  if ((initial_slashes and (path->startswith(str1224) and !path->startswith(str1225)))) {
    initial_slashes = 2;
  }
  comps = path->split(str1226);
  new_comps = Alloc<List<Str*>>();
  for (ListIter<Str*> it(comps); !it.Done(); it.Next()) {
    Str* comp = it.Value();
    StackRoots _for({&comp  });
    if ((len(comp) == 0 or str_equals(comp, str1227))) {
      continue;
    }
    if ((!(str_equals(comp, str1228)) or ((initial_slashes == 0 and len(new_comps) == 0) or (len(new_comps) and str_equals(new_comps->index(-1), str1229))))) {
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if ((str_contains(str1236, ch) or IsUnprintableLow(ch))) {
        quote = 2;
        break;
      }
    }
  ...
  parts->append(str1239);
  return str_concat(prefix, str1240->join(parts));
}
...
void _encode_bytes_x(Str* s, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (str_equals(byte, str1247)) {
      part = str1248;
    }
    else {
      if (str_equals(byte, str1249)) {
        part = str1250;
      }
      else {
        if (str_equals(byte, str1251)) {
          part = str1252;
        }
        else {
          if (str_equals(byte, str1253)) {
            part = str1254;
          }
          else {
            if (str_equals(byte, str1255)) {
              ...
              if (str_equals(byte, str1257)) {
                part = shell_compat ? str1258 : str1259;
              }
              else {
    ...
    if (typ == Ascii) {
      ...
      if (str_equals(byte, str1263)) {
        ...
        if (str_equals(byte, str1265)) {
          ...
          if (str_equals(byte, str1267)) {
            out = str1268;
          }
          else {
            if (str_equals(byte, str1269)) {
              out = str1270;
            }
            else {
              if (str_equals(byte, str1271)) {
                ...
                if (str_equals(byte, str1273)) {
                  out = shell_compat ? str1274 : str1275;
                }
                else {
                  if (IsUnprintableLow(byte)) {
...
syntax_asdl::word__String* _StringWordEmitter::ReadWord(types_asdl::lex_mode_t unused_lex_mode) {
  ...
  if (this->i == this->n) {
    w = Alloc<word::String>(Id::Eof_Real, str1276, runtime::NO_SPID);
    return w;
  }
...
syntax_asdl::bool_expr_t* _TwoArgs(builtin_bracket::_StringWordEmitter* w_parser) {
  ...
  w1 = w_parser->Read();
  s0 = w0->s;
  if (maybe_str_equals(s0, str1277)) {
    return Alloc<bool_expr::LogicalNot>(Alloc<bool_expr::WordTest>(w1));
  }
  unary_id = Id::Undefined_Tok;
  if (w0->s->startswith(str1278)) {
    if (maybe_str_equals(s0, str1279)) {
      ...
      if (maybe_str_equals(s0, str1280)) {
        ...
        if (maybe_str_equals(s0, str1281)) {
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    ...
    strs = cmd_val->argv;
    if ((!strs or !(str_equals(strs->index(-1), str1291)))) {
      this->errfmt->Print_(str1292, cmd_val->arg_spids->index(0));
      return 2;
    }
    cmd_val->argv->pop();
  ...
  try {
    ...
    if (n == 4) {
      a0 = w_parser->Peek(0);
      if (str_equals(a0, str1294)) {
        w_parser->Read();
        child = _ThreeArgs(w_parser);
        bool_node = Alloc<bool_expr::LogicalNot>(child);
      }
      else {
        if ((str_equals(a0, str1295) and str_equals(w_parser->Peek(3), str1296))) {
          w_parser->Read();
          bool_node = _TwoArgs(w_parser);
        }
        else {
    ...
    this->errfmt->PrettyPrintError(e, str1297);
    return 2;
  }
  ...
  try {
    ...
    this->errfmt->PrettyPrintError(e, str1298);
    return 2;
  }
  status = b ? 0 : 1;
  return status;

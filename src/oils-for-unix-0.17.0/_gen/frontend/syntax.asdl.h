...
class command__Func : public command_t {
 public:
  command__Func(Token* keyword, Token* name, List<Param*>* pos_params, Token*
                pos_splat, List<Param*>* named_params, Token* named_splat,
                command_t* body)
      : keyword(keyword),
        name(name),
...
class command__TeaFunc : public command_t {
 public:
  command__TeaFunc(Token* name, List<Param*>* pos_params, Token* pos_splat,

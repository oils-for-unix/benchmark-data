...
GLOBAL_STR(gVersion, "0.31.0");

GLOBAL_LIST(STRICT_ALL, int, 12, {39 COMMA 40 COMMA 41 COMMA 42 COMMA 43 COMMA 44 COMMA 48 COMMA 45 COMMA 37 COMMA 38 COMMA 47 COMMA 46});
GLOBAL_LIST(YSH_UPGRADE, int, 26, {60 COMMA 59 COMMA 65 COMMA 1 COMMA 67 COMMA 4 COMMA 66 COMMA 2 COMMA 5 COMMA 49 COMMA 52 COMMA 53 COMMA 54 COMMA 51 COMMA 55 COMMA 50 COMMA 57 COMMA 56 COMMA 3 COMMA 61 COMMA 64 COMMA 58 COMMA 6 COMMA 7 COMMA 63 COMMA 62});
GLOBAL_LIST(YSH_ALL, int, 54, {60 COMMA 59 COMMA 65 COMMA 1 COMMA 83 COMMA 67 COMMA 4 COMMA 66 COMMA 78 COMMA 79 COMMA 2 COMMA 5 COMMA 49 COMMA 68 COMMA 69 COMMA 70 COMMA 76 COMMA 52 COMMA 53 COMMA 75 COMMA 71 COMMA 74 COMMA 54 COMMA 51 COMMA 72 COMMA 55 COMMA 50 COMMA 73 COMMA 57 COMMA 77 COMMA 56 COMMA 3 COMMA 61 COMMA 64 COMMA 80 COMMA 81 COMMA 82 COMMA 58 COMMA 39 COMMA 40 COMMA 41 COMMA 42 COMMA 43 COMMA 44 COMMA 48 COMMA 45 COMMA 37 COMMA 38 COMMA 47 COMMA 46 COMMA 6 COMMA 7 COMMA 63 COMMA 62});
GLOBAL_LIST(DEFAULT_TRUE, int, 17, {28 COMMA 29 COMMA 59 COMMA 30 COMMA 83 COMMA 18 COMMA 19 COMMA 69 COMMA 70 COMMA 76 COMMA 75 COMMA 71 COMMA 74 COMMA 72 COMMA 73 COMMA 77 COMMA 63});
GLOBAL_LIST(PARSE_OPTION_NUMS, int, 22, {83 COMMA 49 COMMA 68 COMMA 69 COMMA 70 COMMA 76 COMMA 52 COMMA 53 COMMA 75 COMMA 71 COMMA 74 COMMA 54 COMMA 51 COMMA 72 COMMA 55 COMMA 50 COMMA 73 COMMA 57 COMMA 77 COMMA 56 COMMA 37 COMMA 38});
GLOBAL_LIST(SHOPT_OPTION_NUMS, int, 106, {28 COMMA 29 COMMA 35 COMMA 36 COMMA 34 COMMA 33 COMMA 88 COMMA 89 COMMA 90 COMMA 91 COMMA 92 COMMA 93 COMMA 94 COMMA 87 COMMA 60 COMMA 95 COMMA 59 COMMA 96 COMMA 97 COMMA 23 COMMA 30 COMMA 65 COMMA 25 COMMA 98 COMMA 83 COMMA 24 COMMA 21 COMMA 99 COMMA 20 COMMA 67 COMMA 100 COMMA 101 COMMA 102 COMMA 103 COMMA 86 COMMA 104 COMMA 105 COMMA 85 COMMA 106 COMMA 26 COMMA 27 COMMA 4 COMMA 66 COMMA 107 COMMA 19 COMMA 108 COMMA 109 COMMA 110 COMMA 111 COMMA 112 COMMA 113 COMMA 78 COMMA 79 COMMA 114 COMMA 22 COMMA 5 COMMA 49 COMMA 68 COMMA 69 COMMA 70 COMMA 76 COMMA 52 COMMA 53 COMMA 75 COMMA 71 COMMA 74 COMMA 54 COMMA 51 COMMA 72 COMMA 55 COMMA 50 COMMA 73 COMMA 57 COMMA 77 COMMA 56 COMMA 61 COMMA 84 COMMA 115 COMMA 116 COMMA 31 COMMA 32 COMMA 117 COMMA 118 COMMA 64 COMMA 80 COMMA 81 COMMA 82 COMMA 58 COMMA 119 COMMA 39 COMMA 40 COMMA 41 COMMA 42 COMMA 43 COMMA 44 COMMA 48 COMMA 45 COMMA 37 COMMA 38 COMMA 47 COMMA 46 COMMA 6 COMMA 7 COMMA 120 COMMA 63 COMMA 62});
...
GLOBAL_LIST(VISIBLE_SHOPT_NUMS, int, 71, {28 COMMA 29 COMMA 35 COMMA 36 COMMA 34 COMMA 33 COMMA 60 COMMA 59 COMMA 23 COMMA 30 COMMA 65 COMMA 25 COMMA 83 COMMA 24 COMMA 21 COMMA 20 COMMA 67 COMMA 85 COMMA 26 COMMA 27 COMMA 4 COMMA 66 COMMA 19 COMMA 78 COMMA 79 COMMA 22 COMMA 5 COMMA 49 COMMA 68 COMMA 69 COMMA 70 COMMA 76 COMMA 52 COMMA 53 COMMA 75 COMMA 71 COMMA 74 COMMA 54 COMMA 51 COMMA 72 COMMA 55 COMMA 50 COMMA 73 COMMA 57 COMMA 77 COMMA 56 COMMA 61 COMMA 84 COMMA 31 COMMA 32 COMMA 64 COMMA 80 COMMA 81 COMMA 82 COMMA 58 COMMA 39 COMMA 40 COMMA 41 COMMA 42 COMMA 43 COMMA 44 COMMA 48 COMMA 45 COMMA 37 COMMA 38 COMMA 47 COMMA 46 COMMA 6 COMMA 7 COMMA 63 COMMA 62});
...
option_asdl::option_t OptionNum(BigStr* s) {
  ...
  switch (data[0]) {
  case '_':
    if (length == 18 && memcmp("_allow_command_sub", data, 18) == 0) return 28;
    if (length == 18 && memcmp("_allow_process_sub", data, 18) == 0) return 29;
    if (length == 13 && memcmp("_running_trap", data, 13) == 0) return 33;
    if (length == 12 && memcmp("_running_hay", data, 12) == 0) return 34;
    if (length == 14 && memcmp("_no_debug_trap", data, 14) == 0) return 35;
    if (length == 12 && memcmp("_no_err_trap", data, 12) == 0) return 36;
    break;
  case 'c':
    if (length == 19 && memcmp("command_sub_errexit", data, 19) == 0) return 60;
    break;
  case 'd':
    if (length == 7 && memcmp("dotglob", data, 7) == 0) return 23;
    if (length == 13 && memcmp("dynamic_scope", data, 13) == 0) return 30;
    if (length == 8 && memcmp("dashglob", data, 8) == 0) return 59;
    break;
  case 'e':
    ...
    if (length == 7 && memcmp("env_obj", data, 7) == 0) return 65;
    if (length == 14 && memcmp("expand_aliases", data, 14) == 0) return 83;
    break;
  case 'f':
    if (length == 8 && memcmp("failglob", data, 8) == 0) return 20;
    if (length == 15 && memcmp("for_loop_frames", data, 15) == 0) return 67;
    break;
  case 'h':
    if (length == 7 && memcmp("hashall", data, 7) == 0) return 18;
    if (length == 12 && memcmp("hostcomplete", data, 12) == 0) return 85;
    break;
  case 'i':
    ...
    if (length == 16 && memcmp("init_ysh_globals", data, 16) == 0) return 66;
    break;
  case 'l':
  ...
  case 'n':
    ...
    if (length == 11 && memcmp("no_exported", data, 11) == 0) return 78;
    if (length == 15 && memcmp("no_init_globals", data, 15) == 0) return 79;
    break;
  case 'p':
    if (length == 8 && memcmp("pipefail", data, 8) == 0) return 3;
    if (length == 5 && memcmp("posix", data, 5) == 0) return 14;
    if (length == 8 && memcmp("parse_at", data, 8) == 0) return 49;
    if (length == 10 && memcmp("parse_proc", data, 10) == 0) return 50;
    if (length == 10 && memcmp("parse_func", data, 10) == 0) return 51;
    if (length == 11 && memcmp("parse_brace", data, 11) == 0) return 52;
    if (length == 13 && memcmp("parse_bracket", data, 13) == 0) return 53;
    if (length == 12 && memcmp("parse_equals", data, 12) == 0) return 54;
    if (length == 11 && memcmp("parse_paren", data, 11) == 0) return 55;
    if (length == 16 && memcmp("parse_ysh_string", data, 16) == 0) return 56;
    if (length == 18 && memcmp("parse_triple_quote", data, 18) == 0) return 57;
    if (length == 16 && memcmp("process_sub_fail", data, 16) == 0) return 61;
    if (length == 12 && memcmp("parse_at_all", data, 12) == 0) return 68;
    if (length == 15 && memcmp("parse_backslash", data, 15) == 0) return 69;
    if (length == 15 && memcmp("parse_backticks", data, 15) == 0) return 70;
    if (length == 12 && memcmp("parse_dollar", data, 12) == 0) return 71;
    if (length == 13 && memcmp("parse_ignored", data, 13) == 0) return 72;
    if (length == 14 && memcmp("parse_sh_arith", data, 14) == 0) return 73;
    if (length == 12 && memcmp("parse_dparen", data, 12) == 0) return 74;
    if (length == 14 && memcmp("parse_dbracket", data, 14) == 0) return 75;
    if (length == 15 && memcmp("parse_bare_word", data, 15) == 0) return 76;
    if (length == 15 && memcmp("parse_word_join", data, 15) == 0) return 77;
    if (length == 8 && memcmp("progcomp", data, 8) == 0) return 84;
    break;
  case 'r':
    if (length == 14 && memcmp("redefine_const", data, 14) == 0) return 31;
    if (length == 15 && memcmp("redefine_source", data, 15) == 0) return 32;
    break;
  case 's':
    if (length == 19 && memcmp("strict_parse_equals", data, 19) == 0) return 37;
    if (length == 18 && memcmp("strict_parse_slice", data, 18) == 0) return 38;
    if (length == 11 && memcmp("strict_argv", data, 11) == 0) return 39;
    if (length == 12 && memcmp("strict_arith", data, 12) == 0) return 40;
    if (length == 12 && memcmp("strict_array", data, 12) == 0) return 41;
    if (length == 19 && memcmp("strict_control_flow", data, 19) == 0) return 42;
    if (length == 18 && memcmp("strict_env_binding", data, 18) == 0) return 43;
    if (length == 14 && memcmp("strict_errexit", data, 14) == 0) return 44;
    if (length == 14 && memcmp("strict_nameref", data, 14) == 0) return 45;
    if (length == 16 && memcmp("strict_word_eval", data, 16) == 0) return 46;
    if (length == 12 && memcmp("strict_tilde", data, 12) == 0) return 47;
    if (length == 11 && memcmp("strict_glob", data, 11) == 0) return 48;
    if (length == 16 && memcmp("simple_word_eval", data, 16) == 0) return 58;
    if (length == 17 && memcmp("sigpipe_status_ok", data, 17) == 0) return 64;
    if (length == 11 && memcmp("simple_echo", data, 11) == 0) return 80;
    if (length == 19 && memcmp("simple_eval_builtin", data, 19) == 0) return 81;
    if (length == 19 && memcmp("simple_test_builtin", data, 19) == 0) return 82;
    break;
  case 'v':
  ...
  case 'x':
    ...
    if (length == 11 && memcmp("xtrace_rich", data, 11) == 0) return 62;
    if (length == 14 && memcmp("xtrace_details", data, 14) == 0) return 63;
    break;
  }
...
option_asdl::option_t UnimplOptionNum(BigStr* s) {
  ...
  switch (data[0]) {
  case 'a':
    if (length == 17 && memcmp("assoc_expand_once", data, 17) == 0) return 88;
    if (length == 6 && memcmp("autocd", data, 6) == 0) return 89;
    break;
  case 'c':
    if (length == 7 && memcmp("cmdhist", data, 7) == 0) return 87;
    if (length == 11 && memcmp("cdable_vars", data, 11) == 0) return 90;
    if (length == 7 && memcmp("cdspell", data, 7) == 0) return 91;
    if (length == 9 && memcmp("checkhash", data, 9) == 0) return 92;
    if (length == 9 && memcmp("checkjobs", data, 9) == 0) return 93;
    if (length == 12 && memcmp("checkwinsize", data, 12) == 0) return 94;
    if (length == 18 && memcmp("complete_fullquote", data, 18) == 0) return 95;
    break;
  case 'd':
    if (length == 9 && memcmp("direxpand", data, 9) == 0) return 96;
    if (length == 8 && memcmp("dirspell", data, 8) == 0) return 97;
    break;
  case 'e':
    if (length == 8 && memcmp("execfail", data, 8) == 0) return 98;
    if (length == 8 && memcmp("extquote", data, 8) == 0) return 99;
    break;
  case 'f':
    if (length == 13 && memcmp("force_fignore", data, 13) == 0) return 100;
    break;
  case 'g':
    if (length == 15 && memcmp("globasciiranges", data, 15) == 0) return 101;
    if (length == 8 && memcmp("globstar", data, 8) == 0) return 102;
    if (length == 10 && memcmp("gnu_errfmt", data, 10) == 0) return 103;
    break;
  case 'h':
    if (length == 10 && memcmp("histappend", data, 10) == 0) return 86;
    if (length == 10 && memcmp("histreedit", data, 10) == 0) return 104;
    if (length == 10 && memcmp("histverify", data, 10) == 0) return 105;
    if (length == 9 && memcmp("huponexit", data, 9) == 0) return 106;
    break;
  case 'i':
    if (length == 20 && memcmp("interactive_comments", data, 20) == 0) return 107;
    break;
  case 'l':
    if (length == 7 && memcmp("lithist", data, 7) == 0) return 108;
    if (length == 16 && memcmp("localvar_inherit", data, 16) == 0) return 109;
    if (length == 14 && memcmp("localvar_unset", data, 14) == 0) return 110;
    if (length == 11 && memcmp("login_shell", data, 11) == 0) return 111;
    break;
  case 'm':
    if (length == 8 && memcmp("mailwarn", data, 8) == 0) return 112;
    break;
  case 'n':
    if (length == 23 && memcmp("no_empty_cmd_completion", data, 23) == 0) return 113;
    if (length == 10 && memcmp("nocaseglob", data, 10) == 0) return 114;
    break;
  case 'p':
    if (length == 14 && memcmp("progcomp_alias", data, 14) == 0) return 115;
    if (length == 10 && memcmp("promptvars", data, 10) == 0) return 116;
    break;
  case 'r':
    if (length == 16 && memcmp("restricted_shell", data, 16) == 0) return 117;
    break;
  case 's':
    if (length == 13 && memcmp("shift_verbose", data, 13) == 0) return 118;
    if (length == 10 && memcmp("sourcepath", data, 10) == 0) return 119;
    break;
  case 'x':
    if (length == 8 && memcmp("xpg_echo", data, 8) == 0) return 120;
    break;
  }
...
builtin_t LookupNormalBuiltin(BigStr* s) {
  ...
  switch (data[0]) {
  case '[':
    if (length == 1 && memcmp("[", data, 1) == 0) return 77;
    break;
  case '_':
    if (length == 5 && memcmp("__cat", data, 5) == 0) return 81;
    break;
  case 'a':
    if (length == 6 && memcmp("assert", data, 6) == 0) return 19;
    if (length == 5 && memcmp("alias", data, 5) == 0) return 54;
    if (length == 6 && memcmp("append", data, 6) == 0) return 57;
    break;
  case 'b':
    if (length == 5 && memcmp("break", data, 5) == 0) return 20;
    if (length == 2 && memcmp("bg", data, 2) == 0) return 40;
    if (length == 7 && memcmp("builtin", data, 7) == 0) return 48;
    if (length == 4 && memcmp("bind", data, 4) == 0) return 56;
    if (length == 10 && memcmp("boolstatus", data, 10) == 0) return 75;
    break;
  case 'c':
    if (length == 8 && memcmp("continue", data, 8) == 0) return 21;
    if (length == 2 && memcmp("cd", data, 2) == 0) return 29;
    ...
    if (length == 3 && memcmp("ctx", data, 3) == 0) return 72;
    break;
  case 'd':
    if (length == 4 && memcmp("dirs", data, 4) == 0) return 32;
    break;
  case 'e':
    if (length == 6 && memcmp("extern", data, 6) == 0) return 15;
    if (length == 4 && memcmp("exit", data, 4) == 0) return 23;
    if (length == 4 && memcmp("echo", data, 4) == 0) return 25;
    if (length == 5 && memcmp("error", data, 5) == 0) return 65;
    break;
  case 'f':
    if (length == 5 && memcmp("false", data, 5) == 0) return 17;
    if (length == 2 && memcmp("fg", data, 2) == 0) return 39;
    if (length == 6 && memcmp("failed", data, 6) == 0) return 66;
    if (length == 4 && memcmp("fork", data, 4) == 0) return 67;
    if (length == 8 && memcmp("forkwait", data, 8) == 0) return 68;
    if (length == 5 && memcmp("fopen", data, 5) == 0) return 70;
    break;
  case 'g':
  ...
  case 'h':
    ...
    if (length == 3 && memcmp("hay", data, 3) == 0) return 62;
    if (length == 7 && memcmp("haynode", data, 7) == 0) return 63;
    break;
  case 'i':
    if (length == 6 && memcmp("invoke", data, 6) == 0) return 73;
    if (length == 7 && memcmp("is-main", data, 7) == 0) return 80;
    break;
  case 'j':
    if (length == 4 && memcmp("jobs", data, 4) == 0) return 38;
    if (length == 4 && memcmp("json", data, 4) == 0) return 59;
    if (length == 5 && memcmp("json8", data, 5) == 0) return 60;
    break;
  case 'm':
    if (length == 7 && memcmp("mapfile", data, 7) == 0) return 27;
    break;
  case 'p':
    if (length == 6 && memcmp("printf", data, 6) == 0) return 26;
    ...
    if (length == 2 && memcmp("pp", data, 2) == 0) return 61;
    if (length == 14 && memcmp("push-registers", data, 14) == 0) return 78;
    break;
  case 'r':
    if (length == 6 && memcmp("return", data, 6) == 0) return 22;
    if (length == 4 && memcmp("read", data, 4) == 0) return 24;
    if (length == 9 && memcmp("readarray", data, 9) == 0) return 28;
    if (length == 5 && memcmp("redir", data, 5) == 0) return 69;
    if (length == 7 && memcmp("runproc", data, 7) == 0) return 74;
    break;
  case 's':
    if (length == 6 && memcmp("source", data, 6) == 0) return 34;
    if (length == 5 && memcmp("shopt", data, 5) == 0) return 41;
    if (length == 5 && memcmp("shvar", data, 5) == 0) return 71;
    if (length == 12 && memcmp("source-guard", data, 12) == 0) return 79;
    break;
  case 't':
    ...
    if (length == 4 && memcmp("test", data, 4) == 0) return 76;
    break;
  case 'u':
    if (length == 5 && memcmp("umask", data, 5) == 0) return 35;
    if (length == 6 && memcmp("ulimit", data, 6) == 0) return 36;
    if (length == 7 && memcmp("unalias", data, 7) == 0) return 55;
    if (length == 3 && memcmp("use", data, 3) == 0) return 64;
    break;
  case 'w':
    if (length == 4 && memcmp("wait", data, 4) == 0) return 37;
    if (length == 5 && memcmp("write", data, 5) == 0) return 58;
    break;
  }
...
builtin_t LookupPrivateBuiltin(BigStr* s) {
  ...
  switch (data[0]) {
  case 's':
    if (length == 5 && memcmp("sleep", data, 5) == 0) return 82;
    break;
  }
...
GLOBAL_STR(kOptionName_28, "_allow_command_sub");
GLOBAL_STR(kOptionName_29, "_allow_process_sub");
GLOBAL_STR(kOptionName_30, "dynamic_scope");
GLOBAL_STR(kOptionName_31, "redefine_const");
GLOBAL_STR(kOptionName_32, "redefine_source");
GLOBAL_STR(kOptionName_33, "_running_trap");
GLOBAL_STR(kOptionName_34, "_running_hay");
GLOBAL_STR(kOptionName_35, "_no_debug_trap");
GLOBAL_STR(kOptionName_36, "_no_err_trap");
GLOBAL_STR(kOptionName_37, "strict_parse_equals");
GLOBAL_STR(kOptionName_38, "strict_parse_slice");
GLOBAL_STR(kOptionName_39, "strict_argv");
GLOBAL_STR(kOptionName_40, "strict_arith");
GLOBAL_STR(kOptionName_41, "strict_array");
GLOBAL_STR(kOptionName_42, "strict_control_flow");
GLOBAL_STR(kOptionName_43, "strict_env_binding");
GLOBAL_STR(kOptionName_44, "strict_errexit");
GLOBAL_STR(kOptionName_45, "strict_nameref");
GLOBAL_STR(kOptionName_46, "strict_word_eval");
GLOBAL_STR(kOptionName_47, "strict_tilde");
GLOBAL_STR(kOptionName_48, "strict_glob");
GLOBAL_STR(kOptionName_49, "parse_at");
GLOBAL_STR(kOptionName_50, "parse_proc");
GLOBAL_STR(kOptionName_51, "parse_func");
GLOBAL_STR(kOptionName_52, "parse_brace");
GLOBAL_STR(kOptionName_53, "parse_bracket");
GLOBAL_STR(kOptionName_54, "parse_equals");
GLOBAL_STR(kOptionName_55, "parse_paren");
GLOBAL_STR(kOptionName_56, "parse_ysh_string");
GLOBAL_STR(kOptionName_57, "parse_triple_quote");
GLOBAL_STR(kOptionName_58, "simple_word_eval");
GLOBAL_STR(kOptionName_59, "dashglob");
GLOBAL_STR(kOptionName_60, "command_sub_errexit");
GLOBAL_STR(kOptionName_61, "process_sub_fail");
GLOBAL_STR(kOptionName_62, "xtrace_rich");
GLOBAL_STR(kOptionName_63, "xtrace_details");
GLOBAL_STR(kOptionName_64, "sigpipe_status_ok");
GLOBAL_STR(kOptionName_65, "env_obj");
GLOBAL_STR(kOptionName_66, "init_ysh_globals");
GLOBAL_STR(kOptionName_67, "for_loop_frames");
GLOBAL_STR(kOptionName_68, "parse_at_all");
GLOBAL_STR(kOptionName_69, "parse_backslash");
GLOBAL_STR(kOptionName_70, "parse_backticks");
GLOBAL_STR(kOptionName_71, "parse_dollar");
GLOBAL_STR(kOptionName_72, "parse_ignored");
GLOBAL_STR(kOptionName_73, "parse_sh_arith");
GLOBAL_STR(kOptionName_74, "parse_dparen");
GLOBAL_STR(kOptionName_75, "parse_dbracket");
GLOBAL_STR(kOptionName_76, "parse_bare_word");
GLOBAL_STR(kOptionName_77, "parse_word_join");
GLOBAL_STR(kOptionName_78, "no_exported");
GLOBAL_STR(kOptionName_79, "no_init_globals");
GLOBAL_STR(kOptionName_80, "simple_echo");
GLOBAL_STR(kOptionName_81, "simple_eval_builtin");
GLOBAL_STR(kOptionName_82, "simple_test_builtin");
GLOBAL_STR(kOptionName_83, "expand_aliases");
GLOBAL_STR(kOptionName_84, "progcomp");
GLOBAL_STR(kOptionName_85, "hostcomplete");
GLOBAL_STR(kOptionName_86, "histappend");
GLOBAL_STR(kOptionName_87, "cmdhist");
GLOBAL_STR(kOptionName_88, "assoc_expand_once");
GLOBAL_STR(kOptionName_89, "autocd");
GLOBAL_STR(kOptionName_90, "cdable_vars");
GLOBAL_STR(kOptionName_91, "cdspell");
GLOBAL_STR(kOptionName_92, "checkhash");
GLOBAL_STR(kOptionName_93, "checkjobs");
GLOBAL_STR(kOptionName_94, "checkwinsize");
GLOBAL_STR(kOptionName_95, "complete_fullquote");
GLOBAL_STR(kOptionName_96, "direxpand");
GLOBAL_STR(kOptionName_97, "dirspell");
GLOBAL_STR(kOptionName_98, "execfail");
GLOBAL_STR(kOptionName_99, "extquote");
GLOBAL_STR(kOptionName_100, "force_fignore");
GLOBAL_STR(kOptionName_101, "globasciiranges");
GLOBAL_STR(kOptionName_102, "globstar");
GLOBAL_STR(kOptionName_103, "gnu_errfmt");
GLOBAL_STR(kOptionName_104, "histreedit");
GLOBAL_STR(kOptionName_105, "histverify");
GLOBAL_STR(kOptionName_106, "huponexit");
GLOBAL_STR(kOptionName_107, "interactive_comments");
GLOBAL_STR(kOptionName_108, "lithist");
GLOBAL_STR(kOptionName_109, "localvar_inherit");
GLOBAL_STR(kOptionName_110, "localvar_unset");
GLOBAL_STR(kOptionName_111, "login_shell");
GLOBAL_STR(kOptionName_112, "mailwarn");
GLOBAL_STR(kOptionName_113, "no_empty_cmd_completion");
GLOBAL_STR(kOptionName_114, "nocaseglob");
GLOBAL_STR(kOptionName_115, "progcomp_alias");
GLOBAL_STR(kOptionName_116, "promptvars");
GLOBAL_STR(kOptionName_117, "restricted_shell");
GLOBAL_STR(kOptionName_118, "shift_verbose");
GLOBAL_STR(kOptionName_119, "sourcepath");
GLOBAL_STR(kOptionName_120, "xpg_echo");
...
GLOBAL_STR(kBUILTIN_NAMES_14, "extern");
GLOBAL_STR(kBUILTIN_NAMES_15, "true");
GLOBAL_STR(kBUILTIN_NAMES_16, "false");
GLOBAL_STR(kBUILTIN_NAMES_17, "try");
GLOBAL_STR(kBUILTIN_NAMES_18, "assert");
GLOBAL_STR(kBUILTIN_NAMES_19, "break");
GLOBAL_STR(kBUILTIN_NAMES_20, "continue");
GLOBAL_STR(kBUILTIN_NAMES_21, "return");
GLOBAL_STR(kBUILTIN_NAMES_22, "exit");
GLOBAL_STR(kBUILTIN_NAMES_23, "read");
GLOBAL_STR(kBUILTIN_NAMES_24, "echo");
GLOBAL_STR(kBUILTIN_NAMES_25, "printf");
GLOBAL_STR(kBUILTIN_NAMES_26, "mapfile");
GLOBAL_STR(kBUILTIN_NAMES_27, "readarray");
GLOBAL_STR(kBUILTIN_NAMES_28, "cd");
...
GLOBAL_STR(kBUILTIN_NAMES_53, "alias");
GLOBAL_STR(kBUILTIN_NAMES_54, "unalias");
GLOBAL_STR(kBUILTIN_NAMES_55, "bind");
GLOBAL_STR(kBUILTIN_NAMES_56, "append");
GLOBAL_STR(kBUILTIN_NAMES_57, "write");
GLOBAL_STR(kBUILTIN_NAMES_58, "json");
GLOBAL_STR(kBUILTIN_NAMES_59, "json8");
GLOBAL_STR(kBUILTIN_NAMES_60, "pp");
GLOBAL_STR(kBUILTIN_NAMES_61, "hay");
GLOBAL_STR(kBUILTIN_NAMES_62, "haynode");
GLOBAL_STR(kBUILTIN_NAMES_63, "use");
GLOBAL_STR(kBUILTIN_NAMES_64, "error");
GLOBAL_STR(kBUILTIN_NAMES_65, "failed");
GLOBAL_STR(kBUILTIN_NAMES_66, "fork");
GLOBAL_STR(kBUILTIN_NAMES_67, "forkwait");
GLOBAL_STR(kBUILTIN_NAMES_68, "redir");
GLOBAL_STR(kBUILTIN_NAMES_69, "fopen");
GLOBAL_STR(kBUILTIN_NAMES_70, "shvar");
GLOBAL_STR(kBUILTIN_NAMES_71, "ctx");
GLOBAL_STR(kBUILTIN_NAMES_72, "invoke");
GLOBAL_STR(kBUILTIN_NAMES_73, "runproc");
GLOBAL_STR(kBUILTIN_NAMES_74, "boolstatus");
GLOBAL_STR(kBUILTIN_NAMES_75, "test");
GLOBAL_STR(kBUILTIN_NAMES_76, "[");
GLOBAL_STR(kBUILTIN_NAMES_77, "push-registers");
GLOBAL_STR(kBUILTIN_NAMES_78, "source-guard");
GLOBAL_STR(kBUILTIN_NAMES_79, "is-main");
GLOBAL_STR(kBUILTIN_NAMES_80, "__cat");
GLOBAL_STR(kBUILTIN_NAMES_81, "sleep");
...
GLOBAL_STR(kSHOPT_OPTION_NAMES_21, "env_obj");
GLOBAL_STR(kSHOPT_OPTION_NAMES_22, "eval_unsafe_arith");
GLOBAL_STR(kSHOPT_OPTION_NAMES_23, "execfail");
GLOBAL_STR(kSHOPT_OPTION_NAMES_24, "expand_aliases");
GLOBAL_STR(kSHOPT_OPTION_NAMES_25, "extdebug");
GLOBAL_STR(kSHOPT_OPTION_NAMES_26, "extglob");
GLOBAL_STR(kSHOPT_OPTION_NAMES_27, "extquote");
GLOBAL_STR(kSHOPT_OPTION_NAMES_28, "failglob");
GLOBAL_STR(kSHOPT_OPTION_NAMES_29, "for_loop_frames");
GLOBAL_STR(kSHOPT_OPTION_NAMES_30, "force_fignore");
GLOBAL_STR(kSHOPT_OPTION_NAMES_31, "globasciiranges");
...
GLOBAL_STR(kSHOPT_OPTION_NAMES_53, "nocaseglob");
GLOBAL_STR(kSHOPT_OPTION_NAMES_54, "nocasematch");
GLOBAL_STR(kSHOPT_OPTION_NAMES_55, "nullglob");
GLOBAL_STR(kSHOPT_OPTION_NAMES_56, "parse_at");
GLOBAL_STR(kSHOPT_OPTION_NAMES_57, "parse_at_all");
GLOBAL_STR(kSHOPT_OPTION_NAMES_58, "parse_backslash");
GLOBAL_STR(kSHOPT_OPTION_NAMES_59, "parse_backticks");
GLOBAL_STR(kSHOPT_OPTION_NAMES_60, "parse_bare_word");
GLOBAL_STR(kSHOPT_OPTION_NAMES_61, "parse_brace");
GLOBAL_STR(kSHOPT_OPTION_NAMES_62, "parse_bracket");
GLOBAL_STR(kSHOPT_OPTION_NAMES_63, "parse_dbracket");
GLOBAL_STR(kSHOPT_OPTION_NAMES_64, "parse_dollar");
GLOBAL_STR(kSHOPT_OPTION_NAMES_65, "parse_dparen");
GLOBAL_STR(kSHOPT_OPTION_NAMES_66, "parse_equals");
GLOBAL_STR(kSHOPT_OPTION_NAMES_67, "parse_func");
GLOBAL_STR(kSHOPT_OPTION_NAMES_68, "parse_ignored");
GLOBAL_STR(kSHOPT_OPTION_NAMES_69, "parse_paren");
GLOBAL_STR(kSHOPT_OPTION_NAMES_70, "parse_proc");
GLOBAL_STR(kSHOPT_OPTION_NAMES_71, "parse_sh_arith");
GLOBAL_STR(kSHOPT_OPTION_NAMES_72, "parse_triple_quote");
GLOBAL_STR(kSHOPT_OPTION_NAMES_73, "parse_word_join");
GLOBAL_STR(kSHOPT_OPTION_NAMES_74, "parse_ysh_string");
GLOBAL_STR(kSHOPT_OPTION_NAMES_75, "process_sub_fail");
GLOBAL_STR(kSHOPT_OPTION_NAMES_76, "progcomp");
GLOBAL_STR(kSHOPT_OPTION_NAMES_77, "progcomp_alias");
GLOBAL_STR(kSHOPT_OPTION_NAMES_78, "promptvars");
GLOBAL_STR(kSHOPT_OPTION_NAMES_79, "redefine_const");
GLOBAL_STR(kSHOPT_OPTION_NAMES_80, "redefine_source");
GLOBAL_STR(kSHOPT_OPTION_NAMES_81, "restricted_shell");
GLOBAL_STR(kSHOPT_OPTION_NAMES_82, "shift_verbose");
GLOBAL_STR(kSHOPT_OPTION_NAMES_83, "sigpipe_status_ok");
GLOBAL_STR(kSHOPT_OPTION_NAMES_84, "simple_echo");
GLOBAL_STR(kSHOPT_OPTION_NAMES_85, "simple_eval_builtin");
GLOBAL_STR(kSHOPT_OPTION_NAMES_86, "simple_test_builtin");
GLOBAL_STR(kSHOPT_OPTION_NAMES_87, "simple_word_eval");
GLOBAL_STR(kSHOPT_OPTION_NAMES_88, "sourcepath");
GLOBAL_STR(kSHOPT_OPTION_NAMES_89, "strict_argv");
GLOBAL_STR(kSHOPT_OPTION_NAMES_90, "strict_arith");
GLOBAL_STR(kSHOPT_OPTION_NAMES_91, "strict_array");
GLOBAL_STR(kSHOPT_OPTION_NAMES_92, "strict_control_flow");
GLOBAL_STR(kSHOPT_OPTION_NAMES_93, "strict_env_binding");
GLOBAL_STR(kSHOPT_OPTION_NAMES_94, "strict_errexit");
GLOBAL_STR(kSHOPT_OPTION_NAMES_95, "strict_glob");
GLOBAL_STR(kSHOPT_OPTION_NAMES_96, "strict_nameref");
GLOBAL_STR(kSHOPT_OPTION_NAMES_97, "strict_parse_equals");
GLOBAL_STR(kSHOPT_OPTION_NAMES_98, "strict_parse_slice");
GLOBAL_STR(kSHOPT_OPTION_NAMES_99, "strict_tilde");
GLOBAL_STR(kSHOPT_OPTION_NAMES_100, "strict_word_eval");
GLOBAL_STR(kSHOPT_OPTION_NAMES_101, "verbose_errexit");
GLOBAL_STR(kSHOPT_OPTION_NAMES_102, "verbose_warn");
GLOBAL_STR(kSHOPT_OPTION_NAMES_103, "xpg_echo");
GLOBAL_STR(kSHOPT_OPTION_NAMES_104, "xtrace_details");
GLOBAL_STR(kSHOPT_OPTION_NAMES_105, "xtrace_rich");
GLOBAL_LIST(SHOPT_OPTION_NAMES, BigStr*, 106, {kSHOPT_OPTION_NAMES_0 COMMA kSHOPT_OPTION_NAMES_1 COMMA kSHOPT_OPTION_NAMES_2 COMMA kSHOPT_OPTION_NAMES_3 COMMA kSHOPT_OPTION_NAMES_4 COMMA kSHOPT_OPTION_NAMES_5 COMMA kSHOPT_OPTION_NAMES_6 COMMA kSHOPT_OPTION_NAMES_7 COMMA kSHOPT_OPTION_NAMES_8 COMMA kSHOPT_OPTION_NAMES_9 COMMA kSHOPT_OPTION_NAMES_10 COMMA kSHOPT_OPTION_NAMES_11 COMMA kSHOPT_OPTION_NAMES_12 COMMA kSHOPT_OPTION_NAMES_13 COMMA kSHOPT_OPTION_NAMES_14 COMMA kSHOPT_OPTION_NAMES_15 COMMA kSHOPT_OPTION_NAMES_16 COMMA kSHOPT_OPTION_NAMES_17 COMMA kSHOPT_OPTION_NAMES_18 COMMA kSHOPT_OPTION_NAMES_19 COMMA kSHOPT_OPTION_NAMES_20 COMMA kSHOPT_OPTION_NAMES_21 COMMA kSHOPT_OPTION_NAMES_22 COMMA kSHOPT_OPTION_NAMES_23 COMMA kSHOPT_OPTION_NAMES_24 COMMA kSHOPT_OPTION_NAMES_25 COMMA kSHOPT_OPTION_NAMES_26 COMMA kSHOPT_OPTION_NAMES_27 COMMA kSHOPT_OPTION_NAMES_28 COMMA kSHOPT_OPTION_NAMES_29 COMMA kSHOPT_OPTION_NAMES_30 COMMA kSHOPT_OPTION_NAMES_31 COMMA kSHOPT_OPTION_NAMES_32 COMMA kSHOPT_OPTION_NAMES_33 COMMA kSHOPT_OPTION_NAMES_34 COMMA kSHOPT_OPTION_NAMES_35 COMMA kSHOPT_OPTION_NAMES_36 COMMA kSHOPT_OPTION_NAMES_37 COMMA kSHOPT_OPTION_NAMES_38 COMMA kSHOPT_OPTION_NAMES_39 COMMA kSHOPT_OPTION_NAMES_40 COMMA kSHOPT_OPTION_NAMES_41 COMMA kSHOPT_OPTION_NAMES_42 COMMA kSHOPT_OPTION_NAMES_43 COMMA kSHOPT_OPTION_NAMES_44 COMMA kSHOPT_OPTION_NAMES_45 COMMA kSHOPT_OPTION_NAMES_46 COMMA kSHOPT_OPTION_NAMES_47 COMMA kSHOPT_OPTION_NAMES_48 COMMA kSHOPT_OPTION_NAMES_49 COMMA kSHOPT_OPTION_NAMES_50 COMMA kSHOPT_OPTION_NAMES_51 COMMA kSHOPT_OPTION_NAMES_52 COMMA kSHOPT_OPTION_NAMES_53 COMMA kSHOPT_OPTION_NAMES_54 COMMA kSHOPT_OPTION_NAMES_55 COMMA kSHOPT_OPTION_NAMES_56 COMMA kSHOPT_OPTION_NAMES_57 COMMA kSHOPT_OPTION_NAMES_58 COMMA kSHOPT_OPTION_NAMES_59 COMMA kSHOPT_OPTION_NAMES_60 COMMA kSHOPT_OPTION_NAMES_61 COMMA kSHOPT_OPTION_NAMES_62 COMMA kSHOPT_OPTION_NAMES_63 COMMA kSHOPT_OPTION_NAMES_64 COMMA kSHOPT_OPTION_NAMES_65 COMMA kSHOPT_OPTION_NAMES_66 COMMA kSHOPT_OPTION_NAMES_67 COMMA kSHOPT_OPTION_NAMES_68 COMMA kSHOPT_OPTION_NAMES_69 COMMA kSHOPT_OPTION_NAMES_70 COMMA kSHOPT_OPTION_NAMES_71 COMMA kSHOPT_OPTION_NAMES_72 COMMA kSHOPT_OPTION_NAMES_73 COMMA kSHOPT_OPTION_NAMES_74 COMMA kSHOPT_OPTION_NAMES_75 COMMA kSHOPT_OPTION_NAMES_76 COMMA kSHOPT_OPTION_NAMES_77 COMMA kSHOPT_OPTION_NAMES_78 COMMA kSHOPT_OPTION_NAMES_79 COMMA kSHOPT_OPTION_NAMES_80 COMMA kSHOPT_OPTION_NAMES_81 COMMA kSHOPT_OPTION_NAMES_82 COMMA kSHOPT_OPTION_NAMES_83 COMMA kSHOPT_OPTION_NAMES_84 COMMA kSHOPT_OPTION_NAMES_85 COMMA kSHOPT_OPTION_NAMES_86 COMMA kSHOPT_OPTION_NAMES_87 COMMA kSHOPT_OPTION_NAMES_88 COMMA kSHOPT_OPTION_NAMES_89 COMMA kSHOPT_OPTION_NAMES_90 COMMA kSHOPT_OPTION_NAMES_91 COMMA kSHOPT_OPTION_NAMES_92 COMMA kSHOPT_OPTION_NAMES_93 COMMA kSHOPT_OPTION_NAMES_94 COMMA kSHOPT_OPTION_NAMES_95 COMMA kSHOPT_OPTION_NAMES_96 COMMA kSHOPT_OPTION_NAMES_97 COMMA kSHOPT_OPTION_NAMES_98 COMMA kSHOPT_OPTION_NAMES_99 COMMA kSHOPT_OPTION_NAMES_100 COMMA kSHOPT_OPTION_NAMES_101 COMMA kSHOPT_OPTION_NAMES_102 COMMA kSHOPT_OPTION_NAMES_103 COMMA kSHOPT_OPTION_NAMES_104 COMMA kSHOPT_OPTION_NAMES_105});

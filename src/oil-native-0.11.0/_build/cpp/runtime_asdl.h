...
class VTestPlace {
 public:
  VTestPlace() : type_tag_(201), name(new Str("")), index(nullptr) {
  }
...
class Proc {
 public:
  Proc() : type_tag_(205), name(new Str("")), name_spid(-1), sig(nullptr),
...
class StatusArray {
 public:
  StatusArray() : type_tag_(206), codes(new List<int>()), spids(new
              List<int>()) {
  }

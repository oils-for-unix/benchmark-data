...
class main {
 public:
  main(Dict<Str*, runtime_asdl::value_t*>* attrs) :
    ...
    l(static_cast<value__Bool*>(attrs->index_(new Str("l")))->b),
    location_start_line(attrs->index_(new Str("location_start_line"))->tag_() == value_e::Undef
      ? -1
      : static_cast<value__Int*>(attrs->index_(new Str("location_start_line")))->i),
    location_str(attrs->index_(new Str("location_str"))->tag_() == value_e::Undef
      ? nullptr
      : static_cast<value__Str*>(attrs->index_(new Str("location_str")))->s),

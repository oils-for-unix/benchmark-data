...
GLOBAL_STR(str134, "pipeline");
GLOBAL_STR(str135, "Command subs not allowed here because status wouldn't be checked (strict_errexit).");
GLOBAL_STR(str136, "__cat");
GLOBAL_STR(str137, "osh I/O error: %s");
GLOBAL_STR(str138, "Command Sub exited with status %d");
GLOBAL_STR(str139, "");
GLOBAL_STR(str140, "\n");
GLOBAL_STR(str141, "Process subs not allowed here because status wouldn't be checked (strict_errexit).");
GLOBAL_STR(str142, "/dev/fd/%d");
GLOBAL_STR(str143, "/dev/fd/%d");
GLOBAL_STR(str144, "<_FdFrame %s>");
GLOBAL_STR(str145, "r");
GLOBAL_STR(str146, "%d: %s");
GLOBAL_STR(str147, "%d: %s");
GLOBAL_STR(str148, "%d: %s");
GLOBAL_STR(str149, "Can't open %r: %s");
GLOBAL_STR(str150, "Error closing descriptor %d: %s");
GLOBAL_STR(str151, "dup2(%d, %d) error: %s");
GLOBAL_STR(str152, "<StdinFromPipe %d %d>");
GLOBAL_STR(str153, "<StdoutToPipe %d %d>");
GLOBAL_STR(str154, "Hijacked: %s");
GLOBAL_STR(str155, "/bin/sh");
GLOBAL_STR(str156, "/bin/sh");
GLOBAL_STR(str157, "Can't execute %r: %s");
GLOBAL_STR(str158, "[process] %s");
GLOBAL_STR(str159, " ");
GLOBAL_STR(str160, "[subprog] %s");
GLOBAL_STR(str161, "");
GLOBAL_STR(str162, "osh I/O error: %s");
GLOBAL_STR(str163, "[here doc writer]");
GLOBAL_STR(str164, "<Process %s %s>");
GLOBAL_STR(str165, "  ");
GLOBAL_STR(str166, "%%%d");
GLOBAL_STR(str167, "%d\n");
GLOBAL_STR(str168, "%s %d %7s ");
GLOBAL_STR(str169, "\n");
GLOBAL_STR(str170, "Fatal error in posix.fork()");
GLOBAL_STR(str171, "%d\n");
GLOBAL_STR(str172, "%%%d");
GLOBAL_STR(str173, "  ");
GLOBAL_STR(str174, "%s %d %7s ");
GLOBAL_STR(str175, "\n");
GLOBAL_STR(str176, "Pipeline in state %s");
GLOBAL_STR(str177, "\n");
GLOBAL_STR(str178, "[process debug info]\n");
GLOBAL_STR(str179, "\n");
GLOBAL_STR(str180, "[pipeline debug info]\n");
GLOBAL_STR(str181, "osh: PID %d stopped, but osh didn't start it");
GLOBAL_STR(str182, "");
GLOBAL_STR(str183, "");
GLOBAL_STR(str184, "[PID %d] Stopped");
GLOBAL_STR(str185, "");
GLOBAL_STR(str186, "main");
GLOBAL_STR(str187, "osh usage error: %s");
GLOBAL_STR(str188, "%s-usage");
GLOBAL_STR(str189, "Oil");
GLOBAL_STR(str190, "main");
GLOBAL_STR(str191, "oil");
GLOBAL_STR(str192, "oil:all");
GLOBAL_STR(str193, "--one-pass-parse requires noexec (-n)");
GLOBAL_STR(str194, "completion");
GLOBAL_STR(str195, "history");
GLOBAL_STR(str196, "");
GLOBAL_STR(str197, "OSH_DEBUG_DIR");
GLOBAL_STR(str198, "%d-osh.log");
GLOBAL_STR(str199, "Writing logs to %r");
GLOBAL_STR(str200, "OSH_HIJACK_SHEBANG");
GLOBAL_STR(str201, "");
GLOBAL_STR(str202, "OSH_CRASH_DUMP_DIR");
GLOBAL_STR(str203, "");
GLOBAL_STR(str204, "");
GLOBAL_STR(str205, "osh: Couldn't open %r: %s");
GLOBAL_STR(str206, "/proc/%d/status");
GLOBAL_STR(str207, "--parser-mem-dump can only be used with -n");
GLOBAL_STR(str208, "/proc/%d/status");
GLOBAL_STR(str209, " \t\n\"'><=;|&(:");
GLOBAL_STR(str210, "/");
GLOBAL_STR(str211, "PATH");
GLOBAL_STR(str212, ":");
GLOBAL_STR(str213, "Recursive 'hay eval' not allowed");
GLOBAL_STR(str214, "source");
GLOBAL_STR(str215, "children");
GLOBAL_STR(str216, "got invalid option %r");
GLOBAL_STR(str217, "got invalid option %r");
GLOBAL_STR(str218, "invalid option %r (try shopt)");
GLOBAL_STR(str219, "SHELLOPTS");
GLOBAL_STR(str220, ":");
GLOBAL_STR(str221, "Syntax options must be set at the top level (outside any function)");
GLOBAL_STR(str222, "Warning: set -o verbose not implemented");
GLOBAL_STR(str223, "SHELLOPTS");
GLOBAL_STR(str224, "%s:%s");
GLOBAL_STR(str225, "SHELLOPTS");
GLOBAL_STR(str226, ":");
GLOBAL_STR(str227, ":");
GLOBAL_STR(str228, "SHELLOPTS");
GLOBAL_STR(str229, "set %so %s");
GLOBAL_STR(str230, "-");
GLOBAL_STR(str231, "+");
GLOBAL_STR(str232, "got invalid option %r");
GLOBAL_STR(str233, "shopt -%s %s");
GLOBAL_STR(str234, "s");
GLOBAL_STR(str235, "u");
GLOBAL_STR(str236, "<_ArgFrame %s %d at %x>");
GLOBAL_STR(str237, "Can't determine working directory: %s");
GLOBAL_STR(str238, "IFS");
GLOBAL_STR(str239, "UID");
GLOBAL_STR(str240, "EUID");
GLOBAL_STR(str241, "PPID");
GLOBAL_STR(str242, "HOSTNAME");
GLOBAL_STR(str243, "OSTYPE");
GLOBAL_STR(str244, "OPTIND");
GLOBAL_STR(str245, "1");
GLOBAL_STR(str246, "PS4");
GLOBAL_STR(str247, "${SHX_indent}${SHX_punct}${SHX_pid_str} ");
GLOBAL_STR(str248, "COMP_WORDBREAKS");
GLOBAL_STR(str249, "SHELLOPTS");
GLOBAL_STR(str250, "SHELLOPTS");
GLOBAL_STR(str251, "");
GLOBAL_STR(str252, "SHELLOPTS");
GLOBAL_STR(str253, "PWD");
GLOBAL_STR(str254, "PWD");
GLOBAL_STR(str255, "PWD");
GLOBAL_STR(str256, "PATH");
GLOBAL_STR(str257, "PATH");
GLOBAL_STR(str258, "/bin:/usr/bin");
GLOBAL_STR(str259, "OIL_VERSION");
GLOBAL_STR(str260, "PWD");
GLOBAL_STR(str261, "PS1");
GLOBAL_STR(str262, "PS1");
GLOBAL_STR(str263, "\\s-\\v\\$ ");
GLOBAL_STR(str264, "");
GLOBAL_STR(str265, "<Mem");
GLOBAL_STR(str266, "  -- %d --");
GLOBAL_STR(str267, "  %s %s");
GLOBAL_STR(str268, ">");
GLOBAL_STR(str269, "\n");
GLOBAL_STR(str270, "\n");
GLOBAL_STR(str271, "Warning: span_id undefined in SetCurrentSpanId");
GLOBAL_STR(str272, "setref requires a nameref (:out param)");
GLOBAL_STR(str273, "nameref %r is undefined");
GLOBAL_STR(str274, "nameref %r contains invalid variable name %r");
GLOBAL_STR(str275, "Circular nameref %s");
GLOBAL_STR(str276, " -> ");
GLOBAL_STR(str277, "__");
GLOBAL_STR(str278, "Can't assign to readonly value %r");
GLOBAL_STR(str279, "Only strings can be exported");
GLOBAL_STR(str280, "nameref must be a string");
GLOBAL_STR(str281, "Can't assign to readonly array");
GLOBAL_STR(str282, "Can't assign to items in a string");
GLOBAL_STR(str283, "Value of type %s can't be indexed");
GLOBAL_STR(str284, "Can't assign to readonly associative array");
GLOBAL_STR(str285, "ARGV");
GLOBAL_STR(str286, "_status");
GLOBAL_STR(str287, "_this_dir");
GLOBAL_STR(str288, "PIPESTATUS");
GLOBAL_STR(str289, "_pipeline_status");
GLOBAL_STR(str290, "_process_sub_status");
GLOBAL_STR(str291, "BASH_REMATCH");
GLOBAL_STR(str292, "FUNCNAME");
GLOBAL_STR(str293, "source");
GLOBAL_STR(str294, "BASH_SOURCE");
GLOBAL_STR(str295, "BASH_LINENO");
GLOBAL_STR(str296, "0");
GLOBAL_STR(str297, "LINENO");
GLOBAL_STR(str298, "BASHPID");
GLOBAL_STR(str299, "Can't unset readonly variable %r");
GLOBAL_STR(str300, "%r isn't an array");
GLOBAL_STR(str301, "$%s isn't defined");
GLOBAL_STR(str302, "$%s should be a string");
GLOBAL_STR(str303, "$%s should be a string, got %s");
GLOBAL_STR(str304, "$%s doesn't look like an integer, got %r");
GLOBAL_STR(str305, "EOF");
GLOBAL_STR(str306, "/");
GLOBAL_STR(str307, "~");
GLOBAL_STR(str308, "  ");
GLOBAL_STR(str309, "\n  ");
...
GLOBAL_STR(str314, "~");
GLOBAL_STR(str315, "\n");
GLOBAL_STR(str316, "[ interactive ]");
GLOBAL_STR(str317, "[ headless ]");
GLOBAL_STR(str318, "[ -c flag ]");
GLOBAL_STR(str319, "[ stdin%s ]");
GLOBAL_STR(str320, "[ %s word at ? ]");
GLOBAL_STR(str321, "[ %s word at line %d of %s ]");
GLOBAL_STR(str322, "?");
GLOBAL_STR(str323, "?");
GLOBAL_STR(str324, "line %d of %s");
GLOBAL_STR(str325, "[ var %s at %s ]");
GLOBAL_STR(str326, "[ expansion of alias %r ]");
GLOBAL_STR(str327, "[ %s in %s ]");
GLOBAL_STR(str328, "-- %s");
GLOBAL_STR(str329, "[??? no location ???] %s%s\n");
GLOBAL_STR(str330, "%s:%d: %s%s\n");
GLOBAL_STR(str331, "");
GLOBAL_STR(str332, "");
GLOBAL_STR(str333, "");
GLOBAL_STR(str334, "errexit PID %d: ");
GLOBAL_STR(str335, "none");
GLOBAL_STR(str336, "AST not printed.");
GLOBAL_STR(str337, "text");
GLOBAL_STR(str338, "abbrev-text");
GLOBAL_STR(str339, "html");
GLOBAL_STR(str340, "abbrev-html");
GLOBAL_STR(str341, "abbrev-");
GLOBAL_STR(str342, "\n");
GLOBAL_STR(str343, "\n");
GLOBAL_STR(str344, "-");
GLOBAL_STR(str345, "_");
GLOBAL_STR(str346, "<_Attributes %s>");
GLOBAL_STR(str347, "<args.Reader %r %d>");
GLOBAL_STR(str348, "expected argument to %r");
GLOBAL_STR(str349, "-");
GLOBAL_STR(str350, "expected integer after %s, got %r");
GLOBAL_STR(str351, "-");
GLOBAL_STR(str352, "got invalid integer for %s: %s");
GLOBAL_STR(str353, "-");
GLOBAL_STR(str354, "expected number after %r, got %r");
GLOBAL_STR(str355, "-");
GLOBAL_STR(str356, "got invalid float for %s: %s");
GLOBAL_STR(str357, "-");
GLOBAL_STR(str358, "got invalid argument %r to %r, expected one of: %s");
GLOBAL_STR(str359, "-");
GLOBAL_STR(str360, "|");
GLOBAL_STR(str361, "0");
GLOBAL_STR(str362, "F");
GLOBAL_STR(str363, "false");
GLOBAL_STR(str364, "False");
GLOBAL_STR(str365, "1");
GLOBAL_STR(str366, "T");
GLOBAL_STR(str367, "true");
GLOBAL_STR(str368, "Talse");
GLOBAL_STR(str369, "got invalid argument to boolean flag: %r");
GLOBAL_STR(str370, "-");
GLOBAL_STR(str371, "-");
GLOBAL_STR(str372, "Invalid option %r");
GLOBAL_STR(str373, "Expected argument for action");
GLOBAL_STR(str374, "Invalid action name %r");
GLOBAL_STR(str375, "--");
GLOBAL_STR(str376, "--");
GLOBAL_STR(str377, "=");
GLOBAL_STR(str378, "got invalid flag %r");
GLOBAL_STR(str379, "-");
GLOBAL_STR(str380, "0");
GLOBAL_STR(str381, "Z");
GLOBAL_STR(str382, "-");
GLOBAL_STR(str383, "doesn't accept flag %s");
GLOBAL_STR(str384, "-");
GLOBAL_STR(str385, "+");
GLOBAL_STR(str386, "+");
GLOBAL_STR(str387, "doesn't accept option %s");
GLOBAL_STR(str388, "+");
GLOBAL_STR(str389, "-");
GLOBAL_STR(str390, "--");
GLOBAL_STR(str391, "--");
GLOBAL_STR(str392, "got invalid flag %r");
GLOBAL_STR(str393, "-");
GLOBAL_STR(str394, "+");
GLOBAL_STR(str395, "got invalid flag %r");
GLOBAL_STR(str396, "-");
GLOBAL_STR(str397, "<LineLexer at pos %d of line %r (id = %d)>");
GLOBAL_STR(str398, "");
GLOBAL_STR(str399, "");
GLOBAL_STR(str400, "");
GLOBAL_STR(str401, "");
GLOBAL_STR(str402, "<Trail %s %s %s %s>");
GLOBAL_STR(str403, "");
GLOBAL_STR(str404, "Here docs aren't allowed in expressions");
GLOBAL_STR(str405, "\n");
GLOBAL_STR(str406, "got unexpected typed args");
GLOBAL_STR(str407, "Expected an expression");
GLOBAL_STR(str408, "Expected an expression");
GLOBAL_STR(str409, "Too many typed args (expected one expression)");
GLOBAL_STR(str410, "Expected block argument");
GLOBAL_STR(str411, "Too many typed args (expected one block)");
GLOBAL_STR(str412, "Use === to be exact, or ~== to convert types");
GLOBAL_STR(str413, "");
GLOBAL_STR(str414, " (%s)");
GLOBAL_STR(str415, "Unexpected token in expression mode%s");
GLOBAL_STR(str416, "Syntax error in expression (near %s)");
GLOBAL_STR(str417, "alnum");
GLOBAL_STR(str418, "cntrl");
GLOBAL_STR(str419, "lower");
GLOBAL_STR(str420, "space");
GLOBAL_STR(str421, "alpha");
GLOBAL_STR(str422, "digit");
GLOBAL_STR(str423, "print");
GLOBAL_STR(str424, "upper");
GLOBAL_STR(str425, "blank");
GLOBAL_STR(str426, "graph");
GLOBAL_STR(str427, "punct");
GLOBAL_STR(str428, "xdigit");
GLOBAL_STR(str429, "Range start/end shouldn't have more than one character");
GLOBAL_STR(str430, "Write singleton tuples with tup(), not a trailing comma");
GLOBAL_STR(str431, "testlist_comp");
GLOBAL_STR(str432, "obj.field isn't valid, but obj.method() is");
GLOBAL_STR(str433, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str434, "Can't assign to this expression");
GLOBAL_STR(str435, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str436, "Expr");
GLOBAL_STR(str437, "Block");
GLOBAL_STR(str438, "proc param types should be Expr or Block");
GLOBAL_STR(str439, "TODO");
GLOBAL_STR(str440, "dot");
GLOBAL_STR(str441, "Can't negate this symbol");
GLOBAL_STR(str442, "%r isn't a character class");
GLOBAL_STR(str443, "Can't negate this symbol");
GLOBAL_STR(str444, "%r isn't a character class");
GLOBAL_STR(str445, "%start");
GLOBAL_STR(str446, "%end");
GLOBAL_STR(str447, "dot");
GLOBAL_STR(str448, "Unexpected token %r in regex");
GLOBAL_STR(str449, "Couldn't open %r: %s");
GLOBAL_STR(str450, "%s-%s");
GLOBAL_STR(str451, "ERE can't express code point %d");
GLOBAL_STR(str452, "Perl classes can't be negated in ERE");
GLOBAL_STR(str453, "%s");
GLOBAL_STR(str454, "POSIX classes can't be negated in ERE");
GLOBAL_STR(str455, "[:%s:]");
GLOBAL_STR(str456, ".");
GLOBAL_STR(str457, "^");
GLOBAL_STR(str458, "$");
GLOBAL_STR(str459, "|");
GLOBAL_STR(str460, "POSIX EREs don't have groups without capture, so this node needs () around it.");
GLOBAL_STR(str461, "+");
GLOBAL_STR(str462, "*");
GLOBAL_STR(str463, "?");
GLOBAL_STR(str464, "{%s}");
...
GLOBAL_STR(str475, "^");
GLOBAL_STR(str476, "]");
GLOBAL_STR(str477, "The [ operator doesn't apply to this expression");
GLOBAL_STR(str478, "Expected ]]");
GLOBAL_STR(str479, "Unexpected trailing word %s");
GLOBAL_STR(str480, "Invalid argument to unary operator");
GLOBAL_STR(str481, "Expected ), got %s");
GLOBAL_STR(str482, "Unexpected token in boolean expression (%s)");
GLOBAL_STR(str483, "");
GLOBAL_STR(str484, "Expected %d, got %d");
GLOBAL_STR(str485, "Step can't be 0");
GLOBAL_STR(str486, "Invalid step %d for ascending integer range");
GLOBAL_STR(str487, "Invalid step %d for descending integer range");
GLOBAL_STR(str488, "Invalid step %d for ascending character range");
GLOBAL_STR(str489, "Invalid step %d for descending character range");
GLOBAL_STR(str490, "Mismatched cases in character range");
GLOBAL_STR(str491, "");
GLOBAL_STR(str492, "0");
GLOBAL_STR(str493, "0");
GLOBAL_STR(str494, "g");
...
GLOBAL_STR(str531, ")");
GLOBAL_STR(str532, "");
GLOBAL_STR(str533, "export_");
GLOBAL_STR(str534, "doesn't accept -f because it's dangerous.  (The code can usually be restructured with 'source')");
GLOBAL_STR(str535, "doesn't accept RHS with -n");
GLOBAL_STR(str536, "Got -a but RHS isn't an array");
GLOBAL_STR(str537, "Got -A but RHS isn't an associative array");
GLOBAL_STR(str538, "readonly");
GLOBAL_STR(str539, "new_var");
GLOBAL_STR(str540, "with -f expects function names");
GLOBAL_STR(str541, "declare -f %s");
GLOBAL_STR(str542, "-");
GLOBAL_STR(str543, "-");
GLOBAL_STR(str544, "-");
GLOBAL_STR(str545, "+");
GLOBAL_STR(str546, "+");
GLOBAL_STR(str547, "+");
GLOBAL_STR(str548, "unset");
GLOBAL_STR(str549, "Invalid shift argument %r");
GLOBAL_STR(str550, "got too many arguments");
GLOBAL_STR(str551, "eval");
GLOBAL_STR(str552, "requires code string");
GLOBAL_STR(str553, "requires exactly 1 argument");
GLOBAL_STR(str554, " ");
GLOBAL_STR(str555, "eval");
GLOBAL_STR(str556, "eval");
GLOBAL_STR(str557, "source");
GLOBAL_STR(str558, "missing required argument");
GLOBAL_STR(str559, "source %r failed: %s");
GLOBAL_STR(str560, "source");
GLOBAL_STR(str561, "command");
GLOBAL_STR(str562, "Can't run assignment builtin recursively");
GLOBAL_STR(str563, "%r isn't a shell builtin");
GLOBAL_STR(str564, "runproc");
GLOBAL_STR(str565, "requires arguments");
GLOBAL_STR(str566, "runproc: no proc named %r");
GLOBAL_STR(str567, "try_");
GLOBAL_STR(str568, "expects a block or command argv");
GLOBAL_STR(str569, "boolstatus");
GLOBAL_STR(str570, "expected a command to run");
GLOBAL_STR(str571, "boolstatus expected status 0 or 1, got %d");
GLOBAL_STR(str572, "function");
GLOBAL_STR(str573, "alias");
GLOBAL_STR(str574, "builtin");
GLOBAL_STR(str575, "builtin");
GLOBAL_STR(str576, "builtin");
GLOBAL_STR(str577, "keyword");
GLOBAL_STR(str578, "keyword");
GLOBAL_STR(str579, "file");
GLOBAL_STR(str580, "type");
GLOBAL_STR(str581, "type: %r not found");
GLOBAL_STR(str582, "file");
GLOBAL_STR(str583, "file");
GLOBAL_STR(str584, "%s is a %s");
GLOBAL_STR(str585, "function");
GLOBAL_STR(str586, "");
GLOBAL_STR(str587, "");
GLOBAL_STR(str588, "\r\n");
GLOBAL_STR(str589, "\n");
...
GLOBAL_STR(str591, "");
GLOBAL_STR(str592, "");
GLOBAL_STR(str593, "read error: %s");
GLOBAL_STR(str594, "read");
GLOBAL_STR(str595, "_line");
GLOBAL_STR(str596, ":");
GLOBAL_STR(str597, "got extra argument");
GLOBAL_STR(str598, "--qsn can only be used with --line");
GLOBAL_STR(str599, "_all");
GLOBAL_STR(str600, ":");
GLOBAL_STR(str601, "got extra argument");
GLOBAL_STR(str602, "--qsn not implemented yet");
GLOBAL_STR(str603, "read -t isn't implemented (except t=0)");
GLOBAL_STR(str604, "REPLY");
GLOBAL_STR(str605, "REPLY");
GLOBAL_STR(str606, "");
GLOBAL_STR(str607, ":");
GLOBAL_STR(str608, "mapfile");
GLOBAL_STR(str609, "MAPFILE");
GLOBAL_STR(str610, ":");
GLOBAL_STR(str611, "mapfile: read() error: %s");
GLOBAL_STR(str612, "\n");
GLOBAL_STR(str613, "cd");
GLOBAL_STR(str614, "HOME");
GLOBAL_STR(str615, "HOME");
GLOBAL_STR(str616, "-");
GLOBAL_STR(str617, "OLDPWD");
GLOBAL_STR(str618, "PWD");
GLOBAL_STR(str619, "cd %r: %s");
GLOBAL_STR(str620, "PWD");
GLOBAL_STR(str621, "OLDPWD");
GLOBAL_STR(str622, "%2d  %s");
GLOBAL_STR(str623, " ");
GLOBAL_STR(str624, "pushd");
...
GLOBAL_STR(str634, "got extra argument");
GLOBAL_STR(str635, "HOME");
GLOBAL_STR(str636, "dirs");
GLOBAL_STR(str637, "HOME");
GLOBAL_STR(str638, "pwd");
GLOBAL_STR(str639, "_devbuild/help/groups.txt");
GLOBAL_STR(str640, "help");
GLOBAL_STR(str641, "help");
GLOBAL_STR(str642, "_devbuild/help/%s");
GLOBAL_STR(str643, "no help topics match %r");
GLOBAL_STR(str644, "osh I/O error: %s");
GLOBAL_STR(str645, "# +");
GLOBAL_STR(str646, "osh printf doesn't support the %r flag");
GLOBAL_STR(str647, "eEfFgG");
GLOBAL_STR(str648, "osh printf doesn't support floating point");
GLOBAL_STR(str649, "c");
GLOBAL_STR(str650, "osh printf doesn't support single characters (bytes)");
GLOBAL_STR(str651, "Invalid printf format character");
GLOBAL_STR(str652, "Expected a printf format character");
GLOBAL_STR(str653, "%");
GLOBAL_STR(str654, "");
GLOBAL_STR(str655, "printf got invalid width %r");
GLOBAL_STR(str656, "0");
GLOBAL_STR(str657, "");
GLOBAL_STR(str658, "printf got invalid precision %r");
GLOBAL_STR(str659, "");
GLOBAL_STR(str660, "s");
GLOBAL_STR(str661, "q");
GLOBAL_STR(str662, "b");
GLOBAL_STR(str663, "");
GLOBAL_STR(str664, "diouxX");
GLOBAL_STR(str665, "'\"");
GLOBAL_STR(str666, "printf expected an integer, got %r");
GLOBAL_STR(str667, "TZ");
GLOBAL_STR(str668, "TZ");
GLOBAL_STR(str669, "ouxX");
GLOBAL_STR(str670, "Can't format negative number %d with %%%s");
GLOBAL_STR(str671, "o");
GLOBAL_STR(str672, "x");
GLOBAL_STR(str673, "X");
GLOBAL_STR(str674, "0");
...
GLOBAL_STR(str680, " ");
GLOBAL_STR(str681, " ");
GLOBAL_STR(str682, "printf");
GLOBAL_STR(str683, "requires a format string");
GLOBAL_STR(str684, "printf");
GLOBAL_STR(str685, "");
GLOBAL_STR(str686, "alias");
GLOBAL_STR(str687, "alias %s=%r");
GLOBAL_STR(str688, "=");
GLOBAL_STR(str689, "No alias named %r");
GLOBAL_STR(str690, "alias %s=%r");
GLOBAL_STR(str691, "unalias");
GLOBAL_STR(str692, "requires an argument");
GLOBAL_STR(str693, "No alias named %r");
GLOBAL_STR(str694, "%s=%s");
GLOBAL_STR(str695, "set");
GLOBAL_STR(str696, "shopt");
GLOBAL_STR(str697, "got invalid option %r");
GLOBAL_STR(str698, "hash");
GLOBAL_STR(str699, "got extra arguments after -r");
GLOBAL_STR(str700, "hash: %r not found");
GLOBAL_STR(str701, ":");
GLOBAL_STR(str702, "OPTIND");
GLOBAL_STR(str703, "OPTIND");
GLOBAL_STR(str704, "OPTARG");
GLOBAL_STR(str705, "OPTARG");
GLOBAL_STR(str706, "");
GLOBAL_STR(str707, "?");
GLOBAL_STR(str708, "-");
GLOBAL_STR(str709, "-");
GLOBAL_STR(str710, "?");
GLOBAL_STR(str711, "?");
GLOBAL_STR(str712, "getopts: option %r requires an argument.");
GLOBAL_STR(str713, "(getopts argv: %s)");
GLOBAL_STR(str714, " ");
GLOBAL_STR(str715, "?");
GLOBAL_STR(str716, "");
GLOBAL_STR(str717, "requires an argspec");
GLOBAL_STR(str718, "requires the name of a variable to set");
GLOBAL_STR(str719, "got invalid variable name %r");
GLOBAL_STR(str720, "echo");
GLOBAL_STR(str721, "");
GLOBAL_STR(str722, "takes at most one arg when simple_echo is on (hint: add quotes)");
GLOBAL_STR(str723, " ");
GLOBAL_STR(str724, "\n");
GLOBAL_STR(str725, "module");
GLOBAL_STR(str726, "requires a name");
GLOBAL_STR(str727, "(interactive) Reloading module %r");
GLOBAL_STR(str728, "expected 'bin' or 'dialect'");
GLOBAL_STR(str729, "dialect");
GLOBAL_STR(str730, "expected dialect name");
GLOBAL_STR(str731, "_DIALECT");
GLOBAL_STR(str732, "Expected dialect %r, got %r");
GLOBAL_STR(str733, "Expected dialect %r");
GLOBAL_STR(str734, "bin");
GLOBAL_STR(str735, "bin %s");
GLOBAL_STR(str736, "expected 'bin' or 'dialect'");
GLOBAL_STR(str737, "shvar");
GLOBAL_STR(str738, "expected a block");
GLOBAL_STR(str739, "Expected name=value");
GLOBAL_STR(str740, "=");
GLOBAL_STR(str741, "Expected name=value");
GLOBAL_STR(str742, "PATH");
GLOBAL_STR(str743, "push-registers");
GLOBAL_STR(str744, "expected a block");
GLOBAL_STR(str745, "fopen");
GLOBAL_STR(str746, "expected a block");
GLOBAL_STR(str747, "Can't append array to string");
GLOBAL_STR(str748, "Can't append string to array");
GLOBAL_STR(str749, "Assignment builtin %r not configured");
GLOBAL_STR(str750, "%r ");
GLOBAL_STR(str751, "Command");
GLOBAL_STR(str752, "Assignment");
GLOBAL_STR(str753, "Subshell");
GLOBAL_STR(str754, "Pipeline");
GLOBAL_STR(str755, "%s failed with status %d");
GLOBAL_STR(str756, "Redirect filename can't be empty");
GLOBAL_STR(str757, "Redirect descriptor can't be empty");
GLOBAL_STR(str758, "-");
GLOBAL_STR(str759, "-");
GLOBAL_STR(str760, "Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
GLOBAL_STR(str761, "\n");
GLOBAL_STR(str762, "Unknown redirect op");
GLOBAL_STR(str763, "Unknown redirect type");
GLOBAL_STR(str764, "strict_errexit only allows simple commands in conditionals (got %s). ");
GLOBAL_STR(str765, "strict_errexit only allows a single command.  Hint: use 'try'.");
GLOBAL_STR(str766, "strict_errexit only allows simple commands in conditionals (got %s). ");
GLOBAL_STR(str767, "ShAssignment builtins don't accept blocks");
GLOBAL_STR(str768, "|& isn't supported");
GLOBAL_STR(str769, "%r expected a number, got %r");
GLOBAL_STR(str770, "Invalid control flow at top level");
GLOBAL_STR(str771, "warning: ");
GLOBAL_STR(str772, "List iteration expects at most 2 loop variables");
GLOBAL_STR(str773, "Function %s was already defined (redefine_proc)");
GLOBAL_STR(str774, "Proc %s was already defined (redefine_proc)");
GLOBAL_STR(str775, "trap");
GLOBAL_STR(str776, "failglob: ");
GLOBAL_STR(str777, "Loop and control flow can't be in different processes");
GLOBAL_STR(str778, "fatal: ");
GLOBAL_STR(str779, "EXIT");
GLOBAL_STR(str780, "trap EXIT");
GLOBAL_STR(str781, "__");
GLOBAL_STR(str782, ":");
GLOBAL_STR(str783, "Invalid argument %r.  Expected a name starting with :");
GLOBAL_STR(str784, "No value provided for param %r");
GLOBAL_STR(str785, "proc %r expected %d arguments, but got %d");
GLOBAL_STR(str786, "Unexpected %r (in function call)");
GLOBAL_STR(str787, "Unexpected control flow in block");
GLOBAL_STR(str788, "Attempted to exit from completion hook.");
GLOBAL_STR(str789, "Couldn't find terminator for here doc that starts here");
GLOBAL_STR(str790, "\t");
GLOBAL_STR(str791, "Invalid here doc delimiter");
GLOBAL_STR(str792, "+");
GLOBAL_STR(str793, "+");
GLOBAL_STR(str794, "+");
GLOBAL_STR(str795, "%d != %d");
GLOBAL_STR(str796, "array place");
GLOBAL_STR(str797, "Environment binding shouldn't look like an array assignment");
GLOBAL_STR(str798, "+");
GLOBAL_STR(str799, "Expected = in environment binding, got +=");
GLOBAL_STR(str800, "Environment bindings can't contain array literals");
GLOBAL_STR(str801, "procs and shell functions can't be nested");
GLOBAL_STR(str802, "%r was already declared");
GLOBAL_STR(str803, "%r hasn't been declared");
GLOBAL_STR(str804, "Can't modify constant %r");
GLOBAL_STR(str805, "Expected word type %s, got %s");
GLOBAL_STR(str806, "{");
GLOBAL_STR(str807, "}");
GLOBAL_STR(str808, "Invalid token after redirect operator");
GLOBAL_STR(str809, "Space required before (");
GLOBAL_STR(str810, "Unexpected left paren (might need a space before it)");
GLOBAL_STR(str811, "Empty arg list not allowed");
GLOBAL_STR(str812, " ");
GLOBAL_STR(str813, " ");
GLOBAL_STR(str814, "line IDs %d != %d");
GLOBAL_STR(str815, " ");
GLOBAL_STR(str816, "");
GLOBAL_STR(str817, "Unexpected typed args");
GLOBAL_STR(str818, "=word isn't allowed.  Hint: either quote it or add a space after =\nto pretty print an expression");
GLOBAL_STR(str819, "Use const or var/setvar to assign in Oil (parse_sh_assign)");
GLOBAL_STR(str820, "Unexpected typed args");
GLOBAL_STR(str821, "Unexpected typed args");
GLOBAL_STR(str822, "Control flow shouldn't have redirects");
GLOBAL_STR(str823, "Control flow shouldn't have environment bindings");
GLOBAL_STR(str824, "Unexpected argument to %r");
GLOBAL_STR(str825, "Invalid word in for loop");
GLOBAL_STR(str826, "Invalid word after for expression");
GLOBAL_STR(str827, "Expected loop variable (a constant word)");
GLOBAL_STR(str828, ",");
GLOBAL_STR(str829, "Loop variables look like x, y (fix spaces)");
GLOBAL_STR(str830, "Invalid loop variable name %r");
GLOBAL_STR(str831, "Unexpected word after 3 loop variables");
GLOBAL_STR(str832, "Expected { after iterable expression");
GLOBAL_STR(str833, "Surround this word with either parens or quotes (parse_bare_word)");
GLOBAL_STR(str834, "Expected at most 2 loop variables");
GLOBAL_STR(str835, "Unexpected word after for loop variable");
GLOBAL_STR(str836, "Bash for loops aren't allowed (parse_dparen)");
GLOBAL_STR(str837, "Expected left paren (parse_sloppy_case)");
GLOBAL_STR(str838, "Constant pattern should be quoted (parse_bare_word)");
GLOBAL_STR(str839, "Expected ;; or esac");
GLOBAL_STR(str840, "This is a constant string.  You may want a variable like $x (parse_bare_word)");
GLOBAL_STR(str841, "You may want a space between parens (parse_dparen)");
GLOBAL_STR(str842, "Unexpected word while parsing compound command");
GLOBAL_STR(str843, "Invalid function name");
GLOBAL_STR(str844, "Expected ) in function definition");
GLOBAL_STR(str845, "Invalid KSH-style function name");
GLOBAL_STR(str846, "Unexpected word when parsing command");
GLOBAL_STR(str847, "Enable Oil to use procs (parse_proc)");
GLOBAL_STR(str848, "Unexpected right brace");
GLOBAL_STR(str849, "Unexpected = (Hint: use const/var/setvar, or quote it)");
...
class ctx_HayNode : public gc_heap::Obj {
 public:
...
class ctx_HayEval : public gc_heap::Obj {
 public:
...
class ParseHay : public gc_heap::Obj {
 public:
...
class EvalHay : public gc_heap::Obj {
 public:
...
class BlockAsStr : public gc_heap::Obj {
 public:
...
class HayFunc : public gc_heap::Obj {
 public:
...
inline Str* fmt117(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("-", 1);
  gBuf.format_s(a1);
...
inline Str* fmt136(int a0, int a1) {
  gBuf.reset();
...
inline Str* fmt174(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt191(Str* a0, int a1) {
  gBuf.reset();
  gBuf.format_s(a0);
...
inline Str* fmt198(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_r(a0);
...
inline Str* fmt199(int a0) {
  gBuf.reset();
  gBuf.write_const("List iteration expects at most 2 loop variables", 47);
  return gBuf.getvalue();
}
...
inline Str* fmt204(Str* a0, int a1, int a2) {
  gBuf.reset();
  gBuf.write_const("proc ", 5);
  gBuf.format_r(a0);
...
inline Str* fmt222(int a0, int a1) {
  gBuf.reset();
...
inline Str* fmt274(Str* a0, int a1) {
  gBuf.reset();
...
inline Str* fmt287(Str* a0, Str* a1, syntax_asdl::word_t* a2) {
  gBuf.reset();
...
inline Str* fmt293(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt297(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt361(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt384(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("/", 1);
  gBuf.format_s(a1);
...
void _PrintShValue(runtime_asdl::value_t* val, mylib::BufWriter* buf) {
  ...
  switch (val->tag_()) {
    ...
    case value_e::MaybeStrArray: {
      ...
      parts = Alloc<List<Str*>>(std::initializer_list<Str*>{str57});
    ...
    case value_e::AssocArray: {
      ...
      parts = Alloc<List<Str*>>(std::initializer_list<Str*>{str60});
...
Tracer::Tracer(parse_lib::ParseContext* parse_ctx, optview::Exec* exec_opts, state::MutableOpts* mutable_opts, state::Mem* mem, util::_DebugFile* f) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Tracer)) {
  ...
  this->ind = 0;
  this->indents = Alloc<List<Str*>>(std::initializer_list<Str*>{str66});
...
void ShellExecutor::RunPipeline(syntax_asdl::command__Pipeline* node, runtime_asdl::CommandStatus* status_out) {
  ...
  {  // with
    dev::ctx_Tracer ctx(this->tracer, str134, nullptr);
...
Str* ShellExecutor::RunCommandSub(syntax_asdl::command_sub* cs_part) {
  ...
  if (node->tag_() == command_e::Simple) {
    ...
    if ((len(simple->words) == 0 and (len(simple->redirects) == 1 and simple->redirects->index_(0)->op->id == Id::Redir_Less))) {
      tok = Alloc<Token>(Id::Lit_Chars, runtime::NO_SPID, str136);
  ...
  while (true) {
    ...
    if (n < 0) {
      if (err_num == EINTR) {
        ...
        e_die(fmt29(posix::strerror(err_num)), 2);
      }
    }
    else {
      if (n == 0) {
  ...
  return str139->join(chunks)->rstrip(str140);
}
...
mylib::LineReader* FdState::Open(Str* path) {
  ...
  fd_mode = O_RDONLY;
  return this->_Open(path, str145, fd_mode);
}
...
void ExternalProgram::_Exec(Str* argv0_path, List<Str*>* argv, int argv0_spid, Dict<Str*, Str*>* environ, bool should_retry) {
  ...
  try {
    ...
    if ((e->errno == ENOEXEC and should_retry)) {
      new_argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str155, argv0_path});
      new_argv->extend(argv->slice(1));
      this->_Exec(str156, new_argv, argv0_spid, environ, false);
    }
...
int Process::Start(runtime_asdl::trace_t* why) {
  ...
  pid = posix::fork();
  if (pid < 0) {
    throw Alloc<RuntimeError>(str170);
  }
  else {
    if (pid == 0) {
...
runtime_asdl::cmd_value__Argv* MakeBuiltinArgv(List<Str*>* argv1) {
  ...
  argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str185});
  argv->extend(argv1);
...
int Main(Str* lang, args::Reader* arg_r, Dict<Str*, Str*>* environ, bool login_shell, pyutil::_ResourceLoader* loader, void* line_input) {
  ...
  if (flag->help) {
    help_builtin->Run(MakeBuiltinArgv(Alloc<List<Str*>>(std::initializer_list<Str*>{fmt55(lang)})));
    return 0;
  }
  if (flag->version) {
    pyutil::ShowAppVersion(str189, loader);
    return 0;
  }
  no_str = nullptr;
  ...
  if (arg_r->AtEnd()) {
    ...
    dollar0 = arg_r->Peek();
    frame0 = Alloc<state::DebugFrame>(dollar0, str190, no_str, state::LINE_ZERO, 0, 0);
  ...
  if (str_equals(lang, str191)) {
    mutable_opts->SetAnyOption(str192, true);
  }
  ...
  comp_arena->PushSource(Alloc<source::Unused>(str194));
  ...
  hist_arena->PushSource(Alloc<source::Unused>(str195));
  ...
  interp = environ->get(str200, str201);
  ...
  crash_dump_dir = environ->get(str202, str203);
  ...
  if (flag->c != nullptr) {
    ...
    if (flag->i) {
      ...
      if (script_name == nullptr) {
        stdin = mylib::Stdin();
        arena->PushSource(Alloc<source::Stdin>(str204));
...
Str* SearchPath::Lookup(Str* name, bool exec_required) {
  ...
  val = this->mem->GetValue(str211);
  UP_val = val;
  if (val->tag_() == value_e::Str) {
    value__Str* val = static_cast<value__Str*>(UP_val);
    path_list = val->s->split(str212);
  }
  else {
...
ctx_HayNode::ctx_HayNode(state::Hay* hay_state, Str* hay_name) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(ctx_HayNode)) {
  this->hay_state = hay_state;
...
ctx_HayEval::ctx_HayEval(state::Hay* hay_state, state::MutableOpts* mutable_opts, state::Mem* mem) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(ctx_HayEval)) {
  this->hay_state = hay_state;
  this->mutable_opts = mutable_opts;
  this->mem = mem;
...
Hay::Hay() : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Hay)) {
  this->root_defs = Alloc<hay_node>();
  this->cur_defs = this->root_defs;
  this->def_stack = Alloc<List<runtime_asdl::hay_node*>>(std::initializer_list<runtime_asdl::hay_node*>{this->root_defs});
  Dict<Str*, void*>* node = this->_MakeOutputNode();
  this->result_stack = Alloc<List<Dict<Str*, void*>*>>(std::initializer_list<Dict<Str*, void*>*>{node});
  this->output = nullptr;
}

Dict<Str*, void*>* Hay::_MakeOutputNode() {
  auto* d = NewDict<Str*, void*>();
  d->set(str214, nullptr);
  d->set(str215, Alloc<List<void*>>());
  return d;
}
...
void MutableOpts::Init() {
  ...
  UP_shellopts = this->mem->GetValue(str219);
...
void MutableOpts::SetOldOption(Str* opt_name, bool b) {
  ...
  UP_val = this->mem->GetValue(str223);
  value__Str* val = static_cast<value__Str*>(UP_val);
  shellopts = val->s;
  if (b) {
    if (!str_contains(shellopts, opt_name)) {
      new_val = Alloc<value::Str>(fmt64(shellopts, opt_name));
      this->mem->InternalSetGlobal(str225, new_val);
    }
  }
  else {
    if (str_contains(shellopts, opt_name)) {
      names = Alloc<List<Str*>>();
      for (ListIter<Str*> it(shellopts->split(str226)); !it.Done(); it.Next()) {
        Str* n = it.Value();
        if (!(str_equals(n, opt_name))) {
          names->append(n);
        }
      }
      new_val = Alloc<value::Str>(str227->join(names));
      this->mem->InternalSetGlobal(str228, new_val);
    }
  }
}
...
void MutableOpts::ShowOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    b = this->Get(opt_num);
    print(fmt65(b ? str230 : str231, opt_name));
  }
}
...
void MutableOpts::ShowShoptOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<int> it(opt_nums); !it.Done(); it.Next()) {
    ...
    StackRoots _for({&opt_num  });
    b = this->Get(opt_num);
    print(fmt67(b ? str234 : str235, consts::OptionName(opt_num)));
  }
}
...
void _InitDefaults(state::Mem* mem) {
  ...
  SetGlobalString(mem, str238, split::DEFAULT_IFS);
  SetGlobalString(mem, str239, str(posix::getuid()));
  SetGlobalString(mem, str240, str(posix::geteuid()));
  SetGlobalString(mem, str241, str(posix::getppid()));
  SetGlobalString(mem, str242, libc::gethostname());
  SetGlobalString(mem, str243, pyos::OsType());
  SetGlobalString(mem, str244, str245);
  SetGlobalString(mem, str246, str247);
  SetGlobalString(mem, str248, _READLINE_DELIMS);
}
...
void _InitVarsFromEnv(state::Mem* mem, Dict<Str*, Str*>* environ) {
  ...
  val = mem->GetValue(str249);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str250, str251);
  }
  mem->SetValue(Alloc<lvalue::Named>(str252), nullptr, scope_e::GlobalOnly, SetReadOnly);
  val = mem->GetValue(str253);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str254, _GetWorkingDir());
  }
  mem->SetValue(Alloc<lvalue::Named>(str255), nullptr, scope_e::GlobalOnly, SetExport);
  val = mem->GetValue(str256);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str257, str258);
  }
}
...
void InitMem(state::Mem* mem, Dict<Str*, Str*>* environ, Str* version_str) {
  ...
  SetGlobalString(mem, str259, version_str);
  _InitDefaults(mem);
  _InitVarsFromEnv(mem, environ);
  val = mem->GetValue(str260);
...
void InitInteractive(state::Mem* mem) {
  ...
  if (mem->GetValue(str261)->tag_() == value_e::Undef) {
    SetGlobalString(mem, str262, str263);
  }
}
...
Mem::Mem(Str* dollar0, List<Str*>* argv, alloc::Arena* arena, List<state::DebugFrame*>* debug_stack) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Mem)) {
  ...
  this->var_stack = Alloc<List<Dict<Str*, runtime_asdl::cell*>*>>(std::initializer_list<Dict<Str*, runtime_asdl::cell*>*>{frame});
  this->arena = arena;
  this->debug_stack = debug_stack;
  this->pwd = nullptr;
  this->current_spid = runtime::NO_SPID;
  this->line_num = Alloc<value::Str>(str264);
...
Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> Mem::_ResolveNameOrRef(Str* name, runtime_asdl::scope_t which_scopes, bool is_setref, List<Str*>* ref_trail) {
  ...
  if (ref_trail == nullptr) {
    ...
    if (list_contains(ref_trail, new_name)) {
      e_die(fmt71(str276->join(ref_trail)));
    }
  }
  ...
  switch (lval->tag_()) {
    case lvalue_e::Named: {
      ...
      if (keyword_id == Id::KW_SetRef) {
        lval->name = str_concat(str277, lval->name);
      }
...
runtime_asdl::value_t* Mem::GetValue(Str* name, runtime_asdl::scope_t which_scopes) {
  ...
  if ((str_equals(name, str288) || str_equals(name, str289))) {
    return Alloc<value::MaybeStrArray>();
  }
  if (str_equals(name, str290)) {
    return Alloc<value::MaybeStrArray>();
  }
...
Str* PrettyDir(Str* dir_name, Str* home_dir) {
  ...
  if (home_dir != nullptr) {
    if ((str_equals(dir_name, home_dir) or dir_name->startswith(str_concat(home_dir, str306)))) {
      return str_concat(str307, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    StackRoots _for({&c  });
    buf->write(str_equals(c, str310) ? str311 : str312);
  }
  buf->write(str313);
  buf->write(str_repeat(str314, (length - 1)));
  buf->write(str315);
...
void ErrorFormatter::Print_(Str* msg, int span_id) {
  ...
  _PrintWithSpanId(str331, msg, span_id, this->arena, true);
}
...
void ErrorFormatter::PrintMessage(Str* msg, int span_id) {
  ...
  _PrintWithSpanId(str332, msg, span_id, this->arena, false);
}
...
void PrintAst(syntax_asdl::command_t* node, arg_types::main* flag) {
  ...
  if (maybe_str_equals(flag->ast_format, str335)) {
    println_stderr(str336);
  }
  else {
    f = mylib::Stdout();
    afmt = flag->ast_format;
    if ((maybe_str_equals(afmt, str337) || maybe_str_equals(afmt, str338))) {
      ast_f = fmt::DetectConsoleOutput(f);
    }
    else {
      if ((maybe_str_equals(afmt, str339) || maybe_str_equals(afmt, str340))) {
...
void _Attributes::Set(Str* name, runtime_asdl::value_t* val) {
  ...
  name = name->replace(str344, str345);
...
bool SetAttachedBool::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  if (attached_arg != nullptr) {
    if ((str_equals(attached_arg, str361) || str_equals(attached_arg, str362) || str_equals(attached_arg, str363) || str_equals(attached_arg, str364))) {
      b = false;
    }
    else {
      if ((str_equals(attached_arg, str365) || str_equals(attached_arg, str366) || str_equals(attached_arg, str367) || str_equals(attached_arg, str368))) {
        b = true;
      }
      else {
...
bool SetOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str370);
...
args::_Attributes* Parse(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str375)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if ((len(spec->actions_long) and arg->startswith(str376))) {
      pos = arg->find(str377, 2);
      if (pos == -1) {
        suffix = nullptr;
      ...
      if ((arg->startswith(str379) and len(arg) > 1)) {
        n = len(arg);
        for (int i = 1; i < n; ++i) {
          ch = arg->index_(i);
          if (str_equals(ch, str380)) {
            ch = str381;
          }
          if (list_contains(spec->plus_flags, ch)) {
            out->Set(ch, Alloc<value::Str>(str382));
            continue;
          }
        ...
        if ((len(spec->plus_flags) and (arg->startswith(str385) and len(arg) > 1))) {
          n = len(arg);
          for (int i = 1; i < n; ++i) {
            ch = arg->index_(i);
            if (list_contains(spec->plus_flags, ch)) {
              out->Set(ch, Alloc<value::Str>(str386));
              continue;
            }
            e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
          }
...
args::_Attributes* ParseLikeEcho(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    chars = arg->slice(1);
    if ((arg->startswith(str389) and len(chars))) {
      done = false;
...
args::_Attributes* ParseMore(flag_spec::_FlagSpecAndMore* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str390)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if (arg->startswith(str391)) {
    ...
    if (((arg->startswith(str393) or arg->startswith(str394)) and len(arg) > 1)) {
      char0 = arg->index_(0);
...
int LineLexer::GetSpanIdForEof() {
  int line_id;
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str398, 0);
  }
  else {
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str400, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = Alloc<Token>(id_, span_id, str401);
      return t;
    }
...
lexer::Lexer* ParseContext::MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = Alloc<lexer::LineLexer>(str403, this->arena);
...
ExprParser::ExprParser(parse_lib::ParseContext* parse_ctx, grammar::Grammar* gr, bool tea_keywords) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(ExprParser)) {
  this->parse_ctx = parse_ctx;
  this->gr = gr;
...
GLOBAL_LIST(Str*, 12, POSIX_CLASSES, {str417 COMMA str418 COMMA str419 COMMA str420 COMMA str421 COMMA str422 COMMA str423 COMMA str424 COMMA str425 COMMA str426 COMMA str427 COMMA str428});
Str* RANGE_POINT_TOO_LONG = str429;
int NT_OFFSET = 256;
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw Alloc<NotImplementedError>(str431);
  }
  if (id0 == Id::Op_LBracket) {
    elts = Alloc<List<syntax_asdl::expr_t*>>();
    for (int i = 0; i < n; i += 2) {
  ...
  while (i < n) {
    ...
    if ((prefix and prefix->id == Id::Expr_At)) {
      ...
      if (typ == nullptr) {
        ...
        if ((typ->val != str436 && typ->val != str437)) {
          p_die(fmt110(), typ);
        }
...
syntax_asdl::re_t* Transformer::_NameInRegex(syntax_asdl::Token* negated_tok, syntax_asdl::Token* tok) {
  ...
  val = tok->val;
  if (maybe_str_equals(val, str440)) {
    if (negated_tok) {
      p_die(fmt111(), tok);
    }
    return tok;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((str_equals(tok->val, str445) || str_equals(tok->val, str446) || str_equals(tok->val, str447))) {
        return tok;
      }
...
ParseHay::ParseHay(process::FdState* fd_state, parse_lib::ParseContext* parse_ctx, ui::ErrorFormatter* errfmt) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(ParseHay)) {
  this->fd_state = fd_state;
  this->parse_ctx = parse_ctx;
  this->errfmt = errfmt;
}
...
runtime_asdl::value_t* ParseHay::Call(Str* path) {
  ...
  try {
    ...
    throw Alloc<error::Expr>(fmt116(path, msg), call_spid);
  }
...
EvalHay::EvalHay(state::Hay* hay_state, state::MutableOpts* mutable_opts, state::Mem* mem, cmd_eval::CommandEvaluator* cmd_ev) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(EvalHay)) {
  this->hay_state = hay_state;
  this->mutable_opts = mutable_opts;
  this->mem = mem;
  this->cmd_ev = cmd_ev;
...
BlockAsStr::BlockAsStr(alloc::Arena* arena) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(BlockAsStr)) {
  this->arena = arena;
}
...
HayFunc::HayFunc(state::Hay* hay_state) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(HayFunc)) {
  this->hay_state = hay_state;
}
...
void _ClassLiteralToPosixEre(syntax_asdl::class_literal_term_t* term, List<Str*>* parts) {
  ...
  if (tag == class_literal_term_e::CodePoint) {
    ...
    if (code_point < 128) {
      ...
      e_die(fmt118(code_point), term->spid);
    }
    return ;
  }
  if (tag == class_literal_term_e::PerlClass) {
    ...
    if (term->negated) {
      e_die(fmt119(), term->negated->span_id);
    }
    else {
      pat = fmt120(chars);
    }
...
void AsPosixEre(syntax_asdl::re_t* node, List<Str*>* parts) {
  ...
  if (tag == re_e::Repeat) {
    ...
    if (op_tag == re_repeat_e::Num) {
      ...
      parts->append(fmt124(op->times->val));
      return ;
    }
    if (op_tag == re_repeat_e::Range) {
      re_repeat__Range* op = static_cast<re_repeat__Range*>(UP_op);
      lower = op->lower ? op->lower->val : str465;
      upper = op->upper ? op->upper->val : str466;
      parts->append(fmt125(lower, upper));
      return ;
    }
...
syntax_asdl::bool_expr_t* BoolParser::ParseForBuiltin() {
  ...
  if (this->bool_id != Id::Eof_Real) {
    p_die(fmt132(word_::Pretty(this->cur_word)), this->cur_word);
  }
  return node;
}
...
syntax_asdl::bool_expr_t* BoolParser::ParseFactor() {
  ...
  p_die(fmt135(ui::PrettyId(this->bool_id)), this->cur_word);
}
...
Str* _RangeParser::_Eat(int token_type) {
  ...
  if (this->token_type != token_type) {
    throw Alloc<_NotARange>(fmt136(token_type, this->token_type));
  }
  val = this->token_val;
  this->_Next();
  return val;
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  flag = attrs->attrs;
  tmp_g = flag->get(str494);
  tmp_a = flag->get(str495);
  tmp_A = flag->get(str496);
  ...
  flag_A = (tmp_A and tmp_A->tag_() == value_e::Bool) ? static_cast<value__Bool*>(tmp_A)->b : false;
  tmp_n = flag->get(str497);
  tmp_r = flag->get(str498);
  tmp_x = flag->get(str499);
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if ((maybe_str_equals(flag_n, str501) and !cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_n, str502) and cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str503) and !cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str504) and cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str505) and !cell->exported)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str506) and cell->exported)) {
      continue;
    }
    ...
    if (print_flags) {
      ...
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str513, str514->join(flags), str515, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str516, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (has_holes) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str519, name, str520, str(i), str521, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str523, str524->join(body), str525}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str527, key_quoted, str528, value_quoted}));
          }
          if (len(body) > 0) {
            decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str529, str530->join(body), str531}));
          }
        }
        else {
          ;  // pass
...
int Export::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r->Next();
  attrs = flag_spec::Parse(str533, arg_r);
...
int Readonly::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str538, arg_r);
...
int NewVar::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str539, arg_r);
  ...
  flags_to_clear = 0;
  if (maybe_str_equals(arg->x, str545)) {
    flags |= state::ClearExport;
  }
  if (maybe_str_equals(arg->r, str546)) {
    flags |= state::ClearReadOnly;
  }
  if (maybe_str_equals(arg->n, str547)) {
...
int Eval::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str551, cmd_val);
  arg_r = tup0.at1();
  if (this->exec_opts->simple_eval_builtin()) {
    Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str552);
    code_str = tup1.at0();
    eval_spid = tup1.at1();
    if (!arg_r->AtEnd()) {
      e_usage(str553);
    ...
    code_str = str554->join(arg_r->Rest());
    eval_spid = cmd_val->arg_spids->index_(0);
  }
  line_reader = reader::StringLineReader(code_str, this->arena);
  c_parser = this->parse_ctx->MakeOshParser(line_reader);
  src = Alloc<source::ArgvWord>(str555, eval_spid);
  {  // with
    dev::ctx_Tracer ctx(this->tracer, str556, nullptr);
...
int Source::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str557, cmd_val);
  arg_r = tup2.at1();
  path = arg_r->Peek();
  if (path == nullptr) {
    e_usage(str558);
  ...
  try {
    ...
    this->errfmt->Print_(fmt149(path, pyutil::strerror(e)), cmd_val->arg_spids->index_(1));
    return 1;
  }
  try {
    try {
      ...
      c_parser = this->parse_ctx->MakeOshParser(line_reader);
      {  // with
        dev::ctx_Tracer ctx(this->tracer, str560, cmd_val->argv);
...
int Command::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup3 = flag_spec::ParseCmdVal(str561, cmd_val, true);
  attrs = tup3.at0();
  arg_r = tup3.at1();
...
int Builtin::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (to_run == consts::NO_INDEX) {
    ...
    if (consts::LookupAssignBuiltin(name) != consts::NO_INDEX) {
      this->errfmt->Print_(str562, span_id);
    }
    else {
      this->errfmt->Print_(fmt150(name), span_id);
    }
    return 1;
  }
...
int RunProc::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str564, cmd_val, true);
  arg_r = tup5.at1();
  Tuple2<List<Str*>*, List<int>*> tup6 = arg_r->Rest2();
  argv = tup6.at0();
  spids = tup6.at1();
  if (len(argv) == 0) {
    throw Alloc<error::Usage>(str565, runtime::NO_SPID);
  }
  name = argv->index_(0);
  if (!dict_contains(this->procs, name)) {
    this->errfmt->PrintMessage(fmt151(name));
    return 1;
  }
...
int Try::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup7 = flag_spec::ParseCmdVal(str567, cmd_val, true);
  arg_r = tup7.at1();
...
int BoolStatus::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseCmdVal(str569, cmd_val);
  arg_r = tup9.at1();
  if (arg_r->Peek() == nullptr) {
    e_usage(str570);
  }
  ...
  if ((status != 0 && status != 1)) {
    throw Alloc<error::FatalRuntime>(fmt152(status), spids->index_(0), status);
  }
  return status;
}
        ...
        if (consts::LookupNormalBuiltin(name) != 0) {
          ...
          if (consts::LookupSpecialBuiltin(name) != 0) {
            ...
            if (consts::LookupAssignBuiltin(name) != 0) {
              kind = (Alloc<Tuple2<Str*, Str*>>(str576, name));
            }
            else {
              if (consts::IsControlFlow(name)) {
                kind = (Alloc<Tuple2<Str*, Str*>>(str577, name));
              }
              else {
                if (consts::IsKeyword(name)) {
                  kind = (Alloc<Tuple2<Str*, Str*>>(str578, name));
                }
                else {
                  ...
                  if (resolved == nullptr) {
                    ...
                    kind = (Alloc<Tuple2<Str*, Str*>>(str579, resolved));
                  }
                }
              }
            }
...
int Type::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseCmdVal(str580, cmd_val);
  attrs = tup11.at0();
  arg_r = tup11.at1();
...
int Read::_Line(arg_types::read* arg, Str* var_name) {
  ...
  if (!arg->with_eol) {
    if (line->endswith(str588)) {
      ...
      if (line->endswith(str589)) {
        line = line->slice(0, -1);
      }
    }
  }
  if ((arg->q and line->startswith(str590))) {
    arena = this->parse_ctx->arena;
    line_reader = reader::StringLineReader(line, arena);
    lexer = this->parse_ctx->MakeLexer(line_reader);
    try {
      {  // with
        alloc::ctx_Location ctx(arena, Alloc<source::Stdin>(str591));
...
int Read::_Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str594, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
  ...
  if (arg->line) {
    ...
    next_spid = tup8.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str597, next_spid);
    }
  ...
  if (arg->all) {
    ...
    next_spid = tup10.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str601, next_spid);
    }
...
int MapFile::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup13 = flag_spec::ParseCmdVal(str608, cmd_val);
  attrs = tup13.at0();
  arg_r = tup13.at1();
  ...
  while (true) {
    ...
    if ((arg->t and line->endswith(str612))) {
      line = line->slice(0, -1);
    }
    lines->append(line);
  }
...
int Cd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str613, cmd_val, true);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  ...
  arg_spid = tup16.at1();
  if (dest_dir == nullptr) {
    val = this->mem->GetValue(str614);
    try {
      dest_dir = state::GetString(this->mem, str615);
    }
    catch (error::Runtime* e) {
  ...
  if (str_equals(dest_dir, str616)) {
    try {
      dest_dir = state::GetString(this->mem, str617);
      print(dest_dir);
    }
    catch (error::Runtime* e) {
      this->errfmt->Print_(e->UserErrorString());
  ...
  try {
    pwd = state::GetString(this->mem, str618);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    return 1;
  ...
  state::ExportGlobalString(this->mem, str620, real_dest_dir);
  ...
  if (block) {
    ...
    state::ExportGlobalString(this->mem, str621, pwd);
...
int Pushd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup17 = flag_spec::ParseCmdVal(str624, cmd_val);
  arg_r = tup17.at1();
  ...
  if (extra != nullptr) {
    e_usage(fmt159(), extra_spid);
  }
  dest_dir = os_path::abspath(dir_arg);
  err_num = pyos::Chdir(dest_dir);
  if (err_num != 0) {
    this->errfmt->Print_(fmt160(dest_dir, posix::strerror(err_num)), dir_arg_spid);
    return 1;
  }
...
bool _PopDirStack(state::Mem* mem, state::DirStack* dir_stack, ui::ErrorFormatter* errfmt) {
  ...
  err_num = pyos::Chdir(dest_dir);
  if (err_num != 0) {
    errfmt->Print_(fmt161(dest_dir, posix::strerror(err_num)));
    return false;
  }
...
int Popd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup20 = flag_spec::ParseCmdVal(str633, cmd_val);
  arg_r = tup20.at1();
  ...
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str635));
  return 0;
}
...
int Dirs::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup22 = flag_spec::ParseCmdVal(str636, cmd_val);
  attrs = tup22.at0();
  arg_r = tup22.at1();
  arg = Alloc<arg_types::dirs>(attrs->attrs);
  home_dir = state::MaybeString(this->mem, str637);
  style = SINGLE_LINE;
  if (arg->l) {
    home_dir = nullptr;
  }
...
int Pwd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup23 = flag_spec::ParseCmdVal(str638, cmd_val);
  attrs = tup23.at0();
  arg_r = tup23.at1();
...
List<Str*>* Help::_Groups() {
  ...
  contents = this->loader->Get(str639);
...
int Help::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup24 = flag_spec::ParseCmdVal(str640, cmd_val);
  attrs = tup24.at0();
  arg_r = tup24.at1();
  ...
  try {
    contents = this->loader->Get(fmt163(topic));
  }
  catch (IOError*) {
    this->errfmt->Print_(fmt164(topic), blame_spid);
    return 1;
  }
  print(contents);
  return 0;
  ...
  while (true) {
    ...
    if (n < 0) {
      if (err_num == EINTR) {
        ...
        e_die(fmt165(posix::strerror(err_num)), 2);
      }
    }
    else {
      if (n == 0) {
...
syntax_asdl::printf_part_t* _FormatStringParser::_ParseFormatStr() {
  ...
  while ((this->token_type == Id::Format_Flag || this->token_type == Id::Format_Zero)) {
    ...
    if (str_contains(str645, flag)) {
      p_die(fmt166(flag), this->cur_token);
    }
  ...
  if ((this->token_type == Id::Format_Type || this->token_type == Id::Format_Time)) {
    ...
    if (str_contains(str647, part->type->val)) {
      p_die(fmt167(), part->type);
    }
    if (maybe_str_equals(part->type->val, str649)) {
      p_die(fmt168(), part->type);
    }
  }
  else {
        ...
        if (part->tag_() == printf_part_e::Percent) {
          ...
          if (part->width) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt171(width_str), width_spid);
              return 1;
            }
          }
          precision = -1;
          if (part->precision) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt172(precision_str), precision_spid);
              return 1;
            }
          }
          if (arg_index < num_args) {
          ...
          if (str_equals(typ, str660)) {
            ...
            if (str_equals(typ, str661)) {
              s = qsn::maybe_shell_encode(s);
            }
            else {
              if (str_equals(typ, str662)) {
                ...
                s = str663->join(c_parts);
              }
              else {
                if ((part->type->id == Id::Format_Time or str_contains(str664, typ))) {
                  try {
                    d = to_int(s);
                  }
                  catch (ValueError*) {
                    if ((len(s) >= 1 and str_contains(str665, s->index_(0)))) {
                  ...
                  if (part->type->id == Id::Format_Time) {
                    ...
                    if ((d < 0 and str_contains(str669, typ))) {
                      e_die(fmt174(d, typ), part->type->span_id);
                    }
                    ...
                    zero_pad = 0;
                    if ((width >= 0 and list_contains(flags, str674))) {
                      zero_pad = 1;
                    }
                    else {
                    ...
                    if (zero_pad) {
                      negative = str_equals(s->index_(0), str675);
                      if (negative) {
                        digits = s->slice(1);
                        sign = str676;
                        if (zero_pad == 1) {
                      ...
                      s = str_concat(sign, digits->rjust(n, str678));
                    }
                  }
                }
                else {
          ...
          if (width >= 0) {
            if (list_contains(flags, str679)) {
              s = s->ljust(width, str680);
            }
            else {
              s = s->rjust(width, str681);
            }
          }
          out->append(s);
        }
...
int Printf::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup1 = flag_spec::ParseCmdVal(str682, cmd_val);
  attrs = tup1.at0();
  arg_r = tup1.at1();
  arg = Alloc<arg_types::printf>(attrs->attrs);
  Tuple2<Str*, int> tup2 = arg_r->ReadRequired2(str683);
  fmt = tup2.at0();
  fmt_spid = tup2.at1();
  ...
  if (dict_contains(this->parse_cache, fmt)) {
    ...
    {  // with
      alloc::ctx_Location ctx(arena, Alloc<source::ArgvWord>(str684, fmt_spid));
...
int Alias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str686, cmd_val);
  arg_r = tup0.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup1 = mylib::split_once(arg, str688);
    name = tup1.at0();
    alias_exp = tup1.at1();
    if (alias_exp == nullptr) {
      alias_exp = this->aliases->get(name);
      if (alias_exp == nullptr) {
        this->errfmt->Print_(fmt176(name), cmd_val->arg_spids->index_(i));
        status = 1;
      }
      else {
...
int UnAlias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str691, cmd_val);
  arg_r = tup2.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
    e_usage(str692);
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->argv) == 1) {
    ...
    for (ListIter<Str*> it(sorted(mapping)); !it.Done(); it.Next()) {
      ...
      code_str = fmt179(name, qsn::maybe_shell_encode(str_val));
      print(code_str);
    }
    return 0;
  }
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  arg = flag_spec::ParseMore(str695, arg_r);
  if (arg->show_options) {
...
int Shopt::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup7 = flag_spec::ParseCmdVal(str696, cmd_val, true);
  attrs = tup7.at0();
  arg_r = tup7.at1();
...
int Hash::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup8 = flag_spec::ParseCmdVal(str698, cmd_val);
  attrs = tup8.at0();
  arg_r = tup8.at1();
...
Dict<Str*, bool>* _ParseOptSpec(Str* spec_str) {
  ...
  while (true) {
    ...
    if (str_equals(spec_str->index_(i), str701)) {
      spec->set(ch, true);
      i += 1;
    }
  }
...
int GetOptsState::_OptInd() {
  int result;
  try {
    result = state::GetInteger(this->mem, str702);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    result = -1;
...
void GetOptsState::IncIndex() {
  state::BuiltinSetString(this->mem, str703, str((this->_optind + 1)));
}

void GetOptsState::SetArg(Str* optarg) {
  StackRoots _roots({&optarg});

  state::BuiltinSetString(this->mem, str704, optarg);
}

void GetOptsState::Fail() {
  state::BuiltinSetString(this->mem, str705, str706);
}
...
Tuple2<int, Str*> _GetOpts(Dict<Str*, bool>* spec, List<Str*>* argv, builtin_pure::GetOptsState* my_state, ui::ErrorFormatter* errfmt) {
  ...
  if ((!current->startswith(str708) or str_equals(current, str709))) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str710));
  }
  ...
  if (!dict_contains(spec, flag_char)) {
    return (Tuple2<int, Str*>(0, str711));
  }
  if (spec->index_(flag_char)) {
    if (more_chars) {
      ...
      if (optarg == nullptr) {
        my_state->Fail();
        errfmt->Print_(fmt182(current));
        tmp = Alloc<List<Str*>>();
        for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
          Str* a = it.Value();
          tmp->append(qsn::maybe_shell_encode(a));
        }
        println_stderr(fmt183(str714->join(tmp)));
        return (Tuple2<int, Str*>(0, str715));
      }
    }
    my_state->IncIndex();
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  spec_str = arg_r->ReadRequired(str717);
  Tuple2<Str*, int> tup9 = arg_r->ReadRequired2(str718);
  var_name = tup9.at0();
  var_spid = tup9.at1();
  ...
  if (match::IsValidVarName(var_name)) {
    ...
    throw Alloc<error::Usage>(fmt184(var_name), var_spid);
  }
  return status;
}
...
int Echo::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseLikeEcho(str720, cmd_val);
  attrs = tup11.at0();
  arg_r = tup11.at1();
  ...
  if (arg->e) {
    ...
    for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
      ...
      new_argv->append(str721->join(parts));
      if (backslash_c) {
        break;
      }
    }
...
int Module::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup13 = flag_spec::ParseCmdVal(str725, cmd_val);
  arg_r = tup13.at1();
  Tuple2<Str*, int> tup14 = arg_r->ReadRequired2(str726);
  name = tup14.at0();
  if (dict_contains(this->modules, name)) {
    if (this->exec_opts->redefine_module()) {
      this->errfmt->PrintMessage(fmt185(name));
      return 0;
    }
    else {
      return 1;
...
int Use::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_spid = tup15.at1();
  if (arg == nullptr) {
    throw Alloc<error::Usage>(str728, runtime::NO_SPID);
  }
  arg_r->Next();
  if (str_equals(arg, str729)) {
    Tuple2<Str*, int> tup16 = arg_r->Peek2();
    expected = tup16.at0();
    e_spid = tup16.at1();
    if (expected == nullptr) {
      throw Alloc<error::Usage>(str730, runtime::NO_SPID);
    }
    UP_actual = this->mem->GetValue(str731, scope_e::Dynamic);
    if (UP_actual->tag_() == value_e::Str) {
      ...
      if (maybe_str_equals(actual, expected)) {
        ...
        this->errfmt->Print_(fmt186(expected, actual), e_spid);
        return 1;
      }
    }
    else {
      this->errfmt->Print_(fmt187(expected), e_spid);
      return 1;
    }
  }
  if (str_equals(arg, str734)) {
    rest = arg_r->Rest();
    for (ListIter<Str*> it(rest); !it.Done(); it.Next()) {
      Str* name = it.Value();
      StackRoots _for({&name    });
      println_stderr(fmt188(name));
    }
    return 0;
  }
  throw Alloc<error::Usage>(str736, arg_spid);
}
...
int Shvar::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup17 = flag_spec::ParseCmdVal(str737, cmd_val, true);
  arg_r = tup17.at1();
  block = typed_args::GetOneBlock(cmd_val->typed_args);
  if (!block) {
    throw Alloc<error::Usage>(str738, runtime::NO_SPID);
  }
  ...
  for (ListIter<Str*> it(args); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup19 = mylib::split_once(arg, str740);
    name = tup19.at0();
    s = tup19.at1();
    if (s == nullptr) {
      throw Alloc<error::Usage>(str741, arg_spids->index_(i));
    }
...
int PushRegisters::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup20 = flag_spec::ParseCmdVal(str743, cmd_val, true);
  arg_r = tup20.at1();
  block = typed_args::GetOneBlock(cmd_val->typed_args);
  if (!block) {
...
int Fopen::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup21 = flag_spec::ParseCmdVal(str745, cmd_val, true);
  arg_r = tup21.at1();
  block = typed_args::GetOneBlock(cmd_val->typed_args);
  if (!block) {
...
int CommandEvaluator::_RunAssignBuiltin(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  if (builtin_func == nullptr) {
    e_die(fmt189(cmd_val->argv->index_(0)), cmd_val->arg_spids->index_(0));
  }
  try {
    try {
      status = builtin_func->Run(cmd_val);
      ...
      this->errfmt->PrefixPrint(e->msg, fmt190(arg0), e->span_id);
      status = 2;
    }
  }
  catch (std::exception) { }  return status;
  ...
  switch (arg->tag_()) {
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        filename = val->s;
        if (len(filename) == 0) {
          throw Alloc<error::RedirectEval>(str756, arg_word);
        }
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          t = val->s;
          if (len(t) == 0) {
            throw Alloc<error::RedirectEval>(str757, arg_word);
            return nullptr;
          }
          try {
            if (maybe_str_equals(t, str758)) {
              result->arg = Alloc<redirect_arg::CloseFd>();
            }
            else {
              if (str_equals(t->index_(-1), str759)) {
            ...
            throw Alloc<error::RedirectEval>(fmt192(t), arg_word);
            return nullptr;
          }
          return result;
        }
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = Alloc<redirect_arg::HereDoc>(str_concat(val->s, str761));
            return result;
          }
          else {
            throw Alloc<AssertionError>();
...
void CommandEvaluator::_StrictErrExit(syntax_asdl::command_t* node) {
  ...
  if (_HasManyStatuses(node)) {
    ...
    e_die(fmt193(node_str), location::SpanForCommand(node));
  }
}
...
void CommandEvaluator::_StrictErrExitList(List<syntax_asdl::command_t*>* node_list) {
  ...
  if (len(node_list) > 1) {
    e_die(fmt194(), location::SpanForCommand(node_list->index_(0)));
  }
  ...
  switch (node->tag_()) {
    case command_e::Simple: {
      ...
      if (UP_cmd_val->tag_() == cmd_value_e::Argv) {
        ...
        if (node->block) {
          e_die(fmt196(), node->block->spids->index_(0));
        }
        cmd_value__Assign* cmd_val = static_cast<cmd_value__Assign*>(UP_cmd_val);
      }
    ...
    case command_e::Pipeline: {
      ...
      if (len(node->stderr_indices)) {
        e_die(fmt197(), node->spids->index_(0));
      }
      if (node->negated) {
    ...
    case command_e::ControlFlow: {
      ...
      if (node->arg_word) {
        ...
        if ((len(str_val->s) == 0 and !this->exec_opts->strict_control_flow())) {
          ...
          try {
            ...
            e_die(fmt198(node->token->val, str_val->s), node->arg_word);
          }
        }
      }
      else {
      ...
      if (ok) {
        ...
        if (this->exec_opts->strict_control_flow()) {
          ...
          this->errfmt->PrefixPrint(msg, str771, tok->span_id);
          status = 0;
        }
      }
    }
        ...
        try {
          ...
          if (n == 1) {
            ...
            if (n == 2) {
              ...
              e_die(fmt199(node->spids->index_(0)), 2);
            }
          }
          index = 0;
    ...
    case command_e::ShFunction: {
      ...
      if ((dict_contains(this->procs, node->name) and !this->exec_opts->redefine_proc())) {
        e_die(fmt200(node->name), node->spids->index_(1));
      }
    ...
    case command_e::Proc: {
      ...
      if ((dict_contains(this->procs, node->name->val) and !this->exec_opts->redefine_proc())) {
        e_die(fmt201(node->name->val), node->name->span_id);
      }
      defaults = nullptr;
    ...
    {  // with
      ...
      for (ListIter<syntax_asdl::command_t*> it(to_run); !it.Done(); it.Next()) {
        ...
        {  // with
          ...
          {  // with
            dev::ctx_Tracer ctx(this->tracer, str775, nullptr);
      ...
      if (this->shell_ex->PushRedirects(redirects)) {
        {  // with
          ...
          try {
            ...
            this->errfmt->PrettyPrintError(e, str776);
            status = 1;
            check_errexit = true;
          }
        }
...
Tuple2<bool, bool> CommandEvaluator::ExecuteAndCatch(syntax_asdl::command_t* node, int cmd_flags) {
  ...
  try {
    ...
    if ((cmd_flags & RaiseControlFlow)) {
      ...
      if (e->IsReturn()) {
        ...
        this->errfmt->Print_(str777, e->token->span_id);
        is_fatal = true;
        status = 1;
      }
    }
  ...
  if (err) {
    ...
    if (is_errexit) {
      ...
      this->errfmt->PrettyPrintError(err, str778);
    }
  }
...
void CommandEvaluator::MaybeRunExitTrap(List<int>* mut_status) {
  ...
  handler = this->traps->get(str779);
  if (handler) {
    {  // with
      dev::ctx_Tracer ctx(this->tracer, str780, nullptr);
  ...
  {  // with
    ...
    if (UP_sig->tag_() == proc_sig_e::Closed) {
      ...
      for (ListIter<syntax_asdl::UntypedParam*> it(sig->untyped); !it.Done(); it.Next(), ++i) {
        ...
        if (i < n_args) {
          ...
          if (is_out_param) {
            param_name = str_concat(str781, param_name);
            if (!arg_str->startswith(str782)) {
              e_die(fmt202(arg_str));
            }
      ...
      if (sig->rest) {
        ...
        if (n_args > n_params) {
          this->errfmt->Print_(fmt204(proc->name, n_params, n_args), arg0_spid);
          return 2;
        }
      }
    }
    try {
      ...
      if (e->IsReturn()) {
        ...
        e_die(fmt205(e->token->val), e->token);
      }
    }
    catch (error::FatalRuntime* e) {
      this->dumper->MaybeCollect(this, e);
...
int CommandEvaluator::RunFuncForCompletion(runtime_asdl::Proc* proc, List<Str*>* argv) {
  ...
  try {
    ...
    this->errfmt->Print_(str788, e->token->span_id);
    status = 1;
  }
  return status;
}
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index_(i), str790))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index_(-2), str792)) {
    ...
    if ((left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse)) {
      var_name = left_token->val->slice(0, -1);
      if (str_equals(close_token->val->index_(-2), str793)) {
        op = assign_op_e::PlusEqual;
      }
      else {
        op = assign_op_e::Equal;
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        var_name = left_token->val->slice(0, -1);
        if (str_equals(close_token->val->index_(-2), str794)) {
          op = assign_op_e::PlusEqual;
        }
        else {
          op = assign_op_e::Equal;
        ...
        src = Alloc<source::Reparsed>(str796, left_token->span_id, close_token->span_id);
        {  // with
          alloc::ctx_Location ctx(arena, src);
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    if (str_equals(left_token->val->index_(-2), str798)) {
...
CommandParser::CommandParser(parse_lib::ParseContext* parse_ctx, optview::Parse* parse_opts, word_parse::WordParser* w_parser, lexer::Lexer* lexer, reader::_Reader* line_reader) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(CommandParser)) {
  this->parse_ctx = parse_ctx;
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index_(0), str806)) {
    pos = op_val->find(str807);
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    i += 1;
    if (!alias_exp->endswith(str812)) {
      expanded->append(str813);
      break;
    }
  }
  if (len(expanded) == 0) {
  ...
  while (i < n) {
    ...
    if (span1->line_id == span2->line_id) {
      ...
      throw Alloc<NotImplementedError>(fmt222(span1->line_id, span2->line_id));
    }
    expanded->append(str815);
    i += 1;
  }
  code_str = str816->join(expanded);
  line_reader = reader::StringLineReader(code_str, this->arena);
  ...
  if (kind == Kind::ControlFlow) {
    ...
    if (len(suffix_words) == 1) {
      ...
      if (len(suffix_words) == 2) {
        ...
        p_die(fmt230(kw_token->val), suffix_words->index_(2));
      }
    }
...
syntax_asdl::command__ForEach* CommandParser::_ParseForEachLoop(int for_spid) {
  ...
  while (true) {
    ...
    if (!match::IsValidVarName(iter_name)) {
      if (str_contains(iter_name, str828)) {
        p_die(fmt234(), w);
      }
      p_die(fmt235(iter_name), w);
    }
    ...
    if (this->w_parser->LookPastSpace() == Id::Op_LParen) {
      ...
      if ((!this->parse_opts->parse_bare_word() and len(iter_words) == 1)) {
        ...
        if ((ok and (match::IsValidVarName(s) and !quoted))) {
          p_die(fmt238(), iter_words->index_(0));
        }
      }
...
syntax_asdl::case_arm* CommandParser::ParseCaseItem() {
  ...
  if ((!this->parse_opts->parse_bare_word() and len(pat_words) == 1)) {
    ...
    quoted = tup21.at2();
    if ((ok and (match::IsValidVarName(s) and !quoted))) {
      p_die(fmt243(), pat_words->index_(0));
    }
  }
...
Str* Evaluator::EvalPrompt(runtime_asdl::value_t* UP_val) {
  ...
  if (ps1_word == nullptr) {
    ...
    try {
      ...
      ps1_word = word_::ErrorWord(fmt263(e->UserErrorString()));
    }
...
int ArithEvaluator::_StringToInteger(Str* s, int span_id) {
  ...
  if (str_contains(s, str943)) {
    ...
    for (StrIter it(digits); !it.Done(); it.Next()) {
          ...
          if (str_equals(ch, str948)) {
            ...
            if (str_equals(ch, str949)) {
              ...
              if (ch->isdigit()) {
                ...
                e_strict(fmt273(digits), span_id);
              }
            }
          }
        }
      ...
      if (digit >= base) {
        e_strict(fmt274(digits, base), span_id);
      }
    ...
    if ((this->exec_opts->eval_unsafe_arith() and this->parse_ctx)) {
      ...
      {  // with
        ...
        try {
          ...
          this->errfmt->PrettyPrintError(e);
          e_die(fmt275(), e->span_id);
        }
      }
      if (node2->tag_() == arith_expr_e::Word) {
        e_die(fmt276(s), span_id);
      }
      else {
      ...
      if ((len(s->strip()) == 0 or match::IsValidVarName(s))) {
        e_strict(fmt277(s), span_id);
      }
      else {
        e_die(fmt278(s), span_id);
      }
    }
  }
  return integer;
...
int ArithEvaluator::_ValToIntOrError(runtime_asdl::value_t* val, int span_id) {
  ...
  e_die(fmt280(ui::ValType(val)), span_id);
}
        ...
        if (op_id == Id::Arith_Minus) {
          ...
          if (op_id == Id::Arith_Star) {
            ...
            if (op_id == Id::Arith_Slash) {
              if (rhs == 0) {
                e_die(fmt283(), location::SpanForArithExpr(node->right));
              }
              ret = (lhs / rhs);
            }
            else {
              if (op_id == Id::Arith_Percent) {
                if (rhs == 0) {
                  e_die(fmt284(), location::SpanForArithExpr(node->right));
                }
                ret = (lhs % rhs);
              }
              else {
  ...
  switch (node->tag_()) {
    ...
    case bool_expr_e::Unary: {
      ...
      if (arg_type == bool_arg_type_e::Other) {
        ...
        e_die(fmt286(ui::PrettyId(op_id)));
      }
      throw Alloc<AssertionError>();
    }
      break;
      ...
      if (arg_type == bool_arg_type_e::Str) {
        ...
        if (op_id == Id::BoolBinary_EqualTilde) {
          try {
            ...
            msg = e->message;
            e_die(fmt287(s2, msg, node->right), 2);
          }
          if (matches == nullptr) {
            return false;
          }
      ...
      if ((tok->id == Id::VOp1_Percent || tok->id == Id::VOp1_DPercent)) {
        ...
        if (tok->id == Id::VOp1_Comma) {
          if (!(str_equals(arg, str986))) {
            e_die(fmt288(ui::PrettyId(tok->id)), tok);
          }
          if (len(s)) {
          ...
          if (tok->id == Id::VOp1_DComma) {
            if (!(str_equals(arg, str988))) {
              e_die(fmt289(ui::PrettyId(tok->id)), tok);
            }
            return s->lower();
          }
          else {
            if (tok->id == Id::VOp1_Caret) {
              if (!(str_equals(arg, str990))) {
                e_die(fmt290(ui::PrettyId(tok->id)), tok);
              }
              if (len(s)) {
              ...
              if (tok->id == Id::VOp1_DCaret) {
                if (!(str_equals(arg, str992))) {
                  e_die(fmt291(ui::PrettyId(tok->id)), tok);
                }
                return s->upper();
              }
              else {
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Slash) {
    try {
      ...
      msg = e->message;
      e_die(fmt293(regex, msg), this->slash_spid);
    }
  }
...
void TdopParser::Eat(int token_type) {
  if (!this->AtToken(token_type)) {
    p_die(fmt297(ui::PrettyId(token_type), ui::PrettyId(this->op_id)), this->cur_word);
  }
  this->Next();
}
...
runtime_asdl::value_t* DecayArray(runtime_asdl::value_t* val) {
  ...
  if (val->tag_() == value_e::MaybeStrArray) {
    ...
    if (val->tag_() == value_e::AssocArray) {
      value__AssocArray* assoc_val = static_cast<value__AssocArray*>(val);
      s = dict_contains(assoc_val->d, str1020) ? assoc_val->d->index_(str1021) : nullptr;
    }
    else {
      throw Alloc<AssertionError>();
    }
...
runtime_asdl::assign_arg* _SplitAssignArg(Str* arg, int word_spid) {
  ...
  if (m == nullptr) {
    e_die(fmt299(arg), word_spid);
  }
  var_name = m->index_(1);
  op = m->index_(3);
  if (len(op)) {
    val = Alloc<value::Str>(m->index_(4));
    append = str_equals(op->index_(0), str1024);
  }
  else {
    val = nullptr;
    append = false;
      ...
      if ((tok->id == Id::VTest_ColonEquals || tok->id == Id::VTest_Equals)) {
        ...
        if ((tok->id == Id::VTest_ColonQMark || tok->id == Id::VTest_QMark)) {
          if (is_falsey) {
            ...
            e_die(fmt303(error_str), blame_token);
          }
          else {
            return false;
          }
...
runtime_asdl::value_t* AbstractWordEvaluator::_ArrayIndex(runtime_asdl::value_t* val, syntax_asdl::braced_var_sub* part, runtime_asdl::VTestPlace* vtest_place) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      ...
      break;
    case value_e::Str: {
      e_die(fmt311(part->token->val), part->token);
    }
      break;
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* array_val = static_cast<value__MaybeStrArray*>(UP_val);
    ...
    case word_e::Compound: {
      ...
      if (has_extglob) {
        if (to_bool((eval_flags & EXTGLOB_FILES))) {
          ...
          if (n < 0) {
            span_id = word_::LeftMostSpanForWord(w);
            throw Alloc<error::FailGlob>(fmt323(fnmatch_pat), span_id);
          }
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalForPlugin(syntax_asdl::compound_word* w) {
  ...
  {  // with
    ...
    try {
      ...
      val = Alloc<value::Str>(fmt327(e->UserErrorString()));
    }
    catch (_OSError* e) {
      val = Alloc<value::Str>(fmt328(pyutil::strerror(e)));
    }
    catch (KeyboardInterrupt*) {
...
void AbstractWordEvaluator::_EvalWordFrame(List<Tuple3<Str*, bool, bool>*>* frame, List<Str*>* argv) {
  ...
  for (ListIter<Str*> it(args); !it.Done(); it.Next()) {
    ...
    if (glob_::LooksLikeGlob(a)) {
      ...
      if (n < 0) {
        throw Alloc<error::FailGlob>(fmt329(a), runtime::NO_SPID);
      }
    }
    else {
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index_(-2), str1112)) {
...
runtime_asdl::cmd_value_t* AbstractWordEvaluator::SimpleEvalWordSequence2(List<syntax_asdl::compound_word*>* words, bool allow_assign) {
  ...
  for (ListIter<syntax_asdl::compound_word*> it(words); !it.Done(); it.Next(), ++i) {
    ...
    if (glob_::LooksLikeStaticGlob(w)) {
      ...
      if (num_appended < 0) {
        throw Alloc<error::FailGlob>(fmt331(val->s), word_spid);
      }
...
syntax_asdl::suffix_op__PatSub* WordParser::_ReadPatSubVarOp() {
  ...
  if (this->token_type == Id::Lit_Slash) {
    ...
    this->_Peek();
    if (this->token_type != Id::Right_DollarBrace) {
      p_die(fmt334(ui::PrettyId(this->token_type)), this->cur_token);
    }
          ...
          if (op_kind == Kind::VOp2) {
            if (this->token_type == Id::VOp2_Slash) {
              ...
              if (this->token_type == Id::VOp2_Colon) {
                ...
                p_die(fmt342(str1132), this->cur_token);
              }
            }
          }
          else {
            if (op_kind == Kind::VOp3) {
              if (allow_query) {
                ...
                p_die(fmt343(str1134), this->cur_token);
              }
            }
          }
        }
...
void WordParser::ParseProc(syntax_asdl::command__Proc* node) {
  ...
  if (this->token_type != Id::Lit_Chars) {
    p_die(fmt360(ui::PrettyToken(this->cur_token, this->arena)), this->cur_token);
  }
...
syntax_asdl::arith_expr_t* WordParser::_ReadArithExpr(int end_id) {
  ...
  if ((end_id != Id::Undefined_Tok and cur_id != end_id)) {
    p_die(fmt361(ui::PrettyId(cur_id), ui::PrettyId(end_id)), this->a_parser->cur_word);
  }
  return anode;
}
...
syntax_asdl::command__ForExpr* WordParser::ReadForExpression() {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt364(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
  if (cur_id == Id::Arith_Semi) {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt365(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
              ...
              if (!this->parse_opts->parse_dollar()) {
                if ((num_parts == 0 and lex_mode == lex_mode_e::ShCommand)) {
                  ...
                  if (str_equals(next_byte, str1171)) {
                    println_stderr(fmt375(next_byte));
                  }
                }
...
Tuple2<syntax_asdl::word_t*, bool> WordParser::_ReadArithWord() {
  ...
  this->_Peek();
  if (this->token_kind == Kind::Unknown) {
    p_die(fmt380(this->cur_token->val), this->cur_token);
  }
  else {
    if (this->token_kind == Kind::Eof) {
...
Str* normpath(Str* path) {
  ...
  for (ListIter<Str*> it(comps); !it.Done(); it.Next()) {
    ...
    if ((!(str_equals(comp, str1228)) or ((initial_slashes == 0 and len(new_comps) == 0) or (len(new_comps) and str_equals(new_comps->index_(-1), str1229))))) {
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    ...
    strs = cmd_val->argv;
    if ((!strs or !(str_equals(strs->index_(-1), str1291)))) {
      this->errfmt->Print_(str1292, cmd_val->arg_spids->index_(0));
      return 2;
    }
    cmd_val->argv->pop();

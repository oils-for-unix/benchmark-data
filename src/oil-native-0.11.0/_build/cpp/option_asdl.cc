...
const char* option_str(int tag) {
  ...
  case option::allow_csub_psub:
    return "option.allow_csub_psub";
  ...
  case option::_running_hay:
    return "option._running_hay";
  ...
  case option::parse_proc:
    return "option.parse_proc";
  ...
  case option::parse_sh_assign:
    return "option.parse_sh_assign";
  case option::parse_dparen:
    return "option.parse_dparen";
  case option::parse_bare_word:
    return "option.parse_bare_word";
  case option::parse_sloppy_case:
    return "option.parse_sloppy_case";
...
const char* builtin_str(int tag) {
  ...
  case builtin::hay:
    return "builtin.hay";
  case builtin::haynode:
    return "builtin.haynode";
  case builtin::module:
  ...
  case builtin::boolstatus:
    return "builtin.boolstatus";
  case builtin::argparse:
    return "builtin.argparse";
  case builtin::describe:

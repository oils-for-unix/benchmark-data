...
hnode_t* command__Use::PrettyTree() {
  hnode__Record* out_node = runtime::NewRecord(new Str("command.Use"));
  List<field*>* L = out_node->fields;
    ...
    if (this->names && len(this->names)) {  // ArrayType
      hnode__Array* x2 = new hnode__Array(new List<hnode_t*>());
      for (ListIter<use_name*> it(this->names); !it.Done(); it.Next()) {
        use_name* i2 = it.Value();
        x2->children->append(i2->PrettyTree());
      }
...
hnode_t* command__Use::_AbbreviatedTree() {
  hnode__Record* out_node = runtime::NewRecord(new Str("command.Use"));
  List<field*>* L = out_node->fields;
...
hnode_t* command__Use::AbbreviatedTree() {
  return _AbbreviatedTree();
}
...
hnode_t* command_t::PrettyTree() {
  ...
  case command_e::Use: {
    command__Use* obj = static_cast<command__Use*>(this);
    return obj->PrettyTree();
  }
  default:
    assert(0);
...
hnode_t* use_name::PrettyTree() {
  hnode__Record* out_node = runtime::NewRecord(new Str("use_name"));
  List<field*>* L = out_node->fields;
    hnode_t* x0 = this->name->PrettyTree();
    L->append(new field(new Str("name"), x0));
...
hnode_t* use_name::_AbbreviatedTree() {
  hnode__Record* out_node = runtime::NewRecord(new Str("use_name"));
  List<field*>* L = out_node->fields;
    hnode_t* x0 = this->name->AbbreviatedTree();
    L->append(new field(new Str("name"), x0));
...
hnode_t* use_name::AbbreviatedTree() {
  return _AbbreviatedTree();
}

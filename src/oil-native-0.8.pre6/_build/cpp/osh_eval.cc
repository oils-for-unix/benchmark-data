...
Str* str42 = new Str("-c");
Str* str43 = new Str("PWD");
Str* str44 = new Str("VERSION");
Str* str45 = new Str("");
Str* str46 = new Str("\n");
Str* str47 = new Str("osh");
Str* str48 = new Str("");
Str* str49 = new Str("set %d");
Str* str50 = new Str("-o");
Str* str51 = new Str("can't disable errexit running a function. Maybe wrap the function in a process with the at-splice pattern.");
Str* str52 = new Str("Unhandled SimpleCommand");
Str* str53 = new Str("\n");
Str* str54 = new Str("-c flag");
Str* str55 = new Str("Span ID out of range: %d is greater than %d");
Str* str56 = new Str("\u001b[0;0m");
Str* str57 = new Str("\u001b[1m");
Str* str58 = new Str("\u001b[4m");
Str* str59 = new Str("\u001b[7m");
Str* str60 = new Str("\u001b[31m");
Str* str61 = new Str("\u001b[32m");
Str* str62 = new Str("\u001b[33m");
Str* str63 = new Str("\u001b[34m");
Str* str64 = new Str("+");
Str* str65 = new Str(" ");
Str* str66 = new Str("PS4");
Str* str67 = new Str("<ERROR: Can't parse PS4: %s>");
Str* str68 = new Str(" ");
Str* str69 = new Str("%s%s%s");
Str* str70 = new Str("+=");
Str* str71 = new Str("=");
Str* str72 = new Str("<_ControlFlow %s>");
Str* str73 = new Str(" \t\n\"'><=;|&(:");
Str* str74 = new Str("/");
Str* str75 = new Str("PATH");
Str* str76 = new Str(":");
Str* str77 = new Str("<ErrExit %s %s>");
Str* str78 = new Str("got invalid option %r");
Str* str79 = new Str("doesn't own option %r (try 'set')");
Str* str80 = new Str("got invalid option %r");
Str* str81 = new Str("doesn't own option %r (try 'shopt')");
Str* str82 = new Str("SHELLOPTS");
Str* str83 = new Str(":");
Str* str84 = new Str("Syntax options must be set at the top level (outside any function)");
Str* str85 = new Str("Warning: set -o verbose not implemented");
Str* str86 = new Str("SHELLOPTS");
Str* str87 = new Str("%s:%s");
Str* str88 = new Str("SHELLOPTS");
Str* str89 = new Str(":");
Str* str90 = new Str(":");
Str* str91 = new Str("SHELLOPTS");
Str* str92 = new Str("oil:basic");
Str* str93 = new Str("oil:all");
Str* str94 = new Str("strict:all");
Str* str95 = new Str("errexit");
Str* str96 = new Str("set %so %s");
Str* str97 = new Str("-");
Str* str98 = new Str("+");
Str* str99 = new Str("got invalid option %r");
Str* str100 = new Str("shopt -%s %s");
Str* str101 = new Str("s");
Str* str102 = new Str("u");
Str* str103 = new Str("<_ArgFrame %s %d at %x>");
Str* str104 = new Str("Can't determine working directory: %s");
Str* str105 = new Str("IFS");
Str* str106 = new Str("UID");
Str* str107 = new Str("EUID");
Str* str108 = new Str("PPID");
Str* str109 = new Str("HOSTNAME");
Str* str110 = new Str("OSTYPE");
Str* str111 = new Str("OPTIND");
Str* str112 = new Str("1");
Str* str113 = new Str("PS4");
Str* str114 = new Str("+ ");
Str* str115 = new Str("COMP_WORDBREAKS");
Str* str116 = new Str("SHELLOPTS");
Str* str117 = new Str("SHELLOPTS");
Str* str118 = new Str("");
Str* str119 = new Str("SHELLOPTS");
Str* str120 = new Str("PWD");
Str* str121 = new Str("PWD");
Str* str122 = new Str("PWD");
Str* str123 = new Str("OIL_VERSION");
Str* str124 = new Str("PWD");
Str* str125 = new Str("");
Str* str126 = new Str("<Mem");
Str* str127 = new Str("  -- %d --");
Str* str128 = new Str("  %s %s");
Str* str129 = new Str(">");
Str* str130 = new Str("\n");
Str* str131 = new Str("\n");
Str* str132 = new Str("Warning: span_id undefined in SetCurrentSpanId");
Str* str133 = new Str("nameref %r is undefined");
Str* str134 = new Str("nameref %r contains invalid variable name %r");
Str* str135 = new Str("%r has already been declared");
Str* str136 = new Str("%r hasn't been declared");
Str* str137 = new Str("nameref cycle: %s");
Str* str138 = new Str(" -> ");
Str* str139 = new Str("Can't assign to readonly value %r");
Str* str140 = new Str("Only strings can be exported");
Str* str141 = new Str("nameref must be a string");
Str* str142 = new Str("Can't assign to readonly array");
Str* str143 = new Str("Can't assign to items in a string");
Str* str144 = new Str("Value of type %s can't be indexed");
Str* str145 = new Str("Can't assign to readonly associative array");
Str* str146 = new Str("ARGV");
Str* str147 = new Str("PIPESTATUS");
Str* str148 = new Str("FUNCNAME");
Str* str149 = new Str("source");
Str* str150 = new Str("BASH_SOURCE");
Str* str151 = new Str("BASH_LINENO");
Str* str152 = new Str("0");
Str* str153 = new Str("LINENO");
Str* str154 = new Str("BASHPID");
Str* str155 = new Str("Can't unset readonly variable %r");
Str* str156 = new Str("%r isn't an array");
Str* str157 = new Str("$%s isn't defined");
Str* str158 = new Str("$%s should be a string");
Str* str159 = new Str("$%s should be a string, got %s");
Str* str160 = new Str("$%s doesn't look like an integer, got %r");
Str* str161 = new Str("EOF");
Str* str162 = new Str("/");
Str* str163 = new Str("~");
Str* str164 = new Str("  ");
Str* str165 = new Str("\n  ");
...
Str* str170 = new Str("~");
Str* str171 = new Str("\n");
Str* str172 = new Str("[ interactive ]");
Str* str173 = new Str("[ -c flag ]");
Str* str174 = new Str("[ stdin%s ]");
Str* str175 = new Str("[ expansion of alias %r ]");
Str* str176 = new Str("[ backticks at ... ]");
Str* str177 = new Str("[ array LValue in %s ]");
Str* str178 = new Str("[ eval at line %d of %s ]");
Str* str179 = new Str("[ trap ]");
Str* str180 = new Str("[ variable ]");
Str* str181 = new Str("%s:%d: %s%s\n");
Str* str182 = new Str("[??? no location ???] %s%s\n");
Str* str183 = new Str("");
Str* str184 = new Str("");
Str* str185 = new Str("");
Str* str186 = new Str("<_Attributes %s>");
Str* str187 = new Str("<args.Reader %r %d>");
Str* str188 = new Str("expected argument to %r");
Str* str189 = new Str("-");
Str* str190 = new Str("got invalid argument %r to %r, expected one of: %s");
Str* str191 = new Str("-");
Str* str192 = new Str(", ");
Str* str193 = new Str("expected integer after %s, got %r");
Str* str194 = new Str("-");
Str* str195 = new Str("got invalid integer for %s: %s");
Str* str196 = new Str("-");
Str* str197 = new Str("expected number after %r, got %r");
Str* str198 = new Str("-");
Str* str199 = new Str("0");
Str* str200 = new Str("F");
Str* str201 = new Str("false");
Str* str202 = new Str("False");
Str* str203 = new Str("1");
Str* str204 = new Str("T");
Str* str205 = new Str("true");
Str* str206 = new Str("Talse");
Str* str207 = new Str("got invalid argument to boolean flag: %r");
Str* str208 = new Str("-");
Str* str209 = new Str("-");
Str* str210 = new Str("got invalid option %r");
Str* str211 = new Str("Expected argument for action");
Str* str212 = new Str("Invalid action name %r");
Str* str213 = new Str("--");
Str* str214 = new Str("-");
Str* str215 = new Str("-");
Str* str216 = new Str("doesn't accept flag %s");
Str* str217 = new Str("-");
Str* str218 = new Str("+");
Str* str219 = new Str("+");
Str* str220 = new Str("doesn't accept option %s");
Str* str221 = new Str("+");
Str* str222 = new Str("-");
Str* str223 = new Str("--");
Str* str224 = new Str("--");
Str* str225 = new Str("got invalid flag %r");
Str* str226 = new Str("-");
Str* str227 = new Str("+");
Str* str228 = new Str("got invalid flag %r");
Str* str229 = new Str("-");
Str* str230 = new Str("^--?([a-zA-Z0-9][a-zA-Z0-9\\-]*)(=.*)?$");
Str* str231 = new Str("<LineLexer at pos %d of line %r (id = %d)>");
Str* str232 = new Str("");
Str* str233 = new Str("");
Str* str234 = new Str("");
Str* str235 = new Str("<Trail %s %s %s %s>");
Str* str236 = new Str("");
Str* str237 = new Str("ShAssignment expression can't be nested like this");
Str* str238 = new Str("Here docs aren't allowed in expressions");
Str* str239 = new Str("\n");
Str* str240 = new Str("");
Str* str241 = new Str(" (%s)");
Str* str242 = new Str("Unexpected token in expression mode%s");
Str* str243 = new Str("Syntax error in expression (near %s)");
Str* str244 = new Str("alnum");
Str* str245 = new Str("cntrl");
Str* str246 = new Str("lower");
Str* str247 = new Str("space");
Str* str248 = new Str("alpha");
Str* str249 = new Str("digit");
Str* str250 = new Str("print");
Str* str251 = new Str("upper");
Str* str252 = new Str("blank");
Str* str253 = new Str("graph");
Str* str254 = new Str("punct");
Str* str255 = new Str("xdigit");
Str* str256 = new Str("Range start/end shouldn't have more than one character");
Str* str257 = new Str("Write singleton tuples with tup(), not a trailing comma");
Str* str258 = new Str("testlist_comp");
Str* str259 = new Str("PNode type %d (%s) wasn't handled");
Str* str260 = new Str("Can't assign to this expression");
Str* str261 = new Str("PNode type %d (%s) wasn't handled");
Str* str262 = new Str("TODO");
Str* str263 = new Str("dot");
Str* str264 = new Str("Can't negate this symbol");
Str* str265 = new Str("%r isn't a character class");
Str* str266 = new Str("Can't negate this symbol");
Str* str267 = new Str("%r isn't a character class");
Str* str268 = new Str("%start");
Str* str269 = new Str("%end");
Str* str270 = new Str("dot");
Str* str271 = new Str("Unexpected token %r in regex");
Str* str272 = new Str("%s-%s");
Str* str273 = new Str("ERE can't express code point %d");
Str* str274 = new Str("Perl classes can't be negated in ERE");
Str* str275 = new Str("%s");
Str* str276 = new Str("POSIX classes can't be negated in ERE");
Str* str277 = new Str("[:%s:]");
Str* str278 = new Str(".");
Str* str279 = new Str("^");
Str* str280 = new Str("$");
Str* str281 = new Str("|");
Str* str282 = new Str("POSIX EREs don't have groups without capture, so this node needs () around it.");
Str* str283 = new Str("+");
Str* str284 = new Str("*");
Str* str285 = new Str("?");
Str* str286 = new Str("{%s}");
Str* str287 = new Str("");
Str* str288 = new Str("");
Str* str289 = new Str("{%s,%s}");
Str* str290 = new Str("(");
Str* str291 = new Str(")");
Str* str292 = new Str("[^%s]");
Str* str293 = new Str("[%s]");
Str* str294 = new Str("[^[:%s:]]");
Str* str295 = new Str("[[:%s:]]");
Str* str296 = new Str("[");
Str* str297 = new Str("^");
Str* str298 = new Str("]");
Str* str299 = new Str("The [ operator doesn't apply to this expression");
Str* str300 = new Str("Expected ]]");
Str* str301 = new Str("Unexpected trailing word %s");
Str* str302 = new Str("Invalid argument to unary operator");
Str* str303 = new Str("Expected ), got %s");
Str* str304 = new Str("Unexpected token in boolean expression");
Str* str305 = new Str("");
Str* str306 = new Str("Expected %d, got %d");
Str* str307 = new Str("Step can't be 0");
Str* str308 = new Str("Invalid step %d for ascending integer range");
Str* str309 = new Str("Invalid step %d for descending integer range");
Str* str310 = new Str("Invalid step %d for ascending character range");
Str* str311 = new Str("Invalid step %d for descending character range");
Str* str312 = new Str("Mismatched cases in character range");
Str* str313 = new Str("");
Str* str314 = new Str("0");
Str* str315 = new Str("0");
Str* str316 = new Str("g");
Str* str317 = new Str("a");
Str* str318 = new Str("A");
Str* str319 = new Str("n");
Str* str320 = new Str("r");
Str* str321 = new Str("x");
Str* str322 = new Str("%s=%s");
Str* str323 = new Str("-");
Str* str324 = new Str("+");
Str* str325 = new Str("-");
Str* str326 = new Str("+");
Str* str327 = new Str("-");
Str* str328 = new Str("+");
Str* str329 = new Str("n");
Str* str330 = new Str("r");
Str* str331 = new Str("x");
Str* str332 = new Str("a");
Str* str333 = new Str("A");
Str* str334 = new Str("-");
Str* str335 = new Str("declare -");
Str* str336 = new Str("");
Str* str337 = new Str(" ");
Str* str338 = new Str("=");
Str* str339 = new Str("=()");
...
Str* str353 = new Str(")");
Str* str354 = new Str("");
Str* str355 = new Str("export_");
Str* str356 = new Str("doesn't accept -f because it's dangerous.  (The code can usually be restructured with 'source')");
Str* str357 = new Str("doesn't accept RHS with -n");
Str* str358 = new Str("Got -a but RHS isn't an array");
Str* str359 = new Str("Got -A but RHS isn't an associative array");
Str* str360 = new Str("readonly");
Str* str361 = new Str("new_var");
Str* str362 = new Str("passed -f without args");
Str* str363 = new Str("declare -f %s");
Str* str364 = new Str("-");
Str* str365 = new Str("-");
Str* str366 = new Str("-");
Str* str367 = new Str("+");
Str* str368 = new Str("+");
Str* str369 = new Str("+");
Str* str370 = new Str("Invalid unset expression");
Str* str371 = new Str("Expected a variable name.  Expressions are allowed with shopt -s eval_unsafe_arith");
Str* str372 = new Str("unset");
Str* str373 = new Str("Invalid shift argument %r");
Str* str374 = new Str("got too many arguments");
Str* str375 = new Str("eval");
Str* str376 = new Str("requires code string");
Str* str377 = new Str("requires exactly 1 argument");
Str* str378 = new Str(" ");
Str* str379 = new Str("source");
Str* str380 = new Str("missing required argument");
Str* str381 = new Str("source %r failed: %s");
Str* str382 = new Str("command");
Str* str383 = new Str("Can't run assignment builtin recursively");
Str* str384 = new Str("%r isn't a shell builtin");
Str* str385 = new Str("function");
Str* str386 = new Str("alias");
Str* str387 = new Str("builtin");
Str* str388 = new Str("builtin");
Str* str389 = new Str("builtin");
Str* str390 = new Str("keyword");
Str* str391 = new Str("keyword");
Str* str392 = new Str("file");
Str* str393 = new Str("type");
Str* str394 = new Str("type: %r not found");
Str* str395 = new Str("file");
Str* str396 = new Str("file");
Str* str397 = new Str("%s is a %s");
Str* str398 = new Str("function");
Str* str399 = new Str("");
Str* str400 = new Str("read");
Str* str401 = new Str("REPLY");
Str* str402 = new Str("");
Str* str403 = new Str("REPLY");
Str* str404 = new Str("\u0000");
Str* str405 = new Str("\n");
Str* str406 = new Str("");
Str* str407 = new Str("mapfile");
Str* str408 = new Str("MAPFILE");
Str* str409 = new Str("cd");
Str* str410 = new Str("HOME");
Str* str411 = new Str("HOME");
Str* str412 = new Str("-");
Str* str413 = new Str("OLDPWD");
Str* str414 = new Str("PWD");
Str* str415 = new Str("cd %r: %s");
Str* str416 = new Str("PWD");
Str* str417 = new Str("OLDPWD");
Str* str418 = new Str("%2d  %s");
Str* str419 = new Str(" ");
Str* str420 = new Str("pushd: no other directory");
Str* str421 = new Str("got too many arguments");
Str* str422 = new Str("pushd: %r: %s");
Str* str423 = new Str("HOME");
Str* str424 = new Str("PWD");
Str* str425 = new Str("popd: directory stack is empty");
Str* str426 = new Str("popd: %r: %s");
Str* str427 = new Str("PWD");
Str* str428 = new Str("got extra argument");
Str* str429 = new Str("HOME");
Str* str430 = new Str("dirs");
Str* str431 = new Str("HOME");
Str* str432 = new Str("pwd");
Str* str433 = new Str("# +");
Str* str434 = new Str("osh printf doesn't support the %r flag");
Str* str435 = new Str("eEfFgG");
Str* str436 = new Str("osh printf doesn't support floating point");
Str* str437 = new Str("c");
Str* str438 = new Str("osh printf doesn't support single characters (bytes)");
Str* str439 = new Str("Invalid printf format character");
Str* str440 = new Str("Expected a printf format character");
Str* str441 = new Str("fsT");
Str* str442 = new Str("printf precision can't be specified with type %r");
Str* str443 = new Str("printf");
Str* str444 = new Str("requires a format string");
Str* str445 = new Str("%");
Str* str446 = new Str("");
Str* str447 = new Str("printf got invalid width %r");
Str* str448 = new Str("0");
Str* str449 = new Str("");
Str* str450 = new Str("printf got invalid precision %r");
Str* str451 = new Str("");
Str* str452 = new Str("s");
Str* str453 = new Str("q");
Str* str454 = new Str("b");
Str* str455 = new Str("");
Str* str456 = new Str("diouxX");
Str* str457 = new Str("'\"");
Str* str458 = new Str("printf expected an integer, got %r");
Str* str459 = new Str("di");
Str* str460 = new Str("ouxX");
Str* str461 = new Str("Can't format negative number %d with %%%s");
Str* str462 = new Str("u");
Str* str463 = new Str("o");
Str* str464 = new Str("x");
Str* str465 = new Str("X");
Str* str466 = new Str("TZ");
Str* str467 = new Str("TZ");
Str* str468 = new Str("-");
Str* str469 = new Str(" ");
Str* str470 = new Str("0");
Str* str471 = new Str("0");
Str* str472 = new Str(" ");
Str* str473 = new Str("");
Str* str474 = new Str("got invalid variable name %r");
Str* str475 = new Str("alias");
Str* str476 = new Str("alias %s=%r");
Str* str477 = new Str("=");
Str* str478 = new Str("No alias named %r");
Str* str479 = new Str("alias %s=%r");
Str* str480 = new Str("unalias");
Str* str481 = new Str("requires an argument");
Str* str482 = new Str("No alias named %r");
Str* str483 = new Str("%s=%s");
Str* str484 = new Str("set");
Str* str485 = new Str("shopt");
Str* str486 = new Str("hash");
Str* str487 = new Str("got extra arguments after -r");
Str* str488 = new Str("hash: %r not found");
Str* str489 = new Str("-");
Str* str490 = new Str(":");
Str* str491 = new Str("");
Str* str492 = new Str("?");
...
Str* str494 = new Str("?");
Str* str495 = new Str("?");
Str* str496 = new Str("getopts: option %r requires an argument.");
Str* str497 = new Str("(getopts argv: %s)");
Str* str498 = new Str(" ");
Str* str499 = new Str("?");
Str* str500 = new Str("requires an argspec");
Str* str501 = new Str("requires the name of a variable to set");
Str* str502 = new Str("OPTIND");
Str* str503 = new Str("OPTARG");
Str* str504 = new Str("OPTIND");
Str* str505 = new Str("got invalid variable name %r");
Str* str506 = new Str("echo");
Str* str507 = new Str("");
Str* str508 = new Str("takes at most one arg when strict_echo is on (hint: add quotes)");
Str* str509 = new Str(" ");
Str* str510 = new Str("\n");
Str* str511 = new Str("Assignment builtin %r not configured");
Str* str512 = new Str("%r ");
Str* str513 = new Str("");
Str* str514 = new Str("command in ");
Str* str515 = new Str("assignment in ");
Str* str516 = new Str("subshell invoked from ");
Str* str517 = new Str("pipeline invoked from ");
Str* str518 = new Str("");
Str* str519 = new Str("Exiting with status %d (%sPID %d)");
Str* str520 = new Str("Redirect filename can't be empty");
Str* str521 = new Str("Redirect descriptor can't be empty");
Str* str522 = new Str("-");
Str* str523 = new Str("-");
Str* str524 = new Str("Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
Str* str525 = new Str("\n");
Str* str526 = new Str("Unknown redirect op");
Str* str527 = new Str("Unknown redirect type");
Str* str528 = new Str("TODO: trace string for assignment");
Str* str529 = new Str("ShAssignment builtins don't accept blocks");
Str* str530 = new Str("|& isn't supported");
Str* str531 = new Str("Can't append array to string");
Str* str532 = new Str("Can't append string to array");
Str* str533 = new Str("%r expected a number, got %r");
Str* str534 = new Str("Invalid control flow at top level");
Str* str535 = new Str("warning: ");
Str* str536 = new Str("errexit is disabled here, but strict_errexit disallows it with a compound command (%s)");
Str* str537 = new Str("Loop and control flow can't be in different processes");
Str* str538 = new Str("fatal: ");
Str* str539 = new Str("EXIT");
Str* str540 = new Str("Unexpected %r (in function call)");
Str* str541 = new Str("Attempted to exit from completion hook.");
Str* str542 = new Str("Couldn't find terminator for here doc that starts here");
Str* str543 = new Str("\t");
Str* str544 = new Str("Invalid here doc delimiter");
Str* str545 = new Str("+");
Str* str546 = new Str("+");
Str* str547 = new Str("+");
Str* str548 = new Str("%d != %d");
Str* str549 = new Str("Environment binding shouldn't look like an array assignment");
Str* str550 = new Str("+");
Str* str551 = new Str("Expected = in environment binding, got +=");
Str* str552 = new Str("Environment bindings can't contain array literals");
Str* str553 = new Str("Expected word type %s, got %s");
Str* str554 = new Str("{");
Str* str555 = new Str("}");
Str* str556 = new Str("Invalid token after redirect operator");
Str* str557 = new Str(" ");
Str* str558 = new Str(" ");
Str* str559 = new Str("line IDs %d != %d");
Str* str560 = new Str(" ");
Str* str561 = new Str("");
Str* str562 = new Str("Unexpected block");
Str* str563 = new Str("=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
Str* str564 = new Str("name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
Str* str565 = new Str("Unexpected block");
Str* str566 = new Str("Unexpected block");
Str* str567 = new Str("Control flow shouldn't have redirects");
Str* str568 = new Str("Control flow shouldn't have environment bindings");
Str* str569 = new Str("Unexpected argument to %r");
Str* str570 = new Str("Invalid word in for loop");
Str* str571 = new Str("Invalid word after for expression");
Str* str572 = new Str("Loop variable name should be a constant");
Str* str573 = new Str("Invalid loop variable name");
Str* str574 = new Str("Unexpected word after for loop variable");
Str* str575 = new Str("Expected ;; or esac");
Str* str576 = new Str("Unexpected word while parsing compound command");
Str* str577 = new Str("Invalid function name");
Str* str578 = new Str("Expected ) in function definition");
Str* str579 = new Str("Invalid KSH-style function name");
Str* str580 = new Str("Unexpected word when parsing command");
Str* str581 = new Str("Unexpected right brace");
Str* str582 = new Str("Unexpected EOF while parsing command");
Str* str583 = new Str("Invalid word while parsing command");
Str* str584 = new Str("Unexpected word while parsing command line");
Str* str585 = new Str("Unterminated here doc began here");
Str* str586 = new Str("\\");
Str* str587 = new Str("*");
Str* str588 = new Str("?");
Str* str589 = new Str("[");
...
Str* str593 = new Str("\\?*+{}^$.()|");
Str* str594 = new Str("\\");
Str* str595 = new Str("Unexpected escaped character %r");
Str* str596 = new Str("");
Str* str597 = new Str("");
Str* str598 = new Str("Malformed character class; treating as literal");
Str* str599 = new Str("Got unescaped right bracket");
Str* str600 = new Str("Got unescaped trailing backslash");
Str* str601 = new Str(".|^$()+*?[]{}\\");
Str* str602 = new Str("\\");
Str* str603 = new Str("\\");
Str* str604 = new Str("\\[");
...
Str* str616 = new Str("]");
Str* str617 = new Str("");
Str* str618 = new Str("Error expanding glob %r: %s");
Str* str619 = new Str("-");
Str* str620 = new Str("<Error: unbalanced \\[ and \\]> ");
Str* str621 = new Str("$");
Str* str622 = new Str("#");
Str* str623 = new Str("$");
Str* str624 = new Str("hostname");
Str* str625 = new Str("user");
Str* str626 = new Str("$ ");
Str* str627 = new Str("\u0001");
Str* str628 = new Str("\u0002");
Str* str629 = new Str("$");
Str* str630 = new Str("$");
Str* str631 = new Str("u");
Str* str632 = new Str("user");
Str* str633 = new Str("h");
Str* str634 = new Str("hostname");
Str* str635 = new Str(".");
Str* str636 = new Str("H");
Str* str637 = new Str("hostname");
Str* str638 = new Str("w");
Str* str639 = new Str("PWD");
Str* str640 = new Str("HOME");
Str* str641 = new Str("<Error: %s>");
Str* str642 = new Str("W");
Str* str643 = new Str("PWD");
Str* str644 = new Str("<Error: PWD is not a string> ");
Str* str645 = new Str("<Error: \\%s not implemented in $PS1> ");
Str* str646 = new Str("$");
Str* str647 = new Str("\\$");
Str* str648 = new Str("Invalid token %r");
Str* str649 = new Str("");
Str* str650 = new Str("<ERROR: Can't parse PS1: %s>");
Str* str651 = new Str("osh");
Str* str652 = new Str("PS1");
Str* str653 = new Str("PROMPT_COMMAND");
Str* str654 = new Str("Undefined variable %r");
Str* str655 = new Str("Can't use [] on value of type %s");
Str* str656 = new Str("");
Str* str657 = new Str("Can't use [] on value of type %s");
Str* str658 = new Str("");
Str* str659 = new Str("0x");
Str* str660 = new Str("Invalid hex constant %r");
Str* str661 = new Str("0");
Str* str662 = new Str("Invalid octal constant %r");
Str* str663 = new Str("#");
Str* str664 = new Str("#");
Str* str665 = new Str("Invalid base for numeric constant %r");
Str* str666 = new Str("a");
Str* str667 = new Str("A");
Str* str668 = new Str("@");
Str* str669 = new Str("_");
Str* str670 = new Str("Invalid digits for numeric constant %r");
Str* str671 = new Str("Digits %r out of range for base %d");
Str* str672 = new Str("Parse error in recursive arithmetic");
Str* str673 = new Str("Invalid integer constant %r");
Str* str674 = new Str("Undefined value in arithmetic context");
Str* str675 = new Str("Expected a value convertible to integer, got %s");
Str* str676 = new Str("0");
Str* str677 = new Str("Divide by zero");
Str* str678 = new Str("Divide by zero");
Str* str679 = new Str("Expected array or assoc in index expression, got %s");
Str* str680 = new Str("Divide by zero");
Str* str681 = new Str("Divide by zero");
Str* str682 = new Str("Exponent can't be less than zero");
Str* str683 = new Str("Associative array keys must be strings: $x 'x' \"$x\" etc.");
Str* str684 = new Str("Invalid place to modify");
Str* str685 = new Str("BASH_REMATCH");
Str* str686 = new Str("Invalid file descriptor %r");
Str* str687 = new Str("%s isn't implemented");
Str* str688 = new Str("Invalid regex %r: %s");
Str* str689 = new Str(" \t\n");
Str* str690 = new Str("IFS");
Str* str691 = new Str("IFS shouldn't be an array");
Str* str692 = new Str(" \t\n");
Str* str693 = new Str("IFS");
Str* str694 = new Str(" ");
Str* str695 = new Str("");
Str* str696 = new Str("IFS shouldn't be an array");
Str* str697 = new Str("\\");
Str* str698 = new Str("\\");
Str* str699 = new Str("Invalid transition from %r with %r");
Str* str700 = new Str("\u00ef\u00bf\u00bd");
Str* str701 = new Str("");
Str* str702 = new Str("Incomplete UTF-8 character");
Str* str703 = new Str("Invalid UTF-8 continuation byte");
Str* str704 = new Str("Invalid start of UTF-8 character");
Str* str705 = new Str("");
Str* str706 = new Str("%s can't have an argument");
Str* str707 = new Str("");
Str* str708 = new Str("%s can't have an argument");
Str* str709 = new Str("");
Str* str710 = new Str("%s can't have an argument");
Str* str711 = new Str("");
Str* str712 = new Str("%s can't have an argument");
Str* str713 = new Str("");
Str* str714 = new Str("<_GlobReplacer regex %r r %r>");
Str* str715 = new Str("(%s)");
Str* str716 = new Str("Error matching regex %r: %s");
Str* str717 = new Str("^");
Str* str718 = new Str("$");
Str* str719 = new Str("\r");
Str* str720 = new Str("<INVALID CR>");
Str* str721 = new Str("\n");
Str* str722 = new Str("<INVALID NEWLINE>");
Str* str723 = new Str(" `~!$&*()[]{}\\|;'\"<>?");
Str* str724 = new Str("Left-hand side of this assignment is invalid");
Str* str725 = new Str("Token can't be used in prefix position");
Str* str726 = new Str("Token can't be used in infix position");
Str* str727 = new Str("Parser expected %s, got %s");
Str* str728 = new Str("Unexpected end of input");
Str* str729 = new Str("Invalid token %s");
Str* str730 = new Str("warning: Invalid backslash escape in C-style string: %r");
Str* str731 = new Str("BASH_SOURCE");
Str* str732 = new Str("FUNCNAME");
Str* str733 = new Str("BASH_LINENO");
Str* str734 = new Str("0");
...
Str* str740 = new Str("");
Str* str741 = new Str("");
Str* str742 = new Str("The length index of a array slice can't be negative: %d");
Str* str743 = new Str("Can't slice associative arrays");
Str* str744 = new Str("i");
Str* str745 = new Str("e");
Str* str746 = new Str("f");
Str* str747 = new Str("n");
Str* str748 = new Str("u");
Str* str749 = new Str("x");
Str* str750 = new Str("C");
Str* str751 = new Str("");
Str* str752 = new Str("~");
Str* str753 = new Str("HOME");
Str* str754 = new Str("Can't assign to special variable");
Str* str755 = new Str("unset variable %r");
Str* str756 = new Str("@");
Str* str757 = new Str("*");
Str* str758 = new Str("@");
Str* str759 = new Str("*");
Str* str760 = new Str("warning: ");
Str* str761 = new Str("-1");
Str* str762 = new Str("@");
Str* str763 = new Str("*");
Str* str764 = new Str("[");
Str* str765 = new Str("]");
Str* str766 = new Str("Bad indirect expansion: %r");
Str* str767 = new Str("");
Str* str768 = new Str("");
Str* str769 = new Str("$");
Str* str770 = new Str("Undefined variable %r");
Str* str771 = new Str("Undefined array %r");
Str* str772 = new Str("Can't index string with @");
Str* str773 = new Str("Can't index string with *");
Str* str774 = new Str("Can't index string %r with integer");
Str* str775 = new Str("Array %r can't be referred to as a scalar (without @ or *)");
Str* str776 = new Str("\u0001");
Str* str777 = new Str("");
Str* str778 = new Str("\u0002");
Str* str779 = new Str("");
Str* str780 = new Str("a");
Str* str781 = new Str("A");
Str* str782 = new Str("r");
Str* str783 = new Str("x");
Str* str784 = new Str("n");
Str* str785 = new Str("");
Str* str786 = new Str("Var op %r not implemented");
Str* str787 = new Str("");
Str* str788 = new Str("warning: ");
Str* str789 = new Str("");
Str* str790 = new Str("Illegal array word part (strict_array)");
Str* str791 = new Str(" ");
Str* str792 = new Str("");
Str* str793 = new Str("Array %r can't be referred to as a scalar (without @ or *)");
Str* str794 = new Str("Unexpected array literal");
Str* str795 = new Str("Unexpected associative array literal");
Str* str796 = new Str("|");
Str* str797 = new Str(")");
Str* str798 = new Str("Can't splice %r");
Str* str799 = new Str("");
Str* str800 = new Str("");
Str* str801 = new Str("This word should yield a string, but it contains an array");
Str* str802 = new Str(" ");
Str* str803 = new Str("");
Str* str804 = new Str("<Runtime error: %s>");
Str* str805 = new Str("<I/O error: %s>");
Str* str806 = new Str("<I/O error: %s>");
Str* str807 = new Str("<Ctrl-C>");
Str* str808 = new Str("");
Str* str809 = new Str("");
Str* str810 = new Str("");
Str* str811 = new Str("");
Str* str812 = new Str("");
Str* str813 = new Str("LHS array not allowed in assignment builtin");
Str* str814 = new Str("+");
Str* str815 = new Str("+= not allowed in assignment builtin");
Str* str816 = new Str("-");
Str* str817 = new Str("+");
Str* str818 = new Str("f");
Str* str819 = new Str("F");
Str* str820 = new Str("");
Str* str821 = new Str("=");
Str* str822 = new Str("Invalid variable name %r");
Str* str823 = new Str("__NO_COMMAND_SUB__");
Str* str824 = new Str("__NO_PROCESS_SUB__");
Str* str825 = new Str("Expected : or } in slice");
Str* str826 = new Str("/");
Str* str827 = new Str("Pattern in ${x/pat/replace} must not be empty");
Str* str828 = new Str("Expected } after replacement string, got %s");
Str* str829 = new Str("Expected } or / to close pattern");
Str* str830 = new Str("Expected ] to close subscript");
Str* str831 = new Str("Expected } to close ${");
Str* str832 = new Str("Expected } to close ${");
Str* str833 = new Str("Expected } to close ${");
Str* str834 = new Str("Unexpected token in ${} (%s)");
Str* str835 = new Str("VOp2");
Str* str836 = new Str("Unexpected token in ${} (%s)");
Str* str837 = new Str("VOp3");
Str* str838 = new Str("Expected } to close ${");
Str* str839 = new Str("Expected } after length expression");
Str* str840 = new Str("Unexpected token in ${}");
Str* str841 = new Str("\\");
Str* str842 = new Str("Strings with backslashes should look like r'\\n' or c'\\n'");
Str* str843 = new Str("Unexpected EOF in single-quoted string that began here");
Str* str844 = new Str("Unexpected EOF reading extended glob that began here");
Str* str845 = new Str("Unexpected EOF reading double-quoted string that began here");
Str* str846 = new Str("Unexpected EOF while looking for closing backtick");
Str* str847 = new Str("");
Str* str848 = new Str("Invalid proc name %s");
Str* str849 = new Str("Expected first ) to end arith sub");
Str* str850 = new Str("Expected second ) to end arith sub");
Str* str851 = new Str("Expected first ) to end arith statement");
Str* str852 = new Str("Expected second ) to end arith statement");
Str* str853 = new Str("Expected ) to end for loop expression");
Str* str854 = new Str("Expected ( after =");
Str* str855 = new Str("Unexpected token in array literal");
Str* str856 = new Str("Expected associative array pair");
Str* str857 = new Str("Unexpected token after array literal");
Str* str858 = new Str("Unexpected token after array splice");
Str* str859 = new Str("Word has unbalanced { }.  Maybe add a space or quote it like \\{");
Str* str860 = new Str("Unexpected token while parsing arithmetic: %r");
Str* str861 = new Str("Unhandled: %s (%s)");
Str* str862 = new Str("Invalid lex state %s");
Str* str863 = new Str("");
Str* str864 = new Str("");
Str* str865 = new Str("");
Str* str866 = new Str("");
...
Str* str870 = new Str("");
Str* str871 = new Str("");
Str* str872 = new Str("Compound shouldn't be empty");
Str* str873 = new Str("/");
Str* str874 = new Str("");
Str* str875 = new Str("EOF");
Str* str876 = new Str("typ");
Str* str877 = new Str("tok");
Str* str878 = new Str("children");
Str* str879 = new Str("-");
Str* str880 = new Str("with %d children");
Str* str881 = new Str("");
Str* str882 = new Str("(PNode %s %s %s)");
Str* str883 = new Str("&");
Str* str884 = new Str("&amp;");
Str* str885 = new Str("<");
Str* str886 = new Str("&lt;");
...
Str* str904 = new Str("\n");
Str* str905 = new Str("\\n");
Str* str906 = new Str("\r");
Str* str907 = new Str("\\r");
Str* str908 = new Str("\t");
Str* str909 = new Str("\\t");
Str* str910 = new Str("\u0000");
Str* str911 = new Str("\\x00");
Str* str912 = new Str("\\0");
Str* str913 = new Str("");
Str* str914 = new Str("");
Str* str915 = new Str("");
Str* str916 = new Str("\\");
...
Str* str920 = new Str("\n");
Str* str921 = new Str("\\n");
Str* str922 = new Str("\r");
Str* str923 = new Str("\\r");
Str* str924 = new Str("\t");
Str* str925 = new Str("\\t");
Str* str926 = new Str("\u0000");
Str* str927 = new Str("\\x00");
Str* str928 = new Str("\\0");
Str* str929 = new Str("");
Str* str930 = new Str("!");
Str* str931 = new Str("Expected unary operator, got %r (2 args)");
Str* str932 = new Str("-a");
Str* str933 = new Str("-o");
Str* str934 = new Str("!");
Str* str935 = new Str("(");
Str* str936 = new Str(")");
Str* str937 = new Str("Expected binary operator, got %r (3 args)");
Str* str938 = new Str("]");
Str* str939 = new Str("missing closing ]");
Str* str940 = new Str("!");
Str* str941 = new Str("(");
Str* str942 = new Str(")");
Str* str943 = new Str("(test) ");
Str* str944 = new Str("(test) ");
...
Str* fmt39(Str* a0, int a1, Str* a2, Str* a3) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const(":", 1);
  gBuf.format_d(a1);
...
args::_Attributes* ParseLikeEcho(runtime_asdl::FlagSpec_* spec, args::Reader* arg_r);
...
Str* fmt117(int a0, Str* a1, int a2) {
  gBuf.reset();
...
Str* fmt178(Str* a0, Str* a1, syntax_asdl::word_t* a2) {
  gBuf.reset();
...
int main(List<Str*>* argv) {
  ...
  osh_eval::NullExecutor* shell_ex;
  ...
  argv = argv->slice(1);
  Tuple4<int, bool, Str*, bool> tup0 = Parse(argv);
  i = tup0.at0();
  flag_a = tup0.at1();
  flag_c = tup0.at2();
  flag_n = tup0.at3();
  ...
  environ->set(str43, posix::getcwd());
  state::InitMem(mem, environ, str44);
  opt_hook = new state::OptHook();
  Tuple3<optview::Parse*, optview::Exec*, state::MutableOpts*> tup1 = state::MakeOpts(mem, opt_hook);
  parse_opts = tup1.at0();
  exec_opts = tup1.at1();
  mutable_opts = tup1.at2();
  ...
  prompt_ev = new prompt::Evaluator(str47, parse_ctx, mem);
  ...
  cmd_deps->dumper = new dev::CrashDumper(str48);
  search_path = new state::SearchPath(mem);
  builtins = new Dict<int, vm::_Builtin*>();
  builtins->set(builtin_i::echo, new builtin_pure::Echo(exec_opts));
  builtins->set(builtin_i::set, new Set(mutable_opts));
  builtins->set(builtin_i::shopt, new builtin_pure::Shopt(mutable_opts));
  builtins->set(builtin_i::alias, new builtin_pure::Alias(aliases, errfmt));
  builtins->set(builtin_i::unalias, new builtin_pure::UnAlias(aliases, errfmt));
  builtins->set(builtin_i::hash, new builtin_pure::Hash(search_path));
  builtins->set(builtin_i::getopts, new builtin_pure::GetOpts(mem, errfmt));
  ...
  builtins->set(builtin_i::colon, true_);
  builtins->set(builtin_i::true_, true_);
  builtins->set(builtin_i::false_, new builtin_pure::Boolean(1));
  builtins->set(builtin_i::type, new builtin_meta::Type(procs, aliases, search_path, errfmt));
  ...
  builtins->set(builtin_i::test, new builtin_bracket::Test(false, exec_opts, mem, errfmt));
  builtins->set(builtin_i::bracket, new builtin_bracket::Test(true, exec_opts, mem, errfmt));
  dir_stack = new state::DirStack();
  builtins->set(builtin_i::pushd, new builtin_misc::Pushd(mem, dir_stack, errfmt));
  builtins->set(builtin_i::popd, new builtin_misc::Popd(mem, dir_stack, errfmt));
  builtins->set(builtin_i::dirs, new builtin_misc::Dirs(mem, dir_stack, errfmt));
  builtins->set(builtin_i::pwd, new builtin_misc::Pwd(mem, errfmt));
  builtins->set(builtin_i::times, new builtin_misc::Times());
  builtins->set(builtin_i::read, new builtin_misc::Read(splitter, mem));
  builtins->set(builtin_i::cat, new builtin_misc::Cat());
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  b = str_equals(argv->index(1), str50);
  opt_name = argv->index(2);
  this->mutable_opts->SetOption(opt_name, b);
  return 0;
}

NullExecutor::NullExecutor(optview::Exec* exec_opts, state::MutableOpts* mutable_opts, Dict<Str*, syntax_asdl::command__ShFunction*>* procs, Dict<int, vm::_Builtin*>* builtins) {
...
void Tracer::OnShAssignment(runtime_asdl::lvalue_t* lval, syntax_asdl::assign_op_t op, runtime_asdl::value_t* val, int flags, runtime_asdl::scope_t lookup_mode) {
  ...
  first_char = tup1.at0();
  prefix = tup1.at1();
  op_str = op == assign_op_e::PlusEqual ? str70 : str71;
}
...
Str* SearchPath::Lookup(Str* name, bool exec_required) {
  ...
  val = this->mem->GetVar(str75);
  UP_val = val;
  if (val->tag_() == value_e::Str) {
    value__Str* val = static_cast<value__Str*>(UP_val);
    path_list = val->s->split(str76);
  }
  else {
...
MutableOpts::MutableOpts(state::Mem* mem, List<bool>* opt_array, state::_ErrExit* errexit, state::OptHook* opt_hook) {
  ...
  runtime_asdl::value_t* UP_shellopts = this->mem->GetVar(str82);
...
void MutableOpts::SetOption(Str* opt_name, bool b) {
  ...
  UP_val = this->mem->GetVar(str86);
  value__Str* val = static_cast<value__Str*>(UP_val);
  shellopts = val->s;
  if (b) {
    if (!str_contains(shellopts, opt_name)) {
      new_val = new value::Str(fmt14(shellopts, opt_name));
      this->mem->InternalSetGlobal(str88, new_val);
    }
  }
  else {
    if (str_contains(shellopts, opt_name)) {
      names = new List<Str*>();
      for (ListIter<Str*> it(shellopts->split(str89)); !it.Done(); it.Next()) {
        Str* n = it.Value();
        names->append(n);
      }
      new_val = new value::Str(str90->join(names));
      this->mem->InternalSetGlobal(str91, new_val);
    }
  }
}
...
void MutableOpts::ShowOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    print(fmt15(b ? str97 : str98, opt_name));
  }
}
...
void MutableOpts::ShowShoptOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    print(fmt17(b ? str101 : str102, opt_name));
  }
}
...
void _InitDefaults(state::Mem* mem) {
  SetGlobalString(mem, str105, split::DEFAULT_IFS);
  SetGlobalString(mem, str106, str(posix::getuid()));
  SetGlobalString(mem, str107, str(posix::geteuid()));
  SetGlobalString(mem, str108, str(posix::getppid()));
  SetGlobalString(mem, str109, libc::gethostname());
  SetGlobalString(mem, str110, passwd::OsType());
  SetGlobalString(mem, str111, str112);
  SetGlobalString(mem, str113, str114);
  SetGlobalString(mem, str115, _READLINE_DELIMS);
}
...
void _InitVarsFromEnv(state::Mem* mem, Dict<Str*, Str*>* environ) {
  ...
  val = mem->GetVar(str116);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str117, str118);
  }
  mem->SetVar(new lvalue::Named(str119), nullptr, scope_e::GlobalOnly, SetReadOnly);
  val = mem->GetVar(str120);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str121, _GetWorkingDir());
  }
  mem->SetVar(new lvalue::Named(str122), nullptr, scope_e::GlobalOnly, SetExport);
}
...
void InitMem(state::Mem* mem, Dict<Str*, Str*>* environ, Str* version_str) {
  ...
  SetGlobalString(mem, str123, version_str);
  _InitDefaults(mem);
  _InitVarsFromEnv(mem, environ);
  val = mem->GetVar(str124);
...
Mem::Mem(Str* dollar0, List<Str*>* argv, alloc::Arena* arena, List<state::DebugFrame*>* debug_stack) {
  ...
  this->line_num = new value::Str(str125);
...
void Mem::_DisallowNamerefCycle(Str* name, List<Str*>* ref_trail) {
  ...
  if (list_contains(ref_trail, new_name)) {
    e_die(fmt23(str138->join(ref_trail)));
  }
...
Str* GetString(state::Mem* mem, Str* name) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      throw new error::Runtime(fmt31(name));
    }
      break;
    case value_e::Str: {
      ...
      break;
    default: {
      throw new error::Runtime(fmt32(name));
    }
  }
}
...
int GetInteger(state::Mem* mem, Str* name) {
  ...
  val = mem->GetVar(name, scope_e::Dynamic);
  if (val->tag_() != value_e::Str) {
    throw new error::Runtime(fmt33(name, ui::ValType(val)));
  }
  s = static_cast<value__Str*>(val)->s;
  try {
    i = to_int(s);
    ...
    throw new error::Runtime(fmt34(name, s));
  }
  return i;
}
...
Str* PrettyDir(Str* dir_name, Str* home_dir) {
  if (home_dir != nullptr) {
    if (str_equals(dir_name, home_dir) or dir_name->startswith(str_concat(home_dir, str162))) {
      return str_concat(str163, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    f->write(str_equals(c, str166) ? str167 : str168);
  }
  f->write(str169);
  f->write(str_repeat(str170, length - 1));
  f->write(str171);
}
...
void _PrintWithSpanId(Str* prefix, Str* msg, int span_id, alloc::Arena* arena, mylib::Writer* f) {
  ...
  switch (src->tag_()) {
    ...
    case source_e::EvalArg: {
      ...
      source_str = fmt38(line_num, outer_source);
    }
      break;
    case source_e::Trap: {
      source_str = str179;
  ...
  f->write(fmt39(source_str, line_num, prefix, msg));
}
...
void PrettyPrintError(error::_ErrorWithLocation* err, alloc::Arena* arena) {
  PrettyPrintError(err, arena, str183);
}
...
void ErrorFormatter::Print_(Str* msg, int span_id) {
  ...
  _PrintWithOptionalSpanId(str184, msg, span_id, this->arena);
}
...
bool SetBoolToArg::OnMatch(Str* prefix, Str* suffix, args::Reader* arg_r, args::_Attributes* out) {
  ...
  if (suffix) {
    if ((suffix == str199 || suffix == str200 || suffix == str201 || suffix == str202)) {
      b = false;
    }
    else {
      if ((suffix == str203 || suffix == str204 || suffix == str205 || suffix == str206)) {
        b = true;
      }
      else {
        e_usage(fmt41(suffix));
      }
    }
  }
  else {
...
args::_Attributes* Parse(runtime_asdl::FlagSpec_* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    ...
    if (arg->startswith(str214) and len(arg) > 1) {
      n = len(arg);
      for (int i = 1; i < n; ++i) {
        ch = arg->index(i);
        if (list_contains(spec->options, ch)) {
          out->Set(ch, new value::Str(str215));
          continue;
        }
      ...
      if (len(spec->options) and arg->startswith(str218) and len(arg) > 1) {
        n = len(arg);
        for (int i = 1; i < n; ++i) {
          ch = arg->index(i);
          if (list_contains(spec->options, ch)) {
            out->Set(ch, new value::Str(str219));
            continue;
          }
          e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
        }
...
args::_Attributes* ParseLikeEcho(runtime_asdl::FlagSpec_* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    chars = arg->slice(1);
    if (arg->startswith(str222) and len(chars)) {
      done = false;
...
args::_Attributes* ParseMore(flag_spec::_FlagSpecAndMore* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    ...
    if (arg->startswith(str226) or arg->startswith(str227)) {
      char0 = arg->index(0);
...
int LineLexer::GetSpanIdForEof() {
  ...
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str232, 0);
  }
  else {
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str233, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = new Token(id_, span_id, str234);
      return t;
    }
...
lexer::Lexer* ParseContext::_MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = new lexer::LineLexer(str236, this->arena);
...
int _Classify(grammar::Grammar* gr, syntax_asdl::Token* tok) {
  ...
  type_str = tok->id == Id::Unknown_Tok ? str240 : fmt45(ui::PrettyId(tok->id));
  p_die(fmt46(type_str), tok);
}
...
Tuple2<pnode::PNode*, syntax_asdl::Token*> ExprParser::Parse(lexer::Lexer* lexer, int start_symbol) {
  ...
  try {
    ...
    p_die(fmt47(ui::PrettyId(e->tok->id)), e->tok);
  }
...
List<Str*>* POSIX_CLASSES = new List<Str*>({str244, str245, str246, str247, str248, str249, str250, str251, str252, str253, str254, str255});
Str* RANGE_POINT_TOO_LONG = str256;
int NT_OFFSET = 256;
...
syntax_asdl::expr_t* Transformer::_Tuple(List<pnode::PNode*>* children) {
  ...
  if (n == 2) {
    p_die(fmt48(), children->index(1)->tok);
  }
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw new NotImplementedError(str258);
  }
  if (id0 == Id::Op_LBracket) {
    elts = new List<syntax_asdl::expr_t*>();
    for (int i = 0; i < n; i += 2) {
  ...
  for (int i = 0; i < n; i += 2) {
    ...
    if (tag == expr_e::Var) {
      ...
      if ((tag == place_expr_e::Var || tag == place_expr_e::Subscript || tag == place_expr_e::Attribute)) {
        ...
        p_die(fmt49(), p->tok ? p->tok : nullptr);
      }
    }
  }
  return places;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((tok->val == str268 || tok->val == str269 || tok->val == str270)) {
        return tok;
      }
      p_die(fmt54(tok->val), tok);
    }
...
void _ClassLiteralToPosixEre(syntax_asdl::class_literal_term_t* term, List<Str*>* parts) {
  ...
  if (tag == class_literal_term_e::CodePoint) {
    ...
    if (code_point < 128) {
      ...
      e_die(fmt56(code_point), term->spid);
    }
    return ;
  }
  if (tag == class_literal_term_e::PerlClass) {
    ...
    if (term->negated) {
      e_die(fmt57(), term->negated->span_id);
    }
    else {
      pat = fmt58(chars);
    }
  ...
  if (tag == class_literal_term_e::PosixClass) {
    ...
    n = term->name;
    if (term->negated) {
      e_die(fmt59(), term->negated->span_id);
    }
    else {
      pat = fmt60(n);
    }
...
void AsPosixEre(syntax_asdl::re_t* node, List<Str*>* parts) {
  ...
  if (tag == re_e::Repeat) {
    ...
    if (op_tag == re_repeat_e::Num) {
      ...
      parts->append(fmt62(op->times->val));
      return ;
    }
    if (op_tag == re_repeat_e::Range) {
      re_repeat__Range* op = static_cast<re_repeat__Range*>(UP_op);
      lower = op->lower ? op->lower->val : str287;
      upper = op->upper ? op->upper->val : str288;
      parts->append(fmt63(lower, upper));
      return ;
    }
...
syntax_asdl::bool_expr_t* BoolParser::ParseForBuiltin() {
  ...
  if (this->op_id != Id::Eof_Real) {
    p_die(fmt70(word_::Pretty(this->cur_word)), this->cur_word);
  }
  return node;
}
...
syntax_asdl::bool_expr_t* BoolParser::ParseFactor() {
  ...
  if (this->op_id == Id::Op_LParen) {
    ...
    if (this->op_id != Id::Op_RParen) {
      p_die(fmt72(word_::Pretty(this->cur_word)), this->cur_word);
    }
    this->_Next();
    return node;
  }
  p_die(fmt73(), this->cur_word);
}
...
Str* _RangeParser::_Eat(int token_type) {
  ...
  if (this->token_type != token_type) {
    throw new _NotARange(fmt74(token_type, this->token_type));
  }
  val = this->token_val;
  this->_Next();
  return val;
...
syntax_asdl::word_part__BracedRange* _RangeParser::Parse() {
  ...
  if (this->token_type == Id::Range_Int) {
    ...
    if (start < end) {
      ...
      if (part->step <= 0) {
        p_die(fmt76(part->step), this->span_id);
      }
    }
    else {
      if (start > end) {
        ...
        if (part->step >= 0) {
          p_die(fmt77(part->step), this->span_id);
        }
      }
      else {
        part->step = 1;
    ...
    if (this->token_type == Id::Range_Char) {
      ...
      if (start_num < end_num) {
        ...
        if (part->step <= 0) {
          p_die(fmt78(part->step), this->span_id);
        }
      }
      else {
        if (start_num > end_num) {
          ...
          if (part->step >= 0) {
            p_die(fmt79(part->step), this->span_id);
          }
        }
        else {
          part->step = 1;
      ...
      if (upper1 != upper2) {
        p_die(fmt80(), this->span_id);
      }
    }
    else {
      throw new _NotARange(str313);
    }
  }
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  flag = attrs->attrs;
  tmp_g = flag->get(str316);
  tmp_a = flag->get(str317);
  tmp_A = flag->get(str318);
  ...
  flag_A = tmp_A and tmp_A->tag_() == value_e::Bool ? static_cast<value__Bool*>(tmp_A)->b : false;
  tmp_n = flag->get(str319);
  tmp_r = flag->get(str320);
  tmp_x = flag->get(str321);
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if (str_equals(flag_n, str323) and !cell->nameref) {
      continue;
    }
    if (str_equals(flag_n, str324) and cell->nameref) {
      continue;
    }
    if (str_equals(flag_r, str325) and !cell->readonly) {
      continue;
    }
    if (str_equals(flag_r, str326) and cell->readonly) {
      continue;
    }
    if (str_equals(flag_x, str327) and !cell->exported) {
      continue;
    }
    if (str_equals(flag_x, str328) and cell->exported) {
      continue;
    }
    ...
    if (print_flags) {
      ...
      decl->extend(new List<Str*>({str335, str336->join(flags), str337, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(new List<Str*>({str338, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (list_contains(array_val->strs, nullptr)) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(new List<Str*>({str341, name, str342, str(i), str343, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(new List<Str*>({str345, str346->join(body), str347}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(new List<Str*>({str349, key_quoted, str350, value_quoted}));
          }
          if (len(body) > 0) {
            decl->extend(new List<Str*>({str351, str352->join(body), str353}));
          }
        }
      }
    }
    print(str354->join(decl));
    count += 1;
  }
...
int Export::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r->Next();
  attrs = flag_spec::Parse(str355, arg_r);
...
int Readonly::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = new args::Reader(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str360, arg_r);
...
int NewVar::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = new args::Reader(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str361, arg_r);
...
int Unset::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str372, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
...
int Eval::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str375, cmd_val);
  arg_r = tup0.at1();
  if (this->exec_opts->strict_eval_builtin()) {
    Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str376);
    code_str = tup1.at0();
    eval_spid = tup1.at1();
    if (!arg_r->AtEnd()) {
      e_usage(str377);
    ...
    code_str = str378->join(arg_r->Rest());
...
int Source::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str379, cmd_val);
  arg_r = tup2.at1();
  path = arg_r->Peek();
  if (path == nullptr) {
    e_usage(str380);
  ...
  try {
    ...
    this->errfmt->Print_(fmt89(path, pyutil::strerror_OS(e)), cmd_val->arg_spids->index(1));
    return 1;
  }
  try {
    try {
...
int Command::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup3 = flag_spec::ParseCmdVal(str382, cmd_val);
  attrs = tup3.at0();
  arg_r = tup3.at1();
...
int Builtin::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (to_run == consts::NO_INDEX) {
    ...
    if (consts::LookupAssignBuiltin(name) != consts::NO_INDEX) {
      this->errfmt->Print_(str383, span_id);
    }
    else {
      this->errfmt->Print_(fmt90(name), span_id);
    }
    return 1;
  }
...
List<Tuple2<Str*, Str*>*>* _ResolveNames(List<Str*>* names, Dict<Str*, syntax_asdl::command__ShFunction*>* funcs, Dict<Str*, Str*>* aliases, state::SearchPath* search_path) {
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if (dict_contains(funcs, name)) {
      kind = (new Tuple2<Str*, Str*>(str385, name));
    }
    else {
      if (dict_contains(aliases, name)) {
        kind = (new Tuple2<Str*, Str*>(str386, name));
      }
      else {
        if (consts::LookupNormalBuiltin(name) != 0) {
          kind = (new Tuple2<Str*, Str*>(str387, name));
        }
        else {
          if (consts::LookupSpecialBuiltin(name) != 0) {
            kind = (new Tuple2<Str*, Str*>(str388, name));
          }
          else {
            if (consts::LookupAssignBuiltin(name) != 0) {
              kind = (new Tuple2<Str*, Str*>(str389, name));
            }
            else {
              if (consts::IsControlFlow(name)) {
                kind = (new Tuple2<Str*, Str*>(str390, name));
              }
              else {
                if (consts::IsKeyword(name)) {
                  kind = (new Tuple2<Str*, Str*>(str391, name));
                }
                else {
                  ...
                  if (resolved == nullptr) {
                    ...
                    kind = (new Tuple2<Str*, Str*>(str392, resolved));
                  }
                }
              }
            }
...
int Type::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str393, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
  ...
  for (ListIter<Tuple2<Str*, Str*>*> it(r); !it.Done(); it.Next()) {
    ...
    name = tup6->at1();
    if (kind == nullptr) {
      this->errfmt->StderrLine(fmt91(name));
      status = 1;
    }
    else {
      if (arg->t) {
        ...
        if (arg->p) {
          if (str_equals(kind, str395)) {
            print(name);
          }
        }
        else {
          if (arg->P) {
            if (str_equals(kind, str396)) {
              print(name);
            }
            else {
            ...
            print(fmt92(name, kind));
            if (str_equals(kind, str398)) {
              ;  // pass
            }
          }
        }
...
Tuple2<Str*, bool> ReadLineFromStdin(Str* delim_char) {
  ...
  return (Tuple2<Str*, bool>(str399->join(chars), eof));
}
...
int Read::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str400, cmd_val);
  attrs = tup2.at0();
  arg_r = tup2.at1();
...
int MapFile::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str407, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
...
int Cd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup7 = flag_spec::ParseCmdVal(str409, cmd_val);
  attrs = tup7.at0();
  arg_r = tup7.at1();
  ...
  if (dest_dir == nullptr) {
    ...
    try {
      dest_dir = state::GetString(this->mem, str411);
    }
    catch (error::Runtime* e) {
  ...
  if (str_equals(dest_dir, str412)) {
    try {
      dest_dir = state::GetString(this->mem, str413);
      print(dest_dir);
    }
    catch (error::Runtime* e) {
      this->errfmt->Print_(e->UserErrorString());
  ...
  try {
    pwd = state::GetString(this->mem, str414);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    return 1;
  ...
  try {
    ...
    this->errfmt->Print_(fmt93(real_dest_dir, pyutil::strerror_OS(e)), arg_spid);
    return 1;
  }
  state::ExportGlobalString(this->mem, str416, real_dest_dir);
  ...
  if (cmd_val->block) {
    ...
    state::ExportGlobalString(this->mem, str417, pwd);
...
void _PrintDirStack(state::DirStack* dir_stack, int style, Str* home_dir) {
  ...
  if (style == WITH_LINE_NUMBERS) {
    ...
    for (ListIter<Str*> it(dir_stack->Iter()); !it.Done(); it.Next(), ++i) {
      Str* entry = it.Value();
      print(fmt94(i, ui::PrettyDir(entry, home_dir)));
    }
  }
  else {
...
int Pushd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  try {
    ...
    this->errfmt->Print_(fmt95(dest_dir, pyutil::strerror_OS(e)), cmd_val->arg_spids->index(1));
    return 1;
  }
  this->dir_stack->Push(dest_dir);
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str423));
  state::ExportGlobalString(this->mem, str424, dest_dir);
...
bool _PopDirStack(state::Mem* mem, state::DirStack* dir_stack, ui::ErrorFormatter* errfmt) {
  ...
  try {
    ...
    errfmt->Print_(fmt96(dest_dir, pyutil::strerror_OS(e)));
    return false;
  }
  state::SetGlobalString(mem, str427, dest_dir);
  mem->SetPwd(dest_dir);
  return true;
}
...
int Popd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  if (len(cmd_val->arg_spids) > 1) {
    e_usage(fmt97(), cmd_val->arg_spids->index(1));
  }
  if (!_PopDirStack(this->mem, this->dir_stack, this->errfmt)) {
    return 1;
  }
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str429));
  return 0;
}
...
int Dirs::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseCmdVal(str430, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  arg = new arg_types::dirs(attrs->attrs);
  home_dir = state::MaybeString(this->mem, str431);
  style = SINGLE_LINE;
  if (arg->l) {
    home_dir = nullptr;
  }
...
int Pwd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup10 = flag_spec::ParseCmdVal(str432, cmd_val);
  attrs = tup10.at0();
  arg_r = tup10.at1();
...
syntax_asdl::printf_part_t* _FormatStringParser::_ParseFormatStr() {
  ...
  while ((this->token_type == Id::Format_Flag || this->token_type == Id::Format_Zero)) {
    ...
    if (str_contains(str433, flag)) {
      p_die(fmt98(flag), this->cur_token);
    }
  ...
  if ((this->token_type == Id::Format_Type || this->token_type == Id::Format_Time)) {
    ...
    if (str_contains(str435, part->type->val)) {
      p_die(fmt99(), part->type);
    }
    if (part->type->val == str437) {
      p_die(fmt100(), part->type);
    }
  }
  else {
  ...
  if (part->precision and !str_contains(str441, part->type->val->index(-1))) {
...
int Printf::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str443, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
  arg = new arg_types::printf(attrs->attrs);
  Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str444);
  fmt = tup1.at0();
  fmt_spid = tup1.at1();
        ...
        if (part->tag_() == printf_part_e::Percent) {
          ...
          if (part->width) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt101(width_str), width_spid);
              return 1;
            }
          }
          precision = -1;
          if (part->precision) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt102(precision_str), precision_spid);
              return 1;
            }
          }
          if (arg_index < num_args) {
          ...
          typ = part->type->val;
          if (str_equals(typ, str452)) {
            if (precision >= 0) {
              s = s->slice(0, precision);
            }
          }
          else {
            if (str_equals(typ, str453)) {
              s = qsn::maybe_shell_encode(s);
            }
            else {
              if (str_equals(typ, str454)) {
                ...
                s = str455->join(c_parts);
              }
              else {
                if (str_contains(str456, typ) or part->type->id == Id::Format_Time) {
                  try {
                    d = to_int(s);
                  }
                  catch (ValueError*) {
                    if (len(s) >= 1 and str_contains(str457, s->index(0))) {
                      ...
                      if (part->type->id == Id::Format_Time and len(s) == 0 and word_spid == runtime::NO_SPID) {
                        ...
                        this->errfmt->Print_(fmt103(s), blame_spid);
                        return 1;
                      }
                    }
                  }
                  if (str_contains(str459, typ)) {
                    s = str(d);
                  }
                  else {
                    if (str_contains(str460, typ)) {
                      if (d < 0) {
                        e_die(fmt104(d, typ), part->type->span_id);
                      }
                      if (str_equals(typ, str462)) {
                        s = str(d);
                      }
                      else {
                        if (str_equals(typ, str463)) {
                          s = mylib::octal(d);
                        }
                        else {
                          if (str_equals(typ, str464)) {
                            s = mylib::hex_lower(d);
                          }
                          else {
                            if (str_equals(typ, str465)) {
                              s = mylib::hex_upper(d);
                            }
                          }
                        }
          ...
          if (width >= 0) {
            if (len(flags)) {
              if (list_contains(flags, str468)) {
                s = s->ljust(width, str469);
              }
              else {
                if (list_contains(flags, str470)) {
                  s = s->rjust(width, str471);
                }
                else {
                  ;  // pass
                }
  ...
  result = str473->join(out);
  if (arg->v) {
    var_name = arg->v;
    if (!match::IsValidVarName(var_name)) {
      e_usage(fmt105(var_name));
    }
...
int Alias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str475, cmd_val);
  arg_r = tup0.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    Tuple2<Str*, Str*> tup1 = mylib::split_once(arg, str477);
    name = tup1.at0();
    alias_exp = tup1.at1();
    if (alias_exp == nullptr) {
      alias_exp = this->aliases->get(name);
      if (alias_exp == nullptr) {
        this->errfmt->Print_(fmt107(name), cmd_val->arg_spids->index(i));
        status = 1;
      }
      else {
        print(fmt108(name, alias_exp));
      }
    }
    else {
...
int UnAlias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str480, cmd_val);
  arg_r = tup2.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
    e_usage(str481);
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    ...
    try {
      ...
      this->errfmt->Print_(fmt109(name), cmd_val->arg_spids->index(i));
      status = 1;
    }
  }
  return status;
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->argv) == 1) {
    ...
    for (ListIter<Str*> it(sorted(mapping)); !it.Done(); it.Next()) {
      ...
      code_str = fmt110(name, qsn::maybe_shell_encode(str_val));
      print(code_str);
    }
    return 0;
  }
  arg_r = new args::Reader(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  arg = flag_spec::ParseMore(str484, arg_r);
  if (arg->show_options) {
...
int Shopt::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str485, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
...
int Hash::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str486, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
...
Dict<Str*, bool>* _ParseOptSpec(Str* spec_str) {
  ...
  while (true) {
    ...
    c = spec_str->index(i);
    key = str_concat(str489, c);
    spec->set(key, false);
    i += 1;
    if (i >= n) {
      break;
    }
    if (str_equals(spec_str->index(i), str490)) {
      spec->set(key, true);
      i += 1;
    }
  }
...
Tuple4<int, Str*, Str*, int> _GetOpts(Dict<Str*, bool>* spec, List<Str*>* argv, int optind, ui::ErrorFormatter* errfmt) {
  ...
  try {
    ...
    return (Tuple4<int, Str*, Str*, int>(1, str492, optarg, optind));
  }
  if (!current->startswith(str493)) {
    return (Tuple4<int, Str*, Str*, int>(1, str494, optarg, optind));
  }
  if (!dict_contains(spec, current)) {
    optind += 1;
    return (Tuple4<int, Str*, Str*, int>(0, str495, optarg, optind));
  }
  optind += 1;
  ...
  if (needs_arg) {
    try {
      ...
      errfmt->Print_(fmt112(current));
      tmp = new List<Str*>();
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* a = it.Value();
        tmp->append(qsn::maybe_shell_encode(a));
      }
      println_stderr(fmt113(str498->join(tmp)));
      return (Tuple4<int, Str*, Str*, int>(0, str499, optarg, optind));
    }
    optind += 1;
  }
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = new args::Reader(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  spec_str = arg_r->ReadRequired(str500);
  Tuple2<Str*, int> tup7 = arg_r->ReadRequired2(str501);
  var_name = tup7.at0();
  var_spid = tup7.at1();
  try {
  ...
  try {
    optind = state::GetInteger(this->mem, str502);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    return 1;
  ...
  optarg = tup8.at2();
  optind = tup8.at3();
  state::SetStringDynamic(this->mem, str503, optarg);
  state::SetStringDynamic(this->mem, str504, str(optind));
  if (match::IsValidVarName(var_name)) {
    state::SetStringDynamic(this->mem, var_name, opt_char);
  }
  else {
    throw new error::Usage(fmt114(var_name), var_spid);
  }
  return status;
}
...
int Echo::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseLikeEcho(str506, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  if (arg->e) {
    ...
    for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
      ...
      new_argv->append(str507->join(parts));
      if (backslash_c) {
        break;
      }
    }
...
int CommandEvaluator::_RunAssignBuiltin(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  if (builtin_func == nullptr) {
    e_die(fmt115(cmd_val->argv->index(0)), cmd_val->arg_spids->index(0));
  }
  try {
    try {
      status = builtin_func->Run(cmd_val);
      ...
      this->errfmt->PrefixPrint(e->msg, fmt116(arg0), e->span_id);
      status = 2;
    }
...
void CommandEvaluator::_CheckStatus(int status, syntax_asdl::command_t* node) {
  ...
  if (this->exec_opts->errexit() and status != 0) {
    ...
    throw new error::ErrExit(fmt117(status, reason, posix::getpid()), span_id, status);
  }
}
  ...
  switch (arg->tag_()) {
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        filename = val->s;
        if (!filename) {
          throw new error::RedirectEval(str520, arg_word);
        }
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          t = val->s;
          if (!t) {
            throw new error::RedirectEval(str521, arg_word);
            return nullptr;
          }
          try {
            if (str_equals(t, str522)) {
              result->arg = new redirect_arg::CloseFd();
            }
            else {
              if (str_equals(t->index(-1), str523)) {
            ...
            throw new error::RedirectEval(fmt118(t), arg_word);
            return nullptr;
          }
          return result;
        }
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = new redirect_arg::HereDoc(str_concat(val->s, str525));
            return result;
          }
          else {
            throw new AssertionError();
  ...
  switch (node->tag_()) {
    case command_e::Simple: {
      ...
      if (UP_cmd_val->tag_() == cmd_value_e::Argv) {
        ...
        argv = new List<Str*>({str528});
        if (node->block) {
          e_die(fmt119(), node->block->spids->index(0));
        }
      }
    ...
    case command_e::Pipeline: {
      ...
      if (len(node->stderr_indices)) {
        e_die(fmt120(), node->spids->index(0));
      }
      if (node->negated) {
    ...
    case command_e::ControlFlow: {
      ...
      if (node->arg_word) {
        ...
        try {
          ...
          e_die(fmt121(node->token->val, str_val->s), node->arg_word);
        }
      }
      else {
      ...
      if (ok) {
        ...
        if (this->exec_opts->strict_control_flow()) {
          ...
          this->errfmt->PrefixPrint(msg, str535, tok->span_id);
          status = 0;
        }
      }
    }
...
Tuple2<bool, bool> CommandEvaluator::ExecuteAndCatch(syntax_asdl::command_t* node, int cmd_flags) {
  ...
  try {
    ...
    if (cmd_flags & IsEvalSource) {
      ...
      if (e->IsReturn()) {
        ...
        is_eval = false;
        this->errfmt->Print_(str537, e->token->span_id);
        is_fatal = true;
        status = 1;
      }
    }
  ...
  if (err) {
    ...
    if (is_errexit and !this->exec_opts->verbose_errexit()) {
      ...
      ui::PrettyPrintError(err, this->arena, str538);
    }
  }
  ...
  try {
    try {
      ...
      if (e->IsReturn()) {
        ...
        e_die(fmt123(e->token->val), e->token);
      }
    }
    catch (error::FatalRuntime* e) {
      this->dumper->MaybeCollect(this, e);
...
int CommandEvaluator::RunFuncForCompletion(syntax_asdl::command__ShFunction* func_node, List<Str*>* argv) {
  ...
  try {
    ...
    this->errfmt->Print_(str541, e->token->span_id);
    status = 1;
  }
  return status;
}
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index(i), str543))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index(-2), str545)) {
    ...
    if (left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse) {
      var_name = left_token->val->slice(0, -1);
      if (str_equals(close_token->val->index(-2), str546)) {
        op = assign_op_e::PlusEqual;
      }
      else {
        op = assign_op_e::Equal;
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        var_name = left_token->val->slice(0, -1);
        if (str_equals(close_token->val->index(-2), str547)) {
          op = assign_op_e::PlusEqual;
        }
        else {
          op = assign_op_e::Equal;
        ...
        if (span1->line_id == span2->line_id) {
          ...
          throw new NotImplementedError(fmt126(span1->line_id, span2->line_id));
        }
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    w = tup6->at3();
    if (left_token->id != Id::Lit_VarLike) {
      p_die(fmt127(), left_token);
    }
    if (str_equals(left_token->val->index(-2), str550)) {
      p_die(fmt128(), left_token);
    }
    var_name = left_token->val->slice(0, -1);
    n = len(w->parts);
    if (part_offset == n) {
...
void CommandParser::_Eat(int c_id) {
  ...
  msg = fmt130(ui::PrettyId(c_id), ui::PrettyId(actual_id));
  this->_Eat2(c_id, msg);
}
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index(0), str554)) {
    pos = op_val->find(str555);
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    i += 1;
    if (!alias_exp->endswith(str557)) {
      expanded->append(str558);
      break;
    }
  }
  if (len(expanded) == 0) {
  ...
  while (i < n) {
    ...
    if (span1->line_id == span2->line_id) {
      ...
      throw new NotImplementedError(fmt132(span1->line_id, span2->line_id));
    }
    expanded->append(str560);
    i += 1;
  }
  code_str = str561->join(expanded);
  line_reader = reader::StringLineReader(code_str, this->arena);
  ...
  if (kind == Kind::ControlFlow) {
    ...
    if (len(suffix_words) == 1) {
      ...
      if (len(suffix_words) == 2) {
        ...
        p_die(fmt140(kw_token->val), suffix_words->index(2));
      }
    }
...
syntax_asdl::command__ForEach* CommandParser::_ParseForEachLoop(int for_spid) {
  ...
  quoted = tup15.at2();
  if (!ok or quoted) {
    p_die(fmt143(), this->cur_word);
  }
  if (!match::IsValidVarName(iter_name)) {
    p_die(fmt144(), this->cur_word);
  }
...
syntax_asdl::command__ShFunction* CommandParser::ParseFunctionDef() {
  ...
  if (len(name) == 0) {
    p_die(fmt148(), cur_word);
  }
  this->_Next();
  this->_Peek();
  this->lexer->PushHint(Id::Op_RParen, Id::Right_ShFunction);
  this->_Next();
  this->_Eat2(Id::Right_ShFunction, str578);
...
syntax_asdl::command_t* CommandParser::ParseCommand() {
  ...
  if (this->c_kind == Kind::Eof) {
    p_die(fmt152(), this->cur_word);
  }
  p_die(fmt153(), this->cur_word);
}
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if (str_equals(c, str586)) {
      i += 1;
    }
    else {
      if (str_equals(c, str587) or str_equals(c, str588)) {
        return true;
      }
      else {
        if (str_equals(c, str589)) {
          left_bracket = true;
        }
        else {
          if (str_equals(c, str590) and left_bracket) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  return util::BackslashEscape(s, str592);
}
Str* ERE_META_CHARS = str593;
...
Str* GlobUnescape(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if (str_equals(c, str594) and i != n - 1) {
      i += 1;
      c2 = s->index(i);
  ...
  return str596->join(unescaped);
}

_GlobParser::_GlobParser(match::SimpleLexer* lexer) {
  this->lexer = lexer;
  this->token_type = Id::Undefined_Tok;
  this->token_val = str597;
      ...
      if (tag == glob_part_e::Operator) {
        ...
        if (tag == glob_part_e::CharClass) {
          ...
          for (ListIter<Str*> it(part->strs); !it.Done(); it.Next()) {
            Str* s = it.Value();
            if (str_equals(s, str612)) {
              literal_hyphen = true;
              continue;
            }
            if (str_equals(s, str613)) {
...
int Globber::Expand(Str* arg, List<Str*>* out) {
  ...
  if (n) {
    for (ListIter<Str*> it(results); !it.Done(); it.Next()) {
      Str* name = it.Value();
      if (name->startswith(str619) and !this->exec_opts->dashglob()) {
        n -= 1;
        continue;
      }
      out->append(name);
...
Str* _PromptEvaluatorCache::Get(Str* name) {
  ...
  if (str_equals(name, str621)) {
    value = this->_GetEuid() == 0 ? str622 : str623;
  }
  else {
    if (str_equals(name, str624)) {
      value = libc::gethostname();
    }
    else {
      if (str_equals(name, str625)) {
        value = passwd::GetUserName(this->_GetEuid());
      }
      else {
        throw new AssertionError();
      }
...
Evaluator::Evaluator(Str* lang, parse_lib::ParseContext* parse_ctx, state::Mem* mem) {
  ...
  this->parse_ctx = parse_ctx;
  this->mem = mem;
  this->default_prompt = str_concat(lang, str626);
      ...
      if (id_ == Id::PS_Octal3) {
        ...
        if (id_ == Id::PS_LBrace) {
          ...
          if (id_ == Id::PS_RBrace) {
            ...
            if (id_ == Id::PS_Subst) {
              ch = value->slice(1);
              if (str_equals(ch, str629)) {
                r = this->cache->Get(str630);
              }
              else {
                if (str_equals(ch, str631)) {
                  r = this->cache->Get(str632);
                }
                else {
                  if (str_equals(ch, str633)) {
                    hostname = this->cache->Get(str634);
                    Tuple2<Str*, Str*> tup1 = mylib::split_once(hostname, str635);
                    r = tup1.at0();
                  }
                  else {
                    if (str_equals(ch, str636)) {
                      r = this->cache->Get(str637);
                    }
                    else {
                      if (str_equals(ch, str638)) {
                        try {
                          pwd = state::GetString(this->mem, str639);
                          home = state::MaybeString(this->mem, str640);
                          r = ui::PrettyDir(pwd, home);
                        }
                        catch (error::Runtime* e) {
                          r = fmt157(e->UserErrorString());
                        }
                      }
                      else {
                        if (str_equals(ch, str642)) {
                          val = this->mem->GetVar(str643);
                          if (val->tag_() == value_e::Str) {
                            value__Str* str_val = static_cast<value__Str*>(val);
              ...
              ret->append(r->replace(str646, str647));
            }
            else {
              throw new AssertionError();
            }
...
Str* Evaluator::EvalPrompt(runtime_asdl::value_t* UP_val) {
  ...
  try {
    ...
    try {
      ...
      ps1_word = word_::ErrorWord(fmt159(e->UserErrorString()));
    }
...
Str* Evaluator::EvalFirstPrompt() {
  ...
  if (str_equals(this->lang, str651)) {
    val = this->mem->GetVar(str652);
    ...
    case lvalue_e::Indexed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          break;
        default: {
          e_die(fmt161(ui::ValType(val)));
        }
      }
      s = word_eval::GetArrayItem(array_val->strs, lval->index);
      if (s == nullptr) {
        val = new value::Str(str656);
      }
      else {
        val = new value::Str(s);
      }
    ...
    case lvalue_e::Keyed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::AssocArray: {
          ...
          break;
        default: {
          e_die(fmt162(ui::ValType(val)));
        }
      }
      s = assoc_val->d->get(lval->key);
      if (s == nullptr) {
        val = new value::Str(str658);
      }
      else {
        val = new value::Str(s);
      }
...
int ArithEvaluator::_StringToInteger(Str* s, int span_id) {
  ...
  if (s->startswith(str659)) {
    try {
      integer = to_int(s, 16);
    }
    catch (ValueError*) {
      e_strict(fmt163(s), span_id);
    }
    return integer;
  }
  if (s->startswith(str661)) {
    try {
      integer = to_int(s, 8);
    }
    catch (ValueError*) {
      e_strict(fmt164(s), span_id);
    }
    return integer;
  }
  if (str_contains(s, str663)) {
    Tuple2<Str*, Str*> tup0 = mylib::split_once(s, str664);
    b = tup0.at0();
    digits = tup0.at1();
    try {
      base = to_int(b);
      ...
      e_strict(fmt165(b), span_id);
    }
    integer = 0;
    for (StrIter it(digits); !it.Done(); it.Next()) {
      Str* ch = it.Value();
      if (IsLower(ch)) {
        digit = ord(ch) - ord(str666) + 10;
      }
      else {
        if (IsUpper(ch)) {
          digit = ord(ch) - ord(str667) + 36;
        }
        else {
          if (str_equals(ch, str668)) {
            digit = 62;
          }
          else {
            if (str_equals(ch, str669)) {
              ...
              if (ch->isdigit()) {
                ...
                e_strict(fmt166(digits), span_id);
              }
            }
          }
        }
      ...
      if (digit >= base) {
        e_strict(fmt167(digits, base), span_id);
      }
...
int ArithEvaluator::_ValToIntOrError(runtime_asdl::value_t* val, int span_id) {
  ...
  e_die(fmt171(ui::ValType(val)), span_id);
}
  ...
  if ((val->tag_() == value_e::MaybeStrArray || val->tag_() == value_e::AssocArray) and lval->tag_() == lvalue_e::Named) {
    ...
    if (word_eval::CheckCompatArray(named_lval->name, this->exec_opts)) {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (val->tag_() == value_e::AssocArray) {
          lval = new lvalue::Keyed(named_lval->name, str676);
        }
      }
        ...
        if (op_id == Id::Arith_Minus) {
          ...
          if (op_id == Id::Arith_Star) {
            ...
            if (op_id == Id::Arith_Slash) {
              if (rhs == 0) {
                e_die(fmt173(), location::SpanForArithExpr(node->right));
              }
              ret = lhs / rhs;
            }
            else {
              if (op_id == Id::Arith_Percent) {
                if (rhs == 0) {
                  e_die(fmt174(), location::SpanForArithExpr(node->right));
                }
                ret = lhs % rhs;
              }
              else {
...
void BoolEvaluator::_SetRegexMatches(List<Str*>* matches) {
  state::SetGlobalArray(this->mem, str685, matches);
}
  ...
  switch (node->tag_()) {
    ...
    case bool_expr_e::Unary: {
      ...
      if (arg_type == bool_arg_type_e::Other) {
        ...
        e_die(fmt177(ui::PrettyId(op_id)));
      }
      throw new AssertionError();
    }
      break;
      ...
      if (arg_type == bool_arg_type_e::Str) {
        ...
        if (op_id == Id::BoolBinary_EqualTilde) {
          try {
            ...
            msg = e->message;
            e_die(fmt178(s2, msg, node->right), 2);
          }
          if (matches == nullptr) {
            return false;
          }
...
_BaseSplitter::_BaseSplitter(Str* escape_chars) {
  this->escape_chars = str_concat(escape_chars, str697);
}
    ...
    if (i < n) {
      ...
      if (str_contains(ws_chars, c)) {
        ...
        if (str_contains(other_chars, c)) {
          ...
          if (allow_escape and str_equals(c, str698)) {
...
Str* Utf8Encode(int code) {
  ...
  return str701->join(tmp);
}
Str* INCOMPLETE_CHAR = str702;
Str* INVALID_CONT = str703;
Str* INVALID_START = str704;
    ...
    if ((op->op_id == Id::VOp1_Pound || op->op_id == Id::VOp1_DPound)) {
      ...
      if ((op->op_id == Id::VOp1_Percent || op->op_id == Id::VOp1_DPercent)) {
        ...
        if (op->op_id == Id::VOp1_Comma) {
          if (!(str_equals(arg, str705))) {
            e_die(fmt179(ui::PrettyId(op->op_id)));
          }
          if (len(s)) {
          ...
          if (op->op_id == Id::VOp1_DComma) {
            if (!(str_equals(arg, str707))) {
              e_die(fmt180(ui::PrettyId(op->op_id)));
            }
            return s->lower();
          }
          else {
            if (op->op_id == Id::VOp1_Caret) {
              if (!(str_equals(arg, str709))) {
                e_die(fmt181(ui::PrettyId(op->op_id)));
              }
              if (len(s)) {
              ...
              if (op->op_id == Id::VOp1_DCaret) {
                if (!(str_equals(arg, str711))) {
                  e_die(fmt182(ui::PrettyId(op->op_id)));
                }
                return s->upper();
              }
              else {
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Slash) {
    try {
      ...
      msg = e->message;
      e_die(fmt184(regex, msg), this->slash_spid);
    }
  }
  if (op->replace_mode == Id::Lit_Pound) {
    regex = str_concat(str717, regex);
  }
  else {
    if (op->replace_mode == Id::Lit_Percent) {
      regex = str_concat(regex, str718);
    }
  }
...
Str* ShellQuoteB(Str* s) {
  s = s->replace(str719, str720)->replace(str721, str722);
  return util::BackslashEscape(s, str723);
}
...
void TdopParser::Eat(int token_type) {
  if (!this->AtToken(token_type)) {
    p_die(fmt188(ui::PrettyId(token_type), ui::PrettyId(this->op_id)), this->cur_word);
  }
  this->Next();
}
...
using runtime_asdl::scope_e;
List<Str*>* _STRING_AND_ARRAY = new List<Str*>({str731, str732, str733});
...
runtime_asdl::value_t* ResolveCompatArray(runtime_asdl::value_t* val) {
  ...
  if (val->tag_() == value_e::MaybeStrArray) {
    ...
    if (val->tag_() == value_e::AssocArray) {
      value__AssocArray* assoc_val = static_cast<value__AssocArray*>(val);
      s = dict_contains(assoc_val->d, str734) ? assoc_val->d->index(str735) : nullptr;
    }
    else {
      throw new AssertionError();
    }
...
Str* _BackslashEscape(Str* s) {
  return s->replace(str738, str739);
}
...
runtime_asdl::part_value_t* _ValueToPartValue(runtime_asdl::value_t* val, bool quoted) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      return new part_value::String(str740, quoted, !quoted);
    }
      break;
    case value_e::Str: {
      value__Str* val = static_cast<value__Str*>(UP_val);
      ...
      if ((op->op_id == Id::VTest_ColonEquals || op->op_id == Id::VTest_Equals)) {
        ...
        if ((op->op_id == Id::VTest_ColonQMark || op->op_id == Id::VTest_QMark)) {
          if (is_falsey) {
            ...
            e_die(fmt193(error_str), blame_token);
          }
          else {
            return false;
          }
      ...
      case value_e::Str: {
        ...
        try {
          ...
          if (this->exec_opts->strict_word_eval()) {
            ...
            this->errfmt->PrettyPrintError(e, str760);
            return new value::Str(str761);
          }
        }
      }
        break;
    ...
    if (op_id == Id::VSub_Bang) {
      ...
      switch (val->tag_()) {
        case value_e::Str: {
          ...
          if ((val->s == str762 || val->s == str763)) {
            return new value::MaybeStrArray(this->mem->GetArgv());
          }
          i = val->s->find(str764);
          if (i >= 0 and str_equals(val->s->index(-1), str765)) {
...
void AbstractWordEvaluator::_EvalDoubleQuoted(List<syntax_asdl::word_part_t*>* parts, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  if (len(parts) == 0) {
    v = new part_value::String(str767, true, false);
    part_vals->append(v);
    return ;
  }
...
runtime_asdl::value_t* AbstractWordEvaluator::_EmptyStrOrError(runtime_asdl::value_t* val, syntax_asdl::Token* token) {
  ...
  if (!this->exec_opts->nounset()) {
    return new value::Str(str768);
  }
  name = token->val->startswith(str769) ? token->val->slice(1) : token->val;
  e_die(fmt195(name), token);
}

runtime_asdl::value_t* AbstractWordEvaluator::_EmptyMaybeStrArrayOrError(syntax_asdl::Token* token) {
  if (this->exec_opts->nounset()) {
    e_die(fmt196(token->val), token);
  }
  else {
      ...
      case bracket_op_e::ArrayIndex: {
        ...
        switch (val->tag_()) {
          case value_e::Undef: {
            ...
            break;
          case value_e::Str: {
            e_die(fmt199(part->token->val), part->token);
          }
            break;
          case value_e::MaybeStrArray: {
    ...
    switch (suffix_op->tag_()) {
      case suffix_op_e::Nullary: {
        ...
        if (op_id == Id::VOp0_P) {
          ...
          p = prompt->replace(str776, str777)->replace(str778, str779);
          val = new value::Str(p);
        }
        else {
          if (op_id == Id::VOp0_Q) {
            ...
            if (op_id == Id::VOp0_a) {
              ...
              val = new value::Str(str785->join(chars));
            }
            else {
              e_die(fmt201(op->val), op);
            }
          }
        }
      }
      ...
      case suffix_op_e::Slice: {
        ...
        try {
          ...
          if (this->exec_opts->strict_word_eval()) {
            ...
            this->errfmt->PrettyPrintError(e, str788);
            switch (val->tag_()) {
              case value_e::Str: {
                val = new value::Str(str789);
              }
                break;
              case value_e::MaybeStrArray: {
  ...
  switch (part->tag_()) {
    ...
    case word_part_e::ExtGlob: {
      ...
      for (ListIter<syntax_asdl::word_t*> it(part->arms); !it.Done(); it.Next(), ++i) {
        syntax_asdl::word_t* w = it.Value();
        if (i != 0) {
          part_vals->append(new part_value::String(str796, false, false));
        }
        this->_EvalWordToParts(w, false, part_vals);
      }
      part_vals->append(new part_value::String(str797, false, false));
    }
      break;
...
void AbstractWordEvaluator::_EvalWordToParts(syntax_asdl::word_t* w, bool quoted, List<runtime_asdl::part_value_t*>* part_vals, bool is_subst) {
  ...
  switch (w->tag_()) {
    case word_e::Compound: {
      ...
      break;
    case word_e::Empty: {
      part_vals->append(new part_value::String(str799, quoted, !quoted));
    }
      break;
    default: {
      throw new AssertionError();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, runtime_asdl::quote_t quote_kind) {
  ...
  return new value::Str(str803->join(strs));
}
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalForPlugin(syntax_asdl::compound_word* w) {
  ...
  try {
    try {
      ...
      val = new value::Str(fmt208(e->UserErrorString()));
    }
    catch (OSError* e) {
      val = new value::Str(fmt209(pyutil::strerror_OS(e)));
    }
    catch (IOError* e) {
      val = new value::Str(fmt210(pyutil::strerror_IO(e)));
    }
    catch (KeyboardInterrupt*) {
      val = new value::Str(str807);
    }
  }
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index(-2), str814)) {
          e_die(fmt212(), w);
        }
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        if (arg->startswith(str816) or arg->startswith(str817)) {
          flags->append(arg);
          flag_spids->append(word_spid);
          if (str_contains(arg, str818) or str_contains(arg, str819)) {
            eval_to_pairs = false;
          }
        }
        else {
...
syntax_asdl::suffix_op__PatSub* WordParser::_ReadPatSubVarOp() {
  ...
  if (len(pat->parts) == 1) {
    ...
    s = tup0.at1();
    quoted = tup0.at2();
    if (ok and str_equals(s, str826) and !quoted) {
  ...
  if (this->token_type == Id::Lit_Slash) {
    ...
    this->_Peek();
    if (this->token_type != Id::Right_DollarBrace) {
      p_die(fmt216(ui::PrettyId(this->token_type)), this->cur_token);
    }
    return new suffix_op::PatSub(pat, replace, replace_mode);
  }
  p_die(fmt217(), this->cur_token);
}
        ...
        if (op_kind == Kind::VOp2) {
          if (this->token_type == Id::VOp2_Slash) {
            ...
            if (this->token_type == Id::VOp2_Colon) {
              ...
              if (this->token_type != Id::Arith_RBrace) {
                p_die(fmt221(), this->cur_token);
              }
            }
            else {
              p_die(fmt222(str835), this->cur_token);
            }
          }
        }
        else {
          if (op_kind == Kind::VOp3) {
            if (allow_query) {
              ...
              p_die(fmt223(str837), this->cur_token);
            }
          }
        }
      }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool no_backslashes) {
  ...
  while (!done) {
    ...
    if ((this->token_kind == Kind::Lit || this->token_kind == Kind::Char)) {
      tok = this->cur_token;
      if (no_backslashes and str_contains(tok->val, str841)) {
        p_die(fmt227(), tok);
      }
      tokens->append(tok);
    }
...
void WordParser::ParseProc(syntax_asdl::command__Proc* node) {
  ...
  if (this->token_type != Id::Lit_Chars) {
    p_die(fmt232(ui::PrettyToken(this->cur_token, this->arena)), this->cur_token);
  }
...
Tuple2<syntax_asdl::word_t*, bool> WordParser::_ReadArithWord() {
  ...
  if (this->token_kind == Kind::Unknown) {
    p_die(fmt244(this->cur_token->val), this->cur_token);
  }
  else {
    if (this->token_kind == Kind::Eof) {
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str863, false));
    }
      break;
    case word_part_e::AssocArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str864, false));
    }
      break;
    case word_part_e::Literal: {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str866, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str867->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
    ...
    case word_part_e::ExtGlob: 
    case word_part_e::Splice: {
      return (Tuple3<bool, Str*, bool>(false, str868, false));
    }
      break;
    default: {
      throw new AssertionError();
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() != word_e::Compound) {
    return (Tuple3<bool, Str*, bool>(false, str869, quoted));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  strs = new List<Str*>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str870, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str871->join(strs), quoted));
}
...
Str* escape(Str* s) {
  s = s->replace(str883, str884);
  s = s->replace(str885, str886);
  s = s->replace(str887, str888);
  return s;
}
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if (str_contains(str889, ch) or IsUnprintableLow(ch)) {
        quote = 2;
        break;
      }
    }
  ...
  parts->append(str892);
  return str_concat(prefix, str893->join(parts));
}
...
void _encode_bytes_x(Str* s, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    Str* byte = it.Value();
    if (str_equals(byte, str900)) {
      part = str901;
    }
    else {
      if (str_equals(byte, str902)) {
        part = str903;
      }
      else {
        if (str_equals(byte, str904)) {
          part = str905;
        }
        else {
          if (str_equals(byte, str906)) {
            part = str907;
          }
          else {
            if (str_equals(byte, str908)) {
              part = str909;
            }
            else {
              if (str_equals(byte, str910)) {
                part = shell_compat ? str911 : str912;
              }
              else {
...
bool _encode_runes(Str* s, int bit8_display, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (typ == Ascii) {
      state = Start;
      if (str_equals(byte, str916)) {
        out = str917;
      }
      else {
        if (str_equals(byte, str918)) {
          out = str919;
        }
        else {
          if (str_equals(byte, str920)) {
            out = str921;
          }
          else {
            if (str_equals(byte, str922)) {
              out = str923;
            }
            else {
              if (str_equals(byte, str924)) {
                out = str925;
              }
              else {
                if (str_equals(byte, str926)) {
                  out = shell_compat ? str927 : str928;
                }
                else {
                  if (IsUnprintableLow(byte)) {
...
syntax_asdl::word__String* _StringWordEmitter::ReadWord(types_asdl::lex_mode_t unused_lex_mode) {
  ...
  if (this->i == this->n) {
    w = new word::String(Id::Eof_Real, str929, runtime::NO_SPID);
    return w;
  }
...
syntax_asdl::bool_expr_t* _ThreeArgs(builtin_bracket::_StringWordEmitter* w_parser) {
  ...
  if (w0->s == str935 and w2->s == str936) {
    return new bool_expr::WordTest(w1);
  }
  p_die(fmt246(w1->s), w1);
}
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    strs = cmd_val->argv;
    if (!strs or !(str_equals(strs->index(-1), str938))) {
      this->errfmt->Print_(str939, cmd_val->arg_spids->index(0));
      return 2;
    }
    cmd_val->argv->pop();
  ...
  try {
    ...
    if (n == 4) {
      a0 = w_parser->Peek(0);
      if (str_equals(a0, str940)) {
        w_parser->Read();
        child = _ThreeArgs(w_parser);
        bool_node = new bool_expr::LogicalNot(child);
      }
      else {
        if (str_equals(a0, str941) and str_equals(w_parser->Peek(3), str942)) {
          w_parser->Read();
          bool_node = _TwoArgs(w_parser);
        }
        else {
    ...
    this->errfmt->PrettyPrintError(e, str943);
    return 2;
  }
  ...
  try {
    ...
    this->errfmt->PrettyPrintError(e, str944);
    return 2;
  }
  status = b ? 0 : 1;
  return status;

...
const char* action_str(int tag) {
  ...
  case action_e::SetToTrue:
    return "action.SetToTrue";
  case action_e::SetOption:
    return "action.SetOption";
  case action_e::SetNamedOption:
    return "action.SetNamedOption";
  case action_e::SetAction:
    return "action.SetAction";
  case action_e::SetNamedAction:
    return "action.SetNamedAction";
  default:
    assert(0);
  }
}
...
hnode_t* action__SetToTrue::PrettyTree() {
  hnode__Record* out_node = runtime::NewRecord(new Str("action.SetToTrue"));
  List<field*>* L = out_node->fields;
    hnode_t* x0 = runtime::NewLeaf(this->name, color_e::StringConst);
    L->append(new field(new Str("name"), x0));
...
hnode_t* action__SetToTrue::_AbbreviatedTree() {
  hnode__Record* out_node = runtime::NewRecord(new Str("action.SetToTrue"));
  List<field*>* L = out_node->fields;
    hnode_t* x0 = runtime::NewLeaf(this->name, color_e::StringConst);
    L->append(new field(new Str("name"), x0));
...
hnode_t* action__SetToTrue::AbbreviatedTree() {
  return _AbbreviatedTree();
}

hnode_t* action__SetOption::PrettyTree() {
  hnode__Record* out_node = runtime::NewRecord(new Str("action.SetOption"));
  List<field*>* L = out_node->fields;
    hnode_t* x0 = runtime::NewLeaf(this->name, color_e::StringConst);
    L->append(new field(new Str("name"), x0));
...
hnode_t* action__SetOption::_AbbreviatedTree() {
  hnode__Record* out_node = runtime::NewRecord(new Str("action.SetOption"));
  List<field*>* L = out_node->fields;
    hnode_t* x0 = runtime::NewLeaf(this->name, color_e::StringConst);
    L->append(new field(new Str("name"), x0));
...
hnode_t* action__SetOption::AbbreviatedTree() {
  return _AbbreviatedTree();
}

hnode_t* action__SetNamedOption::PrettyTree() {
  hnode__Record* out_node = runtime::NewRecord(new
                                               Str("action.SetNamedOption"));
  return out_node;
}

hnode_t* action__SetNamedOption::_AbbreviatedTree() {
  hnode__Record* out_node = runtime::NewRecord(new
                                               Str("action.SetNamedOption"));
  return out_node;
}

hnode_t* action__SetNamedOption::AbbreviatedTree() {
  return _AbbreviatedTree();
}

hnode_t* action__SetAction::PrettyTree() {
  hnode__Record* out_node = runtime::NewRecord(new Str("action.SetAction"));
  List<field*>* L = out_node->fields;
    hnode_t* x0 = runtime::NewLeaf(this->name, color_e::StringConst);
    L->append(new field(new Str("name"), x0));
...
hnode_t* action__SetAction::_AbbreviatedTree() {
  hnode__Record* out_node = runtime::NewRecord(new Str("action.SetAction"));
  List<field*>* L = out_node->fields;
    hnode_t* x0 = runtime::NewLeaf(this->name, color_e::StringConst);
    L->append(new field(new Str("name"), x0));
...
hnode_t* action__SetAction::AbbreviatedTree() {
  return _AbbreviatedTree();
}

hnode_t* action__SetNamedAction::PrettyTree() {
  hnode__Record* out_node = runtime::NewRecord(new
                                               Str("action.SetNamedAction"));
  return out_node;
}

hnode_t* action__SetNamedAction::_AbbreviatedTree() {
  hnode__Record* out_node = runtime::NewRecord(new
                                               Str("action.SetNamedAction"));
  return out_node;
}

hnode_t* action__SetNamedAction::AbbreviatedTree() {
  return _AbbreviatedTree();
}
...
hnode_t* action_t::PrettyTree() {
  ...
  case action_e::SetToTrue: {
    action__SetToTrue* obj = static_cast<action__SetToTrue*>(this);
    return obj->PrettyTree();
  }
  case action_e::SetOption: {
    action__SetOption* obj = static_cast<action__SetOption*>(this);
    return obj->PrettyTree();
  }
  case action_e::SetNamedOption: {
    action__SetNamedOption* obj = static_cast<action__SetNamedOption*>(this);
    return obj->PrettyTree();
  }
  case action_e::SetAction: {
    action__SetAction* obj = static_cast<action__SetAction*>(this);
    return obj->PrettyTree();
  }
  case action_e::SetNamedAction: {
    action__SetNamedAction* obj = static_cast<action__SetNamedAction*>(this);
    return obj->PrettyTree();
  }
  default:
    assert(0);
...
hnode_t* FlagSpecAndMore_::PrettyTree() {
  hnode__Record* out_node = runtime::NewRecord(new Str("FlagSpecAndMore_"));
  List<field*>* L = out_node->fields;
    if (this->actions_short) {
      auto m = new hnode__Leaf(new Str("map"), color_e::OtherConst);
      hnode__Array* x0 = new hnode__Array(new List<hnode_t*>({m}));
      for (DictIter<Str*, action_t*> it(this->actions_short); !it.Done();
           it.Next()) {
        auto k0 = it.Key();
        auto v0 = it.Value();
        x0->children->append(runtime::NewLeaf(k0, color_e::StringConst));
      ...
      L->append(new field(new Str ("actions_short"), x0));
    }

    if (this->actions_long) {
      auto m = new hnode__Leaf(new Str("map"), color_e::OtherConst);
      hnode__Array* x1 = new hnode__Array(new List<hnode_t*>({m}));
      for (DictIter<Str*, action_t*> it(this->actions_long); !it.Done();
           it.Next()) {
        auto k1 = it.Key();
        auto v1 = it.Value();
        x1->children->append(runtime::NewLeaf(k1, color_e::StringConst));
      ...
      L->append(new field(new Str ("actions_long"), x1));
    }

    if (this->defaults) {
      auto m = new hnode__Leaf(new Str("map"), color_e::OtherConst);
      hnode__Array* x2 = new hnode__Array(new List<hnode_t*>({m}));
      for (DictIter<Str*, value_t*> it(this->defaults); !it.Done(); it.Next()) {
        auto k2 = it.Key();
        auto v2 = it.Value();
        x2->children->append(runtime::NewLeaf(k2, color_e::StringConst));
        x2->children->append(v2->PrettyTree());
      }
      L->append(new field(new Str ("defaults"), x2));
    }

  return out_node;
}

hnode_t* FlagSpecAndMore_::_AbbreviatedTree() {
  hnode__Record* out_node = runtime::NewRecord(new Str("FlagSpecAndMore_"));
  List<field*>* L = out_node->fields;
    if (this->actions_short) {
      auto m = new hnode__Leaf(new Str("map"), color_e::OtherConst);
    ...
    if (this->defaults) {
      ...
      for (DictIter<Str*, value_t*> it(this->defaults); !it.Done(); it.Next()) {
        ...
        auto v2 = it.Value();
        x2->children->append(runtime::NewLeaf(k2, color_e::StringConst));
        x2->children->append(v2->AbbreviatedTree());
      }
      L->append(new field(new Str ("defaults"), x2));
    }
...
hnode_t* FlagSpecAndMore_::AbbreviatedTree() {
  return _AbbreviatedTree();
}

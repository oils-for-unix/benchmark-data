...
const char* debug_frame_str(int tag) {
  ...
  case debug_frame_e::Main:
    return "debug_frame.Main";
  case debug_frame_e::Source:
    return "debug_frame.Source";
  case debug_frame_e::Call:
    return "debug_frame.Call";
  default:
    assert(0);
  }
}
...
hnode_t* debug_frame__Main::PrettyTree() {
  hnode::Record* out_node = runtime::NewRecord(StrFromC("debug_frame.Main"));
  List<Field*>* L = out_node->fields;
...
hnode_t* debug_frame__Source::PrettyTree() {
  hnode::Record* out_node = runtime::NewRecord(StrFromC("debug_frame.Source"));
  List<Field*>* L = out_node->fields;
...
hnode_t* debug_frame__Call::PrettyTree() {
  hnode::Record* out_node = runtime::NewRecord(StrFromC("debug_frame.Call"));
  List<Field*>* L = out_node->fields;
...
hnode_t* command__Func::PrettyTree() {
  ...
  if (this->rest_of_pos) {  // Optional
    hnode_t* x3 = this->rest_of_pos->PrettyTree();
    L->append(Alloc<Field>(StrFromC("rest_of_pos"), x3));
  }
  ...
  if (this->rest_of_named) {  // Optional
    hnode_t* x5 = this->rest_of_named->PrettyTree();
    L->append(Alloc<Field>(StrFromC("rest_of_named"), x5));
  }
...
hnode_t* command__TeaFunc::PrettyTree() {
  ...
  if (this->return_types != nullptr) {  // List
    hnode::Array* x5 = Alloc<hnode::Array>(Alloc<List<hnode_t*>>());
    for (ListIter<TypeExpr*> it(this->return_types); !it.Done(); it.Next()) {
      TypeExpr* i5 = it.Value();
      x5->children->append(i5->PrettyTree());
    }
...
GcGlobal<class_item__Method> gclass_item__Method = 
  { ObjHeader::Global(class_item_e::Method) };
...
hnode_t* proc_sig__Closed::PrettyTree() {
  ...
  if (this->word_params != nullptr) {  // List
    hnode::Array* x0 = Alloc<hnode::Array>(Alloc<List<hnode_t*>>());
    for (ListIter<Param*> it(this->word_params); !it.Done(); it.Next()) {
      Param* i0 = it.Value();
      x0->children->append(i0->PrettyTree());
    }
    L->append(Alloc<Field>(StrFromC("word_params"), x0));
  }

  if (this->rest_of_words) {  // Optional
    hnode_t* x1 = this->rest_of_words->PrettyTree();
    L->append(Alloc<Field>(StrFromC("rest_of_words"), x1));
  }
  ...
  if (this->block_param) {  // Optional
    hnode_t* x6 = this->block_param->PrettyTree();
    L->append(Alloc<Field>(StrFromC("block_param"), x6));
  }

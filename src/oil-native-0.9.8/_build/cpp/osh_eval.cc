...
GLOBAL_STR(str136, "");
GLOBAL_STR(str137, "\n");
GLOBAL_STR(str138, "/dev/fd/%d");
GLOBAL_STR(str139, "/dev/fd/%d");
GLOBAL_STR(str140, "");
GLOBAL_STR(str141, "main");
GLOBAL_STR(str142, "osh usage error: %s");
GLOBAL_STR(str143, "%s-usage");
GLOBAL_STR(str144, "Oil");
GLOBAL_STR(str145, "main");
GLOBAL_STR(str146, "oil");
GLOBAL_STR(str147, "oil:all");
GLOBAL_STR(str148, "--one-pass-parse requires noexec (-n)");
GLOBAL_STR(str149, "completion");
GLOBAL_STR(str150, "history");
GLOBAL_STR(str151, "");
GLOBAL_STR(str152, "OSH_DEBUG_DIR");
GLOBAL_STR(str153, "%d-osh.log");
GLOBAL_STR(str154, "Writing logs to %r");
GLOBAL_STR(str155, "OSH_HIJACK_SHEBANG");
GLOBAL_STR(str156, "");
GLOBAL_STR(str157, "OSH_CRASH_DUMP_DIR");
GLOBAL_STR(str158, "");
GLOBAL_STR(str159, "");
GLOBAL_STR(str160, "osh: Couldn't open %r: %s");
GLOBAL_STR(str161, "/proc/%d/status");
GLOBAL_STR(str162, "--parser-mem-dump can only be used with -n");
GLOBAL_STR(str163, "/proc/%d/status");
GLOBAL_STR(str164, "Can't run a proc while errexit is disabled. Use 'try' or wrap it in a process with $0 myproc");
GLOBAL_STR(str165, "Unhandled SimpleCommand");
GLOBAL_STR(str166, "\n");
GLOBAL_STR(str167, "<_FdFrame %s>");
GLOBAL_STR(str168, "r");
GLOBAL_STR(str169, "%d: %s");
GLOBAL_STR(str170, "%d: %s");
GLOBAL_STR(str171, "%d: %s");
GLOBAL_STR(str172, "Can't open %r: %s");
GLOBAL_STR(str173, "Error closing descriptor %d: %s");
GLOBAL_STR(str174, "dup2(%d, %d) error: %s");
GLOBAL_STR(str175, "<StdinFromPipe %d %d>");
GLOBAL_STR(str176, "<StdoutToPipe %d %d>");
GLOBAL_STR(str177, "/bin/sh");
GLOBAL_STR(str178, "/bin/sh");
GLOBAL_STR(str179, "Can't execute %r: %s");
GLOBAL_STR(str180, "[process] %s");
GLOBAL_STR(str181, " ");
GLOBAL_STR(str182, "[subprog] %s");
GLOBAL_STR(str183, "");
GLOBAL_STR(str184, "osh I/O error: %s");
GLOBAL_STR(str185, "[here doc writer]");
GLOBAL_STR(str186, "<Process %s %s>");
GLOBAL_STR(str187, "  ");
GLOBAL_STR(str188, "%%%d");
GLOBAL_STR(str189, "%s %d %7s ");
GLOBAL_STR(str190, "\n");
GLOBAL_STR(str191, "Fatal error in posix.fork()");
GLOBAL_STR(str192, "%%%d");
GLOBAL_STR(str193, "  ");
GLOBAL_STR(str194, "%s %d %7s ");
GLOBAL_STR(str195, "\n");
GLOBAL_STR(str196, "Pipeline in state %s");
GLOBAL_STR(str197, "\n");
GLOBAL_STR(str198, "[process debug info]\n");
GLOBAL_STR(str199, "\n");
GLOBAL_STR(str200, "[pipeline debug info]\n");
GLOBAL_STR(str201, "osh: PID %d stopped, but osh didn't start it");
GLOBAL_STR(str202, "");
GLOBAL_STR(str203, "");
GLOBAL_STR(str204, "[PID %d] Stopped");
GLOBAL_STR(str205, "");
GLOBAL_STR(str206, "main");
GLOBAL_STR(str207, "osh usage error: %s");
GLOBAL_STR(str208, "%s-usage");
GLOBAL_STR(str209, "Oil");
GLOBAL_STR(str210, "main");
GLOBAL_STR(str211, "oil");
GLOBAL_STR(str212, "oil:all");
GLOBAL_STR(str213, "--one-pass-parse requires noexec (-n)");
GLOBAL_STR(str214, "completion");
GLOBAL_STR(str215, "history");
GLOBAL_STR(str216, "");
GLOBAL_STR(str217, "OSH_DEBUG_DIR");
GLOBAL_STR(str218, "%d-osh.log");
GLOBAL_STR(str219, "Writing logs to %r");
GLOBAL_STR(str220, "OSH_HIJACK_SHEBANG");
GLOBAL_STR(str221, "");
GLOBAL_STR(str222, "OSH_CRASH_DUMP_DIR");
GLOBAL_STR(str223, "");
GLOBAL_STR(str224, "");
GLOBAL_STR(str225, "osh: Couldn't open %r: %s");
GLOBAL_STR(str226, "/proc/%d/status");
GLOBAL_STR(str227, "--parser-mem-dump can only be used with -n");
GLOBAL_STR(str228, "/proc/%d/status");
GLOBAL_STR(str229, " \t\n\"'><=;|&(:");
GLOBAL_STR(str230, "/");
GLOBAL_STR(str231, "PATH");
GLOBAL_STR(str232, ":");
GLOBAL_STR(str233, "got invalid option %r");
GLOBAL_STR(str234, "got invalid option %r");
GLOBAL_STR(str235, "invalid option %r (try -O or shopt)");
GLOBAL_STR(str236, "SHELLOPTS");
GLOBAL_STR(str237, ":");
GLOBAL_STR(str238, "Syntax options must be set at the top level (outside any function)");
GLOBAL_STR(str239, "Warning: set -o verbose not implemented");
GLOBAL_STR(str240, "SHELLOPTS");
GLOBAL_STR(str241, "%s:%s");
GLOBAL_STR(str242, "SHELLOPTS");
GLOBAL_STR(str243, ":");
GLOBAL_STR(str244, ":");
GLOBAL_STR(str245, "SHELLOPTS");
GLOBAL_STR(str246, "oil:basic");
GLOBAL_STR(str247, "oil:all");
GLOBAL_STR(str248, "strict:all");
GLOBAL_STR(str249, "set %so %s");
GLOBAL_STR(str250, "-");
GLOBAL_STR(str251, "+");
GLOBAL_STR(str252, "oil:basic");
GLOBAL_STR(str253, "oil:all");
GLOBAL_STR(str254, "strict:all");
GLOBAL_STR(str255, "got invalid option %r");
GLOBAL_STR(str256, "shopt -%s %s");
GLOBAL_STR(str257, "s");
GLOBAL_STR(str258, "u");
GLOBAL_STR(str259, "<_ArgFrame %s %d at %x>");
GLOBAL_STR(str260, "Can't determine working directory: %s");
GLOBAL_STR(str261, "IFS");
GLOBAL_STR(str262, "UID");
GLOBAL_STR(str263, "EUID");
GLOBAL_STR(str264, "PPID");
GLOBAL_STR(str265, "HOSTNAME");
GLOBAL_STR(str266, "OSTYPE");
GLOBAL_STR(str267, "OPTIND");
GLOBAL_STR(str268, "1");
GLOBAL_STR(str269, "PS4");
GLOBAL_STR(str270, "${SHX_indent}${SHX_punct}${SHX_pid_str} ");
GLOBAL_STR(str271, "COMP_WORDBREAKS");
GLOBAL_STR(str272, "SHELLOPTS");
GLOBAL_STR(str273, "SHELLOPTS");
GLOBAL_STR(str274, "");
GLOBAL_STR(str275, "SHELLOPTS");
GLOBAL_STR(str276, "PWD");
GLOBAL_STR(str277, "PWD");
GLOBAL_STR(str278, "PWD");
GLOBAL_STR(str279, "PATH");
GLOBAL_STR(str280, "PATH");
GLOBAL_STR(str281, "/bin:/usr/bin");
GLOBAL_STR(str282, "OIL_VERSION");
GLOBAL_STR(str283, "PWD");
GLOBAL_STR(str284, "PS1");
GLOBAL_STR(str285, "PS1");
GLOBAL_STR(str286, "\\s-\\v\\$ ");
GLOBAL_STR(str287, "");
GLOBAL_STR(str288, "<Mem");
GLOBAL_STR(str289, "  -- %d --");
GLOBAL_STR(str290, "  %s %s");
GLOBAL_STR(str291, ">");
GLOBAL_STR(str292, "\n");
GLOBAL_STR(str293, "\n");
GLOBAL_STR(str294, "Warning: span_id undefined in SetCurrentSpanId");
GLOBAL_STR(str295, "setref requires a nameref (:out param)");
GLOBAL_STR(str296, "nameref %r is undefined");
GLOBAL_STR(str297, "nameref %r contains invalid variable name %r");
GLOBAL_STR(str298, "Circular nameref %s");
GLOBAL_STR(str299, " -> ");
GLOBAL_STR(str300, "__");
GLOBAL_STR(str301, "Can't assign to readonly value %r");
GLOBAL_STR(str302, "Only strings can be exported");
GLOBAL_STR(str303, "nameref must be a string");
GLOBAL_STR(str304, "Can't assign to readonly array");
GLOBAL_STR(str305, "Can't assign to items in a string");
GLOBAL_STR(str306, "Value of type %s can't be indexed");
GLOBAL_STR(str307, "Can't assign to readonly associative array");
GLOBAL_STR(str308, "ARGV");
GLOBAL_STR(str309, "_status");
GLOBAL_STR(str310, "_this_dir");
GLOBAL_STR(str311, "PIPESTATUS");
GLOBAL_STR(str312, "_pipeline_status");
GLOBAL_STR(str313, "_process_sub_status");
GLOBAL_STR(str314, "BASH_REMATCH");
GLOBAL_STR(str315, "FUNCNAME");
GLOBAL_STR(str316, "source");
GLOBAL_STR(str317, "BASH_SOURCE");
GLOBAL_STR(str318, "BASH_LINENO");
GLOBAL_STR(str319, "0");
GLOBAL_STR(str320, "LINENO");
GLOBAL_STR(str321, "BASHPID");
GLOBAL_STR(str322, "Can't unset readonly variable %r");
GLOBAL_STR(str323, "%r isn't an array");
GLOBAL_STR(str324, "$%s isn't defined");
GLOBAL_STR(str325, "$%s should be a string");
GLOBAL_STR(str326, "$%s should be a string, got %s");
GLOBAL_STR(str327, "$%s doesn't look like an integer, got %r");
GLOBAL_STR(str328, "EOF");
GLOBAL_STR(str329, "/");
GLOBAL_STR(str330, "~");
GLOBAL_STR(str331, "  ");
GLOBAL_STR(str332, "\n  ");
...
GLOBAL_STR(str337, "~");
GLOBAL_STR(str338, "\n");
GLOBAL_STR(str339, "[ interactive ]");
GLOBAL_STR(str340, "[ headless ]");
GLOBAL_STR(str341, "[ -c flag ]");
GLOBAL_STR(str342, "[ stdin%s ]");
GLOBAL_STR(str343, "[ %s word at ? ]");
GLOBAL_STR(str344, "[ %s word at line %d of %s ]");
GLOBAL_STR(str345, "?");
GLOBAL_STR(str346, "?");
GLOBAL_STR(str347, "line %d of %s");
GLOBAL_STR(str348, "[ var %s at %s ]");
GLOBAL_STR(str349, "[ expansion of alias %r ]");
GLOBAL_STR(str350, "[ %s in %s ]");
GLOBAL_STR(str351, "[??? no location ???] %s%s\n");
GLOBAL_STR(str352, "%s:%d: %s%s\n");
GLOBAL_STR(str353, "");
GLOBAL_STR(str354, "");
GLOBAL_STR(str355, "");
GLOBAL_STR(str356, "errexit PID %d: ");
GLOBAL_STR(str357, "none");
GLOBAL_STR(str358, "AST not printed.");
GLOBAL_STR(str359, "text");
GLOBAL_STR(str360, "abbrev-text");
GLOBAL_STR(str361, "html");
GLOBAL_STR(str362, "abbrev-html");
GLOBAL_STR(str363, "abbrev-");
GLOBAL_STR(str364, "\n");
GLOBAL_STR(str365, "\n");
GLOBAL_STR(str366, "-");
GLOBAL_STR(str367, "_");
GLOBAL_STR(str368, "<_Attributes %s>");
GLOBAL_STR(str369, "<args.Reader %r %d>");
GLOBAL_STR(str370, "expected argument to %r");
GLOBAL_STR(str371, "-");
GLOBAL_STR(str372, "expected integer after %s, got %r");
GLOBAL_STR(str373, "-");
GLOBAL_STR(str374, "got invalid integer for %s: %s");
GLOBAL_STR(str375, "-");
GLOBAL_STR(str376, "expected number after %r, got %r");
GLOBAL_STR(str377, "-");
GLOBAL_STR(str378, "got invalid float for %s: %s");
GLOBAL_STR(str379, "-");
GLOBAL_STR(str380, "got invalid argument %r to %r, expected one of: %s");
GLOBAL_STR(str381, "-");
GLOBAL_STR(str382, "|");
GLOBAL_STR(str383, "0");
GLOBAL_STR(str384, "F");
GLOBAL_STR(str385, "false");
GLOBAL_STR(str386, "False");
GLOBAL_STR(str387, "1");
GLOBAL_STR(str388, "T");
GLOBAL_STR(str389, "true");
GLOBAL_STR(str390, "Talse");
GLOBAL_STR(str391, "got invalid argument to boolean flag: %r");
GLOBAL_STR(str392, "-");
GLOBAL_STR(str393, "-");
GLOBAL_STR(str394, "Invalid option %r");
GLOBAL_STR(str395, "Expected argument for action");
GLOBAL_STR(str396, "Invalid action name %r");
GLOBAL_STR(str397, "--");
GLOBAL_STR(str398, "--");
GLOBAL_STR(str399, "=");
GLOBAL_STR(str400, "got invalid flag %r");
GLOBAL_STR(str401, "-");
GLOBAL_STR(str402, "0");
GLOBAL_STR(str403, "Z");
GLOBAL_STR(str404, "-");
GLOBAL_STR(str405, "doesn't accept flag %s");
GLOBAL_STR(str406, "-");
GLOBAL_STR(str407, "+");
GLOBAL_STR(str408, "+");
GLOBAL_STR(str409, "doesn't accept option %s");
GLOBAL_STR(str410, "+");
GLOBAL_STR(str411, "-");
GLOBAL_STR(str412, "--");
GLOBAL_STR(str413, "--");
GLOBAL_STR(str414, "got invalid flag %r");
GLOBAL_STR(str415, "-");
GLOBAL_STR(str416, "+");
GLOBAL_STR(str417, "got invalid flag %r");
GLOBAL_STR(str418, "-");
GLOBAL_STR(str419, "<LineLexer at pos %d of line %r (id = %d)>");
GLOBAL_STR(str420, "");
GLOBAL_STR(str421, "");
GLOBAL_STR(str422, "");
GLOBAL_STR(str423, "");
GLOBAL_STR(str424, "<Trail %s %s %s %s>");
GLOBAL_STR(str425, "");
GLOBAL_STR(str426, "Here docs aren't allowed in expressions");
GLOBAL_STR(str427, "\n");
GLOBAL_STR(str428, "Expected an expression");
GLOBAL_STR(str429, "Expected an expression");
GLOBAL_STR(str430, "Too many typed args (expected one expression)");
GLOBAL_STR(str431, "Expected block argument");
GLOBAL_STR(str432, "Too many typed args (expected one block)");
GLOBAL_STR(str433, "Use === to be exact, or ~== to convert types");
GLOBAL_STR(str434, "");
GLOBAL_STR(str435, " (%s)");
GLOBAL_STR(str436, "Unexpected token in expression mode%s");
GLOBAL_STR(str437, "Syntax error in expression (near %s)");
GLOBAL_STR(str438, "alnum");
GLOBAL_STR(str439, "cntrl");
GLOBAL_STR(str440, "lower");
GLOBAL_STR(str441, "space");
GLOBAL_STR(str442, "alpha");
GLOBAL_STR(str443, "digit");
GLOBAL_STR(str444, "print");
GLOBAL_STR(str445, "upper");
GLOBAL_STR(str446, "blank");
GLOBAL_STR(str447, "graph");
GLOBAL_STR(str448, "punct");
GLOBAL_STR(str449, "xdigit");
GLOBAL_STR(str450, "Range start/end shouldn't have more than one character");
GLOBAL_STR(str451, "Write singleton tuples with tup(), not a trailing comma");
GLOBAL_STR(str452, "testlist_comp");
GLOBAL_STR(str453, "obj.field isn't valid, but obj.method() is");
GLOBAL_STR(str454, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str455, "Can't assign to this expression");
GLOBAL_STR(str456, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str457, "Expr");
GLOBAL_STR(str458, "Block");
GLOBAL_STR(str459, "proc param types should be Expr or Block");
GLOBAL_STR(str460, "TODO");
GLOBAL_STR(str461, "dot");
GLOBAL_STR(str462, "Can't negate this symbol");
GLOBAL_STR(str463, "%r isn't a character class");
GLOBAL_STR(str464, "Can't negate this symbol");
GLOBAL_STR(str465, "%r isn't a character class");
GLOBAL_STR(str466, "%start");
GLOBAL_STR(str467, "%end");
GLOBAL_STR(str468, "dot");
GLOBAL_STR(str469, "Unexpected token %r in regex");
GLOBAL_STR(str470, "%s-%s");
GLOBAL_STR(str471, "ERE can't express code point %d");
GLOBAL_STR(str472, "Perl classes can't be negated in ERE");
GLOBAL_STR(str473, "%s");
GLOBAL_STR(str474, "POSIX classes can't be negated in ERE");
GLOBAL_STR(str475, "[:%s:]");
GLOBAL_STR(str476, ".");
GLOBAL_STR(str477, "^");
GLOBAL_STR(str478, "$");
GLOBAL_STR(str479, "|");
GLOBAL_STR(str480, "POSIX EREs don't have groups without capture, so this node needs () around it.");
GLOBAL_STR(str481, "+");
GLOBAL_STR(str482, "*");
GLOBAL_STR(str483, "?");
GLOBAL_STR(str484, "{%s}");
...
GLOBAL_STR(str495, "^");
GLOBAL_STR(str496, "]");
GLOBAL_STR(str497, "The [ operator doesn't apply to this expression");
GLOBAL_STR(str498, "Expected ]]");
GLOBAL_STR(str499, "Unexpected trailing word %s");
GLOBAL_STR(str500, "Invalid argument to unary operator");
GLOBAL_STR(str501, "Expected ), got %s");
GLOBAL_STR(str502, "Unexpected token in boolean expression (%s)");
GLOBAL_STR(str503, "");
GLOBAL_STR(str504, "Expected %d, got %d");
GLOBAL_STR(str505, "Step can't be 0");
GLOBAL_STR(str506, "Invalid step %d for ascending integer range");
GLOBAL_STR(str507, "Invalid step %d for descending integer range");
GLOBAL_STR(str508, "Invalid step %d for ascending character range");
GLOBAL_STR(str509, "Invalid step %d for descending character range");
GLOBAL_STR(str510, "Mismatched cases in character range");
GLOBAL_STR(str511, "");
GLOBAL_STR(str512, "0");
GLOBAL_STR(str513, "0");
GLOBAL_STR(str514, "g");
...
GLOBAL_STR(str551, ")");
GLOBAL_STR(str552, "");
GLOBAL_STR(str553, "export_");
GLOBAL_STR(str554, "doesn't accept -f because it's dangerous.  (The code can usually be restructured with 'source')");
GLOBAL_STR(str555, "doesn't accept RHS with -n");
GLOBAL_STR(str556, "Got -a but RHS isn't an array");
GLOBAL_STR(str557, "Got -A but RHS isn't an associative array");
GLOBAL_STR(str558, "readonly");
GLOBAL_STR(str559, "new_var");
GLOBAL_STR(str560, "with -f expects function names");
GLOBAL_STR(str561, "declare -f %s");
GLOBAL_STR(str562, "-");
GLOBAL_STR(str563, "-");
GLOBAL_STR(str564, "-");
GLOBAL_STR(str565, "+");
GLOBAL_STR(str566, "+");
GLOBAL_STR(str567, "+");
GLOBAL_STR(str568, "unset");
GLOBAL_STR(str569, "Invalid shift argument %r");
GLOBAL_STR(str570, "got too many arguments");
GLOBAL_STR(str571, "eval");
GLOBAL_STR(str572, "requires code string");
GLOBAL_STR(str573, "requires exactly 1 argument");
GLOBAL_STR(str574, " ");
GLOBAL_STR(str575, "eval");
GLOBAL_STR(str576, "eval");
GLOBAL_STR(str577, "source");
GLOBAL_STR(str578, "missing required argument");
GLOBAL_STR(str579, "source %r failed: %s");
GLOBAL_STR(str580, "source");
GLOBAL_STR(str581, "command");
GLOBAL_STR(str582, "Can't run assignment builtin recursively");
GLOBAL_STR(str583, "%r isn't a shell builtin");
GLOBAL_STR(str584, "runproc");
GLOBAL_STR(str585, "requires arguments");
GLOBAL_STR(str586, "runproc: no proc named %r");
GLOBAL_STR(str587, "try_");
GLOBAL_STR(str588, "'try' expected a command to run");
GLOBAL_STR(str589, "(original failure)");
GLOBAL_STR(str590, "");
GLOBAL_STR(str591, "status %d when --allow-status-01");
GLOBAL_STR(str592, ":");
GLOBAL_STR(str593, "function");
GLOBAL_STR(str594, "alias");
GLOBAL_STR(str595, "builtin");
GLOBAL_STR(str596, "builtin");
GLOBAL_STR(str597, "builtin");
GLOBAL_STR(str598, "keyword");
GLOBAL_STR(str599, "keyword");
GLOBAL_STR(str600, "file");
GLOBAL_STR(str601, "type");
GLOBAL_STR(str602, "type: %r not found");
GLOBAL_STR(str603, "file");
GLOBAL_STR(str604, "file");
GLOBAL_STR(str605, "%s is a %s");
GLOBAL_STR(str606, "function");
GLOBAL_STR(str607, "");
GLOBAL_STR(str608, "");
GLOBAL_STR(str609, "\r\n");
GLOBAL_STR(str610, "\n");
...
GLOBAL_STR(str612, "");
GLOBAL_STR(str613, "");
GLOBAL_STR(str614, "read error: %s");
GLOBAL_STR(str615, "read");
GLOBAL_STR(str616, "_line");
GLOBAL_STR(str617, ":");
GLOBAL_STR(str618, "got extra argument");
GLOBAL_STR(str619, "--qsn can only be used with --line");
GLOBAL_STR(str620, "_all");
GLOBAL_STR(str621, ":");
GLOBAL_STR(str622, "got extra argument");
GLOBAL_STR(str623, "--qsn not implemented yet");
GLOBAL_STR(str624, "read -t isn't implemented (except t=0)");
GLOBAL_STR(str625, "REPLY");
GLOBAL_STR(str626, "REPLY");
GLOBAL_STR(str627, "");
GLOBAL_STR(str628, ":");
GLOBAL_STR(str629, "mapfile");
GLOBAL_STR(str630, "MAPFILE");
GLOBAL_STR(str631, ":");
GLOBAL_STR(str632, "mapfile: read() error: %s");
GLOBAL_STR(str633, "\n");
GLOBAL_STR(str634, "cd");
GLOBAL_STR(str635, "HOME");
GLOBAL_STR(str636, "HOME");
GLOBAL_STR(str637, "-");
GLOBAL_STR(str638, "OLDPWD");
GLOBAL_STR(str639, "PWD");
GLOBAL_STR(str640, "cd %r: %s");
GLOBAL_STR(str641, "PWD");
GLOBAL_STR(str642, "OLDPWD");
GLOBAL_STR(str643, "%2d  %s");
GLOBAL_STR(str644, " ");
GLOBAL_STR(str645, "pushd: no other directory");
GLOBAL_STR(str646, "got too many arguments");
GLOBAL_STR(str647, "pushd: %r: %s");
GLOBAL_STR(str648, "HOME");
GLOBAL_STR(str649, "PWD");
GLOBAL_STR(str650, "popd: directory stack is empty");
GLOBAL_STR(str651, "popd: %r: %s");
GLOBAL_STR(str652, "PWD");
GLOBAL_STR(str653, "got extra argument");
GLOBAL_STR(str654, "HOME");
GLOBAL_STR(str655, "dirs");
GLOBAL_STR(str656, "HOME");
GLOBAL_STR(str657, "pwd");
GLOBAL_STR(str658, "_devbuild/help/groups.txt");
GLOBAL_STR(str659, "help");
GLOBAL_STR(str660, "help");
GLOBAL_STR(str661, "_devbuild/help/%s");
GLOBAL_STR(str662, "no help topics match %r");
GLOBAL_STR(str663, "osh I/O error: %s");
GLOBAL_STR(str664, "# +");
GLOBAL_STR(str665, "osh printf doesn't support the %r flag");
GLOBAL_STR(str666, "eEfFgG");
GLOBAL_STR(str667, "osh printf doesn't support floating point");
GLOBAL_STR(str668, "c");
GLOBAL_STR(str669, "osh printf doesn't support single characters (bytes)");
GLOBAL_STR(str670, "Invalid printf format character");
GLOBAL_STR(str671, "Expected a printf format character");
GLOBAL_STR(str672, "%");
GLOBAL_STR(str673, "");
GLOBAL_STR(str674, "printf got invalid width %r");
GLOBAL_STR(str675, "0");
GLOBAL_STR(str676, "");
GLOBAL_STR(str677, "printf got invalid precision %r");
GLOBAL_STR(str678, "");
GLOBAL_STR(str679, "s");
GLOBAL_STR(str680, "q");
GLOBAL_STR(str681, "b");
GLOBAL_STR(str682, "");
GLOBAL_STR(str683, "diouxX");
GLOBAL_STR(str684, "'\"");
GLOBAL_STR(str685, "printf expected an integer, got %r");
GLOBAL_STR(str686, "TZ");
GLOBAL_STR(str687, "TZ");
GLOBAL_STR(str688, "ouxX");
GLOBAL_STR(str689, "Can't format negative number %d with %%%s");
GLOBAL_STR(str690, "o");
GLOBAL_STR(str691, "x");
GLOBAL_STR(str692, "X");
GLOBAL_STR(str693, "0");
...
GLOBAL_STR(str702, "requires a format string");
GLOBAL_STR(str703, "printf");
GLOBAL_STR(str704, "");
GLOBAL_STR(str705, "alias");
GLOBAL_STR(str706, "alias %s=%r");
GLOBAL_STR(str707, "=");
GLOBAL_STR(str708, "No alias named %r");
GLOBAL_STR(str709, "alias %s=%r");
GLOBAL_STR(str710, "unalias");
GLOBAL_STR(str711, "requires an argument");
GLOBAL_STR(str712, "No alias named %r");
GLOBAL_STR(str713, "%s=%s");
GLOBAL_STR(str714, "set");
GLOBAL_STR(str715, "shopt");
GLOBAL_STR(str716, "got invalid option %r");
GLOBAL_STR(str717, "hash");
GLOBAL_STR(str718, "got extra arguments after -r");
GLOBAL_STR(str719, "hash: %r not found");
GLOBAL_STR(str720, ":");
GLOBAL_STR(str721, "OPTIND");
GLOBAL_STR(str722, "OPTIND");
GLOBAL_STR(str723, "OPTARG");
...
GLOBAL_STR(str729, "?");
GLOBAL_STR(str730, "?");
GLOBAL_STR(str731, "getopts: option %r requires an argument.");
GLOBAL_STR(str732, "(getopts argv: %s)");
GLOBAL_STR(str733, " ");
GLOBAL_STR(str734, "?");
GLOBAL_STR(str735, "");
GLOBAL_STR(str736, "requires an argspec");
GLOBAL_STR(str737, "requires the name of a variable to set");
GLOBAL_STR(str738, "got invalid variable name %r");
GLOBAL_STR(str739, "echo");
GLOBAL_STR(str740, "");
GLOBAL_STR(str741, "takes at most one arg when simple_echo is on (hint: add quotes)");
GLOBAL_STR(str742, " ");
GLOBAL_STR(str743, "\n");
GLOBAL_STR(str744, "module");
GLOBAL_STR(str745, "requires a name");
GLOBAL_STR(str746, "(interactive) Reloading module %r");
GLOBAL_STR(str747, "expected 'bin' or 'dialect'");
GLOBAL_STR(str748, "dialect");
GLOBAL_STR(str749, "expected dialect name");
GLOBAL_STR(str750, "_DIALECT");
GLOBAL_STR(str751, "Expected dialect %r, got %r");
GLOBAL_STR(str752, "Expected dialect %r");
GLOBAL_STR(str753, "bin");
GLOBAL_STR(str754, "bin %s");
GLOBAL_STR(str755, "expected 'bin' or 'dialect'");
GLOBAL_STR(str756, "shvar");
GLOBAL_STR(str757, "expected a block");
GLOBAL_STR(str758, "Expected name=value");
GLOBAL_STR(str759, "=");
GLOBAL_STR(str760, "Expected name=value");
GLOBAL_STR(str761, "expected a block");
GLOBAL_STR(str762, "Can't append array to string");
GLOBAL_STR(str763, "Can't append string to array");
GLOBAL_STR(str764, "Assignment builtin %r not configured");
GLOBAL_STR(str765, "%r ");
GLOBAL_STR(str766, "Command");
GLOBAL_STR(str767, "Assignment");
GLOBAL_STR(str768, "Subshell");
GLOBAL_STR(str769, "Pipeline");
GLOBAL_STR(str770, "%s failed with status %d");
GLOBAL_STR(str771, "Redirect filename can't be empty");
GLOBAL_STR(str772, "Redirect descriptor can't be empty");
GLOBAL_STR(str773, "-");
GLOBAL_STR(str774, "-");
GLOBAL_STR(str775, "Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
GLOBAL_STR(str776, "\n");
GLOBAL_STR(str777, "Unknown redirect op");
GLOBAL_STR(str778, "Unknown redirect type");
GLOBAL_STR(str779, "strict_errexit only allows simple commands (got %s). Hint: use 'try'.");
GLOBAL_STR(str780, "strict_errexit only allows a single command.  Hint: use 'try'.");
GLOBAL_STR(str781, "strict_errexit only allows simple commands (got %s). Hint: use 'try'.");
GLOBAL_STR(str782, "ShAssignment builtins don't accept blocks");
GLOBAL_STR(str783, "|& isn't supported");
GLOBAL_STR(str784, "%r expected a number, got %r");
GLOBAL_STR(str785, "Invalid control flow at top level");
GLOBAL_STR(str786, "warning: ");
GLOBAL_STR(str787, "Function %s was already defined (redefine_proc)");
GLOBAL_STR(str788, "Proc %s was already defined (redefine_proc)");
GLOBAL_STR(str789, "trap");
GLOBAL_STR(str790, "failglob: ");
GLOBAL_STR(str791, "Loop and control flow can't be in different processes");
GLOBAL_STR(str792, "fatal: ");
GLOBAL_STR(str793, "EXIT");
GLOBAL_STR(str794, "trap EXIT");
GLOBAL_STR(str795, "__");
GLOBAL_STR(str796, ":");
GLOBAL_STR(str797, "Invalid argument %r.  Expected a name starting with :");
GLOBAL_STR(str798, "No value provided for param %r");
GLOBAL_STR(str799, "proc %r expected %d arguments, but got %d");
GLOBAL_STR(str800, "Unexpected %r (in function call)");
GLOBAL_STR(str801, "Attempted to exit from completion hook.");
GLOBAL_STR(str802, "Couldn't find terminator for here doc that starts here");
GLOBAL_STR(str803, "\t");
GLOBAL_STR(str804, "Invalid here doc delimiter");
GLOBAL_STR(str805, "+");
GLOBAL_STR(str806, "+");
GLOBAL_STR(str807, "+");
GLOBAL_STR(str808, "%d != %d");
GLOBAL_STR(str809, "array place");
GLOBAL_STR(str810, "Environment binding shouldn't look like an array assignment");
GLOBAL_STR(str811, "+");
GLOBAL_STR(str812, "Expected = in environment binding, got +=");
GLOBAL_STR(str813, "Environment bindings can't contain array literals");
GLOBAL_STR(str814, "procs and shell functions can't be nested");
GLOBAL_STR(str815, "%r was already declared");
GLOBAL_STR(str816, "%r hasn't been declared");
GLOBAL_STR(str817, "Can't modify constant %r");
GLOBAL_STR(str818, "Expected word type %s, got %s");
GLOBAL_STR(str819, "{");
GLOBAL_STR(str820, "}");
GLOBAL_STR(str821, "Invalid token after redirect operator");
GLOBAL_STR(str822, "Space required before (");
GLOBAL_STR(str823, "Unexpected left paren (might need a space before it)");
GLOBAL_STR(str824, "Empty arg list not allowed");
GLOBAL_STR(str825, "TODO: Parse Redirect");
GLOBAL_STR(str826, " ");
GLOBAL_STR(str827, " ");
GLOBAL_STR(str828, "line IDs %d != %d");
GLOBAL_STR(str829, " ");
GLOBAL_STR(str830, "");
GLOBAL_STR(str831, "Unexpected typed args");
GLOBAL_STR(str832, "=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
GLOBAL_STR(str833, "name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
GLOBAL_STR(str834, "Unexpected typed args");
GLOBAL_STR(str835, "Unexpected typed args");
GLOBAL_STR(str836, "Control flow shouldn't have redirects");
GLOBAL_STR(str837, "Control flow shouldn't have environment bindings");
GLOBAL_STR(str838, "Unexpected argument to %r");
GLOBAL_STR(str839, "Invalid word in for loop");
GLOBAL_STR(str840, "Invalid word after for expression");
GLOBAL_STR(str841, "Loop variable name should be a constant");
GLOBAL_STR(str842, "Invalid loop variable name");
GLOBAL_STR(str843, "Unexpected word after for loop variable");
GLOBAL_STR(str844, "Expected ;; or esac");
GLOBAL_STR(str845, "Unexpected word while parsing compound command");
GLOBAL_STR(str846, "Invalid function name");
GLOBAL_STR(str847, "Expected ) in function definition");
GLOBAL_STR(str848, "Invalid KSH-style function name");
GLOBAL_STR(str849, "Unexpected word when parsing command");
GLOBAL_STR(str850, "Unexpected right brace");
GLOBAL_STR(str851, "Unexpected EOF while parsing command");
GLOBAL_STR(str852, "Invalid word while parsing command");
GLOBAL_STR(str853, "Invalid word while parsing command line");
GLOBAL_STR(str854, "Invalid word while parsing command list");
GLOBAL_STR(str855, "Unterminated here doc began here");
GLOBAL_STR(str856, "\\");
GLOBAL_STR(str857, "*");
GLOBAL_STR(str858, "?");
GLOBAL_STR(str859, "[");
...
GLOBAL_STR(str863, "\\?*+{}^$.()|");
GLOBAL_STR(str864, "\\");
GLOBAL_STR(str865, "Unexpected escaped character %r");
GLOBAL_STR(str866, "");
GLOBAL_STR(str867, "");
GLOBAL_STR(str868, "Malformed character class; treating as literal");
GLOBAL_STR(str869, "Got unescaped right bracket");
GLOBAL_STR(str870, "Got unescaped trailing backslash");
GLOBAL_STR(str871, ".|^$()+*?[]{}\\");
GLOBAL_STR(str872, "\\");
GLOBAL_STR(str873, "\\");
GLOBAL_STR(str874, "\\[");
...
GLOBAL_STR(str886, "]");
GLOBAL_STR(str887, "");
GLOBAL_STR(str888, "Error expanding glob %r: %s");
GLOBAL_STR(str889, "-");
GLOBAL_STR(str890, "<Error: unbalanced \\[ and \\]> ");
GLOBAL_STR(str891, "$");
GLOBAL_STR(str892, "#");
GLOBAL_STR(str893, "$");
GLOBAL_STR(str894, "hostname");
GLOBAL_STR(str895, "user");
GLOBAL_STR(str896, "\u0001");
GLOBAL_STR(str897, "\u0002");
GLOBAL_STR(str898, "$");
GLOBAL_STR(str899, "$");
GLOBAL_STR(str900, "u");
GLOBAL_STR(str901, "user");
GLOBAL_STR(str902, "h");
GLOBAL_STR(str903, "hostname");
GLOBAL_STR(str904, ".");
GLOBAL_STR(str905, "H");
GLOBAL_STR(str906, "hostname");
GLOBAL_STR(str907, "s");
GLOBAL_STR(str908, "v");
GLOBAL_STR(str909, "A");
GLOBAL_STR(str910, "%H:%M");
GLOBAL_STR(str911, "D");
GLOBAL_STR(str912, "%X");
GLOBAL_STR(str913, "w");
GLOBAL_STR(str914, "PWD");
GLOBAL_STR(str915, "HOME");
GLOBAL_STR(str916, "<Error: %s>");
GLOBAL_STR(str917, "W");
GLOBAL_STR(str918, "PWD");
GLOBAL_STR(str919, "<Error: PWD is not a string> ");
GLOBAL_STR(str920, "<Error: \\%s not implemented in $PS1> ");
GLOBAL_STR(str921, "$");
GLOBAL_STR(str922, "\\$");
GLOBAL_STR(str923, "Invalid token %r");
GLOBAL_STR(str924, "");
GLOBAL_STR(str925, "");
GLOBAL_STR(str926, "<ERROR: Can't parse PS1: %s>");
GLOBAL_STR(str927, "osh");
GLOBAL_STR(str928, "PS1");
GLOBAL_STR(str929, "$ ");
GLOBAL_STR(str930, "PROMPT_COMMAND");
GLOBAL_STR(str931, "Undefined variable %r");
GLOBAL_STR(str932, "Can't use [] on value of type %s");
GLOBAL_STR(str933, "");
GLOBAL_STR(str934, "Can't use [] on value of type %s");
GLOBAL_STR(str935, "");
GLOBAL_STR(str936, "dynamic place");
GLOBAL_STR(str937, "got invalid place expression");
GLOBAL_STR(str938, "expected a var name.  shopt -s eval_unsafe_arith allows a[i]");
GLOBAL_STR(str939, "Invalid var ref");
GLOBAL_STR(str940, "0x");
GLOBAL_STR(str941, "Invalid hex constant %r");
GLOBAL_STR(str942, "0");
GLOBAL_STR(str943, "Invalid octal constant %r");
GLOBAL_STR(str944, "#");
GLOBAL_STR(str945, "#");
GLOBAL_STR(str946, "Invalid base for numeric constant %r");
GLOBAL_STR(str947, "a");
GLOBAL_STR(str948, "A");
GLOBAL_STR(str949, "@");
GLOBAL_STR(str950, "_");
GLOBAL_STR(str951, "Invalid digits for numeric constant %r");
GLOBAL_STR(str952, "Digits %r out of range for base %d");
GLOBAL_STR(str953, "Parse error in recursive arithmetic");
...
GLOBAL_STR(str957, "Undefined value in arithmetic context");
GLOBAL_STR(str958, "Expected a value convertible to integer, got %s");
GLOBAL_STR(str959, "0");
GLOBAL_STR(str960, "Undefined variable %r");
GLOBAL_STR(str961, "Divide by zero");
GLOBAL_STR(str962, "Divide by zero");
GLOBAL_STR(str963, "Expected array or assoc in index expression, got %s");
GLOBAL_STR(str964, "Divide by zero");
GLOBAL_STR(str965, "Divide by zero");
GLOBAL_STR(str966, "Exponent can't be less than zero");
GLOBAL_STR(str967, "Associative array keys must be strings: $x 'x' \"$x\" etc.");
GLOBAL_STR(str968, "Invalid place to modify");
GLOBAL_STR(str969, "%s isn't implemented");
GLOBAL_STR(str970, "Invalid regex %r: %s");
GLOBAL_STR(str971, " \t\n");
GLOBAL_STR(str972, "IFS");
GLOBAL_STR(str973, "IFS shouldn't be an array");
GLOBAL_STR(str974, " \t\n");
GLOBAL_STR(str975, "IFS");
GLOBAL_STR(str976, " ");
GLOBAL_STR(str977, "");
GLOBAL_STR(str978, "IFS shouldn't be an array");
GLOBAL_STR(str979, "\\");
GLOBAL_STR(str980, "\\");
GLOBAL_STR(str981, "Invalid transition from %r with %r");
GLOBAL_STR(str982, "\u00ef\u00bf\u00bd");
GLOBAL_STR(str983, "");
GLOBAL_STR(str984, "Incomplete UTF-8 character");
GLOBAL_STR(str985, "Invalid UTF-8 continuation byte");
GLOBAL_STR(str986, "Invalid start of UTF-8 character");
GLOBAL_STR(str987, "");
GLOBAL_STR(str988, "%s can't have an argument");
GLOBAL_STR(str989, "");
...
GLOBAL_STR(str995, "");
GLOBAL_STR(str996, "<_GlobReplacer regex %r r %r>");
GLOBAL_STR(str997, "(%s)");
GLOBAL_STR(str998, "Error matching regex %r: %s");
GLOBAL_STR(str999, "^");
GLOBAL_STR(str1000, "$");
GLOBAL_STR(str1001, "\r");
GLOBAL_STR(str1002, "<INVALID CR>");
GLOBAL_STR(str1003, "\n");
GLOBAL_STR(str1004, "<INVALID NEWLINE>");
GLOBAL_STR(str1005, " `~!$&*()[]{}\\|;'\"<>?");
GLOBAL_STR(str1006, "Left-hand side of this assignment is invalid");
GLOBAL_STR(str1007, "Token can't be used in prefix position");
GLOBAL_STR(str1008, "Token can't be used in infix position");
GLOBAL_STR(str1009, "Parser expected %s, got %s");
GLOBAL_STR(str1010, "Unexpected end of input");
GLOBAL_STR(str1011, "");
GLOBAL_STR(str1012, "");
GLOBAL_STR(str1013, " \t");
GLOBAL_STR(str1014, "\n");
...
GLOBAL_STR(str1016, "\n");
GLOBAL_STR(str1017, "\n");
GLOBAL_STR(str1018, "BASH_SOURCE");
GLOBAL_STR(str1019, "FUNCNAME");
GLOBAL_STR(str1020, "BASH_LINENO");
GLOBAL_STR(str1021, "0");
GLOBAL_STR(str1022, "0");
GLOBAL_STR(str1023, "^([a-zA-Z_][a-zA-Z0-9_]*)((=|\\+=)(.*))?$");
GLOBAL_STR(str1024, "Assignment builtin expected NAME=value, got %r");
GLOBAL_STR(str1025, "+");
GLOBAL_STR(str1026, "\\");
GLOBAL_STR(str1027, "\\\\");
GLOBAL_STR(str1028, "");
GLOBAL_STR(str1029, "");
GLOBAL_STR(str1030, "The length index of a array slice can't be negative: %d");
GLOBAL_STR(str1031, "Can't slice associative arrays");
GLOBAL_STR(str1032, "i");
GLOBAL_STR(str1033, "e");
GLOBAL_STR(str1034, "f");
GLOBAL_STR(str1035, "n");
GLOBAL_STR(str1036, "u");
GLOBAL_STR(str1037, "x");
GLOBAL_STR(str1038, "C");
GLOBAL_STR(str1039, "");
GLOBAL_STR(str1040, "~");
GLOBAL_STR(str1041, "HOME");
GLOBAL_STR(str1042, "Error expanding tilde (e.g. invalid user)");
GLOBAL_STR(str1043, "Can't assign to special variable");
GLOBAL_STR(str1044, "unset variable %r");
GLOBAL_STR(str1045, "warning: ");
GLOBAL_STR(str1046, "-1");
GLOBAL_STR(str1047, "a[i] not allowed without shopt -s eval_unsafe_arith");
GLOBAL_STR(str1048, "Indirect expansion of array");
GLOBAL_STR(str1049, "Indirect expansion of assoc array");
GLOBAL_STR(str1050, "extended globs not supported in ${x//GLOB/}");
GLOBAL_STR(str1051, "");
...
GLOBAL_STR(str1056, "\u0002");
GLOBAL_STR(str1057, "");
GLOBAL_STR(str1058, "Can't use @P on %s");
GLOBAL_STR(str1059, " ");
GLOBAL_STR(str1060, "Can't use @Q on %s");
GLOBAL_STR(str1061, "a");
GLOBAL_STR(str1062, "A");
GLOBAL_STR(str1063, "r");
GLOBAL_STR(str1064, "x");
GLOBAL_STR(str1065, "n");
GLOBAL_STR(str1066, "");
GLOBAL_STR(str1067, "Var op %r not implemented");
GLOBAL_STR(str1068, "Can't index string with @");
GLOBAL_STR(str1069, "Can't index string with *");
GLOBAL_STR(str1070, "Can't index string %r with integer");
GLOBAL_STR(str1071, "");
GLOBAL_STR(str1072, "");
GLOBAL_STR(str1073, "$");
GLOBAL_STR(str1074, "Undefined variable %r");
GLOBAL_STR(str1075, "Undefined array %r");
GLOBAL_STR(str1076, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str1077, "Test operation not allowed with ${!array[@]}");
GLOBAL_STR(str1078, "Not implemented");
GLOBAL_STR(str1079, "Illegal array word part (strict_array)");
GLOBAL_STR(str1080, " ");
GLOBAL_STR(str1081, "");
GLOBAL_STR(str1082, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str1083, "@(");
GLOBAL_STR(str1084, "|");
GLOBAL_STR(str1085, ")");
GLOBAL_STR(str1086, "Extended globs and arrays can't appear in the same word");
GLOBAL_STR(str1087, "*");
GLOBAL_STR(str1088, "Unexpected array literal");
GLOBAL_STR(str1089, "Unexpected associative array literal");
GLOBAL_STR(str1090, "Can't splice %r");
GLOBAL_STR(str1091, "");
GLOBAL_STR(str1092, "");
GLOBAL_STR(str1093, "Extended glob %r matched no files");
GLOBAL_STR(str1094, "Extended glob not allowed in this word");
GLOBAL_STR(str1095, "");
GLOBAL_STR(str1096, "This word should yield a string, but it contains an array");
GLOBAL_STR(str1097, " ");
GLOBAL_STR(str1098, "extended glob not allowed in this word");
GLOBAL_STR(str1099, "");
GLOBAL_STR(str1100, "");
GLOBAL_STR(str1101, "");
GLOBAL_STR(str1102, "");
GLOBAL_STR(str1103, "<Runtime error: %s>");
GLOBAL_STR(str1104, "<I/O error: %s>");
GLOBAL_STR(str1105, "<Ctrl-C>");
GLOBAL_STR(str1106, "");
GLOBAL_STR(str1107, "");
GLOBAL_STR(str1108, "");
GLOBAL_STR(str1109, "");
GLOBAL_STR(str1110, "Pattern %r matched no files");
GLOBAL_STR(str1111, "");
GLOBAL_STR(str1112, "LHS array not allowed in assignment builtin");
GLOBAL_STR(str1113, "+");
GLOBAL_STR(str1114, "-");
GLOBAL_STR(str1115, "+");
GLOBAL_STR(str1116, "f");
GLOBAL_STR(str1117, "F");
GLOBAL_STR(str1118, "Pattern %r matched no files");
GLOBAL_STR(str1119, "");
GLOBAL_STR(str1120, "__NO_COMMAND_SUB__");
GLOBAL_STR(str1121, "__NO_PROCESS_SUB__");
GLOBAL_STR(str1122, "Expected : or } in slice");
GLOBAL_STR(str1123, "Pattern in ${x/pat/replace} must not be empty");
GLOBAL_STR(str1124, "Expected } after replacement string, got %s");
GLOBAL_STR(str1125, "Expected } or / to close pattern");
GLOBAL_STR(str1126, "Expected ] to close subscript");
GLOBAL_STR(str1127, "Expected } to close ${");
GLOBAL_STR(str1128, "Expected } to close ${");
GLOBAL_STR(str1129, "Expected a constant argument");
GLOBAL_STR(str1130, "Expected } to close ${");
GLOBAL_STR(str1131, "Expected } to close ${");
GLOBAL_STR(str1132, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1133, "VOp2");
GLOBAL_STR(str1134, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1135, "VOp3");
GLOBAL_STR(str1136, "Expected } to close ${");
GLOBAL_STR(str1137, "Expected } after length expression");
GLOBAL_STR(str1138, "TODO: ${.myproc builtin sub}");
GLOBAL_STR(str1139, "Unexpected token in ${}");
GLOBAL_STR(str1140, "\\");
GLOBAL_STR(str1141, "Strings with backslashes should look like r'\\n' or $'\\n'");
GLOBAL_STR(str1142, "Use \\xhh or \\u{...} instead of octal escapes in Oil strings");
GLOBAL_STR(str1143, "Invalid hex escape in Oil string (must be \\xHH)");
GLOBAL_STR(str1144, "Invalid char escape in C-style string literal");
GLOBAL_STR(str1145, "Unexpected EOF in single-quoted string that began here");
GLOBAL_STR(str1146, "\"");
GLOBAL_STR(str1147, "'");
GLOBAL_STR(str1148, "Unexpected EOF reading extended glob that began here");
GLOBAL_STR(str1149, "Invalid char escape in double quoted string");
GLOBAL_STR(str1150, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1151, "Invalid backtick: use $(cmd) or \\` in Oil strings");
GLOBAL_STR(str1152, "Unexpected EOF reading double-quoted string that began here");
GLOBAL_STR(str1153, "Use $(cmd) instead of backticks (parse_backticks)");
GLOBAL_STR(str1154, "Unexpected EOF while looking for closing backtick");
GLOBAL_STR(str1155, "");
GLOBAL_STR(str1156, "backticks");
GLOBAL_STR(str1157, "Invalid proc name %s");
GLOBAL_STR(str1158, "Unexpected token after arithmetic expression (%s != %s)");
GLOBAL_STR(str1159, "Expected second ) to end arith sub");
GLOBAL_STR(str1160, "Expected second ) to end arith statement");
GLOBAL_STR(str1161, "Expected ; here");
GLOBAL_STR(str1162, "Expected ; here");
GLOBAL_STR(str1163, "Expected ) to end for loop expression");
GLOBAL_STR(str1164, "Expected ( after =");
GLOBAL_STR(str1165, "Unexpected token in array literal");
GLOBAL_STR(str1166, "Expected associative array pair");
GLOBAL_STR(str1167, "Invalid char escape (parse_backslash)");
GLOBAL_STR(str1168, "Unexpected token after array literal");
GLOBAL_STR(str1169, "Unexpected token after array splice");
GLOBAL_STR(str1170, "TODO: @{.myproc builtin sub}");
GLOBAL_STR(str1171, "Literal @ starting a word must be quoted (parse_at_all)");
GLOBAL_STR(str1172, "/");
GLOBAL_STR(str1173, "next_byte %r");
GLOBAL_STR(str1174, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1175, "Unexpected token after @()");
GLOBAL_STR(str1176, "Word has unbalanced { }.  Maybe add a space or quote it like \\{");
GLOBAL_STR(str1177, "Unexpected parts after triple quoted string");
GLOBAL_STR(str1178, "Unexpected token while parsing arithmetic: %r");
GLOBAL_STR(str1179, "Invalid blank line in multiline mode");
GLOBAL_STR(str1180, "r");
GLOBAL_STR(str1181, "Unhandled: %s (%s)");
GLOBAL_STR(str1182, "Invalid var ref");
GLOBAL_STR(str1183, "Expected end of var ref");
GLOBAL_STR(str1184, "Invalid lex state %s");
GLOBAL_STR(str1185, "");
GLOBAL_STR(str1186, "");
GLOBAL_STR(str1187, "");
GLOBAL_STR(str1188, "");
...
GLOBAL_STR(str1192, "");
GLOBAL_STR(str1193, "");
GLOBAL_STR(str1194, "Compound shouldn't be empty");
GLOBAL_STR(str1195, "/");
GLOBAL_STR(str1196, "/");
GLOBAL_STR(str1197, "");
GLOBAL_STR(str1198, "EOF");
GLOBAL_STR(str1199, "typ");
GLOBAL_STR(str1200, "tok");
GLOBAL_STR(str1201, "children");
GLOBAL_STR(str1202, "-");
GLOBAL_STR(str1203, "with %d children");
GLOBAL_STR(str1204, "");
GLOBAL_STR(str1205, "(PNode %s %s %s)");
GLOBAL_STR(str1206, "&");
GLOBAL_STR(str1207, "&amp;");
GLOBAL_STR(str1208, "<");
GLOBAL_STR(str1209, "&lt;");
...
GLOBAL_STR(str1231, "/");
GLOBAL_STR(str1232, " \n\r\t");
GLOBAL_STR(str1233, "Unexpected token in QSN string");
GLOBAL_STR(str1234, "Expected closing single quote in QSN string");
GLOBAL_STR(str1235, "Unexpected data after closing quote");
GLOBAL_STR(str1236, "Unexpected token after QSN string");
GLOBAL_STR(str1237, "\\'\r\n\t\u0000");
GLOBAL_STR(str1238, "$'");
GLOBAL_STR(str1239, "'");
GLOBAL_STR(str1240, "'");
...
GLOBAL_STR(str1255, "\\r");
GLOBAL_STR(str1256, "\t");
GLOBAL_STR(str1257, "\\t");
GLOBAL_STR(str1258, "\u0000");
GLOBAL_STR(str1259, "\\x00");
GLOBAL_STR(str1260, "\\0");
GLOBAL_STR(str1261, "");
GLOBAL_STR(str1262, "");
GLOBAL_STR(str1263, "");
GLOBAL_STR(str1264, "\\");
...
GLOBAL_STR(str1271, "\\r");
GLOBAL_STR(str1272, "\t");
GLOBAL_STR(str1273, "\\t");
GLOBAL_STR(str1274, "\u0000");
GLOBAL_STR(str1275, "\\x00");
GLOBAL_STR(str1276, "\\0");
GLOBAL_STR(str1277, "");
GLOBAL_STR(str1278, "!");
GLOBAL_STR(str1279, "--");
GLOBAL_STR(str1280, "--dir");
GLOBAL_STR(str1281, "--exists");
GLOBAL_STR(str1282, "--file");
GLOBAL_STR(str1283, "--symlink");
GLOBAL_STR(str1284, "Expected unary operator, got %r (2 args)");
GLOBAL_STR(str1285, "-a");
GLOBAL_STR(str1286, "-o");
GLOBAL_STR(str1287, "!");
GLOBAL_STR(str1288, "(");
GLOBAL_STR(str1289, ")");
GLOBAL_STR(str1290, "Expected binary operator, got %r (3 args)");
GLOBAL_STR(str1291, "should be invoked as 'test' (simple_test_builtin)");
GLOBAL_STR(str1292, "]");
GLOBAL_STR(str1293, "missing closing ]");
GLOBAL_STR(str1294, "should only have 3 arguments or fewer (simple_test_builtin)");
GLOBAL_STR(str1295, "!");
GLOBAL_STR(str1296, "(");
GLOBAL_STR(str1297, ")");
GLOBAL_STR(str1298, "(test) ");
GLOBAL_STR(str1299, "(test) ");
...
runtime_asdl::cmd_value__Argv* MakeBuiltinArgv(List<Str*>* argv1) {
  ...
  argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str140});
  argv->extend(argv1);
...
int Main(Str* lang, args::Reader* arg_r, Dict<Str*, Str*>* environ, bool login_shell, pyutil::_ResourceLoader* loader, void* line_input) {
  ...
  arg_r->Next();
  try {
    attrs = flag_spec::ParseMore(str141, arg_r);
  }
  catch (error::Usage* e) {
  ...
  if (flag->version) {
    pyutil::ShowAppVersion(str144, loader);
    return 0;
  }
  no_str = nullptr;
  ...
  if (arg_r->AtEnd()) {
    ...
    dollar0 = arg_r->Peek();
    frame0 = Alloc<state::DebugFrame>(dollar0, str145, no_str, state::LINE_ZERO, 0, 0);
  ...
  if (str_equals(lang, str146)) {
    mutable_opts->SetShoptOption(str147, true);
  }
  ...
  comp_arena->PushSource(Alloc<source::Unused>(str149));
  ...
  hist_arena->PushSource(Alloc<source::Unused>(str150));
  ...
  interp = environ->get(str155, str156);
  ...
  crash_dump_dir = environ->get(str157, str158);
  ...
  if (flag->c != nullptr) {
    ...
    if (flag->i) {
      ...
      if (script_name == nullptr) {
        stdin = mylib::Stdin();
        arena->PushSource(Alloc<source::Stdin>(str159));
...
mylib::LineReader* FdState::Open(Str* path) {
  ...
  fd_mode = O_RDONLY;
  return this->_Open(path, str168, fd_mode);
}
...
void ExternalProgram::_Exec(Str* argv0_path, List<Str*>* argv, int argv0_spid, Dict<Str*, Str*>* environ, bool should_retry) {
  ...
  try {
    ...
    if ((e->errno == ENOEXEC and should_retry)) {
      new_argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str177, argv0_path});
      new_argv->extend(argv->slice(1));
      this->_Exec(str178, new_argv, argv0_spid, environ, false);
    }
...
runtime_asdl::cmd_value__Argv* MakeBuiltinArgv(List<Str*>* argv1) {
  ...
  argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str205});
  argv->extend(argv1);
  return Alloc<cmd_value::Argv>(argv, list_repeat(runtime::NO_SPID, len(argv)), nullptr);
}
...
int Main(Str* lang, args::Reader* arg_r, Dict<Str*, Str*>* environ, bool login_shell, pyutil::_ResourceLoader* loader, void* line_input) {
  ...
  arg_r->Next();
  try {
    attrs = flag_spec::ParseMore(str206, arg_r);
  }
  catch (error::Usage* e) {
  ...
  if (flag->version) {
    pyutil::ShowAppVersion(str209, loader);
    return 0;
  }
  no_str = nullptr;
  debug_stack = Alloc<List<state::DebugFrame*>>();
  if (arg_r->AtEnd()) {
    ...
    dollar0 = arg_r->Peek();
    frame0 = Alloc<state::DebugFrame>(dollar0, str210, no_str, state::LINE_ZERO, 0, 0);
    debug_stack->append(frame0);
  }
  frame1 = Alloc<state::DebugFrame>(no_str, no_str, no_str, runtime::NO_SPID, 0, 0);
  debug_stack->append(frame1);
  ...
  if (str_equals(lang, str211)) {
    mutable_opts->SetShoptOption(str212, true);
  }
  builtin_pure::SetShellOpts(mutable_opts, attrs->opt_changes, attrs->shopt_changes);
  aliases = Alloc<Dict<Str*, Str*>>();
  oil_grammar = nullptr;
  ...
  parse_ctx->Init_OnePassParse(flag->one_pass_parse);
  comp_arena = Alloc<alloc::Arena>();
  comp_arena->PushSource(Alloc<source::Unused>(str214));
  trail1 = Alloc<parse_lib::Trail>();
  comp_ctx = Alloc<parse_lib::ParseContext>(comp_arena, parse_opts, aliases, oil_grammar);
  comp_ctx->Init_Trail(trail1);
  comp_ctx->Init_OnePassParse(true);
  hist_arena = Alloc<alloc::Arena>();
  hist_arena->PushSource(Alloc<source::Unused>(str215));
  trail2 = Alloc<parse_lib::Trail>();
  hist_ctx = Alloc<parse_lib::ParseContext>(hist_arena, parse_opts, aliases, oil_grammar);
  hist_ctx->Init_Trail(trail2);
  cmd_deps = Alloc<cmd_eval::Deps>();
  ...
  waiter = Alloc<process::Waiter>(job_state, exec_opts, sig_state, tracer);
  fd_state->waiter = waiter;
  interp = environ->get(str220, str221);
  search_path = Alloc<state::SearchPath>(mem);
  ext_prog = Alloc<process::ExternalProgram>(interp, fd_state, errfmt, debug_f);
  splitter = Alloc<split::SplitContext>(mem);
  crash_dump_dir = environ->get(str222, str223);
  cmd_deps->dumper = Alloc<dev::CrashDumper>(crash_dump_dir);
  dir_stack = Alloc<state::DirStack>();
  builtins = Alloc<Dict<int, vm::_Builtin*>>();
  modules = Alloc<Dict<Str*, bool>>();
  ...
  if (flag->c != nullptr) {
    ...
    if (flag->i) {
      ...
      if (script_name == nullptr) {
        stdin = mylib::Stdin();
        arena->PushSource(Alloc<source::Stdin>(str224));
        line_reader = Alloc<reader::FileLineReader>(stdin, arena);
      }
      else {
        arena->PushSource(Alloc<source::MainFile>(script_name));
...
Str* SearchPath::Lookup(Str* name, bool exec_required) {
  ...
  val = this->mem->GetValue(str231);
  UP_val = val;
  if (val->tag_() == value_e::Str) {
    value__Str* val = static_cast<value__Str*>(UP_val);
    path_list = val->s->split(str232);
  }
  else {
...
void MutableOpts::Init() {
  ...
  UP_shellopts = this->mem->GetValue(str236);
...
void MutableOpts::SetOption(Str* opt_name, bool b) {
  ...
  UP_val = this->mem->GetValue(str240);
  value__Str* val = static_cast<value__Str*>(UP_val);
  shellopts = val->s;
  if (b) {
    if (!str_contains(shellopts, opt_name)) {
      new_val = Alloc<value::Str>(fmt66(shellopts, opt_name));
      this->mem->InternalSetGlobal(str242, new_val);
    }
  }
  else {
    if (str_contains(shellopts, opt_name)) {
      names = Alloc<List<Str*>>();
      for (ListIter<Str*> it(shellopts->split(str243)); !it.Done(); it.Next()) {
        Str* n = it.Value();
        if (!(str_equals(n, opt_name))) {
          names->append(n);
        }
      }
      new_val = Alloc<value::Str>(str244->join(names));
      this->mem->InternalSetGlobal(str245, new_val);
    }
  }
}
...
void MutableOpts::ShowOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    b = this->Get(opt_num);
    print(fmt67(b ? str250 : str251, opt_name));
  }
}
...
void MutableOpts::ShowShoptOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<int> it(opt_nums); !it.Done(); it.Next()) {
    ...
    print(fmt69(b ? str257 : str258, consts::OptionName(opt_num)));
  }
}
...
void _InitDefaults(state::Mem* mem) {
  ...
  SetGlobalString(mem, str261, split::DEFAULT_IFS);
  SetGlobalString(mem, str262, str(posix::getuid()));
  SetGlobalString(mem, str263, str(posix::geteuid()));
  SetGlobalString(mem, str264, str(posix::getppid()));
  SetGlobalString(mem, str265, libc::gethostname());
  SetGlobalString(mem, str266, pyos::OsType());
  SetGlobalString(mem, str267, str268);
  SetGlobalString(mem, str269, str270);
  SetGlobalString(mem, str271, _READLINE_DELIMS);
}
...
void _InitVarsFromEnv(state::Mem* mem, Dict<Str*, Str*>* environ) {
  ...
  val = mem->GetValue(str272);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str273, str274);
  }
  mem->SetValue(Alloc<lvalue::Named>(str275), nullptr, scope_e::GlobalOnly, SetReadOnly);
  val = mem->GetValue(str276);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str277, _GetWorkingDir());
  }
  mem->SetValue(Alloc<lvalue::Named>(str278), nullptr, scope_e::GlobalOnly, SetExport);
  val = mem->GetValue(str279);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str280, str281);
  }
}
...
void InitMem(state::Mem* mem, Dict<Str*, Str*>* environ, Str* version_str) {
  ...
  SetGlobalString(mem, str282, version_str);
  _InitDefaults(mem);
...
void InitInteractive(state::Mem* mem) {
  ...
  if (mem->GetValue(str284)->tag_() == value_e::Undef) {
    SetGlobalString(mem, str285, str286);
  }
}
...
Mem::Mem(Str* dollar0, List<Str*>* argv, alloc::Arena* arena, List<state::DebugFrame*>* debug_stack) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Mem)) {
  ...
  this->line_num = Alloc<value::Str>(str287);
...
Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> Mem::_ResolveNameOrRef(Str* name, runtime_asdl::scope_t which_scopes, bool is_setref, List<Str*>* ref_trail) {
  ...
  if (ref_trail == nullptr) {
    ...
    if (list_contains(ref_trail, new_name)) {
      e_die(fmt73(str299->join(ref_trail)));
    }
  }
  ...
  switch (lval->tag_()) {
    case lvalue_e::Named: {
      ...
      if (keyword_id == Id::KW_SetRef) {
        lval->name = str_concat(str300, lval->name);
      }
...
runtime_asdl::value_t* Mem::GetValue(Str* name, runtime_asdl::scope_t which_scopes) {
  ...
  if ((str_equals(name, str311) || str_equals(name, str312))) {
...
Str* PrettyDir(Str* dir_name, Str* home_dir) {
  ...
  if (home_dir != nullptr) {
    if ((str_equals(dir_name, home_dir) or dir_name->startswith(str_concat(home_dir, str329)))) {
      return str_concat(str330, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    StackRoots _for({&c  });
    buf->write(str_equals(c, str333) ? str334 : str335);
  }
  buf->write(str336);
  buf->write(str_repeat(str337, (length - 1)));
  buf->write(str338);
...
void ErrorFormatter::Print_(Str* msg, int span_id) {
  ...
  _PrintWithSpanId(str353, msg, span_id, this->arena, true);
}
...
void ErrorFormatter::PrintMessage(Str* msg, int span_id) {
  ...
  _PrintWithSpanId(str354, msg, span_id, this->arena, false);
}
...
void PrintAst(syntax_asdl::command_t* node, arg_types::main* flag) {
  ...
  if (maybe_str_equals(flag->ast_format, str357)) {
    println_stderr(str358);
  }
  else {
    f = mylib::Stdout();
    ...
    if ((maybe_str_equals(afmt, str359) || maybe_str_equals(afmt, str360))) {
      ...
      if ((maybe_str_equals(afmt, str361) || maybe_str_equals(afmt, str362))) {
...
void _Attributes::Set(Str* name, runtime_asdl::value_t* val) {
  ...
  name = name->replace(str366, str367);
...
bool SetAttachedBool::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  if (attached_arg != nullptr) {
    if ((str_equals(attached_arg, str383) || str_equals(attached_arg, str384) || str_equals(attached_arg, str385) || str_equals(attached_arg, str386))) {
      b = false;
    }
    else {
...
bool SetOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str392);
...
args::_Attributes* Parse(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str397)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if ((len(spec->actions_long) and arg->startswith(str398))) {
      pos = arg->find(str399, 2);
      if (pos == -1) {
        suffix = nullptr;
      ...
      if ((arg->startswith(str401) and len(arg) > 1)) {
        n = len(arg);
        for (int i = 1; i < n; ++i) {
          ch = arg->index(i);
          if (str_equals(ch, str402)) {
            ch = str403;
          }
          if (list_contains(spec->plus_flags, ch)) {
            out->Set(ch, Alloc<value::Str>(str404));
            continue;
          }
        ...
        if ((len(spec->plus_flags) and (arg->startswith(str407) and len(arg) > 1))) {
          n = len(arg);
          for (int i = 1; i < n; ++i) {
            ch = arg->index(i);
            if (list_contains(spec->plus_flags, ch)) {
...
args::_Attributes* ParseLikeEcho(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    chars = arg->slice(1);
    if ((arg->startswith(str411) and len(chars))) {
      done = false;
...
args::_Attributes* ParseMore(flag_spec::_FlagSpecAndMore* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str412)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if (arg->startswith(str413)) {
    ...
    if (((arg->startswith(str415) or arg->startswith(str416)) and len(arg) > 1)) {
      char0 = arg->index(0);
...
int LineLexer::GetSpanIdForEof() {
  int line_id;
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str420, 0);
  }
  else {
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str422, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = Alloc<Token>(id_, span_id, str423);
      return t;
    }
...
lexer::Lexer* ParseContext::MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = Alloc<lexer::LineLexer>(str425, this->arena);
...
GLOBAL_LIST(Str*, 12, POSIX_CLASSES, {str438 COMMA str439 COMMA str440 COMMA str441 COMMA str442 COMMA str443 COMMA str444 COMMA str445 COMMA str446 COMMA str447 COMMA str448 COMMA str449});
Str* RANGE_POINT_TOO_LONG = str450;
int NT_OFFSET = 256;
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw Alloc<NotImplementedError>(str452);
  }
  if (id0 == Id::Op_LBracket) {
    elts = Alloc<List<syntax_asdl::expr_t*>>();
    for (int i = 0; i < n; i += 2) {
  ...
  while (i < n) {
    ...
    if ((prefix and prefix->id == Id::Expr_At)) {
      ...
      if (typ == nullptr) {
        ...
        if ((typ->val != str457 && typ->val != str458)) {
          p_die(fmt110(), typ);
        }
...
syntax_asdl::re_t* Transformer::_NameInRegex(syntax_asdl::Token* negated_tok, syntax_asdl::Token* tok) {
  ...
  val = tok->val;
  if (maybe_str_equals(val, str461)) {
    if (negated_tok) {
      p_die(fmt111(), tok);
    }
    return tok;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((str_equals(tok->val, str466) || str_equals(tok->val, str467) || str_equals(tok->val, str468))) {
        return tok;
      }
...
void AsPosixEre(syntax_asdl::re_t* node, List<Str*>* parts) {
  ...
  if (tag == re_e::Repeat) {
    ...
    if (op_tag == re_repeat_e::Range) {
      ...
      lower = op->lower ? op->lower->val : str485;
      upper = op->upper ? op->upper->val : str486;
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  flag = attrs->attrs;
  tmp_g = flag->get(str514);
  tmp_a = flag->get(str515);
  ...
  flag_A = (tmp_A and tmp_A->tag_() == value_e::Bool) ? static_cast<value__Bool*>(tmp_A)->b : false;
  tmp_n = flag->get(str517);
  tmp_r = flag->get(str518);
  tmp_x = flag->get(str519);
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if ((maybe_str_equals(flag_n, str521) and !cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_n, str522) and cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str523) and !cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str524) and cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str525) and !cell->exported)) {
      continue;
    }
    ...
    if (print_flags) {
      ...
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str533, str534->join(flags), str535, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str536, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (has_holes) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str539, name, str540, str(i), str541, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str543, str544->join(body), str545}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str547, key_quoted, str548, value_quoted}));
          }
          if (len(body) > 0) {
            decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str549, str550->join(body), str551}));
          }
        }
        else {
          ;  // pass
...
int Export::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r->Next();
  attrs = flag_spec::Parse(str553, arg_r);
...
int NewVar::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  flags = 0;
  if (maybe_str_equals(arg->x, str562)) {
    flags |= state::SetExport;
  }
  if (maybe_str_equals(arg->r, str563)) {
    flags |= state::SetReadOnly;
  }
  if (maybe_str_equals(arg->n, str564)) {
    flags |= state::SetNameref;
  }
  flags_to_clear = 0;
  if (maybe_str_equals(arg->x, str565)) {
    flags |= state::ClearExport;
  }
  if (maybe_str_equals(arg->r, str566)) {
    flags |= state::ClearReadOnly;
  }
  if (maybe_str_equals(arg->n, str567)) {
...
int Unset::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str568, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
...
int Eval::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str571, cmd_val);
  arg_r = tup0.at1();
  if (this->exec_opts->simple_eval_builtin()) {
    Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str572);
    code_str = tup1.at0();
    eval_spid = tup1.at1();
    if (!arg_r->AtEnd()) {
      e_usage(str573);
    ...
    code_str = str574->join(arg_r->Rest());
    eval_spid = cmd_val->arg_spids->index(0);
  }
  line_reader = reader::StringLineReader(code_str, this->arena);
  c_parser = this->parse_ctx->MakeOshParser(line_reader);
  src = Alloc<source::ArgvWord>(str575, eval_spid);
  {  // with
    dev::ctx_Tracer ctx(this->tracer, str576, nullptr);
...
int Source::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str577, cmd_val);
  arg_r = tup2.at1();
  path = arg_r->Peek();
  if (path == nullptr) {
    e_usage(str578);
  ...
  try {
    try {
      ...
      c_parser = this->parse_ctx->MakeOshParser(line_reader);
      {  // with
        dev::ctx_Tracer ctx(this->tracer, str580, cmd_val->argv);
...
int Command::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup3 = flag_spec::ParseCmdVal(str581, cmd_val);
  attrs = tup3.at0();
  arg_r = tup3.at1();
...
int Builtin::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (to_run == consts::NO_INDEX) {
    ...
    if (consts::LookupAssignBuiltin(name) != consts::NO_INDEX) {
      this->errfmt->Print_(str582, span_id);
    }
    else {
...
int RunProc::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str584, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
  ...
  spids = tup6.at1();
  if (len(argv) == 0) {
    throw Alloc<error::Usage>(str585, runtime::NO_SPID);
  }
  name = argv->index(0);
  if (!dict_contains(this->procs, name)) {
...
int Try::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup7 = flag_spec::ParseCmdVal(str587, cmd_val);
  attrs = tup7.at0();
  arg_r = tup7.at1();
  ...
  if ((arg->allow_status_01 and (status != 0 && status != 1))) {
    if (failure_spid != runtime::NO_SPID) {
      this->errfmt->Print_(str589, failure_spid);
      this->errfmt->StderrLine(str590);
    }
    throw Alloc<error::FatalRuntime>(fmt152(status), spids->index(0), status);
  }
  if (arg->assign != nullptr) {
    var_name = arg->assign;
    if (var_name->startswith(str592)) {
              ...
              if (consts::IsControlFlow(name)) {
                ...
                if (consts::IsKeyword(name)) {
                  ...
                  if (resolved == nullptr) {
                    ...
                    kind = (Alloc<Tuple2<Str*, Str*>>(str600, resolved));
                  }
                }
              }
            }
...
int Type::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseCmdVal(str601, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
...
int Read::_Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str615, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
  ...
  if (arg->line) {
    ...
    next_spid = tup8.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str618, next_spid);
    }
...
int MapFile::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup13 = flag_spec::ParseCmdVal(str629, cmd_val);
  attrs = tup13.at0();
  arg_r = tup13.at1();
  ...
  while (true) {
    ...
    if ((arg->t and line->endswith(str633))) {
      line = line->slice(0, -1);
    }
    lines->append(line);
  }
...
int Cd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str634, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  ...
  if (str_equals(dest_dir, str637)) {
    try {
      dest_dir = state::GetString(this->mem, str638);
      print(dest_dir);
    }
    catch (error::Runtime* e) {
      this->errfmt->Print_(e->UserErrorString());
  ...
  try {
    pwd = state::GetString(this->mem, str639);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    return 1;
  ...
  state::ExportGlobalString(this->mem, str641, real_dest_dir);
  ...
  if (block) {
    ...
    state::ExportGlobalString(this->mem, str642, pwd);
...
int Pushd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str648));
  state::ExportGlobalString(this->mem, str649, dest_dir);
...
bool _PopDirStack(state::Mem* mem, state::DirStack* dir_stack, ui::ErrorFormatter* errfmt) {
  ...
  state::SetGlobalString(mem, str652, dest_dir);
  mem->SetPwd(dest_dir);
  return true;
}
...
int Popd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str654));
  return 0;
}
...
int Dirs::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup17 = flag_spec::ParseCmdVal(str655, cmd_val);
  attrs = tup17.at0();
  arg_r = tup17.at1();
  arg = Alloc<arg_types::dirs>(attrs->attrs);
  home_dir = state::MaybeString(this->mem, str656);
  style = SINGLE_LINE;
  if (arg->l) {
    home_dir = nullptr;
  }
...
int Pwd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup18 = flag_spec::ParseCmdVal(str657, cmd_val);
  attrs = tup18.at0();
  arg_r = tup18.at1();
...
List<Str*>* Help::_Groups() {
  ...
  contents = this->loader->Get(str658);
...
int Help::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup19 = flag_spec::ParseCmdVal(str659, cmd_val);
  attrs = tup19.at0();
  arg_r = tup19.at1();
...
syntax_asdl::printf_part_t* _FormatStringParser::_ParseFormatStr() {
  ...
  if ((this->token_type == Id::Format_Type || this->token_type == Id::Format_Time)) {
    ...
    if (str_contains(str666, part->type->val)) {
      p_die(fmt166(), part->type);
    }
    if (maybe_str_equals(part->type->val, str668)) {
    ...
    for (ListIter<syntax_asdl::printf_part_t*> it(parts); !it.Done(); it.Next()) {
      ...
      if (part->tag_() == printf_part_e::Literal) {
        ...
        if (part->tag_() == printf_part_e::Percent) {
          ...
          if (str_equals(typ, str679)) {
            ...
            if (str_equals(typ, str680)) {
              ...
              if (str_equals(typ, str681)) {
                ...
                s = str682->join(c_parts);
              }
              else {
                if ((part->type->id == Id::Format_Time or str_contains(str683, typ))) {
                  try {
                    d = to_int(s);
                  }
                  catch (ValueError*) {
                    if ((len(s) >= 1 and str_contains(str684, s->index(0)))) {
                  ...
                  if (part->type->id == Id::Format_Time) {
                    ...
                    if ((d < 0 and str_contains(str688, typ))) {
                    ...
                    zero_pad = 0;
                    if ((width >= 0 and list_contains(flags, str693))) {
                      zero_pad = 1;
                    }
                    else {
                    ...
                    if (zero_pad) {
                      negative = str_equals(s->index(0), str694);
                      if (negative) {
                        digits = s->slice(1);
                        sign = str695;
                        if (zero_pad == 1) {
                      ...
                      s = str_concat(sign, digits->rjust(n, str697));
                    }
                  }
                }
                else {
          ...
          if (width >= 0) {
            if (list_contains(flags, str698)) {
              s = s->ljust(width, str699);
            }
            else {
              s = s->rjust(width, str700);
            }
          }
          out->append(s);
        }
...
int Printf::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup1 = flag_spec::ParseCmdVal(str701, cmd_val);
  attrs = tup1.at0();
  arg_r = tup1.at1();
  arg = Alloc<arg_types::printf>(attrs->attrs);
  Tuple2<Str*, int> tup2 = arg_r->ReadRequired2(str702);
  fmt = tup2.at0();
  fmt_spid = tup2.at1();
  ...
  if (dict_contains(this->parse_cache, fmt)) {
    ...
    {  // with
      alloc::ctx_Location ctx(arena, Alloc<source::ArgvWord>(str703, fmt_spid));
...
int Alias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str705, cmd_val);
  arg_r = tup0.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup1 = mylib::split_once(arg, str707);
    name = tup1.at0();
    alias_exp = tup1.at1();
...
int UnAlias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str710, cmd_val);
  arg_r = tup2.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
    e_usage(str711);
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  arg = flag_spec::ParseMore(str714, arg_r);
  if (arg->show_options) {
...
int Shopt::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str715, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
...
int Hash::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str717, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
...
Dict<Str*, bool>* _ParseOptSpec(Str* spec_str) {
  ...
  while (true) {
    ...
    if (str_equals(spec_str->index(i), str720)) {
      spec->set(ch, true);
      i += 1;
    }
  }
...
int GetOptsState::_OptInd() {
  int result;
  try {
    result = state::GetInteger(this->mem, str721);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    result = -1;
...
void GetOptsState::IncIndex() {
  state::BuiltinSetString(this->mem, str722, str((this->_optind + 1)));
}

void GetOptsState::SetArg(Str* optarg) {
  StackRoots _roots({&optarg});

  state::BuiltinSetString(this->mem, str723, optarg);
}

void GetOptsState::Fail() {
  state::BuiltinSetString(this->mem, str724, str725);
}
...
Tuple2<int, Str*> _GetOpts(Dict<Str*, bool>* spec, List<Str*>* argv, builtin_pure::GetOptsState* my_state, ui::ErrorFormatter* errfmt) {
  ...
  if (current == nullptr) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str726));
  }
  if ((!current->startswith(str727) or str_equals(current, str728))) {
    my_state->Fail();
  ...
  if (!dict_contains(spec, flag_char)) {
    return (Tuple2<int, Str*>(0, str730));
  }
  if (spec->index(flag_char)) {
    if (more_chars) {
      ...
      if (optarg == nullptr) {
        ...
        println_stderr(fmt182(str733->join(tmp)));
        return (Tuple2<int, Str*>(0, str734));
      }
    }
    my_state->IncIndex();
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  spec_str = arg_r->ReadRequired(str736);
  Tuple2<Str*, int> tup7 = arg_r->ReadRequired2(str737);
  var_name = tup7.at0();
  var_spid = tup7.at1();
...
int Echo::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseLikeEcho(str739, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  if (arg->e) {
    ...
    for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
      ...
      new_argv->append(str740->join(parts));
      if (backslash_c) {
        break;
      }
    }
...
int Module::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseCmdVal(str744, cmd_val);
  arg_r = tup11.at1();
  Tuple2<Str*, int> tup12 = arg_r->ReadRequired2(str745);
  name = tup12.at0();
...
int Use::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r->Next();
  if (str_equals(arg, str748)) {
    Tuple2<Str*, int> tup14 = arg_r->Peek2();
    expected = tup14.at0();
    e_spid = tup14.at1();
    if (expected == nullptr) {
      throw Alloc<error::Usage>(str749, runtime::NO_SPID);
    }
    UP_actual = this->mem->GetValue(str750, scope_e::Dynamic);
  ...
  throw Alloc<error::Usage>(str755, arg_spid);
}
...
int Shvar::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str756, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  block = typed_args::GetOneBlock(cmd_val->typed_args);
  if (!block) {
    throw Alloc<error::Usage>(str757, runtime::NO_SPID);
  }
  ...
  for (ListIter<Str*> it(args); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup17 = mylib::split_once(arg, str759);
    name = tup17.at0();
    s = tup17.at1();
    if (s == nullptr) {
      throw Alloc<error::Usage>(str760, arg_spids->index(i));
    }
    ...
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          t = val->s;
          if (len(t) == 0) {
            throw Alloc<error::RedirectEval>(str772, arg_word);
            return nullptr;
          }
          try {
            if (maybe_str_equals(t, str773)) {
              result->arg = Alloc<redirect_arg::CloseFd>();
            }
            else {
              if (str_equals(t->index(-1), str774)) {
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = Alloc<redirect_arg::HereDoc>(str_concat(val->s, str776));
            return result;
          }
          else {
            throw Alloc<AssertionError>();
    ...
    case command_e::ControlFlow: {
      ...
      if (ok) {
        ...
        if (this->exec_opts->strict_control_flow()) {
          ...
          this->errfmt->PrefixPrint(msg, str786, tok->span_id);
          status = 0;
        }
      }
    }
    ...
    {  // with
      ...
      for (ListIter<syntax_asdl::command_t*> it(to_run); !it.Done(); it.Next()) {
        ...
        {  // with
          ...
          {  // with
            dev::ctx_Tracer ctx(this->tracer, str789, nullptr);
      ...
      if (this->shell_ex->PushRedirects(redirects)) {
        {  // with
          ...
          try {
            ...
            this->errfmt->PrettyPrintError(e, str790);
            status = 1;
            check_errexit = true;
          }
        }
...
Tuple2<bool, bool> CommandEvaluator::ExecuteAndCatch(syntax_asdl::command_t* node, int cmd_flags) {
  ...
  try {
    ...
    if ((cmd_flags & RaiseControlFlow)) {
      ...
      if (e->IsReturn()) {
        ...
        this->errfmt->Print_(str791, e->token->span_id);
        is_fatal = true;
        status = 1;
      }
    }
  ...
  if (err) {
    ...
    if (is_errexit) {
      ...
      this->errfmt->PrettyPrintError(err, str792);
    }
  }
...
void CommandEvaluator::MaybeRunExitTrap(List<int>* mut_status) {
  ...
  handler = this->traps->get(str793);
  if (handler) {
    {  // with
      dev::ctx_Tracer ctx(this->tracer, str794, nullptr);
    ...
    if (UP_sig->tag_() == proc_sig_e::Closed) {
      ...
      for (ListIter<syntax_asdl::UntypedParam*> it(sig->untyped); !it.Done(); it.Next(), ++i) {
        ...
        if (i < n_args) {
          ...
          if (is_out_param) {
            param_name = str_concat(str795, param_name);
            if (!arg_str->startswith(str796)) {
...
int CommandEvaluator::RunFuncForCompletion(runtime_asdl::Proc* proc, List<Str*>* argv) {
  ...
  try {
    ...
    this->errfmt->Print_(str801, e->token->span_id);
    status = 1;
  }
  return status;
}
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index(i), str803))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index(-2), str805)) {
    ...
    if ((left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse)) {
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        var_name = left_token->val->slice(0, -1);
        if (str_equals(close_token->val->index(-2), str807)) {
          op = assign_op_e::PlusEqual;
        }
        else {
          op = assign_op_e::Equal;
        ...
        src = Alloc<source::Reparsed>(str809, left_token->span_id, close_token->span_id);
        {  // with
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    if (str_equals(left_token->val->index(-2), str811)) {
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index(0), str819)) {
    pos = op_val->find(str820);
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    i += 1;
    if (!alias_exp->endswith(str826)) {
      expanded->append(str827);
      break;
    }
  }
  if (len(expanded) == 0) {
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if (str_equals(c, str856)) {
      i += 1;
    }
    else {
      if ((str_equals(c, str857) or str_equals(c, str858))) {
        return true;
      }
      else {
        if (str_equals(c, str859)) {
          left_bracket = true;
        }
        else {
          if ((str_equals(c, str860) and left_bracket)) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  ...
  return pyutil::BackslashEscape(s, str862);
}
Str* ERE_META_CHARS = str863;
...
Str* GlobUnescape(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if ((str_equals(c, str864) and i != (n - 1))) {
      i += 1;
      c2 = s->index(i);
...
Str* _REGEX_CHARS_TO_ESCAPE = str871;
...
Str* _PromptEvaluatorCache::Get(Str* name) {
  ...
  if (str_equals(name, str891)) {
    value = this->_GetEuid() == 0 ? str892 : str893;
  }
  else {
      ...
      if (id_ == Id::PS_Octal3) {
        ...
        if (id_ == Id::PS_LBrace) {
          ...
          if (id_ == Id::PS_RBrace) {
            ...
            if (id_ == Id::PS_Subst) {
              ch = value->index(1);
              if (str_equals(ch, str898)) {
                r = this->cache->Get(str899);
              }
              else {
                if (str_equals(ch, str900)) {
                  ...
                  if (str_equals(ch, str902)) {
                    hostname = this->cache->Get(str903);
                    Tuple2<Str*, Str*> tup1 = mylib::split_once(hostname, str904);
                    r = tup1.at0();
                  }
                  else {
                      ...
                      if (str_equals(ch, str907)) {
                        ...
                        if (str_equals(ch, str908)) {
                          ...
                          if (str_equals(ch, str909)) {
                            now = time_::time();
                            r = time_::strftime(str910, time_::localtime(now));
                          }
                          else {
                            if (str_equals(ch, str911)) {
                              ...
                              if (str_equals(ch, str913)) {
                                try {
                                  pwd = state::GetString(this->mem, str914);
                                  home = state::MaybeString(this->mem, str915);
                                ...
                                if (str_equals(ch, str917)) {
                                  val = this->mem->GetValue(str918);
                                  if (val->tag_() == value_e::Str) {
                                    value__Str* str_val = static_cast<value__Str*>(val);
              ...
              ret->append(r->replace(str921, str922));
            }
            else {
              throw Alloc<AssertionError>();
            }
...
Str* Evaluator::EvalFirstPrompt() {
  ...
  if (str_equals(this->lang, str927)) {
    val = this->mem->GetValue(str928);
    return this->EvalPrompt(val);
  }
  else {
    return str_concat(this->lang, str929);
  }
}
Str* PROMPT_COMMAND = str930;
...
runtime_asdl::lvalue_t* UnsafeArith::ParseLValue(Str* s, int span_id) {
  ...
  {  // with
    alloc::ctx_Location ctx(this->arena, Alloc<source::ArgvWord>(str936, span_id));
...
int ArithEvaluator::_StringToInteger(Str* s, int span_id) {
  ...
  if (str_contains(s, str944)) {
    Tuple2<Str*, Str*> tup0 = mylib::split_once(s, str945);
    b = tup0.at0();
    digits = tup0.at1();
    try {
      base = to_int(b);
    ...
    for (StrIter it(digits); !it.Done(); it.Next()) {
      ...
      StackRoots _for({&ch    });
      if (IsLower(ch)) {
        digit = ((ord(ch) - ord(str947)) + 10);
      }
      else {
        if (IsUpper(ch)) {
          digit = ((ord(ch) - ord(str948)) + 36);
        }
        else {
  ...
  if (((val->tag_() == value_e::MaybeStrArray || val->tag_() == value_e::AssocArray) and lval->tag_() == lvalue_e::Named)) {
    ...
    if (word_eval::ShouldArrayDecay(named_lval->name, this->exec_opts)) {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (val->tag_() == value_e::AssocArray) {
          lval = Alloc<lvalue::Keyed>(named_lval->name, str959);
        }
      }
...
split::IfsSplitter* SplitContext::_GetSplitter(Str* ifs) {
  ...
  if (ifs == nullptr) {
    val = this->mem->GetValue(str972, scope_e::Dynamic);
    UP_val = val;
    switch (val->tag_()) {
      case value_e::Undef: {
        ifs = DEFAULT_IFS;
...
Str* SplitContext::GetJoinChar() {
  ...
  val = this->mem->GetValue(str975, scope_e::Dynamic);
  UP_val = val;
  switch (val->tag_()) {
    case value_e::Undef: {
      return str976;
...
_BaseSplitter::_BaseSplitter(Str* escape_chars) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(_BaseSplitter)) {
  this->escape_chars = str_concat(escape_chars, str979);
}
    ...
    if (i < n) {
      ...
      if (str_contains(ws_chars, c)) {
        ...
        if (str_contains(other_chars, c)) {
          ...
          if ((allow_escape and str_equals(c, str980))) {
...
Str* Utf8Encode(int code) {
  ...
  return str983->join(tmp);
}
Str* INCOMPLETE_CHAR = str984;
Str* INVALID_CONT = str985;
Str* INVALID_START = str986;
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Pound) {
    regex = str_concat(str999, regex);
  }
  else {
    if (op->replace_mode == Id::Lit_Percent) {
      regex = str_concat(regex, str1000);
    }
  }
...
Str* ShellQuoteB(Str* s) {
  ...
  s = s->replace(str1001, str1002)->replace(str1003, str1004);
  return pyutil::BackslashEscape(s, str1005);
}
...
int QUOTE_ERE = (1 << 6);
GLOBAL_LIST(Str*, 3, _STRING_AND_ARRAY, {str1018 COMMA str1019 COMMA str1020});
...
runtime_asdl::value_t* DecayArray(runtime_asdl::value_t* val) {
  ...
  if (val->tag_() == value_e::MaybeStrArray) {
    ...
    if (val->tag_() == value_e::AssocArray) {
      value__AssocArray* assoc_val = static_cast<value__AssocArray*>(val);
      s = dict_contains(assoc_val->d, str1021) ? assoc_val->d->index(str1022) : nullptr;
    }
    else {
      throw Alloc<AssertionError>();
    }
...
runtime_asdl::assign_arg* _SplitAssignArg(Str* arg, int word_spid) {
  ...
  if (len(op)) {
    ...
    append = str_equals(op->index(0), str1025);
  }
  else {
    val = nullptr;
    append = false;
...
Str* _BackslashEscape(Str* s) {
  ...
  return s->replace(str1026, str1027);
}
...
runtime_asdl::part_value_t* _ValueToPartValue(runtime_asdl::value_t* val, bool quoted) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      return Alloc<part_value::String>(str1028, quoted, !quoted);
    }
      break;
    case value_e::Str: {
      value__Str* val = static_cast<value__Str*>(UP_val);
...
Str* TildeEvaluator::Eval(syntax_asdl::Token* token) {
  ...
  if (maybe_str_equals(token->val, str1040)) {
    val = this->mem->GetValue(str1041);
    UP_val = val;
    if (val->tag_() == value_e::Str) {
      value__Str* val = static_cast<value__Str*>(UP_val);
      return val->s;
    ...
    case value_e::Str: {
      ...
      try {
        ...
        if (this->exec_opts->strict_word_eval()) {
          ...
          this->errfmt->PrettyPrintError(e, str1045);
          return Alloc<value::Str>(str1046);
        }
      }
    }
      break;
  ...
  if (op_id == Id::VOp0_P) {
    switch (val->tag_()) {
      case value_e::Str: {
        ...
        p = prompt->replace(str1054, str1055)->replace(str1056, str1057);
    ...
    if (op_id == Id::VOp0_Q) {
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          result = Alloc<value::Str>(str1059->join(tmp));
        }
          break;
        default: {
      ...
      if (op_id == Id::VOp0_a) {
        ...
        result = Alloc<value::Str>(str1066->join(chars));
      }
      else {
...
void AbstractWordEvaluator::_EvalDoubleQuoted(List<syntax_asdl::word_part_t*>* parts, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  if (len(parts) == 0) {
    v = Alloc<part_value::String>(str1071, true, false);
    part_vals->append(v);
    return ;
  }
  for (ListIter<syntax_asdl::word_part_t*> it(parts); !it.Done(); it.Next()) {
...
runtime_asdl::value_t* AbstractWordEvaluator::_EmptyStrOrError(runtime_asdl::value_t* val, syntax_asdl::Token* token) {
  ...
  if (!this->exec_opts->nounset()) {
    return Alloc<value::Str>(str1072);
  }
  name = token->val->startswith(str1073) ? token->val->slice(1) : token->val;
...
void AbstractWordEvaluator::_EvalExtGlob(syntax_asdl::word_part__ExtGlob* part, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  part_vals->append(Alloc<part_value::String>(str1085, false, false));
}
    ...
    case word_e::Compound: {
      ...
      if (has_extglob) {
        if (to_bool((eval_flags & EXTGLOB_FILES))) {
          ...
          glob_pat = str1091->join(glob_parts);
          fnmatch_pat = str1092->join(fnmatch_parts);
          results = Alloc<List<Str*>>();
      ...
      break;
    case word_e::Empty: {
      part_vals->append(Alloc<part_value::String>(str1095, quoted, !quoted));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, int eval_flags) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return Alloc<value::Str>(str1099);
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  part_vals = Alloc<List<runtime_asdl::part_value_t*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
  ...
  return Alloc<value::Str>(str1100->join(strs));
}
...
Tuple2<runtime_asdl::value__Str*, bool> AbstractWordEvaluator::EvalWordToPattern(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return (Tuple2<runtime_asdl::value__Str*, bool>(Alloc<value::Str>(str1101), false));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  has_extglob = false;
  part_vals = Alloc<List<runtime_asdl::part_value_t*>>();
  ...
  return (Tuple2<runtime_asdl::value__Str*, bool>(Alloc<value::Str>(str1102->join(strs)), has_extglob));
}
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index(-2), str1113)) {
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        StackRoots _for({&arg      });
        if ((arg->startswith(str1114) or arg->startswith(str1115))) {
          flags->append(arg);
          flag_spids->append(word_spid);
          if ((str_contains(arg, str1116) or str_contains(arg, str1117))) {
            eval_to_pairs = false;
          }
        }
        else {
...
runtime_asdl::part_value__String* CompletionWordEvaluator::_EvalProcessSub(syntax_asdl::command_sub* cs_part) {
  ...
  return Alloc<part_value::String>(str1121, true, false);
}
          ...
          if (op_kind == Kind::VOp2) {
            if (this->token_type == Id::VOp2_Slash) {
              ...
              if (this->token_type == Id::VOp2_Colon) {
                ...
                p_die(fmt328(str1133), this->cur_token);
              }
            }
          }
          else {
            if (op_kind == Kind::VOp3) {
              if (allow_query) {
                ...
                p_die(fmt329(str1135), this->cur_token);
              }
            }
          }
        }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool is_oil_expr) {
  ...
  while (num_end_tokens < expected_end_tokens) {
    ...
    if ((this->token_kind == Kind::Lit || this->token_kind == Kind::Char)) {
      tok = this->cur_token;
      if ((no_backslashes and str_contains(tok->val, str1140))) {
        p_die(fmt334(), tok);
      }
      if (is_oil_expr) {
...
syntax_asdl::word_part_t* WordParser::_ReadUnquotedLeftParts(bool try_triple_quote, List<bool>* triple_out) {
  ...
  if ((this->token_type == Id::Left_SingleQuote || this->token_type == Id::Left_RSingleQuote || this->token_type == Id::Left_DollarSingleQuote)) {
    ...
    if ((try_triple_quote and len(sq_part->tokens) == 0)) {
      if (str_equals(this->lexer->ByteLookAhead(), str1147)) {
        this->_Next(lex_mode_e::ShCommand);
        this->_Peek();
  ...
  if ((left_id == Id::Left_DollarParen || left_id == Id::Left_AtParen || left_id == Id::Left_ProcSubIn || left_id == Id::Left_ProcSubOut)) {
    ...
    if ((left_id == Id::Left_Backtick and this->parse_ctx->one_pass_parse)) {
      ...
      if (left_id == Id::Left_Backtick) {
        ...
        right_spid = this->cur_token->span_id;
        code_str = str1155->join(parts);
        arena = this->parse_ctx->arena;
        line_reader = reader::StringLineReader(code_str, arena);
        c_parser = this->parse_ctx->MakeOshParser(line_reader);
        src = Alloc<source::Reparsed>(str1156, left_spid, right_spid);
        {  // with
          alloc::ctx_Location ctx(arena, src);
            ...
            if (this->token_type == Id::Lit_Dollar) {
              if (!this->parse_opts->parse_dollar()) {
                if ((num_parts == 0 and lex_mode == lex_mode_e::ShCommand)) {
                  ...
                  if (str_equals(next_byte, str1172)) {
          ...
          if ((this->token_kind == Kind::VSub || this->token_kind == Kind::Lit || this->token_kind == Kind::History || this->token_kind == Kind::Left || this->token_kind == Kind::KW || this->token_kind == Kind::ControlFlow || this->token_kind == Kind::BoolUnary || this->token_kind == Kind::BoolBinary || this->token_kind == Kind::ExtGlob)) {
            if (this->token_type == Id::Lit_Pound) {
              ...
              if (this->token_type == Id::Lit_TPound) {
                ...
                if ((this->parse_opts->parse_raw_string() and (this->token_type == Id::Lit_Chars and maybe_str_equals(this->cur_token->val, str1180)))) {
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      ...
      break;
    case word_part_e::AssocArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1186, false));
    }
      break;
    case word_part_e::Literal: {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str1188, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str1189->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
    ...
    case word_part_e::FuncCall: 
    case word_part_e::ExprSub: {
      return (Tuple3<bool, Str*, bool>(false, str1190, false));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str1192, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str1193->join(strs), quoted));
}
...
syntax_asdl::compound_word* TildeDetect(syntax_asdl::word_t* UP_w) {
  ...
  if ((id_ == Id::Lit_Chars and static_cast<Token*>(part1)->val->startswith(str1195))) {
    new_parts->extend(w->parts->slice(1));
    return Alloc<compound_word>(new_parts);
  }
  return nullptr;
...
void TildeDetectAssign(syntax_asdl::compound_word* w) {
  ...
  for (int i = 0; i < n; ++i) {
    ...
    if ((do_expand and LiteralId(cur) == Id::Lit_TildeLike)) {
      ...
      if (next_part) {
        is_tilde = (LiteralId(next_part) == Id::Lit_Colon or (LiteralId(next_part) == Id::Lit_Chars and static_cast<Token*>(next_part)->val->startswith(str1196)));
      }
      else {
        is_tilde = true;
      }
...
Str* join(Str* s1, Str* s2) {
  ...
  if ((s2->startswith(str1214) or len(s1) == 0)) {
    return s2;
  }
  if (s1->endswith(str1215)) {
...
Tuple2<Str*, Str*> _splitext(Str* p, Str* sep, Str* extsep) {
  ...
  return (Tuple2<Str*, Str*>(p, str1218));
}
...
Str* normpath(Str* path) {
  ...
  slash = str1221;
  dot = str1222;
  if (str_equals(path, str1223)) {
    return dot;
  }
  initial_slashes = path->startswith(str1224);
  if ((initial_slashes and (path->startswith(str1225) and !path->startswith(str1226)))) {
    initial_slashes = 2;
  }
  comps = path->split(str1227);
  new_comps = Alloc<List<Str*>>();
  for (ListIter<Str*> it(comps); !it.Done(); it.Next()) {
    Str* comp = it.Value();
    StackRoots _for({&comp  });
    if ((len(comp) == 0 or str_equals(comp, str1228))) {
      continue;
    }
    if ((!(str_equals(comp, str1229)) or ((initial_slashes == 0 and len(new_comps) == 0) or (len(new_comps) and str_equals(new_comps->index(-1), str1230))))) {
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if ((str_contains(str1237, ch) or IsUnprintableLow(ch))) {
        quote = 2;
        break;
      }
    }
  ...
  parts->append(str1240);
  return str_concat(prefix, str1241->join(parts));
}
...
Str* maybe_encode(Str* s, int bit8_display) {
  ...
  parts->append(str1243);
  return str1244->join(parts);
}
...
Str* encode(Str* s, int bit8_display) {
  ...
  _encode(s, bit8_display, false, parts);
  parts->append(str1246);
  return str1247->join(parts);
}
          ...
          if (str_equals(byte, str1254)) {
            ...
            if (str_equals(byte, str1256)) {
              ...
              if (str_equals(byte, str1258)) {
                part = shell_compat ? str1259 : str1260;
              }
              else {
            ...
            if (str_equals(byte, str1270)) {
              ...
              if (str_equals(byte, str1272)) {
                ...
                if (str_equals(byte, str1274)) {
                  out = shell_compat ? str1275 : str1276;
                }
                else {
                  if (IsUnprintableLow(byte)) {
...
syntax_asdl::word__String* _StringWordEmitter::ReadWord(types_asdl::lex_mode_t unused_lex_mode) {
  ...
  if (this->i == this->n) {
    w = Alloc<word::String>(Id::Eof_Real, str1277, runtime::NO_SPID);
    return w;
  }
...
syntax_asdl::bool_expr_t* _ThreeArgs(builtin_bracket::_StringWordEmitter* w_parser) {
  ...
  if (maybe_str_equals(w1->s, str1286)) {
    return Alloc<bool_expr::LogicalOr>(Alloc<bool_expr::WordTest>(w0), Alloc<bool_expr::WordTest>(w2));
  }
  if (maybe_str_equals(w0->s, str1287)) {
    w_parser->Rewind(2);
    child = _TwoArgs(w_parser);
    return Alloc<bool_expr::LogicalNot>(child);
  }
  if ((maybe_str_equals(w0->s, str1288) and maybe_str_equals(w2->s, str1289))) {
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    ...
    strs = cmd_val->argv;
    if ((!strs or !(str_equals(strs->index(-1), str1292)))) {
      this->errfmt->Print_(str1293, cmd_val->arg_spids->index(0));
      return 2;
    }
    cmd_val->argv->pop();
  ...
  try {
    ...
    if (n == 4) {
      a0 = w_parser->Peek(0);
      if (str_equals(a0, str1295)) {
        w_parser->Read();
        child = _ThreeArgs(w_parser);
        bool_node = Alloc<bool_expr::LogicalNot>(child);
      }
      else {
        if ((str_equals(a0, str1296) and str_equals(w_parser->Peek(3), str1297))) {
          w_parser->Read();
          bool_node = _TwoArgs(w_parser);
        }
        else {
  ...
  try {
    ...
    this->errfmt->PrettyPrintError(e, str1299);
    return 2;
  }
  status = b ? 0 : 1;
  return status;

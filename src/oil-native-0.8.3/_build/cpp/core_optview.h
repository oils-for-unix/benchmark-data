...
class Parse : public _View {
 public:
  ...
  bool strict_backslash() { return _Get(option_i::strict_backslash); }
  bool strict_backticks() { return _Get(option_i::strict_backticks); }
  bool strict_dollar() { return _Get(option_i::strict_dollar); }
  bool parse_at() { return _Get(option_i::parse_at); }
  bool parse_brace() { return _Get(option_i::parse_brace); }
  bool parse_index_expr() { return _Get(option_i::parse_index_expr); }
  bool parse_paren() { return _Get(option_i::parse_paren); }
  bool parse_rawc() { return _Get(option_i::parse_rawc); }
...
class Exec : public _View {
 public:
  ...
  bool strict_echo() { return _Get(option_i::strict_echo); }
  bool strict_errexit() { return _Get(option_i::strict_errexit); }
  bool strict_eval_builtin() { return _Get(option_i::strict_eval_builtin); }

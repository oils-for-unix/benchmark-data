...
const char* option_str(int tag) {
  ...
  case option::strict_backslash:
    return "option.strict_backslash";
  case option::strict_backticks:
    return "option.strict_backticks";
  case option::strict_dollar:
    return "option.strict_dollar";

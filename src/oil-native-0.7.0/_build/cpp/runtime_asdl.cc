...
hnode_t* cmd_value__Assign::PrettyTree() {
  ...
  List<field*>* L = out_node->fields;
    hnode_t* x0 = new hnode__Leaf(new Str(builtin_str(this->builtin_id)),
                                  color_e::TypeName);
...
hnode_t* arg_vector::PrettyTree() {
  hnode__Record* out_node = runtime::NewRecord(new Str("arg_vector"));
  List<field*>* L = out_node->fields;
...
hnode_t* arg_vector::_AbbreviatedTree() {
  hnode__Record* out_node = runtime::NewRecord(new Str("arg_vector"));
  List<field*>* L = out_node->fields;
    if (this->strs && len(this->strs)) {  // ArrayType
      hnode__Array* x0 = new hnode__Array(new List<hnode_t*>());
...
hnode_t* arg_vector::AbbreviatedTree() {
  return _AbbreviatedTree();
}
...
hnode_t* cell::PrettyTree() {
  ...
  List<field*>* L = out_node->fields;
    hnode_t* x0 = this->val->PrettyTree();
    L->append(new field(new Str("val"), x0));

    hnode_t* x1 = new hnode__Leaf(this->exported ? runtime::TRUE_STR :
                                  runtime::FALSE_STR, color_e::OtherConst);
    L->append(new field(new Str("exported"), x1));

    hnode_t* x2 = new hnode__Leaf(this->readonly ? runtime::TRUE_STR :
                                  runtime::FALSE_STR, color_e::OtherConst);
    L->append(new field(new Str("readonly"), x2));
...
hnode_t* cell::_AbbreviatedTree() {
  hnode__Record* out_node = runtime::NewRecord(new Str("cell"));
  List<field*>* L = out_node->fields;
    hnode_t* x0 = this->val->AbbreviatedTree();
    L->append(new field(new Str("val"), x0));
...
const char* var_flags_str(var_flags_e tag) {
  switch (tag) {
  case var_flags_e::Exported:
    return "var_flags.Exported";
  case var_flags_e::ReadOnly:
    return "var_flags.ReadOnly";
  default:
    assert(0);
  }
}
...
const char* job_status_str(int tag) {
  switch (tag) {
  case job_status_e::Process:
    return "job_status.Process";
...
hnode_t* job_status__Process::PrettyTree() {
  hnode__Record* out_node = runtime::NewRecord(new Str("job_status.Process"));
  List<field*>* L = out_node->fields;
    hnode_t* x0 = new hnode__Leaf(str(this->status), color_e::OtherConst);
    L->append(new field(new Str("status"), x0));

  return out_node;
}

hnode_t* job_status__Process::_AbbreviatedTree() {
  hnode__Record* out_node = runtime::NewRecord(new Str("job_status.Process"));
  List<field*>* L = out_node->fields;
    hnode_t* x0 = new hnode__Leaf(str(this->status), color_e::OtherConst);
    L->append(new field(new Str("status"), x0));
...
hnode_t* job_status__Process::AbbreviatedTree() {
  return _AbbreviatedTree();
}
...
hnode_t* job_status__Pipeline::PrettyTree() {
  ...
  List<field*>* L = out_node->fields;
    if (this->statuses && len(this->statuses)) {  // ArrayType
      hnode__Array* x0 = new hnode__Array(new List<hnode_t*>());
      for (ListIter<int>it(this->statuses); !it.Done(); it.Next()) {
        int i0 = it.Value();
        x0->children->append(new hnode__Leaf(str(i0), color_e::OtherConst));
      }
      L->append(new field(new Str("statuses"), x0));
    }
...
hnode_t* job_status_t::PrettyTree() {
  switch (this->tag_()) {
  case job_status_e::Process: {
    job_status__Process* obj = static_cast<job_status__Process*>(this);
    return obj->PrettyTree();
  }
  case job_status_e::Pipeline: {

...
GLOBAL_STR(str44, "\u001b[0;0m");
GLOBAL_STR(str45, "\u001b[1m");
GLOBAL_STR(str46, "\u001b[4m");
GLOBAL_STR(str47, "\u001b[7m");
GLOBAL_STR(str48, "\u001b[31m");
GLOBAL_STR(str49, "\u001b[32m");
GLOBAL_STR(str50, "\u001b[33m");
GLOBAL_STR(str51, "\u001b[34m");
GLOBAL_STR(str52, "proc");
GLOBAL_STR(str53, "source");
GLOBAL_STR(str54, "?");
GLOBAL_STR(str55, "(");
GLOBAL_STR(str56, ")");
GLOBAL_STR(str57, " ");
GLOBAL_STR(str58, "(");
GLOBAL_STR(str59, "[%s]=%s");
GLOBAL_STR(str60, ")");
GLOBAL_STR(str61, " ");
GLOBAL_STR(str62, " ");
GLOBAL_STR(str63, "\n");
...
GLOBAL_STR(str66, "");
GLOBAL_STR(str67, "");
GLOBAL_STR(str68, "SHX_indent");
GLOBAL_STR(str69, "SHX_punct");
GLOBAL_STR(str70, "SHX_pid_str");
GLOBAL_STR(str71, "PS4");
GLOBAL_STR(str72, "");
GLOBAL_STR(str73, "<ERROR: Can't parse PS4: %s>");
GLOBAL_STR(str74, "");
GLOBAL_STR(str75, "  ");
GLOBAL_STR(str76, "+");
GLOBAL_STR(str77, "|");
GLOBAL_STR(str78, "command %d:");
GLOBAL_STR(str79, "forkwait %d\n");
GLOBAL_STR(str80, "command sub %d\n");
GLOBAL_STR(str81, "proc sub %d\n");
GLOBAL_STR(str82, "here doc %d\n");
GLOBAL_STR(str83, "fork %d\n");
GLOBAL_STR(str84, "part %d\n");
GLOBAL_STR(str85, ";");
GLOBAL_STR(str86, "process %d: status %d\n");
GLOBAL_STR(str87, " %d");
GLOBAL_STR(str88, ">");
GLOBAL_STR(str89, "proc");
GLOBAL_STR(str90, "source");
GLOBAL_STR(str91, "wait");
GLOBAL_STR(str92, "\n");
GLOBAL_STR(str93, "<");
GLOBAL_STR(str94, " ");
GLOBAL_STR(str95, "\n");
...
GLOBAL_STR(str97, "\n");
GLOBAL_STR(str98, ".");
GLOBAL_STR(str99, "exec");
GLOBAL_STR(str100, ".");
GLOBAL_STR(str101, "builtin");
GLOBAL_STR(str102, " ");
GLOBAL_STR(str103, "\n");
GLOBAL_STR(str104, " ");
GLOBAL_STR(str105, " ");
...
GLOBAL_STR(str107, "\n");
GLOBAL_STR(str108, "?");
GLOBAL_STR(str109, "%s[%d]");
GLOBAL_STR(str110, "%s[%s]");
GLOBAL_STR(str111, "+=");
GLOBAL_STR(str112, "=");
GLOBAL_STR(str113, "\n");
GLOBAL_STR(str114, "+");
...
GLOBAL_STR(str118, " ...");
GLOBAL_STR(str119, "\n");
GLOBAL_STR(str120, "<_ControlFlow %s>");
GLOBAL_STR(str121, "Invalid control flow %r in pipeline / subshell / background");
GLOBAL_STR(str122, "%r ");
GLOBAL_STR(str123, "Command evaluated to an empty argv array");
GLOBAL_STR(str124, "Can't run assignment builtin recursively");
GLOBAL_STR(str125, "errexit was disabled for this construct");
GLOBAL_STR(str126, "");
GLOBAL_STR(str127, "Can't run a proc while errexit is disabled. Use 'try' or wrap it in a process with $0 myproc");
GLOBAL_STR(str128, "proc");
GLOBAL_STR(str129, "Unexpected typed args passed to external command %r");
GLOBAL_STR(str130, "%r not found");
GLOBAL_STR(str131, "pipeline");
GLOBAL_STR(str132, "Command subs not allowed here because status wouldn't be checked (strict_errexit).");
GLOBAL_STR(str133, "__cat");
GLOBAL_STR(str134, "osh I/O error: %s");
GLOBAL_STR(str135, "Command Sub exited with status %d");
GLOBAL_STR(str136, "");
GLOBAL_STR(str137, "\n");
GLOBAL_STR(str138, "Process subs not allowed here because status wouldn't be checked (strict_errexit).");
GLOBAL_STR(str139, "/dev/fd/%d");
GLOBAL_STR(str140, "/dev/fd/%d");
GLOBAL_STR(str141, "");
GLOBAL_STR(str142, "main");
GLOBAL_STR(str143, "osh usage error: %s");
GLOBAL_STR(str144, "%s-usage");
GLOBAL_STR(str145, "Oil");
GLOBAL_STR(str146, "main");
GLOBAL_STR(str147, "oil");
GLOBAL_STR(str148, "oil:all");
GLOBAL_STR(str149, "--one-pass-parse requires noexec (-n)");
GLOBAL_STR(str150, "completion");
GLOBAL_STR(str151, "history");
GLOBAL_STR(str152, "");
GLOBAL_STR(str153, "OSH_DEBUG_DIR");
GLOBAL_STR(str154, "%d-osh.log");
GLOBAL_STR(str155, "Writing logs to %r");
GLOBAL_STR(str156, "OSH_HIJACK_SHEBANG");
GLOBAL_STR(str157, "");
GLOBAL_STR(str158, "OSH_CRASH_DUMP_DIR");
GLOBAL_STR(str159, "");
GLOBAL_STR(str160, "");
GLOBAL_STR(str161, "osh: Couldn't open %r: %s");
GLOBAL_STR(str162, "/proc/%d/status");
GLOBAL_STR(str163, "--parser-mem-dump can only be used with -n");
GLOBAL_STR(str164, "/proc/%d/status");
GLOBAL_STR(str165, "Can't run a proc while errexit is disabled. Use 'try' or wrap it in a process with $0 myproc");
GLOBAL_STR(str166, "Unhandled SimpleCommand");
GLOBAL_STR(str167, "\n");
GLOBAL_STR(str168, "<_FdFrame %s>");
GLOBAL_STR(str169, "r");
GLOBAL_STR(str170, "%d: %s");
GLOBAL_STR(str171, "%d: %s");
GLOBAL_STR(str172, "%d: %s");
GLOBAL_STR(str173, "Can't open %r: %s");
GLOBAL_STR(str174, "Error closing descriptor %d: %s");
GLOBAL_STR(str175, "dup2(%d, %d) error: %s");
GLOBAL_STR(str176, "<StdinFromPipe %d %d>");
GLOBAL_STR(str177, "<StdoutToPipe %d %d>");
GLOBAL_STR(str178, "Hijacked: %s");
GLOBAL_STR(str179, "/bin/sh");
GLOBAL_STR(str180, "/bin/sh");
GLOBAL_STR(str181, "Can't execute %r: %s");
GLOBAL_STR(str182, "[process] %s");
GLOBAL_STR(str183, " ");
GLOBAL_STR(str184, "[subprog] %s");
GLOBAL_STR(str185, "");
GLOBAL_STR(str186, "osh I/O error: %s");
GLOBAL_STR(str187, "[here doc writer]");
GLOBAL_STR(str188, "<Process %s %s>");
GLOBAL_STR(str189, "  ");
GLOBAL_STR(str190, "%%%d");
GLOBAL_STR(str191, "%d\n");
GLOBAL_STR(str192, "%s %d %7s ");
GLOBAL_STR(str193, "\n");
GLOBAL_STR(str194, "Fatal error in posix.fork()");
GLOBAL_STR(str195, "%d\n");
GLOBAL_STR(str196, "%%%d");
GLOBAL_STR(str197, "  ");
GLOBAL_STR(str198, "%s %d %7s ");
GLOBAL_STR(str199, "\n");
GLOBAL_STR(str200, "Pipeline in state %s");
GLOBAL_STR(str201, "\n");
GLOBAL_STR(str202, "[process debug info]\n");
GLOBAL_STR(str203, "\n");
GLOBAL_STR(str204, "[pipeline debug info]\n");
GLOBAL_STR(str205, "osh: PID %d stopped, but osh didn't start it");
GLOBAL_STR(str206, "");
GLOBAL_STR(str207, "");
GLOBAL_STR(str208, "[PID %d] Stopped");
GLOBAL_STR(str209, "");
GLOBAL_STR(str210, "main");
GLOBAL_STR(str211, "osh usage error: %s");
GLOBAL_STR(str212, "%s-usage");
GLOBAL_STR(str213, "Oil");
GLOBAL_STR(str214, "main");
GLOBAL_STR(str215, "oil");
GLOBAL_STR(str216, "oil:all");
GLOBAL_STR(str217, "--one-pass-parse requires noexec (-n)");
GLOBAL_STR(str218, "completion");
GLOBAL_STR(str219, "history");
GLOBAL_STR(str220, "");
GLOBAL_STR(str221, "OSH_DEBUG_DIR");
GLOBAL_STR(str222, "%d-osh.log");
GLOBAL_STR(str223, "Writing logs to %r");
GLOBAL_STR(str224, "OSH_HIJACK_SHEBANG");
GLOBAL_STR(str225, "");
GLOBAL_STR(str226, "OSH_CRASH_DUMP_DIR");
GLOBAL_STR(str227, "");
GLOBAL_STR(str228, "");
GLOBAL_STR(str229, "osh: Couldn't open %r: %s");
GLOBAL_STR(str230, "/proc/%d/status");
GLOBAL_STR(str231, "--parser-mem-dump can only be used with -n");
GLOBAL_STR(str232, "/proc/%d/status");
GLOBAL_STR(str233, " \t\n\"'><=;|&(:");
GLOBAL_STR(str234, "/");
GLOBAL_STR(str235, "PATH");
GLOBAL_STR(str236, ":");
GLOBAL_STR(str237, "got invalid option %r");
GLOBAL_STR(str238, "got invalid option %r");
GLOBAL_STR(str239, "invalid option %r (try -O or shopt)");
GLOBAL_STR(str240, "SHELLOPTS");
GLOBAL_STR(str241, ":");
GLOBAL_STR(str242, "Syntax options must be set at the top level (outside any function)");
GLOBAL_STR(str243, "Warning: set -o verbose not implemented");
GLOBAL_STR(str244, "SHELLOPTS");
GLOBAL_STR(str245, "%s:%s");
GLOBAL_STR(str246, "SHELLOPTS");
GLOBAL_STR(str247, ":");
GLOBAL_STR(str248, ":");
GLOBAL_STR(str249, "SHELLOPTS");
GLOBAL_STR(str250, "oil:basic");
GLOBAL_STR(str251, "oil:all");
GLOBAL_STR(str252, "strict:all");
GLOBAL_STR(str253, "set %so %s");
GLOBAL_STR(str254, "-");
GLOBAL_STR(str255, "+");
GLOBAL_STR(str256, "oil:basic");
GLOBAL_STR(str257, "oil:all");
GLOBAL_STR(str258, "strict:all");
GLOBAL_STR(str259, "got invalid option %r");
GLOBAL_STR(str260, "shopt -%s %s");
GLOBAL_STR(str261, "s");
GLOBAL_STR(str262, "u");
GLOBAL_STR(str263, "<_ArgFrame %s %d at %x>");
GLOBAL_STR(str264, "Can't determine working directory: %s");
GLOBAL_STR(str265, "IFS");
GLOBAL_STR(str266, "UID");
GLOBAL_STR(str267, "EUID");
GLOBAL_STR(str268, "PPID");
GLOBAL_STR(str269, "HOSTNAME");
GLOBAL_STR(str270, "OSTYPE");
GLOBAL_STR(str271, "OPTIND");
GLOBAL_STR(str272, "1");
GLOBAL_STR(str273, "PS4");
GLOBAL_STR(str274, "${SHX_indent}${SHX_punct}${SHX_pid_str} ");
GLOBAL_STR(str275, "COMP_WORDBREAKS");
GLOBAL_STR(str276, "SHELLOPTS");
GLOBAL_STR(str277, "SHELLOPTS");
GLOBAL_STR(str278, "");
GLOBAL_STR(str279, "SHELLOPTS");
GLOBAL_STR(str280, "PWD");
GLOBAL_STR(str281, "PWD");
GLOBAL_STR(str282, "PWD");
GLOBAL_STR(str283, "PATH");
GLOBAL_STR(str284, "PATH");
GLOBAL_STR(str285, "/bin:/usr/bin");
GLOBAL_STR(str286, "OIL_VERSION");
GLOBAL_STR(str287, "PWD");
GLOBAL_STR(str288, "PS1");
GLOBAL_STR(str289, "PS1");
GLOBAL_STR(str290, "\\s-\\v\\$ ");
GLOBAL_STR(str291, "");
GLOBAL_STR(str292, "<Mem");
GLOBAL_STR(str293, "  -- %d --");
GLOBAL_STR(str294, "  %s %s");
GLOBAL_STR(str295, ">");
GLOBAL_STR(str296, "\n");
GLOBAL_STR(str297, "\n");
GLOBAL_STR(str298, "Warning: span_id undefined in SetCurrentSpanId");
GLOBAL_STR(str299, "setref requires a nameref (:out param)");
GLOBAL_STR(str300, "nameref %r is undefined");
GLOBAL_STR(str301, "nameref %r contains invalid variable name %r");
GLOBAL_STR(str302, "Circular nameref %s");
GLOBAL_STR(str303, " -> ");
GLOBAL_STR(str304, "__");
GLOBAL_STR(str305, "Can't assign to readonly value %r");
GLOBAL_STR(str306, "Only strings can be exported");
GLOBAL_STR(str307, "nameref must be a string");
GLOBAL_STR(str308, "Can't assign to readonly array");
GLOBAL_STR(str309, "Can't assign to items in a string");
GLOBAL_STR(str310, "Value of type %s can't be indexed");
GLOBAL_STR(str311, "Can't assign to readonly associative array");
GLOBAL_STR(str312, "ARGV");
GLOBAL_STR(str313, "_status");
GLOBAL_STR(str314, "_this_dir");
GLOBAL_STR(str315, "PIPESTATUS");
GLOBAL_STR(str316, "_pipeline_status");
GLOBAL_STR(str317, "_process_sub_status");
GLOBAL_STR(str318, "BASH_REMATCH");
GLOBAL_STR(str319, "FUNCNAME");
GLOBAL_STR(str320, "source");
GLOBAL_STR(str321, "BASH_SOURCE");
GLOBAL_STR(str322, "BASH_LINENO");
GLOBAL_STR(str323, "0");
GLOBAL_STR(str324, "LINENO");
GLOBAL_STR(str325, "BASHPID");
GLOBAL_STR(str326, "Can't unset readonly variable %r");
GLOBAL_STR(str327, "%r isn't an array");
GLOBAL_STR(str328, "$%s isn't defined");
GLOBAL_STR(str329, "$%s should be a string");
GLOBAL_STR(str330, "$%s should be a string, got %s");
GLOBAL_STR(str331, "$%s doesn't look like an integer, got %r");
GLOBAL_STR(str332, "EOF");
GLOBAL_STR(str333, "/");
GLOBAL_STR(str334, "~");
GLOBAL_STR(str335, "  ");
GLOBAL_STR(str336, "\n  ");
...
GLOBAL_STR(str341, "~");
GLOBAL_STR(str342, "\n");
GLOBAL_STR(str343, "[ interactive ]");
GLOBAL_STR(str344, "[ headless ]");
GLOBAL_STR(str345, "[ -c flag ]");
GLOBAL_STR(str346, "[ stdin%s ]");
GLOBAL_STR(str347, "[ %s word at ? ]");
GLOBAL_STR(str348, "[ %s word at line %d of %s ]");
GLOBAL_STR(str349, "?");
GLOBAL_STR(str350, "?");
GLOBAL_STR(str351, "line %d of %s");
GLOBAL_STR(str352, "[ var %s at %s ]");
GLOBAL_STR(str353, "[ expansion of alias %r ]");
GLOBAL_STR(str354, "[ %s in %s ]");
GLOBAL_STR(str355, "[??? no location ???] %s%s\n");
GLOBAL_STR(str356, "%s:%d: %s%s\n");
GLOBAL_STR(str357, "");
GLOBAL_STR(str358, "");
GLOBAL_STR(str359, "");
GLOBAL_STR(str360, "errexit PID %d: ");
GLOBAL_STR(str361, "none");
GLOBAL_STR(str362, "AST not printed.");
GLOBAL_STR(str363, "text");
GLOBAL_STR(str364, "abbrev-text");
GLOBAL_STR(str365, "html");
GLOBAL_STR(str366, "abbrev-html");
GLOBAL_STR(str367, "abbrev-");
GLOBAL_STR(str368, "\n");
GLOBAL_STR(str369, "\n");
GLOBAL_STR(str370, "-");
GLOBAL_STR(str371, "_");
GLOBAL_STR(str372, "<_Attributes %s>");
GLOBAL_STR(str373, "<args.Reader %r %d>");
GLOBAL_STR(str374, "expected argument to %r");
GLOBAL_STR(str375, "-");
GLOBAL_STR(str376, "expected integer after %s, got %r");
GLOBAL_STR(str377, "-");
GLOBAL_STR(str378, "got invalid integer for %s: %s");
GLOBAL_STR(str379, "-");
GLOBAL_STR(str380, "expected number after %r, got %r");
GLOBAL_STR(str381, "-");
GLOBAL_STR(str382, "got invalid float for %s: %s");
GLOBAL_STR(str383, "-");
GLOBAL_STR(str384, "got invalid argument %r to %r, expected one of: %s");
GLOBAL_STR(str385, "-");
GLOBAL_STR(str386, "|");
GLOBAL_STR(str387, "0");
GLOBAL_STR(str388, "F");
GLOBAL_STR(str389, "false");
GLOBAL_STR(str390, "False");
GLOBAL_STR(str391, "1");
GLOBAL_STR(str392, "T");
GLOBAL_STR(str393, "true");
GLOBAL_STR(str394, "Talse");
GLOBAL_STR(str395, "got invalid argument to boolean flag: %r");
GLOBAL_STR(str396, "-");
GLOBAL_STR(str397, "-");
GLOBAL_STR(str398, "Invalid option %r");
GLOBAL_STR(str399, "Expected argument for action");
GLOBAL_STR(str400, "Invalid action name %r");
GLOBAL_STR(str401, "--");
GLOBAL_STR(str402, "--");
GLOBAL_STR(str403, "=");
GLOBAL_STR(str404, "got invalid flag %r");
GLOBAL_STR(str405, "-");
GLOBAL_STR(str406, "0");
GLOBAL_STR(str407, "Z");
GLOBAL_STR(str408, "-");
GLOBAL_STR(str409, "doesn't accept flag %s");
GLOBAL_STR(str410, "-");
GLOBAL_STR(str411, "+");
GLOBAL_STR(str412, "+");
GLOBAL_STR(str413, "doesn't accept option %s");
GLOBAL_STR(str414, "+");
GLOBAL_STR(str415, "-");
GLOBAL_STR(str416, "--");
GLOBAL_STR(str417, "--");
GLOBAL_STR(str418, "got invalid flag %r");
GLOBAL_STR(str419, "-");
GLOBAL_STR(str420, "+");
GLOBAL_STR(str421, "got invalid flag %r");
GLOBAL_STR(str422, "-");
GLOBAL_STR(str423, "<LineLexer at pos %d of line %r (id = %d)>");
GLOBAL_STR(str424, "");
GLOBAL_STR(str425, "");
GLOBAL_STR(str426, "");
GLOBAL_STR(str427, "");
GLOBAL_STR(str428, "<Trail %s %s %s %s>");
GLOBAL_STR(str429, "");
GLOBAL_STR(str430, "Here docs aren't allowed in expressions");
GLOBAL_STR(str431, "\n");
GLOBAL_STR(str432, "got unexpected typed args");
GLOBAL_STR(str433, "Expected an expression");
GLOBAL_STR(str434, "Expected an expression");
GLOBAL_STR(str435, "Too many typed args (expected one expression)");
GLOBAL_STR(str436, "Expected block argument");
GLOBAL_STR(str437, "Too many typed args (expected one block)");
GLOBAL_STR(str438, "Use === to be exact, or ~== to convert types");
GLOBAL_STR(str439, "");
GLOBAL_STR(str440, " (%s)");
GLOBAL_STR(str441, "Unexpected token in expression mode%s");
GLOBAL_STR(str442, "Syntax error in expression (near %s)");
GLOBAL_STR(str443, "alnum");
GLOBAL_STR(str444, "cntrl");
GLOBAL_STR(str445, "lower");
GLOBAL_STR(str446, "space");
GLOBAL_STR(str447, "alpha");
GLOBAL_STR(str448, "digit");
GLOBAL_STR(str449, "print");
GLOBAL_STR(str450, "upper");
GLOBAL_STR(str451, "blank");
GLOBAL_STR(str452, "graph");
GLOBAL_STR(str453, "punct");
GLOBAL_STR(str454, "xdigit");
GLOBAL_STR(str455, "Range start/end shouldn't have more than one character");
GLOBAL_STR(str456, "Write singleton tuples with tup(), not a trailing comma");
GLOBAL_STR(str457, "testlist_comp");
GLOBAL_STR(str458, "obj.field isn't valid, but obj.method() is");
GLOBAL_STR(str459, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str460, "Can't assign to this expression");
GLOBAL_STR(str461, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str462, "Expr");
GLOBAL_STR(str463, "Block");
GLOBAL_STR(str464, "proc param types should be Expr or Block");
GLOBAL_STR(str465, "TODO");
GLOBAL_STR(str466, "dot");
GLOBAL_STR(str467, "Can't negate this symbol");
GLOBAL_STR(str468, "%r isn't a character class");
GLOBAL_STR(str469, "Can't negate this symbol");
GLOBAL_STR(str470, "%r isn't a character class");
GLOBAL_STR(str471, "%start");
GLOBAL_STR(str472, "%end");
GLOBAL_STR(str473, "dot");
GLOBAL_STR(str474, "Unexpected token %r in regex");
GLOBAL_STR(str475, "%s-%s");
GLOBAL_STR(str476, "ERE can't express code point %d");
GLOBAL_STR(str477, "Perl classes can't be negated in ERE");
GLOBAL_STR(str478, "%s");
GLOBAL_STR(str479, "POSIX classes can't be negated in ERE");
GLOBAL_STR(str480, "[:%s:]");
GLOBAL_STR(str481, ".");
GLOBAL_STR(str482, "^");
GLOBAL_STR(str483, "$");
GLOBAL_STR(str484, "|");
GLOBAL_STR(str485, "POSIX EREs don't have groups without capture, so this node needs () around it.");
GLOBAL_STR(str486, "+");
GLOBAL_STR(str487, "*");
GLOBAL_STR(str488, "?");
GLOBAL_STR(str489, "{%s}");
...
GLOBAL_STR(str500, "^");
GLOBAL_STR(str501, "]");
GLOBAL_STR(str502, "The [ operator doesn't apply to this expression");
GLOBAL_STR(str503, "Expected ]]");
GLOBAL_STR(str504, "Unexpected trailing word %s");
GLOBAL_STR(str505, "Invalid argument to unary operator");
GLOBAL_STR(str506, "Expected ), got %s");
GLOBAL_STR(str507, "Unexpected token in boolean expression (%s)");
GLOBAL_STR(str508, "");
GLOBAL_STR(str509, "Expected %d, got %d");
GLOBAL_STR(str510, "Step can't be 0");
GLOBAL_STR(str511, "Invalid step %d for ascending integer range");
GLOBAL_STR(str512, "Invalid step %d for descending integer range");
GLOBAL_STR(str513, "Invalid step %d for ascending character range");
GLOBAL_STR(str514, "Invalid step %d for descending character range");
GLOBAL_STR(str515, "Mismatched cases in character range");
GLOBAL_STR(str516, "");
GLOBAL_STR(str517, "0");
GLOBAL_STR(str518, "0");
GLOBAL_STR(str519, "g");
...
GLOBAL_STR(str556, ")");
GLOBAL_STR(str557, "");
GLOBAL_STR(str558, "export_");
GLOBAL_STR(str559, "doesn't accept -f because it's dangerous.  (The code can usually be restructured with 'source')");
GLOBAL_STR(str560, "doesn't accept RHS with -n");
GLOBAL_STR(str561, "Got -a but RHS isn't an array");
GLOBAL_STR(str562, "Got -A but RHS isn't an associative array");
GLOBAL_STR(str563, "readonly");
GLOBAL_STR(str564, "new_var");
GLOBAL_STR(str565, "with -f expects function names");
GLOBAL_STR(str566, "declare -f %s");
GLOBAL_STR(str567, "-");
GLOBAL_STR(str568, "-");
GLOBAL_STR(str569, "-");
GLOBAL_STR(str570, "+");
GLOBAL_STR(str571, "+");
GLOBAL_STR(str572, "+");
GLOBAL_STR(str573, "unset");
GLOBAL_STR(str574, "Invalid shift argument %r");
GLOBAL_STR(str575, "got too many arguments");
GLOBAL_STR(str576, "eval");
GLOBAL_STR(str577, "requires code string");
GLOBAL_STR(str578, "requires exactly 1 argument");
GLOBAL_STR(str579, " ");
GLOBAL_STR(str580, "eval");
GLOBAL_STR(str581, "eval");
GLOBAL_STR(str582, "source");
GLOBAL_STR(str583, "missing required argument");
GLOBAL_STR(str584, "source %r failed: %s");
GLOBAL_STR(str585, "source");
GLOBAL_STR(str586, "command");
GLOBAL_STR(str587, "Can't run assignment builtin recursively");
GLOBAL_STR(str588, "%r isn't a shell builtin");
GLOBAL_STR(str589, "runproc");
GLOBAL_STR(str590, "requires arguments");
GLOBAL_STR(str591, "runproc: no proc named %r");
GLOBAL_STR(str592, "try_");
GLOBAL_STR(str593, "expects a block or command argv");
GLOBAL_STR(str594, "boolstatus");
GLOBAL_STR(str595, "expected a command to run");
GLOBAL_STR(str596, "boolstatus expected status 0 or 1, got %d");
GLOBAL_STR(str597, "function");
GLOBAL_STR(str598, "alias");
GLOBAL_STR(str599, "builtin");
GLOBAL_STR(str600, "builtin");
GLOBAL_STR(str601, "builtin");
GLOBAL_STR(str602, "keyword");
GLOBAL_STR(str603, "keyword");
GLOBAL_STR(str604, "file");
GLOBAL_STR(str605, "type");
GLOBAL_STR(str606, "type: %r not found");
GLOBAL_STR(str607, "file");
GLOBAL_STR(str608, "file");
GLOBAL_STR(str609, "%s is a %s");
GLOBAL_STR(str610, "function");
GLOBAL_STR(str611, "");
GLOBAL_STR(str612, "");
GLOBAL_STR(str613, "\r\n");
GLOBAL_STR(str614, "\n");
...
GLOBAL_STR(str616, "");
GLOBAL_STR(str617, "");
GLOBAL_STR(str618, "read error: %s");
GLOBAL_STR(str619, "read");
GLOBAL_STR(str620, "_line");
GLOBAL_STR(str621, ":");
GLOBAL_STR(str622, "got extra argument");
GLOBAL_STR(str623, "--qsn can only be used with --line");
GLOBAL_STR(str624, "_all");
GLOBAL_STR(str625, ":");
GLOBAL_STR(str626, "got extra argument");
GLOBAL_STR(str627, "--qsn not implemented yet");
GLOBAL_STR(str628, "read -t isn't implemented (except t=0)");
GLOBAL_STR(str629, "REPLY");
GLOBAL_STR(str630, "REPLY");
GLOBAL_STR(str631, "");
GLOBAL_STR(str632, ":");
GLOBAL_STR(str633, "mapfile");
GLOBAL_STR(str634, "MAPFILE");
GLOBAL_STR(str635, ":");
GLOBAL_STR(str636, "mapfile: read() error: %s");
GLOBAL_STR(str637, "\n");
GLOBAL_STR(str638, "cd");
GLOBAL_STR(str639, "HOME");
GLOBAL_STR(str640, "HOME");
GLOBAL_STR(str641, "-");
GLOBAL_STR(str642, "OLDPWD");
GLOBAL_STR(str643, "PWD");
GLOBAL_STR(str644, "cd %r: %s");
GLOBAL_STR(str645, "PWD");
GLOBAL_STR(str646, "OLDPWD");
GLOBAL_STR(str647, "%2d  %s");
GLOBAL_STR(str648, " ");
GLOBAL_STR(str649, "pushd");
GLOBAL_STR(str650, "pushd: no other directory");
GLOBAL_STR(str651, "got too many arguments");
GLOBAL_STR(str652, "pushd: %r: %s");
GLOBAL_STR(str653, "HOME");
GLOBAL_STR(str654, "PWD");
GLOBAL_STR(str655, "popd: directory stack is empty");
GLOBAL_STR(str656, "popd: %r: %s");
GLOBAL_STR(str657, "PWD");
GLOBAL_STR(str658, "pushd");
GLOBAL_STR(str659, "got extra argument");
GLOBAL_STR(str660, "HOME");
GLOBAL_STR(str661, "dirs");
GLOBAL_STR(str662, "HOME");
GLOBAL_STR(str663, "pwd");
GLOBAL_STR(str664, "_devbuild/help/groups.txt");
GLOBAL_STR(str665, "help");
GLOBAL_STR(str666, "help");
GLOBAL_STR(str667, "_devbuild/help/%s");
GLOBAL_STR(str668, "no help topics match %r");
GLOBAL_STR(str669, "osh I/O error: %s");
GLOBAL_STR(str670, "# +");
GLOBAL_STR(str671, "osh printf doesn't support the %r flag");
GLOBAL_STR(str672, "eEfFgG");
GLOBAL_STR(str673, "osh printf doesn't support floating point");
GLOBAL_STR(str674, "c");
GLOBAL_STR(str675, "osh printf doesn't support single characters (bytes)");
GLOBAL_STR(str676, "Invalid printf format character");
GLOBAL_STR(str677, "Expected a printf format character");
GLOBAL_STR(str678, "%");
GLOBAL_STR(str679, "");
GLOBAL_STR(str680, "printf got invalid width %r");
GLOBAL_STR(str681, "0");
GLOBAL_STR(str682, "");
GLOBAL_STR(str683, "printf got invalid precision %r");
GLOBAL_STR(str684, "");
GLOBAL_STR(str685, "s");
GLOBAL_STR(str686, "q");
GLOBAL_STR(str687, "b");
GLOBAL_STR(str688, "");
GLOBAL_STR(str689, "diouxX");
GLOBAL_STR(str690, "'\"");
GLOBAL_STR(str691, "printf expected an integer, got %r");
GLOBAL_STR(str692, "TZ");
GLOBAL_STR(str693, "TZ");
GLOBAL_STR(str694, "ouxX");
GLOBAL_STR(str695, "Can't format negative number %d with %%%s");
GLOBAL_STR(str696, "o");
GLOBAL_STR(str697, "x");
GLOBAL_STR(str698, "X");
GLOBAL_STR(str699, "0");
...
GLOBAL_STR(str705, " ");
GLOBAL_STR(str706, " ");
GLOBAL_STR(str707, "printf");
GLOBAL_STR(str708, "requires a format string");
GLOBAL_STR(str709, "printf");
GLOBAL_STR(str710, "");
GLOBAL_STR(str711, "alias");
GLOBAL_STR(str712, "alias %s=%r");
GLOBAL_STR(str713, "=");
GLOBAL_STR(str714, "No alias named %r");
GLOBAL_STR(str715, "alias %s=%r");
GLOBAL_STR(str716, "unalias");
GLOBAL_STR(str717, "requires an argument");
GLOBAL_STR(str718, "No alias named %r");
GLOBAL_STR(str719, "%s=%s");
GLOBAL_STR(str720, "set");
GLOBAL_STR(str721, "shopt");
GLOBAL_STR(str722, "got invalid option %r");
GLOBAL_STR(str723, "hash");
GLOBAL_STR(str724, "got extra arguments after -r");
GLOBAL_STR(str725, "hash: %r not found");
GLOBAL_STR(str726, ":");
GLOBAL_STR(str727, "OPTIND");
GLOBAL_STR(str728, "OPTIND");
GLOBAL_STR(str729, "OPTARG");
GLOBAL_STR(str730, "OPTARG");
GLOBAL_STR(str731, "");
GLOBAL_STR(str732, "?");
GLOBAL_STR(str733, "-");
GLOBAL_STR(str734, "-");
GLOBAL_STR(str735, "?");
GLOBAL_STR(str736, "?");
GLOBAL_STR(str737, "getopts: option %r requires an argument.");
GLOBAL_STR(str738, "(getopts argv: %s)");
GLOBAL_STR(str739, " ");
GLOBAL_STR(str740, "?");
GLOBAL_STR(str741, "");
GLOBAL_STR(str742, "requires an argspec");
GLOBAL_STR(str743, "requires the name of a variable to set");
GLOBAL_STR(str744, "got invalid variable name %r");
GLOBAL_STR(str745, "echo");
GLOBAL_STR(str746, "");
GLOBAL_STR(str747, "takes at most one arg when simple_echo is on (hint: add quotes)");
GLOBAL_STR(str748, " ");
GLOBAL_STR(str749, "\n");
GLOBAL_STR(str750, "module");
GLOBAL_STR(str751, "requires a name");
GLOBAL_STR(str752, "(interactive) Reloading module %r");
GLOBAL_STR(str753, "expected 'bin' or 'dialect'");
GLOBAL_STR(str754, "dialect");
GLOBAL_STR(str755, "expected dialect name");
GLOBAL_STR(str756, "_DIALECT");
GLOBAL_STR(str757, "Expected dialect %r, got %r");
GLOBAL_STR(str758, "Expected dialect %r");
GLOBAL_STR(str759, "bin");
GLOBAL_STR(str760, "bin %s");
GLOBAL_STR(str761, "expected 'bin' or 'dialect'");
GLOBAL_STR(str762, "shvar");
GLOBAL_STR(str763, "expected a block");
GLOBAL_STR(str764, "Expected name=value");
GLOBAL_STR(str765, "=");
GLOBAL_STR(str766, "Expected name=value");
GLOBAL_STR(str767, "expected a block");
GLOBAL_STR(str768, "Can't append array to string");
GLOBAL_STR(str769, "Can't append string to array");
GLOBAL_STR(str770, "Assignment builtin %r not configured");
GLOBAL_STR(str771, "%r ");
GLOBAL_STR(str772, "Command");
GLOBAL_STR(str773, "Assignment");
GLOBAL_STR(str774, "Subshell");
GLOBAL_STR(str775, "Pipeline");
GLOBAL_STR(str776, "%s failed with status %d");
GLOBAL_STR(str777, "Redirect filename can't be empty");
GLOBAL_STR(str778, "Redirect descriptor can't be empty");
GLOBAL_STR(str779, "-");
GLOBAL_STR(str780, "-");
GLOBAL_STR(str781, "Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
GLOBAL_STR(str782, "\n");
GLOBAL_STR(str783, "Unknown redirect op");
GLOBAL_STR(str784, "Unknown redirect type");
GLOBAL_STR(str785, "strict_errexit only allows simple commands in conditionals (got %s). ");
GLOBAL_STR(str786, "strict_errexit only allows a single command.  Hint: use 'try'.");
GLOBAL_STR(str787, "strict_errexit only allows simple commands in conditionals (got %s). ");
GLOBAL_STR(str788, "ShAssignment builtins don't accept blocks");
GLOBAL_STR(str789, "|& isn't supported");
GLOBAL_STR(str790, "%r expected a number, got %r");
GLOBAL_STR(str791, "Invalid control flow at top level");
GLOBAL_STR(str792, "warning: ");
GLOBAL_STR(str793, "Function %s was already defined (redefine_proc)");
GLOBAL_STR(str794, "Proc %s was already defined (redefine_proc)");
GLOBAL_STR(str795, "trap");
GLOBAL_STR(str796, "failglob: ");
GLOBAL_STR(str797, "Loop and control flow can't be in different processes");
GLOBAL_STR(str798, "fatal: ");
GLOBAL_STR(str799, "EXIT");
GLOBAL_STR(str800, "trap EXIT");
GLOBAL_STR(str801, "__");
GLOBAL_STR(str802, ":");
GLOBAL_STR(str803, "Invalid argument %r.  Expected a name starting with :");
GLOBAL_STR(str804, "No value provided for param %r");
GLOBAL_STR(str805, "proc %r expected %d arguments, but got %d");
GLOBAL_STR(str806, "Unexpected %r (in function call)");
GLOBAL_STR(str807, "Unexpected control flow in block");
GLOBAL_STR(str808, "Attempted to exit from completion hook.");
GLOBAL_STR(str809, "Couldn't find terminator for here doc that starts here");
GLOBAL_STR(str810, "\t");
GLOBAL_STR(str811, "Invalid here doc delimiter");
GLOBAL_STR(str812, "+");
GLOBAL_STR(str813, "+");
GLOBAL_STR(str814, "+");
GLOBAL_STR(str815, "%d != %d");
GLOBAL_STR(str816, "array place");
GLOBAL_STR(str817, "Environment binding shouldn't look like an array assignment");
GLOBAL_STR(str818, "+");
GLOBAL_STR(str819, "Expected = in environment binding, got +=");
GLOBAL_STR(str820, "Environment bindings can't contain array literals");
GLOBAL_STR(str821, "procs and shell functions can't be nested");
GLOBAL_STR(str822, "%r was already declared");
GLOBAL_STR(str823, "%r hasn't been declared");
GLOBAL_STR(str824, "Can't modify constant %r");
GLOBAL_STR(str825, "Expected word type %s, got %s");
GLOBAL_STR(str826, "{");
GLOBAL_STR(str827, "}");
GLOBAL_STR(str828, "Invalid token after redirect operator");
GLOBAL_STR(str829, "Space required before (");
GLOBAL_STR(str830, "Unexpected left paren (might need a space before it)");
GLOBAL_STR(str831, "Empty arg list not allowed");
GLOBAL_STR(str832, "TODO: Parse Redirect");
GLOBAL_STR(str833, " ");
GLOBAL_STR(str834, " ");
GLOBAL_STR(str835, "line IDs %d != %d");
GLOBAL_STR(str836, " ");
GLOBAL_STR(str837, "");
GLOBAL_STR(str838, "Unexpected typed args");
GLOBAL_STR(str839, "=word isn't allowed.  Hint: either quote it or add a space after =\nto pretty print an expression");
GLOBAL_STR(str840, "name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
GLOBAL_STR(str841, "Unexpected typed args");
GLOBAL_STR(str842, "Unexpected typed args");
GLOBAL_STR(str843, "Control flow shouldn't have redirects");
GLOBAL_STR(str844, "Control flow shouldn't have environment bindings");
GLOBAL_STR(str845, "Unexpected argument to %r");
GLOBAL_STR(str846, "Invalid word in for loop");
GLOBAL_STR(str847, "Invalid word after for expression");
GLOBAL_STR(str848, "Loop variable name should be a constant");
GLOBAL_STR(str849, "Invalid loop variable name");
GLOBAL_STR(str850, "Unexpected word after for loop variable");
GLOBAL_STR(str851, "Expected ;; or esac");
GLOBAL_STR(str852, "Unexpected word while parsing compound command");
GLOBAL_STR(str853, "Invalid function name");
GLOBAL_STR(str854, "Expected ) in function definition");
GLOBAL_STR(str855, "Invalid KSH-style function name");
GLOBAL_STR(str856, "Unexpected word when parsing command");
GLOBAL_STR(str857, "Unexpected right brace");
GLOBAL_STR(str858, "Unexpected EOF while parsing command");
GLOBAL_STR(str859, "Invalid word while parsing command");
GLOBAL_STR(str860, "Invalid word while parsing command line");
GLOBAL_STR(str861, "Invalid word while parsing command list");
GLOBAL_STR(str862, "Unterminated here doc began here");
GLOBAL_STR(str863, "\\");
GLOBAL_STR(str864, "*");
GLOBAL_STR(str865, "?");
GLOBAL_STR(str866, "[");
...
GLOBAL_STR(str870, "\\?*+{}^$.()|");
GLOBAL_STR(str871, "\\");
GLOBAL_STR(str872, "Unexpected escaped character %r");
GLOBAL_STR(str873, "");
GLOBAL_STR(str874, "");
GLOBAL_STR(str875, "Malformed character class; treating as literal");
GLOBAL_STR(str876, "Got unescaped right bracket");
GLOBAL_STR(str877, "Got unescaped trailing backslash");
GLOBAL_STR(str878, ".|^$()+*?[]{}\\");
GLOBAL_STR(str879, "\\");
GLOBAL_STR(str880, "\\");
GLOBAL_STR(str881, "\\[");
...
GLOBAL_STR(str893, "]");
GLOBAL_STR(str894, "");
GLOBAL_STR(str895, "Error expanding glob %r: %s");
GLOBAL_STR(str896, "-");
GLOBAL_STR(str897, "<Error: unbalanced \\[ and \\]> ");
GLOBAL_STR(str898, "$");
GLOBAL_STR(str899, "#");
GLOBAL_STR(str900, "$");
GLOBAL_STR(str901, "hostname");
GLOBAL_STR(str902, "user");
GLOBAL_STR(str903, "\u0001");
GLOBAL_STR(str904, "\u0002");
GLOBAL_STR(str905, "$");
GLOBAL_STR(str906, "$");
GLOBAL_STR(str907, "u");
GLOBAL_STR(str908, "user");
GLOBAL_STR(str909, "h");
GLOBAL_STR(str910, "hostname");
GLOBAL_STR(str911, ".");
GLOBAL_STR(str912, "H");
GLOBAL_STR(str913, "hostname");
GLOBAL_STR(str914, "s");
GLOBAL_STR(str915, "v");
GLOBAL_STR(str916, "A");
GLOBAL_STR(str917, "%H:%M");
GLOBAL_STR(str918, "D");
GLOBAL_STR(str919, "%X");
GLOBAL_STR(str920, "w");
GLOBAL_STR(str921, "PWD");
GLOBAL_STR(str922, "HOME");
GLOBAL_STR(str923, "<Error: %s>");
GLOBAL_STR(str924, "W");
GLOBAL_STR(str925, "PWD");
GLOBAL_STR(str926, "<Error: PWD is not a string> ");
GLOBAL_STR(str927, "<Error: \\%s not implemented in $PS1> ");
GLOBAL_STR(str928, "$");
GLOBAL_STR(str929, "\\$");
GLOBAL_STR(str930, "Invalid token %r");
GLOBAL_STR(str931, "");
GLOBAL_STR(str932, "");
GLOBAL_STR(str933, "<ERROR: Can't parse PS1: %s>");
GLOBAL_STR(str934, "osh");
GLOBAL_STR(str935, "PS1");
GLOBAL_STR(str936, "$ ");
GLOBAL_STR(str937, "PROMPT_COMMAND");
GLOBAL_STR(str938, "Undefined variable %r");
GLOBAL_STR(str939, "Can't use [] on value of type %s");
GLOBAL_STR(str940, "");
GLOBAL_STR(str941, "Can't use [] on value of type %s");
GLOBAL_STR(str942, "");
GLOBAL_STR(str943, "dynamic place");
GLOBAL_STR(str944, "got invalid place expression");
GLOBAL_STR(str945, "expected a var name.  shopt -s eval_unsafe_arith allows a[i]");
GLOBAL_STR(str946, "Invalid var ref");
GLOBAL_STR(str947, "0x");
GLOBAL_STR(str948, "Invalid hex constant %r");
GLOBAL_STR(str949, "0");
GLOBAL_STR(str950, "Invalid octal constant %r");
GLOBAL_STR(str951, "#");
GLOBAL_STR(str952, "#");
GLOBAL_STR(str953, "Invalid base for numeric constant %r");
GLOBAL_STR(str954, "a");
GLOBAL_STR(str955, "A");
GLOBAL_STR(str956, "@");
GLOBAL_STR(str957, "_");
GLOBAL_STR(str958, "Invalid digits for numeric constant %r");
GLOBAL_STR(str959, "Digits %r out of range for base %d");
GLOBAL_STR(str960, "Parse error in recursive arithmetic");
GLOBAL_STR(str961, "Invalid integer constant %r");
GLOBAL_STR(str962, "Invalid integer constant %r");
GLOBAL_STR(str963, "Invalid integer constant %r");
GLOBAL_STR(str964, "Undefined value in arithmetic context");
GLOBAL_STR(str965, "Expected a value convertible to integer, got %s");
GLOBAL_STR(str966, "0");
GLOBAL_STR(str967, "Undefined variable %r");
GLOBAL_STR(str968, "Divide by zero");
GLOBAL_STR(str969, "Divide by zero");
GLOBAL_STR(str970, "Expected array or assoc in index expression, got %s");
GLOBAL_STR(str971, "Divide by zero");
GLOBAL_STR(str972, "Divide by zero");
GLOBAL_STR(str973, "Exponent can't be less than zero");
GLOBAL_STR(str974, "Associative array keys must be strings: $x 'x' \"$x\" etc.");
GLOBAL_STR(str975, "Invalid place to modify");
GLOBAL_STR(str976, "%s isn't implemented");
GLOBAL_STR(str977, "Invalid regex %r: %s");
GLOBAL_STR(str978, " \t\n");
GLOBAL_STR(str979, "IFS");
GLOBAL_STR(str980, "IFS shouldn't be an array");
GLOBAL_STR(str981, " \t\n");
GLOBAL_STR(str982, "IFS");
GLOBAL_STR(str983, " ");
GLOBAL_STR(str984, "");
GLOBAL_STR(str985, "IFS shouldn't be an array");
GLOBAL_STR(str986, "\\");
GLOBAL_STR(str987, "\\");
GLOBAL_STR(str988, "Invalid transition from %r with %r");
GLOBAL_STR(str989, "\u00ef\u00bf\u00bd");
GLOBAL_STR(str990, "");
GLOBAL_STR(str991, "Incomplete UTF-8 character");
GLOBAL_STR(str992, "Invalid UTF-8 continuation byte");
GLOBAL_STR(str993, "Invalid start of UTF-8 character");
GLOBAL_STR(str994, "");
GLOBAL_STR(str995, "%s can't have an argument");
GLOBAL_STR(str996, "");
GLOBAL_STR(str997, "%s can't have an argument");
GLOBAL_STR(str998, "");
GLOBAL_STR(str999, "%s can't have an argument");
GLOBAL_STR(str1000, "");
GLOBAL_STR(str1001, "%s can't have an argument");
GLOBAL_STR(str1002, "");
GLOBAL_STR(str1003, "<_GlobReplacer regex %r r %r>");
GLOBAL_STR(str1004, "(%s)");
GLOBAL_STR(str1005, "Error matching regex %r: %s");
GLOBAL_STR(str1006, "^");
GLOBAL_STR(str1007, "$");
GLOBAL_STR(str1008, "\r");
GLOBAL_STR(str1009, "<INVALID CR>");
GLOBAL_STR(str1010, "\n");
GLOBAL_STR(str1011, "<INVALID NEWLINE>");
GLOBAL_STR(str1012, " `~!$&*()[]{}\\|;'\"<>?");
GLOBAL_STR(str1013, "Left-hand side of this assignment is invalid");
GLOBAL_STR(str1014, "Token can't be used in prefix position");
GLOBAL_STR(str1015, "Token can't be used in infix position");
GLOBAL_STR(str1016, "Parser expected %s, got %s");
GLOBAL_STR(str1017, "Unexpected end of input");
GLOBAL_STR(str1018, "");
GLOBAL_STR(str1019, "");
GLOBAL_STR(str1020, " \t");
GLOBAL_STR(str1021, "\n");
...
GLOBAL_STR(str1023, "\n");
GLOBAL_STR(str1024, "\n");
GLOBAL_STR(str1025, "BASH_SOURCE");
GLOBAL_STR(str1026, "FUNCNAME");
GLOBAL_STR(str1027, "BASH_LINENO");
GLOBAL_STR(str1028, "0");
GLOBAL_STR(str1029, "0");
GLOBAL_STR(str1030, "^([a-zA-Z_][a-zA-Z0-9_]*)((=|\\+=)(.*))?$");
GLOBAL_STR(str1031, "Assignment builtin expected NAME=value, got %r");
GLOBAL_STR(str1032, "+");
GLOBAL_STR(str1033, "\\");
GLOBAL_STR(str1034, "\\\\");
GLOBAL_STR(str1035, "");
GLOBAL_STR(str1036, "");
GLOBAL_STR(str1037, "The length index of a array slice can't be negative: %d");
GLOBAL_STR(str1038, "Can't slice associative arrays");
GLOBAL_STR(str1039, "i");
GLOBAL_STR(str1040, "e");
GLOBAL_STR(str1041, "f");
GLOBAL_STR(str1042, "n");
GLOBAL_STR(str1043, "u");
GLOBAL_STR(str1044, "x");
GLOBAL_STR(str1045, "C");
GLOBAL_STR(str1046, "");
GLOBAL_STR(str1047, "~");
GLOBAL_STR(str1048, "HOME");
GLOBAL_STR(str1049, "Error expanding tilde (e.g. invalid user)");
GLOBAL_STR(str1050, "Can't assign to special variable");
GLOBAL_STR(str1051, "unset variable %r");
GLOBAL_STR(str1052, "warning: ");
GLOBAL_STR(str1053, "-1");
GLOBAL_STR(str1054, "a[i] not allowed without shopt -s eval_unsafe_arith");
GLOBAL_STR(str1055, "Indirect expansion of array");
GLOBAL_STR(str1056, "Indirect expansion of assoc array");
GLOBAL_STR(str1057, "extended globs not supported in ${x//GLOB/}");
GLOBAL_STR(str1058, "");
GLOBAL_STR(str1059, "warning: ");
GLOBAL_STR(str1060, "");
GLOBAL_STR(str1061, "\u0001");
GLOBAL_STR(str1062, "");
GLOBAL_STR(str1063, "\u0002");
GLOBAL_STR(str1064, "");
GLOBAL_STR(str1065, "Can't use @P on %s");
GLOBAL_STR(str1066, " ");
GLOBAL_STR(str1067, "Can't use @Q on %s");
GLOBAL_STR(str1068, "a");
GLOBAL_STR(str1069, "A");
GLOBAL_STR(str1070, "r");
GLOBAL_STR(str1071, "x");
GLOBAL_STR(str1072, "n");
GLOBAL_STR(str1073, "");
GLOBAL_STR(str1074, "Var op %r not implemented");
GLOBAL_STR(str1075, "Can't index string with @");
GLOBAL_STR(str1076, "Can't index string with *");
GLOBAL_STR(str1077, "Can't index string %r with integer");
GLOBAL_STR(str1078, "");
GLOBAL_STR(str1079, "");
GLOBAL_STR(str1080, "$");
GLOBAL_STR(str1081, "Undefined variable %r");
GLOBAL_STR(str1082, "Undefined array %r");
GLOBAL_STR(str1083, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str1084, "Test operation not allowed with ${!array[@]}");
GLOBAL_STR(str1085, "Not implemented");
GLOBAL_STR(str1086, "Illegal array word part (strict_array)");
GLOBAL_STR(str1087, " ");
GLOBAL_STR(str1088, "");
GLOBAL_STR(str1089, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str1090, "@(");
GLOBAL_STR(str1091, "|");
GLOBAL_STR(str1092, ")");
GLOBAL_STR(str1093, "Extended globs and arrays can't appear in the same word");
GLOBAL_STR(str1094, "*");
GLOBAL_STR(str1095, "Unexpected array literal");
GLOBAL_STR(str1096, "Unexpected associative array literal");
GLOBAL_STR(str1097, "Can't splice %r");
GLOBAL_STR(str1098, "");
GLOBAL_STR(str1099, "");
GLOBAL_STR(str1100, "Extended glob %r matched no files");
GLOBAL_STR(str1101, "Extended glob not allowed in this word");
GLOBAL_STR(str1102, "");
GLOBAL_STR(str1103, "This word should yield a string, but it contains an array");
GLOBAL_STR(str1104, " ");
GLOBAL_STR(str1105, "extended glob not allowed in this word");
GLOBAL_STR(str1106, "");
GLOBAL_STR(str1107, "");
GLOBAL_STR(str1108, "");
GLOBAL_STR(str1109, "");
GLOBAL_STR(str1110, "<Runtime error: %s>");
GLOBAL_STR(str1111, "<I/O error: %s>");
GLOBAL_STR(str1112, "<Ctrl-C>");
GLOBAL_STR(str1113, "");
GLOBAL_STR(str1114, "");
GLOBAL_STR(str1115, "");
GLOBAL_STR(str1116, "");
GLOBAL_STR(str1117, "Pattern %r matched no files");
GLOBAL_STR(str1118, "");
GLOBAL_STR(str1119, "LHS array not allowed in assignment builtin");
GLOBAL_STR(str1120, "+");
GLOBAL_STR(str1121, "-");
GLOBAL_STR(str1122, "+");
GLOBAL_STR(str1123, "f");
GLOBAL_STR(str1124, "F");
GLOBAL_STR(str1125, "Pattern %r matched no files");
GLOBAL_STR(str1126, "");
GLOBAL_STR(str1127, "__NO_COMMAND_SUB__");
GLOBAL_STR(str1128, "__NO_PROCESS_SUB__");
GLOBAL_STR(str1129, "Expected : or } in slice");
GLOBAL_STR(str1130, "Pattern in ${x/pat/replace} must not be empty");
GLOBAL_STR(str1131, "Expected } after replacement string, got %s");
GLOBAL_STR(str1132, "Expected } or / to close pattern");
GLOBAL_STR(str1133, "Expected ] to close subscript");
GLOBAL_STR(str1134, "Expected } to close ${");
GLOBAL_STR(str1135, "Expected } to close ${");
GLOBAL_STR(str1136, "Expected a constant argument");
GLOBAL_STR(str1137, "Expected } to close ${");
GLOBAL_STR(str1138, "Expected } to close ${");
GLOBAL_STR(str1139, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1140, "VOp2");
GLOBAL_STR(str1141, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1142, "VOp3");
GLOBAL_STR(str1143, "Expected } to close ${");
GLOBAL_STR(str1144, "Expected } after length expression");
GLOBAL_STR(str1145, "TODO: ${.myproc builtin sub}");
GLOBAL_STR(str1146, "Unexpected token in ${}");
GLOBAL_STR(str1147, "\\");
GLOBAL_STR(str1148, "Strings with backslashes should look like r'\\n' or $'\\n'");
GLOBAL_STR(str1149, "Use \\xhh or \\u{...} instead of octal escapes in Oil strings");
GLOBAL_STR(str1150, "Invalid hex escape in Oil string (must be \\xHH)");
GLOBAL_STR(str1151, "Invalid char escape in C-style string literal");
GLOBAL_STR(str1152, "Unexpected EOF in single-quoted string that began here");
GLOBAL_STR(str1153, "\"");
GLOBAL_STR(str1154, "'");
GLOBAL_STR(str1155, "Unexpected EOF reading extended glob that began here");
GLOBAL_STR(str1156, "Invalid char escape in double quoted string");
GLOBAL_STR(str1157, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1158, "Invalid backtick: use $(cmd) or \\` in Oil strings");
GLOBAL_STR(str1159, "Unexpected EOF reading double-quoted string that began here");
GLOBAL_STR(str1160, "Use $(cmd) instead of backticks (parse_backticks)");
GLOBAL_STR(str1161, "Unexpected EOF while looking for closing backtick");
GLOBAL_STR(str1162, "");
GLOBAL_STR(str1163, "backticks");
GLOBAL_STR(str1164, "Invalid proc name %s");
GLOBAL_STR(str1165, "Unexpected token after arithmetic expression (%s != %s)");
GLOBAL_STR(str1166, "Expected second ) to end arith sub");
GLOBAL_STR(str1167, "Expected second ) to end arith statement");
GLOBAL_STR(str1168, "Expected ; here");
GLOBAL_STR(str1169, "Expected ; here");
GLOBAL_STR(str1170, "Expected ) to end for loop expression");
GLOBAL_STR(str1171, "Expected ( after =");
GLOBAL_STR(str1172, "Unexpected token in array literal");
GLOBAL_STR(str1173, "Expected associative array pair");
GLOBAL_STR(str1174, "Invalid char escape (parse_backslash)");
GLOBAL_STR(str1175, "Unexpected token after array literal");
GLOBAL_STR(str1176, "Unexpected token after array splice");
GLOBAL_STR(str1177, "TODO: @{.myproc builtin sub}");
GLOBAL_STR(str1178, "Literal @ starting a word must be quoted (parse_at_all)");
GLOBAL_STR(str1179, "/");
GLOBAL_STR(str1180, "next_byte %r");
GLOBAL_STR(str1181, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1182, "Unexpected token after @()");
GLOBAL_STR(str1183, "Word has unbalanced { }.  Maybe add a space or quote it like \\{");
GLOBAL_STR(str1184, "Unexpected parts after triple quoted string");
GLOBAL_STR(str1185, "Unexpected token while parsing arithmetic: %r");
GLOBAL_STR(str1186, "Invalid blank line in multiline mode");
GLOBAL_STR(str1187, "r");
GLOBAL_STR(str1188, "Unhandled: %s (%s)");
GLOBAL_STR(str1189, "Invalid var ref");
GLOBAL_STR(str1190, "Expected end of var ref");
GLOBAL_STR(str1191, "Invalid lex state %s");
GLOBAL_STR(str1192, "");
GLOBAL_STR(str1193, "");
GLOBAL_STR(str1194, "");
GLOBAL_STR(str1195, "");
...
GLOBAL_STR(str1199, "");
GLOBAL_STR(str1200, "");
GLOBAL_STR(str1201, "Compound shouldn't be empty");
GLOBAL_STR(str1202, "/");
GLOBAL_STR(str1203, "/");
GLOBAL_STR(str1204, "");
GLOBAL_STR(str1205, "EOF");
GLOBAL_STR(str1206, "typ");
GLOBAL_STR(str1207, "tok");
GLOBAL_STR(str1208, "children");
GLOBAL_STR(str1209, "-");
GLOBAL_STR(str1210, "with %d children");
GLOBAL_STR(str1211, "");
GLOBAL_STR(str1212, "(PNode %s %s %s)");
GLOBAL_STR(str1213, "&");
GLOBAL_STR(str1214, "&amp;");
GLOBAL_STR(str1215, "<");
GLOBAL_STR(str1216, "&lt;");
...
GLOBAL_STR(str1238, "/");
GLOBAL_STR(str1239, " \n\r\t");
GLOBAL_STR(str1240, "Unexpected token in QSN string");
GLOBAL_STR(str1241, "Expected closing single quote in QSN string");
GLOBAL_STR(str1242, "Unexpected data after closing quote");
GLOBAL_STR(str1243, "Unexpected token after QSN string");
GLOBAL_STR(str1244, "\\'\r\n\t\u0000");
GLOBAL_STR(str1245, "$'");
GLOBAL_STR(str1246, "'");
GLOBAL_STR(str1247, "'");
...
GLOBAL_STR(str1259, "\n");
GLOBAL_STR(str1260, "\\n");
GLOBAL_STR(str1261, "\r");
GLOBAL_STR(str1262, "\\r");
GLOBAL_STR(str1263, "\t");
GLOBAL_STR(str1264, "\\t");
GLOBAL_STR(str1265, "\u0000");
GLOBAL_STR(str1266, "\\x00");
GLOBAL_STR(str1267, "\\0");
GLOBAL_STR(str1268, "");
GLOBAL_STR(str1269, "");
GLOBAL_STR(str1270, "");
GLOBAL_STR(str1271, "\\");
...
GLOBAL_STR(str1275, "\n");
GLOBAL_STR(str1276, "\\n");
GLOBAL_STR(str1277, "\r");
GLOBAL_STR(str1278, "\\r");
GLOBAL_STR(str1279, "\t");
GLOBAL_STR(str1280, "\\t");
GLOBAL_STR(str1281, "\u0000");
GLOBAL_STR(str1282, "\\x00");
GLOBAL_STR(str1283, "\\0");
GLOBAL_STR(str1284, "");
GLOBAL_STR(str1285, "!");
GLOBAL_STR(str1286, "--");
GLOBAL_STR(str1287, "--dir");
GLOBAL_STR(str1288, "--exists");
GLOBAL_STR(str1289, "--file");
GLOBAL_STR(str1290, "--symlink");
GLOBAL_STR(str1291, "Expected unary operator, got %r (2 args)");
GLOBAL_STR(str1292, "-a");
GLOBAL_STR(str1293, "-o");
GLOBAL_STR(str1294, "!");
GLOBAL_STR(str1295, "(");
GLOBAL_STR(str1296, ")");
GLOBAL_STR(str1297, "Expected binary operator, got %r (3 args)");
GLOBAL_STR(str1298, "should be invoked as 'test' (simple_test_builtin)");
GLOBAL_STR(str1299, "]");
GLOBAL_STR(str1300, "missing closing ]");
GLOBAL_STR(str1301, "should only have 3 arguments or fewer (simple_test_builtin)");
GLOBAL_STR(str1302, "!");
GLOBAL_STR(str1303, "(");
GLOBAL_STR(str1304, ")");
GLOBAL_STR(str1305, "(test) ");
GLOBAL_STR(str1306, "(test) ");
...
void AddBlock(Dict<int, vm::_Builtin*>* builtins, state::Mem* mem, state::MutableOpts* mutable_opts, state::DirStack* dir_stack, cmd_eval::CommandEvaluator* cmd_ev, vm::_Executor* shell_ex, ui::ErrorFormatter* errfmt);
...
inline Str* fmt41(int a0, Str* a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const(": ", 2);
  gBuf.format_s(a1);
...
inline Str* fmt43(int a0, Str* a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const(": ", 2);
  gBuf.format_s(a1);
...
inline Str* fmt45(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt46(int a0, int a1, Str* a2) {
  gBuf.reset();
...
inline Str* fmt54(Str* a0, int a1, Str* a2) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const(" ", 1);
  gBuf.format_d(a1);
...
inline Str* fmt57(Str* a0, int a1, Str* a2) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const(" ", 1);
  gBuf.format_d(a1);
...
class ctx_OilExpr : public gc_heap::Obj {
 public:
...
inline Str* fmt70(Str* a0) {
  ...
  gBuf.format_r(a0);
  gBuf.write_const(" (try -O or shopt)", 18);
  return gBuf.getvalue();
}
...
inline Str* fmt74(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt77(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.write_const("nameref ", 8);
  gBuf.format_r(a0);
...
inline Str* fmt88(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.write_const("$", 1);
  gBuf.format_s(a0);
...
inline Str* fmt92(Str* a0, int a1, Str* a2) {
  gBuf.reset();
  gBuf.write_const("[ ", 2);
  gBuf.format_s(a0);
...
inline Str* fmt93(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt96(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.write_const("[ ", 2);
  gBuf.format_s(a0);
...
inline Str* fmt97(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt98(Str* a0, int a1, Str* a2, Str* a3) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const(":", 1);
  gBuf.format_d(a1);
...
inline Str* fmt141(int a0, int a1) {
  gBuf.reset();
...
inline Str* fmt154(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt162(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt163(int a0, Str* a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const("  ", 2);
  gBuf.format_s(a1);
...
inline Str* fmt165(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt166(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt179(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt182(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.write_const("alias ", 6);
  gBuf.format_s(a0);
  gBuf.write_const("=", 1);
...
inline Str* fmt191(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt196(Str* a0, int a1) {
  gBuf.reset();
  gBuf.format_s(a0);
...
inline Str* fmt203(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_r(a0);
...
inline Str* fmt208(Str* a0, int a1, int a2) {
  gBuf.reset();
  gBuf.write_const("proc ", 5);
  gBuf.format_r(a0);
...
inline Str* fmt213(int a0, int a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const(" != ", 4);
  gBuf.format_d(a1);
...
inline Str* fmt221(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt227(int a0, int a1) {
  gBuf.reset();
...
inline Str* fmt253(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt267(Str* a0, int a1) {
  gBuf.reset();
...
inline Str* fmt280(Str* a0, Str* a1, syntax_asdl::word_t* a2) {
  gBuf.reset();
...
inline Str* fmt286(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt290(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt354(Str* a0, Str* a1) {
  gBuf.reset();
...
class ctx_Multiline : public gc_heap::Obj {
 public:
...
inline Str* fmt377(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("/", 1);
  gBuf.format_s(a1);
...
ctx_ProcessSub::ctx_ProcessSub(vm::_Executor* shell_ex, runtime_asdl::StatusArray* process_sub_status) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(ctx_ProcessSub)) {
...
ctx_Tracer::ctx_Tracer(dev::Tracer* tracer, Str* label, List<Str*>* argv) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(ctx_Tracer)) {
  this->arg = nullptr;
  if (str_equals(label, str52)) {
    this->arg = argv->index_(0);
  }
  else {
    if (str_equals(label, str53)) {
...
void _PrintShValue(runtime_asdl::value_t* val, mylib::BufWriter* buf) {
  ...
  switch (val->tag_()) {
    ...
    case value_e::MaybeStrArray: {
      ...
      parts = Alloc<List<Str*>>(std::initializer_list<Str*>{str55});
...
Tracer::Tracer(parse_lib::ParseContext* parse_ctx, optview::Exec* exec_opts, state::MutableOpts* mutable_opts, state::Mem* mem, util::_DebugFile* f) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Tracer)) {
  ...
  this->ind = 0;
  this->indents = Alloc<List<Str*>>(std::initializer_list<Str*>{str64});
  this->parse_cache = Alloc<Dict<Str*, syntax_asdl::compound_word*>>();
  this->val_indent = Alloc<value::Str>(str65);
  this->val_punct = Alloc<value::Str>(str66);
  this->val_pid_str = Alloc<value::Str>(str67);
  this->lval_indent = Alloc<lvalue::Named>(str68);
  this->lval_punct = Alloc<lvalue::Named>(str69);
  this->lval_pid_str = Alloc<lvalue::Named>(str70);
}
...
void Tracer::_Inc() {
  ...
  if (this->ind >= len(this->indents)) {
    this->indents->append(str_repeat(str75, this->ind));
  }
}
...
void Tracer::OnProcessStart(int pid, runtime_asdl::trace_t* why) {
  ...
  buf = this->_RichTraceBegin(str77);
  if (!buf) {
    return ;
  }
  UP_why = why;
...
void Tracer::OnProcessEnd(int pid, int status) {
  ...
  buf = this->_RichTraceBegin(str85);
  if (!buf) {
    return ;
  }
...
void Tracer::PushMessage(Str* label, List<Str*>* argv) {
  ...
  buf = this->_RichTraceBegin(str88);
  if (buf) {
    buf->write(label);
    if (str_equals(label, str89)) {
      _PrintArgv(argv, buf);
    }
    else {
      if (str_equals(label, str90)) {
...
void Tracer::PopMessage(Str* label, Str* arg) {
  ...
  this->_Dec();
  buf = this->_RichTraceBegin(str93);
  if (buf) {
    buf->write(label);
    if (arg != nullptr) {
      buf->write(str94);
...
void Tracer::PrintMessage(Str* message) {
  ...
  buf = this->_RichTraceBegin(str96);
  if (!buf) {
    return ;
  }
  buf->write(message);
...
void Tracer::OnShAssignment(runtime_asdl::lvalue_t* lval, syntax_asdl::assign_op_t op, runtime_asdl::value_t* val, int flags, runtime_asdl::scope_t which_scopes) {
  ...
  buf->write(left);
  buf->write(op == assign_op_e::PlusEqual ? str111 : str112);
...
void Tracer::PrintSourceCode(int left_spid, int right_spid, alloc::Arena* arena) {
  ...
  if (left_span->line_id == right_span->line_id) {
    ...
    line = arena->GetLine(left_span->line_id);
    end = line->endswith(str117) ? -1 : len(line);
    buf->write(line->slice(start, end));
    buf->write(str118);
  }
  buf->write(str119);
...
int ShellExecutor::RunBuiltin(int builtin_id, runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  this->errfmt->PushLocation(cmd_val->arg_spids->index_(0));
  try {
    try {
...
int ShellExecutor::RunSimpleCommand(runtime_asdl::cmd_value__Argv* cmd_val, runtime_asdl::CommandStatus* cmd_st, bool do_fork, bool call_procs) {
  ...
  if (builtin_id != consts::NO_INDEX) {
    this->errfmt->Print_(str124, arg0_spid);
    return 1;
  }
    ...
    if (proc_node != nullptr) {
      if (this->exec_opts->strict_errexit()) {
        ...
        if (disabled_spid != runtime::NO_SPID) {
          this->errfmt->Print_(str125, disabled_spid);
          this->errfmt->StderrLine(str126);
          e_die(fmt24(), arg0_spid);
        }
      }
      {  // with
        dev::ctx_Tracer ctx(this->tracer, str128, argv);
  ...
  if (cmd_val->typed_args) {
    e_die(fmt25(arg0), cmd_val->typed_args->spids->index_(0));
  }
  argv0_path = this->search_path->CachedLookup(arg0);
  if (argv0_path == nullptr) {
    this->errfmt->Print_(fmt26(arg0), arg0_spid);
    return 127;
  }
  if (do_fork) {
...
void ShellExecutor::RunPipeline(syntax_asdl::command__Pipeline* node, runtime_asdl::CommandStatus* status_out) {
  ...
  {  // with
    dev::ctx_Tracer ctx(this->tracer, str131, nullptr);
...
Str* ShellExecutor::RunCommandSub(syntax_asdl::command_sub* cs_part) {
  ...
  if (!this->exec_opts->allow_csub_psub()) {
    e_die(fmt27(), word_::LeftMostSpanForPart(cs_part));
  }
  node = cs_part->child;
  if (node->tag_() == command_e::Simple) {
    ...
    if ((len(simple->words) == 0 and (len(simple->redirects) == 1 and simple->redirects->index_(0)->op->id == Id::Redir_Less))) {
      tok = Alloc<Token>(Id::Lit_Chars, runtime::NO_SPID, str133);
  ...
  while (true) {
    ...
    if (n < 0) {
      if (err_num == EINTR) {
        ...
        e_die(fmt28(posix::strerror(err_num)), 2);
      }
    }
    else {
      if (n == 0) {
  ...
  return str136->join(chunks)->rstrip(str137);
}
...
Str* ShellExecutor::RunProcessSub(syntax_asdl::command_sub* cs_part) {
  ...
  if (!this->exec_opts->allow_csub_psub()) {
    e_die(fmt30(), word_::LeftMostSpanForPart(cs_part));
  }
...
runtime_asdl::cmd_value__Argv* MakeBuiltinArgv(List<Str*>* argv1) {
  ...
  argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str141});
  argv->extend(argv1);
...
void AddBlock(Dict<int, vm::_Builtin*>* builtins, state::Mem* mem, state::MutableOpts* mutable_opts, state::DirStack* dir_stack, cmd_eval::CommandEvaluator* cmd_ev, vm::_Executor* shell_ex, ui::ErrorFormatter* errfmt) {
  StackRoots _roots({&builtins, &mem, &mutable_opts, &dir_stack, &cmd_ev, &shell_ex, &errfmt});
...
int Main(Str* lang, args::Reader* arg_r, Dict<Str*, Str*>* environ, bool login_shell, pyutil::_ResourceLoader* loader, void* line_input) {
  ...
  if (flag->help) {
    help_builtin->Run(MakeBuiltinArgv(Alloc<List<Str*>>(std::initializer_list<Str*>{fmt34(lang)})));
    return 0;
  }
  if (flag->version) {
    pyutil::ShowAppVersion(str145, loader);
    return 0;
  }
  no_str = nullptr;
  ...
  if (arg_r->AtEnd()) {
    ...
    dollar0 = arg_r->Peek();
    frame0 = Alloc<state::DebugFrame>(dollar0, str146, no_str, state::LINE_ZERO, 0, 0);
  ...
  if (str_equals(lang, str147)) {
    mutable_opts->SetShoptOption(str148, true);
  }
  ...
  comp_arena->PushSource(Alloc<source::Unused>(str150));
  ...
  hist_arena->PushSource(Alloc<source::Unused>(str151));
  ...
  my_pid = posix::getpid();
  debug_path = str152;
  debug_dir = environ->get(str153);
  if (flag->debug_file != nullptr) {
    debug_path = flag->debug_file;
  }
  else {
    if (debug_dir != nullptr) {
      debug_path = os_path::join(debug_dir, fmt35(my_pid));
    }
  }
  if (len(debug_path)) {
    throw Alloc<NotImplementedError>();
  ...
  if (len(debug_path)) {
    println_stderr(fmt36(debug_path));
  }
  ...
  interp = environ->get(str156, str157);
  ...
  crash_dump_dir = environ->get(str158, str159);
  ...
  if (flag->c != nullptr) {
    ...
    if (flag->i) {
      ...
      if (script_name == nullptr) {
        stdin = mylib::Stdin();
        arena->PushSource(Alloc<source::Stdin>(str160));
        ...
        try {
          ...
          println_stderr(fmt37(script_name, pyutil::strerror(e)));
          return 1;
        }
...
int NullExecutor::RunSimpleCommand(runtime_asdl::cmd_value__Argv* cmd_val, runtime_asdl::CommandStatus* cmd_st, bool do_fork) {
  return RunSimpleCommand(cmd_val, cmd_st, do_fork, true);
}

int NullExecutor::RunSimpleCommand(runtime_asdl::cmd_value__Argv* cmd_val, runtime_asdl::CommandStatus* cmd_st, bool do_fork, bool call_procs) {
  List<Str*>* argv = nullptr;
  int arg0_spid;
  Str* arg0 = nullptr;
  int builtin_id;
  ...
  StackRoots _roots({&cmd_val, &cmd_st, &argv, &arg0, &proc_node, &f, &ast_f, &tree});
...
int FdState::_PushDup(int fd1, syntax_asdl::redir_loc_t* loc) {
  ...
  if (loc->tag_() == redir_loc_e::VarName) {
    ...
    try {
      ...
      if (e->errno == EBADF) {
        this->errfmt->Print_(fmt41(fd1, pyutil::strerror(e)));
        return NO_FD;
      }
      else {
        throw ;
    ...
    if (loc->tag_() == redir_loc_e::Fd) {
      ...
      try {
        ...
        this->errfmt->Print_(fmt42(fd1, pyutil::strerror(e)));
        throw ;
      }
      ...
      try {
        ...
        this->errfmt->Print_(fmt43(fd1, pyutil::strerror(e)));
        if (need_restore) {
  ...
  switch (arg->tag_()) {
    case redirect_arg_e::Path: {
      ...
      try {
        ...
        this->errfmt->Print_(fmt44(arg->filename, pyutil::strerror(e)), r->op_spid);
        throw ;
      }
  ...
  for (ReverseListIter<process::_RedirFrame*> it(frame->saved); !it.Done(); it.Next()) {
    ...
    if (rf->saved_fd == NO_FD) {
      try {
        ...
        println_stderr(fmt45(rf->orig_fd, pyutil::strerror(e)));
        throw ;
      }
    }
    else {
      try {
        ...
        println_stderr(fmt46(rf->saved_fd, rf->orig_fd, pyutil::strerror(e)));
        throw ;
      }
      posix::close(rf->saved_fd);
    }
...
void ExternalProgram::_Exec(Str* argv0_path, List<Str*>* argv, int argv0_spid, Dict<Str*, Str*>* environ, bool should_retry) {
    ...
    if (ok) {
      try {
        ...
        if (match::ShouldHijack(line)) {
          h_argv = Alloc<List<Str*>>(std::initializer_list<Str*>{this->hijack_shebang, argv0_path});
          h_argv->extend(argv->slice(1));
          argv = h_argv;
          argv0_path = this->hijack_shebang;
          println_stderr(fmt47(argv0_path));
        }
        else {
          ;  // pass
        }
  ...
  try {
    ...
    if ((e->errno == ENOEXEC and should_retry)) {
      new_argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str179, argv0_path});
      new_argv->extend(argv->slice(1));
      this->_Exec(str180, new_argv, argv0_spid, environ, false);
    }
    this->errfmt->Print_(fmt48(argv0_path, pyutil::strerror(e)), argv0_spid);
    if (e->errno == EACCES) {
      status = 126;
    }
    else {
...
void SubProgramThunk::Run() {
  ...
  try {
    ...
    println_stderr(fmt51(pyutil::strerror(e)));
    status = 2;
  }
  posix::_exit(status);
}
...
void Process::DisplayJob(int job_id, mylib::Writer* f, int style) {
  ...
  if (job_id == -1) {
    ...
    job_id_str = fmt52(job_id);
  }
  if (style == STYLE_PID_ONLY) {
    f->write(fmt53(this->pid));
  }
  else {
    f->write(fmt54(job_id_str, this->pid, _JobStateStr(this->state)));
...
int Process::Start(runtime_asdl::trace_t* why) {
  ...
  pid = posix::fork();
  if (pid < 0) {
    throw Alloc<RuntimeError>(str194);
  }
  else {
    if (pid == 0) {
...
void Pipeline::DisplayJob(int job_id, mylib::Writer* f, int style) {
  ...
  if (style == STYLE_PID_ONLY) {
    f->write(fmt55(this->procs->index_(0)->pid));
  }
  else {
    i = 0;
    for (ListIter<process::Process*> it(this->procs); !it.Done(); it.Next(), ++i) {
      ...
      StackRoots _for({&proc    });
      if (i == 0) {
        job_id_str = fmt56(job_id);
      }
      else {
        job_id_str = str197;
        f->write(fmt57(job_id_str, proc->pid, _JobStateStr(proc->state)));
...
void Pipeline::DebugPrint() {
  print(fmt58(_JobStateStr(this->state)));
}
...
Str* _JobStateStr(runtime_asdl::job_state_t i) {
  return NewStr(job_state_str(i))->slice(10);
}
...
int Waiter::WaitForOne() {
  ...
  if (pid < 0) {
    ...
    if (errno == ECHILD) {
      ...
      if (errno == EINTR) {
        return this->sig_state->last_sig_num;
      }
      else {
        throw Alloc<AssertionError>();
      }
  ...
  if (WIFSIGNALED(status)) {
    ...
    if (WIFEXITED(status)) {
      ...
      if (WIFSTOPPED(status)) {
        println_stderr(str207);
        println_stderr(fmt60(pid));
...
runtime_asdl::cmd_value__Argv* MakeBuiltinArgv(List<Str*>* argv1) {
  ...
  argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str209});
  argv->extend(argv1);
  return Alloc<cmd_value::Argv>(argv, list_repeat(runtime::NO_SPID, len(argv)), nullptr);
}
...
int Main(Str* lang, args::Reader* arg_r, Dict<Str*, Str*>* environ, bool login_shell, pyutil::_ResourceLoader* loader, void* line_input) {
  ...
  arg_r->Next();
  try {
    attrs = flag_spec::ParseMore(str210, arg_r);
  }
  catch (error::Usage* e) {
    println_stderr(fmt61(e->msg));
    return 2;
  }
  flag = Alloc<arg_types::main>(attrs->attrs);
  arena = Alloc<alloc::Arena>();
  ...
  help_builtin = Alloc<builtin_misc::Help>(loader, errfmt);
  if (flag->help) {
    help_builtin->Run(MakeBuiltinArgv(Alloc<List<Str*>>(std::initializer_list<Str*>{fmt62(lang)})));
    return 0;
  }
  if (flag->version) {
    pyutil::ShowAppVersion(str213, loader);
    return 0;
  }
  no_str = nullptr;
  debug_stack = Alloc<List<state::DebugFrame*>>();
  if (arg_r->AtEnd()) {
    ...
    dollar0 = arg_r->Peek();
    frame0 = Alloc<state::DebugFrame>(dollar0, str214, no_str, state::LINE_ZERO, 0, 0);
    debug_stack->append(frame0);
  }
  frame1 = Alloc<state::DebugFrame>(no_str, no_str, no_str, runtime::NO_SPID, 0, 0);
  debug_stack->append(frame1);
  ...
  if (str_equals(lang, str215)) {
    mutable_opts->SetShoptOption(str216, true);
  }
  builtin_pure::SetShellOpts(mutable_opts, attrs->opt_changes, attrs->shopt_changes);
  aliases = Alloc<Dict<Str*, Str*>>();
  oil_grammar = nullptr;
  ...
  parse_ctx->Init_OnePassParse(flag->one_pass_parse);
  comp_arena = Alloc<alloc::Arena>();
  comp_arena->PushSource(Alloc<source::Unused>(str218));
  trail1 = Alloc<parse_lib::Trail>();
  comp_ctx = Alloc<parse_lib::ParseContext>(comp_arena, parse_opts, aliases, oil_grammar);
  comp_ctx->Init_Trail(trail1);
  comp_ctx->Init_OnePassParse(true);
  hist_arena = Alloc<alloc::Arena>();
  hist_arena->PushSource(Alloc<source::Unused>(str219));
  trail2 = Alloc<parse_lib::Trail>();
  hist_ctx = Alloc<parse_lib::ParseContext>(hist_arena, parse_opts, aliases, oil_grammar);
  hist_ctx->Init_Trail(trail2);
  cmd_deps = Alloc<cmd_eval::Deps>();
  ...
  my_pid = posix::getpid();
  debug_path = str220;
  debug_dir = environ->get(str221);
  if (flag->debug_file != nullptr) {
    debug_path = flag->debug_file;
  }
  else {
    if (debug_dir != nullptr) {
      debug_path = os_path::join(debug_dir, fmt63(my_pid));
    }
  }
  if (len(debug_path)) {
    throw Alloc<NotImplementedError>();
  ...
  cmd_deps->debug_f = debug_f;
  if (len(debug_path)) {
    println_stderr(fmt64(debug_path));
  }
  if (flag->xtrace_to_debug_file) {
    trace_f = debug_f;
  }
  ...
  waiter = Alloc<process::Waiter>(job_state, exec_opts, sig_state, tracer);
  fd_state->waiter = waiter;
  interp = environ->get(str224, str225);
  search_path = Alloc<state::SearchPath>(mem);
  ext_prog = Alloc<process::ExternalProgram>(interp, fd_state, errfmt, debug_f);
  splitter = Alloc<split::SplitContext>(mem);
  crash_dump_dir = environ->get(str226, str227);
  cmd_deps->dumper = Alloc<dev::CrashDumper>(crash_dump_dir);
  dir_stack = Alloc<state::DirStack>();
  builtins = Alloc<Dict<int, vm::_Builtin*>>();
  modules = Alloc<Dict<Str*, bool>>();
  ...
  if (flag->c != nullptr) {
    ...
    if (flag->i) {
      ...
      if (script_name == nullptr) {
        stdin = mylib::Stdin();
        arena->PushSource(Alloc<source::Stdin>(str228));
        line_reader = Alloc<reader::FileLineReader>(stdin, arena);
      }
      else {
        arena->PushSource(Alloc<source::MainFile>(script_name));
        try {
          ...
          println_stderr(fmt65(script_name, pyutil::strerror(e)));
          return 1;
        }
        line_reader = Alloc<reader::FileLineReader>(f, arena);
      }
...
Str* SearchPath::Lookup(Str* name, bool exec_required) {
  ...
  val = this->mem->GetValue(str235);
  UP_val = val;
  if (val->tag_() == value_e::Str) {
    value__Str* val = static_cast<value__Str*>(UP_val);
    path_list = val->s->split(str236);
  }
  else {
...
ctx_OilExpr::ctx_OilExpr(state::MutableOpts* mutable_opts) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(ctx_OilExpr)) {
...
void MutableOpts::Init() {
  ...
  UP_shellopts = this->mem->GetValue(str240);
...
void MutableOpts::SetOption(Str* opt_name, bool b) {
  ...
  UP_val = this->mem->GetValue(str244);
  value__Str* val = static_cast<value__Str*>(UP_val);
  shellopts = val->s;
  if (b) {
    if (!str_contains(shellopts, opt_name)) {
      new_val = Alloc<value::Str>(fmt71(shellopts, opt_name));
      this->mem->InternalSetGlobal(str246, new_val);
    }
  }
  else {
    if (str_contains(shellopts, opt_name)) {
      names = Alloc<List<Str*>>();
      for (ListIter<Str*> it(shellopts->split(str247)); !it.Done(); it.Next()) {
        Str* n = it.Value();
        if (!(str_equals(n, opt_name))) {
          names->append(n);
        }
      }
      new_val = Alloc<value::Str>(str248->join(names));
      this->mem->InternalSetGlobal(str249, new_val);
    }
  }
}
...
void MutableOpts::SetShoptOption(Str* opt_name, bool b) {
  ...
  if (str_equals(opt_name, str250)) {
    this->_SetGroup(consts::OIL_BASIC, b);
    this->SetDeferredErrExit(b);
    return ;
  }
  if (str_equals(opt_name, str251)) {
    this->_SetGroup(consts::OIL_ALL, b);
    this->SetDeferredErrExit(b);
    return ;
  }
  if (str_equals(opt_name, str252)) {
...
void MutableOpts::ShowOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    b = this->Get(opt_num);
    print(fmt72(b ? str254 : str255, opt_name));
  }
}
...
void MutableOpts::ShowShoptOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<int> it(opt_nums); !it.Done(); it.Next()) {
    int opt_num = it.Value();
    StackRoots _for({&opt_num  });
    b = this->opt0_array->index_(opt_num);
    print(fmt74(b ? str261 : str262, consts::OptionName(opt_num)));
  }
}
...
void _InitDefaults(state::Mem* mem) {
  ...
  SetGlobalString(mem, str265, split::DEFAULT_IFS);
  SetGlobalString(mem, str266, str(posix::getuid()));
  SetGlobalString(mem, str267, str(posix::geteuid()));
  SetGlobalString(mem, str268, str(posix::getppid()));
  SetGlobalString(mem, str269, libc::gethostname());
  SetGlobalString(mem, str270, pyos::OsType());
  SetGlobalString(mem, str271, str272);
  SetGlobalString(mem, str273, str274);
  SetGlobalString(mem, str275, _READLINE_DELIMS);
}
...
void _InitVarsFromEnv(state::Mem* mem, Dict<Str*, Str*>* environ) {
  ...
  val = mem->GetValue(str276);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str277, str278);
  }
  mem->SetValue(Alloc<lvalue::Named>(str279), nullptr, scope_e::GlobalOnly, SetReadOnly);
  val = mem->GetValue(str280);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str281, _GetWorkingDir());
  }
  mem->SetValue(Alloc<lvalue::Named>(str282), nullptr, scope_e::GlobalOnly, SetExport);
  val = mem->GetValue(str283);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str284, str285);
  }
}
...
void InitMem(state::Mem* mem, Dict<Str*, Str*>* environ, Str* version_str) {
  ...
  SetGlobalString(mem, str286, version_str);
  _InitDefaults(mem);
  _InitVarsFromEnv(mem, environ);
  val = mem->GetValue(str287);
...
void InitInteractive(state::Mem* mem) {
  ...
  if (mem->GetValue(str288)->tag_() == value_e::Undef) {
    SetGlobalString(mem, str289, str290);
  }
}
...
Mem::Mem(Str* dollar0, List<Str*>* argv, alloc::Arena* arena, List<state::DebugFrame*>* debug_stack) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Mem)) {
  ...
  this->line_num = Alloc<value::Str>(str291);
  this->root_pid = posix::getpid();
  this->last_status = Alloc<List<int>>(std::initializer_list<int>{0});
  this->try_status = Alloc<List<int>>(std::initializer_list<int>{0});
...
Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> Mem::_ResolveNameOrRef(Str* name, runtime_asdl::scope_t which_scopes, bool is_setref, List<Str*>* ref_trail) {
  ...
  if (ref_trail == nullptr) {
    ...
    if (list_contains(ref_trail, new_name)) {
      e_die(fmt78(str303->join(ref_trail)));
    }
  }
  ...
  switch (lval->tag_()) {
    case lvalue_e::Named: {
      ...
      if (keyword_id == Id::KW_SetRef) {
        lval->name = str_concat(str304, lval->name);
      }
    ...
    case lvalue_e::Indexed: {
      ...
      e_die(fmt82(ui::ValType(cell->val)), left_spid);
    }
      break;
    case lvalue_e::Keyed: {
      lvalue__Keyed* lval = static_cast<lvalue__Keyed*>(UP_lval);
...
runtime_asdl::value_t* Mem::GetValue(Str* name, runtime_asdl::scope_t which_scopes) {
  ...
  if (str_equals(name, str312)) {
    return Alloc<value::MaybeStrArray>(this->GetArgv());
  }
  if (str_equals(name, str313)) {
    // if not PYTHON
    {
      return Alloc<value::Undef>();
    }
  ...
  if ((str_equals(name, str315) || str_equals(name, str316))) {
    return Alloc<value::MaybeStrArray>();
  }
  if (str_equals(name, str317)) {
    return Alloc<value::MaybeStrArray>();
  }
  if (str_equals(name, str318)) {
    return Alloc<value::MaybeStrArray>(this->regex_matches->index_(-1));
  }
  if (str_equals(name, str319)) {
    strs = Alloc<List<Str*>>();
...
bool Mem::Unset(runtime_asdl::lvalue_t* lval, runtime_asdl::scope_t which_scopes) {
  ...
  if (cell->readonly) {
    throw Alloc<error::Runtime>(fmt84(var_name));
  }
  switch (lval->tag_()) {
    case lvalue_e::Named: {
    ...
    case lvalue_e::Indexed: {
      ...
      if (val->tag_() != value_e::MaybeStrArray) {
        throw Alloc<error::Runtime>(fmt85(var_name));
      }
      value__MaybeStrArray* val = static_cast<value__MaybeStrArray*>(UP_val);
      strs = val->strs;
      n = len(strs);
  ...
  if (which_scopes == scope_e::Dynamic) {
    ...
    if (which_scopes == scope_e::LocalOnly) {
      ...
      if (which_scopes == scope_e::GlobalOnly) {
        ...
        if (which_scopes == scope_e::LocalOrGlobal) {
          scopes = Alloc<List<Dict<Str*, runtime_asdl::cell*>*>>(std::initializer_list<Dict<Str*, runtime_asdl::cell*>*>{this->var_stack->index_(0)});
...
Str* GetString(state::Mem* mem, Str* name) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      throw Alloc<error::Runtime>(fmt86(name));
    }
      break;
    case value_e::Str: {
      ...
      break;
    default: {
      throw Alloc<error::Runtime>(fmt87(name));
    }
  }
}
...
int GetInteger(state::Mem* mem, Str* name) {
  ...
  val = mem->GetValue(name);
  if (val->tag_() != value_e::Str) {
    throw Alloc<error::Runtime>(fmt88(name, ui::ValType(val)));
  }
  ...
  try {
    ...
    throw Alloc<error::Runtime>(fmt89(name, s));
  }
  return i;
}
...
Str* PrettyDir(Str* dir_name, Str* home_dir) {
  ...
  if (home_dir != nullptr) {
    if ((str_equals(dir_name, home_dir) or dir_name->startswith(str_concat(home_dir, str333)))) {
      return str_concat(str334, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    StackRoots _for({&c  });
    buf->write(str_equals(c, str337) ? str338 : str339);
  }
  buf->write(str340);
  buf->write(str_repeat(str341, (length - 1)));
  buf->write(str342);
  ...
  switch (src->tag_()) {
    ...
    case source_e::ArgvWord: {
      ...
      if (src->span_id == runtime::NO_SPID) {
        ...
        s = fmt92(src->what, line_num, outer_source);
      }
    }
      break;
    case source_e::Variable: {
      ...
      if (src->span_id == runtime::NO_SPID) {
        ...
        line_num = arena->GetLineNumber(span->line_id);
        outer_source = GetLineSourceString(arena, span->line_id, quote_filename);
        where = fmt93(line_num, outer_source);
      }
      s = fmt94(var_name, where);
    }
      break;
    case source_e::Alias: {
...
void _PrintWithSpanId(Str* prefix, Str* msg, int span_id, alloc::Arena* arena, bool show_code) {
  ...
  f->write(fmt98(source_str, line_num, prefix, msg));
}
...
void ErrorFormatter::Print_(Str* msg, int span_id) {
  ...
  _PrintWithSpanId(str357, msg, span_id, this->arena, true);
}
...
void ErrorFormatter::PrintMessage(Str* msg, int span_id) {
  ...
  _PrintWithSpanId(str358, msg, span_id, this->arena, false);
}
...
void PrintAst(syntax_asdl::command_t* node, arg_types::main* flag) {
  ...
  if (maybe_str_equals(flag->ast_format, str361)) {
    println_stderr(str362);
  }
  else {
    f = mylib::Stdout();
    afmt = flag->ast_format;
    if ((maybe_str_equals(afmt, str363) || maybe_str_equals(afmt, str364))) {
      ast_f = fmt::DetectConsoleOutput(f);
    }
    else {
      if ((maybe_str_equals(afmt, str365) || maybe_str_equals(afmt, str366))) {
...
void _Attributes::Set(Str* name, runtime_asdl::value_t* val) {
  ...
  name = name->replace(str370, str371);
...
bool SetAttachedBool::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  if (attached_arg != nullptr) {
    if ((str_equals(attached_arg, str387) || str_equals(attached_arg, str388) || str_equals(attached_arg, str389) || str_equals(attached_arg, str390))) {
      b = false;
    }
    else {
      if ((str_equals(attached_arg, str391) || str_equals(attached_arg, str392) || str_equals(attached_arg, str393) || str_equals(attached_arg, str394))) {
        b = true;
      }
      else {
        e_usage(fmt100(attached_arg));
      }
    }
  }
  else {
...
bool SetOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str396);
...
bool SetNamedOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str397);
  arg_r->Next();
  arg = arg_r->Peek();
  if (arg == nullptr) {
...
args::_Attributes* Parse(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str401)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if ((len(spec->actions_long) and arg->startswith(str402))) {
      pos = arg->find(str403, 2);
      if (pos == -1) {
        suffix = nullptr;
      ...
      if ((arg->startswith(str405) and len(arg) > 1)) {
        n = len(arg);
        for (int i = 1; i < n; ++i) {
          ch = arg->index_(i);
          if (str_equals(ch, str406)) {
            ch = str407;
          }
          if (list_contains(spec->plus_flags, ch)) {
            out->Set(ch, Alloc<value::Str>(str408));
            continue;
          }
        ...
        if ((len(spec->plus_flags) and (arg->startswith(str411) and len(arg) > 1))) {
          n = len(arg);
          for (int i = 1; i < n; ++i) {
            ch = arg->index_(i);
            if (list_contains(spec->plus_flags, ch)) {
              out->Set(ch, Alloc<value::Str>(str412));
              continue;
            }
            e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
          }
...
args::_Attributes* ParseLikeEcho(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    chars = arg->slice(1);
    if ((arg->startswith(str415) and len(chars))) {
      done = false;
...
args::_Attributes* ParseMore(flag_spec::_FlagSpecAndMore* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str416)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if (arg->startswith(str417)) {
    ...
    if (((arg->startswith(str419) or arg->startswith(str420)) and len(arg) > 1)) {
      char0 = arg->index_(0);
...
int LineLexer::GetSpanIdForEof() {
  int line_id;
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str424, 0);
  }
  else {
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str426, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = Alloc<Token>(id_, span_id, str427);
      return t;
    }
...
lexer::Lexer* ParseContext::MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = Alloc<lexer::LineLexer>(str429, this->arena);
...
Tuple2<pnode::PNode*, syntax_asdl::Token*> ParseContext::_ParseOil(lexer::Lexer* lexer, int start_symbol) {
  ...
  e_parser = Alloc<expr_parse::ExprParser>(this, this->oil_grammar);
...
syntax_asdl::Token* ParseContext::ParseFunc(lexer::Lexer* lexer, syntax_asdl::command__Func* out) {
  ...
  Tuple2<pnode::PNode*, syntax_asdl::Token*> tup7 = this->_ParseOil(lexer, grammar_nt::named_func);
  pnode = tup7.at0();
  last_token = tup7.at1();
...
syntax_asdl::Token* ParseContext::ParseDataType(lexer::Lexer* lexer, syntax_asdl::command__Data* out) {
  ...
  Tuple2<pnode::PNode*, syntax_asdl::Token*> tup8 = this->_ParseOil(lexer, grammar_nt::tea_data);
  pnode = tup8.at0();
  last_token = tup8.at1();
...
syntax_asdl::Token* ParseContext::ParseEnum(lexer::Lexer* lexer, syntax_asdl::command__Enum* out) {
  ...
  Tuple2<pnode::PNode*, syntax_asdl::Token*> tup9 = this->_ParseOil(lexer, grammar_nt::tea_enum);
  pnode = tup9.at0();
  last_token = tup9.at1();
...
syntax_asdl::Token* ParseContext::ParseClass(lexer::Lexer* lexer, syntax_asdl::command__Class* out) {
  ...
  Tuple2<pnode::PNode*, syntax_asdl::Token*> tup10 = this->_ParseOil(lexer, grammar_nt::tea_class);
  pnode = tup10.at0();
...
syntax_asdl::Token* ParseContext::ParseImport(lexer::Lexer* lexer, syntax_asdl::command__Import* out) {
  ...
  Tuple2<pnode::PNode*, syntax_asdl::Token*> tup11 = this->_ParseOil(lexer, grammar_nt::tea_import);
  pnode = tup11.at0();
    ...
    if (n == 1) {
      ...
      switch (arg->tag_()) {
        ...
        case expr_e::CommandSub: {
          ...
          break;
        default: {
          e_usage(fmt107(), arg_list->spids->index_(0));
        }
      }
    }
    else {
      e_usage(fmt108(), arg_list->spids->index_(0));
    }
  }
}
...
int _Classify(grammar::Grammar* gr, syntax_asdl::Token* tok) {
  ...
  if (tok->id == Id::Unknown_Tok) {
    ...
    type_str = fmt110(ui::PrettyId(tok->id));
  }
  p_die(fmt111(type_str), tok);
}
...
Tuple2<pnode::PNode*, syntax_asdl::Token*> ExprParser::Parse(lexer::Lexer* lexer, int start_symbol) {
  ...
  try {
    ...
    p_die(fmt112(ui::PrettyId(e->tok->id)), e->tok);
  }
...
GLOBAL_LIST(Str*, 12, POSIX_CLASSES, {str443 COMMA str444 COMMA str445 COMMA str446 COMMA str447 COMMA str448 COMMA str449 COMMA str450 COMMA str451 COMMA str452 COMMA str453 COMMA str454});
Str* RANGE_POINT_TOO_LONG = str455;
int NT_OFFSET = 256;
...
syntax_asdl::expr_t* Transformer::_Tuple(List<pnode::PNode*>* children) {
  ...
  if (n == 2) {
    p_die(fmt113(), children->index_(1)->tok);
  }
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw Alloc<NotImplementedError>(str457);
  }
  if (id0 == Id::Op_LBracket) {
    elts = Alloc<List<syntax_asdl::expr_t*>>();
    for (int i = 0; i < n; i += 2) {
  ...
  for (int i = 0; i < n; i += 2) {
    ...
    if (tag == expr_e::Var) {
      ...
      if ((tag == place_expr_e::Var || tag == place_expr_e::Subscript || tag == place_expr_e::Attribute)) {
        ...
        p_die(fmt115(), p->tok ? p->tok : nullptr);
      }
    }
  }
  return places;
  ...
  while (i < n) {
    ...
    if ((prefix and prefix->id == Id::Expr_At)) {
      ...
      if (typ == nullptr) {
        ...
        if ((typ->val != str462 && typ->val != str463)) {
          p_die(fmt116(), typ);
        }
...
Str* Transformer::_RangeChar(pnode::PNode* p_node) {
  ...
  if (ISNONTERMINAL(typ)) {
    if (typ == grammar_nt::sq_string) {
      ...
      s = tokens->index_(0)->val->index_(0);
      return s;
    }
...
syntax_asdl::re_t* Transformer::_NameInRegex(syntax_asdl::Token* negated_tok, syntax_asdl::Token* tok) {
  ...
  val = tok->val;
  if (maybe_str_equals(val, str466)) {
    if (negated_tok) {
      p_die(fmt117(), tok);
    }
    return tok;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((str_equals(tok->val, str471) || str_equals(tok->val, str472) || str_equals(tok->val, str473))) {
        return tok;
      }
      p_die(fmt121(tok->val), tok);
    }
    ...
    if (tok->id == Id::Expr_Bang) {
      ...
      if (ISNONTERMINAL(typ)) {
        return Alloc<re::ClassLiteral>(true, this->_ClassLiteral(children->index_(1)));
      }
      else {
...
void _ClassLiteralToPosixEre(syntax_asdl::class_literal_term_t* term, List<Str*>* parts) {
  ...
  if (tag == class_literal_term_e::CodePoint) {
    ...
    if (code_point < 128) {
      ...
      e_die(fmt123(code_point), term->spid);
    }
    return ;
  }
  ...
  if (tag == class_literal_term_e::PosixClass) {
    ...
    n = term->name;
    if (term->negated) {
      e_die(fmt126(), term->negated->span_id);
    }
    else {
      pat = fmt127(n);
    }
...
void AsPosixEre(syntax_asdl::re_t* node, List<Str*>* parts) {
  ...
  if (tag == re_e::Repeat) {
    ...
    if (op_tag == re_repeat_e::Num) {
      ...
      parts->append(fmt129(op->times->val));
      return ;
    }
    if (op_tag == re_repeat_e::Range) {
      re_repeat__Range* op = static_cast<re_repeat__Range*>(UP_op);
      lower = op->lower ? op->lower->val : str490;
      upper = op->upper ? op->upper->val : str491;
      parts->append(fmt130(lower, upper));
      return ;
    }
...
syntax_asdl::bool_expr_t* BoolParser::ParseFactor() {
  ...
  if (this->bool_id == Id::Op_LParen) {
    ...
    if (this->bool_id != Id::Op_RParen) {
      p_die(fmt139(word_::Pretty(this->cur_word)), this->cur_word);
    }
    this->_Next();
    return node;
  }
  p_die(fmt140(ui::PrettyId(this->bool_id)), this->cur_word);
}
...
Str* _RangeParser::_Eat(int token_type) {
  ...
  if (this->token_type != token_type) {
    throw Alloc<_NotARange>(fmt141(token_type, this->token_type));
  }
  val = this->token_val;
  this->_Next();
  return val;
  ...
  if (this->token_type == Id::Range_Int) {
    ...
    if (this->token_type == Id::Range_Char) {
      ...
      if (start_num < end_num) {
        ...
        if (part->step <= 0) {
          p_die(fmt145(part->step), this->span_id);
        }
      }
      else {
        if (start_num > end_num) {
          ...
          if (part->step >= 0) {
            p_die(fmt146(part->step), this->span_id);
          }
        }
        else {
          part->step = 1;
      ...
      if (upper1 != upper2) {
        p_die(fmt147(), this->span_id);
      }
    }
    else {
      throw Alloc<_NotARange>(str516);
    }
  }
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  flag = attrs->attrs;
  tmp_g = flag->get(str519);
  tmp_a = flag->get(str520);
  tmp_A = flag->get(str521);
  ...
  flag_A = (tmp_A and tmp_A->tag_() == value_e::Bool) ? static_cast<value__Bool*>(tmp_A)->b : false;
  tmp_n = flag->get(str522);
  tmp_r = flag->get(str523);
  tmp_x = flag->get(str524);
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if ((maybe_str_equals(flag_n, str526) and !cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_n, str527) and cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str528) and !cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str529) and cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str530) and !cell->exported)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str531) and cell->exported)) {
      continue;
    }
    ...
    if (print_flags) {
      ...
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str538, str539->join(flags), str540, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str541, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (has_holes) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str544, name, str545, str(i), str546, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str548, str549->join(body), str550}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str552, key_quoted, str553, value_quoted}));
          }
          if (len(body) > 0) {
            decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str554, str555->join(body), str556}));
          }
        }
        else {
          ;  // pass
...
int Export::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r->Next();
  attrs = flag_spec::Parse(str558, arg_r);
...
int Readonly::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str563, arg_r);
...
int NewVar::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str564, arg_r);
  ...
  flags = 0;
  if (maybe_str_equals(arg->x, str567)) {
    flags |= state::SetExport;
  }
  if (maybe_str_equals(arg->r, str568)) {
    flags |= state::SetReadOnly;
  }
  if (maybe_str_equals(arg->n, str569)) {
    flags |= state::SetNameref;
  }
  flags_to_clear = 0;
  if (maybe_str_equals(arg->x, str570)) {
    flags |= state::ClearExport;
  }
  if (maybe_str_equals(arg->r, str571)) {
    flags |= state::ClearReadOnly;
  }
  if (maybe_str_equals(arg->n, str572)) {
...
int Unset::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str573, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
...
int Eval::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str576, cmd_val);
  arg_r = tup0.at1();
  if (this->exec_opts->simple_eval_builtin()) {
    Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str577);
    code_str = tup1.at0();
    eval_spid = tup1.at1();
    if (!arg_r->AtEnd()) {
      e_usage(str578);
    ...
    code_str = str579->join(arg_r->Rest());
    eval_spid = cmd_val->arg_spids->index_(0);
  }
  line_reader = reader::StringLineReader(code_str, this->arena);
  c_parser = this->parse_ctx->MakeOshParser(line_reader);
  src = Alloc<source::ArgvWord>(str580, eval_spid);
  {  // with
    dev::ctx_Tracer ctx(this->tracer, str581, nullptr);
...
int Source::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str582, cmd_val);
  arg_r = tup2.at1();
  path = arg_r->Peek();
  if (path == nullptr) {
    e_usage(str583);
  ...
  try {
    ...
    this->errfmt->Print_(fmt154(path, pyutil::strerror(e)), cmd_val->arg_spids->index_(1));
    return 1;
  }
  try {
    try {
      ...
      c_parser = this->parse_ctx->MakeOshParser(line_reader);
      {  // with
        dev::ctx_Tracer ctx(this->tracer, str585, cmd_val->argv);
...
int Command::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup3 = flag_spec::ParseCmdVal(str586, cmd_val, true);
  attrs = tup3.at0();
  arg_r = tup3.at1();
...
int Builtin::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (to_run == consts::NO_INDEX) {
    ...
    if (consts::LookupAssignBuiltin(name) != consts::NO_INDEX) {
      this->errfmt->Print_(str587, span_id);
    }
    else {
      this->errfmt->Print_(fmt155(name), span_id);
    }
    return 1;
  }
...
int RunProc::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str589, cmd_val, true);
  arg_r = tup5.at1();
  Tuple2<List<Str*>*, List<int>*> tup6 = arg_r->Rest2();
  argv = tup6.at0();
  spids = tup6.at1();
  if (len(argv) == 0) {
    throw Alloc<error::Usage>(str590, runtime::NO_SPID);
  }
  name = argv->index_(0);
  if (!dict_contains(this->procs, name)) {
...
int Try::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup7 = flag_spec::ParseCmdVal(str592, cmd_val, true);
  arg_r = tup7.at1();
...
int BoolStatus::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseCmdVal(str594, cmd_val);
  arg_r = tup9.at1();
  if (arg_r->Peek() == nullptr) {
    e_usage(str595);
  }
  ...
  if ((status != 0 && status != 1)) {
    throw Alloc<error::FatalRuntime>(fmt157(status), spids->index_(0), status);
  }
  return status;
}
...
List<Tuple2<Str*, Str*>*>* _ResolveNames(List<Str*>* names, Dict<Str*, runtime_asdl::Proc*>* funcs, Dict<Str*, Str*>* aliases, state::SearchPath* search_path) {
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if (dict_contains(funcs, name)) {
      kind = (Alloc<Tuple2<Str*, Str*>>(str597, name));
    }
    else {
      if (dict_contains(aliases, name)) {
        kind = (Alloc<Tuple2<Str*, Str*>>(str598, name));
      }
      else {
        if (consts::LookupNormalBuiltin(name) != 0) {
          kind = (Alloc<Tuple2<Str*, Str*>>(str599, name));
        }
        else {
          if (consts::LookupSpecialBuiltin(name) != 0) {
            kind = (Alloc<Tuple2<Str*, Str*>>(str600, name));
          }
          else {
            if (consts::LookupAssignBuiltin(name) != 0) {
              kind = (Alloc<Tuple2<Str*, Str*>>(str601, name));
            }
            else {
              if (consts::IsControlFlow(name)) {
                kind = (Alloc<Tuple2<Str*, Str*>>(str602, name));
              }
              else {
                if (consts::IsKeyword(name)) {
                  kind = (Alloc<Tuple2<Str*, Str*>>(str603, name));
                }
                else {
                  ...
                  if (resolved == nullptr) {
                    ...
                    kind = (Alloc<Tuple2<Str*, Str*>>(str604, resolved));
                  }
                }
              }
            }
...
int Type::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseCmdVal(str605, cmd_val);
  attrs = tup11.at0();
  arg_r = tup11.at1();
  ...
  for (ListIter<Tuple2<Str*, Str*>*> it(r); !it.Done(); it.Next()) {
    ...
    if (kind == nullptr) {
      if (!arg->t) {
        this->errfmt->PrintMessage(fmt158(name));
      }
      status = 1;
    }
    else {
      if (arg->t) {
        ...
        if (arg->p) {
          if (str_equals(kind, str607)) {
            print(name);
          }
        }
        else {
          if (arg->P) {
            if (str_equals(kind, str608)) {
              print(name);
            }
            else {
            ...
            print(fmt159(name, kind));
            if (str_equals(kind, str610)) {
              ;  // pass
            }
          }
        }
...
int Read::_Line(arg_types::read* arg, Str* var_name) {
  ...
  if (!arg->with_eol) {
    if (line->endswith(str613)) {
      line = line->slice(0, -2);
    }
    else {
      if (line->endswith(str614)) {
        line = line->slice(0, -1);
      }
    }
  }
  if ((arg->q and line->startswith(str615))) {
    arena = this->parse_ctx->arena;
    line_reader = reader::StringLineReader(line, arena);
    lexer = this->parse_ctx->MakeLexer(line_reader);
    try {
      {  // with
        alloc::ctx_Location ctx(arena, Alloc<source::Stdin>(str616));
...
int Read::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  try {
    ...
    this->errfmt->PrintMessage(fmt160(posix::strerror(e->err_num)));
    status = 1;
  }
  return status;
}
...
int Read::_Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str619, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
  ...
  if (arg->line) {
    ...
    next_spid = tup8.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str622, next_spid);
    }
  ...
  if (arg->all) {
    ...
    next_spid = tup10.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str626, next_spid);
    }
...
int MapFile::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup13 = flag_spec::ParseCmdVal(str633, cmd_val);
  attrs = tup13.at0();
  arg_r = tup13.at1();
  ...
  while (true) {
    try {
      ...
      this->errfmt->PrintMessage(fmt161(posix::strerror(e->err_num)));
      return 1;
    }
    if (len(line) == 0) {
      break;
    }
    if ((arg->t and line->endswith(str637))) {
      line = line->slice(0, -1);
    }
    lines->append(line);
  }
...
int Cd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  int err_num;
  syntax_asdl::command_t* block = nullptr;
  StackRoots _roots({&cmd_val, &attrs, &arg_r, &arg, &dest_dir, &val, &pwd, &abspath, &real_dest_dir, &block});

  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str638, cmd_val, true);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  ...
  arg_spid = tup16.at1();
  if (dest_dir == nullptr) {
    val = this->mem->GetValue(str639);
    try {
      dest_dir = state::GetString(this->mem, str640);
    }
    catch (error::Runtime* e) {
  ...
  if (str_equals(dest_dir, str641)) {
    try {
      dest_dir = state::GetString(this->mem, str642);
      print(dest_dir);
    }
    catch (error::Runtime* e) {
      this->errfmt->Print_(e->UserErrorString());
  ...
  try {
    pwd = state::GetString(this->mem, str643);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    return 1;
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt162(real_dest_dir, posix::strerror(err_num)), arg_spid);
    return 1;
  }
  state::ExportGlobalString(this->mem, str645, real_dest_dir);
  ...
  if (block) {
    ...
    state::ExportGlobalString(this->mem, str646, pwd);
...
void _PrintDirStack(state::DirStack* dir_stack, int style, Str* home_dir) {
  ...
  if (style == WITH_LINE_NUMBERS) {
    ...
    for (ListIter<Str*> it(dir_stack->Iter()); !it.Done(); it.Next(), ++i) {
      ...
      print(fmt163(i, ui::PrettyDir(entry, home_dir)));
    }
  }
  else {
...
int Pushd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup17 = flag_spec::ParseCmdVal(str649, cmd_val);
  arg_r = tup17.at1();
  Tuple2<Str*, int> tup18 = arg_r->Peek2();
  dir_arg = tup18.at0();
  dir_arg_spid = tup18.at1();
  if (dir_arg == nullptr) {
    this->errfmt->Print_(str650);
    return 1;
  }
  arg_r->Next();
  ...
  if (extra != nullptr) {
    e_usage(fmt164(), extra_spid);
  }
  dest_dir = os_path::abspath(dir_arg);
  err_num = pyos::Chdir(dest_dir);
  if (err_num != 0) {
    this->errfmt->Print_(fmt165(dest_dir, posix::strerror(err_num)), dir_arg_spid);
    return 1;
  }
  this->dir_stack->Push(dest_dir);
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str653));
  state::ExportGlobalString(this->mem, str654, dest_dir);
...
bool _PopDirStack(state::Mem* mem, state::DirStack* dir_stack, ui::ErrorFormatter* errfmt) {
  ...
  if (dest_dir == nullptr) {
    errfmt->Print_(str655);
    return false;
  }
  err_num = pyos::Chdir(dest_dir);
  if (err_num != 0) {
    errfmt->Print_(fmt166(dest_dir, posix::strerror(err_num)));
    return false;
  }
  state::SetGlobalString(mem, str657, dest_dir);
  mem->SetPwd(dest_dir);
  return true;
}
...
int Popd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Str* extra = nullptr;
  int extra_spid;
  StackRoots _roots({&cmd_val, &arg_r, &extra});

  Tuple2<args::_Attributes*, args::Reader*> tup20 = flag_spec::ParseCmdVal(str658, cmd_val);
  arg_r = tup20.at1();
  Tuple2<Str*, int> tup21 = arg_r->Peek2();
  extra = tup21.at0();
  extra_spid = tup21.at1();
  if (extra != nullptr) {
    e_usage(fmt167(), extra_spid);
  }
  if (!_PopDirStack(this->mem, this->dir_stack, this->errfmt)) {
    return 1;
  }
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str660));
  return 0;
}
...
int Dirs::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup22 = flag_spec::ParseCmdVal(str661, cmd_val);
  attrs = tup22.at0();
  arg_r = tup22.at1();
  arg = Alloc<arg_types::dirs>(attrs->attrs);
  home_dir = state::MaybeString(this->mem, str662);
  style = SINGLE_LINE;
  if (arg->l) {
    home_dir = nullptr;
  }
...
int Pwd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup23 = flag_spec::ParseCmdVal(str663, cmd_val);
  attrs = tup23.at0();
  arg_r = tup23.at1();
...
List<Str*>* Help::_Groups() {
  ...
  contents = this->loader->Get(str664);
...
int Help::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup24 = flag_spec::ParseCmdVal(str665, cmd_val);
  attrs = tup24.at0();
  arg_r = tup24.at1();
  ...
  try {
    contents = this->loader->Get(fmt168(topic));
  }
  catch (IOError*) {
    this->errfmt->Print_(fmt169(topic), blame_spid);
    return 1;
  }
  print(contents);
  return 0;
  ...
  while (true) {
    ...
    if (n < 0) {
      if (err_num == EINTR) {
        ...
        e_die(fmt170(posix::strerror(err_num)), 2);
      }
    }
    else {
      if (n == 0) {
...
syntax_asdl::printf_part_t* _FormatStringParser::_ParseFormatStr() {
  ...
  while ((this->token_type == Id::Format_Flag || this->token_type == Id::Format_Zero)) {
    ...
    if (str_contains(str670, flag)) {
      p_die(fmt171(flag), this->cur_token);
    }
  ...
  if ((this->token_type == Id::Format_Type || this->token_type == Id::Format_Time)) {
    ...
    if (str_contains(str672, part->type->val)) {
      p_die(fmt172(), part->type);
    }
    if (maybe_str_equals(part->type->val, str674)) {
      p_die(fmt173(), part->type);
    }
  }
  else {
        ...
        if (part->tag_() == printf_part_e::Percent) {
          ...
          if (part->width) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt176(width_str), width_spid);
              return 1;
            }
          }
          precision = -1;
          if (part->precision) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt177(precision_str), precision_spid);
              return 1;
            }
          }
          if (arg_index < num_args) {
          ...
          typ = part->type->val;
          if (str_equals(typ, str685)) {
            if (precision >= 0) {
              s = s->slice(0, precision);
            }
          }
          else {
            if (str_equals(typ, str686)) {
              s = qsn::maybe_shell_encode(s);
            }
            else {
              if (str_equals(typ, str687)) {
                ...
                s = str688->join(c_parts);
              }
              else {
                if ((part->type->id == Id::Format_Time or str_contains(str689, typ))) {
                  try {
                    d = to_int(s);
                  }
                  catch (ValueError*) {
                    if ((len(s) >= 1 and str_contains(str690, s->index_(0)))) {
                  ...
                  if (part->type->id == Id::Format_Time) {
                    ...
                    if ((d < 0 and str_contains(str694, typ))) {
                      e_die(fmt179(d, typ), part->type->span_id);
                    }
                    if (str_equals(typ, str696)) {
                      s = mylib::octal(d);
                    }
                    else {
                      if (str_equals(typ, str697)) {
                        s = mylib::hex_lower(d);
                      }
                      else {
                        if (str_equals(typ, str698)) {
                          s = mylib::hex_upper(d);
                        }
                        else {
                          s = str(d);
                    ...
                    zero_pad = 0;
                    if ((width >= 0 and list_contains(flags, str699))) {
                      zero_pad = 1;
                    }
                    else {
                    ...
                    if (zero_pad) {
                      negative = str_equals(s->index_(0), str700);
                      if (negative) {
                        digits = s->slice(1);
                        sign = str701;
                        if (zero_pad == 1) {
                      ...
                      s = str_concat(sign, digits->rjust(n, str703));
                    }
                  }
                }
                else {
          ...
          if (width >= 0) {
            if (list_contains(flags, str704)) {
              s = s->ljust(width, str705);
            }
            else {
              s = s->rjust(width, str706);
            }
          }
          out->append(s);
        }
...
int Printf::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup1 = flag_spec::ParseCmdVal(str707, cmd_val);
  attrs = tup1.at0();
  arg_r = tup1.at1();
  arg = Alloc<arg_types::printf>(attrs->attrs);
  Tuple2<Str*, int> tup2 = arg_r->ReadRequired2(str708);
  fmt = tup2.at0();
  fmt_spid = tup2.at1();
  ...
  if (dict_contains(this->parse_cache, fmt)) {
    ...
    {  // with
      alloc::ctx_Location ctx(arena, Alloc<source::ArgvWord>(str709, fmt_spid));
...
int Alias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str711, cmd_val);
  arg_r = tup0.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup1 = mylib::split_once(arg, str713);
    name = tup1.at0();
    alias_exp = tup1.at1();
    if (alias_exp == nullptr) {
      alias_exp = this->aliases->get(name);
      if (alias_exp == nullptr) {
        this->errfmt->Print_(fmt181(name), cmd_val->arg_spids->index_(i));
        status = 1;
      }
      else {
        print(fmt182(name, alias_exp));
      }
    }
    else {
...
int UnAlias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str716, cmd_val);
  arg_r = tup2.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
    e_usage(str717);
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    ...
    if (dict_contains(this->aliases, name)) {
      ...
      this->errfmt->Print_(fmt183(name), cmd_val->arg_spids->index_(i));
      status = 1;
    }
  }
  return status;
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->argv) == 1) {
    ...
    for (ListIter<Str*> it(sorted(mapping)); !it.Done(); it.Next()) {
      ...
      code_str = fmt184(name, qsn::maybe_shell_encode(str_val));
      print(code_str);
    }
    return 0;
  }
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  arg = flag_spec::ParseMore(str720, arg_r);
  if (arg->show_options) {
...
int Shopt::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str721, cmd_val, true);
  attrs = tup5.at0();
  arg_r = tup5.at1();
...
int Hash::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str723, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
...
Dict<Str*, bool>* _ParseOptSpec(Str* spec_str) {
  ...
  while (true) {
    ...
    if (str_equals(spec_str->index_(i), str726)) {
      spec->set(ch, true);
      i += 1;
    }
  }
...
int GetOptsState::_OptInd() {
  int result;
  try {
    result = state::GetInteger(this->mem, str727);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    result = -1;
...
void GetOptsState::IncIndex() {
  state::BuiltinSetString(this->mem, str728, str((this->_optind + 1)));
}

void GetOptsState::SetArg(Str* optarg) {
  StackRoots _roots({&optarg});

  state::BuiltinSetString(this->mem, str729, optarg);
}

void GetOptsState::Fail() {
  state::BuiltinSetString(this->mem, str730, str731);
}
...
Tuple2<int, Str*> _GetOpts(Dict<Str*, bool>* spec, List<Str*>* argv, builtin_pure::GetOptsState* my_state, ui::ErrorFormatter* errfmt) {
  ...
  if ((!current->startswith(str733) or str_equals(current, str734))) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str735));
  }
  ...
  if (!dict_contains(spec, flag_char)) {
    return (Tuple2<int, Str*>(0, str736));
  }
  if (spec->index_(flag_char)) {
    if (more_chars) {
      ...
      if (optarg == nullptr) {
        my_state->Fail();
        errfmt->Print_(fmt187(current));
        tmp = Alloc<List<Str*>>();
        for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
          Str* a = it.Value();
          tmp->append(qsn::maybe_shell_encode(a));
        }
        println_stderr(fmt188(str739->join(tmp)));
        return (Tuple2<int, Str*>(0, str740));
      }
    }
    my_state->IncIndex();
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  spec_str = arg_r->ReadRequired(str742);
  Tuple2<Str*, int> tup7 = arg_r->ReadRequired2(str743);
  var_name = tup7.at0();
  var_spid = tup7.at1();
  ...
  if (match::IsValidVarName(var_name)) {
    ...
    throw Alloc<error::Usage>(fmt189(var_name), var_spid);
  }
  return status;
}
...
int Echo::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseLikeEcho(str745, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  if (arg->e) {
    ...
    for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
      ...
      new_argv->append(str746->join(parts));
      if (backslash_c) {
        break;
      }
    }
...
int Module::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseCmdVal(str750, cmd_val);
  arg_r = tup11.at1();
  Tuple2<Str*, int> tup12 = arg_r->ReadRequired2(str751);
  name = tup12.at0();
  if (dict_contains(this->modules, name)) {
    if (this->exec_opts->redefine_module()) {
      this->errfmt->PrintMessage(fmt190(name));
      return 0;
    }
    else {
      return 1;
...
int Use::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_spid = tup13.at1();
  if (arg == nullptr) {
    throw Alloc<error::Usage>(str753, runtime::NO_SPID);
  }
  arg_r->Next();
  if (str_equals(arg, str754)) {
    Tuple2<Str*, int> tup14 = arg_r->Peek2();
    expected = tup14.at0();
    e_spid = tup14.at1();
    if (expected == nullptr) {
      throw Alloc<error::Usage>(str755, runtime::NO_SPID);
    }
    UP_actual = this->mem->GetValue(str756, scope_e::Dynamic);
    if (UP_actual->tag_() == value_e::Str) {
      ...
      if (maybe_str_equals(actual, expected)) {
        ...
        this->errfmt->Print_(fmt191(expected, actual), e_spid);
        return 1;
      }
    }
    else {
      this->errfmt->Print_(fmt192(expected), e_spid);
      return 1;
    }
  }
  if (str_equals(arg, str759)) {
    rest = arg_r->Rest();
    for (ListIter<Str*> it(rest); !it.Done(); it.Next()) {
      Str* name = it.Value();
      StackRoots _for({&name    });
      println_stderr(fmt193(name));
    }
    return 0;
  }
  throw Alloc<error::Usage>(str761, arg_spid);
}
...
int Shvar::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str762, cmd_val, true);
  arg_r = tup15.at1();
  block = typed_args::GetOneBlock(cmd_val->typed_args);
  if (!block) {
    throw Alloc<error::Usage>(str763, runtime::NO_SPID);
  }
  ...
  arg_spids = tup16.at1();
  if (len(args) == 0) {
    throw Alloc<error::Usage>(str764, runtime::NO_SPID);
  }
  i = 0;
  for (ListIter<Str*> it(args); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup17 = mylib::split_once(arg, str765);
    name = tup17.at0();
    s = tup17.at1();
    if (s == nullptr) {
      throw Alloc<error::Usage>(str766, arg_spids->index_(i));
    }
...
int PushRegisters::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  syntax_asdl::command_t* block = nullptr;
  StackRoots _roots({&cmd_val, &block});

  block = typed_args::GetOneBlock(cmd_val->typed_args);
  if (!block) {
    throw Alloc<error::Usage>(str767, runtime::NO_SPID);
  }
  {  // with
...
int CommandEvaluator::_RunAssignBuiltin(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  if (builtin_func == nullptr) {
    e_die(fmt194(cmd_val->argv->index_(0)), cmd_val->arg_spids->index_(0));
  }
  try {
    try {
      status = builtin_func->Run(cmd_val);
      ...
      this->errfmt->PrefixPrint(e->msg, fmt195(arg0), e->span_id);
      status = 2;
    }
  }
  catch (std::exception) { }  return status;
  ...
  switch (arg->tag_()) {
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        filename = val->s;
        if (len(filename) == 0) {
          throw Alloc<error::RedirectEval>(str777, arg_word);
        }
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          t = val->s;
          if (len(t) == 0) {
            throw Alloc<error::RedirectEval>(str778, arg_word);
            return nullptr;
          }
          try {
            if (maybe_str_equals(t, str779)) {
              result->arg = Alloc<redirect_arg::CloseFd>();
            }
            else {
              if (str_equals(t->index_(-1), str780)) {
            ...
            throw Alloc<error::RedirectEval>(fmt197(t), arg_word);
            return nullptr;
          }
          return result;
        }
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = Alloc<redirect_arg::HereDoc>(str_concat(val->s, str782));
            return result;
          }
          else {
            throw Alloc<AssertionError>();
...
void CommandEvaluator::_StrictErrExit(syntax_asdl::command_t* node) {
  ...
  if (_HasManyStatuses(node)) {
    ...
    e_die(fmt198(node_str), location::SpanForCommand(node));
  }
}
...
void CommandEvaluator::_StrictErrExitList(List<syntax_asdl::command_t*>* node_list) {
  ...
  if (len(node_list) > 1) {
    e_die(fmt199(), location::SpanForCommand(node_list->index_(0)));
  }
  node = node_list->index_(0);
  if (_HasManyStatuses(node)) {
    node_str = ui::CommandType(node);
    e_die(fmt200(node_str), location::SpanForCommand(node));
  }
}
...
int CommandEvaluator::_Dispatch(syntax_asdl::command_t* node, runtime_asdl::CommandStatus* cmd_st) {
  ...
  double e_user;
  double e_sys;
  StackRoots _roots({&node, &cmd_st, &UP_node, &words, &cmd_val, &UP_cmd_val, &typed_args, &block_expr, &rhs, &lval, &old_val, &val, &tok, &str_val, &msg, &left, &child, &iter_name, &iter_list, &init, &for_cond, &body, &update, &defaults, &to_match, &pat_val});
  ...
  switch (node->tag_()) {
    case command_e::Simple: {
      ...
      if (UP_cmd_val->tag_() == cmd_value_e::Argv) {
        ...
        if (node->block) {
          e_die(fmt201(), node->block->spids->index_(0));
        }
        cmd_value__Assign* cmd_val = static_cast<cmd_value__Assign*>(UP_cmd_val);
      }
    ...
    case command_e::Pipeline: {
      ...
      if (len(node->stderr_indices)) {
        e_die(fmt202(), node->spids->index_(0));
      }
      if (node->negated) {
    ...
    case command_e::ControlFlow: {
      ...
      if (node->arg_word) {
        ...
        if ((len(str_val->s) == 0 and !this->exec_opts->strict_control_flow())) {
          ...
          try {
            ...
            e_die(fmt203(node->token->val, str_val->s), node->arg_word);
          }
        }
      }
      else {
      ...
      if (ok) {
        ...
        if (this->exec_opts->strict_control_flow()) {
          ...
          this->errfmt->PrefixPrint(msg, str792, tok->span_id);
          status = 0;
        }
      }
    }
    ...
    case command_e::ShFunction: {
      ...
      if ((dict_contains(this->procs, node->name) and !this->exec_opts->redefine_proc())) {
        e_die(fmt204(node->name), node->spids->index_(1));
      }
    ...
    case command_e::Proc: {
      ...
      if ((dict_contains(this->procs, node->name->val) and !this->exec_opts->redefine_proc())) {
        e_die(fmt205(node->name->val), node->name->span_id);
      }
      defaults = nullptr;
    ...
    {  // with
      ...
      for (ListIter<syntax_asdl::command_t*> it(to_run); !it.Done(); it.Next()) {
        ...
        {  // with
          ...
          {  // with
            dev::ctx_Tracer ctx(this->tracer, str795, nullptr);
      ...
      if (this->shell_ex->PushRedirects(redirects)) {
        {  // with
          ...
          try {
            ...
            this->errfmt->PrettyPrintError(e, str796);
            status = 1;
            check_errexit = true;
          }
        }
...
Tuple2<bool, bool> CommandEvaluator::ExecuteAndCatch(syntax_asdl::command_t* node, int cmd_flags) {
  ...
  try {
    ...
    if ((cmd_flags & RaiseControlFlow)) {
      ...
      if (e->IsReturn()) {
        ...
        this->errfmt->Print_(str797, e->token->span_id);
        is_fatal = true;
        status = 1;
      }
    }
  ...
  if (err) {
    ...
    if (is_errexit) {
      ...
      this->errfmt->PrettyPrintError(err, str798);
    }
  }
...
void CommandEvaluator::MaybeRunExitTrap(List<int>* mut_status) {
  ...
  handler = this->traps->get(str799);
  if (handler) {
    {  // with
      dev::ctx_Tracer ctx(this->tracer, str800, nullptr);

      try {
        Tuple2<bool, bool> tup3 = this->ExecuteAndCatch(handler->node);
        is_return = tup3.at0();
        is_fatal = tup3.at1();
      }
      catch (util::UserExit* e) {
  ...
  {  // with
    ...
    if (UP_sig->tag_() == proc_sig_e::Closed) {
      ...
      for (ListIter<syntax_asdl::UntypedParam*> it(sig->untyped); !it.Done(); it.Next(), ++i) {
        ...
        if (i < n_args) {
          ...
          if (is_out_param) {
            param_name = str_concat(str801, param_name);
            if (!arg_str->startswith(str802)) {
              e_die(fmt206(arg_str));
            }
      ...
      if (sig->rest) {
        ...
        if (n_args > n_params) {
          this->errfmt->Print_(fmt208(proc->name, n_params, n_args), arg0_spid);
          return 2;
        }
      }
    }
    try {
      ...
      if (e->IsReturn()) {
        ...
        e_die(fmt209(e->token->val), e->token);
      }
    }
    catch (error::FatalRuntime* e) {
      this->dumper->MaybeCollect(this, e);
...
int CommandEvaluator::RunFuncForCompletion(runtime_asdl::Proc* proc, List<Str*>* argv) {
  ...
  try {
    ...
    this->errfmt->Print_(str808, e->token->span_id);
    status = 1;
  }
  return status;
}
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index_(i), str810))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index_(-2), str812)) {
    ...
    if ((left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse)) {
      var_name = left_token->val->slice(0, -1);
      if (str_equals(close_token->val->index_(-2), str813)) {
        op = assign_op_e::PlusEqual;
      }
      else {
        op = assign_op_e::Equal;
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        var_name = left_token->val->slice(0, -1);
        if (str_equals(close_token->val->index_(-2), str814)) {
          op = assign_op_e::PlusEqual;
        }
        else {
          op = assign_op_e::Equal;
        ...
        if (span1->line_id == span2->line_id) {
          ...
          throw Alloc<NotImplementedError>(fmt213(span1->line_id, span2->line_id));
        }
        a_parser = parse_ctx->MakeArithParser(code_str);
        src = Alloc<source::Reparsed>(str816, left_token->span_id, close_token->span_id);
        {  // with
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    w = tup6->at3();
    if (left_token->id != Id::Lit_VarLike) {
      p_die(fmt214(), left_token);
    }
    if (str_equals(left_token->val->index_(-2), str818)) {
      p_die(fmt215(), left_token);
    }
    var_name = left_token->val->slice(0, -1);
    n = len(w->parts);
    if (part_offset == n) {
...
void CommandParser::_Eat(int c_id) {
  ...
  msg = fmt221(ui::PrettyId(c_id), ui::PrettyId(actual_id));
  this->_Eat2(c_id, msg);
}
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index_(0), str826)) {
    pos = op_val->find(str827);
...
Tuple4<List<syntax_asdl::redir*>*, List<syntax_asdl::compound_word*>*, syntax_asdl::ArgList*, syntax_asdl::BraceGroup*> CommandParser::_ScanSimpleCommand() {
  ...
  int prev_byte;
  int next_id;
  StackRoots _roots({&redirects, &words, &typed_args, &block, &node});
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    i += 1;
    if (!alias_exp->endswith(str833)) {
      expanded->append(str834);
      break;
    }
  }
  if (len(expanded) == 0) {
  ...
  while (i < n) {
    ...
    if (span1->line_id == span2->line_id) {
      ...
      throw Alloc<NotImplementedError>(fmt227(span1->line_id, span2->line_id));
    }
    expanded->append(str836);
    i += 1;
  }
  code_str = str837->join(expanded);
  line_reader = reader::StringLineReader(code_str, this->arena);
...
syntax_asdl::command_t* CommandParser::ParseSimpleCommand() {
  ...
  Tuple4<List<syntax_asdl::redir*>*, List<syntax_asdl::compound_word*>*, syntax_asdl::ArgList*, syntax_asdl::BraceGroup*> tup10 = this->_ScanSimpleCommand();
  redirects = tup10.at0();
  words = tup10.at1();
  typed_args = tup10.at2();
  block = tup10.at3();
  ...
  if ((this->parse_opts->parse_equals() and len(preparsed_list))) {
    Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* tup12 = preparsed_list->index_(0);
    left_token = tup12->at0();
    p_die(fmt230(), left_token);
  }
  this->parse_ctx->trail->SetLatestWords(suffix_words, redirects);
  if (len(suffix_words) == 0) {
    if (typed_spid != runtime::NO_SPID) {
      p_die(fmt231(), typed_spid);
    }
  ...
  Tuple2<id_kind_asdl::Kind_t, syntax_asdl::Token*> tup13 = word_::KeywordToken(suffix_words->index_(0));
  kind = tup13.at0();
  kw_token = tup13.at1();
  if (kind == Kind::ControlFlow) {
    if (typed_spid != runtime::NO_SPID) {
      p_die(fmt232(), typed_spid);
    }
    if ((!this->parse_opts->parse_ignored() and len(redirects))) {
      p_die(fmt233(), kw_token);
    }
    if (len(preparsed_list)) {
      Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* tup14 = preparsed_list->index_(0);
      left_token = tup14->at0();
      p_die(fmt234(), left_token);
    }
    if (len(suffix_words) == 1) {
      ...
      if (len(suffix_words) == 2) {
        ...
        p_die(fmt235(kw_token->val), suffix_words->index_(2));
      }
    }
...
syntax_asdl::command__ForEach* CommandParser::_ParseForEachLoop(int for_spid) {
  ...
  quoted = tup15.at2();
  if ((!ok or quoted)) {
    p_die(fmt238(), this->cur_word);
  }
  if (!match::IsValidVarName(iter_name)) {
    p_die(fmt239(), this->cur_word);
  }
...
syntax_asdl::command_t* CommandParser::ParseCommand() {
  ...
  if (this->c_kind == Kind::Eof) {
    p_die(fmt248(), this->cur_word);
  }
  p_die(fmt249(), this->cur_word);
}
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    c = s->index_(i);
    if (str_equals(c, str863)) {
      i += 1;
    }
    else {
      if ((str_equals(c, str864) or str_equals(c, str865))) {
        return true;
      }
      else {
        if (str_equals(c, str866)) {
          left_bracket = true;
        }
        else {
          if ((str_equals(c, str867) and left_bracket)) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  ...
  return pyutil::BackslashEscape(s, str869);
}
Str* ERE_META_CHARS = str870;
...
Str* GlobUnescape(Str* s) {
  ...
  while (i < n) {
    c = s->index_(i);
    if ((str_equals(c, str871) and i != (n - 1))) {
      i += 1;
      c2 = s->index_(i);
      ...
      if (tag == glob_part_e::Operator) {
        ...
        if (tag == glob_part_e::CharClass) {
          ...
          for (ListIter<Str*> it(part->strs); !it.Done(); it.Next()) {
            Str* s = it.Value();
            StackRoots _for({&s          });
            if (str_equals(s, str889)) {
              literal_hyphen = true;
              continue;
            }
            if (str_equals(s, str890)) {
...
Str* _PromptEvaluatorCache::Get(Str* name) {
  ...
  if (str_equals(name, str898)) {
    value = this->_GetEuid() == 0 ? str899 : str900;
  }
  else {
    if (str_equals(name, str901)) {
      value = libc::gethostname();
    }
    else {
      if (str_equals(name, str902)) {
...
Evaluator::Evaluator(Str* lang, Str* version_str, parse_lib::ParseContext* parse_ctx, state::Mem* mem) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Evaluator)) {
  this->word_ev = nullptr;
  this->lang = lang;
      ...
      if (id_ == Id::PS_Octal3) {
        ...
        if (id_ == Id::PS_LBrace) {
          ...
          if (id_ == Id::PS_RBrace) {
            ...
            if (id_ == Id::PS_Subst) {
              ch = value->index_(1);
              if (str_equals(ch, str905)) {
                r = this->cache->Get(str906);
              }
              else {
                if (str_equals(ch, str907)) {
                  r = this->cache->Get(str908);
                }
                else {
                  if (str_equals(ch, str909)) {
                    hostname = this->cache->Get(str910);
                    Tuple2<Str*, Str*> tup1 = mylib::split_once(hostname, str911);
                    r = tup1.at0();
                  }
                  else {
                    if (str_equals(ch, str912)) {
                      r = this->cache->Get(str913);
                    }
                    else {
                      if (str_equals(ch, str914)) {
                        r = this->lang;
                      }
                      else {
                        if (str_equals(ch, str915)) {
                          ...
                          if (str_equals(ch, str916)) {
                            now = time_::time();
                            r = time_::strftime(str917, time_::localtime(now));
                          }
                          else {
                            if (str_equals(ch, str918)) {
                              now = time_::time();
                              fmt = value->slice(3, -1);
                              if (len(fmt) == 0) {
                                fmt = str919;
                              ...
                              if (str_equals(ch, str920)) {
                                try {
                                  pwd = state::GetString(this->mem, str921);
                                  home = state::MaybeString(this->mem, str922);
                                  r = ui::PrettyDir(pwd, home);
                                }
                                catch (error::Runtime* e) {
                                  r = fmt254(e->UserErrorString());
                                }
                              }
                              else {
                                if (str_equals(ch, str924)) {
                                  val = this->mem->GetValue(str925);
                                  if (val->tag_() == value_e::Str) {
                                    value__Str* str_val = static_cast<value__Str*>(val);
              ...
              ret->append(r->replace(str928, str929));
            }
            else {
              throw Alloc<AssertionError>();
            }
...
Str* Evaluator::EvalPrompt(runtime_asdl::value_t* UP_val) {
  ...
  if (ps1_word == nullptr) {
    ...
    try {
      ...
      ps1_word = word_::ErrorWord(fmt256(e->UserErrorString()));
    }
...
Str* Evaluator::EvalFirstPrompt() {
  ...
  if (str_equals(this->lang, str934)) {
    val = this->mem->GetValue(str935);
    return this->EvalPrompt(val);
  }
  else {
    return str_concat(this->lang, str936);
  }
}
Str* PROMPT_COMMAND = str937;

UserPlugin::UserPlugin(state::Mem* mem, parse_lib::ParseContext* parse_ctx, cmd_eval::CommandEvaluator* cmd_ev, ui::ErrorFormatter* errfmt) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(UserPlugin)) {
  this->mem = mem;
  this->parse_ctx = parse_ctx;
  this->cmd_ev = cmd_ev;
  this->errfmt = errfmt;
    ...
    case lvalue_e::Indexed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          break;
        default: {
          e_die(fmt258(ui::ValType(val)));
        }
      }
      s = word_eval::GetArrayItem(array_val->strs, lval->index);
      if (s == nullptr) {
        val = Alloc<value::Str>(str940);
      }
      else {
        val = Alloc<value::Str>(s);
      }
...
UnsafeArith::UnsafeArith(state::Mem* mem, optview::Exec* exec_opts, parse_lib::ParseContext* parse_ctx, sh_expr_eval::ArithEvaluator* arith_ev, ui::ErrorFormatter* errfmt) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(UnsafeArith)) {
  this->mem = mem;
  this->exec_opts = exec_opts;
  this->parse_ctx = parse_ctx;
...
runtime_asdl::lvalue_t* UnsafeArith::ParseLValue(Str* s, int span_id) {
  ...
  {  // with
    alloc::ctx_Location ctx(this->arena, Alloc<source::ArgvWord>(str943, span_id));
...
int ArithEvaluator::_StringToInteger(Str* s, int span_id) {
  ...
  if (s->startswith(str947)) {
    try {
      integer = to_int(s, 16);
    }
    catch (ValueError*) {
      e_strict(fmt263(s), span_id);
    }
    return integer;
  }
  if (s->startswith(str949)) {
    try {
      integer = to_int(s, 8);
    }
    catch (ValueError*) {
      e_strict(fmt264(s), span_id);
    }
    return integer;
  }
  if (str_contains(s, str951)) {
    Tuple2<Str*, Str*> tup0 = mylib::split_once(s, str952);
    b = tup0.at0();
    digits = tup0.at1();
    try {
      base = to_int(b);
    ...
    for (StrIter it(digits); !it.Done(); it.Next()) {
      ...
      StackRoots _for({&ch    });
      if (IsLower(ch)) {
        digit = ((ord(ch) - ord(str954)) + 10);
      }
      else {
        if (IsUpper(ch)) {
          digit = ((ord(ch) - ord(str955)) + 36);
        }
        else {
          if (str_equals(ch, str956)) {
            digit = 62;
          }
          else {
            if (str_equals(ch, str957)) {
              ...
              if (ch->isdigit()) {
                ...
                e_strict(fmt266(digits), span_id);
              }
            }
          }
        }
      ...
      if (digit >= base) {
        e_strict(fmt267(digits, base), span_id);
      }
    ...
    if ((this->exec_opts->eval_unsafe_arith() and this->parse_ctx)) {
      ...
      {  // with
        ...
        try {
          ...
          this->errfmt->PrettyPrintError(e);
          e_die(fmt268(), e->span_id);
        }
      }
      if (node2->tag_() == arith_expr_e::Word) {
        e_die(fmt269(s), span_id);
      }
      else {
      ...
      if ((len(s->strip()) == 0 or match::IsValidVarName(s))) {
        e_strict(fmt270(s), span_id);
      }
      else {
        e_die(fmt271(s), span_id);
      }
    }
  }
  return integer;
...
int ArithEvaluator::_ValToIntOrError(runtime_asdl::value_t* val, int span_id) {
  ...
  e_die(fmt273(ui::ValType(val)), span_id);
}
  ...
  if (((val->tag_() == value_e::MaybeStrArray || val->tag_() == value_e::AssocArray) and lval->tag_() == lvalue_e::Named)) {
    ...
    if (word_eval::ShouldArrayDecay(named_lval->name, this->exec_opts)) {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (val->tag_() == value_e::AssocArray) {
          lval = Alloc<lvalue::Keyed>(named_lval->name, str966);
        }
      }
        ...
        if (op_id == Id::Arith_Minus) {
          ...
          if (op_id == Id::Arith_Star) {
            ...
            if (op_id == Id::Arith_Slash) {
              if (rhs == 0) {
                e_die(fmt276(), location::SpanForArithExpr(node->right));
              }
              ret = (lhs / rhs);
            }
            else {
              if (op_id == Id::Arith_Percent) {
                if (rhs == 0) {
                  e_die(fmt277(), location::SpanForArithExpr(node->right));
                }
                ret = (lhs % rhs);
              }
              else {
  ...
  switch (node->tag_()) {
    ...
    case bool_expr_e::Unary: {
      ...
      if (arg_type == bool_arg_type_e::Other) {
        ...
        e_die(fmt279(ui::PrettyId(op_id)));
      }
      throw Alloc<AssertionError>();
    }
      break;
      ...
      if (arg_type == bool_arg_type_e::Str) {
        ...
        if (op_id == Id::BoolBinary_EqualTilde) {
          try {
            ...
            msg = e->message;
            e_die(fmt280(s2, msg, node->right), 2);
          }
          if (matches == nullptr) {
            return false;
          }
...
split::IfsSplitter* SplitContext::_GetSplitter(Str* ifs) {
  ...
  if (ifs == nullptr) {
    val = this->mem->GetValue(str979, scope_e::Dynamic);
    UP_val = val;
    switch (val->tag_()) {
      case value_e::Undef: {
        ifs = DEFAULT_IFS;
...
Str* SplitContext::GetJoinChar() {
  ...
  val = this->mem->GetValue(str982, scope_e::Dynamic);
  UP_val = val;
  switch (val->tag_()) {
    case value_e::Undef: {
      return str983;
...
_BaseSplitter::_BaseSplitter(Str* escape_chars) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(_BaseSplitter)) {
  this->escape_chars = str_concat(escape_chars, str986);
}
    ...
    if (i < n) {
      ...
      if (str_contains(ws_chars, c)) {
        ...
        if (str_contains(other_chars, c)) {
          ...
          if ((allow_escape and str_equals(c, str987))) {
...
Str* Utf8Encode(int code) {
  ...
  return str990->join(tmp);
}
Str* INCOMPLETE_CHAR = str991;
Str* INVALID_CONT = str992;
Str* INVALID_START = str993;
    ...
    if ((tok->id == Id::VOp1_Pound || tok->id == Id::VOp1_DPound)) {
      ...
      if ((tok->id == Id::VOp1_Percent || tok->id == Id::VOp1_DPercent)) {
        ...
        if (tok->id == Id::VOp1_Comma) {
          if (!(str_equals(arg, str994))) {
            e_die(fmt281(ui::PrettyId(tok->id)), tok);
          }
          if (len(s)) {
          ...
          if (tok->id == Id::VOp1_DComma) {
            if (!(str_equals(arg, str996))) {
              e_die(fmt282(ui::PrettyId(tok->id)), tok);
            }
            return s->lower();
          }
          else {
            if (tok->id == Id::VOp1_Caret) {
              if (!(str_equals(arg, str998))) {
                e_die(fmt283(ui::PrettyId(tok->id)), tok);
              }
              if (len(s)) {
              ...
              if (tok->id == Id::VOp1_DCaret) {
                if (!(str_equals(arg, str1000))) {
                  e_die(fmt284(ui::PrettyId(tok->id)), tok);
                }
                return s->upper();
              }
              else {
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Slash) {
    try {
      ...
      msg = e->message;
      e_die(fmt286(regex, msg), this->slash_spid);
    }
  }
  if (op->replace_mode == Id::Lit_Pound) {
    regex = str_concat(str1006, regex);
  }
  else {
    if (op->replace_mode == Id::Lit_Percent) {
      regex = str_concat(regex, str1007);
    }
  }
...
Str* ShellQuoteB(Str* s) {
  ...
  s = s->replace(str1008, str1009)->replace(str1010, str1011);
  return pyutil::BackslashEscape(s, str1012);
}
...
void TdopParser::Eat(int token_type) {
  if (!this->AtToken(token_type)) {
    p_die(fmt290(ui::PrettyId(token_type), ui::PrettyId(this->op_id)), this->cur_word);
  }
  this->Next();
}
...
int QUOTE_ERE = (1 << 6);
GLOBAL_LIST(Str*, 3, _STRING_AND_ARRAY, {str1025 COMMA str1026 COMMA str1027});
...
runtime_asdl::value_t* DecayArray(runtime_asdl::value_t* val) {
  ...
  if (val->tag_() == value_e::MaybeStrArray) {
    ...
    if (val->tag_() == value_e::AssocArray) {
      value__AssocArray* assoc_val = static_cast<value__AssocArray*>(val);
      s = dict_contains(assoc_val->d, str1028) ? assoc_val->d->index_(str1029) : nullptr;
    }
    else {
      throw Alloc<AssertionError>();
    }
...
runtime_asdl::assign_arg* _SplitAssignArg(Str* arg, int word_spid) {
  ...
  if (m == nullptr) {
    e_die(fmt292(arg), word_spid);
  }
  var_name = m->index_(1);
  op = m->index_(3);
  if (len(op)) {
    val = Alloc<value::Str>(m->index_(4));
    append = str_equals(op->index_(0), str1032);
  }
  else {
    val = nullptr;
    append = false;
...
Str* _BackslashEscape(Str* s) {
  ...
  return s->replace(str1033, str1034);
}
...
runtime_asdl::part_value_t* _ValueToPartValue(runtime_asdl::value_t* val, bool quoted) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      return Alloc<part_value::String>(str1035, quoted, !quoted);
    }
      break;
    case value_e::Str: {
      value__Str* val = static_cast<value__Str*>(UP_val);
...
Str* _GetDollarHyphen(optview::Exec* exec_opts) {
  ...
  chars = Alloc<List<Str*>>();
  if (exec_opts->interactive()) {
    chars->append(str1039);
  }
  if (exec_opts->errexit()) {
    chars->append(str1040);
  }
  if (exec_opts->noglob()) {
    chars->append(str1041);
  }
  if (exec_opts->noexec()) {
    chars->append(str1042);
  }
  if (exec_opts->nounset()) {
    chars->append(str1043);
  }
  if (exec_opts->xtrace()) {
    chars->append(str1044);
  }
  if (exec_opts->noclobber()) {
    chars->append(str1045);
  }
  return str1046->join(chars);
}
...
Str* TildeEvaluator::Eval(syntax_asdl::Token* token) {
  ...
  if (maybe_str_equals(token->val, str1047)) {
    val = this->mem->GetValue(str1048);
    UP_val = val;
    if (val->tag_() == value_e::Str) {
      value__Str* val = static_cast<value__Str*>(UP_val);
      return val->s;
      ...
      if ((tok->id == Id::VTest_ColonEquals || tok->id == Id::VTest_Equals)) {
        ...
        if ((tok->id == Id::VTest_ColonQMark || tok->id == Id::VTest_QMark)) {
          if (is_falsey) {
            ...
            e_die(fmt296(error_str), blame_token);
          }
          else {
            return false;
          }
    ...
    case value_e::Str: {
      ...
      try {
        ...
        if (this->exec_opts->strict_word_eval()) {
          ...
          this->errfmt->PrettyPrintError(e, str1052);
          return Alloc<value::Str>(str1053);
        }
      }
    }
      break;
...
runtime_asdl::value_t* AbstractWordEvaluator::_Slice(runtime_asdl::value_t* val, syntax_asdl::suffix_op__Slice* op, Str* var_name, syntax_asdl::braced_var_sub* part) {
  ...
  try {
    ...
    if (this->exec_opts->strict_word_eval()) {
      ...
      this->errfmt->PrettyPrintError(e, str1059);
      switch (val->tag_()) {
        case value_e::Str: {
          val = Alloc<value::Str>(str1060);
        }
          break;
        case value_e::MaybeStrArray: {
  ...
  if (op_id == Id::VOp0_P) {
    switch (val->tag_()) {
      case value_e::Str: {
        ...
        p = prompt->replace(str1061, str1062)->replace(str1063, str1064);
        result = Alloc<value::Str>(p);
      }
        break;
      default: {
        e_die(fmt299(ui::ValType(val)));
      }
    }
  }
  else {
    if (op_id == Id::VOp0_Q) {
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          result = Alloc<value::Str>(str1066->join(tmp));
        }
          break;
        default: {
          e_die(fmt300(ui::ValType(val)));
        }
      }
    }
    else {
      if (op_id == Id::VOp0_a) {
        ...
        switch (val->tag_()) {
          case value_e::MaybeStrArray: {
            chars->append(str1068);
          }
            break;
          case value_e::AssocArray: {
            chars->append(str1069);
          }
            break;
        }
        if (var_name != nullptr) {
          ...
          if (cell) {
            if (cell->readonly) {
              chars->append(str1070);
            }
            if (cell->exported) {
              chars->append(str1071);
            }
            if (cell->nameref) {
              chars->append(str1072);
            }
          }
        }
        result = Alloc<value::Str>(str1073->join(chars));
      }
      else {
        e_die(fmt301(op->val), op);
      }
    }
  }
...
runtime_asdl::value_t* AbstractWordEvaluator::_ArrayIndex(runtime_asdl::value_t* val, syntax_asdl::braced_var_sub* part, runtime_asdl::VTestPlace* vtest_place) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      ...
      break;
    case value_e::Str: {
      e_die(fmt304(part->token->val), part->token);
    }
      break;
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* array_val = static_cast<value__MaybeStrArray*>(UP_val);
...
void AbstractWordEvaluator::_EvalDoubleQuoted(List<syntax_asdl::word_part_t*>* parts, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  if (len(parts) == 0) {
    v = Alloc<part_value::String>(str1078, true, false);
    part_vals->append(v);
    return ;
  }
  for (ListIter<syntax_asdl::word_part_t*> it(parts); !it.Done(); it.Next()) {
...
runtime_asdl::value_t* AbstractWordEvaluator::_EmptyStrOrError(runtime_asdl::value_t* val, syntax_asdl::Token* token) {
  ...
  if (!this->exec_opts->nounset()) {
    return Alloc<value::Str>(str1079);
  }
  name = token->val->startswith(str1080) ? token->val->slice(1) : token->val;
  e_die(fmt305(name), token);
}
...
void AbstractWordEvaluator::_EvalExtGlob(syntax_asdl::word_part__ExtGlob* part, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  for (ListIter<syntax_asdl::compound_word*> it(part->arms); !it.Done(); it.Next(), ++i) {
    ...
    StackRoots _for({&w  });
    if (i != 0) {
      part_vals->append(Alloc<part_value::String>(str1091, false, false));
    }
    this->_EvalWordToParts(w, part_vals, EXTGLOB_NESTED);
  }
  part_vals->append(Alloc<part_value::String>(str1092, false, false));
}
    ...
    case word_e::Compound: {
      ...
      if (has_extglob) {
        if (to_bool((eval_flags & EXTGLOB_FILES))) {
          ...
          glob_pat = str1098->join(glob_parts);
          fnmatch_pat = str1099->join(fnmatch_parts);
          results = Alloc<List<Str*>>();
          n = this->globber->ExpandExtended(glob_pat, fnmatch_pat, results);
          if (n < 0) {
            span_id = word_::LeftMostSpanForWord(w);
            throw Alloc<error::FailGlob>(fmt316(fnmatch_pat), span_id);
          }
      ...
      break;
    case word_e::Empty: {
      part_vals->append(Alloc<part_value::String>(str1102, quoted, !quoted));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, int eval_flags) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return Alloc<value::Str>(str1106);
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  part_vals = Alloc<List<runtime_asdl::part_value_t*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
  ...
  return Alloc<value::Str>(str1107->join(strs));
}
...
Tuple2<runtime_asdl::value__Str*, bool> AbstractWordEvaluator::EvalWordToPattern(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return (Tuple2<runtime_asdl::value__Str*, bool>(Alloc<value::Str>(str1108), false));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  has_extglob = false;
  part_vals = Alloc<List<runtime_asdl::part_value_t*>>();
  ...
  return (Tuple2<runtime_asdl::value__Str*, bool>(Alloc<value::Str>(str1109->join(strs)), has_extglob));
}
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalForPlugin(syntax_asdl::compound_word* w) {
  ...
  {  // with
    ...
    try {
      ...
      val = Alloc<value::Str>(fmt320(e->UserErrorString()));
    }
    catch (_OSError* e) {
      val = Alloc<value::Str>(fmt321(pyutil::strerror(e)));
    }
    catch (KeyboardInterrupt*) {
      val = Alloc<value::Str>(str1112);
    }
  }
  return val;
}
...
runtime_asdl::value_t* AbstractWordEvaluator::EvalRhsWord(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return Alloc<value::Str>(str1113);
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  if (len(w->parts) == 1) {
...
void AbstractWordEvaluator::_EvalWordFrame(List<Tuple3<Str*, bool, bool>*>* frame, List<Str*>* argv) {
  ...
  for (ListIter<Str*> it(args); !it.Done(); it.Next()) {
    ...
    if (glob_::LooksLikeGlob(a)) {
      ...
      if (n < 0) {
        throw Alloc<error::FailGlob>(fmt322(a), runtime::NO_SPID);
      }
    }
    else {
...
runtime_asdl::cmd_value__Assign* AbstractWordEvaluator::_EvalAssignBuiltin(int builtin_id, Str* arg0, List<syntax_asdl::compound_word*>* words) {
  ...
  flag_spids = Alloc<List<int>>(std::initializer_list<int>{word_::LeftMostSpanForWord(words->index_(0))});
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index_(-2), str1120)) {
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        StackRoots _for({&arg      });
        if ((arg->startswith(str1121) or arg->startswith(str1122))) {
          flags->append(arg);
          flag_spids->append(word_spid);
          if ((str_contains(arg, str1123) or str_contains(arg, str1124))) {
            eval_to_pairs = false;
          }
        }
        else {
...
runtime_asdl::cmd_value_t* AbstractWordEvaluator::SimpleEvalWordSequence2(List<syntax_asdl::compound_word*>* words, bool allow_assign) {
  ...
  for (ListIter<syntax_asdl::compound_word*> it(words); !it.Done(); it.Next(), ++i) {
    ...
    if (glob_::LooksLikeStaticGlob(w)) {
      ...
      if (num_appended < 0) {
        throw Alloc<error::FailGlob>(fmt324(val->s), word_spid);
      }
...
runtime_asdl::part_value__String* CompletionWordEvaluator::_EvalProcessSub(syntax_asdl::command_sub* cs_part) {
  ...
  return Alloc<part_value::String>(str1128, true, false);
}
...
syntax_asdl::suffix_op__PatSub* WordParser::_ReadPatSubVarOp() {
  ...
  if (this->token_type == Id::Lit_Slash) {
    ...
    this->_Peek();
    if (this->token_type != Id::Right_DollarBrace) {
      p_die(fmt327(ui::PrettyId(this->token_type)), this->cur_token);
    }
          ...
          if (op_kind == Kind::VOp2) {
            if (this->token_type == Id::VOp2_Slash) {
              ...
              if (this->token_type == Id::VOp2_Colon) {
                ...
                if (this->token_type != Id::Arith_RBrace) {
                  p_die(fmt334(), this->cur_token);
                }
              }
              else {
                p_die(fmt335(str1140), this->cur_token);
              }
            }
          }
          else {
            if (op_kind == Kind::VOp3) {
              if (allow_query) {
                ...
                p_die(fmt336(str1142), this->cur_token);
              }
            }
          }
        }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool is_oil_expr) {
  ...
  while (num_end_tokens < expected_end_tokens) {
    ...
    if ((this->token_kind == Kind::Lit || this->token_kind == Kind::Char)) {
      tok = this->cur_token;
      if ((no_backslashes and str_contains(tok->val, str1147))) {
        p_die(fmt341(), tok);
      }
      if (is_oil_expr) {
...
syntax_asdl::word_part_t* WordParser::_ReadUnquotedLeftParts(bool try_triple_quote, List<bool>* triple_out) {
  ...
  if ((this->token_type == Id::Left_DoubleQuote || this->token_type == Id::Left_DollarDoubleQuote)) {
    ...
    if ((try_triple_quote and len(dq_part->parts) == 0)) {
      if (str_equals(this->lexer->ByteLookAhead(), str1153)) {
  ...
  if ((this->token_type == Id::Left_SingleQuote || this->token_type == Id::Left_RSingleQuote || this->token_type == Id::Left_DollarSingleQuote)) {
    ...
    if ((try_triple_quote and len(sq_part->tokens) == 0)) {
      if (str_equals(this->lexer->ByteLookAhead(), str1154)) {
        this->_Next(lex_mode_e::ShCommand);
        this->_Peek();
  ...
  if ((left_id == Id::Left_DollarParen || left_id == Id::Left_AtParen || left_id == Id::Left_ProcSubIn || left_id == Id::Left_ProcSubOut)) {
    ...
    if ((left_id == Id::Left_Backtick and this->parse_ctx->one_pass_parse)) {
      ...
      if (left_id == Id::Left_Backtick) {
        ...
        right_spid = this->cur_token->span_id;
        code_str = str1162->join(parts);
        arena = this->parse_ctx->arena;
        line_reader = reader::StringLineReader(code_str, arena);
        c_parser = this->parse_ctx->MakeOshParser(line_reader);
        src = Alloc<source::Reparsed>(str1163, left_spid, right_spid);
        {  // with
          alloc::ctx_Location ctx(arena, src);
...
void WordParser::ParseProc(syntax_asdl::command__Proc* node) {
  ...
  if (this->token_type != Id::Lit_Chars) {
    p_die(fmt353(ui::PrettyToken(this->cur_token, this->arena)), this->cur_token);
  }
...
syntax_asdl::arith_expr_t* WordParser::_ReadArithExpr(int end_id) {
  ...
  if ((end_id != Id::Undefined_Tok and cur_id != end_id)) {
    p_die(fmt354(ui::PrettyId(cur_id), ui::PrettyId(end_id)), this->a_parser->cur_word);
  }
  return anode;
}
...
syntax_asdl::command__ForExpr* WordParser::ReadForExpression() {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt357(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
  if (cur_id == Id::Arith_Semi) {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt358(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
            ...
            if (this->token_type == Id::Lit_Dollar) {
              if (!this->parse_opts->parse_dollar()) {
                if ((num_parts == 0 and lex_mode == lex_mode_e::ShCommand)) {
                  ...
                  if (str_equals(next_byte, str1179)) {
                    println_stderr(fmt368(next_byte));
                  }
                }
...
Tuple2<syntax_asdl::word_t*, bool> WordParser::_ReadArithWord() {
  ...
  this->_Peek();
  if (this->token_kind == Kind::Unknown) {
    p_die(fmt373(this->cur_token->val), this->cur_token);
  }
  else {
    if (this->token_kind == Kind::Eof) {
          ...
          if ((this->token_kind == Kind::VSub || this->token_kind == Kind::Lit || this->token_kind == Kind::History || this->token_kind == Kind::Left || this->token_kind == Kind::KW || this->token_kind == Kind::ControlFlow || this->token_kind == Kind::BoolUnary || this->token_kind == Kind::BoolBinary || this->token_kind == Kind::ExtGlob)) {
            if (this->token_type == Id::Lit_Pound) {
              ...
              if (this->token_type == Id::Lit_TPound) {
                ...
                if ((this->parse_opts->parse_raw_string() and (this->token_type == Id::Lit_Chars and maybe_str_equals(this->cur_token->val, str1187)))) {
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1192, false));
    }
      break;
    case word_part_e::AssocArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1193, false));
    }
      break;
    case word_part_e::Literal: {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str1195, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str1196->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
    ...
    case word_part_e::FuncCall: 
    case word_part_e::ExprSub: {
      return (Tuple3<bool, Str*, bool>(false, str1197, false));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() != word_e::Compound) {
    return (Tuple3<bool, Str*, bool>(false, str1198, quoted));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  strs = Alloc<List<Str*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str1199, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str1200->join(strs), quoted));
}
...
syntax_asdl::compound_word* TildeDetect(syntax_asdl::word_t* UP_w) {
  ...
  if ((id_ == Id::Lit_Chars and static_cast<Token*>(part1)->val->startswith(str1202))) {
    new_parts->extend(w->parts->slice(1));
    return Alloc<compound_word>(new_parts);
  }
  return nullptr;
...
void TildeDetectAssign(syntax_asdl::compound_word* w) {
  ...
  for (int i = 0; i < n; ++i) {
    ...
    if ((do_expand and LiteralId(cur) == Id::Lit_TildeLike)) {
      ...
      if (next_part) {
        is_tilde = (LiteralId(next_part) == Id::Lit_Colon or (LiteralId(next_part) == Id::Lit_Chars and static_cast<Token*>(next_part)->val->startswith(str1203)));
      }
      else {
        is_tilde = true;
      }
...
ctx_Multiline::ctx_Multiline(word_parse::WordParser* w_parser) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(ctx_Multiline)) {
...
Str* escape(Str* s) {
  ...
  s = s->replace(str1213, str1214);
  s = s->replace(str1215, str1216);
  s = s->replace(str1217, str1218);
  return s;
}
...
Str* join(Str* s1, Str* s2) {
  ...
  if ((s2->startswith(str1221) or len(s1) == 0)) {
    return s2;
  }
  if (s1->endswith(str1222)) {
...
Tuple2<Str*, Str*> _splitext(Str* p, Str* sep, Str* extsep) {
  ...
  return (Tuple2<Str*, Str*>(p, str1225));
}
...
Str* normpath(Str* path) {
  ...
  slash = str1228;
  dot = str1229;
  if (str_equals(path, str1230)) {
    return dot;
  }
  initial_slashes = path->startswith(str1231);
  if ((initial_slashes and (path->startswith(str1232) and !path->startswith(str1233)))) {
    initial_slashes = 2;
  }
  comps = path->split(str1234);
  new_comps = Alloc<List<Str*>>();
  for (ListIter<Str*> it(comps); !it.Done(); it.Next()) {
    Str* comp = it.Value();
    StackRoots _for({&comp  });
    if ((len(comp) == 0 or str_equals(comp, str1235))) {
      continue;
    }
    if ((!(str_equals(comp, str1236)) or ((initial_slashes == 0 and len(new_comps) == 0) or (len(new_comps) and str_equals(new_comps->index_(-1), str1237))))) {
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if ((str_contains(str1244, ch) or IsUnprintableLow(ch))) {
        quote = 2;
        break;
      }
    }
  ...
  parts->append(str1247);
  return str_concat(prefix, str1248->join(parts));
}
...
Str* maybe_encode(Str* s, int bit8_display) {
  ...
  parts = Alloc<List<Str*>>();
  parts->append(str1249);
  _encode(s, bit8_display, false, parts);
  parts->append(str1250);
  return str1251->join(parts);
}
...
Str* encode(Str* s, int bit8_display) {
  ...
  parts = Alloc<List<Str*>>();
  parts->append(str1252);
  _encode(s, bit8_display, false, parts);
  parts->append(str1253);
  return str1254->join(parts);
}
...
void _encode_bytes_x(Str* s, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (str_equals(byte, str1255)) {
      part = str1256;
    }
    else {
      if (str_equals(byte, str1257)) {
        part = str1258;
      }
      else {
        if (str_equals(byte, str1259)) {
          part = str1260;
        }
        else {
          if (str_equals(byte, str1261)) {
            part = str1262;
          }
          else {
            if (str_equals(byte, str1263)) {
              part = str1264;
            }
            else {
              if (str_equals(byte, str1265)) {
                part = shell_compat ? str1266 : str1267;
              }
              else {
...
bool _encode_runes(Str* s, int bit8_display, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (typ == Ascii) {
      state = Start;
      if (str_equals(byte, str1271)) {
        out = str1272;
      }
      else {
        if (str_equals(byte, str1273)) {
          out = str1274;
        }
        else {
          if (str_equals(byte, str1275)) {
            out = str1276;
          }
          else {
            if (str_equals(byte, str1277)) {
              out = str1278;
            }
            else {
              if (str_equals(byte, str1279)) {
                out = str1280;
              }
              else {
                if (str_equals(byte, str1281)) {
                  out = shell_compat ? str1282 : str1283;
                }
                else {
                  if (IsUnprintableLow(byte)) {
...
syntax_asdl::word__String* _StringWordEmitter::ReadWord(types_asdl::lex_mode_t unused_lex_mode) {
  ...
  if (this->i == this->n) {
    w = Alloc<word::String>(Id::Eof_Real, str1284, runtime::NO_SPID);
    return w;
  }
...
syntax_asdl::bool_expr_t* _TwoArgs(builtin_bracket::_StringWordEmitter* w_parser) {
  ...
  w1 = w_parser->Read();
  s0 = w0->s;
  if (maybe_str_equals(s0, str1285)) {
    return Alloc<bool_expr::LogicalNot>(Alloc<bool_expr::WordTest>(w1));
  }
  unary_id = Id::Undefined_Tok;
  if (w0->s->startswith(str1286)) {
    if (maybe_str_equals(s0, str1287)) {
      unary_id = Id::BoolUnary_d;
    }
    else {
      if (maybe_str_equals(s0, str1288)) {
        unary_id = Id::BoolUnary_e;
      }
      else {
        if (maybe_str_equals(s0, str1289)) {
          unary_id = Id::BoolUnary_f;
        }
        else {
          if (maybe_str_equals(s0, str1290)) {
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    ...
    strs = cmd_val->argv;
    if ((!strs or !(str_equals(strs->index_(-1), str1299)))) {
      this->errfmt->Print_(str1300, cmd_val->arg_spids->index_(0));
      return 2;
    }
    cmd_val->argv->pop();
  ...
  try {
    ...
    if (n == 4) {
      a0 = w_parser->Peek(0);
      if (str_equals(a0, str1302)) {
        w_parser->Read();
        child = _ThreeArgs(w_parser);
        bool_node = Alloc<bool_expr::LogicalNot>(child);
      }
      else {
        if ((str_equals(a0, str1303) and str_equals(w_parser->Peek(3), str1304))) {
          w_parser->Read();
          bool_node = _TwoArgs(w_parser);
        }
        else {
    ...
    this->errfmt->PrettyPrintError(e, str1305);
    return 2;
  }
  ...
  try {
    ...
    this->errfmt->PrettyPrintError(e, str1306);
    return 2;
  }
  status = b ? 0 : 1;
  return status;

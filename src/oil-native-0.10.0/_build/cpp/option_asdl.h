...
namespace option_i {
  ...
  const int parse_at_all = 49;
  const int parse_backslash = 50;
  const int parse_backticks = 51;
  const int parse_dollar = 52;
  const int parse_ignored = 53;
  const int parse_amp = 54;
  const int simple_echo = 55;
  const int simple_eval_builtin = 56;
  const int simple_test_builtin = 57;
  const int parse_equals = 58;
...
namespace builtin_i {
  ...
  const int boolstatus = 63;
  const int push_registers = 64;
  const int cat = 65;
  const int ARRAY_SIZE = 66;
};

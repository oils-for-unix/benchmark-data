...
BigStr* Id_str(int tag, bool dot) {
  ...
  case Id::Left_DollarTSingleQuote:
    v = "Left_DollarTSingleQuote"; break;
  ...
  case Id::QSN_LiteralBytes:
    v = "QSN_LiteralBytes"; break;
  case Id::QSN_SpecialByte:
    v = "QSN_SpecialByte"; break;
  case Id::QSN_Begin2:
    v = "QSN_Begin2"; break;
  case Id::QSN_Begin3:
    v = "QSN_Begin3"; break;

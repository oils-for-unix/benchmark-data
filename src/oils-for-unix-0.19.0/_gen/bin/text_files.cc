...
GLOBAL_STR(gStr15, R"zZXx(Plugins and Hooks

  [YSH]   renderPrompt()
)zZXx");

GLOBAL_STR(gStr16, R"zZXx(Global Shell Options
...
GLOBAL_STR(gStr18, R"zZXx(Front End
...
GLOBAL_STR(gStr19, R"zZXx(bin/osh is compatible with POSIX shell, bash, and other shells.
...
GLOBAL_STR(gStr21, R"zZXx(bin/oils-for-unix is an executable that contains OSH, YSH, and more.
...
GLOBAL_STR(gStr22, R"zZXx(Packle

  [Packle]   Null   Bool   Int   Float   Str   List   Dict
)zZXx");

GLOBAL_STR(gStr23, R"zZXx(Builtin Functions
...
GLOBAL_STR(gStr24, R"zZXx(Assignments and Expressions
...
GLOBAL_STR(gStr25, R"zZXx(Command Language
...
GLOBAL_STR(gStr26, R"zZXx(Builtin Commands
...
GLOBAL_STR(gStr27, R"zZXx(# Can we define methods in pure YSH?
#
# (mylist->find(42) !== -1)
#
#   instead of 
...
GLOBAL_STR(gStr28, R"zZXx(func __math_select(list, cmp) {
...
GLOBAL_STR(gStr30, R"zZXx(# testing.ysh
#
# Usage:
...
GLOBAL_STR(gStr31, R"zZXx(func identity(x) {
...
GLOBAL_STR(gStr33, R"zZXx(# args.ysh
#
# Usage:
...
TextFile array[] = {
    ...
    {.rel_path = "_devbuild/help/ysh-plugin", .contents = gStr15},
    {.rel_path = "_devbuild/help/osh-option", .contents = gStr16},
    {.rel_path = "_devbuild/help/osh-chapters", .contents = gStr17},
    {.rel_path = "_devbuild/help/ysh-front-end", .contents = gStr18},
    {.rel_path = "_devbuild/help/osh-usage", .contents = gStr19},
    {.rel_path = "_devbuild/help/osh-front-end", .contents = gStr20},
    {.rel_path = "_devbuild/help/oils-usage", .contents = gStr21},
    {.rel_path = "_devbuild/help/data-packle", .contents = gStr22},
    {.rel_path = "_devbuild/help/ysh-builtin-func", .contents = gStr23},
    {.rel_path = "_devbuild/help/osh-osh-assign", .contents = gStr24},
    {.rel_path = "_devbuild/help/ysh-cmd-lang", .contents = gStr25},
    {.rel_path = "_devbuild/help/ysh-builtin-cmd", .contents = gStr26},
    {.rel_path = "stdlib/methods.ysh", .contents = gStr27},
    {.rel_path = "stdlib/math.ysh", .contents = gStr28},
    {.rel_path = "stdlib/list.ysh", .contents = gStr29},
    {.rel_path = "stdlib/testing.ysh", .contents = gStr30},
    {.rel_path = "stdlib/funcs.ysh", .contents = gStr31},
    {.rel_path = "stdlib/prelude.ysh", .contents = gStr32},
    {.rel_path = "stdlib/args.ysh", .contents = gStr33},

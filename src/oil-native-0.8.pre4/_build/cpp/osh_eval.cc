...
Str* str35 = new Str(" ");
Str* str36 = new Str("]");
Str* str37 = new Str("arg %r");
Str* str38 = new Str("arith val %d");
Str* str39 = new Str("Unhandled node %s");
Str* str40 = new Str("-n");
Str* str41 = new Str("-a");
Str* str42 = new Str("none");
Str* str43 = new Str("-c");
Str* str44 = new Str("");
Str* str45 = new Str("\n");
...
Str* str56 = new Str("<_ControlFlow %s>");
Str* str57 = new Str(" \t\n\"'><=;|&(:");
Str* str58 = new Str("/");
Str* str59 = new Str("PATH");
Str* str60 = new Str(":");
Str* str61 = new Str("SHELLOPTS");
Str* str62 = new Str(":");
Str* str63 = new Str("Syntax options must be set at the top level (outside any function)");
Str* str64 = new Str("got invalid option %r");
Str* str65 = new Str("errexit");
Str* str66 = new Str("verbose");
Str* str67 = new Str("Warning: set -o verbose not implemented");
Str* str68 = new Str("got invalid option %r");
Str* str69 = new Str("SHELLOPTS");
Str* str70 = new Str("%s:%s");
Str* str71 = new Str("SHELLOPTS");
Str* str72 = new Str(":");
Str* str73 = new Str(":");
Str* str74 = new Str("SHELLOPTS");
Str* str75 = new Str("oil:basic");
Str* str76 = new Str("oil:all");
Str* str77 = new Str("strict:all");
Str* str78 = new Str("got invalid option %r");
Str* str79 = new Str("got invalid option %r");
Str* str80 = new Str("errexit");
Str* str81 = new Str("set %so %s");
Str* str82 = new Str("-");
Str* str83 = new Str("+");
Str* str84 = new Str("got invalid option %r");
Str* str85 = new Str("shopt -%s %s");
Str* str86 = new Str("s");
Str* str87 = new Str("u");
Str* str88 = new Str("<_ArgFrame %s %d at %x>");
Str* str89 = new Str("Can't determine working directory: %s");
Str* str90 = new Str("IFS");
Str* str91 = new Str("UID");
Str* str92 = new Str("EUID");
Str* str93 = new Str("PPID");
Str* str94 = new Str("HOSTNAME");
Str* str95 = new Str("OSTYPE");
Str* str96 = new Str("OPTIND");
Str* str97 = new Str("1");
Str* str98 = new Str("PS4");
Str* str99 = new Str("+ ");
Str* str100 = new Str("COMP_WORDBREAKS");
...
Str* str107 = new Str("PWD");
Str* str108 = new Str("OIL_VERSION");
Str* str109 = new Str("PWD");
Str* str110 = new Str("");
Str* str111 = new Str("<Mem");
Str* str112 = new Str("  -- %d --");
Str* str113 = new Str("  %s %s");
Str* str114 = new Str(">");
Str* str115 = new Str("\n");
Str* str116 = new Str("\n");
Str* str117 = new Str("Warning: span_id undefined in SetCurrentSpanId");
Str* str118 = new Str("nameref %r is undefined");
Str* str119 = new Str("nameref %r contains invalid variable name %r");
Str* str120 = new Str("%r has already been declared");
Str* str121 = new Str("%r hasn't been declared");
Str* str122 = new Str("nameref cycle: %s");
Str* str123 = new Str(" -> ");
Str* str124 = new Str("Can't assign to readonly value %r");
Str* str125 = new Str("Only strings can be exported");
Str* str126 = new Str("nameref must be a string");
Str* str127 = new Str("Can't assign to readonly array");
Str* str128 = new Str("Can't assign to items in a string");
Str* str129 = new Str("Value of type %s can't be indexed");
Str* str130 = new Str("Can't assign to readonly associative array");
Str* str131 = new Str("ARGV");
Str* str132 = new Str("PIPESTATUS");
Str* str133 = new Str("FUNCNAME");
Str* str134 = new Str("source");
Str* str135 = new Str("BASH_SOURCE");
Str* str136 = new Str("BASH_LINENO");
Str* str137 = new Str("0");
Str* str138 = new Str("LINENO");
Str* str139 = new Str("BASHPID");
Str* str140 = new Str("Can't unset readonly variable %r");
Str* str141 = new Str("%r isn't an array");
Str* str142 = new Str("EOF");
Str* str143 = new Str("/");
Str* str144 = new Str("~");
Str* str145 = new Str("  ");
Str* str146 = new Str("\n  ");
...
Str* str151 = new Str("~");
Str* str152 = new Str("\n");
Str* str153 = new Str("[ interactive ]");
Str* str154 = new Str("[ -c flag ]");
Str* str155 = new Str("[ stdin%s ]");
Str* str156 = new Str("[ expansion of alias %r ]");
Str* str157 = new Str("[ backticks at ... ]");
Str* str158 = new Str("[ array LValue in %s ]");
Str* str159 = new Str("[ eval at line %d of %s ]");
Str* str160 = new Str("[ trap ]");
Str* str161 = new Str("[ variable ]");
Str* str162 = new Str("%s:%d: %s%s\n");
Str* str163 = new Str("[??? no location ???] %s%s\n");
Str* str164 = new Str("");
Str* str165 = new Str("");
Str* str166 = new Str("<LineLexer at pos %d of line %r (id = %d)>");
Str* str167 = new Str("");
Str* str168 = new Str("");
Str* str169 = new Str("");
Str* str170 = new Str("<Trail %s %s %s %s>");
Str* str171 = new Str("");
Str* str172 = new Str("ShAssignment expression can't be nested like this");
Str* str173 = new Str("Here docs aren't allowed in expressions");
Str* str174 = new Str("\n");
Str* str175 = new Str("  ");
Str* str176 = new Str("-");
Str* str177 = new Str("%s%d %s %s\n");
Str* str178 = new Str("");
Str* str179 = new Str(" (%s)");
Str* str180 = new Str("Unexpected token in expression mode%s");
Str* str181 = new Str("Syntax error in expression");
Str* str182 = new Str("alnum");
Str* str183 = new Str("cntrl");
Str* str184 = new Str("lower");
Str* str185 = new Str("space");
Str* str186 = new Str("alpha");
Str* str187 = new Str("digit");
Str* str188 = new Str("print");
Str* str189 = new Str("upper");
Str* str190 = new Str("blank");
Str* str191 = new Str("graph");
Str* str192 = new Str("punct");
Str* str193 = new Str("xdigit");
Str* str194 = new Str("Range start/end shouldn't have more than one character");
Str* str195 = new Str("Write singleton tuples with tup(), not a trailing comma");
Str* str196 = new Str("testlist_comp");
Str* str197 = new Str("PNode type %d (%s) wasn't handled");
Str* str198 = new Str("Can't assign to this expression");
Str* str199 = new Str("PNode type %d (%s) wasn't handled");
Str* str200 = new Str("TODO");
Str* str201 = new Str("dot");
Str* str202 = new Str("Can't negate this symbol");
Str* str203 = new Str("%r isn't a character class");
Str* str204 = new Str("Can't negate this symbol");
Str* str205 = new Str("%r isn't a character class");
Str* str206 = new Str("%start");
Str* str207 = new Str("%end");
Str* str208 = new Str("dot");
Str* str209 = new Str("Unexpected token %r in regex");
Str* str210 = new Str("The [ operator doesn't apply to this expression");
...
Str* str216 = new Str("");
Str* str217 = new Str("Expected %d, got %d");
Str* str218 = new Str("Step can't be 0");
Str* str219 = new Str("Invalid step %d for ascending integer range");
Str* str220 = new Str("Invalid step %d for descending integer range");
Str* str221 = new Str("Invalid step %d for ascending character range");
Str* str222 = new Str("Invalid step %d for descending character range");
Str* str223 = new Str("Mismatched cases in character range");
Str* str224 = new Str("");
Str* str225 = new Str("0");
Str* str226 = new Str("0");
Str* str227 = new Str("Couldn't find terminator for here doc that starts here");
Str* str228 = new Str("\t");
Str* str229 = new Str("Invalid here doc delimiter");
Str* str230 = new Str("+");
Str* str231 = new Str("+");
Str* str232 = new Str("+");
Str* str233 = new Str("%d != %d");
Str* str234 = new Str("Environment binding shouldn't look like an array assignment");
Str* str235 = new Str("+");
Str* str236 = new Str("Expected = in environment binding, got +=");
Str* str237 = new Str("Environment bindings can't contain array literals");
Str* str238 = new Str("Expected word type %s, got %s");
Str* str239 = new Str("{");
Str* str240 = new Str("}");
Str* str241 = new Str("Invalid token after redirect operator");
Str* str242 = new Str(" ");
Str* str243 = new Str(" ");
Str* str244 = new Str("line IDs %d != %d");
Str* str245 = new Str(" ");
Str* str246 = new Str("");
Str* str247 = new Str("Unexpected block");
Str* str248 = new Str("=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
Str* str249 = new Str("name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
Str* str250 = new Str("Unexpected block");
Str* str251 = new Str("Unexpected block");
Str* str252 = new Str("Control flow shouldn't have redirects");
Str* str253 = new Str("Control flow shouldn't have environment bindings");
Str* str254 = new Str("Unexpected argument to %r");
Str* str255 = new Str("Invalid word in for loop");
Str* str256 = new Str("Invalid word after for expression");
Str* str257 = new Str("Loop variable name should be a constant");
Str* str258 = new Str("Invalid loop variable name");
Str* str259 = new Str("Unexpected word after for loop variable");
Str* str260 = new Str("Expected ;; or esac");
Str* str261 = new Str("Unexpected word while parsing compound command");
Str* str262 = new Str("Invalid function name");
Str* str263 = new Str("Expected ) in function definition");
Str* str264 = new Str("Invalid KSH-style function name");
Str* str265 = new Str("Unexpected word when parsing command");
Str* str266 = new Str("Unexpected right brace");
Str* str267 = new Str("Unexpected EOF while parsing command");
Str* str268 = new Str("Invalid word while parsing command");
Str* str269 = new Str("Unexpected word while parsing command line");
Str* str270 = new Str("Unterminated here doc began here");
Str* str271 = new Str("\\");
Str* str272 = new Str("*");
Str* str273 = new Str("?");
Str* str274 = new Str("[");
...
Str* str278 = new Str("\\?*+{}^$.()|");
Str* str279 = new Str("\\");
Str* str280 = new Str("Unexpected escaped character %r");
Str* str281 = new Str("");
Str* str282 = new Str("");
Str* str283 = new Str("Malformed character class; treating as literal");
Str* str284 = new Str("Got unescaped right bracket");
Str* str285 = new Str("Got unescaped trailing backslash");
Str* str286 = new Str(".|^$()+*?[]{}\\");
Str* str287 = new Str("\\");
Str* str288 = new Str("\\");
Str* str289 = new Str("\\[");
...
Str* str297 = new Str("]");
Str* str298 = new Str("");
Str* str299 = new Str("Error expanding glob %r: %s");
Str* str300 = new Str("-");
Str* str301 = new Str("Undefined variable %r");
Str* str302 = new Str("Can't use [] on value of type %s");
Str* str303 = new Str("");
Str* str304 = new Str("Can't use [] on value of type %s");
Str* str305 = new Str("");
Str* str306 = new Str("0x");
Str* str307 = new Str("Invalid hex constant %r");
Str* str308 = new Str("0");
Str* str309 = new Str("Invalid octal constant %r");
Str* str310 = new Str("#");
Str* str311 = new Str("#");
Str* str312 = new Str("Invalid base for numeric constant %r");
Str* str313 = new Str("a");
Str* str314 = new Str("z");
Str* str315 = new Str("a");
Str* str316 = new Str("A");
Str* str317 = new Str("Z");
Str* str318 = new Str("A");
Str* str319 = new Str("@");
Str* str320 = new Str("_");
Str* str321 = new Str("Invalid digits for numeric constant %r");
Str* str322 = new Str("Digits %r out of range for base %d");
Str* str323 = new Str("Parse error in recursive arithmetic");
Str* str324 = new Str("Invalid integer constant %r");
Str* str325 = new Str("Undefined value in arithmetic context");
Str* str326 = new Str("Expected a value convertible to integer, got %s");
Str* str327 = new Str("Divide by zero");
Str* str328 = new Str("Divide by zero");
Str* str329 = new Str("Expected array or assoc in index expression, got %s");
Str* str330 = new Str("Divide by zero");
Str* str331 = new Str("Divide by zero");
Str* str332 = new Str("Exponent can't be less than zero");
Str* str333 = new Str("Associative array keys must be strings: $x 'x' \"$x\" etc.");
Str* str334 = new Str("Invalid place to modify");
Str* str335 = new Str("BASH_REMATCH");
Str* str336 = new Str("Invalid file descriptor %r");
Str* str337 = new Str("%s isn't implemented");
Str* str338 = new Str("Invalid regex %r");
Str* str339 = new Str(" \t\n");
Str* str340 = new Str("IFS");
Str* str341 = new Str("IFS shouldn't be an array");
Str* str342 = new Str(" \t\n");
Str* str343 = new Str("IFS");
Str* str344 = new Str(" ");
Str* str345 = new Str("");
Str* str346 = new Str("IFS shouldn't be an array");
Str* str347 = new Str("\\");
Str* str348 = new Str("\\");
Str* str349 = new Str("Invalid transition from %r with %r");
Str* str350 = new Str("\u00ef\u00bf\u00bd");
Str* str351 = new Str("");
Str* str352 = new Str("Incomplete UTF-8 character");
Str* str353 = new Str("Invalid UTF-8 continuation byte");
Str* str354 = new Str("Invalid start of UTF-8 character");
Str* str355 = new Str("");
Str* str356 = new Str("%s can't have an argument");
Str* str357 = new Str("");
Str* str358 = new Str("%s can't have an argument");
Str* str359 = new Str("");
Str* str360 = new Str("%s can't have an argument");
Str* str361 = new Str("");
Str* str362 = new Str("%s can't have an argument");
Str* str363 = new Str("");
Str* str364 = new Str("<_GlobReplacer regex %r r %r>");
Str* str365 = new Str("(%s)");
Str* str366 = new Str("Error matching regex %r: %s");
Str* str367 = new Str("^");
Str* str368 = new Str("$");
Str* str369 = new Str("\r");
Str* str370 = new Str("<INVALID CR>");
Str* str371 = new Str("\n");
Str* str372 = new Str("<INVALID NEWLINE>");
Str* str373 = new Str(" `~!$&*()[]{}\\|;'\"<>?");
Str* str374 = new Str("Left-hand side of this assignment is invalid");
Str* str375 = new Str("Token can't be used in prefix position");
Str* str376 = new Str("Token can't be used in infix position");
Str* str377 = new Str("Parser expected %s, got %s");
Str* str378 = new Str("Unexpected end of input");
Str* str379 = new Str("Invalid token %s");
Str* str380 = new Str("warning: Invalid backslash escape in C-style string");
Str* str381 = new Str("BASH_SOURCE");
Str* str382 = new Str("FUNCNAME");
Str* str383 = new Str("BASH_LINENO");
Str* str384 = new Str("");
Str* str385 = new Str("");
Str* str386 = new Str("\\");
Str* str387 = new Str("\\\\");
Str* str388 = new Str("");
Str* str389 = new Str("The start index of a string slice can't be negative: %d");
Str* str390 = new Str("The length of a string slice can't be negative: %d");
Str* str391 = new Str("The length index of a array slice can't be negative: %d");
Str* str392 = new Str("Can't slice associative arrays");
Str* str393 = new Str("i");
Str* str394 = new Str("e");
Str* str395 = new Str("u");
Str* str396 = new Str("x");
Str* str397 = new Str("n");
Str* str398 = new Str("");
Str* str399 = new Str("~");
Str* str400 = new Str("HOME");
Str* str401 = new Str("Can't assign to special variable");
Str* str402 = new Str("unset variable %r");
Str* str403 = new Str("@");
Str* str404 = new Str("*");
Str* str405 = new Str("@");
Str* str406 = new Str("*");
Str* str407 = new Str("warning: ");
Str* str408 = new Str("-1");
Str* str409 = new Str("@");
Str* str410 = new Str("*");
Str* str411 = new Str("[");
Str* str412 = new Str("]");
Str* str413 = new Str("Bad indirect expansion: %r");
Str* str414 = new Str("");
Str* str415 = new Str("");
Str* str416 = new Str("Undefined variable");
Str* str417 = new Str("$");
Str* str418 = new Str("Undefined variable %r");
Str* str419 = new Str("");
Str* str420 = new Str("Undefined array %r");
Str* str421 = new Str("Can't index string with @");
Str* str422 = new Str("Can't index string with *");
Str* str423 = new Str("Can't index string %r with integer");
Str* str424 = new Str("Array %r can't be referred to as a scalar (without @ or *)");
Str* str425 = new Str("\u0001");
Str* str426 = new Str("");
Str* str427 = new Str("\u0002");
Str* str428 = new Str("");
Str* str429 = new Str("a");
Str* str430 = new Str("A");
Str* str431 = new Str("r");
Str* str432 = new Str("x");
Str* str433 = new Str("n");
Str* str434 = new Str("");
Str* str435 = new Str("Var op %r not implemented");
Str* str436 = new Str("");
Str* str437 = new Str("warning: ");
Str* str438 = new Str("");
Str* str439 = new Str("Illegal array word part (strict_array)");
Str* str440 = new Str(" ");
Str* str441 = new Str("");
Str* str442 = new Str("Array %r can't be referred to as a scalar (without @ or *)");
Str* str443 = new Str("Unexpected array literal");
Str* str444 = new Str("Unexpected associative array literal");
Str* str445 = new Str("|");
Str* str446 = new Str(")");
Str* str447 = new Str("Can't splice %r");
Str* str448 = new Str("");
Str* str449 = new Str("");
Str* str450 = new Str("This word should yield a string, but it contains an array");
Str* str451 = new Str(" ");
Str* str452 = new Str("");
Str* str453 = new Str("<Runtime error: %s>");
Str* str454 = new Str("<I/O error: %s>");
Str* str455 = new Str("<I/O error: %s>");
Str* str456 = new Str("<Ctrl-C>");
Str* str457 = new Str("");
Str* str458 = new Str("");
Str* str459 = new Str("");
Str* str460 = new Str("");
Str* str461 = new Str("");
Str* str462 = new Str("LHS array not allowed in assignment builtin");
Str* str463 = new Str("+");
Str* str464 = new Str("+= not allowed in assignment builtin");
Str* str465 = new Str("-");
Str* str466 = new Str("+");
Str* str467 = new Str("f");
Str* str468 = new Str("F");
Str* str469 = new Str("");
Str* str470 = new Str("=");
Str* str471 = new Str("Invalid variable name %r");
Str* str472 = new Str("__NO_COMMAND_SUB__");
Str* str473 = new Str("__NO_PROCESS_SUB__");
Str* str474 = new Str("Expected : or } in slice");
Str* str475 = new Str("/");
Str* str476 = new Str("Pattern in ${x/pat/replace} must not be empty");
Str* str477 = new Str("Expected } after replacement string, got %s");
Str* str478 = new Str("Expected } or / to close pattern");
Str* str479 = new Str("Expected ] to close subscript");
Str* str480 = new Str("Expected } to close ${");
Str* str481 = new Str("Expected } to close ${");
Str* str482 = new Str("Expected } to close ${");
Str* str483 = new Str("Unexpected token in ${} (%s)");
Str* str484 = new Str("VOp2");
Str* str485 = new Str("Unexpected token in ${} (%s)");
Str* str486 = new Str("VOp3");
Str* str487 = new Str("Expected } to close ${");
Str* str488 = new Str("Expected } after length expression");
Str* str489 = new Str("Unexpected token in ${}");
Str* str490 = new Str("\\");
Str* str491 = new Str("Strings with backslashes should look like r'\\n' or c'\\n'");
Str* str492 = new Str("Unexpected EOF in single-quoted string that began here");
Str* str493 = new Str("Unexpected EOF reading extended glob that began here");
Str* str494 = new Str("Unexpected EOF reading double-quoted string that began here");
Str* str495 = new Str("Unexpected EOF while looking for closing backtick");
Str* str496 = new Str("");
Str* str497 = new Str("Invalid proc name %s");
Str* str498 = new Str("Expected first ) to end arith sub");
Str* str499 = new Str("Expected second ) to end arith sub");
Str* str500 = new Str("Expected first ) to end arith statement");
Str* str501 = new Str("Expected second ) to end arith statement");
Str* str502 = new Str("Expected ) to end for loop expression");
Str* str503 = new Str("Expected ( after =");
Str* str504 = new Str("Unexpected token in array literal");
Str* str505 = new Str("Expected associative array pair");
Str* str506 = new Str("Unexpected token after array literal");
Str* str507 = new Str("Unexpected token after array splice");
Str* str508 = new Str("Word has unbalanced { }.  Maybe add a space or quote it like \\{");
Str* str509 = new Str("Unexpected token in arithmetic context");
Str* str510 = new Str("Unhandled: %s (%s)");
Str* str511 = new Str("Invalid lex state %s");
Str* str512 = new Str("");
Str* str513 = new Str("");
Str* str514 = new Str("");
Str* str515 = new Str("");
...
Str* str519 = new Str("");
Str* str520 = new Str("");
Str* str521 = new Str("Compound shouldn't be empty");
Str* str522 = new Str("/");
Str* str523 = new Str("");
Str* str524 = new Str("EOF");
Str* str525 = new Str("typ");
Str* str526 = new Str("tok");
Str* str527 = new Str("children");
Str* str528 = new Str("-");
Str* str529 = new Str("with %d children");
Str* str530 = new Str("");
Str* str531 = new Str("(PNode %s %s %s)");
Str* str532 = new Str("&");
Str* str533 = new Str("&amp;");
Str* str534 = new Str("<");
Str* str535 = new Str("&lt;");
...
Str* str553 = new Str("\n");
Str* str554 = new Str("\\n");
Str* str555 = new Str("\r");
Str* str556 = new Str("\\r");
Str* str557 = new Str("\t");
Str* str558 = new Str("\\t");
Str* str559 = new Str("\u0000");
Str* str560 = new Str("\\x00");
Str* str561 = new Str("\\0");
Str* str562 = new Str("");
Str* str563 = new Str("");
Str* str564 = new Str("");
Str* str565 = new Str("\\");
...
Str* str569 = new Str("\n");
Str* str570 = new Str("\\n");
Str* str571 = new Str("\r");
Str* str572 = new Str("\\r");
Str* str573 = new Str("\t");
Str* str574 = new Str("\\t");
Str* str575 = new Str("\u0000");
Str* str576 = new Str("\\x00");
Str* str577 = new Str("\\0");
...
Str* fmt34(Str* a0, int a1, Str* a2, Str* a3) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const(":", 1);
  gBuf.format_d(a1);
...
Str* fmt38(Str* a0, int a1, Str* a2, Str* a3) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.format_d(a1);
  gBuf.write_const(" ", 1);
...
Str* fmt112(Str* a0, syntax_asdl::word_t* a1) {
  gBuf.reset();
  ...
  while (i < n) {
    if (str_equals(argv->index(i), str40)) {
      ...
      if (str_equals(argv->index(i), str41)) {
        ...
        if (str_equals(argv->index(i), str43)) {
          if (i >= n) {
            throw new AssertionError();
          }
          i += 1;
...
Str* SearchPath::Lookup(Str* name, bool exec_required) {
  ...
  val = this->mem->GetVar(str59);
  UP_val = val;
  if (val->tag_() == value_e::Str) {
    value__Str* val = static_cast<value__Str*>(UP_val);
    path_list = val->s->split(str60);
  }
  else {
...
this->opt_array->set(opt_num, true);
  ...
  runtime_asdl::value_t* UP_shellopts = this->mem->GetVar(str61);
...
void MutableOpts::_SetOption(Str* opt_name, bool b) {
  ...
  if (str_equals(opt_name, str65)) {
    this->errexit->Set(b);
  }
  else {
    if (str_equals(opt_name, str66) and b) {
      println_stderr(str67);
    }
...
void MutableOpts::SetOption(Str* opt_name, bool b) {
  ...
  UP_val = this->mem->GetVar(str69);
  value__Str* val = static_cast<value__Str*>(UP_val);
  shellopts = val->s;
  if (b) {
    if (!str_contains(shellopts, opt_name)) {
      new_val = new value::Str(fmt11(shellopts, opt_name));
      this->mem->InternalSetGlobal(str71, new_val);
    }
  }
  else {
    if (str_contains(shellopts, opt_name)) {
      names = new List<Str*>();
      for (ListIter<Str*> it(shellopts->split(str72)); !it.Done(); it.Next()) {
        Str* n = it.Value();
        names->append(n);
      }
      new_val = new value::Str(str73->join(names));
      this->mem->InternalSetGlobal(str74, new_val);
    }
  }
}
...
void MutableOpts::SetShoptOption(Str* opt_name, bool b) {
  ...
  if (str_equals(opt_name, str76)) {
    this->_SetGroup(consts::OIL_ALL, b);
    return ;
  }
  if (str_equals(opt_name, str77)) {
...
void MutableOpts::ShowOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    print(fmt14(b ? str82 : str83, opt_name));
  }
}
...
void MutableOpts::ShowShoptOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    b = this->opt_array->index(index);
    print(fmt16(b ? str86 : str87, opt_name));
  }
}
...
void _InitDefaults(state::Mem* mem) {
  SetGlobalString(mem, str90, split::DEFAULT_IFS);
  SetGlobalString(mem, str91, str(posix::getuid()));
  SetGlobalString(mem, str92, str(posix::geteuid()));
  SetGlobalString(mem, str93, str(posix::getppid()));
  SetGlobalString(mem, str94, libc::gethostname());
  SetGlobalString(mem, str95, posix::uname()->index(0)->lower());
  SetGlobalString(mem, str96, str97);
  SetGlobalString(mem, str98, str99);
  SetGlobalString(mem, str100, _READLINE_DELIMS);
}
...
void _InitVarsFromEnv(state::Mem* mem, Dict<Str*, Str*>* environ) {
  ...
  val = mem->GetVar(str101);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str102, str103);
  }
  mem->SetVar(new lvalue::Named(str104), nullptr, scope_e::GlobalOnly, SetReadOnly);
  val = mem->GetVar(str105);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str106, _GetWorkingDir());
  }
  mem->SetVar(new lvalue::Named(str107), nullptr, scope_e::GlobalOnly, SetExport);
}
...
void InitMem(state::Mem* mem, Dict<Str*, Str*>* environ, Str* version_str) {
  ...
  SetGlobalString(mem, str108, version_str);
  _InitDefaults(mem);
  _InitVarsFromEnv(mem, environ);
  val = mem->GetVar(str109);
...
Mem::Mem(Str* dollar0, List<Str*>* argv, alloc::Arena* arena, List<state::DebugFrame*>* debug_stack) {
  ...
  this->line_num = new value::Str(str110);
...
void Mem::_DisallowNamerefCycle(Str* name, List<Str*>* ref_trail) {
  ...
  if (list_contains(ref_trail, new_name)) {
    e_die(fmt22(str123->join(ref_trail)));
  }
...
bool Mem::Unset(runtime_asdl::lvalue_t* lval, runtime_asdl::scope_t lookup_mode, bool strict) {
  ...
  if (cell->readonly) {
    throw new error::Runtime(fmt28(var_name));
  }
  switch (lval->tag_()) {
    case lvalue_e::Named: {
    }
...
Str* PrettyDir(Str* dir_name, runtime_asdl::value_t* UP_home_dir) {
  ...
  if (UP_home_dir and UP_home_dir->tag_() == value_e::Str) {
    ...
    if (dir_name == home_dir or dir_name->startswith(str_concat(home_dir, str143))) {
      return str_concat(str144, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    f->write(str_equals(c, str147) ? str148 : str149);
  }
  f->write(str150);
  f->write(str_repeat(str151, length - 1));
  f->write(str152);
}
...
void _PrintWithSpanId(Str* prefix, Str* msg, int span_id, alloc::Arena* arena, mylib::Writer* f) {
  ...
  switch (src->tag_()) {
    ...
    case source_e::EvalArg: {
      ...
      source_str = fmt33(line_num, outer_source);
    }
      break;
    case source_e::Trap: {
      source_str = str160;
  ...
  f->write(fmt34(source_str, line_num, prefix, msg));
}
...
void PrettyPrintError(error::_ErrorWithLocation* err, alloc::Arena* arena) {
  PrettyPrintError(err, arena, str164);
}
...
int LineLexer::GetSpanIdForEof() {
  ...
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str167, 0);
  }
  else {
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str168, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = new Token(id_, span_id, str169);
      return t;
    }
...
lexer::Lexer* ParseContext::_MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = new lexer::LineLexer(str171, this->arena);
...
void ParseTreePrinter::_Print(pnode::PNode* pnode, int indent, int i) {
  ...
  this->f->write(fmt38(ind, i, this->names->index(pnode->typ), v));
...
int _Classify(grammar::Grammar* gr, syntax_asdl::Token* tok) {
  ...
  type_str = tok->id == Id::Unknown_Tok ? str178 : fmt39(ui::PrettyId(tok->id));
  p_die(fmt40(type_str), tok);
}
...
Tuple2<pnode::PNode*, syntax_asdl::Token*> ExprParser::Parse(lexer::Lexer* lexer, int start_symbol) {
  ...
  try {
    ...
    throw new error::Parse(str181, e->tok);
  }
...
List<Str*>* POSIX_CLASSES = new List<Str*>({str182, str183, str184, str185, str186, str187, str188, str189, str190, str191, str192, str193});
Str* RANGE_POINT_TOO_LONG = str194;
int NT_OFFSET = 256;
...
syntax_asdl::expr_t* Transformer::_Tuple(List<pnode::PNode*>* children) {
  ...
  if (n == 2) {
    p_die(fmt41(), children->index(1)->tok);
  }
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw new NotImplementedError(str196);
  }
  if (id0 == Id::Op_LBracket) {
    elts = new List<syntax_asdl::expr_t*>();
    for (int i = 0; i < n; i += 2) {
  ...
  for (int i = 0; i < n; i += 2) {
    ...
    if (tag == expr_e::Var) {
      ...
      if ((tag == place_expr_e::Var || tag == place_expr_e::Subscript || tag == place_expr_e::Attribute)) {
        ...
        p_die(fmt42(), p->tok ? p->tok : nullptr);
      }
    }
  }
  return places;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((tok->val == str206 || tok->val == str207 || tok->val == str208)) {
        return tok;
      }
      p_die(fmt47(tok->val), tok);
    }
...
syntax_asdl::bool_expr_t* BoolParser::ParseForBuiltin() {
  ...
  if (this->op_id != Id::Eof_Real) {
    p_die(fmt50(word_::Pretty(this->cur_word)), this->cur_word);
  }
  return node;
}
...
syntax_asdl::bool_expr_t* BoolParser::ParseFactor() {
  ...
  if (this->op_id == Id::Op_LParen) {
    ...
    if (this->op_id != Id::Op_RParen) {
      p_die(fmt52(word_::Pretty(this->cur_word)), this->cur_word);
    }
    this->_Next();
    return node;
  }
  p_die(fmt53(), this->cur_word);
}
...
Str* _RangeParser::_Eat(int token_type) {
  ...
  if (this->token_type != token_type) {
    throw new _NotARange(fmt54(token_type, this->token_type));
  }
  val = this->token_val;
  this->_Next();
  return val;
    ...
    if (this->token_type == Id::Range_Char) {
      ...
      if (start_num < end_num) {
        ...
        if (start_num > end_num) {
          ...
          if (part->step >= 0) {
            p_die(fmt59(part->step), this->span_id);
          }
        }
        else {
          part->step = 1;
      ...
      if (upper1 != upper2) {
        p_die(fmt60(), this->span_id);
      }
    }
    else {
      throw new _NotARange(str224);
    }
  }
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index(i), str228))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index(-2), str230)) {
    ...
    if (left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse) {
      var_name = left_token->val->slice(0, -1);
      if (str_equals(close_token->val->index(-2), str231)) {
        op = assign_op_e::PlusEqual;
      }
      else {
        op = assign_op_e::Equal;
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        var_name = left_token->val->slice(0, -1);
        if (str_equals(close_token->val->index(-2), str232)) {
          op = assign_op_e::PlusEqual;
        }
        else {
          op = assign_op_e::Equal;
        ...
        if (span1->line_id == span2->line_id) {
          ...
          throw new NotImplementedError(fmt63(span1->line_id, span2->line_id));
        }
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    if (str_equals(left_token->val->index(-2), str235)) {
      p_die(fmt65(), left_token);
    }
    var_name = left_token->val->slice(0, -1);
    n = len(w->parts);
    if (part_offset == n) {
...
void CommandParser::_Eat(int c_id) {
  ...
  msg = fmt67(ui::PrettyId(c_id), ui::PrettyId(actual_id));
  this->_Eat2(c_id, msg);
}
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index(0), str239)) {
    pos = op_val->find(str240);
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    i += 1;
    if (!alias_exp->endswith(str242)) {
      expanded->append(str243);
      break;
    }
  }
  if (len(expanded) == 0) {
  ...
  while (i < n) {
    ...
    if (span1->line_id == span2->line_id) {
      ...
      throw new NotImplementedError(fmt69(span1->line_id, span2->line_id));
    }
    expanded->append(str245);
    i += 1;
  }
  code_str = str246->join(expanded);
  line_reader = reader::StringLineReader(code_str, this->arena);
  ...
  if (kind == Kind::ControlFlow) {
    ...
    if (len(suffix_words) == 1) {
      ...
      if (len(suffix_words) == 2) {
        ...
        p_die(fmt77(kw_token->val), suffix_words->index(2));
      }
    }
...
syntax_asdl::command__ShFunction* CommandParser::ParseFunctionDef() {
  ...
  this->_Next();
  this->_Eat2(Id::Right_ShFunction, str263);
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    ...
    if (str_equals(c, str271)) {
      ...
      if (str_equals(c, str272) or str_equals(c, str273)) {
        return true;
      }
      else {
        if (str_equals(c, str274)) {
          left_bracket = true;
        }
        else {
          if (str_equals(c, str275) and left_bracket) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  return util::BackslashEscape(s, str277);
}
Str* ERE_META_CHARS = str278;
...
Str* GlobUnescape(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if (str_equals(c, str279) and i != n - 1) {
      i += 1;
      c2 = s->index(i);
  ...
  return str281->join(unescaped);
}

_GlobParser::_GlobParser(match::SimpleLexer* lexer) {
  this->lexer = lexer;
  this->token_type = Id::Undefined_Tok;
  this->token_val = str282;
...
int Globber::Expand(Str* arg, List<Str*>* out) {
  ...
  if (n) {
    for (ListIter<Str*> it(results); !it.Done(); it.Next()) {
      Str* name = it.Value();
      if (name->startswith(str300) and !this->exec_opts->dashglob()) {
        n -= 1;
        continue;
      }
      out->append(name);
    ...
    case lvalue_e::Indexed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          break;
        default: {
          e_die(fmt95(ui::ValType(val)));
        }
      }
      try {
        s = array_val->strs->index(lval->index);
      }
      catch (IndexError*) {
        s = nullptr;
      }
      if (s == nullptr) {
        val = new value::Str(str303);
      }
      else {
        val = new value::Str(s);
      }
    ...
    case lvalue_e::Keyed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::AssocArray: {
          ...
          break;
        default: {
          e_die(fmt96(ui::ValType(val)));
        }
      }
      s = assoc_val->d->get(lval->key);
      if (s == nullptr) {
        val = new value::Str(str305);
      }
      else {
        val = new value::Str(s);
      }
...
int ArithEvaluator::_StringToInteger(Str* s, int span_id) {
  ...
  if (s->startswith(str306)) {
    try {
      integer = to_int(s, 16);
    }
    catch (ValueError*) {
      e_strict(fmt97(s), span_id);
    }
    return integer;
  }
  if (s->startswith(str308)) {
    try {
      integer = to_int(s, 8);
    }
    catch (ValueError*) {
      e_strict(fmt98(s), span_id);
    }
    return integer;
  }
  if (str_contains(s, str310)) {
    parts = s->split(str311, 1);
    b = parts->index(0);
    ...
    try {
      ...
      e_strict(fmt99(b), span_id);
    }
    integer = 0;
    n = 1;
    for (StrIter it(digits); !it.Done(); it.Next()) {
      Str* ch = it.Value();
      if (str313 <= ch and ch <= str314) {
        digit = ord(ch) - ord(str315) + 10;
      }
      else {
        if (str316 <= ch and ch <= str317) {
          digit = ord(ch) - ord(str318) + 36;
        }
        else {
          if (str_equals(ch, str319)) {
            digit = 62;
          }
          else {
            if (str_equals(ch, str320)) {
              digit = 63;
            }
            else {
              if (ch->isdigit()) {
                ...
                e_strict(fmt100(digits), span_id);
              }
            }
          }
        }
      ...
      if (digit >= base) {
        e_strict(fmt101(digits, base), span_id);
      }
      integer += digit * n;
      n *= base;
    }
...
int ArithEvaluator::_ValToIntOrError(runtime_asdl::value_t* val, int span_id) {
  ...
  e_die(fmt105(ui::ValType(val)), span_id);
}
...
runtime_asdl::value_t* ArithEvaluator::Eval(syntax_asdl::arith_expr_t* node) {
  ...
  switch (node->tag_()) {
    ...
    case arith_expr_e::UnaryAssign: {
      ...
      op_id = node->op_id;
      Tuple2<int, runtime_asdl::lvalue_t*> tup0 = this->_EvalLhsAndLookupArith(node->child);
      old_int = tup0.at0();
      lval = tup0.at1();
    ...
    case arith_expr_e::BinaryAssign: {
      ...
      Tuple2<int, runtime_asdl::lvalue_t*> tup1 = this->_EvalLhsAndLookupArith(node->left);
      old_int = tup1.at0();
      lval = tup1.at1();
        ...
        if (op_id == Id::Arith_Minus) {
          ...
          if (op_id == Id::Arith_Star) {
            ...
            if (op_id == Id::Arith_Slash) {
              if (rhs == 0) {
                e_die(fmt107(), location::SpanForArithExpr(node->right));
              }
              ret = lhs / rhs;
            }
            else {
              if (op_id == Id::Arith_Percent) {
                if (rhs == 0) {
                  e_die(fmt108(), location::SpanForArithExpr(node->right));
                }
                ret = lhs % rhs;
              }
              else {
...
runtime_asdl::lvalue_t* ArithEvaluator::EvalArithLhs(syntax_asdl::arith_expr_t* anode, int span_id) {
  ...
  if (anode->tag_() == arith_expr_e::Binary) {
    ...
    if (anode->op_id == Id::Arith_LBracket) {
      Tuple2<Str*, int> tup2 = this->_VarRefOrWord(anode->left);
      var_name = tup2.at0();
      span_id = tup2.at1();
      if (var_name != nullptr) {
  ...
  Tuple2<Str*, int> tup3 = this->_VarRefOrWord(anode);
  var_name = tup3.at0();
  span_id = tup3.at1();
  if (var_name != nullptr) {
...
void BoolEvaluator::_SetRegexMatches(List<Str*>* matches) {
  state::SetGlobalArray(this->mem, str335, matches);
}
  ...
  switch (node->tag_()) {
    ...
    case bool_expr_e::Unary: {
      ...
      if (arg_type == bool_arg_type_e::Other) {
        ...
        e_die(fmt111(ui::PrettyId(op_id)));
      }
      throw new AssertionError();
    }
      break;
...
_BaseSplitter::_BaseSplitter(Str* escape_chars) {
  this->escape_chars = str_concat(escape_chars, str347);
}
    ...
    if (i < n) {
      ...
      if (str_contains(ws_chars, c)) {
        ...
        if (str_contains(other_chars, c)) {
          ...
          if (allow_escape and str_equals(c, str348)) {
            ch = CH::Backslash;
          }
          else {
            ch = CH::Black;
...
Str* Utf8Encode(int code) {
  ...
  return str351->join(tmp);
}
Str* INCOMPLETE_CHAR = str352;
Str* INVALID_CONT = str353;
Str* INVALID_START = str354;
    ...
    if ((op->op_id == Id::VOp1_Pound || op->op_id == Id::VOp1_DPound)) {
      ...
      if ((op->op_id == Id::VOp1_Percent || op->op_id == Id::VOp1_DPercent)) {
        ...
        if (op->op_id == Id::VOp1_Comma) {
          if (!(str_equals(arg, str355))) {
            e_die(fmt113(ui::PrettyId(op->op_id)));
          }
          if (len(s)) {
          ...
          if (op->op_id == Id::VOp1_DComma) {
            if (!(str_equals(arg, str357))) {
              e_die(fmt114(ui::PrettyId(op->op_id)));
            }
            return s->lower();
          }
          else {
            if (op->op_id == Id::VOp1_Caret) {
              if (!(str_equals(arg, str359))) {
                e_die(fmt115(ui::PrettyId(op->op_id)));
              }
              if (len(s)) {
              ...
              if (op->op_id == Id::VOp1_DCaret) {
                if (!(str_equals(arg, str361))) {
                  e_die(fmt116(ui::PrettyId(op->op_id)));
                }
                return s->upper();
              }
              else {
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Slash) {
    try {
      ...
      msg = e->message;
      e_die(fmt118(regex, msg), this->slash_spid);
    }
  }
  if (op->replace_mode == Id::Lit_Pound) {
    regex = str_concat(str367, regex);
  }
  else {
    if (op->replace_mode == Id::Lit_Percent) {
      regex = str_concat(regex, str368);
    }
  }
...
Str* ShellQuoteB(Str* s) {
  s = s->replace(str369, str370)->replace(str371, str372);
  return util::BackslashEscape(s, str373);
}
...
void TdopParser::Eat(int token_type) {
  if (!this->AtToken(token_type)) {
    p_die(fmt122(ui::PrettyId(token_type), ui::PrettyId(this->op_id)), this->cur_word);
  }
  this->Next();
}
...
using runtime_asdl::scope_e;
List<Str*>* _STRING_AND_ARRAY = new List<Str*>({str381, str382, str383});
...
Str* _BackslashEscape(Str* s) {
  return s->replace(str386, str387);
}
...
runtime_asdl::value_t* _PerformSlice(runtime_asdl::value_t* val, int begin, int length, bool has_length, syntax_asdl::braced_var_sub* part, runtime_asdl::value__Str* arg0_val) {
  ...
  switch (val->tag_()) {
    case value_e::Str: {
      ...
      s = val->s;
      if (begin < 0) {
        e_strict(fmt124(begin), part);
      }
      byte_begin = string_ops::AdvanceUtf8Chars(s, begin, 0);
      if (has_length) {
        if (length < 0) {
          e_strict(fmt125(length), part);
        }
      ...
      if ((op->op_id == Id::VTest_ColonEquals || op->op_id == Id::VTest_Equals)) {
        ...
        if ((op->op_id == Id::VTest_ColonQMark || op->op_id == Id::VTest_QMark)) {
          if (is_falsey) {
            ...
            e_die(fmt128(error_str), blame_token);
          }
          else {
            return false;
          }
      ...
      case value_e::Str: {
        ...
        try {
          ...
          if (this->exec_opts->strict_word_eval()) {
            ...
            this->errfmt->PrettyPrintError(e, str407);
            return new value::Str(str408);
          }
        }
      }
        break;
    ...
    if (op_id == Id::VSub_Bang) {
      ...
      switch (val->tag_()) {
        case value_e::Str: {
          ...
          if ((val->s == str409 || val->s == str410)) {
            return new value::MaybeStrArray(this->mem->GetArgv());
          }
          i = val->s->find(str411);
          if (i >= 0 and str_equals(val->s->index(-1), str412)) {
...
void AbstractWordEvaluator::_EvalDoubleQuoted(List<syntax_asdl::word_part_t*>* parts, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  if (len(parts) == 0) {
    v = new part_value::String(str414, true, false);
    part_vals->append(v);
    return ;
  }
...
runtime_asdl::value__Str* AbstractWordEvaluator::_BashArrayCompat(runtime_asdl::value__MaybeStrArray* val) {
  ...
  s = val->strs ? val->strs->index(0) : str415;
  ...
  if (val->tag_() == value_e::Undef) {
    if (this->exec_opts->nounset()) {
      if (token == nullptr) {
        ...
        name = token->val->startswith(str417) ? token->val->slice(1) : token->val;
        e_die(fmt130(name), token);
      }
    }
    else {
      return new value::Str(str419);
    }
  }
  else {
    return val;
...
void AbstractWordEvaluator::_EvalBracedVarSub(syntax_asdl::braced_var_sub* part, List<runtime_asdl::part_value_t*>* part_vals, bool quoted) {
  ...
  if (part->token->id == Id::VSub_Name) {
    if (part->prefix_op != nullptr and part->suffix_op != nullptr and part->suffix_op->tag_() == suffix_op_e::Nullary) {
      ...
      Token* suffix_op = static_cast<Token*>(part->suffix_op);
      maybe_decay_array = !quoted and suffix_op->id == Id::VOp3_At;
      name_query = true;
    }
    else {
  ...
  if (part->bracket_op) {
      ...
      case bracket_op_e::ArrayIndex: {
        ...
        switch (val->tag_()) {
          case value_e::Undef: {
            ...
            break;
          case value_e::Str: {
            e_die(fmt134(part->token->val), part->token);
          }
            break;
          case value_e::MaybeStrArray: {
            value__MaybeStrArray* array_val = static_cast<value__MaybeStrArray*>(UP_val);
    ...
    if (var_name and (val->tag_() == value_e::MaybeStrArray || val->tag_() == value_e::AssocArray)) {
      ...
      if (suffix_op2 and suffix_op2->tag_() == suffix_op_e::Nullary and static_cast<Token*>(suffix_op2)->id == Id::VOp0_a) {
        ...
        if (list_contains(_STRING_AND_ARRAY, var_name)) {
          bash_array_compat = true;
        }
        else {
          e_die(fmt135(var_name), part);
        }
      }
    }
  }
  if (part->prefix_op and !name_query) {
    val = this->_EmptyStrOrError(val);
    val = this->_ApplyPrefixOp(val, part->prefix_op, part->token);
  }
  if (part->suffix_op and !name_query) {
    op = part->suffix_op;
    UP_op = op;
    switch (op->tag_()) {
      case suffix_op_e::Nullary: {
        ...
        if (op_id == Id::VOp0_P) {
          ...
          p = prompt->replace(str425, str426)->replace(str427, str428);
          val = new value::Str(p);
        }
        else {
          if (op_id == Id::VOp0_Q) {
            ...
            if (op_id == Id::VOp0_a) {
              ...
              val = new value::Str(str434->join(chars));
            }
            else {
              e_die(fmt136(op->val), op);
            }
          }
        }
      }
      ...
      case suffix_op_e::Slice: {
        ...
        try {
          ...
          if (this->exec_opts->strict_word_eval()) {
            ...
            this->errfmt->PrettyPrintError(e, str437);
            switch (val->tag_()) {
              case value_e::Str: {
                val = new value::Str(str438);
              }
                break;
              case value_e::MaybeStrArray: {
  ...
  switch (part->tag_()) {
    ...
    case word_part_e::ExtGlob: {
      ...
      for (ListIter<syntax_asdl::word_t*> it(part->arms); !it.Done(); it.Next(), ++i) {
        syntax_asdl::word_t* w = it.Value();
        if (i != 0) {
          part_vals->append(new part_value::String(str445, false, false));
        }
        this->_EvalWordToParts(w, false, part_vals);
      }
      part_vals->append(new part_value::String(str446, false, false));
    }
      break;
...
void AbstractWordEvaluator::_EvalWordToParts(syntax_asdl::word_t* w, bool quoted, List<runtime_asdl::part_value_t*>* part_vals, bool is_subst) {
  ...
  switch (w->tag_()) {
    case word_e::Compound: {
      ...
      break;
    case word_e::Empty: {
      part_vals->append(new part_value::String(str448, quoted, !quoted));
    }
      break;
    default: {
      throw new AssertionError();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, runtime_asdl::quote_t quote_kind) {
  ...
  return new value::Str(str452->join(strs));
}
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalForPlugin(syntax_asdl::compound_word* w) {
  ...
  try {
    try {
      ...
      val = new value::Str(fmt143(e->UserErrorString()));
    }
    catch (OSError* e) {
      val = new value::Str(fmt144(pyutil::strerror_OS(e)));
    }
    catch (IOError* e) {
      val = new value::Str(fmt145(pyutil::strerror_IO(e)));
    }
    catch (KeyboardInterrupt*) {
      val = new value::Str(str456);
    }
  }
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index(-2), str463)) {
          e_die(fmt147(), w);
        }
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        if (arg->startswith(str465) or arg->startswith(str466)) {
          flags->append(arg);
          flag_spids->append(word_spid);
          if (str_contains(arg, str467) or str_contains(arg, str468)) {
            eval_to_pairs = false;
          }
        }
        else {
...
syntax_asdl::suffix_op__PatSub* WordParser::_ReadPatSubVarOp() {
  ...
  if (len(pat->parts) == 1) {
    ...
    s = tup0.at1();
    quoted = tup0.at2();
    if (ok and str_equals(s, str475) and !quoted) {
  ...
  if (this->token_type == Id::Lit_Slash) {
    ...
    this->_Peek();
    if (this->token_type != Id::Right_DollarBrace) {
      p_die(fmt151(ui::PrettyId(this->token_type)), this->cur_token);
    }
        ...
        if (op_kind == Kind::VOp2) {
          if (this->token_type == Id::VOp2_Slash) {
            ...
            if (this->token_type == Id::VOp2_Colon) {
              ...
              p_die(fmt157(str484), this->cur_token);
            }
          }
        }
        else {
          if (op_kind == Kind::VOp3) {
            if (allow_query) {
              ...
              p_die(fmt158(str486), this->cur_token);
            }
          }
        }
      }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool no_backslashes) {
  ...
  while (!done) {
    ...
    if ((this->token_kind == Kind::Lit || this->token_kind == Kind::Char)) {
      tok = this->cur_token;
      if (no_backslashes and str_contains(tok->val, str490)) {
        p_die(fmt162(), tok);
      }
      tokens->append(tok);
    }
...
void WordParser::ParseProc(syntax_asdl::command__Proc* node) {
  ...
  if (this->token_type != Id::Lit_Chars) {
    p_die(fmt167(ui::PrettyToken(this->cur_token, this->arena)), this->cur_token);
  }
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str512, false));
    }
      break;
    case word_part_e::AssocArrayLiteral: {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str515, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str516->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
    ...
    case word_part_e::ExtGlob: 
    case word_part_e::Splice: {
      return (Tuple3<bool, Str*, bool>(false, str517, false));
    }
      break;
    default: {
      throw new AssertionError();
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() != word_e::Compound) {
    return (Tuple3<bool, Str*, bool>(false, str518, quoted));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  strs = new List<Str*>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
  ...
  return (Tuple3<bool, Str*, bool>(true, str520->join(strs), quoted));
}
...
Str* escape(Str* s) {
  s = s->replace(str532, str533);
  s = s->replace(str534, str535);
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if (str_contains(str538, ch) or IsUnprintableLow(ch)) {
        quote = 2;
        break;
      }
    }
  ...
  parts->append(str541);
  return str_concat(prefix, str542->join(parts));
}
...
void _encode_bytes_x(Str* s, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    Str* byte = it.Value();
    if (str_equals(byte, str549)) {
      part = str550;
    }
    else {
      if (str_equals(byte, str551)) {
        part = str552;
      }
      else {
        if (str_equals(byte, str553)) {
          part = str554;
        }
        else {
          if (str_equals(byte, str555)) {
            part = str556;
          }
          else {
            if (str_equals(byte, str557)) {
              part = str558;
            }
            else {
              if (str_equals(byte, str559)) {
                part = shell_compat ? str560 : str561;
              }
              else {
...
bool _encode_runes(Str* s, int bit8_display, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (typ == Ascii) {
      state = Start;
      if (str_equals(byte, str565)) {
        out = str566;
      }
      else {
        if (str_equals(byte, str567)) {
          out = str568;
        }
        else {
          if (str_equals(byte, str569)) {
            out = str570;
          }
          else {
            if (str_equals(byte, str571)) {
              out = str572;
            }
            else {
              if (str_equals(byte, str573)) {
                out = str574;
              }
              else {
                if (str_equals(byte, str575)) {
                  out = shell_compat ? str576 : str577;
                }
                else {
                  if (IsUnprintableLow(byte)) {

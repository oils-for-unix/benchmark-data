...
GLOBAL_STR(str122, "%r ");
GLOBAL_STR(str123, "");
GLOBAL_STR(str124, "Command evaluated to an empty argv array");
GLOBAL_STR(str125, "Can't run assignment builtin recursively");
GLOBAL_STR(str126, "errexit was disabled for this construct");
GLOBAL_STR(str127, "");
GLOBAL_STR(str128, "Can't run a proc while errexit is disabled. Use 'try' or wrap it in a process with $0 myproc");
GLOBAL_STR(str129, "proc");
GLOBAL_STR(str130, "Unexpected typed args passed to external command %r");
GLOBAL_STR(str131, "%r not found");
GLOBAL_STR(str132, "pipeline");
GLOBAL_STR(str133, "Command subs not allowed here because status wouldn't be checked (strict_errexit).");
GLOBAL_STR(str134, "__cat");
GLOBAL_STR(str135, "osh I/O error: %s");
GLOBAL_STR(str136, "Command Sub exited with status %d");
GLOBAL_STR(str137, "");
GLOBAL_STR(str138, "\n");
...
GLOBAL_STR(str178, "/bin/sh");
GLOBAL_STR(str179, "/bin/sh");
GLOBAL_STR(str180, "Can't execute %r: %s");
GLOBAL_STR(str181, "[process] %s");
GLOBAL_STR(str182, " ");
GLOBAL_STR(str183, "[subprog] %s");
GLOBAL_STR(str184, "");
GLOBAL_STR(str185, "osh I/O error: %s");
GLOBAL_STR(str186, "[here doc writer]");
GLOBAL_STR(str187, "<Process %s %s>");
GLOBAL_STR(str188, "  ");
GLOBAL_STR(str189, "%%%d");
GLOBAL_STR(str190, "%s %d %7s ");
GLOBAL_STR(str191, "\n");
GLOBAL_STR(str192, "Fatal error in posix.fork()");
GLOBAL_STR(str193, "%%%d");
GLOBAL_STR(str194, "  ");
GLOBAL_STR(str195, "%s %d %7s ");
GLOBAL_STR(str196, "\n");
GLOBAL_STR(str197, "Pipeline in state %s");
GLOBAL_STR(str198, "\n");
GLOBAL_STR(str199, "[process debug info]\n");
GLOBAL_STR(str200, "\n");
GLOBAL_STR(str201, "[pipeline debug info]\n");
GLOBAL_STR(str202, "osh: PID %d stopped, but osh didn't start it");
GLOBAL_STR(str203, "");
GLOBAL_STR(str204, "");
GLOBAL_STR(str205, "[PID %d] Stopped");
GLOBAL_STR(str206, "");
GLOBAL_STR(str207, "main");
GLOBAL_STR(str208, "osh usage error: %s");
GLOBAL_STR(str209, "%s-usage");
GLOBAL_STR(str210, "Oil");
GLOBAL_STR(str211, "main");
GLOBAL_STR(str212, "oil");
GLOBAL_STR(str213, "oil:all");
GLOBAL_STR(str214, "--one-pass-parse requires noexec (-n)");
GLOBAL_STR(str215, "completion");
GLOBAL_STR(str216, "history");
GLOBAL_STR(str217, "");
GLOBAL_STR(str218, "OSH_DEBUG_DIR");
GLOBAL_STR(str219, "%d-osh.log");
GLOBAL_STR(str220, "Writing logs to %r");
GLOBAL_STR(str221, "OSH_HIJACK_SHEBANG");
GLOBAL_STR(str222, "");
GLOBAL_STR(str223, "OSH_CRASH_DUMP_DIR");
GLOBAL_STR(str224, "");
GLOBAL_STR(str225, "");
GLOBAL_STR(str226, "osh: Couldn't open %r: %s");
GLOBAL_STR(str227, "/proc/%d/status");
GLOBAL_STR(str228, "--parser-mem-dump can only be used with -n");
GLOBAL_STR(str229, "/proc/%d/status");
GLOBAL_STR(str230, " \t\n\"'><=;|&(:");
GLOBAL_STR(str231, "/");
GLOBAL_STR(str232, "PATH");
GLOBAL_STR(str233, ":");
GLOBAL_STR(str234, "got invalid option %r");
GLOBAL_STR(str235, "got invalid option %r");
GLOBAL_STR(str236, "invalid option %r (try -O or shopt)");
GLOBAL_STR(str237, "SHELLOPTS");
GLOBAL_STR(str238, ":");
GLOBAL_STR(str239, "Syntax options must be set at the top level (outside any function)");
GLOBAL_STR(str240, "Warning: set -o verbose not implemented");
GLOBAL_STR(str241, "SHELLOPTS");
GLOBAL_STR(str242, "%s:%s");
GLOBAL_STR(str243, "SHELLOPTS");
GLOBAL_STR(str244, ":");
GLOBAL_STR(str245, ":");
GLOBAL_STR(str246, "SHELLOPTS");
GLOBAL_STR(str247, "oil:basic");
GLOBAL_STR(str248, "oil:all");
GLOBAL_STR(str249, "strict:all");
GLOBAL_STR(str250, "set %so %s");
GLOBAL_STR(str251, "-");
GLOBAL_STR(str252, "+");
GLOBAL_STR(str253, "oil:basic");
GLOBAL_STR(str254, "oil:all");
GLOBAL_STR(str255, "strict:all");
GLOBAL_STR(str256, "got invalid option %r");
GLOBAL_STR(str257, "shopt -%s %s");
GLOBAL_STR(str258, "s");
GLOBAL_STR(str259, "u");
GLOBAL_STR(str260, "<_ArgFrame %s %d at %x>");
GLOBAL_STR(str261, "Can't determine working directory: %s");
GLOBAL_STR(str262, "IFS");
GLOBAL_STR(str263, "UID");
GLOBAL_STR(str264, "EUID");
GLOBAL_STR(str265, "PPID");
GLOBAL_STR(str266, "HOSTNAME");
GLOBAL_STR(str267, "OSTYPE");
GLOBAL_STR(str268, "OPTIND");
GLOBAL_STR(str269, "1");
GLOBAL_STR(str270, "PS4");
GLOBAL_STR(str271, "${SHX_indent}${SHX_punct}${SHX_pid_str} ");
GLOBAL_STR(str272, "COMP_WORDBREAKS");
GLOBAL_STR(str273, "SHELLOPTS");
GLOBAL_STR(str274, "SHELLOPTS");
GLOBAL_STR(str275, "");
GLOBAL_STR(str276, "SHELLOPTS");
GLOBAL_STR(str277, "PWD");
GLOBAL_STR(str278, "PWD");
GLOBAL_STR(str279, "PWD");
GLOBAL_STR(str280, "PATH");
GLOBAL_STR(str281, "PATH");
GLOBAL_STR(str282, "/bin:/usr/bin");
GLOBAL_STR(str283, "OIL_VERSION");
GLOBAL_STR(str284, "PWD");
GLOBAL_STR(str285, "PS1");
GLOBAL_STR(str286, "PS1");
GLOBAL_STR(str287, "\\s-\\v\\$ ");
GLOBAL_STR(str288, "");
GLOBAL_STR(str289, "<Mem");
GLOBAL_STR(str290, "  -- %d --");
GLOBAL_STR(str291, "  %s %s");
GLOBAL_STR(str292, ">");
GLOBAL_STR(str293, "\n");
GLOBAL_STR(str294, "\n");
GLOBAL_STR(str295, "Warning: span_id undefined in SetCurrentSpanId");
GLOBAL_STR(str296, "setref requires a nameref (:out param)");
GLOBAL_STR(str297, "nameref %r is undefined");
GLOBAL_STR(str298, "nameref %r contains invalid variable name %r");
GLOBAL_STR(str299, "Circular nameref %s");
GLOBAL_STR(str300, " -> ");
GLOBAL_STR(str301, "__");
GLOBAL_STR(str302, "Can't assign to readonly value %r");
GLOBAL_STR(str303, "Only strings can be exported");
GLOBAL_STR(str304, "nameref must be a string");
GLOBAL_STR(str305, "Can't assign to readonly array");
GLOBAL_STR(str306, "Can't assign to items in a string");
GLOBAL_STR(str307, "Value of type %s can't be indexed");
GLOBAL_STR(str308, "Can't assign to readonly associative array");
GLOBAL_STR(str309, "ARGV");
GLOBAL_STR(str310, "_status");
GLOBAL_STR(str311, "_this_dir");
GLOBAL_STR(str312, "PIPESTATUS");
GLOBAL_STR(str313, "_pipeline_status");
GLOBAL_STR(str314, "_process_sub_status");
GLOBAL_STR(str315, "BASH_REMATCH");
GLOBAL_STR(str316, "FUNCNAME");
GLOBAL_STR(str317, "source");
GLOBAL_STR(str318, "BASH_SOURCE");
GLOBAL_STR(str319, "BASH_LINENO");
GLOBAL_STR(str320, "0");
GLOBAL_STR(str321, "LINENO");
GLOBAL_STR(str322, "BASHPID");
GLOBAL_STR(str323, "Can't unset readonly variable %r");
GLOBAL_STR(str324, "%r isn't an array");
GLOBAL_STR(str325, "$%s isn't defined");
GLOBAL_STR(str326, "$%s should be a string");
GLOBAL_STR(str327, "$%s should be a string, got %s");
GLOBAL_STR(str328, "$%s doesn't look like an integer, got %r");
GLOBAL_STR(str329, "EOF");
GLOBAL_STR(str330, "/");
GLOBAL_STR(str331, "~");
GLOBAL_STR(str332, "  ");
GLOBAL_STR(str333, "\n  ");
...
GLOBAL_STR(str338, "~");
GLOBAL_STR(str339, "\n");
GLOBAL_STR(str340, "[ interactive ]");
GLOBAL_STR(str341, "[ headless ]");
GLOBAL_STR(str342, "[ -c flag ]");
GLOBAL_STR(str343, "[ stdin%s ]");
GLOBAL_STR(str344, "[ %s word at ? ]");
GLOBAL_STR(str345, "[ %s word at line %d of %s ]");
GLOBAL_STR(str346, "?");
GLOBAL_STR(str347, "?");
GLOBAL_STR(str348, "line %d of %s");
GLOBAL_STR(str349, "[ var %s at %s ]");
GLOBAL_STR(str350, "[ expansion of alias %r ]");
GLOBAL_STR(str351, "[ %s in %s ]");
GLOBAL_STR(str352, "[??? no location ???] %s%s\n");
GLOBAL_STR(str353, "%s:%d: %s%s\n");
GLOBAL_STR(str354, "");
GLOBAL_STR(str355, "");
GLOBAL_STR(str356, "");
GLOBAL_STR(str357, "errexit PID %d: ");
GLOBAL_STR(str358, "none");
GLOBAL_STR(str359, "AST not printed.");
GLOBAL_STR(str360, "text");
GLOBAL_STR(str361, "abbrev-text");
GLOBAL_STR(str362, "html");
GLOBAL_STR(str363, "abbrev-html");
GLOBAL_STR(str364, "abbrev-");
GLOBAL_STR(str365, "\n");
GLOBAL_STR(str366, "\n");
GLOBAL_STR(str367, "-");
GLOBAL_STR(str368, "_");
GLOBAL_STR(str369, "<_Attributes %s>");
GLOBAL_STR(str370, "<args.Reader %r %d>");
GLOBAL_STR(str371, "expected argument to %r");
GLOBAL_STR(str372, "-");
GLOBAL_STR(str373, "expected integer after %s, got %r");
GLOBAL_STR(str374, "-");
GLOBAL_STR(str375, "got invalid integer for %s: %s");
GLOBAL_STR(str376, "-");
GLOBAL_STR(str377, "expected number after %r, got %r");
GLOBAL_STR(str378, "-");
GLOBAL_STR(str379, "got invalid float for %s: %s");
GLOBAL_STR(str380, "-");
GLOBAL_STR(str381, "got invalid argument %r to %r, expected one of: %s");
GLOBAL_STR(str382, "-");
GLOBAL_STR(str383, "|");
GLOBAL_STR(str384, "0");
GLOBAL_STR(str385, "F");
GLOBAL_STR(str386, "false");
GLOBAL_STR(str387, "False");
GLOBAL_STR(str388, "1");
GLOBAL_STR(str389, "T");
GLOBAL_STR(str390, "true");
GLOBAL_STR(str391, "Talse");
GLOBAL_STR(str392, "got invalid argument to boolean flag: %r");
GLOBAL_STR(str393, "-");
GLOBAL_STR(str394, "-");
GLOBAL_STR(str395, "Invalid option %r");
GLOBAL_STR(str396, "Expected argument for action");
GLOBAL_STR(str397, "Invalid action name %r");
GLOBAL_STR(str398, "--");
GLOBAL_STR(str399, "--");
GLOBAL_STR(str400, "=");
...
GLOBAL_STR(str404, "Z");
GLOBAL_STR(str405, "-");
GLOBAL_STR(str406, "doesn't accept flag %s");
GLOBAL_STR(str407, "-");
GLOBAL_STR(str408, "+");
GLOBAL_STR(str409, "+");
GLOBAL_STR(str410, "doesn't accept option %s");
GLOBAL_STR(str411, "+");
GLOBAL_STR(str412, "-");
GLOBAL_STR(str413, "--");
GLOBAL_STR(str414, "--");
GLOBAL_STR(str415, "got invalid flag %r");
GLOBAL_STR(str416, "-");
GLOBAL_STR(str417, "+");
GLOBAL_STR(str418, "got invalid flag %r");
GLOBAL_STR(str419, "-");
GLOBAL_STR(str420, "<LineLexer at pos %d of line %r (id = %d)>");
GLOBAL_STR(str421, "");
GLOBAL_STR(str422, "");
GLOBAL_STR(str423, "");
GLOBAL_STR(str424, "");
GLOBAL_STR(str425, "<Trail %s %s %s %s>");
GLOBAL_STR(str426, "");
GLOBAL_STR(str427, "Here docs aren't allowed in expressions");
GLOBAL_STR(str428, "\n");
GLOBAL_STR(str429, "Expected an expression");
GLOBAL_STR(str430, "Expected an expression");
GLOBAL_STR(str431, "Too many typed args (expected one expression)");
GLOBAL_STR(str432, "Expected block argument");
GLOBAL_STR(str433, "Too many typed args (expected one block)");
GLOBAL_STR(str434, "Use === to be exact, or ~== to convert types");
GLOBAL_STR(str435, "");
GLOBAL_STR(str436, " (%s)");
GLOBAL_STR(str437, "Unexpected token in expression mode%s");
GLOBAL_STR(str438, "Syntax error in expression (near %s)");
GLOBAL_STR(str439, "alnum");
GLOBAL_STR(str440, "cntrl");
GLOBAL_STR(str441, "lower");
GLOBAL_STR(str442, "space");
GLOBAL_STR(str443, "alpha");
GLOBAL_STR(str444, "digit");
GLOBAL_STR(str445, "print");
GLOBAL_STR(str446, "upper");
GLOBAL_STR(str447, "blank");
GLOBAL_STR(str448, "graph");
GLOBAL_STR(str449, "punct");
GLOBAL_STR(str450, "xdigit");
GLOBAL_STR(str451, "Range start/end shouldn't have more than one character");
GLOBAL_STR(str452, "Write singleton tuples with tup(), not a trailing comma");
GLOBAL_STR(str453, "testlist_comp");
GLOBAL_STR(str454, "obj.field isn't valid, but obj.method() is");
GLOBAL_STR(str455, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str456, "Can't assign to this expression");
GLOBAL_STR(str457, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str458, "Expr");
GLOBAL_STR(str459, "Block");
GLOBAL_STR(str460, "proc param types should be Expr or Block");
GLOBAL_STR(str461, "TODO");
GLOBAL_STR(str462, "dot");
GLOBAL_STR(str463, "Can't negate this symbol");
GLOBAL_STR(str464, "%r isn't a character class");
GLOBAL_STR(str465, "Can't negate this symbol");
GLOBAL_STR(str466, "%r isn't a character class");
GLOBAL_STR(str467, "%start");
GLOBAL_STR(str468, "%end");
GLOBAL_STR(str469, "dot");
GLOBAL_STR(str470, "Unexpected token %r in regex");
GLOBAL_STR(str471, "%s-%s");
GLOBAL_STR(str472, "ERE can't express code point %d");
GLOBAL_STR(str473, "Perl classes can't be negated in ERE");
GLOBAL_STR(str474, "%s");
GLOBAL_STR(str475, "POSIX classes can't be negated in ERE");
GLOBAL_STR(str476, "[:%s:]");
GLOBAL_STR(str477, ".");
GLOBAL_STR(str478, "^");
GLOBAL_STR(str479, "$");
GLOBAL_STR(str480, "|");
GLOBAL_STR(str481, "POSIX EREs don't have groups without capture, so this node needs () around it.");
GLOBAL_STR(str482, "+");
GLOBAL_STR(str483, "*");
GLOBAL_STR(str484, "?");
GLOBAL_STR(str485, "{%s}");
...
GLOBAL_STR(str496, "^");
GLOBAL_STR(str497, "]");
GLOBAL_STR(str498, "The [ operator doesn't apply to this expression");
GLOBAL_STR(str499, "Expected ]]");
GLOBAL_STR(str500, "Unexpected trailing word %s");
GLOBAL_STR(str501, "Invalid argument to unary operator");
GLOBAL_STR(str502, "Expected ), got %s");
GLOBAL_STR(str503, "Unexpected token in boolean expression (%s)");
GLOBAL_STR(str504, "");
GLOBAL_STR(str505, "Expected %d, got %d");
GLOBAL_STR(str506, "Step can't be 0");
GLOBAL_STR(str507, "Invalid step %d for ascending integer range");
GLOBAL_STR(str508, "Invalid step %d for descending integer range");
GLOBAL_STR(str509, "Invalid step %d for ascending character range");
GLOBAL_STR(str510, "Invalid step %d for descending character range");
GLOBAL_STR(str511, "Mismatched cases in character range");
GLOBAL_STR(str512, "");
GLOBAL_STR(str513, "0");
GLOBAL_STR(str514, "0");
GLOBAL_STR(str515, "g");
...
GLOBAL_STR(str552, ")");
GLOBAL_STR(str553, "");
GLOBAL_STR(str554, "export_");
GLOBAL_STR(str555, "doesn't accept -f because it's dangerous.  (The code can usually be restructured with 'source')");
GLOBAL_STR(str556, "doesn't accept RHS with -n");
GLOBAL_STR(str557, "Got -a but RHS isn't an array");
GLOBAL_STR(str558, "Got -A but RHS isn't an associative array");
GLOBAL_STR(str559, "readonly");
GLOBAL_STR(str560, "new_var");
GLOBAL_STR(str561, "with -f expects function names");
GLOBAL_STR(str562, "declare -f %s");
GLOBAL_STR(str563, "-");
GLOBAL_STR(str564, "-");
GLOBAL_STR(str565, "-");
GLOBAL_STR(str566, "+");
GLOBAL_STR(str567, "+");
GLOBAL_STR(str568, "+");
GLOBAL_STR(str569, "unset");
GLOBAL_STR(str570, "Invalid shift argument %r");
GLOBAL_STR(str571, "got too many arguments");
GLOBAL_STR(str572, "eval");
GLOBAL_STR(str573, "requires code string");
GLOBAL_STR(str574, "requires exactly 1 argument");
GLOBAL_STR(str575, " ");
GLOBAL_STR(str576, "eval");
GLOBAL_STR(str577, "eval");
GLOBAL_STR(str578, "source");
GLOBAL_STR(str579, "missing required argument");
GLOBAL_STR(str580, "source %r failed: %s");
GLOBAL_STR(str581, "source");
GLOBAL_STR(str582, "command");
GLOBAL_STR(str583, "Can't run assignment builtin recursively");
GLOBAL_STR(str584, "%r isn't a shell builtin");
GLOBAL_STR(str585, "runproc");
GLOBAL_STR(str586, "requires arguments");
GLOBAL_STR(str587, "runproc: no proc named %r");
GLOBAL_STR(str588, "try_");
GLOBAL_STR(str589, "'try' expected a command to run");
GLOBAL_STR(str590, "(original failure)");
GLOBAL_STR(str591, "");
GLOBAL_STR(str592, "status %d when --allow-status-01");
GLOBAL_STR(str593, ":");
GLOBAL_STR(str594, "function");
GLOBAL_STR(str595, "alias");
GLOBAL_STR(str596, "builtin");
GLOBAL_STR(str597, "builtin");
GLOBAL_STR(str598, "builtin");
GLOBAL_STR(str599, "keyword");
GLOBAL_STR(str600, "keyword");
GLOBAL_STR(str601, "file");
GLOBAL_STR(str602, "type");
GLOBAL_STR(str603, "type: %r not found");
GLOBAL_STR(str604, "file");
GLOBAL_STR(str605, "file");
GLOBAL_STR(str606, "%s is a %s");
GLOBAL_STR(str607, "function");
GLOBAL_STR(str608, "");
GLOBAL_STR(str609, "");
GLOBAL_STR(str610, "\r\n");
GLOBAL_STR(str611, "\n");
...
GLOBAL_STR(str613, "");
GLOBAL_STR(str614, "");
GLOBAL_STR(str615, "read error: %s");
GLOBAL_STR(str616, "read");
GLOBAL_STR(str617, "_line");
GLOBAL_STR(str618, ":");
GLOBAL_STR(str619, "got extra argument");
GLOBAL_STR(str620, "--qsn can only be used with --line");
GLOBAL_STR(str621, "_all");
GLOBAL_STR(str622, ":");
GLOBAL_STR(str623, "got extra argument");
GLOBAL_STR(str624, "--qsn not implemented yet");
GLOBAL_STR(str625, "read -t isn't implemented (except t=0)");
GLOBAL_STR(str626, "REPLY");
GLOBAL_STR(str627, "REPLY");
GLOBAL_STR(str628, "");
GLOBAL_STR(str629, ":");
GLOBAL_STR(str630, "mapfile");
GLOBAL_STR(str631, "MAPFILE");
GLOBAL_STR(str632, ":");
GLOBAL_STR(str633, "mapfile: read() error: %s");
GLOBAL_STR(str634, "\n");
GLOBAL_STR(str635, "cd");
GLOBAL_STR(str636, "HOME");
GLOBAL_STR(str637, "HOME");
GLOBAL_STR(str638, "-");
GLOBAL_STR(str639, "OLDPWD");
GLOBAL_STR(str640, "PWD");
GLOBAL_STR(str641, "cd %r: %s");
GLOBAL_STR(str642, "PWD");
GLOBAL_STR(str643, "OLDPWD");
GLOBAL_STR(str644, "%2d  %s");
GLOBAL_STR(str645, " ");
GLOBAL_STR(str646, "pushd: no other directory");
GLOBAL_STR(str647, "got too many arguments");
GLOBAL_STR(str648, "pushd: %r: %s");
GLOBAL_STR(str649, "HOME");
GLOBAL_STR(str650, "PWD");
GLOBAL_STR(str651, "popd: directory stack is empty");
GLOBAL_STR(str652, "popd: %r: %s");
GLOBAL_STR(str653, "PWD");
GLOBAL_STR(str654, "got extra argument");
GLOBAL_STR(str655, "HOME");
GLOBAL_STR(str656, "dirs");
GLOBAL_STR(str657, "HOME");
GLOBAL_STR(str658, "pwd");
GLOBAL_STR(str659, "_devbuild/help/groups.txt");
GLOBAL_STR(str660, "help");
GLOBAL_STR(str661, "help");
GLOBAL_STR(str662, "_devbuild/help/%s");
GLOBAL_STR(str663, "no help topics match %r");
GLOBAL_STR(str664, "osh I/O error: %s");
GLOBAL_STR(str665, "# +");
GLOBAL_STR(str666, "osh printf doesn't support the %r flag");
GLOBAL_STR(str667, "eEfFgG");
GLOBAL_STR(str668, "osh printf doesn't support floating point");
GLOBAL_STR(str669, "c");
GLOBAL_STR(str670, "osh printf doesn't support single characters (bytes)");
GLOBAL_STR(str671, "Invalid printf format character");
GLOBAL_STR(str672, "Expected a printf format character");
GLOBAL_STR(str673, "%");
GLOBAL_STR(str674, "");
GLOBAL_STR(str675, "printf got invalid width %r");
GLOBAL_STR(str676, "0");
GLOBAL_STR(str677, "");
GLOBAL_STR(str678, "printf got invalid precision %r");
GLOBAL_STR(str679, "");
GLOBAL_STR(str680, "s");
GLOBAL_STR(str681, "q");
GLOBAL_STR(str682, "b");
GLOBAL_STR(str683, "");
GLOBAL_STR(str684, "diouxX");
GLOBAL_STR(str685, "'\"");
GLOBAL_STR(str686, "printf expected an integer, got %r");
GLOBAL_STR(str687, "TZ");
GLOBAL_STR(str688, "TZ");
GLOBAL_STR(str689, "ouxX");
GLOBAL_STR(str690, "Can't format negative number %d with %%%s");
GLOBAL_STR(str691, "o");
GLOBAL_STR(str692, "x");
GLOBAL_STR(str693, "X");
GLOBAL_STR(str694, "0");
...
GLOBAL_STR(str700, " ");
GLOBAL_STR(str701, " ");
GLOBAL_STR(str702, "printf");
GLOBAL_STR(str703, "requires a format string");
GLOBAL_STR(str704, "printf");
GLOBAL_STR(str705, "");
GLOBAL_STR(str706, "alias");
GLOBAL_STR(str707, "alias %s=%r");
GLOBAL_STR(str708, "=");
GLOBAL_STR(str709, "No alias named %r");
GLOBAL_STR(str710, "alias %s=%r");
GLOBAL_STR(str711, "unalias");
GLOBAL_STR(str712, "requires an argument");
GLOBAL_STR(str713, "No alias named %r");
GLOBAL_STR(str714, "%s=%s");
GLOBAL_STR(str715, "set");
GLOBAL_STR(str716, "shopt");
GLOBAL_STR(str717, "got invalid option %r");
GLOBAL_STR(str718, "hash");
GLOBAL_STR(str719, "got extra arguments after -r");
GLOBAL_STR(str720, "hash: %r not found");
GLOBAL_STR(str721, ":");
GLOBAL_STR(str722, "OPTIND");
GLOBAL_STR(str723, "OPTIND");
GLOBAL_STR(str724, "OPTARG");
GLOBAL_STR(str725, "OPTARG");
GLOBAL_STR(str726, "");
GLOBAL_STR(str727, "?");
GLOBAL_STR(str728, "-");
GLOBAL_STR(str729, "-");
GLOBAL_STR(str730, "?");
GLOBAL_STR(str731, "?");
GLOBAL_STR(str732, "getopts: option %r requires an argument.");
GLOBAL_STR(str733, "(getopts argv: %s)");
GLOBAL_STR(str734, " ");
GLOBAL_STR(str735, "?");
GLOBAL_STR(str736, "");
GLOBAL_STR(str737, "requires an argspec");
GLOBAL_STR(str738, "requires the name of a variable to set");
GLOBAL_STR(str739, "got invalid variable name %r");
GLOBAL_STR(str740, "echo");
GLOBAL_STR(str741, "");
GLOBAL_STR(str742, "takes at most one arg when simple_echo is on (hint: add quotes)");
GLOBAL_STR(str743, " ");
GLOBAL_STR(str744, "\n");
GLOBAL_STR(str745, "module");
GLOBAL_STR(str746, "requires a name");
GLOBAL_STR(str747, "(interactive) Reloading module %r");
GLOBAL_STR(str748, "expected 'bin' or 'dialect'");
GLOBAL_STR(str749, "dialect");
GLOBAL_STR(str750, "expected dialect name");
GLOBAL_STR(str751, "_DIALECT");
GLOBAL_STR(str752, "Expected dialect %r, got %r");
GLOBAL_STR(str753, "Expected dialect %r");
GLOBAL_STR(str754, "bin");
GLOBAL_STR(str755, "bin %s");
GLOBAL_STR(str756, "expected 'bin' or 'dialect'");
GLOBAL_STR(str757, "shvar");
GLOBAL_STR(str758, "expected a block");
GLOBAL_STR(str759, "Expected name=value");
GLOBAL_STR(str760, "=");
GLOBAL_STR(str761, "Expected name=value");
GLOBAL_STR(str762, "expected a block");
GLOBAL_STR(str763, "Can't append array to string");
GLOBAL_STR(str764, "Can't append string to array");
GLOBAL_STR(str765, "Assignment builtin %r not configured");
GLOBAL_STR(str766, "%r ");
GLOBAL_STR(str767, "");
GLOBAL_STR(str768, "Command");
GLOBAL_STR(str769, "Assignment");
GLOBAL_STR(str770, "Subshell");
GLOBAL_STR(str771, "Pipeline");
GLOBAL_STR(str772, "%s failed with status %d");
GLOBAL_STR(str773, "Redirect filename can't be empty");
GLOBAL_STR(str774, "Redirect descriptor can't be empty");
GLOBAL_STR(str775, "-");
GLOBAL_STR(str776, "-");
GLOBAL_STR(str777, "Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
GLOBAL_STR(str778, "\n");
GLOBAL_STR(str779, "Unknown redirect op");
GLOBAL_STR(str780, "Unknown redirect type");
GLOBAL_STR(str781, "strict_errexit only allows simple commands (got %s). Hint: use 'try'.");
GLOBAL_STR(str782, "strict_errexit only allows a single command.  Hint: use 'try'.");
GLOBAL_STR(str783, "strict_errexit only allows simple commands (got %s). Hint: use 'try'.");
GLOBAL_STR(str784, "ShAssignment builtins don't accept blocks");
GLOBAL_STR(str785, "|& isn't supported");
GLOBAL_STR(str786, "%r expected a number, got %r");
GLOBAL_STR(str787, "Invalid control flow at top level");
GLOBAL_STR(str788, "warning: ");
GLOBAL_STR(str789, "Function %s was already defined (redefine_proc)");
GLOBAL_STR(str790, "Proc %s was already defined (redefine_proc)");
GLOBAL_STR(str791, "trap");
GLOBAL_STR(str792, "failglob: ");
GLOBAL_STR(str793, "Loop and control flow can't be in different processes");
GLOBAL_STR(str794, "fatal: ");
GLOBAL_STR(str795, "EXIT");
GLOBAL_STR(str796, "trap EXIT");
GLOBAL_STR(str797, "__");
GLOBAL_STR(str798, ":");
GLOBAL_STR(str799, "Invalid argument %r.  Expected a name starting with :");
GLOBAL_STR(str800, "No value provided for param %r");
GLOBAL_STR(str801, "proc %r expected %d arguments, but got %d");
GLOBAL_STR(str802, "Unexpected %r (in function call)");
GLOBAL_STR(str803, "Attempted to exit from completion hook.");
GLOBAL_STR(str804, "Couldn't find terminator for here doc that starts here");
GLOBAL_STR(str805, "\t");
GLOBAL_STR(str806, "Invalid here doc delimiter");
GLOBAL_STR(str807, "+");
GLOBAL_STR(str808, "+");
GLOBAL_STR(str809, "+");
GLOBAL_STR(str810, "%d != %d");
GLOBAL_STR(str811, "array place");
GLOBAL_STR(str812, "Environment binding shouldn't look like an array assignment");
GLOBAL_STR(str813, "+");
GLOBAL_STR(str814, "Expected = in environment binding, got +=");
GLOBAL_STR(str815, "Environment bindings can't contain array literals");
GLOBAL_STR(str816, "procs and shell functions can't be nested");
GLOBAL_STR(str817, "%r was already declared");
GLOBAL_STR(str818, "%r hasn't been declared");
GLOBAL_STR(str819, "Can't modify constant %r");
GLOBAL_STR(str820, "Expected word type %s, got %s");
GLOBAL_STR(str821, "{");
GLOBAL_STR(str822, "}");
GLOBAL_STR(str823, "Invalid token after redirect operator");
GLOBAL_STR(str824, "Space required before (");
GLOBAL_STR(str825, "Unexpected left paren (might need a space before it)");
GLOBAL_STR(str826, "Empty arg list not allowed");
GLOBAL_STR(str827, "TODO: Parse Redirect");
GLOBAL_STR(str828, " ");
GLOBAL_STR(str829, " ");
GLOBAL_STR(str830, "line IDs %d != %d");
GLOBAL_STR(str831, " ");
GLOBAL_STR(str832, "");
GLOBAL_STR(str833, "Unexpected typed args");
GLOBAL_STR(str834, "=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
GLOBAL_STR(str835, "name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
GLOBAL_STR(str836, "Unexpected typed args");
GLOBAL_STR(str837, "Unexpected typed args");
GLOBAL_STR(str838, "Control flow shouldn't have redirects");
GLOBAL_STR(str839, "Control flow shouldn't have environment bindings");
GLOBAL_STR(str840, "Unexpected argument to %r");
GLOBAL_STR(str841, "Invalid word in for loop");
GLOBAL_STR(str842, "Invalid word after for expression");
GLOBAL_STR(str843, "Loop variable name should be a constant");
GLOBAL_STR(str844, "Invalid loop variable name");
GLOBAL_STR(str845, "Unexpected word after for loop variable");
GLOBAL_STR(str846, "Expected ;; or esac");
GLOBAL_STR(str847, "Unexpected word while parsing compound command");
GLOBAL_STR(str848, "Invalid function name");
GLOBAL_STR(str849, "Expected ) in function definition");
GLOBAL_STR(str850, "Invalid KSH-style function name");
GLOBAL_STR(str851, "Unexpected word when parsing command");
GLOBAL_STR(str852, "Unexpected right brace");
GLOBAL_STR(str853, "Unexpected EOF while parsing command");
GLOBAL_STR(str854, "Invalid word while parsing command");
GLOBAL_STR(str855, "Invalid word while parsing command line");
GLOBAL_STR(str856, "Invalid word while parsing command list");
GLOBAL_STR(str857, "Unterminated here doc began here");
GLOBAL_STR(str858, "\\");
GLOBAL_STR(str859, "*");
GLOBAL_STR(str860, "?");
GLOBAL_STR(str861, "[");
...
GLOBAL_STR(str865, "\\?*+{}^$.()|");
GLOBAL_STR(str866, "\\");
GLOBAL_STR(str867, "Unexpected escaped character %r");
GLOBAL_STR(str868, "");
GLOBAL_STR(str869, "");
GLOBAL_STR(str870, "Malformed character class; treating as literal");
GLOBAL_STR(str871, "Got unescaped right bracket");
GLOBAL_STR(str872, "Got unescaped trailing backslash");
GLOBAL_STR(str873, ".|^$()+*?[]{}\\");
GLOBAL_STR(str874, "\\");
GLOBAL_STR(str875, "\\");
GLOBAL_STR(str876, "\\[");
...
GLOBAL_STR(str888, "]");
GLOBAL_STR(str889, "");
GLOBAL_STR(str890, "Error expanding glob %r: %s");
GLOBAL_STR(str891, "-");
GLOBAL_STR(str892, "<Error: unbalanced \\[ and \\]> ");
GLOBAL_STR(str893, "$");
GLOBAL_STR(str894, "#");
GLOBAL_STR(str895, "$");
GLOBAL_STR(str896, "hostname");
GLOBAL_STR(str897, "user");
GLOBAL_STR(str898, "\u0001");
GLOBAL_STR(str899, "\u0002");
GLOBAL_STR(str900, "$");
GLOBAL_STR(str901, "$");
GLOBAL_STR(str902, "u");
GLOBAL_STR(str903, "user");
GLOBAL_STR(str904, "h");
GLOBAL_STR(str905, "hostname");
GLOBAL_STR(str906, ".");
GLOBAL_STR(str907, "H");
GLOBAL_STR(str908, "hostname");
GLOBAL_STR(str909, "s");
GLOBAL_STR(str910, "v");
GLOBAL_STR(str911, "A");
GLOBAL_STR(str912, "%H:%M");
GLOBAL_STR(str913, "D");
GLOBAL_STR(str914, "%X");
GLOBAL_STR(str915, "w");
GLOBAL_STR(str916, "PWD");
GLOBAL_STR(str917, "HOME");
GLOBAL_STR(str918, "<Error: %s>");
GLOBAL_STR(str919, "W");
GLOBAL_STR(str920, "PWD");
GLOBAL_STR(str921, "<Error: PWD is not a string> ");
GLOBAL_STR(str922, "<Error: \\%s not implemented in $PS1> ");
GLOBAL_STR(str923, "$");
GLOBAL_STR(str924, "\\$");
GLOBAL_STR(str925, "Invalid token %r");
GLOBAL_STR(str926, "");
GLOBAL_STR(str927, "");
GLOBAL_STR(str928, "<ERROR: Can't parse PS1: %s>");
GLOBAL_STR(str929, "osh");
GLOBAL_STR(str930, "PS1");
GLOBAL_STR(str931, "$ ");
GLOBAL_STR(str932, "PROMPT_COMMAND");
GLOBAL_STR(str933, "Undefined variable %r");
GLOBAL_STR(str934, "Can't use [] on value of type %s");
GLOBAL_STR(str935, "");
GLOBAL_STR(str936, "Can't use [] on value of type %s");
GLOBAL_STR(str937, "");
GLOBAL_STR(str938, "dynamic place");
GLOBAL_STR(str939, "got invalid place expression");
GLOBAL_STR(str940, "expected a var name.  shopt -s eval_unsafe_arith allows a[i]");
GLOBAL_STR(str941, "Invalid var ref");
GLOBAL_STR(str942, "0x");
GLOBAL_STR(str943, "Invalid hex constant %r");
GLOBAL_STR(str944, "0");
GLOBAL_STR(str945, "Invalid octal constant %r");
GLOBAL_STR(str946, "#");
GLOBAL_STR(str947, "#");
GLOBAL_STR(str948, "Invalid base for numeric constant %r");
GLOBAL_STR(str949, "a");
GLOBAL_STR(str950, "A");
GLOBAL_STR(str951, "@");
GLOBAL_STR(str952, "_");
GLOBAL_STR(str953, "Invalid digits for numeric constant %r");
GLOBAL_STR(str954, "Digits %r out of range for base %d");
GLOBAL_STR(str955, "Parse error in recursive arithmetic");
GLOBAL_STR(str956, "Invalid integer constant %r");
GLOBAL_STR(str957, "Invalid integer constant %r");
GLOBAL_STR(str958, "Invalid integer constant %r");
GLOBAL_STR(str959, "Undefined value in arithmetic context");
GLOBAL_STR(str960, "Expected a value convertible to integer, got %s");
GLOBAL_STR(str961, "0");
GLOBAL_STR(str962, "Undefined variable %r");
GLOBAL_STR(str963, "Divide by zero");
GLOBAL_STR(str964, "Divide by zero");
GLOBAL_STR(str965, "Expected array or assoc in index expression, got %s");
GLOBAL_STR(str966, "Divide by zero");
GLOBAL_STR(str967, "Divide by zero");
GLOBAL_STR(str968, "Exponent can't be less than zero");
GLOBAL_STR(str969, "Associative array keys must be strings: $x 'x' \"$x\" etc.");
GLOBAL_STR(str970, "Invalid place to modify");
GLOBAL_STR(str971, "%s isn't implemented");
GLOBAL_STR(str972, "Invalid regex %r: %s");
GLOBAL_STR(str973, " \t\n");
GLOBAL_STR(str974, "IFS");
GLOBAL_STR(str975, "IFS shouldn't be an array");
GLOBAL_STR(str976, " \t\n");
GLOBAL_STR(str977, "IFS");
GLOBAL_STR(str978, " ");
GLOBAL_STR(str979, "");
GLOBAL_STR(str980, "IFS shouldn't be an array");
GLOBAL_STR(str981, "\\");
GLOBAL_STR(str982, "\\");
GLOBAL_STR(str983, "Invalid transition from %r with %r");
GLOBAL_STR(str984, "\u00ef\u00bf\u00bd");
GLOBAL_STR(str985, "");
GLOBAL_STR(str986, "Incomplete UTF-8 character");
GLOBAL_STR(str987, "Invalid UTF-8 continuation byte");
GLOBAL_STR(str988, "Invalid start of UTF-8 character");
GLOBAL_STR(str989, "");
GLOBAL_STR(str990, "%s can't have an argument");
GLOBAL_STR(str991, "");
GLOBAL_STR(str992, "%s can't have an argument");
GLOBAL_STR(str993, "");
GLOBAL_STR(str994, "%s can't have an argument");
GLOBAL_STR(str995, "");
GLOBAL_STR(str996, "%s can't have an argument");
GLOBAL_STR(str997, "");
GLOBAL_STR(str998, "<_GlobReplacer regex %r r %r>");
GLOBAL_STR(str999, "(%s)");
GLOBAL_STR(str1000, "Error matching regex %r: %s");
GLOBAL_STR(str1001, "^");
GLOBAL_STR(str1002, "$");
GLOBAL_STR(str1003, "\r");
GLOBAL_STR(str1004, "<INVALID CR>");
GLOBAL_STR(str1005, "\n");
GLOBAL_STR(str1006, "<INVALID NEWLINE>");
GLOBAL_STR(str1007, " `~!$&*()[]{}\\|;'\"<>?");
GLOBAL_STR(str1008, "Left-hand side of this assignment is invalid");
GLOBAL_STR(str1009, "Token can't be used in prefix position");
GLOBAL_STR(str1010, "Token can't be used in infix position");
GLOBAL_STR(str1011, "Parser expected %s, got %s");
GLOBAL_STR(str1012, "Unexpected end of input");
GLOBAL_STR(str1013, "");
GLOBAL_STR(str1014, "");
GLOBAL_STR(str1015, " \t");
GLOBAL_STR(str1016, "\n");
...
GLOBAL_STR(str1018, "\n");
GLOBAL_STR(str1019, "\n");
GLOBAL_STR(str1020, "BASH_SOURCE");
GLOBAL_STR(str1021, "FUNCNAME");
GLOBAL_STR(str1022, "BASH_LINENO");
GLOBAL_STR(str1023, "0");
GLOBAL_STR(str1024, "0");
GLOBAL_STR(str1025, "^([a-zA-Z_][a-zA-Z0-9_]*)((=|\\+=)(.*))?$");
GLOBAL_STR(str1026, "Assignment builtin expected NAME=value, got %r");
GLOBAL_STR(str1027, "+");
GLOBAL_STR(str1028, "\\");
GLOBAL_STR(str1029, "\\\\");
GLOBAL_STR(str1030, "");
GLOBAL_STR(str1031, "");
GLOBAL_STR(str1032, "The length index of a array slice can't be negative: %d");
GLOBAL_STR(str1033, "Can't slice associative arrays");
GLOBAL_STR(str1034, "i");
GLOBAL_STR(str1035, "e");
GLOBAL_STR(str1036, "f");
GLOBAL_STR(str1037, "n");
GLOBAL_STR(str1038, "u");
GLOBAL_STR(str1039, "x");
GLOBAL_STR(str1040, "C");
GLOBAL_STR(str1041, "");
GLOBAL_STR(str1042, "~");
GLOBAL_STR(str1043, "HOME");
GLOBAL_STR(str1044, "Error expanding tilde (e.g. invalid user)");
GLOBAL_STR(str1045, "Can't assign to special variable");
GLOBAL_STR(str1046, "unset variable %r");
GLOBAL_STR(str1047, "warning: ");
GLOBAL_STR(str1048, "-1");
GLOBAL_STR(str1049, "a[i] not allowed without shopt -s eval_unsafe_arith");
GLOBAL_STR(str1050, "Indirect expansion of array");
GLOBAL_STR(str1051, "Indirect expansion of assoc array");
GLOBAL_STR(str1052, "extended globs not supported in ${x//GLOB/}");
GLOBAL_STR(str1053, "");
GLOBAL_STR(str1054, "warning: ");
GLOBAL_STR(str1055, "");
GLOBAL_STR(str1056, "\u0001");
GLOBAL_STR(str1057, "");
GLOBAL_STR(str1058, "\u0002");
GLOBAL_STR(str1059, "");
GLOBAL_STR(str1060, "Can't use @P on %s");
GLOBAL_STR(str1061, " ");
GLOBAL_STR(str1062, "Can't use @Q on %s");
GLOBAL_STR(str1063, "a");
GLOBAL_STR(str1064, "A");
GLOBAL_STR(str1065, "r");
GLOBAL_STR(str1066, "x");
GLOBAL_STR(str1067, "n");
GLOBAL_STR(str1068, "");
GLOBAL_STR(str1069, "Var op %r not implemented");
GLOBAL_STR(str1070, "Can't index string with @");
GLOBAL_STR(str1071, "Can't index string with *");
GLOBAL_STR(str1072, "Can't index string %r with integer");
GLOBAL_STR(str1073, "");
GLOBAL_STR(str1074, "");
GLOBAL_STR(str1075, "$");
GLOBAL_STR(str1076, "Undefined variable %r");
GLOBAL_STR(str1077, "Undefined array %r");
GLOBAL_STR(str1078, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str1079, "Test operation not allowed with ${!array[@]}");
GLOBAL_STR(str1080, "Not implemented");
GLOBAL_STR(str1081, "Illegal array word part (strict_array)");
GLOBAL_STR(str1082, " ");
GLOBAL_STR(str1083, "");
GLOBAL_STR(str1084, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str1085, "@(");
GLOBAL_STR(str1086, "|");
GLOBAL_STR(str1087, ")");
GLOBAL_STR(str1088, "Extended globs and arrays can't appear in the same word");
GLOBAL_STR(str1089, "*");
GLOBAL_STR(str1090, "Unexpected array literal");
GLOBAL_STR(str1091, "Unexpected associative array literal");
GLOBAL_STR(str1092, "Can't splice %r");
GLOBAL_STR(str1093, "");
GLOBAL_STR(str1094, "");
GLOBAL_STR(str1095, "Extended glob %r matched no files");
GLOBAL_STR(str1096, "Extended glob not allowed in this word");
GLOBAL_STR(str1097, "");
GLOBAL_STR(str1098, "This word should yield a string, but it contains an array");
GLOBAL_STR(str1099, " ");
GLOBAL_STR(str1100, "extended glob not allowed in this word");
GLOBAL_STR(str1101, "");
GLOBAL_STR(str1102, "");
GLOBAL_STR(str1103, "");
GLOBAL_STR(str1104, "");
GLOBAL_STR(str1105, "<Runtime error: %s>");
GLOBAL_STR(str1106, "<I/O error: %s>");
GLOBAL_STR(str1107, "<Ctrl-C>");
GLOBAL_STR(str1108, "");
GLOBAL_STR(str1109, "");
GLOBAL_STR(str1110, "");
GLOBAL_STR(str1111, "");
GLOBAL_STR(str1112, "Pattern %r matched no files");
GLOBAL_STR(str1113, "");
GLOBAL_STR(str1114, "LHS array not allowed in assignment builtin");
GLOBAL_STR(str1115, "+");
GLOBAL_STR(str1116, "-");
GLOBAL_STR(str1117, "+");
GLOBAL_STR(str1118, "f");
GLOBAL_STR(str1119, "F");
GLOBAL_STR(str1120, "Pattern %r matched no files");
GLOBAL_STR(str1121, "");
GLOBAL_STR(str1122, "__NO_COMMAND_SUB__");
GLOBAL_STR(str1123, "__NO_PROCESS_SUB__");
GLOBAL_STR(str1124, "Expected : or } in slice");
GLOBAL_STR(str1125, "Pattern in ${x/pat/replace} must not be empty");
GLOBAL_STR(str1126, "Expected } after replacement string, got %s");
GLOBAL_STR(str1127, "Expected } or / to close pattern");
GLOBAL_STR(str1128, "Expected ] to close subscript");
GLOBAL_STR(str1129, "Expected } to close ${");
GLOBAL_STR(str1130, "Expected } to close ${");
GLOBAL_STR(str1131, "Expected a constant argument");
GLOBAL_STR(str1132, "Expected } to close ${");
GLOBAL_STR(str1133, "Expected } to close ${");
GLOBAL_STR(str1134, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1135, "VOp2");
GLOBAL_STR(str1136, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1137, "VOp3");
GLOBAL_STR(str1138, "Expected } to close ${");
GLOBAL_STR(str1139, "Expected } after length expression");
GLOBAL_STR(str1140, "TODO: ${.myproc builtin sub}");
GLOBAL_STR(str1141, "Unexpected token in ${}");
GLOBAL_STR(str1142, "\\");
GLOBAL_STR(str1143, "Strings with backslashes should look like r'\\n' or $'\\n'");
GLOBAL_STR(str1144, "Use \\xhh or \\u{...} instead of octal escapes in Oil strings");
GLOBAL_STR(str1145, "Invalid hex escape in Oil string (must be \\xHH)");
GLOBAL_STR(str1146, "Invalid char escape in C-style string literal");
GLOBAL_STR(str1147, "Unexpected EOF in single-quoted string that began here");
GLOBAL_STR(str1148, "\"");
GLOBAL_STR(str1149, "'");
GLOBAL_STR(str1150, "Unexpected EOF reading extended glob that began here");
GLOBAL_STR(str1151, "Invalid char escape in double quoted string");
GLOBAL_STR(str1152, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1153, "Invalid backtick: use $(cmd) or \\` in Oil strings");
GLOBAL_STR(str1154, "Unexpected EOF reading double-quoted string that began here");
GLOBAL_STR(str1155, "Use $(cmd) instead of backticks (parse_backticks)");
GLOBAL_STR(str1156, "Unexpected EOF while looking for closing backtick");
GLOBAL_STR(str1157, "");
GLOBAL_STR(str1158, "backticks");
GLOBAL_STR(str1159, "Invalid proc name %s");
GLOBAL_STR(str1160, "Unexpected token after arithmetic expression (%s != %s)");
GLOBAL_STR(str1161, "Expected second ) to end arith sub");
GLOBAL_STR(str1162, "Expected second ) to end arith statement");
GLOBAL_STR(str1163, "Expected ; here");
GLOBAL_STR(str1164, "Expected ; here");
GLOBAL_STR(str1165, "Expected ) to end for loop expression");
GLOBAL_STR(str1166, "Expected ( after =");
GLOBAL_STR(str1167, "Unexpected token in array literal");
GLOBAL_STR(str1168, "Expected associative array pair");
GLOBAL_STR(str1169, "Invalid char escape (parse_backslash)");
GLOBAL_STR(str1170, "Unexpected token after array literal");
GLOBAL_STR(str1171, "Unexpected token after array splice");
GLOBAL_STR(str1172, "TODO: @{.myproc builtin sub}");
GLOBAL_STR(str1173, "Literal @ starting a word must be quoted (parse_at_all)");
GLOBAL_STR(str1174, "/");
GLOBAL_STR(str1175, "next_byte %r");
GLOBAL_STR(str1176, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1177, "Unexpected token after @()");
GLOBAL_STR(str1178, "Word has unbalanced { }.  Maybe add a space or quote it like \\{");
GLOBAL_STR(str1179, "Unexpected parts after triple quoted string");
GLOBAL_STR(str1180, "Unexpected token while parsing arithmetic: %r");
GLOBAL_STR(str1181, "Invalid blank line in multiline mode");
GLOBAL_STR(str1182, "r");
GLOBAL_STR(str1183, "Unhandled: %s (%s)");
GLOBAL_STR(str1184, "Invalid var ref");
GLOBAL_STR(str1185, "Expected end of var ref");
GLOBAL_STR(str1186, "Invalid lex state %s");
GLOBAL_STR(str1187, "");
GLOBAL_STR(str1188, "");
GLOBAL_STR(str1189, "");
GLOBAL_STR(str1190, "");
...
GLOBAL_STR(str1194, "");
GLOBAL_STR(str1195, "");
GLOBAL_STR(str1196, "Compound shouldn't be empty");
GLOBAL_STR(str1197, "/");
GLOBAL_STR(str1198, "/");
GLOBAL_STR(str1199, "");
GLOBAL_STR(str1200, "EOF");
GLOBAL_STR(str1201, "typ");
GLOBAL_STR(str1202, "tok");
GLOBAL_STR(str1203, "children");
GLOBAL_STR(str1204, "-");
GLOBAL_STR(str1205, "with %d children");
GLOBAL_STR(str1206, "");
GLOBAL_STR(str1207, "(PNode %s %s %s)");
GLOBAL_STR(str1208, "&");
GLOBAL_STR(str1209, "&amp;");
GLOBAL_STR(str1210, "<");
GLOBAL_STR(str1211, "&lt;");
...
GLOBAL_STR(str1233, "/");
GLOBAL_STR(str1234, " \n\r\t");
GLOBAL_STR(str1235, "Unexpected token in QSN string");
GLOBAL_STR(str1236, "Expected closing single quote in QSN string");
GLOBAL_STR(str1237, "Unexpected data after closing quote");
GLOBAL_STR(str1238, "Unexpected token after QSN string");
GLOBAL_STR(str1239, "\\'\r\n\t\u0000");
GLOBAL_STR(str1240, "$'");
GLOBAL_STR(str1241, "'");
GLOBAL_STR(str1242, "'");
...
GLOBAL_STR(str1254, "\n");
GLOBAL_STR(str1255, "\\n");
GLOBAL_STR(str1256, "\r");
GLOBAL_STR(str1257, "\\r");
GLOBAL_STR(str1258, "\t");
GLOBAL_STR(str1259, "\\t");
GLOBAL_STR(str1260, "\u0000");
GLOBAL_STR(str1261, "\\x00");
GLOBAL_STR(str1262, "\\0");
GLOBAL_STR(str1263, "");
GLOBAL_STR(str1264, "");
GLOBAL_STR(str1265, "");
GLOBAL_STR(str1266, "\\");
...
GLOBAL_STR(str1270, "\n");
GLOBAL_STR(str1271, "\\n");
GLOBAL_STR(str1272, "\r");
GLOBAL_STR(str1273, "\\r");
GLOBAL_STR(str1274, "\t");
GLOBAL_STR(str1275, "\\t");
GLOBAL_STR(str1276, "\u0000");
GLOBAL_STR(str1277, "\\x00");
GLOBAL_STR(str1278, "\\0");
GLOBAL_STR(str1279, "");
GLOBAL_STR(str1280, "!");
GLOBAL_STR(str1281, "--");
GLOBAL_STR(str1282, "--dir");
GLOBAL_STR(str1283, "--exists");
GLOBAL_STR(str1284, "--file");
GLOBAL_STR(str1285, "--symlink");
GLOBAL_STR(str1286, "Expected unary operator, got %r (2 args)");
GLOBAL_STR(str1287, "-a");
GLOBAL_STR(str1288, "-o");
GLOBAL_STR(str1289, "!");
GLOBAL_STR(str1290, "(");
GLOBAL_STR(str1291, ")");
GLOBAL_STR(str1292, "Expected binary operator, got %r (3 args)");
GLOBAL_STR(str1293, "should be invoked as 'test' (simple_test_builtin)");
GLOBAL_STR(str1294, "]");
GLOBAL_STR(str1295, "missing closing ]");
GLOBAL_STR(str1296, "should only have 3 arguments or fewer (simple_test_builtin)");
GLOBAL_STR(str1297, "!");
GLOBAL_STR(str1298, "(");
GLOBAL_STR(str1299, ")");
GLOBAL_STR(str1300, "(test) ");
GLOBAL_STR(str1301, "(test) ");
...
inline Str* fmt35(Str* a0, Str* a1) {
  gBuf.reset();
...
class Job : public gc_heap::Obj {
 public:
  Job();
  virtual void DisplayJob(int job_id, mylib::Writer* f);
...
inline Str* fmt42(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt44(int a0, int a1, Str* a2) {
  gBuf.reset();
...
inline Str* fmt52(Str* a0, int a1, Str* a2) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const(" ", 1);
  gBuf.format_d(a1);
...
inline Str* fmt60(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.write_const("osh: Couldn't open ", 19);
  gBuf.format_r(a0);
  gBuf.write_const(": ", 2);
...
inline Str* fmt69(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt83(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.write_const("$", 1);
  gBuf.format_s(a0);
...
inline Str* fmt84(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.write_const("$", 1);
  gBuf.format_s(a0);
...
inline Str* fmt87(Str* a0, int a1, Str* a2) {
  gBuf.reset();
  gBuf.write_const("[ ", 2);
  gBuf.format_s(a0);
...
inline Str* fmt88(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt92(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt93(Str* a0, int a1, Str* a2, Str* a3) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const(":", 1);
  gBuf.format_d(a1);
...
inline Str* fmt116(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("-", 1);
  gBuf.format_s(a1);
...
inline Str* fmt135(int a0, int a1) {
  gBuf.reset();
...
inline Str* fmt142(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("=", 1);
  gBuf.format_s(a1);
...
inline Str* fmt158(int a0, Str* a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const("  ", 2);
  gBuf.format_s(a1);
...
inline Str* fmt173(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt174(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt176(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.write_const("alias ", 6);
  gBuf.format_s(a0);
  gBuf.write_const("=", 1);
...
inline Str* fmt178(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("=", 1);
  gBuf.format_s(a1);
...
inline Str* fmt185(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt190(Str* a0, int a1) {
  gBuf.reset();
  gBuf.format_s(a0);
...
inline Str* fmt202(Str* a0, int a1, int a2) {
  gBuf.reset();
  gBuf.write_const("proc ", 5);
  gBuf.format_r(a0);
...
inline Str* fmt206(int a0, int a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const(" != ", 4);
  gBuf.format_d(a1);
...
inline Str* fmt214(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt220(int a0, int a1) {
  gBuf.reset();
...
inline Str* fmt246(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt260(Str* a0, int a1) {
  gBuf.reset();
...
inline Str* fmt273(Str* a0, Str* a1, syntax_asdl::word_t* a2) {
  gBuf.reset();
...
inline Str* fmt279(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt347(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt370(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("/", 1);
  gBuf.format_s(a1);
...
int ShellExecutor::RunSimpleCommand(runtime_asdl::cmd_value__Argv* cmd_val, runtime_asdl::CommandStatus* cmd_st, bool do_fork, bool call_procs) {
  ...
  argv = cmd_val->argv;
  arg0_spid = len(cmd_val->arg_spids) ? cmd_val->arg_spids->index(0) : runtime::NO_SPID;
  if (len(argv) == 0) {
  ...
  if (builtin_id != consts::NO_INDEX) {
    this->errfmt->Print_(str125, arg0_spid);
    return 1;
  }
    ...
    if (proc_node != nullptr) {
      if (this->exec_opts->strict_errexit()) {
        ...
        if (disabled_spid != runtime::NO_SPID) {
          this->errfmt->Print_(str126, disabled_spid);
          this->errfmt->StderrLine(str127);
          e_die(fmt24(), arg0_spid);
        }
      }
      {  // with
        dev::ctx_Tracer ctx(this->tracer, str129, argv);
  ...
  if (cmd_val->typed_args) {
    e_die(fmt25(arg0), cmd_val->typed_args->spids->index(0));
  }
...
void ShellExecutor::RunPipeline(syntax_asdl::command__Pipeline* node, runtime_asdl::CommandStatus* status_out) {
  ...
  {  // with
    dev::ctx_Tracer ctx(this->tracer, str132, nullptr);
...
Str* ShellExecutor::RunCommandSub(syntax_asdl::command_sub* cs_part) {
  ...
  if (node->tag_() == command_e::Simple) {
    ...
    if ((len(simple->words) == 0 and (len(simple->redirects) == 1 and simple->redirects->index(0)->op->id == Id::Redir_Less))) {
      tok = Alloc<Token>(Id::Lit_Chars, runtime::NO_SPID, str134);
  ...
  while (true) {
    ...
    if (n < 0) {
      if (err_num == EINTR) {
        ...
        e_die(fmt27(posix::strerror(err_num)), 2);
      }
    }
    else {
      if (n == 0) {
  ...
  return str137->join(chunks)->rstrip(str138);
}
...
int Main(Str* lang, args::Reader* arg_r, Dict<Str*, Str*>* environ, bool login_shell, pyutil::_ResourceLoader* loader, void* line_input) {
  ...
  if (flag->help) {
    help_builtin->Run(MakeBuiltinArgv(Alloc<List<Str*>>(std::initializer_list<Str*>{fmt32(lang)})));
    return 0;
  }
  if (flag->version) {
  ...
  if (flag->debug_file != nullptr) {
    ...
    if (debug_dir != nullptr) {
      debug_path = os_path::join(debug_dir, fmt33(my_pid));
    }
  }
  if (len(debug_path)) {
    throw Alloc<NotImplementedError>();
  ...
  if (len(debug_path)) {
    println_stderr(fmt34(debug_path));
  }
    ...
    if (flag->i) {
      ...
      if (script_name == nullptr) {
        ...
        try {
          ...
          println_stderr(fmt35(script_name, pyutil::strerror(e)));
          return 1;
        }
  ...
  switch (arg->tag_()) {
    case redirect_arg_e::Path: {
      ...
      try {
        ...
        this->errfmt->Print_(fmt42(arg->filename, pyutil::strerror(e)), r->op_spid);
        throw ;
      }
  ...
  for (ReverseListIter<process::_RedirFrame*> it(frame->saved); !it.Done(); it.Next()) {
    ...
    if (rf->saved_fd == NO_FD) {
      try {
        ...
        println_stderr(fmt43(rf->orig_fd, pyutil::strerror(e)));
        throw ;
      }
    }
    else {
      try {
        ...
        println_stderr(fmt44(rf->saved_fd, rf->orig_fd, pyutil::strerror(e)));
        throw ;
      }
      posix::close(rf->saved_fd);
    }
...
void SubProgramThunk::Run() {
  ...
  try {
    ...
    println_stderr(fmt48(pyutil::strerror(e)));
    status = 2;
  }
  posix::_exit(status);
}
...
void Job::DisplayJob(int job_id, mylib::Writer* f) {
  StackRoots _roots({&f});
...
void Process::DisplayJob(int job_id, mylib::Writer* f) {
  ...
  f->write(fmt50(job_id_str, this->pid, _JobStateStr(this->state)));
...
int Process::Start(runtime_asdl::trace_t* why) {
  ...
  pid = posix::fork();
  if (pid < 0) {
    throw Alloc<RuntimeError>(str192);
  }
  else {
    if (pid == 0) {
...
void Pipeline::DisplayJob(int job_id, mylib::Writer* f) {
  int i;
  Str* job_id_str = nullptr;
  StackRoots _roots({&f, &job_id_str});
  ...
  for (ListIter<process::Process*> it(this->procs); !it.Done(); it.Next(), ++i) {
    ...
    StackRoots _for({&proc  });
    if (i == 0) {
      job_id_str = fmt51(job_id);
    }
    else {
      job_id_str = str194;
    }
    f->write(fmt52(job_id_str, proc->pid, _JobStateStr(proc->state)));
...
void Pipeline::DebugPrint() {
  print(fmt53(_JobStateStr(this->state)));
}
  ...
  if (WIFSIGNALED(status)) {
    ...
    if (WIFEXITED(status)) {
      ...
      if (WIFSTOPPED(status)) {
        println_stderr(str204);
        println_stderr(fmt55(pid));
...
runtime_asdl::cmd_value__Argv* MakeBuiltinArgv(List<Str*>* argv1) {
  ...
  argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str206});
  argv->extend(argv1);
  return Alloc<cmd_value::Argv>(argv, list_repeat(runtime::NO_SPID, len(argv)), nullptr);
}
...
int Main(Str* lang, args::Reader* arg_r, Dict<Str*, Str*>* environ, bool login_shell, pyutil::_ResourceLoader* loader, void* line_input) {
  ...
  arg_r->Next();
  try {
    attrs = flag_spec::ParseMore(str207, arg_r);
  }
  catch (error::Usage* e) {
    println_stderr(fmt56(e->msg));
    return 2;
  }
  flag = Alloc<arg_types::main>(attrs->attrs);
  arena = Alloc<alloc::Arena>();
  ...
  help_builtin = Alloc<builtin_misc::Help>(loader, errfmt);
  if (flag->help) {
    help_builtin->Run(MakeBuiltinArgv(Alloc<List<Str*>>(std::initializer_list<Str*>{fmt57(lang)})));
    return 0;
  }
  if (flag->version) {
    pyutil::ShowAppVersion(str210, loader);
    return 0;
  }
  no_str = nullptr;
  debug_stack = Alloc<List<state::DebugFrame*>>();
  if (arg_r->AtEnd()) {
    ...
    dollar0 = arg_r->Peek();
    frame0 = Alloc<state::DebugFrame>(dollar0, str211, no_str, state::LINE_ZERO, 0, 0);
    debug_stack->append(frame0);
  }
  frame1 = Alloc<state::DebugFrame>(no_str, no_str, no_str, runtime::NO_SPID, 0, 0);
  debug_stack->append(frame1);
  ...
  if (str_equals(lang, str212)) {
    mutable_opts->SetShoptOption(str213, true);
  }
  builtin_pure::SetShellOpts(mutable_opts, attrs->opt_changes, attrs->shopt_changes);
  aliases = Alloc<Dict<Str*, Str*>>();
  oil_grammar = nullptr;
  ...
  parse_ctx->Init_OnePassParse(flag->one_pass_parse);
  comp_arena = Alloc<alloc::Arena>();
  comp_arena->PushSource(Alloc<source::Unused>(str215));
  trail1 = Alloc<parse_lib::Trail>();
  comp_ctx = Alloc<parse_lib::ParseContext>(comp_arena, parse_opts, aliases, oil_grammar);
  comp_ctx->Init_Trail(trail1);
  comp_ctx->Init_OnePassParse(true);
  hist_arena = Alloc<alloc::Arena>();
  hist_arena->PushSource(Alloc<source::Unused>(str216));
  trail2 = Alloc<parse_lib::Trail>();
  hist_ctx = Alloc<parse_lib::ParseContext>(hist_arena, parse_opts, aliases, oil_grammar);
  hist_ctx->Init_Trail(trail2);
  cmd_deps = Alloc<cmd_eval::Deps>();
  ...
  my_pid = posix::getpid();
  debug_path = str217;
  debug_dir = environ->get(str218);
  if (flag->debug_file != nullptr) {
    debug_path = flag->debug_file;
  }
  else {
    if (debug_dir != nullptr) {
      debug_path = os_path::join(debug_dir, fmt58(my_pid));
    }
  }
  if (len(debug_path)) {
    throw Alloc<NotImplementedError>();
  ...
  cmd_deps->debug_f = debug_f;
  if (len(debug_path)) {
    println_stderr(fmt59(debug_path));
  }
  if (flag->xtrace_to_debug_file) {
    trace_f = debug_f;
  }
  ...
  waiter = Alloc<process::Waiter>(job_state, exec_opts, sig_state, tracer);
  fd_state->waiter = waiter;
  interp = environ->get(str221, str222);
  search_path = Alloc<state::SearchPath>(mem);
  ext_prog = Alloc<process::ExternalProgram>(interp, fd_state, errfmt, debug_f);
  splitter = Alloc<split::SplitContext>(mem);
  crash_dump_dir = environ->get(str223, str224);
  cmd_deps->dumper = Alloc<dev::CrashDumper>(crash_dump_dir);
  dir_stack = Alloc<state::DirStack>();
  builtins = Alloc<Dict<int, vm::_Builtin*>>();
  modules = Alloc<Dict<Str*, bool>>();
  ...
  if (flag->c != nullptr) {
    ...
    if (flag->i) {
      ...
      if (script_name == nullptr) {
        stdin = mylib::Stdin();
        arena->PushSource(Alloc<source::Stdin>(str225));
        line_reader = Alloc<reader::FileLineReader>(stdin, arena);
      }
      else {
        arena->PushSource(Alloc<source::MainFile>(script_name));
        try {
          ...
          println_stderr(fmt60(script_name, pyutil::strerror(e)));
          return 1;
        }
        line_reader = Alloc<reader::FileLineReader>(f, arena);
      }
...
Str* SearchPath::Lookup(Str* name, bool exec_required) {
  ...
  val = this->mem->GetValue(str232);
  UP_val = val;
  if (val->tag_() == value_e::Str) {
    value__Str* val = static_cast<value__Str*>(UP_val);
    path_list = val->s->split(str233);
  }
  else {
...
void MutableOpts::Init() {
  ...
  UP_shellopts = this->mem->GetValue(str237);
...
void MutableOpts::SetOption(Str* opt_name, bool b) {
  ...
  UP_val = this->mem->GetValue(str241);
  value__Str* val = static_cast<value__Str*>(UP_val);
  shellopts = val->s;
  if (b) {
    if (!str_contains(shellopts, opt_name)) {
      new_val = Alloc<value::Str>(fmt66(shellopts, opt_name));
      this->mem->InternalSetGlobal(str243, new_val);
    }
  }
  else {
    if (str_contains(shellopts, opt_name)) {
      names = Alloc<List<Str*>>();
      for (ListIter<Str*> it(shellopts->split(str244)); !it.Done(); it.Next()) {
        Str* n = it.Value();
        if (!(str_equals(n, opt_name))) {
          names->append(n);
        }
      }
      new_val = Alloc<value::Str>(str245->join(names));
...
void MutableOpts::ShowOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    b = this->Get(opt_num);
    print(fmt67(b ? str251 : str252, opt_name));
  }
}
...
void MutableOpts::ShowShoptOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    Str* opt_name = it.Value();
    StackRoots _for({&opt_name  });
    if (str_equals(opt_name, str253)) {
      opt_nums->extend(consts::OIL_BASIC);
    }
    else {
      if (str_equals(opt_name, str254)) {
        opt_nums->extend(consts::OIL_ALL);
      }
      else {
        if (str_equals(opt_name, str255)) {
  ...
  for (ListIter<int> it(opt_nums); !it.Done(); it.Next()) {
    ...
    print(fmt69(b ? str258 : str259, consts::OptionName(opt_num)));
  }
}
...
void _InitDefaults(state::Mem* mem) {
  ...
  SetGlobalString(mem, str262, split::DEFAULT_IFS);
  SetGlobalString(mem, str263, str(posix::getuid()));
  SetGlobalString(mem, str264, str(posix::geteuid()));
  SetGlobalString(mem, str265, str(posix::getppid()));
  SetGlobalString(mem, str266, libc::gethostname());
  SetGlobalString(mem, str267, pyos::OsType());
  SetGlobalString(mem, str268, str269);
  SetGlobalString(mem, str270, str271);
  SetGlobalString(mem, str272, _READLINE_DELIMS);
}
...
void _InitVarsFromEnv(state::Mem* mem, Dict<Str*, Str*>* environ) {
  ...
  val = mem->GetValue(str273);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str274, str275);
  }
  mem->SetValue(Alloc<lvalue::Named>(str276), nullptr, scope_e::GlobalOnly, SetReadOnly);
  val = mem->GetValue(str277);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str278, _GetWorkingDir());
  }
  mem->SetValue(Alloc<lvalue::Named>(str279), nullptr, scope_e::GlobalOnly, SetExport);
  val = mem->GetValue(str280);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str281, str282);
  }
}
...
void InitMem(state::Mem* mem, Dict<Str*, Str*>* environ, Str* version_str) {
  ...
  SetGlobalString(mem, str283, version_str);
  _InitDefaults(mem);
  _InitVarsFromEnv(mem, environ);
  val = mem->GetValue(str284);
...
void InitInteractive(state::Mem* mem) {
  ...
  if (mem->GetValue(str285)->tag_() == value_e::Undef) {
    SetGlobalString(mem, str286, str287);
  }
}
...
Mem::Mem(Str* dollar0, List<Str*>* argv, alloc::Arena* arena, List<state::DebugFrame*>* debug_stack) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Mem)) {
  ...
  this->line_num = Alloc<value::Str>(str288);
...
Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> Mem::_ResolveNameOrRef(Str* name, runtime_asdl::scope_t which_scopes, bool is_setref, List<Str*>* ref_trail) {
  ...
  if (ref_trail == nullptr) {
    ...
    if (list_contains(ref_trail, new_name)) {
      e_die(fmt73(str300->join(ref_trail)));
    }
  }
  ...
  switch (lval->tag_()) {
    case lvalue_e::Named: {
      ...
      if (keyword_id == Id::KW_SetRef) {
        lval->name = str_concat(str301, lval->name);
      }
    ...
    case lvalue_e::Indexed: {
      ...
      e_die(fmt77(ui::ValType(cell->val)), left_spid);
    }
      break;
    case lvalue_e::Keyed: {
      lvalue__Keyed* lval = static_cast<lvalue__Keyed*>(UP_lval);
...
bool Mem::Unset(runtime_asdl::lvalue_t* lval, runtime_asdl::scope_t which_scopes) {
  ...
  if (cell->readonly) {
    throw Alloc<error::Runtime>(fmt79(var_name));
  }
  switch (lval->tag_()) {
    case lvalue_e::Named: {
    ...
    case lvalue_e::Indexed: {
      ...
      if (val->tag_() != value_e::MaybeStrArray) {
        throw Alloc<error::Runtime>(fmt80(var_name));
      }
      value__MaybeStrArray* val = static_cast<value__MaybeStrArray*>(UP_val);
      strs = val->strs;
      n = len(strs);
...
Str* GetString(state::Mem* mem, Str* name) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      throw Alloc<error::Runtime>(fmt81(name));
    }
      break;
    case value_e::Str: {
      ...
      break;
    default: {
      throw Alloc<error::Runtime>(fmt82(name));
    }
  }
}
...
int GetInteger(state::Mem* mem, Str* name) {
  ...
  val = mem->GetValue(name);
  if (val->tag_() != value_e::Str) {
    throw Alloc<error::Runtime>(fmt83(name, ui::ValType(val)));
  }
  ...
  try {
    ...
    throw Alloc<error::Runtime>(fmt84(name, s));
  }
  return i;
}
...
Str* PrettyDir(Str* dir_name, Str* home_dir) {
  ...
  if (home_dir != nullptr) {
    if ((str_equals(dir_name, home_dir) or dir_name->startswith(str_concat(home_dir, str330)))) {
      return str_concat(str331, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    StackRoots _for({&c  });
    buf->write(str_equals(c, str334) ? str335 : str336);
  }
  buf->write(str337);
  buf->write(str_repeat(str338, (length - 1)));
  buf->write(str339);
  ...
  switch (src->tag_()) {
    ...
    case source_e::ArgvWord: {
      ...
      if (src->span_id == runtime::NO_SPID) {
        ...
        s = fmt87(src->what, line_num, outer_source);
      }
    }
      break;
    case source_e::Variable: {
      ...
      if (src->span_id == runtime::NO_SPID) {
        ...
        line_num = arena->GetLineNumber(span->line_id);
        outer_source = GetLineSourceString(arena, span->line_id, quote_filename);
        where = fmt88(line_num, outer_source);
      }
      s = fmt89(var_name, where);
    }
      break;
    case source_e::Alias: {
...
void _PrintWithSpanId(Str* prefix, Str* msg, int span_id, alloc::Arena* arena, bool show_code) {
  ...
  f->write(fmt93(source_str, line_num, prefix, msg));
}
...
void ErrorFormatter::Print_(Str* msg, int span_id) {
  ...
  _PrintWithSpanId(str354, msg, span_id, this->arena, true);
}
...
void ErrorFormatter::PrintMessage(Str* msg, int span_id) {
  ...
  _PrintWithSpanId(str355, msg, span_id, this->arena, false);
}
...
void PrintAst(syntax_asdl::command_t* node, arg_types::main* flag) {
  ...
  if (maybe_str_equals(flag->ast_format, str358)) {
    println_stderr(str359);
  }
  else {
    f = mylib::Stdout();
    afmt = flag->ast_format;
    if ((maybe_str_equals(afmt, str360) || maybe_str_equals(afmt, str361))) {
      ast_f = fmt::DetectConsoleOutput(f);
    }
    else {
      if ((maybe_str_equals(afmt, str362) || maybe_str_equals(afmt, str363))) {
...
void _Attributes::Set(Str* name, runtime_asdl::value_t* val) {
  ...
  name = name->replace(str367, str368);
...
bool SetAttachedBool::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  if (attached_arg != nullptr) {
    if ((str_equals(attached_arg, str384) || str_equals(attached_arg, str385) || str_equals(attached_arg, str386) || str_equals(attached_arg, str387))) {
      b = false;
    }
    else {
      if ((str_equals(attached_arg, str388) || str_equals(attached_arg, str389) || str_equals(attached_arg, str390) || str_equals(attached_arg, str391))) {
        b = true;
      }
      else {
        e_usage(fmt95(attached_arg));
      }
    }
  }
  else {
...
bool SetOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str393);
...
bool SetNamedOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str394);
  arg_r->Next();
  arg = arg_r->Peek();
  if (arg == nullptr) {
...
args::_Attributes* Parse(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str398)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if ((len(spec->actions_long) and arg->startswith(str399))) {
      pos = arg->find(str400, 2);
      if (pos == -1) {
        suffix = nullptr;
      ...
      if ((arg->startswith(str402) and len(arg) > 1)) {
        n = len(arg);
        for (int i = 1; i < n; ++i) {
          ch = arg->index(i);
          if (str_equals(ch, str403)) {
            ch = str404;
          }
          if (list_contains(spec->plus_flags, ch)) {
            out->Set(ch, Alloc<value::Str>(str405));
            continue;
          }
        ...
        if ((len(spec->plus_flags) and (arg->startswith(str408) and len(arg) > 1))) {
          n = len(arg);
          for (int i = 1; i < n; ++i) {
            ch = arg->index(i);
            if (list_contains(spec->plus_flags, ch)) {
              out->Set(ch, Alloc<value::Str>(str409));
              continue;
            }
            e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
          }
...
args::_Attributes* ParseLikeEcho(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    chars = arg->slice(1);
    if ((arg->startswith(str412) and len(chars))) {
      done = false;
...
args::_Attributes* ParseMore(flag_spec::_FlagSpecAndMore* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str413)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if (arg->startswith(str414)) {
    ...
    if (((arg->startswith(str416) or arg->startswith(str417)) and len(arg) > 1)) {
      char0 = arg->index(0);
...
int LineLexer::GetSpanIdForEof() {
  int line_id;
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str421, 0);
  }
  else {
...
int LineLexer::ByteLookBack() {
  ...
  if (pos < 0) {
    ...
    return ord(this->line->index(pos));
  }
}
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str423, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = Alloc<Token>(id_, span_id, str424);
      return t;
    }
  ...
  if (len(this->translation_stack)) {
    Tuple2<int, int>* tup6 = this->translation_stack->index(-1);
    old_id = tup6->at0();
    new_id = tup6->at1();
    if (t->id == old_id) {
...
lexer::Lexer* ParseContext::MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = Alloc<lexer::LineLexer>(str426, this->arena);
...
syntax_asdl::expr_t* RequiredExpr(syntax_asdl::ArgList* arg_list) {
  ...
  span_id = arg_list->spids->index(0);
  ...
  if (n == 0) {
    ...
    if (n == 1) {
      return arg_list->positional->index(0);
    }
    else {
...
syntax_asdl::command_t* GetOneBlock(syntax_asdl::ArgList* arg_list) {
  ...
  if (n == 0) {
    ...
    if (n == 1) {
      arg = arg_list->positional->index(0);
      UP_arg = arg;
      switch (arg->tag_()) {
        ...
        case expr_e::CommandSub: {
          ...
          break;
        default: {
          e_usage(fmt101(), arg_list->spids->index(0));
        }
      }
    }
    else {
      e_usage(fmt102(), arg_list->spids->index(0));
    }
  }
}
...
GLOBAL_LIST(Str*, 12, POSIX_CLASSES, {str439 COMMA str440 COMMA str441 COMMA str442 COMMA str443 COMMA str444 COMMA str445 COMMA str446 COMMA str447 COMMA str448 COMMA str449 COMMA str450});
Str* RANGE_POINT_TOO_LONG = str451;
int NT_OFFSET = 256;
...
syntax_asdl::expr_t* Transformer::_Tuple(List<pnode::PNode*>* children) {
  ...
  if (n == 2) {
    p_die(fmt107(), children->index(1)->tok);
  }
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw Alloc<NotImplementedError>(str453);
  }
  if (id0 == Id::Op_LBracket) {
    elts = Alloc<List<syntax_asdl::expr_t*>>();
    for (int i = 0; i < n; i += 2) {
  ...
  for (int i = 0; i < n; i += 2) {
    ...
    if (tag == expr_e::Var) {
      ...
      if ((tag == place_expr_e::Var || tag == place_expr_e::Subscript || tag == place_expr_e::Attribute)) {
        ...
        p_die(fmt109(), p->tok ? p->tok : nullptr);
      }
    }
  }
  return places;
...
syntax_asdl::proc_sig_t* Transformer::_ProcParams(pnode::PNode* p_node) {
  ...
  i = 0;
  while (i < n) {
    Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, syntax_asdl::Token*, syntax_asdl::expr_t*> tup2 = this->_ProcParam(children->index(i));
    prefix = tup2.at0();
    name = tup2.at1();
    typ = tup2.at2();
    ...
    if ((prefix and prefix->id == Id::Expr_At)) {
      ...
      if (typ == nullptr) {
        ...
        if ((typ->val != str458 && typ->val != str459)) {
          p_die(fmt110(), typ);
        }
...
syntax_asdl::re_t* Transformer::_NameInRegex(syntax_asdl::Token* negated_tok, syntax_asdl::Token* tok) {
  ...
  val = tok->val;
  if (maybe_str_equals(val, str462)) {
    if (negated_tok) {
      p_die(fmt111(), tok);
    }
    return tok;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((str_equals(tok->val, str467) || str_equals(tok->val, str468) || str_equals(tok->val, str469))) {
        return tok;
      }
      p_die(fmt115(tok->val), tok);
    }
...
void _ClassLiteralToPosixEre(syntax_asdl::class_literal_term_t* term, List<Str*>* parts) {
  ...
  if (tag == class_literal_term_e::CodePoint) {
    ...
    if (code_point < 128) {
      ...
      e_die(fmt117(code_point), term->spid);
    }
    return ;
  }
  if (tag == class_literal_term_e::PerlClass) {
    ...
    if (term->negated) {
      e_die(fmt118(), term->negated->span_id);
    }
    else {
      pat = fmt119(chars);
    }
  ...
  if (tag == class_literal_term_e::PosixClass) {
    ...
    n = term->name;
    if (term->negated) {
      e_die(fmt120(), term->negated->span_id);
    }
    else {
      pat = fmt121(n);
    }
...
void AsPosixEre(syntax_asdl::re_t* node, List<Str*>* parts) {
  ...
  if (tag == re_e::Repeat) {
    ...
    if (op_tag == re_repeat_e::Num) {
      ...
      parts->append(fmt123(op->times->val));
      return ;
    }
    if (op_tag == re_repeat_e::Range) {
      re_repeat__Range* op = static_cast<re_repeat__Range*>(UP_op);
      lower = op->lower ? op->lower->val : str486;
      upper = op->upper ? op->upper->val : str487;
      parts->append(fmt124(lower, upper));
      return ;
    }
...
syntax_asdl::bool_expr_t* BoolParser::ParseForBuiltin() {
  ...
  if (this->bool_id != Id::Eof_Real) {
    p_die(fmt131(word_::Pretty(this->cur_word)), this->cur_word);
  }
  return node;
}
...
syntax_asdl::bool_expr_t* BoolParser::ParseFactor() {
  ...
  if (this->bool_id == Id::Op_LParen) {
    ...
    if (this->bool_id != Id::Op_RParen) {
      p_die(fmt133(word_::Pretty(this->cur_word)), this->cur_word);
    }
    this->_Next();
    return node;
  }
  p_die(fmt134(ui::PrettyId(this->bool_id)), this->cur_word);
}
...
Str* _RangeParser::_Eat(int token_type) {
  ...
  if (this->token_type != token_type) {
    throw Alloc<_NotARange>(fmt135(token_type, this->token_type));
  }
  val = this->token_val;
  this->_Next();
  return val;
...
syntax_asdl::word_part__BracedRange* _RangeParser::Parse() {
  ...
  if (this->token_type == Id::Range_Int) {
    ...
    if (start < end) {
      ...
      if (part->step <= 0) {
        p_die(fmt137(part->step), this->span_id);
      }
    }
    else {
      if (start > end) {
        ...
        if (part->step >= 0) {
          p_die(fmt138(part->step), this->span_id);
        }
      }
      else {
        part->step = 1;
    ...
    if (this->token_type == Id::Range_Char) {
      ...
      if (start_num < end_num) {
        ...
        if (part->step <= 0) {
          p_die(fmt139(part->step), this->span_id);
        }
      }
      else {
        if (start_num > end_num) {
          ...
          if (part->step >= 0) {
            p_die(fmt140(part->step), this->span_id);
          }
        }
        else {
          part->step = 1;
      ...
      if (upper1 != upper2) {
        p_die(fmt141(), this->span_id);
      }
    }
    else {
      throw Alloc<_NotARange>(str512);
    }
  }
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  flag = attrs->attrs;
  tmp_g = flag->get(str515);
  tmp_a = flag->get(str516);
  tmp_A = flag->get(str517);
  ...
  flag_A = (tmp_A and tmp_A->tag_() == value_e::Bool) ? static_cast<value__Bool*>(tmp_A)->b : false;
  tmp_n = flag->get(str518);
  tmp_r = flag->get(str519);
  tmp_x = flag->get(str520);
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if ((maybe_str_equals(flag_n, str522) and !cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_n, str523) and cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str524) and !cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str525) and cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str526) and !cell->exported)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str527) and cell->exported)) {
      continue;
    }
    ...
    if (print_flags) {
      ...
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str534, str535->join(flags), str536, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str537, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (has_holes) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str540, name, str541, str(i), str542, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str544, str545->join(body), str546}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str548, key_quoted, str549, value_quoted}));
          }
          if (len(body) > 0) {
            decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str550, str551->join(body), str552}));
          }
        }
        else {
          ;  // pass
...
int Export::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r->Next();
  attrs = flag_spec::Parse(str554, arg_r);
...
int Readonly::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str559, arg_r);
...
int NewVar::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str560, arg_r);
  ...
  flags = 0;
  if (maybe_str_equals(arg->x, str563)) {
    flags |= state::SetExport;
  }
  if (maybe_str_equals(arg->r, str564)) {
    flags |= state::SetReadOnly;
  }
  if (maybe_str_equals(arg->n, str565)) {
    flags |= state::SetNameref;
  }
  flags_to_clear = 0;
  if (maybe_str_equals(arg->x, str566)) {
    flags |= state::ClearExport;
  }
  if (maybe_str_equals(arg->r, str567)) {
    flags |= state::ClearReadOnly;
  }
  if (maybe_str_equals(arg->n, str568)) {
...
int Unset::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str569, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
...
int Eval::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str572, cmd_val);
  arg_r = tup0.at1();
  if (this->exec_opts->simple_eval_builtin()) {
    Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str573);
    code_str = tup1.at0();
    eval_spid = tup1.at1();
    if (!arg_r->AtEnd()) {
      e_usage(str574);
    ...
    code_str = str575->join(arg_r->Rest());
    eval_spid = cmd_val->arg_spids->index(0);
  }
  line_reader = reader::StringLineReader(code_str, this->arena);
  c_parser = this->parse_ctx->MakeOshParser(line_reader);
  src = Alloc<source::ArgvWord>(str576, eval_spid);
  {  // with
    dev::ctx_Tracer ctx(this->tracer, str577, nullptr);
...
int Source::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str578, cmd_val);
  arg_r = tup2.at1();
  path = arg_r->Peek();
  if (path == nullptr) {
    e_usage(str579);
  ...
  try {
    ...
    this->errfmt->Print_(fmt148(path, pyutil::strerror(e)), cmd_val->arg_spids->index(1));
    return 1;
  }
  try {
    try {
      ...
      c_parser = this->parse_ctx->MakeOshParser(line_reader);
      {  // with
        dev::ctx_Tracer ctx(this->tracer, str581, cmd_val->argv);
...
int Command::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup3 = flag_spec::ParseCmdVal(str582, cmd_val);
  attrs = tup3.at0();
  arg_r = tup3.at1();
...
int Builtin::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (to_run == consts::NO_INDEX) {
    ...
    if (consts::LookupAssignBuiltin(name) != consts::NO_INDEX) {
      this->errfmt->Print_(str583, span_id);
    }
    else {
      this->errfmt->Print_(fmt149(name), span_id);
    }
    return 1;
  }
...
int RunProc::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  runtime_asdl::cmd_value__Argv* cmd_val2 = nullptr;
  runtime_asdl::CommandStatus* cmd_st = nullptr;
  StackRoots _roots({&cmd_val, &attrs, &arg_r, &arg, &argv, &spids, &name, &cmd_val2, &cmd_st});

  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str585, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
  ...
  spids = tup6.at1();
  if (len(argv) == 0) {
    throw Alloc<error::Usage>(str586, runtime::NO_SPID);
  }
  name = argv->index(0);
  if (!dict_contains(this->procs, name)) {
    this->errfmt->PrintMessage(fmt150(name));
    return 1;
  }
...
int Try::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  int status;
  Str* var_name = nullptr;
  StackRoots _roots({&cmd_val, &attrs, &arg_r, &arg, &argv, &spids, &cmd_val2, &cmd_st, &var_name});

  Tuple2<args::_Attributes*, args::Reader*> tup7 = flag_spec::ParseCmdVal(str588, cmd_val);
  attrs = tup7.at0();
  arg_r = tup7.at1();
  ...
  if ((arg->allow_status_01 and (status != 0 && status != 1))) {
    if (failure_spid != runtime::NO_SPID) {
      this->errfmt->Print_(str590, failure_spid);
      this->errfmt->StderrLine(str591);
    }
    throw Alloc<error::FatalRuntime>(fmt152(status), spids->index(0), status);
  }
  if (arg->assign != nullptr) {
    var_name = arg->assign;
    if (var_name->startswith(str593)) {
...
List<Tuple2<Str*, Str*>*>* _ResolveNames(List<Str*>* names, Dict<Str*, runtime_asdl::Proc*>* funcs, Dict<Str*, Str*>* aliases, state::SearchPath* search_path) {
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if (dict_contains(funcs, name)) {
      kind = (Alloc<Tuple2<Str*, Str*>>(str594, name));
    }
    else {
      if (dict_contains(aliases, name)) {
        kind = (Alloc<Tuple2<Str*, Str*>>(str595, name));
      }
      else {
        if (consts::LookupNormalBuiltin(name) != 0) {
          kind = (Alloc<Tuple2<Str*, Str*>>(str596, name));
        }
        else {
              ...
              if (consts::IsControlFlow(name)) {
                ...
                if (consts::IsKeyword(name)) {
                  ...
                  if (resolved == nullptr) {
                    ...
                    kind = (Alloc<Tuple2<Str*, Str*>>(str601, resolved));
                  }
                }
              }
            }
...
int Type::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseCmdVal(str602, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  for (ListIter<Tuple2<Str*, Str*>*> it(r); !it.Done(); it.Next()) {
    ...
    if (kind == nullptr) {
      if (!arg->t) {
        this->errfmt->PrintMessage(fmt153(name));
      }
      status = 1;
    }
    else {
      if (arg->t) {
        ...
        if (arg->p) {
          if (str_equals(kind, str604)) {
            print(name);
          }
        }
        else {
          if (arg->P) {
            if (str_equals(kind, str605)) {
              print(name);
            }
            else {
...
int Read::_Line(arg_types::read* arg, Str* var_name) {
  ...
  if (!arg->with_eol) {
    if (line->endswith(str610)) {
      line = line->slice(0, -2);
    }
    else {
      if (line->endswith(str611)) {
        line = line->slice(0, -1);
      }
    }
  }
  if ((arg->q and line->startswith(str612))) {
    arena = this->parse_ctx->arena;
    line_reader = reader::StringLineReader(line, arena);
    lexer = this->parse_ctx->MakeLexer(line_reader);
    try {
      {  // with
        alloc::ctx_Location ctx(arena, Alloc<source::Stdin>(str613));
...
int Read::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  try {
    ...
    this->errfmt->PrintMessage(fmt155(posix::strerror(e->err_num)));
    status = 1;
  }
  return status;
}
...
int Read::_Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str616, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
  ...
  if (arg->line) {
    ...
    next_spid = tup8.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str619, next_spid);
    }
  ...
  if (arg->all) {
    ...
    next_spid = tup10.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str623, next_spid);
    }
...
int MapFile::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup13 = flag_spec::ParseCmdVal(str630, cmd_val);
  attrs = tup13.at0();
  arg_r = tup13.at1();
  ...
  while (true) {
    try {
      ...
      this->errfmt->PrintMessage(fmt156(posix::strerror(e->err_num)));
      return 1;
    }
    if (len(line) == 0) {
      break;
    }
    if ((arg->t and line->endswith(str634))) {
      line = line->slice(0, -1);
    }
    lines->append(line);
  }
...
int Cd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str635, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  ...
  arg_spid = tup16.at1();
  if (dest_dir == nullptr) {
    val = this->mem->GetValue(str636);
    try {
      dest_dir = state::GetString(this->mem, str637);
    }
    catch (error::Runtime* e) {
  ...
  if (str_equals(dest_dir, str638)) {
    try {
      dest_dir = state::GetString(this->mem, str639);
      print(dest_dir);
    }
    catch (error::Runtime* e) {
      this->errfmt->Print_(e->UserErrorString());
  ...
  try {
    pwd = state::GetString(this->mem, str640);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    return 1;
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt157(real_dest_dir, posix::strerror(err_num)), arg_spid);
    return 1;
  }
  state::ExportGlobalString(this->mem, str642, real_dest_dir);
  ...
  if (block) {
    ...
    state::ExportGlobalString(this->mem, str643, pwd);
...
void _PrintDirStack(state::DirStack* dir_stack, int style, Str* home_dir) {
  ...
  if (style == WITH_LINE_NUMBERS) {
    ...
    for (ListIter<Str*> it(dir_stack->Iter()); !it.Done(); it.Next(), ++i) {
      ...
      print(fmt158(i, ui::PrettyDir(entry, home_dir)));
    }
  }
  else {
...
int Pushd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt159(dest_dir, posix::strerror(err_num)), cmd_val->arg_spids->index(1));
    return 1;
  }
  this->dir_stack->Push(dest_dir);
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str649));
  state::ExportGlobalString(this->mem, str650, dest_dir);
...
bool _PopDirStack(state::Mem* mem, state::DirStack* dir_stack, ui::ErrorFormatter* errfmt) {
  ...
  if (dest_dir == nullptr) {
    errfmt->Print_(str651);
    return false;
  }
  err_num = pyos::Chdir(dest_dir);
  if (err_num != 0) {
    errfmt->Print_(fmt160(dest_dir, posix::strerror(err_num)));
    return false;
  }
  state::SetGlobalString(mem, str653, dest_dir);
  mem->SetPwd(dest_dir);
  return true;
}
...
int Popd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->arg_spids) > 1) {
    e_usage(fmt161(), cmd_val->arg_spids->index(1));
  }
  if (!_PopDirStack(this->mem, this->dir_stack, this->errfmt)) {
    return 1;
  }
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str655));
  return 0;
}
...
int Dirs::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup17 = flag_spec::ParseCmdVal(str656, cmd_val);
  attrs = tup17.at0();
  arg_r = tup17.at1();
  arg = Alloc<arg_types::dirs>(attrs->attrs);
  home_dir = state::MaybeString(this->mem, str657);
  style = SINGLE_LINE;
  if (arg->l) {
    home_dir = nullptr;
  }
...
int Pwd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup18 = flag_spec::ParseCmdVal(str658, cmd_val);
  attrs = tup18.at0();
  arg_r = tup18.at1();
...
List<Str*>* Help::_Groups() {
  ...
  contents = this->loader->Get(str659);
...
int Help::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup19 = flag_spec::ParseCmdVal(str660, cmd_val);
  attrs = tup19.at0();
  arg_r = tup19.at1();
  Tuple2<Str*, int> tup20 = arg_r->Peek2();
  topic = tup20.at0();
  blame_spid = tup20.at1();
  if (topic == nullptr) {
    topic = str661;
  ...
  try {
    contents = this->loader->Get(fmt162(topic));
  }
  catch (IOError*) {
    this->errfmt->Print_(fmt163(topic), blame_spid);
    return 1;
  }
  print(contents);
  return 0;
...
int Cat::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  chunks = Alloc<List<Str*>>();
  while (true) {
    Tuple2<int, int> tup21 = pyos::Read(0, 4096, chunks);
    n = tup21.at0();
    err_num = tup21.at1();
    if (n < 0) {
      if (err_num == EINTR) {
        ...
        e_die(fmt164(posix::strerror(err_num)), 2);
      }
    }
    else {
      if (n == 0) {
        ...
        mylib::Stdout()->write(chunks->index(0));
        chunks->pop();
      }
    }
  }
...
syntax_asdl::printf_part_t* _FormatStringParser::_ParseFormatStr() {
  ...
  while ((this->token_type == Id::Format_Flag || this->token_type == Id::Format_Zero)) {
    ...
    if (str_contains(str665, flag)) {
      p_die(fmt165(flag), this->cur_token);
    }
  ...
  if ((this->token_type == Id::Format_Type || this->token_type == Id::Format_Time)) {
    ...
    if (str_contains(str667, part->type->val)) {
      p_die(fmt166(), part->type);
    }
    if (maybe_str_equals(part->type->val, str669)) {
      p_die(fmt167(), part->type);
    }
  }
  else {
        ...
        if (part->tag_() == printf_part_e::Percent) {
          ...
          if (part->width) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt170(width_str), width_spid);
              return 1;
            }
          }
          precision = -1;
          if (part->precision) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt171(precision_str), precision_spid);
              return 1;
            }
          }
          if (arg_index < num_args) {
          ...
          if (str_equals(typ, str680)) {
            ...
            if (str_equals(typ, str681)) {
              ...
              if (str_equals(typ, str682)) {
                ...
                s = str683->join(c_parts);
              }
              else {
                if ((part->type->id == Id::Format_Time or str_contains(str684, typ))) {
                  try {
                    d = to_int(s);
                  }
                  catch (ValueError*) {
                    if ((len(s) >= 1 and str_contains(str685, s->index(0)))) {
                  ...
                  if (part->type->id == Id::Format_Time) {
                    ...
                    if ((d < 0 and str_contains(str689, typ))) {
                      e_die(fmt173(d, typ), part->type->span_id);
                    }
                    if (str_equals(typ, str691)) {
                      s = mylib::octal(d);
                    }
                    else {
                      if (str_equals(typ, str692)) {
                        s = mylib::hex_lower(d);
                      }
                      else {
                        if (str_equals(typ, str693)) {
                          s = mylib::hex_upper(d);
                        }
                        else {
                          s = str(d);
                    ...
                    zero_pad = 0;
                    if ((width >= 0 and list_contains(flags, str694))) {
                      zero_pad = 1;
                    }
                    else {
                    ...
                    if (zero_pad) {
                      negative = str_equals(s->index(0), str695);
                      if (negative) {
                        digits = s->slice(1);
                        sign = str696;
                        if (zero_pad == 1) {
                      ...
                      s = str_concat(sign, digits->rjust(n, str698));
                    }
                  }
                }
                else {
          ...
          if (width >= 0) {
            if (list_contains(flags, str699)) {
              s = s->ljust(width, str700);
            }
            else {
              s = s->rjust(width, str701);
            }
          }
          out->append(s);
        }
...
int Printf::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup1 = flag_spec::ParseCmdVal(str702, cmd_val);
  attrs = tup1.at0();
  arg_r = tup1.at1();
  arg = Alloc<arg_types::printf>(attrs->attrs);
  Tuple2<Str*, int> tup2 = arg_r->ReadRequired2(str703);
  fmt = tup2.at0();
  fmt_spid = tup2.at1();
  ...
  if (dict_contains(this->parse_cache, fmt)) {
    ...
    {  // with
      alloc::ctx_Location ctx(arena, Alloc<source::ArgvWord>(str704, fmt_spid));
...
int Alias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str706, cmd_val);
  arg_r = tup0.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup1 = mylib::split_once(arg, str708);
    name = tup1.at0();
    alias_exp = tup1.at1();
    if (alias_exp == nullptr) {
      alias_exp = this->aliases->get(name);
      if (alias_exp == nullptr) {
        this->errfmt->Print_(fmt175(name), cmd_val->arg_spids->index(i));
        status = 1;
      }
      else {
        print(fmt176(name, alias_exp));
      }
    }
    else {
...
int UnAlias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str711, cmd_val);
  arg_r = tup2.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
    e_usage(str712);
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    ...
    if (dict_contains(this->aliases, name)) {
      ...
      this->errfmt->Print_(fmt177(name), cmd_val->arg_spids->index(i));
      status = 1;
    }
  }
  return status;
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->argv) == 1) {
    ...
    for (ListIter<Str*> it(sorted(mapping)); !it.Done(); it.Next()) {
      ...
      code_str = fmt178(name, qsn::maybe_shell_encode(str_val));
      print(code_str);
    }
    return 0;
  }
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  arg = flag_spec::ParseMore(str715, arg_r);
  if (arg->show_options) {
...
int Shopt::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str716, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
...
int Hash::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str718, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
...
Dict<Str*, bool>* _ParseOptSpec(Str* spec_str) {
  ...
  while (true) {
    ...
    if (str_equals(spec_str->index(i), str721)) {
      spec->set(ch, true);
      i += 1;
    }
  }
...
int GetOptsState::_OptInd() {
  int result;
  try {
    result = state::GetInteger(this->mem, str722);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    result = -1;
...
void GetOptsState::IncIndex() {
  state::BuiltinSetString(this->mem, str723, str((this->_optind + 1)));
}

void GetOptsState::SetArg(Str* optarg) {
  StackRoots _roots({&optarg});

  state::BuiltinSetString(this->mem, str724, optarg);
}

void GetOptsState::Fail() {
  state::BuiltinSetString(this->mem, str725, str726);
}
...
Tuple2<int, Str*> _GetOpts(Dict<Str*, bool>* spec, List<Str*>* argv, builtin_pure::GetOptsState* my_state, ui::ErrorFormatter* errfmt) {
  ...
  if (current == nullptr) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str727));
  }
  if ((!current->startswith(str728) or str_equals(current, str729))) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str730));
  }
  ...
  if (!dict_contains(spec, flag_char)) {
    return (Tuple2<int, Str*>(0, str731));
  }
  if (spec->index(flag_char)) {
    if (more_chars) {
      ...
      if (optarg == nullptr) {
        my_state->Fail();
        errfmt->Print_(fmt181(current));
        tmp = Alloc<List<Str*>>();
        for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
          Str* a = it.Value();
          tmp->append(qsn::maybe_shell_encode(a));
        }
        println_stderr(fmt182(str734->join(tmp)));
        return (Tuple2<int, Str*>(0, str735));
      }
    }
    my_state->IncIndex();
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  spec_str = arg_r->ReadRequired(str737);
  Tuple2<Str*, int> tup7 = arg_r->ReadRequired2(str738);
  var_name = tup7.at0();
  var_spid = tup7.at1();
  ...
  if (match::IsValidVarName(var_name)) {
    ...
    throw Alloc<error::Usage>(fmt183(var_name), var_spid);
  }
  return status;
}
...
int Echo::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseLikeEcho(str740, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  if (arg->e) {
    ...
    for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
      ...
      new_argv->append(str741->join(parts));
      if (backslash_c) {
        break;
      }
    }
...
int Module::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseCmdVal(str745, cmd_val);
  arg_r = tup11.at1();
  Tuple2<Str*, int> tup12 = arg_r->ReadRequired2(str746);
  name = tup12.at0();
  if (dict_contains(this->modules, name)) {
    if (this->exec_opts->redefine_module()) {
      this->errfmt->PrintMessage(fmt184(name));
      return 0;
    }
    else {
      return 1;
...
int Use::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_spid = tup13.at1();
  if (arg == nullptr) {
    throw Alloc<error::Usage>(str748, runtime::NO_SPID);
  }
  arg_r->Next();
  if (str_equals(arg, str749)) {
    ...
    UP_actual = this->mem->GetValue(str751, scope_e::Dynamic);
    if (UP_actual->tag_() == value_e::Str) {
      ...
      if (maybe_str_equals(actual, expected)) {
        ...
        this->errfmt->Print_(fmt185(expected, actual), e_spid);
        return 1;
      }
    }
    else {
      this->errfmt->Print_(fmt186(expected), e_spid);
      return 1;
    }
  }
  if (str_equals(arg, str754)) {
    ...
    for (ListIter<Str*> it(rest); !it.Done(); it.Next()) {
      Str* name = it.Value();
      StackRoots _for({&name    });
      println_stderr(fmt187(name));
    }
    return 0;
  }
  throw Alloc<error::Usage>(str756, arg_spid);
}
...
int Shvar::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Str* name = nullptr;
  Str* s = nullptr;
  StackRoots _roots({&cmd_val, &attrs, &arg_r, &block, &pairs, &args, &arg_spids, &name, &s});

  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str757, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  block = typed_args::GetOneBlock(cmd_val->typed_args);
  if (!block) {
    throw Alloc<error::Usage>(str758, runtime::NO_SPID);
  }
  ...
  arg_spids = tup16.at1();
  if (len(args) == 0) {
    throw Alloc<error::Usage>(str759, runtime::NO_SPID);
  }
  i = 0;
  for (ListIter<Str*> it(args); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup17 = mylib::split_once(arg, str760);
    name = tup17.at0();
    s = tup17.at1();
    if (s == nullptr) {
      throw Alloc<error::Usage>(str761, arg_spids->index(i));
    }
...
int PushRegisters::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  block = typed_args::GetOneBlock(cmd_val->typed_args);
  if (!block) {
    throw Alloc<error::Usage>(str762, runtime::NO_SPID);
  }
  {  // with
...
int CommandEvaluator::_RunAssignBuiltin(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  if (builtin_func == nullptr) {
    e_die(fmt188(cmd_val->argv->index(0)), cmd_val->arg_spids->index(0));
  }
  try {
    try {
      status = builtin_func->Run(cmd_val);
      ...
      this->errfmt->PrefixPrint(e->msg, fmt189(arg0), e->span_id);
      status = 2;
    }
    catch (KeyboardInterrupt*) {
      if (this->exec_opts->interactive()) {
  ...
  switch (arg->tag_()) {
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        filename = val->s;
        if (len(filename) == 0) {
          throw Alloc<error::RedirectEval>(str773, arg_word);
        }
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          t = val->s;
          if (len(t) == 0) {
            throw Alloc<error::RedirectEval>(str774, arg_word);
            return nullptr;
          }
          try {
            if (maybe_str_equals(t, str775)) {
              result->arg = Alloc<redirect_arg::CloseFd>();
            }
            else {
              if (str_equals(t->index(-1), str776)) {
            ...
            throw Alloc<error::RedirectEval>(fmt191(t), arg_word);
            return nullptr;
          }
          return result;
        }
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = Alloc<redirect_arg::HereDoc>(str_concat(val->s, str778));
            return result;
          }
          else {
            throw Alloc<AssertionError>();
...
void CommandEvaluator::_StrictErrExit(syntax_asdl::command_t* node) {
  ...
  if (_HasManyStatuses(node)) {
    ...
    e_die(fmt192(node_str), location::SpanForCommand(node));
  }
}
...
void CommandEvaluator::_StrictErrExitList(List<syntax_asdl::command_t*>* node_list) {
  ...
  if (len(node_list) > 1) {
    e_die(fmt193(), location::SpanForCommand(node_list->index(0)));
  }
  node = node_list->index(0);
  if (_HasManyStatuses(node)) {
    node_str = ui::CommandType(node);
    e_die(fmt194(node_str), location::SpanForCommand(node));
  }
}
  ...
  switch (node->tag_()) {
      ...
      if (UP_cmd_val->tag_() == cmd_value_e::Argv) {
        ...
        if (node->typed_args) {
          ...
          if (node->block) {
            ...
            block_expr = Alloc<expr__BlockArg>(node->block);
            typed_args->positional->append(block_expr);
            typed_args->spids->append(node->block->spids->index(0));
          }
        }
        ...
        if (node->block) {
          e_die(fmt195(), node->block->spids->index(0));
        }
        cmd_value__Assign* cmd_val = static_cast<cmd_value__Assign*>(UP_cmd_val);
      }
    ...
    case command_e::Pipeline: {
      ...
      if (len(node->stderr_indices)) {
        e_die(fmt196(), node->spids->index(0));
      }
      if (node->negated) {
    ...
    case command_e::ControlFlow: {
      ...
      if (node->arg_word) {
        ...
        if ((len(str_val->s) == 0 and !this->exec_opts->strict_control_flow())) {
          ...
          try {
            ...
            e_die(fmt197(node->token->val, str_val->s), node->arg_word);
          }
        }
      }
      else {
      ...
      if (ok) {
        ...
        if (this->exec_opts->strict_control_flow()) {
          ...
          this->errfmt->PrefixPrint(msg, str788, tok->span_id);
          status = 0;
        }
      }
    }
    ...
    case command_e::ShFunction: {
      ...
      if ((dict_contains(this->procs, node->name) and !this->exec_opts->redefine_proc())) {
        e_die(fmt198(node->name), node->spids->index(1));
      }
    ...
    case command_e::Proc: {
      ...
      if ((dict_contains(this->procs, node->name->val) and !this->exec_opts->redefine_proc())) {
        e_die(fmt199(node->name->val), node->name->span_id);
      }
      defaults = nullptr;
    ...
    {  // with
      ...
      for (ListIter<syntax_asdl::command_t*> it(to_run); !it.Done(); it.Next()) {
        ...
        {  // with
          ...
          {  // with
            dev::ctx_Tracer ctx(this->tracer, str791, nullptr);
      ...
      if (this->shell_ex->PushRedirects(redirects)) {
        {  // with
          ...
          try {
            ...
            this->errfmt->PrettyPrintError(e, str792);
            status = 1;
            check_errexit = true;
          }
        }
        ...
        if (len(codes)) {
          ...
          if (this->exec_opts->pipefail()) {
            ...
            for (ListIter<int> it(codes); !it.Done(); it.Next(), ++i) {
              ...
              if (st != 0) {
                status = st;
                errexit_spid = cmd_st->pipe_spids->index(i);
              }
            }
          }
          else {
...
Tuple2<bool, bool> CommandEvaluator::ExecuteAndCatch(syntax_asdl::command_t* node, int cmd_flags) {
  ...
  try {
    ...
    if ((cmd_flags & RaiseControlFlow)) {
      ...
      if (e->IsReturn()) {
        ...
        this->errfmt->Print_(str793, e->token->span_id);
        is_fatal = true;
        status = 1;
      }
    }
  ...
  if (err) {
    ...
    if (is_errexit) {
      ...
      this->errfmt->PrettyPrintError(err, str794);
    }
  }
...
void CommandEvaluator::MaybeRunExitTrap(List<int>* mut_status) {
  ...
  handler = this->traps->get(str795);
  if (handler) {
    {  // with
      dev::ctx_Tracer ctx(this->tracer, str796, nullptr);
  ...
  {  // with
    ...
    if (UP_sig->tag_() == proc_sig_e::Closed) {
      ...
      for (ListIter<syntax_asdl::UntypedParam*> it(sig->untyped); !it.Done(); it.Next(), ++i) {
        ...
        if (i < n_args) {
          ...
          if (is_out_param) {
            param_name = str_concat(str797, param_name);
            if (!arg_str->startswith(str798)) {
              e_die(fmt200(arg_str));
            }
      ...
      if (sig->rest) {
        ...
        if (n_args > n_params) {
          this->errfmt->Print_(fmt202(proc->name, n_params, n_args), arg0_spid);
          return 2;
        }
      }
    }
    try {
      ...
      if (e->IsReturn()) {
        ...
        e_die(fmt203(e->token->val), e->token);
      }
    }
    catch (error::FatalRuntime* e) {
      this->dumper->MaybeCollect(this, e);
...
int CommandEvaluator::RunFuncForCompletion(runtime_asdl::Proc* proc, List<Str*>* argv) {
  ...
  try {
    ...
    this->errfmt->Print_(str803, e->token->span_id);
    status = 1;
  }
  return status;
}
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index(i), str805))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index(-2), str807)) {
    ...
    if ((left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse)) {
      var_name = left_token->val->slice(0, -1);
      if (str_equals(close_token->val->index(-2), str808)) {
        op = assign_op_e::PlusEqual;
      }
      else {
        op = assign_op_e::Equal;
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        var_name = left_token->val->slice(0, -1);
        if (str_equals(close_token->val->index(-2), str809)) {
          op = assign_op_e::PlusEqual;
        }
        else {
          op = assign_op_e::Equal;
        ...
        if (span1->line_id == span2->line_id) {
          ...
          throw Alloc<NotImplementedError>(fmt206(span1->line_id, span2->line_id));
        }
        a_parser = parse_ctx->MakeArithParser(code_str);
        src = Alloc<source::Reparsed>(str811, left_token->span_id, close_token->span_id);
        {  // with
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    if (str_equals(left_token->val->index(-2), str813)) {
      p_die(fmt208(), left_token);
    }
    var_name = left_token->val->slice(0, -1);
    n = len(w->parts);
    if (part_offset == n) {
...
void CommandParser::_Eat(int c_id) {
  ...
  msg = fmt214(ui::PrettyId(c_id), ui::PrettyId(actual_id));
  this->_Eat2(c_id, msg);
}
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index(0), str821)) {
    pos = op_val->find(str822);
        ...
        if (this->c_id == Id::Op_LParen) {
          ...
          if ((prev_byte != SPACE_CH && prev_byte != TAB_CH)) {
            if (this->parse_opts->parse_at()) {
              p_die(fmt216(), this->cur_word);
            }
            else {
              p_die(fmt217(), this->cur_word);
            }
          }
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    i += 1;
    if (!alias_exp->endswith(str828)) {
      expanded->append(str829);
      break;
    }
  }
  if (len(expanded) == 0) {
  ...
  while (i < n) {
    ...
    if (span1->line_id == span2->line_id) {
      ...
      throw Alloc<NotImplementedError>(fmt220(span1->line_id, span2->line_id));
    }
    expanded->append(str831);
    i += 1;
  }
  code_str = str832->join(expanded);
  line_reader = reader::StringLineReader(code_str, this->arena);
...
syntax_asdl::command_t* CommandParser::ParseSimpleCommand() {
  ...
  if (block) {
    typed_spid = block->spids->index(0);
  }
  if (typed_args) {
    typed_spid = typed_args->spids->index(0);
  }
  if (len(words) == 0) {
    if (typed_spid != runtime::NO_SPID) {
      p_die(fmt221(), typed_spid);
    }
  ...
  if (kind == Kind::ControlFlow) {
    ...
    if (len(suffix_words) == 1) {
      ...
      if (len(suffix_words) == 2) {
        ...
        p_die(fmt228(kw_token->val), suffix_words->index(2));
      }
    }
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if (str_equals(c, str858)) {
      i += 1;
    }
    else {
      if ((str_equals(c, str859) or str_equals(c, str860))) {
        return true;
      }
      else {
        if (str_equals(c, str861)) {
          left_bracket = true;
        }
        else {
          if ((str_equals(c, str862) and left_bracket)) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  ...
  return pyutil::BackslashEscape(s, str864);
}
Str* ERE_META_CHARS = str865;
...
Str* GlobUnescape(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if ((str_equals(c, str866) and i != (n - 1))) {
      i += 1;
      c2 = s->index(i);
      ...
      if (tag == glob_part_e::Operator) {
        ...
        if (tag == glob_part_e::CharClass) {
          ...
          for (ListIter<Str*> it(part->strs); !it.Done(); it.Next()) {
            Str* s = it.Value();
            StackRoots _for({&s          });
            if (str_equals(s, str884)) {
              literal_hyphen = true;
              continue;
            }
            if (str_equals(s, str885)) {
...
Str* _PromptEvaluatorCache::Get(Str* name) {
  ...
  if (str_equals(name, str893)) {
    value = this->_GetEuid() == 0 ? str894 : str895;
  }
  else {
    if (str_equals(name, str896)) {
      value = libc::gethostname();
    }
    else {
      if (str_equals(name, str897)) {
      ...
      if (id_ == Id::PS_Octal3) {
        ...
        if (id_ == Id::PS_LBrace) {
          ...
          if (id_ == Id::PS_RBrace) {
            ...
            if (id_ == Id::PS_Subst) {
              ch = value->index(1);
              if (str_equals(ch, str900)) {
                r = this->cache->Get(str901);
              }
              else {
                if (str_equals(ch, str902)) {
                  r = this->cache->Get(str903);
                }
                else {
                  if (str_equals(ch, str904)) {
                    hostname = this->cache->Get(str905);
                    Tuple2<Str*, Str*> tup1 = mylib::split_once(hostname, str906);
                    r = tup1.at0();
                  }
                  else {
                    if (str_equals(ch, str907)) {
                      ...
                      if (str_equals(ch, str909)) {
                        ...
                        if (str_equals(ch, str910)) {
                          r = this->version_str;
                        }
                        else {
                          if (str_equals(ch, str911)) {
                            now = time_::time();
                            r = time_::strftime(str912, time_::localtime(now));
                          }
                          else {
                            if (str_equals(ch, str913)) {
                              now = time_::time();
                              fmt = value->slice(3, -1);
                              if (len(fmt) == 0) {
                                fmt = str914;
                              ...
                              if (str_equals(ch, str915)) {
                                try {
                                  pwd = state::GetString(this->mem, str916);
                                  home = state::MaybeString(this->mem, str917);
                                  r = ui::PrettyDir(pwd, home);
                                }
                                catch (error::Runtime* e) {
                                  r = fmt247(e->UserErrorString());
                                }
                              }
                              else {
                                if (str_equals(ch, str919)) {
                                  val = this->mem->GetValue(str920);
                                  if (val->tag_() == value_e::Str) {
                                    value__Str* str_val = static_cast<value__Str*>(val);
              ...
              ret->append(r->replace(str923, str924));
            }
            else {
              throw Alloc<AssertionError>();
            }
...
Str* Evaluator::EvalPrompt(runtime_asdl::value_t* UP_val) {
  ...
  if (ps1_word == nullptr) {
    ...
    try {
      ...
      ps1_word = word_::ErrorWord(fmt249(e->UserErrorString()));
    }
...
Str* Evaluator::EvalFirstPrompt() {
  ...
  if (str_equals(this->lang, str929)) {
    val = this->mem->GetValue(str930);
    return this->EvalPrompt(val);
  }
  else {
    return str_concat(this->lang, str931);
  }
}
Str* PROMPT_COMMAND = str932;
    ...
    case lvalue_e::Indexed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          break;
        default: {
          e_die(fmt251(ui::ValType(val)));
        }
      }
      s = word_eval::GetArrayItem(array_val->strs, lval->index);
      if (s == nullptr) {
        val = Alloc<value::Str>(str935);
      }
      else {
        val = Alloc<value::Str>(s);
      }
    ...
    case lvalue_e::Keyed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::AssocArray: {
          ...
          break;
        default: {
          e_die(fmt252(ui::ValType(val)));
        }
      }
      s = assoc_val->d->get(lval->key);
      if (s == nullptr) {
        val = Alloc<value::Str>(str937);
      }
      else {
        val = Alloc<value::Str>(s);
      }
...
runtime_asdl::lvalue_t* UnsafeArith::ParseLValue(Str* s, int span_id) {
  ...
  {  // with
    alloc::ctx_Location ctx(this->arena, Alloc<source::ArgvWord>(str938, span_id));
...
int ArithEvaluator::_StringToInteger(Str* s, int span_id) {
  ...
  if (s->startswith(str942)) {
    try {
      integer = to_int(s, 16);
    }
    catch (ValueError*) {
      e_strict(fmt256(s), span_id);
    }
    return integer;
  }
  if (s->startswith(str944)) {
    try {
      integer = to_int(s, 8);
    }
    catch (ValueError*) {
      e_strict(fmt257(s), span_id);
    }
    return integer;
  }
  if (str_contains(s, str946)) {
    Tuple2<Str*, Str*> tup0 = mylib::split_once(s, str947);
    b = tup0.at0();
    digits = tup0.at1();
    try {
      base = to_int(b);
    ...
    for (StrIter it(digits); !it.Done(); it.Next()) {
      ...
      StackRoots _for({&ch    });
      if (IsLower(ch)) {
        digit = ((ord(ch) - ord(str949)) + 10);
      }
      else {
        if (IsUpper(ch)) {
          digit = ((ord(ch) - ord(str950)) + 36);
        }
        else {
          if (str_equals(ch, str951)) {
            digit = 62;
          }
          else {
            if (str_equals(ch, str952)) {
              ...
              if (ch->isdigit()) {
                ...
                e_strict(fmt259(digits), span_id);
              }
            }
          }
        }
      ...
      if (digit >= base) {
        e_strict(fmt260(digits, base), span_id);
      }
    ...
    if ((this->exec_opts->eval_unsafe_arith() and this->parse_ctx)) {
      ...
      {  // with
        ...
        try {
          ...
          this->errfmt->PrettyPrintError(e);
          e_die(fmt261(), e->span_id);
        }
      }
      if (node2->tag_() == arith_expr_e::Word) {
        e_die(fmt262(s), span_id);
      }
      else {
...
int ArithEvaluator::_ValToIntOrError(runtime_asdl::value_t* val, int span_id) {
  ...
  e_die(fmt266(ui::ValType(val)), span_id);
}
  ...
  if (((val->tag_() == value_e::MaybeStrArray || val->tag_() == value_e::AssocArray) and lval->tag_() == lvalue_e::Named)) {
    ...
    if (word_eval::ShouldArrayDecay(named_lval->name, this->exec_opts)) {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (val->tag_() == value_e::AssocArray) {
          lval = Alloc<lvalue::Keyed>(named_lval->name, str961);
        }
      }
        ...
        if (op_id == Id::Arith_Minus) {
          ...
          if (op_id == Id::Arith_Star) {
            ...
            if (op_id == Id::Arith_Slash) {
              if (rhs == 0) {
                e_die(fmt269(), location::SpanForArithExpr(node->right));
              }
              ret = (lhs / rhs);
            }
            else {
              if (op_id == Id::Arith_Percent) {
                if (rhs == 0) {
                  e_die(fmt270(), location::SpanForArithExpr(node->right));
                }
                ret = (lhs % rhs);
              }
              else {
  ...
  switch (node->tag_()) {
    ...
    case bool_expr_e::Unary: {
      ...
      if (arg_type == bool_arg_type_e::Other) {
        ...
        e_die(fmt272(ui::PrettyId(op_id)));
      }
      throw Alloc<AssertionError>();
    }
      break;
      ...
      if (arg_type == bool_arg_type_e::Str) {
        ...
        if (op_id == Id::BoolBinary_EqualTilde) {
          try {
            ...
            msg = e->message;
            e_die(fmt273(s2, msg, node->right), 2);
          }
          if (matches == nullptr) {
            return false;
          }
...
split::IfsSplitter* SplitContext::_GetSplitter(Str* ifs) {
  ...
  if (ifs == nullptr) {
    val = this->mem->GetValue(str974, scope_e::Dynamic);
    UP_val = val;
    switch (val->tag_()) {
      case value_e::Undef: {
        ifs = DEFAULT_IFS;
...
Str* SplitContext::GetJoinChar() {
  ...
  val = this->mem->GetValue(str977, scope_e::Dynamic);
  UP_val = val;
  switch (val->tag_()) {
    case value_e::Undef: {
      return str978;
...
_BaseSplitter::_BaseSplitter(Str* escape_chars) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(_BaseSplitter)) {
  this->escape_chars = str_concat(escape_chars, str981);
}
    ...
    if (i < n) {
      ...
      if (str_contains(ws_chars, c)) {
        ...
        if (str_contains(other_chars, c)) {
          ...
          if ((allow_escape and str_equals(c, str982))) {
...
Str* Utf8Encode(int code) {
  ...
  return str985->join(tmp);
}
Str* INCOMPLETE_CHAR = str986;
Str* INVALID_CONT = str987;
Str* INVALID_START = str988;
    ...
    if ((tok->id == Id::VOp1_Pound || tok->id == Id::VOp1_DPound)) {
      ...
      if ((tok->id == Id::VOp1_Percent || tok->id == Id::VOp1_DPercent)) {
        ...
        if (tok->id == Id::VOp1_Comma) {
          if (!(str_equals(arg, str989))) {
            e_die(fmt274(ui::PrettyId(tok->id)), tok);
          }
          if (len(s)) {
          ...
          if (tok->id == Id::VOp1_DComma) {
            if (!(str_equals(arg, str991))) {
              e_die(fmt275(ui::PrettyId(tok->id)), tok);
            }
            return s->lower();
          }
          else {
            if (tok->id == Id::VOp1_Caret) {
              if (!(str_equals(arg, str993))) {
                e_die(fmt276(ui::PrettyId(tok->id)), tok);
              }
              if (len(s)) {
              ...
              if (tok->id == Id::VOp1_DCaret) {
                if (!(str_equals(arg, str995))) {
                  e_die(fmt277(ui::PrettyId(tok->id)), tok);
                }
                return s->upper();
              }
              else {
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Slash) {
    try {
      ...
      msg = e->message;
      e_die(fmt279(regex, msg), this->slash_spid);
    }
  }
  if (op->replace_mode == Id::Lit_Pound) {
    regex = str_concat(str1001, regex);
  }
  else {
    if (op->replace_mode == Id::Lit_Percent) {
      regex = str_concat(regex, str1002);
    }
  }
...
Str* ShellQuoteB(Str* s) {
  ...
  s = s->replace(str1003, str1004)->replace(str1005, str1006);
  return pyutil::BackslashEscape(s, str1007);
}
...
void TdopParser::Eat(int token_type) {
  if (!this->AtToken(token_type)) {
    p_die(fmt283(ui::PrettyId(token_type), ui::PrettyId(this->op_id)), this->cur_word);
  }
  this->Next();
}
...
int QUOTE_ERE = (1 << 6);
GLOBAL_LIST(Str*, 3, _STRING_AND_ARRAY, {str1020 COMMA str1021 COMMA str1022});
...
runtime_asdl::value_t* DecayArray(runtime_asdl::value_t* val) {
  ...
  if (val->tag_() == value_e::MaybeStrArray) {
    ...
    if (val->tag_() == value_e::AssocArray) {
      value__AssocArray* assoc_val = static_cast<value__AssocArray*>(val);
      s = dict_contains(assoc_val->d, str1023) ? assoc_val->d->index(str1024) : nullptr;
    }
    else {
      throw Alloc<AssertionError>();
    }
...
runtime_asdl::assign_arg* _SplitAssignArg(Str* arg, int word_spid) {
  ...
  if (m == nullptr) {
    e_die(fmt285(arg), word_spid);
  }
  var_name = m->index(1);
  op = m->index(3);
  if (len(op)) {
    val = Alloc<value::Str>(m->index(4));
    append = str_equals(op->index(0), str1027);
  }
  else {
    val = nullptr;
    append = false;
...
Str* _BackslashEscape(Str* s) {
  ...
  return s->replace(str1028, str1029);
}
...
runtime_asdl::part_value_t* _ValueToPartValue(runtime_asdl::value_t* val, bool quoted) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      return Alloc<part_value::String>(str1030, quoted, !quoted);
    }
      break;
    case value_e::Str: {
      value__Str* val = static_cast<value__Str*>(UP_val);
...
Str* _GetDollarHyphen(optview::Exec* exec_opts) {
  ...
  chars = Alloc<List<Str*>>();
  if (exec_opts->interactive()) {
    chars->append(str1034);
  }
  if (exec_opts->errexit()) {
    chars->append(str1035);
  }
  if (exec_opts->noglob()) {
    chars->append(str1036);
  }
  if (exec_opts->noexec()) {
    chars->append(str1037);
  }
  if (exec_opts->nounset()) {
    chars->append(str1038);
  }
  if (exec_opts->xtrace()) {
...
Str* TildeEvaluator::Eval(syntax_asdl::Token* token) {
  ...
  if (maybe_str_equals(token->val, str1042)) {
    val = this->mem->GetValue(str1043);
    UP_val = val;
    if (val->tag_() == value_e::Str) {
      value__Str* val = static_cast<value__Str*>(UP_val);
      return val->s;
      ...
      if ((tok->id == Id::VTest_ColonEquals || tok->id == Id::VTest_Equals)) {
        ...
        if ((tok->id == Id::VTest_ColonQMark || tok->id == Id::VTest_QMark)) {
          if (is_falsey) {
            ...
            e_die(fmt289(error_str), blame_token);
          }
          else {
            return false;
          }
    ...
    case value_e::Str: {
      ...
      try {
        ...
        if (this->exec_opts->strict_word_eval()) {
          ...
          this->errfmt->PrettyPrintError(e, str1047);
          return Alloc<value::Str>(str1048);
        }
      }
    }
      break;
...
runtime_asdl::value_t* AbstractWordEvaluator::_Slice(runtime_asdl::value_t* val, syntax_asdl::suffix_op__Slice* op, Str* var_name, syntax_asdl::braced_var_sub* part) {
  ...
  try {
    ...
    if (this->exec_opts->strict_word_eval()) {
      ...
      this->errfmt->PrettyPrintError(e, str1054);
      switch (val->tag_()) {
        case value_e::Str: {
          val = Alloc<value::Str>(str1055);
        }
          break;
        case value_e::MaybeStrArray: {
  ...
  if (op_id == Id::VOp0_P) {
    switch (val->tag_()) {
      case value_e::Str: {
        ...
        p = prompt->replace(str1056, str1057)->replace(str1058, str1059);
        result = Alloc<value::Str>(p);
      }
        break;
      default: {
        e_die(fmt292(ui::ValType(val)));
      }
    }
  }
  else {
    if (op_id == Id::VOp0_Q) {
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          result = Alloc<value::Str>(str1061->join(tmp));
        }
          break;
        default: {
          e_die(fmt293(ui::ValType(val)));
        }
      }
    }
    else {
      if (op_id == Id::VOp0_a) {
        ...
        switch (val->tag_()) {
          case value_e::MaybeStrArray: {
            chars->append(str1063);
          }
            break;
          case value_e::AssocArray: {
            chars->append(str1064);
          }
            break;
        }
        if (var_name != nullptr) {
          ...
          if (cell) {
            if (cell->readonly) {
              chars->append(str1065);
            }
            if (cell->exported) {
              chars->append(str1066);
            }
            if (cell->nameref) {
              chars->append(str1067);
            }
          }
        }
        result = Alloc<value::Str>(str1068->join(chars));
      }
      else {
        e_die(fmt294(op->val), op);
      }
    }
  }
...
runtime_asdl::value_t* AbstractWordEvaluator::_ArrayIndex(runtime_asdl::value_t* val, syntax_asdl::braced_var_sub* part, runtime_asdl::VTestPlace* vtest_place) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      ...
      break;
    case value_e::Str: {
      e_die(fmt297(part->token->val), part->token);
    }
      break;
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* array_val = static_cast<value__MaybeStrArray*>(UP_val);
...
void AbstractWordEvaluator::_EvalDoubleQuoted(List<syntax_asdl::word_part_t*>* parts, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  if (len(parts) == 0) {
    v = Alloc<part_value::String>(str1073, true, false);
    part_vals->append(v);
    return ;
  }
  for (ListIter<syntax_asdl::word_part_t*> it(parts); !it.Done(); it.Next()) {
...
runtime_asdl::value_t* AbstractWordEvaluator::_EmptyStrOrError(runtime_asdl::value_t* val, syntax_asdl::Token* token) {
  ...
  if (!this->exec_opts->nounset()) {
    return Alloc<value::Str>(str1074);
  }
  name = token->val->startswith(str1075) ? token->val->slice(1) : token->val;
  e_die(fmt298(name), token);
}
...
Str* AbstractWordEvaluator::EvalBracedVarSubToString(syntax_asdl::braced_var_sub* part) {
  ...
  return this->_ConcatPartVals(part_vals, part->spids->index(0));
}
...
void AbstractWordEvaluator::_EvalExtGlob(syntax_asdl::word_part__ExtGlob* part, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  for (ListIter<syntax_asdl::compound_word*> it(part->arms); !it.Done(); it.Next(), ++i) {
    ...
    StackRoots _for({&w  });
    if (i != 0) {
      part_vals->append(Alloc<part_value::String>(str1086, false, false));
    }
    this->_EvalWordToParts(w, part_vals, EXTGLOB_NESTED);
  }
  part_vals->append(Alloc<part_value::String>(str1087, false, false));
}
    ...
    case word_e::Compound: {
      ...
      if (has_extglob) {
        if (to_bool((eval_flags & EXTGLOB_FILES))) {
          ...
          glob_pat = str1093->join(glob_parts);
          fnmatch_pat = str1094->join(fnmatch_parts);
          results = Alloc<List<Str*>>();
          n = this->globber->ExpandExtended(glob_pat, fnmatch_pat, results);
          if (n < 0) {
            span_id = word_::LeftMostSpanForWord(w);
            throw Alloc<error::FailGlob>(fmt309(fnmatch_pat), span_id);
          }
      ...
      break;
    case word_e::Empty: {
      part_vals->append(Alloc<part_value::String>(str1097, quoted, !quoted));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, int eval_flags) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return Alloc<value::Str>(str1101);
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  part_vals = Alloc<List<runtime_asdl::part_value_t*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
  ...
  return Alloc<value::Str>(str1102->join(strs));
}
...
Tuple2<runtime_asdl::value__Str*, bool> AbstractWordEvaluator::EvalWordToPattern(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return (Tuple2<runtime_asdl::value__Str*, bool>(Alloc<value::Str>(str1103), false));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  has_extglob = false;
  part_vals = Alloc<List<runtime_asdl::part_value_t*>>();
  ...
  return (Tuple2<runtime_asdl::value__Str*, bool>(Alloc<value::Str>(str1104->join(strs)), has_extglob));
}
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalForPlugin(syntax_asdl::compound_word* w) {
  ...
  {  // with
    ...
    try {
      ...
      val = Alloc<value::Str>(fmt313(e->UserErrorString()));
    }
    catch (_OSError* e) {
      val = Alloc<value::Str>(fmt314(pyutil::strerror(e)));
    }
    catch (KeyboardInterrupt*) {
      val = Alloc<value::Str>(str1107);
    }
  }
  return val;
}
...
runtime_asdl::value_t* AbstractWordEvaluator::EvalRhsWord(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return Alloc<value::Str>(str1108);
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  if (len(w->parts) == 1) {
...
void AbstractWordEvaluator::_EvalWordFrame(List<Tuple3<Str*, bool, bool>*>* frame, List<Str*>* argv) {
  ...
  for (ListIter<Str*> it(args); !it.Done(); it.Next()) {
    ...
    if (glob_::LooksLikeGlob(a)) {
      ...
      if (n < 0) {
        throw Alloc<error::FailGlob>(fmt315(a), runtime::NO_SPID);
      }
    }
    else {
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index(-2), str1115)) {
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        StackRoots _for({&arg      });
        if ((arg->startswith(str1116) or arg->startswith(str1117))) {
          flags->append(arg);
          flag_spids->append(word_spid);
          if ((str_contains(arg, str1118) or str_contains(arg, str1119))) {
            eval_to_pairs = false;
          }
        }
        else {
...
runtime_asdl::cmd_value_t* AbstractWordEvaluator::SimpleEvalWordSequence2(List<syntax_asdl::compound_word*>* words, bool allow_assign) {
  ...
  for (ListIter<syntax_asdl::compound_word*> it(words); !it.Done(); it.Next(), ++i) {
    ...
    if (glob_::LooksLikeStaticGlob(w)) {
      ...
      if (num_appended < 0) {
        throw Alloc<error::FailGlob>(fmt317(val->s), word_spid);
      }
...
runtime_asdl::part_value__String* CompletionWordEvaluator::_EvalProcessSub(syntax_asdl::command_sub* cs_part) {
  ...
  return Alloc<part_value::String>(str1123, true, false);
}
...
syntax_asdl::suffix_op__PatSub* WordParser::_ReadPatSubVarOp() {
  ...
  if (this->token_type == Id::Lit_Slash) {
    ...
    this->_Peek();
    if (this->token_type != Id::Right_DollarBrace) {
      p_die(fmt320(ui::PrettyId(this->token_type)), this->cur_token);
    }
    return Alloc<suffix_op::PatSub>(pat, replace, replace_mode);
  }
  p_die(fmt321(), this->cur_token);
}
          ...
          if (op_kind == Kind::VOp2) {
            if (this->token_type == Id::VOp2_Slash) {
              ...
              if (this->token_type == Id::VOp2_Colon) {
                ...
                p_die(fmt328(str1135), this->cur_token);
              }
            }
          }
          else {
            if (op_kind == Kind::VOp3) {
              if (allow_query) {
                ...
                p_die(fmt329(str1137), this->cur_token);
              }
            }
          }
        }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool is_oil_expr) {
  ...
  while (num_end_tokens < expected_end_tokens) {
    ...
    if ((this->token_kind == Kind::Lit || this->token_kind == Kind::Char)) {
      tok = this->cur_token;
      if ((no_backslashes and str_contains(tok->val, str1142))) {
        p_die(fmt334(), tok);
      }
      if (is_oil_expr) {
...
syntax_asdl::word_part_t* WordParser::_ReadUnquotedLeftParts(bool try_triple_quote, List<bool>* triple_out) {
  ...
  if ((this->token_type == Id::Left_DoubleQuote || this->token_type == Id::Left_DollarDoubleQuote)) {
    ...
    if ((try_triple_quote and len(dq_part->parts) == 0)) {
      if (str_equals(this->lexer->ByteLookAhead(), str1148)) {
  ...
  if ((this->token_type == Id::Left_SingleQuote || this->token_type == Id::Left_RSingleQuote || this->token_type == Id::Left_DollarSingleQuote)) {
    ...
    if ((try_triple_quote and len(sq_part->tokens) == 0)) {
      if (str_equals(this->lexer->ByteLookAhead(), str1149)) {
        this->_Next(lex_mode_e::ShCommand);
        this->_Peek();
  ...
  if ((left_id == Id::Left_DollarParen || left_id == Id::Left_AtParen || left_id == Id::Left_ProcSubIn || left_id == Id::Left_ProcSubOut)) {
    ...
    if ((left_id == Id::Left_Backtick and this->parse_ctx->one_pass_parse)) {
      ...
      if (left_id == Id::Left_Backtick) {
        ...
        right_spid = this->cur_token->span_id;
        code_str = str1157->join(parts);
        arena = this->parse_ctx->arena;
        line_reader = reader::StringLineReader(code_str, arena);
        c_parser = this->parse_ctx->MakeOshParser(line_reader);
        src = Alloc<source::Reparsed>(str1158, left_spid, right_spid);
        {  // with
          alloc::ctx_Location ctx(arena, src);
...
void WordParser::ParseProc(syntax_asdl::command__Proc* node) {
  ...
  if (this->token_type != Id::Lit_Chars) {
    p_die(fmt346(ui::PrettyToken(this->cur_token, this->arena)), this->cur_token);
  }
...
syntax_asdl::arith_expr_t* WordParser::_ReadArithExpr(int end_id) {
  ...
  if ((end_id != Id::Undefined_Tok and cur_id != end_id)) {
    p_die(fmt347(ui::PrettyId(cur_id), ui::PrettyId(end_id)), this->a_parser->cur_word);
  }
  return anode;
}
...
syntax_asdl::command__ForExpr* WordParser::ReadForExpression() {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt350(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
  if (cur_id == Id::Arith_Semi) {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt351(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
            ...
            if (this->token_type == Id::Lit_Dollar) {
              if (!this->parse_opts->parse_dollar()) {
                if ((num_parts == 0 and lex_mode == lex_mode_e::ShCommand)) {
                  ...
                  if (str_equals(next_byte, str1174)) {
                    println_stderr(fmt361(next_byte));
                  }
                }
                p_die(fmt362(), this->cur_token);
              }
            }
          }
        }
...
Tuple2<syntax_asdl::word_t*, bool> WordParser::_ReadArithWord() {
  ...
  this->_Peek();
  if (this->token_kind == Kind::Unknown) {
    p_die(fmt366(this->cur_token->val), this->cur_token);
  }
  else {
    if (this->token_kind == Kind::Eof) {
          ...
          if ((this->token_kind == Kind::VSub || this->token_kind == Kind::Lit || this->token_kind == Kind::History || this->token_kind == Kind::Left || this->token_kind == Kind::KW || this->token_kind == Kind::ControlFlow || this->token_kind == Kind::BoolUnary || this->token_kind == Kind::BoolBinary || this->token_kind == Kind::ExtGlob)) {
            if (this->token_type == Id::Lit_Pound) {
              ...
              if (this->token_type == Id::Lit_TPound) {
                ...
                if ((this->parse_opts->parse_raw_string() and (this->token_type == Id::Lit_Chars and maybe_str_equals(this->cur_token->val, str1182)))) {
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1187, false));
    }
      break;
    case word_part_e::AssocArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1188, false));
    }
      break;
    case word_part_e::Literal: {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str1190, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str1191->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() != word_e::Compound) {
    return (Tuple3<bool, Str*, bool>(false, str1193, quoted));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  strs = Alloc<List<Str*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str1194, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str1195->join(strs), quoted));
}
...
syntax_asdl::compound_word* TildeDetect(syntax_asdl::word_t* UP_w) {
  ...
  if ((id_ == Id::Lit_Chars and static_cast<Token*>(part1)->val->startswith(str1197))) {
    new_parts->extend(w->parts->slice(1));
    return Alloc<compound_word>(new_parts);
  }
  return nullptr;
...
void TildeDetectAssign(syntax_asdl::compound_word* w) {
  ...
  for (int i = 0; i < n; ++i) {
    ...
    if ((do_expand and LiteralId(cur) == Id::Lit_TildeLike)) {
      ...
      if (next_part) {
        is_tilde = (LiteralId(next_part) == Id::Lit_Colon or (LiteralId(next_part) == Id::Lit_Chars and static_cast<Token*>(next_part)->val->startswith(str1198)));
      }
      else {
        is_tilde = true;
      }
...
Str* escape(Str* s) {
  ...
  s = s->replace(str1208, str1209);
  s = s->replace(str1210, str1211);
  s = s->replace(str1212, str1213);
  return s;
}
...
Str* join(Str* s1, Str* s2) {
  ...
  if ((s2->startswith(str1216) or len(s1) == 0)) {
    return s2;
  }
  if (s1->endswith(str1217)) {
...
Tuple2<Str*, Str*> _splitext(Str* p, Str* sep, Str* extsep) {
  ...
  return (Tuple2<Str*, Str*>(p, str1220));
}
...
Str* normpath(Str* path) {
  ...
  slash = str1223;
  dot = str1224;
  if (str_equals(path, str1225)) {
    return dot;
  }
  initial_slashes = path->startswith(str1226);
  if ((initial_slashes and (path->startswith(str1227) and !path->startswith(str1228)))) {
    initial_slashes = 2;
  }
  comps = path->split(str1229);
  new_comps = Alloc<List<Str*>>();
  for (ListIter<Str*> it(comps); !it.Done(); it.Next()) {
    Str* comp = it.Value();
    StackRoots _for({&comp  });
    if ((len(comp) == 0 or str_equals(comp, str1230))) {
      continue;
    }
    if ((!(str_equals(comp, str1231)) or ((initial_slashes == 0 and len(new_comps) == 0) or (len(new_comps) and str_equals(new_comps->index(-1), str1232))))) {
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if ((str_contains(str1239, ch) or IsUnprintableLow(ch))) {
        quote = 2;
        break;
      }
    }
  ...
  parts->append(str1242);
  return str_concat(prefix, str1243->join(parts));
}
...
Str* maybe_encode(Str* s, int bit8_display) {
  ...
  parts = Alloc<List<Str*>>();
  parts->append(str1244);
  _encode(s, bit8_display, false, parts);
  parts->append(str1245);
  return str1246->join(parts);
}
...
Str* encode(Str* s, int bit8_display) {
  ...
  _encode(s, bit8_display, false, parts);
  parts->append(str1248);
  return str1249->join(parts);
}
...
void _encode_bytes_x(Str* s, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (str_equals(byte, str1250)) {
      part = str1251;
    }
    else {
      if (str_equals(byte, str1252)) {
        part = str1253;
      }
      else {
        if (str_equals(byte, str1254)) {
          part = str1255;
        }
        else {
          if (str_equals(byte, str1256)) {
            part = str1257;
          }
          else {
            if (str_equals(byte, str1258)) {
              part = str1259;
            }
            else {
              if (str_equals(byte, str1260)) {
                part = shell_compat ? str1261 : str1262;
              }
              else {
...
bool _encode_runes(Str* s, int bit8_display, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (typ == Ascii) {
      state = Start;
      if (str_equals(byte, str1266)) {
        out = str1267;
      }
      else {
        if (str_equals(byte, str1268)) {
          out = str1269;
        }
        else {
          if (str_equals(byte, str1270)) {
            out = str1271;
          }
          else {
            if (str_equals(byte, str1272)) {
              out = str1273;
            }
            else {
              if (str_equals(byte, str1274)) {
                out = str1275;
              }
              else {
                if (str_equals(byte, str1276)) {
                  out = shell_compat ? str1277 : str1278;
                }
                else {
                  if (IsUnprintableLow(byte)) {
...
syntax_asdl::word__String* _StringWordEmitter::ReadWord(types_asdl::lex_mode_t unused_lex_mode) {
  ...
  if (this->i == this->n) {
    w = Alloc<word::String>(Id::Eof_Real, str1279, runtime::NO_SPID);
    return w;
  }
...
syntax_asdl::bool_expr_t* _TwoArgs(builtin_bracket::_StringWordEmitter* w_parser) {
  ...
  w1 = w_parser->Read();
  s0 = w0->s;
  if (maybe_str_equals(s0, str1280)) {
    return Alloc<bool_expr::LogicalNot>(Alloc<bool_expr::WordTest>(w1));
  }
  unary_id = Id::Undefined_Tok;
  if (w0->s->startswith(str1281)) {
    if (maybe_str_equals(s0, str1282)) {
      unary_id = Id::BoolUnary_d;
    }
    else {
      if (maybe_str_equals(s0, str1283)) {
        unary_id = Id::BoolUnary_e;
      }
      else {
        if (maybe_str_equals(s0, str1284)) {
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    ...
    strs = cmd_val->argv;
    if ((!strs or !(str_equals(strs->index(-1), str1294)))) {
      this->errfmt->Print_(str1295, cmd_val->arg_spids->index(0));
      return 2;
    }
    cmd_val->argv->pop();
  ...
  try {
    ...
    if (n == 4) {
      a0 = w_parser->Peek(0);
      if (str_equals(a0, str1297)) {
        w_parser->Read();
        child = _ThreeArgs(w_parser);
        bool_node = Alloc<bool_expr::LogicalNot>(child);
      }
      else {
        if ((str_equals(a0, str1298) and str_equals(w_parser->Peek(3), str1299))) {
          w_parser->Read();
          bool_node = _TwoArgs(w_parser);
        }
        else {
    ...
    this->errfmt->PrettyPrintError(e, str1300);
    return 2;
  }
  ...
  try {
    ...
    this->errfmt->PrettyPrintError(e, str1301);
    return 2;
  }
  status = b ? 0 : 1;
  return status;

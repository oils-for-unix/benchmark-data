...
List<int>* STRICT_ALL = new List<int>({3, 19, 2, 18, 40, 4, 20, 21, 22, 29, 23, 24, 25, 26, 30, 27, 28});
List<int>* OIL_BASIC = new List<int>({32, 3, 19, 33, 2, 18, 35, 36, 40, 37, 38, 39, 4, 34, 31, 20, 21, 22, 29, 23, 24, 25, 26, 30, 27, 28});
List<int>* OIL_ALL = new List<int>({32, 3, 19, 33, 2, 18, 35, 36, 42, 40, 37, 38, 39, 41, 4, 34, 31, 20, 21, 22, 29, 23, 24, 25, 26, 30, 27, 28});
List<int>* DEFAULT_TRUE = new List<int>({32, 3, 40});
List<int>* PARSE_OPTION_NUMS = new List<int>({35, 36, 16, 42, 40, 37, 38, 39, 41});
List<int>* SHOPT_OPTION_NUMS = new List<int>({50, 51, 52, 53, 54, 55, 56, 49, 17, 57, 32, 58, 59, 60, 15, 61, 43, 62, 44, 63, 14, 64, 65, 66, 67, 47, 68, 69, 48, 70, 19, 71, 45, 72, 73, 74, 75, 76, 33, 77, 78, 79, 18, 35, 36, 16, 42, 40, 37, 38, 39, 41, 46, 80, 81, 82, 83, 34, 31, 84, 20, 21, 22, 29, 23, 24, 25, 26, 30, 27, 28, 85});

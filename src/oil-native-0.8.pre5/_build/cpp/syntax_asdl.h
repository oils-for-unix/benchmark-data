...
class command_sub : public word_part_t, public expr_t {
 public:
  command_sub() : tag(1007), left_token(nullptr), child(nullptr), spids(new
              List<int>()) {
  }
  command_sub(Token* left_token, command_t* child) : tag(1007),

...
GLOBAL_STR(str70, "can't disable errexit running a function. Maybe wrap the function in a process with the at-splice pattern.");
GLOBAL_STR(str71, "Unexpected block passed to external command %r");
GLOBAL_STR(str72, "%r not found");
GLOBAL_STR(str73, "[%%%d] Started Pipeline with PID %d");
GLOBAL_STR(str74, "[%%%d] Started PID %d");
GLOBAL_STR(str75, "__cat");
GLOBAL_STR(str76, "Command sub exited with status %d (%s)");
GLOBAL_STR(str77, "");
GLOBAL_STR(str78, "\n");
GLOBAL_STR(str79, "/dev/fd/%d");
GLOBAL_STR(str80, "/dev/fd/%d");
GLOBAL_STR(str81, "<_FdFrame %s>");
GLOBAL_STR(str82, "r");
GLOBAL_STR(str83, "%d: %s");
GLOBAL_STR(str84, "%d: %s");
GLOBAL_STR(str85, "%d: %s");
GLOBAL_STR(str86, "Can't open %r: %s");
GLOBAL_STR(str87, "Error closing descriptor %d: %s");
GLOBAL_STR(str88, "dup2(%d, %d) error: %s");
GLOBAL_STR(str89, "<StdinFromPipe %d %d>");
GLOBAL_STR(str90, "<StdoutToPipe %d %d>");
GLOBAL_STR(str91, "/bin/sh");
GLOBAL_STR(str92, "/bin/sh");
GLOBAL_STR(str93, "Can't execute %r: %s");
GLOBAL_STR(str94, "[process] %s");
GLOBAL_STR(str95, " ");
GLOBAL_STR(str96, "[subprog] %s");
GLOBAL_STR(str97, "");
GLOBAL_STR(str98, "osh I/O error: %s");
GLOBAL_STR(str99, "[here doc writer]");
GLOBAL_STR(str100, "<Process %s>");
GLOBAL_STR(str101, "Fatal error in posix.fork()");
GLOBAL_STR(str102, "<Pipeline %s>");
GLOBAL_STR(str103, " ");
GLOBAL_STR(str104, "JobState MaybeRemove %d");
GLOBAL_STR(str105, "osh: PID %d stopped, but osh didn't start it");
GLOBAL_STR(str106, "");
GLOBAL_STR(str107, "");
GLOBAL_STR(str108, "[PID %d] Stopped");
GLOBAL_STR(str109, "");
GLOBAL_STR(str110, "main");
GLOBAL_STR(str111, "osh usage error: %s");
GLOBAL_STR(str112, "%s-usage");
GLOBAL_STR(str113, "Oil");
GLOBAL_STR(str114, "main");
GLOBAL_STR(str115, "oil");
GLOBAL_STR(str116, "oil:all");
GLOBAL_STR(str117, "--one-pass-parse requires noexec (-n)");
GLOBAL_STR(str118, "completion");
GLOBAL_STR(str119, "history");
GLOBAL_STR(str120, "");
GLOBAL_STR(str121, "OSH_DEBUG_DIR");
GLOBAL_STR(str122, "%d-osh.log");
GLOBAL_STR(str123, "Writing logs to %r");
GLOBAL_STR(str124, "OSH_HIJACK_SHEBANG");
GLOBAL_STR(str125, "");
GLOBAL_STR(str126, "OSH_CRASH_DUMP_DIR");
GLOBAL_STR(str127, "");
GLOBAL_STR(str128, "");
GLOBAL_STR(str129, "osh: Couldn't open %r: %s");
GLOBAL_STR(str130, "/proc/%d/status");
GLOBAL_STR(str131, "--parser-mem-dump can only be used with -n");
GLOBAL_STR(str132, "/proc/%d/status");
GLOBAL_STR(str133, "can't disable errexit running a function. Maybe wrap the function in a process with the at-splice pattern.");
GLOBAL_STR(str134, "Unhandled SimpleCommand");
GLOBAL_STR(str135, "\n");
GLOBAL_STR(str136, " \t\n\"'><=;|&(:");
GLOBAL_STR(str137, "/");
GLOBAL_STR(str138, "PATH");
GLOBAL_STR(str139, ":");
GLOBAL_STR(str140, "<ErrExit %s %s>");
GLOBAL_STR(str141, "got invalid option %r");
GLOBAL_STR(str142, "doesn't own option %r (try 'set')");
GLOBAL_STR(str143, "got invalid option %r");
GLOBAL_STR(str144, "doesn't own option %r (try 'shopt')");
GLOBAL_STR(str145, "SHELLOPTS");
GLOBAL_STR(str146, ":");
GLOBAL_STR(str147, "Syntax options must be set at the top level (outside any function)");
GLOBAL_STR(str148, "Warning: set -o verbose not implemented");
GLOBAL_STR(str149, "SHELLOPTS");
GLOBAL_STR(str150, "%s:%s");
GLOBAL_STR(str151, "SHELLOPTS");
GLOBAL_STR(str152, ":");
GLOBAL_STR(str153, ":");
GLOBAL_STR(str154, "SHELLOPTS");
GLOBAL_STR(str155, "oil:basic");
GLOBAL_STR(str156, "oil:all");
GLOBAL_STR(str157, "strict:all");
GLOBAL_STR(str158, "errexit");
...
GLOBAL_STR(str210, "PIPESTATUS");
GLOBAL_STR(str211, "FUNCNAME");
GLOBAL_STR(str212, "source");
GLOBAL_STR(str213, "BASH_SOURCE");
GLOBAL_STR(str214, "BASH_LINENO");
GLOBAL_STR(str215, "0");
GLOBAL_STR(str216, "LINENO");
GLOBAL_STR(str217, "BASHPID");
GLOBAL_STR(str218, "Can't unset readonly variable %r");
GLOBAL_STR(str219, "%r isn't an array");
GLOBAL_STR(str220, "$%s isn't defined");
GLOBAL_STR(str221, "$%s should be a string");
GLOBAL_STR(str222, "$%s should be a string, got %s");
GLOBAL_STR(str223, "$%s doesn't look like an integer, got %r");
GLOBAL_STR(str224, "EOF");
GLOBAL_STR(str225, "/");
GLOBAL_STR(str226, "~");
GLOBAL_STR(str227, "  ");
GLOBAL_STR(str228, "\n  ");
...
GLOBAL_STR(str233, "~");
GLOBAL_STR(str234, "\n");
GLOBAL_STR(str235, "[ interactive ]");
GLOBAL_STR(str236, "[ -c flag ]");
GLOBAL_STR(str237, "[ stdin%s ]");
GLOBAL_STR(str238, "[ expansion of alias %r ]");
GLOBAL_STR(str239, "[ backticks at ... ]");
GLOBAL_STR(str240, "[ array LValue in %s ]");
GLOBAL_STR(str241, "[ eval at line %d of %s ]");
GLOBAL_STR(str242, "[ trap ]");
GLOBAL_STR(str243, "[ variable ]");
GLOBAL_STR(str244, "%s:%d: %s%s\n");
GLOBAL_STR(str245, "[??? no location ???] %s%s\n");
GLOBAL_STR(str246, "");
GLOBAL_STR(str247, "");
GLOBAL_STR(str248, "");
GLOBAL_STR(str249, "none");
GLOBAL_STR(str250, "AST not printed.");
GLOBAL_STR(str251, "text");
GLOBAL_STR(str252, "abbrev-text");
GLOBAL_STR(str253, "html");
GLOBAL_STR(str254, "abbrev-html");
GLOBAL_STR(str255, "abbrev-");
GLOBAL_STR(str256, "\n");
GLOBAL_STR(str257, "\n");
GLOBAL_STR(str258, "-");
GLOBAL_STR(str259, "_");
GLOBAL_STR(str260, "<_Attributes %s>");
GLOBAL_STR(str261, "<args.Reader %r %d>");
GLOBAL_STR(str262, "expected argument to %r");
GLOBAL_STR(str263, "-");
GLOBAL_STR(str264, "expected integer after %s, got %r");
GLOBAL_STR(str265, "-");
GLOBAL_STR(str266, "got invalid integer for %s: %s");
GLOBAL_STR(str267, "-");
GLOBAL_STR(str268, "expected number after %r, got %r");
GLOBAL_STR(str269, "-");
GLOBAL_STR(str270, "got invalid float for %s: %s");
GLOBAL_STR(str271, "-");
GLOBAL_STR(str272, "got invalid argument %r to %r, expected one of: %s");
GLOBAL_STR(str273, "-");
GLOBAL_STR(str274, "|");
GLOBAL_STR(str275, "0");
GLOBAL_STR(str276, "F");
GLOBAL_STR(str277, "false");
GLOBAL_STR(str278, "False");
GLOBAL_STR(str279, "1");
GLOBAL_STR(str280, "T");
GLOBAL_STR(str281, "true");
GLOBAL_STR(str282, "Talse");
GLOBAL_STR(str283, "got invalid argument to boolean flag: %r");
GLOBAL_STR(str284, "-");
GLOBAL_STR(str285, "-");
GLOBAL_STR(str286, "got invalid option %r");
GLOBAL_STR(str287, "Expected argument for action");
GLOBAL_STR(str288, "Invalid action name %r");
GLOBAL_STR(str289, "--");
GLOBAL_STR(str290, "-");
GLOBAL_STR(str291, "-");
GLOBAL_STR(str292, "doesn't accept flag %s");
GLOBAL_STR(str293, "-");
GLOBAL_STR(str294, "+");
GLOBAL_STR(str295, "+");
GLOBAL_STR(str296, "doesn't accept option %s");
GLOBAL_STR(str297, "+");
GLOBAL_STR(str298, "-");
GLOBAL_STR(str299, "--");
GLOBAL_STR(str300, "--");
GLOBAL_STR(str301, "got invalid flag %r");
GLOBAL_STR(str302, "-");
GLOBAL_STR(str303, "+");
GLOBAL_STR(str304, "got invalid flag %r");
GLOBAL_STR(str305, "-");
GLOBAL_STR(str306, "^--?([a-zA-Z0-9][a-zA-Z0-9\\-]*)(=.*)?$");
GLOBAL_STR(str307, "<LineLexer at pos %d of line %r (id = %d)>");
GLOBAL_STR(str308, "");
GLOBAL_STR(str309, "");
GLOBAL_STR(str310, "");
GLOBAL_STR(str311, "<Trail %s %s %s %s>");
GLOBAL_STR(str312, "");
GLOBAL_STR(str313, "ShAssignment expression can't be nested like this");
GLOBAL_STR(str314, "Here docs aren't allowed in expressions");
GLOBAL_STR(str315, "\n");
GLOBAL_STR(str316, "");
GLOBAL_STR(str317, " (%s)");
GLOBAL_STR(str318, "Unexpected token in expression mode%s");
GLOBAL_STR(str319, "Syntax error in expression (near %s)");
GLOBAL_STR(str320, "alnum");
GLOBAL_STR(str321, "cntrl");
GLOBAL_STR(str322, "lower");
GLOBAL_STR(str323, "space");
GLOBAL_STR(str324, "alpha");
GLOBAL_STR(str325, "digit");
GLOBAL_STR(str326, "print");
GLOBAL_STR(str327, "upper");
GLOBAL_STR(str328, "blank");
GLOBAL_STR(str329, "graph");
GLOBAL_STR(str330, "punct");
GLOBAL_STR(str331, "xdigit");
GLOBAL_STR(str332, "Range start/end shouldn't have more than one character");
GLOBAL_STR(str333, "Write singleton tuples with tup(), not a trailing comma");
GLOBAL_STR(str334, "testlist_comp");
GLOBAL_STR(str335, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str336, "Can't assign to this expression");
GLOBAL_STR(str337, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str338, "TODO");
GLOBAL_STR(str339, "dot");
GLOBAL_STR(str340, "Can't negate this symbol");
GLOBAL_STR(str341, "%r isn't a character class");
GLOBAL_STR(str342, "Can't negate this symbol");
GLOBAL_STR(str343, "%r isn't a character class");
GLOBAL_STR(str344, "%start");
GLOBAL_STR(str345, "%end");
GLOBAL_STR(str346, "dot");
GLOBAL_STR(str347, "Unexpected token %r in regex");
GLOBAL_STR(str348, "%s-%s");
GLOBAL_STR(str349, "ERE can't express code point %d");
GLOBAL_STR(str350, "Perl classes can't be negated in ERE");
GLOBAL_STR(str351, "%s");
GLOBAL_STR(str352, "POSIX classes can't be negated in ERE");
GLOBAL_STR(str353, "[:%s:]");
GLOBAL_STR(str354, ".");
GLOBAL_STR(str355, "^");
GLOBAL_STR(str356, "$");
GLOBAL_STR(str357, "|");
GLOBAL_STR(str358, "POSIX EREs don't have groups without capture, so this node needs () around it.");
GLOBAL_STR(str359, "+");
GLOBAL_STR(str360, "*");
GLOBAL_STR(str361, "?");
GLOBAL_STR(str362, "{%s}");
...
GLOBAL_STR(str373, "^");
GLOBAL_STR(str374, "]");
GLOBAL_STR(str375, "The [ operator doesn't apply to this expression");
GLOBAL_STR(str376, "Expected ]]");
GLOBAL_STR(str377, "Unexpected trailing word %s");
GLOBAL_STR(str378, "Invalid argument to unary operator");
GLOBAL_STR(str379, "Expected ), got %s");
GLOBAL_STR(str380, "Unexpected token in boolean expression (%s)");
GLOBAL_STR(str381, "");
GLOBAL_STR(str382, "Expected %d, got %d");
GLOBAL_STR(str383, "Step can't be 0");
GLOBAL_STR(str384, "Invalid step %d for ascending integer range");
GLOBAL_STR(str385, "Invalid step %d for descending integer range");
GLOBAL_STR(str386, "Invalid step %d for ascending character range");
GLOBAL_STR(str387, "Invalid step %d for descending character range");
GLOBAL_STR(str388, "Mismatched cases in character range");
GLOBAL_STR(str389, "");
GLOBAL_STR(str390, "0");
GLOBAL_STR(str391, "0");
GLOBAL_STR(str392, "g");
...
GLOBAL_STR(str429, ")");
GLOBAL_STR(str430, "");
GLOBAL_STR(str431, "export_");
GLOBAL_STR(str432, "doesn't accept -f because it's dangerous.  (The code can usually be restructured with 'source')");
GLOBAL_STR(str433, "doesn't accept RHS with -n");
GLOBAL_STR(str434, "Got -a but RHS isn't an array");
GLOBAL_STR(str435, "Got -A but RHS isn't an associative array");
GLOBAL_STR(str436, "readonly");
GLOBAL_STR(str437, "new_var");
GLOBAL_STR(str438, "passed -f without args");
GLOBAL_STR(str439, "declare -f %s");
GLOBAL_STR(str440, "-");
GLOBAL_STR(str441, "-");
GLOBAL_STR(str442, "-");
GLOBAL_STR(str443, "+");
GLOBAL_STR(str444, "+");
GLOBAL_STR(str445, "+");
GLOBAL_STR(str446, "Invalid unset expression");
GLOBAL_STR(str447, "expected a variable name.  shopt -s eval_unsafe_arith allows expressions");
GLOBAL_STR(str448, "unset");
GLOBAL_STR(str449, "Invalid shift argument %r");
GLOBAL_STR(str450, "got too many arguments");
GLOBAL_STR(str451, "eval");
GLOBAL_STR(str452, "requires code string");
GLOBAL_STR(str453, "requires exactly 1 argument");
GLOBAL_STR(str454, " ");
GLOBAL_STR(str455, "source");
GLOBAL_STR(str456, "missing required argument");
GLOBAL_STR(str457, "source %r failed: %s");
GLOBAL_STR(str458, "command");
GLOBAL_STR(str459, "Can't run assignment builtin recursively");
GLOBAL_STR(str460, "%r isn't a shell builtin");
GLOBAL_STR(str461, "function");
GLOBAL_STR(str462, "alias");
GLOBAL_STR(str463, "builtin");
GLOBAL_STR(str464, "builtin");
GLOBAL_STR(str465, "builtin");
GLOBAL_STR(str466, "keyword");
GLOBAL_STR(str467, "keyword");
GLOBAL_STR(str468, "file");
GLOBAL_STR(str469, "type");
GLOBAL_STR(str470, "type: %r not found");
GLOBAL_STR(str471, "file");
GLOBAL_STR(str472, "file");
GLOBAL_STR(str473, "%s is a %s");
GLOBAL_STR(str474, "function");
GLOBAL_STR(str475, "");
GLOBAL_STR(str476, "read");
GLOBAL_STR(str477, "read -t isn't implemented (except t=0)");
GLOBAL_STR(str478, "");
GLOBAL_STR(str479, "REPLY");
GLOBAL_STR(str480, "REPLY");
GLOBAL_STR(str481, "\u0000");
GLOBAL_STR(str482, "\n");
GLOBAL_STR(str483, "");
GLOBAL_STR(str484, "mapfile");
GLOBAL_STR(str485, "MAPFILE");
GLOBAL_STR(str486, "\n");
GLOBAL_STR(str487, "cd");
GLOBAL_STR(str488, "HOME");
GLOBAL_STR(str489, "HOME");
GLOBAL_STR(str490, "-");
GLOBAL_STR(str491, "OLDPWD");
GLOBAL_STR(str492, "PWD");
GLOBAL_STR(str493, "cd %r: %s");
GLOBAL_STR(str494, "PWD");
GLOBAL_STR(str495, "OLDPWD");
GLOBAL_STR(str496, "%2d  %s");
GLOBAL_STR(str497, " ");
GLOBAL_STR(str498, "pushd: no other directory");
GLOBAL_STR(str499, "got too many arguments");
GLOBAL_STR(str500, "pushd: %r: %s");
GLOBAL_STR(str501, "HOME");
GLOBAL_STR(str502, "PWD");
GLOBAL_STR(str503, "popd: directory stack is empty");
GLOBAL_STR(str504, "popd: %r: %s");
GLOBAL_STR(str505, "PWD");
GLOBAL_STR(str506, "got extra argument");
GLOBAL_STR(str507, "HOME");
GLOBAL_STR(str508, "dirs");
GLOBAL_STR(str509, "HOME");
GLOBAL_STR(str510, "pwd");
GLOBAL_STR(str511, "_devbuild/help/groups.txt");
GLOBAL_STR(str512, "help");
GLOBAL_STR(str513, "help");
GLOBAL_STR(str514, "_devbuild/help/%s");
GLOBAL_STR(str515, "no help topics match %r");
GLOBAL_STR(str516, "# +");
GLOBAL_STR(str517, "osh printf doesn't support the %r flag");
GLOBAL_STR(str518, "eEfFgG");
GLOBAL_STR(str519, "osh printf doesn't support floating point");
GLOBAL_STR(str520, "c");
GLOBAL_STR(str521, "osh printf doesn't support single characters (bytes)");
GLOBAL_STR(str522, "Invalid printf format character");
GLOBAL_STR(str523, "Expected a printf format character");
GLOBAL_STR(str524, "fsT");
GLOBAL_STR(str525, "printf precision can't be specified with type %r");
GLOBAL_STR(str526, "printf");
GLOBAL_STR(str527, "requires a format string");
GLOBAL_STR(str528, "%");
GLOBAL_STR(str529, "");
GLOBAL_STR(str530, "printf got invalid width %r");
GLOBAL_STR(str531, "0");
GLOBAL_STR(str532, "");
GLOBAL_STR(str533, "printf got invalid precision %r");
GLOBAL_STR(str534, "");
GLOBAL_STR(str535, "s");
GLOBAL_STR(str536, "q");
GLOBAL_STR(str537, "b");
GLOBAL_STR(str538, "");
GLOBAL_STR(str539, "diouxX");
GLOBAL_STR(str540, "'\"");
GLOBAL_STR(str541, "printf expected an integer, got %r");
GLOBAL_STR(str542, "di");
GLOBAL_STR(str543, "ouxX");
GLOBAL_STR(str544, "Can't format negative number %d with %%%s");
GLOBAL_STR(str545, "u");
GLOBAL_STR(str546, "o");
GLOBAL_STR(str547, "x");
GLOBAL_STR(str548, "X");
GLOBAL_STR(str549, "TZ");
GLOBAL_STR(str550, "TZ");
GLOBAL_STR(str551, "-");
GLOBAL_STR(str552, " ");
GLOBAL_STR(str553, "0");
GLOBAL_STR(str554, "0");
GLOBAL_STR(str555, " ");
GLOBAL_STR(str556, "");
GLOBAL_STR(str557, "Invalid -v expression");
GLOBAL_STR(str558, "-v expected a variable name.  shopt -s eval_unsafe_arith allows expressions");
GLOBAL_STR(str559, "alias");
GLOBAL_STR(str560, "alias %s=%r");
GLOBAL_STR(str561, "=");
GLOBAL_STR(str562, "No alias named %r");
GLOBAL_STR(str563, "alias %s=%r");
GLOBAL_STR(str564, "unalias");
GLOBAL_STR(str565, "requires an argument");
GLOBAL_STR(str566, "No alias named %r");
GLOBAL_STR(str567, "%s=%s");
GLOBAL_STR(str568, "set");
GLOBAL_STR(str569, "shopt");
GLOBAL_STR(str570, "hash");
GLOBAL_STR(str571, "got extra arguments after -r");
GLOBAL_STR(str572, "hash: %r not found");
GLOBAL_STR(str573, ":");
GLOBAL_STR(str574, "OPTIND");
GLOBAL_STR(str575, "OPTIND");
GLOBAL_STR(str576, "OPTARG");
GLOBAL_STR(str577, "OPTARG");
GLOBAL_STR(str578, "");
GLOBAL_STR(str579, "?");
GLOBAL_STR(str580, "-");
GLOBAL_STR(str581, "-");
GLOBAL_STR(str582, "?");
GLOBAL_STR(str583, "?");
GLOBAL_STR(str584, "getopts: option %r requires an argument.");
GLOBAL_STR(str585, "(getopts argv: %s)");
GLOBAL_STR(str586, " ");
GLOBAL_STR(str587, "?");
GLOBAL_STR(str588, "");
GLOBAL_STR(str589, "requires an argspec");
GLOBAL_STR(str590, "requires the name of a variable to set");
GLOBAL_STR(str591, "got invalid variable name %r");
GLOBAL_STR(str592, "echo");
GLOBAL_STR(str593, "");
GLOBAL_STR(str594, "takes at most one arg when strict_echo is on (hint: add quotes)");
GLOBAL_STR(str595, " ");
GLOBAL_STR(str596, "\n");
GLOBAL_STR(str597, "Assignment builtin %r not configured");
GLOBAL_STR(str598, "%r ");
GLOBAL_STR(str599, "");
GLOBAL_STR(str600, "command in ");
GLOBAL_STR(str601, "assignment in ");
GLOBAL_STR(str602, "subshell invoked from ");
GLOBAL_STR(str603, "pipeline invoked from ");
GLOBAL_STR(str604, "");
GLOBAL_STR(str605, "Exiting with status %d (%sPID %d)");
GLOBAL_STR(str606, "Redirect filename can't be empty");
GLOBAL_STR(str607, "Redirect descriptor can't be empty");
GLOBAL_STR(str608, "-");
GLOBAL_STR(str609, "-");
GLOBAL_STR(str610, "Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
GLOBAL_STR(str611, "\n");
GLOBAL_STR(str612, "Unknown redirect op");
GLOBAL_STR(str613, "Unknown redirect type");
GLOBAL_STR(str614, "TODO: trace string for assignment");
GLOBAL_STR(str615, "ShAssignment builtins don't accept blocks");
GLOBAL_STR(str616, "|& isn't supported");
GLOBAL_STR(str617, "Can't append array to string");
GLOBAL_STR(str618, "Can't append string to array");
GLOBAL_STR(str619, "%r expected a number, got %r");
GLOBAL_STR(str620, "Invalid control flow at top level");
GLOBAL_STR(str621, "warning: ");
GLOBAL_STR(str622, "errexit is disabled here, but strict_errexit disallows it with a compound command (%s)");
GLOBAL_STR(str623, "Loop and control flow can't be in different processes");
GLOBAL_STR(str624, "fatal: ");
GLOBAL_STR(str625, "EXIT");
GLOBAL_STR(str626, "Unexpected %r (in function call)");
GLOBAL_STR(str627, "Attempted to exit from completion hook.");
GLOBAL_STR(str628, "Couldn't find terminator for here doc that starts here");
GLOBAL_STR(str629, "\t");
GLOBAL_STR(str630, "Invalid here doc delimiter");
GLOBAL_STR(str631, "+");
GLOBAL_STR(str632, "+");
GLOBAL_STR(str633, "+");
GLOBAL_STR(str634, "%d != %d");
GLOBAL_STR(str635, "Environment binding shouldn't look like an array assignment");
GLOBAL_STR(str636, "+");
GLOBAL_STR(str637, "Expected = in environment binding, got +=");
GLOBAL_STR(str638, "Environment bindings can't contain array literals");
GLOBAL_STR(str639, "Expected word type %s, got %s");
GLOBAL_STR(str640, "{");
GLOBAL_STR(str641, "}");
GLOBAL_STR(str642, "Invalid token after redirect operator");
GLOBAL_STR(str643, " ");
GLOBAL_STR(str644, " ");
GLOBAL_STR(str645, "line IDs %d != %d");
GLOBAL_STR(str646, " ");
GLOBAL_STR(str647, "");
GLOBAL_STR(str648, "Unexpected block");
GLOBAL_STR(str649, "=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
GLOBAL_STR(str650, "name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
GLOBAL_STR(str651, "Unexpected block");
GLOBAL_STR(str652, "Unexpected block");
GLOBAL_STR(str653, "Control flow shouldn't have redirects");
GLOBAL_STR(str654, "Control flow shouldn't have environment bindings");
GLOBAL_STR(str655, "Unexpected argument to %r");
GLOBAL_STR(str656, "Invalid word in for loop");
GLOBAL_STR(str657, "Invalid word after for expression");
GLOBAL_STR(str658, "Loop variable name should be a constant");
GLOBAL_STR(str659, "Invalid loop variable name");
GLOBAL_STR(str660, "Unexpected word after for loop variable");
GLOBAL_STR(str661, "Expected ;; or esac");
GLOBAL_STR(str662, "Unexpected word while parsing compound command");
GLOBAL_STR(str663, "Invalid function name");
GLOBAL_STR(str664, "Expected ) in function definition");
GLOBAL_STR(str665, "Invalid KSH-style function name");
GLOBAL_STR(str666, "Unexpected word when parsing command");
GLOBAL_STR(str667, "Unexpected right brace");
GLOBAL_STR(str668, "Unexpected EOF while parsing command");
GLOBAL_STR(str669, "Invalid word while parsing command");
GLOBAL_STR(str670, "Unexpected word while parsing command line");
GLOBAL_STR(str671, "Unterminated here doc began here");
GLOBAL_STR(str672, "\\");
GLOBAL_STR(str673, "*");
GLOBAL_STR(str674, "?");
GLOBAL_STR(str675, "[");
...
GLOBAL_STR(str679, "\\?*+{}^$.()|");
GLOBAL_STR(str680, "\\");
GLOBAL_STR(str681, "Unexpected escaped character %r");
GLOBAL_STR(str682, "");
GLOBAL_STR(str683, "");
GLOBAL_STR(str684, "Malformed character class; treating as literal");
GLOBAL_STR(str685, "Got unescaped right bracket");
GLOBAL_STR(str686, "Got unescaped trailing backslash");
GLOBAL_STR(str687, ".|^$()+*?[]{}\\");
GLOBAL_STR(str688, "\\");
GLOBAL_STR(str689, "\\");
GLOBAL_STR(str690, "\\[");
...
GLOBAL_STR(str702, "]");
GLOBAL_STR(str703, "");
GLOBAL_STR(str704, "Error expanding glob %r: %s");
GLOBAL_STR(str705, "-");
GLOBAL_STR(str706, "<Error: unbalanced \\[ and \\]> ");
GLOBAL_STR(str707, "$");
GLOBAL_STR(str708, "#");
GLOBAL_STR(str709, "$");
GLOBAL_STR(str710, "hostname");
GLOBAL_STR(str711, "user");
GLOBAL_STR(str712, "$ ");
GLOBAL_STR(str713, "\u0001");
GLOBAL_STR(str714, "\u0002");
GLOBAL_STR(str715, "$");
GLOBAL_STR(str716, "$");
GLOBAL_STR(str717, "u");
GLOBAL_STR(str718, "user");
GLOBAL_STR(str719, "h");
GLOBAL_STR(str720, "hostname");
GLOBAL_STR(str721, ".");
GLOBAL_STR(str722, "H");
GLOBAL_STR(str723, "hostname");
GLOBAL_STR(str724, "w");
GLOBAL_STR(str725, "PWD");
GLOBAL_STR(str726, "HOME");
GLOBAL_STR(str727, "<Error: %s>");
GLOBAL_STR(str728, "W");
GLOBAL_STR(str729, "PWD");
GLOBAL_STR(str730, "<Error: PWD is not a string> ");
GLOBAL_STR(str731, "<Error: \\%s not implemented in $PS1> ");
GLOBAL_STR(str732, "$");
GLOBAL_STR(str733, "\\$");
GLOBAL_STR(str734, "Invalid token %r");
GLOBAL_STR(str735, "");
GLOBAL_STR(str736, "<ERROR: Can't parse PS1: %s>");
GLOBAL_STR(str737, "osh");
GLOBAL_STR(str738, "PS1");
GLOBAL_STR(str739, "PROMPT_COMMAND");
GLOBAL_STR(str740, "Undefined variable %r");
GLOBAL_STR(str741, "Can't use [] on value of type %s");
GLOBAL_STR(str742, "");
GLOBAL_STR(str743, "Can't use [] on value of type %s");
GLOBAL_STR(str744, "");
GLOBAL_STR(str745, "0x");
GLOBAL_STR(str746, "Invalid hex constant %r");
GLOBAL_STR(str747, "0");
GLOBAL_STR(str748, "Invalid octal constant %r");
GLOBAL_STR(str749, "#");
GLOBAL_STR(str750, "#");
GLOBAL_STR(str751, "Invalid base for numeric constant %r");
GLOBAL_STR(str752, "a");
GLOBAL_STR(str753, "A");
GLOBAL_STR(str754, "@");
GLOBAL_STR(str755, "_");
GLOBAL_STR(str756, "Invalid digits for numeric constant %r");
GLOBAL_STR(str757, "Digits %r out of range for base %d");
GLOBAL_STR(str758, "Parse error in recursive arithmetic");
GLOBAL_STR(str759, "Invalid integer constant %r");
GLOBAL_STR(str760, "Invalid integer constant %r");
GLOBAL_STR(str761, "Invalid integer constant %r");
GLOBAL_STR(str762, "Undefined value in arithmetic context");
GLOBAL_STR(str763, "Expected a value convertible to integer, got %s");
GLOBAL_STR(str764, "0");
GLOBAL_STR(str765, "Divide by zero");
GLOBAL_STR(str766, "Divide by zero");
GLOBAL_STR(str767, "Expected array or assoc in index expression, got %s");
GLOBAL_STR(str768, "Divide by zero");
GLOBAL_STR(str769, "Divide by zero");
GLOBAL_STR(str770, "Exponent can't be less than zero");
GLOBAL_STR(str771, "Associative array keys must be strings: $x 'x' \"$x\" etc.");
GLOBAL_STR(str772, "Invalid place to modify");
GLOBAL_STR(str773, "BASH_REMATCH");
GLOBAL_STR(str774, "%s isn't implemented");
GLOBAL_STR(str775, "Invalid regex %r: %s");
GLOBAL_STR(str776, " \t\n");
GLOBAL_STR(str777, "IFS");
GLOBAL_STR(str778, "IFS shouldn't be an array");
GLOBAL_STR(str779, " \t\n");
GLOBAL_STR(str780, "IFS");
GLOBAL_STR(str781, " ");
GLOBAL_STR(str782, "");
GLOBAL_STR(str783, "IFS shouldn't be an array");
GLOBAL_STR(str784, "\\");
GLOBAL_STR(str785, "\\");
GLOBAL_STR(str786, "Invalid transition from %r with %r");
GLOBAL_STR(str787, "\u00ef\u00bf\u00bd");
GLOBAL_STR(str788, "");
GLOBAL_STR(str789, "Incomplete UTF-8 character");
GLOBAL_STR(str790, "Invalid UTF-8 continuation byte");
GLOBAL_STR(str791, "Invalid start of UTF-8 character");
GLOBAL_STR(str792, "");
GLOBAL_STR(str793, "%s can't have an argument");
GLOBAL_STR(str794, "");
GLOBAL_STR(str795, "%s can't have an argument");
GLOBAL_STR(str796, "");
GLOBAL_STR(str797, "%s can't have an argument");
GLOBAL_STR(str798, "");
GLOBAL_STR(str799, "%s can't have an argument");
GLOBAL_STR(str800, "");
GLOBAL_STR(str801, "<_GlobReplacer regex %r r %r>");
GLOBAL_STR(str802, "(%s)");
GLOBAL_STR(str803, "Error matching regex %r: %s");
GLOBAL_STR(str804, "^");
GLOBAL_STR(str805, "$");
GLOBAL_STR(str806, "\r");
GLOBAL_STR(str807, "<INVALID CR>");
GLOBAL_STR(str808, "\n");
GLOBAL_STR(str809, "<INVALID NEWLINE>");
GLOBAL_STR(str810, " `~!$&*()[]{}\\|;'\"<>?");
GLOBAL_STR(str811, "Left-hand side of this assignment is invalid");
GLOBAL_STR(str812, "Token can't be used in prefix position");
GLOBAL_STR(str813, "Token can't be used in infix position");
GLOBAL_STR(str814, "Parser expected %s, got %s");
GLOBAL_STR(str815, "Unexpected end of input");
GLOBAL_STR(str816, "BASH_SOURCE");
GLOBAL_STR(str817, "FUNCNAME");
GLOBAL_STR(str818, "BASH_LINENO");
GLOBAL_STR(str819, "0");
GLOBAL_STR(str820, "0");
GLOBAL_STR(str821, "");
GLOBAL_STR(str822, "");
...
GLOBAL_STR(str825, "");
GLOBAL_STR(str826, "");
GLOBAL_STR(str827, "The length index of a array slice can't be negative: %d");
GLOBAL_STR(str828, "Can't slice associative arrays");
GLOBAL_STR(str829, "i");
GLOBAL_STR(str830, "e");
GLOBAL_STR(str831, "f");
GLOBAL_STR(str832, "n");
...
GLOBAL_STR(str839, "Error expanding tilde (e.g. invalid user)");
GLOBAL_STR(str840, "Can't assign to special variable");
GLOBAL_STR(str841, "unset variable %r");
GLOBAL_STR(str842, "@");
GLOBAL_STR(str843, "*");
GLOBAL_STR(str844, "@");
GLOBAL_STR(str845, "*");
GLOBAL_STR(str846, "warning: ");
GLOBAL_STR(str847, "-1");
GLOBAL_STR(str848, "@");
GLOBAL_STR(str849, "*");
GLOBAL_STR(str850, "[");
GLOBAL_STR(str851, "]");
GLOBAL_STR(str852, "Bad indirect expansion: %r");
GLOBAL_STR(str853, "");
GLOBAL_STR(str854, "warning: ");
GLOBAL_STR(str855, "");
GLOBAL_STR(str856, "\u0001");
GLOBAL_STR(str857, "");
GLOBAL_STR(str858, "\u0002");
GLOBAL_STR(str859, "");
GLOBAL_STR(str860, "Can't use @P on %s");
GLOBAL_STR(str861, " ");
GLOBAL_STR(str862, "Can't use @Q on %s");
GLOBAL_STR(str863, "a");
GLOBAL_STR(str864, "A");
GLOBAL_STR(str865, "r");
GLOBAL_STR(str866, "x");
GLOBAL_STR(str867, "n");
GLOBAL_STR(str868, "");
GLOBAL_STR(str869, "Var op %r not implemented");
GLOBAL_STR(str870, "Can't index string with @");
GLOBAL_STR(str871, "Can't index string with *");
GLOBAL_STR(str872, "Can't index string %r with integer");
GLOBAL_STR(str873, "");
GLOBAL_STR(str874, "");
GLOBAL_STR(str875, "$");
GLOBAL_STR(str876, "Undefined variable %r");
GLOBAL_STR(str877, "Undefined array %r");
GLOBAL_STR(str878, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str879, "Illegal array word part (strict_array)");
GLOBAL_STR(str880, " ");
GLOBAL_STR(str881, "");
GLOBAL_STR(str882, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str883, "Unexpected array literal");
GLOBAL_STR(str884, "Unexpected associative array literal");
GLOBAL_STR(str885, "@(");
GLOBAL_STR(str886, "|");
GLOBAL_STR(str887, ")");
GLOBAL_STR(str888, "Can't splice %r");
GLOBAL_STR(str889, "");
GLOBAL_STR(str890, "");
GLOBAL_STR(str891, "This word should yield a string, but it contains an array");
GLOBAL_STR(str892, " ");
GLOBAL_STR(str893, "");
GLOBAL_STR(str894, "<Runtime error: %s>");
GLOBAL_STR(str895, "<I/O error: %s>");
GLOBAL_STR(str896, "<Ctrl-C>");
GLOBAL_STR(str897, "");
GLOBAL_STR(str898, "");
GLOBAL_STR(str899, "");
GLOBAL_STR(str900, "");
GLOBAL_STR(str901, "");
GLOBAL_STR(str902, "LHS array not allowed in assignment builtin");
GLOBAL_STR(str903, "+");
GLOBAL_STR(str904, "+= not allowed in assignment builtin");
GLOBAL_STR(str905, "-");
GLOBAL_STR(str906, "+");
GLOBAL_STR(str907, "f");
GLOBAL_STR(str908, "F");
GLOBAL_STR(str909, "");
GLOBAL_STR(str910, "=");
GLOBAL_STR(str911, "Invalid variable name %r");
GLOBAL_STR(str912, "__NO_COMMAND_SUB__");
GLOBAL_STR(str913, "__NO_PROCESS_SUB__");
GLOBAL_STR(str914, "Expected : or } in slice");
GLOBAL_STR(str915, "Pattern in ${x/pat/replace} must not be empty");
GLOBAL_STR(str916, "Expected } after replacement string, got %s");
GLOBAL_STR(str917, "Expected } or / to close pattern");
GLOBAL_STR(str918, "Expected ] to close subscript");
GLOBAL_STR(str919, "Expected } to close ${");
GLOBAL_STR(str920, "Expected } to close ${");
GLOBAL_STR(str921, "Expected } to close ${");
GLOBAL_STR(str922, "Unexpected token in ${} (%s)");
GLOBAL_STR(str923, "VOp2");
GLOBAL_STR(str924, "Unexpected token in ${} (%s)");
GLOBAL_STR(str925, "VOp3");
GLOBAL_STR(str926, "Expected } to close ${");
GLOBAL_STR(str927, "Expected } after length expression");
GLOBAL_STR(str928, "Unexpected token in ${}");
GLOBAL_STR(str929, "'");
GLOBAL_STR(str930, "\\");
GLOBAL_STR(str931, "Strings with backslashes should look like r'\\n' or c'\\n'");
GLOBAL_STR(str932, "Invalid char escape in C-style string literal");
GLOBAL_STR(str933, "Unexpected EOF in single-quoted string that began here");
GLOBAL_STR(str934, "Unexpected EOF reading extended glob that began here");
GLOBAL_STR(str935, "Invalid char escape in double quoted string");
GLOBAL_STR(str936, "Invalid backtick: use $(cmd) or \\` in Oil strings");
GLOBAL_STR(str937, "Unexpected EOF reading double-quoted string that began here");
GLOBAL_STR(str938, "Use $(cmd) instead of backticks (strict_backticks)");
GLOBAL_STR(str939, "Unexpected EOF while looking for closing backtick");
GLOBAL_STR(str940, "");
GLOBAL_STR(str941, "Invalid proc name %s");
GLOBAL_STR(str942, "Unexpected token after arithmetic expression (%s != %s)");
GLOBAL_STR(str943, "Expected second ) to end arith sub");
GLOBAL_STR(str944, "Expected second ) to end arith statement");
GLOBAL_STR(str945, "Expected ; here");
GLOBAL_STR(str946, "Expected ; here");
GLOBAL_STR(str947, "Expected ) to end for loop expression");
GLOBAL_STR(str948, "Expected ( after =");
GLOBAL_STR(str949, "Unexpected token in array literal");
GLOBAL_STR(str950, "Expected associative array pair");
GLOBAL_STR(str951, "Unexpected token after array literal");
GLOBAL_STR(str952, "Unexpected token after array splice");
GLOBAL_STR(str953, "Word has unbalanced { }.  Maybe add a space or quote it like \\{");
GLOBAL_STR(str954, "Unexpected token while parsing arithmetic: %r");
GLOBAL_STR(str955, "Unhandled: %s (%s)");
GLOBAL_STR(str956, "Invalid lex state %s");
GLOBAL_STR(str957, "");
GLOBAL_STR(str958, "");
GLOBAL_STR(str959, "");
GLOBAL_STR(str960, "");
...
GLOBAL_STR(str964, "");
GLOBAL_STR(str965, "");
GLOBAL_STR(str966, "Compound shouldn't be empty");
GLOBAL_STR(str967, "/");
GLOBAL_STR(str968, "/");
GLOBAL_STR(str969, "");
GLOBAL_STR(str970, "EOF");
GLOBAL_STR(str971, "typ");
GLOBAL_STR(str972, "tok");
GLOBAL_STR(str973, "children");
GLOBAL_STR(str974, "-");
GLOBAL_STR(str975, "with %d children");
GLOBAL_STR(str976, "");
GLOBAL_STR(str977, "(PNode %s %s %s)");
GLOBAL_STR(str978, "&");
GLOBAL_STR(str979, "&amp;");
GLOBAL_STR(str980, "<");
GLOBAL_STR(str981, "&lt;");
...
GLOBAL_STR(str1023, "\n");
GLOBAL_STR(str1024, "\\n");
GLOBAL_STR(str1025, "\r");
GLOBAL_STR(str1026, "\\r");
GLOBAL_STR(str1027, "\t");
GLOBAL_STR(str1028, "\\t");
GLOBAL_STR(str1029, "\u0000");
GLOBAL_STR(str1030, "\\x00");
GLOBAL_STR(str1031, "\\0");
GLOBAL_STR(str1032, "");
GLOBAL_STR(str1033, "");
GLOBAL_STR(str1034, "");
GLOBAL_STR(str1035, "\\");
...
GLOBAL_STR(str1039, "\n");
GLOBAL_STR(str1040, "\\n");
GLOBAL_STR(str1041, "\r");
GLOBAL_STR(str1042, "\\r");
GLOBAL_STR(str1043, "\t");
GLOBAL_STR(str1044, "\\t");
GLOBAL_STR(str1045, "\u0000");
GLOBAL_STR(str1046, "\\x00");
GLOBAL_STR(str1047, "\\0");
GLOBAL_STR(str1048, "");
GLOBAL_STR(str1049, "!");
GLOBAL_STR(str1050, "Expected unary operator, got %r (2 args)");
GLOBAL_STR(str1051, "-a");
GLOBAL_STR(str1052, "-o");
GLOBAL_STR(str1053, "!");
GLOBAL_STR(str1054, "(");
GLOBAL_STR(str1055, ")");
GLOBAL_STR(str1056, "Expected binary operator, got %r (3 args)");
GLOBAL_STR(str1057, "]");
GLOBAL_STR(str1058, "missing closing ]");
GLOBAL_STR(str1059, "!");
GLOBAL_STR(str1060, "(");
GLOBAL_STR(str1061, ")");
GLOBAL_STR(str1062, "(test) ");
GLOBAL_STR(str1063, "(test) ");
...
inline Str* fmt276(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt289(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("/", 1);
  gBuf.format_s(a1);
...
int ShellExecutor::RunPipeline(syntax_asdl::command__Pipeline* node) {
  ...
  pi->AddLast((Alloc<Tuple2<cmd_eval::CommandEvaluator*, syntax_asdl::command_t*>>(this->cmd_ev, node->children->index((n - 1)))));
...
Str* ShellExecutor::RunCommandSub(syntax_asdl::command_t* node) {
  ...
  if (node->tag_() == command_e::Simple) {
    ...
    if ((len(simple->words) == 0 and (len(simple->redirects) == 1 and simple->redirects->index(0)->op->id == Id::Redir_Less))) {
      tok = Alloc<Token>(Id::Lit_Chars, runtime::NO_SPID, str75);
  ...
  if (this->exec_opts->more_errexit()) {
    if ((this->exec_opts->errexit() and status != 0)) {
      throw Alloc<error::ErrExit>(fmt18(status, ui::CommandType(node)), runtime::NO_SPID, status);
    }
  }
  else {
...
void ExternalProgram::_Exec(Str* argv0_path, List<Str*>* argv, int argv0_spid, Dict<Str*, Str*>* environ, bool should_retry) {
  ...
  try {
    ...
    if ((e->errno == errno_::ENOEXEC and should_retry)) {
      new_argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str91, argv0_path});
...
int Process::Start() {
  ...
  pid = posix::fork();
  if (pid < 0) {
    throw Alloc<RuntimeError>(str101);
  }
  else {
    if (pid == 0) {
...
runtime_asdl::cmd_value__Argv* MakeBuiltinArgv(List<Str*>* argv1) {
  ...
  argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str109});
  argv->extend(argv1);
...
void AddPure(Dict<int, vm::_Builtin*>* b, state::Mem* mem, Dict<Str*, syntax_asdl::command__ShFunction*>* procs, state::MutableOpts* mutable_opts, Dict<Str*, Str*>* aliases, state::SearchPath* search_path, ui::ErrorFormatter* errfmt) {
  ...
  b->set(builtin_i::shopt, Alloc<builtin_pure::Shopt>(mutable_opts));
...
void AddIO(Dict<int, vm::_Builtin*>* b, state::Mem* mem, state::DirStack* dir_stack, optview::Exec* exec_opts, split::SplitContext* splitter, ui::ErrorFormatter* errfmt) {
  ...
  b->set(builtin_i::read, Alloc<builtin_misc::Read>(splitter, mem));
...
int Main(Str* lang, args::Reader* arg_r, Dict<Str*, Str*>* environ, bool login_shell, pyutil::_ResourceLoader* loader, void* line_input) {
  ...
  if (arg_r->AtEnd()) {
    ...
    dollar0 = arg_r->Peek();
    frame0 = Alloc<state::DebugFrame>(dollar0, str114, no_str, state::LINE_ZERO, 0, 0);
  ...
  comp_arena->PushSource(Alloc<source::Unused>(str118));
  ...
  hist_arena->PushSource(Alloc<source::Unused>(str119));
  ...
  if (flag->c != nullptr) {
    ...
    if (flag->i) {
      ...
      if (script_name == nullptr) {
        stdin = mylib::Stdin();
        arena->PushSource(Alloc<source::Stdin>(str128));
...
ctx_ErrExit::ctx_ErrExit(state::MutableOpts* mutable_opts, int span_id) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(ctx_ErrExit)) {
...
_ErrExit::_ErrExit() : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(_ErrExit)) {
  this->_value = false;
  this->stack = Alloc<List<int>>();
}
...
_Getter::_Getter(List<bool>* opt_array, Str* opt_name) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(_Getter)) {
...
Tuple3<optview::Parse*, optview::Exec*, state::MutableOpts*> MakeOpts(state::Mem* mem, state::OptHook* opt_hook) {
  ...
  errexit = Alloc<_ErrExit>();
  parse_opts = Alloc<optview::Parse>(opt_array);
  exec_opts = Alloc<optview::Exec>(opt_array, errexit);
  mutable_opts = Alloc<MutableOpts>(mem, opt_array, errexit, opt_hook);
...
MutableOpts::MutableOpts(state::Mem* mem, List<bool>* opt_array, state::_ErrExit* errexit, state::OptHook* opt_hook) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(MutableOpts)) {
  this->mem = mem;
  this->opt_array = opt_array;
...
void MutableOpts::SetOption(Str* opt_name, bool b) {
  ...
  if (b) {
    if (!str_contains(shellopts, opt_name)) {
      new_val = Alloc<value::Str>(fmt46(shellopts, opt_name));
    ...
    if (str_contains(shellopts, opt_name)) {
      ...
      new_val = Alloc<value::Str>(str153->join(names));
    ...
    if ((arg->startswith(str290) and len(arg) > 1)) {
      ...
      for (int i = 1; i < n; ++i) {
        ...
        if (list_contains(spec->plus_flags, ch)) {
          out->Set(ch, Alloc<value::Str>(str291));
          continue;
        }
      ...
      if ((len(spec->plus_flags) and (arg->startswith(str294) and len(arg) > 1))) {
        ...
        for (int i = 1; i < n; ++i) {
          ch = arg->index(i);
          if (list_contains(spec->plus_flags, ch)) {
            out->Set(ch, Alloc<value::Str>(str295));
            continue;
          }
          e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
        }
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = Alloc<Token>(id_, span_id, str310);
      return t;
    }
...
lexer::Lexer* ParseContext::_MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = Alloc<lexer::LineLexer>(str312, this->arena);
...
List<Str*> glist1 = {str320, str321, str322, str323, str324, str325, str326, str327, str328, str329, str330, str331};
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw Alloc<NotImplementedError>(str334);
  }
  if (id0 == Id::Op_LBracket) {
    elts = Alloc<List<syntax_asdl::expr_t*>>();
    for (int i = 0; i < n; i += 2) {
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if (print_flags) {
      ...
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str411, str412->join(flags), str413, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str414, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (has_holes) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str417, name, str418, str(i), str419, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str421, str422->join(body), str423}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str425, key_quoted, str426, value_quoted}));
          }
          if (len(body) > 0) {
            decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str427, str428->join(body), str429}));
          }
        }
        else {
          ;  // pass
...
List<Tuple2<Str*, Str*>*>* _ResolveNames(List<Str*>* names, Dict<Str*, syntax_asdl::command__ShFunction*>* funcs, Dict<Str*, Str*>* aliases, state::SearchPath* search_path) {
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if (dict_contains(funcs, name)) {
      kind = (Alloc<Tuple2<Str*, Str*>>(str461, name));
    }
    else {
      if (dict_contains(aliases, name)) {
        kind = (Alloc<Tuple2<Str*, Str*>>(str462, name));
      }
      else {
        if (consts::LookupNormalBuiltin(name) != 0) {
          kind = (Alloc<Tuple2<Str*, Str*>>(str463, name));
        }
        else {
          if (consts::LookupSpecialBuiltin(name) != 0) {
            kind = (Alloc<Tuple2<Str*, Str*>>(str464, name));
          }
          else {
            if (consts::LookupAssignBuiltin(name) != 0) {
              kind = (Alloc<Tuple2<Str*, Str*>>(str465, name));
            }
            else {
              if (consts::IsControlFlow(name)) {
                kind = (Alloc<Tuple2<Str*, Str*>>(str466, name));
              }
              else {
                if (consts::IsKeyword(name)) {
                  kind = (Alloc<Tuple2<Str*, Str*>>(str467, name));
                }
                else {
                  ...
                  if (resolved == nullptr) {
                    ...
                    kind = (Alloc<Tuple2<Str*, Str*>>(str468, resolved));
                  }
                }
              }
            }
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (match::IsValidVarName(var_name)) {
    ...
    throw Alloc<error::Usage>(fmt151(var_name), var_spid);
  }
  return status;
}
...
List<int> glist1 = {command_e::DoGroup, command_e::BraceGroup, command_e::Subshell, command_e::WhileUntil, command_e::If, command_e::Case, command_e::TimeBlock, command_e::CommandList};
List<int>* _DISALLOWED = &glist1;
...
void CommandEvaluator::_CheckStatus(int status, syntax_asdl::command_t* node) {
  ...
  if ((this->exec_opts->errexit() and status != 0)) {
    ...
    throw Alloc<error::ErrExit>(fmt154(status, reason, posix::getpid()), span_id, status);
  }
}
  ...
  switch (arg->tag_()) {
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        filename = val->s;
        if (len(filename) == 0) {
          throw Alloc<error::RedirectEval>(str606, arg_word);
        }
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          t = val->s;
          if (len(t) == 0) {
            throw Alloc<error::RedirectEval>(str607, arg_word);
            return nullptr;
          }
          try {
            ...
            throw Alloc<error::RedirectEval>(fmt155(t), arg_word);
            return nullptr;
          }
          return result;
        }
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = Alloc<redirect_arg::HereDoc>(str_concat(val->s, str611));
            return result;
          }
          else {
            throw Alloc<AssertionError>();
  ...
  switch (node->tag_()) {
    case command_e::Simple: {
      ...
      if (UP_cmd_val->tag_() == cmd_value_e::Argv) {
        ...
        argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str614});
        if (node->block) {
    ...
    case command_e::TimeBlock: {
      ...
      Tuple3<double, double, double> tup3 = pyos::Time();
      e_real = tup3.at0();
      e_user = tup3.at1();
      e_sys = tup3.at2();
...
int CommandEvaluator::_Execute(syntax_asdl::command_t* node) {
  ...
  if ((node->tag_() == command_e::NoOp || node->tag_() == command_e::ControlFlow || node->tag_() == command_e::Pipeline || node->tag_() == command_e::AndOr || node->tag_() == command_e::CommandList || node->tag_() == command_e::DoGroup || node->tag_() == command_e::Sentence || node->tag_() == command_e::TimeBlock || node->tag_() == command_e::ShFunction || node->tag_() == command_e::VarDecl || node->tag_() == command_e::PlaceMutation || node->tag_() == command_e::OilCondition || node->tag_() == command_e::OilForIn || node->tag_() == command_e::Proc || node->tag_() == command_e::Func || node->tag_() == command_e::Return || node->tag_() == command_e::Expr || node->tag_() == command_e::BareDecl)) {
    redirects = Alloc<List<runtime_asdl::redirect*>>();
  }
  else {
    try {
  ...
  if (redirects == nullptr) {
    ...
    if (len(redirects)) {
      if (this->shell_ex->PushRedirects(redirects)) {
        try {
          Tuple2<int, bool> tup4 = this->_Dispatch(node);
          status = tup4.at0();
          check_errexit = tup4.at1();
        }
        catch (std::exception) { }      }
      else {
        status = 1;
      ...
      Tuple2<int, bool> tup5 = this->_Dispatch(node);
      status = tup5.at0();
      check_errexit = tup5.at1();
    }
  }
  this->mem->SetLastStatus(status);
  if (check_errexit) {
...
void CommandEvaluator::MaybeRunExitTrap(List<int>* mut_status) {
  ...
  if (handler) {
    try {
      Tuple2<bool, bool> tup6 = this->ExecuteAndCatch(handler->node);
      is_return = tup6.at0();
      is_fatal = tup6.at1();
    }
    catch (util::UserExit* e) {
    ...
    if ((left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse)) {
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        ...
        if (span1->line_id == span2->line_id) {
          ...
          throw Alloc<NotImplementedError>(fmt163(span1->line_id, span2->line_id));
        }
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    if (span1->line_id == span2->line_id) {
      ...
      throw Alloc<NotImplementedError>(fmt169(span1->line_id, span2->line_id));
    }
...
syntax_asdl::command__WhileUntil* CommandParser::ParseWhileUntil(syntax_asdl::Token* keyword) {
  ...
  if ((this->parse_opts->parse_paren() and this->w_parser->LookAhead() == Id::Op_LParen)) {
    ...
    enode = tup19.at0();
    cond_list = Alloc<List<syntax_asdl::command_t*>>(std::initializer_list<syntax_asdl::command_t*>{Alloc<command::OilCondition>(enode)});
  }
  else {
  ...
  node = Alloc<command::WhileUntil>(keyword, cond_list, body_node, nullptr);
...
void CommandParser::_ParseOilElifElse(syntax_asdl::command__If* if_node) {
  ...
  while (this->c_id == Id::KW_Elif) {
    ...
    body = this->ParseBraceGroup();
    arm = Alloc<syntax_asdl::if_arm>(cond_list, body->children, Alloc<List<int>>(std::initializer_list<int>{elif_spid}));
    arms->append(arm);
  }
  this->_Peek();
...
syntax_asdl::command__If* CommandParser::_ParseOilIf(int if_spid, List<syntax_asdl::command_t*>* cond_list) {
  ...
  arm = Alloc<syntax_asdl::if_arm>(cond_list, body1->children, Alloc<List<int>>(std::initializer_list<int>{if_spid}));
...
void CommandParser::_ParseElifElse(syntax_asdl::command__If* if_node) {
  ...
  while (this->c_id == Id::KW_Elif) {
    ...
    arm = Alloc<syntax_asdl::if_arm>(cond->children, body->children, Alloc<List<int>>(std::initializer_list<int>{elif_spid, then_spid}));
    arms->append(arm);
  }
  if (this->c_id == Id::KW_Else) {
    else_spid = word_::LeftMostSpanForWord(this->cur_word);
...
syntax_asdl::command__If* CommandParser::ParseIf() {
  ...
  this->_Eat(Id::KW_Then);
  body = this->_ParseCommandList();
  arm = Alloc<syntax_asdl::if_arm>(cond_list, body->children, Alloc<List<int>>(std::initializer_list<int>{if_spid, then_spid}));
  if_node->arms->append(arm);
  if ((this->c_id == Id::KW_Elif || this->c_id == Id::KW_Else)) {
  ...
  if (((val->tag_() == value_e::MaybeStrArray || val->tag_() == value_e::AssocArray) and lval->tag_() == lvalue_e::Named)) {
    ...
    if (word_eval::CheckCompatArray(named_lval->name, this->exec_opts)) {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (val->tag_() == value_e::AssocArray) {
          lval = Alloc<lvalue::Keyed>(named_lval->name, str764);
        }
      }
...
using runtime_asdl::scope_e;
List<Str*> glist0 = {str816, str817, str818};
...
runtime_asdl::value_t* ResolveCompatArray(runtime_asdl::value_t* val) {
  ...
  if (val->tag_() == value_e::MaybeStrArray) {
    ...
    if (val->tag_() == value_e::AssocArray) {
      value__AssocArray* assoc_val = static_cast<value__AssocArray*>(val);
      s = dict_contains(assoc_val->d, str819) ? assoc_val->d->index(str820) : nullptr;
    }
    else {
      throw Alloc<AssertionError>();
    }
...
Str* _BackslashEscape(Str* s) {
  return s->replace(str823, str824);
}
...
runtime_asdl::part_value_t* _ValueToPartValue(runtime_asdl::value_t* val, bool quoted) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      return Alloc<part_value::String>(str825, quoted, !quoted);
    }
      break;
    case value_e::Str: {
      value__Str* val = static_cast<value__Str*>(UP_val);
...
Str* TildeEvaluator::Eval(syntax_asdl::Token* token) {
  ...
  if (maybe_str_equals(token->val, str837)) {
    val = this->mem->GetVar(str838);
    UP_val = val;
    if (val->tag_() == value_e::Str) {
      value__Str* val = static_cast<value__Str*>(UP_val);
      return val->s;
      ...
      if ((op->op_id == Id::VTest_ColonEquals || op->op_id == Id::VTest_Equals)) {
        ...
        if ((op->op_id == Id::VTest_ColonQMark || op->op_id == Id::VTest_QMark)) {
          if (is_falsey) {
            ...
            e_die(fmt231(error_str), blame_token);
          }
          else {
            return false;
          }
...
runtime_asdl::value_t* AbstractWordEvaluator::_EvalIndirectArrayExpansion(Str* name, Str* index) {
  ...
  switch (val->tag_()) {
    ...
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* val = static_cast<value__MaybeStrArray*>(UP_val);
      if ((str_equals(index, str842) || str_equals(index, str843))) {
    ...
    case value_e::AssocArray: {
      value__AssocArray* val = static_cast<value__AssocArray*>(UP_val);
      if ((str_equals(index, str844) || str_equals(index, str845))) {
        throw Alloc<NotImplementedError>();
      }
      s = val->d->get(index);
      if (s != nullptr) {
      ...
      case value_e::Str: {
        ...
        try {
          ...
          if (this->exec_opts->strict_word_eval()) {
            ...
            this->errfmt->PrettyPrintError(e, str846);
            return Alloc<value::Str>(str847);
          }
        }
      }
        break;
    ...
    if (op_id == Id::VSub_Bang) {
      ...
      switch (val->tag_()) {
        case value_e::Str: {
          ...
          if ((maybe_str_equals(val->s, str848) || maybe_str_equals(val->s, str849))) {
            return Alloc<value::MaybeStrArray>(this->mem->GetArgv());
          }
          i = val->s->find(str850);
          if ((i >= 0 and str_equals(val->s->index(-1), str851))) {
...
runtime_asdl::value_t* AbstractWordEvaluator::_Slice(runtime_asdl::value_t* val, syntax_asdl::suffix_op__Slice* op, Str* var_name, syntax_asdl::braced_var_sub* part) {
  ...
  try {
    ...
    if (this->exec_opts->strict_word_eval()) {
      ...
      this->errfmt->PrettyPrintError(e, str854);
      switch (val->tag_()) {
        case value_e::Str: {
  ...
  if (op_id == Id::VOp0_P) {
    switch (val->tag_()) {
      case value_e::Str: {
        ...
        p = prompt->replace(str856, str857)->replace(str858, str859);
    ...
    if (op_id == Id::VOp0_Q) {
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          result = Alloc<value::Str>(str861->join(tmp));
        }
          break;
        default: {
      ...
      if (op_id == Id::VOp0_a) {
        ...
        result = Alloc<value::Str>(str868->join(chars));
      }
      else {
        e_die(fmt235(op->val), op);
      }
    }
  }
...
Tuple2<runtime_asdl::value_t*, runtime_asdl::a_index_t*> AbstractWordEvaluator::_ArrayIndex(runtime_asdl::value_t* val, syntax_asdl::braced_var_sub* part) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      ...
      break;
    case value_e::Str: {
      e_die(fmt238(part->token->val), part->token);
    }
      break;
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* array_val = static_cast<value__MaybeStrArray*>(UP_val);
...
void AbstractWordEvaluator::_EvalDoubleQuoted(List<syntax_asdl::word_part_t*>* parts, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  if (len(parts) == 0) {
    v = Alloc<part_value::String>(str873, true, false);
    part_vals->append(v);
    return ;
  }
...
runtime_asdl::value_t* AbstractWordEvaluator::_EmptyStrOrError(runtime_asdl::value_t* val, syntax_asdl::Token* token) {
  ...
  if (!this->exec_opts->nounset()) {
    return Alloc<value::Str>(str874);
  }
  name = token->val->startswith(str875) ? token->val->slice(1) : token->val;
  e_die(fmt239(name), token);
}

runtime_asdl::value_t* AbstractWordEvaluator::_EmptyMaybeStrArrayOrError(syntax_asdl::Token* token) {
  if (this->exec_opts->nounset()) {
    e_die(fmt240(token->val), token);
  }
  else {
  ...
  switch (part->tag_()) {
    ...
    case word_part_e::ExtGlob: {
      ...
      for (ListIter<syntax_asdl::word_t*> it(part->arms); !it.Done(); it.Next(), ++i) {
        syntax_asdl::word_t* w = it.Value();
        if (i != 0) {
          part_vals->append(Alloc<part_value::String>(str886, false, false));
        }
        this->_EvalWordToParts(w, false, part_vals);
      }
      part_vals->append(Alloc<part_value::String>(str887, false, false));
    }
      break;
...
void AbstractWordEvaluator::_EvalWordToParts(syntax_asdl::word_t* w, bool quoted, List<runtime_asdl::part_value_t*>* part_vals, bool is_subst) {
  ...
  switch (w->tag_()) {
    case word_e::Compound: {
      ...
      break;
    case word_e::Empty: {
      part_vals->append(Alloc<part_value::String>(str889, quoted, !quoted));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, runtime_asdl::quote_t quote_kind) {
  ...
  return Alloc<value::Str>(str893->join(strs));
}
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalForPlugin(syntax_asdl::compound_word* w) {
  ...
  {  // with
    ...
    try {
      ...
      val = Alloc<value::Str>(fmt248(e->UserErrorString()));
    }
    catch (_OSError* e) {
      val = Alloc<value::Str>(fmt249(pyutil::strerror(e)));
    }
    catch (KeyboardInterrupt*) {
      val = Alloc<value::Str>(str896);
    }
  }
  return val;
}
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index(-2), str903)) {
          e_die(fmt251(), w);
        }
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        if ((arg->startswith(str905) or arg->startswith(str906))) {
          flags->append(arg);
          flag_spids->append(word_spid);
          if ((str_contains(arg, str907) or str_contains(arg, str908))) {
            eval_to_pairs = false;
          }
        }
        else {
...
runtime_asdl::part_value__String* CompletionWordEvaluator::_EvalProcessSub(syntax_asdl::command_t* node, int id_) {
  return Alloc<part_value::String>(str913, true, false);
}
...
syntax_asdl::suffix_op__PatSub* WordParser::_ReadPatSubVarOp() {
  ...
  if (this->token_type == Id::Lit_Slash) {
    ...
    this->_Peek();
    if (this->token_type != Id::Right_DollarBrace) {
      p_die(fmt255(ui::PrettyId(this->token_type)), this->cur_token);
    }
    return Alloc<suffix_op::PatSub>(pat, replace, replace_mode);
  }
  p_die(fmt256(), this->cur_token);
}
        ...
        if (op_kind == Kind::VOp2) {
          if (this->token_type == Id::VOp2_Slash) {
            ...
            if (this->token_type == Id::VOp2_Colon) {
              ...
              p_die(fmt261(str923), this->cur_token);
            }
          }
        }
        else {
          if (op_kind == Kind::VOp3) {
            if (allow_query) {
              ...
              p_die(fmt262(str925), this->cur_token);
            }
          }
        }
      }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool is_oil_expr) {
  ...
  no_backslashes = (is_oil_expr and maybe_str_equals(left_token->val, str929));
  done = false;
  while (!done) {
    this->_Next(lex_mode);
    this->_Peek();
...
void WordParser::ParseProc(syntax_asdl::command__Proc* node) {
  ...
  if (this->token_type != Id::Lit_Chars) {
    p_die(fmt275(ui::PrettyToken(this->cur_token, this->arena)), this->cur_token);
  }
...
syntax_asdl::arith_expr_t* WordParser::_ReadArithExpr(int end_id) {
  ...
  if ((end_id != Id::Undefined_Tok and cur_id != end_id)) {
    p_die(fmt276(ui::PrettyId(cur_id), ui::PrettyId(end_id)), this->a_parser->cur_word);
  }
  return anode;
}
...
syntax_asdl::command__ForExpr* WordParser::ReadForExpression() {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt279(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
  if (cur_id == Id::Arith_Semi) {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt280(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
        ...
        if ((this->token_type == Id::Lit_VarLike and num_parts == 0)) {
          ...
          if ((this->parse_opts->parse_at() and (this->token_type == Id::Lit_Splice and num_parts == 0))) {
            ...
            if (next_id == Id::Op_LParen) {
              ...
              part = Alloc<word_part::FuncCall>(splice_token, arglist);
            }
            else {
              part = Alloc<word_part::Splice>(splice_token);
            }
            w->parts->append(part);
            this->_Next(lex_mode);
            this->_Peek();
            if (!list_contains(KINDS_THAT_END_WORDS, this->token_kind)) {
              p_die(fmt286(), this->cur_token);
            }
            done = true;
          }
          else {
...
Tuple2<syntax_asdl::word_t*, bool> WordParser::_ReadArithWord() {
  ...
  this->_Peek();
  if (this->token_kind == Kind::Unknown) {
    p_die(fmt288(this->cur_token->val), this->cur_token);
  }
  else {
    if (this->token_kind == Kind::Eof) {
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str957, false));
    }
      break;
    case word_part_e::AssocArrayLiteral: {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str960, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str961->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
    ...
    case word_part_e::ExtGlob: 
    case word_part_e::Splice: {
      return (Tuple3<bool, Str*, bool>(false, str962, false));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() != word_e::Compound) {
    return (Tuple3<bool, Str*, bool>(false, str963, quoted));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  strs = Alloc<List<Str*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str964, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str965->join(strs), quoted));
}
...
syntax_asdl::compound_word* TildeDetect(syntax_asdl::word_t* UP_w) {
  ...
  if ((id_ == Id::Lit_Chars and static_cast<Token*>(part1)->val->startswith(str967))) {
    new_parts->extend(w->parts->slice(1));
    return Alloc<compound_word>(new_parts);
  }
  return nullptr;
...
void TildeDetectAssign(syntax_asdl::compound_word* w) {
  ...
  for (int i = 0; i < n; ++i) {
    ...
    if ((do_expand and LiteralId(cur) == Id::Lit_TildeLike)) {
      ...
      if (next_part) {
        is_tilde = (LiteralId(next_part) == Id::Lit_Colon or (LiteralId(next_part) == Id::Lit_Chars and static_cast<Token*>(next_part)->val->startswith(str968)));
      }
      else {
        is_tilde = true;
      }
...
Str* escape(Str* s) {
  ...
  s = s->replace(str980, str981);
  s = s->replace(str982, str983);
  return s;
}
...
Str* join(Str* s1, Str* s2) {
  if ((s2->startswith(str986) or len(s1) == 0)) {
    return s2;
  }
  if (s1->endswith(str987)) {
...
Tuple2<Str*, Str*> split(Str* p) {
  ...
  head = p->slice(0, i);
  tail = p->slice(i);
  if ((len(head) and !(str_equals(head, str_repeat(str990, len(head)))))) {
    head = head->rstrip(str991);
  }
...
Tuple2<Str*, Str*> _splitext(Str* p, Str* sep, Str* extsep) {
  ...
  return (Tuple2<Str*, Str*>(p, str992));
}
...
Str* dirname(Str* p) {
  ...
  i = (p->rfind(str994) + 1);
  head = p->slice(0, i);
  if ((head and !(str_equals(head, str_repeat(str995, len(head)))))) {
    head = head->rstrip(str996);
  }
  return head;
}
...
Str* normpath(Str* path) {
  ...
  slash = str997;
  dot = str998;
  if (str_equals(path, str999)) {
    return dot;
  }
  initial_slashes = path->startswith(str1000);
  if ((initial_slashes and (path->startswith(str1001) and !path->startswith(str1002)))) {
    initial_slashes = 2;
  }
  comps = path->split(str1003);
  new_comps = Alloc<List<Str*>>();
  for (ListIter<Str*> it(comps); !it.Done(); it.Next()) {
    Str* comp = it.Value();
    if ((len(comp) == 0 or str_equals(comp, str1004))) {
      continue;
    }
    if ((!(str_equals(comp, str1005)) or ((initial_slashes == 0 and len(new_comps) == 0) or (len(new_comps) and str_equals(new_comps->index(-1), str1006))))) {
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if ((str_contains(str1008, ch) or IsUnprintableLow(ch))) {
        quote = 2;
        break;
      }
    }
  ...
  parts->append(str1011);
  return str_concat(prefix, str1012->join(parts));
}
...
Str* maybe_encode(Str* s, int bit8_display) {
  ...
  parts->append(str1014);
  return str1015->join(parts);
}
...
Str* encode(Str* s, int bit8_display) {
  ...
  parts = Alloc<List<Str*>>();
  parts->append(str1016);
  _encode(s, bit8_display, false, parts);
  parts->append(str1017);
  return str1018->join(parts);
}
      ...
      if (str_equals(byte, str1021)) {
        ...
        if (str_equals(byte, str1023)) {
          ...
          if (str_equals(byte, str1025)) {
            ...
            if (str_equals(byte, str1027)) {
              part = str1028;
            }
            else {
              if (str_equals(byte, str1029)) {
                part = shell_compat ? str1030 : str1031;
              }
              else {
        ...
        if (str_equals(byte, str1037)) {
          ...
          if (str_equals(byte, str1039)) {
            ...
            if (str_equals(byte, str1041)) {
              ...
              if (str_equals(byte, str1043)) {
                out = str1044;
              }
              else {
                if (str_equals(byte, str1045)) {
                  out = shell_compat ? str1046 : str1047;
                }
                else {
                  if (IsUnprintableLow(byte)) {
...
syntax_asdl::word__String* _StringWordEmitter::ReadWord(types_asdl::lex_mode_t unused_lex_mode) {
  ...
  if (this->i == this->n) {
    w = Alloc<word::String>(Id::Eof_Real, str1048, runtime::NO_SPID);
    return w;
  }
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    strs = cmd_val->argv;
    if ((!strs or !(str_equals(strs->index(-1), str1057)))) {
      this->errfmt->Print_(str1058, cmd_val->arg_spids->index(0));
      return 2;
    }
    cmd_val->argv->pop();
  ...
  try {
    ...
    if (n == 4) {
      a0 = w_parser->Peek(0);
      if (str_equals(a0, str1059)) {
        w_parser->Read();
        child = _ThreeArgs(w_parser);
        bool_node = Alloc<bool_expr::LogicalNot>(child);
      }
      else {
        if ((str_equals(a0, str1060) and str_equals(w_parser->Peek(3), str1061))) {
          w_parser->Read();
          bool_node = _TwoArgs(w_parser);
        }
        else {
    ...
    this->errfmt->PrettyPrintError(e, str1062);
    return 2;
  }
  ...
  try {
    ...
    this->errfmt->PrettyPrintError(e, str1063);
    return 2;
  }
  status = b ? 0 : 1;
  return status;

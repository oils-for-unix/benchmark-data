...
class Parse {
 public:
  ...
  bool strict_backticks() { return opt_array->index(option_i::strict_backticks); }
...
class Exec {
 public:
  ...
  bool verbose_errexit() { return opt_array->index(option_i::verbose_errexit); }
  ...
  bool strict_tilde() { return opt_array->index(option_i::strict_tilde); }

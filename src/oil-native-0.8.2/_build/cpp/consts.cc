...
List<int>* STRICT_ALL = new List<int>({3, 21, 2, 20, 44, 4, 22, 23, 24, 33, 34, 25, 26, 27, 28, 32, 29, 31, 30});
List<int>* OIL_BASIC = new List<int>({36, 3, 21, 37, 2, 20, 39, 40, 44, 41, 42, 43, 4, 38, 35, 22, 23, 24, 25, 26, 27, 28, 32, 29, 31, 30});
List<int>* OIL_ALL = new List<int>({36, 3, 21, 37, 2, 20, 39, 40, 46, 44, 41, 42, 43, 45, 4, 38, 35, 22, 23, 24, 33, 34, 25, 26, 27, 28, 32, 29, 31, 30});
List<int>* DEFAULT_TRUE = new List<int>({36, 3, 44, 19});
List<int>* PARSE_OPTION_NUMS = new List<int>({39, 40, 17, 46, 44, 41, 42, 43, 45, 47, 33, 34});
List<int>* SHOPT_OPTION_NUMS = new List<int>({54, 55, 56, 57, 58, 59, 60, 53, 18, 61, 36, 62, 63, 64, 16, 65, 48, 66, 15, 67, 14, 68, 69, 70, 71, 51, 72, 73, 52, 74, 21, 75, 49, 76, 77, 78, 79, 80, 37, 81, 82, 83, 20, 39, 40, 17, 46, 44, 41, 42, 43, 45, 47, 50, 84, 85, 86, 87, 38, 35, 88, 22, 23, 24, 33, 34, 25, 26, 27, 28, 32, 29, 31, 30, 19, 89});

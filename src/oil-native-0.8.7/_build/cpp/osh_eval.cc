...
GLOBAL_STR(str131, "");
GLOBAL_STR(str132, "Can't run a proc while errexit is disabled. Use 'run' or wrap it in a process with $0 myproc");
...
GLOBAL_STR(str154, "/bin/sh");
GLOBAL_STR(str155, "/bin/sh");
GLOBAL_STR(str156, "Can't execute %r: %s");
GLOBAL_STR(str157, "[process] %s");
GLOBAL_STR(str158, " ");
GLOBAL_STR(str159, "[subprog] %s");
GLOBAL_STR(str160, "");
GLOBAL_STR(str161, "osh I/O error: %s");
GLOBAL_STR(str162, "[here doc writer]");
GLOBAL_STR(str163, "<Process %s>");
GLOBAL_STR(str164, "Fatal error in posix.fork()");
GLOBAL_STR(str165, "<Pipeline %s>");
GLOBAL_STR(str166, " ");
GLOBAL_STR(str167, "JobState MaybeRemove %d");
GLOBAL_STR(str168, "osh: PID %d stopped, but osh didn't start it");
GLOBAL_STR(str169, "");
GLOBAL_STR(str170, "");
GLOBAL_STR(str171, "[PID %d] Stopped");
GLOBAL_STR(str172, "");
GLOBAL_STR(str173, "main");
GLOBAL_STR(str174, "osh usage error: %s");
GLOBAL_STR(str175, "%s-usage");
GLOBAL_STR(str176, "Oil");
GLOBAL_STR(str177, "main");
GLOBAL_STR(str178, "oil");
GLOBAL_STR(str179, "oil:all");
GLOBAL_STR(str180, "--one-pass-parse requires noexec (-n)");
GLOBAL_STR(str181, "completion");
GLOBAL_STR(str182, "history");
GLOBAL_STR(str183, "");
GLOBAL_STR(str184, "OSH_DEBUG_DIR");
GLOBAL_STR(str185, "%d-osh.log");
GLOBAL_STR(str186, "Writing logs to %r");
GLOBAL_STR(str187, "OSH_HIJACK_SHEBANG");
GLOBAL_STR(str188, "");
GLOBAL_STR(str189, "OSH_CRASH_DUMP_DIR");
GLOBAL_STR(str190, "");
GLOBAL_STR(str191, "");
GLOBAL_STR(str192, "osh: Couldn't open %r: %s");
GLOBAL_STR(str193, "/proc/%d/status");
GLOBAL_STR(str194, "--parser-mem-dump can only be used with -n");
GLOBAL_STR(str195, "/proc/%d/status");
GLOBAL_STR(str196, "Can't run a proc while errexit is disabled. Use 'catch' or wrap it in a process with $0 myproc");
GLOBAL_STR(str197, "Unhandled SimpleCommand");
GLOBAL_STR(str198, "\n");
GLOBAL_STR(str199, " \t\n\"'><=;|&(:");
GLOBAL_STR(str200, "/");
GLOBAL_STR(str201, "PATH");
GLOBAL_STR(str202, ":");
GLOBAL_STR(str203, "got invalid option %r");
GLOBAL_STR(str204, "got invalid option %r");
GLOBAL_STR(str205, "doesn't own option %r (try 'shopt')");
GLOBAL_STR(str206, "SHELLOPTS");
GLOBAL_STR(str207, ":");
GLOBAL_STR(str208, "Syntax options must be set at the top level (outside any function)");
GLOBAL_STR(str209, "Warning: set -o verbose not implemented");
GLOBAL_STR(str210, "SHELLOPTS");
GLOBAL_STR(str211, "%s:%s");
GLOBAL_STR(str212, "SHELLOPTS");
GLOBAL_STR(str213, ":");
GLOBAL_STR(str214, ":");
GLOBAL_STR(str215, "SHELLOPTS");
GLOBAL_STR(str216, "oil:basic");
GLOBAL_STR(str217, "oil:all");
GLOBAL_STR(str218, "strict:all");
GLOBAL_STR(str219, "set %so %s");
GLOBAL_STR(str220, "-");
GLOBAL_STR(str221, "+");
GLOBAL_STR(str222, "oil:basic");
GLOBAL_STR(str223, "oil:all");
GLOBAL_STR(str224, "strict:all");
GLOBAL_STR(str225, "got invalid option %r");
GLOBAL_STR(str226, "shopt -%s %s");
GLOBAL_STR(str227, "s");
GLOBAL_STR(str228, "u");
GLOBAL_STR(str229, "<_ArgFrame %s %d at %x>");
GLOBAL_STR(str230, "Can't determine working directory: %s");
GLOBAL_STR(str231, "IFS");
GLOBAL_STR(str232, "UID");
GLOBAL_STR(str233, "EUID");
GLOBAL_STR(str234, "PPID");
GLOBAL_STR(str235, "HOSTNAME");
GLOBAL_STR(str236, "OSTYPE");
GLOBAL_STR(str237, "OPTIND");
GLOBAL_STR(str238, "1");
GLOBAL_STR(str239, "PS4");
GLOBAL_STR(str240, "${SHX_indent}${SHX_punct}${SHX_pid_str} ");
GLOBAL_STR(str241, "COMP_WORDBREAKS");
GLOBAL_STR(str242, "SHELLOPTS");
GLOBAL_STR(str243, "SHELLOPTS");
GLOBAL_STR(str244, "");
GLOBAL_STR(str245, "SHELLOPTS");
GLOBAL_STR(str246, "PWD");
GLOBAL_STR(str247, "PWD");
GLOBAL_STR(str248, "PWD");
GLOBAL_STR(str249, "OIL_VERSION");
GLOBAL_STR(str250, "PWD");
GLOBAL_STR(str251, "");
GLOBAL_STR(str252, "<Mem");
GLOBAL_STR(str253, "  -- %d --");
GLOBAL_STR(str254, "  %s %s");
GLOBAL_STR(str255, ">");
GLOBAL_STR(str256, "\n");
GLOBAL_STR(str257, "\n");
GLOBAL_STR(str258, "Warning: span_id undefined in SetCurrentSpanId");
GLOBAL_STR(str259, "setref requires a nameref (:out param), got %r");
GLOBAL_STR(str260, "nameref %r is undefined");
GLOBAL_STR(str261, "nameref %r contains invalid variable name %r");
GLOBAL_STR(str262, "nameref cycle: %s");
GLOBAL_STR(str263, " -> ");
GLOBAL_STR(str264, "__");
GLOBAL_STR(str265, "Can't assign to readonly value %r");
GLOBAL_STR(str266, "Only strings can be exported");
GLOBAL_STR(str267, "nameref must be a string");
GLOBAL_STR(str268, "Can't assign to readonly array");
GLOBAL_STR(str269, "Can't assign to items in a string");
GLOBAL_STR(str270, "Value of type %s can't be indexed");
GLOBAL_STR(str271, "Can't assign to readonly associative array");
GLOBAL_STR(str272, "ARGV");
GLOBAL_STR(str273, "_status");
GLOBAL_STR(str274, "PIPESTATUS");
GLOBAL_STR(str275, "_pipeline_status");
GLOBAL_STR(str276, "_process_sub_status");
GLOBAL_STR(str277, "FUNCNAME");
GLOBAL_STR(str278, "source");
GLOBAL_STR(str279, "BASH_SOURCE");
GLOBAL_STR(str280, "BASH_LINENO");
GLOBAL_STR(str281, "0");
GLOBAL_STR(str282, "LINENO");
GLOBAL_STR(str283, "BASHPID");
GLOBAL_STR(str284, "Can't unset readonly variable %r");
GLOBAL_STR(str285, "%r isn't an array");
GLOBAL_STR(str286, "$%s isn't defined");
GLOBAL_STR(str287, "$%s should be a string");
GLOBAL_STR(str288, "$%s should be a string, got %s");
GLOBAL_STR(str289, "$%s doesn't look like an integer, got %r");
GLOBAL_STR(str290, "EOF");
GLOBAL_STR(str291, "/");
GLOBAL_STR(str292, "~");
GLOBAL_STR(str293, "  ");
GLOBAL_STR(str294, "\n  ");
...
GLOBAL_STR(str299, "~");
GLOBAL_STR(str300, "\n");
GLOBAL_STR(str301, "[ interactive ]");
GLOBAL_STR(str302, "[ -c flag ]");
GLOBAL_STR(str303, "[ stdin%s ]");
GLOBAL_STR(str304, "[ expansion of alias %r ]");
GLOBAL_STR(str305, "[ backticks at ... ]");
GLOBAL_STR(str306, "[ array LValue in %s ]");
GLOBAL_STR(str307, "[ eval at line %d of %s ]");
GLOBAL_STR(str308, "[ trap ]");
GLOBAL_STR(str309, "[ variable ]");
GLOBAL_STR(str310, "%s:%d: %s%s\n");
GLOBAL_STR(str311, "[??? no location ???] %s%s\n");
GLOBAL_STR(str312, "");
GLOBAL_STR(str313, "");
GLOBAL_STR(str314, "");
GLOBAL_STR(str315, "none");
GLOBAL_STR(str316, "AST not printed.");
GLOBAL_STR(str317, "text");
GLOBAL_STR(str318, "abbrev-text");
GLOBAL_STR(str319, "html");
GLOBAL_STR(str320, "abbrev-html");
GLOBAL_STR(str321, "abbrev-");
GLOBAL_STR(str322, "\n");
GLOBAL_STR(str323, "\n");
GLOBAL_STR(str324, "-");
GLOBAL_STR(str325, "_");
GLOBAL_STR(str326, "<_Attributes %s>");
GLOBAL_STR(str327, "<args.Reader %r %d>");
GLOBAL_STR(str328, "expected argument to %r");
GLOBAL_STR(str329, "-");
GLOBAL_STR(str330, "expected integer after %s, got %r");
GLOBAL_STR(str331, "-");
GLOBAL_STR(str332, "got invalid integer for %s: %s");
GLOBAL_STR(str333, "-");
GLOBAL_STR(str334, "expected number after %r, got %r");
GLOBAL_STR(str335, "-");
GLOBAL_STR(str336, "got invalid float for %s: %s");
GLOBAL_STR(str337, "-");
GLOBAL_STR(str338, "got invalid argument %r to %r, expected one of: %s");
GLOBAL_STR(str339, "-");
GLOBAL_STR(str340, "|");
GLOBAL_STR(str341, "0");
GLOBAL_STR(str342, "F");
GLOBAL_STR(str343, "false");
GLOBAL_STR(str344, "False");
GLOBAL_STR(str345, "1");
GLOBAL_STR(str346, "T");
GLOBAL_STR(str347, "true");
GLOBAL_STR(str348, "Talse");
GLOBAL_STR(str349, "got invalid argument to boolean flag: %r");
GLOBAL_STR(str350, "-");
GLOBAL_STR(str351, "-");
GLOBAL_STR(str352, "got invalid option %r");
GLOBAL_STR(str353, "Expected argument for action");
GLOBAL_STR(str354, "Invalid action name %r");
GLOBAL_STR(str355, "--");
GLOBAL_STR(str356, "--");
GLOBAL_STR(str357, "got invalid flag %r");
GLOBAL_STR(str358, "-");
GLOBAL_STR(str359, "0");
GLOBAL_STR(str360, "Z");
GLOBAL_STR(str361, "-");
GLOBAL_STR(str362, "doesn't accept flag %s");
GLOBAL_STR(str363, "-");
GLOBAL_STR(str364, "+");
GLOBAL_STR(str365, "+");
GLOBAL_STR(str366, "doesn't accept option %s");
GLOBAL_STR(str367, "+");
GLOBAL_STR(str368, "-");
GLOBAL_STR(str369, "--");
GLOBAL_STR(str370, "--");
GLOBAL_STR(str371, "got invalid flag %r");
GLOBAL_STR(str372, "-");
GLOBAL_STR(str373, "+");
GLOBAL_STR(str374, "got invalid flag %r");
GLOBAL_STR(str375, "-");
GLOBAL_STR(str376, "^--?([a-zA-Z0-9][a-zA-Z0-9\\-]*)(=.*)?$");
GLOBAL_STR(str377, "<LineLexer at pos %d of line %r (id = %d)>");
GLOBAL_STR(str378, "");
GLOBAL_STR(str379, "");
GLOBAL_STR(str380, "");
GLOBAL_STR(str381, "");
GLOBAL_STR(str382, "<Trail %s %s %s %s>");
GLOBAL_STR(str383, "");
GLOBAL_STR(str384, "ShAssignment expression can't be nested like this");
GLOBAL_STR(str385, "Here docs aren't allowed in expressions");
GLOBAL_STR(str386, "\n");
GLOBAL_STR(str387, "");
GLOBAL_STR(str388, " (%s)");
GLOBAL_STR(str389, "Unexpected token in expression mode%s");
GLOBAL_STR(str390, "Syntax error in expression (near %s)");
GLOBAL_STR(str391, "alnum");
GLOBAL_STR(str392, "cntrl");
GLOBAL_STR(str393, "lower");
GLOBAL_STR(str394, "space");
GLOBAL_STR(str395, "alpha");
GLOBAL_STR(str396, "digit");
GLOBAL_STR(str397, "print");
GLOBAL_STR(str398, "upper");
GLOBAL_STR(str399, "blank");
GLOBAL_STR(str400, "graph");
GLOBAL_STR(str401, "punct");
GLOBAL_STR(str402, "xdigit");
GLOBAL_STR(str403, "Range start/end shouldn't have more than one character");
GLOBAL_STR(str404, "Write singleton tuples with tup(), not a trailing comma");
GLOBAL_STR(str405, "testlist_comp");
GLOBAL_STR(str406, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str407, "Can't assign to this expression");
GLOBAL_STR(str408, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str409, "TODO");
GLOBAL_STR(str410, "dot");
GLOBAL_STR(str411, "Can't negate this symbol");
GLOBAL_STR(str412, "%r isn't a character class");
GLOBAL_STR(str413, "Can't negate this symbol");
GLOBAL_STR(str414, "%r isn't a character class");
GLOBAL_STR(str415, "%start");
GLOBAL_STR(str416, "%end");
GLOBAL_STR(str417, "dot");
GLOBAL_STR(str418, "Unexpected token %r in regex");
GLOBAL_STR(str419, "%s-%s");
GLOBAL_STR(str420, "ERE can't express code point %d");
GLOBAL_STR(str421, "Perl classes can't be negated in ERE");
GLOBAL_STR(str422, "%s");
GLOBAL_STR(str423, "POSIX classes can't be negated in ERE");
GLOBAL_STR(str424, "[:%s:]");
GLOBAL_STR(str425, ".");
GLOBAL_STR(str426, "^");
GLOBAL_STR(str427, "$");
GLOBAL_STR(str428, "|");
GLOBAL_STR(str429, "POSIX EREs don't have groups without capture, so this node needs () around it.");
GLOBAL_STR(str430, "+");
GLOBAL_STR(str431, "*");
GLOBAL_STR(str432, "?");
GLOBAL_STR(str433, "{%s}");
...
GLOBAL_STR(str444, "^");
GLOBAL_STR(str445, "]");
GLOBAL_STR(str446, "The [ operator doesn't apply to this expression");
GLOBAL_STR(str447, "Expected ]]");
GLOBAL_STR(str448, "Unexpected trailing word %s");
GLOBAL_STR(str449, "Invalid argument to unary operator");
GLOBAL_STR(str450, "Expected ), got %s");
GLOBAL_STR(str451, "Unexpected token in boolean expression (%s)");
GLOBAL_STR(str452, "");
GLOBAL_STR(str453, "Expected %d, got %d");
GLOBAL_STR(str454, "Step can't be 0");
GLOBAL_STR(str455, "Invalid step %d for ascending integer range");
GLOBAL_STR(str456, "Invalid step %d for descending integer range");
GLOBAL_STR(str457, "Invalid step %d for ascending character range");
GLOBAL_STR(str458, "Invalid step %d for descending character range");
GLOBAL_STR(str459, "Mismatched cases in character range");
GLOBAL_STR(str460, "");
GLOBAL_STR(str461, "0");
GLOBAL_STR(str462, "0");
GLOBAL_STR(str463, "g");
...
GLOBAL_STR(str500, ")");
GLOBAL_STR(str501, "");
GLOBAL_STR(str502, "export_");
GLOBAL_STR(str503, "doesn't accept -f because it's dangerous.  (The code can usually be restructured with 'source')");
GLOBAL_STR(str504, "doesn't accept RHS with -n");
GLOBAL_STR(str505, "Got -a but RHS isn't an array");
GLOBAL_STR(str506, "Got -A but RHS isn't an associative array");
GLOBAL_STR(str507, "readonly");
GLOBAL_STR(str508, "new_var");
GLOBAL_STR(str509, "with -f expects function names");
GLOBAL_STR(str510, "declare -f %s");
GLOBAL_STR(str511, "-");
GLOBAL_STR(str512, "-");
GLOBAL_STR(str513, "-");
GLOBAL_STR(str514, "+");
GLOBAL_STR(str515, "+");
GLOBAL_STR(str516, "+");
GLOBAL_STR(str517, "Invalid unset expression");
GLOBAL_STR(str518, "expected a variable name.  shopt -s eval_unsafe_arith allows expressions");
GLOBAL_STR(str519, "unset");
GLOBAL_STR(str520, "Invalid shift argument %r");
GLOBAL_STR(str521, "got too many arguments");
GLOBAL_STR(str522, "eval");
GLOBAL_STR(str523, "requires code string");
GLOBAL_STR(str524, "requires exactly 1 argument");
GLOBAL_STR(str525, " ");
GLOBAL_STR(str526, "eval");
GLOBAL_STR(str527, "source");
GLOBAL_STR(str528, "missing required argument");
GLOBAL_STR(str529, "source %r failed: %s");
GLOBAL_STR(str530, "source");
GLOBAL_STR(str531, "command");
GLOBAL_STR(str532, "Can't run assignment builtin recursively");
GLOBAL_STR(str533, "%r isn't a shell builtin");
GLOBAL_STR(str534, "sigpipe");
GLOBAL_STR(str535, "run");
GLOBAL_STR(str536, "'run' expected a command to run");
GLOBAL_STR(str537, "(original failure)");
GLOBAL_STR(str538, "");
GLOBAL_STR(str539, "fatal: status %d when --allow-status-01");
GLOBAL_STR(str540, ":");
GLOBAL_STR(str541, "function");
GLOBAL_STR(str542, "alias");
GLOBAL_STR(str543, "builtin");
GLOBAL_STR(str544, "builtin");
GLOBAL_STR(str545, "builtin");
GLOBAL_STR(str546, "keyword");
GLOBAL_STR(str547, "keyword");
GLOBAL_STR(str548, "file");
GLOBAL_STR(str549, "type");
GLOBAL_STR(str550, "type: %r not found");
GLOBAL_STR(str551, "file");
GLOBAL_STR(str552, "file");
GLOBAL_STR(str553, "%s is a %s");
GLOBAL_STR(str554, "function");
GLOBAL_STR(str555, "");
GLOBAL_STR(str556, "\n");
GLOBAL_STR(str557, "");
GLOBAL_STR(str558, "");
...
GLOBAL_STR(str562, "");
GLOBAL_STR(str563, "");
GLOBAL_STR(str564, "read");
GLOBAL_STR(str565, "_line");
GLOBAL_STR(str566, ":");
GLOBAL_STR(str567, "got extra argument");
GLOBAL_STR(str568, "--qsn can only be used with --line");
GLOBAL_STR(str569, "_all");
GLOBAL_STR(str570, ":");
GLOBAL_STR(str571, "got extra argument");
GLOBAL_STR(str572, "--qsn not implemented yet");
GLOBAL_STR(str573, "read -t isn't implemented (except t=0)");
GLOBAL_STR(str574, "");
GLOBAL_STR(str575, "REPLY");
GLOBAL_STR(str576, "REPLY");
GLOBAL_STR(str577, "\u0000");
GLOBAL_STR(str578, "\u0000");
GLOBAL_STR(str579, "\n");
GLOBAL_STR(str580, "");
GLOBAL_STR(str581, "mapfile");
GLOBAL_STR(str582, "MAPFILE");
GLOBAL_STR(str583, ":");
GLOBAL_STR(str584, "\n");
GLOBAL_STR(str585, "cd");
GLOBAL_STR(str586, "HOME");
GLOBAL_STR(str587, "HOME");
GLOBAL_STR(str588, "-");
GLOBAL_STR(str589, "OLDPWD");
GLOBAL_STR(str590, "PWD");
GLOBAL_STR(str591, "cd %r: %s");
GLOBAL_STR(str592, "PWD");
GLOBAL_STR(str593, "OLDPWD");
GLOBAL_STR(str594, "%2d  %s");
GLOBAL_STR(str595, " ");
GLOBAL_STR(str596, "pushd: no other directory");
GLOBAL_STR(str597, "got too many arguments");
GLOBAL_STR(str598, "pushd: %r: %s");
GLOBAL_STR(str599, "HOME");
GLOBAL_STR(str600, "PWD");
GLOBAL_STR(str601, "popd: directory stack is empty");
GLOBAL_STR(str602, "popd: %r: %s");
GLOBAL_STR(str603, "PWD");
GLOBAL_STR(str604, "got extra argument");
GLOBAL_STR(str605, "HOME");
GLOBAL_STR(str606, "dirs");
GLOBAL_STR(str607, "HOME");
GLOBAL_STR(str608, "pwd");
GLOBAL_STR(str609, "_devbuild/help/groups.txt");
GLOBAL_STR(str610, "help");
GLOBAL_STR(str611, "help");
GLOBAL_STR(str612, "_devbuild/help/%s");
GLOBAL_STR(str613, "no help topics match %r");
GLOBAL_STR(str614, "# +");
GLOBAL_STR(str615, "osh printf doesn't support the %r flag");
GLOBAL_STR(str616, "eEfFgG");
GLOBAL_STR(str617, "osh printf doesn't support floating point");
GLOBAL_STR(str618, "c");
GLOBAL_STR(str619, "osh printf doesn't support single characters (bytes)");
GLOBAL_STR(str620, "Invalid printf format character");
GLOBAL_STR(str621, "Expected a printf format character");
GLOBAL_STR(str622, "fsT");
GLOBAL_STR(str623, "printf precision can't be specified with type %r");
GLOBAL_STR(str624, "printf");
GLOBAL_STR(str625, "requires a format string");
GLOBAL_STR(str626, "%");
GLOBAL_STR(str627, "");
GLOBAL_STR(str628, "printf got invalid width %r");
GLOBAL_STR(str629, "0");
GLOBAL_STR(str630, "");
GLOBAL_STR(str631, "printf got invalid precision %r");
GLOBAL_STR(str632, "");
GLOBAL_STR(str633, "s");
GLOBAL_STR(str634, "q");
GLOBAL_STR(str635, "b");
GLOBAL_STR(str636, "");
GLOBAL_STR(str637, "diouxX");
GLOBAL_STR(str638, "'\"");
GLOBAL_STR(str639, "printf expected an integer, got %r");
GLOBAL_STR(str640, "di");
GLOBAL_STR(str641, "ouxX");
GLOBAL_STR(str642, "Can't format negative number %d with %%%s");
GLOBAL_STR(str643, "u");
GLOBAL_STR(str644, "o");
GLOBAL_STR(str645, "x");
GLOBAL_STR(str646, "X");
GLOBAL_STR(str647, "TZ");
GLOBAL_STR(str648, "TZ");
GLOBAL_STR(str649, "-");
GLOBAL_STR(str650, " ");
GLOBAL_STR(str651, "0");
GLOBAL_STR(str652, "0");
GLOBAL_STR(str653, " ");
GLOBAL_STR(str654, "");
GLOBAL_STR(str655, "Invalid -v expression");
GLOBAL_STR(str656, "-v expected a variable name.  shopt -s eval_unsafe_arith allows expressions");
GLOBAL_STR(str657, "alias");
GLOBAL_STR(str658, "alias %s=%r");
GLOBAL_STR(str659, "=");
GLOBAL_STR(str660, "No alias named %r");
GLOBAL_STR(str661, "alias %s=%r");
GLOBAL_STR(str662, "unalias");
GLOBAL_STR(str663, "requires an argument");
GLOBAL_STR(str664, "No alias named %r");
GLOBAL_STR(str665, "%s=%s");
GLOBAL_STR(str666, "set");
GLOBAL_STR(str667, "shopt");
GLOBAL_STR(str668, "got invalid option %r");
GLOBAL_STR(str669, "hash");
GLOBAL_STR(str670, "got extra arguments after -r");
GLOBAL_STR(str671, "hash: %r not found");
GLOBAL_STR(str672, ":");
GLOBAL_STR(str673, "OPTIND");
GLOBAL_STR(str674, "OPTIND");
GLOBAL_STR(str675, "OPTARG");
GLOBAL_STR(str676, "OPTARG");
GLOBAL_STR(str677, "");
GLOBAL_STR(str678, "?");
GLOBAL_STR(str679, "-");
GLOBAL_STR(str680, "-");
GLOBAL_STR(str681, "?");
GLOBAL_STR(str682, "?");
GLOBAL_STR(str683, "getopts: option %r requires an argument.");
GLOBAL_STR(str684, "(getopts argv: %s)");
GLOBAL_STR(str685, " ");
GLOBAL_STR(str686, "?");
GLOBAL_STR(str687, "");
GLOBAL_STR(str688, "requires an argspec");
GLOBAL_STR(str689, "requires the name of a variable to set");
GLOBAL_STR(str690, "got invalid variable name %r");
GLOBAL_STR(str691, "echo");
GLOBAL_STR(str692, "");
GLOBAL_STR(str693, "takes at most one arg when simple_echo is on (hint: add quotes)");
GLOBAL_STR(str694, " ");
GLOBAL_STR(str695, "\n");
GLOBAL_STR(str696, "Assignment builtin %r not configured");
GLOBAL_STR(str697, "%r ");
GLOBAL_STR(str698, "");
GLOBAL_STR(str699, "command in ");
GLOBAL_STR(str700, "assignment in ");
GLOBAL_STR(str701, "subshell invoked from ");
GLOBAL_STR(str702, "pipeline invoked from ");
GLOBAL_STR(str703, "");
GLOBAL_STR(str704, "Exiting with status %d (%sPID %d)");
GLOBAL_STR(str705, "Redirect filename can't be empty");
GLOBAL_STR(str706, "Redirect descriptor can't be empty");
GLOBAL_STR(str707, "-");
GLOBAL_STR(str708, "-");
GLOBAL_STR(str709, "Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
GLOBAL_STR(str710, "\n");
GLOBAL_STR(str711, "Unknown redirect op");
GLOBAL_STR(str712, "Unknown redirect type");
GLOBAL_STR(str713, "strict_errexit only allows simple commands (got %s). Hint: use 'run'.");
GLOBAL_STR(str714, "strict_errexit only allows a single command.  Hint: use \"run\".");
GLOBAL_STR(str715, "strict_errexit only allows simple commands (got %s). Hint: use 'run'.");
GLOBAL_STR(str716, "ShAssignment builtins don't accept blocks");
GLOBAL_STR(str717, "|& isn't supported");
GLOBAL_STR(str718, "Can't append array to string");
GLOBAL_STR(str719, "Can't append string to array");
GLOBAL_STR(str720, "%r expected a number, got %r");
GLOBAL_STR(str721, "Invalid control flow at top level");
GLOBAL_STR(str722, "warning: ");
GLOBAL_STR(str723, "trap");
GLOBAL_STR(str724, "Loop and control flow can't be in different processes");
GLOBAL_STR(str725, "fatal: ");
GLOBAL_STR(str726, "EXIT");
GLOBAL_STR(str727, "trap EXIT");
GLOBAL_STR(str728, "__");
GLOBAL_STR(str729, ":");
GLOBAL_STR(str730, "Invalid argument %r.  Expected a name starting with :");
GLOBAL_STR(str731, "No value provided for param %r");
GLOBAL_STR(str732, "proc %r expected %d arguments, but got %d");
GLOBAL_STR(str733, "Unexpected %r (in function call)");
GLOBAL_STR(str734, "Attempted to exit from completion hook.");
GLOBAL_STR(str735, "Couldn't find terminator for here doc that starts here");
GLOBAL_STR(str736, "\t");
GLOBAL_STR(str737, "Invalid here doc delimiter");
GLOBAL_STR(str738, "+");
GLOBAL_STR(str739, "+");
GLOBAL_STR(str740, "+");
GLOBAL_STR(str741, "%d != %d");
GLOBAL_STR(str742, "Environment binding shouldn't look like an array assignment");
GLOBAL_STR(str743, "+");
GLOBAL_STR(str744, "Expected = in environment binding, got +=");
GLOBAL_STR(str745, "Environment bindings can't contain array literals");
GLOBAL_STR(str746, "procs can't contain other procs or functions");
GLOBAL_STR(str747, "%r was already declared");
GLOBAL_STR(str748, "%r hasn't been declared");
GLOBAL_STR(str749, "Can't modify constant %r");
GLOBAL_STR(str750, "Expected word type %s, got %s");
GLOBAL_STR(str751, "{");
GLOBAL_STR(str752, "}");
GLOBAL_STR(str753, "Invalid token after redirect operator");
GLOBAL_STR(str754, "TODO: Parse Redirect");
GLOBAL_STR(str755, " ");
GLOBAL_STR(str756, " ");
GLOBAL_STR(str757, "line IDs %d != %d");
GLOBAL_STR(str758, " ");
GLOBAL_STR(str759, "");
GLOBAL_STR(str760, "Unexpected block");
GLOBAL_STR(str761, "=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
GLOBAL_STR(str762, "name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
GLOBAL_STR(str763, "Unexpected block");
GLOBAL_STR(str764, "Unexpected block");
GLOBAL_STR(str765, "Control flow shouldn't have redirects");
GLOBAL_STR(str766, "Control flow shouldn't have environment bindings");
GLOBAL_STR(str767, "Unexpected argument to %r");
GLOBAL_STR(str768, "Invalid word in for loop");
GLOBAL_STR(str769, "Invalid word after for expression");
GLOBAL_STR(str770, "Loop variable name should be a constant");
GLOBAL_STR(str771, "Invalid loop variable name");
GLOBAL_STR(str772, "Unexpected word after for loop variable");
GLOBAL_STR(str773, "Expected ;; or esac");
GLOBAL_STR(str774, "Unexpected word while parsing compound command");
GLOBAL_STR(str775, "Invalid function name");
GLOBAL_STR(str776, "Expected ) in function definition");
GLOBAL_STR(str777, "Invalid KSH-style function name");
GLOBAL_STR(str778, "Unexpected word when parsing command");
GLOBAL_STR(str779, "Unexpected right brace");
GLOBAL_STR(str780, "Unexpected EOF while parsing command");
GLOBAL_STR(str781, "Invalid word while parsing command");
GLOBAL_STR(str782, "Unexpected word while parsing command line");
GLOBAL_STR(str783, "Unterminated here doc began here");
GLOBAL_STR(str784, "\\");
GLOBAL_STR(str785, "*");
GLOBAL_STR(str786, "?");
GLOBAL_STR(str787, "[");
...
GLOBAL_STR(str791, "\\?*+{}^$.()|");
GLOBAL_STR(str792, "\\");
GLOBAL_STR(str793, "Unexpected escaped character %r");
GLOBAL_STR(str794, "");
GLOBAL_STR(str795, "");
GLOBAL_STR(str796, "Malformed character class; treating as literal");
GLOBAL_STR(str797, "Got unescaped right bracket");
GLOBAL_STR(str798, "Got unescaped trailing backslash");
GLOBAL_STR(str799, ".|^$()+*?[]{}\\");
GLOBAL_STR(str800, "\\");
GLOBAL_STR(str801, "\\");
GLOBAL_STR(str802, "\\[");
...
GLOBAL_STR(str814, "]");
GLOBAL_STR(str815, "");
GLOBAL_STR(str816, "Error expanding glob %r: %s");
GLOBAL_STR(str817, "-");
GLOBAL_STR(str818, "<Error: unbalanced \\[ and \\]> ");
GLOBAL_STR(str819, "$");
GLOBAL_STR(str820, "#");
GLOBAL_STR(str821, "$");
GLOBAL_STR(str822, "hostname");
GLOBAL_STR(str823, "user");
GLOBAL_STR(str824, "$ ");
GLOBAL_STR(str825, "\u0001");
GLOBAL_STR(str826, "\u0002");
GLOBAL_STR(str827, "$");
GLOBAL_STR(str828, "$");
GLOBAL_STR(str829, "u");
GLOBAL_STR(str830, "user");
GLOBAL_STR(str831, "h");
GLOBAL_STR(str832, "hostname");
GLOBAL_STR(str833, ".");
GLOBAL_STR(str834, "H");
GLOBAL_STR(str835, "hostname");
GLOBAL_STR(str836, "w");
GLOBAL_STR(str837, "PWD");
GLOBAL_STR(str838, "HOME");
GLOBAL_STR(str839, "<Error: %s>");
GLOBAL_STR(str840, "W");
GLOBAL_STR(str841, "PWD");
GLOBAL_STR(str842, "<Error: PWD is not a string> ");
GLOBAL_STR(str843, "<Error: \\%s not implemented in $PS1> ");
GLOBAL_STR(str844, "$");
GLOBAL_STR(str845, "\\$");
GLOBAL_STR(str846, "Invalid token %r");
GLOBAL_STR(str847, "");
GLOBAL_STR(str848, "<ERROR: Can't parse PS1: %s>");
GLOBAL_STR(str849, "osh");
GLOBAL_STR(str850, "PS1");
GLOBAL_STR(str851, "PROMPT_COMMAND");
GLOBAL_STR(str852, "Undefined variable %r");
GLOBAL_STR(str853, "Can't use [] on value of type %s");
GLOBAL_STR(str854, "");
GLOBAL_STR(str855, "Can't use [] on value of type %s");
GLOBAL_STR(str856, "");
GLOBAL_STR(str857, "0x");
GLOBAL_STR(str858, "Invalid hex constant %r");
GLOBAL_STR(str859, "0");
GLOBAL_STR(str860, "Invalid octal constant %r");
GLOBAL_STR(str861, "#");
GLOBAL_STR(str862, "#");
GLOBAL_STR(str863, "Invalid base for numeric constant %r");
GLOBAL_STR(str864, "a");
GLOBAL_STR(str865, "A");
GLOBAL_STR(str866, "@");
GLOBAL_STR(str867, "_");
GLOBAL_STR(str868, "Invalid digits for numeric constant %r");
GLOBAL_STR(str869, "Digits %r out of range for base %d");
GLOBAL_STR(str870, "Parse error in recursive arithmetic");
GLOBAL_STR(str871, "Invalid integer constant %r");
GLOBAL_STR(str872, "Invalid integer constant %r");
GLOBAL_STR(str873, "Invalid integer constant %r");
GLOBAL_STR(str874, "Undefined value in arithmetic context");
GLOBAL_STR(str875, "Expected a value convertible to integer, got %s");
GLOBAL_STR(str876, "0");
GLOBAL_STR(str877, "Divide by zero");
GLOBAL_STR(str878, "Divide by zero");
GLOBAL_STR(str879, "Expected array or assoc in index expression, got %s");
GLOBAL_STR(str880, "Divide by zero");
GLOBAL_STR(str881, "Divide by zero");
GLOBAL_STR(str882, "Exponent can't be less than zero");
GLOBAL_STR(str883, "Associative array keys must be strings: $x 'x' \"$x\" etc.");
GLOBAL_STR(str884, "Invalid place to modify");
GLOBAL_STR(str885, "BASH_REMATCH");
GLOBAL_STR(str886, "%s isn't implemented");
GLOBAL_STR(str887, "Invalid regex %r: %s");
GLOBAL_STR(str888, " \t\n");
GLOBAL_STR(str889, "IFS");
GLOBAL_STR(str890, "IFS shouldn't be an array");
GLOBAL_STR(str891, " \t\n");
GLOBAL_STR(str892, "IFS");
GLOBAL_STR(str893, " ");
GLOBAL_STR(str894, "");
GLOBAL_STR(str895, "IFS shouldn't be an array");
GLOBAL_STR(str896, "\\");
GLOBAL_STR(str897, "\\");
GLOBAL_STR(str898, "Invalid transition from %r with %r");
GLOBAL_STR(str899, "\u00ef\u00bf\u00bd");
GLOBAL_STR(str900, "");
GLOBAL_STR(str901, "Incomplete UTF-8 character");
GLOBAL_STR(str902, "Invalid UTF-8 continuation byte");
GLOBAL_STR(str903, "Invalid start of UTF-8 character");
GLOBAL_STR(str904, "");
GLOBAL_STR(str905, "%s can't have an argument");
GLOBAL_STR(str906, "");
GLOBAL_STR(str907, "%s can't have an argument");
GLOBAL_STR(str908, "");
GLOBAL_STR(str909, "%s can't have an argument");
GLOBAL_STR(str910, "");
GLOBAL_STR(str911, "%s can't have an argument");
GLOBAL_STR(str912, "");
GLOBAL_STR(str913, "<_GlobReplacer regex %r r %r>");
GLOBAL_STR(str914, "(%s)");
GLOBAL_STR(str915, "Error matching regex %r: %s");
GLOBAL_STR(str916, "^");
GLOBAL_STR(str917, "$");
GLOBAL_STR(str918, "\r");
GLOBAL_STR(str919, "<INVALID CR>");
GLOBAL_STR(str920, "\n");
GLOBAL_STR(str921, "<INVALID NEWLINE>");
GLOBAL_STR(str922, " `~!$&*()[]{}\\|;'\"<>?");
GLOBAL_STR(str923, "Left-hand side of this assignment is invalid");
GLOBAL_STR(str924, "Token can't be used in prefix position");
GLOBAL_STR(str925, "Token can't be used in infix position");
GLOBAL_STR(str926, "Parser expected %s, got %s");
GLOBAL_STR(str927, "Unexpected end of input");
GLOBAL_STR(str928, "");
GLOBAL_STR(str929, "");
GLOBAL_STR(str930, "BASH_SOURCE");
GLOBAL_STR(str931, "FUNCNAME");
GLOBAL_STR(str932, "BASH_LINENO");
GLOBAL_STR(str933, "0");
GLOBAL_STR(str934, "0");
GLOBAL_STR(str935, "\\");
GLOBAL_STR(str936, "\\\\");
GLOBAL_STR(str937, "");
GLOBAL_STR(str938, "");
GLOBAL_STR(str939, "The length index of a array slice can't be negative: %d");
GLOBAL_STR(str940, "Can't slice associative arrays");
GLOBAL_STR(str941, "i");
GLOBAL_STR(str942, "e");
GLOBAL_STR(str943, "f");
GLOBAL_STR(str944, "n");
...
GLOBAL_STR(str948, "");
GLOBAL_STR(str949, "~");
GLOBAL_STR(str950, "HOME");
GLOBAL_STR(str951, "Error expanding tilde (e.g. invalid user)");
GLOBAL_STR(str952, "Can't assign to special variable");
GLOBAL_STR(str953, "unset variable %r");
GLOBAL_STR(str954, "@");
GLOBAL_STR(str955, "*");
GLOBAL_STR(str956, "@");
GLOBAL_STR(str957, "*");
GLOBAL_STR(str958, "warning: ");
GLOBAL_STR(str959, "-1");
GLOBAL_STR(str960, "@");
GLOBAL_STR(str961, "*");
GLOBAL_STR(str962, "[");
GLOBAL_STR(str963, "]");
GLOBAL_STR(str964, "Bad indirect expansion: %r");
GLOBAL_STR(str965, "");
GLOBAL_STR(str966, "warning: ");
GLOBAL_STR(str967, "");
GLOBAL_STR(str968, "\u0001");
GLOBAL_STR(str969, "");
GLOBAL_STR(str970, "\u0002");
GLOBAL_STR(str971, "");
GLOBAL_STR(str972, "Can't use @P on %s");
GLOBAL_STR(str973, " ");
GLOBAL_STR(str974, "Can't use @Q on %s");
GLOBAL_STR(str975, "a");
GLOBAL_STR(str976, "A");
GLOBAL_STR(str977, "r");
GLOBAL_STR(str978, "x");
GLOBAL_STR(str979, "n");
GLOBAL_STR(str980, "");
GLOBAL_STR(str981, "Var op %r not implemented");
GLOBAL_STR(str982, "Can't index string with @");
GLOBAL_STR(str983, "Can't index string with *");
GLOBAL_STR(str984, "Can't index string %r with integer");
GLOBAL_STR(str985, "");
GLOBAL_STR(str986, "");
GLOBAL_STR(str987, "$");
GLOBAL_STR(str988, "Undefined variable %r");
GLOBAL_STR(str989, "Undefined array %r");
GLOBAL_STR(str990, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str991, "Illegal array word part (strict_array)");
GLOBAL_STR(str992, " ");
GLOBAL_STR(str993, "");
GLOBAL_STR(str994, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str995, "Unexpected array literal");
GLOBAL_STR(str996, "Unexpected associative array literal");
GLOBAL_STR(str997, "@(");
GLOBAL_STR(str998, "|");
GLOBAL_STR(str999, ")");
GLOBAL_STR(str1000, "Can't splice %r");
GLOBAL_STR(str1001, "");
GLOBAL_STR(str1002, "");
GLOBAL_STR(str1003, "This word should yield a string, but it contains an array");
GLOBAL_STR(str1004, " ");
GLOBAL_STR(str1005, "");
GLOBAL_STR(str1006, "<Runtime error: %s>");
GLOBAL_STR(str1007, "<I/O error: %s>");
GLOBAL_STR(str1008, "<Ctrl-C>");
GLOBAL_STR(str1009, "");
GLOBAL_STR(str1010, "");
GLOBAL_STR(str1011, "");
GLOBAL_STR(str1012, "");
GLOBAL_STR(str1013, "");
GLOBAL_STR(str1014, "LHS array not allowed in assignment builtin");
GLOBAL_STR(str1015, "+");
GLOBAL_STR(str1016, "+= not allowed in assignment builtin");
GLOBAL_STR(str1017, "-");
GLOBAL_STR(str1018, "+");
GLOBAL_STR(str1019, "f");
GLOBAL_STR(str1020, "F");
GLOBAL_STR(str1021, "");
GLOBAL_STR(str1022, "=");
GLOBAL_STR(str1023, "Invalid variable name %r");
GLOBAL_STR(str1024, "__NO_COMMAND_SUB__");
GLOBAL_STR(str1025, "__NO_PROCESS_SUB__");
GLOBAL_STR(str1026, "Expected : or } in slice");
GLOBAL_STR(str1027, "Pattern in ${x/pat/replace} must not be empty");
GLOBAL_STR(str1028, "Expected } after replacement string, got %s");
GLOBAL_STR(str1029, "Expected } or / to close pattern");
GLOBAL_STR(str1030, "Expected ] to close subscript");
GLOBAL_STR(str1031, "Expected } to close ${");
GLOBAL_STR(str1032, "Expected } to close ${");
GLOBAL_STR(str1033, "Expected } to close ${");
GLOBAL_STR(str1034, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1035, "VOp2");
GLOBAL_STR(str1036, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1037, "VOp3");
GLOBAL_STR(str1038, "Expected } to close ${");
GLOBAL_STR(str1039, "Expected } after length expression");
GLOBAL_STR(str1040, "Unexpected token in ${}");
GLOBAL_STR(str1041, "\\");
GLOBAL_STR(str1042, "Strings with backslashes should look like r'\\n' or c'\\n'");
GLOBAL_STR(str1043, "Use \\xhh or \\u{...} instead of octal escapes in Oil strings");
GLOBAL_STR(str1044, "Invalid hex escape in Oil string (must be \\xHH)");
GLOBAL_STR(str1045, "Invalid char escape in C-style string literal");
GLOBAL_STR(str1046, "Unexpected EOF in single-quoted string that began here");
GLOBAL_STR(str1047, "Unexpected EOF reading extended glob that began here");
GLOBAL_STR(str1048, "Invalid char escape in double quoted string");
GLOBAL_STR(str1049, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1050, "Invalid backtick: use $(cmd) or \\` in Oil strings");
GLOBAL_STR(str1051, "Unexpected EOF reading double-quoted string that began here");
GLOBAL_STR(str1052, "Use $(cmd) instead of backticks (parse_backticks)");
GLOBAL_STR(str1053, "Unexpected EOF while looking for closing backtick");
GLOBAL_STR(str1054, "");
GLOBAL_STR(str1055, "Invalid proc name %s");
GLOBAL_STR(str1056, "Unexpected token after arithmetic expression (%s != %s)");
GLOBAL_STR(str1057, "Expected second ) to end arith sub");
GLOBAL_STR(str1058, "Expected second ) to end arith statement");
GLOBAL_STR(str1059, "Expected ; here");
GLOBAL_STR(str1060, "Expected ; here");
GLOBAL_STR(str1061, "Expected ) to end for loop expression");
GLOBAL_STR(str1062, "Expected ( after =");
GLOBAL_STR(str1063, "Unexpected token in array literal");
GLOBAL_STR(str1064, "Expected associative array pair");
GLOBAL_STR(str1065, "Invalid char escape (parse_backslash)");
GLOBAL_STR(str1066, "Unexpected token after array literal");
GLOBAL_STR(str1067, "Unexpected token after array splice");
GLOBAL_STR(str1068, "Literal @ starting a word must be quoted (parse_at_all)");
GLOBAL_STR(str1069, "/");
GLOBAL_STR(str1070, "next_byte %r");
GLOBAL_STR(str1071, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1072, "Unexpected token after @()");
GLOBAL_STR(str1073, "id = %s");
GLOBAL_STR(str1074, "id = %s");
GLOBAL_STR(str1075, "Word has unbalanced { }.  Maybe add a space or quote it like \\{");
GLOBAL_STR(str1076, "Unexpected token while parsing arithmetic: %r");
GLOBAL_STR(str1077, "Unhandled: %s (%s)");
GLOBAL_STR(str1078, "Invalid lex state %s");
GLOBAL_STR(str1079, "");
GLOBAL_STR(str1080, "");
GLOBAL_STR(str1081, "");
GLOBAL_STR(str1082, "");
...
GLOBAL_STR(str1086, "");
GLOBAL_STR(str1087, "");
GLOBAL_STR(str1088, "Compound shouldn't be empty");
GLOBAL_STR(str1089, "/");
GLOBAL_STR(str1090, "/");
GLOBAL_STR(str1091, "");
GLOBAL_STR(str1092, "EOF");
GLOBAL_STR(str1093, "typ");
GLOBAL_STR(str1094, "tok");
GLOBAL_STR(str1095, "children");
GLOBAL_STR(str1096, "-");
GLOBAL_STR(str1097, "with %d children");
GLOBAL_STR(str1098, "");
GLOBAL_STR(str1099, "(PNode %s %s %s)");
GLOBAL_STR(str1100, "&");
GLOBAL_STR(str1101, "&amp;");
GLOBAL_STR(str1102, "<");
GLOBAL_STR(str1103, "&lt;");
...
GLOBAL_STR(str1129, "/");
GLOBAL_STR(str1130, " \n\r\t");
GLOBAL_STR(str1131, "Unexpected token in QSN string");
GLOBAL_STR(str1132, "Expected closing single quote in QSN string");
GLOBAL_STR(str1133, "Unexpected data after closing quote");
GLOBAL_STR(str1134, "Unexpected token after QSN string");
GLOBAL_STR(str1135, "\\'\r\n\t\u0000");
GLOBAL_STR(str1136, "$'");
GLOBAL_STR(str1137, "'");
GLOBAL_STR(str1138, "'");
...
GLOBAL_STR(str1150, "\n");
GLOBAL_STR(str1151, "\\n");
GLOBAL_STR(str1152, "\r");
GLOBAL_STR(str1153, "\\r");
GLOBAL_STR(str1154, "\t");
GLOBAL_STR(str1155, "\\t");
GLOBAL_STR(str1156, "\u0000");
GLOBAL_STR(str1157, "\\x00");
GLOBAL_STR(str1158, "\\0");
GLOBAL_STR(str1159, "");
GLOBAL_STR(str1160, "");
GLOBAL_STR(str1161, "");
GLOBAL_STR(str1162, "\\");
...
GLOBAL_STR(str1166, "\n");
GLOBAL_STR(str1167, "\\n");
GLOBAL_STR(str1168, "\r");
GLOBAL_STR(str1169, "\\r");
GLOBAL_STR(str1170, "\t");
GLOBAL_STR(str1171, "\\t");
GLOBAL_STR(str1172, "\u0000");
GLOBAL_STR(str1173, "\\x00");
GLOBAL_STR(str1174, "\\0");
GLOBAL_STR(str1175, "");
GLOBAL_STR(str1176, "!");
GLOBAL_STR(str1177, "--");
GLOBAL_STR(str1178, "--dir");
GLOBAL_STR(str1179, "--exists");
GLOBAL_STR(str1180, "--file");
GLOBAL_STR(str1181, "--symlink");
GLOBAL_STR(str1182, "Expected unary operator, got %r (2 args)");
GLOBAL_STR(str1183, "-a");
GLOBAL_STR(str1184, "-o");
GLOBAL_STR(str1185, "!");
GLOBAL_STR(str1186, "(");
GLOBAL_STR(str1187, ")");
GLOBAL_STR(str1188, "Expected binary operator, got %r (3 args)");
GLOBAL_STR(str1189, "should be invoked as 'test' (simple_test_builtin)");
GLOBAL_STR(str1190, "]");
GLOBAL_STR(str1191, "missing closing ]");
GLOBAL_STR(str1192, "should only have 3 arguments or fewer (simple_test_builtin)");
GLOBAL_STR(str1193, "!");
GLOBAL_STR(str1194, "(");
GLOBAL_STR(str1195, ")");
GLOBAL_STR(str1196, "(test) ");
GLOBAL_STR(str1197, "(test) ");
...
inline Str* fmt31(int a0, Str* a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const(": ", 2);
  gBuf.format_s(a1);
...
inline Str* fmt32(int a0, Str* a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const(": ", 2);
  gBuf.format_s(a1);
...
inline Str* fmt33(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt35(int a0, int a1, Str* a2) {
  gBuf.reset();
...
inline Str* fmt36(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt54(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const(":", 1);
  gBuf.format_s(a1);
...
inline Str* fmt77(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt78(Str* a0, int a1, Str* a2, Str* a3) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const(":", 1);
  gBuf.format_d(a1);
...
inline Str* fmt113(int a0, int a1) {
  gBuf.reset();
...
inline Str* fmt135(int a0, Str* a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const("  ", 2);
  gBuf.format_s(a1);
...
inline Str* fmt137(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt149(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt164(int a0, Str* a1, int a2) {
  gBuf.reset();
...
inline Str* fmt174(Str* a0, int a1, int a2) {
  gBuf.reset();
...
inline Str* fmt224(Str* a0, int a1) {
  gBuf.reset();
...
inline Str* fmt236(Str* a0, Str* a1, syntax_asdl::word_t* a2) {
  gBuf.reset();
...
inline Str* fmt299(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt319(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("/", 1);
  gBuf.format_s(a1);
  ...
  if (call_procs) {
    ...
    if (proc_node != nullptr) {
      if ((this->exec_opts->strict_errexit() and this->mutable_opts->ErrExitIsDisabled())) {
        this->errfmt->Print_(str130, this->mutable_opts->ErrExitSpanId());
...
int FdState::_PushDup(int fd1, syntax_asdl::redir_loc_t* loc) {
  ...
  if (loc->tag_() == redir_loc_e::VarName) {
    ...
    try {
      ...
      if (e->errno == errno_::EBADF) {
        this->errfmt->Print_(fmt30(fd1, pyutil::strerror(e)));
        return NO_FD;
      }
      else {
        throw ;
    ...
    if (loc->tag_() == redir_loc_e::Fd) {
      ...
      try {
        ...
        this->errfmt->Print_(fmt31(fd1, pyutil::strerror(e)));
        throw ;
      }
      ...
      try {
        ...
        this->errfmt->Print_(fmt32(fd1, pyutil::strerror(e)));
        if (need_restore) {
  ...
  switch (arg->tag_()) {
    case redirect_arg_e::Path: {
      ...
      try {
        ...
        this->errfmt->Print_(fmt33(arg->filename, pyutil::strerror(e)), r->op_spid);
        throw ;
      }
  ...
  for (ReverseListIter<process::_RedirFrame*> it(frame->saved); !it.Done(); it.Next()) {
    ...
    if (rf->saved_fd == NO_FD) {
      try {
        ...
        println_stderr(fmt34(rf->orig_fd, pyutil::strerror(e)));
        throw ;
      }
    }
    else {
      try {
        ...
        println_stderr(fmt35(rf->saved_fd, rf->orig_fd, pyutil::strerror(e)));
        throw ;
      }
      posix::close(rf->saved_fd);
    }
...
void ExternalProgram::_Exec(Str* argv0_path, List<Str*>* argv, int argv0_spid, Dict<Str*, Str*>* environ, bool should_retry) {
  ...
  try {
    ...
    if ((e->errno == errno_::ENOEXEC and should_retry)) {
      new_argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str154, argv0_path});
      new_argv->extend(argv->slice(1));
      this->_Exec(str155, new_argv, argv0_spid, environ, false);
    }
    this->errfmt->Print_(fmt36(argv0_path, pyutil::strerror(e)), argv0_spid);
...
Str* SubProgramThunk::DisplayLine() {
  return fmt38(ui::CommandType(this->node));
}
...
void SubProgramThunk::Run() {
  ...
  try {
    ...
    println_stderr(fmt39(pyutil::strerror(e)));
    status = 2;
  }
  posix::_exit(status);
}
...
int Process::Start(runtime_asdl::trace_t* why) {
  ...
  pid = posix::fork();
  if (pid < 0) {
    throw Alloc<RuntimeError>(str164);
  }
  else {
    if (pid == 0) {
  ...
  if (WIFSIGNALED(status)) {
    ...
    if (WIFEXITED(status)) {
      ...
      if (WIFSTOPPED(status)) {
        println_stderr(str170);
        println_stderr(fmt42(pid));
...
runtime_asdl::cmd_value__Argv* MakeBuiltinArgv(List<Str*>* argv1) {
  ...
  argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str172});
  argv->extend(argv1);
...
int Main(Str* lang, args::Reader* arg_r, Dict<Str*, Str*>* environ, bool login_shell, pyutil::_ResourceLoader* loader, void* line_input) {
  ...
  if (flag->help) {
    help_builtin->Run(MakeBuiltinArgv(Alloc<List<Str*>>(std::initializer_list<Str*>{fmt44(lang)})));
    return 0;
  }
  if (flag->version) {
    pyutil::ShowAppVersion(str176, loader);
    return 0;
  }
  no_str = nullptr;
  ...
  if (arg_r->AtEnd()) {
    ...
    dollar0 = arg_r->Peek();
    frame0 = Alloc<state::DebugFrame>(dollar0, str177, no_str, state::LINE_ZERO, 0, 0);
  ...
  if (str_equals(lang, str178)) {
    mutable_opts->SetShoptOption(str179, true);
  }
  ...
  comp_arena->PushSource(Alloc<source::Unused>(str181));
  ...
  hist_arena->PushSource(Alloc<source::Unused>(str182));
  ...
  my_pid = posix::getpid();
  debug_path = str183;
  debug_dir = environ->get(str184);
  if (flag->debug_file != nullptr) {
    debug_path = flag->debug_file;
  }
  else {
    if (debug_dir != nullptr) {
      debug_path = os_path::join(debug_dir, fmt45(my_pid));
    }
  }
  if (len(debug_path)) {
    throw Alloc<NotImplementedError>();
  ...
  if (len(debug_path)) {
    println_stderr(fmt46(debug_path));
  }
  ...
  interp = environ->get(str187, str188);
  ...
  crash_dump_dir = environ->get(str189, str190);
  ...
  if (flag->c != nullptr) {
    ...
    if (flag->i) {
      ...
      if (script_name == nullptr) {
        stdin = mylib::Stdin();
        arena->PushSource(Alloc<source::Stdin>(str191));
        ...
        try {
          ...
          println_stderr(fmt47(script_name, pyutil::strerror(e)));
          return 1;
        }
...
Str* SearchPath::Lookup(Str* name, bool exec_required) {
  ...
  val = this->mem->GetValue(str201);
  UP_val = val;
  if (val->tag_() == value_e::Str) {
    value__Str* val = static_cast<value__Str*>(UP_val);
    path_list = val->s->split(str202);
  }
  else {
...
void MutableOpts::Init() {
  ...
  UP_shellopts = this->mem->GetValue(str206);
...
void MutableOpts::SetOption(Str* opt_name, bool b) {
  ...
  UP_val = this->mem->GetValue(str210);
  value__Str* val = static_cast<value__Str*>(UP_val);
  shellopts = val->s;
  if (b) {
    if (!str_contains(shellopts, opt_name)) {
      new_val = Alloc<value::Str>(fmt54(shellopts, opt_name));
      this->mem->InternalSetGlobal(str212, new_val);
    }
  }
  else {
    if (str_contains(shellopts, opt_name)) {
      names = Alloc<List<Str*>>();
      for (ListIter<Str*> it(shellopts->split(str213)); !it.Done(); it.Next()) {
        Str* n = it.Value();
        if (!(str_equals(n, opt_name))) {
          names->append(n);
        }
      }
      new_val = Alloc<value::Str>(str214->join(names));
      this->mem->InternalSetGlobal(str215, new_val);
    }
  }
}
...
void MutableOpts::SetShoptOption(Str* opt_name, bool b) {
  ...
  if (str_equals(opt_name, str216)) {
    this->_SetGroup(consts::OIL_BASIC, b);
    return ;
  }
  if (str_equals(opt_name, str217)) {
    this->_SetGroup(consts::OIL_ALL, b);
    return ;
  }
  if (str_equals(opt_name, str218)) {
...
void MutableOpts::ShowOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    b = this->Get(opt_num);
    print(fmt55(b ? str220 : str221, opt_name));
  }
}
...
void MutableOpts::ShowShoptOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<int> it(opt_nums); !it.Done(); it.Next()) {
    ...
    print(fmt57(b ? str227 : str228, consts::OptionName(opt_num)));
  }
}
...
void _InitDefaults(state::Mem* mem) {
  ...
  SetGlobalString(mem, str231, split::DEFAULT_IFS);
  SetGlobalString(mem, str232, str(posix::getuid()));
  SetGlobalString(mem, str233, str(posix::geteuid()));
  SetGlobalString(mem, str234, str(posix::getppid()));
  SetGlobalString(mem, str235, libc::gethostname());
  SetGlobalString(mem, str236, pyos::OsType());
  SetGlobalString(mem, str237, str238);
  SetGlobalString(mem, str239, str240);
  SetGlobalString(mem, str241, _READLINE_DELIMS);
}
...
void _InitVarsFromEnv(state::Mem* mem, Dict<Str*, Str*>* environ) {
  ...
  val = mem->GetValue(str242);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str243, str244);
  }
  mem->SetValue(Alloc<lvalue::Named>(str245), nullptr, scope_e::GlobalOnly, SetReadOnly);
  val = mem->GetValue(str246);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str247, _GetWorkingDir());
  }
  mem->SetValue(Alloc<lvalue::Named>(str248), nullptr, scope_e::GlobalOnly, SetExport);
}
...
void InitMem(state::Mem* mem, Dict<Str*, Str*>* environ, Str* version_str) {
  ...
  SetGlobalString(mem, str249, version_str);
  _InitDefaults(mem);
...
Mem::Mem(Str* dollar0, List<Str*>* argv, alloc::Arena* arena, List<state::DebugFrame*>* debug_stack) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Mem)) {
  ...
  this->line_num = Alloc<value::Str>(str251);
...
void Mem::_DisallowNamerefCycle(Str* name, runtime_asdl::scope_t which_scopes, List<Str*>* ref_trail) {
  ...
  if (list_contains(ref_trail, new_name)) {
    e_die(fmt62(str263->join(ref_trail)));
  }
  ...
  switch (lval->tag_()) {
    case lvalue_e::Named: {
      ...
      if (keyword_id == Id::KW_SetRef) {
        lval->name = str_concat(str264, lval->name);
      }
    ...
    case lvalue_e::Indexed: {
      ...
      e_die(fmt66(ui::ValType(cell->val)), left_spid);
    }
      break;
    case lvalue_e::Keyed: {
      lvalue__Keyed* lval = static_cast<lvalue__Keyed*>(UP_lval);
...
runtime_asdl::value_t* Mem::GetValue(Str* name, runtime_asdl::scope_t which_scopes) {
  ...
  if (str_equals(name, str272)) {
    return Alloc<value::MaybeStrArray>(this->GetArgv());
  }
  if (str_equals(name, str273)) {
    return Alloc<value::Str>(str(this->last_status->index(-1)));
  }
  if ((str_equals(name, str274) || str_equals(name, str275))) {
    return Alloc<value::MaybeStrArray>();
  }
  if (str_equals(name, str276)) {
    return Alloc<value::MaybeStrArray>();
  }
  if (str_equals(name, str277)) {
    strs = Alloc<List<Str*>>();
...
bool Mem::Unset(runtime_asdl::lvalue_t* lval, bool strict) {
  ...
  if (cell->readonly) {
    throw Alloc<error::Runtime>(fmt68(var_name));
  }
  switch (lval->tag_()) {
    case lvalue_e::Named: {
    ...
    case lvalue_e::Indexed: {
      ...
      if (val->tag_() != value_e::MaybeStrArray) {
        throw Alloc<error::Runtime>(fmt69(var_name));
      }
      value__MaybeStrArray* val = static_cast<value__MaybeStrArray*>(UP_val);
      strs = val->strs;
      n = len(strs);
...
Str* GetString(state::Mem* mem, Str* name) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      throw Alloc<error::Runtime>(fmt70(name));
    }
      break;
    case value_e::Str: {
      ...
      break;
    default: {
      throw Alloc<error::Runtime>(fmt71(name));
    }
  }
}
...
int GetInteger(state::Mem* mem, Str* name) {
  ...
  val = mem->GetValue(name);
  if (val->tag_() != value_e::Str) {
    throw Alloc<error::Runtime>(fmt72(name, ui::ValType(val)));
  }
  ...
  try {
    ...
    throw Alloc<error::Runtime>(fmt73(name, s));
  }
  return i;
}
...
Str* PrettyDir(Str* dir_name, Str* home_dir) {
  ...
  if (home_dir != nullptr) {
    if ((str_equals(dir_name, home_dir) or dir_name->startswith(str_concat(home_dir, str291)))) {
      return str_concat(str292, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    StackRoots _for({&c  });
    f->write(str_equals(c, str295) ? str296 : str297);
  }
  f->write(str298);
  f->write(str_repeat(str299, (length - 1)));
  f->write(str300);
}
...
void _PrintWithSpanId(Str* prefix, Str* msg, int span_id, alloc::Arena* arena, mylib::Writer* f) {
  ...
  switch (src->tag_()) {
    ...
    case source_e::EvalArg: {
      ...
      source_str = fmt77(line_num, outer_source);
    }
      break;
    case source_e::Trap: {
      source_str = str308;
  ...
  f->write(fmt78(source_str, line_num, prefix, msg));
}
...
void PrettyPrintError(error::_ErrorWithLocation* err, alloc::Arena* arena) {
  PrettyPrintError(err, arena, str312);
}
...
void ErrorFormatter::Print_(Str* msg, int span_id) {
  ...
  _PrintWithOptionalSpanId(str313, msg, span_id, this->arena);
}
...
void PrintAst(syntax_asdl::command_t* node, arg_types::main* flag) {
  ...
  if (maybe_str_equals(flag->ast_format, str315)) {
    println_stderr(str316);
  }
  else {
    f = mylib::Stdout();
    afmt = flag->ast_format;
    if ((maybe_str_equals(afmt, str317) || maybe_str_equals(afmt, str318))) {
      ast_f = fmt::DetectConsoleOutput(f);
    }
    else {
      if ((maybe_str_equals(afmt, str319) || maybe_str_equals(afmt, str320))) {
...
void _Attributes::Set(Str* name, runtime_asdl::value_t* val) {
  ...
  name = name->replace(str324, str325);
...
bool SetAttachedBool::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  if (attached_arg != nullptr) {
    if ((str_equals(attached_arg, str341) || str_equals(attached_arg, str342) || str_equals(attached_arg, str343) || str_equals(attached_arg, str344))) {
      b = false;
    }
    else {
      if ((str_equals(attached_arg, str345) || str_equals(attached_arg, str346) || str_equals(attached_arg, str347) || str_equals(attached_arg, str348))) {
        b = true;
      }
      else {
        e_usage(fmt80(attached_arg));
      }
    }
  }
  else {
...
bool SetOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str350);
...
bool SetNamedOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str351);
  arg_r->Next();
  arg = arg_r->Peek();
  if (arg == nullptr) {
...
args::_Attributes* Parse(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str355)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if ((len(spec->actions_long) and arg->startswith(str356))) {
      ...
      if ((arg->startswith(str358) and len(arg) > 1)) {
        n = len(arg);
        for (int i = 1; i < n; ++i) {
          ch = arg->index(i);
          if (str_equals(ch, str359)) {
            ch = str360;
          }
          if (list_contains(spec->plus_flags, ch)) {
            out->Set(ch, Alloc<value::Str>(str361));
            continue;
          }
        ...
        if ((len(spec->plus_flags) and (arg->startswith(str364) and len(arg) > 1))) {
          n = len(arg);
          for (int i = 1; i < n; ++i) {
            ch = arg->index(i);
            if (list_contains(spec->plus_flags, ch)) {
              out->Set(ch, Alloc<value::Str>(str365));
              continue;
            }
            e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
          }
...
args::_Attributes* ParseLikeEcho(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    chars = arg->slice(1);
    if ((arg->startswith(str368) and len(chars))) {
      done = false;
...
args::_Attributes* ParseMore(flag_spec::_FlagSpecAndMore* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str369)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if (arg->startswith(str370)) {
      action = spec->actions_long->get(arg->slice(2));
      if (action == nullptr) {
        e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
      }
    ...
    if (((arg->startswith(str372) or arg->startswith(str373)) and len(arg) > 1)) {
      char0 = arg->index(0);
...
int LineLexer::GetSpanIdForEof() {
  int line_id;
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str378, 0);
  }
  else {
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str380, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = Alloc<Token>(id_, span_id, str381);
      return t;
    }
...
lexer::Lexer* ParseContext::_MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = Alloc<lexer::LineLexer>(str383, this->arena);
...
int _Classify(grammar::Grammar* gr, syntax_asdl::Token* tok) {
  ...
  type_str = tok->id == Id::Unknown_Tok ? str387 : fmt84(ui::PrettyId(tok->id));
  p_die(fmt85(type_str), tok);
}
...
Tuple2<pnode::PNode*, syntax_asdl::Token*> ExprParser::Parse(lexer::Lexer* lexer, int start_symbol) {
  ...
  try {
    ...
    p_die(fmt86(ui::PrettyId(e->tok->id)), e->tok);
  }
...
GLOBAL_LIST(Str*, 12, POSIX_CLASSES, {str391 COMMA str392 COMMA str393 COMMA str394 COMMA str395 COMMA str396 COMMA str397 COMMA str398 COMMA str399 COMMA str400 COMMA str401 COMMA str402});
Str* RANGE_POINT_TOO_LONG = str403;
int NT_OFFSET = 256;
...
syntax_asdl::expr_t* Transformer::_Tuple(List<pnode::PNode*>* children) {
  ...
  if (n == 2) {
    p_die(fmt87(), children->index(1)->tok);
  }
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw Alloc<NotImplementedError>(str405);
  }
  if (id0 == Id::Op_LBracket) {
    elts = Alloc<List<syntax_asdl::expr_t*>>();
    for (int i = 0; i < n; i += 2) {
  ...
  for (int i = 0; i < n; i += 2) {
    ...
    if (tag == expr_e::Var) {
      ...
      if ((tag == place_expr_e::Var || tag == place_expr_e::Subscript || tag == place_expr_e::Attribute)) {
        ...
        p_die(fmt88(), p->tok ? p->tok : nullptr);
      }
    }
  }
  return places;
...
syntax_asdl::re_t* Transformer::_NameInRegex(syntax_asdl::Token* negated_tok, syntax_asdl::Token* tok) {
  ...
  val = tok->val;
  if (maybe_str_equals(val, str410)) {
    if (negated_tok) {
      p_die(fmt89(), tok);
    }
    return tok;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((str_equals(tok->val, str415) || str_equals(tok->val, str416) || str_equals(tok->val, str417))) {
        return tok;
      }
      p_die(fmt93(tok->val), tok);
    }
...
void _ClassLiteralToPosixEre(syntax_asdl::class_literal_term_t* term, List<Str*>* parts) {
  ...
  if (tag == class_literal_term_e::CodePoint) {
    ...
    if (code_point < 128) {
      ...
      e_die(fmt95(code_point), term->spid);
    }
    return ;
  }
  if (tag == class_literal_term_e::PerlClass) {
    ...
    if (term->negated) {
      e_die(fmt96(), term->negated->span_id);
    }
    else {
      pat = fmt97(chars);
    }
  ...
  if (tag == class_literal_term_e::PosixClass) {
    ...
    n = term->name;
    if (term->negated) {
      e_die(fmt98(), term->negated->span_id);
    }
    else {
      pat = fmt99(n);
    }
...
void AsPosixEre(syntax_asdl::re_t* node, List<Str*>* parts) {
  ...
  if (tag == re_e::Repeat) {
    ...
    if (op_tag == re_repeat_e::Num) {
      ...
      parts->append(fmt101(op->times->val));
      return ;
    }
    if (op_tag == re_repeat_e::Range) {
      re_repeat__Range* op = static_cast<re_repeat__Range*>(UP_op);
      lower = op->lower ? op->lower->val : str434;
      upper = op->upper ? op->upper->val : str435;
      parts->append(fmt102(lower, upper));
      return ;
    }
...
syntax_asdl::bool_expr_t* BoolParser::ParseForBuiltin() {
  ...
  if (this->bool_id != Id::Eof_Real) {
    p_die(fmt109(word_::Pretty(this->cur_word)), this->cur_word);
  }
  return node;
}
...
syntax_asdl::bool_expr_t* BoolParser::ParseFactor() {
  ...
  if (this->bool_id == Id::Op_LParen) {
    ...
    if (this->bool_id != Id::Op_RParen) {
      p_die(fmt111(word_::Pretty(this->cur_word)), this->cur_word);
    }
    this->_Next();
    return node;
  }
  p_die(fmt112(ui::PrettyId(this->bool_id)), this->cur_word);
}
...
Str* _RangeParser::_Eat(int token_type) {
  ...
  if (this->token_type != token_type) {
    throw Alloc<_NotARange>(fmt113(token_type, this->token_type));
  }
  val = this->token_val;
  this->_Next();
  return val;
...
syntax_asdl::word_part__BracedRange* _RangeParser::Parse() {
  ...
  if (this->token_type == Id::Range_Int) {
    ...
    if (start < end) {
      ...
      if (part->step <= 0) {
        p_die(fmt115(part->step), this->span_id);
      }
    }
    else {
      if (start > end) {
        ...
        if (part->step >= 0) {
          p_die(fmt116(part->step), this->span_id);
        }
      }
      else {
        part->step = 1;
    ...
    if (this->token_type == Id::Range_Char) {
      ...
      if (start_num < end_num) {
        ...
        if (part->step <= 0) {
          p_die(fmt117(part->step), this->span_id);
        }
      }
      else {
        if (start_num > end_num) {
          ...
          if (part->step >= 0) {
            p_die(fmt118(part->step), this->span_id);
          }
        }
        else {
          part->step = 1;
      ...
      if (upper1 != upper2) {
        p_die(fmt119(), this->span_id);
      }
    }
    else {
      throw Alloc<_NotARange>(str460);
    }
  }
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  flag = attrs->attrs;
  tmp_g = flag->get(str463);
  tmp_a = flag->get(str464);
  tmp_A = flag->get(str465);
  ...
  flag_A = (tmp_A and tmp_A->tag_() == value_e::Bool) ? static_cast<value__Bool*>(tmp_A)->b : false;
  tmp_n = flag->get(str466);
  tmp_r = flag->get(str467);
  tmp_x = flag->get(str468);
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if ((maybe_str_equals(flag_n, str470) and !cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_n, str471) and cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str472) and !cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str473) and cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str474) and !cell->exported)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str475) and cell->exported)) {
      continue;
    }
    ...
    if (print_flags) {
      ...
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str482, str483->join(flags), str484, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str485, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (has_holes) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str488, name, str489, str(i), str490, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str492, str493->join(body), str494}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str496, key_quoted, str497, value_quoted}));
          }
          if (len(body) > 0) {
            decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str498, str499->join(body), str500}));
          }
        }
        else {
          ;  // pass
...
int Export::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r->Next();
  attrs = flag_spec::Parse(str502, arg_r);
...
int Readonly::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str507, arg_r);
...
int NewVar::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str508, arg_r);
  ...
  flags = 0;
  if (maybe_str_equals(arg->x, str511)) {
    flags |= state::SetExport;
  }
  if (maybe_str_equals(arg->r, str512)) {
    flags |= state::SetReadOnly;
  }
  if (maybe_str_equals(arg->n, str513)) {
    flags |= state::SetNameref;
  }
  flags_to_clear = 0;
  if (maybe_str_equals(arg->x, str514)) {
    flags |= state::ClearExport;
  }
  if (maybe_str_equals(arg->r, str515)) {
    flags |= state::ClearReadOnly;
  }
  if (maybe_str_equals(arg->n, str516)) {
...
int Unset::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str519, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
...
int Eval::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str522, cmd_val);
  arg_r = tup0.at1();
  if (this->exec_opts->simple_eval_builtin()) {
    Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str523);
    code_str = tup1.at0();
    eval_spid = tup1.at1();
    if (!arg_r->AtEnd()) {
      e_usage(str524);
    ...
    code_str = str525->join(arg_r->Rest());
  ...
  {  // with
    dev::ctx_Tracer ctx(this->tracer, str526, nullptr);
...
int Source::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str527, cmd_val);
  arg_r = tup2.at1();
  path = arg_r->Peek();
  if (path == nullptr) {
    e_usage(str528);
  ...
  try {
    ...
    this->errfmt->Print_(fmt128(path, pyutil::strerror(e)), cmd_val->arg_spids->index(1));
    return 1;
  }
  try {
    try {
      ...
      c_parser = this->parse_ctx->MakeOshParser(line_reader);
      {  // with
        dev::ctx_Tracer ctx(this->tracer, str530, cmd_val->argv);
...
int Command::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup3 = flag_spec::ParseCmdVal(str531, cmd_val);
  attrs = tup3.at0();
  arg_r = tup3.at1();
...
int Builtin::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (to_run == consts::NO_INDEX) {
    ...
    if (consts::LookupAssignBuiltin(name) != consts::NO_INDEX) {
      this->errfmt->Print_(str532, span_id);
    }
    else {
      this->errfmt->Print_(fmt129(name), span_id);
    }
    return 1;
  }
...
int _AdjustStatus(Str* status_ok, int status) {
  ...
  if ((str_equals(status_ok->lower(), str534) and status == 141)) {
    status = 0;
  }
  return status;
}
...
int Run_::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseOilCmdVal(str535, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
  ...
  if ((arg->allow_status_01 and (status != 0 && status != 1))) {
    if (failure_spid != runtime::NO_SPID) {
      this->errfmt->Print_(str537, failure_spid);
      this->errfmt->StderrLine(str538);
    }
    throw Alloc<error::ErrExit>(fmt131(status), spids->index(0), status);
  }
  if (arg->assign_status != nullptr) {
    var_name = arg->assign_status;
    if (var_name->startswith(str540)) {
...
List<Tuple2<Str*, Str*>*>* _ResolveNames(List<Str*>* names, Dict<Str*, runtime_asdl::Proc*>* funcs, Dict<Str*, Str*>* aliases, state::SearchPath* search_path) {
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if (dict_contains(funcs, name)) {
      kind = (Alloc<Tuple2<Str*, Str*>>(str541, name));
    }
    else {
      if (dict_contains(aliases, name)) {
        kind = (Alloc<Tuple2<Str*, Str*>>(str542, name));
      }
      else {
        if (consts::LookupNormalBuiltin(name) != 0) {
          kind = (Alloc<Tuple2<Str*, Str*>>(str543, name));
        }
        else {
          if (consts::LookupSpecialBuiltin(name) != 0) {
            kind = (Alloc<Tuple2<Str*, Str*>>(str544, name));
          }
          else {
            if (consts::LookupAssignBuiltin(name) != 0) {
              kind = (Alloc<Tuple2<Str*, Str*>>(str545, name));
            }
            else {
              if (consts::IsControlFlow(name)) {
                kind = (Alloc<Tuple2<Str*, Str*>>(str546, name));
              }
              else {
                if (consts::IsKeyword(name)) {
                  kind = (Alloc<Tuple2<Str*, Str*>>(str547, name));
                }
                else {
                  ...
                  if (resolved == nullptr) {
                    ...
                    kind = (Alloc<Tuple2<Str*, Str*>>(str548, resolved));
                  }
                }
              }
            }
...
int Type::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup7 = flag_spec::ParseCmdVal(str549, cmd_val);
  attrs = tup7.at0();
  arg_r = tup7.at1();
  ...
  for (ListIter<Tuple2<Str*, Str*>*> it(r); !it.Done(); it.Next()) {
    ...
    name = tup8->at1();
    if (kind == nullptr) {
      this->errfmt->StderrLine(fmt132(name));
      status = 1;
    }
    else {
      if (arg->t) {
        ...
        if (arg->p) {
          if (str_equals(kind, str551)) {
            print(name);
          }
        }
        else {
          if (arg->P) {
            if (str_equals(kind, str552)) {
              print(name);
            }
            else {
            ...
            print(fmt133(name, kind));
            if (str_equals(kind, str554)) {
              ;  // pass
            }
          }
        }
...
Tuple2<Str*, bool> _ReadUntilDelim(Str* delim_char) {
  ...
  return (Tuple2<Str*, bool>(str555->join(chars), eof));
}
...
Str* _ReadLine() {
  ...
  while (true) {
    ...
    chars->append(c);
    if (str_equals(c, str556)) {
      break;
    }
  }
  return str557->join(chars);
}
...
int Read::_Line(arg_types::read* arg, Str* var_name) {
  ...
  if (!arg->with_eol) {
    if (line->endswith(str559)) {
      line = line->slice(0, -2);
    }
    else {
      if (line->endswith(str560)) {
        line = line->slice(0, -1);
      }
    }
  }
  if ((arg->q and line->startswith(str561))) {
    arena = this->parse_ctx->arena;
    line_reader = reader::StringLineReader(line, arena);
    lexer = this->parse_ctx->_MakeLexer(line_reader);
    try {
      {  // with
        alloc::ctx_Location ctx(arena, Alloc<source::Stdin>(str562));
...
int Read::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (arg->line) {
    ...
    next_spid = tup4.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str567, next_spid);
    }
  ...
  if (arg->all) {
    ...
    next_spid = tup6.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str571, next_spid);
    }
...
int MapFile::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseCmdVal(str581, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  while (true) {
    ...
    if ((arg->t and line->endswith(str584))) {
      line = line->slice(0, -1);
    }
    lines->append(line);
  }
...
int Cd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseCmdVal(str585, cmd_val);
  attrs = tup11.at0();
  arg_r = tup11.at1();
  ...
  arg_spid = tup12.at1();
  if (dest_dir == nullptr) {
    val = this->mem->GetValue(str586);
    try {
      dest_dir = state::GetString(this->mem, str587);
    }
    catch (error::Runtime* e) {
  ...
  if (str_equals(dest_dir, str588)) {
    try {
      dest_dir = state::GetString(this->mem, str589);
      print(dest_dir);
    }
    catch (error::Runtime* e) {
      this->errfmt->Print_(e->UserErrorString());
  ...
  try {
    pwd = state::GetString(this->mem, str590);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    return 1;
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt134(real_dest_dir, posix::strerror(err_num)), arg_spid);
    return 1;
  }
  state::ExportGlobalString(this->mem, str592, real_dest_dir);
  ...
  if (cmd_val->block) {
    ...
    state::ExportGlobalString(this->mem, str593, pwd);
...
void _PrintDirStack(state::DirStack* dir_stack, int style, Str* home_dir) {
  ...
  if (style == WITH_LINE_NUMBERS) {
    ...
    for (ListIter<Str*> it(dir_stack->Iter()); !it.Done(); it.Next(), ++i) {
      ...
      print(fmt135(i, ui::PrettyDir(entry, home_dir)));
    }
  }
  else {
...
int Pushd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt136(dest_dir, posix::strerror(err_num)), cmd_val->arg_spids->index(1));
    return 1;
  }
  this->dir_stack->Push(dest_dir);
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str599));
  state::ExportGlobalString(this->mem, str600, dest_dir);
...
bool _PopDirStack(state::Mem* mem, state::DirStack* dir_stack, ui::ErrorFormatter* errfmt) {
  ...
  if (dest_dir == nullptr) {
    errfmt->Print_(str601);
    return false;
  }
  err_num = pyos::Chdir(dest_dir);
  if (err_num != 0) {
    errfmt->Print_(fmt137(dest_dir, posix::strerror(err_num)));
    return false;
  }
  state::SetGlobalString(mem, str603, dest_dir);
  mem->SetPwd(dest_dir);
  return true;
}
...
int Popd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->arg_spids) > 1) {
    e_usage(fmt138(), cmd_val->arg_spids->index(1));
  }
  if (!_PopDirStack(this->mem, this->dir_stack, this->errfmt)) {
    return 1;
  }
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str605));
  return 0;
}
...
int Dirs::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup13 = flag_spec::ParseCmdVal(str606, cmd_val);
  attrs = tup13.at0();
  arg_r = tup13.at1();
  arg = Alloc<arg_types::dirs>(attrs->attrs);
  home_dir = state::MaybeString(this->mem, str607);
  style = SINGLE_LINE;
  if (arg->l) {
    home_dir = nullptr;
  }
...
int Pwd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup14 = flag_spec::ParseCmdVal(str608, cmd_val);
  attrs = tup14.at0();
  arg_r = tup14.at1();
...
List<Str*>* Help::_Groups() {
  ...
  contents = this->loader->Get(str609);
...
int Help::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str610, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  ...
  try {
    contents = this->loader->Get(fmt139(topic));
  }
  catch (IOError*) {
    this->errfmt->Print_(fmt140(topic), blame_spid);
    return 1;
  }
  print(contents);
  return 0;
...
syntax_asdl::printf_part_t* _FormatStringParser::_ParseFormatStr() {
  ...
  while ((this->token_type == Id::Format_Flag || this->token_type == Id::Format_Zero)) {
    ...
    if (str_contains(str614, flag)) {
      p_die(fmt141(flag), this->cur_token);
    }
  ...
  if ((this->token_type == Id::Format_Type || this->token_type == Id::Format_Time)) {
    ...
    if (str_contains(str616, part->type->val)) {
      p_die(fmt142(), part->type);
    }
    if (maybe_str_equals(part->type->val, str618)) {
      p_die(fmt143(), part->type);
    }
  }
  else {
  ...
  if ((part->precision and !str_contains(str622, part->type->val->index(-1)))) {
...
int Printf::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str624, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
  arg = Alloc<arg_types::printf>(attrs->attrs);
  Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str625);
  fmt = tup1.at0();
  fmt_spid = tup1.at1();
        ...
        if (part->tag_() == printf_part_e::Percent) {
          ...
          if (part->width) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt146(width_str), width_spid);
              return 1;
            }
          }
          precision = -1;
          if (part->precision) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt147(precision_str), precision_spid);
              return 1;
            }
          }
          if (arg_index < num_args) {
          ...
          typ = part->type->val;
          if (str_equals(typ, str633)) {
            if (precision >= 0) {
              s = s->slice(0, precision);
            }
          }
          else {
            if (str_equals(typ, str634)) {
              s = qsn::maybe_shell_encode(s);
            }
            else {
              if (str_equals(typ, str635)) {
                ...
                s = str636->join(c_parts);
              }
              else {
                if ((str_contains(str637, typ) or part->type->id == Id::Format_Time)) {
                  try {
                    d = to_int(s);
                  }
                  catch (ValueError*) {
                    if ((len(s) >= 1 and str_contains(str638, s->index(0)))) {
                      ...
                      if ((part->type->id == Id::Format_Time and (len(s) == 0 and word_spid == runtime::NO_SPID))) {
                        ...
                        this->errfmt->Print_(fmt148(s), blame_spid);
                        return 1;
                      }
                    }
                  }
                  if (str_contains(str640, typ)) {
                    s = str(d);
                  }
                  else {
                    if (str_contains(str641, typ)) {
                      if (d < 0) {
                        e_die(fmt149(d, typ), part->type->span_id);
                      }
                      if (str_equals(typ, str643)) {
                        s = str(d);
                      }
                      else {
                        if (str_equals(typ, str644)) {
                          s = mylib::octal(d);
                        }
                        else {
                          if (str_equals(typ, str645)) {
                            s = mylib::hex_lower(d);
                          }
                          else {
                            if (str_equals(typ, str646)) {
                              s = mylib::hex_upper(d);
                            }
                          }
                        }
          ...
          if (width >= 0) {
            if (len(flags)) {
              if (list_contains(flags, str649)) {
                s = s->ljust(width, str650);
              }
              else {
                if (list_contains(flags, str651)) {
                  s = s->rjust(width, str652);
                }
                else {
                  ;  // pass
                }
...
int Alias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str657, cmd_val);
  arg_r = tup0.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup1 = mylib::split_once(arg, str659);
    name = tup1.at0();
    alias_exp = tup1.at1();
    if (alias_exp == nullptr) {
      alias_exp = this->aliases->get(name);
      if (alias_exp == nullptr) {
        this->errfmt->Print_(fmt153(name), cmd_val->arg_spids->index(i));
        status = 1;
      }
      else {
        print(fmt154(name, alias_exp));
      }
    }
    else {
...
int UnAlias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str662, cmd_val);
  arg_r = tup2.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
    e_usage(str663);
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    ...
    if (dict_contains(this->aliases, name)) {
      ...
      this->errfmt->Print_(fmt155(name), cmd_val->arg_spids->index(i));
      status = 1;
    }
  }
  return status;
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->argv) == 1) {
    ...
    for (ListIter<Str*> it(sorted(mapping)); !it.Done(); it.Next()) {
      ...
      code_str = fmt156(name, qsn::maybe_shell_encode(str_val));
      print(code_str);
    }
    return 0;
  }
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  arg = flag_spec::ParseMore(str666, arg_r);
  if (arg->show_options) {
...
int Shopt::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str667, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
...
int Hash::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str669, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
...
Dict<Str*, bool>* _ParseOptSpec(Str* spec_str) {
  ...
  while (true) {
    ...
    if (str_equals(spec_str->index(i), str672)) {
      spec->set(ch, true);
      i += 1;
    }
  }
...
int GetOptsState::_OptInd() {
  int result;
  try {
    result = state::GetInteger(this->mem, str673);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    result = -1;
...
void GetOptsState::IncIndex() {
  state::SetRefString(this->mem, str674, str((this->_optind + 1)));
}

void GetOptsState::SetArg(Str* optarg) {
  StackRoots _roots({&optarg});

  state::SetRefString(this->mem, str675, optarg);
}

void GetOptsState::Fail() {
  state::SetRefString(this->mem, str676, str677);
}
...
Tuple2<int, Str*> _GetOpts(Dict<Str*, bool>* spec, List<Str*>* argv, builtin_pure::GetOptsState* my_state, ui::ErrorFormatter* errfmt) {
  ...
  if (current == nullptr) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str678));
  }
  if ((!current->startswith(str679) or str_equals(current, str680))) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str681));
  }
  ...
  if (!dict_contains(spec, flag_char)) {
    return (Tuple2<int, Str*>(0, str682));
  }
  if (spec->index(flag_char)) {
    if (more_chars) {
      ...
      if (optarg == nullptr) {
        my_state->Fail();
        errfmt->Print_(fmt159(current));
        tmp = Alloc<List<Str*>>();
        for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
          Str* a = it.Value();
          tmp->append(qsn::maybe_shell_encode(a));
        }
        println_stderr(fmt160(str685->join(tmp)));
        return (Tuple2<int, Str*>(0, str686));
      }
    }
    my_state->IncIndex();
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  spec_str = arg_r->ReadRequired(str688);
  Tuple2<Str*, int> tup7 = arg_r->ReadRequired2(str689);
  var_name = tup7.at0();
  var_spid = tup7.at1();
  ...
  if (match::IsValidVarName(var_name)) {
    ...
    throw Alloc<error::Usage>(fmt161(var_name), var_spid);
  }
  return status;
}
...
int Echo::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseLikeEcho(str691, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  if (arg->e) {
    ...
    for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
      ...
      new_argv->append(str692->join(parts));
      if (backslash_c) {
        break;
      }
    }
...
int CommandEvaluator::_RunAssignBuiltin(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  if (builtin_func == nullptr) {
    e_die(fmt162(cmd_val->argv->index(0)), cmd_val->arg_spids->index(0));
  }
  try {
    try {
      status = builtin_func->Run(cmd_val);
      ...
      this->errfmt->PrefixPrint(e->msg, fmt163(arg0), e->span_id);
      status = 2;
    }
    catch (KeyboardInterrupt*) {
      if (this->exec_opts->interactive()) {
...
void CommandEvaluator::_CheckStatus(int status, syntax_asdl::command_t* node, int blame_spid) {
  ...
  if ((this->exec_opts->errexit() and status != 0)) {
    ...
    throw Alloc<error::ErrExit>(fmt164(status, reason, posix::getpid()), span_id, status);
  }
}
  ...
  switch (arg->tag_()) {
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        filename = val->s;
        if (len(filename) == 0) {
          throw Alloc<error::RedirectEval>(str705, arg_word);
        }
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          t = val->s;
          if (len(t) == 0) {
            throw Alloc<error::RedirectEval>(str706, arg_word);
            return nullptr;
          }
          try {
            if (maybe_str_equals(t, str707)) {
              result->arg = Alloc<redirect_arg::CloseFd>();
            }
            else {
              if (str_equals(t->index(-1), str708)) {
            ...
            throw Alloc<error::RedirectEval>(fmt165(t), arg_word);
            return nullptr;
          }
          return result;
        }
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = Alloc<redirect_arg::HereDoc>(str_concat(val->s, str710));
            return result;
          }
          else {
            throw Alloc<AssertionError>();
...
void CommandEvaluator::_StrictErrExit(syntax_asdl::command_t* node) {
  ...
  if (_HasManyStatuses(node)) {
    ...
    e_die(fmt166(node_str), location::SpanForCommand(node));
  }
}
...
void CommandEvaluator::_StrictErrExitList(List<syntax_asdl::command_t*>* node_list) {
  ...
  if (len(node_list) > 1) {
    e_die(fmt167(), location::SpanForCommand(node_list->index(0)));
  }
  node = node_list->index(0);
  if (_HasManyStatuses(node)) {
    node_str = ui::CommandType(node);
    e_die(fmt168(node_str), location::SpanForCommand(node));
  }
}
  ...
  switch (node->tag_()) {
    case command_e::Simple: {
      ...
      if (UP_cmd_val->tag_() == cmd_value_e::Argv) {
        ...
        if (node->block) {
          e_die(fmt169(), node->block->spids->index(0));
        }
        cmd_value__Assign* cmd_val = static_cast<cmd_value__Assign*>(UP_cmd_val);
      }
    ...
    case command_e::Pipeline: {
      ...
      if (len(node->stderr_indices)) {
        e_die(fmt170(), node->spids->index(0));
      }
      if (node->negated) {
    ...
    case command_e::ControlFlow: {
      ...
      if (node->arg_word) {
        ...
        try {
          ...
          e_die(fmt171(node->token->val, str_val->s), node->arg_word);
        }
      }
      else {
      ...
      if (ok) {
        ...
        if (this->exec_opts->strict_control_flow()) {
          ...
          this->errfmt->PrefixPrint(msg, str722, tok->span_id);
          status = 0;
        }
      }
    }
    ...
    {  // with
      ...
      for (ListIter<syntax_asdl::command_t*> it(to_run); !it.Done(); it.Next()) {
        ...
        {  // with
          ...
          {  // with
            dev::ctx_Tracer ctx(this->tracer, str723, nullptr);
...
Tuple2<bool, bool> CommandEvaluator::ExecuteAndCatch(syntax_asdl::command_t* node, int cmd_flags) {
  ...
  try {
    ...
    if ((cmd_flags & IsEvalSource)) {
      ...
      if (e->IsReturn()) {
        ...
        is_eval = false;
        this->errfmt->Print_(str724, e->token->span_id);
        is_fatal = true;
        status = 1;
      }
    }
  ...
  if (err) {
    ...
    if ((is_errexit and !this->exec_opts->verbose_errexit())) {
      ...
      ui::PrettyPrintError(err, this->arena, str725);
    }
  }
...
void CommandEvaluator::MaybeRunExitTrap(List<int>* mut_status) {
  ...
  handler = this->traps->get(str726);
  if (handler) {
    {  // with
      dev::ctx_Tracer ctx(this->tracer, str727, nullptr);
    ...
    if (UP_sig->tag_() == proc_sig_e::Closed) {
      ...
      for (ListIter<syntax_asdl::param*> it(sig->params); !it.Done(); it.Next(), ++i) {
        ...
        if (i < n_args) {
          ...
          if (is_out_param) {
            param_name = str_concat(str728, param_name);
            if (!arg_str->startswith(str729)) {
              e_die(fmt172(arg_str));
            }
      ...
      if (sig->rest) {
        ...
        if (n_args > n_params) {
          throw Alloc<TypeError>(fmt174(proc->name, n_params, n_args));
        }
      }
    }
    try {
      ...
      if (e->IsReturn()) {
        ...
        e_die(fmt175(e->token->val), e->token);
      }
    }
    catch (error::FatalRuntime* e) {
      this->dumper->MaybeCollect(this, e);
...
int CommandEvaluator::RunFuncForCompletion(runtime_asdl::Proc* proc, List<Str*>* argv) {
  ...
  try {
    ...
    this->errfmt->Print_(str734, e->token->span_id);
    status = 1;
  }
  return status;
}
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index(i), str736))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index(-2), str738)) {
    ...
    if ((left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse)) {
      var_name = left_token->val->slice(0, -1);
      if (str_equals(close_token->val->index(-2), str739)) {
        op = assign_op_e::PlusEqual;
      }
      else {
        op = assign_op_e::Equal;
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        var_name = left_token->val->slice(0, -1);
        if (str_equals(close_token->val->index(-2), str740)) {
          op = assign_op_e::PlusEqual;
        }
        else {
          op = assign_op_e::Equal;
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    w = tup6->at3();
    if (left_token->id != Id::Lit_VarLike) {
      p_die(fmt179(), left_token);
    }
    if (str_equals(left_token->val->index(-2), str743)) {
...
void CommandParser::_Eat(int c_id) {
  ...
  msg = fmt186(ui::PrettyId(c_id), ui::PrettyId(actual_id));
  this->_Eat2(c_id, msg);
}
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index(0), str751)) {
    pos = op_val->find(str752);
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    i += 1;
    if (!alias_exp->endswith(str755)) {
      expanded->append(str756);
      break;
    }
  }
  if (len(expanded) == 0) {
  ...
  while (i < n) {
    ...
    expanded->append(str758);
    i += 1;
  }
  code_str = str759->join(expanded);
  line_reader = reader::StringLineReader(code_str, this->arena);
  ...
  if (kind == Kind::ControlFlow) {
    ...
    if (len(suffix_words) == 1) {
      ...
      if (len(suffix_words) == 2) {
        ...
        p_die(fmt197(kw_token->val), suffix_words->index(2));
      }
    }
...
syntax_asdl::command__ShFunction* CommandParser::ParseFunctionDef() {
  ...
  this->_Next();
  this->_Eat2(Id::Right_ShFunction, str776);
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if (str_equals(c, str784)) {
      i += 1;
    }
    else {
      if ((str_equals(c, str785) or str_equals(c, str786))) {
        return true;
      }
      else {
        if (str_equals(c, str787)) {
          left_bracket = true;
        }
        else {
          if ((str_equals(c, str788) and left_bracket)) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  ...
  return pyutil::BackslashEscape(s, str790);
}
Str* ERE_META_CHARS = str791;
...
Str* GlobUnescape(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if ((str_equals(c, str792) and i != (n - 1))) {
      i += 1;
      c2 = s->index(i);
      ...
      if (tag == glob_part_e::Operator) {
        ...
        if (tag == glob_part_e::CharClass) {
          ...
          for (ListIter<Str*> it(part->strs); !it.Done(); it.Next()) {
            Str* s = it.Value();
            StackRoots _for({&s          });
            if (str_equals(s, str810)) {
              literal_hyphen = true;
              continue;
            }
            if (str_equals(s, str811)) {
...
int Globber::Expand(Str* arg, List<Str*>* out) {
  ...
  if (n) {
    for (ListIter<Str*> it(results); !it.Done(); it.Next()) {
      Str* name = it.Value();
      StackRoots _for({&name    });
      if ((name->startswith(str817) and !this->exec_opts->dashglob())) {
        n -= 1;
        continue;
      }
      out->append(name);
...
Str* _PromptEvaluatorCache::Get(Str* name) {
  ...
  if (str_equals(name, str819)) {
    value = this->_GetEuid() == 0 ? str820 : str821;
  }
  else {
    if (str_equals(name, str822)) {
      value = libc::gethostname();
    }
    else {
      if (str_equals(name, str823)) {
...
Evaluator::Evaluator(Str* lang, parse_lib::ParseContext* parse_ctx, state::Mem* mem) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Evaluator)) {
  ...
  this->parse_ctx = parse_ctx;
  this->mem = mem;
  this->default_prompt = str_concat(lang, str824);
      ...
      if (id_ == Id::PS_Octal3) {
        ...
        if (id_ == Id::PS_LBrace) {
          ...
          if (id_ == Id::PS_RBrace) {
            ...
            if (id_ == Id::PS_Subst) {
              ch = value->slice(1);
              if (str_equals(ch, str827)) {
                r = this->cache->Get(str828);
              }
              else {
                if (str_equals(ch, str829)) {
                  r = this->cache->Get(str830);
                }
                else {
                  if (str_equals(ch, str831)) {
                    hostname = this->cache->Get(str832);
                    Tuple2<Str*, Str*> tup1 = mylib::split_once(hostname, str833);
                    r = tup1.at0();
                  }
                  else {
                    if (str_equals(ch, str834)) {
                      r = this->cache->Get(str835);
                    }
                    else {
                      if (str_equals(ch, str836)) {
                        try {
                          pwd = state::GetString(this->mem, str837);
                          home = state::MaybeString(this->mem, str838);
                          r = ui::PrettyDir(pwd, home);
                        }
                        catch (error::Runtime* e) {
                          r = fmt214(e->UserErrorString());
                        }
                      }
                      else {
                        if (str_equals(ch, str840)) {
                          val = this->mem->GetValue(str841);
                          if (val->tag_() == value_e::Str) {
                            value__Str* str_val = static_cast<value__Str*>(val);
              ...
              ret->append(r->replace(str844, str845));
            }
            else {
              throw Alloc<AssertionError>();
            }
...
Str* Evaluator::EvalPrompt(runtime_asdl::value_t* UP_val) {
  ...
  if (ps1_word == nullptr) {
    ...
    try {
      ...
      ps1_word = word_::ErrorWord(fmt216(e->UserErrorString()));
    }
...
Str* Evaluator::EvalFirstPrompt() {
  ...
  if (str_equals(this->lang, str849)) {
    val = this->mem->GetValue(str850);
    ...
    case lvalue_e::Indexed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          break;
        default: {
          e_die(fmt218(ui::ValType(val)));
        }
      }
      s = word_eval::GetArrayItem(array_val->strs, lval->index);
      if (s == nullptr) {
        val = Alloc<value::Str>(str854);
      }
      else {
        val = Alloc<value::Str>(s);
      }
    ...
    case lvalue_e::Keyed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::AssocArray: {
          ...
          break;
        default: {
          e_die(fmt219(ui::ValType(val)));
        }
      }
      s = assoc_val->d->get(lval->key);
      if (s == nullptr) {
        val = Alloc<value::Str>(str856);
      }
      else {
        val = Alloc<value::Str>(s);
      }
...
int ArithEvaluator::_StringToInteger(Str* s, int span_id) {
  ...
  if (s->startswith(str857)) {
    try {
      integer = to_int(s, 16);
    }
    catch (ValueError*) {
      e_strict(fmt220(s), span_id);
    }
    return integer;
  }
  if (s->startswith(str859)) {
    try {
      integer = to_int(s, 8);
    }
    catch (ValueError*) {
      e_strict(fmt221(s), span_id);
    }
    return integer;
  }
  if (str_contains(s, str861)) {
    Tuple2<Str*, Str*> tup0 = mylib::split_once(s, str862);
    b = tup0.at0();
    digits = tup0.at1();
    try {
      base = to_int(b);
    ...
    for (StrIter it(digits); !it.Done(); it.Next()) {
      ...
      StackRoots _for({&ch    });
      if (IsLower(ch)) {
        digit = ((ord(ch) - ord(str864)) + 10);
      }
      else {
        if (IsUpper(ch)) {
          digit = ((ord(ch) - ord(str865)) + 36);
        }
        else {
          if (str_equals(ch, str866)) {
            digit = 62;
          }
          else {
            if (str_equals(ch, str867)) {
              digit = 63;
            }
            else {
              if (ch->isdigit()) {
                ...
                e_strict(fmt223(digits), span_id);
              }
            }
          }
        }
      ...
      if (digit >= base) {
        e_strict(fmt224(digits, base), span_id);
      }
    ...
    if ((this->exec_opts->eval_unsafe_arith() and this->parse_ctx)) {
      ...
      {  // with
        ...
        try {
          ...
          ui::PrettyPrintError(e, arena);
          e_die(fmt225(), e->span_id);
        }
      }
      if (node2->tag_() == arith_expr_e::Word) {
        e_die(fmt226(s), span_id);
      }
      else {
      ...
      if ((len(s->strip()) == 0 or match::IsValidVarName(s))) {
        e_strict(fmt227(s), span_id);
      }
      else {
        e_die(fmt228(s), span_id);
      }
    }
  }
  return integer;
...
int ArithEvaluator::_ValToIntOrError(runtime_asdl::value_t* val, int span_id) {
  ...
  e_die(fmt230(ui::ValType(val)), span_id);
}
  ...
  if (((val->tag_() == value_e::MaybeStrArray || val->tag_() == value_e::AssocArray) and lval->tag_() == lvalue_e::Named)) {
    ...
    if (word_eval::CheckCompatArray(named_lval->name, this->exec_opts)) {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (val->tag_() == value_e::AssocArray) {
          lval = Alloc<lvalue::Keyed>(named_lval->name, str876);
        }
      }
        ...
        if (op_id == Id::Arith_Minus) {
          ...
          if (op_id == Id::Arith_Star) {
            ...
            if (op_id == Id::Arith_Slash) {
              if (rhs == 0) {
                e_die(fmt232(), location::SpanForArithExpr(node->right));
              }
              ret = (lhs / rhs);
            }
            else {
              if (op_id == Id::Arith_Percent) {
                if (rhs == 0) {
                  e_die(fmt233(), location::SpanForArithExpr(node->right));
                }
                ret = (lhs % rhs);
              }
              else {
...
void BoolEvaluator::_SetRegexMatches(List<Str*>* matches) {
  ...
  state::SetGlobalArray(this->mem, str885, matches);
}
  ...
  switch (node->tag_()) {
    ...
    case bool_expr_e::Unary: {
      ...
      if (arg_type == bool_arg_type_e::Other) {
        ...
        e_die(fmt235(ui::PrettyId(op_id)));
      }
      throw Alloc<AssertionError>();
    }
      break;
      ...
      if (arg_type == bool_arg_type_e::Str) {
        ...
        if (op_id == Id::BoolBinary_EqualTilde) {
          try {
            ...
            msg = e->message;
            e_die(fmt236(s2, msg, node->right), 2);
          }
          if (matches == nullptr) {
            return false;
          }
...
_BaseSplitter::_BaseSplitter(Str* escape_chars) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(_BaseSplitter)) {
  this->escape_chars = str_concat(escape_chars, str896);
}
    ...
    if (i < n) {
      ...
      if (str_contains(ws_chars, c)) {
        ...
        if (str_contains(other_chars, c)) {
          ...
          if ((allow_escape and str_equals(c, str897))) {
...
Str* Utf8Encode(int code) {
  ...
  return str900->join(tmp);
}
Str* INCOMPLETE_CHAR = str901;
Str* INVALID_CONT = str902;
Str* INVALID_START = str903;
    ...
    if ((op->op_id == Id::VOp1_Pound || op->op_id == Id::VOp1_DPound)) {
      ...
      if ((op->op_id == Id::VOp1_Percent || op->op_id == Id::VOp1_DPercent)) {
        ...
        if (op->op_id == Id::VOp1_Comma) {
          if (!(str_equals(arg, str904))) {
            e_die(fmt237(ui::PrettyId(op->op_id)));
          }
          if (len(s)) {
          ...
          if (op->op_id == Id::VOp1_DComma) {
            if (!(str_equals(arg, str906))) {
              e_die(fmt238(ui::PrettyId(op->op_id)));
            }
            return s->lower();
          }
          else {
            if (op->op_id == Id::VOp1_Caret) {
              if (!(str_equals(arg, str908))) {
                e_die(fmt239(ui::PrettyId(op->op_id)));
              }
              if (len(s)) {
              ...
              if (op->op_id == Id::VOp1_DCaret) {
                if (!(str_equals(arg, str910))) {
                  e_die(fmt240(ui::PrettyId(op->op_id)));
                }
                return s->upper();
              }
              else {
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Slash) {
    try {
      ...
      msg = e->message;
      e_die(fmt242(regex, msg), this->slash_spid);
    }
  }
  if (op->replace_mode == Id::Lit_Pound) {
    regex = str_concat(str916, regex);
  }
  else {
    if (op->replace_mode == Id::Lit_Percent) {
      regex = str_concat(regex, str917);
    }
  }
...
Str* ShellQuoteB(Str* s) {
  ...
  s = s->replace(str918, str919)->replace(str920, str921);
  return pyutil::BackslashEscape(s, str922);
}
...
void TdopParser::Eat(int token_type) {
  if (!this->AtToken(token_type)) {
    p_die(fmt246(ui::PrettyId(token_type), ui::PrettyId(this->op_id)), this->cur_word);
  }
  this->Next();
}
...
GLOBAL_LIST(Str*, 3, _STRING_AND_ARRAY, {str930 COMMA str931 COMMA str932});
...
runtime_asdl::value_t* ResolveCompatArray(runtime_asdl::value_t* val) {
  ...
  if (val->tag_() == value_e::MaybeStrArray) {
    ...
    if (val->tag_() == value_e::AssocArray) {
      value__AssocArray* assoc_val = static_cast<value__AssocArray*>(val);
      s = dict_contains(assoc_val->d, str933) ? assoc_val->d->index(str934) : nullptr;
    }
    else {
      throw Alloc<AssertionError>();
    }
...
Str* _BackslashEscape(Str* s) {
  ...
  return s->replace(str935, str936);
}
...
runtime_asdl::part_value_t* _ValueToPartValue(runtime_asdl::value_t* val, bool quoted) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      return Alloc<part_value::String>(str937, quoted, !quoted);
    }
      break;
    case value_e::Str: {
      value__Str* val = static_cast<value__Str*>(UP_val);
...
Str* TildeEvaluator::Eval(syntax_asdl::Token* token) {
  ...
  if (maybe_str_equals(token->val, str949)) {
    val = this->mem->GetValue(str950);
    UP_val = val;
    if (val->tag_() == value_e::Str) {
      value__Str* val = static_cast<value__Str*>(UP_val);
      return val->s;
      ...
      if ((op->op_id == Id::VTest_ColonEquals || op->op_id == Id::VTest_Equals)) {
        ...
        if ((op->op_id == Id::VTest_ColonQMark || op->op_id == Id::VTest_QMark)) {
          if (is_falsey) {
            ...
            e_die(fmt251(error_str), blame_token);
          }
          else {
            return false;
          }
...
runtime_asdl::value_t* AbstractWordEvaluator::_EvalIndirectArrayExpansion(Str* name, Str* index) {
  ...
  switch (val->tag_()) {
    ...
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* val = static_cast<value__MaybeStrArray*>(UP_val);
      if ((str_equals(index, str954) || str_equals(index, str955))) {
    ...
    case value_e::AssocArray: {
      value__AssocArray* val = static_cast<value__AssocArray*>(UP_val);
      if ((str_equals(index, str956) || str_equals(index, str957))) {
        throw Alloc<NotImplementedError>();
      }
      s = val->d->get(index);
      if (s != nullptr) {
      ...
      case value_e::Str: {
        ...
        try {
          ...
          if (this->exec_opts->strict_word_eval()) {
            ...
            this->errfmt->PrettyPrintError(e, str958);
            return Alloc<value::Str>(str959);
          }
        }
      }
        break;
    ...
    if (op_id == Id::VSub_Bang) {
      ...
      switch (val->tag_()) {
        case value_e::Str: {
          ...
          if ((maybe_str_equals(val->s, str960) || maybe_str_equals(val->s, str961))) {
            return Alloc<value::MaybeStrArray>(this->mem->GetArgv());
          }
          i = val->s->find(str962);
          if ((i >= 0 and str_equals(val->s->index(-1), str963))) {
...
runtime_asdl::value_t* AbstractWordEvaluator::_Slice(runtime_asdl::value_t* val, syntax_asdl::suffix_op__Slice* op, Str* var_name, syntax_asdl::braced_var_sub* part) {
  ...
  try {
    ...
    if (this->exec_opts->strict_word_eval()) {
      ...
      this->errfmt->PrettyPrintError(e, str966);
      switch (val->tag_()) {
        case value_e::Str: {
          val = Alloc<value::Str>(str967);
        }
          break;
        case value_e::MaybeStrArray: {
  ...
  if (op_id == Id::VOp0_P) {
    switch (val->tag_()) {
      case value_e::Str: {
        ...
        p = prompt->replace(str968, str969)->replace(str970, str971);
        result = Alloc<value::Str>(p);
      }
        break;
      default: {
        e_die(fmt253(ui::ValType(val)));
      }
    }
  }
  else {
    if (op_id == Id::VOp0_Q) {
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          result = Alloc<value::Str>(str973->join(tmp));
        }
          break;
        default: {
      ...
      if (op_id == Id::VOp0_a) {
        ...
        result = Alloc<value::Str>(str980->join(chars));
      }
      else {
        e_die(fmt255(op->val), op);
      }
    }
  }
...
Tuple2<runtime_asdl::value_t*, runtime_asdl::a_index_t*> AbstractWordEvaluator::_ArrayIndex(runtime_asdl::value_t* val, syntax_asdl::braced_var_sub* part) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      ...
      break;
    case value_e::Str: {
      e_die(fmt258(part->token->val), part->token);
    }
      break;
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* array_val = static_cast<value__MaybeStrArray*>(UP_val);
...
void AbstractWordEvaluator::_EvalDoubleQuoted(List<syntax_asdl::word_part_t*>* parts, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  if (len(parts) == 0) {
    v = Alloc<part_value::String>(str985, true, false);
    part_vals->append(v);
    return ;
  }
...
runtime_asdl::value_t* AbstractWordEvaluator::_EmptyStrOrError(runtime_asdl::value_t* val, syntax_asdl::Token* token) {
  ...
  if (!this->exec_opts->nounset()) {
    return Alloc<value::Str>(str986);
  }
  name = token->val->startswith(str987) ? token->val->slice(1) : token->val;
  e_die(fmt259(name), token);
}
  ...
  switch (part->tag_()) {
    ...
    case word_part_e::ExtGlob: {
      ...
      for (ListIter<syntax_asdl::compound_word*> it(part->arms); !it.Done(); it.Next(), ++i) {
        ...
        StackRoots _for({&w      });
        if (i != 0) {
          part_vals->append(Alloc<part_value::String>(str998, false, false));
        }
        this->_EvalWordToParts(w, false, part_vals);
      }
      part_vals->append(Alloc<part_value::String>(str999, false, false));
    }
      break;
...
void AbstractWordEvaluator::_EvalWordToParts(syntax_asdl::word_t* w, bool quoted, List<runtime_asdl::part_value_t*>* part_vals, bool is_subst) {
  ...
  switch (w->tag_()) {
    case word_e::Compound: {
      ...
      break;
    case word_e::Empty: {
      part_vals->append(Alloc<part_value::String>(str1001, quoted, !quoted));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, runtime_asdl::quote_t quote_kind) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return Alloc<value::Str>(str1002);
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  part_vals = Alloc<List<runtime_asdl::part_value_t*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
  ...
  return Alloc<value::Str>(str1005->join(strs));
}
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalForPlugin(syntax_asdl::compound_word* w) {
  ...
  {  // with
    ...
    try {
      ...
      val = Alloc<value::Str>(fmt268(e->UserErrorString()));
    }
    catch (_OSError* e) {
      val = Alloc<value::Str>(fmt269(pyutil::strerror(e)));
    }
    catch (KeyboardInterrupt*) {
      val = Alloc<value::Str>(str1008);
    }
  }
  return val;
}
...
runtime_asdl::value_t* AbstractWordEvaluator::EvalRhsWord(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return Alloc<value::Str>(str1009);
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  if (len(w->parts) == 1) {
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index(-2), str1015)) {
          e_die(fmt271(), w);
        }
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        StackRoots _for({&arg      });
        if ((arg->startswith(str1017) or arg->startswith(str1018))) {
          flags->append(arg);
          flag_spids->append(word_spid);
          if ((str_contains(arg, str1019) or str_contains(arg, str1020))) {
            eval_to_pairs = false;
          }
        }
        else {
...
runtime_asdl::part_value__String* CompletionWordEvaluator::_EvalProcessSub(syntax_asdl::command_sub* cs_part) {
  ...
  return Alloc<part_value::String>(str1025, true, false);
}
...
syntax_asdl::suffix_op__PatSub* WordParser::_ReadPatSubVarOp() {
  ...
  if (this->token_type == Id::Lit_Slash) {
    ...
    this->_Peek();
    if (this->token_type != Id::Right_DollarBrace) {
      p_die(fmt275(ui::PrettyId(this->token_type)), this->cur_token);
    }
        ...
        if (op_kind == Kind::VOp2) {
          if (this->token_type == Id::VOp2_Slash) {
            ...
            if (this->token_type == Id::VOp2_Colon) {
              ...
              p_die(fmt281(str1035), this->cur_token);
            }
          }
        }
        else {
          if (op_kind == Kind::VOp3) {
            if (allow_query) {
              ...
              p_die(fmt282(str1037), this->cur_token);
            }
          }
        }
      }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool is_oil_expr) {
  ...
  while (!done) {
    ...
    if ((this->token_kind == Kind::Lit || this->token_kind == Kind::Char)) {
      tok = this->cur_token;
      if ((no_backslashes and str_contains(tok->val, str1041))) {
        p_die(fmt286(), tok);
      }
      if (is_oil_expr) {
...
void WordParser::ParseProc(syntax_asdl::command__Proc* node) {
  ...
  if (this->token_type != Id::Lit_Chars) {
    p_die(fmt298(ui::PrettyToken(this->cur_token, this->arena)), this->cur_token);
  }
...
syntax_asdl::arith_expr_t* WordParser::_ReadArithExpr(int end_id) {
  ...
  if ((end_id != Id::Undefined_Tok and cur_id != end_id)) {
    p_die(fmt299(ui::PrettyId(cur_id), ui::PrettyId(end_id)), this->a_parser->cur_word);
  }
  return anode;
}
...
syntax_asdl::command__ForExpr* WordParser::ReadForExpression() {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt302(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
  if (cur_id == Id::Arith_Semi) {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt303(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
            ...
            if (this->token_type == Id::Lit_Dollar) {
              if (!this->parse_opts->parse_dollar()) {
                if ((num_parts == 0 and lex_mode == lex_mode_e::ShCommand)) {
                  ...
                  if (str_equals(next_byte, str1069)) {
                    println_stderr(fmt312(next_byte));
                  }
                }
...
Tuple2<syntax_asdl::word_t*, bool> WordParser::_ReadArithWord() {
  ...
  this->_Peek();
  if (this->token_kind == Kind::Unknown) {
    p_die(fmt318(this->cur_token->val), this->cur_token);
  }
  else {
    if (this->token_kind == Kind::Eof) {
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1079, false));
    }
      break;
    case word_part_e::AssocArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1080, false));
    }
      break;
    case word_part_e::Literal: {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str1082, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str1083->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
    ...
    case word_part_e::ExtGlob: 
    case word_part_e::Splice: {
      return (Tuple3<bool, Str*, bool>(false, str1084, false));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() != word_e::Compound) {
    return (Tuple3<bool, Str*, bool>(false, str1085, quoted));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  strs = Alloc<List<Str*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str1086, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str1087->join(strs), quoted));
}
...
syntax_asdl::compound_word* TildeDetect(syntax_asdl::word_t* UP_w) {
  ...
  if ((id_ == Id::Lit_Chars and static_cast<Token*>(part1)->val->startswith(str1089))) {
    new_parts->extend(w->parts->slice(1));
    return Alloc<compound_word>(new_parts);
  }
  return nullptr;
...
void TildeDetectAssign(syntax_asdl::compound_word* w) {
  ...
  for (int i = 0; i < n; ++i) {
    ...
    if ((do_expand and LiteralId(cur) == Id::Lit_TildeLike)) {
      ...
      if (next_part) {
        is_tilde = (LiteralId(next_part) == Id::Lit_Colon or (LiteralId(next_part) == Id::Lit_Chars and static_cast<Token*>(next_part)->val->startswith(str1090)));
      }
      else {
        is_tilde = true;
      }
...
Str* escape(Str* s) {
  ...
  s = s->replace(str1100, str1101);
  s = s->replace(str1102, str1103);
  s = s->replace(str1104, str1105);
  return s;
}
...
Str* join(Str* s1, Str* s2) {
  ...
  if ((s2->startswith(str1108) or len(s1) == 0)) {
    return s2;
  }
  if (s1->endswith(str1109)) {
...
Tuple2<Str*, Str*> split(Str* p) {
  ...
  head = p->slice(0, i);
  tail = p->slice(i);
  if ((len(head) and !(str_equals(head, str_repeat(str1112, len(head)))))) {
    head = head->rstrip(str1113);
  }
...
Tuple2<Str*, Str*> _splitext(Str* p, Str* sep, Str* extsep) {
  ...
  return (Tuple2<Str*, Str*>(p, str1114));
}
...
Str* dirname(Str* p) {
  ...
  i = (p->rfind(str1116) + 1);
  head = p->slice(0, i);
  if ((head and !(str_equals(head, str_repeat(str1117, len(head)))))) {
    head = head->rstrip(str1118);
  }
  return head;
}
...
Str* normpath(Str* path) {
  ...
  slash = str1119;
  dot = str1120;
  if (str_equals(path, str1121)) {
    return dot;
  }
  initial_slashes = path->startswith(str1122);
  if ((initial_slashes and (path->startswith(str1123) and !path->startswith(str1124)))) {
    initial_slashes = 2;
  }
  comps = path->split(str1125);
  new_comps = Alloc<List<Str*>>();
  for (ListIter<Str*> it(comps); !it.Done(); it.Next()) {
    Str* comp = it.Value();
    StackRoots _for({&comp  });
    if ((len(comp) == 0 or str_equals(comp, str1126))) {
      continue;
    }
    if ((!(str_equals(comp, str1127)) or ((initial_slashes == 0 and len(new_comps) == 0) or (len(new_comps) and str_equals(new_comps->index(-1), str1128))))) {
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if ((str_contains(str1135, ch) or IsUnprintableLow(ch))) {
        quote = 2;
        break;
      }
    }
  ...
  parts->append(str1138);
  return str_concat(prefix, str1139->join(parts));
}
...
Str* maybe_encode(Str* s, int bit8_display) {
  ...
  parts = Alloc<List<Str*>>();
  parts->append(str1140);
  _encode(s, bit8_display, false, parts);
  parts->append(str1141);
  return str1142->join(parts);
}
...
Str* encode(Str* s, int bit8_display) {
  ...
  parts = Alloc<List<Str*>>();
  parts->append(str1143);
  _encode(s, bit8_display, false, parts);
  parts->append(str1144);
  return str1145->join(parts);
}
...
void _encode_bytes_x(Str* s, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (str_equals(byte, str1146)) {
      part = str1147;
    }
    else {
      if (str_equals(byte, str1148)) {
        part = str1149;
      }
      else {
        if (str_equals(byte, str1150)) {
          part = str1151;
        }
        else {
          if (str_equals(byte, str1152)) {
            part = str1153;
          }
          else {
            if (str_equals(byte, str1154)) {
              part = str1155;
            }
            else {
              if (str_equals(byte, str1156)) {
                part = shell_compat ? str1157 : str1158;
              }
              else {
...
bool _encode_runes(Str* s, int bit8_display, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (typ == Ascii) {
      state = Start;
      if (str_equals(byte, str1162)) {
        out = str1163;
      }
      else {
        if (str_equals(byte, str1164)) {
          out = str1165;
        }
        else {
          if (str_equals(byte, str1166)) {
            out = str1167;
          }
          else {
            if (str_equals(byte, str1168)) {
              out = str1169;
            }
            else {
              if (str_equals(byte, str1170)) {
                out = str1171;
              }
              else {
                if (str_equals(byte, str1172)) {
                  out = shell_compat ? str1173 : str1174;
                }
                else {
                  if (IsUnprintableLow(byte)) {
...
syntax_asdl::word__String* _StringWordEmitter::ReadWord(types_asdl::lex_mode_t unused_lex_mode) {
  ...
  if (this->i == this->n) {
    w = Alloc<word::String>(Id::Eof_Real, str1175, runtime::NO_SPID);
    return w;
  }
...
syntax_asdl::bool_expr_t* _TwoArgs(builtin_bracket::_StringWordEmitter* w_parser) {
  ...
  w1 = w_parser->Read();
  s0 = w0->s;
  if (maybe_str_equals(s0, str1176)) {
    return Alloc<bool_expr::LogicalNot>(Alloc<bool_expr::WordTest>(w1));
  }
  unary_id = Id::Undefined_Tok;
  if (w0->s->startswith(str1177)) {
    if (maybe_str_equals(s0, str1178)) {
      unary_id = Id::BoolUnary_d;
    }
    else {
      if (maybe_str_equals(s0, str1179)) {
        unary_id = Id::BoolUnary_e;
      }
      else {
        if (maybe_str_equals(s0, str1180)) {
          unary_id = Id::BoolUnary_f;
        }
        else {
          if (maybe_str_equals(s0, str1181)) {
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    ...
    strs = cmd_val->argv;
    if ((!strs or !(str_equals(strs->index(-1), str1190)))) {
      this->errfmt->Print_(str1191, cmd_val->arg_spids->index(0));
      return 2;
    }
    cmd_val->argv->pop();
  ...
  try {
    ...
    if (n == 4) {
      a0 = w_parser->Peek(0);
      if (str_equals(a0, str1193)) {
        w_parser->Read();
        child = _ThreeArgs(w_parser);
        bool_node = Alloc<bool_expr::LogicalNot>(child);
      }
      else {
        if ((str_equals(a0, str1194) and str_equals(w_parser->Peek(3), str1195))) {
          w_parser->Read();
          bool_node = _TwoArgs(w_parser);
        }
        else {
    ...
    this->errfmt->PrettyPrintError(e, str1196);
    return 2;
  }
  ...
  try {
    ...
    this->errfmt->PrettyPrintError(e, str1197);
    return 2;
  }
  status = b ? 0 : 1;
  return status;

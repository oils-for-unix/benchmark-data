...
const char* params_0[] = {"_running_trap", "allow_command_sub", "assoc_expand_once", "autocd", "cdable_vars", "cdspell", "checkhash", "checkjobs", "checkwinsize", "cmdhist", "command_sub_errexit", "compat_array", "complete_fullquote", "dashglob", "direxpand", "dirspell", "dotglob", "dynamic_scope", "eval_unsafe_arith", "execfail", "expand_aliases", "extdebug", "extglob", "extquote", "failglob", "force_fignore", "globasciiranges", "globstar", "gnu_errfmt", "histappend", "histreedit", "histverify", "hostcomplete", "huponexit", "inherit_errexit", "interactive_comments", "lastpipe", "lithist", "localvar_inherit", "localvar_unset", "login_shell", "mailwarn", "no_empty_cmd_completion", "nocaseglob", "nocasematch", "nullglob", "oil:all", "oil:basic", "parse_amp", "parse_at", "parse_at_all", "parse_backslash", "parse_backticks", "parse_brace", "parse_dollar", "parse_dynamic_arith", "parse_equals", "parse_ignored", "parse_paren", "parse_set", "parse_tea", "parse_triple_dots", "parse_triple_quoted", "process_sub_fail", "progcomp", "progcomp_alias", "promptvars", "restricted_shell", "shift_verbose", "simple_echo", "simple_eval_builtin", "simple_test_builtin", "simple_word_eval", "sourcepath", "strict:all", "strict_argv", "strict_arith", "strict_array", "strict_control_flow", "strict_errexit", "strict_glob", "strict_nameref", "strict_tilde", "strict_word_eval", "verbose_errexit", "xpg_echo", "xtrace_details", "xtrace_rich", nullptr};

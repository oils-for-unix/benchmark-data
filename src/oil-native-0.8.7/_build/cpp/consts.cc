...
List<int>* STRICT_ALL = new List<int>({1, 24, 2, 23, 3, 25, 26, 27, 28, 29, 33, 30, 32, 31});
List<int>* OIL_BASIC = new List<int>({42, 40, 1, 41, 24, 2, 23, 34, 35, 36, 38, 37, 3, 43, 39, 25, 26, 27, 28, 29, 33, 30, 32, 31, 45, 44});
List<int>* OIL_ALL = new List<int>({42, 40, 1, 41, 24, 2, 23, 53, 34, 48, 49, 50, 35, 51, 47, 52, 36, 46, 38, 37, 3, 43, 54, 55, 56, 39, 25, 26, 27, 28, 29, 33, 30, 32, 31, 45, 44});
List<int>* DEFAULT_TRUE = new List<int>({20, 40, 21, 41, 13, 49, 50, 51, 52, 19, 45});
List<int>* PARSE_OPTION_NUMS = new List<int>({41, 53, 34, 48, 49, 50, 35, 51, 17, 47, 52, 36, 46, 57, 38, 37});
List<int>* SHOPT_OPTION_NUMS = new List<int>({22, 20, 63, 64, 65, 66, 67, 68, 69, 62, 42, 18, 70, 40, 71, 72, 73, 21, 16, 74, 41, 75, 15, 76, 14, 77, 78, 79, 80, 60, 81, 82, 61, 83, 24, 84, 58, 85, 86, 87, 88, 89, 90, 91, 92, 23, 53, 34, 48, 49, 50, 35, 51, 17, 47, 52, 36, 46, 57, 38, 37, 43, 59, 93, 94, 95, 96, 54, 55, 56, 39, 97, 25, 26, 27, 28, 29, 33, 30, 32, 31, 19, 98, 45, 44});
List<int>* SET_OPTION_NUMS = new List<int>({11, 1, 13, 8, 4, 7, 2, 3, 9, 6, 10, 5});
List<int>* VISIBLE_SHOPT_NUMS = new List<int>({22, 20, 42, 18, 40, 21, 16, 41, 15, 14, 24, 23, 53, 34, 48, 49, 50, 35, 51, 17, 47, 52, 36, 46, 57, 38, 37, 43, 54, 55, 56, 39, 25, 26, 27, 28, 29, 33, 30, 32, 31, 19, 45, 44});
...
Kind GetKind(id_kind_asdl::Id_t id) {
  ...
  case Id::Left_CSingleQuote: return Kind::Left;
  ...
  case Id::Left_AmpParen: return Kind::Left;
...
builtin_t LookupNormalBuiltin(Str* s) {
  ...
  case '[':
    ...
    break;
  case '_':
    if (len == 5 && memcmp("__cat", data, 5) == 0) return 60;
    break;
  case 'a':
    if (len == 5 && memcmp("alias", data, 5) == 0) return 47;
    break;
  case 'b':
    if (len == 2 && memcmp("bg", data, 2) == 0) return 35;
    if (len == 4 && memcmp("bind", data, 4) == 0) return 49;
    break;
  case 'c':
    if (len == 2 && memcmp("cd", data, 2) == 0) return 25;
    if (len == 8 && memcmp("complete", data, 8) == 0) return 37;
    if (len == 7 && memcmp("compgen", data, 7) == 0) return 38;
    if (len == 7 && memcmp("compopt", data, 7) == 0) return 39;
    if (len == 10 && memcmp("compadjust", data, 10) == 0) return 40;
    if (len == 7 && memcmp("command", data, 7) == 0) return 42;
    break;
  case 'd':
    if (len == 4 && memcmp("dirs", data, 4) == 0) return 28;
    break;
  case 'e':
    if (len == 4 && memcmp("echo", data, 4) == 0) return 21;
    break;
  case 'f':
    if (len == 5 && memcmp("false", data, 5) == 0) return 19;
    if (len == 2 && memcmp("fg", data, 2) == 0) return 34;
    if (len == 5 && memcmp("fopen", data, 5) == 0) return 56;
    if (len == 4 && memcmp("fork", data, 4) == 0) return 58;
    if (len == 8 && memcmp("forkwait", data, 8) == 0) return 59;
    break;
  case 'g':
    if (len == 7 && memcmp("getopts", data, 7) == 0) return 41;
    break;
  case 'h':
    if (len == 4 && memcmp("hash", data, 4) == 0) return 44;
    if (len == 4 && memcmp("help", data, 4) == 0) return 45;
    if (len == 7 && memcmp("history", data, 7) == 0) return 46;
    break;
  case 'j':
    if (len == 4 && memcmp("jobs", data, 4) == 0) return 33;
    if (len == 4 && memcmp("json", data, 4) == 0) return 52;
    break;
  case 'm':
    if (len == 7 && memcmp("mapfile", data, 7) == 0) return 23;
    break;
  case 'o':
    if (len == 4 && memcmp("opts", data, 4) == 0) return 55;
    break;
  case 'p':
    if (len == 6 && memcmp("printf", data, 6) == 0) return 22;
    if (len == 5 && memcmp("pushd", data, 5) == 0) return 26;
    if (len == 4 && memcmp("popd", data, 4) == 0) return 27;
    if (len == 3 && memcmp("pwd", data, 3) == 0) return 29;
    if (len == 4 && memcmp("push", data, 4) == 0) return 50;
    if (len == 2 && memcmp("pp", data, 2) == 0) return 53;
    break;
  case 'r':
    if (len == 4 && memcmp("read", data, 4) == 0) return 20;
    if (len == 9 && memcmp("readarray", data, 9) == 0) return 24;
    if (len == 3 && memcmp("run", data, 3) == 0) return 57;
    break;
  case 's':
    if (len == 6 && memcmp("source", data, 6) == 0) return 30;
    if (len == 5 && memcmp("shopt", data, 5) == 0) return 36;
    break;
  case 't':
    if (len == 4 && memcmp("test", data, 4) == 0) return 16;
    if (len == 4 && memcmp("true", data, 4) == 0) return 18;
    if (len == 4 && memcmp("type", data, 4) == 0) return 43;
    break;
  case 'u':
    if (len == 5 && memcmp("umask", data, 5) == 0) return 31;
    if (len == 7 && memcmp("unalias", data, 7) == 0) return 48;
    if (len == 3 && memcmp("use", data, 3) == 0) return 54;
    break;
  case 'w':
    if (len == 4 && memcmp("wait", data, 4) == 0) return 32;
    if (len == 5 && memcmp("write", data, 5) == 0) return 51;
    break;
  }
...
bool IsKeyword(Str* s) {
  ...
  case 's':
    ...
    if (len == 3 && memcmp("set", data, 3) == 0) return true;
    if (len == 8 && memcmp("setlocal", data, 8) == 0) return true;

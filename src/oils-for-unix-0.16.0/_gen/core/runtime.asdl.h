...
namespace syntax_asdl { class word_t; class CompoundWord; class ArgList; class command_t; class re_t; class redir_loc_t; class Token; class proc_sig_t; class loc_t; }
...
class value__MaybeStrArray : public value_t {
 public:
  ...
  static value__MaybeStrArray* CreateNull(bool alloc_lists = false) { 
    return Alloc<value__MaybeStrArray>(alloc_lists ? Alloc<List<Str*>>() :
                                       nullptr);
  }
...
class value__AssocArray : public value_t {
 public:
  ...
  static value__AssocArray* CreateNull(bool alloc_lists = false) { 
...
class value__Tuple : public value_t {
 public:
  value__Tuple(List<value_t*>* items)
      : items(items) {
  }

  static value__Tuple* CreateNull(bool alloc_lists = false) { 
    return Alloc<value__Tuple>(alloc_lists ? Alloc<List<value_t*>>() : nullptr);
  }

  hnode_t* PrettyTree();

  static constexpr ObjHeader obj_header() {
    return ObjHeader::AsdlClass(static_cast<uint16_t>(value_e::Tuple), 1);
  }

  List<value_t*>* items;

  DISALLOW_COPY_AND_ASSIGN(value__Tuple)
};
...
class value__Slice : public value_t {
 public:
  value__Slice(IntBox* lower, IntBox* upper, IntBox* step)
      : lower(lower),
        upper(upper),
        step(step) {
  }
  ...
  static value__Slice* CreateNull(bool alloc_lists = false) { 
    return Alloc<value__Slice>(nullptr, nullptr, nullptr);
  }

  hnode_t* PrettyTree();

  static constexpr ObjHeader obj_header() {
    return ObjHeader::AsdlClass(static_cast<uint16_t>(value_e::Slice), 3);
  }
...
class value__Range : public value_t {
 public:
  value__Range(IntBox* lower, IntBox* upper, IntBox* step)
      : lower(lower),
        upper(upper),
        step(step) {
  }
  ...
  static value__Range* CreateNull(bool alloc_lists = false) { 
    return Alloc<value__Range>(nullptr, nullptr, nullptr);
  }

  hnode_t* PrettyTree();

  static constexpr ObjHeader obj_header() {
    return ObjHeader::AsdlClass(static_cast<uint16_t>(value_e::Range), 3);
  }
...
class value__Obj : public value_t {
 public:
  ...
  static value__Obj* CreateNull(bool alloc_lists = false) { 
...
class lvalue__ObjAttr : public lvalue_t {
 public:
  ...
  static lvalue__ObjAttr* CreateNull(bool alloc_lists = false) { 

...
GLOBAL_STR(gVersion, "0.16.0");

GLOBAL_LIST(int, 9, STRICT_ALL, {26 COMMA 27 COMMA 28 COMMA 29 COMMA 30 COMMA 34 COMMA 31 COMMA 33 COMMA 32});
GLOBAL_LIST(int, 22, YSH_UPGRADE, {45 COMMA 43 COMMA 1 COMMA 44 COMMA 4 COMMA 2 COMMA 5 COMMA 35 COMMA 37 COMMA 38 COMMA 39 COMMA 36 COMMA 40 COMMA 41 COMMA 3 COMMA 46 COMMA 50 COMMA 49 COMMA 42 COMMA 6 COMMA 48 COMMA 47});
GLOBAL_LIST(int, 43, YSH_ALL, {45 COMMA 43 COMMA 1 COMMA 44 COMMA 4 COMMA 2 COMMA 5 COMMA 35 COMMA 51 COMMA 52 COMMA 53 COMMA 59 COMMA 37 COMMA 54 COMMA 58 COMMA 38 COMMA 55 COMMA 39 COMMA 36 COMMA 40 COMMA 56 COMMA 57 COMMA 41 COMMA 3 COMMA 46 COMMA 50 COMMA 49 COMMA 60 COMMA 61 COMMA 62 COMMA 42 COMMA 26 COMMA 27 COMMA 28 COMMA 29 COMMA 30 COMMA 34 COMMA 31 COMMA 33 COMMA 32 COMMA 6 COMMA 48 COMMA 47});
GLOBAL_LIST(int, 16, DEFAULT_TRUE, {20 COMMA 21 COMMA 43 COMMA 22 COMMA 44 COMMA 16 COMMA 52 COMMA 53 COMMA 59 COMMA 54 COMMA 58 COMMA 55 COMMA 56 COMMA 57 COMMA 50 COMMA 48});
GLOBAL_LIST(int, 18, PARSE_OPTION_NUMS, {44 COMMA 35 COMMA 51 COMMA 52 COMMA 53 COMMA 59 COMMA 37 COMMA 54 COMMA 58 COMMA 38 COMMA 55 COMMA 39 COMMA 36 COMMA 40 COMMA 56 COMMA 57 COMMA 63 COMMA 41});
GLOBAL_LIST(int, 91, SHOPT_OPTION_NUMS, {20 COMMA 21 COMMA 25 COMMA 24 COMMA 69 COMMA 70 COMMA 71 COMMA 72 COMMA 73 COMMA 74 COMMA 75 COMMA 68 COMMA 45 COMMA 76 COMMA 43 COMMA 77 COMMA 78 COMMA 79 COMMA 22 COMMA 19 COMMA 80 COMMA 44 COMMA 81 COMMA 18 COMMA 82 COMMA 17 COMMA 83 COMMA 84 COMMA 85 COMMA 86 COMMA 66 COMMA 87 COMMA 88 COMMA 67 COMMA 89 COMMA 4 COMMA 90 COMMA 64 COMMA 91 COMMA 92 COMMA 93 COMMA 94 COMMA 95 COMMA 96 COMMA 97 COMMA 98 COMMA 5 COMMA 35 COMMA 51 COMMA 52 COMMA 53 COMMA 59 COMMA 37 COMMA 54 COMMA 58 COMMA 38 COMMA 55 COMMA 39 COMMA 36 COMMA 40 COMMA 56 COMMA 57 COMMA 63 COMMA 41 COMMA 46 COMMA 65 COMMA 99 COMMA 100 COMMA 23 COMMA 50 COMMA 101 COMMA 102 COMMA 49 COMMA 60 COMMA 61 COMMA 62 COMMA 42 COMMA 103 COMMA 26 COMMA 27 COMMA 28 COMMA 29 COMMA 30 COMMA 34 COMMA 31 COMMA 33 COMMA 32 COMMA 6 COMMA 104 COMMA 48 COMMA 47});
...
GLOBAL_LIST(int, 50, VISIBLE_SHOPT_NUMS, {20 COMMA 21 COMMA 25 COMMA 24 COMMA 45 COMMA 43 COMMA 22 COMMA 19 COMMA 44 COMMA 18 COMMA 17 COMMA 4 COMMA 5 COMMA 35 COMMA 51 COMMA 52 COMMA 53 COMMA 59 COMMA 37 COMMA 54 COMMA 58 COMMA 38 COMMA 55 COMMA 39 COMMA 36 COMMA 40 COMMA 56 COMMA 57 COMMA 63 COMMA 41 COMMA 46 COMMA 23 COMMA 50 COMMA 49 COMMA 60 COMMA 61 COMMA 62 COMMA 42 COMMA 26 COMMA 27 COMMA 28 COMMA 29 COMMA 30 COMMA 34 COMMA 31 COMMA 33 COMMA 32 COMMA 6 COMMA 48 COMMA 47});
...
option_asdl::option_t OptionNum(Str* s) {
  ...
  switch (data[0]) {
  case '_':
    if (length == 18 && memcmp("_allow_command_sub", data, 18) == 0) return 20;
    if (length == 18 && memcmp("_allow_process_sub", data, 18) == 0) return 21;
    if (length == 13 && memcmp("_running_trap", data, 13) == 0) return 24;
    if (length == 12 && memcmp("_running_hay", data, 12) == 0) return 25;
    break;
  case 'a':
    if (length == 17 && memcmp("assoc_expand_once", data, 17) == 0) return 69;
    if (length == 6 && memcmp("autocd", data, 6) == 0) return 70;
    break;
  case 'c':
    if (length == 19 && memcmp("command_sub_errexit", data, 19) == 0) return 45;
    if (length == 7 && memcmp("cmdhist", data, 7) == 0) return 68;
    if (length == 11 && memcmp("cdable_vars", data, 11) == 0) return 71;
    if (length == 7 && memcmp("cdspell", data, 7) == 0) return 72;
    if (length == 9 && memcmp("checkhash", data, 9) == 0) return 73;
    if (length == 9 && memcmp("checkjobs", data, 9) == 0) return 74;
    if (length == 12 && memcmp("checkwinsize", data, 12) == 0) return 75;
    if (length == 18 && memcmp("complete_fullquote", data, 18) == 0) return 76;
    break;
  case 'd':
    if (length == 13 && memcmp("dynamic_scope", data, 13) == 0) return 22;
    if (length == 8 && memcmp("dashglob", data, 8) == 0) return 43;
    if (length == 9 && memcmp("direxpand", data, 9) == 0) return 77;
    if (length == 8 && memcmp("dirspell", data, 8) == 0) return 78;
    if (length == 7 && memcmp("dotglob", data, 7) == 0) return 79;
    break;
  case 'e':
    ...
    if (length == 14 && memcmp("expand_aliases", data, 14) == 0) return 44;
    if (length == 8 && memcmp("execfail", data, 8) == 0) return 80;
    if (length == 8 && memcmp("extdebug", data, 8) == 0) return 81;
    if (length == 8 && memcmp("extquote", data, 8) == 0) return 82;
    break;
  case 'f':
    if (length == 8 && memcmp("failglob", data, 8) == 0) return 17;
    if (length == 13 && memcmp("force_fignore", data, 13) == 0) return 83;
    break;
  case 'g':
    if (length == 15 && memcmp("globasciiranges", data, 15) == 0) return 84;
    if (length == 8 && memcmp("globstar", data, 8) == 0) return 85;
    if (length == 10 && memcmp("gnu_errfmt", data, 10) == 0) return 86;
    break;
  case 'h':
    if (length == 7 && memcmp("hashall", data, 7) == 0) return 16;
    if (length == 10 && memcmp("histappend", data, 10) == 0) return 66;
    if (length == 12 && memcmp("hostcomplete", data, 12) == 0) return 67;
    if (length == 10 && memcmp("histreedit", data, 10) == 0) return 87;
    if (length == 10 && memcmp("histverify", data, 10) == 0) return 88;
    if (length == 9 && memcmp("huponexit", data, 9) == 0) return 89;
    break;
  case 'i':
    if (length == 15 && memcmp("inherit_errexit", data, 15) == 0) return 4;
    if (length == 11 && memcmp("interactive", data, 11) == 0) return 15;
    if (length == 20 && memcmp("interactive_comments", data, 20) == 0) return 90;
    break;
  case 'l':
    if (length == 8 && memcmp("lastpipe", data, 8) == 0) return 64;
    if (length == 7 && memcmp("lithist", data, 7) == 0) return 91;
    if (length == 16 && memcmp("localvar_inherit", data, 16) == 0) return 92;
    if (length == 14 && memcmp("localvar_unset", data, 14) == 0) return 93;
    if (length == 11 && memcmp("login_shell", data, 11) == 0) return 94;
    break;
  case 'm':
    if (length == 8 && memcmp("mailwarn", data, 8) == 0) return 95;
    break;
  case 'n':
    ...
    if (length == 23 && memcmp("no_empty_cmd_completion", data, 23) == 0) return 96;
    if (length == 10 && memcmp("nocaseglob", data, 10) == 0) return 97;
    if (length == 11 && memcmp("nocasematch", data, 11) == 0) return 98;
    break;
  case 'p':
    if (length == 8 && memcmp("pipefail", data, 8) == 0) return 3;
    if (length == 5 && memcmp("posix", data, 5) == 0) return 12;
    if (length == 8 && memcmp("parse_at", data, 8) == 0) return 35;
    if (length == 10 && memcmp("parse_proc", data, 10) == 0) return 36;
    if (length == 11 && memcmp("parse_brace", data, 11) == 0) return 37;
    if (length == 12 && memcmp("parse_equals", data, 12) == 0) return 38;
    if (length == 11 && memcmp("parse_paren", data, 11) == 0) return 39;
    if (length == 16 && memcmp("parse_raw_string", data, 16) == 0) return 40;
    if (length == 18 && memcmp("parse_triple_quote", data, 18) == 0) return 41;
    if (length == 16 && memcmp("process_sub_fail", data, 16) == 0) return 46;
    if (length == 12 && memcmp("parse_at_all", data, 12) == 0) return 51;
    if (length == 15 && memcmp("parse_backslash", data, 15) == 0) return 52;
    if (length == 15 && memcmp("parse_backticks", data, 15) == 0) return 53;
    if (length == 12 && memcmp("parse_dollar", data, 12) == 0) return 54;
    if (length == 13 && memcmp("parse_ignored", data, 13) == 0) return 55;
    if (length == 14 && memcmp("parse_sh_arith", data, 14) == 0) return 56;
    ...
    if (length == 9 && memcmp("parse_tea", data, 9) == 0) return 63;
    if (length == 8 && memcmp("progcomp", data, 8) == 0) return 65;
    if (length == 14 && memcmp("progcomp_alias", data, 14) == 0) return 99;
    if (length == 10 && memcmp("promptvars", data, 10) == 0) return 100;
    break;
  case 'r':
    if (length == 15 && memcmp("redefine_module", data, 15) == 0) return 23;
    if (length == 13 && memcmp("redefine_proc", data, 13) == 0) return 50;
    if (length == 16 && memcmp("restricted_shell", data, 16) == 0) return 101;
    break;
  case 's':
    if (length == 11 && memcmp("strict_argv", data, 11) == 0) return 26;
    if (length == 12 && memcmp("strict_arith", data, 12) == 0) return 27;
    if (length == 12 && memcmp("strict_array", data, 12) == 0) return 28;
    if (length == 19 && memcmp("strict_control_flow", data, 19) == 0) return 29;
    if (length == 14 && memcmp("strict_errexit", data, 14) == 0) return 30;
    if (length == 14 && memcmp("strict_nameref", data, 14) == 0) return 31;
    if (length == 16 && memcmp("strict_word_eval", data, 16) == 0) return 32;
    if (length == 12 && memcmp("strict_tilde", data, 12) == 0) return 33;
    if (length == 11 && memcmp("strict_glob", data, 11) == 0) return 34;
    if (length == 16 && memcmp("simple_word_eval", data, 16) == 0) return 42;
    if (length == 17 && memcmp("sigpipe_status_ok", data, 17) == 0) return 49;
    if (length == 11 && memcmp("simple_echo", data, 11) == 0) return 60;
    if (length == 19 && memcmp("simple_eval_builtin", data, 19) == 0) return 61;
    if (length == 19 && memcmp("simple_test_builtin", data, 19) == 0) return 62;
    if (length == 13 && memcmp("shift_verbose", data, 13) == 0) return 102;
    if (length == 10 && memcmp("sourcepath", data, 10) == 0) return 103;
    break;
  case 'v':
  ...
  case 'x':
    ...
    if (length == 11 && memcmp("xtrace_rich", data, 11) == 0) return 47;
    if (length == 14 && memcmp("xtrace_details", data, 14) == 0) return 48;
    if (length == 8 && memcmp("xpg_echo", data, 8) == 0) return 104;
    break;
  }
...
GLOBAL_STR(kBUILTIN_NAMES_15, "test");
GLOBAL_STR(kBUILTIN_NAMES_16, "[");
GLOBAL_STR(kBUILTIN_NAMES_17, "true");
GLOBAL_STR(kBUILTIN_NAMES_18, "false");
GLOBAL_STR(kBUILTIN_NAMES_19, "try");
GLOBAL_STR(kBUILTIN_NAMES_20, "read");
GLOBAL_STR(kBUILTIN_NAMES_21, "echo");
GLOBAL_STR(kBUILTIN_NAMES_22, "printf");
GLOBAL_STR(kBUILTIN_NAMES_23, "mapfile");
GLOBAL_STR(kBUILTIN_NAMES_24, "readarray");
GLOBAL_STR(kBUILTIN_NAMES_25, "cd");
GLOBAL_STR(kBUILTIN_NAMES_26, "pushd");
GLOBAL_STR(kBUILTIN_NAMES_27, "popd");
GLOBAL_STR(kBUILTIN_NAMES_28, "dirs");
GLOBAL_STR(kBUILTIN_NAMES_29, "pwd");
GLOBAL_STR(kBUILTIN_NAMES_30, "source");
GLOBAL_STR(kBUILTIN_NAMES_31, "umask");

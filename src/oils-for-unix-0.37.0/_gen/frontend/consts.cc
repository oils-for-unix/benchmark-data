...
GLOBAL_LIST(STRICT_ALL, int, 13, {43 COMMA 41 COMMA 42 COMMA 44 COMMA 45 COMMA 46 COMMA 47 COMMA 51 COMMA 48 COMMA 39 COMMA 40 COMMA 50 COMMA 49});
GLOBAL_LIST(YSH_UPGRADE, int, 27, {64 COMMA 69 COMMA 1 COMMA 71 COMMA 4 COMMA 70 COMMA 63 COMMA 67 COMMA 2 COMMA 5 COMMA 52 COMMA 55 COMMA 56 COMMA 57 COMMA 54 COMMA 58 COMMA 53 COMMA 60 COMMA 61 COMMA 59 COMMA 3 COMMA 65 COMMA 68 COMMA 62 COMMA 6 COMMA 7 COMMA 66});
GLOBAL_LIST(YSH_ALL, int, 59, {64 COMMA 69 COMMA 1 COMMA 90 COMMA 71 COMMA 4 COMMA 70 COMMA 63 COMMA 83 COMMA 84 COMMA 85 COMMA 73 COMMA 74 COMMA 75 COMMA 76 COMMA 77 COMMA 78 COMMA 79 COMMA 80 COMMA 81 COMMA 82 COMMA 67 COMMA 2 COMMA 5 COMMA 52 COMMA 72 COMMA 55 COMMA 56 COMMA 57 COMMA 54 COMMA 58 COMMA 53 COMMA 60 COMMA 61 COMMA 59 COMMA 3 COMMA 65 COMMA 68 COMMA 86 COMMA 87 COMMA 88 COMMA 89 COMMA 62 COMMA 43 COMMA 41 COMMA 42 COMMA 44 COMMA 45 COMMA 46 COMMA 47 COMMA 51 COMMA 48 COMMA 39 COMMA 40 COMMA 50 COMMA 49 COMMA 6 COMMA 7 COMMA 66});
GLOBAL_LIST(DEFAULT_TRUE, int, 7, {30 COMMA 31 COMMA 32 COMMA 90 COMMA 19 COMMA 20 COMMA 29});
GLOBAL_LIST(PARSE_OPTION_NUMS, int, 24, {90 COMMA 73 COMMA 74 COMMA 75 COMMA 76 COMMA 77 COMMA 78 COMMA 79 COMMA 80 COMMA 81 COMMA 82 COMMA 52 COMMA 72 COMMA 55 COMMA 56 COMMA 57 COMMA 54 COMMA 58 COMMA 53 COMMA 60 COMMA 61 COMMA 59 COMMA 39 COMMA 40});
GLOBAL_LIST(SHOPT_OPTION_NUMS, int, 112, {30 COMMA 31 COMMA 37 COMMA 38 COMMA 36 COMMA 35 COMMA 95 COMMA 96 COMMA 97 COMMA 98 COMMA 99 COMMA 100 COMMA 101 COMMA 94 COMMA 64 COMMA 102 COMMA 103 COMMA 104 COMMA 24 COMMA 32 COMMA 69 COMMA 26 COMMA 105 COMMA 90 COMMA 25 COMMA 22 COMMA 106 COMMA 21 COMMA 71 COMMA 107 COMMA 108 COMMA 109 COMMA 110 COMMA 93 COMMA 111 COMMA 112 COMMA 92 COMMA 113 COMMA 27 COMMA 28 COMMA 4 COMMA 70 COMMA 114 COMMA 20 COMMA 115 COMMA 116 COMMA 117 COMMA 118 COMMA 119 COMMA 63 COMMA 120 COMMA 83 COMMA 84 COMMA 85 COMMA 73 COMMA 74 COMMA 75 COMMA 76 COMMA 77 COMMA 78 COMMA 79 COMMA 80 COMMA 81 COMMA 82 COMMA 67 COMMA 121 COMMA 23 COMMA 5 COMMA 52 COMMA 72 COMMA 55 COMMA 56 COMMA 57 COMMA 54 COMMA 58 COMMA 53 COMMA 60 COMMA 61 COMMA 59 COMMA 65 COMMA 91 COMMA 122 COMMA 123 COMMA 33 COMMA 34 COMMA 124 COMMA 29 COMMA 125 COMMA 68 COMMA 86 COMMA 87 COMMA 88 COMMA 89 COMMA 62 COMMA 126 COMMA 43 COMMA 41 COMMA 42 COMMA 44 COMMA 45 COMMA 46 COMMA 47 COMMA 51 COMMA 48 COMMA 39 COMMA 40 COMMA 50 COMMA 49 COMMA 6 COMMA 7 COMMA 127 COMMA 66});
...
GLOBAL_LIST(VISIBLE_SHOPT_NUMS, int, 77, {30 COMMA 31 COMMA 37 COMMA 38 COMMA 36 COMMA 35 COMMA 64 COMMA 24 COMMA 32 COMMA 69 COMMA 26 COMMA 90 COMMA 25 COMMA 22 COMMA 21 COMMA 71 COMMA 92 COMMA 27 COMMA 28 COMMA 4 COMMA 70 COMMA 20 COMMA 63 COMMA 83 COMMA 84 COMMA 85 COMMA 73 COMMA 74 COMMA 75 COMMA 76 COMMA 77 COMMA 78 COMMA 79 COMMA 80 COMMA 81 COMMA 82 COMMA 67 COMMA 23 COMMA 5 COMMA 52 COMMA 72 COMMA 55 COMMA 56 COMMA 57 COMMA 54 COMMA 58 COMMA 53 COMMA 60 COMMA 61 COMMA 59 COMMA 65 COMMA 91 COMMA 33 COMMA 34 COMMA 29 COMMA 68 COMMA 86 COMMA 87 COMMA 88 COMMA 89 COMMA 62 COMMA 43 COMMA 41 COMMA 42 COMMA 44 COMMA 45 COMMA 46 COMMA 47 COMMA 51 COMMA 48 COMMA 39 COMMA 40 COMMA 50 COMMA 49 COMMA 6 COMMA 7 COMMA 66});
...
option_asdl::option_t OptionNum(BigStr* s) {
  ...
  switch (data[0]) {
  case '_':
    if (length == 18 && memcmp("_allow_command_sub", data, 18) == 0) return 30;
    if (length == 18 && memcmp("_allow_process_sub", data, 18) == 0) return 31;
    if (length == 13 && memcmp("_running_trap", data, 13) == 0) return 35;
    if (length == 12 && memcmp("_running_hay", data, 12) == 0) return 36;
    if (length == 14 && memcmp("_no_debug_trap", data, 14) == 0) return 37;
    if (length == 12 && memcmp("_no_err_trap", data, 12) == 0) return 38;
    break;
  case 'a':
    if (length == 9 && memcmp("allexport", data, 9) == 0) return 8;
    break;
  case 'c':
    if (length == 19 && memcmp("command_sub_errexit", data, 19) == 0) return 64;
    break;
  case 'd':
    if (length == 7 && memcmp("dotglob", data, 7) == 0) return 24;
    if (length == 13 && memcmp("dynamic_scope", data, 13) == 0) return 32;
    break;
  case 'e':
    ...
    if (length == 7 && memcmp("extglob", data, 7) == 0) return 22;
    if (length == 8 && memcmp("extdebug", data, 8) == 0) return 25;
    if (length == 17 && memcmp("eval_unsafe_arith", data, 17) == 0) return 26;
    if (length == 7 && memcmp("env_obj", data, 7) == 0) return 69;
    if (length == 14 && memcmp("expand_aliases", data, 14) == 0) return 90;
    break;
  case 'f':
    if (length == 8 && memcmp("failglob", data, 8) == 0) return 21;
    if (length == 15 && memcmp("for_loop_frames", data, 15) == 0) return 71;
    break;
  case 'h':
    if (length == 7 && memcmp("hashall", data, 7) == 0) return 19;
    if (length == 12 && memcmp("hostcomplete", data, 12) == 0) return 92;
    break;
  case 'i':
    if (length == 15 && memcmp("inherit_errexit", data, 15) == 0) return 4;
    if (length == 11 && memcmp("interactive", data, 11) == 0) return 18;
    if (length == 21 && memcmp("ignore_flags_not_impl", data, 21) == 0) return 27;
    if (length == 21 && memcmp("ignore_shopt_not_impl", data, 21) == 0) return 28;
    if (length == 16 && memcmp("init_ysh_globals", data, 16) == 0) return 70;
    break;
  case 'l':
  ...
  case 'n':
    ...
    if (length == 12 && memcmp("no_dash_glob", data, 12) == 0) return 63;
    if (length == 13 && memcmp("no_xtrace_osh", data, 13) == 0) return 67;
    if (length == 18 && memcmp("no_parse_backslash", data, 18) == 0) return 73;
    if (length == 18 && memcmp("no_parse_backticks", data, 18) == 0) return 74;
    if (length == 18 && memcmp("no_parse_bare_word", data, 18) == 0) return 75;
    if (length == 17 && memcmp("no_parse_dbracket", data, 17) == 0) return 76;
    if (length == 15 && memcmp("no_parse_dollar", data, 15) == 0) return 77;
    if (length == 15 && memcmp("no_parse_dparen", data, 15) == 0) return 78;
    if (length == 16 && memcmp("no_parse_ignored", data, 16) == 0) return 79;
    if (length == 12 && memcmp("no_parse_osh", data, 12) == 0) return 80;
    if (length == 17 && memcmp("no_parse_sh_arith", data, 17) == 0) return 81;
    if (length == 18 && memcmp("no_parse_word_join", data, 18) == 0) return 82;
    if (length == 11 && memcmp("no_exported", data, 11) == 0) return 83;
    if (length == 15 && memcmp("no_init_globals", data, 15) == 0) return 84;
    if (length == 15 && memcmp("no_osh_builtins", data, 15) == 0) return 85;
    break;
  case 'p':
    if (length == 8 && memcmp("pipefail", data, 8) == 0) return 3;
    if (length == 5 && memcmp("posix", data, 5) == 0) return 15;
    if (length == 8 && memcmp("parse_at", data, 8) == 0) return 52;
    if (length == 10 && memcmp("parse_proc", data, 10) == 0) return 53;
    if (length == 10 && memcmp("parse_func", data, 10) == 0) return 54;
    if (length == 11 && memcmp("parse_brace", data, 11) == 0) return 55;
    if (length == 13 && memcmp("parse_bracket", data, 13) == 0) return 56;
    if (length == 12 && memcmp("parse_equals", data, 12) == 0) return 57;
    if (length == 11 && memcmp("parse_paren", data, 11) == 0) return 58;
    if (length == 16 && memcmp("parse_ysh_string", data, 16) == 0) return 59;
    if (length == 18 && memcmp("parse_triple_quote", data, 18) == 0) return 60;
    if (length == 18 && memcmp("parse_ysh_expr_sub", data, 18) == 0) return 61;
    if (length == 16 && memcmp("process_sub_fail", data, 16) == 0) return 65;
    if (length == 12 && memcmp("parse_at_all", data, 12) == 0) return 72;
    if (length == 8 && memcmp("progcomp", data, 8) == 0) return 91;
    break;
  case 'r':
    if (length == 14 && memcmp("rewrite_extern", data, 14) == 0) return 29;
    if (length == 14 && memcmp("redefine_const", data, 14) == 0) return 33;
    if (length == 15 && memcmp("redefine_source", data, 15) == 0) return 34;
    break;
  case 's':
    if (length == 19 && memcmp("strict_parse_equals", data, 19) == 0) return 39;
    if (length == 18 && memcmp("strict_parse_slice", data, 18) == 0) return 40;
    if (length == 11 && memcmp("strict_argv", data, 11) == 0) return 41;
    if (length == 12 && memcmp("strict_arith", data, 12) == 0) return 42;
    if (length == 16 && memcmp("strict_arg_parse", data, 16) == 0) return 43;
    if (length == 12 && memcmp("strict_array", data, 12) == 0) return 44;
    if (length == 19 && memcmp("strict_control_flow", data, 19) == 0) return 45;
    if (length == 18 && memcmp("strict_env_binding", data, 18) == 0) return 46;
    if (length == 14 && memcmp("strict_errexit", data, 14) == 0) return 47;
    if (length == 14 && memcmp("strict_nameref", data, 14) == 0) return 48;
    if (length == 16 && memcmp("strict_word_eval", data, 16) == 0) return 49;
    if (length == 12 && memcmp("strict_tilde", data, 12) == 0) return 50;
    if (length == 11 && memcmp("strict_glob", data, 11) == 0) return 51;
    if (length == 16 && memcmp("simple_word_eval", data, 16) == 0) return 62;
    if (length == 17 && memcmp("sigpipe_status_ok", data, 17) == 0) return 68;
    if (length == 11 && memcmp("simple_echo", data, 11) == 0) return 86;
    if (length == 19 && memcmp("simple_eval_builtin", data, 19) == 0) return 87;
    if (length == 19 && memcmp("simple_test_builtin", data, 19) == 0) return 88;
    if (length == 19 && memcmp("simple_trap_builtin", data, 19) == 0) return 89;
    break;
  case 'v':
  ...
  case 'x':
    ...
    if (length == 11 && memcmp("xtrace_rich", data, 11) == 0) return 66;
    break;
  }
...
option_asdl::option_t UnimplOptionNum(BigStr* s) {
  ...
  switch (data[0]) {
  case 'a':
    if (length == 17 && memcmp("assoc_expand_once", data, 17) == 0) return 95;
    if (length == 6 && memcmp("autocd", data, 6) == 0) return 96;
    break;
  case 'c':
    if (length == 7 && memcmp("cmdhist", data, 7) == 0) return 94;
    if (length == 11 && memcmp("cdable_vars", data, 11) == 0) return 97;
    if (length == 7 && memcmp("cdspell", data, 7) == 0) return 98;
    if (length == 9 && memcmp("checkhash", data, 9) == 0) return 99;
    if (length == 9 && memcmp("checkjobs", data, 9) == 0) return 100;
    if (length == 12 && memcmp("checkwinsize", data, 12) == 0) return 101;
    if (length == 18 && memcmp("complete_fullquote", data, 18) == 0) return 102;
    break;
  case 'd':
    if (length == 9 && memcmp("direxpand", data, 9) == 0) return 103;
    if (length == 8 && memcmp("dirspell", data, 8) == 0) return 104;
    break;
  case 'e':
    if (length == 8 && memcmp("execfail", data, 8) == 0) return 105;
    if (length == 8 && memcmp("extquote", data, 8) == 0) return 106;
    break;
  case 'f':
    if (length == 13 && memcmp("force_fignore", data, 13) == 0) return 107;
    break;
  case 'g':
    if (length == 15 && memcmp("globasciiranges", data, 15) == 0) return 108;
    if (length == 8 && memcmp("globstar", data, 8) == 0) return 109;
    if (length == 10 && memcmp("gnu_errfmt", data, 10) == 0) return 110;
    break;
  case 'h':
    if (length == 10 && memcmp("histappend", data, 10) == 0) return 93;
    if (length == 10 && memcmp("histreedit", data, 10) == 0) return 111;
    if (length == 10 && memcmp("histverify", data, 10) == 0) return 112;
    if (length == 9 && memcmp("huponexit", data, 9) == 0) return 113;
    break;
  case 'i':
    if (length == 20 && memcmp("interactive_comments", data, 20) == 0) return 114;
    break;
  case 'l':
    if (length == 7 && memcmp("lithist", data, 7) == 0) return 115;
    if (length == 16 && memcmp("localvar_inherit", data, 16) == 0) return 116;
    if (length == 14 && memcmp("localvar_unset", data, 14) == 0) return 117;
    if (length == 11 && memcmp("login_shell", data, 11) == 0) return 118;
    break;
  case 'm':
    if (length == 8 && memcmp("mailwarn", data, 8) == 0) return 119;
    break;
  case 'n':
    if (length == 23 && memcmp("no_empty_cmd_completion", data, 23) == 0) return 120;
    if (length == 10 && memcmp("nocaseglob", data, 10) == 0) return 121;
    break;
  case 'p':
    if (length == 14 && memcmp("progcomp_alias", data, 14) == 0) return 122;
    if (length == 10 && memcmp("promptvars", data, 10) == 0) return 123;
    break;
  case 'r':
    if (length == 16 && memcmp("restricted_shell", data, 16) == 0) return 124;
    break;
  case 's':
    if (length == 13 && memcmp("shift_verbose", data, 13) == 0) return 125;
    if (length == 10 && memcmp("sourcepath", data, 10) == 0) return 126;
    break;
  case 'x':
    if (length == 8 && memcmp("xpg_echo", data, 8) == 0) return 127;
    break;
  }
...
GLOBAL_STR(kOptionName_21, "failglob");
GLOBAL_STR(kOptionName_22, "extglob");
GLOBAL_STR(kOptionName_23, "nocasematch");
GLOBAL_STR(kOptionName_24, "dotglob");
GLOBAL_STR(kOptionName_25, "extdebug");
GLOBAL_STR(kOptionName_26, "eval_unsafe_arith");
GLOBAL_STR(kOptionName_27, "ignore_flags_not_impl");
GLOBAL_STR(kOptionName_28, "ignore_shopt_not_impl");
GLOBAL_STR(kOptionName_29, "rewrite_extern");
GLOBAL_STR(kOptionName_30, "_allow_command_sub");
GLOBAL_STR(kOptionName_31, "_allow_process_sub");
GLOBAL_STR(kOptionName_32, "dynamic_scope");
GLOBAL_STR(kOptionName_33, "redefine_const");
GLOBAL_STR(kOptionName_34, "redefine_source");
GLOBAL_STR(kOptionName_35, "_running_trap");
GLOBAL_STR(kOptionName_36, "_running_hay");
GLOBAL_STR(kOptionName_37, "_no_debug_trap");
GLOBAL_STR(kOptionName_38, "_no_err_trap");
GLOBAL_STR(kOptionName_39, "strict_parse_equals");
GLOBAL_STR(kOptionName_40, "strict_parse_slice");
GLOBAL_STR(kOptionName_41, "strict_argv");
GLOBAL_STR(kOptionName_42, "strict_arith");
GLOBAL_STR(kOptionName_43, "strict_arg_parse");
GLOBAL_STR(kOptionName_44, "strict_array");
GLOBAL_STR(kOptionName_45, "strict_control_flow");
GLOBAL_STR(kOptionName_46, "strict_env_binding");
GLOBAL_STR(kOptionName_47, "strict_errexit");
GLOBAL_STR(kOptionName_48, "strict_nameref");
GLOBAL_STR(kOptionName_49, "strict_word_eval");
GLOBAL_STR(kOptionName_50, "strict_tilde");
GLOBAL_STR(kOptionName_51, "strict_glob");
GLOBAL_STR(kOptionName_52, "parse_at");
GLOBAL_STR(kOptionName_53, "parse_proc");
GLOBAL_STR(kOptionName_54, "parse_func");
GLOBAL_STR(kOptionName_55, "parse_brace");
GLOBAL_STR(kOptionName_56, "parse_bracket");
GLOBAL_STR(kOptionName_57, "parse_equals");
GLOBAL_STR(kOptionName_58, "parse_paren");
GLOBAL_STR(kOptionName_59, "parse_ysh_string");
GLOBAL_STR(kOptionName_60, "parse_triple_quote");
GLOBAL_STR(kOptionName_61, "parse_ysh_expr_sub");
GLOBAL_STR(kOptionName_62, "simple_word_eval");
GLOBAL_STR(kOptionName_63, "no_dash_glob");
GLOBAL_STR(kOptionName_64, "command_sub_errexit");
GLOBAL_STR(kOptionName_65, "process_sub_fail");
GLOBAL_STR(kOptionName_66, "xtrace_rich");
GLOBAL_STR(kOptionName_67, "no_xtrace_osh");
GLOBAL_STR(kOptionName_68, "sigpipe_status_ok");
GLOBAL_STR(kOptionName_69, "env_obj");
GLOBAL_STR(kOptionName_70, "init_ysh_globals");
GLOBAL_STR(kOptionName_71, "for_loop_frames");
GLOBAL_STR(kOptionName_72, "parse_at_all");
GLOBAL_STR(kOptionName_73, "no_parse_backslash");
GLOBAL_STR(kOptionName_74, "no_parse_backticks");
GLOBAL_STR(kOptionName_75, "no_parse_bare_word");
GLOBAL_STR(kOptionName_76, "no_parse_dbracket");
GLOBAL_STR(kOptionName_77, "no_parse_dollar");
GLOBAL_STR(kOptionName_78, "no_parse_dparen");
GLOBAL_STR(kOptionName_79, "no_parse_ignored");
GLOBAL_STR(kOptionName_80, "no_parse_osh");
GLOBAL_STR(kOptionName_81, "no_parse_sh_arith");
GLOBAL_STR(kOptionName_82, "no_parse_word_join");
GLOBAL_STR(kOptionName_83, "no_exported");
GLOBAL_STR(kOptionName_84, "no_init_globals");
GLOBAL_STR(kOptionName_85, "no_osh_builtins");
GLOBAL_STR(kOptionName_86, "simple_echo");
GLOBAL_STR(kOptionName_87, "simple_eval_builtin");
GLOBAL_STR(kOptionName_88, "simple_test_builtin");
GLOBAL_STR(kOptionName_89, "simple_trap_builtin");
GLOBAL_STR(kOptionName_90, "expand_aliases");
GLOBAL_STR(kOptionName_91, "progcomp");
GLOBAL_STR(kOptionName_92, "hostcomplete");
GLOBAL_STR(kOptionName_93, "histappend");
GLOBAL_STR(kOptionName_94, "cmdhist");
GLOBAL_STR(kOptionName_95, "assoc_expand_once");
GLOBAL_STR(kOptionName_96, "autocd");
GLOBAL_STR(kOptionName_97, "cdable_vars");
GLOBAL_STR(kOptionName_98, "cdspell");
GLOBAL_STR(kOptionName_99, "checkhash");
GLOBAL_STR(kOptionName_100, "checkjobs");
GLOBAL_STR(kOptionName_101, "checkwinsize");
GLOBAL_STR(kOptionName_102, "complete_fullquote");
GLOBAL_STR(kOptionName_103, "direxpand");
GLOBAL_STR(kOptionName_104, "dirspell");
GLOBAL_STR(kOptionName_105, "execfail");
GLOBAL_STR(kOptionName_106, "extquote");
GLOBAL_STR(kOptionName_107, "force_fignore");
GLOBAL_STR(kOptionName_108, "globasciiranges");
GLOBAL_STR(kOptionName_109, "globstar");
GLOBAL_STR(kOptionName_110, "gnu_errfmt");
GLOBAL_STR(kOptionName_111, "histreedit");
GLOBAL_STR(kOptionName_112, "histverify");
GLOBAL_STR(kOptionName_113, "huponexit");
GLOBAL_STR(kOptionName_114, "interactive_comments");
GLOBAL_STR(kOptionName_115, "lithist");
GLOBAL_STR(kOptionName_116, "localvar_inherit");
GLOBAL_STR(kOptionName_117, "localvar_unset");
GLOBAL_STR(kOptionName_118, "login_shell");
GLOBAL_STR(kOptionName_119, "mailwarn");
GLOBAL_STR(kOptionName_120, "no_empty_cmd_completion");
GLOBAL_STR(kOptionName_121, "nocaseglob");
GLOBAL_STR(kOptionName_122, "progcomp_alias");
GLOBAL_STR(kOptionName_123, "promptvars");
GLOBAL_STR(kOptionName_124, "restricted_shell");
GLOBAL_STR(kOptionName_125, "shift_verbose");
GLOBAL_STR(kOptionName_126, "sourcepath");
GLOBAL_STR(kOptionName_127, "xpg_echo");

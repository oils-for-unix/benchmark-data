...
main() {
  ...
  local more_cxx_flags='-D NO_GC_HACK -D OLDSTL_BINDINGS'
  ...
  echo 'CXX mycpp/oldstl_containers.cc'
  compile_one "$compiler" "$variant" "$more_cxx_flags" \
    mycpp/oldstl_containers.cc "_build/obj/$compiler-$variant-sh/oldstl_containers.o"
  ...
  link "$compiler" "$variant" "$out" \
    ...
    "_build/obj/$compiler-$variant-sh/oldstl_containers.o" \

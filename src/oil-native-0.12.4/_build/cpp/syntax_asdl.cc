// _build/cpp/syntax_asdl.cc is generated by asdl/tool.py
...
hnode_t* parse_result__Node::PrettyTree() {
  ...
  L->append(new field(StrFromC("cmd"), x0));
...
hnode_t* source__Unused::PrettyTree() {
  ...
  L->append(new field(StrFromC("comment"), x0));
...
hnode_t* source__MainFile::PrettyTree() {
  ...
  L->append(new field(StrFromC("path"), x0));
...
hnode_t* source__SourcedFile::PrettyTree() {
  ...
  L->append(new field(StrFromC("spid"), x1));
...
hnode_t* source__ArgvWord::PrettyTree() {
  ...
  L->append(new field(StrFromC("what"), x0));

  hnode_t* x1 = new hnode__Leaf(str(this->span_id), color_e::OtherConst);
  L->append(new field(StrFromC("span_id"), x1));
...
hnode_t* source__Variable::PrettyTree() {
  ...
  L->append(new field(StrFromC("var_name"), x0));
...
hnode_t* source__Alias::PrettyTree() {
  ...
  L->append(new field(StrFromC("argv0"), x0));

  hnode_t* x1 = new hnode__Leaf(str(this->argv0_spid), color_e::OtherConst);
  L->append(new field(StrFromC("argv0_spid"), x1));
...
hnode_t* source__Reparsed::PrettyTree() {
  ...
  hnode_t* x1 = new hnode__Leaf(str(this->left_spid), color_e::OtherConst);
  L->append(new field(StrFromC("left_spid"), x1));

  hnode_t* x2 = new hnode__Leaf(str(this->right_spid), color_e::OtherConst);
  L->append(new field(StrFromC("right_spid"), x2));
...
hnode_t* source__Synthetic::PrettyTree() {
  ...
  L->append(new field(StrFromC("s"), x0));
...
hnode_t* Token::PrettyTree() {
  ...
  hnode_t* x0 = new hnode__Leaf(StrFromC(Id_str(this->id)), color_e::UserType);
  L->append(new field(StrFromC("id"), x0));

  hnode_t* x1 = new hnode__Leaf(str(this->span_id), color_e::OtherConst);
  L->append(new field(StrFromC("span_id"), x1));

  hnode_t* x2 = runtime::NewLeaf(this->val, color_e::StringConst);
  L->append(new field(StrFromC("val"), x2));

  return out_node;
}

hnode_t* speck::PrettyTree() {
  hnode__Record* out_node = runtime::NewRecord(StrFromC("speck"));
  List<field*>* L = out_node->fields;
...
runtime::NewRecord(StrFromC("bracket_op.WholeArray"));
  ...
  hnode_t* x0 = new hnode__Leaf(StrFromC(Id_str(this->op_id)),
                                color_e::UserType);
  L->append(new field(StrFromC("op_id"), x0));
...
runtime::NewRecord(StrFromC("bracket_op.ArrayIndex"));
  ...
  L->append(new field(StrFromC("expr"), x0));
...
hnode_t* suffix_op__Static::PrettyTree() {
  ...
  L->append(new field(StrFromC("arg"), x1));
...
hnode_t* suffix_op__PatSub::PrettyTree() {
  ...
  L->append(new field(StrFromC("pat"), x0));

  if (this->replace) {  // MaybeType
    hnode_t* x1 = this->replace->PrettyTree();
    L->append(new field(StrFromC("replace"), x1));
  }

  hnode_t* x2 = new hnode__Leaf(StrFromC(Id_str(this->replace_mode)),
                                color_e::UserType);
  L->append(new field(StrFromC("replace_mode"), x2));

  if (this->spids && len(this->spids)) {  // ArrayType
    hnode__Array* x3 = new hnode__Array(NewList<hnode_t*>());
    for (ListIter<int> it(this->spids); !it.Done(); it.Next()) {
      int i3 = it.Value();
      x3->children->append(new hnode__Leaf(str(i3), color_e::OtherConst));
    }
    L->append(new field(StrFromC("spids"), x3));
  }
...
hnode_t* suffix_op__Slice::PrettyTree() {
  ...
  if (this->begin) {  // MaybeType
    ...
    L->append(new field(StrFromC("begin"), x0));
  }

  if (this->length) {  // MaybeType
    hnode_t* x1 = this->length->PrettyTree();
    L->append(new field(StrFromC("length"), x1));
  }
...
hnode_t* double_quoted::PrettyTree() {
  ...
  L->append(new field(StrFromC("left"), x0));

  if (this->parts && len(this->parts)) {  // ArrayType
    hnode__Array* x1 = new hnode__Array(NewList<hnode_t*>());
    for (ListIter<word_part_t*> it(this->parts); !it.Done(); it.Next()) {
      word_part_t* i1 = it.Value();
      x1->children->append(i1->PrettyTree());
    }
    L->append(new field(StrFromC("parts"), x1));
  }

  hnode_t* x2 = new hnode__Leaf(this->multiline ? runtime::TRUE_STR :
                                runtime::FALSE_STR, color_e::OtherConst);
  L->append(new field(StrFromC("multiline"), x2));
...
hnode_t* single_quoted::PrettyTree() {
  ...
  if (this->tokens && len(this->tokens)) {  // ArrayType
    ...
    L->append(new field(StrFromC("tokens"), x1));
  }
...
hnode_t* simple_var_sub::PrettyTree() {
  ...
  L->append(new field(StrFromC("token"), x0));
...
hnode_t* braced_var_sub::PrettyTree() {
  ...
  if (this->prefix_op) {  // MaybeType
    ...
    L->append(new field(StrFromC("prefix_op"), x1));
  }

  if (this->bracket_op) {  // MaybeType
    hnode_t* x2 = this->bracket_op->PrettyTree();
    L->append(new field(StrFromC("bracket_op"), x2));
  }

  if (this->suffix_op) {  // MaybeType
    hnode_t* x3 = this->suffix_op->PrettyTree();
    L->append(new field(StrFromC("suffix_op"), x3));
  }

  if (this->spids && len(this->spids)) {  // ArrayType
    hnode__Array* x4 = new hnode__Array(NewList<hnode_t*>());
    for (ListIter<int> it(this->spids); !it.Done(); it.Next()) {
      int i4 = it.Value();
      x4->children->append(new hnode__Leaf(str(i4), color_e::OtherConst));
    }
    L->append(new field(StrFromC("spids"), x4));
  }
...
hnode_t* command_sub::PrettyTree() {
  ...
  L->append(new field(StrFromC("left_token"), x0));

  hnode_t* x1 = this->child->PrettyTree();
  L->append(new field(StrFromC("child"), x1));
...
hnode_t* sh_array_literal::PrettyTree() {
  ...
  if (this->words && len(this->words)) {  // ArrayType
    ...
    L->append(new field(StrFromC("words"), x1));
  }
...
hnode_t* ArgList::PrettyTree() {
  ...
  if (this->positional && len(this->positional)) {  // ArrayType
    hnode__Array* x0 = new hnode__Array(NewList<hnode_t*>());
    for (ListIter<expr_t*> it(this->positional); !it.Done(); it.Next()) {
      expr_t* i0 = it.Value();
      x0->children->append(i0->PrettyTree());
    }
    L->append(new field(StrFromC("positional"), x0));
  }
  ...
  if (this->named && len(this->named)) {  // ArrayType
    ...
    L->append(new field(StrFromC("named"), x1));
  }
...
runtime::NewRecord(StrFromC("word_part.AssocArrayLiteral"));
  ...
  if (this->pairs && len(this->pairs)) {  // ArrayType
    ...
    L->append(new field(StrFromC("pairs"), x1));
  }
...
runtime::NewRecord(StrFromC("word_part.EscapedLiteral"));
  ...
  if (this->spids && len(this->spids)) {  // ArrayType
    ...
    L->append(new field(StrFromC("spids"), x1));
  }
...
hnode_t* word_part__ArithSub::PrettyTree() {
  ...
  L->append(new field(StrFromC("anode"), x0));
...
runtime::NewRecord(StrFromC("word_part.BracedTuple"));
  ...
  if (this->words && len(this->words)) {  // ArrayType
    ...
    L->append(new field(StrFromC("words"), x0));
  }
...
runtime::NewRecord(StrFromC("word_part.BracedRange"));
  ...
  hnode_t* x0 = new hnode__Leaf(StrFromC(Id_str(this->kind)),
                                color_e::UserType);
  L->append(new field(StrFromC("kind"), x0));

  hnode_t* x1 = runtime::NewLeaf(this->start, color_e::StringConst);
  L->append(new field(StrFromC("start"), x1));

  hnode_t* x2 = runtime::NewLeaf(this->end, color_e::StringConst);
  L->append(new field(StrFromC("end"), x2));

  hnode_t* x3 = new hnode__Leaf(str(this->step), color_e::OtherConst);
  L->append(new field(StrFromC("step"), x3));
...
hnode_t* word_part__ExtGlob::PrettyTree() {
  ...
  L->append(new field(StrFromC("op"), x0));
  ...
  if (this->arms && len(this->arms)) {  // ArrayType
    ...
    L->append(new field(StrFromC("arms"), x1));
  }
...
hnode_t* word_part__Splice::PrettyTree() {
  ...
  L->append(new field(StrFromC("name"), x0));
...
hnode_t* word_part__FuncCall::PrettyTree() {
  ...
  L->append(new field(StrFromC("args"), x1));
...
hnode_t* compound_word::PrettyTree() {
  ...
  if (this->parts && len(this->parts)) {  // ArrayType
    ...
    L->append(new field(StrFromC("parts"), x0));
  }
...
hnode_t* string_line::PrettyTree() {
  ...
  hnode_t* x0 = new hnode__Leaf(str(this->dedent), color_e::OtherConst);
  L->append(new field(StrFromC("dedent"), x0));

  if (this->part && len(this->part)) {  // ArrayType
    hnode__Array* x1 = new hnode__Array(NewList<hnode_t*>());
    for (ListIter<word_part_t*> it(this->part); !it.Done(); it.Next()) {
      word_part_t* i1 = it.Value();
      x1->children->append(i1->PrettyTree());
    }
    L->append(new field(StrFromC("part"), x1));
  }
...
hnode_t* triple_quoted::PrettyTree() {
  ...
  hnode_t* x0 = new hnode__Leaf(str(this->min_dedent), color_e::OtherConst);
  L->append(new field(StrFromC("min_dedent"), x0));

  if (this->lines && len(this->lines)) {  // ArrayType
    hnode__Array* x1 = new hnode__Array(NewList<hnode_t*>());
    for (ListIter<string_line*> it(this->lines); !it.Done(); it.Next()) {
      string_line* i1 = it.Value();
      x1->children->append(i1->PrettyTree());
    }
    L->append(new field(StrFromC("lines"), x1));
  }
...
hnode_t* word__Empty::PrettyTree() {
  hnode__Record* out_node = runtime::NewRecord(StrFromC("word.Empty"));
  return out_node;
}
...
hnode_t* word__String::PrettyTree() {
  ...
  L->append(new field(StrFromC("s"), x1));

  hnode_t* x2 = new hnode__Leaf(str(this->span_id), color_e::OtherConst);
  L->append(new field(StrFromC("span_id"), x2));
...
runtime::NewRecord(StrFromC("sh_lhs_expr.IndexedName"));
  ...
  L->append(new field(StrFromC("index"), x1));
...
runtime::NewRecord(StrFromC("arith_expr.BinaryAssign"));
  ...
  L->append(new field(StrFromC("left"), x1));

  hnode_t* x2 = this->right->PrettyTree();
  L->append(new field(StrFromC("right"), x2));
...
runtime::NewRecord(StrFromC("arith_expr.TernaryOp"));
  ...
  L->append(new field(StrFromC("cond"), x0));

  hnode_t* x1 = this->true_expr->PrettyTree();
  L->append(new field(StrFromC("true_expr"), x1));

  hnode_t* x2 = this->false_expr->PrettyTree();
  L->append(new field(StrFromC("false_expr"), x2));
...
hnode_t* bool_expr__WordTest::PrettyTree() {
  ...
  L->append(new field(StrFromC("w"), x0));
...
runtime::NewRecord(StrFromC("bool_expr.LogicalNot"));
  ...
  L->append(new field(StrFromC("child"), x0));
...
runtime::NewRecord(StrFromC("bool_expr.LogicalAnd"));
  ...
  L->append(new field(StrFromC("right"), x1));
...
hnode_t* redir_loc__Fd::PrettyTree() {
  ...
  L->append(new field(StrFromC("fd"), x0));
...
hnode_t* redir_param__HereDoc::PrettyTree() {
  ...
  L->append(new field(StrFromC("here_begin"), x0));

  hnode_t* x1 = new hnode__Leaf(str(this->here_end_span_id),
                                color_e::OtherConst);
  L->append(new field(StrFromC("here_end_span_id"), x1));
  ...
  if (this->stdin_parts && len(this->stdin_parts)) {  // ArrayType
    ...
    L->append(new field(StrFromC("stdin_parts"), x2));
  }
...
hnode_t* redir::PrettyTree() {
  ...
  L->append(new field(StrFromC("loc"), x1));

  hnode_t* x2 = this->arg->PrettyTree();
  L->append(new field(StrFromC("arg"), x2));
...
hnode_t* assign_pair::PrettyTree() {
  ...
  L->append(new field(StrFromC("lhs"), x0));

  hnode_t* x1 = new hnode__Leaf(StrFromC(assign_op_str(this->op)),
                                color_e::TypeName);
  L->append(new field(StrFromC("op"), x1));

  if (this->rhs) {  // MaybeType
    hnode_t* x2 = this->rhs->PrettyTree();
    L->append(new field(StrFromC("rhs"), x2));
  }
...
hnode_t* env_pair::PrettyTree() {
  ...
  L->append(new field(StrFromC("val"), x1));
...
hnode_t* condition__Shell::PrettyTree() {
  ...
  if (this->commands && len(this->commands)) {  // ArrayType
    hnode__Array* x0 = new hnode__Array(NewList<hnode_t*>());
    for (ListIter<command_t*> it(this->commands); !it.Done(); it.Next()) {
      command_t* i0 = it.Value();
      x0->children->append(i0->PrettyTree());
    }
    L->append(new field(StrFromC("commands"), x0));
  }
...
hnode_t* condition__Oil::PrettyTree() {
  ...
  L->append(new field(StrFromC("e"), x0));
...
hnode_t* condition_t::PrettyTree() {
  ...
  case condition_e::Oil: {
    condition__Oil* obj = static_cast<condition__Oil*>(this);
    return obj->PrettyTree();
  }
  default:
    assert(0);
...
hnode_t* condition_t::_AbbreviatedTree() {
  switch (this->tag_()) {
  case condition_e::Shell: {
    condition__Shell* obj = static_cast<condition__Shell*>(this);
    return obj->_AbbreviatedTree();
...
hnode_t* condition_t::AbbreviatedTree() {
  switch (this->tag_()) {
  case condition_e::Shell: {
    condition__Shell* obj = static_cast<condition__Shell*>(this);
    return obj->AbbreviatedTree();
...
hnode_t* case_arm::PrettyTree() {
  ...
  if (this->pat_list && len(this->pat_list)) {  // ArrayType
    ...
    L->append(new field(StrFromC("pat_list"), x0));
  }
  ...
  if (this->action && len(this->action)) {  // ArrayType
    ...
    L->append(new field(StrFromC("action"), x1));
  }
...
hnode_t* for_iter__Oil::PrettyTree() {
  ...
  L->append(new field(StrFromC("blame"), x1));
...
hnode_t* for_iter_t::PrettyTree() {
  ...
  case for_iter_e::Oil: {
    for_iter__Oil* obj = static_cast<for_iter__Oil*>(this);
    return obj->PrettyTree();
  }
  default:
    assert(0);
...
hnode_t* for_iter_t::_AbbreviatedTree() {
  switch (this->tag_()) {
  case for_iter_e::Args: {
    for_iter__Args* obj = static_cast<for_iter__Args*>(this);
    return obj->_AbbreviatedTree();
...
hnode_t* for_iter_t::AbbreviatedTree() {
  switch (this->tag_()) {
  case for_iter_e::Args: {
    for_iter__Args* obj = static_cast<for_iter__Args*>(this);
    return obj->AbbreviatedTree();
...
hnode_t* BraceGroup::PrettyTree() {
  ...
  if (this->doc_token) {  // MaybeType
    hnode_t* x0 = this->doc_token->PrettyTree();
    L->append(new field(StrFromC("doc_token"), x0));
  }
  ...
  if (this->children && len(this->children)) {  // ArrayType
    ...
    L->append(new field(StrFromC("children"), x1));
  }
  ...
  if (this->redirects && len(this->redirects)) {  // ArrayType
    ...
    L->append(new field(StrFromC("redirects"), x2));
  }
...
hnode_t* command__NoOp::PrettyTree() {
  ...
  if (this->spids && len(this->spids)) {  // ArrayType
    ...
    L->append(new field(StrFromC("spids"), x0));
  }
...
hnode_t* command__Simple::PrettyTree() {
  ...
  if (this->redirects && len(this->redirects)) {  // ArrayType
    ...
    L->append(new field(StrFromC("redirects"), x1));
  }
  ...
  if (this->more_env && len(this->more_env)) {  // ArrayType
    ...
    L->append(new field(StrFromC("more_env"), x2));
  }

  if (this->typed_args) {  // MaybeType
    hnode_t* x3 = this->typed_args->PrettyTree();
    L->append(new field(StrFromC("typed_args"), x3));
  }

  if (this->block) {  // MaybeType
    hnode_t* x4 = this->block->PrettyTree();
    L->append(new field(StrFromC("block"), x4));
  }

  hnode_t* x5 = new hnode__Leaf(this->do_fork ? runtime::TRUE_STR :
                                runtime::FALSE_STR, color_e::OtherConst);
  L->append(new field(StrFromC("do_fork"), x5));

  if (this->spids && len(this->spids)) {  // ArrayType
    hnode__Array* x6 = new hnode__Array(NewList<hnode_t*>());
    for (ListIter<int> it(this->spids); !it.Done(); it.Next()) {
      int i6 = it.Value();
      x6->children->append(new hnode__Leaf(str(i6), color_e::OtherConst));
    }
    L->append(new field(StrFromC("spids"), x6));
  }
...
hnode_t* command__Sentence::PrettyTree() {
  ...
  L->append(new field(StrFromC("terminator"), x1));
...
runtime::NewRecord(StrFromC("command.ShAssignment"));
  ...
  if (this->pairs && len(this->pairs)) {  // ArrayType
    ...
    L->append(new field(StrFromC("pairs"), x0));
  }
...
hnode_t* command__Pipeline::PrettyTree() {
  ...
  if (this->children && len(this->children)) {  // ArrayType
    ...
    L->append(new field(StrFromC("children"), x0));
  }

  hnode_t* x1 = new hnode__Leaf(this->negated ? runtime::TRUE_STR :
                                runtime::FALSE_STR, color_e::OtherConst);
  L->append(new field(StrFromC("negated"), x1));
  ...
  if (this->stderr_indices && len(this->stderr_indices)) {  // ArrayType
    ...
    L->append(new field(StrFromC("stderr_indices"), x2));
  }
...
hnode_t* command__AndOr::PrettyTree() {
  ...
  if (this->ops && len(this->ops)) {  // ArrayType
    ...
    for (ListIter<Id_t> it(this->ops); !it.Done(); it.Next()) {
      Id_t i0 = it.Value();
      x0->children->append(new hnode__Leaf(StrFromC(Id_str(i0)),
                           color_e::UserType));
    }
    L->append(new field(StrFromC("ops"), x0));
  }
...
hnode_t* command__ForEach::PrettyTree() {
  ...
  if (this->redirects && len(this->redirects)) {  // ArrayType
    ...
    L->append(new field(StrFromC("redirects"), x3));
  }
...
hnode_t* command__ForExpr::PrettyTree() {
  ...
  if (this->redirects && len(this->redirects)) {  // ArrayType
    ...
    L->append(new field(StrFromC("redirects"), x4));
  }

  if (this->spids && len(this->spids)) {  // ArrayType
    hnode__Array* x5 = new hnode__Array(NewList<hnode_t*>());
    for (ListIter<int> it(this->spids); !it.Done(); it.Next()) {
      int i5 = it.Value();
      x5->children->append(new hnode__Leaf(str(i5), color_e::OtherConst));
    }
    L->append(new field(StrFromC("spids"), x5));
  }
...
hnode_t* command__WhileUntil::PrettyTree() {
  ...
  L->append(new field(StrFromC("keyword"), x0));
...
hnode_t* command__If::PrettyTree() {
  ...
  if (this->arms && len(this->arms)) {  // ArrayType
    ...
    L->append(new field(StrFromC("arms"), x0));
  }
  ...
  if (this->else_action && len(this->else_action)) {  // ArrayType
    ...
    L->append(new field(StrFromC("else_action"), x1));
  }
...
hnode_t* command__Case::PrettyTree() {
  ...
  L->append(new field(StrFromC("to_match"), x0));
...
hnode_t* command__ShFunction::PrettyTree() {
  ...
  L->append(new field(StrFromC("body"), x1));
...
hnode_t* command__TimeBlock::PrettyTree() {
  ...
  L->append(new field(StrFromC("pipeline"), x0));
...
hnode_t* command__BareDecl::PrettyTree() {
  ...
  L->append(new field(StrFromC("rhs"), x1));
...
hnode_t* command__VarDecl::PrettyTree() {
  ...
  if (this->lhs && len(this->lhs)) {  // ArrayType
    ...
    L->append(new field(StrFromC("lhs"), x1));
  }
...
runtime::NewRecord(StrFromC("command.PlaceMutation"));
  ...
  L->append(new field(StrFromC("op"), x2));

  hnode_t* x3 = this->rhs->PrettyTree();
  L->append(new field(StrFromC("rhs"), x3));
...
hnode_t* command__Expr::PrettyTree() {
  ...
  L->append(new field(StrFromC("e"), x1));
...
hnode_t* command__Proc::PrettyTree() {
  ...
  L->append(new field(StrFromC("sig"), x1));
...
hnode_t* command__Func::PrettyTree() {
  ...
  if (this->pos_params && len(this->pos_params)) {  // ArrayType
    ...
    L->append(new field(StrFromC("pos_params"), x1));
  }

  if (this->pos_splat) {  // MaybeType
    hnode_t* x2 = this->pos_splat->PrettyTree();
    L->append(new field(StrFromC("pos_splat"), x2));
  }
  ...
  if (this->named_params && len(this->named_params)) {  // ArrayType
    ...
    L->append(new field(StrFromC("named_params"), x3));
  }

  if (this->named_splat) {  // MaybeType
    hnode_t* x4 = this->named_splat->PrettyTree();
    L->append(new field(StrFromC("named_splat"), x4));
  }
  ...
  if (this->return_types && len(this->return_types)) {  // ArrayType
    ...
    L->append(new field(StrFromC("return_types"), x5));
  }

  hnode_t* x6 = this->body->PrettyTree();
  L->append(new field(StrFromC("body"), x6));

  if (this->spids && len(this->spids)) {  // ArrayType
    hnode__Array* x7 = new hnode__Array(NewList<hnode_t*>());
    for (ListIter<int> it(this->spids); !it.Done(); it.Next()) {
      int i7 = it.Value();
      x7->children->append(new hnode__Leaf(str(i7), color_e::OtherConst));
    }
    L->append(new field(StrFromC("spids"), x7));
  }
...
hnode_t* command__Data::PrettyTree() {
  ...
  if (this->params && len(this->params)) {  // ArrayType
    ...
    L->append(new field(StrFromC("params"), x1));
  }
...
hnode_t* command__Enum::PrettyTree() {
  ...
  if (this->variants && len(this->variants)) {  // ArrayType
    hnode__Array* x1 = new hnode__Array(NewList<hnode_t*>());
    for (ListIter<variant*> it(this->variants); !it.Done(); it.Next()) {
      variant* i1 = it.Value();
      x1->children->append(i1->PrettyTree());
    }
    L->append(new field(StrFromC("variants"), x1));
  }
...
hnode_t* command__Class::PrettyTree() {
  ...
  if (this->extends) {  // MaybeType
    hnode_t* x1 = this->extends->PrettyTree();
    L->append(new field(StrFromC("extends"), x1));
  }
  ...
  if (this->items && len(this->items)) {  // ArrayType
    ...
    L->append(new field(StrFromC("items"), x2));
  }
...
hnode_t* command__Import::PrettyTree() {
  ...
  if (this->alias) {  // MaybeType
    hnode_t* x1 = this->alias->PrettyTree();
    L->append(new field(StrFromC("alias"), x1));
  }

  if (this->names && len(this->names)) {  // ArrayType
    hnode__Array* x2 = new hnode__Array(NewList<hnode_t*>());
    for (ListIter<import_name*> it(this->names); !it.Done(); it.Next()) {
      import_name* i2 = it.Value();
      x2->children->append(i2->PrettyTree());
    }
    L->append(new field(StrFromC("names"), x2));
  }
...
hnode_t* command__For::PrettyTree() {
  ...
  if (this->targets && len(this->targets)) {  // ArrayType
    hnode__Array* x0 = new hnode__Array(NewList<hnode_t*>());
    for (ListIter<name_type*> it(this->targets); !it.Done(); it.Next()) {
      name_type* i0 = it.Value();
      x0->children->append(i0->PrettyTree());
    }
    L->append(new field(StrFromC("targets"), x0));
  }
...
hnode_t* command__While::PrettyTree() {
  ...
  L->append(new field(StrFromC("test"), x0));
...
hnode_t* command__Return::PrettyTree() {
  ...
  if (this->value) {  // MaybeType
    hnode_t* x0 = this->value->PrettyTree();
    L->append(new field(StrFromC("value"), x0));
  }
...
hnode_t* variant_type__Anon::PrettyTree() {
  ...
  if (this->params && len(this->params)) {  // ArrayType
    ...
    L->append(new field(StrFromC("params"), x0));
  }
...
hnode_t* variant_type__Ref::PrettyTree() {
  ...
  L->append(new field(StrFromC("type_name"), x0));
...
hnode_t* variant_type_t::_AbbreviatedTree() {
  switch (this->tag_()) {
  case variant_type_e::Anon: {
    variant_type__Anon* obj = static_cast<variant_type__Anon*>(this);
    return obj->_AbbreviatedTree();
...
hnode_t* variant_type_t::AbbreviatedTree() {
  switch (this->tag_()) {
  case variant_type_e::Anon: {
    variant_type__Anon* obj = static_cast<variant_type__Anon*>(this);
    return obj->AbbreviatedTree();
...
hnode_t* variant::PrettyTree() {
  ...
  L->append(new field(StrFromC("tag_name"), x0));

  if (this->typ) {  // MaybeType
    hnode_t* x1 = this->typ->PrettyTree();
    L->append(new field(StrFromC("typ"), x1));
  }
...
hnode_t* class_item__Data::PrettyTree() {
  ...
  if (this->fields && len(this->fields)) {  // ArrayType
    hnode__Array* x1 = new hnode__Array(NewList<hnode_t*>());
    for (ListIter<name_type*> it(this->fields); !it.Done(); it.Next()) {
      name_type* i1 = it.Value();
      x1->children->append(i1->PrettyTree());
    }
    L->append(new field(StrFromC("fields"), x1));
  }
...
hnode_t* class_item_t::_AbbreviatedTree() {
  switch (this->tag_()) {
  case class_item_e::Data: {
    class_item__Data* obj = static_cast<class_item__Data*>(this);
    return obj->_AbbreviatedTree();
...
hnode_t* class_item_t::AbbreviatedTree() {
  switch (this->tag_()) {
  case class_item_e::Data: {
    class_item__Data* obj = static_cast<class_item__Data*>(this);
    return obj->AbbreviatedTree();
...
hnode_t* UntypedParam::PrettyTree() {
  ...
  if (this->ref) {  // MaybeType
    hnode_t* x0 = this->ref->PrettyTree();
    L->append(new field(StrFromC("ref"), x0));
  }

  hnode_t* x1 = this->name->PrettyTree();
  L->append(new field(StrFromC("name"), x1));

  if (this->default_val) {  // MaybeType
    hnode_t* x2 = this->default_val->PrettyTree();
    L->append(new field(StrFromC("default_val"), x2));
  }
...
hnode_t* TypedParam::PrettyTree() {
  ...
  L->append(new field(StrFromC("type"), x1));
...
hnode_t* param::PrettyTree() {
  ...
  if (this->prefix) {  // MaybeType
    hnode_t* x0 = this->prefix->PrettyTree();
    L->append(new field(StrFromC("prefix"), x0));
  }
  ...
  if (this->type) {  // MaybeType
    ...
    L->append(new field(StrFromC("type"), x2));
  }

  if (this->default_val) {  // MaybeType
    hnode_t* x3 = this->default_val->PrettyTree();
    L->append(new field(StrFromC("default_val"), x3));
  }
...
hnode_t* glob_part__CharClass::PrettyTree() {
  ...
  hnode_t* x0 = new hnode__Leaf(this->negated ? runtime::TRUE_STR :
                                runtime::FALSE_STR, color_e::OtherConst);
  L->append(new field(StrFromC("negated"), x0));
  ...
  if (this->strs && len(this->strs)) {  // ArrayType
    ...
    L->append(new field(StrFromC("strs"), x1));
  }
...
hnode_t* comprehension::PrettyTree() {
  ...
  L->append(new field(StrFromC("iter"), x1));

  if (this->cond) {  // MaybeType
    hnode_t* x2 = this->cond->PrettyTree();
    L->append(new field(StrFromC("cond"), x2));
  }
...
hnode_t* named_arg::PrettyTree() {
  ...
  L->append(new field(StrFromC("value"), x1));
...
hnode_t* subscript::PrettyTree() {
  ...
  L->append(new field(StrFromC("obj"), x0));
  ...
  if (this->indices && len(this->indices)) {  // ArrayType
    ...
    L->append(new field(StrFromC("indices"), x1));
  }
...
hnode_t* attribute::PrettyTree() {
  ...
  L->append(new field(StrFromC("attr"), x2));

  hnode_t* x3 = new hnode__Leaf(StrFromC(expr_context_str(this->ctx)),
                                color_e::TypeName);
  L->append(new field(StrFromC("ctx"), x3));
...
hnode_t* expr__Const::PrettyTree() {
  ...
  L->append(new field(StrFromC("c"), x0));
...
hnode_t* expr__RegexLiteral::PrettyTree() {
  ...
  L->append(new field(StrFromC("regex"), x1));
  ...
  if (this->flags && len(this->flags)) {  // ArrayType
    ...
    L->append(new field(StrFromC("flags"), x2));
  }

  if (this->trans_pref) {  // MaybeType
    hnode_t* x3 = this->trans_pref->PrettyTree();
    L->append(new field(StrFromC("trans_pref"), x3));
  }
...
hnode_t* expr__BlockArg::PrettyTree() {
  hnode__Record* out_node = runtime::NewRecord(StrFromC("expr.BlockArg"));
  List<field*>* L = out_node->fields;

  hnode_t* x0 = this->block->PrettyTree();
  L->append(new field(StrFromC("block"), x0));
...
hnode_t* expr__Compare::PrettyTree() {
  ...
  if (this->ops && len(this->ops)) {  // ArrayType
    ...
    L->append(new field(StrFromC("ops"), x1));
  }
  ...
  if (this->comparators && len(this->comparators)) {  // ArrayType
    ...
    L->append(new field(StrFromC("comparators"), x2));
  }
...
hnode_t* expr__FuncCall::PrettyTree() {
  ...
  L->append(new field(StrFromC("func"), x0));
...
hnode_t* expr__IfExp::PrettyTree() {
  ...
  L->append(new field(StrFromC("orelse"), x2));
...
hnode_t* expr__Tuple::PrettyTree() {
  ...
  if (this->elts && len(this->elts)) {  // ArrayType
    ...
    L->append(new field(StrFromC("elts"), x0));
  }

  hnode_t* x1 = new hnode__Leaf(StrFromC(expr_context_str(this->ctx)),
                                color_e::TypeName);
  L->append(new field(StrFromC("ctx"), x1));
...
hnode_t* expr__Dict::PrettyTree() {
  ...
  if (this->keys && len(this->keys)) {  // ArrayType
    ...
    L->append(new field(StrFromC("keys"), x0));
  }
  ...
  if (this->values && len(this->values)) {  // ArrayType
    ...
    L->append(new field(StrFromC("values"), x1));
  }
...
hnode_t* expr__ListComp::PrettyTree() {
  ...
  L->append(new field(StrFromC("elt"), x0));
  ...
  if (this->generators && len(this->generators)) {  // ArrayType
    ...
    L->append(new field(StrFromC("generators"), x1));
  }
...
hnode_t* expr__DictComp::PrettyTree() {
  ...
  L->append(new field(StrFromC("key"), x0));
  ...
  if (this->generators && len(this->generators)) {  // ArrayType
    ...
    L->append(new field(StrFromC("generators"), x2));
  }
...
hnode_t* expr__Range::PrettyTree() {
  ...
  L->append(new field(StrFromC("lower"), x0));

  hnode_t* x1 = this->upper->PrettyTree();
  L->append(new field(StrFromC("upper"), x1));
...
hnode_t* expr_t::PrettyTree() {
  ...
  case expr_e::BlockArg: {
    expr__BlockArg* obj = static_cast<expr__BlockArg*>(this);
    return obj->PrettyTree();
  }
  case expr_e::Lambda: {
...
runtime::NewRecord(StrFromC("class_literal_term.Range"));
  ...
  L->append(new field(StrFromC("start"), x0));

  hnode_t* x1 = this->end->PrettyTree();
  L->append(new field(StrFromC("end"), x1));
...
hnode_t* CharCode::PrettyTree() {
  ...
  L->append(new field(StrFromC("i"), x0));

  hnode_t* x1 = new hnode__Leaf(this->u_braced ? runtime::TRUE_STR :
                                runtime::FALSE_STR, color_e::OtherConst);
  L->append(new field(StrFromC("u_braced"), x1));

  hnode_t* x2 = new hnode__Leaf(str(this->spid), color_e::OtherConst);
  L->append(new field(StrFromC("spid"), x2));
...
hnode_t* char_class_term_t::_AbbreviatedTree() {
  switch (this->tag_()) {
  case char_class_term_e::PosixClass: {
    posix_class* obj = static_cast<posix_class*>(this);
    return obj->_AbbreviatedTree();
...
hnode_t* char_class_term_t::AbbreviatedTree() {
  switch (this->tag_()) {
  case char_class_term_e::PosixClass: {
    posix_class* obj = static_cast<posix_class*>(this);
    return obj->AbbreviatedTree();
...
hnode_t* re_repeat__Num::PrettyTree() {
  ...
  L->append(new field(StrFromC("times"), x0));
...
hnode_t* re__CharClassLiteral::PrettyTree() {
  ...
  if (this->terms && len(this->terms)) {  // ArrayType
    ...
    L->append(new field(StrFromC("terms"), x1));
  }
...
hnode_t* re__Capture::PrettyTree() {
  ...
  if (this->var_name) {  // MaybeType
    ...
    L->append(new field(StrFromC("var_name"), x1));
  }
...
hnode_t* re__Backtracking::PrettyTree() {
  ...
  L->append(new field(StrFromC("child"), x2));

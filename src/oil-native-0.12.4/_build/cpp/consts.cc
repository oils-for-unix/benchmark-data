...
List<int>* STRICT_ALL = NewList<int>({27, 28, 29, 30, 31, 35, 32, 34, 33});
List<int>* OIL_UPGRADE = NewList<int>({46, 44, 1, 45, 4, 2, 5, 36, 38, 39, 40, 37, 41, 42, 3, 47, 51, 50, 43, 6, 49, 48});
List<int>* OIL_ALL = NewList<int>({46, 44, 1, 45, 4, 2, 5, 36, 52, 53, 54, 59, 38, 55, 58, 39, 56, 40, 37, 41, 57, 60, 42, 3, 47, 51, 50, 61, 62, 63, 43, 27, 28, 29, 30, 31, 35, 32, 34, 33, 6, 49, 48});
List<int>* DEFAULT_TRUE = NewList<int>({22, 44, 23, 45, 16, 53, 54, 59, 55, 58, 56, 57, 60, 51, 49});
List<int>* PARSE_OPTION_NUMS = NewList<int>({45, 36, 52, 53, 54, 59, 38, 55, 58, 20, 39, 56, 40, 37, 41, 57, 60, 64, 42});
List<int>* SHOPT_OPTION_NUMS = NewList<int>({26, 25, 22, 70, 71, 72, 73, 74, 75, 76, 69, 46, 21, 77, 44, 78, 79, 80, 23, 19, 81, 45, 82, 18, 83, 17, 84, 85, 86, 87, 67, 88, 89, 68, 90, 4, 91, 65, 92, 93, 94, 95, 96, 97, 98, 99, 5, 36, 52, 53, 54, 59, 38, 55, 58, 20, 39, 56, 40, 37, 41, 57, 60, 64, 42, 47, 66, 100, 101, 24, 51, 102, 103, 50, 61, 62, 63, 43, 104, 27, 28, 29, 30, 31, 35, 32, 34, 33, 6, 105, 49, 48});
List<int>* SET_OPTION_NUMS = NewList<int>({14, 1, 16, 11, 7, 10, 2, 3, 12, 9, 13, 8});
List<int>* VISIBLE_SHOPT_NUMS = NewList<int>({26, 25, 22, 46, 21, 44, 23, 19, 45, 18, 17, 4, 5, 36, 52, 53, 54, 59, 38, 55, 58, 20, 39, 56, 40, 37, 41, 57, 60, 64, 42, 47, 24, 51, 50, 61, 62, 63, 43, 27, 28, 29, 30, 31, 35, 32, 34, 33, 6, 49, 48});

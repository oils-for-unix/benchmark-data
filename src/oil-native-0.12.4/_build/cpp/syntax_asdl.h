...
class source__Reparsed : public source_t {
 public:
  source__Reparsed() : type_tag_(static_cast<uint16_t>(source_e::Reparsed)),
                   what(StrFromC("")), left_spid(-1), right_spid(-1) {
  }
...
class suffix_op__PatSub : public suffix_op_t {
 public:
  suffix_op__PatSub() : type_tag_(static_cast<uint16_t>(suffix_op_e::PatSub)),
                    pat(nullptr), replace(nullptr), replace_mode(-1),
                    spids(NewList<int>()) {
  }
...
class word_part__AssocArrayLiteral : public word_part_t {
 public:
  word_part__AssocArrayLiteral() :
                               type_tag_(static_cast<uint16_t>(word_part_e::AssocArrayLiteral)), left(nullptr), pairs(NewList<compound_word*>()), spids(NewList<int>()) {
  }
  word_part__AssocArrayLiteral(Token* left, List<compound_word*>* pairs) :
                               type_tag_(static_cast<uint16_t>(word_part_e::AssocArrayLiteral)), left(left), pairs(pairs), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Token* left;
...
class word_part__EscapedLiteral : public word_part_t {
 public:
  word_part__EscapedLiteral() :
                            type_tag_(static_cast<uint16_t>(word_part_e::EscapedLiteral)), token(nullptr), spids(NewList<int>()) {
  }
  word_part__EscapedLiteral(Token* token) :
                            type_tag_(static_cast<uint16_t>(word_part_e::EscapedLiteral)), token(token), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Token* token;
  List<int>* spids;
...
class word_part__TildeSub : public word_part_t {
 public:
  word_part__TildeSub() :
                      ...
                      token(nullptr), spids(NewList<int>()) {
  }
  word_part__TildeSub(Token* token) :
                      type_tag_(static_cast<uint16_t>(word_part_e::TildeSub)),
                      token(token), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Token* token;
  List<int>* spids;
...
class word_part__ArithSub : public word_part_t {
 public:
  word_part__ArithSub() :
                      ...
                      anode(nullptr), spids(NewList<int>()) {
  }
  word_part__ArithSub(arith_expr_t* anode) :
                      type_tag_(static_cast<uint16_t>(word_part_e::ArithSub)),
                      anode(anode), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  arith_expr_t* anode;
  List<int>* spids;
...
class word_part__BracedTuple : public word_part_t {
 public:
  word_part__BracedTuple() :
                         type_tag_(static_cast<uint16_t>(word_part_e::BracedTuple)), words(NewList<compound_word*>()), spids(NewList<int>()) {
  }
  word_part__BracedTuple(List<compound_word*>* words) :
                         type_tag_(static_cast<uint16_t>(word_part_e::BracedTuple)), words(words), spids(NewList<int>()) {
  }
  OBJ_HEADER();
...
class word_part__BracedRange : public word_part_t {
 public:
  word_part__BracedRange() :
                         type_tag_(static_cast<uint16_t>(word_part_e::BracedRange)), kind(-1), start(StrFromC("")), end(StrFromC("")), step(-1), spids(NewList<int>()) {
  }
  word_part__BracedRange(Id_t kind, Str* start, Str* end, int step) :
                         type_tag_(static_cast<uint16_t>(word_part_e::BracedRange)), kind(kind), start(start), end(end), step(step), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Id_t kind;
  Str* start;
...
class word_part__ExtGlob : public word_part_t {
 public:
  word_part__ExtGlob() :
                     ...
                     op(nullptr), arms(NewList<compound_word*>()),
                     spids(NewList<int>()) {
  }
  word_part__ExtGlob(Token* op, List<compound_word*>* arms) :
                     type_tag_(static_cast<uint16_t>(word_part_e::ExtGlob)),
                     op(op), arms(arms), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Token* op;
...
class word_part__Splice : public word_part_t {
 public:
  word_part__Splice() : type_tag_(static_cast<uint16_t>(word_part_e::Splice)),
                    name(nullptr), spids(NewList<int>()) {
  }
...
class word_part__FuncCall : public word_part_t {
 public:
  word_part__FuncCall() :
                      ...
                      name(nullptr), args(nullptr), spids(NewList<int>()) {
  }
  word_part__FuncCall(Token* name, ArgList* args) :
                      type_tag_(static_cast<uint16_t>(word_part_e::FuncCall)),
                      name(name), args(args), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Token* name;
  ArgList* args;
...
class word_part__ExprSub : public word_part_t {
 public:
  word_part__ExprSub() :
                     ...
                     left(nullptr), child(nullptr), spids(NewList<int>()) {
  }
  word_part__ExprSub(Token* left, expr_t* child) :
                     type_tag_(static_cast<uint16_t>(word_part_e::ExprSub)),
                     left(left), child(child), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Token* left;
  expr_t* child;
...
class sh_lhs_expr__IndexedName : public sh_lhs_expr_t {
 public:
  sh_lhs_expr__IndexedName() :
                           type_tag_(static_cast<uint16_t>(sh_lhs_expr_e::IndexedName)), name(StrFromC("")), index(nullptr), spids(NewList<int>()) {
  }
  sh_lhs_expr__IndexedName(Str* name, arith_expr_t* index) :
                           type_tag_(static_cast<uint16_t>(sh_lhs_expr_e::IndexedName)), name(name), index(index), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Str* name;
  arith_expr_t* index;
...
class sh_lhs_expr__UnparsedIndex : public sh_lhs_expr_t {
 public:
  sh_lhs_expr__UnparsedIndex() :
                             type_tag_(static_cast<uint16_t>(sh_lhs_expr_e::UnparsedIndex)), name(StrFromC("")), index(StrFromC("")), spids(NewList<int>()) {
  }
  sh_lhs_expr__UnparsedIndex(Str* name, Str* index) :
                             type_tag_(static_cast<uint16_t>(sh_lhs_expr_e::UnparsedIndex)), name(name), index(index), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Str* name;
  Str* index;
...
class redir_param__HereDoc : public redir_param_t {
 public:
  redir_param__HereDoc() :
                       type_tag_(static_cast<uint16_t>(redir_param_e::HereDoc)), here_begin(nullptr), here_end_span_id(-1), stdin_parts(NewList<word_part_t*>()) {
  }
...
class command__Simple : public command_t {
 public:
  command__Simple() : type_tag_(static_cast<uint16_t>(command_e::Simple)),
                  words(NewList<word_t*>()), redirects(NewList<redir*>()),
                  more_env(NewList<env_pair*>()), typed_args(nullptr),
                  block(nullptr), do_fork(false), spids(NewList<int>()) {
  }
...
class command__ExpandedAlias : public command_t {
 public:
  command__ExpandedAlias() :
                         type_tag_(static_cast<uint16_t>(command_e::ExpandedAlias)), child(nullptr), redirects(NewList<redir*>()), more_env(NewList<env_pair*>()), spids(NewList<int>()) {
  }
  command__ExpandedAlias(command_t* child, List<redir*>* redirects,
                         List<env_pair*>* more_env) :
                         type_tag_(static_cast<uint16_t>(command_e::ExpandedAlias)), child(child), redirects(redirects), more_env(more_env), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  command_t* child;
  List<redir*>* redirects;
...
class command__Sentence : public command_t {
 public:
  command__Sentence() : type_tag_(static_cast<uint16_t>(command_e::Sentence)),
                    child(nullptr), terminator(nullptr), spids(NewList<int>()) {
  }
  command__Sentence(command_t* child, Token* terminator) :
                    type_tag_(static_cast<uint16_t>(command_e::Sentence)),
                    child(child), terminator(terminator), spids(NewList<int>())
                    {
  }
  OBJ_HEADER();
  command_t* child;
...
class command__ShAssignment : public command_t {
 public:
  command__ShAssignment() :
                        type_tag_(static_cast<uint16_t>(command_e::ShAssignment)), pairs(NewList<assign_pair*>()), redirects(NewList<redir*>()), spids(NewList<int>()) {
  }
  command__ShAssignment(List<assign_pair*>* pairs, List<redir*>* redirects) :
                        type_tag_(static_cast<uint16_t>(command_e::ShAssignment)), pairs(pairs), redirects(redirects), spids(NewList<int>()) {
  }
  OBJ_HEADER();
...
class command__ControlFlow : public command_t {
 public:
  command__ControlFlow() :
                       type_tag_(static_cast<uint16_t>(command_e::ControlFlow)), token(nullptr), arg_word(nullptr), spids(NewList<int>()) {
  }
  command__ControlFlow(Token* token, word_t* arg_word) :
                       type_tag_(static_cast<uint16_t>(command_e::ControlFlow)), token(token), arg_word(arg_word), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Token* token;
  word_t* arg_word;
...
class command__Pipeline : public command_t {
 public:
  command__Pipeline() : type_tag_(static_cast<uint16_t>(command_e::Pipeline)),
                    children(NewList<command_t*>()), negated(false),
                    stderr_indices(NewList<int>()), spids(NewList<int>()) {
  }
  command__Pipeline(List<command_t*>* children, bool negated, List<int>*
                    ...
                    stderr_indices(stderr_indices), spids(NewList<int>()) {
  }
  OBJ_HEADER();
...
class command__DoGroup : public command_t {
 public:
  command__DoGroup() : type_tag_(static_cast<uint16_t>(command_e::DoGroup)),
                   children(NewList<command_t*>()), spids(NewList<int>()) {
  }
...
class command__ForEach : public command_t {
 public:
  command__ForEach() : type_tag_(static_cast<uint16_t>(command_e::ForEach)),
                   iter_names(NewList<Str*>()), iterable(nullptr),
                   body(nullptr), redirects(NewList<redir*>()),
                   spids(NewList<int>()) {
  }
  command__ForEach(List<Str*>* iter_names, for_iter_t* iterable, command_t*
                   ...
                   redirects(redirects), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  List<Str*>* iter_names;
  for_iter_t* iterable;
...
class command__WhileUntil : public command_t {
 public:
  command__WhileUntil() :
                      ...
                      redirects(NewList<redir*>()), spids(NewList<int>()) {
  }
...
class command__If : public command_t {
 public:
  command__If() : type_tag_(static_cast<uint16_t>(command_e::If)),
              arms(NewList<if_arm*>()), else_action(NewList<command_t*>()),
              redirects(NewList<redir*>()), spids(NewList<int>()) {
  }
...
class command__ShFunction : public command_t {
 public:
  command__ShFunction() :
                      ...
                      name(StrFromC("")), body(nullptr), spids(NewList<int>()) {
  }
  command__ShFunction(Str* name, command_t* body) :
                      type_tag_(static_cast<uint16_t>(command_e::ShFunction)),
                      name(name), body(body), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Str* name;
  command_t* body;
...
class command__TimeBlock : public command_t {
 public:
  command__TimeBlock() :
                     ...
                     pipeline(nullptr), spids(NewList<int>()) {
  }
  command__TimeBlock(command_t* pipeline) :
                     type_tag_(static_cast<uint16_t>(command_e::TimeBlock)),
                     pipeline(pipeline), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  command_t* pipeline;
  List<int>* spids;
...
class command__CommandList : public command_t {
 public:
  command__CommandList() :
                       type_tag_(static_cast<uint16_t>(command_e::CommandList)), children(NewList<command_t*>()), spids(NewList<int>()) {
  }
  command__CommandList(List<command_t*>* children) :
                       type_tag_(static_cast<uint16_t>(command_e::CommandList)), children(children), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  List<command_t*>* children;
  List<int>* spids;
...
class command__PlaceMutation : public command_t {
 public:
  command__PlaceMutation() :
                         type_tag_(static_cast<uint16_t>(command_e::PlaceMutation)), keyword(nullptr), lhs(NewList<place_expr_t*>()), op(nullptr), rhs(nullptr), spids(NewList<int>()) {
  }
  command__PlaceMutation(Token* keyword, List<place_expr_t*>* lhs, Token* op,
                         expr_t* rhs) :
                         type_tag_(static_cast<uint16_t>(command_e::PlaceMutation)), keyword(keyword), lhs(lhs), op(op), rhs(rhs), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Token* keyword;
...
class command__Func : public command_t {
 public:
  command__Func() : type_tag_(static_cast<uint16_t>(command_e::Func)),
                name(nullptr), pos_params(NewList<param*>()),
                pos_splat(nullptr), named_params(NewList<param*>()),
                named_splat(nullptr), return_types(NewList<type_expr_t*>()),
                body(nullptr), spids(NewList<int>()) {
  }
  command__Func(Token* name, List<param*>* pos_params, Token* pos_splat,
                ...
                return_types(return_types), body(body), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Token* name;
...
class command__Class : public command_t {
 public:
  command__Class() : type_tag_(static_cast<uint16_t>(command_e::Class)),
                 name(nullptr), extends(nullptr),
                 items(NewList<class_item_t*>()), spids(NewList<int>()) {
  }
  command__Class(Token* name, Token* extends, List<class_item_t*>* items) :
                 type_tag_(static_cast<uint16_t>(command_e::Class)),
                 name(name), extends(extends), items(items),
                 spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Token* name;
...
class command__Import : public command_t {
 public:
  command__Import() : type_tag_(static_cast<uint16_t>(command_e::Import)),
                  path(nullptr), alias(nullptr),
                  names(NewList<import_name*>()), spids(NewList<int>()) {
  }
  command__Import(single_quoted* path, Token* alias, List<import_name*>* names)
                  : type_tag_(static_cast<uint16_t>(command_e::Import)),
                  path(path), alias(alias), names(names), spids(NewList<int>())
                  {
  }
  OBJ_HEADER();
  single_quoted* path;
...
class class_item__Data : public class_item_t {
 public:
  class_item__Data() : type_tag_(static_cast<uint16_t>(class_item_e::Data)),
                   keyword(nullptr), fields(NewList<name_type*>()) {
  }
...
class proc_sig__Closed : public proc_sig_t {
 public:
  proc_sig__Closed() : type_tag_(static_cast<uint16_t>(proc_sig_e::Closed)),
                   untyped(NewList<UntypedParam*>()), rest(nullptr),
...
class glob_part__CharClass : public glob_part_t {
 public:
  glob_part__CharClass() :
                       type_tag_(static_cast<uint16_t>(glob_part_e::CharClass)), negated(false), strs(NewList<Str*>()) {
  }
...
class printf_part__Percent : public printf_part_t {
 public:
  printf_part__Percent() :
                       type_tag_(static_cast<uint16_t>(printf_part_e::Percent)), flags(NewList<Token*>()), width(nullptr), precision(nullptr), type(nullptr) {
  }
...
class type_expr__Compound : public type_expr_t {
 public:
  type_expr__Compound() :
                      ...
                      name(nullptr), params(NewList<type_expr_t*>()) {
  }
...
class expr__RegexLiteral : public expr_t {
 public:
  expr__RegexLiteral() :
                     ...
                     left(nullptr), regex(nullptr), flags(NewList<Token*>()),
                     trans_pref(nullptr), spids(NewList<int>()) {
  }
  expr__RegexLiteral(Token* left, re_t* regex, List<Token*>* flags, Token*
                     trans_pref) :
                     type_tag_(static_cast<uint16_t>(expr_e::RegexLiteral)),
                     left(left), regex(regex), flags(flags),
                     trans_pref(trans_pref), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Token* left;
  re_t* regex;
...
class expr__Lambda : public expr_t {
 public:
  expr__Lambda() : type_tag_(static_cast<uint16_t>(expr_e::Lambda)),
               params(NewList<name_type*>()), body(nullptr),
               spids(NewList<int>()) {
  }
  expr__Lambda(List<name_type*>* params, expr_t* body) :
               type_tag_(static_cast<uint16_t>(expr_e::Lambda)),
               params(params), body(body), spids(NewList<int>()) {
  }
  OBJ_HEADER();
...
class expr__Compare : public expr_t {
 public:
  expr__Compare() : type_tag_(static_cast<uint16_t>(expr_e::Compare)),
                left(nullptr), ops(NewList<speck*>()),
                comparators(NewList<expr_t*>()), spids(NewList<int>()) {
  }
  expr__Compare(expr_t* left, List<speck*>* ops, List<expr_t*>* comparators) :
                type_tag_(static_cast<uint16_t>(expr_e::Compare)), left(left),
                ops(ops), comparators(comparators), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  expr_t* left;
  List<speck*>* ops;
...
class expr__Tuple : public expr_t {
 public:
  expr__Tuple() : type_tag_(static_cast<uint16_t>(expr_e::Tuple)),
              elts(NewList<expr_t*>()), ctx(expr_context_e::Load),
              spids(NewList<int>()) {
  }
  expr__Tuple(List<expr_t*>* elts, expr_context_t ctx) :
              type_tag_(static_cast<uint16_t>(expr_e::Tuple)), elts(elts),
              ctx(ctx), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  List<expr_t*>* elts;
  expr_context_t ctx;
...
class expr__List : public expr_t {
 public:
  expr__List() : type_tag_(static_cast<uint16_t>(expr_e::List)),
             elts(NewList<expr_t*>()), ctx(expr_context_e::Load),
             spids(NewList<int>()) {
  }
...
class expr__Dict : public expr_t {
 public:
  expr__Dict() : type_tag_(static_cast<uint16_t>(expr_e::Dict)),
             keys(NewList<expr_t*>()), values(NewList<expr_t*>()),
             spids(NewList<int>()) {
  }
  expr__Dict(List<expr_t*>* keys, List<expr_t*>* values) :
             type_tag_(static_cast<uint16_t>(expr_e::Dict)), keys(keys),
             values(values), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  List<expr_t*>* keys;
  List<expr_t*>* values;
...
class expr__DictComp : public expr_t {
 public:
  expr__DictComp() : type_tag_(static_cast<uint16_t>(expr_e::DictComp)),
                 ...
                 generators(NewList<comprehension*>()), spids(NewList<int>()) {
  }
...
class expr__GeneratorExp : public expr_t {
 public:
  ...
  expr__GeneratorExp(expr_t* elt, List<comprehension*>* generators) :
                     type_tag_(static_cast<uint16_t>(expr_e::GeneratorExp)),
                     elt(elt), generators(generators), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  expr_t* elt;
  List<comprehension*>* generators;
...
class expr__Spread : public expr_t {
 public:
  expr__Spread() : type_tag_(static_cast<uint16_t>(expr_e::Spread)),
               child(nullptr), ctx(expr_context_e::Load), spids(NewList<int>())
               {
  }
...
class class_literal_term__Range : public class_literal_term_t {
 public:
  class_literal_term__Range() :
                            type_tag_(static_cast<uint16_t>(class_literal_term_e::Range)), start(nullptr), end(nullptr) {
  }
...
class char_class_term__Range : public char_class_term_t {
 public:
  char_class_term__Range() :
                         type_tag_(static_cast<uint16_t>(char_class_term_e::Range)), start(nullptr), end(nullptr) {
  }
  char_class_term__Range(CharCode* start, CharCode* end) :
                         type_tag_(static_cast<uint16_t>(char_class_term_e::Range)), start(start), end(end) {
  }
  OBJ_HEADER();
  CharCode* start;
  CharCode* end;
...
class re__CharClassLiteral : public re_t {
 public:
  re__CharClassLiteral() :
                       type_tag_(static_cast<uint16_t>(re_e::CharClassLiteral)), negated(false), terms(NewList<class_literal_term_t*>()) {
  }
  re__CharClassLiteral(bool negated, List<class_literal_term_t*>* terms) :
                       type_tag_(static_cast<uint16_t>(re_e::CharClassLiteral)), negated(negated), terms(terms) {
  }
  OBJ_HEADER();
  bool negated;
...
class re__CharClass : public re_t {
 public:
  re__CharClass() : type_tag_(static_cast<uint16_t>(re_e::CharClass)),
                negated(false), terms(NewList<char_class_term_t*>()) {
  }
...
class re__Seq : public re_t {
 public:
  re__Seq() : type_tag_(static_cast<uint16_t>(re_e::Seq)),
...
class re__Alt : public re_t {
 public:
  re__Alt() : type_tag_(static_cast<uint16_t>(re_e::Alt)),
          children(NewList<re_t*>()) {
  }
...
arith_expr_t, public re_t {
 public:
  Token() : type_tag_(201), id(-1), span_id(-1), val(StrFromC("")) {
  }
...
class_literal_term_t, public re_t {
 public:
  double_quoted() : type_tag_(203), left(nullptr),
                parts(NewList<word_part_t*>()), multiline(false),
                spids(NewList<int>()) {
  }
...
class_literal_term_t, public re_t {
 public:
  single_quoted() : type_tag_(204), left(nullptr), tokens(NewList<Token*>()),
                multiline(false), spids(NewList<int>()) {
  }
  single_quoted(Token* left, List<Token*>* tokens, bool multiline) :
                type_tag_(204), left(left), tokens(tokens),
                multiline(multiline), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Token* left;
  List<Token*>* tokens;
...
class_literal_term_t, public re_t {
 public:
  braced_var_sub() : type_tag_(206), token(nullptr), prefix_op(nullptr),
                 bracket_op(nullptr), suffix_op(nullptr), spids(NewList<int>())
                 {
  }
  braced_var_sub(Token* token, speck* prefix_op, bracket_op_t* bracket_op,
                 ...
                 suffix_op(suffix_op), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Token* token;
  speck* prefix_op;
...
class command_sub : public word_part_t, public expr_t {
 public:
  ...
  command_sub(Token* left_token, command_t* child) : type_tag_(207),
              left_token(left_token), child(child), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Token* left_token;
  command_t* child;
...
class sh_array_literal : public word_part_t, public expr_t {
 public:
  sh_array_literal() : type_tag_(208), left(nullptr),
                   words(NewList<word_t*>()), spids(NewList<int>()) {
  }
  sh_array_literal(Token* left, List<word_t*>* words) : type_tag_(208),
                   left(left), words(words), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Token* left;
  List<word_t*>* words;
...
class ArgList {
 public:
  ArgList() : type_tag_(209), positional(NewList<expr_t*>()),
          named(NewList<named_arg*>()), spids(NewList<int>()) {
  }
  ArgList(List<expr_t*>* positional, List<named_arg*>* named) : type_tag_(209),
          positional(positional), named(named), spids(NewList<int>()) {
  }
  OBJ_HEADER();
...
class compound_word : public word_t, public arith_expr_t, public redir_param_t {
 public:
  compound_word() : type_tag_(210), parts(NewList<word_part_t*>()) {
  }
...
class string_line {
 public:
  string_line() : type_tag_(211), dedent(-1), part(NewList<word_part_t*>()) {
  }
...
class triple_quoted {
 public:
  triple_quoted() : type_tag_(212), min_dedent(-1),
...
class env_pair {
 public:
  env_pair() : type_tag_(215), name(StrFromC("")), val(nullptr),
           spids(NewList<int>()) {
  }
...
class case_arm {
 public:
  case_arm() : type_tag_(216), pat_list(NewList<word_t*>()),
           action(NewList<command_t*>()), spids(NewList<int>()) {
  }
...
class if_arm {
 public:
  if_arm() : type_tag_(217), cond(nullptr), action(NewList<command_t*>()),
         spids(NewList<int>()) {
  }
...
class BraceGroup : public command_t {
 public:
  BraceGroup() : type_tag_(218), doc_token(nullptr),
             children(NewList<command_t*>()), redirects(NewList<redir*>()),
             spids(NewList<int>()) {
  }
  BraceGroup(Token* doc_token, List<command_t*>* children, List<redir*>*
             redirects) : type_tag_(218), doc_token(doc_token),
             children(children), redirects(redirects), spids(NewList<int>()) {
  }
  OBJ_HEADER();
  Token* doc_token;
  List<command_t*>* children;
...
class comprehension {
 public:
  comprehension() : type_tag_(225), lhs(NewList<name_type*>()), iter(nullptr),
                cond(nullptr) {
  }
...
class subscript : public place_expr_t, public expr_t {
 public:
  subscript() : type_tag_(227), obj(nullptr), indices(NewList<expr_t*>()) {
  }
...
public re_t {
 public:
  posix_class() : type_tag_(229), negated(nullptr), name(StrFromC("")) {
  }
...
public re_t {
 public:
  perl_class() : type_tag_(230), negated(nullptr), name(StrFromC("")) {
  }
...
class CharCode : public char_class_term_t {
 public:
  CharCode() : type_tag_(231), i(-1), u_braced(false), spid(-1) {
  }
  CharCode(int i, bool u_braced, int spid) : type_tag_(231), i(i),
           u_braced(u_braced), spid(spid) {
  }
  OBJ_HEADER();
  int i;
  bool u_braced;

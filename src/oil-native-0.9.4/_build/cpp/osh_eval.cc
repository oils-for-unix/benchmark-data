...
GLOBAL_STR(str130, "Unexpected block passed to external command %r");
...
GLOBAL_STR(str398, "Z");
GLOBAL_STR(str399, "-");
GLOBAL_STR(str400, "doesn't accept flag %s");
GLOBAL_STR(str401, "-");
GLOBAL_STR(str402, "+");
GLOBAL_STR(str403, "+");
GLOBAL_STR(str404, "doesn't accept option %s");
GLOBAL_STR(str405, "+");
GLOBAL_STR(str406, "-");
GLOBAL_STR(str407, "--");
GLOBAL_STR(str408, "--");
GLOBAL_STR(str409, "got invalid flag %r");
GLOBAL_STR(str410, "-");
GLOBAL_STR(str411, "+");
GLOBAL_STR(str412, "got invalid flag %r");
GLOBAL_STR(str413, "-");
GLOBAL_STR(str414, "^--?([a-zA-Z0-9][a-zA-Z0-9\\-]*)(=.*)?$");
...
GLOBAL_STR(str421, "");
GLOBAL_STR(str422, "ShAssignment expression can't be nested like this");
GLOBAL_STR(str423, "Here docs aren't allowed in expressions");
GLOBAL_STR(str424, "\n");
GLOBAL_STR(str425, "");
GLOBAL_STR(str426, " (%s)");
GLOBAL_STR(str427, "Unexpected token in expression mode%s");
GLOBAL_STR(str428, "Syntax error in expression (near %s)");
GLOBAL_STR(str429, "alnum");
GLOBAL_STR(str430, "cntrl");
GLOBAL_STR(str431, "lower");
GLOBAL_STR(str432, "space");
GLOBAL_STR(str433, "alpha");
GLOBAL_STR(str434, "digit");
GLOBAL_STR(str435, "print");
GLOBAL_STR(str436, "upper");
GLOBAL_STR(str437, "blank");
GLOBAL_STR(str438, "graph");
GLOBAL_STR(str439, "punct");
GLOBAL_STR(str440, "xdigit");
GLOBAL_STR(str441, "Range start/end shouldn't have more than one character");
GLOBAL_STR(str442, "Write singleton tuples with tup(), not a trailing comma");
GLOBAL_STR(str443, "testlist_comp");
GLOBAL_STR(str444, "obj.field isn't valid, but obj.method() is");
GLOBAL_STR(str445, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str446, "Can't assign to this expression");
GLOBAL_STR(str447, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str448, "TODO");
GLOBAL_STR(str449, "dot");
GLOBAL_STR(str450, "Can't negate this symbol");
GLOBAL_STR(str451, "%r isn't a character class");
GLOBAL_STR(str452, "Can't negate this symbol");
GLOBAL_STR(str453, "%r isn't a character class");
GLOBAL_STR(str454, "%start");
GLOBAL_STR(str455, "%end");
GLOBAL_STR(str456, "dot");
GLOBAL_STR(str457, "Unexpected token %r in regex");
GLOBAL_STR(str458, "%s-%s");
GLOBAL_STR(str459, "ERE can't express code point %d");
GLOBAL_STR(str460, "Perl classes can't be negated in ERE");
GLOBAL_STR(str461, "%s");
GLOBAL_STR(str462, "POSIX classes can't be negated in ERE");
GLOBAL_STR(str463, "[:%s:]");
GLOBAL_STR(str464, ".");
GLOBAL_STR(str465, "^");
GLOBAL_STR(str466, "$");
GLOBAL_STR(str467, "|");
GLOBAL_STR(str468, "POSIX EREs don't have groups without capture, so this node needs () around it.");
GLOBAL_STR(str469, "+");
GLOBAL_STR(str470, "*");
GLOBAL_STR(str471, "?");
GLOBAL_STR(str472, "{%s}");
...
GLOBAL_STR(str576, "'try' expected a command to run");
GLOBAL_STR(str577, "(original failure)");
GLOBAL_STR(str578, "");
GLOBAL_STR(str579, "fatal: status %d when --allow-status-01");
GLOBAL_STR(str580, ":");
GLOBAL_STR(str581, "function");
GLOBAL_STR(str582, "alias");
GLOBAL_STR(str583, "builtin");
GLOBAL_STR(str584, "builtin");
GLOBAL_STR(str585, "builtin");
GLOBAL_STR(str586, "keyword");
GLOBAL_STR(str587, "keyword");
GLOBAL_STR(str588, "file");
GLOBAL_STR(str589, "type");
GLOBAL_STR(str590, "type: %r not found");
GLOBAL_STR(str591, "file");
GLOBAL_STR(str592, "file");
GLOBAL_STR(str593, "%s is a %s");
GLOBAL_STR(str594, "function");
GLOBAL_STR(str595, "osh I/O error: %s");
GLOBAL_STR(str596, "");
GLOBAL_STR(str597, "osh I/O error: %s");
GLOBAL_STR(str598, "osh I/O error: %s");
GLOBAL_STR(str599, "osh I/O error: %s");
GLOBAL_STR(str600, "");
GLOBAL_STR(str601, "\r\n");
GLOBAL_STR(str602, "\n");
GLOBAL_STR(str603, "'");
GLOBAL_STR(str604, "");
GLOBAL_STR(str605, "");
GLOBAL_STR(str606, "read");
GLOBAL_STR(str607, "_line");
GLOBAL_STR(str608, ":");
GLOBAL_STR(str609, "got extra argument");
GLOBAL_STR(str610, "--qsn can only be used with --line");
GLOBAL_STR(str611, "_all");
GLOBAL_STR(str612, ":");
GLOBAL_STR(str613, "got extra argument");
GLOBAL_STR(str614, "--qsn not implemented yet");
GLOBAL_STR(str615, "read -t isn't implemented (except t=0)");
GLOBAL_STR(str616, "REPLY");
GLOBAL_STR(str617, "REPLY");
GLOBAL_STR(str618, "");
GLOBAL_STR(str619, ":");
GLOBAL_STR(str620, "mapfile");
GLOBAL_STR(str621, "MAPFILE");
GLOBAL_STR(str622, ":");
GLOBAL_STR(str623, "\n");
GLOBAL_STR(str624, "cd");
GLOBAL_STR(str625, "HOME");
GLOBAL_STR(str626, "HOME");
GLOBAL_STR(str627, "-");
GLOBAL_STR(str628, "OLDPWD");
GLOBAL_STR(str629, "PWD");
GLOBAL_STR(str630, "cd %r: %s");
GLOBAL_STR(str631, "PWD");
GLOBAL_STR(str632, "OLDPWD");
GLOBAL_STR(str633, "%2d  %s");
GLOBAL_STR(str634, " ");
GLOBAL_STR(str635, "pushd: no other directory");
GLOBAL_STR(str636, "got too many arguments");
GLOBAL_STR(str637, "pushd: %r: %s");
GLOBAL_STR(str638, "HOME");
GLOBAL_STR(str639, "PWD");
GLOBAL_STR(str640, "popd: directory stack is empty");
GLOBAL_STR(str641, "popd: %r: %s");
GLOBAL_STR(str642, "PWD");
GLOBAL_STR(str643, "got extra argument");
GLOBAL_STR(str644, "HOME");
GLOBAL_STR(str645, "dirs");
GLOBAL_STR(str646, "HOME");
GLOBAL_STR(str647, "pwd");
GLOBAL_STR(str648, "_devbuild/help/groups.txt");
GLOBAL_STR(str649, "help");
GLOBAL_STR(str650, "help");
GLOBAL_STR(str651, "_devbuild/help/%s");
GLOBAL_STR(str652, "no help topics match %r");
GLOBAL_STR(str653, "osh I/O error: %s");
GLOBAL_STR(str654, "# +");
GLOBAL_STR(str655, "osh printf doesn't support the %r flag");
GLOBAL_STR(str656, "eEfFgG");
GLOBAL_STR(str657, "osh printf doesn't support floating point");
GLOBAL_STR(str658, "c");
GLOBAL_STR(str659, "osh printf doesn't support single characters (bytes)");
GLOBAL_STR(str660, "Invalid printf format character");
GLOBAL_STR(str661, "Expected a printf format character");
GLOBAL_STR(str662, "%");
GLOBAL_STR(str663, "");
GLOBAL_STR(str664, "printf got invalid width %r");
GLOBAL_STR(str665, "0");
GLOBAL_STR(str666, "");
GLOBAL_STR(str667, "printf got invalid precision %r");
GLOBAL_STR(str668, "");
GLOBAL_STR(str669, "s");
GLOBAL_STR(str670, "q");
GLOBAL_STR(str671, "b");
GLOBAL_STR(str672, "");
GLOBAL_STR(str673, "diouxX");
GLOBAL_STR(str674, "'\"");
GLOBAL_STR(str675, "printf expected an integer, got %r");
GLOBAL_STR(str676, "TZ");
GLOBAL_STR(str677, "TZ");
GLOBAL_STR(str678, "ouxX");
GLOBAL_STR(str679, "Can't format negative number %d with %%%s");
GLOBAL_STR(str680, "o");
GLOBAL_STR(str681, "x");
GLOBAL_STR(str682, "X");
GLOBAL_STR(str683, "0");
...
GLOBAL_STR(str689, " ");
GLOBAL_STR(str690, " ");
GLOBAL_STR(str691, "printf");
GLOBAL_STR(str692, "requires a format string");
GLOBAL_STR(str693, "printf");
GLOBAL_STR(str694, "");
GLOBAL_STR(str695, "alias");
GLOBAL_STR(str696, "alias %s=%r");
GLOBAL_STR(str697, "=");
GLOBAL_STR(str698, "No alias named %r");
GLOBAL_STR(str699, "alias %s=%r");
GLOBAL_STR(str700, "unalias");
GLOBAL_STR(str701, "requires an argument");
GLOBAL_STR(str702, "No alias named %r");
GLOBAL_STR(str703, "%s=%s");
GLOBAL_STR(str704, "set");
GLOBAL_STR(str705, "shopt");
GLOBAL_STR(str706, "got invalid option %r");
GLOBAL_STR(str707, "hash");
GLOBAL_STR(str708, "got extra arguments after -r");
GLOBAL_STR(str709, "hash: %r not found");
GLOBAL_STR(str710, ":");
GLOBAL_STR(str711, "OPTIND");
GLOBAL_STR(str712, "OPTIND");
GLOBAL_STR(str713, "OPTARG");
GLOBAL_STR(str714, "OPTARG");
GLOBAL_STR(str715, "");
GLOBAL_STR(str716, "?");
GLOBAL_STR(str717, "-");
GLOBAL_STR(str718, "-");
GLOBAL_STR(str719, "?");
GLOBAL_STR(str720, "?");
GLOBAL_STR(str721, "getopts: option %r requires an argument.");
GLOBAL_STR(str722, "(getopts argv: %s)");
GLOBAL_STR(str723, " ");
GLOBAL_STR(str724, "?");
GLOBAL_STR(str725, "");
GLOBAL_STR(str726, "requires an argspec");
GLOBAL_STR(str727, "requires the name of a variable to set");
GLOBAL_STR(str728, "got invalid variable name %r");
GLOBAL_STR(str729, "echo");
GLOBAL_STR(str730, "");
GLOBAL_STR(str731, "takes at most one arg when simple_echo is on (hint: add quotes)");
GLOBAL_STR(str732, " ");
GLOBAL_STR(str733, "\n");
GLOBAL_STR(str734, "module");
GLOBAL_STR(str735, "requires a name");
GLOBAL_STR(str736, "[oil -i] Reloading module %r");
GLOBAL_STR(str737, "expected 'bin' or 'dialect'");
GLOBAL_STR(str738, "dialect");
GLOBAL_STR(str739, "expected dialect name");
GLOBAL_STR(str740, "_DIALECT");
GLOBAL_STR(str741, "Expected dialect %r, got %r");
GLOBAL_STR(str742, "Expected dialect %r");
GLOBAL_STR(str743, "bin");
GLOBAL_STR(str744, "bin %s");
GLOBAL_STR(str745, "expected 'bin' or 'dialect'");
GLOBAL_STR(str746, "shvar");
GLOBAL_STR(str747, "expected a block");
GLOBAL_STR(str748, "Expected name=value");
GLOBAL_STR(str749, "=");
GLOBAL_STR(str750, "Expected name=value");
GLOBAL_STR(str751, "expected a block");
GLOBAL_STR(str752, "Assignment builtin %r not configured");
GLOBAL_STR(str753, "%r ");
GLOBAL_STR(str754, "");
GLOBAL_STR(str755, "command in ");
GLOBAL_STR(str756, "assignment in ");
GLOBAL_STR(str757, "subshell invoked from ");
GLOBAL_STR(str758, "pipeline invoked from ");
GLOBAL_STR(str759, "");
GLOBAL_STR(str760, "Exiting with status %d (%sPID %d)");
GLOBAL_STR(str761, "Redirect filename can't be empty");
GLOBAL_STR(str762, "Redirect descriptor can't be empty");
GLOBAL_STR(str763, "-");
GLOBAL_STR(str764, "-");
GLOBAL_STR(str765, "Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
GLOBAL_STR(str766, "\n");
GLOBAL_STR(str767, "Unknown redirect op");
GLOBAL_STR(str768, "Unknown redirect type");
GLOBAL_STR(str769, "strict_errexit only allows simple commands (got %s). Hint: use 'try'.");
GLOBAL_STR(str770, "strict_errexit only allows a single command.  Hint: use \"run\".");
GLOBAL_STR(str771, "strict_errexit only allows simple commands (got %s). Hint: use 'try'.");
GLOBAL_STR(str772, "ShAssignment builtins don't accept blocks");
GLOBAL_STR(str773, "|& isn't supported");
GLOBAL_STR(str774, "Can't append array to string");
GLOBAL_STR(str775, "Can't append string to array");
GLOBAL_STR(str776, "%r expected a number, got %r");
GLOBAL_STR(str777, "Invalid control flow at top level");
GLOBAL_STR(str778, "warning: ");
GLOBAL_STR(str779, "Function %s was already defined (redefine_proc)");
GLOBAL_STR(str780, "Proc %s was already defined (redefine_proc)");
GLOBAL_STR(str781, "trap");
GLOBAL_STR(str782, "Loop and control flow can't be in different processes");
GLOBAL_STR(str783, "fatal: ");
GLOBAL_STR(str784, "EXIT");
GLOBAL_STR(str785, "trap EXIT");
GLOBAL_STR(str786, "__");
GLOBAL_STR(str787, ":");
GLOBAL_STR(str788, "Invalid argument %r.  Expected a name starting with :");
GLOBAL_STR(str789, "No value provided for param %r");
GLOBAL_STR(str790, "proc %r expected %d arguments, but got %d");
GLOBAL_STR(str791, "Unexpected %r (in function call)");
GLOBAL_STR(str792, "Attempted to exit from completion hook.");
GLOBAL_STR(str793, "Couldn't find terminator for here doc that starts here");
GLOBAL_STR(str794, "\t");
GLOBAL_STR(str795, "Invalid here doc delimiter");
GLOBAL_STR(str796, "+");
GLOBAL_STR(str797, "+");
GLOBAL_STR(str798, "+");
GLOBAL_STR(str799, "%d != %d");
GLOBAL_STR(str800, "array place");
GLOBAL_STR(str801, "Environment binding shouldn't look like an array assignment");
GLOBAL_STR(str802, "+");
GLOBAL_STR(str803, "Expected = in environment binding, got +=");
GLOBAL_STR(str804, "Environment bindings can't contain array literals");
GLOBAL_STR(str805, "procs and shell functions can't be nested");
GLOBAL_STR(str806, "%r was already declared");
GLOBAL_STR(str807, "%r hasn't been declared");
GLOBAL_STR(str808, "Can't modify constant %r");
GLOBAL_STR(str809, "Expected word type %s, got %s");
GLOBAL_STR(str810, "{");
GLOBAL_STR(str811, "}");
GLOBAL_STR(str812, "Invalid token after redirect operator");
GLOBAL_STR(str813, "TODO: Parse Redirect");
GLOBAL_STR(str814, " ");
GLOBAL_STR(str815, " ");
GLOBAL_STR(str816, "line IDs %d != %d");
GLOBAL_STR(str817, " ");
GLOBAL_STR(str818, "");
GLOBAL_STR(str819, "Unexpected block");
GLOBAL_STR(str820, "=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
GLOBAL_STR(str821, "name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
GLOBAL_STR(str822, "Unexpected block");
GLOBAL_STR(str823, "Unexpected block");
GLOBAL_STR(str824, "Control flow shouldn't have redirects");
GLOBAL_STR(str825, "Control flow shouldn't have environment bindings");
GLOBAL_STR(str826, "Unexpected argument to %r");
GLOBAL_STR(str827, "Invalid word in for loop");
GLOBAL_STR(str828, "Invalid word after for expression");
GLOBAL_STR(str829, "Loop variable name should be a constant");
GLOBAL_STR(str830, "Invalid loop variable name");
GLOBAL_STR(str831, "Unexpected word after for loop variable");
GLOBAL_STR(str832, "Expected ;; or esac");
GLOBAL_STR(str833, "Unexpected word while parsing compound command");
GLOBAL_STR(str834, "Invalid function name");
GLOBAL_STR(str835, "Expected ) in function definition");
GLOBAL_STR(str836, "Invalid KSH-style function name");
GLOBAL_STR(str837, "Unexpected word when parsing command");
GLOBAL_STR(str838, "Unexpected right brace");
GLOBAL_STR(str839, "Unexpected EOF while parsing command");
GLOBAL_STR(str840, "Invalid word while parsing command");
GLOBAL_STR(str841, "Unexpected word while parsing command line");
GLOBAL_STR(str842, "Unterminated here doc began here");
GLOBAL_STR(str843, "\\");
GLOBAL_STR(str844, "*");
GLOBAL_STR(str845, "?");
GLOBAL_STR(str846, "[");
...
GLOBAL_STR(str850, "\\?*+{}^$.()|");
GLOBAL_STR(str851, "\\");
GLOBAL_STR(str852, "Unexpected escaped character %r");
GLOBAL_STR(str853, "");
GLOBAL_STR(str854, "");
GLOBAL_STR(str855, "Malformed character class; treating as literal");
GLOBAL_STR(str856, "Got unescaped right bracket");
GLOBAL_STR(str857, "Got unescaped trailing backslash");
GLOBAL_STR(str858, ".|^$()+*?[]{}\\");
GLOBAL_STR(str859, "\\");
GLOBAL_STR(str860, "\\");
GLOBAL_STR(str861, "\\[");
...
GLOBAL_STR(str873, "]");
GLOBAL_STR(str874, "");
GLOBAL_STR(str875, "Error expanding glob %r: %s");
GLOBAL_STR(str876, "-");
GLOBAL_STR(str877, "<Error: unbalanced \\[ and \\]> ");
GLOBAL_STR(str878, "$");
GLOBAL_STR(str879, "#");
GLOBAL_STR(str880, "$");
GLOBAL_STR(str881, "hostname");
GLOBAL_STR(str882, "user");
GLOBAL_STR(str883, "\u0001");
GLOBAL_STR(str884, "\u0002");
GLOBAL_STR(str885, "$");
GLOBAL_STR(str886, "$");
GLOBAL_STR(str887, "u");
GLOBAL_STR(str888, "user");
GLOBAL_STR(str889, "h");
GLOBAL_STR(str890, "hostname");
GLOBAL_STR(str891, ".");
GLOBAL_STR(str892, "H");
...
GLOBAL_STR(str895, "v");
GLOBAL_STR(str896, "A");
GLOBAL_STR(str897, "%H:%M");
GLOBAL_STR(str898, "D");
GLOBAL_STR(str899, "%X");
GLOBAL_STR(str900, "w");
GLOBAL_STR(str901, "PWD");
GLOBAL_STR(str902, "HOME");
GLOBAL_STR(str903, "<Error: %s>");
GLOBAL_STR(str904, "W");
GLOBAL_STR(str905, "PWD");
GLOBAL_STR(str906, "<Error: PWD is not a string> ");
GLOBAL_STR(str907, "<Error: \\%s not implemented in $PS1> ");
GLOBAL_STR(str908, "$");
GLOBAL_STR(str909, "\\$");
GLOBAL_STR(str910, "Invalid token %r");
GLOBAL_STR(str911, "");
GLOBAL_STR(str912, "");
GLOBAL_STR(str913, "<ERROR: Can't parse PS1: %s>");
GLOBAL_STR(str914, "osh");
GLOBAL_STR(str915, "PS1");
GLOBAL_STR(str916, "$ ");
GLOBAL_STR(str917, "PROMPT_COMMAND");
GLOBAL_STR(str918, "Undefined variable %r");
GLOBAL_STR(str919, "Can't use [] on value of type %s");
GLOBAL_STR(str920, "");
GLOBAL_STR(str921, "Can't use [] on value of type %s");
GLOBAL_STR(str922, "");
GLOBAL_STR(str923, "dynamic place");
GLOBAL_STR(str924, "got invalid place expression");
GLOBAL_STR(str925, "expected a var name.  shopt -s eval_unsafe_arith allows a[i]");
GLOBAL_STR(str926, "Invalid var ref");
GLOBAL_STR(str927, "0x");
GLOBAL_STR(str928, "Invalid hex constant %r");
GLOBAL_STR(str929, "0");
GLOBAL_STR(str930, "Invalid octal constant %r");
GLOBAL_STR(str931, "#");
GLOBAL_STR(str932, "#");
GLOBAL_STR(str933, "Invalid base for numeric constant %r");
GLOBAL_STR(str934, "a");
GLOBAL_STR(str935, "A");
GLOBAL_STR(str936, "@");
GLOBAL_STR(str937, "_");
GLOBAL_STR(str938, "Invalid digits for numeric constant %r");
GLOBAL_STR(str939, "Digits %r out of range for base %d");
GLOBAL_STR(str940, "Parse error in recursive arithmetic");
GLOBAL_STR(str941, "Invalid integer constant %r");
GLOBAL_STR(str942, "Invalid integer constant %r");
GLOBAL_STR(str943, "Invalid integer constant %r");
GLOBAL_STR(str944, "Undefined value in arithmetic context");
GLOBAL_STR(str945, "Expected a value convertible to integer, got %s");
GLOBAL_STR(str946, "0");
GLOBAL_STR(str947, "Divide by zero");
GLOBAL_STR(str948, "Divide by zero");
GLOBAL_STR(str949, "Expected array or assoc in index expression, got %s");
GLOBAL_STR(str950, "Divide by zero");
GLOBAL_STR(str951, "Divide by zero");
GLOBAL_STR(str952, "Exponent can't be less than zero");
GLOBAL_STR(str953, "Associative array keys must be strings: $x 'x' \"$x\" etc.");
GLOBAL_STR(str954, "Invalid place to modify");
GLOBAL_STR(str955, "%s isn't implemented");
GLOBAL_STR(str956, "Invalid regex %r: %s");
GLOBAL_STR(str957, " \t\n");
GLOBAL_STR(str958, "IFS");
GLOBAL_STR(str959, "IFS shouldn't be an array");
GLOBAL_STR(str960, " \t\n");
GLOBAL_STR(str961, "IFS");
GLOBAL_STR(str962, " ");
GLOBAL_STR(str963, "");
GLOBAL_STR(str964, "IFS shouldn't be an array");
GLOBAL_STR(str965, "\\");
GLOBAL_STR(str966, "\\");
GLOBAL_STR(str967, "Invalid transition from %r with %r");
GLOBAL_STR(str968, "\u00ef\u00bf\u00bd");
GLOBAL_STR(str969, "");
GLOBAL_STR(str970, "Incomplete UTF-8 character");
GLOBAL_STR(str971, "Invalid UTF-8 continuation byte");
GLOBAL_STR(str972, "Invalid start of UTF-8 character");
GLOBAL_STR(str973, "");
GLOBAL_STR(str974, "%s can't have an argument");
GLOBAL_STR(str975, "");
GLOBAL_STR(str976, "%s can't have an argument");
GLOBAL_STR(str977, "");
GLOBAL_STR(str978, "%s can't have an argument");
GLOBAL_STR(str979, "");
GLOBAL_STR(str980, "%s can't have an argument");
GLOBAL_STR(str981, "");
GLOBAL_STR(str982, "<_GlobReplacer regex %r r %r>");
GLOBAL_STR(str983, "(%s)");
GLOBAL_STR(str984, "Error matching regex %r: %s");
GLOBAL_STR(str985, "^");
GLOBAL_STR(str986, "$");
GLOBAL_STR(str987, "\r");
GLOBAL_STR(str988, "<INVALID CR>");
GLOBAL_STR(str989, "\n");
GLOBAL_STR(str990, "<INVALID NEWLINE>");
GLOBAL_STR(str991, " `~!$&*()[]{}\\|;'\"<>?");
GLOBAL_STR(str992, "Left-hand side of this assignment is invalid");
GLOBAL_STR(str993, "Token can't be used in prefix position");
GLOBAL_STR(str994, "Token can't be used in infix position");
GLOBAL_STR(str995, "Parser expected %s, got %s");
GLOBAL_STR(str996, "Unexpected end of input");
GLOBAL_STR(str997, "");
GLOBAL_STR(str998, "");
GLOBAL_STR(str999, " \t");
GLOBAL_STR(str1000, "\n");
...
GLOBAL_STR(str1002, "\n");
GLOBAL_STR(str1003, "\n");
GLOBAL_STR(str1004, "BASH_SOURCE");
GLOBAL_STR(str1005, "FUNCNAME");
GLOBAL_STR(str1006, "BASH_LINENO");
GLOBAL_STR(str1007, "0");
GLOBAL_STR(str1008, "0");
GLOBAL_STR(str1009, "\\");
GLOBAL_STR(str1010, "\\\\");
GLOBAL_STR(str1011, "");
GLOBAL_STR(str1012, "");
GLOBAL_STR(str1013, "The length index of a array slice can't be negative: %d");
GLOBAL_STR(str1014, "Can't slice associative arrays");
GLOBAL_STR(str1015, "i");
GLOBAL_STR(str1016, "e");
GLOBAL_STR(str1017, "f");
GLOBAL_STR(str1018, "n");
GLOBAL_STR(str1019, "u");
GLOBAL_STR(str1020, "x");
GLOBAL_STR(str1021, "C");
GLOBAL_STR(str1022, "");
GLOBAL_STR(str1023, "~");
GLOBAL_STR(str1024, "HOME");
GLOBAL_STR(str1025, "Error expanding tilde (e.g. invalid user)");
GLOBAL_STR(str1026, "Can't assign to special variable");
GLOBAL_STR(str1027, "unset variable %r");
GLOBAL_STR(str1028, "warning: ");
GLOBAL_STR(str1029, "-1");
GLOBAL_STR(str1030, "a[i] not allowed without shopt -s eval_unsafe_arith");
GLOBAL_STR(str1031, "Indirect expansion of array");
GLOBAL_STR(str1032, "Indirect expansion of assoc array");
GLOBAL_STR(str1033, "extended globs not supported in ${x//GLOB/}");
GLOBAL_STR(str1034, "");
GLOBAL_STR(str1035, "warning: ");
GLOBAL_STR(str1036, "");
GLOBAL_STR(str1037, "\u0001");
GLOBAL_STR(str1038, "");
GLOBAL_STR(str1039, "\u0002");
GLOBAL_STR(str1040, "");
GLOBAL_STR(str1041, "Can't use @P on %s");
GLOBAL_STR(str1042, " ");
GLOBAL_STR(str1043, "Can't use @Q on %s");
GLOBAL_STR(str1044, "a");
GLOBAL_STR(str1045, "A");
GLOBAL_STR(str1046, "r");
GLOBAL_STR(str1047, "x");
GLOBAL_STR(str1048, "n");
GLOBAL_STR(str1049, "");
GLOBAL_STR(str1050, "Var op %r not implemented");
GLOBAL_STR(str1051, "Can't index string with @");
GLOBAL_STR(str1052, "Can't index string with *");
GLOBAL_STR(str1053, "Can't index string %r with integer");
GLOBAL_STR(str1054, "");
GLOBAL_STR(str1055, "");
GLOBAL_STR(str1056, "$");
GLOBAL_STR(str1057, "Undefined variable %r");
GLOBAL_STR(str1058, "Undefined array %r");
GLOBAL_STR(str1059, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str1060, "Test operation not allowed with ${!array[@]}");
GLOBAL_STR(str1061, "Not implemented");
GLOBAL_STR(str1062, "Illegal array word part (strict_array)");
GLOBAL_STR(str1063, " ");
GLOBAL_STR(str1064, "");
GLOBAL_STR(str1065, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str1066, "@(");
GLOBAL_STR(str1067, "|");
GLOBAL_STR(str1068, ")");
GLOBAL_STR(str1069, "Extended globs and arrays can't appear in the same word");
GLOBAL_STR(str1070, "*");
GLOBAL_STR(str1071, "Unexpected array literal");
GLOBAL_STR(str1072, "Unexpected associative array literal");
GLOBAL_STR(str1073, "Can't splice %r");
GLOBAL_STR(str1074, "");
GLOBAL_STR(str1075, "");
GLOBAL_STR(str1076, "Extended glob not allowed in this word");
GLOBAL_STR(str1077, "");
GLOBAL_STR(str1078, "This word should yield a string, but it contains an array");
GLOBAL_STR(str1079, " ");
GLOBAL_STR(str1080, "extended glob not allowed in this word");
GLOBAL_STR(str1081, "");
GLOBAL_STR(str1082, "");
GLOBAL_STR(str1083, "");
GLOBAL_STR(str1084, "");
GLOBAL_STR(str1085, "<Runtime error: %s>");
GLOBAL_STR(str1086, "<I/O error: %s>");
GLOBAL_STR(str1087, "<Ctrl-C>");
GLOBAL_STR(str1088, "");
GLOBAL_STR(str1089, "");
GLOBAL_STR(str1090, "");
GLOBAL_STR(str1091, "");
GLOBAL_STR(str1092, "");
GLOBAL_STR(str1093, "LHS array not allowed in assignment builtin");
GLOBAL_STR(str1094, "+");
GLOBAL_STR(str1095, "+= not allowed in assignment builtin");
GLOBAL_STR(str1096, "-");
GLOBAL_STR(str1097, "+");
GLOBAL_STR(str1098, "f");
GLOBAL_STR(str1099, "F");
GLOBAL_STR(str1100, "");
GLOBAL_STR(str1101, "=");
GLOBAL_STR(str1102, "Invalid variable name %r");
GLOBAL_STR(str1103, "__NO_COMMAND_SUB__");
GLOBAL_STR(str1104, "__NO_PROCESS_SUB__");
GLOBAL_STR(str1105, "Expected : or } in slice");
GLOBAL_STR(str1106, "Pattern in ${x/pat/replace} must not be empty");
GLOBAL_STR(str1107, "Expected } after replacement string, got %s");
GLOBAL_STR(str1108, "Expected } or / to close pattern");
GLOBAL_STR(str1109, "Expected ] to close subscript");
GLOBAL_STR(str1110, "Expected } to close ${");
GLOBAL_STR(str1111, "Expected } to close ${");
GLOBAL_STR(str1112, "Expected a constant argument");
GLOBAL_STR(str1113, "Expected } to close ${");
GLOBAL_STR(str1114, "Expected } to close ${");
GLOBAL_STR(str1115, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1116, "VOp2");
GLOBAL_STR(str1117, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1118, "VOp3");
GLOBAL_STR(str1119, "Expected } to close ${");
GLOBAL_STR(str1120, "Expected } after length expression");
GLOBAL_STR(str1121, "TODO: ${.myproc builtin sub}");
GLOBAL_STR(str1122, "Unexpected token in ${}");
GLOBAL_STR(str1123, "\\");
GLOBAL_STR(str1124, "Strings with backslashes should look like r'\\n' or $'\\n'");
GLOBAL_STR(str1125, "Use \\xhh or \\u{...} instead of octal escapes in Oil strings");
GLOBAL_STR(str1126, "Invalid hex escape in Oil string (must be \\xHH)");
GLOBAL_STR(str1127, "Invalid char escape in C-style string literal");
GLOBAL_STR(str1128, "Unexpected EOF in single-quoted string that began here");
GLOBAL_STR(str1129, "\"");
GLOBAL_STR(str1130, "'");
GLOBAL_STR(str1131, "Unexpected EOF reading extended glob that began here");
GLOBAL_STR(str1132, "Invalid char escape in double quoted string");
GLOBAL_STR(str1133, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1134, "Invalid backtick: use $(cmd) or \\` in Oil strings");
GLOBAL_STR(str1135, "Unexpected EOF reading double-quoted string that began here");
GLOBAL_STR(str1136, "Use $(cmd) instead of backticks (parse_backticks)");
GLOBAL_STR(str1137, "Unexpected EOF while looking for closing backtick");
GLOBAL_STR(str1138, "");
GLOBAL_STR(str1139, "backticks");
GLOBAL_STR(str1140, "Invalid proc name %s");
GLOBAL_STR(str1141, "Unexpected token after arithmetic expression (%s != %s)");
GLOBAL_STR(str1142, "Expected second ) to end arith sub");
GLOBAL_STR(str1143, "Expected second ) to end arith statement");
GLOBAL_STR(str1144, "Expected ; here");
GLOBAL_STR(str1145, "Expected ; here");
GLOBAL_STR(str1146, "Expected ) to end for loop expression");
GLOBAL_STR(str1147, "Expected ( after =");
GLOBAL_STR(str1148, "Unexpected token in array literal");
GLOBAL_STR(str1149, "Expected associative array pair");
GLOBAL_STR(str1150, "Invalid char escape (parse_backslash)");
GLOBAL_STR(str1151, "Unexpected token after array literal");
GLOBAL_STR(str1152, "Unexpected token after array splice");
GLOBAL_STR(str1153, "TODO: @{.myproc builtin sub}");
GLOBAL_STR(str1154, "Literal @ starting a word must be quoted (parse_at_all)");
GLOBAL_STR(str1155, "/");
GLOBAL_STR(str1156, "next_byte %r");
GLOBAL_STR(str1157, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1158, "Unexpected token after @()");
GLOBAL_STR(str1159, "Word has unbalanced { }.  Maybe add a space or quote it like \\{");
GLOBAL_STR(str1160, "Unexpected parts after triple quoted string");
GLOBAL_STR(str1161, "Unexpected token while parsing arithmetic: %r");
GLOBAL_STR(str1162, "Invalid blank line in multiline mode");
GLOBAL_STR(str1163, "r");
GLOBAL_STR(str1164, "Unhandled: %s (%s)");
GLOBAL_STR(str1165, "Invalid var ref");
GLOBAL_STR(str1166, "Expected end of var ref");
GLOBAL_STR(str1167, "Invalid lex state %s");
GLOBAL_STR(str1168, "");
GLOBAL_STR(str1169, "");
GLOBAL_STR(str1170, "");
GLOBAL_STR(str1171, "");
...
GLOBAL_STR(str1175, "");
GLOBAL_STR(str1176, "");
GLOBAL_STR(str1177, "Compound shouldn't be empty");
GLOBAL_STR(str1178, "/");
GLOBAL_STR(str1179, "/");
GLOBAL_STR(str1180, "");
GLOBAL_STR(str1181, "EOF");
GLOBAL_STR(str1182, "typ");
GLOBAL_STR(str1183, "tok");
GLOBAL_STR(str1184, "children");
GLOBAL_STR(str1185, "-");
GLOBAL_STR(str1186, "with %d children");
GLOBAL_STR(str1187, "");
GLOBAL_STR(str1188, "(PNode %s %s %s)");
GLOBAL_STR(str1189, "&");
GLOBAL_STR(str1190, "&amp;");
GLOBAL_STR(str1191, "<");
GLOBAL_STR(str1192, "&lt;");
...
GLOBAL_STR(str1214, "/");
GLOBAL_STR(str1215, " \n\r\t");
GLOBAL_STR(str1216, "Unexpected token in QSN string");
GLOBAL_STR(str1217, "Expected closing single quote in QSN string");
GLOBAL_STR(str1218, "Unexpected data after closing quote");
GLOBAL_STR(str1219, "Unexpected token after QSN string");
GLOBAL_STR(str1220, "\\'\r\n\t\u0000");
GLOBAL_STR(str1221, "$'");
GLOBAL_STR(str1222, "'");
GLOBAL_STR(str1223, "'");
...
GLOBAL_STR(str1235, "\n");
GLOBAL_STR(str1236, "\\n");
GLOBAL_STR(str1237, "\r");
GLOBAL_STR(str1238, "\\r");
GLOBAL_STR(str1239, "\t");
GLOBAL_STR(str1240, "\\t");
GLOBAL_STR(str1241, "\u0000");
GLOBAL_STR(str1242, "\\x00");
GLOBAL_STR(str1243, "\\0");
GLOBAL_STR(str1244, "");
GLOBAL_STR(str1245, "");
GLOBAL_STR(str1246, "");
GLOBAL_STR(str1247, "\\");
...
GLOBAL_STR(str1261, "!");
GLOBAL_STR(str1262, "--");
GLOBAL_STR(str1263, "--dir");
GLOBAL_STR(str1264, "--exists");
GLOBAL_STR(str1265, "--file");
GLOBAL_STR(str1266, "--symlink");
GLOBAL_STR(str1267, "Expected unary operator, got %r (2 args)");
GLOBAL_STR(str1268, "-a");
GLOBAL_STR(str1269, "-o");
GLOBAL_STR(str1270, "!");
GLOBAL_STR(str1271, "(");
GLOBAL_STR(str1272, ")");
GLOBAL_STR(str1273, "Expected binary operator, got %r (3 args)");
GLOBAL_STR(str1274, "should be invoked as 'test' (simple_test_builtin)");
GLOBAL_STR(str1275, "]");
GLOBAL_STR(str1276, "missing closing ]");
GLOBAL_STR(str1277, "should only have 3 arguments or fewer (simple_test_builtin)");
GLOBAL_STR(str1278, "!");
GLOBAL_STR(str1279, "(");
GLOBAL_STR(str1280, ")");
GLOBAL_STR(str1281, "(test) ");
GLOBAL_STR(str1282, "(test) ");
...
inline Str* fmt129(int a0, int a1) {
  gBuf.reset();
...
inline Str* fmt136(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("=", 1);
  gBuf.format_s(a1);
...
inline Str* fmt153(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt154(int a0, Str* a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const("  ", 2);
  gBuf.format_s(a1);
...
inline Str* fmt155(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt156(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt169(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt172(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.write_const("alias ", 6);
  gBuf.format_s(a0);
  gBuf.write_const("=", 1);
...
inline Str* fmt186(int a0, Str* a1, int a2) {
  gBuf.reset();
...
inline Str* fmt193(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_r(a0);
...
inline Str* fmt198(Str* a0, int a1, int a2) {
  gBuf.reset();
  gBuf.write_const("proc ", 5);
  gBuf.format_r(a0);
...
inline Str* fmt202(int a0, int a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const(" != ", 4);
  gBuf.format_d(a1);
...
inline Str* fmt210(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt238(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt252(Str* a0, int a1) {
  gBuf.reset();
...
inline Str* fmt264(Str* a0, Str* a1, syntax_asdl::word_t* a2) {
  gBuf.reset();
...
inline Str* fmt270(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt336(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt359(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("/", 1);
  gBuf.format_s(a1);
...
int ShellExecutor::RunSimpleCommand(runtime_asdl::cmd_value__Argv* cmd_val, bool do_fork, bool call_procs) {
  ...
  if (builtin_id != consts::NO_INDEX) {
    this->errfmt->Print_(str125, span_id);
    return 1;
  }
...
args::_Attributes* Parse(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    ...
    if ((len(spec->actions_long) and arg->startswith(str394))) {
      ...
      if ((arg->startswith(str396) and len(arg) > 1)) {
        n = len(arg);
        for (int i = 1; i < n; ++i) {
          ch = arg->index(i);
          if (str_equals(ch, str397)) {
            ch = str398;
          }
          if (list_contains(spec->plus_flags, ch)) {
            out->Set(ch, Alloc<value::Str>(str399));
            continue;
          }
        ...
        if ((len(spec->plus_flags) and (arg->startswith(str402) and len(arg) > 1))) {
          n = len(arg);
          for (int i = 1; i < n; ++i) {
            ch = arg->index(i);
            if (list_contains(spec->plus_flags, ch)) {
              out->Set(ch, Alloc<value::Str>(str403));
              continue;
            }
            e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
          }
...
args::_Attributes* ParseLikeEcho(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    chars = arg->slice(1);
    if ((arg->startswith(str406) and len(chars))) {
      done = false;
...
args::_Attributes* ParseMore(flag_spec::_FlagSpecAndMore* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str407)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if (arg->startswith(str408)) {
      action = spec->actions_long->get(arg->slice(2));
      if (action == nullptr) {
        e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
      }
    ...
    if (((arg->startswith(str410) or arg->startswith(str411)) and len(arg) > 1)) {
      char0 = arg->index(0);
...
int _Classify(grammar::Grammar* gr, syntax_asdl::Token* tok) {
  ...
  type_str = tok->id == Id::Unknown_Tok ? str425 : fmt99(ui::PrettyId(tok->id));
  p_die(fmt100(type_str), tok);
}
...
Tuple2<pnode::PNode*, syntax_asdl::Token*> ExprParser::Parse(lexer::Lexer* lexer, int start_symbol) {
  ...
  try {
    ...
    p_die(fmt101(ui::PrettyId(e->tok->id)), e->tok);
  }
...
GLOBAL_LIST(Str*, 12, POSIX_CLASSES, {str429 COMMA str430 COMMA str431 COMMA str432 COMMA str433 COMMA str434 COMMA str435 COMMA str436 COMMA str437 COMMA str438 COMMA str439 COMMA str440});
Str* RANGE_POINT_TOO_LONG = str441;
int NT_OFFSET = 256;
...
syntax_asdl::expr_t* Transformer::_Tuple(List<pnode::PNode*>* children) {
  ...
  if (n == 2) {
    p_die(fmt102(), children->index(1)->tok);
  }
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw Alloc<NotImplementedError>(str443);
  }
  if (id0 == Id::Op_LBracket) {
    elts = Alloc<List<syntax_asdl::expr_t*>>();
    for (int i = 0; i < n; i += 2) {
  ...
  for (int i = 0; i < n; i += 2) {
    ...
    if (tag == expr_e::Var) {
      ...
      if ((tag == place_expr_e::Var || tag == place_expr_e::Subscript || tag == place_expr_e::Attribute)) {
        ...
        p_die(fmt104(), p->tok ? p->tok : nullptr);
      }
    }
  }
  return places;
...
syntax_asdl::re_t* Transformer::_NameInRegex(syntax_asdl::Token* negated_tok, syntax_asdl::Token* tok) {
  ...
  val = tok->val;
  if (maybe_str_equals(val, str449)) {
    if (negated_tok) {
      p_die(fmt105(), tok);
    }
    return tok;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((str_equals(tok->val, str454) || str_equals(tok->val, str455) || str_equals(tok->val, str456))) {
        return tok;
      }
      p_die(fmt109(tok->val), tok);
    }
...
void _ClassLiteralToPosixEre(syntax_asdl::class_literal_term_t* term, List<Str*>* parts) {
  ...
  if (tag == class_literal_term_e::CodePoint) {
    ...
    if (code_point < 128) {
      ...
      e_die(fmt111(code_point), term->spid);
    }
    return ;
  }
  if (tag == class_literal_term_e::PerlClass) {
    ...
    if (term->negated) {
      e_die(fmt112(), term->negated->span_id);
    }
    else {
      pat = fmt113(chars);
    }
  ...
  if (tag == class_literal_term_e::PosixClass) {
    ...
    n = term->name;
    if (term->negated) {
      e_die(fmt114(), term->negated->span_id);
    }
    else {
      pat = fmt115(n);
    }
...
void AsPosixEre(syntax_asdl::re_t* node, List<Str*>* parts) {
  ...
  if (tag == re_e::Repeat) {
    ...
    if (op_tag == re_repeat_e::Num) {
      ...
      parts->append(fmt117(op->times->val));
      return ;
    }
    if (op_tag == re_repeat_e::Range) {
      re_repeat__Range* op = static_cast<re_repeat__Range*>(UP_op);
      lower = op->lower ? op->lower->val : str473;
      upper = op->upper ? op->upper->val : str474;
      parts->append(fmt118(lower, upper));
      return ;
    }
...
syntax_asdl::bool_expr_t* BoolParser::ParseForBuiltin() {
  ...
  if (this->bool_id != Id::Eof_Real) {
    p_die(fmt125(word_::Pretty(this->cur_word)), this->cur_word);
  }
  return node;
}
...
syntax_asdl::bool_expr_t* BoolParser::ParseFactor() {
  ...
  if (this->bool_id == Id::Op_LParen) {
    ...
    if (this->bool_id != Id::Op_RParen) {
      p_die(fmt127(word_::Pretty(this->cur_word)), this->cur_word);
    }
    this->_Next();
    return node;
  }
  p_die(fmt128(ui::PrettyId(this->bool_id)), this->cur_word);
}
...
Str* _RangeParser::_Eat(int token_type) {
  ...
  if (this->token_type != token_type) {
    throw Alloc<_NotARange>(fmt129(token_type, this->token_type));
  }
  val = this->token_val;
  this->_Next();
  return val;
...
syntax_asdl::word_part__BracedRange* _RangeParser::Parse() {
  ...
  if (this->token_type == Id::Range_Int) {
    ...
    if (start < end) {
      ...
      if (part->step <= 0) {
        p_die(fmt131(part->step), this->span_id);
      }
    }
    else {
      if (start > end) {
        ...
        if (part->step >= 0) {
          p_die(fmt132(part->step), this->span_id);
        }
      }
      else {
        part->step = 1;
    ...
    if (this->token_type == Id::Range_Char) {
      ...
      if (start_num < end_num) {
        ...
        if (part->step <= 0) {
          p_die(fmt133(part->step), this->span_id);
        }
      }
      else {
        if (start_num > end_num) {
          ...
          if (part->step >= 0) {
            p_die(fmt134(part->step), this->span_id);
          }
        }
        else {
          part->step = 1;
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if (print_flags) {
      ...
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str521, str522->join(flags), str523, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str524, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (has_holes) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str527, name, str528, str(i), str529, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str531, str532->join(body), str533}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str535, key_quoted, str536, value_quoted}));
          }
          if (len(body) > 0) {
            decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str537, str538->join(body), str539}));
          }
        }
        else {
          ;  // pass
...
int Source::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  try {
    ...
    this->errfmt->Print_(fmt142(path, pyutil::strerror(e)), cmd_val->arg_spids->index(1));
    return 1;
  }
  try {
    try {
...
int Command::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup3 = flag_spec::ParseCmdVal(str569, cmd_val);
  attrs = tup3.at0();
  arg_r = tup3.at1();
...
int Builtin::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (to_run == consts::NO_INDEX) {
    ...
    if (consts::LookupAssignBuiltin(name) != consts::NO_INDEX) {
      ...
      this->errfmt->Print_(fmt143(name), span_id);
    }
    return 1;
  }
...
int RunProc::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseOilCmdVal(str572, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
  ...
  name = argv->index(0);
  if (!dict_contains(this->procs, name)) {
    this->errfmt->StderrLine(fmt144(name));
    return 1;
  }
...
int Try::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup7 = flag_spec::ParseOilCmdVal(str575, cmd_val);
  attrs = tup7.at0();
  arg_r = tup7.at1();
  ...
  if ((arg->allow_status_01 and (status != 0 && status != 1))) {
    if (failure_spid != runtime::NO_SPID) {
      this->errfmt->Print_(str577, failure_spid);
      this->errfmt->StderrLine(str578);
    }
    throw Alloc<error::ErrExit>(fmt146(status), spids->index(0), status);
  }
  if (arg->assign != nullptr) {
    var_name = arg->assign;
    if (var_name->startswith(str580)) {
            ...
            if (consts::LookupAssignBuiltin(name) != 0) {
              ...
              if (consts::IsControlFlow(name)) {
                ...
                if (consts::IsKeyword(name)) {
                  kind = (Alloc<Tuple2<Str*, Str*>>(str587, name));
                }
                else {
                  ...
                  if (resolved == nullptr) {
                    ...
                    kind = (Alloc<Tuple2<Str*, Str*>>(str588, resolved));
                  }
                }
              }
            }
...
int Type::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseCmdVal(str589, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  for (ListIter<Tuple2<Str*, Str*>*> it(r); !it.Done(); it.Next()) {
    ...
    name = tup10->at1();
    if (kind == nullptr) {
      this->errfmt->StderrLine(fmt147(name));
      status = 1;
    }
    else {
      if (arg->t) {
        ...
        if (arg->p) {
          ...
          if (arg->P) {
            ...
            print(fmt148(name, kind));
            if (str_equals(kind, str594)) {
              ;  // pass
            }
          }
        }
  ...
  while (bytes_left > 0) {
    ...
    if (n < 0) {
      if (err_num == errno_::EINTR) {
        ...
        e_die(fmt149(posix::strerror(err_num)), 2);
      }
    }
    else {
      if (n == 0) {
  ...
  while (true) {
    ...
    if (ch < 0) {
      if (err_num == errno_::EINTR) {
        ...
        e_die(fmt150(posix::strerror(err_num)), 2);
      }
    }
    else {
  ...
  while (true) {
    ...
    if (ch < 0) {
      if (err_num == errno_::EINTR) {
        ...
        e_die(fmt151(posix::strerror(err_num)), 2);
      }
    }
    else {
      if (ch == pyos::EOF_SENTINEL) {
  ...
  while (true) {
    ...
    if (n < 0) {
      if (err_num == errno_::EINTR) {
        ...
        e_die(fmt152(posix::strerror(err_num)), 2);
      }
    }
    else {
      if (n == 0) {
...
int Read::_Line(arg_types::read* arg, Str* var_name) {
  ...
  if (!arg->with_eol) {
    if (line->endswith(str601)) {
      line = line->slice(0, -2);
    }
    else {
      if (line->endswith(str602)) {
        line = line->slice(0, -1);
      }
    }
  }
  if ((arg->q and line->startswith(str603))) {
    arena = this->parse_ctx->arena;
    line_reader = reader::StringLineReader(line, arena);
    lexer = this->parse_ctx->MakeLexer(line_reader);
    try {
      {  // with
        alloc::ctx_Location ctx(arena, Alloc<source::Stdin>(str604));
...
int Read::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str606, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
  ...
  if (arg->all) {
    ...
    next_spid = tup10.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str613, next_spid);
    }
...
int MapFile::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup13 = flag_spec::ParseCmdVal(str620, cmd_val);
  attrs = tup13.at0();
  arg_r = tup13.at1();
  ...
  while (true) {
    ...
    if ((arg->t and line->endswith(str623))) {
      line = line->slice(0, -1);
    }
    lines->append(line);
  }
...
int Cd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str624, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  ...
  if (str_equals(dest_dir, str627)) {
    try {
      dest_dir = state::GetString(this->mem, str628);
      print(dest_dir);
    }
    catch (error::Runtime* e) {
      this->errfmt->Print_(e->UserErrorString());
  ...
  try {
    pwd = state::GetString(this->mem, str629);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    return 1;
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt153(real_dest_dir, posix::strerror(err_num)), arg_spid);
    return 1;
  }
  state::ExportGlobalString(this->mem, str631, real_dest_dir);
  ...
  if (cmd_val->block) {
    ...
    state::ExportGlobalString(this->mem, str632, pwd);
...
void _PrintDirStack(state::DirStack* dir_stack, int style, Str* home_dir) {
  ...
  if (style == WITH_LINE_NUMBERS) {
    ...
    for (ListIter<Str*> it(dir_stack->Iter()); !it.Done(); it.Next(), ++i) {
      ...
      print(fmt154(i, ui::PrettyDir(entry, home_dir)));
    }
  }
  else {
...
int Pushd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt155(dest_dir, posix::strerror(err_num)), cmd_val->arg_spids->index(1));
    return 1;
  }
  this->dir_stack->Push(dest_dir);
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str638));
  state::ExportGlobalString(this->mem, str639, dest_dir);
...
bool _PopDirStack(state::Mem* mem, state::DirStack* dir_stack, ui::ErrorFormatter* errfmt) {
  ...
  if (dest_dir == nullptr) {
    errfmt->Print_(str640);
    return false;
  }
  err_num = pyos::Chdir(dest_dir);
  if (err_num != 0) {
    errfmt->Print_(fmt156(dest_dir, posix::strerror(err_num)));
    return false;
  }
  state::SetGlobalString(mem, str642, dest_dir);
  mem->SetPwd(dest_dir);
  return true;
}
...
int Popd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->arg_spids) > 1) {
    e_usage(fmt157(), cmd_val->arg_spids->index(1));
  }
  if (!_PopDirStack(this->mem, this->dir_stack, this->errfmt)) {
    return 1;
  }
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str644));
  return 0;
}
...
int Dirs::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup17 = flag_spec::ParseCmdVal(str645, cmd_val);
  attrs = tup17.at0();
  arg_r = tup17.at1();
  arg = Alloc<arg_types::dirs>(attrs->attrs);
  home_dir = state::MaybeString(this->mem, str646);
  style = SINGLE_LINE;
  if (arg->l) {
    home_dir = nullptr;
  }
...
int Pwd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup18 = flag_spec::ParseCmdVal(str647, cmd_val);
  attrs = tup18.at0();
  arg_r = tup18.at1();
...
List<Str*>* Help::_Groups() {
  ...
  contents = this->loader->Get(str648);
...
int Help::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup19 = flag_spec::ParseCmdVal(str649, cmd_val);
  attrs = tup19.at0();
  arg_r = tup19.at1();
  ...
  try {
    contents = this->loader->Get(fmt158(topic));
  }
  catch (IOError*) {
    this->errfmt->Print_(fmt159(topic), blame_spid);
    return 1;
  }
  print(contents);
  return 0;
  ...
  while (true) {
    ...
    if (n < 0) {
      if (err_num == errno_::EINTR) {
        ...
        e_die(fmt160(posix::strerror(err_num)), 2);
      }
    }
    else {
      if (n == 0) {
...
syntax_asdl::printf_part_t* _FormatStringParser::_ParseFormatStr() {
  ...
  while ((this->token_type == Id::Format_Flag || this->token_type == Id::Format_Zero)) {
    ...
    if (str_contains(str654, flag)) {
      p_die(fmt161(flag), this->cur_token);
    }
  ...
  if ((this->token_type == Id::Format_Type || this->token_type == Id::Format_Time)) {
    ...
    if (str_contains(str656, part->type->val)) {
      p_die(fmt162(), part->type);
    }
    if (maybe_str_equals(part->type->val, str658)) {
      p_die(fmt163(), part->type);
    }
  }
  else {
        ...
        if (part->tag_() == printf_part_e::Percent) {
          ...
          if (part->width) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt166(width_str), width_spid);
              return 1;
            }
          }
          precision = -1;
          if (part->precision) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt167(precision_str), precision_spid);
              return 1;
            }
          }
          if (arg_index < num_args) {
          ...
          if (str_equals(typ, str669)) {
            ...
            if (str_equals(typ, str670)) {
              ...
              if (str_equals(typ, str671)) {
                ...
                s = str672->join(c_parts);
              }
              else {
                if ((part->type->id == Id::Format_Time or str_contains(str673, typ))) {
                  try {
                    d = to_int(s);
                  }
                  catch (ValueError*) {
                    if ((len(s) >= 1 and str_contains(str674, s->index(0)))) {
                  ...
                  if (part->type->id == Id::Format_Time) {
                    ...
                    if ((d < 0 and str_contains(str678, typ))) {
                      e_die(fmt169(d, typ), part->type->span_id);
                    }
                    ...
                    zero_pad = 0;
                    if ((width >= 0 and list_contains(flags, str683))) {
                      zero_pad = 1;
                    }
                    else {
                    ...
                    if (zero_pad) {
                      negative = str_equals(s->index(0), str684);
                      if (negative) {
                        digits = s->slice(1);
                        sign = str685;
                        if (zero_pad == 1) {
                      ...
                      s = str_concat(sign, digits->rjust(n, str687));
                    }
                  }
                }
                else {
          ...
          if (width >= 0) {
            if (list_contains(flags, str688)) {
              s = s->ljust(width, str689);
            }
            else {
              s = s->rjust(width, str690);
            }
          }
          out->append(s);
        }
...
int Printf::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup1 = flag_spec::ParseCmdVal(str691, cmd_val);
  attrs = tup1.at0();
  arg_r = tup1.at1();
  arg = Alloc<arg_types::printf>(attrs->attrs);
  Tuple2<Str*, int> tup2 = arg_r->ReadRequired2(str692);
  fmt = tup2.at0();
  fmt_spid = tup2.at1();
  ...
  if (dict_contains(this->parse_cache, fmt)) {
    ...
    {  // with
      alloc::ctx_Location ctx(arena, Alloc<source::ArgvWord>(str693, fmt_spid));
...
int Alias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str695, cmd_val);
  arg_r = tup0.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup1 = mylib::split_once(arg, str697);
    name = tup1.at0();
    alias_exp = tup1.at1();
    if (alias_exp == nullptr) {
      alias_exp = this->aliases->get(name);
      if (alias_exp == nullptr) {
        this->errfmt->Print_(fmt171(name), cmd_val->arg_spids->index(i));
        status = 1;
      }
      else {
        print(fmt172(name, alias_exp));
      }
    }
    else {
...
int UnAlias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str700, cmd_val);
  arg_r = tup2.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
    e_usage(str701);
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    ...
    if (dict_contains(this->aliases, name)) {
      ...
      this->errfmt->Print_(fmt173(name), cmd_val->arg_spids->index(i));
      status = 1;
    }
  }
  return status;
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->argv) == 1) {
    ...
    for (ListIter<Str*> it(sorted(mapping)); !it.Done(); it.Next()) {
      ...
      code_str = fmt174(name, qsn::maybe_shell_encode(str_val));
      print(code_str);
    }
    return 0;
  }
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  arg = flag_spec::ParseMore(str704, arg_r);
  if (arg->show_options) {
...
int Shopt::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str705, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
...
int Hash::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str707, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
...
Dict<Str*, bool>* _ParseOptSpec(Str* spec_str) {
  ...
  while (true) {
    ...
    if (str_equals(spec_str->index(i), str710)) {
      spec->set(ch, true);
      i += 1;
    }
  }
...
int GetOptsState::_OptInd() {
  int result;
  try {
    result = state::GetInteger(this->mem, str711);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    result = -1;
...
void GetOptsState::IncIndex() {
  state::BuiltinSetString(this->mem, str712, str((this->_optind + 1)));
}

void GetOptsState::SetArg(Str* optarg) {
  StackRoots _roots({&optarg});

  state::BuiltinSetString(this->mem, str713, optarg);
}

void GetOptsState::Fail() {
  state::BuiltinSetString(this->mem, str714, str715);
}
...
Tuple2<int, Str*> _GetOpts(Dict<Str*, bool>* spec, List<Str*>* argv, builtin_pure::GetOptsState* my_state, ui::ErrorFormatter* errfmt) {
  ...
  if (current == nullptr) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str716));
  }
  if ((!current->startswith(str717) or str_equals(current, str718))) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str719));
  }
  ...
  if (!dict_contains(spec, flag_char)) {
    return (Tuple2<int, Str*>(0, str720));
  }
  if (spec->index(flag_char)) {
    if (more_chars) {
      ...
      if (optarg == nullptr) {
        my_state->Fail();
        errfmt->Print_(fmt177(current));
        tmp = Alloc<List<Str*>>();
        for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
          Str* a = it.Value();
          tmp->append(qsn::maybe_shell_encode(a));
        }
        println_stderr(fmt178(str723->join(tmp)));
        return (Tuple2<int, Str*>(0, str724));
      }
    }
    my_state->IncIndex();
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  spec_str = arg_r->ReadRequired(str726);
  Tuple2<Str*, int> tup7 = arg_r->ReadRequired2(str727);
  var_name = tup7.at0();
  var_spid = tup7.at1();
  ...
  if (match::IsValidVarName(var_name)) {
    ...
    throw Alloc<error::Usage>(fmt179(var_name), var_spid);
  }
  return status;
}
...
int Echo::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseLikeEcho(str729, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  if (arg->e) {
    ...
    for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
      ...
      new_argv->append(str730->join(parts));
      if (backslash_c) {
        break;
      }
    }
...
int Module::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseOilCmdVal(str734, cmd_val);
  arg_r = tup11.at1();
  Tuple2<Str*, int> tup12 = arg_r->ReadRequired2(str735);
  name = tup12.at0();
  if (dict_contains(this->modules, name)) {
    if (this->exec_opts->redefine_module()) {
      this->errfmt->StderrLine(fmt180(name));
      return 0;
    }
    else {
      return 1;
...
int Use::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_spid = tup13.at1();
  if (arg == nullptr) {
    throw Alloc<error::Usage>(str737, runtime::NO_SPID);
  }
  arg_r->Next();
  if (str_equals(arg, str738)) {
    Tuple2<Str*, int> tup14 = arg_r->Peek2();
    expected = tup14.at0();
    e_spid = tup14.at1();
    if (expected == nullptr) {
    ...
    UP_actual = this->mem->GetValue(str740, scope_e::Dynamic);
    if (UP_actual->tag_() == value_e::Str) {
      ...
      if (maybe_str_equals(actual, expected)) {
        ...
        this->errfmt->Print_(fmt181(expected, actual), e_spid);
        return 1;
      }
    }
    else {
      this->errfmt->Print_(fmt182(expected), e_spid);
      return 1;
    }
  }
  if (str_equals(arg, str743)) {
    rest = arg_r->Rest();
    for (ListIter<Str*> it(rest); !it.Done(); it.Next()) {
      Str* name = it.Value();
      StackRoots _for({&name    });
      println_stderr(fmt183(name));
    }
    return 0;
  }
  throw Alloc<error::Usage>(str745, arg_spid);
}
...
int Shvar::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseOilCmdVal(str746, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  if (!cmd_val->block) {
  ...
  for (ListIter<Str*> it(args); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup17 = mylib::split_once(arg, str749);
    name = tup17.at0();
    s = tup17.at1();
    if (s == nullptr) {
      throw Alloc<error::Usage>(str750, arg_spids->index(i));
    }
...
int PushRegisters::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (!cmd_val->block) {
    throw Alloc<error::Usage>(str751, runtime::NO_SPID);
  }
  {  // with
...
int CommandEvaluator::_RunAssignBuiltin(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  if (builtin_func == nullptr) {
    e_die(fmt184(cmd_val->argv->index(0)), cmd_val->arg_spids->index(0));
  }
  try {
    try {
      status = builtin_func->Run(cmd_val);
      ...
      this->errfmt->PrefixPrint(e->msg, fmt185(arg0), e->span_id);
      status = 2;
    }
    catch (KeyboardInterrupt*) {
      if (this->exec_opts->interactive()) {
...
void CommandEvaluator::_CheckStatus(int status, syntax_asdl::command_t* node, int blame_spid) {
  ...
  if ((this->exec_opts->errexit() and status != 0)) {
    ...
    throw Alloc<error::ErrExit>(fmt186(status, reason, posix::getpid()), span_id, status);
  }
}
  ...
  switch (arg->tag_()) {
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        filename = val->s;
        if (len(filename) == 0) {
          throw Alloc<error::RedirectEval>(str761, arg_word);
        }
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          t = val->s;
          if (len(t) == 0) {
            throw Alloc<error::RedirectEval>(str762, arg_word);
            return nullptr;
          }
          try {
            if (maybe_str_equals(t, str763)) {
              result->arg = Alloc<redirect_arg::CloseFd>();
            }
            else {
              if (str_equals(t->index(-1), str764)) {
            ...
            throw Alloc<error::RedirectEval>(fmt187(t), arg_word);
            return nullptr;
          }
          return result;
        }
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = Alloc<redirect_arg::HereDoc>(str_concat(val->s, str766));
            return result;
          }
          else {
            throw Alloc<AssertionError>();
...
void CommandEvaluator::_StrictErrExit(syntax_asdl::command_t* node) {
  ...
  if (_HasManyStatuses(node)) {
    ...
    e_die(fmt188(node_str), location::SpanForCommand(node));
  }
}
...
void CommandEvaluator::_StrictErrExitList(List<syntax_asdl::command_t*>* node_list) {
  ...
  if (len(node_list) > 1) {
    e_die(fmt189(), location::SpanForCommand(node_list->index(0)));
  }
  node = node_list->index(0);
  if (_HasManyStatuses(node)) {
    node_str = ui::CommandType(node);
    e_die(fmt190(node_str), location::SpanForCommand(node));
  }
}
  ...
  switch (node->tag_()) {
    case command_e::Simple: {
      ...
      if (UP_cmd_val->tag_() == cmd_value_e::Argv) {
        ...
        if (node->block) {
          e_die(fmt191(), node->block->spids->index(0));
        }
        cmd_value__Assign* cmd_val = static_cast<cmd_value__Assign*>(UP_cmd_val);
      }
    ...
    case command_e::Pipeline: {
      ...
      if (len(node->stderr_indices)) {
        e_die(fmt192(), node->spids->index(0));
      }
      if (node->negated) {
    ...
    case command_e::ControlFlow: {
      ...
      if (node->arg_word) {
        ...
        if ((len(str_val->s) == 0 and !this->exec_opts->strict_control_flow())) {
          ...
          try {
            ...
            e_die(fmt193(node->token->val, str_val->s), node->arg_word);
          }
        }
      }
      else {
      ...
      if (ok) {
        ...
        if (this->exec_opts->strict_control_flow()) {
          ...
          this->errfmt->PrefixPrint(msg, str778, tok->span_id);
          status = 0;
        }
      }
    }
    ...
    case command_e::ShFunction: {
      ...
      if ((dict_contains(this->procs, node->name) and !this->exec_opts->redefine_proc())) {
        e_die(fmt194(node->name), node->spids->index(1));
      }
    ...
    case command_e::Proc: {
      ...
      if ((dict_contains(this->procs, node->name->val) and !this->exec_opts->redefine_proc())) {
        e_die(fmt195(node->name->val), node->name->span_id);
      }
      defaults = nullptr;
    ...
    {  // with
      ...
      for (ListIter<syntax_asdl::command_t*> it(to_run); !it.Done(); it.Next()) {
        ...
        {  // with
          ...
          {  // with
            dev::ctx_Tracer ctx(this->tracer, str781, nullptr);
...
Tuple2<bool, bool> CommandEvaluator::ExecuteAndCatch(syntax_asdl::command_t* node, int cmd_flags) {
  ...
  try {
    ...
    if ((cmd_flags & RaiseControlFlow)) {
      ...
      if (e->IsReturn()) {
        ...
        this->errfmt->Print_(str782, e->token->span_id);
        is_fatal = true;
        status = 1;
      }
    }
  ...
  if (err) {
    ...
    if ((is_errexit and !this->exec_opts->verbose_errexit())) {
      ...
      ui::PrettyPrintError(err, this->arena, str783);
    }
  }
...
void CommandEvaluator::MaybeRunExitTrap(List<int>* mut_status) {
  ...
  handler = this->traps->get(str784);
  if (handler) {
    {  // with
      dev::ctx_Tracer ctx(this->tracer, str785, nullptr);
    ...
    if (UP_sig->tag_() == proc_sig_e::Closed) {
      ...
      for (ListIter<syntax_asdl::param*> it(sig->params); !it.Done(); it.Next(), ++i) {
        ...
        if (i < n_args) {
          ...
          if (is_out_param) {
            param_name = str_concat(str786, param_name);
            if (!arg_str->startswith(str787)) {
              e_die(fmt196(arg_str));
            }
      ...
      if (sig->rest) {
        ...
        if (n_args > n_params) {
          throw Alloc<TypeError>(fmt198(proc->name, n_params, n_args));
        }
      }
    }
    try {
      ...
      if (e->IsReturn()) {
        ...
        e_die(fmt199(e->token->val), e->token);
      }
    }
    catch (error::FatalRuntime* e) {
      this->dumper->MaybeCollect(this, e);
...
int CommandEvaluator::RunFuncForCompletion(runtime_asdl::Proc* proc, List<Str*>* argv) {
  ...
  try {
    ...
    this->errfmt->Print_(str792, e->token->span_id);
    status = 1;
  }
  return status;
}
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index(i), str794))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index(-2), str796)) {
    ...
    if ((left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse)) {
      var_name = left_token->val->slice(0, -1);
      if (str_equals(close_token->val->index(-2), str797)) {
        op = assign_op_e::PlusEqual;
      }
      else {
        op = assign_op_e::Equal;
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        var_name = left_token->val->slice(0, -1);
        if (str_equals(close_token->val->index(-2), str798)) {
          op = assign_op_e::PlusEqual;
        }
        else {
          op = assign_op_e::Equal;
        ...
        if (span1->line_id == span2->line_id) {
          ...
          throw Alloc<NotImplementedError>(fmt202(span1->line_id, span2->line_id));
        }
        a_parser = parse_ctx->MakeArithParser(code_str);
        src = Alloc<source::Reparsed>(str800, left_token->span_id, close_token->span_id);
        {  // with
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    if (str_equals(left_token->val->index(-2), str802)) {
      p_die(fmt204(), left_token);
    }
    var_name = left_token->val->slice(0, -1);
    n = len(w->parts);
    if (part_offset == n) {
...
void CommandParser::_Eat(int c_id) {
  ...
  msg = fmt210(ui::PrettyId(c_id), ui::PrettyId(actual_id));
  this->_Eat2(c_id, msg);
}
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index(0), str810)) {
    pos = op_val->find(str811);
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    expanded->append(str817);
    i += 1;
  }
  code_str = str818->join(expanded);
  line_reader = reader::StringLineReader(code_str, this->arena);
  ...
  if (kind == Kind::ControlFlow) {
    ...
    if (len(suffix_words) == 1) {
      ...
      if (len(suffix_words) == 2) {
        ...
        p_die(fmt221(kw_token->val), suffix_words->index(2));
      }
    }
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if (str_equals(c, str843)) {
      i += 1;
    }
    else {
      if ((str_equals(c, str844) or str_equals(c, str845))) {
        return true;
      }
      else {
        if (str_equals(c, str846)) {
          left_bracket = true;
        }
        else {
          if ((str_equals(c, str847) and left_bracket)) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  ...
  return pyutil::BackslashEscape(s, str849);
}
Str* ERE_META_CHARS = str850;
...
Str* GlobUnescape(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if ((str_equals(c, str851) and i != (n - 1))) {
      i += 1;
      c2 = s->index(i);
      ...
      if (tag == glob_part_e::Operator) {
        ...
        if (tag == glob_part_e::CharClass) {
          ...
          for (ListIter<Str*> it(part->strs); !it.Done(); it.Next()) {
            Str* s = it.Value();
            StackRoots _for({&s          });
            if (str_equals(s, str869)) {
              literal_hyphen = true;
              continue;
            }
            if (str_equals(s, str870)) {
...
Str* _PromptEvaluatorCache::Get(Str* name) {
  ...
  if (str_equals(name, str878)) {
    value = this->_GetEuid() == 0 ? str879 : str880;
  }
  else {
    if (str_equals(name, str881)) {
      value = libc::gethostname();
    }
    else {
      if (str_equals(name, str882)) {
      ...
      if (id_ == Id::PS_Octal3) {
        ...
        if (id_ == Id::PS_LBrace) {
          ...
          if (id_ == Id::PS_RBrace) {
            ...
            if (id_ == Id::PS_Subst) {
              ch = value->index(1);
              if (str_equals(ch, str885)) {
                r = this->cache->Get(str886);
              }
              else {
                if (str_equals(ch, str887)) {
                  r = this->cache->Get(str888);
                }
                else {
                  if (str_equals(ch, str889)) {
                    hostname = this->cache->Get(str890);
                    Tuple2<Str*, Str*> tup1 = mylib::split_once(hostname, str891);
                    r = tup1.at0();
                  }
                  else {
                    if (str_equals(ch, str892)) {
                      r = this->cache->Get(str893);
                    }
                    else {
                      if (str_equals(ch, str894)) {
                        r = this->lang;
                      }
                      else {
                        if (str_equals(ch, str895)) {
                          r = this->version_str;
                        }
                        else {
                          if (str_equals(ch, str896)) {
                            now = time_::time();
                            r = time_::strftime(str897, time_::localtime(now));
                          }
                          else {
                            if (str_equals(ch, str898)) {
                              ...
                              if (str_equals(ch, str900)) {
                                try {
                                  pwd = state::GetString(this->mem, str901);
                                  home = state::MaybeString(this->mem, str902);
                                  r = ui::PrettyDir(pwd, home);
                                }
                                catch (error::Runtime* e) {
                                  r = fmt239(e->UserErrorString());
                                }
                              }
                              else {
                                if (str_equals(ch, str904)) {
                                  val = this->mem->GetValue(str905);
                                  if (val->tag_() == value_e::Str) {
                                    value__Str* str_val = static_cast<value__Str*>(val);
              ...
              ret->append(r->replace(str908, str909));
            }
            else {
              throw Alloc<AssertionError>();
            }
...
Str* Evaluator::EvalPrompt(runtime_asdl::value_t* UP_val) {
  ...
  if (ps1_word == nullptr) {
    ...
    try {
      ...
      ps1_word = word_::ErrorWord(fmt241(e->UserErrorString()));
    }
...
Str* Evaluator::EvalFirstPrompt() {
  ...
  if (str_equals(this->lang, str914)) {
    val = this->mem->GetValue(str915);
    return this->EvalPrompt(val);
  }
  else {
    return str_concat(this->lang, str916);
  }
}
Str* PROMPT_COMMAND = str917;
    ...
    case lvalue_e::Keyed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::AssocArray: {
          ...
          break;
        default: {
          e_die(fmt244(ui::ValType(val)));
        }
      }
      s = assoc_val->d->get(lval->key);
      if (s == nullptr) {
        val = Alloc<value::Str>(str922);
      }
      else {
        val = Alloc<value::Str>(s);
      }
...
runtime_asdl::lvalue_t* UnsafeArith::ParseLValue(Str* s, int span_id) {
  ...
  {  // with
    alloc::ctx_Location ctx(arena, Alloc<source::ArgvWord>(str923, span_id));
...
int ArithEvaluator::_StringToInteger(Str* s, int span_id) {
  ...
  if (s->startswith(str927)) {
    try {
      integer = to_int(s, 16);
    }
    catch (ValueError*) {
      e_strict(fmt248(s), span_id);
    }
    return integer;
  }
  if (s->startswith(str929)) {
    try {
      integer = to_int(s, 8);
    }
    catch (ValueError*) {
      e_strict(fmt249(s), span_id);
    }
    return integer;
  }
  if (str_contains(s, str931)) {
    Tuple2<Str*, Str*> tup0 = mylib::split_once(s, str932);
    b = tup0.at0();
    digits = tup0.at1();
    try {
      base = to_int(b);
    ...
    for (StrIter it(digits); !it.Done(); it.Next()) {
      ...
      StackRoots _for({&ch    });
      if (IsLower(ch)) {
        digit = ((ord(ch) - ord(str934)) + 10);
      }
      else {
        if (IsUpper(ch)) {
          digit = ((ord(ch) - ord(str935)) + 36);
        }
        else {
          if (str_equals(ch, str936)) {
            digit = 62;
          }
          else {
            if (str_equals(ch, str937)) {
              digit = 63;
            }
            else {
              if (ch->isdigit()) {
                ...
                e_strict(fmt251(digits), span_id);
              }
            }
          }
        }
      ...
      if (digit >= base) {
        e_strict(fmt252(digits, base), span_id);
      }
    ...
    if ((this->exec_opts->eval_unsafe_arith() and this->parse_ctx)) {
      ...
      {  // with
        ...
        try {
          ...
          ui::PrettyPrintError(e, arena);
          e_die(fmt253(), e->span_id);
        }
      }
      if (node2->tag_() == arith_expr_e::Word) {
        e_die(fmt254(s), span_id);
      }
      else {
      ...
      if ((len(s->strip()) == 0 or match::IsValidVarName(s))) {
        e_strict(fmt255(s), span_id);
      }
      else {
        e_die(fmt256(s), span_id);
      }
    }
  }
  return integer;
...
int ArithEvaluator::_ValToIntOrError(runtime_asdl::value_t* val, int span_id) {
  ...
  e_die(fmt258(ui::ValType(val)), span_id);
}
  ...
  if (((val->tag_() == value_e::MaybeStrArray || val->tag_() == value_e::AssocArray) and lval->tag_() == lvalue_e::Named)) {
    ...
    if (word_eval::ShouldArrayDecay(named_lval->name, this->exec_opts)) {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (val->tag_() == value_e::AssocArray) {
          lval = Alloc<lvalue::Keyed>(named_lval->name, str946);
        }
      }
        ...
        if (op_id == Id::Arith_Minus) {
          ...
          if (op_id == Id::Arith_Star) {
            ...
            if (op_id == Id::Arith_Slash) {
              if (rhs == 0) {
                e_die(fmt260(), location::SpanForArithExpr(node->right));
              }
              ret = (lhs / rhs);
            }
            else {
              if (op_id == Id::Arith_Percent) {
                if (rhs == 0) {
                  e_die(fmt261(), location::SpanForArithExpr(node->right));
                }
                ret = (lhs % rhs);
              }
              else {
  ...
  switch (node->tag_()) {
    ...
    case bool_expr_e::Unary: {
      ...
      if (arg_type == bool_arg_type_e::Other) {
        ...
        e_die(fmt263(ui::PrettyId(op_id)));
      }
      throw Alloc<AssertionError>();
    }
      break;
      ...
      if (arg_type == bool_arg_type_e::Str) {
        ...
        if (op_id == Id::BoolBinary_EqualTilde) {
          try {
            ...
            msg = e->message;
            e_die(fmt264(s2, msg, node->right), 2);
          }
          if (matches == nullptr) {
            return false;
          }
...
split::IfsSplitter* SplitContext::_GetSplitter(Str* ifs) {
  ...
  if (ifs == nullptr) {
    val = this->mem->GetValue(str958, scope_e::Dynamic);
    UP_val = val;
    switch (val->tag_()) {
      case value_e::Undef: {
        ifs = DEFAULT_IFS;
...
Str* SplitContext::GetJoinChar() {
  ...
  val = this->mem->GetValue(str961, scope_e::Dynamic);
  UP_val = val;
  switch (val->tag_()) {
    case value_e::Undef: {
      return str962;
...
_BaseSplitter::_BaseSplitter(Str* escape_chars) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(_BaseSplitter)) {
  this->escape_chars = str_concat(escape_chars, str965);
}
    ...
    if (i < n) {
      ...
      if (str_contains(ws_chars, c)) {
        ...
        if (str_contains(other_chars, c)) {
          ...
          if ((allow_escape and str_equals(c, str966))) {
...
Str* Utf8Encode(int code) {
  ...
  return str969->join(tmp);
}
Str* INCOMPLETE_CHAR = str970;
Str* INVALID_CONT = str971;
Str* INVALID_START = str972;
    ...
    if ((tok->id == Id::VOp1_Pound || tok->id == Id::VOp1_DPound)) {
      ...
      if ((tok->id == Id::VOp1_Percent || tok->id == Id::VOp1_DPercent)) {
        ...
        if (tok->id == Id::VOp1_Comma) {
          if (!(str_equals(arg, str973))) {
            e_die(fmt265(ui::PrettyId(tok->id)), tok);
          }
          if (len(s)) {
          ...
          if (tok->id == Id::VOp1_DComma) {
            if (!(str_equals(arg, str975))) {
              e_die(fmt266(ui::PrettyId(tok->id)), tok);
            }
            return s->lower();
          }
          else {
            if (tok->id == Id::VOp1_Caret) {
              if (!(str_equals(arg, str977))) {
                e_die(fmt267(ui::PrettyId(tok->id)), tok);
              }
              if (len(s)) {
              ...
              if (tok->id == Id::VOp1_DCaret) {
                if (!(str_equals(arg, str979))) {
                  e_die(fmt268(ui::PrettyId(tok->id)), tok);
                }
                return s->upper();
              }
              else {
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Slash) {
    try {
      ...
      msg = e->message;
      e_die(fmt270(regex, msg), this->slash_spid);
    }
  }
  if (op->replace_mode == Id::Lit_Pound) {
    regex = str_concat(str985, regex);
  }
  else {
    if (op->replace_mode == Id::Lit_Percent) {
      regex = str_concat(regex, str986);
    }
  }
...
Str* ShellQuoteB(Str* s) {
  ...
  s = s->replace(str987, str988)->replace(str989, str990);
  return pyutil::BackslashEscape(s, str991);
}
...
void TdopParser::Eat(int token_type) {
  if (!this->AtToken(token_type)) {
    p_die(fmt274(ui::PrettyId(token_type), ui::PrettyId(this->op_id)), this->cur_word);
  }
  this->Next();
}
...
int QUOTE_ERE = (1 << 6);
GLOBAL_LIST(Str*, 3, _STRING_AND_ARRAY, {str1004 COMMA str1005 COMMA str1006});
...
runtime_asdl::value_t* DecayArray(runtime_asdl::value_t* val) {
  ...
  if (val->tag_() == value_e::MaybeStrArray) {
    ...
    if (val->tag_() == value_e::AssocArray) {
      value__AssocArray* assoc_val = static_cast<value__AssocArray*>(val);
      s = dict_contains(assoc_val->d, str1007) ? assoc_val->d->index(str1008) : nullptr;
    }
    else {
      throw Alloc<AssertionError>();
    }
...
Str* _BackslashEscape(Str* s) {
  ...
  return s->replace(str1009, str1010);
}
...
runtime_asdl::part_value_t* _ValueToPartValue(runtime_asdl::value_t* val, bool quoted) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      return Alloc<part_value::String>(str1011, quoted, !quoted);
    }
      break;
    case value_e::Str: {
      value__Str* val = static_cast<value__Str*>(UP_val);
...
Str* _GetDollarHyphen(optview::Exec* exec_opts) {
  ...
  chars = Alloc<List<Str*>>();
  if (exec_opts->interactive()) {
    chars->append(str1015);
  }
  if (exec_opts->errexit()) {
    chars->append(str1016);
  }
  if (exec_opts->noglob()) {
    chars->append(str1017);
  }
  if (exec_opts->noexec()) {
    chars->append(str1018);
  }
  if (exec_opts->nounset()) {
    chars->append(str1019);
  }
  if (exec_opts->xtrace()) {
    chars->append(str1020);
  }
  if (exec_opts->noclobber()) {
    chars->append(str1021);
  }
  return str1022->join(chars);
}
...
Str* TildeEvaluator::Eval(syntax_asdl::Token* token) {
  ...
  if (maybe_str_equals(token->val, str1023)) {
    val = this->mem->GetValue(str1024);
    UP_val = val;
    if (val->tag_() == value_e::Str) {
      value__Str* val = static_cast<value__Str*>(UP_val);
      return val->s;
      ...
      if ((tok->id == Id::VTest_ColonEquals || tok->id == Id::VTest_Equals)) {
        ...
        if ((tok->id == Id::VTest_ColonQMark || tok->id == Id::VTest_QMark)) {
          if (is_falsey) {
            ...
            e_die(fmt279(error_str), blame_token);
          }
          else {
            return false;
          }
    ...
    case value_e::Str: {
      ...
      try {
        ...
        if (this->exec_opts->strict_word_eval()) {
          ...
          this->errfmt->PrettyPrintError(e, str1028);
          return Alloc<value::Str>(str1029);
        }
      }
    }
      break;
...
runtime_asdl::value_t* AbstractWordEvaluator::_Slice(runtime_asdl::value_t* val, syntax_asdl::suffix_op__Slice* op, Str* var_name, syntax_asdl::braced_var_sub* part) {
  ...
  try {
    ...
    if (this->exec_opts->strict_word_eval()) {
      ...
      this->errfmt->PrettyPrintError(e, str1035);
      switch (val->tag_()) {
        case value_e::Str: {
          val = Alloc<value::Str>(str1036);
        }
          break;
        case value_e::MaybeStrArray: {
  ...
  if (op_id == Id::VOp0_P) {
    switch (val->tag_()) {
      case value_e::Str: {
        ...
        p = prompt->replace(str1037, str1038)->replace(str1039, str1040);
        result = Alloc<value::Str>(p);
      }
        break;
      default: {
        e_die(fmt282(ui::ValType(val)));
      }
    }
  }
  else {
    if (op_id == Id::VOp0_Q) {
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          result = Alloc<value::Str>(str1042->join(tmp));
        }
          break;
        default: {
          e_die(fmt283(ui::ValType(val)));
        }
      }
    }
    else {
      if (op_id == Id::VOp0_a) {
        ...
        if (var_name != nullptr) {
          ...
          if (cell) {
            if (cell->readonly) {
              chars->append(str1046);
            }
            if (cell->exported) {
              chars->append(str1047);
            }
            if (cell->nameref) {
              chars->append(str1048);
            }
          }
        }
        result = Alloc<value::Str>(str1049->join(chars));
      }
      else {
        e_die(fmt284(op->val), op);
      }
    }
  }
...
runtime_asdl::value_t* AbstractWordEvaluator::_ArrayIndex(runtime_asdl::value_t* val, syntax_asdl::braced_var_sub* part, runtime_asdl::VTestPlace* vtest_place) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      ...
      break;
    case value_e::Str: {
      e_die(fmt287(part->token->val), part->token);
    }
      break;
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* array_val = static_cast<value__MaybeStrArray*>(UP_val);
...
void AbstractWordEvaluator::_EvalDoubleQuoted(List<syntax_asdl::word_part_t*>* parts, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  if (len(parts) == 0) {
    v = Alloc<part_value::String>(str1054, true, false);
    part_vals->append(v);
    return ;
  }
  for (ListIter<syntax_asdl::word_part_t*> it(parts); !it.Done(); it.Next()) {
...
runtime_asdl::value_t* AbstractWordEvaluator::_EmptyStrOrError(runtime_asdl::value_t* val, syntax_asdl::Token* token) {
  ...
  if (!this->exec_opts->nounset()) {
    return Alloc<value::Str>(str1055);
  }
  name = token->val->startswith(str1056) ? token->val->slice(1) : token->val;
  e_die(fmt288(name), token);
}
...
void AbstractWordEvaluator::_EvalExtGlob(syntax_asdl::word_part__ExtGlob* part, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  for (ListIter<syntax_asdl::compound_word*> it(part->arms); !it.Done(); it.Next(), ++i) {
    ...
    StackRoots _for({&w  });
    if (i != 0) {
      part_vals->append(Alloc<part_value::String>(str1067, false, false));
    }
    this->_EvalWordToParts(w, part_vals, EXTGLOB_NESTED);
  }
  part_vals->append(Alloc<part_value::String>(str1068, false, false));
}
    ...
    case word_e::Compound: {
      ...
      if (has_extglob) {
        if (to_bool((eval_flags & EXTGLOB_FILES))) {
          ...
          glob_pat = str1074->join(glob_parts);
          fnmatch_pat = str1075->join(fnmatch_parts);
          results = Alloc<List<Str*>>();
      ...
      break;
    case word_e::Empty: {
      part_vals->append(Alloc<part_value::String>(str1077, quoted, !quoted));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, int eval_flags) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return Alloc<value::Str>(str1081);
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  part_vals = Alloc<List<runtime_asdl::part_value_t*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
  ...
  return Alloc<value::Str>(str1082->join(strs));
}
...
Tuple2<runtime_asdl::value__Str*, bool> AbstractWordEvaluator::EvalWordToPattern(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return (Tuple2<runtime_asdl::value__Str*, bool>(Alloc<value::Str>(str1083), false));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  has_extglob = false;
  part_vals = Alloc<List<runtime_asdl::part_value_t*>>();
  ...
  return (Tuple2<runtime_asdl::value__Str*, bool>(Alloc<value::Str>(str1084->join(strs)), has_extglob));
}
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalForPlugin(syntax_asdl::compound_word* w) {
  ...
  {  // with
    ...
    try {
      ...
      val = Alloc<value::Str>(fmt302(e->UserErrorString()));
    }
    catch (_OSError* e) {
      val = Alloc<value::Str>(fmt303(pyutil::strerror(e)));
    }
    catch (KeyboardInterrupt*) {
      val = Alloc<value::Str>(str1087);
    }
  }
  return val;
}
...
runtime_asdl::value_t* AbstractWordEvaluator::EvalRhsWord(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return Alloc<value::Str>(str1088);
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  if (len(w->parts) == 1) {
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index(-2), str1094)) {
          e_die(fmt305(), w);
        }
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        StackRoots _for({&arg      });
        if ((arg->startswith(str1096) or arg->startswith(str1097))) {
          flags->append(arg);
          flag_spids->append(word_spid);
          if ((str_contains(arg, str1098) or str_contains(arg, str1099))) {
            eval_to_pairs = false;
          }
        }
        else {
...
runtime_asdl::part_value__String* CompletionWordEvaluator::_EvalProcessSub(syntax_asdl::command_sub* cs_part) {
  ...
  return Alloc<part_value::String>(str1104, true, false);
}
...
syntax_asdl::suffix_op__PatSub* WordParser::_ReadPatSubVarOp() {
  ...
  if (this->token_type == Id::Lit_Slash) {
    ...
    this->_Peek();
    if (this->token_type != Id::Right_DollarBrace) {
      p_die(fmt309(ui::PrettyId(this->token_type)), this->cur_token);
    }
    return Alloc<suffix_op::PatSub>(pat, replace, replace_mode);
  }
  p_die(fmt310(), this->cur_token);
}
          ...
          if (op_kind == Kind::VOp2) {
            if (this->token_type == Id::VOp2_Slash) {
              ...
              if (this->token_type == Id::VOp2_Colon) {
                ...
                p_die(fmt317(str1116), this->cur_token);
              }
            }
          }
          else {
            if (op_kind == Kind::VOp3) {
              if (allow_query) {
                ...
                p_die(fmt318(str1118), this->cur_token);
              }
            }
          }
        }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool is_oil_expr) {
  ...
  while (num_end_tokens < expected_end_tokens) {
    ...
    if ((this->token_kind == Kind::Lit || this->token_kind == Kind::Char)) {
      tok = this->cur_token;
      if ((no_backslashes and str_contains(tok->val, str1123))) {
        p_die(fmt323(), tok);
      }
      if (is_oil_expr) {
...
syntax_asdl::word_part_t* WordParser::_ReadUnquotedLeftParts(bool try_triple_quote, List<bool>* triple_out) {
  ...
  if ((this->token_type == Id::Left_DoubleQuote || this->token_type == Id::Left_DollarDoubleQuote)) {
    ...
    if ((try_triple_quote and len(dq_part->parts) == 0)) {
      if (str_equals(this->lexer->ByteLookAhead(), str1129)) {
  ...
  if ((this->token_type == Id::Left_SingleQuote || this->token_type == Id::Left_RSingleQuote || this->token_type == Id::Left_DollarSingleQuote)) {
    ...
    if ((try_triple_quote and len(sq_part->tokens) == 0)) {
      if (str_equals(this->lexer->ByteLookAhead(), str1130)) {
        this->_Next(lex_mode_e::ShCommand);
        this->_Peek();
  ...
  if ((left_id == Id::Left_DollarParen || left_id == Id::Left_AtParen || left_id == Id::Left_ProcSubIn || left_id == Id::Left_ProcSubOut)) {
    ...
    if ((left_id == Id::Left_Backtick and this->parse_ctx->one_pass_parse)) {
      ...
      if (left_id == Id::Left_Backtick) {
        ...
        right_spid = this->cur_token->span_id;
        code_str = str1138->join(parts);
        arena = this->parse_ctx->arena;
        line_reader = reader::StringLineReader(code_str, arena);
        c_parser = this->parse_ctx->MakeOshParser(line_reader);
        src = Alloc<source::Reparsed>(str1139, left_spid, right_spid);
        {  // with
          alloc::ctx_Location ctx(arena, src);
...
void WordParser::ParseProc(syntax_asdl::command__Proc* node) {
  ...
  if (this->token_type != Id::Lit_Chars) {
    p_die(fmt335(ui::PrettyToken(this->cur_token, this->arena)), this->cur_token);
  }
...
syntax_asdl::arith_expr_t* WordParser::_ReadArithExpr(int end_id) {
  ...
  if ((end_id != Id::Undefined_Tok and cur_id != end_id)) {
    p_die(fmt336(ui::PrettyId(cur_id), ui::PrettyId(end_id)), this->a_parser->cur_word);
  }
  return anode;
}
...
syntax_asdl::command__ForExpr* WordParser::ReadForExpression() {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt339(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
  if (cur_id == Id::Arith_Semi) {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt340(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
            ...
            if (this->token_type == Id::Lit_Dollar) {
              if (!this->parse_opts->parse_dollar()) {
                if ((num_parts == 0 and lex_mode == lex_mode_e::ShCommand)) {
                  ...
                  if (str_equals(next_byte, str1155)) {
                    println_stderr(fmt350(next_byte));
                  }
                }
...
Tuple2<syntax_asdl::word_t*, bool> WordParser::_ReadArithWord() {
  ...
  this->_Peek();
  if (this->token_kind == Kind::Unknown) {
    p_die(fmt355(this->cur_token->val), this->cur_token);
  }
  else {
    if (this->token_kind == Kind::Eof) {
          ...
          if ((this->token_kind == Kind::VSub || this->token_kind == Kind::Lit || this->token_kind == Kind::History || this->token_kind == Kind::Left || this->token_kind == Kind::KW || this->token_kind == Kind::ControlFlow || this->token_kind == Kind::BoolUnary || this->token_kind == Kind::BoolBinary || this->token_kind == Kind::ExtGlob)) {
            if (this->token_type == Id::Lit_Pound) {
              ...
              if (this->token_type == Id::Lit_TPound) {
                ...
                if ((this->parse_opts->parse_raw_string() and (this->token_type == Id::Lit_Chars and maybe_str_equals(this->cur_token->val, str1163)))) {
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1168, false));
    }
      break;
    case word_part_e::AssocArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1169, false));
    }
      break;
    case word_part_e::Literal: {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str1171, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str1172->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
    ...
    case word_part_e::FuncCall: 
    case word_part_e::ExprSub: {
      return (Tuple3<bool, Str*, bool>(false, str1173, false));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() != word_e::Compound) {
    return (Tuple3<bool, Str*, bool>(false, str1174, quoted));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  strs = Alloc<List<Str*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str1175, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str1176->join(strs), quoted));
}
...
syntax_asdl::compound_word* TildeDetect(syntax_asdl::word_t* UP_w) {
  ...
  if ((id_ == Id::Lit_Chars and static_cast<Token*>(part1)->val->startswith(str1178))) {
    new_parts->extend(w->parts->slice(1));
    return Alloc<compound_word>(new_parts);
  }
  return nullptr;
...
void TildeDetectAssign(syntax_asdl::compound_word* w) {
  ...
  for (int i = 0; i < n; ++i) {
    ...
    if ((do_expand and LiteralId(cur) == Id::Lit_TildeLike)) {
      ...
      if (next_part) {
        is_tilde = (LiteralId(next_part) == Id::Lit_Colon or (LiteralId(next_part) == Id::Lit_Chars and static_cast<Token*>(next_part)->val->startswith(str1179)));
      }
      else {
        is_tilde = true;
      }
...
Str* escape(Str* s) {
  ...
  s = s->replace(str1189, str1190);
  s = s->replace(str1191, str1192);
  s = s->replace(str1193, str1194);
  return s;
}
...
Str* join(Str* s1, Str* s2) {
  ...
  if ((s2->startswith(str1197) or len(s1) == 0)) {
    return s2;
  }
  if (s1->endswith(str1198)) {
...
Tuple2<Str*, Str*> _splitext(Str* p, Str* sep, Str* extsep) {
  ...
  return (Tuple2<Str*, Str*>(p, str1201));
}
...
Str* normpath(Str* path) {
  ...
  slash = str1204;
  dot = str1205;
  if (str_equals(path, str1206)) {
    return dot;
  }
  initial_slashes = path->startswith(str1207);
  if ((initial_slashes and (path->startswith(str1208) and !path->startswith(str1209)))) {
    initial_slashes = 2;
  }
  comps = path->split(str1210);
  new_comps = Alloc<List<Str*>>();
  for (ListIter<Str*> it(comps); !it.Done(); it.Next()) {
    Str* comp = it.Value();
    StackRoots _for({&comp  });
    if ((len(comp) == 0 or str_equals(comp, str1211))) {
      continue;
    }
    if ((!(str_equals(comp, str1212)) or ((initial_slashes == 0 and len(new_comps) == 0) or (len(new_comps) and str_equals(new_comps->index(-1), str1213))))) {
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if ((str_contains(str1220, ch) or IsUnprintableLow(ch))) {
        quote = 2;
        break;
      }
    }
  ...
  parts->append(str1223);
  return str_concat(prefix, str1224->join(parts));
}
...
Str* maybe_encode(Str* s, int bit8_display) {
  ...
  parts = Alloc<List<Str*>>();
  parts->append(str1225);
  _encode(s, bit8_display, false, parts);
  parts->append(str1226);
  return str1227->join(parts);
}
...
Str* encode(Str* s, int bit8_display) {
  ...
  parts = Alloc<List<Str*>>();
  parts->append(str1228);
  _encode(s, bit8_display, false, parts);
  parts->append(str1229);
  return str1230->join(parts);
}
...
void _encode_bytes_x(Str* s, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (str_equals(byte, str1231)) {
      part = str1232;
    }
    else {
      if (str_equals(byte, str1233)) {
        part = str1234;
      }
      else {
        if (str_equals(byte, str1235)) {
          part = str1236;
        }
        else {
          if (str_equals(byte, str1237)) {
            part = str1238;
          }
          else {
            if (str_equals(byte, str1239)) {
              part = str1240;
            }
            else {
              if (str_equals(byte, str1241)) {
                part = shell_compat ? str1242 : str1243;
              }
              else {
            ...
            if (str_equals(byte, str1253)) {
              ...
              if (str_equals(byte, str1255)) {
                ...
                if (str_equals(byte, str1257)) {
                  out = shell_compat ? str1258 : str1259;
                }
                else {
                  if (IsUnprintableLow(byte)) {
...
syntax_asdl::word__String* _StringWordEmitter::ReadWord(types_asdl::lex_mode_t unused_lex_mode) {
  ...
  if (this->i == this->n) {
    w = Alloc<word::String>(Id::Eof_Real, str1260, runtime::NO_SPID);
    return w;
  }
...
syntax_asdl::bool_expr_t* _TwoArgs(builtin_bracket::_StringWordEmitter* w_parser) {
  ...
  w1 = w_parser->Read();
  s0 = w0->s;
  if (maybe_str_equals(s0, str1261)) {
    return Alloc<bool_expr::LogicalNot>(Alloc<bool_expr::WordTest>(w1));
  }
  unary_id = Id::Undefined_Tok;
  if (w0->s->startswith(str1262)) {
    if (maybe_str_equals(s0, str1263)) {
      unary_id = Id::BoolUnary_d;
    }
    else {
      if (maybe_str_equals(s0, str1264)) {
        unary_id = Id::BoolUnary_e;
      }
      else {
        if (maybe_str_equals(s0, str1265)) {
          unary_id = Id::BoolUnary_f;
        }
        else {
          if (maybe_str_equals(s0, str1266)) {
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    ...
    strs = cmd_val->argv;
    if ((!strs or !(str_equals(strs->index(-1), str1275)))) {
      this->errfmt->Print_(str1276, cmd_val->arg_spids->index(0));
      return 2;
    }
    cmd_val->argv->pop();
  ...
  try {
    ...
    if (n == 4) {
      a0 = w_parser->Peek(0);
      if (str_equals(a0, str1278)) {
        w_parser->Read();
        child = _ThreeArgs(w_parser);
        bool_node = Alloc<bool_expr::LogicalNot>(child);
      }
      else {
        if ((str_equals(a0, str1279) and str_equals(w_parser->Peek(3), str1280))) {
          w_parser->Read();
          bool_node = _TwoArgs(w_parser);
        }
        else {
    ...
    this->errfmt->PrettyPrintError(e, str1281);
    return 2;
  }
  ...
  try {
    ...
    this->errfmt->PrettyPrintError(e, str1282);
    return 2;
  }
  status = b ? 0 : 1;
  return status;

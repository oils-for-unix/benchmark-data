...
List<int>* STRICT_ALL = new List<int>({3, 21, 2, 20, 43, 4, 22, 23, 24, 32, 25, 26, 27, 28, 33, 29, 31, 30});
List<int>* OIL_BASIC = new List<int>({35, 3, 21, 36, 2, 20, 38, 39, 43, 40, 41, 42, 4, 37, 34, 22, 23, 24, 32, 25, 26, 27, 28, 33, 29, 31, 30});
List<int>* OIL_ALL = new List<int>({35, 3, 21, 36, 2, 20, 38, 39, 45, 43, 40, 41, 42, 44, 4, 37, 34, 22, 23, 24, 32, 25, 26, 27, 28, 33, 29, 31, 30});
List<int>* DEFAULT_TRUE = new List<int>({35, 3, 43, 19});
List<int>* PARSE_OPTION_NUMS = new List<int>({38, 39, 17, 45, 43, 40, 41, 42, 44, 46});
List<int>* SHOPT_OPTION_NUMS = new List<int>({53, 54, 55, 56, 57, 58, 59, 52, 18, 60, 35, 61, 62, 63, 16, 64, 47, 65, 15, 66, 14, 67, 68, 69, 70, 50, 71, 72, 51, 73, 21, 74, 48, 75, 76, 77, 78, 79, 36, 80, 81, 82, 20, 38, 39, 17, 45, 43, 40, 41, 42, 44, 46, 49, 83, 84, 85, 86, 37, 34, 87, 22, 23, 24, 32, 25, 26, 27, 28, 33, 29, 31, 30, 19, 88});
...
Kind GetKind(id_kind_asdl::Id_t id) {
  ...
  case Id::Left_PercentBrace: return Kind::Left;
  case Id::Left_PercentBracket: return Kind::Left;
...
builtin_t LookupNormalBuiltin(Str* s) {
  ...
  case '[':
    ...
    break;
  case '_':
    if (len == 5 && memcmp("__cat", data, 5) == 0) return 58;
    break;
  case 'a':
  ...
  case 'g':
    ...
    if (len == 7 && memcmp("getline", data, 7) == 0) return 53;
    break;
  case 'h':
  ...
  case 'm':
    ...
    break;
  case 'o':
    if (len == 4 && memcmp("opts", data, 4) == 0) return 57;
    break;
  case 'p':
  ...
  case 'r':
    ...
    if (len == 4 && memcmp("repr", data, 4) == 0) return 55;
    break;
  case 's':
  ...
  case 'u':
    ...
    if (len == 3 && memcmp("use", data, 3) == 0) return 56;
    break;
  case 'w':
...
bool IsKeyword(Str* s) {
  ...
  case 'p':
    ...
    if (len == 4 && memcmp("pass", data, 4) == 0) return true;
    break;
  case 's':
  ...
  case 'u':
    ...
    if (len == 3 && memcmp("use", data, 3) == 0) return true;
    break;
  case 'v':

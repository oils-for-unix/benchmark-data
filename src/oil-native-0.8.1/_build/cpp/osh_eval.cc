...
Str* str40 = new Str("PATH");
Str* str41 = new Str("/bin");
Str* str42 = new Str("osh");
Str* str43 = new Str("oil: %s");
Str* str44 = new Str("osh fatal error: %s");
Str* str45 = new Str("");
Str* str46 = new Str("osh I/O error: %s");
Str* str47 = new Str("-c flag");
...
Str* str65 = new Str("Invalid control flow %r in pipeline / subshell / background");
Str* str66 = new Str("%r ");
Str* str67 = new Str("");
Str* str68 = new Str("Command evaluated to an empty argv array");
Str* str69 = new Str("Can't run assignment builtin recursively");
Str* str70 = new Str("can't disable errexit running a function. Maybe wrap the function in a process with the at-splice pattern.");
Str* str71 = new Str("Unexpected block passed to external command %r");
Str* str72 = new Str("%r not found");
Str* str73 = new Str("[%%%d] Started Pipeline with PID %d");
Str* str74 = new Str("[%%%d] Started PID %d");
Str* str75 = new Str("__cat");
Str* str76 = new Str("Command sub exited with status %d (%s)");
Str* str77 = new Str("");
Str* str78 = new Str("\n");
Str* str79 = new Str("/dev/fd/%d");
Str* str80 = new Str("/dev/fd/%d");
Str* str81 = new Str("<_FdFrame %s>");
Str* str82 = new Str("r");
Str* str83 = new Str("%d: %s");
Str* str84 = new Str("%d: %s");
Str* str85 = new Str("%d: %s");
Str* str86 = new Str("Can't open %r: %s");
Str* str87 = new Str("Error closing descriptor %d: %s");
Str* str88 = new Str("dup2(%d, %d) error: %s");
Str* str89 = new Str("<StdinFromPipe %d %d>");
Str* str90 = new Str("<StdoutToPipe %d %d>");
Str* str91 = new Str("/bin/sh");
Str* str92 = new Str("/bin/sh");
Str* str93 = new Str("Can't execute %r: %s");
Str* str94 = new Str("[process] %s");
Str* str95 = new Str(" ");
Str* str96 = new Str("[subprog] %s");
Str* str97 = new Str("");
Str* str98 = new Str("osh I/O error: %s");
Str* str99 = new Str("[here doc writer]");
Str* str100 = new Str("<Process %s>");
Str* str101 = new Str("Fatal error in posix.fork()");
Str* str102 = new Str("<Pipeline %s>");
Str* str103 = new Str(" ");
Str* str104 = new Str("JobState MaybeRemove %d");
Str* str105 = new Str("osh: PID %d stopped, but osh didn't start it");
Str* str106 = new Str("");
Str* str107 = new Str("");
Str* str108 = new Str("[PID %d] Stopped");
Str* str109 = new Str("");
Str* str110 = new Str("main");
Str* str111 = new Str("osh usage error: %s");
Str* str112 = new Str("%s-usage");
Str* str113 = new Str("Oil");
Str* str114 = new Str("main");
Str* str115 = new Str("oil");
Str* str116 = new Str("oil:all");
Str* str117 = new Str("--one-pass-parse requires noexec (-n)");
Str* str118 = new Str("completion");
Str* str119 = new Str("history");
Str* str120 = new Str("");
Str* str121 = new Str("OSH_DEBUG_DIR");
Str* str122 = new Str("%d-osh.log");
Str* str123 = new Str("Writing logs to %r");
Str* str124 = new Str("OSH_HIJACK_SHEBANG");
Str* str125 = new Str("");
Str* str126 = new Str("OSH_CRASH_DUMP_DIR");
Str* str127 = new Str("");
Str* str128 = new Str("");
Str* str129 = new Str("osh: Couldn't open %r: %s");
Str* str130 = new Str("/proc/%d/status");
Str* str131 = new Str("--parser-mem-dump can only be used with -n");
Str* str132 = new Str("/proc/%d/status");
Str* str133 = new Str("can't disable errexit running a function. Maybe wrap the function in a process with the at-splice pattern.");
Str* str134 = new Str("Unhandled SimpleCommand");
Str* str135 = new Str("\n");
Str* str136 = new Str(" \t\n\"'><=;|&(:");
Str* str137 = new Str("/");
Str* str138 = new Str("PATH");
Str* str139 = new Str(":");
Str* str140 = new Str("<ErrExit %s %s>");
Str* str141 = new Str("got invalid option %r");
Str* str142 = new Str("doesn't own option %r (try 'set')");
Str* str143 = new Str("got invalid option %r");
Str* str144 = new Str("doesn't own option %r (try 'shopt')");
Str* str145 = new Str("SHELLOPTS");
Str* str146 = new Str(":");
Str* str147 = new Str("Syntax options must be set at the top level (outside any function)");
Str* str148 = new Str("Warning: set -o verbose not implemented");
Str* str149 = new Str("SHELLOPTS");
Str* str150 = new Str("%s:%s");
Str* str151 = new Str("SHELLOPTS");
Str* str152 = new Str(":");
Str* str153 = new Str(":");
Str* str154 = new Str("SHELLOPTS");
Str* str155 = new Str("oil:basic");
Str* str156 = new Str("oil:all");
Str* str157 = new Str("strict:all");
Str* str158 = new Str("errexit");
Str* str159 = new Str("set %so %s");
Str* str160 = new Str("-");
Str* str161 = new Str("+");
Str* str162 = new Str("got invalid option %r");
Str* str163 = new Str("shopt -%s %s");
Str* str164 = new Str("s");
Str* str165 = new Str("u");
Str* str166 = new Str("<_ArgFrame %s %d at %x>");
Str* str167 = new Str("Can't determine working directory: %s");
Str* str168 = new Str("IFS");
Str* str169 = new Str("UID");
Str* str170 = new Str("EUID");
Str* str171 = new Str("PPID");
Str* str172 = new Str("HOSTNAME");
Str* str173 = new Str("OSTYPE");
Str* str174 = new Str("OPTIND");
Str* str175 = new Str("1");
Str* str176 = new Str("PS4");
Str* str177 = new Str("+ ");
Str* str178 = new Str("COMP_WORDBREAKS");
Str* str179 = new Str("SHELLOPTS");
Str* str180 = new Str("SHELLOPTS");
Str* str181 = new Str("");
Str* str182 = new Str("SHELLOPTS");
Str* str183 = new Str("PWD");
Str* str184 = new Str("PWD");
Str* str185 = new Str("PWD");
Str* str186 = new Str("OIL_VERSION");
Str* str187 = new Str("PWD");
Str* str188 = new Str("");
Str* str189 = new Str("<Mem");
Str* str190 = new Str("  -- %d --");
Str* str191 = new Str("  %s %s");
Str* str192 = new Str(">");
Str* str193 = new Str("\n");
Str* str194 = new Str("\n");
Str* str195 = new Str("Warning: span_id undefined in SetCurrentSpanId");
Str* str196 = new Str("nameref %r is undefined");
Str* str197 = new Str("nameref %r contains invalid variable name %r");
Str* str198 = new Str("%r has already been declared");
Str* str199 = new Str("%r hasn't been declared");
Str* str200 = new Str("nameref cycle: %s");
Str* str201 = new Str(" -> ");
Str* str202 = new Str("Can't assign to readonly value %r");
Str* str203 = new Str("Only strings can be exported");
Str* str204 = new Str("nameref must be a string");
Str* str205 = new Str("Can't assign to readonly array");
Str* str206 = new Str("Can't assign to items in a string");
Str* str207 = new Str("Value of type %s can't be indexed");
Str* str208 = new Str("Can't assign to readonly associative array");
Str* str209 = new Str("ARGV");
Str* str210 = new Str("PIPESTATUS");
Str* str211 = new Str("FUNCNAME");
Str* str212 = new Str("source");
Str* str213 = new Str("BASH_SOURCE");
Str* str214 = new Str("BASH_LINENO");
Str* str215 = new Str("0");
Str* str216 = new Str("LINENO");
Str* str217 = new Str("BASHPID");
Str* str218 = new Str("Can't unset readonly variable %r");
Str* str219 = new Str("%r isn't an array");
Str* str220 = new Str("$%s isn't defined");
Str* str221 = new Str("$%s should be a string");
Str* str222 = new Str("$%s should be a string, got %s");
Str* str223 = new Str("$%s doesn't look like an integer, got %r");
Str* str224 = new Str("EOF");
Str* str225 = new Str("/");
Str* str226 = new Str("~");
Str* str227 = new Str("  ");
Str* str228 = new Str("\n  ");
...
Str* str233 = new Str("~");
Str* str234 = new Str("\n");
Str* str235 = new Str("[ interactive ]");
Str* str236 = new Str("[ -c flag ]");
Str* str237 = new Str("[ stdin%s ]");
Str* str238 = new Str("[ expansion of alias %r ]");
Str* str239 = new Str("[ backticks at ... ]");
Str* str240 = new Str("[ array LValue in %s ]");
Str* str241 = new Str("[ eval at line %d of %s ]");
Str* str242 = new Str("[ trap ]");
Str* str243 = new Str("[ variable ]");
Str* str244 = new Str("%s:%d: %s%s\n");
Str* str245 = new Str("[??? no location ???] %s%s\n");
Str* str246 = new Str("");
Str* str247 = new Str("");
Str* str248 = new Str("");
Str* str249 = new Str("none");
Str* str250 = new Str("AST not printed.");
Str* str251 = new Str("text");
Str* str252 = new Str("abbrev-text");
Str* str253 = new Str("html");
Str* str254 = new Str("abbrev-html");
Str* str255 = new Str("abbrev-");
Str* str256 = new Str("\n");
Str* str257 = new Str("\n");
Str* str258 = new Str("-");
Str* str259 = new Str("_");
Str* str260 = new Str("<_Attributes %s>");
Str* str261 = new Str("<args.Reader %r %d>");
Str* str262 = new Str("expected argument to %r");
Str* str263 = new Str("-");
Str* str264 = new Str("expected integer after %s, got %r");
Str* str265 = new Str("-");
Str* str266 = new Str("got invalid integer for %s: %s");
Str* str267 = new Str("-");
Str* str268 = new Str("expected number after %r, got %r");
Str* str269 = new Str("-");
Str* str270 = new Str("got invalid float for %s: %s");
Str* str271 = new Str("-");
Str* str272 = new Str("got invalid argument %r to %r, expected one of: %s");
Str* str273 = new Str("-");
Str* str274 = new Str("|");
Str* str275 = new Str("0");
Str* str276 = new Str("F");
Str* str277 = new Str("false");
Str* str278 = new Str("False");
Str* str279 = new Str("1");
Str* str280 = new Str("T");
Str* str281 = new Str("true");
Str* str282 = new Str("Talse");
Str* str283 = new Str("got invalid argument to boolean flag: %r");
Str* str284 = new Str("-");
Str* str285 = new Str("-");
Str* str286 = new Str("got invalid option %r");
Str* str287 = new Str("Expected argument for action");
Str* str288 = new Str("Invalid action name %r");
Str* str289 = new Str("--");
Str* str290 = new Str("-");
Str* str291 = new Str("-");
Str* str292 = new Str("doesn't accept flag %s");
Str* str293 = new Str("-");
Str* str294 = new Str("+");
Str* str295 = new Str("+");
Str* str296 = new Str("doesn't accept option %s");
Str* str297 = new Str("+");
Str* str298 = new Str("-");
Str* str299 = new Str("--");
Str* str300 = new Str("--");
Str* str301 = new Str("got invalid flag %r");
Str* str302 = new Str("-");
Str* str303 = new Str("+");
Str* str304 = new Str("got invalid flag %r");
Str* str305 = new Str("-");
Str* str306 = new Str("^--?([a-zA-Z0-9][a-zA-Z0-9\\-]*)(=.*)?$");
Str* str307 = new Str("<LineLexer at pos %d of line %r (id = %d)>");
Str* str308 = new Str("");
Str* str309 = new Str("");
Str* str310 = new Str("");
Str* str311 = new Str("<Trail %s %s %s %s>");
Str* str312 = new Str("");
Str* str313 = new Str("ShAssignment expression can't be nested like this");
Str* str314 = new Str("Here docs aren't allowed in expressions");
Str* str315 = new Str("\n");
Str* str316 = new Str("");
Str* str317 = new Str(" (%s)");
Str* str318 = new Str("Unexpected token in expression mode%s");
Str* str319 = new Str("Syntax error in expression (near %s)");
Str* str320 = new Str("alnum");
Str* str321 = new Str("cntrl");
Str* str322 = new Str("lower");
Str* str323 = new Str("space");
Str* str324 = new Str("alpha");
Str* str325 = new Str("digit");
Str* str326 = new Str("print");
Str* str327 = new Str("upper");
Str* str328 = new Str("blank");
Str* str329 = new Str("graph");
Str* str330 = new Str("punct");
Str* str331 = new Str("xdigit");
Str* str332 = new Str("Range start/end shouldn't have more than one character");
Str* str333 = new Str("Write singleton tuples with tup(), not a trailing comma");
Str* str334 = new Str("testlist_comp");
Str* str335 = new Str("PNode type %d (%s) wasn't handled");
Str* str336 = new Str("Can't assign to this expression");
Str* str337 = new Str("PNode type %d (%s) wasn't handled");
Str* str338 = new Str("TODO");
Str* str339 = new Str("dot");
Str* str340 = new Str("Can't negate this symbol");
Str* str341 = new Str("%r isn't a character class");
Str* str342 = new Str("Can't negate this symbol");
Str* str343 = new Str("%r isn't a character class");
Str* str344 = new Str("%start");
Str* str345 = new Str("%end");
Str* str346 = new Str("dot");
Str* str347 = new Str("Unexpected token %r in regex");
Str* str348 = new Str("%s-%s");
Str* str349 = new Str("ERE can't express code point %d");
Str* str350 = new Str("Perl classes can't be negated in ERE");
Str* str351 = new Str("%s");
Str* str352 = new Str("POSIX classes can't be negated in ERE");
Str* str353 = new Str("[:%s:]");
Str* str354 = new Str(".");
Str* str355 = new Str("^");
Str* str356 = new Str("$");
Str* str357 = new Str("|");
Str* str358 = new Str("POSIX EREs don't have groups without capture, so this node needs () around it.");
Str* str359 = new Str("+");
Str* str360 = new Str("*");
Str* str361 = new Str("?");
Str* str362 = new Str("{%s}");
Str* str363 = new Str("");
Str* str364 = new Str("");
Str* str365 = new Str("{%s,%s}");
Str* str366 = new Str("(");
Str* str367 = new Str(")");
Str* str368 = new Str("[^%s]");
Str* str369 = new Str("[%s]");
Str* str370 = new Str("[^[:%s:]]");
Str* str371 = new Str("[[:%s:]]");
Str* str372 = new Str("[");
Str* str373 = new Str("^");
Str* str374 = new Str("]");
Str* str375 = new Str("The [ operator doesn't apply to this expression");
Str* str376 = new Str("Expected ]]");
Str* str377 = new Str("Unexpected trailing word %s");
Str* str378 = new Str("Invalid argument to unary operator");
Str* str379 = new Str("Expected ), got %s");
Str* str380 = new Str("Unexpected token in boolean expression (%s)");
Str* str381 = new Str("");
Str* str382 = new Str("Expected %d, got %d");
Str* str383 = new Str("Step can't be 0");
Str* str384 = new Str("Invalid step %d for ascending integer range");
Str* str385 = new Str("Invalid step %d for descending integer range");
Str* str386 = new Str("Invalid step %d for ascending character range");
Str* str387 = new Str("Invalid step %d for descending character range");
Str* str388 = new Str("Mismatched cases in character range");
Str* str389 = new Str("");
Str* str390 = new Str("0");
Str* str391 = new Str("0");
Str* str392 = new Str("g");
Str* str393 = new Str("a");
Str* str394 = new Str("A");
Str* str395 = new Str("n");
Str* str396 = new Str("r");
Str* str397 = new Str("x");
Str* str398 = new Str("%s=%s");
Str* str399 = new Str("-");
Str* str400 = new Str("+");
Str* str401 = new Str("-");
Str* str402 = new Str("+");
Str* str403 = new Str("-");
Str* str404 = new Str("+");
Str* str405 = new Str("n");
Str* str406 = new Str("r");
Str* str407 = new Str("x");
Str* str408 = new Str("a");
Str* str409 = new Str("A");
Str* str410 = new Str("-");
Str* str411 = new Str("declare -");
Str* str412 = new Str("");
Str* str413 = new Str(" ");
Str* str414 = new Str("=");
Str* str415 = new Str("=()");
...
Str* str429 = new Str(")");
Str* str430 = new Str("");
Str* str431 = new Str("export_");
Str* str432 = new Str("doesn't accept -f because it's dangerous.  (The code can usually be restructured with 'source')");
Str* str433 = new Str("doesn't accept RHS with -n");
Str* str434 = new Str("Got -a but RHS isn't an array");
Str* str435 = new Str("Got -A but RHS isn't an associative array");
Str* str436 = new Str("readonly");
Str* str437 = new Str("new_var");
Str* str438 = new Str("passed -f without args");
Str* str439 = new Str("declare -f %s");
Str* str440 = new Str("-");
Str* str441 = new Str("-");
Str* str442 = new Str("-");
Str* str443 = new Str("+");
Str* str444 = new Str("+");
Str* str445 = new Str("+");
Str* str446 = new Str("Invalid unset expression");
Str* str447 = new Str("expected a variable name.  shopt -s eval_unsafe_arith allows expressions");
Str* str448 = new Str("unset");
Str* str449 = new Str("Invalid shift argument %r");
Str* str450 = new Str("got too many arguments");
Str* str451 = new Str("eval");
Str* str452 = new Str("requires code string");
Str* str453 = new Str("requires exactly 1 argument");
Str* str454 = new Str(" ");
Str* str455 = new Str("source");
Str* str456 = new Str("missing required argument");
Str* str457 = new Str("source %r failed: %s");
Str* str458 = new Str("command");
Str* str459 = new Str("Can't run assignment builtin recursively");
Str* str460 = new Str("%r isn't a shell builtin");
Str* str461 = new Str("function");
Str* str462 = new Str("alias");
Str* str463 = new Str("builtin");
Str* str464 = new Str("builtin");
Str* str465 = new Str("builtin");
Str* str466 = new Str("keyword");
Str* str467 = new Str("keyword");
Str* str468 = new Str("file");
Str* str469 = new Str("type");
Str* str470 = new Str("type: %r not found");
Str* str471 = new Str("file");
Str* str472 = new Str("file");
Str* str473 = new Str("%s is a %s");
Str* str474 = new Str("function");
Str* str475 = new Str("");
Str* str476 = new Str("read");
Str* str477 = new Str("read -t isn't implemented (except t=0)");
Str* str478 = new Str("");
Str* str479 = new Str("REPLY");
Str* str480 = new Str("REPLY");
Str* str481 = new Str("\u0000");
Str* str482 = new Str("\n");
Str* str483 = new Str("");
Str* str484 = new Str("mapfile");
Str* str485 = new Str("MAPFILE");
Str* str486 = new Str("\n");
Str* str487 = new Str("cd");
Str* str488 = new Str("HOME");
Str* str489 = new Str("HOME");
Str* str490 = new Str("-");
Str* str491 = new Str("OLDPWD");
Str* str492 = new Str("PWD");
Str* str493 = new Str("cd %r: %s");
Str* str494 = new Str("PWD");
Str* str495 = new Str("OLDPWD");
Str* str496 = new Str("%2d  %s");
Str* str497 = new Str(" ");
Str* str498 = new Str("pushd: no other directory");
Str* str499 = new Str("got too many arguments");
Str* str500 = new Str("pushd: %r: %s");
Str* str501 = new Str("HOME");
Str* str502 = new Str("PWD");
Str* str503 = new Str("popd: directory stack is empty");
Str* str504 = new Str("popd: %r: %s");
Str* str505 = new Str("PWD");
Str* str506 = new Str("got extra argument");
Str* str507 = new Str("HOME");
Str* str508 = new Str("dirs");
Str* str509 = new Str("HOME");
Str* str510 = new Str("pwd");
Str* str511 = new Str("_devbuild/help/groups.txt");
Str* str512 = new Str("help");
Str* str513 = new Str("help");
Str* str514 = new Str("_devbuild/help/%s");
Str* str515 = new Str("no help topics match %r");
Str* str516 = new Str("# +");
Str* str517 = new Str("osh printf doesn't support the %r flag");
Str* str518 = new Str("eEfFgG");
Str* str519 = new Str("osh printf doesn't support floating point");
Str* str520 = new Str("c");
Str* str521 = new Str("osh printf doesn't support single characters (bytes)");
Str* str522 = new Str("Invalid printf format character");
Str* str523 = new Str("Expected a printf format character");
Str* str524 = new Str("fsT");
Str* str525 = new Str("printf precision can't be specified with type %r");
Str* str526 = new Str("printf");
Str* str527 = new Str("requires a format string");
Str* str528 = new Str("%");
Str* str529 = new Str("");
Str* str530 = new Str("printf got invalid width %r");
Str* str531 = new Str("0");
Str* str532 = new Str("");
Str* str533 = new Str("printf got invalid precision %r");
Str* str534 = new Str("");
Str* str535 = new Str("s");
Str* str536 = new Str("q");
Str* str537 = new Str("b");
Str* str538 = new Str("");
Str* str539 = new Str("diouxX");
Str* str540 = new Str("'\"");
Str* str541 = new Str("printf expected an integer, got %r");
Str* str542 = new Str("di");
Str* str543 = new Str("ouxX");
Str* str544 = new Str("Can't format negative number %d with %%%s");
Str* str545 = new Str("u");
Str* str546 = new Str("o");
Str* str547 = new Str("x");
Str* str548 = new Str("X");
Str* str549 = new Str("TZ");
Str* str550 = new Str("TZ");
Str* str551 = new Str("-");
Str* str552 = new Str(" ");
Str* str553 = new Str("0");
Str* str554 = new Str("0");
Str* str555 = new Str(" ");
Str* str556 = new Str("");
Str* str557 = new Str("Invalid -v expression");
Str* str558 = new Str("-v expected a variable name.  shopt -s eval_unsafe_arith allows expressions");
Str* str559 = new Str("alias");
Str* str560 = new Str("alias %s=%r");
Str* str561 = new Str("=");
Str* str562 = new Str("No alias named %r");
Str* str563 = new Str("alias %s=%r");
Str* str564 = new Str("unalias");
Str* str565 = new Str("requires an argument");
Str* str566 = new Str("No alias named %r");
Str* str567 = new Str("%s=%s");
Str* str568 = new Str("set");
Str* str569 = new Str("shopt");
Str* str570 = new Str("hash");
Str* str571 = new Str("got extra arguments after -r");
Str* str572 = new Str("hash: %r not found");
Str* str573 = new Str(":");
Str* str574 = new Str("OPTIND");
Str* str575 = new Str("OPTIND");
Str* str576 = new Str("OPTARG");
Str* str577 = new Str("OPTARG");
Str* str578 = new Str("");
Str* str579 = new Str("?");
Str* str580 = new Str("-");
Str* str581 = new Str("-");
Str* str582 = new Str("?");
Str* str583 = new Str("?");
Str* str584 = new Str("getopts: option %r requires an argument.");
Str* str585 = new Str("(getopts argv: %s)");
Str* str586 = new Str(" ");
Str* str587 = new Str("?");
Str* str588 = new Str("");
Str* str589 = new Str("requires an argspec");
Str* str590 = new Str("requires the name of a variable to set");
Str* str591 = new Str("got invalid variable name %r");
Str* str592 = new Str("echo");
Str* str593 = new Str("");
Str* str594 = new Str("takes at most one arg when strict_echo is on (hint: add quotes)");
Str* str595 = new Str(" ");
Str* str596 = new Str("\n");
Str* str597 = new Str("Assignment builtin %r not configured");
Str* str598 = new Str("%r ");
Str* str599 = new Str("");
Str* str600 = new Str("command in ");
Str* str601 = new Str("assignment in ");
Str* str602 = new Str("subshell invoked from ");
Str* str603 = new Str("pipeline invoked from ");
Str* str604 = new Str("");
Str* str605 = new Str("Exiting with status %d (%sPID %d)");
Str* str606 = new Str("Redirect filename can't be empty");
Str* str607 = new Str("Redirect descriptor can't be empty");
Str* str608 = new Str("-");
Str* str609 = new Str("-");
Str* str610 = new Str("Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
Str* str611 = new Str("\n");
Str* str612 = new Str("Unknown redirect op");
Str* str613 = new Str("Unknown redirect type");
Str* str614 = new Str("TODO: trace string for assignment");
Str* str615 = new Str("ShAssignment builtins don't accept blocks");
Str* str616 = new Str("|& isn't supported");
Str* str617 = new Str("Can't append array to string");
Str* str618 = new Str("Can't append string to array");
Str* str619 = new Str("%r expected a number, got %r");
Str* str620 = new Str("Invalid control flow at top level");
Str* str621 = new Str("warning: ");
Str* str622 = new Str("errexit is disabled here, but strict_errexit disallows it with a compound command (%s)");
Str* str623 = new Str("Loop and control flow can't be in different processes");
Str* str624 = new Str("fatal: ");
Str* str625 = new Str("EXIT");
Str* str626 = new Str("Unexpected %r (in function call)");
Str* str627 = new Str("Attempted to exit from completion hook.");
Str* str628 = new Str("Couldn't find terminator for here doc that starts here");
Str* str629 = new Str("\t");
Str* str630 = new Str("Invalid here doc delimiter");
Str* str631 = new Str("+");
Str* str632 = new Str("+");
Str* str633 = new Str("+");
Str* str634 = new Str("%d != %d");
Str* str635 = new Str("Environment binding shouldn't look like an array assignment");
Str* str636 = new Str("+");
Str* str637 = new Str("Expected = in environment binding, got +=");
Str* str638 = new Str("Environment bindings can't contain array literals");
Str* str639 = new Str("Expected word type %s, got %s");
Str* str640 = new Str("{");
Str* str641 = new Str("}");
Str* str642 = new Str("Invalid token after redirect operator");
Str* str643 = new Str(" ");
Str* str644 = new Str(" ");
Str* str645 = new Str("line IDs %d != %d");
Str* str646 = new Str(" ");
Str* str647 = new Str("");
Str* str648 = new Str("Unexpected block");
Str* str649 = new Str("=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
Str* str650 = new Str("name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
Str* str651 = new Str("Unexpected block");
Str* str652 = new Str("Unexpected block");
Str* str653 = new Str("Control flow shouldn't have redirects");
Str* str654 = new Str("Control flow shouldn't have environment bindings");
Str* str655 = new Str("Unexpected argument to %r");
Str* str656 = new Str("Invalid word in for loop");
Str* str657 = new Str("Invalid word after for expression");
Str* str658 = new Str("Loop variable name should be a constant");
Str* str659 = new Str("Invalid loop variable name");
Str* str660 = new Str("Unexpected word after for loop variable");
Str* str661 = new Str("Expected ;; or esac");
Str* str662 = new Str("Unexpected word while parsing compound command");
Str* str663 = new Str("Invalid function name");
Str* str664 = new Str("Expected ) in function definition");
Str* str665 = new Str("Invalid KSH-style function name");
Str* str666 = new Str("Unexpected word when parsing command");
Str* str667 = new Str("Unexpected right brace");
Str* str668 = new Str("Unexpected EOF while parsing command");
Str* str669 = new Str("Invalid word while parsing command");
Str* str670 = new Str("Unexpected word while parsing command line");
Str* str671 = new Str("Unterminated here doc began here");
Str* str672 = new Str("\\");
Str* str673 = new Str("*");
Str* str674 = new Str("?");
Str* str675 = new Str("[");
...
Str* str679 = new Str("\\?*+{}^$.()|");
Str* str680 = new Str("\\");
Str* str681 = new Str("Unexpected escaped character %r");
Str* str682 = new Str("");
Str* str683 = new Str("");
Str* str684 = new Str("Malformed character class; treating as literal");
Str* str685 = new Str("Got unescaped right bracket");
Str* str686 = new Str("Got unescaped trailing backslash");
Str* str687 = new Str(".|^$()+*?[]{}\\");
Str* str688 = new Str("\\");
Str* str689 = new Str("\\");
Str* str690 = new Str("\\[");
...
Str* str702 = new Str("]");
Str* str703 = new Str("");
Str* str704 = new Str("Error expanding glob %r: %s");
Str* str705 = new Str("-");
Str* str706 = new Str("<Error: unbalanced \\[ and \\]> ");
Str* str707 = new Str("$");
Str* str708 = new Str("#");
Str* str709 = new Str("$");
Str* str710 = new Str("hostname");
Str* str711 = new Str("user");
Str* str712 = new Str("$ ");
Str* str713 = new Str("\u0001");
Str* str714 = new Str("\u0002");
Str* str715 = new Str("$");
Str* str716 = new Str("$");
Str* str717 = new Str("u");
Str* str718 = new Str("user");
Str* str719 = new Str("h");
Str* str720 = new Str("hostname");
Str* str721 = new Str(".");
Str* str722 = new Str("H");
Str* str723 = new Str("hostname");
Str* str724 = new Str("w");
Str* str725 = new Str("PWD");
Str* str726 = new Str("HOME");
Str* str727 = new Str("<Error: %s>");
Str* str728 = new Str("W");
Str* str729 = new Str("PWD");
Str* str730 = new Str("<Error: PWD is not a string> ");
Str* str731 = new Str("<Error: \\%s not implemented in $PS1> ");
Str* str732 = new Str("$");
Str* str733 = new Str("\\$");
Str* str734 = new Str("Invalid token %r");
Str* str735 = new Str("");
Str* str736 = new Str("<ERROR: Can't parse PS1: %s>");
Str* str737 = new Str("osh");
Str* str738 = new Str("PS1");
Str* str739 = new Str("PROMPT_COMMAND");
Str* str740 = new Str("Undefined variable %r");
Str* str741 = new Str("Can't use [] on value of type %s");
Str* str742 = new Str("");
Str* str743 = new Str("Can't use [] on value of type %s");
Str* str744 = new Str("");
Str* str745 = new Str("0x");
Str* str746 = new Str("Invalid hex constant %r");
Str* str747 = new Str("0");
Str* str748 = new Str("Invalid octal constant %r");
Str* str749 = new Str("#");
Str* str750 = new Str("#");
Str* str751 = new Str("Invalid base for numeric constant %r");
Str* str752 = new Str("a");
Str* str753 = new Str("A");
Str* str754 = new Str("@");
Str* str755 = new Str("_");
Str* str756 = new Str("Invalid digits for numeric constant %r");
Str* str757 = new Str("Digits %r out of range for base %d");
Str* str758 = new Str("Parse error in recursive arithmetic");
Str* str759 = new Str("Invalid integer constant %r");
Str* str760 = new Str("Invalid integer constant %r");
Str* str761 = new Str("Invalid integer constant %r");
Str* str762 = new Str("Undefined value in arithmetic context");
Str* str763 = new Str("Expected a value convertible to integer, got %s");
Str* str764 = new Str("0");
Str* str765 = new Str("Divide by zero");
Str* str766 = new Str("Divide by zero");
Str* str767 = new Str("Expected array or assoc in index expression, got %s");
Str* str768 = new Str("Divide by zero");
Str* str769 = new Str("Divide by zero");
Str* str770 = new Str("Exponent can't be less than zero");
Str* str771 = new Str("Associative array keys must be strings: $x 'x' \"$x\" etc.");
Str* str772 = new Str("Invalid place to modify");
Str* str773 = new Str("BASH_REMATCH");
Str* str774 = new Str("%s isn't implemented");
Str* str775 = new Str("Invalid regex %r: %s");
Str* str776 = new Str(" \t\n");
Str* str777 = new Str("IFS");
Str* str778 = new Str("IFS shouldn't be an array");
Str* str779 = new Str(" \t\n");
Str* str780 = new Str("IFS");
Str* str781 = new Str(" ");
Str* str782 = new Str("");
Str* str783 = new Str("IFS shouldn't be an array");
Str* str784 = new Str("\\");
Str* str785 = new Str("\\");
Str* str786 = new Str("Invalid transition from %r with %r");
Str* str787 = new Str("\u00ef\u00bf\u00bd");
Str* str788 = new Str("");
Str* str789 = new Str("Incomplete UTF-8 character");
Str* str790 = new Str("Invalid UTF-8 continuation byte");
Str* str791 = new Str("Invalid start of UTF-8 character");
Str* str792 = new Str("");
Str* str793 = new Str("%s can't have an argument");
Str* str794 = new Str("");
Str* str795 = new Str("%s can't have an argument");
Str* str796 = new Str("");
Str* str797 = new Str("%s can't have an argument");
Str* str798 = new Str("");
Str* str799 = new Str("%s can't have an argument");
Str* str800 = new Str("");
Str* str801 = new Str("<_GlobReplacer regex %r r %r>");
Str* str802 = new Str("(%s)");
Str* str803 = new Str("Error matching regex %r: %s");
Str* str804 = new Str("^");
Str* str805 = new Str("$");
Str* str806 = new Str("\r");
Str* str807 = new Str("<INVALID CR>");
Str* str808 = new Str("\n");
Str* str809 = new Str("<INVALID NEWLINE>");
Str* str810 = new Str(" `~!$&*()[]{}\\|;'\"<>?");
Str* str811 = new Str("Left-hand side of this assignment is invalid");
Str* str812 = new Str("Token can't be used in prefix position");
Str* str813 = new Str("Token can't be used in infix position");
Str* str814 = new Str("Parser expected %s, got %s");
Str* str815 = new Str("Unexpected end of input");
Str* str816 = new Str("warning: Invalid backslash escape in C-style string: %r");
Str* str817 = new Str("BASH_SOURCE");
Str* str818 = new Str("FUNCNAME");
Str* str819 = new Str("BASH_LINENO");
Str* str820 = new Str("0");
Str* str821 = new Str("0");
Str* str822 = new Str("");
Str* str823 = new Str("");
Str* str824 = new Str("\\");
Str* str825 = new Str("\\\\");
Str* str826 = new Str("");
Str* str827 = new Str("");
Str* str828 = new Str("The length index of a array slice can't be negative: %d");
Str* str829 = new Str("Can't slice associative arrays");
Str* str830 = new Str("i");
Str* str831 = new Str("e");
Str* str832 = new Str("f");
Str* str833 = new Str("n");
Str* str834 = new Str("u");
Str* str835 = new Str("x");
Str* str836 = new Str("C");
Str* str837 = new Str("");
Str* str838 = new Str("~");
Str* str839 = new Str("HOME");
Str* str840 = new Str("Error expanding tilde (e.g. invalid user)");
Str* str841 = new Str("Can't assign to special variable");
Str* str842 = new Str("unset variable %r");
Str* str843 = new Str("@");
Str* str844 = new Str("*");
Str* str845 = new Str("@");
Str* str846 = new Str("*");
Str* str847 = new Str("warning: ");
Str* str848 = new Str("-1");
Str* str849 = new Str("@");
Str* str850 = new Str("*");
Str* str851 = new Str("[");
Str* str852 = new Str("]");
Str* str853 = new Str("Bad indirect expansion: %r");
Str* str854 = new Str("");
Str* str855 = new Str("warning: ");
Str* str856 = new Str("");
Str* str857 = new Str("\u0001");
Str* str858 = new Str("");
Str* str859 = new Str("\u0002");
Str* str860 = new Str("");
Str* str861 = new Str("Can't use @P on %s");
Str* str862 = new Str(" ");
Str* str863 = new Str("Can't use @Q on %s");
Str* str864 = new Str("a");
Str* str865 = new Str("A");
Str* str866 = new Str("r");
Str* str867 = new Str("x");
Str* str868 = new Str("n");
Str* str869 = new Str("");
Str* str870 = new Str("Var op %r not implemented");
Str* str871 = new Str("Can't index string with @");
Str* str872 = new Str("Can't index string with *");
Str* str873 = new Str("Can't index string %r with integer");
Str* str874 = new Str("");
Str* str875 = new Str("");
Str* str876 = new Str("$");
Str* str877 = new Str("Undefined variable %r");
Str* str878 = new Str("Undefined array %r");
Str* str879 = new Str("Array %r can't be referred to as a scalar (without @ or *)");
Str* str880 = new Str("Illegal array word part (strict_array)");
Str* str881 = new Str(" ");
Str* str882 = new Str("");
Str* str883 = new Str("Array %r can't be referred to as a scalar (without @ or *)");
Str* str884 = new Str("Unexpected array literal");
Str* str885 = new Str("Unexpected associative array literal");
Str* str886 = new Str("@(");
Str* str887 = new Str("|");
Str* str888 = new Str(")");
Str* str889 = new Str("Can't splice %r");
Str* str890 = new Str("");
Str* str891 = new Str("");
Str* str892 = new Str("This word should yield a string, but it contains an array");
Str* str893 = new Str(" ");
Str* str894 = new Str("");
Str* str895 = new Str("<Runtime error: %s>");
Str* str896 = new Str("<I/O error: %s>");
Str* str897 = new Str("<Ctrl-C>");
Str* str898 = new Str("");
Str* str899 = new Str("");
Str* str900 = new Str("");
Str* str901 = new Str("");
Str* str902 = new Str("");
Str* str903 = new Str("LHS array not allowed in assignment builtin");
Str* str904 = new Str("+");
Str* str905 = new Str("+= not allowed in assignment builtin");
Str* str906 = new Str("-");
Str* str907 = new Str("+");
Str* str908 = new Str("f");
Str* str909 = new Str("F");
Str* str910 = new Str("");
Str* str911 = new Str("=");
Str* str912 = new Str("Invalid variable name %r");
Str* str913 = new Str("__NO_COMMAND_SUB__");
Str* str914 = new Str("__NO_PROCESS_SUB__");
Str* str915 = new Str("Expected : or } in slice");
Str* str916 = new Str("Pattern in ${x/pat/replace} must not be empty");
Str* str917 = new Str("Expected } after replacement string, got %s");
Str* str918 = new Str("Expected } or / to close pattern");
Str* str919 = new Str("Expected ] to close subscript");
Str* str920 = new Str("Expected } to close ${");
Str* str921 = new Str("Expected } to close ${");
Str* str922 = new Str("Expected } to close ${");
Str* str923 = new Str("Unexpected token in ${} (%s)");
Str* str924 = new Str("VOp2");
Str* str925 = new Str("Unexpected token in ${} (%s)");
Str* str926 = new Str("VOp3");
Str* str927 = new Str("Expected } to close ${");
Str* str928 = new Str("Expected } after length expression");
Str* str929 = new Str("Unexpected token in ${}");
Str* str930 = new Str("\\");
Str* str931 = new Str("Strings with backslashes should look like r'\\n' or c'\\n'");
Str* str932 = new Str("Unexpected EOF in single-quoted string that began here");
Str* str933 = new Str("Unexpected EOF reading extended glob that began here");
Str* str934 = new Str("Unexpected EOF reading double-quoted string that began here");
Str* str935 = new Str("Unexpected EOF while looking for closing backtick");
Str* str936 = new Str("");
Str* str937 = new Str("Invalid proc name %s");
Str* str938 = new Str("Unexpected token after arithmetic expression (%s != %s)");
Str* str939 = new Str("Expected second ) to end arith sub");
Str* str940 = new Str("Expected second ) to end arith statement");
Str* str941 = new Str("Expected ; here");
Str* str942 = new Str("Expected ; here");
Str* str943 = new Str("Expected ) to end for loop expression");
Str* str944 = new Str("Expected ( after =");
Str* str945 = new Str("Unexpected token in array literal");
Str* str946 = new Str("Expected associative array pair");
Str* str947 = new Str("Unexpected token after array literal");
Str* str948 = new Str("Unexpected token after array splice");
Str* str949 = new Str("Word has unbalanced { }.  Maybe add a space or quote it like \\{");
Str* str950 = new Str("Unexpected token while parsing arithmetic: %r");
Str* str951 = new Str("Unhandled: %s (%s)");
Str* str952 = new Str("Invalid lex state %s");
Str* str953 = new Str("");
Str* str954 = new Str("");
Str* str955 = new Str("");
Str* str956 = new Str("");
...
Str* str960 = new Str("");
Str* str961 = new Str("");
Str* str962 = new Str("Compound shouldn't be empty");
Str* str963 = new Str("/");
Str* str964 = new Str("/");
Str* str965 = new Str("");
Str* str966 = new Str("EOF");
Str* str967 = new Str("typ");
Str* str968 = new Str("tok");
Str* str969 = new Str("children");
Str* str970 = new Str("-");
Str* str971 = new Str("with %d children");
Str* str972 = new Str("");
Str* str973 = new Str("(PNode %s %s %s)");
Str* str974 = new Str("&");
Str* str975 = new Str("&amp;");
Str* str976 = new Str("<");
Str* str977 = new Str("&lt;");
...
Str* str1019 = new Str("\n");
Str* str1020 = new Str("\\n");
Str* str1021 = new Str("\r");
Str* str1022 = new Str("\\r");
Str* str1023 = new Str("\t");
Str* str1024 = new Str("\\t");
Str* str1025 = new Str("\u0000");
Str* str1026 = new Str("\\x00");
Str* str1027 = new Str("\\0");
Str* str1028 = new Str("");
Str* str1029 = new Str("");
Str* str1030 = new Str("");
Str* str1031 = new Str("\\");
...
Str* str1035 = new Str("\n");
Str* str1036 = new Str("\\n");
Str* str1037 = new Str("\r");
Str* str1038 = new Str("\\r");
Str* str1039 = new Str("\t");
Str* str1040 = new Str("\\t");
Str* str1041 = new Str("\u0000");
Str* str1042 = new Str("\\x00");
Str* str1043 = new Str("\\0");
Str* str1044 = new Str("");
Str* str1045 = new Str("!");
Str* str1046 = new Str("Expected unary operator, got %r (2 args)");
Str* str1047 = new Str("-a");
Str* str1048 = new Str("-o");
Str* str1049 = new Str("!");
Str* str1050 = new Str("(");
Str* str1051 = new Str(")");
Str* str1052 = new Str("Expected binary operator, got %r (3 args)");
Str* str1053 = new Str("]");
Str* str1054 = new Str("missing closing ]");
Str* str1055 = new Str("!");
Str* str1056 = new Str("(");
Str* str1057 = new Str(")");
Str* str1058 = new Str("(test) ");
Str* str1059 = new Str("(test) ");
...
class _Executor : public gc_heap::Obj {
 public:
  ...
  virtual int RunPipeline(syntax_asdl::command__Pipeline* node);
  virtual int RunSubshell(syntax_asdl::command__Subshell* node);
  virtual Str* RunCommandSub(syntax_asdl::command_t* node);
  virtual Str* RunProcessSub(syntax_asdl::command_t* node, int op_id);
  virtual void Time();
...
class ctx_ErrExit : public gc_heap::Obj {
 public:
  ctx_ErrExit(state::MutableOpts* mutable_opts, int span_id);
  ~ctx_ErrExit();
...
class _ErrExit : public gc_heap::Obj {
 public:
  _ErrExit();
  ...
  DISALLOW_COPY_AND_ASSIGN(_ErrExit)
};

class _Getter : public gc_heap::Obj {
 public:
  ...
  DISALLOW_COPY_AND_ASSIGN(_Getter)
};
...
inline Str* fmt47(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt49(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt126(int a0, Str* a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const("  ", 2);
  gBuf.format_s(a1);
...
inline Str* fmt140(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt154(int a0, Str* a1, int a2) {
  gBuf.reset();
...
inline Str* fmt158(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_r(a0);
...
inline Str* fmt163(int a0, int a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const(" != ", 4);
  gBuf.format_d(a1);
...
inline Str* fmt169(int a0, int a1) {
  gBuf.reset();
...
inline Str* fmt204(Str* a0, int a1) {
  gBuf.reset();
...
inline Str* fmt216(Str* a0, Str* a1, syntax_asdl::word_t* a2) {
  gBuf.reset();
...
inline Str* fmt222(Str* a0, Str* a1) {
  gBuf.reset();
...
class AbstractWordEvaluator : public StringWordEvaluator {
 public:
  ...
  virtual void CheckCircularDeps();
  virtual runtime_asdl::part_value_t* _EvalCommandSub(syntax_asdl::command_t* node, int id_, bool quoted);
...
inline Str* fmt273(Str* a0, Str* a1) {
  gBuf.reset();
...
_Executor::_Executor() : gc_heap::Obj(0) {
  this->cmd_ev = nullptr;
}
...
_AssignBuiltin::_AssignBuiltin() : gc_heap::Obj(0) {
  ;  // pass
}
...
_Builtin::_Builtin() : gc_heap::Obj(0) {
  ;  // pass
}
...
ColorOutput::ColorOutput(mylib::Writer* f) : gc_heap::Obj(0) {
  this->f = f;
  this->num_chars = 0;
}
...
_PrettyPrinter::_PrettyPrinter(int max_col) : gc_heap::Obj(0) {
...
ctx_Location::ctx_Location(alloc::Arena* arena, syntax_asdl::source_t* src) : gc_heap::Obj(0) {
...
CrashDumper::CrashDumper(Str* crash_dump_dir) : gc_heap::Obj(0) {
...
Tracer::Tracer(parse_lib::ParseContext* parse_ctx, optview::Exec* exec_opts, state::MutableOpts* mutable_opts, state::Mem* mem, word_eval::NormalWordEvaluator* word_ev, util::_DebugFile* f) : gc_heap::Obj(0) {
...
_ControlFlow::_ControlFlow(syntax_asdl::Token* token, int arg) : gc_heap::Obj(0) {
  this->token = token;
  this->arg = arg;
}
...
process::Process* ShellExecutor::_MakeProcess(syntax_asdl::command_t* node, bool inherit_errexit) {
  ...
  thunk = new process::SubProgramThunk(this->cmd_ev, node, inherit_errexit);
  p = new process::Process(thunk, this->job_state);
  return p;
}
...
int ShellExecutor::RunSimpleCommand(runtime_asdl::cmd_value__Argv* cmd_val, bool do_fork, bool call_procs) {
  ...
  if (do_fork) {
    thunk = new process::ExternalThunk(this->ext_prog, argv0_path, cmd_val, environ);
    p = new process::Process(thunk, this->job_state);
...
int ShellExecutor::RunPipeline(syntax_asdl::command__Pipeline* node) {
  process::Pipeline* pi;
  int n;
  process::Process* p;
  List<int>* pipe_status;
  ...
  n = len(node->children);
  for (int i = 0; i < (n - 1); ++i) {
    p = this->_MakeProcess(node->children->index(i));
    p->Init_ParentPipeline(pi);
    pi->Add(p);
  }
  pi->AddLast((new Tuple2<cmd_eval::CommandEvaluator*, syntax_asdl::command_t*>(this->cmd_ev, node->children->index((n - 1)))));
  pipe_status = pi->Run(this->waiter, this->fd_state);
  this->mem->SetPipeStatus(pipe_status);
  if (this->exec_opts->pipefail()) {
    status = 0;
    for (ListIter<int> it(pipe_status); !it.Done(); it.Next()) {
      int st = it.Value();
      if (st != 0) {
        status = st;
      }
...
Str* ShellExecutor::RunCommandSub(syntax_asdl::command_t* node) {
  syntax_asdl::Token* tok;
  ...
  if (node->tag_() == command_e::Simple) {
    ...
    if ((len(simple->words) == 0 and (len(simple->redirects) == 1 and simple->redirects->index(0)->op->id == Id::Redir_Less))) {
      tok = new Token(Id::Lit_Chars, runtime::NO_SPID, str75);
      cat_word = new compound_word(new List<syntax_asdl::word_part_t*>({tok}));
  ...
  r = tup0.at0();
  w = tup0.at1();
  p->AddStateChange(new process::StdoutToPipe(r, w));
  chunks = new List<Str*>();
  posix::close(w);
  while (true) {
  ...
  if (this->exec_opts->more_errexit()) {
    if ((this->exec_opts->errexit() and status != 0)) {
      throw new error::ErrExit(fmt18(status, ui::CommandType(node)), runtime::NO_SPID, status);
    }
  }
  else {
  ...
  return str77->join(chunks)->rstrip(str78);
}

Str* ShellExecutor::RunProcessSub(syntax_asdl::command_t* node, int op_id) {
  process::Process* p;
  int r;
  int w;
  ...
  if (op_id == Id::Left_ProcSubIn) {
    redir = new process::StdoutToPipe(r, w);
  }
  else {
    if (op_id == Id::Left_ProcSubOut) {
      redir = new process::StdinFromPipe(r, w);
    }
    else {
      throw new AssertionError();
    }
...
_RedirFrame::_RedirFrame(int saved_fd, int orig_fd, bool forget) : gc_heap::Obj(0) {
  this->saved_fd = saved_fd;
  this->orig_fd = orig_fd;
  this->forget = forget;
}

_FdFrame::_FdFrame() : gc_heap::Obj(0) {
  this->saved = new List<process::_RedirFrame*>();
  this->need_wait = new List<Tuple2<process::Process*, process::Waiter*>*>();
}
...
FdState::FdState(ui::ErrorFormatter* errfmt, process::JobState* job_state, state::Mem* mem) : gc_heap::Obj(0) {
  this->errfmt = errfmt;
  this->job_state = job_state;
  this->cur_frame = new _FdFrame();
  this->stack = new List<process::_FdFrame*>({this->cur_frame});
  this->mem = mem;
}
...
mylib::LineReader* FdState::Open(Str* path) {
  ...
  return this->_Open(path, str82, fd_mode);
}
...
void FdState::_WriteFdToMem(Str* fd_name, int fd) {
  if (this->mem) {
    this->mem->SetVar(new lvalue::Named(fd_name), new value::Str(str(fd)), scope_e::Dynamic);
  }
}
...
bool FdState::_PushSave(int fd) {
  ...
  if (need_restore) {
    this->cur_frame->saved->append(new _RedirFrame(new_fd, fd, true));
  }
  else {
    this->_PushClose(fd);
  }
...
void FdState::_PushClose(int fd) {
  this->cur_frame->saved->append(new _RedirFrame(NO_FD, fd, false));
}

void FdState::_PushWait(process::Process* proc, process::Waiter* waiter) {
  this->cur_frame->need_wait->append((new Tuple2<process::Process*, process::Waiter*>(proc, waiter)));
}
  ...
  switch (arg->tag_()) {
    case redirect_arg_e::Path: {
          ...
          if ((r->op_id == Id::Redir_DGreat || r->op_id == Id::Redir_AndDGreat)) {
            ...
            if (r->op_id == Id::Redir_Less) {
              ...
              if (r->op_id == Id::Redir_LessGreat) {
                ...
                throw new NotImplementedError(r->op_id);
              }
            }
          }
        }
      ...
      if ((r->op_id == Id::Redir_AndGreat || r->op_id == Id::Redir_AndDGreat)) {
        this->_PushDup(new_fd, new redir_loc::Fd(2));
      }
    }
      break;
    ...
    case redirect_arg_e::MoveFd: {
      ...
      if (new_fd != NO_FD) {
        ...
        this->cur_frame->saved->append(new _RedirFrame(new_fd, fd, false));
      }
    }
      break;
    ...
    case redirect_arg_e::HereDoc: {
      ...
      thunk = new _HereDocWriterThunk(write_fd, arg->body);
      start_process = true;
      if (start_process) {
        here_proc = new Process(thunk, this->job_state);
...
bool FdState::PushStdinFromPipe(int r) {
  ...
  this->stack->append(new_frame);
  this->cur_frame = new_frame;
  this->_PushDup(r, new redir_loc::Fd(0));
  return true;
}
...
ChildStateChange::ChildStateChange() : gc_heap::Obj(0) {
  ;  // pass
}
...
ExternalProgram::ExternalProgram(Str* hijack_shebang, process::FdState* fd_state, ui::ErrorFormatter* errfmt, util::_DebugFile* debug_f) : gc_heap::Obj(0) {
...
void ExternalProgram::_Exec(Str* argv0_path, List<Str*>* argv, int argv0_spid, Dict<Str*, Str*>* environ, bool should_retry) {
  ...
  try {
    ...
    if ((e->errno == errno_::ENOEXEC and should_retry)) {
      new_argv = new List<Str*>({str91, argv0_path});
      new_argv->extend(argv->slice(1));
      this->_Exec(str92, new_argv, argv0_spid, environ, false);
    }
...
void SubProgramThunk::Run() {
  ...
  if (!this->inherit_errexit) {
    this->cmd_ev->mutable_opts->errexit->Disable();
  }
  try {
...
Process::Process(process::Thunk* thunk, process::JobState* job_state) : Job() {
  ...
  this->state_changes = new List<process::ChildStateChange*>();
  this->close_r = -1;
  this->close_w = -1;
  this->pid = -1;
  this->status = -1;
...
runtime_asdl::job_status_t* Process::JobWait(process::Waiter* waiter) {
  ...
  return new job_status::Proc(exit_code);
}
...
Pipeline::Pipeline() : Job() {
  this->procs = new List<process::Process*>();
  this->pids = new List<int>();
  this->pipe_status = new List<int>();
  this->status = -1;
...
void Pipeline::Add(process::Process* p) {
  ...
  prev->AddStateChange(new StdoutToPipe(r, w));
  p->AddStateChange(new StdinFromPipe(r, w));
...
void Pipeline::AddLast(Tuple2<cmd_eval::CommandEvaluator*, syntax_asdl::command_t*>* thunk) {
  ...
  prev = this->procs->index(-1);
  prev->AddStateChange(new StdoutToPipe(r, w));
  this->last_pipe = (new Tuple2<int, int>(r, w));
}
...
runtime_asdl::job_status_t* Pipeline::JobWait(process::Waiter* waiter) {
  ...
  return new job_status::Pipeline(pipe_status);
}
...
JobState::JobState() : gc_heap::Obj(0) {
  this->jobs = new Dict<int, process::Job*>();
  this->child_procs = new Dict<int, process::Process*>();
...
Waiter::Waiter(process::JobState* job_state, optview::Exec* exec_opts) : gc_heap::Obj(0) {
  this->job_state = job_state;
  this->exec_opts = exec_opts;
...
int Main(Str* lang, args::Reader* arg_r, Dict<Str*, Str*>* environ, bool login_shell, pyutil::_ResourceLoader* loader, void* line_input) {
  ...
  arg_r->Next();
  try {
    attrs = flag_spec::ParseMore(str110, arg_r);
  }
  catch (error::Usage* e) {
  ...
  if (flag->help) {
    help_builtin->Run(MakeBuiltinArgv(new List<Str*>({fmt35(lang)})));
    return 0;
  }
  if (flag->version) {
    pyutil::ShowAppVersion(str113, loader);
    return 0;
  }
  no_str = nullptr;
  ...
  if (arg_r->AtEnd()) {
    ...
    dollar0 = arg_r->Peek();
    frame0 = new state::DebugFrame(dollar0, str114, no_str, state::LINE_ZERO, 0, 0);
  ...
  job_state = new process::JobState();
  fd_state = new process::FdState(errfmt, job_state, mem);
  ...
  if (str_equals(lang, str115)) {
    mutable_opts->SetShoptOption(str116, true);
  }
  ...
  comp_arena->PushSource(new source::Unused(str118));
  ...
  hist_arena->PushSource(new source::Unused(str119));
  ...
  waiter = new process::Waiter(job_state, exec_opts);
  my_pid = posix::getpid();
  debug_path = str120;
  debug_dir = environ->get(str121);
  ...
  interp = environ->get(str124, str125);
  search_path = new state::SearchPath(mem);
  ext_prog = new process::ExternalProgram(interp, fd_state, errfmt, debug_f);
  splitter = new split::SplitContext(mem);
  crash_dump_dir = environ->get(str126, str127);
  ...
  shell_ex = new executor::ShellExecutor(mem, exec_opts, mutable_opts, procs, builtins, search_path, ext_prog, waiter, job_state, fd_state, errfmt);
  ...
  builtins->set(builtin_i::printf, new builtin_printf::Printf(mem, exec_opts, parse_ctx, arith_ev, errfmt));
  ...
  if (flag->c != nullptr) {
    ...
    if (flag->i) {
      ...
      if (script_name == nullptr) {
        stdin = mylib::Stdin();
        arena->PushSource(new source::Stdin(str128));
...
SearchPath::SearchPath(state::Mem* mem) : gc_heap::Obj(0) {
  this->mem = mem;
...
Str* SearchPath::Lookup(Str* name, bool exec_required) {
  ...
  val = this->mem->GetVar(str138);
  UP_val = val;
  if (val->tag_() == value_e::Str) {
    value__Str* val = static_cast<value__Str*>(UP_val);
    path_list = val->s->split(str139);
  }
  else {
...
ctx_ErrExit::ctx_ErrExit(state::MutableOpts* mutable_opts, int span_id) : gc_heap::Obj(0) {
...
_ErrExit::_ErrExit() : gc_heap::Obj(0) {
  this->_value = false;
...
_Getter::_Getter(List<bool>* opt_array, Str* opt_name) : gc_heap::Obj(0) {
...
int _SetOptionNum(Str* opt_name) {
  ...
  if (!list_contains(consts::SET_OPTION_NUMS, opt_num)) {
    e_usage(fmt45(opt_name));
  }
  return opt_num;
}

MutableOpts::MutableOpts(state::Mem* mem, List<bool>* opt_array, state::_ErrExit* errexit, state::OptHook* opt_hook) : gc_heap::Obj(0) {
  this->mem = mem;
  this->opt_array = opt_array;
  ...
  runtime_asdl::value_t* UP_shellopts = this->mem->GetVar(str145);
...
void MutableOpts::SetOption(Str* opt_name, bool b) {
  ...
  UP_val = this->mem->GetVar(str149);
  value__Str* val = static_cast<value__Str*>(UP_val);
  shellopts = val->s;
  if (b) {
    if (!str_contains(shellopts, opt_name)) {
      new_val = new value::Str(fmt46(shellopts, opt_name));
      this->mem->InternalSetGlobal(str151, new_val);
    }
  }
  else {
    if (str_contains(shellopts, opt_name)) {
      names = new List<Str*>();
      for (ListIter<Str*> it(shellopts->split(str152)); !it.Done(); it.Next()) {
        Str* n = it.Value();
        if (!(str_equals(n, opt_name))) {
          names->append(n);
        }
      }
      new_val = new value::Str(str153->join(names));
      this->mem->InternalSetGlobal(str154, new_val);
    }
  }
}
...
void MutableOpts::ShowOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    print(fmt47(b ? str160 : str161, opt_name));
  }
}
...
void MutableOpts::ShowShoptOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    print(fmt49(b ? str164 : str165, opt_name));
  }
}

_ArgFrame::_ArgFrame(List<Str*>* argv) : gc_heap::Obj(0) {
  this->argv = argv;
  this->num_shifted = 0;
}
...
DirStack::DirStack() : gc_heap::Obj(0) {
...
Str* _GetWorkingDir() {
  try {
    ...
    e_die(fmt50(pyutil::strerror(e)));
  }
}

DebugFrame::DebugFrame(Str* bash_source, Str* func_name, Str* source_name, int call_spid, int argv_i, int var_i) : gc_heap::Obj(0) {
...
void _InitVarsFromEnv(state::Mem* mem, Dict<Str*, Str*>* environ) {
  ...
  mem->SetVar(new lvalue::Named(str182), nullptr, scope_e::GlobalOnly, SetReadOnly);
  val = mem->GetVar(str183);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str184, _GetWorkingDir());
  }
  mem->SetVar(new lvalue::Named(str185), nullptr, scope_e::GlobalOnly, SetExport);
}
...
ctx_Call::ctx_Call(state::Mem* mem, Str* func_name, int def_spid, List<Str*>* argv) : gc_heap::Obj(0) {
...
ctx_Temp::ctx_Temp(state::Mem* mem) : gc_heap::Obj(0) {
  mem->PushTemp();
  this->mem = mem;
}
...
ctx_Status::ctx_Status(state::Mem* mem) : gc_heap::Obj(0) {
  mem->last_status->append(0);
  mem->pipe_status->append(new List<int>());
  this->mem = mem;
}
...
Mem::Mem(Str* dollar0, List<Str*>* argv, alloc::Arena* arena, List<state::DebugFrame*>* debug_stack) : gc_heap::Obj(0) {
  ...
  this->line_num = new value::Str(str188);
...
void Mem::_DisallowNamerefCycle(Str* name, List<Str*>* ref_trail) {
  ...
  if (list_contains(ref_trail, new_name)) {
    e_die(fmt55(str201->join(ref_trail)));
  }
...
bool Mem::Unset(runtime_asdl::lvalue_t* lval, runtime_asdl::scope_t lookup_mode, bool strict) {
  ...
  if (cell->readonly) {
    throw new error::Runtime(fmt61(var_name));
  }
  switch (lval->tag_()) {
    case lvalue_e::Named: {
    ...
    case lvalue_e::Indexed: {
      ...
      if (val->tag_() != value_e::MaybeStrArray) {
        throw new error::Runtime(fmt62(var_name));
      }
...
Str* GetString(state::Mem* mem, Str* name) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      throw new error::Runtime(fmt63(name));
    }
      break;
    case value_e::Str: {
      ...
      break;
    default: {
      throw new error::Runtime(fmt64(name));
    }
  }
}
...
int GetInteger(state::Mem* mem, Str* name) {
  ...
  val = mem->GetVar(name, scope_e::Dynamic);
  if (val->tag_() != value_e::Str) {
    throw new error::Runtime(fmt65(name, ui::ValType(val)));
  }
  s = static_cast<value__Str*>(val)->s;
  try {
    i = to_int(s);
    ...
    throw new error::Runtime(fmt66(name, s));
  }
  return i;
}
...
Str* PrettyDir(Str* dir_name, Str* home_dir) {
  if (home_dir != nullptr) {
    if ((str_equals(dir_name, home_dir) or dir_name->startswith(str_concat(home_dir, str225)))) {
      return str_concat(str226, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    f->write(str_equals(c, str229) ? str230 : str231);
  }
  f->write(str232);
  f->write(str_repeat(str233, (length - 1)));
  f->write(str234);
}
...
void PrettyPrintError(error::_ErrorWithLocation* err, alloc::Arena* arena) {
  PrettyPrintError(err, arena, str246);
}
...
ErrorFormatter::ErrorFormatter(alloc::Arena* arena) : gc_heap::Obj(0) {
  this->arena = arena;
...
void ErrorFormatter::Print_(Str* msg, int span_id) {
  ...
  _PrintWithOptionalSpanId(str247, msg, span_id, this->arena);
}
...
void PrintAst(syntax_asdl::command_t* node, arg_types::main* flag) {
  ...
  if (maybe_str_equals(flag->ast_format, str249)) {
    println_stderr(str250);
  }
  else {
    f = mylib::Stdout();
    afmt = flag->ast_format;
    if ((maybe_str_equals(afmt, str251) || maybe_str_equals(afmt, str252))) {
      ast_f = fmt::DetectConsoleOutput(f);
    }
    else {
      if ((maybe_str_equals(afmt, str253) || maybe_str_equals(afmt, str254))) {
...
UserExit::UserExit(int status) : gc_heap::Obj(0) {
  this->status = status;
}

_DebugFile::_DebugFile() : gc_heap::Obj(0) {
  ;  // pass
}
...
_Attributes::_Attributes(Dict<Str*, runtime_asdl::value_t*>* defaults) : gc_heap::Obj(0) {
...
void _Attributes::Set(Str* name, runtime_asdl::value_t* val) {
  name = name->replace(str258, str259);
  this->attrs->set(name, val);
}

Reader::Reader(List<Str*>* argv, List<int>* spids) : gc_heap::Obj(0) {
  this->argv = argv;
  this->spids = spids;
  this->n = len(argv);
  this->i = 0;
...
bool SetAttachedBool::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  if (attached_arg != nullptr) {
    if ((str_equals(attached_arg, str275) || str_equals(attached_arg, str276) || str_equals(attached_arg, str277) || str_equals(attached_arg, str278))) {
      b = false;
    }
    else {
      if ((str_equals(attached_arg, str279) || str_equals(attached_arg, str280) || str_equals(attached_arg, str281) || str_equals(attached_arg, str282))) {
        b = true;
      }
      else {
...
bool SetOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str284);
...
bool SetNamedOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str285);
  arg_r->Next();
  arg = arg_r->Peek();
  if (arg == nullptr) {
...
args::_Attributes* Parse(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str289)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if ((arg->startswith(str290) and len(arg) > 1)) {
      n = len(arg);
      for (int i = 1; i < n; ++i) {
        ch = arg->index(i);
        if (list_contains(spec->plus_flags, ch)) {
          out->Set(ch, new value::Str(str291));
          continue;
        }
      ...
      if ((len(spec->plus_flags) and (arg->startswith(str294) and len(arg) > 1))) {
        n = len(arg);
        for (int i = 1; i < n; ++i) {
          ch = arg->index(i);
          if (list_contains(spec->plus_flags, ch)) {
            out->Set(ch, new value::Str(str295));
            continue;
          }
          e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
        }
...
args::_Attributes* ParseLikeEcho(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    chars = arg->slice(1);
    if ((arg->startswith(str298) and len(chars))) {
      done = false;
...
args::_Attributes* ParseMore(flag_spec::_FlagSpecAndMore* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str299)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if (arg->startswith(str300)) {
    ...
    if (((arg->startswith(str302) or arg->startswith(str303)) and len(arg) > 1)) {
      char0 = arg->index(0);
...
LineLexer::LineLexer(Str* line, alloc::Arena* arena) : gc_heap::Obj(0) {
  this->arena = arena;
...
int LineLexer::GetSpanIdForEof() {
  ...
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str308, 0);
  }
  else {
...
Lexer::Lexer(lexer::LineLexer* line_lexer, reader::_Reader* line_reader) : gc_heap::Obj(0) {
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str309, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = new Token(id_, span_id, str310);
      return t;
    }
...
_BaseTrail::_BaseTrail() : gc_heap::Obj(0) {
...
ctx_Alias::ctx_Alias(parse_lib::_BaseTrail* trail) : gc_heap::Obj(0) {
...
ParseContext::ParseContext(alloc::Arena* arena, optview::Parse* parse_opts, Dict<Str*, Str*>* aliases, grammar::Grammar* oil_grammar) : gc_heap::Obj(0) {
  this->arena = arena;
...
lexer::Lexer* ParseContext::_MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = new lexer::LineLexer(str312, this->arena);
...
_Reader::_Reader(alloc::Arena* arena) : gc_heap::Obj(0) {
  this->arena = arena;
  this->line_num = 1;
}
...
int _Classify(grammar::Grammar* gr, syntax_asdl::Token* tok) {
  ...
  type_str = tok->id == Id::Unknown_Tok ? str316 : fmt77(ui::PrettyId(tok->id));
...
ExprParser::ExprParser(parse_lib::ParseContext* parse_ctx, grammar::Grammar* gr) : gc_heap::Obj(0) {
  this->parse_ctx = parse_ctx;
  this->gr = gr;
...
List<Str*>* POSIX_CLASSES = new List<Str*>({str320, str321, str322, str323, str324, str325, str326, str327, str328, str329, str330, str331});
Str* RANGE_POINT_TOO_LONG = str332;
int NT_OFFSET = 256;
...
Transformer::Transformer(grammar::Grammar* gr) : gc_heap::Obj(0) {
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw new NotImplementedError(str334);
  }
  if (id0 == Id::Op_LBracket) {
    elts = new List<syntax_asdl::expr_t*>();
    for (int i = 0; i < n; i += 2) {
...
syntax_asdl::re_t* Transformer::_NameInRegex(syntax_asdl::Token* negated_tok, syntax_asdl::Token* tok) {
  ...
  val = tok->val;
  if (maybe_str_equals(val, str339)) {
    if (negated_tok) {
      p_die(fmt82(), tok);
    }
    return tok;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((str_equals(tok->val, str344) || str_equals(tok->val, str345) || str_equals(tok->val, str346))) {
        return tok;
      }
...
void AsPosixEre(syntax_asdl::re_t* node, List<Str*>* parts) {
  ...
  if (tag == re_e::Repeat) {
    ...
    if (op_tag == re_repeat_e::Range) {
      ...
      lower = op->lower ? op->lower->val : str363;
      upper = op->upper ? op->upper->val : str364;
...
BoolParser::BoolParser(word_parse::WordEmitter* w_parser) : gc_heap::Obj(0) {
...
_NotARange::_NotARange(Str* s) : gc_heap::Obj(0) {
  ;  // pass
}

_RangeParser::_RangeParser(match::SimpleLexer* lexer, int span_id) : gc_heap::Obj(0) {
  this->lexer = lexer;
  this->span_id = span_id;
  this->token_type = Id::Undefined_Tok;
  this->token_val = str381;
}
...
Str* _RangeParser::_Eat(int token_type) {
  ...
  if (this->token_type != token_type) {
    throw new _NotARange(fmt106(token_type, this->token_type));
  }
  val = this->token_val;
  this->_Next();
  return val;
...
_StackFrame::_StackFrame(List<syntax_asdl::word_part_t*>* cur_parts) : gc_heap::Obj(0) {
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  flag = attrs->attrs;
  tmp_g = flag->get(str392);
  tmp_a = flag->get(str393);
  tmp_A = flag->get(str394);
  ...
  flag_A = (tmp_A and tmp_A->tag_() == value_e::Bool) ? static_cast<value__Bool*>(tmp_A)->b : false;
  tmp_n = flag->get(str395);
  tmp_r = flag->get(str396);
  tmp_x = flag->get(str397);
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if ((maybe_str_equals(flag_n, str399) and !cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_n, str400) and cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str401) and !cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str402) and cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str403) and !cell->exported)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str404) and cell->exported)) {
      continue;
    }
    ...
    if (print_flags) {
      ...
      decl->extend(new List<Str*>({str411, str412->join(flags), str413, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(new List<Str*>({str414, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (has_holes) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(new List<Str*>({str417, name, str418, str(i), str419, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(new List<Str*>({str421, str422->join(body), str423}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(new List<Str*>({str425, key_quoted, str426, value_quoted}));
          }
          if (len(body) > 0) {
            decl->extend(new List<Str*>({str427, str428->join(body), str429}));
          }
        }
        else {
          ;  // pass
...
int Export::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r->Next();
  attrs = flag_spec::Parse(str431, arg_r);
...
int Readonly::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = new args::Reader(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str436, arg_r);
...
int NewVar::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = new args::Reader(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str437, arg_r);
  ...
  flags = 0;
  if (maybe_str_equals(arg->x, str440)) {
    flags |= state::SetExport;
  }
  if (maybe_str_equals(arg->r, str441)) {
    flags |= state::SetReadOnly;
  }
  if (maybe_str_equals(arg->n, str442)) {
    flags |= state::SetNameref;
  }
  flags_to_clear = 0;
  if (maybe_str_equals(arg->x, str443)) {
    flags |= state::ClearExport;
  }
  if (maybe_str_equals(arg->r, str444)) {
    flags |= state::ClearReadOnly;
  }
  if (maybe_str_equals(arg->n, str445)) {
...
bool Unset::_UnsetVar(Str* arg, int spid, bool proc_fallback) {
  ...
  {  // with
    alloc::ctx_Location ctx(arena, new source::ArgvWord(spid));
...
int Unset::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str448, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
...
int Eval::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str451, cmd_val);
  arg_r = tup0.at1();
  if (this->exec_opts->strict_eval_builtin()) {
    Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str452);
    code_str = tup1.at0();
    eval_spid = tup1.at1();
    if (!arg_r->AtEnd()) {
      e_usage(str453);
    ...
    code_str = str454->join(arg_r->Rest());
...
int Source::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str455, cmd_val);
  arg_r = tup2.at1();
  path = arg_r->Peek();
  if (path == nullptr) {
    e_usage(str456);
...
int Command::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup3 = flag_spec::ParseCmdVal(str458, cmd_val);
  attrs = tup3.at0();
  arg_r = tup3.at1();
...
int Builtin::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (to_run == consts::NO_INDEX) {
    ...
    if (consts::LookupAssignBuiltin(name) != consts::NO_INDEX) {
      this->errfmt->Print_(str459, span_id);
    }
    else {
...
List<Tuple2<Str*, Str*>*>* _ResolveNames(List<Str*>* names, Dict<Str*, syntax_asdl::command__ShFunction*>* funcs, Dict<Str*, Str*>* aliases, state::SearchPath* search_path) {
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if (dict_contains(funcs, name)) {
      kind = (new Tuple2<Str*, Str*>(str461, name));
    }
    else {
      if (dict_contains(aliases, name)) {
        kind = (new Tuple2<Str*, Str*>(str462, name));
      }
      else {
        if (consts::LookupNormalBuiltin(name) != 0) {
          kind = (new Tuple2<Str*, Str*>(str463, name));
        }
        else {
          if (consts::LookupSpecialBuiltin(name) != 0) {
            kind = (new Tuple2<Str*, Str*>(str464, name));
          }
          else {
            if (consts::LookupAssignBuiltin(name) != 0) {
              kind = (new Tuple2<Str*, Str*>(str465, name));
            }
            else {
              if (consts::IsControlFlow(name)) {
                kind = (new Tuple2<Str*, Str*>(str466, name));
              }
              else {
                if (consts::IsKeyword(name)) {
                  kind = (new Tuple2<Str*, Str*>(str467, name));
                }
                else {
                  ...
                  if (resolved == nullptr) {
                    ...
                    kind = (new Tuple2<Str*, Str*>(str468, resolved));
                  }
                }
              }
            }
...
int Type::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str469, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
  ...
  for (ListIter<Tuple2<Str*, Str*>*> it(r); !it.Done(); it.Next()) {
    ...
    name = tup6->at1();
    if (kind == nullptr) {
      this->errfmt->StderrLine(fmt123(name));
      status = 1;
    }
    else {
      if (arg->t) {
        ...
        if (arg->p) {
          if (str_equals(kind, str471)) {
            print(name);
          }
        }
        else {
          if (arg->P) {
            if (str_equals(kind, str472)) {
              print(name);
            }
            else {
            ...
            print(fmt124(name, kind));
            if (str_equals(kind, str474)) {
              ;  // pass
            }
          }
        }
...
Tuple2<Str*, bool> ReadLineFromStdin(Str* delim_char) {
  ...
  return (Tuple2<Str*, bool>(str475->join(chars), eof));
}
...
int Read::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str476, cmd_val);
  attrs = tup2.at0();
  arg_r = tup2.at1();
  ...
  if (bits == 0) {
    ...
    term = new pyos::TermState(fd, ~bits);
    try {
      status = this->_Read(arg, names);
    }
    catch (std::exception) { }  }
...
int MapFile::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str484, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
  arg = new arg_types::mapfile(attrs->attrs);
  ...
  while (true) {
    ...
    if ((arg->t and line->endswith(str486))) {
      line = line->slice(0, -1);
    }
    lines->append(line);
  }
...
int Cd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup7 = flag_spec::ParseCmdVal(str487, cmd_val);
  attrs = tup7.at0();
  arg_r = tup7.at1();
  ...
  arg_spid = tup8.at1();
  if (dest_dir == nullptr) {
    val = this->mem->GetVar(str488);
    try {
      dest_dir = state::GetString(this->mem, str489);
    }
    catch (error::Runtime* e) {
  ...
  if (str_equals(dest_dir, str490)) {
    try {
      dest_dir = state::GetString(this->mem, str491);
      print(dest_dir);
    }
    catch (error::Runtime* e) {
      this->errfmt->Print_(e->UserErrorString());
  ...
  try {
    pwd = state::GetString(this->mem, str492);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    return 1;
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt125(real_dest_dir, posix::strerror(err_num)), arg_spid);
    return 1;
  }
  state::ExportGlobalString(this->mem, str494, real_dest_dir);
  ...
  if (cmd_val->block) {
    ...
    state::ExportGlobalString(this->mem, str495, pwd);
...
void _PrintDirStack(state::DirStack* dir_stack, int style, Str* home_dir) {
  ...
  if (style == WITH_LINE_NUMBERS) {
    ...
    for (ListIter<Str*> it(dir_stack->Iter()); !it.Done(); it.Next(), ++i) {
      Str* entry = it.Value();
      print(fmt126(i, ui::PrettyDir(entry, home_dir)));
    }
  }
  else {
...
int Pushd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt127(dest_dir, posix::strerror(err_num)), cmd_val->arg_spids->index(1));
    return 1;
  }
  this->dir_stack->Push(dest_dir);
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str501));
  state::ExportGlobalString(this->mem, str502, dest_dir);
...
bool _PopDirStack(state::Mem* mem, state::DirStack* dir_stack, ui::ErrorFormatter* errfmt) {
  ...
  if (dest_dir == nullptr) {
    errfmt->Print_(str503);
    return false;
  }
  err_num = pyos::Chdir(dest_dir);
  if (err_num != 0) {
    errfmt->Print_(fmt128(dest_dir, posix::strerror(err_num)));
    return false;
  }
  state::SetGlobalString(mem, str505, dest_dir);
  mem->SetPwd(dest_dir);
  return true;
}
...
int Popd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  if (len(cmd_val->arg_spids) > 1) {
    e_usage(fmt129(), cmd_val->arg_spids->index(1));
  }
  if (!_PopDirStack(this->mem, this->dir_stack, this->errfmt)) {
    return 1;
  }
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str507));
  return 0;
}
...
int Dirs::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseCmdVal(str508, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  arg = new arg_types::dirs(attrs->attrs);
  home_dir = state::MaybeString(this->mem, str509);
  style = SINGLE_LINE;
  if (arg->l) {
    home_dir = nullptr;
  }
...
int Pwd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup10 = flag_spec::ParseCmdVal(str510, cmd_val);
  attrs = tup10.at0();
  arg_r = tup10.at1();
...
List<Str*>* Help::_Groups() {
  ...
  contents = this->loader->Get(str511);
...
int Help::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseCmdVal(str512, cmd_val);
  attrs = tup11.at0();
  arg_r = tup11.at1();
  Tuple2<Str*, int> tup12 = arg_r->Peek2();
  topic = tup12.at0();
  blame_spid = tup12.at1();
  if (topic == nullptr) {
    topic = str513;
  ...
  try {
    contents = this->loader->Get(fmt130(topic));
  }
  catch (IOError*) {
    this->errfmt->Print_(fmt131(topic), blame_spid);
    return 1;
  }
  print(contents);
  return 0;
...
_FormatStringParser::_FormatStringParser(lexer::Lexer* lexer) : gc_heap::Obj(0) {
  this->lexer = lexer;
}
...
syntax_asdl::printf_part_t* _FormatStringParser::_ParseFormatStr() {
  ...
  while ((this->token_type == Id::Format_Flag || this->token_type == Id::Format_Zero)) {
    ...
    if (str_contains(str516, flag)) {
      p_die(fmt132(flag), this->cur_token);
    }
  ...
  if ((this->token_type == Id::Format_Type || this->token_type == Id::Format_Time)) {
    ...
    if (str_contains(str518, part->type->val)) {
      p_die(fmt133(), part->type);
    }
    if (maybe_str_equals(part->type->val, str520)) {
      p_die(fmt134(), part->type);
    }
  }
  else {
    if (this->token_type == Id::Unknown_Tok) {
      p_die(fmt135(), this->cur_token);
    }
    else {
      p_die(fmt136(), this->cur_token);
    }
  }
  if ((part->precision and !str_contains(str524, part->type->val->index(-1)))) {
...
int Printf::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str526, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
  arg = new arg_types::printf(attrs->attrs);
  Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str527);
  fmt = tup1.at0();
  fmt_spid = tup1.at1();
  ...
  if (dict_contains(this->parse_cache, fmt)) {
    ...
    {  // with
      alloc::ctx_Location ctx(arena, new source::ArgvWord(fmt_spid));
        ...
        if (part->tag_() == printf_part_e::Percent) {
          ...
          if (part->width) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt137(width_str), width_spid);
              return 1;
            }
          }
          precision = -1;
          if (part->precision) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt138(precision_str), precision_spid);
              return 1;
            }
          }
          if (arg_index < num_args) {
          ...
          typ = part->type->val;
          if (str_equals(typ, str535)) {
            if (precision >= 0) {
              s = s->slice(0, precision);
            }
          }
          else {
            if (str_equals(typ, str536)) {
              s = qsn::maybe_shell_encode(s);
            }
            else {
              if (str_equals(typ, str537)) {
                ...
                while (true) {
                  ...
                  tok = new Token(id_, runtime::NO_SPID, tok_val);
                ...
                s = str538->join(c_parts);
              }
              else {
                if ((str_contains(str539, typ) or part->type->id == Id::Format_Time)) {
                  try {
                    d = to_int(s);
                  }
                  catch (ValueError*) {
                    if ((len(s) >= 1 and str_contains(str540, s->index(0)))) {
                      ...
                      if ((part->type->id == Id::Format_Time and (len(s) == 0 and word_spid == runtime::NO_SPID))) {
                        ...
                        this->errfmt->Print_(fmt139(s), blame_spid);
                        return 1;
                      }
                    }
                  }
                  if (str_contains(str542, typ)) {
                    s = str(d);
                  }
                  else {
                    if (str_contains(str543, typ)) {
                      if (d < 0) {
                        e_die(fmt140(d, typ), part->type->span_id);
                      }
                      if (str_equals(typ, str545)) {
                        s = str(d);
                      }
                      else {
                        if (str_equals(typ, str546)) {
                          s = mylib::octal(d);
                        }
                        else {
                          if (str_equals(typ, str547)) {
                            s = mylib::hex_lower(d);
                          }
                          else {
                            if (str_equals(typ, str548)) {
                              s = mylib::hex_upper(d);
                            }
                          }
                        }
          ...
          if (width >= 0) {
            if (len(flags)) {
              if (list_contains(flags, str551)) {
                s = s->ljust(width, str552);
              }
              else {
                if (list_contains(flags, str553)) {
                  s = s->rjust(width, str554);
                }
                else {
                  ;  // pass
                }
  ...
  result = str556->join(out);
  if (arg->v != nullptr) {
    v_spid = runtime::NO_SPID;
    arena = this->parse_ctx->arena;
    a_parser = this->parse_ctx->MakeArithParser(arg->v);
    {  // with
      alloc::ctx_Location ctx(arena, new source::ArgvWord(v_spid));
    ...
    this->mem->SetVar(lval, new value::Str(result), scope_e::Dynamic);
  }
  else {
...
int Alias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    Tuple2<Str*, Str*> tup1 = mylib::split_once(arg, str561);
    name = tup1.at0();
    alias_exp = tup1.at1();
    if (alias_exp == nullptr) {
      alias_exp = this->aliases->get(name);
      if (alias_exp == nullptr) {
        this->errfmt->Print_(fmt144(name), cmd_val->arg_spids->index(i));
        status = 1;
      }
      else {
...
int UnAlias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str564, cmd_val);
  arg_r = tup2.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
    e_usage(str565);
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->argv) == 1) {
    ...
    for (ListIter<Str*> it(sorted(mapping)); !it.Done(); it.Next()) {
      ...
      code_str = fmt147(name, qsn::maybe_shell_encode(str_val));
      print(code_str);
    }
    return 0;
  }
  arg_r = new args::Reader(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  arg = flag_spec::ParseMore(str568, arg_r);
  if (arg->show_options) {
...
int Shopt::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str569, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
...
int Hash::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str570, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
...
Dict<Str*, bool>* _ParseOptSpec(Str* spec_str) {
  ...
  while (true) {
    ...
    if (str_equals(spec_str->index(i), str573)) {
      spec->set(ch, true);
      i += 1;
    }
  }
...
GetOptsState::GetOptsState(state::Mem* mem, ui::ErrorFormatter* errfmt) : gc_heap::Obj(0) {
  this->mem = mem;
  this->errfmt = errfmt;
  this->_optind = -1;
  this->flag_pos = 1;
...
int GetOptsState::_OptInd() {
  ...
  try {
    result = state::GetInteger(this->mem, str574);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    result = -1;
...
void GetOptsState::IncIndex() {
  state::SetStringDynamic(this->mem, str575, str((this->_optind + 1)));
}

void GetOptsState::SetArg(Str* optarg) {
  state::SetStringDynamic(this->mem, str576, optarg);
}

void GetOptsState::Fail() {
  state::SetStringDynamic(this->mem, str577, str578);
}
...
Tuple2<int, Str*> _GetOpts(Dict<Str*, bool>* spec, List<Str*>* argv, builtin_pure::GetOptsState* my_state, ui::ErrorFormatter* errfmt) {
  ...
  if (current == nullptr) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str579));
  }
  if ((!current->startswith(str580) or str_equals(current, str581))) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str582));
  }
  ...
  if (!dict_contains(spec, flag_char)) {
    return (Tuple2<int, Str*>(0, str583));
  }
  if (spec->index(flag_char)) {
    if (more_chars) {
      ...
      if (optarg == nullptr) {
        my_state->Fail();
        errfmt->Print_(fmt149(current));
        tmp = new List<Str*>();
        for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
          Str* a = it.Value();
          tmp->append(qsn::maybe_shell_encode(a));
        }
        println_stderr(fmt150(str586->join(tmp)));
        return (Tuple2<int, Str*>(0, str587));
      }
    }
    my_state->IncIndex();
...
GetOpts::GetOpts(state::Mem* mem, ui::ErrorFormatter* errfmt) {
  this->mem = mem;
  this->errfmt = errfmt;
  this->my_state = new GetOptsState(mem, errfmt);
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = new args::Reader(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  spec_str = arg_r->ReadRequired(str589);
  Tuple2<Str*, int> tup7 = arg_r->ReadRequired2(str590);
  var_name = tup7.at0();
  var_spid = tup7.at1();
  ...
  if (match::IsValidVarName(var_name)) {
    ...
    throw new error::Usage(fmt151(var_name), var_spid);
  }
  return status;
}
...
int Echo::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseLikeEcho(str592, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  if (arg->e) {
    ...
    for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
      ...
      new_argv->append(str593->join(parts));
      if (backslash_c) {
        break;
      }
    }
...
CommandEvaluator::CommandEvaluator(state::Mem* mem, optview::Exec* exec_opts, ui::ErrorFormatter* errfmt, Dict<Str*, syntax_asdl::command__ShFunction*>* procs, Dict<int, vm::_AssignBuiltin*>* assign_builtins, alloc::Arena* arena, cmd_eval::Deps* cmd_deps) : gc_heap::Obj(0) {
...
int CommandEvaluator::_RunAssignBuiltin(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  if (builtin_func == nullptr) {
    e_die(fmt152(cmd_val->argv->index(0)), cmd_val->arg_spids->index(0));
  }
  try {
    try {
      status = builtin_func->Run(cmd_val);
      ...
      this->errfmt->PrefixPrint(e->msg, fmt153(arg0), e->span_id);
      status = 2;
    }
    catch (KeyboardInterrupt*) {
      if (this->exec_opts->interactive()) {
...
void CommandEvaluator::_CheckStatus(int status, syntax_asdl::command_t* node) {
  ...
  if ((this->exec_opts->errexit() and status != 0)) {
    ...
    throw new error::ErrExit(fmt154(status, reason, posix::getpid()), span_id, status);
  }
}
  ...
  switch (arg->tag_()) {
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        filename = val->s;
        if (len(filename) == 0) {
          throw new error::RedirectEval(str606, arg_word);
        }
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          t = val->s;
          if (len(t) == 0) {
            throw new error::RedirectEval(str607, arg_word);
            return nullptr;
          }
          try {
            if (maybe_str_equals(t, str608)) {
              result->arg = new redirect_arg::CloseFd();
            }
            else {
              if (str_equals(t->index(-1), str609)) {
            ...
            throw new error::RedirectEval(fmt155(t), arg_word);
            return nullptr;
          }
          return result;
        }
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = new redirect_arg::HereDoc(str_concat(val->s, str611));
            return result;
          }
          else {
            throw new AssertionError();
  ...
  switch (node->tag_()) {
    case command_e::Simple: {
      ...
      if (UP_cmd_val->tag_() == cmd_value_e::Argv) {
        ...
        argv = new List<Str*>({str614});
        if (node->block) {
          e_die(fmt156(), node->block->spids->index(0));
        }
      }
    ...
    case command_e::Pipeline: {
      ...
      if (len(node->stderr_indices)) {
        e_die(fmt157(), node->spids->index(0));
      }
      if (node->negated) {
        {  // with
          state::ctx_ErrExit ctx(this->mutable_opts, node->spids->index(0));
    ...
    case command_e::ControlFlow: {
      ...
      if (node->arg_word) {
        ...
        try {
          ...
          e_die(fmt158(node->token->val, str_val->s), node->arg_word);
        }
      }
      else {
      ...
      if (ok) {
        ...
        if (this->exec_opts->strict_control_flow()) {
          ...
          this->errfmt->PrefixPrint(msg, str621, tok->span_id);
          status = 0;
        }
      }
    }
    ...
    case command_e::AndOr: {
      ...
      while (i < n) {
        ...
        if (i == (n - 1)) {
          ...
          {  // with
            state::ctx_ErrExit ctx(this->mutable_opts, node->spids->index(i));
    ...
    case command_e::If: {
      ...
      for (ListIter<syntax_asdl::if_arm*> it(node->arms); !it.Done(); it.Next()) {
        ...
        {  // with
          state::ctx_ErrExit ctx(this->mutable_opts, if_arm->spids->index(0));
...
Tuple2<bool, bool> CommandEvaluator::ExecuteAndCatch(syntax_asdl::command_t* node, int cmd_flags) {
  ...
  try {
    ...
    if ((cmd_flags & IsEvalSource)) {
      ...
      if (e->IsReturn()) {
        ...
        is_eval = false;
        this->errfmt->Print_(str623, e->token->span_id);
        is_fatal = true;
        status = 1;
      }
    }
  ...
  if (err) {
    ...
    if ((is_errexit and !this->exec_opts->verbose_errexit())) {
      ...
      ui::PrettyPrintError(err, this->arena, str624);
    }
  }
  ...
  {  // with
    ...
    try {
      ...
      if (e->IsReturn()) {
        ...
        e_die(fmt160(e->token->val), e->token);
      }
    }
    catch (error::FatalRuntime* e) {
      this->dumper->MaybeCollect(this, e);
...
int CommandEvaluator::RunFuncForCompletion(syntax_asdl::command__ShFunction* func_node, List<Str*>* argv) {
  ...
  try {
    ...
    this->errfmt->Print_(str627, e->token->span_id);
    status = 1;
  }
  return status;
}
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index(i), str629))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index(-2), str631)) {
    ...
    if ((left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse)) {
      var_name = left_token->val->slice(0, -1);
      if (str_equals(close_token->val->index(-2), str632)) {
        op = assign_op_e::PlusEqual;
      }
      else {
        op = assign_op_e::Equal;
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        var_name = left_token->val->slice(0, -1);
        if (str_equals(close_token->val->index(-2), str633)) {
          op = assign_op_e::PlusEqual;
        }
        else {
          op = assign_op_e::Equal;
        ...
        if (span1->line_id == span2->line_id) {
          ...
          throw new NotImplementedError(fmt163(span1->line_id, span2->line_id));
        }
        a_parser = parse_ctx->MakeArithParser(code_str);
        src = new source::LValue(left_token->span_id, close_token->span_id);
        {  // with
          alloc::ctx_Location ctx(arena, src);

          index_node = a_parser->Parse();
        }
        tmp3 = new sh_lhs_expr::IndexedName(var_name, index_node);
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    w = tup6->at3();
    if (left_token->id != Id::Lit_VarLike) {
      p_die(fmt164(), left_token);
    }
    if (str_equals(left_token->val->index(-2), str636)) {
      p_die(fmt165(), left_token);
    }
    var_name = left_token->val->slice(0, -1);
    n = len(w->parts);
    if (part_offset == n) {
...
CommandParser::CommandParser(parse_lib::ParseContext* parse_ctx, word_parse::WordParser* w_parser, lexer::Lexer* lexer, reader::_Reader* line_reader) : gc_heap::Obj(0) {
  this->parse_ctx = parse_ctx;
  ...
  this->aliases_in_flight = new List<Tuple2<Str*, int>*>();
...
void CommandParser::_Eat(int c_id) {
  ...
  msg = fmt167(ui::PrettyId(c_id), ui::PrettyId(actual_id));
  this->_Eat2(c_id, msg);
}
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index(0), str640)) {
    pos = op_val->find(str641);
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  aliases_in_flight = len(this->aliases_in_flight) ? this->aliases_in_flight : new List<Tuple2<Str*, int>*>();
  ...
  while (i < n) {
    ...
    i += 1;
    if (!alias_exp->endswith(str643)) {
      expanded->append(str644);
      break;
    }
  }
  if (len(expanded) == 0) {
  ...
  while (i < n) {
    ...
    if (span1->line_id == span2->line_id) {
      ...
      throw new NotImplementedError(fmt169(span1->line_id, span2->line_id));
    }
    expanded->append(str646);
    i += 1;
  }
  code_str = str647->join(expanded);
  line_reader = reader::StringLineReader(code_str, this->arena);
  cp = this->parse_ctx->MakeOshParser(line_reader);
  cp->Init_AliasesInFlight(aliases_in_flight);
  src = new source::Alias(first_word_str, argv0_spid);
  {  // with
    alloc::ctx_Location ctx(this->arena, src);
  ...
  if (kind == Kind::ControlFlow) {
    ...
    if (len(suffix_words) == 1) {
      ...
      if (len(suffix_words) == 2) {
        ...
        p_die(fmt177(kw_token->val), suffix_words->index(2));
      }
    }
...
syntax_asdl::command__ForEach* CommandParser::_ParseForEachLoop(int for_spid) {
  ...
  quoted = tup15.at2();
  if ((!ok or quoted)) {
    p_die(fmt180(), this->cur_word);
  }
  if (!match::IsValidVarName(iter_name)) {
    p_die(fmt181(), this->cur_word);
  }
...
syntax_asdl::command__ShFunction* CommandParser::ParseFunctionDef() {
  ...
  if (len(name) == 0) {
    p_die(fmt185(), cur_word);
  }
  this->_Next();
  this->_Peek();
  this->lexer->PushHint(Id::Op_RParen, Id::Right_ShFunction);
  this->_Next();
  this->_Eat2(Id::Right_ShFunction, str664);
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if (str_equals(c, str672)) {
      i += 1;
    }
    else {
      if ((str_equals(c, str673) or str_equals(c, str674))) {
        return true;
      }
      else {
        if (str_equals(c, str675)) {
          left_bracket = true;
        }
        else {
          if ((str_equals(c, str676) and left_bracket)) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  return pyutil::BackslashEscape(s, str678);
}
Str* ERE_META_CHARS = str679;
...
Str* GlobUnescape(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if ((str_equals(c, str680) and i != (n - 1))) {
      i += 1;
      c2 = s->index(i);
  ...
  return str682->join(unescaped);
}

_GlobParser::_GlobParser(match::SimpleLexer* lexer) : gc_heap::Obj(0) {
  this->lexer = lexer;
  this->token_type = Id::Undefined_Tok;
  this->token_val = str683;
      ...
      if (tag == glob_part_e::Operator) {
        ...
        if (tag == glob_part_e::CharClass) {
          ...
          for (ListIter<Str*> it(part->strs); !it.Done(); it.Next()) {
            Str* s = it.Value();
            if (str_equals(s, str698)) {
              literal_hyphen = true;
              continue;
            }
            if (str_equals(s, str699)) {
...
Globber::Globber(optview::Exec* exec_opts) : gc_heap::Obj(0) {
  this->exec_opts = exec_opts;
}
...
int Globber::Expand(Str* arg, List<Str*>* out) {
  ...
  if (n) {
    for (ListIter<Str*> it(results); !it.Done(); it.Next()) {
      Str* name = it.Value();
      if ((name->startswith(str705) and !this->exec_opts->dashglob())) {
        n -= 1;
        continue;
      }
      out->append(name);
...
namespace source = syntax_asdl::source;
using syntax_asdl::compound_word;
Str* PROMPT_ERROR = str706;

_PromptEvaluatorCache::_PromptEvaluatorCache() : gc_heap::Obj(0) {
  this->cache = new Dict<Str*, Str*>();
  this->euid = -1;
}
...
Str* _PromptEvaluatorCache::Get(Str* name) {
  ...
  if (str_equals(name, str707)) {
    value = this->_GetEuid() == 0 ? str708 : str709;
  }
  else {
    if (str_equals(name, str710)) {
      value = libc::gethostname();
    }
    else {
      if (str_equals(name, str711)) {
...
Evaluator::Evaluator(Str* lang, parse_lib::ParseContext* parse_ctx, state::Mem* mem) : gc_heap::Obj(0) {
  this->word_ev = nullptr;
  this->lang = lang;
  this->parse_ctx = parse_ctx;
  this->mem = mem;
  this->default_prompt = str_concat(lang, str712);
      ...
      if (id_ == Id::PS_Octal3) {
        ...
        if (id_ == Id::PS_LBrace) {
          ...
          if (id_ == Id::PS_RBrace) {
            ...
            if (id_ == Id::PS_Subst) {
              ch = value->slice(1);
              if (str_equals(ch, str715)) {
                r = this->cache->Get(str716);
              }
              else {
                if (str_equals(ch, str717)) {
                  r = this->cache->Get(str718);
                }
                else {
                  if (str_equals(ch, str719)) {
                    hostname = this->cache->Get(str720);
                    Tuple2<Str*, Str*> tup1 = mylib::split_once(hostname, str721);
                    r = tup1.at0();
                  }
                  else {
                    if (str_equals(ch, str722)) {
                      r = this->cache->Get(str723);
                    }
                    else {
                      if (str_equals(ch, str724)) {
                        try {
                          pwd = state::GetString(this->mem, str725);
                          home = state::MaybeString(this->mem, str726);
                          r = ui::PrettyDir(pwd, home);
                        }
                        catch (error::Runtime* e) {
                          r = fmt194(e->UserErrorString());
                        }
                      }
                      else {
                        if (str_equals(ch, str728)) {
                          val = this->mem->GetVar(str729);
                          if (val->tag_() == value_e::Str) {
                            value__Str* str_val = static_cast<value__Str*>(val);
              ...
              ret->append(r->replace(str732, str733));
            }
            else {
              throw new AssertionError();
            }
...
Str* Evaluator::EvalPrompt(runtime_asdl::value_t* UP_val) {
  ...
  if (ps1_word == nullptr) {
    ...
    try {
      ...
      ps1_word = word_::ErrorWord(fmt196(e->UserErrorString()));
    }
...
Str* Evaluator::EvalFirstPrompt() {
  ...
  if (str_equals(this->lang, str737)) {
    val = this->mem->GetVar(str738);
...
UserPlugin::UserPlugin(state::Mem* mem, parse_lib::ParseContext* parse_ctx, cmd_eval::CommandEvaluator* cmd_ev) : gc_heap::Obj(0) {
  this->mem = mem;
  this->parse_ctx = parse_ctx;
  this->cmd_ev = cmd_ev;
  this->arena = parse_ctx->arena;
...
void UserPlugin::Run() {
  ...
  if (node == nullptr) {
    ...
    c_parser = this->parse_ctx->MakeOshParser(line_reader);
    {  // with
      alloc::ctx_Location ctx(this->arena, new source::PromptCommand(runtime::NO_SPID));
    ...
    case lvalue_e::Indexed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          break;
        default: {
          e_die(fmt198(ui::ValType(val)));
        }
      }
      s = word_eval::GetArrayItem(array_val->strs, lval->index);
      if (s == nullptr) {
        val = new value::Str(str742);
      }
      else {
        val = new value::Str(s);
      }
    ...
    case lvalue_e::Keyed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::AssocArray: {
          ...
          break;
        default: {
          e_die(fmt199(ui::ValType(val)));
        }
      }
      s = assoc_val->d->get(lval->key);
      if (s == nullptr) {
        val = new value::Str(str744);
      }
      else {
        val = new value::Str(s);
      }
...
ArithEvaluator::ArithEvaluator(state::Mem* mem, optview::Exec* exec_opts, parse_lib::ParseContext* parse_ctx, ui::ErrorFormatter* errfmt) : gc_heap::Obj(0) {
  this->word_ev = nullptr;
  this->mem = mem;
  this->exec_opts = exec_opts;
  this->parse_ctx = parse_ctx;
...
int ArithEvaluator::_StringToInteger(Str* s, int span_id) {
  ...
  if (s->startswith(str745)) {
    try {
      integer = to_int(s, 16);
    }
    catch (ValueError*) {
      e_strict(fmt200(s), span_id);
    }
    return integer;
  }
  if (s->startswith(str747)) {
    try {
      integer = to_int(s, 8);
    }
    catch (ValueError*) {
      e_strict(fmt201(s), span_id);
    }
    return integer;
  }
  if (str_contains(s, str749)) {
    Tuple2<Str*, Str*> tup0 = mylib::split_once(s, str750);
    b = tup0.at0();
    digits = tup0.at1();
    try {
      base = to_int(b);
      ...
      e_strict(fmt202(b), span_id);
    }
    integer = 0;
    for (StrIter it(digits); !it.Done(); it.Next()) {
      Str* ch = it.Value();
      if (IsLower(ch)) {
        digit = ((ord(ch) - ord(str752)) + 10);
      }
      else {
        if (IsUpper(ch)) {
          digit = ((ord(ch) - ord(str753)) + 36);
        }
        else {
          if (str_equals(ch, str754)) {
            digit = 62;
          }
          else {
            if (str_equals(ch, str755)) {
              digit = 63;
            }
            else {
              if (ch->isdigit()) {
                ...
                e_strict(fmt203(digits), span_id);
              }
            }
          }
        }
      ...
      if (digit >= base) {
        e_strict(fmt204(digits, base), span_id);
      }
  ...
  try {
    ...
    if ((this->exec_opts->eval_unsafe_arith() and this->parse_ctx)) {
      ...
      {  // with
        alloc::ctx_Location ctx(arena, new source::Variable(span_id));
        ...
        try {
          ...
          ui::PrettyPrintError(e, arena);
          e_die(fmt205(), e->span_id);
        }
      }
      if (node2->tag_() == arith_expr_e::Word) {
        e_die(fmt206(s), span_id);
      }
      else {
      ...
      if ((len(s->strip()) == 0 or match::IsValidVarName(s))) {
        e_strict(fmt207(s), span_id);
      }
      else {
        e_die(fmt208(s), span_id);
      }
    }
  }
  return integer;
...
int ArithEvaluator::_ValToIntOrError(runtime_asdl::value_t* val, int span_id) {
  ...
  e_die(fmt210(ui::ValType(val)), span_id);
}
  ...
  if (((val->tag_() == value_e::MaybeStrArray || val->tag_() == value_e::AssocArray) and lval->tag_() == lvalue_e::Named)) {
    ...
    if (word_eval::CheckCompatArray(named_lval->name, this->exec_opts)) {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (val->tag_() == value_e::AssocArray) {
          lval = new lvalue::Keyed(named_lval->name, str764);
        }
      }
        ...
        if (op_id == Id::Arith_Minus) {
          ...
          if (op_id == Id::Arith_Star) {
            ...
            if (op_id == Id::Arith_Slash) {
              if (rhs == 0) {
                e_die(fmt212(), location::SpanForArithExpr(node->right));
              }
              ret = (lhs / rhs);
            }
            else {
              if (op_id == Id::Arith_Percent) {
                if (rhs == 0) {
                  e_die(fmt213(), location::SpanForArithExpr(node->right));
                }
                ret = (lhs % rhs);
              }
              else {
...
void BoolEvaluator::_SetRegexMatches(List<Str*>* matches) {
  state::SetGlobalArray(this->mem, str773, matches);
}
  ...
  switch (node->tag_()) {
    ...
    case bool_expr_e::Unary: {
      ...
      if (arg_type == bool_arg_type_e::Other) {
        ...
        e_die(fmt215(ui::PrettyId(op_id)));
      }
      throw new AssertionError();
    }
      break;
      ...
      if (arg_type == bool_arg_type_e::Str) {
        ...
        if (op_id == Id::BoolBinary_EqualTilde) {
          try {
            ...
            msg = e->message;
            e_die(fmt216(s2, msg, node->right), 2);
          }
          if (matches == nullptr) {
            return false;
          }
...
SplitContext::SplitContext(state::Mem* mem) : gc_heap::Obj(0) {
  this->mem = mem;
...
_BaseSplitter::_BaseSplitter(Str* escape_chars) : gc_heap::Obj(0) {
  this->escape_chars = str_concat(escape_chars, str784);
}
    ...
    if (i < n) {
      ...
      if (str_contains(ws_chars, c)) {
        ...
        if (str_contains(other_chars, c)) {
          ...
          if ((allow_escape and str_equals(c, str785))) {
...
Str* Utf8Encode(int code) {
  ...
  return str788->join(tmp);
}
Str* INCOMPLETE_CHAR = str789;
Str* INVALID_CONT = str790;
Str* INVALID_START = str791;
    ...
    if ((op->op_id == Id::VOp1_Pound || op->op_id == Id::VOp1_DPound)) {
      ...
      if ((op->op_id == Id::VOp1_Percent || op->op_id == Id::VOp1_DPercent)) {
        ...
        if (op->op_id == Id::VOp1_Comma) {
          if (!(str_equals(arg, str792))) {
            e_die(fmt217(ui::PrettyId(op->op_id)));
          }
          if (len(s)) {
          ...
          if (op->op_id == Id::VOp1_DComma) {
            if (!(str_equals(arg, str794))) {
              e_die(fmt218(ui::PrettyId(op->op_id)));
            }
            return s->lower();
          }
          else {
            if (op->op_id == Id::VOp1_Caret) {
              if (!(str_equals(arg, str796))) {
                e_die(fmt219(ui::PrettyId(op->op_id)));
              }
              if (len(s)) {
              ...
              if (op->op_id == Id::VOp1_DCaret) {
                if (!(str_equals(arg, str798))) {
                  e_die(fmt220(ui::PrettyId(op->op_id)));
                }
                return s->upper();
              }
              else {
...
Str* _PatSubAll(Str* s, Str* regex, Str* replace_str) {
  ...
  return str800->join(parts);
}

GlobReplacer::GlobReplacer(Str* regex, Str* replace_str, int slash_spid) : gc_heap::Obj(0) {
  this->regex = regex;
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Slash) {
    try {
      ...
      msg = e->message;
      e_die(fmt222(regex, msg), this->slash_spid);
    }
  }
  if (op->replace_mode == Id::Lit_Pound) {
    regex = str_concat(str804, regex);
  }
  else {
    if (op->replace_mode == Id::Lit_Percent) {
      regex = str_concat(regex, str805);
    }
  }
...
Str* ShellQuoteB(Str* s) {
  s = s->replace(str806, str807)->replace(str808, str809);
  return pyutil::BackslashEscape(s, str810);
}
...
TdopParser::TdopParser(tdop::ParserSpec* spec, word_parse::WordParser* w_parser, optview::Parse* parse_opts) : gc_heap::Obj(0) {
  this->spec = spec;
  this->w_parser = w_parser;
  this->parse_opts = parse_opts;
  this->cur_word = nullptr;
...
void TdopParser::Eat(int token_type) {
  if (!this->AtToken(token_type)) {
    p_die(fmt226(ui::PrettyId(token_type), ui::PrettyId(this->op_id)), this->cur_word);
  }
  this->Next();
}
...
using runtime_asdl::scope_e;
List<Str*>* _STRING_AND_ARRAY = new List<Str*>({str817, str818, str819});
...
runtime_asdl::value_t* ResolveCompatArray(runtime_asdl::value_t* val) {
  ...
  if (val->tag_() == value_e::MaybeStrArray) {
    ...
    if (val->tag_() == value_e::AssocArray) {
      value__AssocArray* assoc_val = static_cast<value__AssocArray*>(val);
      s = dict_contains(assoc_val->d, str820) ? assoc_val->d->index(str821) : nullptr;
    }
    else {
      throw new AssertionError();
    }
...
Str* _BackslashEscape(Str* s) {
  return s->replace(str824, str825);
}
...
runtime_asdl::part_value_t* _ValueToPartValue(runtime_asdl::value_t* val, bool quoted) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      return new part_value::String(str826, quoted, !quoted);
    }
      break;
    case value_e::Str: {
      value__Str* val = static_cast<value__Str*>(UP_val);
...
runtime_asdl::value_t* _PerformSlice(runtime_asdl::value_t* val, int begin, int length, bool has_length, syntax_asdl::braced_var_sub* part, runtime_asdl::value__Str* arg0_val) {
  ...
  switch (val->tag_()) {
    case value_e::Str: {
      ...
      result = new value::Str(substr);
    }
      break;
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* val = static_cast<value__MaybeStrArray*>(UP_val);
      if ((has_length and length < 0)) {
        e_die(fmt229(length), part);
      }
      if (arg0_val != nullptr) {
      ...
      result = new value::MaybeStrArray(strs);
    }
      break;
    case value_e::AssocArray: {
      e_die(fmt230(), part);
...
StringWordEvaluator::StringWordEvaluator() : gc_heap::Obj(0) {
  ;  // pass
}
...
Str* _GetDollarHyphen(optview::Exec* exec_opts) {
  ...
  return str837->join(chars);
}

TildeEvaluator::TildeEvaluator(state::Mem* mem, optview::Exec* exec_opts) : gc_heap::Obj(0) {
  this->mem = mem;
  this->exec_opts = exec_opts;
}
...
Str* TildeEvaluator::Eval(syntax_asdl::Token* token) {
  ...
  if (maybe_str_equals(token->val, str838)) {
    val = this->mem->GetVar(str839);
    UP_val = val;
    if (val->tag_() == value_e::Str) {
      value__Str* val = static_cast<value__Str*>(UP_val);
      return val->s;
...
runtime_asdl::part_value_t* AbstractWordEvaluator::_EvalCommandSub(syntax_asdl::command_t* node, int id_, bool quoted) {
  throw new NotImplementedError();
}
      ...
      if ((op->op_id == Id::VTest_ColonEquals || op->op_id == Id::VTest_Equals)) {
        ...
        if ((op->op_id == Id::VTest_ColonQMark || op->op_id == Id::VTest_QMark)) {
          if (is_falsey) {
            ...
            e_die(fmt232(error_str), blame_token);
          }
          else {
            return false;
          }
...
runtime_asdl::value_t* AbstractWordEvaluator::_EvalIndirectArrayExpansion(Str* name, Str* index) {
  ...
  switch (val->tag_()) {
    ...
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* val = static_cast<value__MaybeStrArray*>(UP_val);
      if ((str_equals(index, str843) || str_equals(index, str844))) {
    ...
    case value_e::AssocArray: {
      value__AssocArray* val = static_cast<value__AssocArray*>(UP_val);
      if ((str_equals(index, str845) || str_equals(index, str846))) {
        throw new NotImplementedError();
      }
      s = val->d->get(index);
      if (s != nullptr) {
      ...
      case value_e::Str: {
        ...
        try {
          ...
          if (this->exec_opts->strict_word_eval()) {
            ...
            this->errfmt->PrettyPrintError(e, str847);
            return new value::Str(str848);
          }
        }
      }
        break;
    ...
    if (op_id == Id::VSub_Bang) {
      ...
      switch (val->tag_()) {
        case value_e::Str: {
          ...
          if ((maybe_str_equals(val->s, str849) || maybe_str_equals(val->s, str850))) {
            return new value::MaybeStrArray(this->mem->GetArgv());
          }
          i = val->s->find(str851);
          if ((i >= 0 and str_equals(val->s->index(-1), str852))) {
...
runtime_asdl::value_t* AbstractWordEvaluator::_Slice(runtime_asdl::value_t* val, syntax_asdl::suffix_op__Slice* op, Str* var_name, syntax_asdl::braced_var_sub* part) {
  ...
  try {
    ...
    if (this->exec_opts->strict_word_eval()) {
      ...
      this->errfmt->PrettyPrintError(e, str855);
      switch (val->tag_()) {
        case value_e::Str: {
          val = new value::Str(str856);
        }
          break;
        case value_e::MaybeStrArray: {
  ...
  if (op_id == Id::VOp0_P) {
    switch (val->tag_()) {
      case value_e::Str: {
        ...
        p = prompt->replace(str857, str858)->replace(str859, str860);
        result = new value::Str(p);
      }
        break;
      default: {
        e_die(fmt234(ui::ValType(val)));
      }
    }
  }
  else {
    if (op_id == Id::VOp0_Q) {
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          result = new value::Str(str862->join(tmp));
        }
          break;
        default: {
          e_die(fmt235(ui::ValType(val)));
        }
      }
    }
    else {
      if (op_id == Id::VOp0_a) {
        ...
        result = new value::Str(str869->join(chars));
      }
      else {
        e_die(fmt236(op->val), op);
      }
    }
  }
...
Tuple2<runtime_asdl::value_t*, runtime_asdl::a_index_t*> AbstractWordEvaluator::_ArrayIndex(runtime_asdl::value_t* val, syntax_asdl::braced_var_sub* part) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      ...
      break;
    case value_e::Str: {
      e_die(fmt239(part->token->val), part->token);
    }
      break;
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* array_val = static_cast<value__MaybeStrArray*>(UP_val);
...
void AbstractWordEvaluator::_EvalDoubleQuoted(List<syntax_asdl::word_part_t*>* parts, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  if (len(parts) == 0) {
    v = new part_value::String(str874, true, false);
    part_vals->append(v);
    return ;
  }
...
runtime_asdl::value_t* AbstractWordEvaluator::_EmptyStrOrError(runtime_asdl::value_t* val, syntax_asdl::Token* token) {
  ...
  if (!this->exec_opts->nounset()) {
    return new value::Str(str875);
  }
  name = token->val->startswith(str876) ? token->val->slice(1) : token->val;
  e_die(fmt240(name), token);
}

runtime_asdl::value_t* AbstractWordEvaluator::_EmptyMaybeStrArrayOrError(syntax_asdl::Token* token) {
  if (this->exec_opts->nounset()) {
    e_die(fmt241(token->val), token);
  }
  else {
  ...
  switch (part->tag_()) {
    ...
    case word_part_e::CommandSub: {
      ...
      if ((id_ == Id::Left_DollarParen || id_ == Id::Left_AtParen || id_ == Id::Left_Backtick)) {
        sv = this->_EvalCommandSub(part->child, id_, quoted);
      }
      else {
    ...
    case word_part_e::ExtGlob: {
      ...
      part_vals->append(new part_value::String(op_str, false, false));
      i = 0;
      for (ListIter<syntax_asdl::word_t*> it(part->arms); !it.Done(); it.Next(), ++i) {
        syntax_asdl::word_t* w = it.Value();
        if (i != 0) {
          part_vals->append(new part_value::String(str887, false, false));
        }
        this->_EvalWordToParts(w, false, part_vals);
      }
      part_vals->append(new part_value::String(str888, false, false));
    }
      break;
...
void AbstractWordEvaluator::_EvalWordToParts(syntax_asdl::word_t* w, bool quoted, List<runtime_asdl::part_value_t*>* part_vals, bool is_subst) {
  ...
  switch (w->tag_()) {
    case word_e::Compound: {
      ...
      break;
    case word_e::Empty: {
      part_vals->append(new part_value::String(str890, quoted, !quoted));
    }
      break;
    default: {
      throw new AssertionError();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, runtime_asdl::quote_t quote_kind) {
  ...
  return new value::Str(str894->join(strs));
}
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalForPlugin(syntax_asdl::compound_word* w) {
  ...
  {  // with
    ...
    try {
      ...
      val = new value::Str(fmt249(e->UserErrorString()));
    }
    catch (_OSError* e) {
      val = new value::Str(fmt250(pyutil::strerror(e)));
    }
    catch (KeyboardInterrupt*) {
      val = new value::Str(str897);
    }
  }
  return val;
}
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index(-2), str904)) {
          e_die(fmt252(), w);
        }
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        if ((arg->startswith(str906) or arg->startswith(str907))) {
          flags->append(arg);
          flag_spids->append(word_spid);
          if ((str_contains(arg, str908) or str_contains(arg, str909))) {
            eval_to_pairs = false;
          }
        }
        else {
...
runtime_asdl::part_value_t* NormalWordEvaluator::_EvalCommandSub(syntax_asdl::command_t* node, int id_, bool quoted) {
  Str* stdout;
  List<Str*>* strs;
  ...
  if (id_ == Id::Left_AtParen) {
    ...
    return new part_value::Array(strs);
  }
  else {
...
runtime_asdl::part_value_t* CompletionWordEvaluator::_EvalCommandSub(syntax_asdl::command_t* node, int id_, bool quoted) {
  if (id_ == Id::Left_AtParen) {
    return new part_value::Array(new List<Str*>({_DUMMY}));
  }
  else {
    return new part_value::String(_DUMMY, quoted, !quoted);
  }
}

runtime_asdl::part_value__String* CompletionWordEvaluator::_EvalProcessSub(syntax_asdl::command_t* node, int id_) {
  return new part_value::String(str914, true, false);
}
...
WordEmitter::WordEmitter() : gc_heap::Obj(0) {
  ;  // pass
}
...
syntax_asdl::suffix_op__PatSub* WordParser::_ReadPatSubVarOp() {
  ...
  if (this->token_type == Id::Lit_Slash) {
    ...
    this->_Peek();
    if (this->token_type != Id::Right_DollarBrace) {
      p_die(fmt256(ui::PrettyId(this->token_type)), this->cur_token);
    }
        ...
        if (op_kind == Kind::VOp2) {
          if (this->token_type == Id::VOp2_Slash) {
            ...
            if (this->token_type == Id::VOp2_Colon) {
              ...
              p_die(fmt262(str924), this->cur_token);
            }
          }
        }
        else {
          if (op_kind == Kind::VOp3) {
            if (allow_query) {
              ...
              p_die(fmt263(str926), this->cur_token);
            }
          }
        }
      }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool no_backslashes) {
  ...
  while (!done) {
    ...
    if ((this->token_kind == Kind::Lit || this->token_kind == Kind::Char)) {
      tok = this->cur_token;
      if ((no_backslashes and str_contains(tok->val, str930))) {
        p_die(fmt267(), tok);
      }
      tokens->append(tok);
    }
  ...
  if ((left_id == Id::Left_DollarParen || left_id == Id::Left_AtParen || left_id == Id::Left_ProcSubIn || left_id == Id::Left_ProcSubOut)) {
    ...
    if ((left_id == Id::Left_Backtick and this->parse_ctx->one_pass_parse)) {
      ...
      if (left_id == Id::Left_Backtick) {
        ...
        right_spid = this->cur_token->span_id;
        code_str = str936->join(parts);
        arena = this->parse_ctx->arena;
        line_reader = reader::StringLineReader(code_str, arena);
        c_parser = this->parse_ctx->MakeOshParser(line_reader);
        {  // with
          alloc::ctx_Location ctx(arena, new source::Backticks(left_spid, right_spid));
...
void WordParser::ParseProc(syntax_asdl::command__Proc* node) {
  ...
  if (this->token_type != Id::Lit_Chars) {
    p_die(fmt272(ui::PrettyToken(this->cur_token, this->arena)), this->cur_token);
  }
...
syntax_asdl::arith_expr_t* WordParser::_ReadArithExpr(int end_id) {
  ...
  if ((end_id != Id::Undefined_Tok and cur_id != end_id)) {
    p_die(fmt273(ui::PrettyId(cur_id), ui::PrettyId(end_id)), this->a_parser->cur_word);
  }
  return anode;
}
...
syntax_asdl::command__ForExpr* WordParser::ReadForExpression() {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt276(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
  if (cur_id == Id::Arith_Semi) {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt277(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
...
Tuple2<syntax_asdl::word_t*, bool> WordParser::_ReadArithWord() {
  ...
  if (this->token_kind == Kind::Unknown) {
    p_die(fmt285(this->cur_token->val), this->cur_token);
  }
  else {
    if (this->token_kind == Kind::Eof) {
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str953, false));
    }
      break;
    case word_part_e::AssocArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str954, false));
    }
      break;
    case word_part_e::Literal: {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str956, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str957->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
    ...
    case word_part_e::ExtGlob: 
    case word_part_e::Splice: {
      return (Tuple3<bool, Str*, bool>(false, str958, false));
    }
      break;
    default: {
      throw new AssertionError();
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() != word_e::Compound) {
    return (Tuple3<bool, Str*, bool>(false, str959, quoted));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  strs = new List<Str*>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str960, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str961->join(strs), quoted));
}
...
syntax_asdl::compound_word* TildeDetect(syntax_asdl::word_t* UP_w) {
  ...
  if ((id_ == Id::Lit_Chars and static_cast<Token*>(part1)->val->startswith(str963))) {
    new_parts->extend(w->parts->slice(1));
    return new compound_word(new_parts);
  }
  return nullptr;
...
void TildeDetectAssign(syntax_asdl::compound_word* w) {
  ...
  for (int i = 0; i < n; ++i) {
    ...
    if ((do_expand and LiteralId(cur) == Id::Lit_TildeLike)) {
      ...
      if (next_part) {
        is_tilde = (LiteralId(next_part) == Id::Lit_Colon or (LiteralId(next_part) == Id::Lit_Chars and static_cast<Token*>(next_part)->val->startswith(str964)));
      }
      else {
        is_tilde = true;
      }
...
PNode::PNode(int typ, syntax_asdl::Token* tok, List<pnode::PNode*>* children) : gc_heap::Obj(0) {
  this->typ = typ;
  this->tok = tok;
...
Str* escape(Str* s) {
  s = s->replace(str974, str975);
  s = s->replace(str976, str977);
  s = s->replace(str978, str979);
  return s;
}
...
Str* join(Str* s1, Str* s2) {
  if ((s2->startswith(str982) or len(s1) == 0)) {
    return s2;
  }
  if (s1->endswith(str983)) {
...
Tuple2<Str*, Str*> split(Str* p) {
  ...
  head = p->slice(0, i);
  tail = p->slice(i);
  if ((len(head) and !(str_equals(head, str_repeat(str986, len(head)))))) {
    head = head->rstrip(str987);
  }
...
Tuple2<Str*, Str*> _splitext(Str* p, Str* sep, Str* extsep) {
  ...
  return (Tuple2<Str*, Str*>(p, str988));
}
...
Str* dirname(Str* p) {
  ...
  i = (p->rfind(str990) + 1);
  head = p->slice(0, i);
  if ((head and !(str_equals(head, str_repeat(str991, len(head)))))) {
    head = head->rstrip(str992);
  }
  return head;
}
...
Str* normpath(Str* path) {
  ...
  slash = str993;
  dot = str994;
  if (str_equals(path, str995)) {
    return dot;
  }
  initial_slashes = path->startswith(str996);
  if ((initial_slashes and (path->startswith(str997) and !path->startswith(str998)))) {
    initial_slashes = 2;
  }
  comps = path->split(str999);
  new_comps = new List<Str*>();
  for (ListIter<Str*> it(comps); !it.Done(); it.Next()) {
    Str* comp = it.Value();
    if ((len(comp) == 0 or str_equals(comp, str1000))) {
      continue;
    }
    if ((!(str_equals(comp, str1001)) or ((initial_slashes == 0 and len(new_comps) == 0) or (len(new_comps) and str_equals(new_comps->index(-1), str1002))))) {
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if ((str_contains(str1004, ch) or IsUnprintableLow(ch))) {
        quote = 2;
        break;
      }
    }
  ...
  parts->append(str1007);
  return str_concat(prefix, str1008->join(parts));
}
...
Str* maybe_encode(Str* s, int bit8_display) {
  ...
  parts = new List<Str*>();
  parts->append(str1009);
  _encode(s, bit8_display, false, parts);
  parts->append(str1010);
  return str1011->join(parts);
}
...
Str* encode(Str* s, int bit8_display) {
  ...
  parts = new List<Str*>();
  parts->append(str1012);
  _encode(s, bit8_display, false, parts);
  parts->append(str1013);
  return str1014->join(parts);
}
...
void _encode_bytes_x(Str* s, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    Str* byte = it.Value();
    if (str_equals(byte, str1015)) {
      part = str1016;
    }
    else {
      if (str_equals(byte, str1017)) {
        part = str1018;
      }
      else {
        if (str_equals(byte, str1019)) {
          part = str1020;
        }
        else {
          if (str_equals(byte, str1021)) {
            part = str1022;
          }
          else {
            if (str_equals(byte, str1023)) {
              part = str1024;
            }
            else {
              if (str_equals(byte, str1025)) {
                part = shell_compat ? str1026 : str1027;
              }
              else {
...
bool _encode_runes(Str* s, int bit8_display, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (typ == Ascii) {
      state = Start;
      if (str_equals(byte, str1031)) {
        out = str1032;
      }
      else {
        if (str_equals(byte, str1033)) {
          out = str1034;
        }
        else {
          if (str_equals(byte, str1035)) {
            out = str1036;
          }
          else {
            if (str_equals(byte, str1037)) {
              out = str1038;
            }
            else {
              if (str_equals(byte, str1039)) {
                out = str1040;
              }
              else {
                if (str_equals(byte, str1041)) {
                  out = shell_compat ? str1042 : str1043;
                }
                else {
                  if (IsUnprintableLow(byte)) {
...
syntax_asdl::word__String* _StringWordEmitter::ReadWord(types_asdl::lex_mode_t unused_lex_mode) {
  ...
  if (this->i == this->n) {
    w = new word::String(Id::Eof_Real, str1044, runtime::NO_SPID);
    return w;
  }
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    strs = cmd_val->argv;
    if ((!strs or !(str_equals(strs->index(-1), str1053)))) {
      this->errfmt->Print_(str1054, cmd_val->arg_spids->index(0));
      return 2;
    }
    cmd_val->argv->pop();
  ...
  try {
    ...
    if (n == 4) {
      a0 = w_parser->Peek(0);
      if (str_equals(a0, str1055)) {
        w_parser->Read();
        child = _ThreeArgs(w_parser);
        bool_node = new bool_expr::LogicalNot(child);
      }
      else {
        if ((str_equals(a0, str1056) and str_equals(w_parser->Peek(3), str1057))) {
          w_parser->Read();
          bool_node = _TwoArgs(w_parser);
        }
        else {
    ...
    this->errfmt->PrettyPrintError(e, str1058);
    return 2;
  }

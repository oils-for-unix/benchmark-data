...
class source__ArgvCommand : public source_t {
 public:
  source__ArgvCommand() :
                      type_tag_(static_cast<uint16_t>(source_e::ArgvCommand)),
                      first_spid(-1) {
  }
...
class source__EvalArg : public source_t {
 public:
  source__EvalArg() : type_tag_(static_cast<uint16_t>(source_e::EvalArg)),
                  eval_spid(-1) {
  }
  source__EvalArg(int eval_spid) :
                  type_tag_(static_cast<uint16_t>(source_e::EvalArg)),
                  eval_spid(eval_spid) {
  }
  OBJ_HEADER();
  int eval_spid;
...
class source__Trap : public source_t {
 public:
  source__Trap() : type_tag_(static_cast<uint16_t>(source_e::Trap)),
               word_spid(-1) {
  }
  source__Trap(int word_spid) :
               type_tag_(static_cast<uint16_t>(source_e::Trap)),
               word_spid(word_spid) {
  }
  OBJ_HEADER();
  int word_spid;
...
class source__PromptCommand : public source_t {
 public:
  source__PromptCommand() :
                        type_tag_(static_cast<uint16_t>(source_e::PromptCommand)), spid(-1) {
  }
  source__PromptCommand(int spid) :
                        type_tag_(static_cast<uint16_t>(source_e::PromptCommand)), spid(spid) {
  }
  OBJ_HEADER();
  int spid;
  hnode_t* PrettyTree();
...
class source__Backticks : public source_t {
 public:
  source__Backticks() : type_tag_(static_cast<uint16_t>(source_e::Backticks)),
                    left_spid(-1), right_spid(-1) {
  }
  source__Backticks(int left_spid, int right_spid) :
                    type_tag_(static_cast<uint16_t>(source_e::Backticks)),
...
class source__LValue : public source_t {
 public:
  source__LValue() : type_tag_(static_cast<uint16_t>(source_e::LValue)),
                 left_spid(-1), right_spid(-1) {
  }
  source__LValue(int left_spid, int right_spid) :
                 type_tag_(static_cast<uint16_t>(source_e::LValue)),
                 left_spid(left_spid), right_spid(right_spid) {
  }
  OBJ_HEADER();
  int left_spid;
...
class redir_param__MultiLine : public redir_param_t {
 public:
  redir_param__MultiLine() :
                         type_tag_(static_cast<uint16_t>(redir_param_e::MultiLine)), here_begin(nullptr), here_end_span_id(-1), stdin_parts(new List<word_part_t*>()) {
  }
  redir_param__MultiLine(word_t* here_begin, int here_end_span_id,
                         List<word_part_t*>* stdin_parts) :
                         type_tag_(static_cast<uint16_t>(redir_param_e::MultiLine)), here_begin(here_begin), here_end_span_id(here_end_span_id), stdin_parts(stdin_parts) {
  }
  OBJ_HEADER();
  word_t* here_begin;
...
class command__OilCondition : public command_t {
 public:
  command__OilCondition() :
                        type_tag_(static_cast<uint16_t>(command_e::OilCondition)), e(nullptr), spids(new List<int>()) {
  }
  command__OilCondition(expr_t* e) :
                        type_tag_(static_cast<uint16_t>(command_e::OilCondition)), e(e), spids(new List<int>()) {
  }
  OBJ_HEADER();
  expr_t* e;
  List<int>* spids;
...
class command__Use : public command_t {
 public:
  command__Use() : type_tag_(static_cast<uint16_t>(command_e::Use)),
               path(nullptr), alias(nullptr), names(new List<use_name*>()),
               spids(new List<int>()) {
  }
  command__Use(single_quoted* path, Token* alias, List<use_name*>* names) :
               type_tag_(static_cast<uint16_t>(command_e::Use)), path(path),
...
class_literal_term_t, public re_t {
 public:
  double_quoted() : type_tag_(203), left(nullptr), parts(new
                List<word_part_t*>()), spids(new List<int>()) {
  }
  double_quoted(Token* left, List<word_part_t*>* parts) : type_tag_(203),
...
class_literal_term_t, public re_t {
 public:
  ...
  single_quoted(Token* left, List<Token*>* tokens) : type_tag_(204),
                left(left), tokens(tokens), spids(new List<int>()) {
  }
  OBJ_HEADER();
  Token* left;
  List<Token*>* tokens;
...
class redir {
 public:
  redir() : type_tag_(211), op(nullptr), loc(nullptr), arg(nullptr) {
  }
  redir(Token* op, redir_loc_t* loc, redir_param_t* arg) : type_tag_(211),
...
class assign_pair {
 public:
  assign_pair() : type_tag_(212), lhs(nullptr), op(assign_op_e::Equal),
              rhs(nullptr), spids(new List<int>()) {
  }
  assign_pair(sh_lhs_expr_t* lhs, assign_op_t op, word_t* rhs, List<int>*
              spids) : type_tag_(212), lhs(lhs), op(op), rhs(rhs), spids(spids)
              {
  }
  OBJ_HEADER();
  sh_lhs_expr_t* lhs;
...
class env_pair {
 public:
  env_pair() : type_tag_(213), name(new Str("")), val(nullptr), spids(new
           List<int>()) {
  }
  env_pair(Str* name, word_t* val, List<int>* spids) : type_tag_(213),
...
class case_arm {
 public:
  case_arm() : type_tag_(214), pat_list(new List<word_t*>()), action(new
           List<command_t*>()), spids(new List<int>()) {
  }
  case_arm(List<word_t*>* pat_list, List<command_t*>* action, List<int>* spids)
           : type_tag_(214), pat_list(pat_list), action(action), spids(spids) {
  }
  OBJ_HEADER();
...
class if_arm {
 public:
  if_arm() : type_tag_(215), cond(new List<command_t*>()), action(new
         List<command_t*>()), spids(new List<int>()) {
  }
  if_arm(List<command_t*>* cond, List<command_t*>* action, List<int>* spids) :
         type_tag_(215), cond(cond), action(action), spids(spids) {
  }
  OBJ_HEADER();
  List<command_t*>* cond;
  List<command_t*>* action;
...
class BraceGroup : public command_t {
 public:
  BraceGroup() : type_tag_(216), children(new List<command_t*>()),
             redirects(new List<redir*>()), spids(new List<int>()) {
  }
  BraceGroup(List<command_t*>* children, List<redir*>* redirects) :
             type_tag_(216), children(children), redirects(redirects),
             spids(new List<int>()) {
  }
  OBJ_HEADER();
  List<command_t*>* children;
...
class variant {
 public:
  variant() : type_tag_(217), tag_name(nullptr), typ(nullptr) {
  }
  variant(Token* tag_name, variant_type_t* typ) : type_tag_(217),
...
class use_name {
 public:
  use_name() : type_tag_(218), name(nullptr), alias(nullptr) {
  }
  use_name(Token* name, Token* alias) : type_tag_(218), name(name),
           alias(alias) {
  }
  OBJ_HEADER();
  Token* name;
...
class param {
 public:
  param() : type_tag_(219), name(nullptr), type(nullptr), default_val(nullptr) {
  }
  param(Token* name, type_expr_t* type, expr_t* default_val) : type_tag_(219),
...
class name_type {
 public:
  name_type() : type_tag_(220), name(nullptr), typ(nullptr) {
  }
  name_type(Token* name, type_expr_t* typ) : type_tag_(220), name(name),
            typ(typ) {
  }
  OBJ_HEADER();
  Token* name;
...
class comprehension {
 public:
  comprehension() : type_tag_(221), lhs(new List<name_type*>()), iter(nullptr),
                cond(nullptr) {
  }
  comprehension(List<name_type*>* lhs, expr_t* iter, expr_t* cond) :
                type_tag_(221), lhs(lhs), iter(iter), cond(cond) {
  }
  OBJ_HEADER();
  List<name_type*>* lhs;
  expr_t* iter;
...
class named_arg {
 public:
  named_arg() : type_tag_(222), name(nullptr), value(nullptr) {
  }
  named_arg(Token* name, expr_t* value) : type_tag_(222), name(name),
            value(value) {
  }
  OBJ_HEADER();
  Token* name;
...
class subscript : public place_expr_t, public expr_t {
 public:
  subscript() : type_tag_(223), obj(nullptr), indices(new List<expr_t*>()) {
  }
  subscript(expr_t* obj, List<expr_t*>* indices) : type_tag_(223), obj(obj),
            indices(indices) {
  }
  OBJ_HEADER();
  expr_t* obj;
...
class attribute : public place_expr_t, public expr_t {
 public:
  attribute() : type_tag_(224), obj(nullptr), op(nullptr), attr(nullptr),
            ctx(expr_context_e::Load) {
  }
  attribute(expr_t* obj, Token* op, Token* attr, expr_context_t ctx) :
            type_tag_(224), obj(obj), op(op), attr(attr), ctx(ctx) {
  }
  OBJ_HEADER();
  expr_t* obj;
  Token* op;
...
class posix_class : public class_literal_term_t, public re_t {
 public:
  posix_class() : type_tag_(225), negated(nullptr), name(new Str("")) {
  }
  posix_class(speck* negated, Str* name) : type_tag_(225), negated(negated),
              name(name) {
  }
  OBJ_HEADER();
  speck* negated;
...
class perl_class : public class_literal_term_t, public re_t {
 public:
  perl_class() : type_tag_(226), negated(nullptr), name(new Str("")) {
  }
  perl_class(speck* negated, Str* name) : type_tag_(226), negated(negated),
             name(name) {
  }
  OBJ_HEADER();
  speck* negated;

...
GLOBAL_LIST(YSH_UPGRADE, int, 26, {61 COMMA 60 COMMA 66 COMMA 1 COMMA 68 COMMA 4 COMMA 67 COMMA 2 COMMA 5 COMMA 50 COMMA 53 COMMA 54 COMMA 55 COMMA 52 COMMA 56 COMMA 51 COMMA 58 COMMA 57 COMMA 3 COMMA 62 COMMA 65 COMMA 59 COMMA 6 COMMA 7 COMMA 64 COMMA 63});
GLOBAL_LIST(YSH_ALL, int, 54, {61 COMMA 60 COMMA 66 COMMA 1 COMMA 84 COMMA 68 COMMA 4 COMMA 67 COMMA 79 COMMA 80 COMMA 2 COMMA 5 COMMA 50 COMMA 69 COMMA 70 COMMA 71 COMMA 77 COMMA 53 COMMA 54 COMMA 76 COMMA 72 COMMA 75 COMMA 55 COMMA 52 COMMA 73 COMMA 56 COMMA 51 COMMA 74 COMMA 58 COMMA 78 COMMA 57 COMMA 3 COMMA 62 COMMA 65 COMMA 81 COMMA 82 COMMA 83 COMMA 59 COMMA 40 COMMA 41 COMMA 42 COMMA 43 COMMA 44 COMMA 45 COMMA 49 COMMA 46 COMMA 38 COMMA 39 COMMA 48 COMMA 47 COMMA 6 COMMA 7 COMMA 64 COMMA 63});
GLOBAL_LIST(DEFAULT_TRUE, int, 18, {29 COMMA 30 COMMA 60 COMMA 31 COMMA 84 COMMA 18 COMMA 19 COMMA 70 COMMA 71 COMMA 77 COMMA 76 COMMA 72 COMMA 75 COMMA 73 COMMA 74 COMMA 78 COMMA 28 COMMA 64});
GLOBAL_LIST(PARSE_OPTION_NUMS, int, 22, {84 COMMA 50 COMMA 69 COMMA 70 COMMA 71 COMMA 77 COMMA 53 COMMA 54 COMMA 76 COMMA 72 COMMA 75 COMMA 55 COMMA 52 COMMA 73 COMMA 56 COMMA 51 COMMA 74 COMMA 58 COMMA 78 COMMA 57 COMMA 38 COMMA 39});
GLOBAL_LIST(SHOPT_OPTION_NUMS, int, 107, {29 COMMA 30 COMMA 36 COMMA 37 COMMA 35 COMMA 34 COMMA 89 COMMA 90 COMMA 91 COMMA 92 COMMA 93 COMMA 94 COMMA 95 COMMA 88 COMMA 61 COMMA 96 COMMA 60 COMMA 97 COMMA 98 COMMA 23 COMMA 31 COMMA 66 COMMA 25 COMMA 99 COMMA 84 COMMA 24 COMMA 21 COMMA 100 COMMA 20 COMMA 68 COMMA 101 COMMA 102 COMMA 103 COMMA 104 COMMA 87 COMMA 105 COMMA 106 COMMA 86 COMMA 107 COMMA 26 COMMA 27 COMMA 4 COMMA 67 COMMA 108 COMMA 19 COMMA 109 COMMA 110 COMMA 111 COMMA 112 COMMA 113 COMMA 114 COMMA 79 COMMA 80 COMMA 115 COMMA 22 COMMA 5 COMMA 50 COMMA 69 COMMA 70 COMMA 71 COMMA 77 COMMA 53 COMMA 54 COMMA 76 COMMA 72 COMMA 75 COMMA 55 COMMA 52 COMMA 73 COMMA 56 COMMA 51 COMMA 74 COMMA 58 COMMA 78 COMMA 57 COMMA 62 COMMA 85 COMMA 116 COMMA 117 COMMA 32 COMMA 33 COMMA 118 COMMA 28 COMMA 119 COMMA 65 COMMA 81 COMMA 82 COMMA 83 COMMA 59 COMMA 120 COMMA 40 COMMA 41 COMMA 42 COMMA 43 COMMA 44 COMMA 45 COMMA 49 COMMA 46 COMMA 38 COMMA 39 COMMA 48 COMMA 47 COMMA 6 COMMA 7 COMMA 121 COMMA 64 COMMA 63});
...
GLOBAL_LIST(VISIBLE_SHOPT_NUMS, int, 72, {29 COMMA 30 COMMA 36 COMMA 37 COMMA 35 COMMA 34 COMMA 61 COMMA 60 COMMA 23 COMMA 31 COMMA 66 COMMA 25 COMMA 84 COMMA 24 COMMA 21 COMMA 20 COMMA 68 COMMA 86 COMMA 26 COMMA 27 COMMA 4 COMMA 67 COMMA 19 COMMA 79 COMMA 80 COMMA 22 COMMA 5 COMMA 50 COMMA 69 COMMA 70 COMMA 71 COMMA 77 COMMA 53 COMMA 54 COMMA 76 COMMA 72 COMMA 75 COMMA 55 COMMA 52 COMMA 73 COMMA 56 COMMA 51 COMMA 74 COMMA 58 COMMA 78 COMMA 57 COMMA 62 COMMA 85 COMMA 32 COMMA 33 COMMA 28 COMMA 65 COMMA 81 COMMA 82 COMMA 83 COMMA 59 COMMA 40 COMMA 41 COMMA 42 COMMA 43 COMMA 44 COMMA 45 COMMA 49 COMMA 46 COMMA 38 COMMA 39 COMMA 48 COMMA 47 COMMA 6 COMMA 7 COMMA 64 COMMA 63});
...
option_asdl::option_t OptionNum(BigStr* s) {
  ...
  case 'd':
    ...
    if (length == 8 && memcmp("dashglob", data, 8) == 0) return 60;
    break;
  case 'e':
    ...
    if (length == 14 && memcmp("expand_aliases", data, 14) == 0) return 84;
    break;
  case 'f':
  ...
  case 'n':
    ...
    if (length == 11 && memcmp("no_exported", data, 11) == 0) return 79;
    if (length == 15 && memcmp("no_init_globals", data, 15) == 0) return 80;
    break;
  case 'p':
    ...
    if (length == 15 && memcmp("parse_backslash", data, 15) == 0) return 70;
    if (length == 15 && memcmp("parse_backticks", data, 15) == 0) return 71;
    if (length == 12 && memcmp("parse_dollar", data, 12) == 0) return 72;
    if (length == 13 && memcmp("parse_ignored", data, 13) == 0) return 73;
    if (length == 14 && memcmp("parse_sh_arith", data, 14) == 0) return 74;
    if (length == 12 && memcmp("parse_dparen", data, 12) == 0) return 75;
    if (length == 14 && memcmp("parse_dbracket", data, 14) == 0) return 76;
    if (length == 15 && memcmp("parse_bare_word", data, 15) == 0) return 77;
    if (length == 15 && memcmp("parse_word_join", data, 15) == 0) return 78;
    if (length == 8 && memcmp("progcomp", data, 8) == 0) return 85;
    break;
  case 'r':
  ...
  case 's':
    ...
    if (length == 11 && memcmp("simple_echo", data, 11) == 0) return 81;
    if (length == 19 && memcmp("simple_eval_builtin", data, 19) == 0) return 82;
    if (length == 19 && memcmp("simple_test_builtin", data, 19) == 0) return 83;
    break;
  case 'v':
  ...
  case 'x':
    ...
    if (length == 14 && memcmp("xtrace_details", data, 14) == 0) return 64;
    break;
  }
...
option_asdl::option_t UnimplOptionNum(BigStr* s) {
  ...
  switch (data[0]) {
  case 'a':
    if (length == 17 && memcmp("assoc_expand_once", data, 17) == 0) return 89;
    if (length == 6 && memcmp("autocd", data, 6) == 0) return 90;
    break;
  case 'c':
    if (length == 7 && memcmp("cmdhist", data, 7) == 0) return 88;
    if (length == 11 && memcmp("cdable_vars", data, 11) == 0) return 91;
    if (length == 7 && memcmp("cdspell", data, 7) == 0) return 92;
    if (length == 9 && memcmp("checkhash", data, 9) == 0) return 93;
    if (length == 9 && memcmp("checkjobs", data, 9) == 0) return 94;
    if (length == 12 && memcmp("checkwinsize", data, 12) == 0) return 95;
    if (length == 18 && memcmp("complete_fullquote", data, 18) == 0) return 96;
    break;
  case 'd':
    if (length == 9 && memcmp("direxpand", data, 9) == 0) return 97;
    if (length == 8 && memcmp("dirspell", data, 8) == 0) return 98;
    break;
  case 'e':
    if (length == 8 && memcmp("execfail", data, 8) == 0) return 99;
    if (length == 8 && memcmp("extquote", data, 8) == 0) return 100;
    break;
  case 'f':
    if (length == 13 && memcmp("force_fignore", data, 13) == 0) return 101;
    break;
  case 'g':
    if (length == 15 && memcmp("globasciiranges", data, 15) == 0) return 102;
    if (length == 8 && memcmp("globstar", data, 8) == 0) return 103;
    if (length == 10 && memcmp("gnu_errfmt", data, 10) == 0) return 104;
    break;
  case 'h':
    if (length == 10 && memcmp("histappend", data, 10) == 0) return 87;
    if (length == 10 && memcmp("histreedit", data, 10) == 0) return 105;
    if (length == 10 && memcmp("histverify", data, 10) == 0) return 106;
    if (length == 9 && memcmp("huponexit", data, 9) == 0) return 107;
    break;
  case 'i':
    if (length == 20 && memcmp("interactive_comments", data, 20) == 0) return 108;
    break;
  case 'l':
    if (length == 7 && memcmp("lithist", data, 7) == 0) return 109;
    if (length == 16 && memcmp("localvar_inherit", data, 16) == 0) return 110;
    if (length == 14 && memcmp("localvar_unset", data, 14) == 0) return 111;
    if (length == 11 && memcmp("login_shell", data, 11) == 0) return 112;
    break;
  case 'm':
    if (length == 8 && memcmp("mailwarn", data, 8) == 0) return 113;
    break;
  case 'n':
    if (length == 23 && memcmp("no_empty_cmd_completion", data, 23) == 0) return 114;
    if (length == 10 && memcmp("nocaseglob", data, 10) == 0) return 115;
    break;
  case 'p':
    if (length == 14 && memcmp("progcomp_alias", data, 14) == 0) return 116;
    if (length == 10 && memcmp("promptvars", data, 10) == 0) return 117;
    break;
  case 'r':
    if (length == 16 && memcmp("restricted_shell", data, 16) == 0) return 118;
    break;
  case 's':
    if (length == 13 && memcmp("shift_verbose", data, 13) == 0) return 119;
    if (length == 10 && memcmp("sourcepath", data, 10) == 0) return 120;
    break;
  case 'x':
    if (length == 8 && memcmp("xpg_echo", data, 8) == 0) return 121;
    break;
  }
...
builtin_t LookupNormalBuiltin(BigStr* s) {
  ...
  case 'b':
    ...
    if (length == 2 && memcmp("bg", data, 2) == 0) return 39;
    if (length == 7 && memcmp("builtin", data, 7) == 0) return 47;
  ...
  case 'c':
    ...
    if (length == 8 && memcmp("complete", data, 8) == 0) return 41;
    if (length == 7 && memcmp("compgen", data, 7) == 0) return 42;
    if (length == 7 && memcmp("compopt", data, 7) == 0) return 43;
    if (length == 10 && memcmp("compadjust", data, 10) == 0) return 44;
    if (length == 10 && memcmp("compexport", data, 10) == 0) return 45;
    if (length == 7 && memcmp("command", data, 7) == 0) return 48;
    if (length == 3 && memcmp("ctx", data, 3) == 0) return 72;
    break;
  case 'd':
    if (length == 4 && memcmp("dirs", data, 4) == 0) return 31;
    break;
  case 'e':
  ...
  case 'f':
    ...
    if (length == 2 && memcmp("fg", data, 2) == 0) return 38;
    if (length == 2 && memcmp("fc", data, 2) == 0) return 53;
    ...
    break;
  case 'g':
    if (length == 7 && memcmp("getopts", data, 7) == 0) return 46;
    break;
  case 'h':
    if (length == 4 && memcmp("hash", data, 4) == 0) return 50;
    if (length == 4 && memcmp("help", data, 4) == 0) return 51;
    if (length == 7 && memcmp("history", data, 7) == 0) return 52;
  ...
  case 'i':
    ...
    break;
  case 'j':
    if (length == 4 && memcmp("jobs", data, 4) == 0) return 37;
  ...
  case 'p':
    ...
    if (length == 5 && memcmp("pushd", data, 5) == 0) return 29;
    if (length == 4 && memcmp("popd", data, 4) == 0) return 30;
    if (length == 3 && memcmp("pwd", data, 3) == 0) return 32;
  ...
  case 'r':
    ...
    break;
  case 's':
    if (length == 6 && memcmp("source", data, 6) == 0) return 33;
    if (length == 5 && memcmp("shopt", data, 5) == 0) return 40;
  ...
  case 't':
    ...
    if (length == 4 && memcmp("type", data, 4) == 0) return 49;
    if (length == 4 && memcmp("test", data, 4) == 0) return 76;
    break;
  case 'u':
    if (length == 5 && memcmp("umask", data, 5) == 0) return 34;
    if (length == 6 && memcmp("ulimit", data, 6) == 0) return 35;
    if (length == 7 && memcmp("unalias", data, 7) == 0) return 55;
    if (length == 3 && memcmp("use", data, 3) == 0) return 64;
    break;
  case 'w':
    if (length == 4 && memcmp("wait", data, 4) == 0) return 36;
...
builtin_t LookupPrivateBuiltin(BigStr* s) {
  ...
  switch (data[0]) {
  case 'c':
    if (length == 3 && memcmp("cat", data, 3) == 0) return 81;
    break;
  case 'r':
    if (length == 2 && memcmp("rm", data, 2) == 0) return 82;
    break;
  case 's':
    if (length == 5 && memcmp("sleep", data, 5) == 0) return 83;
    break;
  }
...
GLOBAL_STR(kOptionName_60, "dashglob");
...
GLOBAL_STR(kOptionName_64, "xtrace_details");
...
GLOBAL_STR(kOptionName_70, "parse_backslash");
GLOBAL_STR(kOptionName_71, "parse_backticks");
GLOBAL_STR(kOptionName_72, "parse_dollar");
GLOBAL_STR(kOptionName_73, "parse_ignored");
GLOBAL_STR(kOptionName_74, "parse_sh_arith");
GLOBAL_STR(kOptionName_75, "parse_dparen");
GLOBAL_STR(kOptionName_76, "parse_dbracket");
GLOBAL_STR(kOptionName_77, "parse_bare_word");
GLOBAL_STR(kOptionName_78, "parse_word_join");
GLOBAL_STR(kOptionName_79, "no_exported");
GLOBAL_STR(kOptionName_80, "no_init_globals");
GLOBAL_STR(kOptionName_81, "simple_echo");
GLOBAL_STR(kOptionName_82, "simple_eval_builtin");
GLOBAL_STR(kOptionName_83, "simple_test_builtin");
GLOBAL_STR(kOptionName_84, "expand_aliases");
GLOBAL_STR(kOptionName_85, "progcomp");
GLOBAL_STR(kOptionName_86, "hostcomplete");
GLOBAL_STR(kOptionName_87, "histappend");
GLOBAL_STR(kOptionName_88, "cmdhist");
GLOBAL_STR(kOptionName_89, "assoc_expand_once");
GLOBAL_STR(kOptionName_90, "autocd");
GLOBAL_STR(kOptionName_91, "cdable_vars");
GLOBAL_STR(kOptionName_92, "cdspell");
GLOBAL_STR(kOptionName_93, "checkhash");
GLOBAL_STR(kOptionName_94, "checkjobs");
GLOBAL_STR(kOptionName_95, "checkwinsize");
GLOBAL_STR(kOptionName_96, "complete_fullquote");
GLOBAL_STR(kOptionName_97, "direxpand");
GLOBAL_STR(kOptionName_98, "dirspell");
GLOBAL_STR(kOptionName_99, "execfail");
GLOBAL_STR(kOptionName_100, "extquote");
GLOBAL_STR(kOptionName_101, "force_fignore");
GLOBAL_STR(kOptionName_102, "globasciiranges");
GLOBAL_STR(kOptionName_103, "globstar");
GLOBAL_STR(kOptionName_104, "gnu_errfmt");
GLOBAL_STR(kOptionName_105, "histreedit");
GLOBAL_STR(kOptionName_106, "histverify");
GLOBAL_STR(kOptionName_107, "huponexit");
GLOBAL_STR(kOptionName_108, "interactive_comments");
GLOBAL_STR(kOptionName_109, "lithist");
GLOBAL_STR(kOptionName_110, "localvar_inherit");
GLOBAL_STR(kOptionName_111, "localvar_unset");
GLOBAL_STR(kOptionName_112, "login_shell");
GLOBAL_STR(kOptionName_113, "mailwarn");
GLOBAL_STR(kOptionName_114, "no_empty_cmd_completion");
GLOBAL_STR(kOptionName_115, "nocaseglob");
GLOBAL_STR(kOptionName_116, "progcomp_alias");
GLOBAL_STR(kOptionName_117, "promptvars");
GLOBAL_STR(kOptionName_118, "restricted_shell");
GLOBAL_STR(kOptionName_119, "shift_verbose");
GLOBAL_STR(kOptionName_120, "sourcepath");
GLOBAL_STR(kOptionName_121, "xpg_echo");
...
GLOBAL_STR(kBUILTIN_NAMES_28, "pushd");
GLOBAL_STR(kBUILTIN_NAMES_29, "popd");
GLOBAL_STR(kBUILTIN_NAMES_30, "dirs");
GLOBAL_STR(kBUILTIN_NAMES_31, "pwd");
GLOBAL_STR(kBUILTIN_NAMES_32, "source");
GLOBAL_STR(kBUILTIN_NAMES_33, "umask");
GLOBAL_STR(kBUILTIN_NAMES_34, "ulimit");
GLOBAL_STR(kBUILTIN_NAMES_35, "wait");
GLOBAL_STR(kBUILTIN_NAMES_36, "jobs");
GLOBAL_STR(kBUILTIN_NAMES_37, "fg");
GLOBAL_STR(kBUILTIN_NAMES_38, "bg");
GLOBAL_STR(kBUILTIN_NAMES_39, "shopt");
GLOBAL_STR(kBUILTIN_NAMES_40, "complete");
GLOBAL_STR(kBUILTIN_NAMES_41, "compgen");
GLOBAL_STR(kBUILTIN_NAMES_42, "compopt");
GLOBAL_STR(kBUILTIN_NAMES_43, "compadjust");
GLOBAL_STR(kBUILTIN_NAMES_44, "compexport");
GLOBAL_STR(kBUILTIN_NAMES_45, "getopts");
GLOBAL_STR(kBUILTIN_NAMES_46, "builtin");
GLOBAL_STR(kBUILTIN_NAMES_47, "command");
GLOBAL_STR(kBUILTIN_NAMES_48, "type");
GLOBAL_STR(kBUILTIN_NAMES_49, "hash");
GLOBAL_STR(kBUILTIN_NAMES_50, "help");
GLOBAL_STR(kBUILTIN_NAMES_51, "history");
GLOBAL_STR(kBUILTIN_NAMES_52, "fc");

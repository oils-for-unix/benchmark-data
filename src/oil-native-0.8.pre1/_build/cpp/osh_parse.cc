...
Str* str59 = new Str("~");
Str* str60 = new Str("\n");
Str* str61 = new Str("[ interactive ]");
Str* str62 = new Str("[ -c flag ]");
Str* str63 = new Str("[ stdin%s ]");
Str* str64 = new Str("[ expansion of alias %r ]");
Str* str65 = new Str("[ backticks at ... ]");
Str* str66 = new Str("[ array LValue in %s ]");
Str* str67 = new Str("[ eval at line %d of %s ]");
Str* str68 = new Str("[ trap ]");
Str* str69 = new Str("%s:%d: %s%s\n");
Str* str70 = new Str("[??? no location ???] %s%s\n");
Str* str71 = new Str("");
Str* str72 = new Str("");
Str* str73 = new Str("<Trail %s %s %s %s>");
Str* str74 = new Str("");
Str* str75 = new Str("ShAssignment expression can't be nested like this");
Str* str76 = new Str("Here docs aren't allowed in expressions");
Str* str77 = new Str("Couldn't find terminator for here doc that starts here");
Str* str78 = new Str("\t");
Str* str79 = new Str("Invalid here doc delimiter");
Str* str80 = new Str("+");
Str* str81 = new Str("+");
Str* str82 = new Str("+");
Str* str83 = new Str("%d != %d");
Str* str84 = new Str("Environment binding shouldn't look like an array assignment");
Str* str85 = new Str("+");
Str* str86 = new Str("Expected = in environment binding, got +=");
Str* str87 = new Str("Environment bindings can't contain array literals");
Str* str88 = new Str("Expected word type %s, got %s");
Str* str89 = new Str("Invalid token after redirect operator");
Str* str90 = new Str(" ");
Str* str91 = new Str(" ");
Str* str92 = new Str("line IDs %d != %d");
Str* str93 = new Str(" ");
Str* str94 = new Str("");
Str* str95 = new Str("Unexpected block");
Str* str96 = new Str("=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
Str* str97 = new Str("name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
Str* str98 = new Str("Unexpected block");
Str* str99 = new Str("Unexpected block");
Str* str100 = new Str("Control flow shouldn't have redirects");
Str* str101 = new Str("Control flow shouldn't have environment bindings");
Str* str102 = new Str("Unexpected argument to %r");
Str* str103 = new Str("Invalid word in for loop");
Str* str104 = new Str("Invalid word after for expression");
Str* str105 = new Str("Loop variable name should be a constant");
Str* str106 = new Str("Invalid loop variable name");
Str* str107 = new Str("Unexpected word after for loop variable");
Str* str108 = new Str("Expected ;; or esac");
Str* str109 = new Str("Unexpected word while parsing compound command");
Str* str110 = new Str("Invalid function name");
Str* str111 = new Str("Expected ) in function definition");
Str* str112 = new Str("Invalid KSH-style function name");
Str* str113 = new Str("Unexpected word when parsing command");
Str* str114 = new Str("Unexpected right brace");
Str* str115 = new Str("Unexpected EOF while parsing command");
Str* str116 = new Str("Invalid word while parsing command");
Str* str117 = new Str("Unexpected word while parsing command line");
Str* str118 = new Str("Unterminated here doc began here");
Str* str119 = new Str("&");
Str* str120 = new Str("&amp;");
Str* str121 = new Str("<");
Str* str122 = new Str("&lt;");
...
Str* str124 = new Str("&gt;");
Str* str125 = new Str("");
Str* str126 = new Str("Expected %d, got %d");
Str* str127 = new Str("Step can't be 0");
Str* str128 = new Str("Invalid step %d for ascending integer range");
Str* str129 = new Str("Invalid step %d for descending integer range");
Str* str130 = new Str("Invalid step %d for ascending character range");
Str* str131 = new Str("Invalid step %d for descending character range");
Str* str132 = new Str("Mismatched cases in character range");
Str* str133 = new Str("");
...
Str* str143 = new Str("");
Str* str144 = new Str("");
Str* str145 = new Str("Compound shouldn't be empty");
Str* str146 = new Str("/");
Str* str147 = new Str("");
Str* str148 = new Str("EOF");
Str* str149 = new Str("%s: type=%d, tok=%r");
Str* str150 = new Str("typ");
Str* str151 = new Str("tok");
Str* str152 = new Str("children");
Str* str153 = new Str("-");
Str* str154 = new Str("with %d children");
Str* str155 = new Str("");
Str* str156 = new Str("(PNode %s %s %s)");
Str* str157 = new Str("too much input");
Str* str158 = new Str("bad input");
...
Str* str245 = new Str("%start");
Str* str246 = new Str("%end");
Str* str247 = new Str("dot");
Str* str248 = new Str("Unexpected token %r in regex");
...
Str* PrettyDir(Str* dir_name, runtime_asdl::value_t* UP_home_dir) {
  ...
  if (UP_home_dir and UP_home_dir->tag_() == value_e::Str) {
    ...
    if (dir_name == home_dir or dir_name->startswith(str_concat(home_dir, str51))) {
      return str_concat(str52, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    f->write(str_equals(c, str55) ? str56 : str57);
  }
  f->write(str58);
  f->write(str_repeat(str59, length - 1));
  f->write(str60);
}
...
void PrettyPrintError(error::_ErrorWithLocation* err, alloc::Arena* arena) {
  PrettyPrintError(err, arena, str71);
}
...
lexer::Lexer* ParseContext::_MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = new lexer::LineLexer(str74, this->arena);
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir__HereDoc* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index(i), str78))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index(-2), str80)) {
    ...
    if (left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse) {
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        var_name = left_token->val->slice(0, -1);
        if (str_equals(close_token->val->index(-2), str82)) {
          op = assign_op_e::PlusEqual;
        }
        else {
          op = assign_op_e::Equal;
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    if (str_equals(left_token->val->index(-2), str85)) {
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    i += 1;
    if (!alias_exp->endswith(str90)) {
      expanded->append(str91);
      break;
    }
  }
  if (len(expanded) == 0) {
  ...
  while (i < n) {
    ...
    expanded->append(str93);
    i += 1;
  }
  code_str = str94->join(expanded);
  line_reader = reader::StringLineReader(code_str, this->arena);
...
syntax_asdl::command__ShFunction* CommandParser::ParseFunctionDef() {
  ...
  this->_Next();
  this->_Eat2(Id::Right_ShFunction, str111);
...
Str* escape(Str* s) {
  ...
  s = s->replace(str121, str122);
  s = s->replace(str123, str124);
  return s;
}
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str136, false));
    }
      break;
    case word_part_e::AssocArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str137, false));
    }
      break;
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str139, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str140->join(strs), true));
    }
      break;
    ...
    case word_part_e::Splice: {
      return (Tuple3<bool, Str*, bool>(false, str141, false));
    }
      break;
    default: {
      throw new AssertionError();
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() != word_e::Compound) {
    return (Tuple3<bool, Str*, bool>(false, str142, quoted));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  strs = new List<Str*>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str143, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str144->join(strs), quoted));
}
...
bool Parser::addtoken(int typ, syntax_asdl::Token* opaque, int ilabel) {
  ...
  while (true) {
    ...
    if (!found) {
      ...
      if (!found2) {
        throw new ParseError(str158, typ, opaque);
      }
    }
  }
}
...
syntax_asdl::suffix_op__PatSub* WordParser::_ReadPatSubVarOp(types_asdl::lex_mode_t lex_mode) {
  ...
  if (len(pat->parts) == 1) {
    ...
    s = tup0.at1();
    quoted = tup0.at2();
    if (ok and str_equals(s, str164) and !quoted) {
      this->_Next(lex_mode);
      this->_Peek();
...
syntax_asdl::re_t* Transformer::_ReAtom(parse::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((tok->val == str245 || tok->val == str246 || tok->val == str247)) {
        return tok;
      }
      p_die(fmt10(tok->val), tok);
    }

...
List<int>* STRICT_ALL = new List<int>({1, 25, 2, 24, 3, 26, 27, 28, 29, 30, 34, 31, 33, 32});
List<int>* OIL_BASIC = new List<int>({44, 42, 1, 43, 25, 2, 24, 35, 36, 37, 38, 40, 39, 3, 45, 49, 48, 41, 26, 27, 28, 29, 30, 34, 31, 33, 32, 47, 46});
List<int>* OIL_ALL = new List<int>({44, 42, 1, 43, 25, 2, 24, 56, 35, 51, 52, 53, 36, 54, 50, 55, 37, 38, 40, 39, 3, 45, 49, 48, 57, 58, 59, 41, 26, 27, 28, 29, 30, 34, 31, 33, 32, 47, 46});
List<int>* DEFAULT_TRUE = new List<int>({20, 42, 21, 43, 13, 52, 53, 54, 55, 49, 19, 47});
List<int>* PARSE_OPTION_NUMS = new List<int>({43, 56, 35, 51, 52, 53, 36, 54, 17, 50, 55, 37, 38, 60, 40, 39});
List<int>* SHOPT_OPTION_NUMS = new List<int>({23, 20, 66, 67, 68, 69, 70, 71, 72, 65, 44, 18, 73, 42, 74, 75, 76, 21, 16, 77, 43, 78, 15, 79, 14, 80, 81, 82, 83, 63, 84, 85, 64, 86, 25, 87, 61, 88, 89, 90, 91, 92, 93, 94, 95, 24, 56, 35, 51, 52, 53, 36, 54, 17, 50, 55, 37, 38, 60, 40, 39, 45, 62, 96, 97, 22, 49, 98, 99, 48, 57, 58, 59, 41, 100, 26, 27, 28, 29, 30, 34, 31, 33, 32, 19, 101, 47, 46});
List<int>* SET_OPTION_NUMS = new List<int>({11, 1, 13, 8, 4, 7, 2, 3, 9, 6, 10, 5});
List<int>* VISIBLE_SHOPT_NUMS = new List<int>({23, 20, 44, 18, 42, 21, 16, 43, 15, 14, 25, 24, 56, 35, 51, 52, 53, 36, 54, 17, 50, 55, 37, 38, 60, 40, 39, 45, 22, 49, 48, 57, 58, 59, 41, 26, 27, 28, 29, 30, 34, 31, 33, 32, 19, 47, 46});

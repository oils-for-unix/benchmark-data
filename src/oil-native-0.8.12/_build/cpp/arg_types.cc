...
const char* arity0_14[] = {"Z", "q", "r", "s", nullptr};
...
FlagSpec_c kFlagSpecs[] = {
    ...
    { "mapfile", arity0_10, nullptr, nullptr, nullptr, defaults_10 },
    { "new_var", arity0_11, nullptr, nullptr, plus_11, defaults_11 },
    { "printf", nullptr, arity1_12, nullptr, nullptr, defaults_12 },
    { "pwd", arity0_13, nullptr, nullptr, nullptr, defaults_13 },
    { "read", arity0_14, arity1_14, actions_long_14, nullptr, defaults_14 },
    { "readonly", arity0_15, nullptr, nullptr, nullptr, defaults_15 },
    { "shopt", arity0_16, nullptr, actions_long_16, nullptr, defaults_16 },
    { "source", nullptr, nullptr, nullptr, nullptr, nullptr },
    { "trap", arity0_18, nullptr, nullptr, nullptr, defaults_18 },
    { "type", arity0_19, nullptr, nullptr, nullptr, defaults_19 },
    { "unalias", nullptr, nullptr, nullptr, nullptr, nullptr },
    { "unset", arity0_21, nullptr, nullptr, nullptr, defaults_21 },
    { "wait", arity0_22, nullptr, nullptr, nullptr, defaults_22 },
    {},
};

const char* params_0[] = {"_running_trap", "allow_command_sub", "assoc_expand_once", "autocd", "cdable_vars", "cdspell", "checkhash", "checkjobs", "checkwinsize", "cmdhist", "command_sub_errexit", "compat_array", "complete_fullquote", "dashglob", "direxpand", "dirspell", "dotglob", "dynamic_scope", "eval_unsafe_arith", "execfail", "expand_aliases", "extdebug", "extglob", "extquote", "failglob", "force_fignore", "globasciiranges", "globstar", "gnu_errfmt", "histappend", "histreedit", "histverify", "hostcomplete", "huponexit", "inherit_errexit", "interactive_comments", "lastpipe", "lithist", "localvar_inherit", "localvar_unset", "login_shell", "mailwarn", "no_empty_cmd_completion", "nocaseglob", "nocasematch", "nullglob", "oil:all", "oil:basic", "parse_amp", "parse_at", "parse_at_all", "parse_backslash", "parse_backticks", "parse_brace", "parse_dollar", "parse_dynamic_arith", "parse_equals", "parse_ignored", "parse_paren", "parse_raw_string", "parse_tea", "parse_triple_dot", "parse_triple_quote", "process_sub_fail", "progcomp", "progcomp_alias", "promptvars", "redefine_module", "redefine_proc", "restricted_shell", "shift_verbose", "sigpipe_status_ok", "simple_echo", "simple_eval_builtin", "simple_test_builtin", "simple_word_eval", "sourcepath", "strict:all", "strict_argv", "strict_arith", "strict_array", "strict_control_flow", "strict_errexit", "strict_glob", "strict_nameref", "strict_tilde", "strict_word_eval", "verbose_errexit", "xpg_echo", "xtrace_details", "xtrace_rich", nullptr};
...
const char* params_4[] = {"_running_trap", "allow_command_sub", "assoc_expand_once", "autocd", "cdable_vars", "cdspell", "checkhash", "checkjobs", "checkwinsize", "cmdhist", "command_sub_errexit", "compat_array", "complete_fullquote", "dashglob", "direxpand", "dirspell", "dotglob", "dynamic_scope", "eval_unsafe_arith", "execfail", "expand_aliases", "extdebug", "extglob", "extquote", "failglob", "force_fignore", "globasciiranges", "globstar", "gnu_errfmt", "histappend", "histreedit", "histverify", "hostcomplete", "huponexit", "inherit_errexit", "interactive_comments", "lastpipe", "lithist", "localvar_inherit", "localvar_unset", "login_shell", "mailwarn", "no_empty_cmd_completion", "nocaseglob", "nocasematch", "nullglob", "oil:all", "oil:basic", "parse_amp", "parse_at", "parse_at_all", "parse_backslash", "parse_backticks", "parse_brace", "parse_dollar", "parse_dynamic_arith", "parse_equals", "parse_ignored", "parse_paren", "parse_raw_string", "parse_tea", "parse_triple_dot", "parse_triple_quote", "process_sub_fail", "progcomp", "progcomp_alias", "promptvars", "redefine_module", "redefine_proc", "restricted_shell", "shift_verbose", "sigpipe_status_ok", "simple_echo", "simple_eval_builtin", "simple_test_builtin", "simple_word_eval", "sourcepath", "strict:all", "strict_argv", "strict_arith", "strict_array", "strict_control_flow", "strict_errexit", "strict_glob", "strict_nameref", "strict_tilde", "strict_word_eval", "verbose_errexit", "xpg_echo", "xtrace_details", "xtrace_rich", nullptr};

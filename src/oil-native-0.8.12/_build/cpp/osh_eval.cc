...
GLOBAL_STR(str168, "Can't run a proc while errexit is disabled. Use 'catch' or wrap it in a process with $0 myproc");
...
GLOBAL_STR(str286, "nameref cycle: %s");
GLOBAL_STR(str287, " -> ");
...
GLOBAL_STR(str298, "PIPESTATUS");
GLOBAL_STR(str299, "_pipeline_status");
GLOBAL_STR(str300, "_process_sub_status");
GLOBAL_STR(str301, "BASH_REMATCH");
GLOBAL_STR(str302, "FUNCNAME");
GLOBAL_STR(str303, "source");
GLOBAL_STR(str304, "BASH_SOURCE");
GLOBAL_STR(str305, "BASH_LINENO");
GLOBAL_STR(str306, "0");
GLOBAL_STR(str307, "LINENO");
GLOBAL_STR(str308, "BASHPID");
GLOBAL_STR(str309, "Can't unset readonly variable %r");
GLOBAL_STR(str310, "%r isn't an array");
GLOBAL_STR(str311, "$%s isn't defined");
GLOBAL_STR(str312, "$%s should be a string");
GLOBAL_STR(str313, "$%s should be a string, got %s");
GLOBAL_STR(str314, "$%s doesn't look like an integer, got %r");
GLOBAL_STR(str315, "EOF");
GLOBAL_STR(str316, "/");
GLOBAL_STR(str317, "~");
GLOBAL_STR(str318, "  ");
GLOBAL_STR(str319, "\n  ");
...
GLOBAL_STR(str324, "~");
GLOBAL_STR(str325, "\n");
GLOBAL_STR(str326, "[ interactive ]");
GLOBAL_STR(str327, "[ headless ]");
GLOBAL_STR(str328, "[ -c flag ]");
GLOBAL_STR(str329, "[ stdin%s ]");
GLOBAL_STR(str330, "[ expansion of alias %r ]");
GLOBAL_STR(str331, "[ backticks at ... ]");
GLOBAL_STR(str332, "[ array LValue in %s ]");
GLOBAL_STR(str333, "[ eval at line %d of %s ]");
GLOBAL_STR(str334, "[ trap ]");
GLOBAL_STR(str335, "[ variable ]");
GLOBAL_STR(str336, "%s:%d: %s%s\n");
GLOBAL_STR(str337, "[??? no location ???] %s%s\n");
GLOBAL_STR(str338, "");
GLOBAL_STR(str339, "");
GLOBAL_STR(str340, "");
GLOBAL_STR(str341, "none");
GLOBAL_STR(str342, "AST not printed.");
GLOBAL_STR(str343, "text");
GLOBAL_STR(str344, "abbrev-text");
GLOBAL_STR(str345, "html");
GLOBAL_STR(str346, "abbrev-html");
GLOBAL_STR(str347, "abbrev-");
GLOBAL_STR(str348, "\n");
GLOBAL_STR(str349, "\n");
GLOBAL_STR(str350, "-");
GLOBAL_STR(str351, "_");
GLOBAL_STR(str352, "<_Attributes %s>");
GLOBAL_STR(str353, "<args.Reader %r %d>");
GLOBAL_STR(str354, "expected argument to %r");
GLOBAL_STR(str355, "-");
GLOBAL_STR(str356, "expected integer after %s, got %r");
GLOBAL_STR(str357, "-");
GLOBAL_STR(str358, "got invalid integer for %s: %s");
GLOBAL_STR(str359, "-");
GLOBAL_STR(str360, "expected number after %r, got %r");
GLOBAL_STR(str361, "-");
GLOBAL_STR(str362, "got invalid float for %s: %s");
GLOBAL_STR(str363, "-");
GLOBAL_STR(str364, "got invalid argument %r to %r, expected one of: %s");
GLOBAL_STR(str365, "-");
GLOBAL_STR(str366, "|");
GLOBAL_STR(str367, "0");
GLOBAL_STR(str368, "F");
GLOBAL_STR(str369, "false");
GLOBAL_STR(str370, "False");
GLOBAL_STR(str371, "1");
GLOBAL_STR(str372, "T");
GLOBAL_STR(str373, "true");
GLOBAL_STR(str374, "Talse");
GLOBAL_STR(str375, "got invalid argument to boolean flag: %r");
GLOBAL_STR(str376, "-");
GLOBAL_STR(str377, "-");
GLOBAL_STR(str378, "got invalid option %r");
GLOBAL_STR(str379, "Expected argument for action");
GLOBAL_STR(str380, "Invalid action name %r");
GLOBAL_STR(str381, "--");
GLOBAL_STR(str382, "--");
GLOBAL_STR(str383, "got invalid flag %r");
GLOBAL_STR(str384, "-");
GLOBAL_STR(str385, "0");
GLOBAL_STR(str386, "Z");
GLOBAL_STR(str387, "-");
GLOBAL_STR(str388, "doesn't accept flag %s");
GLOBAL_STR(str389, "-");
GLOBAL_STR(str390, "+");
GLOBAL_STR(str391, "+");
GLOBAL_STR(str392, "doesn't accept option %s");
GLOBAL_STR(str393, "+");
GLOBAL_STR(str394, "-");
GLOBAL_STR(str395, "--");
GLOBAL_STR(str396, "--");
...
GLOBAL_STR(str401, "-");
GLOBAL_STR(str402, "^--?([a-zA-Z0-9][a-zA-Z0-9\\-]*)(=.*)?$");
GLOBAL_STR(str403, "<LineLexer at pos %d of line %r (id = %d)>");
GLOBAL_STR(str404, "");
GLOBAL_STR(str405, "");
GLOBAL_STR(str406, "");
GLOBAL_STR(str407, "");
GLOBAL_STR(str408, "<Trail %s %s %s %s>");
GLOBAL_STR(str409, "");
GLOBAL_STR(str410, "ShAssignment expression can't be nested like this");
GLOBAL_STR(str411, "Here docs aren't allowed in expressions");
GLOBAL_STR(str412, "\n");
GLOBAL_STR(str413, "");
GLOBAL_STR(str414, " (%s)");
...
GLOBAL_STR(str436, "TODO");
GLOBAL_STR(str437, "dot");
GLOBAL_STR(str438, "Can't negate this symbol");
GLOBAL_STR(str439, "%r isn't a character class");
GLOBAL_STR(str440, "Can't negate this symbol");
GLOBAL_STR(str441, "%r isn't a character class");
GLOBAL_STR(str442, "%start");
GLOBAL_STR(str443, "%end");
GLOBAL_STR(str444, "dot");
GLOBAL_STR(str445, "Unexpected token %r in regex");
GLOBAL_STR(str446, "%s-%s");
GLOBAL_STR(str447, "ERE can't express code point %d");
GLOBAL_STR(str448, "Perl classes can't be negated in ERE");
GLOBAL_STR(str449, "%s");
GLOBAL_STR(str450, "POSIX classes can't be negated in ERE");
GLOBAL_STR(str451, "[:%s:]");
GLOBAL_STR(str452, ".");
GLOBAL_STR(str453, "^");
GLOBAL_STR(str454, "$");
GLOBAL_STR(str455, "|");
GLOBAL_STR(str456, "POSIX EREs don't have groups without capture, so this node needs () around it.");
GLOBAL_STR(str457, "+");
GLOBAL_STR(str458, "*");
GLOBAL_STR(str459, "?");
GLOBAL_STR(str460, "{%s}");
...
GLOBAL_STR(str471, "^");
GLOBAL_STR(str472, "]");
GLOBAL_STR(str473, "The [ operator doesn't apply to this expression");
GLOBAL_STR(str474, "Expected ]]");
GLOBAL_STR(str475, "Unexpected trailing word %s");
GLOBAL_STR(str476, "Invalid argument to unary operator");
GLOBAL_STR(str477, "Expected ), got %s");
GLOBAL_STR(str478, "Unexpected token in boolean expression (%s)");
GLOBAL_STR(str479, "");
GLOBAL_STR(str480, "Expected %d, got %d");
GLOBAL_STR(str481, "Step can't be 0");
GLOBAL_STR(str482, "Invalid step %d for ascending integer range");
GLOBAL_STR(str483, "Invalid step %d for descending integer range");
GLOBAL_STR(str484, "Invalid step %d for ascending character range");
GLOBAL_STR(str485, "Invalid step %d for descending character range");
GLOBAL_STR(str486, "Mismatched cases in character range");
GLOBAL_STR(str487, "");
GLOBAL_STR(str488, "0");
GLOBAL_STR(str489, "0");
GLOBAL_STR(str490, "g");
...
GLOBAL_STR(str527, ")");
GLOBAL_STR(str528, "");
GLOBAL_STR(str529, "export_");
GLOBAL_STR(str530, "doesn't accept -f because it's dangerous.  (The code can usually be restructured with 'source')");
GLOBAL_STR(str531, "doesn't accept RHS with -n");
GLOBAL_STR(str532, "Got -a but RHS isn't an array");
GLOBAL_STR(str533, "Got -A but RHS isn't an associative array");
GLOBAL_STR(str534, "readonly");
GLOBAL_STR(str535, "new_var");
GLOBAL_STR(str536, "with -f expects function names");
GLOBAL_STR(str537, "declare -f %s");
GLOBAL_STR(str538, "-");
GLOBAL_STR(str539, "-");
GLOBAL_STR(str540, "-");
GLOBAL_STR(str541, "+");
GLOBAL_STR(str542, "+");
GLOBAL_STR(str543, "+");
GLOBAL_STR(str544, "Invalid unset expression");
GLOBAL_STR(str545, "expected a variable name.  shopt -s eval_unsafe_arith allows expressions");
GLOBAL_STR(str546, "unset");
GLOBAL_STR(str547, "Invalid shift argument %r");
GLOBAL_STR(str548, "got too many arguments");
GLOBAL_STR(str549, "eval");
GLOBAL_STR(str550, "requires code string");
GLOBAL_STR(str551, "requires exactly 1 argument");
GLOBAL_STR(str552, " ");
GLOBAL_STR(str553, "eval");
GLOBAL_STR(str554, "source");
GLOBAL_STR(str555, "missing required argument");
GLOBAL_STR(str556, "source %r failed: %s");
GLOBAL_STR(str557, "source");
GLOBAL_STR(str558, "command");
GLOBAL_STR(str559, "Can't run assignment builtin recursively");
GLOBAL_STR(str560, "%r isn't a shell builtin");
GLOBAL_STR(str561, "runproc");
GLOBAL_STR(str562, "requires arguments");
GLOBAL_STR(str563, "runproc: no proc named %r");
GLOBAL_STR(str564, "try_");
GLOBAL_STR(str565, "'try' expected a command to run");
GLOBAL_STR(str566, "(original failure)");
GLOBAL_STR(str567, "");
GLOBAL_STR(str568, "fatal: status %d when --allow-status-01");
GLOBAL_STR(str569, ":");
GLOBAL_STR(str570, "function");
GLOBAL_STR(str571, "alias");
GLOBAL_STR(str572, "builtin");
GLOBAL_STR(str573, "builtin");
GLOBAL_STR(str574, "builtin");
GLOBAL_STR(str575, "keyword");
GLOBAL_STR(str576, "keyword");
GLOBAL_STR(str577, "file");
GLOBAL_STR(str578, "type");
GLOBAL_STR(str579, "type: %r not found");
GLOBAL_STR(str580, "file");
GLOBAL_STR(str581, "file");
GLOBAL_STR(str582, "%s is a %s");
GLOBAL_STR(str583, "function");
GLOBAL_STR(str584, "");
GLOBAL_STR(str585, "\n");
GLOBAL_STR(str586, "");
GLOBAL_STR(str587, "");
...
GLOBAL_STR(str591, "");
GLOBAL_STR(str592, "");
GLOBAL_STR(str593, "read");
GLOBAL_STR(str594, "_line");
GLOBAL_STR(str595, ":");
GLOBAL_STR(str596, "got extra argument");
GLOBAL_STR(str597, "--qsn can only be used with --line");
GLOBAL_STR(str598, "_all");
GLOBAL_STR(str599, ":");
GLOBAL_STR(str600, "got extra argument");
GLOBAL_STR(str601, "--qsn not implemented yet");
GLOBAL_STR(str602, "read -t isn't implemented (except t=0)");
GLOBAL_STR(str603, "");
...
GLOBAL_STR(str612, "MAPFILE");
GLOBAL_STR(str613, ":");
GLOBAL_STR(str614, "\n");
GLOBAL_STR(str615, "cd");
GLOBAL_STR(str616, "HOME");
GLOBAL_STR(str617, "HOME");
GLOBAL_STR(str618, "-");
GLOBAL_STR(str619, "OLDPWD");
GLOBAL_STR(str620, "PWD");
GLOBAL_STR(str621, "cd %r: %s");
GLOBAL_STR(str622, "PWD");
GLOBAL_STR(str623, "OLDPWD");
GLOBAL_STR(str624, "%2d  %s");
GLOBAL_STR(str625, " ");
GLOBAL_STR(str626, "pushd: no other directory");
GLOBAL_STR(str627, "got too many arguments");
GLOBAL_STR(str628, "pushd: %r: %s");
GLOBAL_STR(str629, "HOME");
GLOBAL_STR(str630, "PWD");
GLOBAL_STR(str631, "popd: directory stack is empty");
GLOBAL_STR(str632, "popd: %r: %s");
GLOBAL_STR(str633, "PWD");
...
GLOBAL_STR(str644, "# +");
GLOBAL_STR(str645, "osh printf doesn't support the %r flag");
GLOBAL_STR(str646, "eEfFgG");
GLOBAL_STR(str647, "osh printf doesn't support floating point");
GLOBAL_STR(str648, "c");
GLOBAL_STR(str649, "osh printf doesn't support single characters (bytes)");
GLOBAL_STR(str650, "Invalid printf format character");
GLOBAL_STR(str651, "Expected a printf format character");
GLOBAL_STR(str652, "%");
GLOBAL_STR(str653, "");
GLOBAL_STR(str654, "printf got invalid width %r");
GLOBAL_STR(str655, "0");
GLOBAL_STR(str656, "");
GLOBAL_STR(str657, "printf got invalid precision %r");
GLOBAL_STR(str658, "");
GLOBAL_STR(str659, "s");
GLOBAL_STR(str660, "q");
GLOBAL_STR(str661, "b");
GLOBAL_STR(str662, "");
GLOBAL_STR(str663, "diouxX");
GLOBAL_STR(str664, "'\"");
GLOBAL_STR(str665, "printf expected an integer, got %r");
GLOBAL_STR(str666, "TZ");
GLOBAL_STR(str667, "TZ");
GLOBAL_STR(str668, "ouxX");
GLOBAL_STR(str669, "Can't format negative number %d with %%%s");
GLOBAL_STR(str670, "o");
GLOBAL_STR(str671, "x");
GLOBAL_STR(str672, "X");
GLOBAL_STR(str673, "0");
...
GLOBAL_STR(str679, " ");
GLOBAL_STR(str680, " ");
GLOBAL_STR(str681, "printf");
GLOBAL_STR(str682, "requires a format string");
GLOBAL_STR(str683, "");
GLOBAL_STR(str684, "Invalid -v expression");
GLOBAL_STR(str685, "-v expected a variable name.  shopt -s eval_unsafe_arith allows expressions");
...
GLOBAL_STR(str727, "[oil -i] Reloading module %r");
...
GLOBAL_STR(str742, "expected a block");
GLOBAL_STR(str743, "Assignment builtin %r not configured");
GLOBAL_STR(str744, "%r ");
GLOBAL_STR(str745, "");
GLOBAL_STR(str746, "command in ");
GLOBAL_STR(str747, "assignment in ");
GLOBAL_STR(str748, "subshell invoked from ");
GLOBAL_STR(str749, "pipeline invoked from ");
GLOBAL_STR(str750, "");
GLOBAL_STR(str751, "Exiting with status %d (%sPID %d)");
GLOBAL_STR(str752, "Redirect filename can't be empty");
GLOBAL_STR(str753, "Redirect descriptor can't be empty");
GLOBAL_STR(str754, "-");
GLOBAL_STR(str755, "-");
GLOBAL_STR(str756, "Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
GLOBAL_STR(str757, "\n");
GLOBAL_STR(str758, "Unknown redirect op");
GLOBAL_STR(str759, "Unknown redirect type");
GLOBAL_STR(str760, "strict_errexit only allows simple commands (got %s). Hint: use 'run'.");
GLOBAL_STR(str761, "strict_errexit only allows a single command.  Hint: use \"run\".");
GLOBAL_STR(str762, "strict_errexit only allows simple commands (got %s). Hint: use 'run'.");
GLOBAL_STR(str763, "ShAssignment builtins don't accept blocks");
GLOBAL_STR(str764, "|& isn't supported");
GLOBAL_STR(str765, "Can't append array to string");
GLOBAL_STR(str766, "Can't append string to array");
GLOBAL_STR(str767, "%r expected a number, got %r");
GLOBAL_STR(str768, "Invalid control flow at top level");
GLOBAL_STR(str769, "warning: ");
GLOBAL_STR(str770, "Function %s was already defined (redefine_proc)");
GLOBAL_STR(str771, "Proc %s was already defined (redefine_proc)");
GLOBAL_STR(str772, "trap");
GLOBAL_STR(str773, "Loop and control flow can't be in different processes");
GLOBAL_STR(str774, "fatal: ");
GLOBAL_STR(str775, "EXIT");
GLOBAL_STR(str776, "trap EXIT");
GLOBAL_STR(str777, "__");
GLOBAL_STR(str778, ":");
GLOBAL_STR(str779, "Invalid argument %r.  Expected a name starting with :");
GLOBAL_STR(str780, "No value provided for param %r");
GLOBAL_STR(str781, "proc %r expected %d arguments, but got %d");
GLOBAL_STR(str782, "Unexpected %r (in function call)");
GLOBAL_STR(str783, "Attempted to exit from completion hook.");
GLOBAL_STR(str784, "Couldn't find terminator for here doc that starts here");
GLOBAL_STR(str785, "\t");
GLOBAL_STR(str786, "Invalid here doc delimiter");
GLOBAL_STR(str787, "+");
GLOBAL_STR(str788, "+");
GLOBAL_STR(str789, "+");
GLOBAL_STR(str790, "%d != %d");
GLOBAL_STR(str791, "Environment binding shouldn't look like an array assignment");
GLOBAL_STR(str792, "+");
GLOBAL_STR(str793, "Expected = in environment binding, got +=");
GLOBAL_STR(str794, "Environment bindings can't contain array literals");
GLOBAL_STR(str795, "procs and shell functions can't be nested");
GLOBAL_STR(str796, "%r was already declared");
GLOBAL_STR(str797, "%r hasn't been declared");
GLOBAL_STR(str798, "Can't modify constant %r");
GLOBAL_STR(str799, "Expected word type %s, got %s");
GLOBAL_STR(str800, "{");
GLOBAL_STR(str801, "}");
GLOBAL_STR(str802, "Invalid token after redirect operator");
GLOBAL_STR(str803, "TODO: Parse Redirect");
GLOBAL_STR(str804, " ");
GLOBAL_STR(str805, " ");
GLOBAL_STR(str806, "line IDs %d != %d");
GLOBAL_STR(str807, " ");
GLOBAL_STR(str808, "");
GLOBAL_STR(str809, "Unexpected block");
GLOBAL_STR(str810, "=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
GLOBAL_STR(str811, "name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
GLOBAL_STR(str812, "Unexpected block");
GLOBAL_STR(str813, "Unexpected block");
GLOBAL_STR(str814, "Control flow shouldn't have redirects");
GLOBAL_STR(str815, "Control flow shouldn't have environment bindings");
GLOBAL_STR(str816, "Unexpected argument to %r");
GLOBAL_STR(str817, "Invalid word in for loop");
GLOBAL_STR(str818, "Invalid word after for expression");
GLOBAL_STR(str819, "Loop variable name should be a constant");
GLOBAL_STR(str820, "Invalid loop variable name");
GLOBAL_STR(str821, "Unexpected word after for loop variable");
GLOBAL_STR(str822, "Expected ;; or esac");
GLOBAL_STR(str823, "Unexpected word while parsing compound command");
GLOBAL_STR(str824, "Invalid function name");
GLOBAL_STR(str825, "Expected ) in function definition");
GLOBAL_STR(str826, "Invalid KSH-style function name");
GLOBAL_STR(str827, "Unexpected word when parsing command");
GLOBAL_STR(str828, "Unexpected right brace");
GLOBAL_STR(str829, "Unexpected EOF while parsing command");
GLOBAL_STR(str830, "Invalid word while parsing command");
GLOBAL_STR(str831, "Unexpected word while parsing command line");
GLOBAL_STR(str832, "Unterminated here doc began here");
GLOBAL_STR(str833, "\\");
GLOBAL_STR(str834, "*");
GLOBAL_STR(str835, "?");
GLOBAL_STR(str836, "[");
...
GLOBAL_STR(str840, "\\?*+{}^$.()|");
GLOBAL_STR(str841, "\\");
GLOBAL_STR(str842, "Unexpected escaped character %r");
GLOBAL_STR(str843, "");
GLOBAL_STR(str844, "");
GLOBAL_STR(str845, "Malformed character class; treating as literal");
GLOBAL_STR(str846, "Got unescaped right bracket");
GLOBAL_STR(str847, "Got unescaped trailing backslash");
GLOBAL_STR(str848, ".|^$()+*?[]{}\\");
GLOBAL_STR(str849, "\\");
GLOBAL_STR(str850, "\\");
GLOBAL_STR(str851, "\\[");
...
GLOBAL_STR(str863, "]");
GLOBAL_STR(str864, "");
GLOBAL_STR(str865, "Error expanding glob %r: %s");
GLOBAL_STR(str866, "-");
GLOBAL_STR(str867, "<Error: unbalanced \\[ and \\]> ");
GLOBAL_STR(str868, "$");
GLOBAL_STR(str869, "#");
GLOBAL_STR(str870, "$");
GLOBAL_STR(str871, "hostname");
GLOBAL_STR(str872, "user");
GLOBAL_STR(str873, "$ ");
GLOBAL_STR(str874, "\u0001");
GLOBAL_STR(str875, "\u0002");
GLOBAL_STR(str876, "$");
GLOBAL_STR(str877, "$");
GLOBAL_STR(str878, "u");
GLOBAL_STR(str879, "user");
GLOBAL_STR(str880, "h");
GLOBAL_STR(str881, "hostname");
GLOBAL_STR(str882, ".");
GLOBAL_STR(str883, "H");
GLOBAL_STR(str884, "hostname");
GLOBAL_STR(str885, "w");
GLOBAL_STR(str886, "PWD");
GLOBAL_STR(str887, "HOME");
GLOBAL_STR(str888, "<Error: %s>");
GLOBAL_STR(str889, "W");
GLOBAL_STR(str890, "PWD");
GLOBAL_STR(str891, "<Error: PWD is not a string> ");
GLOBAL_STR(str892, "<Error: \\%s not implemented in $PS1> ");
GLOBAL_STR(str893, "$");
GLOBAL_STR(str894, "\\$");
GLOBAL_STR(str895, "Invalid token %r");
GLOBAL_STR(str896, "");
GLOBAL_STR(str897, "<ERROR: Can't parse PS1: %s>");
GLOBAL_STR(str898, "osh");
GLOBAL_STR(str899, "PS1");
GLOBAL_STR(str900, "PROMPT_COMMAND");
GLOBAL_STR(str901, "Undefined variable %r");
GLOBAL_STR(str902, "Can't use [] on value of type %s");
GLOBAL_STR(str903, "");
GLOBAL_STR(str904, "Can't use [] on value of type %s");
GLOBAL_STR(str905, "");
...
GLOBAL_STR(str1009, "@");
GLOBAL_STR(str1010, "*");
GLOBAL_STR(str1011, "warning: ");
GLOBAL_STR(str1012, "-1");
GLOBAL_STR(str1013, "@");
GLOBAL_STR(str1014, "*");
GLOBAL_STR(str1015, "[");
GLOBAL_STR(str1016, "]");
GLOBAL_STR(str1017, "Bad indirect expansion: %r");
GLOBAL_STR(str1018, "Indirect expansion of array");
GLOBAL_STR(str1019, "Indirect expansion of assoc array");
GLOBAL_STR(str1020, "");
GLOBAL_STR(str1021, "warning: ");
GLOBAL_STR(str1022, "");
GLOBAL_STR(str1023, "\u0001");
GLOBAL_STR(str1024, "");
GLOBAL_STR(str1025, "\u0002");
GLOBAL_STR(str1026, "");
GLOBAL_STR(str1027, "Can't use @P on %s");
GLOBAL_STR(str1028, " ");
GLOBAL_STR(str1029, "Can't use @Q on %s");
GLOBAL_STR(str1030, "a");
GLOBAL_STR(str1031, "A");
GLOBAL_STR(str1032, "r");
GLOBAL_STR(str1033, "x");
GLOBAL_STR(str1034, "n");
GLOBAL_STR(str1035, "");
GLOBAL_STR(str1036, "Var op %r not implemented");
GLOBAL_STR(str1037, "Can't index string with @");
GLOBAL_STR(str1038, "Can't index string with *");
GLOBAL_STR(str1039, "Can't index string %r with integer");
GLOBAL_STR(str1040, "");
GLOBAL_STR(str1041, "");
GLOBAL_STR(str1042, "$");
GLOBAL_STR(str1043, "Undefined variable %r");
GLOBAL_STR(str1044, "Undefined array %r");
GLOBAL_STR(str1045, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str1046, "Test operation not allowed with ${!array[@]}");
GLOBAL_STR(str1047, "Not implemented");
GLOBAL_STR(str1048, "Illegal array word part (strict_array)");
GLOBAL_STR(str1049, " ");
GLOBAL_STR(str1050, "");
GLOBAL_STR(str1051, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str1052, "Unexpected array literal");
GLOBAL_STR(str1053, "Unexpected associative array literal");
GLOBAL_STR(str1054, "@(");
GLOBAL_STR(str1055, "|");
GLOBAL_STR(str1056, ")");
GLOBAL_STR(str1057, "Can't splice %r");
GLOBAL_STR(str1058, "");
GLOBAL_STR(str1059, "");
GLOBAL_STR(str1060, "This word should yield a string, but it contains an array");
GLOBAL_STR(str1061, " ");
GLOBAL_STR(str1062, "");
GLOBAL_STR(str1063, "<Runtime error: %s>");
GLOBAL_STR(str1064, "<I/O error: %s>");
GLOBAL_STR(str1065, "<Ctrl-C>");
GLOBAL_STR(str1066, "");
GLOBAL_STR(str1067, "");
GLOBAL_STR(str1068, "");
GLOBAL_STR(str1069, "");
GLOBAL_STR(str1070, "");
GLOBAL_STR(str1071, "LHS array not allowed in assignment builtin");
GLOBAL_STR(str1072, "+");
GLOBAL_STR(str1073, "+= not allowed in assignment builtin");
GLOBAL_STR(str1074, "-");
GLOBAL_STR(str1075, "+");
GLOBAL_STR(str1076, "f");
GLOBAL_STR(str1077, "F");
GLOBAL_STR(str1078, "");
GLOBAL_STR(str1079, "=");
GLOBAL_STR(str1080, "Invalid variable name %r");
GLOBAL_STR(str1081, "__NO_COMMAND_SUB__");
GLOBAL_STR(str1082, "__NO_PROCESS_SUB__");
GLOBAL_STR(str1083, "Expected : or } in slice");
GLOBAL_STR(str1084, "Pattern in ${x/pat/replace} must not be empty");
GLOBAL_STR(str1085, "Expected } after replacement string, got %s");
GLOBAL_STR(str1086, "Expected } or / to close pattern");
GLOBAL_STR(str1087, "Expected ] to close subscript");
GLOBAL_STR(str1088, "Expected } to close ${");
GLOBAL_STR(str1089, "Expected } to close ${");
GLOBAL_STR(str1090, "Expected a constant argument");
GLOBAL_STR(str1091, "Expected } to close ${");
GLOBAL_STR(str1092, "Expected } to close ${");
GLOBAL_STR(str1093, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1094, "VOp2");
GLOBAL_STR(str1095, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1096, "VOp3");
GLOBAL_STR(str1097, "Expected } to close ${");
GLOBAL_STR(str1098, "Expected } after length expression");
GLOBAL_STR(str1099, "TODO: ${.myproc builtin sub}");
GLOBAL_STR(str1100, "Unexpected token in ${}");
GLOBAL_STR(str1101, "\\");
GLOBAL_STR(str1102, "Strings with backslashes should look like r'\\n' or c'\\n'");
GLOBAL_STR(str1103, "Use \\xhh or \\u{...} instead of octal escapes in Oil strings");
GLOBAL_STR(str1104, "Invalid hex escape in Oil string (must be \\xHH)");
GLOBAL_STR(str1105, "Invalid char escape in C-style string literal");
GLOBAL_STR(str1106, "Unexpected EOF in single-quoted string that began here");
GLOBAL_STR(str1107, "\"");
GLOBAL_STR(str1108, "'");
GLOBAL_STR(str1109, "Unexpected EOF reading extended glob that began here");
GLOBAL_STR(str1110, "Invalid char escape in double quoted string");
GLOBAL_STR(str1111, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1112, "Invalid backtick: use $(cmd) or \\` in Oil strings");
GLOBAL_STR(str1113, "Unexpected EOF reading double-quoted string that began here");
GLOBAL_STR(str1114, "Use $(cmd) instead of backticks (parse_backticks)");
GLOBAL_STR(str1115, "Unexpected EOF while looking for closing backtick");
GLOBAL_STR(str1116, "");
GLOBAL_STR(str1117, "Invalid proc name %s");
GLOBAL_STR(str1118, "Unexpected token after arithmetic expression (%s != %s)");
GLOBAL_STR(str1119, "Expected second ) to end arith sub");
GLOBAL_STR(str1120, "Expected second ) to end arith statement");
GLOBAL_STR(str1121, "Expected ; here");
GLOBAL_STR(str1122, "Expected ; here");
GLOBAL_STR(str1123, "Expected ) to end for loop expression");
GLOBAL_STR(str1124, "Expected ( after =");
GLOBAL_STR(str1125, "Unexpected token in array literal");
GLOBAL_STR(str1126, "Expected associative array pair");
GLOBAL_STR(str1127, "Invalid char escape (parse_backslash)");
GLOBAL_STR(str1128, "Unexpected token after array literal");
GLOBAL_STR(str1129, "Unexpected token after array splice");
...
GLOBAL_STR(str1139, "Unhandled: %s (%s)");
GLOBAL_STR(str1140, "Invalid lex state %s");
GLOBAL_STR(str1141, "");
GLOBAL_STR(str1142, "");
GLOBAL_STR(str1143, "");
GLOBAL_STR(str1144, "");
...
GLOBAL_STR(str1148, "");
GLOBAL_STR(str1149, "");
GLOBAL_STR(str1150, "Compound shouldn't be empty");
GLOBAL_STR(str1151, "/");
GLOBAL_STR(str1152, "/");
GLOBAL_STR(str1153, "");
GLOBAL_STR(str1154, "EOF");
GLOBAL_STR(str1155, "typ");
GLOBAL_STR(str1156, "tok");
GLOBAL_STR(str1157, "children");
GLOBAL_STR(str1158, "-");
GLOBAL_STR(str1159, "with %d children");
GLOBAL_STR(str1160, "");
GLOBAL_STR(str1161, "(PNode %s %s %s)");
GLOBAL_STR(str1162, "&");
GLOBAL_STR(str1163, "&amp;");
GLOBAL_STR(str1164, "<");
GLOBAL_STR(str1165, "&lt;");
...
GLOBAL_STR(str1191, "/");
GLOBAL_STR(str1192, " \n\r\t");
GLOBAL_STR(str1193, "Unexpected token in QSN string");
GLOBAL_STR(str1194, "Expected closing single quote in QSN string");
GLOBAL_STR(str1195, "Unexpected data after closing quote");
GLOBAL_STR(str1196, "Unexpected token after QSN string");
GLOBAL_STR(str1197, "\\'\r\n\t\u0000");
GLOBAL_STR(str1198, "$'");
GLOBAL_STR(str1199, "'");
GLOBAL_STR(str1200, "'");
...
GLOBAL_STR(str1215, "\\r");
GLOBAL_STR(str1216, "\t");
GLOBAL_STR(str1217, "\\t");
GLOBAL_STR(str1218, "\u0000");
GLOBAL_STR(str1219, "\\x00");
GLOBAL_STR(str1220, "\\0");
GLOBAL_STR(str1221, "");
GLOBAL_STR(str1222, "");
GLOBAL_STR(str1223, "");
GLOBAL_STR(str1224, "\\");
...
GLOBAL_STR(str1231, "\\r");
GLOBAL_STR(str1232, "\t");
GLOBAL_STR(str1233, "\\t");
GLOBAL_STR(str1234, "\u0000");
GLOBAL_STR(str1235, "\\x00");
GLOBAL_STR(str1236, "\\0");
GLOBAL_STR(str1237, "");
GLOBAL_STR(str1238, "!");
GLOBAL_STR(str1239, "--");
GLOBAL_STR(str1240, "--dir");
GLOBAL_STR(str1241, "--exists");
GLOBAL_STR(str1242, "--file");
GLOBAL_STR(str1243, "--symlink");
GLOBAL_STR(str1244, "Expected unary operator, got %r (2 args)");
GLOBAL_STR(str1245, "-a");
GLOBAL_STR(str1246, "-o");
GLOBAL_STR(str1247, "!");
GLOBAL_STR(str1248, "(");
GLOBAL_STR(str1249, ")");
GLOBAL_STR(str1250, "Expected binary operator, got %r (3 args)");
GLOBAL_STR(str1251, "should be invoked as 'test' (simple_test_builtin)");
GLOBAL_STR(str1252, "]");
GLOBAL_STR(str1253, "missing closing ]");
GLOBAL_STR(str1254, "should only have 3 arguments or fewer (simple_test_builtin)");
GLOBAL_STR(str1255, "!");
GLOBAL_STR(str1256, "(");
GLOBAL_STR(str1257, ")");
GLOBAL_STR(str1258, "(test) ");
GLOBAL_STR(str1259, "(test) ");
...
inline Str* fmt120(int a0, int a1) {
  gBuf.reset();
...
inline Str* fmt143(int a0, Str* a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const("  ", 2);
  gBuf.format_s(a1);
...
inline Str* fmt157(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt176(int a0, Str* a1, int a2) {
  gBuf.reset();
...
inline Str* fmt183(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_r(a0);
...
inline Str* fmt188(Str* a0, int a1, int a2) {
  gBuf.reset();
  gBuf.write_const("proc ", 5);
  gBuf.format_r(a0);
...
inline Str* fmt192(int a0, int a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const(" != ", 4);
  gBuf.format_d(a1);
...
inline Str* fmt203(int a0, int a1) {
  gBuf.reset();
...
class AbstractWordEvaluator : public StringWordEvaluator {
 public:
  ...
  runtime_asdl::value_t* _IndirectExpansion(runtime_asdl::value_t* val, syntax_asdl::Token* token);
...
inline Str* fmt337(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("/", 1);
  gBuf.format_s(a1);
...
Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> Mem::_ResolveNameOrRef(Str* name, runtime_asdl::scope_t which_scopes, bool ref_required) {
  ...
  Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> tup3 = this->_ResolveNameOrRef(new_name, which_scopes);
  cell = tup3.at0();
  name_map = tup3.at1();
  cell_name = tup3.at2();
...
bool Mem::IsAssocArray(Str* name) {
  ...
  Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> tup4 = this->_ResolveNameOrRef(name, this->ScopesForReading());
  cell = tup4.at0();
  if (cell) {
...
void Mem::_DisallowNamerefCycle(Str* name, runtime_asdl::scope_t which_scopes, List<Str*>* ref_trail) {
  ...
  Tuple2<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*> tup5 = this->_ResolveNameOnly(name, which_scopes);
  cell = tup5.at0();
  ...
  switch (lval->tag_()) {
    case lvalue_e::Named: {
      ...
      if (((flags & SetNameref) or (flags & ClearNameref))) {
        Tuple2<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*> tup6 = this->_ResolveNameOnly(lval->name, which_scopes);
        cell = tup6.at0();
        name_map = tup6.at1();
        cell_name = lval->name;
      }
    ...
    case lvalue_e::Indexed: {
      ...
      Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> tup8 = this->_ResolveNameOrRef(lval->name, which_scopes, ref_required);
      cell = tup8.at0();
      name_map = tup8.at1();
      if (!cell) {
    ...
    case lvalue_e::Keyed: {
      ...
      value__Str* rval = static_cast<value__Str*>(val);
      left_spid = len(lval->spids) ? lval->spids->index(0) : runtime::NO_SPID;
      Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> tup9 = this->_ResolveNameOrRef(lval->name, which_scopes, ref_required);
      cell = tup9.at0();
      name_map = tup9.at1();
      if (cell->readonly) {
...
runtime_asdl::value_t* Mem::GetValue(Str* name, runtime_asdl::scope_t which_scopes) {
  ...
  if ((str_equals(name, str298) || str_equals(name, str299))) {
  ...
  Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> tup10 = this->_ResolveNameOrRef(name, which_scopes);
  cell = tup10.at0();
  if (cell) {
    return cell->val;
  }
...
runtime_asdl::cell* Mem::GetCell(Str* name, runtime_asdl::scope_t which_scopes) {
  ...
  Tuple2<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*> tup11 = this->_ResolveNameOnly(name, which_scopes);
  cell = tup11.at0();
  return cell;
}
...
bool Mem::Unset(runtime_asdl::lvalue_t* lval, runtime_asdl::scope_t which_scopes) {
  ...
  Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> tup12 = this->_ResolveNameOrRef(var_name, which_scopes);
  cell = tup12.at0();
  name_map = tup12.at1();
  cell_name = tup12.at2();
  if (!cell) {
...
bool Mem::ClearFlag(Str* name, int flag) {
  ...
  Tuple2<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*> tup13 = this->_ResolveNameOnly(name, this->ScopesForReading());
  cell = tup13.at0();
  name_map = tup13.at1();
  if (cell) {
    if ((flag & ClearExport)) {
...
Str* PrettyDir(Str* dir_name, Str* home_dir) {
  ...
  if (home_dir != nullptr) {
    if ((str_equals(dir_name, home_dir) or dir_name->startswith(str_concat(home_dir, str316)))) {
      return str_concat(str317, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    StackRoots _for({&c  });
    f->write(str_equals(c, str320) ? str321 : str322);
  }
  f->write(str323);
  f->write(str_repeat(str324, (length - 1)));
  f->write(str325);
}
...
void PrettyPrintError(error::_ErrorWithLocation* err, alloc::Arena* arena) {
  PrettyPrintError(err, arena, str338);
}
...
void ErrorFormatter::Print_(Str* msg, int span_id) {
  ...
  _PrintWithOptionalSpanId(str339, msg, span_id, this->arena);
}
...
void PrintAst(syntax_asdl::command_t* node, arg_types::main* flag) {
  ...
  if (maybe_str_equals(flag->ast_format, str341)) {
    println_stderr(str342);
  }
  else {
    f = mylib::Stdout();
    ...
    if ((maybe_str_equals(afmt, str343) || maybe_str_equals(afmt, str344))) {
      ...
      if ((maybe_str_equals(afmt, str345) || maybe_str_equals(afmt, str346))) {
...
void _Attributes::Set(Str* name, runtime_asdl::value_t* val) {
  ...
  name = name->replace(str350, str351);
...
bool SetAttachedBool::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  if (attached_arg != nullptr) {
    if ((str_equals(attached_arg, str367) || str_equals(attached_arg, str368) || str_equals(attached_arg, str369) || str_equals(attached_arg, str370))) {
      b = false;
    }
    else {
      if ((str_equals(attached_arg, str371) || str_equals(attached_arg, str372) || str_equals(attached_arg, str373) || str_equals(attached_arg, str374))) {
        b = true;
      }
      else {
...
bool SetOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str376);
...
args::_Attributes* Parse(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str381)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if ((len(spec->actions_long) and arg->startswith(str382))) {
      ...
      if ((arg->startswith(str384) and len(arg) > 1)) {
        n = len(arg);
        for (int i = 1; i < n; ++i) {
          ch = arg->index(i);
          if (str_equals(ch, str385)) {
            ch = str386;
          }
        ...
        if ((len(spec->plus_flags) and (arg->startswith(str390) and len(arg) > 1))) {
          n = len(arg);
          for (int i = 1; i < n; ++i) {
            ch = arg->index(i);
            if (list_contains(spec->plus_flags, ch)) {
              out->Set(ch, Alloc<value::Str>(str391));
              continue;
            }
            e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
          }
...
args::_Attributes* ParseLikeEcho(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    chars = arg->slice(1);
    if ((arg->startswith(str394) and len(chars))) {
      done = false;
...
args::_Attributes* ParseMore(flag_spec::_FlagSpecAndMore* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    ...
    if (((arg->startswith(str398) or arg->startswith(str399)) and len(arg) > 1)) {
      char0 = arg->index(0);
...
int LineLexer::GetSpanIdForEof() {
  int line_id;
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str404, 0);
  }
  else {
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str406, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = Alloc<Token>(id_, span_id, str407);
      return t;
    }
...
lexer::Lexer* ParseContext::_MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = Alloc<lexer::LineLexer>(str409, this->arena);
...
int _Classify(grammar::Grammar* gr, syntax_asdl::Token* tok) {
  ...
  type_str = tok->id == Id::Unknown_Tok ? str413 : fmt90(ui::PrettyId(tok->id));
  p_die(fmt91(type_str), tok);
}
...
Tuple2<pnode::PNode*, syntax_asdl::Token*> ExprParser::Parse(lexer::Lexer* lexer, int start_symbol) {
  ...
  try {
    ...
    p_die(fmt92(ui::PrettyId(e->tok->id)), e->tok);
  }
...
syntax_asdl::expr_t* Transformer::_Tuple(List<pnode::PNode*>* children) {
  ...
  if (n == 2) {
    p_die(fmt93(), children->index(1)->tok);
  }
  ...
  for (int i = 0; i < n; i += 2) {
    ...
    if (tag == expr_e::Var) {
      ...
      if ((tag == place_expr_e::Var || tag == place_expr_e::Subscript || tag == place_expr_e::Attribute)) {
        ...
        p_die(fmt95(), p->tok ? p->tok : nullptr);
      }
    }
  }
  return places;
...
syntax_asdl::re_t* Transformer::_NameInRegex(syntax_asdl::Token* negated_tok, syntax_asdl::Token* tok) {
  ...
  val = tok->val;
  if (maybe_str_equals(val, str437)) {
    if (negated_tok) {
      p_die(fmt96(), tok);
    }
    return tok;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((str_equals(tok->val, str442) || str_equals(tok->val, str443) || str_equals(tok->val, str444))) {
        return tok;
      }
      p_die(fmt100(tok->val), tok);
    }
...
void _ClassLiteralToPosixEre(syntax_asdl::class_literal_term_t* term, List<Str*>* parts) {
  ...
  if (tag == class_literal_term_e::CodePoint) {
    ...
    if (code_point < 128) {
      ...
      e_die(fmt102(code_point), term->spid);
    }
    return ;
  }
  if (tag == class_literal_term_e::PerlClass) {
    ...
    if (term->negated) {
      e_die(fmt103(), term->negated->span_id);
    }
    else {
      pat = fmt104(chars);
    }
  ...
  if (tag == class_literal_term_e::PosixClass) {
    ...
    n = term->name;
    if (term->negated) {
      e_die(fmt105(), term->negated->span_id);
    }
    else {
      pat = fmt106(n);
    }
...
void AsPosixEre(syntax_asdl::re_t* node, List<Str*>* parts) {
  ...
  if (tag == re_e::Repeat) {
    ...
    if (op_tag == re_repeat_e::Num) {
      ...
      parts->append(fmt108(op->times->val));
      return ;
    }
    if (op_tag == re_repeat_e::Range) {
      re_repeat__Range* op = static_cast<re_repeat__Range*>(UP_op);
      lower = op->lower ? op->lower->val : str461;
      upper = op->upper ? op->upper->val : str462;
      parts->append(fmt109(lower, upper));
      return ;
    }
...
syntax_asdl::bool_expr_t* BoolParser::ParseForBuiltin() {
  ...
  if (this->bool_id != Id::Eof_Real) {
    p_die(fmt116(word_::Pretty(this->cur_word)), this->cur_word);
  }
  return node;
}
...
syntax_asdl::bool_expr_t* BoolParser::ParseFactor() {
  ...
  if (this->bool_id == Id::Op_LParen) {
    ...
    if (this->bool_id != Id::Op_RParen) {
      p_die(fmt118(word_::Pretty(this->cur_word)), this->cur_word);
    }
    this->_Next();
    return node;
  }
  p_die(fmt119(ui::PrettyId(this->bool_id)), this->cur_word);
}
...
Str* _RangeParser::_Eat(int token_type) {
  ...
  if (this->token_type != token_type) {
    throw Alloc<_NotARange>(fmt120(token_type, this->token_type));
  }
  val = this->token_val;
  this->_Next();
  return val;
...
syntax_asdl::word_part__BracedRange* _RangeParser::Parse() {
  ...
  if (this->token_type == Id::Range_Int) {
    ...
    if (start < end) {
      ...
      if (part->step <= 0) {
        p_die(fmt122(part->step), this->span_id);
      }
    }
    else {
      if (start > end) {
    ...
    if (this->token_type == Id::Range_Char) {
      ...
      if (upper1 != upper2) {
        p_die(fmt126(), this->span_id);
      }
    }
    else {
      throw Alloc<_NotARange>(str487);
    }
  }
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  flag = attrs->attrs;
  tmp_g = flag->get(str490);
  tmp_a = flag->get(str491);
  ...
  flag_A = (tmp_A and tmp_A->tag_() == value_e::Bool) ? static_cast<value__Bool*>(tmp_A)->b : false;
  tmp_n = flag->get(str493);
  tmp_r = flag->get(str494);
  tmp_x = flag->get(str495);
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if ((maybe_str_equals(flag_n, str497) and !cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_n, str498) and cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str499) and !cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str500) and cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str501) and !cell->exported)) {
      continue;
    }
    ...
    if (print_flags) {
      ...
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str509, str510->join(flags), str511, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str512, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (has_holes) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str515, name, str516, str(i), str517, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str519, str520->join(body), str521}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str523, key_quoted, str524, value_quoted}));
          }
          if (len(body) > 0) {
            decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str525, str526->join(body), str527}));
          }
        }
        else {
          ;  // pass
...
int Export::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r->Next();
  attrs = flag_spec::Parse(str529, arg_r);
...
int Readonly::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str534, arg_r);
...
int NewVar::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  flags_to_clear = 0;
  if (maybe_str_equals(arg->x, str541)) {
    flags |= state::ClearExport;
  }
  if (maybe_str_equals(arg->r, str542)) {
    flags |= state::ClearReadOnly;
  }
  if (maybe_str_equals(arg->n, str543)) {
...
int Unset::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str546, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
...
int Eval::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str549, cmd_val);
  arg_r = tup0.at1();
  if (this->exec_opts->simple_eval_builtin()) {
    Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str550);
    code_str = tup1.at0();
    eval_spid = tup1.at1();
    if (!arg_r->AtEnd()) {
      e_usage(str551);
    ...
    code_str = str552->join(arg_r->Rest());
  ...
  {  // with
    dev::ctx_Tracer ctx(this->tracer, str553, nullptr);
...
int Source::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str554, cmd_val);
  arg_r = tup2.at1();
  path = arg_r->Peek();
  if (path == nullptr) {
    e_usage(str555);
  ...
  try {
    ...
    this->errfmt->Print_(fmt135(path, pyutil::strerror(e)), cmd_val->arg_spids->index(1));
    return 1;
  }
  try {
    try {
      ...
      c_parser = this->parse_ctx->MakeOshParser(line_reader);
      {  // with
        dev::ctx_Tracer ctx(this->tracer, str557, cmd_val->argv);
...
int Command::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup3 = flag_spec::ParseCmdVal(str558, cmd_val);
  attrs = tup3.at0();
  arg_r = tup3.at1();
...
int Builtin::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (to_run == consts::NO_INDEX) {
    ...
    if (consts::LookupAssignBuiltin(name) != consts::NO_INDEX) {
      this->errfmt->Print_(str559, span_id);
    }
    else {
      this->errfmt->Print_(fmt136(name), span_id);
    }
    return 1;
  }
...
int RunProc::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseOilCmdVal(str561, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
  ...
  spids = tup6.at1();
  if (len(argv) == 0) {
    throw Alloc<error::Usage>(str562, runtime::NO_SPID);
  }
  name = argv->index(0);
  if (!dict_contains(this->procs, name)) {
    this->errfmt->StderrLine(fmt137(name));
    return 1;
  }
...
int Try::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup7 = flag_spec::ParseOilCmdVal(str564, cmd_val);
  attrs = tup7.at0();
  arg_r = tup7.at1();
  ...
  if ((arg->allow_status_01 and (status != 0 && status != 1))) {
    if (failure_spid != runtime::NO_SPID) {
      this->errfmt->Print_(str566, failure_spid);
      this->errfmt->StderrLine(str567);
    }
    throw Alloc<error::ErrExit>(fmt139(status), spids->index(0), status);
  }
  if (arg->assign != nullptr) {
    var_name = arg->assign;
    if (var_name->startswith(str569)) {
              ...
              if (consts::IsControlFlow(name)) {
                ...
                if (consts::IsKeyword(name)) {
                  ...
                  if (resolved == nullptr) {
                    ...
                    kind = (Alloc<Tuple2<Str*, Str*>>(str577, resolved));
                  }
                }
              }
            }
...
int Type::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseCmdVal(str578, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  for (ListIter<Tuple2<Str*, Str*>*> it(r); !it.Done(); it.Next()) {
    ...
    name = tup10->at1();
    if (kind == nullptr) {
      this->errfmt->StderrLine(fmt140(name));
      status = 1;
    }
    else {
      if (arg->t) {
...
Tuple2<Str*, bool> _ReadUntilDelim(Str* delim_char) {
  ...
  return (Tuple2<Str*, bool>(str584->join(chars), eof));
}
...
Str* _ReadLine() {
  ...
  while (true) {
    ...
    chars->append(c);
    if (str_equals(c, str585)) {
      break;
    }
  }
  return str586->join(chars);
}
...
int Read::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str593, cmd_val);
  attrs = tup2.at0();
  arg_r = tup2.at1();
  ...
  if (arg->all) {
    ...
    next_spid = tup6.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str600, next_spid);
    }
...
int MapFile::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseCmdVal(str611, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  while (true) {
    ...
    if ((arg->t and line->endswith(str614))) {
      line = line->slice(0, -1);
    }
    lines->append(line);
  }
...
int Cd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseCmdVal(str615, cmd_val);
  attrs = tup11.at0();
  arg_r = tup11.at1();
  ...
  if (str_equals(dest_dir, str618)) {
    try {
      dest_dir = state::GetString(this->mem, str619);
      print(dest_dir);
    }
    catch (error::Runtime* e) {
      this->errfmt->Print_(e->UserErrorString());
  ...
  try {
    pwd = state::GetString(this->mem, str620);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    return 1;
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt142(real_dest_dir, posix::strerror(err_num)), arg_spid);
    return 1;
  }
  state::ExportGlobalString(this->mem, str622, real_dest_dir);
  ...
  if (cmd_val->block) {
    ...
    state::ExportGlobalString(this->mem, str623, pwd);
...
void _PrintDirStack(state::DirStack* dir_stack, int style, Str* home_dir) {
  ...
  if (style == WITH_LINE_NUMBERS) {
    ...
    for (ListIter<Str*> it(dir_stack->Iter()); !it.Done(); it.Next(), ++i) {
      ...
      print(fmt143(i, ui::PrettyDir(entry, home_dir)));
    }
  }
  else {
...
int Pushd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt144(dest_dir, posix::strerror(err_num)), cmd_val->arg_spids->index(1));
    return 1;
  }
  this->dir_stack->Push(dest_dir);
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str629));
  state::ExportGlobalString(this->mem, str630, dest_dir);
...
bool _PopDirStack(state::Mem* mem, state::DirStack* dir_stack, ui::ErrorFormatter* errfmt) {
  ...
  if (dest_dir == nullptr) {
    errfmt->Print_(str631);
    return false;
  }
  err_num = pyos::Chdir(dest_dir);
  if (err_num != 0) {
    errfmt->Print_(fmt145(dest_dir, posix::strerror(err_num)));
    return false;
  }
  state::SetGlobalString(mem, str633, dest_dir);
  mem->SetPwd(dest_dir);
  return true;
}
...
int Popd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->arg_spids) > 1) {
    e_usage(fmt146(), cmd_val->arg_spids->index(1));
  }
...
int Dirs::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup13 = flag_spec::ParseCmdVal(str636, cmd_val);
  attrs = tup13.at0();
  arg_r = tup13.at1();
...
int Pwd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup14 = flag_spec::ParseCmdVal(str638, cmd_val);
  attrs = tup14.at0();
  arg_r = tup14.at1();
...
int Help::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str640, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  ...
  try {
    contents = this->loader->Get(fmt147(topic));
  }
  catch (IOError*) {
    this->errfmt->Print_(fmt148(topic), blame_spid);
    return 1;
  }
  print(contents);
  return 0;
...
syntax_asdl::printf_part_t* _FormatStringParser::_ParseFormatStr() {
  ...
  while ((this->token_type == Id::Format_Flag || this->token_type == Id::Format_Zero)) {
    ...
    if (str_contains(str644, flag)) {
      p_die(fmt149(flag), this->cur_token);
    }
  ...
  if ((this->token_type == Id::Format_Type || this->token_type == Id::Format_Time)) {
    ...
    if (str_contains(str646, part->type->val)) {
      p_die(fmt150(), part->type);
    }
    if (maybe_str_equals(part->type->val, str648)) {
        ...
        if (part->tag_() == printf_part_e::Percent) {
          ...
          if (part->width) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt154(width_str), width_spid);
              return 1;
            }
          }
          precision = -1;
          if (part->precision) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt155(precision_str), precision_spid);
              return 1;
            }
          }
          if (arg_index < num_args) {
          ...
          if (str_equals(typ, str659)) {
            ...
            if (str_equals(typ, str660)) {
              ...
              if (str_equals(typ, str661)) {
                ...
                s = str662->join(c_parts);
              }
              else {
                if ((part->type->id == Id::Format_Time or str_contains(str663, typ))) {
                  try {
                    d = to_int(s);
                  }
                  catch (ValueError*) {
                    if ((len(s) >= 1 and str_contains(str664, s->index(0)))) {
                  ...
                  if (part->type->id == Id::Format_Time) {
                    ...
                    if ((d < 0 and str_contains(str668, typ))) {
                      e_die(fmt157(d, typ), part->type->span_id);
                    }
                    ...
                    zero_pad = 0;
                    if ((width >= 0 and list_contains(flags, str673))) {
                      zero_pad = 1;
                    }
                    else {
                    ...
                    if (zero_pad) {
                      negative = str_equals(s->index(0), str674);
                      if (negative) {
                        digits = s->slice(1);
                        sign = str675;
                        if (zero_pad == 1) {
                      ...
                      s = str_concat(sign, digits->rjust(n, str677));
                    }
                  }
                }
                else {
          ...
          if (width >= 0) {
            if (list_contains(flags, str678)) {
              s = s->ljust(width, str679);
            }
            else {
              s = s->rjust(width, str680);
            }
          }
          out->append(s);
        }
...
int Printf::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup1 = flag_spec::ParseCmdVal(str681, cmd_val);
  attrs = tup1.at0();
  arg_r = tup1.at1();
  arg = Alloc<arg_types::printf>(attrs->attrs);
  Tuple2<Str*, int> tup2 = arg_r->ReadRequired2(str682);
  fmt = tup2.at0();
  fmt_spid = tup2.at1();
...
int Alias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    ...
    if (alias_exp == nullptr) {
      ...
      if (alias_exp == nullptr) {
        this->errfmt->Print_(fmt161(name), cmd_val->arg_spids->index(i));
        status = 1;
      }
      else {
        print(fmt162(name, alias_exp));
      }
    }
    else {
...
int UnAlias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    ...
    if (dict_contains(this->aliases, name)) {
      ...
      this->errfmt->Print_(fmt163(name), cmd_val->arg_spids->index(i));
      status = 1;
    }
  }
  return status;
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->argv) == 1) {
    ...
    for (ListIter<Str*> it(sorted(mapping)); !it.Done(); it.Next()) {
      ...
      code_str = fmt164(name, qsn::maybe_shell_encode(str_val));
      print(code_str);
    }
    return 0;
  }
...
int Shopt::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str696, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
...
int Hash::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str698, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
...
Dict<Str*, bool>* _ParseOptSpec(Str* spec_str) {
  ...
  while (true) {
    ...
    if (str_equals(spec_str->index(i), str701)) {
      spec->set(ch, true);
      i += 1;
    }
  }
...
Tuple2<int, Str*> _GetOpts(Dict<Str*, bool>* spec, List<Str*>* argv, builtin_pure::GetOptsState* my_state, ui::ErrorFormatter* errfmt) {
  ...
  if (spec->index(flag_char)) {
    if (more_chars) {
      ...
      if (optarg == nullptr) {
        my_state->Fail();
        errfmt->Print_(fmt167(current));
        tmp = Alloc<List<Str*>>();
        for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
          Str* a = it.Value();
          tmp->append(qsn::maybe_shell_encode(a));
        }
        println_stderr(fmt168(str714->join(tmp)));
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<Str*, int> tup7 = arg_r->ReadRequired2(str718);
  var_name = tup7.at0();
  var_spid = tup7.at1();
  ...
  if (match::IsValidVarName(var_name)) {
    ...
    throw Alloc<error::Usage>(fmt169(var_name), var_spid);
  }
  return status;
}
...
int Echo::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseLikeEcho(str720, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
...
int Module::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseOilCmdVal(str725, cmd_val);
  arg_r = tup11.at1();
  Tuple2<Str*, int> tup12 = arg_r->ReadRequired2(str726);
  name = tup12.at0();
  if (dict_contains(this->modules, name)) {
    if (this->exec_opts->redefine_module()) {
      this->errfmt->StderrLine(fmt170(name));
      return 0;
    }
    else {
      return 1;
  ...
  if (str_equals(arg, str729)) {
    ...
    if (UP_actual->tag_() == value_e::Str) {
      ...
      if (maybe_str_equals(actual, expected)) {
        ...
        this->errfmt->Print_(fmt171(expected, actual), e_spid);
        return 1;
      }
    }
    else {
      this->errfmt->Print_(fmt172(expected), e_spid);
      return 1;
    }
  }
...
int Shvar::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseOilCmdVal(str737, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  if (!cmd_val->block) {
  ...
  for (ListIter<Str*> it(args); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup17 = mylib::split_once(arg, str740);
    name = tup17.at0();
    s = tup17.at1();
    if (s == nullptr) {
      throw Alloc<error::Usage>(str741, arg_spids->index(i));
    }
...
int PushRegisters::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (!cmd_val->block) {
    throw Alloc<error::Usage>(str742, runtime::NO_SPID);
  }
  {  // with
...
int CommandEvaluator::_RunAssignBuiltin(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  if (builtin_func == nullptr) {
    e_die(fmt174(cmd_val->argv->index(0)), cmd_val->arg_spids->index(0));
  }
  try {
    try {
      status = builtin_func->Run(cmd_val);
      ...
      this->errfmt->PrefixPrint(e->msg, fmt175(arg0), e->span_id);
      status = 2;
    }
    catch (KeyboardInterrupt*) {
      if (this->exec_opts->interactive()) {
...
void CommandEvaluator::_CheckStatus(int status, syntax_asdl::command_t* node, int blame_spid) {
  ...
  if ((this->exec_opts->errexit() and status != 0)) {
    ...
    throw Alloc<error::ErrExit>(fmt176(status, reason, posix::getpid()), span_id, status);
  }
}
  ...
  switch (arg->tag_()) {
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        filename = val->s;
        if (len(filename) == 0) {
          throw Alloc<error::RedirectEval>(str752, arg_word);
        }
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          t = val->s;
          if (len(t) == 0) {
            throw Alloc<error::RedirectEval>(str753, arg_word);
            return nullptr;
          }
          try {
            if (maybe_str_equals(t, str754)) {
              result->arg = Alloc<redirect_arg::CloseFd>();
            }
            else {
              if (str_equals(t->index(-1), str755)) {
            ...
            throw Alloc<error::RedirectEval>(fmt177(t), arg_word);
            return nullptr;
          }
          return result;
        }
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = Alloc<redirect_arg::HereDoc>(str_concat(val->s, str757));
            return result;
          }
          else {
            throw Alloc<AssertionError>();
...
void CommandEvaluator::_StrictErrExit(syntax_asdl::command_t* node) {
  ...
  if (_HasManyStatuses(node)) {
    ...
    e_die(fmt178(node_str), location::SpanForCommand(node));
  }
}
...
void CommandEvaluator::_StrictErrExitList(List<syntax_asdl::command_t*>* node_list) {
  ...
  if (len(node_list) > 1) {
    e_die(fmt179(), location::SpanForCommand(node_list->index(0)));
  }
  node = node_list->index(0);
  if (_HasManyStatuses(node)) {
    node_str = ui::CommandType(node);
    e_die(fmt180(node_str), location::SpanForCommand(node));
  }
}
  ...
  switch (node->tag_()) {
    case command_e::Simple: {
      ...
      if (UP_cmd_val->tag_() == cmd_value_e::Argv) {
        ...
        if (node->block) {
          e_die(fmt181(), node->block->spids->index(0));
        }
        cmd_value__Assign* cmd_val = static_cast<cmd_value__Assign*>(UP_cmd_val);
      }
    ...
    case command_e::Pipeline: {
      ...
      if (len(node->stderr_indices)) {
        e_die(fmt182(), node->spids->index(0));
      }
      if (node->negated) {
    ...
    case command_e::ControlFlow: {
      ...
      if (node->arg_word) {
        ...
        if ((len(str_val->s) == 0 and !this->exec_opts->strict_control_flow())) {
          ...
          try {
            ...
            e_die(fmt183(node->token->val, str_val->s), node->arg_word);
          }
        }
      }
      else {
      ...
      if (ok) {
        ...
        if (this->exec_opts->strict_control_flow()) {
          ...
          this->errfmt->PrefixPrint(msg, str769, tok->span_id);
          status = 0;
        }
      }
    }
    ...
    case command_e::ShFunction: {
      ...
      if ((dict_contains(this->procs, node->name) and !this->exec_opts->redefine_proc())) {
        e_die(fmt184(node->name), node->spids->index(1));
      }
    ...
    case command_e::Proc: {
      ...
      if ((dict_contains(this->procs, node->name->val) and !this->exec_opts->redefine_proc())) {
        e_die(fmt185(node->name->val), node->name->span_id);
      }
      defaults = nullptr;
    ...
    {  // with
      ...
      for (ListIter<syntax_asdl::command_t*> it(to_run); !it.Done(); it.Next()) {
        ...
        {  // with
          ...
          {  // with
            dev::ctx_Tracer ctx(this->tracer, str772, nullptr);
...
Tuple2<bool, bool> CommandEvaluator::ExecuteAndCatch(syntax_asdl::command_t* node, int cmd_flags) {
  ...
  try {
    ...
    if ((cmd_flags & RaiseControlFlow)) {
      ...
      if (e->IsReturn()) {
        ...
        this->errfmt->Print_(str773, e->token->span_id);
        is_fatal = true;
        status = 1;
      }
    }
  ...
  if (err) {
    ...
    if ((is_errexit and !this->exec_opts->verbose_errexit())) {
      ...
      ui::PrettyPrintError(err, this->arena, str774);
    }
  }
...
void CommandEvaluator::MaybeRunExitTrap(List<int>* mut_status) {
  ...
  handler = this->traps->get(str775);
  if (handler) {
    {  // with
      dev::ctx_Tracer ctx(this->tracer, str776, nullptr);
    ...
    if (UP_sig->tag_() == proc_sig_e::Closed) {
      ...
      for (ListIter<syntax_asdl::param*> it(sig->params); !it.Done(); it.Next(), ++i) {
        ...
        if (i < n_args) {
          ...
          if (is_out_param) {
            param_name = str_concat(str777, param_name);
            if (!arg_str->startswith(str778)) {
              e_die(fmt186(arg_str));
            }
      ...
      if (sig->rest) {
        ...
        if (n_args > n_params) {
          throw Alloc<TypeError>(fmt188(proc->name, n_params, n_args));
        }
      }
    }
    try {
      ...
      if (e->IsReturn()) {
        ...
        e_die(fmt189(e->token->val), e->token);
      }
    }
    catch (error::FatalRuntime* e) {
      this->dumper->MaybeCollect(this, e);
...
int CommandEvaluator::RunFuncForCompletion(runtime_asdl::Proc* proc, List<Str*>* argv) {
  ...
  try {
    ...
    this->errfmt->Print_(str783, e->token->span_id);
    status = 1;
  }
  return status;
}
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index(i), str785))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index(-2), str787)) {
    ...
    if ((left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse)) {
      var_name = left_token->val->slice(0, -1);
      if (str_equals(close_token->val->index(-2), str788)) {
        op = assign_op_e::PlusEqual;
      }
      else {
        op = assign_op_e::Equal;
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        var_name = left_token->val->slice(0, -1);
        if (str_equals(close_token->val->index(-2), str789)) {
          op = assign_op_e::PlusEqual;
        }
        else {
          op = assign_op_e::Equal;
        ...
        if (span1->line_id == span2->line_id) {
          ...
          throw Alloc<NotImplementedError>(fmt192(span1->line_id, span2->line_id));
        }
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    if (str_equals(left_token->val->index(-2), str792)) {
      p_die(fmt194(), left_token);
    }
    var_name = left_token->val->slice(0, -1);
    n = len(w->parts);
    if (part_offset == n) {
...
void CommandParser::_Eat(int c_id) {
  ...
  msg = fmt200(ui::PrettyId(c_id), ui::PrettyId(actual_id));
  this->_Eat2(c_id, msg);
}
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index(0), str800)) {
    pos = op_val->find(str801);
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    i += 1;
    if (!alias_exp->endswith(str804)) {
      expanded->append(str805);
      break;
    }
  }
  if (len(expanded) == 0) {
  ...
  while (i < n) {
    ...
    if (span1->line_id == span2->line_id) {
      ...
      throw Alloc<NotImplementedError>(fmt203(span1->line_id, span2->line_id));
    }
    expanded->append(str807);
    i += 1;
  }
  code_str = str808->join(expanded);
  line_reader = reader::StringLineReader(code_str, this->arena);
  ...
  if (kind == Kind::ControlFlow) {
    ...
    if (len(suffix_words) == 1) {
      ...
      if (len(suffix_words) == 2) {
        ...
        p_die(fmt211(kw_token->val), suffix_words->index(2));
      }
    }
...
syntax_asdl::command__ShFunction* CommandParser::ParseFunctionDef() {
  ...
  this->_Next();
  this->_Eat2(Id::Right_ShFunction, str825);
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    ...
    if (str_equals(c, str833)) {
      ...
      if ((str_equals(c, str834) or str_equals(c, str835))) {
        return true;
      }
      else {
        if (str_equals(c, str836)) {
          left_bracket = true;
        }
        else {
          if ((str_equals(c, str837) and left_bracket)) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  ...
  return pyutil::BackslashEscape(s, str839);
}
Str* ERE_META_CHARS = str840;
...
Str* GlobUnescape(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if ((str_equals(c, str841) and i != (n - 1))) {
      i += 1;
      c2 = s->index(i);
      ...
      if (tag == glob_part_e::Operator) {
        ...
        if (tag == glob_part_e::CharClass) {
          ...
          for (ListIter<Str*> it(part->strs); !it.Done(); it.Next()) {
            Str* s = it.Value();
            StackRoots _for({&s          });
            if (str_equals(s, str859)) {
              literal_hyphen = true;
              continue;
            }
            if (str_equals(s, str860)) {
...
int Globber::Expand(Str* arg, List<Str*>* out) {
  ...
  if (n) {
    for (ListIter<Str*> it(results); !it.Done(); it.Next()) {
      Str* name = it.Value();
      StackRoots _for({&name    });
      if ((name->startswith(str866) and !this->exec_opts->dashglob())) {
        n -= 1;
        continue;
      }
      out->append(name);
...
Str* _PromptEvaluatorCache::Get(Str* name) {
  ...
  if (str_equals(name, str868)) {
    value = this->_GetEuid() == 0 ? str869 : str870;
  }
  else {
    if (str_equals(name, str871)) {
      value = libc::gethostname();
    }
    else {
      if (str_equals(name, str872)) {
...
Evaluator::Evaluator(Str* lang, parse_lib::ParseContext* parse_ctx, state::Mem* mem) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Evaluator)) {
  ...
  this->parse_ctx = parse_ctx;
  this->mem = mem;
  this->default_prompt = str_concat(lang, str873);
          ...
          if (id_ == Id::PS_RBrace) {
            ...
            if (id_ == Id::PS_Subst) {
              ...
              if (str_equals(ch, str876)) {
                r = this->cache->Get(str877);
              }
              else {
                if (str_equals(ch, str878)) {
                  r = this->cache->Get(str879);
                }
                else {
                  if (str_equals(ch, str880)) {
                    hostname = this->cache->Get(str881);
                    Tuple2<Str*, Str*> tup1 = mylib::split_once(hostname, str882);
                    r = tup1.at0();
                  }
                  else {
                    if (str_equals(ch, str883)) {
                      r = this->cache->Get(str884);
                    }
                    else {
                      if (str_equals(ch, str885)) {
                        try {
                          pwd = state::GetString(this->mem, str886);
                          home = state::MaybeString(this->mem, str887);
              ...
              ret->append(r->replace(str893, str894));
            }
            else {
              throw Alloc<AssertionError>();
            }
...
Str* Evaluator::EvalFirstPrompt() {
  ...
  if (str_equals(this->lang, str898)) {
    val = this->mem->GetValue(str899);
...
bool AbstractWordEvaluator::_ApplyTestOp(runtime_asdl::value_t* val, syntax_asdl::suffix_op__Unary* op, bool quoted, List<runtime_asdl::part_value_t*>* part_vals, Str* var_name, runtime_asdl::a_index_t* var_index, syntax_asdl::Token* blame_token) {
  ...
  StackRoots _roots({&val, &op, &part_vals, &var_name, &var_index, &blame_token, &tok, &UP_val, &assign_part_vals, &rhs_str, &lval, &UP_var_index, &error_part_vals, &error_str});
...
runtime_asdl::value_t* AbstractWordEvaluator::_EvalIndirectArrayExpansion(Str* name, Str* index) {
  ...
  switch (val->tag_()) {
    ...
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* val = static_cast<value__MaybeStrArray*>(UP_val);
      if ((str_equals(index, str1007) || str_equals(index, str1008))) {
    ...
    case value_e::AssocArray: {
      value__AssocArray* val = static_cast<value__AssocArray*>(UP_val);
      if ((str_equals(index, str1009) || str_equals(index, str1010))) {
        throw Alloc<NotImplementedError>();
      }
      s = val->d->get(index);
      if (s != nullptr) {
    ...
    case value_e::Str: {
      ...
      try {
        ...
        if (this->exec_opts->strict_word_eval()) {
          ...
          this->errfmt->PrettyPrintError(e, str1011);
          return Alloc<value::Str>(str1012);
        }
      }
    }
      break;
...
runtime_asdl::value_t* AbstractWordEvaluator::_IndirectExpansion(runtime_asdl::value_t* val, syntax_asdl::Token* token) {
  runtime_asdl::value_t* UP_val = nullptr;
  int i;
  Str* name = nullptr;
  Str* index = nullptr;
  runtime_asdl::value_t* result = nullptr;
  StackRoots _roots({&val, &token, &UP_val, &name, &index, &result});
  ...
  switch (val->tag_()) {
    ...
    case value_e::Str: {
      ...
      if ((maybe_str_equals(val->s, str1013) || maybe_str_equals(val->s, str1014))) {
        return Alloc<value::MaybeStrArray>(this->mem->GetArgv());
      }
      if (1) {
        i = val->s->find(str1015);
        if ((i >= 0 and str_equals(val->s->index(-1), str1016))) {
...
runtime_asdl::value_t* AbstractWordEvaluator::_Slice(runtime_asdl::value_t* val, syntax_asdl::suffix_op__Slice* op, Str* var_name, syntax_asdl::braced_var_sub* part) {
  ...
  try {
    ...
    if (this->exec_opts->strict_word_eval()) {
      ...
      this->errfmt->PrettyPrintError(e, str1021);
      switch (val->tag_()) {
        case value_e::Str: {
          val = Alloc<value::Str>(str1022);
        }
          break;
        case value_e::MaybeStrArray: {
  ...
  if (op_id == Id::VOp0_P) {
    switch (val->tag_()) {
      case value_e::Str: {
        ...
        p = prompt->replace(str1023, str1024)->replace(str1025, str1026);
    ...
    if (op_id == Id::VOp0_Q) {
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          result = Alloc<value::Str>(str1028->join(tmp));
        }
          break;
        default: {
      ...
      if (op_id == Id::VOp0_a) {
        ...
        result = Alloc<value::Str>(str1035->join(chars));
      }
      else {
...
void AbstractWordEvaluator::_EvalDoubleQuoted(List<syntax_asdl::word_part_t*>* parts, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  if (len(parts) == 0) {
    v = Alloc<part_value::String>(str1040, true, false);
    part_vals->append(v);
    return ;
  }
  for (ListIter<syntax_asdl::word_part_t*> it(parts); !it.Done(); it.Next()) {
...
runtime_asdl::value_t* AbstractWordEvaluator::_EmptyStrOrError(runtime_asdl::value_t* val, syntax_asdl::Token* token) {
  ...
  if (!this->exec_opts->nounset()) {
    return Alloc<value::Str>(str1041);
  }
  name = token->val->startswith(str1042) ? token->val->slice(1) : token->val;
...
void AbstractWordEvaluator::_EvalBracedVarSub(syntax_asdl::braced_var_sub* part, List<runtime_asdl::part_value_t*>* part_vals, bool quoted) {
  ...
  runtime_asdl::value_t* UP_val = nullptr;
  StackRoots _roots({&part, &part_vals, &var_name, &names, &sep, &val, &var_index, &bracket_op, &UP_bracket_op, &tmp, &suffix_op, &UP_op, &part_val, &tok, &op, &UP_val});
    ...
    if (part->prefix_op->id == Id::VSub_Pound) {
      ...
      if (part->prefix_op->id == Id::VSub_Bang) {
        if ((part->bracket_op and part->bracket_op->tag_() == bracket_op_e::WholeArray)) {
          ...
          val = this->_IndirectExpansion(val, part->token);
          if (!suffix_is_test) {
            val = this->_EmptyStrOrError(val, part->token);
          }
        }
  ...
  switch (part->tag_()) {
    ...
    case word_part_e::ExtGlob: {
      ...
      for (ListIter<syntax_asdl::compound_word*> it(part->arms); !it.Done(); it.Next(), ++i) {
        ...
        StackRoots _for({&w      });
        if (i != 0) {
          part_vals->append(Alloc<part_value::String>(str1055, false, false));
        }
        this->_EvalWordToParts(w, false, part_vals);
      }
      part_vals->append(Alloc<part_value::String>(str1056, false, false));
    }
      break;
...
void AbstractWordEvaluator::_EvalWordToParts(syntax_asdl::word_t* w, bool quoted, List<runtime_asdl::part_value_t*>* part_vals, bool is_subst) {
  ...
  switch (w->tag_()) {
    case word_e::Compound: {
      ...
      break;
    case word_e::Empty: {
      part_vals->append(Alloc<part_value::String>(str1058, quoted, !quoted));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, runtime_asdl::quote_t quote_kind) {
  ...
  return Alloc<value::Str>(str1062->join(strs));
}
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index(-2), str1072)) {
          e_die(fmt287(), w);
        }
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        StackRoots _for({&arg      });
        if ((arg->startswith(str1074) or arg->startswith(str1075))) {
          flags->append(arg);
          flag_spids->append(word_spid);
          if ((str_contains(arg, str1076) or str_contains(arg, str1077))) {
            eval_to_pairs = false;
          }
        }
        else {
...
runtime_asdl::part_value__String* CompletionWordEvaluator::_EvalProcessSub(syntax_asdl::command_sub* cs_part) {
  ...
  return Alloc<part_value::String>(str1082, true, false);
}
          ...
          if (op_kind == Kind::VOp2) {
            if (this->token_type == Id::VOp2_Slash) {
              ...
              if (this->token_type == Id::VOp2_Colon) {
                ...
                p_die(fmt299(str1094), this->cur_token);
              }
            }
          }
          else {
            if (op_kind == Kind::VOp3) {
              if (allow_query) {
                ...
                p_die(fmt300(str1096), this->cur_token);
              }
            }
          }
        }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool is_oil_expr) {
  ...
  while (num_end_tokens < expected_end_tokens) {
    ...
    if ((this->token_kind == Kind::Lit || this->token_kind == Kind::Char)) {
      tok = this->cur_token;
      if ((no_backslashes and str_contains(tok->val, str1101))) {
        p_die(fmt305(), tok);
      }
      if (is_oil_expr) {
...
syntax_asdl::word_part_t* WordParser::_ReadUnquotedLeftParts(bool try_triple_quote, List<bool>* triple_out) {
  ...
  if ((this->token_type == Id::Left_DoubleQuote || this->token_type == Id::Left_DollarDoubleQuote)) {
    ...
    if ((try_triple_quote and len(dq_part->parts) == 0)) {
      if (str_equals(this->lexer->ByteLookAhead(), str1107)) {
  ...
  if ((this->token_type == Id::Left_SingleQuote || this->token_type == Id::Left_RSingleQuote || this->token_type == Id::Left_DollarSingleQuote)) {
    ...
    if ((try_triple_quote and len(sq_part->tokens) == 0)) {
      if (str_equals(this->lexer->ByteLookAhead(), str1108)) {
        this->_Next(lex_mode_e::ShCommand);
        this->_Peek();
          ...
          if ((this->token_kind == Kind::VSub || this->token_kind == Kind::Lit || this->token_kind == Kind::History || this->token_kind == Kind::Left || this->token_kind == Kind::KW || this->token_kind == Kind::ControlFlow || this->token_kind == Kind::BoolUnary || this->token_kind == Kind::BoolBinary || this->token_kind == Kind::ExtGlob)) {
            if (this->token_type == Id::Lit_Pound) {
              ...
              if (this->token_type == Id::Lit_TPound) {
                ...
                if ((this->parse_opts->parse_raw_string() and (this->token_type == Id::Lit_Chars and maybe_str_equals(this->cur_token->val, str1138)))) {
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1141, false));
    }
      break;
    case word_part_e::AssocArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1142, false));
    }
      break;
    case word_part_e::Literal: {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str1144, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str1145->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
    ...
    case word_part_e::ExtGlob: 
    case word_part_e::Splice: {
      return (Tuple3<bool, Str*, bool>(false, str1146, false));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() != word_e::Compound) {
    return (Tuple3<bool, Str*, bool>(false, str1147, quoted));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  strs = Alloc<List<Str*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str1148, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str1149->join(strs), quoted));
}
...
syntax_asdl::compound_word* TildeDetect(syntax_asdl::word_t* UP_w) {
  ...
  if ((id_ == Id::Lit_Chars and static_cast<Token*>(part1)->val->startswith(str1151))) {
    new_parts->extend(w->parts->slice(1));
    return Alloc<compound_word>(new_parts);
  }
  return nullptr;
...
void TildeDetectAssign(syntax_asdl::compound_word* w) {
  ...
  for (int i = 0; i < n; ++i) {
    ...
    if ((do_expand and LiteralId(cur) == Id::Lit_TildeLike)) {
      ...
      if (next_part) {
        is_tilde = (LiteralId(next_part) == Id::Lit_Colon or (LiteralId(next_part) == Id::Lit_Chars and static_cast<Token*>(next_part)->val->startswith(str1152)));
      }
      else {
        is_tilde = true;
      }
...
Str* escape(Str* s) {
  ...
  s = s->replace(str1162, str1163);
  s = s->replace(str1164, str1165);
  s = s->replace(str1166, str1167);
  return s;
}
...
Str* join(Str* s1, Str* s2) {
  ...
  if ((s2->startswith(str1170) or len(s1) == 0)) {
    return s2;
  }
  if (s1->endswith(str1171)) {
...
Tuple2<Str*, Str*> split(Str* p) {
  ...
  head = p->slice(0, i);
  tail = p->slice(i);
  if ((len(head) and !(str_equals(head, str_repeat(str1174, len(head)))))) {
    head = head->rstrip(str1175);
  }
...
Tuple2<Str*, Str*> _splitext(Str* p, Str* sep, Str* extsep) {
  ...
  return (Tuple2<Str*, Str*>(p, str1176));
}
...
Str* dirname(Str* p) {
  ...
  i = (p->rfind(str1178) + 1);
  head = p->slice(0, i);
  if ((head and !(str_equals(head, str_repeat(str1179, len(head)))))) {
    head = head->rstrip(str1180);
  }
  return head;
}
...
Str* normpath(Str* path) {
  ...
  slash = str1181;
  dot = str1182;
  if (str_equals(path, str1183)) {
    return dot;
  }
  initial_slashes = path->startswith(str1184);
  if ((initial_slashes and (path->startswith(str1185) and !path->startswith(str1186)))) {
    initial_slashes = 2;
  }
  comps = path->split(str1187);
  new_comps = Alloc<List<Str*>>();
  for (ListIter<Str*> it(comps); !it.Done(); it.Next()) {
    Str* comp = it.Value();
    StackRoots _for({&comp  });
    if ((len(comp) == 0 or str_equals(comp, str1188))) {
      continue;
    }
    if ((!(str_equals(comp, str1189)) or ((initial_slashes == 0 and len(new_comps) == 0) or (len(new_comps) and str_equals(new_comps->index(-1), str1190))))) {
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if ((str_contains(str1197, ch) or IsUnprintableLow(ch))) {
        quote = 2;
        break;
      }
    }
  ...
  parts->append(str1200);
  return str_concat(prefix, str1201->join(parts));
}
...
Str* maybe_encode(Str* s, int bit8_display) {
  ...
  parts->append(str1203);
  return str1204->join(parts);
}
...
Str* encode(Str* s, int bit8_display) {
  ...
  _encode(s, bit8_display, false, parts);
  parts->append(str1206);
  return str1207->join(parts);
}
          ...
          if (str_equals(byte, str1214)) {
            ...
            if (str_equals(byte, str1216)) {
              ...
              if (str_equals(byte, str1218)) {
                part = shell_compat ? str1219 : str1220;
              }
              else {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (typ == Ascii) {
      ...
      if (str_equals(byte, str1224)) {
        ...
        if (str_equals(byte, str1226)) {
          out = str1227;
        }
        else {
          if (str_equals(byte, str1228)) {
            out = str1229;
          }
          else {
            if (str_equals(byte, str1230)) {
              out = str1231;
            }
            else {
              if (str_equals(byte, str1232)) {
                out = str1233;
              }
              else {
                if (str_equals(byte, str1234)) {
                  out = shell_compat ? str1235 : str1236;
                }
                else {
                  if (IsUnprintableLow(byte)) {
...
syntax_asdl::word__String* _StringWordEmitter::ReadWord(types_asdl::lex_mode_t unused_lex_mode) {
  ...
  if (this->i == this->n) {
    w = Alloc<word::String>(Id::Eof_Real, str1237, runtime::NO_SPID);
    return w;
  }
    ...
    if (maybe_str_equals(s0, str1240)) {
      ...
      if (maybe_str_equals(s0, str1241)) {
        ...
        if (maybe_str_equals(s0, str1242)) {
          ...
          if (maybe_str_equals(s0, str1243)) {
...
syntax_asdl::bool_expr_t* _ThreeArgs(builtin_bracket::_StringWordEmitter* w_parser) {
  ...
  if (maybe_str_equals(w1->s, str1246)) {
    return Alloc<bool_expr::LogicalOr>(Alloc<bool_expr::WordTest>(w0), Alloc<bool_expr::WordTest>(w2));
  }
  if (maybe_str_equals(w0->s, str1247)) {
    w_parser->Rewind(2);
    child = _TwoArgs(w_parser);
    return Alloc<bool_expr::LogicalNot>(child);
  }
  if ((maybe_str_equals(w0->s, str1248) and maybe_str_equals(w2->s, str1249))) {
    return Alloc<bool_expr::WordTest>(w1);
  }
  p_die(fmt343(w1->s), w1);
}
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    ...
    strs = cmd_val->argv;
    if ((!strs or !(str_equals(strs->index(-1), str1252)))) {
      this->errfmt->Print_(str1253, cmd_val->arg_spids->index(0));
      return 2;
    }
    cmd_val->argv->pop();
  ...
  try {
    ...
    if (n == 4) {
      a0 = w_parser->Peek(0);
      if (str_equals(a0, str1255)) {
        w_parser->Read();
        child = _ThreeArgs(w_parser);
        bool_node = Alloc<bool_expr::LogicalNot>(child);
      }
      else {
        if ((str_equals(a0, str1256) and str_equals(w_parser->Peek(3), str1257))) {
          w_parser->Read();
          bool_node = _TwoArgs(w_parser);
        }
        else {
  ...
  try {
    ...
    this->errfmt->PrettyPrintError(e, str1259);
    return 2;
  }
  status = b ? 0 : 1;
  return status;

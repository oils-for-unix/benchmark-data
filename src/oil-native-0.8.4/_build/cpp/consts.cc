...
List<int>* OIL_BASIC = new List<int>({41, 39, 1, 40, 23, 2, 22, 33, 34, 35, 37, 36, 3, 42, 38, 24, 25, 26, 27, 28, 32, 29, 31, 30});
List<int>* OIL_ALL = new List<int>({41, 39, 1, 40, 23, 2, 22, 50, 33, 45, 46, 47, 34, 48, 44, 49, 35, 43, 37, 36, 3, 42, 51, 52, 53, 38, 24, 25, 26, 27, 28, 32, 29, 31, 30});
List<int>* DEFAULT_TRUE = new List<int>({20, 39, 21, 40, 13, 46, 47, 48, 49, 19});
List<int>* PARSE_OPTION_NUMS = new List<int>({40, 50, 33, 45, 46, 47, 34, 48, 17, 44, 49, 35, 43, 54, 37, 36});
List<int>* SHOPT_OPTION_NUMS = new List<int>({20, 60, 61, 62, 63, 64, 65, 66, 59, 41, 18, 67, 39, 68, 69, 70, 21, 16, 71, 40, 72, 15, 73, 14, 74, 75, 76, 77, 57, 78, 79, 58, 80, 23, 81, 55, 82, 83, 84, 85, 86, 87, 88, 89, 22, 50, 33, 45, 46, 47, 34, 48, 17, 44, 49, 35, 43, 54, 37, 36, 42, 56, 90, 91, 92, 93, 51, 52, 53, 38, 94, 24, 25, 26, 27, 28, 32, 29, 31, 30, 19, 95});
List<int>* SET_OPTION_NUMS = new List<int>({11, 1, 13, 8, 4, 7, 2, 3, 9, 6, 10, 5});
List<int>* VISIBLE_SHOPT_NUMS = new List<int>({20, 41, 18, 39, 21, 16, 40, 15, 14, 23, 22, 50, 33, 45, 46, 47, 34, 48, 17, 44, 49, 35, 43, 54, 37, 36, 42, 51, 52, 53, 38, 24, 25, 26, 27, 28, 32, 29, 31, 30, 19});

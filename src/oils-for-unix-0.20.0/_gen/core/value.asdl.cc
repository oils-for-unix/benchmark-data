...
hnode_t* ProcDefaults::PrettyTree() {
  ...
  if (this->for_word != nullptr) {  // List
    ...
    for (ListIter<value_t*> it(this->for_word); !it.Done(); it.Next()) {
      ...
      hnode_t* h = (i0 == nullptr) ? Alloc<hnode::Leaf>(StrFromC("_"),
                    color_e::OtherConst) : i0->PrettyTree();
  ...
  if (this->for_typed != nullptr) {  // List
    ...
    for (ListIter<value_t*> it(this->for_typed); !it.Done(); it.Next()) {
      ...
      hnode_t* h = (i1 == nullptr) ? Alloc<hnode::Leaf>(StrFromC("_"),
                    color_e::OtherConst) : i1->PrettyTree();
...
hnode_t* y_lvalue__Container::PrettyTree() {
...
hnode_t* sh_lvalue__Indexed::PrettyTree() {
...
hnode_t* sh_lvalue__Keyed::PrettyTree() {
  hnode::Record* out_node = runtime::NewRecord(sh_lvalue_str(this->tag()));
  List<Field*>* L = out_node->fields;
...
hnode_t* sh_lvalue_t::PrettyTree() {
  switch (this->tag()) {
  case sh_lvalue_e::Var: {
    LeftName* obj = static_cast<LeftName*>(this);
    return obj->PrettyTree();
...
hnode_t* eggex_ops__No::PrettyTree() {
  hnode::Record* out_node = runtime::NewRecord(eggex_ops_str(this->tag()));
  return out_node;
}


hnode_t* eggex_ops__Yes::PrettyTree() {
  hnode::Record* out_node = runtime::NewRecord(eggex_ops_str(this->tag()));
  List<Field*>* L = out_node->fields;
...
hnode_t* eggex_ops_t::PrettyTree() {
  switch (this->tag()) {
  case eggex_ops_e::No: {
...
hnode_t* RegexMatch::PrettyTree() {
  ...
  hnode_t* x2 = this->ops->PrettyTree();
...
hnode_t* regex_match__No::PrettyTree() {
  hnode::Record* out_node = runtime::NewRecord(regex_match_str(this->tag()));
  return out_node;
}


hnode_t* regex_match_t::PrettyTree() {
  switch (this->tag()) {
  case regex_match_e::No: {
...
hnode_t* value__Eggex::PrettyTree() {
  ...
  hnode_t* x0 = this->spliced->PrettyTree();
  ...
  if (this->convert_funcs != nullptr) {  // List
    ...
    for (ListIter<value_t*> it(this->convert_funcs); !it.Done(); it.Next()) {
      ...
      hnode_t* h = (i2 == nullptr) ? Alloc<hnode::Leaf>(StrFromC("_"),
                    color_e::OtherConst) : i2->PrettyTree();
  ...
  if (this->convert_toks != nullptr) {  // List
    ...
    for (ListIter<syntax_asdl::Token*> it(this->convert_toks); !it.Done();
      ...
      hnode_t* h = (i3 == nullptr) ? Alloc<hnode::Leaf>(StrFromC("_"),
                    color_e::OtherConst) : i3->PrettyTree();
...
hnode_t* value__Command::PrettyTree() {
  hnode::Record* out_node = runtime::NewRecord(value_str(this->tag()));
  List<Field*>* L = out_node->fields;
...
hnode_t* value__Place::PrettyTree() {
  hnode::Record* out_node = runtime::NewRecord(value_str(this->tag()));
  List<Field*>* L = out_node->fields;
...
hnode_t* value__Module::PrettyTree() {
  hnode::Record* out_node = runtime::NewRecord(value_str(this->tag()));
  List<Field*>* L = out_node->fields;
...
hnode_t* value__Guts::PrettyTree() {
  hnode::Record* out_node = runtime::NewRecord(value_str(this->tag()));
  List<Field*>* L = out_node->fields;
...
hnode_t* value__BuiltinFunc::PrettyTree() {
  hnode::Record* out_node = runtime::NewRecord(value_str(this->tag()));
  List<Field*>* L = out_node->fields;
...
hnode_t* value__BoundFunc::PrettyTree() {
  ...
  hnode_t* x1 = this->func->PrettyTree();
...
hnode_t* value__Proc::PrettyTree() {
  ...
  if (this->defaults) {  // Optional
    hnode_t* x4 = this->defaults->PrettyTree();
...
hnode_t* value__Func::PrettyTree() {
  ...
  hnode_t* x1 = this->parsed->PrettyTree();
...
hnode_t* value__Range::PrettyTree() {
  hnode::Record* out_node = runtime::NewRecord(value_str(this->tag()));
  List<Field*>* L = out_node->fields;

...
List<int>* OIL_BASIC = new List<int>({44, 42, 1, 43, 4, 2, 5, 35, 36, 37, 38, 40, 39, 3, 45, 49, 48, 41, 47, 46});
List<int>* OIL_ALL = new List<int>({44, 42, 1, 43, 4, 2, 5, 56, 35, 51, 52, 53, 36, 54, 50, 55, 37, 38, 40, 39, 3, 45, 49, 48, 57, 58, 59, 41, 26, 27, 28, 29, 30, 34, 31, 33, 32, 47, 46});
List<int>* DEFAULT_TRUE = new List<int>({22, 42, 23, 43, 15, 52, 53, 54, 55, 49, 21, 47});
List<int>* PARSE_OPTION_NUMS = new List<int>({43, 56, 35, 51, 52, 53, 36, 54, 19, 50, 55, 37, 38, 60, 40, 39});
List<int>* SHOPT_OPTION_NUMS = new List<int>({25, 22, 66, 67, 68, 69, 70, 71, 72, 65, 44, 20, 73, 42, 74, 75, 76, 23, 18, 77, 43, 78, 17, 79, 16, 80, 81, 82, 83, 63, 84, 85, 64, 86, 4, 87, 61, 88, 89, 90, 91, 92, 93, 94, 95, 5, 56, 35, 51, 52, 53, 36, 54, 19, 50, 55, 37, 38, 60, 40, 39, 45, 62, 96, 97, 24, 49, 98, 99, 48, 57, 58, 59, 41, 100, 26, 27, 28, 29, 30, 34, 31, 33, 32, 21, 101, 47, 46});
List<int>* SET_OPTION_NUMS = new List<int>({13, 1, 15, 10, 6, 9, 2, 3, 11, 8, 12, 7});
List<int>* VISIBLE_SHOPT_NUMS = new List<int>({25, 22, 44, 20, 42, 23, 18, 43, 17, 16, 4, 5, 56, 35, 51, 52, 53, 36, 54, 19, 50, 55, 37, 38, 60, 40, 39, 45, 24, 49, 48, 57, 58, 59, 41, 26, 27, 28, 29, 30, 34, 31, 33, 32, 21, 47, 46});

...
GLOBAL_STR(str622, "%");
GLOBAL_STR(str623, "");
GLOBAL_STR(str624, "printf got invalid width %r");
GLOBAL_STR(str625, "0");
GLOBAL_STR(str626, "");
GLOBAL_STR(str627, "printf got invalid precision %r");
GLOBAL_STR(str628, "");
GLOBAL_STR(str629, "s");
GLOBAL_STR(str630, "q");
GLOBAL_STR(str631, "b");
GLOBAL_STR(str632, "");
GLOBAL_STR(str633, "diouxX");
GLOBAL_STR(str634, "'\"");
GLOBAL_STR(str635, "printf expected an integer, got %r");
GLOBAL_STR(str636, "TZ");
GLOBAL_STR(str637, "TZ");
GLOBAL_STR(str638, "ouxX");
GLOBAL_STR(str639, "Can't format negative number %d with %%%s");
GLOBAL_STR(str640, "o");
GLOBAL_STR(str641, "x");
GLOBAL_STR(str642, "X");
GLOBAL_STR(str643, "0");
...
GLOBAL_STR(str649, " ");
GLOBAL_STR(str650, " ");
GLOBAL_STR(str651, "printf");
GLOBAL_STR(str652, "requires a format string");
GLOBAL_STR(str653, "");
GLOBAL_STR(str654, "Invalid -v expression");
GLOBAL_STR(str655, "-v expected a variable name.  shopt -s eval_unsafe_arith allows expressions");
GLOBAL_STR(str656, "alias");
GLOBAL_STR(str657, "alias %s=%r");
GLOBAL_STR(str658, "=");
GLOBAL_STR(str659, "No alias named %r");
GLOBAL_STR(str660, "alias %s=%r");
GLOBAL_STR(str661, "unalias");
GLOBAL_STR(str662, "requires an argument");
GLOBAL_STR(str663, "No alias named %r");
GLOBAL_STR(str664, "%s=%s");
GLOBAL_STR(str665, "set");
GLOBAL_STR(str666, "shopt");
GLOBAL_STR(str667, "got invalid option %r");
GLOBAL_STR(str668, "hash");
GLOBAL_STR(str669, "got extra arguments after -r");
GLOBAL_STR(str670, "hash: %r not found");
GLOBAL_STR(str671, ":");
GLOBAL_STR(str672, "OPTIND");
GLOBAL_STR(str673, "OPTIND");
GLOBAL_STR(str674, "OPTARG");
...
GLOBAL_STR(str680, "?");
GLOBAL_STR(str681, "?");
GLOBAL_STR(str682, "getopts: option %r requires an argument.");
GLOBAL_STR(str683, "(getopts argv: %s)");
GLOBAL_STR(str684, " ");
GLOBAL_STR(str685, "?");
GLOBAL_STR(str686, "");
GLOBAL_STR(str687, "requires an argspec");
GLOBAL_STR(str688, "requires the name of a variable to set");
GLOBAL_STR(str689, "got invalid variable name %r");
GLOBAL_STR(str690, "echo");
GLOBAL_STR(str691, "");
GLOBAL_STR(str692, "takes at most one arg when simple_echo is on (hint: add quotes)");
GLOBAL_STR(str693, " ");
GLOBAL_STR(str694, "\n");
GLOBAL_STR(str695, "Assignment builtin %r not configured");
GLOBAL_STR(str696, "%r ");
GLOBAL_STR(str697, "");
GLOBAL_STR(str698, "command in ");
GLOBAL_STR(str699, "assignment in ");
GLOBAL_STR(str700, "subshell invoked from ");
GLOBAL_STR(str701, "pipeline invoked from ");
GLOBAL_STR(str702, "");
GLOBAL_STR(str703, "Exiting with status %d (%sPID %d)");
GLOBAL_STR(str704, "Redirect filename can't be empty");
GLOBAL_STR(str705, "Redirect descriptor can't be empty");
GLOBAL_STR(str706, "-");
GLOBAL_STR(str707, "-");
GLOBAL_STR(str708, "Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
GLOBAL_STR(str709, "\n");
GLOBAL_STR(str710, "Unknown redirect op");
GLOBAL_STR(str711, "Unknown redirect type");
GLOBAL_STR(str712, "strict_errexit only allows simple commands (got %s). Hint: use 'run'.");
GLOBAL_STR(str713, "strict_errexit only allows a single command.  Hint: use \"run\".");
GLOBAL_STR(str714, "strict_errexit only allows simple commands (got %s). Hint: use 'run'.");
GLOBAL_STR(str715, "ShAssignment builtins don't accept blocks");
GLOBAL_STR(str716, "|& isn't supported");
GLOBAL_STR(str717, "Can't append array to string");
GLOBAL_STR(str718, "Can't append string to array");
GLOBAL_STR(str719, "%r expected a number, got %r");
GLOBAL_STR(str720, "Invalid control flow at top level");
GLOBAL_STR(str721, "warning: ");
GLOBAL_STR(str722, "trap");
GLOBAL_STR(str723, "Loop and control flow can't be in different processes");
GLOBAL_STR(str724, "fatal: ");
GLOBAL_STR(str725, "EXIT");
GLOBAL_STR(str726, "trap EXIT");
GLOBAL_STR(str727, "__");
GLOBAL_STR(str728, ":");
GLOBAL_STR(str729, "Invalid argument %r.  Expected a name starting with :");
GLOBAL_STR(str730, "No value provided for param %r");
GLOBAL_STR(str731, "proc %r expected %d arguments, but got %d");
GLOBAL_STR(str732, "Unexpected %r (in function call)");
GLOBAL_STR(str733, "Attempted to exit from completion hook.");
GLOBAL_STR(str734, "Couldn't find terminator for here doc that starts here");
GLOBAL_STR(str735, "\t");
GLOBAL_STR(str736, "Invalid here doc delimiter");
GLOBAL_STR(str737, "+");
GLOBAL_STR(str738, "+");
GLOBAL_STR(str739, "+");
GLOBAL_STR(str740, "%d != %d");
GLOBAL_STR(str741, "Environment binding shouldn't look like an array assignment");
GLOBAL_STR(str742, "+");
GLOBAL_STR(str743, "Expected = in environment binding, got +=");
GLOBAL_STR(str744, "Environment bindings can't contain array literals");
GLOBAL_STR(str745, "procs can't contain other procs or functions");
GLOBAL_STR(str746, "%r was already declared");
GLOBAL_STR(str747, "%r hasn't been declared");
GLOBAL_STR(str748, "Can't modify constant %r");
GLOBAL_STR(str749, "Expected word type %s, got %s");
GLOBAL_STR(str750, "{");
GLOBAL_STR(str751, "}");
GLOBAL_STR(str752, "Invalid token after redirect operator");
GLOBAL_STR(str753, "TODO: Parse Redirect");
GLOBAL_STR(str754, " ");
GLOBAL_STR(str755, " ");
GLOBAL_STR(str756, "line IDs %d != %d");
GLOBAL_STR(str757, " ");
GLOBAL_STR(str758, "");
GLOBAL_STR(str759, "Unexpected block");
GLOBAL_STR(str760, "=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
GLOBAL_STR(str761, "name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
GLOBAL_STR(str762, "Unexpected block");
GLOBAL_STR(str763, "Unexpected block");
GLOBAL_STR(str764, "Control flow shouldn't have redirects");
GLOBAL_STR(str765, "Control flow shouldn't have environment bindings");
GLOBAL_STR(str766, "Unexpected argument to %r");
GLOBAL_STR(str767, "Invalid word in for loop");
GLOBAL_STR(str768, "Invalid word after for expression");
GLOBAL_STR(str769, "Loop variable name should be a constant");
GLOBAL_STR(str770, "Invalid loop variable name");
GLOBAL_STR(str771, "Unexpected word after for loop variable");
GLOBAL_STR(str772, "Expected ;; or esac");
GLOBAL_STR(str773, "Unexpected word while parsing compound command");
GLOBAL_STR(str774, "Invalid function name");
GLOBAL_STR(str775, "Expected ) in function definition");
GLOBAL_STR(str776, "Invalid KSH-style function name");
GLOBAL_STR(str777, "Unexpected word when parsing command");
GLOBAL_STR(str778, "Unexpected right brace");
GLOBAL_STR(str779, "Unexpected EOF while parsing command");
GLOBAL_STR(str780, "Invalid word while parsing command");
GLOBAL_STR(str781, "Unexpected word while parsing command line");
GLOBAL_STR(str782, "Unterminated here doc began here");
GLOBAL_STR(str783, "\\");
GLOBAL_STR(str784, "*");
GLOBAL_STR(str785, "?");
GLOBAL_STR(str786, "[");
...
GLOBAL_STR(str790, "\\?*+{}^$.()|");
GLOBAL_STR(str791, "\\");
GLOBAL_STR(str792, "Unexpected escaped character %r");
GLOBAL_STR(str793, "");
GLOBAL_STR(str794, "");
GLOBAL_STR(str795, "Malformed character class; treating as literal");
GLOBAL_STR(str796, "Got unescaped right bracket");
GLOBAL_STR(str797, "Got unescaped trailing backslash");
GLOBAL_STR(str798, ".|^$()+*?[]{}\\");
GLOBAL_STR(str799, "\\");
GLOBAL_STR(str800, "\\");
GLOBAL_STR(str801, "\\[");
...
GLOBAL_STR(str813, "]");
GLOBAL_STR(str814, "");
GLOBAL_STR(str815, "Error expanding glob %r: %s");
GLOBAL_STR(str816, "-");
GLOBAL_STR(str817, "<Error: unbalanced \\[ and \\]> ");
GLOBAL_STR(str818, "$");
GLOBAL_STR(str819, "#");
GLOBAL_STR(str820, "$");
GLOBAL_STR(str821, "hostname");
GLOBAL_STR(str822, "user");
GLOBAL_STR(str823, "$ ");
GLOBAL_STR(str824, "\u0001");
GLOBAL_STR(str825, "\u0002");
GLOBAL_STR(str826, "$");
GLOBAL_STR(str827, "$");
GLOBAL_STR(str828, "u");
GLOBAL_STR(str829, "user");
GLOBAL_STR(str830, "h");
GLOBAL_STR(str831, "hostname");
GLOBAL_STR(str832, ".");
GLOBAL_STR(str833, "H");
GLOBAL_STR(str834, "hostname");
GLOBAL_STR(str835, "w");
GLOBAL_STR(str836, "PWD");
GLOBAL_STR(str837, "HOME");
GLOBAL_STR(str838, "<Error: %s>");
GLOBAL_STR(str839, "W");
GLOBAL_STR(str840, "PWD");
GLOBAL_STR(str841, "<Error: PWD is not a string> ");
GLOBAL_STR(str842, "<Error: \\%s not implemented in $PS1> ");
GLOBAL_STR(str843, "$");
GLOBAL_STR(str844, "\\$");
GLOBAL_STR(str845, "Invalid token %r");
GLOBAL_STR(str846, "");
GLOBAL_STR(str847, "<ERROR: Can't parse PS1: %s>");
GLOBAL_STR(str848, "osh");
GLOBAL_STR(str849, "PS1");
GLOBAL_STR(str850, "PROMPT_COMMAND");
GLOBAL_STR(str851, "Undefined variable %r");
GLOBAL_STR(str852, "Can't use [] on value of type %s");
GLOBAL_STR(str853, "");
GLOBAL_STR(str854, "Can't use [] on value of type %s");
GLOBAL_STR(str855, "");
GLOBAL_STR(str856, "0x");
GLOBAL_STR(str857, "Invalid hex constant %r");
GLOBAL_STR(str858, "0");
GLOBAL_STR(str859, "Invalid octal constant %r");
GLOBAL_STR(str860, "#");
GLOBAL_STR(str861, "#");
GLOBAL_STR(str862, "Invalid base for numeric constant %r");
GLOBAL_STR(str863, "a");
GLOBAL_STR(str864, "A");
GLOBAL_STR(str865, "@");
GLOBAL_STR(str866, "_");
GLOBAL_STR(str867, "Invalid digits for numeric constant %r");
GLOBAL_STR(str868, "Digits %r out of range for base %d");
GLOBAL_STR(str869, "Parse error in recursive arithmetic");
GLOBAL_STR(str870, "Invalid integer constant %r");
GLOBAL_STR(str871, "Invalid integer constant %r");
GLOBAL_STR(str872, "Invalid integer constant %r");
GLOBAL_STR(str873, "Undefined value in arithmetic context");
GLOBAL_STR(str874, "Expected a value convertible to integer, got %s");
GLOBAL_STR(str875, "0");
GLOBAL_STR(str876, "Divide by zero");
GLOBAL_STR(str877, "Divide by zero");
GLOBAL_STR(str878, "Expected array or assoc in index expression, got %s");
GLOBAL_STR(str879, "Divide by zero");
GLOBAL_STR(str880, "Divide by zero");
GLOBAL_STR(str881, "Exponent can't be less than zero");
GLOBAL_STR(str882, "Associative array keys must be strings: $x 'x' \"$x\" etc.");
GLOBAL_STR(str883, "Invalid place to modify");
GLOBAL_STR(str884, "BASH_REMATCH");
GLOBAL_STR(str885, "%s isn't implemented");
GLOBAL_STR(str886, "Invalid regex %r: %s");
GLOBAL_STR(str887, " \t\n");
GLOBAL_STR(str888, "IFS");
GLOBAL_STR(str889, "IFS shouldn't be an array");
GLOBAL_STR(str890, " \t\n");
GLOBAL_STR(str891, "IFS");
GLOBAL_STR(str892, " ");
GLOBAL_STR(str893, "");
GLOBAL_STR(str894, "IFS shouldn't be an array");
GLOBAL_STR(str895, "\\");
GLOBAL_STR(str896, "\\");
GLOBAL_STR(str897, "Invalid transition from %r with %r");
GLOBAL_STR(str898, "\u00ef\u00bf\u00bd");
GLOBAL_STR(str899, "");
GLOBAL_STR(str900, "Incomplete UTF-8 character");
GLOBAL_STR(str901, "Invalid UTF-8 continuation byte");
GLOBAL_STR(str902, "Invalid start of UTF-8 character");
GLOBAL_STR(str903, "");
GLOBAL_STR(str904, "%s can't have an argument");
GLOBAL_STR(str905, "");
GLOBAL_STR(str906, "%s can't have an argument");
GLOBAL_STR(str907, "");
GLOBAL_STR(str908, "%s can't have an argument");
GLOBAL_STR(str909, "");
GLOBAL_STR(str910, "%s can't have an argument");
GLOBAL_STR(str911, "");
GLOBAL_STR(str912, "<_GlobReplacer regex %r r %r>");
GLOBAL_STR(str913, "(%s)");
GLOBAL_STR(str914, "Error matching regex %r: %s");
GLOBAL_STR(str915, "^");
GLOBAL_STR(str916, "$");
GLOBAL_STR(str917, "\r");
GLOBAL_STR(str918, "<INVALID CR>");
GLOBAL_STR(str919, "\n");
GLOBAL_STR(str920, "<INVALID NEWLINE>");
GLOBAL_STR(str921, " `~!$&*()[]{}\\|;'\"<>?");
GLOBAL_STR(str922, "Left-hand side of this assignment is invalid");
GLOBAL_STR(str923, "Token can't be used in prefix position");
GLOBAL_STR(str924, "Token can't be used in infix position");
GLOBAL_STR(str925, "Parser expected %s, got %s");
GLOBAL_STR(str926, "Unexpected end of input");
GLOBAL_STR(str927, "");
GLOBAL_STR(str928, "");
GLOBAL_STR(str929, "BASH_SOURCE");
GLOBAL_STR(str930, "FUNCNAME");
GLOBAL_STR(str931, "BASH_LINENO");
GLOBAL_STR(str932, "0");
GLOBAL_STR(str933, "0");
GLOBAL_STR(str934, "\\");
GLOBAL_STR(str935, "\\\\");
GLOBAL_STR(str936, "");
GLOBAL_STR(str937, "");
GLOBAL_STR(str938, "The length index of a array slice can't be negative: %d");
GLOBAL_STR(str939, "Can't slice associative arrays");
GLOBAL_STR(str940, "i");
GLOBAL_STR(str941, "e");
GLOBAL_STR(str942, "f");
GLOBAL_STR(str943, "n");
...
GLOBAL_STR(str947, "");
GLOBAL_STR(str948, "~");
GLOBAL_STR(str949, "HOME");
GLOBAL_STR(str950, "Error expanding tilde (e.g. invalid user)");
GLOBAL_STR(str951, "Can't assign to special variable");
GLOBAL_STR(str952, "unset variable %r");
GLOBAL_STR(str953, "@");
GLOBAL_STR(str954, "*");
GLOBAL_STR(str955, "@");
GLOBAL_STR(str956, "*");
GLOBAL_STR(str957, "warning: ");
GLOBAL_STR(str958, "-1");
GLOBAL_STR(str959, "@");
GLOBAL_STR(str960, "*");
GLOBAL_STR(str961, "[");
GLOBAL_STR(str962, "]");
GLOBAL_STR(str963, "Bad indirect expansion: %r");
GLOBAL_STR(str964, "");
GLOBAL_STR(str965, "warning: ");
GLOBAL_STR(str966, "");
GLOBAL_STR(str967, "\u0001");
GLOBAL_STR(str968, "");
GLOBAL_STR(str969, "\u0002");
GLOBAL_STR(str970, "");
GLOBAL_STR(str971, "Can't use @P on %s");
GLOBAL_STR(str972, " ");
GLOBAL_STR(str973, "Can't use @Q on %s");
GLOBAL_STR(str974, "a");
GLOBAL_STR(str975, "A");
GLOBAL_STR(str976, "r");
GLOBAL_STR(str977, "x");
GLOBAL_STR(str978, "n");
GLOBAL_STR(str979, "");
GLOBAL_STR(str980, "Var op %r not implemented");
GLOBAL_STR(str981, "Can't index string with @");
GLOBAL_STR(str982, "Can't index string with *");
GLOBAL_STR(str983, "Can't index string %r with integer");
GLOBAL_STR(str984, "");
GLOBAL_STR(str985, "");
GLOBAL_STR(str986, "$");
GLOBAL_STR(str987, "Undefined variable %r");
GLOBAL_STR(str988, "Undefined array %r");
GLOBAL_STR(str989, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str990, "Illegal array word part (strict_array)");
GLOBAL_STR(str991, " ");
GLOBAL_STR(str992, "");
GLOBAL_STR(str993, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str994, "Unexpected array literal");
GLOBAL_STR(str995, "Unexpected associative array literal");
GLOBAL_STR(str996, "@(");
GLOBAL_STR(str997, "|");
GLOBAL_STR(str998, ")");
GLOBAL_STR(str999, "Can't splice %r");
GLOBAL_STR(str1000, "");
GLOBAL_STR(str1001, "");
GLOBAL_STR(str1002, "This word should yield a string, but it contains an array");
GLOBAL_STR(str1003, " ");
GLOBAL_STR(str1004, "");
GLOBAL_STR(str1005, "<Runtime error: %s>");
GLOBAL_STR(str1006, "<I/O error: %s>");
GLOBAL_STR(str1007, "<Ctrl-C>");
GLOBAL_STR(str1008, "");
GLOBAL_STR(str1009, "");
GLOBAL_STR(str1010, "");
GLOBAL_STR(str1011, "");
GLOBAL_STR(str1012, "");
GLOBAL_STR(str1013, "LHS array not allowed in assignment builtin");
GLOBAL_STR(str1014, "+");
GLOBAL_STR(str1015, "+= not allowed in assignment builtin");
GLOBAL_STR(str1016, "-");
GLOBAL_STR(str1017, "+");
GLOBAL_STR(str1018, "f");
GLOBAL_STR(str1019, "F");
GLOBAL_STR(str1020, "");
GLOBAL_STR(str1021, "=");
GLOBAL_STR(str1022, "Invalid variable name %r");
GLOBAL_STR(str1023, "__NO_COMMAND_SUB__");
GLOBAL_STR(str1024, "__NO_PROCESS_SUB__");
GLOBAL_STR(str1025, "Expected : or } in slice");
GLOBAL_STR(str1026, "Pattern in ${x/pat/replace} must not be empty");
GLOBAL_STR(str1027, "Expected } after replacement string, got %s");
GLOBAL_STR(str1028, "Expected } or / to close pattern");
GLOBAL_STR(str1029, "Expected ] to close subscript");
GLOBAL_STR(str1030, "Expected } to close ${");
GLOBAL_STR(str1031, "Expected } to close ${");
GLOBAL_STR(str1032, "Expected } to close ${");
GLOBAL_STR(str1033, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1034, "VOp2");
GLOBAL_STR(str1035, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1036, "VOp3");
GLOBAL_STR(str1037, "Expected } to close ${");
GLOBAL_STR(str1038, "Expected } after length expression");
GLOBAL_STR(str1039, "Unexpected token in ${}");
GLOBAL_STR(str1040, "\\");
GLOBAL_STR(str1041, "Strings with backslashes should look like r'\\n' or c'\\n'");
GLOBAL_STR(str1042, "Use \\xhh or \\u{...} instead of octal escapes in Oil strings");
GLOBAL_STR(str1043, "Invalid hex escape in Oil string (must be \\xHH)");
GLOBAL_STR(str1044, "Invalid char escape in C-style string literal");
GLOBAL_STR(str1045, "Unexpected EOF in single-quoted string that began here");
GLOBAL_STR(str1046, "Unexpected EOF reading extended glob that began here");
GLOBAL_STR(str1047, "Invalid char escape in double quoted string");
GLOBAL_STR(str1048, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1049, "Invalid backtick: use $(cmd) or \\` in Oil strings");
GLOBAL_STR(str1050, "Unexpected EOF reading double-quoted string that began here");
GLOBAL_STR(str1051, "Use $(cmd) instead of backticks (parse_backticks)");
GLOBAL_STR(str1052, "Unexpected EOF while looking for closing backtick");
GLOBAL_STR(str1053, "");
GLOBAL_STR(str1054, "Invalid proc name %s");
GLOBAL_STR(str1055, "Unexpected token after arithmetic expression (%s != %s)");
GLOBAL_STR(str1056, "Expected second ) to end arith sub");
GLOBAL_STR(str1057, "Expected second ) to end arith statement");
GLOBAL_STR(str1058, "Expected ; here");
GLOBAL_STR(str1059, "Expected ; here");
GLOBAL_STR(str1060, "Expected ) to end for loop expression");
GLOBAL_STR(str1061, "Expected ( after =");
GLOBAL_STR(str1062, "Unexpected token in array literal");
GLOBAL_STR(str1063, "Expected associative array pair");
GLOBAL_STR(str1064, "Invalid char escape (parse_backslash)");
GLOBAL_STR(str1065, "Unexpected token after array literal");
GLOBAL_STR(str1066, "Unexpected token after array splice");
GLOBAL_STR(str1067, "Literal @ starting a word must be quoted (parse_at_all)");
GLOBAL_STR(str1068, "/");
GLOBAL_STR(str1069, "next_byte %r");
GLOBAL_STR(str1070, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1071, "Unexpected token after @()");
GLOBAL_STR(str1072, "id = %s");
GLOBAL_STR(str1073, "id = %s");
GLOBAL_STR(str1074, "Word has unbalanced { }.  Maybe add a space or quote it like \\{");
GLOBAL_STR(str1075, "Unexpected token while parsing arithmetic: %r");
GLOBAL_STR(str1076, "Unhandled: %s (%s)");
GLOBAL_STR(str1077, "Invalid lex state %s");
GLOBAL_STR(str1078, "");
GLOBAL_STR(str1079, "");
GLOBAL_STR(str1080, "");
GLOBAL_STR(str1081, "");
...
GLOBAL_STR(str1085, "");
GLOBAL_STR(str1086, "");
GLOBAL_STR(str1087, "Compound shouldn't be empty");
GLOBAL_STR(str1088, "/");
GLOBAL_STR(str1089, "/");
GLOBAL_STR(str1090, "");
GLOBAL_STR(str1091, "EOF");
GLOBAL_STR(str1092, "typ");
GLOBAL_STR(str1093, "tok");
GLOBAL_STR(str1094, "children");
GLOBAL_STR(str1095, "-");
GLOBAL_STR(str1096, "with %d children");
GLOBAL_STR(str1097, "");
GLOBAL_STR(str1098, "(PNode %s %s %s)");
GLOBAL_STR(str1099, "&");
GLOBAL_STR(str1100, "&amp;");
GLOBAL_STR(str1101, "<");
GLOBAL_STR(str1102, "&lt;");
...
GLOBAL_STR(str1128, "/");
GLOBAL_STR(str1129, " \n\r\t");
GLOBAL_STR(str1130, "Unexpected token in QSN string");
GLOBAL_STR(str1131, "Expected closing single quote in QSN string");
GLOBAL_STR(str1132, "Unexpected data after closing quote");
GLOBAL_STR(str1133, "Unexpected token after QSN string");
GLOBAL_STR(str1134, "\\'\r\n\t\u0000");
GLOBAL_STR(str1135, "$'");
GLOBAL_STR(str1136, "'");
GLOBAL_STR(str1137, "'");
...
GLOBAL_STR(str1149, "\n");
GLOBAL_STR(str1150, "\\n");
GLOBAL_STR(str1151, "\r");
GLOBAL_STR(str1152, "\\r");
GLOBAL_STR(str1153, "\t");
GLOBAL_STR(str1154, "\\t");
GLOBAL_STR(str1155, "\u0000");
GLOBAL_STR(str1156, "\\x00");
GLOBAL_STR(str1157, "\\0");
GLOBAL_STR(str1158, "");
GLOBAL_STR(str1159, "");
GLOBAL_STR(str1160, "");
GLOBAL_STR(str1161, "\\");
...
GLOBAL_STR(str1165, "\n");
GLOBAL_STR(str1166, "\\n");
GLOBAL_STR(str1167, "\r");
GLOBAL_STR(str1168, "\\r");
GLOBAL_STR(str1169, "\t");
GLOBAL_STR(str1170, "\\t");
GLOBAL_STR(str1171, "\u0000");
GLOBAL_STR(str1172, "\\x00");
GLOBAL_STR(str1173, "\\0");
GLOBAL_STR(str1174, "");
GLOBAL_STR(str1175, "!");
GLOBAL_STR(str1176, "--");
GLOBAL_STR(str1177, "--dir");
GLOBAL_STR(str1178, "--exists");
GLOBAL_STR(str1179, "--file");
GLOBAL_STR(str1180, "--symlink");
GLOBAL_STR(str1181, "Expected unary operator, got %r (2 args)");
GLOBAL_STR(str1182, "-a");
GLOBAL_STR(str1183, "-o");
GLOBAL_STR(str1184, "!");
GLOBAL_STR(str1185, "(");
GLOBAL_STR(str1186, ")");
GLOBAL_STR(str1187, "Expected binary operator, got %r (3 args)");
GLOBAL_STR(str1188, "should be invoked as 'test' (simple_test_builtin)");
GLOBAL_STR(str1189, "]");
GLOBAL_STR(str1190, "missing closing ]");
GLOBAL_STR(str1191, "should only have 3 arguments or fewer (simple_test_builtin)");
GLOBAL_STR(str1192, "!");
GLOBAL_STR(str1193, "(");
GLOBAL_STR(str1194, ")");
GLOBAL_STR(str1195, "(test) ");
    ...
    for (ListIter<syntax_asdl::printf_part_t*> it(parts); !it.Done(); it.Next()) {
      ...
      if (part->tag_() == printf_part_e::Literal) {
        ...
        if (part->tag_() == printf_part_e::Percent) {
          ...
          typ = part->type->val;
          if (str_equals(typ, str629)) {
            if (precision >= 0) {
              s = s->slice(0, precision);
            }
          }
          else {
            if (str_equals(typ, str630)) {
              s = qsn::maybe_shell_encode(s);
            }
            else {
              if (str_equals(typ, str631)) {
                ...
                s = str632->join(c_parts);
              }
              else {
                if ((part->type->id == Id::Format_Time or str_contains(str633, typ))) {
                  try {
                    d = to_int(s);
                  }
                  catch (ValueError*) {
                    if ((len(s) >= 1 and str_contains(str634, s->index(0)))) {
                  ...
                  if (part->type->id == Id::Format_Time) {
                    ...
                    if ((d < 0 and str_contains(str638, typ))) {
                      e_die(fmt149(d, typ), part->type->span_id);
                    }
                    if (str_equals(typ, str640)) {
                      s = mylib::octal(d);
                    }
                    else {
                      if (str_equals(typ, str641)) {
                        s = mylib::hex_lower(d);
                      }
                      else {
                        if (str_equals(typ, str642)) {
                          s = mylib::hex_upper(d);
                        }
                        else {
                          s = str(d);
                    ...
                    zero_pad = 0;
                    if ((width >= 0 and list_contains(flags, str643))) {
                      zero_pad = 1;
                    }
                    else {
                    ...
                    if (zero_pad) {
                      negative = str_equals(s->index(0), str644);
                      if (negative) {
                        digits = s->slice(1);
                        sign = str645;
                        if (zero_pad == 1) {
                      ...
                      s = str_concat(sign, digits->rjust(n, str647));
                    }
                  }
                }
                else {
          ...
          if (width >= 0) {
            if (list_contains(flags, str648)) {
              s = s->ljust(width, str649);
            }
            else {
              s = s->rjust(width, str650);
            }
          }
          out->append(s);
        }
...
int Printf::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  syntax_asdl::arith_expr_t* anode = nullptr;
  runtime_asdl::lvalue_t* lval = nullptr;
  StackRoots _roots({&cmd_val, &attrs, &arg_r, &arg, &fmt, &varargs, &spids, &arena, &parts, &line_reader, &lexer, &parser, &out, &result, &a_parser, &anode, &lval});

  Tuple2<args::_Attributes*, args::Reader*> tup1 = flag_spec::ParseCmdVal(str651, cmd_val);
  attrs = tup1.at0();
  arg_r = tup1.at1();
  arg = Alloc<arg_types::printf>(attrs->attrs);
  Tuple2<Str*, int> tup2 = arg_r->ReadRequired2(str652);
  fmt = tup2.at0();
  fmt_spid = tup2.at1();
...
int Alias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str656, cmd_val);
  arg_r = tup0.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup1 = mylib::split_once(arg, str658);
    name = tup1.at0();
    alias_exp = tup1.at1();
...
int UnAlias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str661, cmd_val);
  arg_r = tup2.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
    e_usage(str662);
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  arg = flag_spec::ParseMore(str665, arg_r);
  if (arg->show_options) {
...
int Shopt::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str666, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
...
int Hash::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str668, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
...
Dict<Str*, bool>* _ParseOptSpec(Str* spec_str) {
  ...
  while (true) {
    ...
    if (str_equals(spec_str->index(i), str671)) {
      spec->set(ch, true);
      i += 1;
    }
  }
...
int GetOptsState::_OptInd() {
  int result;
  try {
    result = state::GetInteger(this->mem, str672);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    result = -1;
...
void GetOptsState::IncIndex() {
  state::SetRefString(this->mem, str673, str((this->_optind + 1)));
}

void GetOptsState::SetArg(Str* optarg) {
  StackRoots _roots({&optarg});

  state::SetRefString(this->mem, str674, optarg);
}

void GetOptsState::Fail() {
  state::SetRefString(this->mem, str675, str676);
}
...
Tuple2<int, Str*> _GetOpts(Dict<Str*, bool>* spec, List<Str*>* argv, builtin_pure::GetOptsState* my_state, ui::ErrorFormatter* errfmt) {
  ...
  if (current == nullptr) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str677));
  }
  if ((!current->startswith(str678) or str_equals(current, str679))) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str680));
  }
  ...
  if (!dict_contains(spec, flag_char)) {
    return (Tuple2<int, Str*>(0, str681));
  }
  if (spec->index(flag_char)) {
    if (more_chars) {
      ...
      if (optarg == nullptr) {
        ...
        println_stderr(fmt160(str684->join(tmp)));
        return (Tuple2<int, Str*>(0, str685));
      }
    }
    my_state->IncIndex();
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  spec_str = arg_r->ReadRequired(str687);
  Tuple2<Str*, int> tup7 = arg_r->ReadRequired2(str688);
  var_name = tup7.at0();
  var_spid = tup7.at1();
...
int Echo::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseLikeEcho(str690, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  if (arg->e) {
    ...
    for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
      ...
      new_argv->append(str691->join(parts));
      if (backslash_c) {
        break;
      }
    }
  ...
  switch (arg->tag_()) {
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        filename = val->s;
        if (len(filename) == 0) {
          throw Alloc<error::RedirectEval>(str704, arg_word);
        }
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          try {
            if (maybe_str_equals(t, str706)) {
              result->arg = Alloc<redirect_arg::CloseFd>();
            }
            else {
              if (str_equals(t->index(-1), str707)) {
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = Alloc<redirect_arg::HereDoc>(str_concat(val->s, str709));
            return result;
          }
          else {
            throw Alloc<AssertionError>();
    ...
    case command_e::ControlFlow: {
      ...
      if (ok) {
        ...
        if (this->exec_opts->strict_control_flow()) {
          ...
          this->errfmt->PrefixPrint(msg, str721, tok->span_id);
          status = 0;
        }
      }
    }
    ...
    {  // with
      ...
      for (ListIter<syntax_asdl::command_t*> it(to_run); !it.Done(); it.Next()) {
        ...
        {  // with
          ...
          {  // with
            dev::ctx_Tracer ctx(this->tracer, str722, nullptr);
...
Tuple2<bool, bool> CommandEvaluator::ExecuteAndCatch(syntax_asdl::command_t* node, int cmd_flags) {
  ...
  try {
    ...
    if ((cmd_flags & IsEvalSource)) {
      ...
      if (e->IsReturn()) {
        ...
        is_eval = false;
        this->errfmt->Print_(str723, e->token->span_id);
        is_fatal = true;
        status = 1;
      }
    }
  ...
  if (err) {
    ...
    if ((is_errexit and !this->exec_opts->verbose_errexit())) {
      ...
      ui::PrettyPrintError(err, this->arena, str724);
    }
  }
...
void CommandEvaluator::MaybeRunExitTrap(List<int>* mut_status) {
  ...
  handler = this->traps->get(str725);
  if (handler) {
    {  // with
      dev::ctx_Tracer ctx(this->tracer, str726, nullptr);
    ...
    if (UP_sig->tag_() == proc_sig_e::Closed) {
      ...
      for (ListIter<syntax_asdl::param*> it(sig->params); !it.Done(); it.Next(), ++i) {
        ...
        if (i < n_args) {
          ...
          if (is_out_param) {
            param_name = str_concat(str727, param_name);
            if (!arg_str->startswith(str728)) {
...
int CommandEvaluator::RunFuncForCompletion(runtime_asdl::Proc* proc, List<Str*>* argv) {
  ...
  try {
    ...
    this->errfmt->Print_(str733, e->token->span_id);
    status = 1;
  }
  return status;
}
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index(i), str735))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index(-2), str737)) {
    ...
    if ((left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse)) {
      var_name = left_token->val->slice(0, -1);
      if (str_equals(close_token->val->index(-2), str738)) {
        op = assign_op_e::PlusEqual;
      }
      else {
        op = assign_op_e::Equal;
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    if (str_equals(left_token->val->index(-2), str742)) {
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index(0), str750)) {
    pos = op_val->find(str751);
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    i += 1;
    if (!alias_exp->endswith(str754)) {
      expanded->append(str755);
      break;
    }
  }
  if (len(expanded) == 0) {
  ...
  while (i < n) {
    ...
    expanded->append(str757);
    i += 1;
  }
  code_str = str758->join(expanded);
  line_reader = reader::StringLineReader(code_str, this->arena);
...
syntax_asdl::command__ShFunction* CommandParser::ParseFunctionDef() {
  ...
  this->_Next();
  this->_Eat2(Id::Right_ShFunction, str775);
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if (str_equals(c, str783)) {
      i += 1;
    }
    else {
      if ((str_equals(c, str784) or str_equals(c, str785))) {
        return true;
      }
      else {
        if (str_equals(c, str786)) {
          left_bracket = true;
        }
        else {
          if ((str_equals(c, str787) and left_bracket)) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  ...
  return pyutil::BackslashEscape(s, str789);
}
Str* ERE_META_CHARS = str790;
...
Str* GlobUnescape(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if ((str_equals(c, str791) and i != (n - 1))) {
      i += 1;
      c2 = s->index(i);
...
Str* _REGEX_CHARS_TO_ESCAPE = str798;
...
int Globber::Expand(Str* arg, List<Str*>* out) {
  ...
  if (n) {
    for (ListIter<Str*> it(results); !it.Done(); it.Next()) {
      Str* name = it.Value();
      StackRoots _for({&name    });
      if ((name->startswith(str816) and !this->exec_opts->dashglob())) {
        n -= 1;
        continue;
      }
      out->append(name);
...
Str* _PromptEvaluatorCache::Get(Str* name) {
  ...
  if (str_equals(name, str818)) {
    value = this->_GetEuid() == 0 ? str819 : str820;
  }
  else {
    if (str_equals(name, str821)) {
...
Evaluator::Evaluator(Str* lang, parse_lib::ParseContext* parse_ctx, state::Mem* mem) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Evaluator)) {
  ...
  this->parse_ctx = parse_ctx;
  this->mem = mem;
  this->default_prompt = str_concat(lang, str823);
      ...
      if (id_ == Id::PS_Octal3) {
        ...
        if (id_ == Id::PS_LBrace) {
          ...
          if (id_ == Id::PS_RBrace) {
            ...
            if (id_ == Id::PS_Subst) {
              ch = value->slice(1);
              if (str_equals(ch, str826)) {
                r = this->cache->Get(str827);
              }
              else {
                if (str_equals(ch, str828)) {
                  r = this->cache->Get(str829);
                }
                else {
                  if (str_equals(ch, str830)) {
                    hostname = this->cache->Get(str831);
                    Tuple2<Str*, Str*> tup1 = mylib::split_once(hostname, str832);
                    r = tup1.at0();
                  }
                  else {
                    if (str_equals(ch, str833)) {
                      r = this->cache->Get(str834);
                    }
                    else {
                      if (str_equals(ch, str835)) {
                        try {
                          pwd = state::GetString(this->mem, str836);
                          home = state::MaybeString(this->mem, str837);
                        ...
                        if (str_equals(ch, str839)) {
                          val = this->mem->GetValue(str840);
                          if (val->tag_() == value_e::Str) {
                            value__Str* str_val = static_cast<value__Str*>(val);
              ...
              ret->append(r->replace(str843, str844));
            }
            else {
              throw Alloc<AssertionError>();
            }
...
Str* Evaluator::EvalFirstPrompt() {
  ...
  if (str_equals(this->lang, str848)) {
    val = this->mem->GetValue(str849);
...
int ArithEvaluator::_StringToInteger(Str* s, int span_id) {
  ...
  if (str_contains(s, str860)) {
    Tuple2<Str*, Str*> tup0 = mylib::split_once(s, str861);
    b = tup0.at0();
    digits = tup0.at1();
    try {
      base = to_int(b);
    ...
    for (StrIter it(digits); !it.Done(); it.Next()) {
      ...
      StackRoots _for({&ch    });
      if (IsLower(ch)) {
        digit = ((ord(ch) - ord(str863)) + 10);
      }
      else {
        if (IsUpper(ch)) {
          digit = ((ord(ch) - ord(str864)) + 36);
        }
        else {
          if (str_equals(ch, str865)) {
            digit = 62;
          }
          else {
  ...
  if (((val->tag_() == value_e::MaybeStrArray || val->tag_() == value_e::AssocArray) and lval->tag_() == lvalue_e::Named)) {
    ...
    if (word_eval::CheckCompatArray(named_lval->name, this->exec_opts)) {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (val->tag_() == value_e::AssocArray) {
          lval = Alloc<lvalue::Keyed>(named_lval->name, str875);
        }
      }
...
void BoolEvaluator::_SetRegexMatches(List<Str*>* matches) {
  ...
  state::SetGlobalArray(this->mem, str884, matches);
}
...
_BaseSplitter::_BaseSplitter(Str* escape_chars) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(_BaseSplitter)) {
  this->escape_chars = str_concat(escape_chars, str895);
}
    ...
    if (i < n) {
      ...
      if (str_contains(ws_chars, c)) {
        ...
        if (str_contains(other_chars, c)) {
          ...
          if ((allow_escape and str_equals(c, str896))) {
...
Str* Utf8Encode(int code) {
  ...
  return str899->join(tmp);
}
Str* INCOMPLETE_CHAR = str900;
Str* INVALID_CONT = str901;
Str* INVALID_START = str902;
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Pound) {
    regex = str_concat(str915, regex);
  }
  else {
    if (op->replace_mode == Id::Lit_Percent) {
      regex = str_concat(regex, str916);
    }
  }
...
Str* ShellQuoteB(Str* s) {
  ...
  s = s->replace(str917, str918)->replace(str919, str920);
  return pyutil::BackslashEscape(s, str921);
}
...
GLOBAL_LIST(Str*, 3, _STRING_AND_ARRAY, {str929 COMMA str930 COMMA str931});
...
runtime_asdl::value_t* ResolveCompatArray(runtime_asdl::value_t* val) {
  ...
  if (val->tag_() == value_e::MaybeStrArray) {
    ...
    if (val->tag_() == value_e::AssocArray) {
      value__AssocArray* assoc_val = static_cast<value__AssocArray*>(val);
      s = dict_contains(assoc_val->d, str932) ? assoc_val->d->index(str933) : nullptr;
    }
    else {
      throw Alloc<AssertionError>();
    }
...
Str* _BackslashEscape(Str* s) {
  ...
  return s->replace(str934, str935);
}
...
runtime_asdl::part_value_t* _ValueToPartValue(runtime_asdl::value_t* val, bool quoted) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      return Alloc<part_value::String>(str936, quoted, !quoted);
    }
      break;
    case value_e::Str: {
      value__Str* val = static_cast<value__Str*>(UP_val);
...
Str* TildeEvaluator::Eval(syntax_asdl::Token* token) {
  ...
  if (maybe_str_equals(token->val, str948)) {
    val = this->mem->GetValue(str949);
    UP_val = val;
    if (val->tag_() == value_e::Str) {
      value__Str* val = static_cast<value__Str*>(UP_val);
      return val->s;
...
runtime_asdl::value_t* AbstractWordEvaluator::_EvalIndirectArrayExpansion(Str* name, Str* index) {
  ...
  switch (val->tag_()) {
    ...
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* val = static_cast<value__MaybeStrArray*>(UP_val);
      if ((str_equals(index, str953) || str_equals(index, str954))) {
    ...
    case value_e::AssocArray: {
      value__AssocArray* val = static_cast<value__AssocArray*>(UP_val);
      if ((str_equals(index, str955) || str_equals(index, str956))) {
        throw Alloc<NotImplementedError>();
      }
      s = val->d->get(index);
      if (s != nullptr) {
      ...
      case value_e::Str: {
        ...
        try {
          ...
          if (this->exec_opts->strict_word_eval()) {
            ...
            this->errfmt->PrettyPrintError(e, str957);
            return Alloc<value::Str>(str958);
          }
        }
      }
        break;
    ...
    if (op_id == Id::VSub_Bang) {
      ...
      switch (val->tag_()) {
        case value_e::Str: {
          ...
          if ((maybe_str_equals(val->s, str959) || maybe_str_equals(val->s, str960))) {
            return Alloc<value::MaybeStrArray>(this->mem->GetArgv());
          }
          i = val->s->find(str961);
          if ((i >= 0 and str_equals(val->s->index(-1), str962))) {
...
runtime_asdl::value_t* AbstractWordEvaluator::_Slice(runtime_asdl::value_t* val, syntax_asdl::suffix_op__Slice* op, Str* var_name, syntax_asdl::braced_var_sub* part) {
  ...
  try {
    ...
    if (this->exec_opts->strict_word_eval()) {
      ...
      this->errfmt->PrettyPrintError(e, str965);
      switch (val->tag_()) {
        case value_e::Str: {
          val = Alloc<value::Str>(str966);
        }
          break;
        case value_e::MaybeStrArray: {
  ...
  if (op_id == Id::VOp0_P) {
    switch (val->tag_()) {
      case value_e::Str: {
        ...
        p = prompt->replace(str967, str968)->replace(str969, str970);
    ...
    if (op_id == Id::VOp0_Q) {
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          result = Alloc<value::Str>(str972->join(tmp));
        }
          break;
        default: {
      ...
      if (op_id == Id::VOp0_a) {
        ...
        result = Alloc<value::Str>(str979->join(chars));
      }
      else {
...
void AbstractWordEvaluator::_EvalDoubleQuoted(List<syntax_asdl::word_part_t*>* parts, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  if (len(parts) == 0) {
    v = Alloc<part_value::String>(str984, true, false);
    part_vals->append(v);
    return ;
  }
...
runtime_asdl::value_t* AbstractWordEvaluator::_EmptyStrOrError(runtime_asdl::value_t* val, syntax_asdl::Token* token) {
  ...
  if (!this->exec_opts->nounset()) {
    return Alloc<value::Str>(str985);
  }
  name = token->val->startswith(str986) ? token->val->slice(1) : token->val;
  ...
  switch (part->tag_()) {
    ...
    case word_part_e::ExtGlob: {
      ...
      for (ListIter<syntax_asdl::compound_word*> it(part->arms); !it.Done(); it.Next(), ++i) {
        ...
        StackRoots _for({&w      });
        if (i != 0) {
          part_vals->append(Alloc<part_value::String>(str997, false, false));
        }
...
void AbstractWordEvaluator::_EvalWordToParts(syntax_asdl::word_t* w, bool quoted, List<runtime_asdl::part_value_t*>* part_vals, bool is_subst) {
  ...
  switch (w->tag_()) {
    case word_e::Compound: {
      ...
      break;
    case word_e::Empty: {
      part_vals->append(Alloc<part_value::String>(str1000, quoted, !quoted));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, runtime_asdl::quote_t quote_kind) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return Alloc<value::Str>(str1001);
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  part_vals = Alloc<List<runtime_asdl::part_value_t*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
  ...
  return Alloc<value::Str>(str1004->join(strs));
}
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index(-2), str1014)) {
          e_die(fmt271(), w);
        }
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        StackRoots _for({&arg      });
        if ((arg->startswith(str1016) or arg->startswith(str1017))) {
          flags->append(arg);
          flag_spids->append(word_spid);
          if ((str_contains(arg, str1018) or str_contains(arg, str1019))) {
            eval_to_pairs = false;
          }
        }
        else {
...
runtime_asdl::part_value__String* CompletionWordEvaluator::_EvalProcessSub(syntax_asdl::command_sub* cs_part) {
  ...
  return Alloc<part_value::String>(str1024, true, false);
}
        ...
        if (op_kind == Kind::VOp2) {
          if (this->token_type == Id::VOp2_Slash) {
            ...
            if (this->token_type == Id::VOp2_Colon) {
              ...
              p_die(fmt281(str1034), this->cur_token);
            }
          }
        }
        else {
          if (op_kind == Kind::VOp3) {
            if (allow_query) {
              ...
              p_die(fmt282(str1036), this->cur_token);
            }
          }
        }
      }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool is_oil_expr) {
  ...
  while (!done) {
    ...
    if ((this->token_kind == Kind::Lit || this->token_kind == Kind::Char)) {
      tok = this->cur_token;
      if ((no_backslashes and str_contains(tok->val, str1040))) {
        p_die(fmt286(), tok);
      }
      if (is_oil_expr) {
            ...
            if (this->token_type == Id::Lit_Dollar) {
              if (!this->parse_opts->parse_dollar()) {
                if ((num_parts == 0 and lex_mode == lex_mode_e::ShCommand)) {
                  ...
                  if (str_equals(next_byte, str1068)) {
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1078, false));
    }
      break;
    case word_part_e::AssocArrayLiteral: {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str1081, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str1082->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
    ...
    case word_part_e::ExtGlob: 
    case word_part_e::Splice: {
      return (Tuple3<bool, Str*, bool>(false, str1083, false));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() != word_e::Compound) {
    return (Tuple3<bool, Str*, bool>(false, str1084, quoted));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  strs = Alloc<List<Str*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
  ...
  return (Tuple3<bool, Str*, bool>(true, str1086->join(strs), quoted));
}
...
syntax_asdl::compound_word* TildeDetect(syntax_asdl::word_t* UP_w) {
  ...
  if ((id_ == Id::Lit_Chars and static_cast<Token*>(part1)->val->startswith(str1088))) {
    new_parts->extend(w->parts->slice(1));
    return Alloc<compound_word>(new_parts);
  }
  return nullptr;
...
void TildeDetectAssign(syntax_asdl::compound_word* w) {
  ...
  for (int i = 0; i < n; ++i) {
    ...
    if ((do_expand and LiteralId(cur) == Id::Lit_TildeLike)) {
      ...
      if (next_part) {
        is_tilde = (LiteralId(next_part) == Id::Lit_Colon or (LiteralId(next_part) == Id::Lit_Chars and static_cast<Token*>(next_part)->val->startswith(str1089)));
      }
      else {
        is_tilde = true;
      }
...
Str* escape(Str* s) {
  ...
  s = s->replace(str1099, str1100);
  s = s->replace(str1101, str1102);
  s = s->replace(str1103, str1104);
  return s;
}
...
Str* join(Str* s1, Str* s2) {
  ...
  if ((s2->startswith(str1107) or len(s1) == 0)) {
    return s2;
  }
  if (s1->endswith(str1108)) {
...
Tuple2<Str*, Str*> split(Str* p) {
  ...
  head = p->slice(0, i);
  tail = p->slice(i);
  if ((len(head) and !(str_equals(head, str_repeat(str1111, len(head)))))) {
    head = head->rstrip(str1112);
  }
...
Tuple2<Str*, Str*> _splitext(Str* p, Str* sep, Str* extsep) {
  ...
  return (Tuple2<Str*, Str*>(p, str1113));
}
...
Str* dirname(Str* p) {
  ...
  i = (p->rfind(str1115) + 1);
  head = p->slice(0, i);
  if ((head and !(str_equals(head, str_repeat(str1116, len(head)))))) {
    head = head->rstrip(str1117);
  }
  return head;
}
...
Str* normpath(Str* path) {
  ...
  slash = str1118;
  dot = str1119;
  if (str_equals(path, str1120)) {
    return dot;
  }
  initial_slashes = path->startswith(str1121);
  if ((initial_slashes and (path->startswith(str1122) and !path->startswith(str1123)))) {
    initial_slashes = 2;
  }
  comps = path->split(str1124);
  new_comps = Alloc<List<Str*>>();
  for (ListIter<Str*> it(comps); !it.Done(); it.Next()) {
    Str* comp = it.Value();
    StackRoots _for({&comp  });
    if ((len(comp) == 0 or str_equals(comp, str1125))) {
      continue;
    }
    if ((!(str_equals(comp, str1126)) or ((initial_slashes == 0 and len(new_comps) == 0) or (len(new_comps) and str_equals(new_comps->index(-1), str1127))))) {
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if ((str_contains(str1134, ch) or IsUnprintableLow(ch))) {
        quote = 2;
        break;
      }
    }
  ...
  parts->append(str1137);
  return str_concat(prefix, str1138->join(parts));
}
...
Str* encode(Str* s, int bit8_display) {
  ...
  parts = Alloc<List<Str*>>();
  parts->append(str1142);
  _encode(s, bit8_display, false, parts);
  parts->append(str1143);
  return str1144->join(parts);
}
...
void _encode_bytes_x(Str* s, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (str_equals(byte, str1145)) {
      part = str1146;
    }
    else {
      if (str_equals(byte, str1147)) {
        part = str1148;
      }
      else {
        if (str_equals(byte, str1149)) {
          part = str1150;
        }
        else {
          if (str_equals(byte, str1151)) {
            part = str1152;
          }
          else {
            if (str_equals(byte, str1153)) {
              part = str1154;
            }
            else {
              if (str_equals(byte, str1155)) {
                part = shell_compat ? str1156 : str1157;
              }
              else {
...
bool _encode_runes(Str* s, int bit8_display, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (typ == Ascii) {
      state = Start;
      if (str_equals(byte, str1161)) {
        out = str1162;
      }
      else {
        if (str_equals(byte, str1163)) {
          out = str1164;
        }
        else {
          if (str_equals(byte, str1165)) {
            out = str1166;
          }
          else {
            if (str_equals(byte, str1167)) {
              out = str1168;
            }
            else {
              if (str_equals(byte, str1169)) {
                out = str1170;
              }
              else {
                if (str_equals(byte, str1171)) {
                  out = shell_compat ? str1172 : str1173;
                }
                else {
                  if (IsUnprintableLow(byte)) {
...
syntax_asdl::word__String* _StringWordEmitter::ReadWord(types_asdl::lex_mode_t unused_lex_mode) {
  ...
  if (this->i == this->n) {
    w = Alloc<word::String>(Id::Eof_Real, str1174, runtime::NO_SPID);
    return w;
  }
...
syntax_asdl::bool_expr_t* _TwoArgs(builtin_bracket::_StringWordEmitter* w_parser) {
  ...
  w1 = w_parser->Read();
  s0 = w0->s;
  if (maybe_str_equals(s0, str1175)) {
    return Alloc<bool_expr::LogicalNot>(Alloc<bool_expr::WordTest>(w1));
  }
  unary_id = Id::Undefined_Tok;
  if (w0->s->startswith(str1176)) {
    if (maybe_str_equals(s0, str1177)) {
...
syntax_asdl::bool_expr_t* _ThreeArgs(builtin_bracket::_StringWordEmitter* w_parser) {
  ...
  if (maybe_str_equals(w1->s, str1182)) {
  ...
  if (maybe_str_equals(w0->s, str1184)) {
    w_parser->Rewind(2);
    child = _TwoArgs(w_parser);
    return Alloc<bool_expr::LogicalNot>(child);
  }
  if ((maybe_str_equals(w0->s, str1185) and maybe_str_equals(w2->s, str1186))) {
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    ...
    strs = cmd_val->argv;
    if ((!strs or !(str_equals(strs->index(-1), str1189)))) {
      this->errfmt->Print_(str1190, cmd_val->arg_spids->index(0));
      return 2;
    }
    cmd_val->argv->pop();
  ...
  try {
    ...
    if (n == 4) {
      a0 = w_parser->Peek(0);
      if (str_equals(a0, str1192)) {
        w_parser->Read();
        child = _ThreeArgs(w_parser);
        bool_node = Alloc<bool_expr::LogicalNot>(child);
      }
      else {
        if ((str_equals(a0, str1193) and str_equals(w_parser->Peek(3), str1194))) {
          w_parser->Read();
          bool_node = _TwoArgs(w_parser);
        }
        else {
    ...
    this->errfmt->PrettyPrintError(e, str1195);
    return 2;
  }

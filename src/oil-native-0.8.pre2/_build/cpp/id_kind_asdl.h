...
namespace Id {
  ...
  const int KW_SetGlobal = 260;
  const int KW_Proc = 261;
  const int KW_Func = 262;
  const int KW_Pass = 263;
  const int ControlFlow_Break = 264;
  const int ControlFlow_Continue = 265;
  const int ControlFlow_Return = 266;
  const int ControlFlow_Exit = 267;
  const int Glob_LBracket = 268;
  const int Glob_RBracket = 269;
  const int Glob_Star = 270;
  const int Glob_QMark = 271;
  const int Glob_Bang = 272;
  const int Glob_Caret = 273;
  const int Glob_EscapedChar = 274;
  const int Glob_BadBackslash = 275;
  const int Glob_CleanLiterals = 276;
  const int Glob_OtherLiteral = 277;
  const int Format_EscapedPercent = 278;
  const int Format_Percent = 279;
  const int Format_Flag = 280;
  const int Format_Num = 281;
  const int Format_Dot = 282;
  const int Format_Type = 283;
  const int PS_Subst = 284;
  const int PS_Octal3 = 285;
  const int PS_LBrace = 286;
  const int PS_RBrace = 287;
  const int PS_Literals = 288;
  const int PS_BadBackslash = 289;
  const int Range_Int = 290;
  const int Range_Char = 291;
  const int Range_Dots = 292;
  const int Range_Other = 293;
  const int BoolUnary_z = 294;
  const int BoolUnary_n = 295;
  const int BoolUnary_o = 296;
  const int BoolUnary_t = 297;
  const int BoolUnary_v = 298;
  const int BoolUnary_R = 299;
  const int BoolUnary_a = 300;
  const int BoolUnary_b = 301;
  const int BoolUnary_c = 302;
  const int BoolUnary_d = 303;
  const int BoolUnary_e = 304;
  const int BoolUnary_f = 305;
  const int BoolUnary_g = 306;
  const int BoolUnary_h = 307;
  const int BoolUnary_L = 308;
  const int BoolUnary_p = 309;
  const int BoolUnary_r = 310;
  const int BoolUnary_s = 311;
  const int BoolUnary_S = 312;
  const int BoolUnary_u = 313;
  const int BoolUnary_w = 314;
  const int BoolUnary_x = 315;
  const int BoolUnary_O = 316;
  const int BoolUnary_G = 317;
  const int BoolUnary_N = 318;
  const int BoolBinary_GlobEqual = 319;
  const int BoolBinary_GlobDEqual = 320;
  const int BoolBinary_GlobNEqual = 321;
  const int BoolBinary_EqualTilde = 322;
  const int BoolBinary_ef = 323;
  const int BoolBinary_nt = 324;
  const int BoolBinary_ot = 325;
  const int BoolBinary_eq = 326;
  const int BoolBinary_ne = 327;
  const int BoolBinary_gt = 328;
  const int BoolBinary_ge = 329;
  const int BoolBinary_lt = 330;
  const int BoolBinary_le = 331;
  const int BoolBinary_Equal = 332;
  const int BoolBinary_DEqual = 333;
  const int BoolBinary_NEqual = 334;
  const int ARRAY_SIZE = 335;
};

...
GLOBAL_STR(str135, "Command sub exited with status %d (%s)");
GLOBAL_STR(str136, "");
GLOBAL_STR(str137, "\n");
...
GLOBAL_STR(str186, "<Process %s>");
GLOBAL_STR(str187, "Fatal error in posix.fork()");
GLOBAL_STR(str188, "<Pipeline %s>");
GLOBAL_STR(str189, " ");
GLOBAL_STR(str190, "JobState MaybeRemove %d");
GLOBAL_STR(str191, "osh: PID %d stopped, but osh didn't start it");
GLOBAL_STR(str192, "");
GLOBAL_STR(str193, "");
GLOBAL_STR(str194, "[PID %d] Stopped");
GLOBAL_STR(str195, "");
GLOBAL_STR(str196, "main");
GLOBAL_STR(str197, "osh usage error: %s");
GLOBAL_STR(str198, "%s-usage");
GLOBAL_STR(str199, "Oil");
GLOBAL_STR(str200, "main");
GLOBAL_STR(str201, "oil");
GLOBAL_STR(str202, "oil:all");
GLOBAL_STR(str203, "--one-pass-parse requires noexec (-n)");
GLOBAL_STR(str204, "completion");
GLOBAL_STR(str205, "history");
GLOBAL_STR(str206, "");
GLOBAL_STR(str207, "OSH_DEBUG_DIR");
GLOBAL_STR(str208, "%d-osh.log");
GLOBAL_STR(str209, "Writing logs to %r");
GLOBAL_STR(str210, "OSH_HIJACK_SHEBANG");
GLOBAL_STR(str211, "");
GLOBAL_STR(str212, "OSH_CRASH_DUMP_DIR");
GLOBAL_STR(str213, "");
GLOBAL_STR(str214, "");
GLOBAL_STR(str215, "osh: Couldn't open %r: %s");
GLOBAL_STR(str216, "/proc/%d/status");
GLOBAL_STR(str217, "--parser-mem-dump can only be used with -n");
GLOBAL_STR(str218, "/proc/%d/status");
GLOBAL_STR(str219, " \t\n\"'><=;|&(:");
GLOBAL_STR(str220, "/");
GLOBAL_STR(str221, "PATH");
GLOBAL_STR(str222, ":");
GLOBAL_STR(str223, "got invalid option %r");
GLOBAL_STR(str224, "got invalid option %r");
GLOBAL_STR(str225, "invalid option %r (try -O or shopt)");
GLOBAL_STR(str226, "SHELLOPTS");
GLOBAL_STR(str227, ":");
GLOBAL_STR(str228, "Syntax options must be set at the top level (outside any function)");
GLOBAL_STR(str229, "Warning: set -o verbose not implemented");
GLOBAL_STR(str230, "SHELLOPTS");
GLOBAL_STR(str231, "%s:%s");
GLOBAL_STR(str232, "SHELLOPTS");
GLOBAL_STR(str233, ":");
GLOBAL_STR(str234, ":");
GLOBAL_STR(str235, "SHELLOPTS");
GLOBAL_STR(str236, "oil:basic");
GLOBAL_STR(str237, "oil:all");
GLOBAL_STR(str238, "strict:all");
GLOBAL_STR(str239, "set %so %s");
GLOBAL_STR(str240, "-");
GLOBAL_STR(str241, "+");
GLOBAL_STR(str242, "oil:basic");
GLOBAL_STR(str243, "oil:all");
GLOBAL_STR(str244, "strict:all");
GLOBAL_STR(str245, "got invalid option %r");
GLOBAL_STR(str246, "shopt -%s %s");
GLOBAL_STR(str247, "s");
GLOBAL_STR(str248, "u");
GLOBAL_STR(str249, "<_ArgFrame %s %d at %x>");
GLOBAL_STR(str250, "Can't determine working directory: %s");
GLOBAL_STR(str251, "IFS");
GLOBAL_STR(str252, "UID");
GLOBAL_STR(str253, "EUID");
GLOBAL_STR(str254, "PPID");
GLOBAL_STR(str255, "HOSTNAME");
GLOBAL_STR(str256, "OSTYPE");
GLOBAL_STR(str257, "OPTIND");
GLOBAL_STR(str258, "1");
GLOBAL_STR(str259, "PS4");
GLOBAL_STR(str260, "${SHX_indent}${SHX_punct}${SHX_pid_str} ");
GLOBAL_STR(str261, "COMP_WORDBREAKS");
GLOBAL_STR(str262, "SHELLOPTS");
GLOBAL_STR(str263, "SHELLOPTS");
GLOBAL_STR(str264, "");
GLOBAL_STR(str265, "SHELLOPTS");
GLOBAL_STR(str266, "PWD");
GLOBAL_STR(str267, "PWD");
GLOBAL_STR(str268, "PWD");
GLOBAL_STR(str269, "OIL_VERSION");
GLOBAL_STR(str270, "PWD");
GLOBAL_STR(str271, "");
GLOBAL_STR(str272, "<Mem");
GLOBAL_STR(str273, "  -- %d --");
GLOBAL_STR(str274, "  %s %s");
GLOBAL_STR(str275, ">");
GLOBAL_STR(str276, "\n");
GLOBAL_STR(str277, "\n");
GLOBAL_STR(str278, "Warning: span_id undefined in SetCurrentSpanId");
GLOBAL_STR(str279, "setref requires a nameref (:out param)");
GLOBAL_STR(str280, "nameref %r is undefined");
GLOBAL_STR(str281, "nameref %r contains invalid variable name %r");
GLOBAL_STR(str282, "Circular nameref %s");
GLOBAL_STR(str283, " -> ");
GLOBAL_STR(str284, "__");
GLOBAL_STR(str285, "Can't assign to readonly value %r");
GLOBAL_STR(str286, "Only strings can be exported");
GLOBAL_STR(str287, "nameref must be a string");
GLOBAL_STR(str288, "Can't assign to readonly array");
GLOBAL_STR(str289, "Can't assign to items in a string");
GLOBAL_STR(str290, "Value of type %s can't be indexed");
GLOBAL_STR(str291, "Can't assign to readonly associative array");
GLOBAL_STR(str292, "ARGV");
GLOBAL_STR(str293, "_status");
GLOBAL_STR(str294, "_this_dir");
GLOBAL_STR(str295, "PIPESTATUS");
GLOBAL_STR(str296, "_pipeline_status");
GLOBAL_STR(str297, "_process_sub_status");
GLOBAL_STR(str298, "BASH_REMATCH");
GLOBAL_STR(str299, "FUNCNAME");
GLOBAL_STR(str300, "source");
GLOBAL_STR(str301, "BASH_SOURCE");
GLOBAL_STR(str302, "BASH_LINENO");
GLOBAL_STR(str303, "0");
GLOBAL_STR(str304, "LINENO");
GLOBAL_STR(str305, "BASHPID");
GLOBAL_STR(str306, "Can't unset readonly variable %r");
GLOBAL_STR(str307, "%r isn't an array");
GLOBAL_STR(str308, "$%s isn't defined");
GLOBAL_STR(str309, "$%s should be a string");
GLOBAL_STR(str310, "$%s should be a string, got %s");
GLOBAL_STR(str311, "$%s doesn't look like an integer, got %r");
GLOBAL_STR(str312, "EOF");
GLOBAL_STR(str313, "/");
GLOBAL_STR(str314, "~");
GLOBAL_STR(str315, "  ");
GLOBAL_STR(str316, "\n  ");
...
GLOBAL_STR(str321, "~");
GLOBAL_STR(str322, "\n");
GLOBAL_STR(str323, "[ interactive ]");
GLOBAL_STR(str324, "[ headless ]");
GLOBAL_STR(str325, "[ -c flag ]");
GLOBAL_STR(str326, "[ stdin%s ]");
GLOBAL_STR(str327, "[ %s word at ? ]");
GLOBAL_STR(str328, "[ %s word at line %d of %s ]");
GLOBAL_STR(str329, "?");
GLOBAL_STR(str330, "[ var %s ]");
GLOBAL_STR(str331, "[ expansion of alias %r ]");
GLOBAL_STR(str332, "[ %s in %s ]");
GLOBAL_STR(str333, "%s:%d: %s%s\n");
GLOBAL_STR(str334, "[??? no location ???] %s%s\n");
GLOBAL_STR(str335, "");
GLOBAL_STR(str336, "");
GLOBAL_STR(str337, "");
GLOBAL_STR(str338, "none");
GLOBAL_STR(str339, "AST not printed.");
GLOBAL_STR(str340, "text");
GLOBAL_STR(str341, "abbrev-text");
GLOBAL_STR(str342, "html");
GLOBAL_STR(str343, "abbrev-html");
GLOBAL_STR(str344, "abbrev-");
GLOBAL_STR(str345, "\n");
GLOBAL_STR(str346, "\n");
GLOBAL_STR(str347, "-");
GLOBAL_STR(str348, "_");
GLOBAL_STR(str349, "<_Attributes %s>");
GLOBAL_STR(str350, "<args.Reader %r %d>");
GLOBAL_STR(str351, "expected argument to %r");
GLOBAL_STR(str352, "-");
GLOBAL_STR(str353, "expected integer after %s, got %r");
GLOBAL_STR(str354, "-");
GLOBAL_STR(str355, "got invalid integer for %s: %s");
GLOBAL_STR(str356, "-");
GLOBAL_STR(str357, "expected number after %r, got %r");
GLOBAL_STR(str358, "-");
GLOBAL_STR(str359, "got invalid float for %s: %s");
GLOBAL_STR(str360, "-");
GLOBAL_STR(str361, "got invalid argument %r to %r, expected one of: %s");
GLOBAL_STR(str362, "-");
GLOBAL_STR(str363, "|");
GLOBAL_STR(str364, "0");
GLOBAL_STR(str365, "F");
GLOBAL_STR(str366, "false");
GLOBAL_STR(str367, "False");
GLOBAL_STR(str368, "1");
GLOBAL_STR(str369, "T");
GLOBAL_STR(str370, "true");
GLOBAL_STR(str371, "Talse");
GLOBAL_STR(str372, "got invalid argument to boolean flag: %r");
GLOBAL_STR(str373, "-");
GLOBAL_STR(str374, "-");
GLOBAL_STR(str375, "Invalid option %r");
GLOBAL_STR(str376, "Expected argument for action");
GLOBAL_STR(str377, "Invalid action name %r");
GLOBAL_STR(str378, "--");
GLOBAL_STR(str379, "--");
GLOBAL_STR(str380, "got invalid flag %r");
GLOBAL_STR(str381, "-");
GLOBAL_STR(str382, "0");
GLOBAL_STR(str383, "Z");
GLOBAL_STR(str384, "-");
GLOBAL_STR(str385, "doesn't accept flag %s");
GLOBAL_STR(str386, "-");
GLOBAL_STR(str387, "+");
GLOBAL_STR(str388, "+");
GLOBAL_STR(str389, "doesn't accept option %s");
GLOBAL_STR(str390, "+");
GLOBAL_STR(str391, "-");
GLOBAL_STR(str392, "--");
GLOBAL_STR(str393, "--");
GLOBAL_STR(str394, "got invalid flag %r");
GLOBAL_STR(str395, "-");
GLOBAL_STR(str396, "+");
GLOBAL_STR(str397, "got invalid flag %r");
GLOBAL_STR(str398, "-");
GLOBAL_STR(str399, "^--?([a-zA-Z0-9][a-zA-Z0-9\\-]*)(=.*)?$");
GLOBAL_STR(str400, "<LineLexer at pos %d of line %r (id = %d)>");
GLOBAL_STR(str401, "");
GLOBAL_STR(str402, "");
GLOBAL_STR(str403, "");
GLOBAL_STR(str404, "");
GLOBAL_STR(str405, "<Trail %s %s %s %s>");
GLOBAL_STR(str406, "");
GLOBAL_STR(str407, "ShAssignment expression can't be nested like this");
GLOBAL_STR(str408, "Here docs aren't allowed in expressions");
GLOBAL_STR(str409, "\n");
GLOBAL_STR(str410, "");
GLOBAL_STR(str411, " (%s)");
GLOBAL_STR(str412, "Unexpected token in expression mode%s");
GLOBAL_STR(str413, "Syntax error in expression (near %s)");
GLOBAL_STR(str414, "alnum");
GLOBAL_STR(str415, "cntrl");
GLOBAL_STR(str416, "lower");
GLOBAL_STR(str417, "space");
GLOBAL_STR(str418, "alpha");
GLOBAL_STR(str419, "digit");
GLOBAL_STR(str420, "print");
GLOBAL_STR(str421, "upper");
GLOBAL_STR(str422, "blank");
GLOBAL_STR(str423, "graph");
GLOBAL_STR(str424, "punct");
GLOBAL_STR(str425, "xdigit");
GLOBAL_STR(str426, "Range start/end shouldn't have more than one character");
GLOBAL_STR(str427, "Write singleton tuples with tup(), not a trailing comma");
GLOBAL_STR(str428, "testlist_comp");
GLOBAL_STR(str429, "obj.field isn't valid, but obj.method() is");
GLOBAL_STR(str430, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str431, "Can't assign to this expression");
GLOBAL_STR(str432, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str433, "TODO");
GLOBAL_STR(str434, "dot");
GLOBAL_STR(str435, "Can't negate this symbol");
GLOBAL_STR(str436, "%r isn't a character class");
GLOBAL_STR(str437, "Can't negate this symbol");
GLOBAL_STR(str438, "%r isn't a character class");
GLOBAL_STR(str439, "%start");
GLOBAL_STR(str440, "%end");
GLOBAL_STR(str441, "dot");
GLOBAL_STR(str442, "Unexpected token %r in regex");
GLOBAL_STR(str443, "%s-%s");
GLOBAL_STR(str444, "ERE can't express code point %d");
GLOBAL_STR(str445, "Perl classes can't be negated in ERE");
GLOBAL_STR(str446, "%s");
GLOBAL_STR(str447, "POSIX classes can't be negated in ERE");
GLOBAL_STR(str448, "[:%s:]");
GLOBAL_STR(str449, ".");
GLOBAL_STR(str450, "^");
GLOBAL_STR(str451, "$");
GLOBAL_STR(str452, "|");
GLOBAL_STR(str453, "POSIX EREs don't have groups without capture, so this node needs () around it.");
GLOBAL_STR(str454, "+");
GLOBAL_STR(str455, "*");
GLOBAL_STR(str456, "?");
GLOBAL_STR(str457, "{%s}");
...
GLOBAL_STR(str468, "^");
GLOBAL_STR(str469, "]");
GLOBAL_STR(str470, "The [ operator doesn't apply to this expression");
GLOBAL_STR(str471, "Expected ]]");
GLOBAL_STR(str472, "Unexpected trailing word %s");
GLOBAL_STR(str473, "Invalid argument to unary operator");
GLOBAL_STR(str474, "Expected ), got %s");
GLOBAL_STR(str475, "Unexpected token in boolean expression (%s)");
GLOBAL_STR(str476, "");
GLOBAL_STR(str477, "Expected %d, got %d");
GLOBAL_STR(str478, "Step can't be 0");
GLOBAL_STR(str479, "Invalid step %d for ascending integer range");
GLOBAL_STR(str480, "Invalid step %d for descending integer range");
GLOBAL_STR(str481, "Invalid step %d for ascending character range");
GLOBAL_STR(str482, "Invalid step %d for descending character range");
GLOBAL_STR(str483, "Mismatched cases in character range");
GLOBAL_STR(str484, "");
GLOBAL_STR(str485, "0");
GLOBAL_STR(str486, "0");
GLOBAL_STR(str487, "g");
...
GLOBAL_STR(str524, ")");
GLOBAL_STR(str525, "");
GLOBAL_STR(str526, "export_");
GLOBAL_STR(str527, "doesn't accept -f because it's dangerous.  (The code can usually be restructured with 'source')");
GLOBAL_STR(str528, "doesn't accept RHS with -n");
GLOBAL_STR(str529, "Got -a but RHS isn't an array");
GLOBAL_STR(str530, "Got -A but RHS isn't an associative array");
GLOBAL_STR(str531, "readonly");
GLOBAL_STR(str532, "new_var");
GLOBAL_STR(str533, "with -f expects function names");
GLOBAL_STR(str534, "declare -f %s");
GLOBAL_STR(str535, "-");
GLOBAL_STR(str536, "-");
GLOBAL_STR(str537, "-");
GLOBAL_STR(str538, "+");
GLOBAL_STR(str539, "+");
GLOBAL_STR(str540, "+");
GLOBAL_STR(str541, "unset");
GLOBAL_STR(str542, "Invalid shift argument %r");
GLOBAL_STR(str543, "got too many arguments");
GLOBAL_STR(str544, "eval");
GLOBAL_STR(str545, "requires code string");
GLOBAL_STR(str546, "requires exactly 1 argument");
GLOBAL_STR(str547, " ");
GLOBAL_STR(str548, "eval");
GLOBAL_STR(str549, "eval");
GLOBAL_STR(str550, "source");
GLOBAL_STR(str551, "missing required argument");
GLOBAL_STR(str552, "source %r failed: %s");
GLOBAL_STR(str553, "source");
GLOBAL_STR(str554, "command");
GLOBAL_STR(str555, "Can't run assignment builtin recursively");
GLOBAL_STR(str556, "%r isn't a shell builtin");
GLOBAL_STR(str557, "runproc");
GLOBAL_STR(str558, "requires arguments");
GLOBAL_STR(str559, "runproc: no proc named %r");
GLOBAL_STR(str560, "try_");
GLOBAL_STR(str561, "'try' expected a command to run");
GLOBAL_STR(str562, "(original failure)");
GLOBAL_STR(str563, "");
GLOBAL_STR(str564, "fatal: status %d when --allow-status-01");
GLOBAL_STR(str565, ":");
GLOBAL_STR(str566, "function");
GLOBAL_STR(str567, "alias");
GLOBAL_STR(str568, "builtin");
GLOBAL_STR(str569, "builtin");
GLOBAL_STR(str570, "builtin");
GLOBAL_STR(str571, "keyword");
GLOBAL_STR(str572, "keyword");
GLOBAL_STR(str573, "file");
GLOBAL_STR(str574, "type");
GLOBAL_STR(str575, "type: %r not found");
GLOBAL_STR(str576, "file");
GLOBAL_STR(str577, "file");
GLOBAL_STR(str578, "%s is a %s");
GLOBAL_STR(str579, "function");
GLOBAL_STR(str580, "");
GLOBAL_STR(str581, "\n");
GLOBAL_STR(str582, "");
GLOBAL_STR(str583, "");
...
GLOBAL_STR(str587, "");
GLOBAL_STR(str588, "");
GLOBAL_STR(str589, "read");
GLOBAL_STR(str590, "_line");
GLOBAL_STR(str591, ":");
GLOBAL_STR(str592, "got extra argument");
GLOBAL_STR(str593, "--qsn can only be used with --line");
GLOBAL_STR(str594, "_all");
GLOBAL_STR(str595, ":");
GLOBAL_STR(str596, "got extra argument");
GLOBAL_STR(str597, "--qsn not implemented yet");
GLOBAL_STR(str598, "read -t isn't implemented (except t=0)");
GLOBAL_STR(str599, "");
GLOBAL_STR(str600, "REPLY");
GLOBAL_STR(str601, "REPLY");
GLOBAL_STR(str602, "\u0000");
GLOBAL_STR(str603, "\u0000");
GLOBAL_STR(str604, "\n");
GLOBAL_STR(str605, "");
GLOBAL_STR(str606, ":");
GLOBAL_STR(str607, "mapfile");
GLOBAL_STR(str608, "MAPFILE");
GLOBAL_STR(str609, ":");
GLOBAL_STR(str610, "\n");
GLOBAL_STR(str611, "cd");
GLOBAL_STR(str612, "HOME");
GLOBAL_STR(str613, "HOME");
GLOBAL_STR(str614, "-");
GLOBAL_STR(str615, "OLDPWD");
GLOBAL_STR(str616, "PWD");
GLOBAL_STR(str617, "cd %r: %s");
GLOBAL_STR(str618, "PWD");
GLOBAL_STR(str619, "OLDPWD");
GLOBAL_STR(str620, "%2d  %s");
GLOBAL_STR(str621, " ");
GLOBAL_STR(str622, "pushd: no other directory");
GLOBAL_STR(str623, "got too many arguments");
GLOBAL_STR(str624, "pushd: %r: %s");
GLOBAL_STR(str625, "HOME");
GLOBAL_STR(str626, "PWD");
GLOBAL_STR(str627, "popd: directory stack is empty");
GLOBAL_STR(str628, "popd: %r: %s");
GLOBAL_STR(str629, "PWD");
GLOBAL_STR(str630, "got extra argument");
GLOBAL_STR(str631, "HOME");
GLOBAL_STR(str632, "dirs");
GLOBAL_STR(str633, "HOME");
GLOBAL_STR(str634, "pwd");
GLOBAL_STR(str635, "_devbuild/help/groups.txt");
GLOBAL_STR(str636, "help");
GLOBAL_STR(str637, "help");
GLOBAL_STR(str638, "_devbuild/help/%s");
GLOBAL_STR(str639, "no help topics match %r");
GLOBAL_STR(str640, "# +");
GLOBAL_STR(str641, "osh printf doesn't support the %r flag");
GLOBAL_STR(str642, "eEfFgG");
GLOBAL_STR(str643, "osh printf doesn't support floating point");
GLOBAL_STR(str644, "c");
GLOBAL_STR(str645, "osh printf doesn't support single characters (bytes)");
GLOBAL_STR(str646, "Invalid printf format character");
GLOBAL_STR(str647, "Expected a printf format character");
GLOBAL_STR(str648, "%");
GLOBAL_STR(str649, "");
GLOBAL_STR(str650, "printf got invalid width %r");
GLOBAL_STR(str651, "0");
GLOBAL_STR(str652, "");
GLOBAL_STR(str653, "printf got invalid precision %r");
GLOBAL_STR(str654, "");
GLOBAL_STR(str655, "s");
GLOBAL_STR(str656, "q");
GLOBAL_STR(str657, "b");
GLOBAL_STR(str658, "");
GLOBAL_STR(str659, "diouxX");
GLOBAL_STR(str660, "'\"");
GLOBAL_STR(str661, "printf expected an integer, got %r");
GLOBAL_STR(str662, "TZ");
GLOBAL_STR(str663, "TZ");
GLOBAL_STR(str664, "ouxX");
GLOBAL_STR(str665, "Can't format negative number %d with %%%s");
GLOBAL_STR(str666, "o");
GLOBAL_STR(str667, "x");
GLOBAL_STR(str668, "X");
GLOBAL_STR(str669, "0");
...
GLOBAL_STR(str675, " ");
GLOBAL_STR(str676, " ");
GLOBAL_STR(str677, "printf");
GLOBAL_STR(str678, "requires a format string");
GLOBAL_STR(str679, "printf");
GLOBAL_STR(str680, "");
GLOBAL_STR(str681, "alias");
GLOBAL_STR(str682, "alias %s=%r");
GLOBAL_STR(str683, "=");
GLOBAL_STR(str684, "No alias named %r");
GLOBAL_STR(str685, "alias %s=%r");
GLOBAL_STR(str686, "unalias");
GLOBAL_STR(str687, "requires an argument");
GLOBAL_STR(str688, "No alias named %r");
GLOBAL_STR(str689, "%s=%s");
GLOBAL_STR(str690, "set");
GLOBAL_STR(str691, "shopt");
GLOBAL_STR(str692, "got invalid option %r");
GLOBAL_STR(str693, "hash");
GLOBAL_STR(str694, "got extra arguments after -r");
GLOBAL_STR(str695, "hash: %r not found");
GLOBAL_STR(str696, ":");
GLOBAL_STR(str697, "OPTIND");
GLOBAL_STR(str698, "OPTIND");
GLOBAL_STR(str699, "OPTARG");
GLOBAL_STR(str700, "OPTARG");
GLOBAL_STR(str701, "");
GLOBAL_STR(str702, "?");
GLOBAL_STR(str703, "-");
GLOBAL_STR(str704, "-");
GLOBAL_STR(str705, "?");
GLOBAL_STR(str706, "?");
GLOBAL_STR(str707, "getopts: option %r requires an argument.");
GLOBAL_STR(str708, "(getopts argv: %s)");
GLOBAL_STR(str709, " ");
GLOBAL_STR(str710, "?");
GLOBAL_STR(str711, "");
GLOBAL_STR(str712, "requires an argspec");
GLOBAL_STR(str713, "requires the name of a variable to set");
GLOBAL_STR(str714, "got invalid variable name %r");
GLOBAL_STR(str715, "echo");
GLOBAL_STR(str716, "");
GLOBAL_STR(str717, "takes at most one arg when simple_echo is on (hint: add quotes)");
GLOBAL_STR(str718, " ");
GLOBAL_STR(str719, "\n");
GLOBAL_STR(str720, "module");
GLOBAL_STR(str721, "requires a name");
GLOBAL_STR(str722, "[oil -i] Reloading module %r");
GLOBAL_STR(str723, "expected 'bin' or 'dialect'");
GLOBAL_STR(str724, "dialect");
GLOBAL_STR(str725, "expected dialect name");
GLOBAL_STR(str726, "_DIALECT");
GLOBAL_STR(str727, "Expected dialect %r, got %r");
GLOBAL_STR(str728, "Expected dialect %r");
GLOBAL_STR(str729, "bin");
GLOBAL_STR(str730, "bin %s");
GLOBAL_STR(str731, "expected 'bin' or 'dialect'");
GLOBAL_STR(str732, "shvar");
GLOBAL_STR(str733, "expected a block");
GLOBAL_STR(str734, "Expected name=value");
GLOBAL_STR(str735, "=");
GLOBAL_STR(str736, "Expected name=value");
GLOBAL_STR(str737, "expected a block");
GLOBAL_STR(str738, "Assignment builtin %r not configured");
GLOBAL_STR(str739, "%r ");
GLOBAL_STR(str740, "");
GLOBAL_STR(str741, "command in ");
GLOBAL_STR(str742, "assignment in ");
GLOBAL_STR(str743, "subshell invoked from ");
GLOBAL_STR(str744, "pipeline invoked from ");
GLOBAL_STR(str745, "");
GLOBAL_STR(str746, "Exiting with status %d (%sPID %d)");
GLOBAL_STR(str747, "Redirect filename can't be empty");
GLOBAL_STR(str748, "Redirect descriptor can't be empty");
GLOBAL_STR(str749, "-");
GLOBAL_STR(str750, "-");
GLOBAL_STR(str751, "Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
GLOBAL_STR(str752, "\n");
GLOBAL_STR(str753, "Unknown redirect op");
GLOBAL_STR(str754, "Unknown redirect type");
GLOBAL_STR(str755, "strict_errexit only allows simple commands (got %s). Hint: use 'try'.");
GLOBAL_STR(str756, "strict_errexit only allows a single command.  Hint: use \"run\".");
GLOBAL_STR(str757, "strict_errexit only allows simple commands (got %s). Hint: use 'try'.");
GLOBAL_STR(str758, "ShAssignment builtins don't accept blocks");
GLOBAL_STR(str759, "|& isn't supported");
GLOBAL_STR(str760, "Can't append array to string");
GLOBAL_STR(str761, "Can't append string to array");
GLOBAL_STR(str762, "%r expected a number, got %r");
GLOBAL_STR(str763, "Invalid control flow at top level");
GLOBAL_STR(str764, "warning: ");
GLOBAL_STR(str765, "Function %s was already defined (redefine_proc)");
GLOBAL_STR(str766, "Proc %s was already defined (redefine_proc)");
GLOBAL_STR(str767, "trap");
GLOBAL_STR(str768, "Loop and control flow can't be in different processes");
GLOBAL_STR(str769, "fatal: ");
GLOBAL_STR(str770, "EXIT");
GLOBAL_STR(str771, "trap EXIT");
GLOBAL_STR(str772, "__");
GLOBAL_STR(str773, ":");
GLOBAL_STR(str774, "Invalid argument %r.  Expected a name starting with :");
GLOBAL_STR(str775, "No value provided for param %r");
GLOBAL_STR(str776, "proc %r expected %d arguments, but got %d");
GLOBAL_STR(str777, "Unexpected %r (in function call)");
GLOBAL_STR(str778, "Attempted to exit from completion hook.");
GLOBAL_STR(str779, "Couldn't find terminator for here doc that starts here");
GLOBAL_STR(str780, "\t");
GLOBAL_STR(str781, "Invalid here doc delimiter");
GLOBAL_STR(str782, "+");
GLOBAL_STR(str783, "+");
GLOBAL_STR(str784, "+");
GLOBAL_STR(str785, "%d != %d");
GLOBAL_STR(str786, "array place");
GLOBAL_STR(str787, "Environment binding shouldn't look like an array assignment");
GLOBAL_STR(str788, "+");
GLOBAL_STR(str789, "Expected = in environment binding, got +=");
GLOBAL_STR(str790, "Environment bindings can't contain array literals");
GLOBAL_STR(str791, "procs and shell functions can't be nested");
GLOBAL_STR(str792, "%r was already declared");
GLOBAL_STR(str793, "%r hasn't been declared");
GLOBAL_STR(str794, "Can't modify constant %r");
GLOBAL_STR(str795, "Expected word type %s, got %s");
GLOBAL_STR(str796, "{");
GLOBAL_STR(str797, "}");
GLOBAL_STR(str798, "Invalid token after redirect operator");
GLOBAL_STR(str799, "TODO: Parse Redirect");
GLOBAL_STR(str800, " ");
GLOBAL_STR(str801, " ");
GLOBAL_STR(str802, "line IDs %d != %d");
GLOBAL_STR(str803, " ");
GLOBAL_STR(str804, "");
GLOBAL_STR(str805, "Unexpected block");
GLOBAL_STR(str806, "=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
GLOBAL_STR(str807, "name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
GLOBAL_STR(str808, "Unexpected block");
GLOBAL_STR(str809, "Unexpected block");
GLOBAL_STR(str810, "Control flow shouldn't have redirects");
GLOBAL_STR(str811, "Control flow shouldn't have environment bindings");
GLOBAL_STR(str812, "Unexpected argument to %r");
GLOBAL_STR(str813, "Invalid word in for loop");
GLOBAL_STR(str814, "Invalid word after for expression");
GLOBAL_STR(str815, "Loop variable name should be a constant");
GLOBAL_STR(str816, "Invalid loop variable name");
GLOBAL_STR(str817, "Unexpected word after for loop variable");
GLOBAL_STR(str818, "Expected ;; or esac");
GLOBAL_STR(str819, "Unexpected word while parsing compound command");
GLOBAL_STR(str820, "Invalid function name");
GLOBAL_STR(str821, "Expected ) in function definition");
GLOBAL_STR(str822, "Invalid KSH-style function name");
GLOBAL_STR(str823, "Unexpected word when parsing command");
GLOBAL_STR(str824, "Unexpected right brace");
GLOBAL_STR(str825, "Unexpected EOF while parsing command");
GLOBAL_STR(str826, "Invalid word while parsing command");
GLOBAL_STR(str827, "Unexpected word while parsing command line");
GLOBAL_STR(str828, "Unterminated here doc began here");
GLOBAL_STR(str829, "\\");
GLOBAL_STR(str830, "*");
GLOBAL_STR(str831, "?");
GLOBAL_STR(str832, "[");
...
GLOBAL_STR(str836, "\\?*+{}^$.()|");
GLOBAL_STR(str837, "\\");
GLOBAL_STR(str838, "Unexpected escaped character %r");
GLOBAL_STR(str839, "");
GLOBAL_STR(str840, "");
GLOBAL_STR(str841, "Malformed character class; treating as literal");
GLOBAL_STR(str842, "Got unescaped right bracket");
GLOBAL_STR(str843, "Got unescaped trailing backslash");
GLOBAL_STR(str844, ".|^$()+*?[]{}\\");
GLOBAL_STR(str845, "\\");
GLOBAL_STR(str846, "\\");
GLOBAL_STR(str847, "\\[");
...
GLOBAL_STR(str859, "]");
GLOBAL_STR(str860, "");
GLOBAL_STR(str861, "Error expanding glob %r: %s");
GLOBAL_STR(str862, "-");
GLOBAL_STR(str863, "<Error: unbalanced \\[ and \\]> ");
GLOBAL_STR(str864, "$");
GLOBAL_STR(str865, "#");
GLOBAL_STR(str866, "$");
GLOBAL_STR(str867, "hostname");
GLOBAL_STR(str868, "user");
GLOBAL_STR(str869, "$ ");
GLOBAL_STR(str870, "\u0001");
GLOBAL_STR(str871, "\u0002");
GLOBAL_STR(str872, "$");
GLOBAL_STR(str873, "$");
GLOBAL_STR(str874, "u");
GLOBAL_STR(str875, "user");
GLOBAL_STR(str876, "h");
GLOBAL_STR(str877, "hostname");
GLOBAL_STR(str878, ".");
GLOBAL_STR(str879, "H");
GLOBAL_STR(str880, "hostname");
GLOBAL_STR(str881, "w");
GLOBAL_STR(str882, "PWD");
GLOBAL_STR(str883, "HOME");
GLOBAL_STR(str884, "<Error: %s>");
GLOBAL_STR(str885, "W");
GLOBAL_STR(str886, "PWD");
GLOBAL_STR(str887, "<Error: PWD is not a string> ");
GLOBAL_STR(str888, "<Error: \\%s not implemented in $PS1> ");
GLOBAL_STR(str889, "$");
GLOBAL_STR(str890, "\\$");
GLOBAL_STR(str891, "Invalid token %r");
GLOBAL_STR(str892, "");
GLOBAL_STR(str893, "<ERROR: Can't parse PS1: %s>");
GLOBAL_STR(str894, "osh");
GLOBAL_STR(str895, "PS1");
GLOBAL_STR(str896, "PROMPT_COMMAND");
GLOBAL_STR(str897, "Undefined variable %r");
GLOBAL_STR(str898, "Can't use [] on value of type %s");
GLOBAL_STR(str899, "");
GLOBAL_STR(str900, "Can't use [] on value of type %s");
GLOBAL_STR(str901, "");
GLOBAL_STR(str902, "dynamic place");
...
GLOBAL_STR(str1045, "|");
GLOBAL_STR(str1046, ")");
GLOBAL_STR(str1047, "Extended globs and arrays can't appear in the same word");
GLOBAL_STR(str1048, "*");
GLOBAL_STR(str1049, "Unexpected array literal");
GLOBAL_STR(str1050, "Unexpected associative array literal");
GLOBAL_STR(str1051, "Can't splice %r");
GLOBAL_STR(str1052, "");
GLOBAL_STR(str1053, "");
GLOBAL_STR(str1054, "Extended glob not allowed in this word");
GLOBAL_STR(str1055, "");
GLOBAL_STR(str1056, "This word should yield a string, but it contains an array");
GLOBAL_STR(str1057, " ");
GLOBAL_STR(str1058, "extended glob not allowed in this word");
GLOBAL_STR(str1059, "");
GLOBAL_STR(str1060, "");
GLOBAL_STR(str1061, "<Runtime error: %s>");
GLOBAL_STR(str1062, "<I/O error: %s>");
GLOBAL_STR(str1063, "<Ctrl-C>");
GLOBAL_STR(str1064, "");
GLOBAL_STR(str1065, "");
GLOBAL_STR(str1066, "");
GLOBAL_STR(str1067, "");
GLOBAL_STR(str1068, "");
GLOBAL_STR(str1069, "LHS array not allowed in assignment builtin");
GLOBAL_STR(str1070, "+");
GLOBAL_STR(str1071, "+= not allowed in assignment builtin");
GLOBAL_STR(str1072, "-");
GLOBAL_STR(str1073, "+");
GLOBAL_STR(str1074, "f");
GLOBAL_STR(str1075, "F");
GLOBAL_STR(str1076, "");
GLOBAL_STR(str1077, "=");
GLOBAL_STR(str1078, "Invalid variable name %r");
GLOBAL_STR(str1079, "__NO_COMMAND_SUB__");
GLOBAL_STR(str1080, "__NO_PROCESS_SUB__");
GLOBAL_STR(str1081, "Expected : or } in slice");
GLOBAL_STR(str1082, "Pattern in ${x/pat/replace} must not be empty");
GLOBAL_STR(str1083, "Expected } after replacement string, got %s");
GLOBAL_STR(str1084, "Expected } or / to close pattern");
GLOBAL_STR(str1085, "Expected ] to close subscript");
GLOBAL_STR(str1086, "Expected } to close ${");
GLOBAL_STR(str1087, "Expected } to close ${");
GLOBAL_STR(str1088, "Expected a constant argument");
GLOBAL_STR(str1089, "Expected } to close ${");
GLOBAL_STR(str1090, "Expected } to close ${");
GLOBAL_STR(str1091, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1092, "VOp2");
GLOBAL_STR(str1093, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1094, "VOp3");
GLOBAL_STR(str1095, "Expected } to close ${");
GLOBAL_STR(str1096, "Expected } after length expression");
GLOBAL_STR(str1097, "TODO: ${.myproc builtin sub}");
GLOBAL_STR(str1098, "Unexpected token in ${}");
GLOBAL_STR(str1099, "\\");
GLOBAL_STR(str1100, "Strings with backslashes should look like r'\\n' or $'\\n'");
GLOBAL_STR(str1101, "Use \\xhh or \\u{...} instead of octal escapes in Oil strings");
GLOBAL_STR(str1102, "Invalid hex escape in Oil string (must be \\xHH)");
GLOBAL_STR(str1103, "Invalid char escape in C-style string literal");
GLOBAL_STR(str1104, "Unexpected EOF in single-quoted string that began here");
GLOBAL_STR(str1105, "\"");
GLOBAL_STR(str1106, "'");
GLOBAL_STR(str1107, "Unexpected EOF reading extended glob that began here");
GLOBAL_STR(str1108, "Invalid char escape in double quoted string");
GLOBAL_STR(str1109, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1110, "Invalid backtick: use $(cmd) or \\` in Oil strings");
GLOBAL_STR(str1111, "Unexpected EOF reading double-quoted string that began here");
GLOBAL_STR(str1112, "Use $(cmd) instead of backticks (parse_backticks)");
GLOBAL_STR(str1113, "Unexpected EOF while looking for closing backtick");
GLOBAL_STR(str1114, "");
GLOBAL_STR(str1115, "backticks");
GLOBAL_STR(str1116, "Invalid proc name %s");
GLOBAL_STR(str1117, "Unexpected token after arithmetic expression (%s != %s)");
GLOBAL_STR(str1118, "Expected second ) to end arith sub");
GLOBAL_STR(str1119, "Expected second ) to end arith statement");
GLOBAL_STR(str1120, "Expected ; here");
GLOBAL_STR(str1121, "Expected ; here");
GLOBAL_STR(str1122, "Expected ) to end for loop expression");
GLOBAL_STR(str1123, "Expected ( after =");
GLOBAL_STR(str1124, "Unexpected token in array literal");
GLOBAL_STR(str1125, "Expected associative array pair");
GLOBAL_STR(str1126, "Invalid char escape (parse_backslash)");
GLOBAL_STR(str1127, "Unexpected token after array literal");
GLOBAL_STR(str1128, "Unexpected token after array splice");
GLOBAL_STR(str1129, "TODO: @{.myproc builtin sub}");
GLOBAL_STR(str1130, "Literal @ starting a word must be quoted (parse_at_all)");
GLOBAL_STR(str1131, "/");
GLOBAL_STR(str1132, "next_byte %r");
GLOBAL_STR(str1133, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1134, "Unexpected token after @()");
GLOBAL_STR(str1135, "Word has unbalanced { }.  Maybe add a space or quote it like \\{");
GLOBAL_STR(str1136, "Unexpected parts after triple quoted string");
GLOBAL_STR(str1137, "Unexpected token while parsing arithmetic: %r");
GLOBAL_STR(str1138, "Invalid blank line in multiline mode");
GLOBAL_STR(str1139, "r");
GLOBAL_STR(str1140, "Unhandled: %s (%s)");
GLOBAL_STR(str1141, "Invalid var ref");
GLOBAL_STR(str1142, "Expected end of var ref");
GLOBAL_STR(str1143, "Invalid lex state %s");
GLOBAL_STR(str1144, "");
GLOBAL_STR(str1145, "");
GLOBAL_STR(str1146, "");
GLOBAL_STR(str1147, "");
...
GLOBAL_STR(str1151, "");
GLOBAL_STR(str1152, "");
GLOBAL_STR(str1153, "Compound shouldn't be empty");
GLOBAL_STR(str1154, "/");
GLOBAL_STR(str1155, "/");
GLOBAL_STR(str1156, "");
GLOBAL_STR(str1157, "EOF");
GLOBAL_STR(str1158, "typ");
GLOBAL_STR(str1159, "tok");
GLOBAL_STR(str1160, "children");
GLOBAL_STR(str1161, "-");
GLOBAL_STR(str1162, "with %d children");
GLOBAL_STR(str1163, "");
GLOBAL_STR(str1164, "(PNode %s %s %s)");
GLOBAL_STR(str1165, "&");
GLOBAL_STR(str1166, "&amp;");
GLOBAL_STR(str1167, "<");
GLOBAL_STR(str1168, "&lt;");
...
GLOBAL_STR(str1190, "/");
GLOBAL_STR(str1191, " \n\r\t");
GLOBAL_STR(str1192, "Unexpected token in QSN string");
GLOBAL_STR(str1193, "Expected closing single quote in QSN string");
GLOBAL_STR(str1194, "Unexpected data after closing quote");
GLOBAL_STR(str1195, "Unexpected token after QSN string");
GLOBAL_STR(str1196, "\\'\r\n\t\u0000");
GLOBAL_STR(str1197, "$'");
GLOBAL_STR(str1198, "'");
GLOBAL_STR(str1199, "'");
...
GLOBAL_STR(str1211, "\n");
GLOBAL_STR(str1212, "\\n");
GLOBAL_STR(str1213, "\r");
GLOBAL_STR(str1214, "\\r");
GLOBAL_STR(str1215, "\t");
GLOBAL_STR(str1216, "\\t");
GLOBAL_STR(str1217, "\u0000");
GLOBAL_STR(str1218, "\\x00");
GLOBAL_STR(str1219, "\\0");
GLOBAL_STR(str1220, "");
GLOBAL_STR(str1221, "");
GLOBAL_STR(str1222, "");
GLOBAL_STR(str1223, "\\");
...
GLOBAL_STR(str1227, "\n");
GLOBAL_STR(str1228, "\\n");
GLOBAL_STR(str1229, "\r");
GLOBAL_STR(str1230, "\\r");
GLOBAL_STR(str1231, "\t");
GLOBAL_STR(str1232, "\\t");
GLOBAL_STR(str1233, "\u0000");
GLOBAL_STR(str1234, "\\x00");
GLOBAL_STR(str1235, "\\0");
GLOBAL_STR(str1236, "");
GLOBAL_STR(str1237, "!");
GLOBAL_STR(str1238, "--");
GLOBAL_STR(str1239, "--dir");
GLOBAL_STR(str1240, "--exists");
GLOBAL_STR(str1241, "--file");
GLOBAL_STR(str1242, "--symlink");
GLOBAL_STR(str1243, "Expected unary operator, got %r (2 args)");
GLOBAL_STR(str1244, "-a");
GLOBAL_STR(str1245, "-o");
GLOBAL_STR(str1246, "!");
GLOBAL_STR(str1247, "(");
GLOBAL_STR(str1248, ")");
GLOBAL_STR(str1249, "Expected binary operator, got %r (3 args)");
GLOBAL_STR(str1250, "should be invoked as 'test' (simple_test_builtin)");
GLOBAL_STR(str1251, "]");
GLOBAL_STR(str1252, "missing closing ]");
GLOBAL_STR(str1253, "should only have 3 arguments or fewer (simple_test_builtin)");
GLOBAL_STR(str1254, "!");
GLOBAL_STR(str1255, "(");
GLOBAL_STR(str1256, ")");
GLOBAL_STR(str1257, "(test) ");
GLOBAL_STR(str1258, "(test) ");
...
inline Str* fmt82(Str* a0, int a1, Str* a2) {
  gBuf.reset();
  gBuf.write_const("[ ", 2);
  gBuf.format_s(a0);
...
inline Str* fmt86(Str* a0, int a1, Str* a2, Str* a3) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const(":", 1);
  gBuf.format_d(a1);
...
inline Str* fmt104(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("-", 1);
  gBuf.format_s(a1);
...
inline Str* fmt123(int a0, int a1) {
  gBuf.reset();
...
inline Str* fmt144(int a0, Str* a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const("  ", 2);
  gBuf.format_s(a1);
...
inline Str* fmt175(int a0, Str* a1, int a2) {
  gBuf.reset();
...
inline Str* fmt187(Str* a0, int a1, int a2) {
  gBuf.reset();
  gBuf.write_const("proc ", 5);
  gBuf.format_r(a0);
...
inline Str* fmt191(int a0, int a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const(" != ", 4);
  gBuf.format_d(a1);
...
inline Str* fmt199(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt227(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt241(Str* a0, int a1) {
  gBuf.reset();
...
inline Str* fmt253(Str* a0, Str* a1, syntax_asdl::word_t* a2) {
  gBuf.reset();
...
inline Str* fmt259(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt263(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt324(Str* a0, Str* a1) {
  gBuf.reset();
...
runtime_asdl::cmd_value__Argv* MakeBuiltinArgv(List<Str*>* argv1) {
  ...
  argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str195});
  argv->extend(argv1);
  return Alloc<cmd_value::Argv>(argv, list_repeat(runtime::NO_SPID, len(argv)), nullptr);
}
...
int Main(Str* lang, args::Reader* arg_r, Dict<Str*, Str*>* environ, bool login_shell, pyutil::_ResourceLoader* loader, void* line_input) {
  ...
  arg_r->Next();
  try {
    attrs = flag_spec::ParseMore(str196, arg_r);
  }
  catch (error::Usage* e) {
  ...
  if (flag->version) {
    pyutil::ShowAppVersion(str199, loader);
    return 0;
  }
  no_str = nullptr;
  debug_stack = Alloc<List<state::DebugFrame*>>();
  if (arg_r->AtEnd()) {
    ...
    dollar0 = arg_r->Peek();
    frame0 = Alloc<state::DebugFrame>(dollar0, str200, no_str, state::LINE_ZERO, 0, 0);
    debug_stack->append(frame0);
  }
  frame1 = Alloc<state::DebugFrame>(no_str, no_str, no_str, runtime::NO_SPID, 0, 0);
  debug_stack->append(frame1);
  ...
  if (str_equals(lang, str201)) {
    mutable_opts->SetShoptOption(str202, true);
  }
  builtin_pure::SetShellOpts(mutable_opts, attrs->opt_changes, attrs->shopt_changes);
  aliases = Alloc<Dict<Str*, Str*>>();
  oil_grammar = nullptr;
  ...
  parse_ctx->Init_OnePassParse(flag->one_pass_parse);
  comp_arena = Alloc<alloc::Arena>();
  comp_arena->PushSource(Alloc<source::Unused>(str204));
  trail1 = Alloc<parse_lib::Trail>();
  comp_ctx = Alloc<parse_lib::ParseContext>(comp_arena, parse_opts, aliases, oil_grammar);
  comp_ctx->Init_Trail(trail1);
  comp_ctx->Init_OnePassParse(true);
  hist_arena = Alloc<alloc::Arena>();
  hist_arena->PushSource(Alloc<source::Unused>(str205));
  trail2 = Alloc<parse_lib::Trail>();
  hist_ctx = Alloc<parse_lib::ParseContext>(hist_arena, parse_opts, aliases, oil_grammar);
  hist_ctx->Init_Trail(trail2);
  cmd_deps = Alloc<cmd_eval::Deps>();
  ...
  waiter = Alloc<process::Waiter>(job_state, exec_opts, sig_state, tracer);
  fd_state->waiter = waiter;
  interp = environ->get(str210, str211);
  search_path = Alloc<state::SearchPath>(mem);
  ext_prog = Alloc<process::ExternalProgram>(interp, fd_state, errfmt, debug_f);
  splitter = Alloc<split::SplitContext>(mem);
  crash_dump_dir = environ->get(str212, str213);
  cmd_deps->dumper = Alloc<dev::CrashDumper>(crash_dump_dir);
  dir_stack = Alloc<state::DirStack>();
  builtins = Alloc<Dict<int, vm::_Builtin*>>();
  modules = Alloc<Dict<Str*, bool>>();
  ...
  if (flag->c != nullptr) {
    ...
    if (flag->i) {
      ...
      if (script_name == nullptr) {
        stdin = mylib::Stdin();
        arena->PushSource(Alloc<source::Stdin>(str214));
        line_reader = Alloc<reader::FileLineReader>(stdin, arena);
      }
      else {
        arena->PushSource(Alloc<source::MainFile>(script_name));
...
Str* SearchPath::Lookup(Str* name, bool exec_required) {
  ...
  val = this->mem->GetValue(str221);
  UP_val = val;
  if (val->tag_() == value_e::Str) {
    value__Str* val = static_cast<value__Str*>(UP_val);
    path_list = val->s->split(str222);
  }
  else {
...
void MutableOpts::Init() {
  ...
  UP_shellopts = this->mem->GetValue(str226);
...
void MutableOpts::SetOption(Str* opt_name, bool b) {
  ...
  UP_val = this->mem->GetValue(str230);
  value__Str* val = static_cast<value__Str*>(UP_val);
  shellopts = val->s;
  if (b) {
    if (!str_contains(shellopts, opt_name)) {
      new_val = Alloc<value::Str>(fmt61(shellopts, opt_name));
      this->mem->InternalSetGlobal(str232, new_val);
    }
  }
  else {
    if (str_contains(shellopts, opt_name)) {
      names = Alloc<List<Str*>>();
      for (ListIter<Str*> it(shellopts->split(str233)); !it.Done(); it.Next()) {
        Str* n = it.Value();
        if (!(str_equals(n, opt_name))) {
          names->append(n);
        }
      }
      new_val = Alloc<value::Str>(str234->join(names));
      this->mem->InternalSetGlobal(str235, new_val);
    }
  }
}
...
void MutableOpts::SetShoptOption(Str* opt_name, bool b) {
  ...
  if (str_equals(opt_name, str236)) {
    this->_SetGroup(consts::OIL_BASIC, b);
    this->SetDeferredErrExit(b);
    return ;
  }
  if (str_equals(opt_name, str237)) {
    this->_SetGroup(consts::OIL_ALL, b);
    this->SetDeferredErrExit(b);
    return ;
  }
  if (str_equals(opt_name, str238)) {
...
void MutableOpts::ShowOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    b = this->Get(opt_num);
    print(fmt62(b ? str240 : str241, opt_name));
  }
}
...
void MutableOpts::ShowShoptOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    if (str_equals(opt_name, str242)) {
      ...
      if (str_equals(opt_name, str243)) {
        opt_nums->extend(consts::OIL_ALL);
      }
      else {
        if (str_equals(opt_name, str244)) {
  ...
  for (ListIter<int> it(opt_nums); !it.Done(); it.Next()) {
    ...
    print(fmt64(b ? str247 : str248, consts::OptionName(opt_num)));
  }
}
...
void _InitDefaults(state::Mem* mem) {
  ...
  SetGlobalString(mem, str251, split::DEFAULT_IFS);
  SetGlobalString(mem, str252, str(posix::getuid()));
  SetGlobalString(mem, str253, str(posix::geteuid()));
  SetGlobalString(mem, str254, str(posix::getppid()));
  SetGlobalString(mem, str255, libc::gethostname());
  SetGlobalString(mem, str256, pyos::OsType());
  SetGlobalString(mem, str257, str258);
  SetGlobalString(mem, str259, str260);
  SetGlobalString(mem, str261, _READLINE_DELIMS);
}
...
void _InitVarsFromEnv(state::Mem* mem, Dict<Str*, Str*>* environ) {
  ...
  val = mem->GetValue(str262);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str263, str264);
  }
  mem->SetValue(Alloc<lvalue::Named>(str265), nullptr, scope_e::GlobalOnly, SetReadOnly);
  val = mem->GetValue(str266);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str267, _GetWorkingDir());
  }
  mem->SetValue(Alloc<lvalue::Named>(str268), nullptr, scope_e::GlobalOnly, SetExport);
}
...
void InitMem(state::Mem* mem, Dict<Str*, Str*>* environ, Str* version_str) {
  ...
  SetGlobalString(mem, str269, version_str);
  _InitDefaults(mem);
...
Mem::Mem(Str* dollar0, List<Str*>* argv, alloc::Arena* arena, List<state::DebugFrame*>* debug_stack) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Mem)) {
  ...
  this->line_num = Alloc<value::Str>(str271);
...
Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> Mem::_ResolveNameOrRef(Str* name, runtime_asdl::scope_t which_scopes, bool is_setref, List<Str*>* ref_trail) {
  ...
  if (ref_trail == nullptr) {
    ...
    if (list_contains(ref_trail, new_name)) {
      e_die(fmt68(str283->join(ref_trail)));
    }
  }
  ...
  switch (lval->tag_()) {
    case lvalue_e::Named: {
      ...
      if (keyword_id == Id::KW_SetRef) {
        lval->name = str_concat(str284, lval->name);
      }
...
runtime_asdl::value_t* Mem::GetValue(Str* name, runtime_asdl::scope_t which_scopes) {
  ...
  if ((str_equals(name, str295) || str_equals(name, str296))) {
...
Str* PrettyDir(Str* dir_name, Str* home_dir) {
  ...
  if (home_dir != nullptr) {
    if ((str_equals(dir_name, home_dir) or dir_name->startswith(str_concat(home_dir, str313)))) {
      return str_concat(str314, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    StackRoots _for({&c  });
    f->write(str_equals(c, str317) ? str318 : str319);
  }
  f->write(str320);
  f->write(str_repeat(str321, (length - 1)));
  f->write(str322);
}
  ...
  switch (src->tag_()) {
    ...
    case source_e::ArgvWord: {
      ...
      if (src->span_id == runtime::NO_SPID) {
        ...
        s = fmt82(src->what, line_num, outer_source);
      }
    }
      break;
    case source_e::Variable: {
      source__Variable* src = static_cast<source__Variable*>(UP_src);
      var_name = src->var_name != nullptr ? src->var_name : str329;
      s = fmt83(var_name);
    }
      break;
    case source_e::Alias: {
...
void _PrintWithSpanId(Str* prefix, Str* msg, int span_id, alloc::Arena* arena, mylib::Writer* f) {
  ...
  f->write(fmt86(source_str, line_num, prefix, msg));
}
...
void PrettyPrintError(error::_ErrorWithLocation* err, alloc::Arena* arena) {
  PrettyPrintError(err, arena, str335);
}
...
void ErrorFormatter::Print_(Str* msg, int span_id) {
  ...
  _PrintWithOptionalSpanId(str336, msg, span_id, this->arena);
}
...
void PrintAst(syntax_asdl::command_t* node, arg_types::main* flag) {
  ...
  if (maybe_str_equals(flag->ast_format, str338)) {
    println_stderr(str339);
  }
  else {
    f = mylib::Stdout();
    ...
    if ((maybe_str_equals(afmt, str340) || maybe_str_equals(afmt, str341))) {
      ...
      if ((maybe_str_equals(afmt, str342) || maybe_str_equals(afmt, str343))) {
...
void _Attributes::Set(Str* name, runtime_asdl::value_t* val) {
  ...
  name = name->replace(str347, str348);
...
bool SetAttachedBool::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  if (attached_arg != nullptr) {
    if ((str_equals(attached_arg, str364) || str_equals(attached_arg, str365) || str_equals(attached_arg, str366) || str_equals(attached_arg, str367))) {
      b = false;
    }
    else {
...
bool SetOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str373);
...
bool SetNamedOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str374);
  arg_r->Next();
  arg = arg_r->Peek();
  if (arg == nullptr) {
...
args::_Attributes* Parse(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str378)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if ((len(spec->actions_long) and arg->startswith(str379))) {
      ...
      if ((arg->startswith(str381) and len(arg) > 1)) {
        n = len(arg);
        for (int i = 1; i < n; ++i) {
          ch = arg->index(i);
          if (str_equals(ch, str382)) {
            ch = str383;
          }
          if (list_contains(spec->plus_flags, ch)) {
            out->Set(ch, Alloc<value::Str>(str384));
            continue;
          }
        ...
        if ((len(spec->plus_flags) and (arg->startswith(str387) and len(arg) > 1))) {
          n = len(arg);
          for (int i = 1; i < n; ++i) {
            ch = arg->index(i);
            if (list_contains(spec->plus_flags, ch)) {
...
args::_Attributes* ParseLikeEcho(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    chars = arg->slice(1);
    if ((arg->startswith(str391) and len(chars))) {
      done = false;
...
args::_Attributes* ParseMore(flag_spec::_FlagSpecAndMore* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str392)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if (arg->startswith(str393)) {
      action = spec->actions_long->get(arg->slice(2));
      if (action == nullptr) {
        e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
      }
    ...
    if (((arg->startswith(str395) or arg->startswith(str396)) and len(arg) > 1)) {
      char0 = arg->index(0);
...
int LineLexer::GetSpanIdForEof() {
  int line_id;
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str401, 0);
  }
  else {
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str403, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = Alloc<Token>(id_, span_id, str404);
      return t;
    }
...
lexer::Lexer* ParseContext::MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = Alloc<lexer::LineLexer>(str406, this->arena);
...
int _Classify(grammar::Grammar* gr, syntax_asdl::Token* tok) {
  ...
  type_str = tok->id == Id::Unknown_Tok ? str410 : fmt93(ui::PrettyId(tok->id));
  p_die(fmt94(type_str), tok);
}
...
Tuple2<pnode::PNode*, syntax_asdl::Token*> ExprParser::Parse(lexer::Lexer* lexer, int start_symbol) {
  ...
  try {
    ...
    p_die(fmt95(ui::PrettyId(e->tok->id)), e->tok);
  }
...
GLOBAL_LIST(Str*, 12, POSIX_CLASSES, {str414 COMMA str415 COMMA str416 COMMA str417 COMMA str418 COMMA str419 COMMA str420 COMMA str421 COMMA str422 COMMA str423 COMMA str424 COMMA str425});
Str* RANGE_POINT_TOO_LONG = str426;
int NT_OFFSET = 256;
...
syntax_asdl::expr_t* Transformer::_Tuple(List<pnode::PNode*>* children) {
  ...
  if (n == 2) {
    p_die(fmt96(), children->index(1)->tok);
  }
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw Alloc<NotImplementedError>(str428);
  }
  if (id0 == Id::Op_LBracket) {
    elts = Alloc<List<syntax_asdl::expr_t*>>();
    for (int i = 0; i < n; i += 2) {
  ...
  for (int i = 0; i < n; i += 2) {
    ...
    if (tag == expr_e::Var) {
      ...
      if ((tag == place_expr_e::Var || tag == place_expr_e::Subscript || tag == place_expr_e::Attribute)) {
        ...
        p_die(fmt98(), p->tok ? p->tok : nullptr);
      }
    }
  }
  return places;
...
syntax_asdl::re_t* Transformer::_NameInRegex(syntax_asdl::Token* negated_tok, syntax_asdl::Token* tok) {
  ...
  val = tok->val;
  if (maybe_str_equals(val, str434)) {
    if (negated_tok) {
      p_die(fmt99(), tok);
    }
    return tok;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((str_equals(tok->val, str439) || str_equals(tok->val, str440) || str_equals(tok->val, str441))) {
        return tok;
      }
      p_die(fmt103(tok->val), tok);
    }
...
void _ClassLiteralToPosixEre(syntax_asdl::class_literal_term_t* term, List<Str*>* parts) {
  ...
  if (tag == class_literal_term_e::CodePoint) {
    ...
    if (code_point < 128) {
      ...
      e_die(fmt105(code_point), term->spid);
    }
    return ;
  }
  ...
  if (tag == class_literal_term_e::PosixClass) {
    ...
    n = term->name;
    if (term->negated) {
      e_die(fmt108(), term->negated->span_id);
    }
    else {
      pat = fmt109(n);
    }
...
void AsPosixEre(syntax_asdl::re_t* node, List<Str*>* parts) {
  ...
  if (tag == re_e::Repeat) {
    ...
    if (op_tag == re_repeat_e::Num) {
      ...
      parts->append(fmt111(op->times->val));
      return ;
    }
    if (op_tag == re_repeat_e::Range) {
      re_repeat__Range* op = static_cast<re_repeat__Range*>(UP_op);
      lower = op->lower ? op->lower->val : str458;
      upper = op->upper ? op->upper->val : str459;
      parts->append(fmt112(lower, upper));
      return ;
    }
...
syntax_asdl::bool_expr_t* BoolParser::ParseFactor() {
  ...
  if (this->bool_id == Id::Op_LParen) {
    ...
    if (this->bool_id != Id::Op_RParen) {
      p_die(fmt121(word_::Pretty(this->cur_word)), this->cur_word);
    }
    this->_Next();
    return node;
  }
  p_die(fmt122(ui::PrettyId(this->bool_id)), this->cur_word);
}
...
Str* _RangeParser::_Eat(int token_type) {
  ...
  if (this->token_type != token_type) {
    throw Alloc<_NotARange>(fmt123(token_type, this->token_type));
  }
  val = this->token_val;
  this->_Next();
  return val;
  ...
  if (this->token_type == Id::Range_Int) {
    ...
    if (this->token_type == Id::Range_Char) {
      ...
      if (start_num < end_num) {
        ...
        if (part->step <= 0) {
          p_die(fmt127(part->step), this->span_id);
        }
      }
      else {
        if (start_num > end_num) {
          ...
          if (part->step >= 0) {
            p_die(fmt128(part->step), this->span_id);
          }
        }
        else {
          part->step = 1;
      ...
      if (upper1 != upper2) {
        p_die(fmt129(), this->span_id);
      }
    }
    else {
      throw Alloc<_NotARange>(str484);
    }
  }
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  flag = attrs->attrs;
  tmp_g = flag->get(str487);
  tmp_a = flag->get(str488);
  tmp_A = flag->get(str489);
  ...
  flag_A = (tmp_A and tmp_A->tag_() == value_e::Bool) ? static_cast<value__Bool*>(tmp_A)->b : false;
  tmp_n = flag->get(str490);
  tmp_r = flag->get(str491);
  tmp_x = flag->get(str492);
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if ((maybe_str_equals(flag_n, str494) and !cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_n, str495) and cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str496) and !cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str497) and cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str498) and !cell->exported)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str499) and cell->exported)) {
      continue;
    }
    ...
    if (print_flags) {
      ...
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str506, str507->join(flags), str508, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str509, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (has_holes) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str512, name, str513, str(i), str514, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str516, str517->join(body), str518}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str520, key_quoted, str521, value_quoted}));
          }
          if (len(body) > 0) {
            decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str522, str523->join(body), str524}));
          }
        }
        else {
          ;  // pass
...
int Export::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r->Next();
  attrs = flag_spec::Parse(str526, arg_r);
...
int Readonly::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str531, arg_r);
...
int NewVar::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str532, arg_r);
  ...
  flags = 0;
  if (maybe_str_equals(arg->x, str535)) {
    flags |= state::SetExport;
  }
  if (maybe_str_equals(arg->r, str536)) {
    flags |= state::SetReadOnly;
  }
  if (maybe_str_equals(arg->n, str537)) {
    flags |= state::SetNameref;
  }
  flags_to_clear = 0;
  if (maybe_str_equals(arg->x, str538)) {
    flags |= state::ClearExport;
  }
  if (maybe_str_equals(arg->r, str539)) {
    flags |= state::ClearReadOnly;
  }
  if (maybe_str_equals(arg->n, str540)) {
...
int Unset::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str541, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
...
int Eval::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str544, cmd_val);
  arg_r = tup0.at1();
  if (this->exec_opts->simple_eval_builtin()) {
    Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str545);
    code_str = tup1.at0();
    eval_spid = tup1.at1();
    if (!arg_r->AtEnd()) {
      e_usage(str546);
    ...
    code_str = str547->join(arg_r->Rest());
    eval_spid = cmd_val->arg_spids->index(0);
  }
  line_reader = reader::StringLineReader(code_str, this->arena);
  c_parser = this->parse_ctx->MakeOshParser(line_reader);
  src = Alloc<source::ArgvWord>(str548, eval_spid);
  {  // with
    dev::ctx_Tracer ctx(this->tracer, str549, nullptr);
...
int Source::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str550, cmd_val);
  arg_r = tup2.at1();
  path = arg_r->Peek();
  if (path == nullptr) {
    e_usage(str551);
  ...
  try {
    ...
    this->errfmt->Print_(fmt136(path, pyutil::strerror(e)), cmd_val->arg_spids->index(1));
    return 1;
  }
  try {
    try {
      ...
      c_parser = this->parse_ctx->MakeOshParser(line_reader);
      {  // with
        dev::ctx_Tracer ctx(this->tracer, str553, cmd_val->argv);
...
int Command::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup3 = flag_spec::ParseCmdVal(str554, cmd_val);
  attrs = tup3.at0();
  arg_r = tup3.at1();
...
int Builtin::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (to_run == consts::NO_INDEX) {
    ...
    if (consts::LookupAssignBuiltin(name) != consts::NO_INDEX) {
      this->errfmt->Print_(str555, span_id);
    }
    else {
      this->errfmt->Print_(fmt137(name), span_id);
    }
    return 1;
  }
...
int RunProc::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseOilCmdVal(str557, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
  ...
  spids = tup6.at1();
  if (len(argv) == 0) {
    throw Alloc<error::Usage>(str558, runtime::NO_SPID);
  }
  name = argv->index(0);
  if (!dict_contains(this->procs, name)) {
    this->errfmt->StderrLine(fmt138(name));
    return 1;
  }
...
int Try::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup7 = flag_spec::ParseOilCmdVal(str560, cmd_val);
  attrs = tup7.at0();
  arg_r = tup7.at1();
  ...
  if ((arg->allow_status_01 and (status != 0 && status != 1))) {
    if (failure_spid != runtime::NO_SPID) {
      this->errfmt->Print_(str562, failure_spid);
      this->errfmt->StderrLine(str563);
    }
    throw Alloc<error::ErrExit>(fmt140(status), spids->index(0), status);
  }
  if (arg->assign != nullptr) {
    var_name = arg->assign;
    if (var_name->startswith(str565)) {
...
List<Tuple2<Str*, Str*>*>* _ResolveNames(List<Str*>* names, Dict<Str*, runtime_asdl::Proc*>* funcs, Dict<Str*, Str*>* aliases, state::SearchPath* search_path) {
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if (dict_contains(funcs, name)) {
      kind = (Alloc<Tuple2<Str*, Str*>>(str566, name));
    }
    else {
      if (dict_contains(aliases, name)) {
        kind = (Alloc<Tuple2<Str*, Str*>>(str567, name));
      }
      else {
        if (consts::LookupNormalBuiltin(name) != 0) {
          kind = (Alloc<Tuple2<Str*, Str*>>(str568, name));
        }
        else {
              ...
              if (consts::IsControlFlow(name)) {
                ...
                if (consts::IsKeyword(name)) {
                  ...
                  if (resolved == nullptr) {
                    ...
                    kind = (Alloc<Tuple2<Str*, Str*>>(str573, resolved));
                  }
                }
              }
            }
...
int Type::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseCmdVal(str574, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  for (ListIter<Tuple2<Str*, Str*>*> it(r); !it.Done(); it.Next()) {
    ...
    name = tup10->at1();
    if (kind == nullptr) {
      this->errfmt->StderrLine(fmt141(name));
      status = 1;
    }
    else {
      if (arg->t) {
        ...
        if (arg->p) {
          if (str_equals(kind, str576)) {
            print(name);
          }
        }
        else {
          if (arg->P) {
            if (str_equals(kind, str577)) {
              print(name);
            }
            else {
...
Tuple2<Str*, bool> _ReadUntilDelim(Str* delim_char) {
  ...
  return (Tuple2<Str*, bool>(str580->join(chars), eof));
}
...
Str* _ReadLine() {
  ...
  while (true) {
    ...
    chars->append(c);
    if (str_equals(c, str581)) {
      break;
    }
  }
  return str582->join(chars);
}
...
int Read::_Line(arg_types::read* arg, Str* var_name) {
  ...
  if (!arg->with_eol) {
    if (line->endswith(str584)) {
      line = line->slice(0, -2);
    }
    else {
      if (line->endswith(str585)) {
        line = line->slice(0, -1);
      }
    }
  }
  if ((arg->q and line->startswith(str586))) {
    arena = this->parse_ctx->arena;
    line_reader = reader::StringLineReader(line, arena);
    lexer = this->parse_ctx->MakeLexer(line_reader);
    try {
      {  // with
        alloc::ctx_Location ctx(arena, Alloc<source::Stdin>(str587));
...
int Read::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str589, cmd_val);
  attrs = tup2.at0();
  arg_r = tup2.at1();
  ...
  if (arg->line) {
    ...
    next_spid = tup4.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str592, next_spid);
    }
  ...
  if (arg->all) {
    ...
    next_spid = tup6.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str596, next_spid);
    }
...
int MapFile::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseCmdVal(str607, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  while (true) {
    ...
    if ((arg->t and line->endswith(str610))) {
      line = line->slice(0, -1);
    }
    lines->append(line);
  }
...
int Cd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseCmdVal(str611, cmd_val);
  attrs = tup11.at0();
  arg_r = tup11.at1();
  ...
  arg_spid = tup12.at1();
  if (dest_dir == nullptr) {
    val = this->mem->GetValue(str612);
    try {
      dest_dir = state::GetString(this->mem, str613);
    }
    catch (error::Runtime* e) {
  ...
  try {
    pwd = state::GetString(this->mem, str616);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    return 1;
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt143(real_dest_dir, posix::strerror(err_num)), arg_spid);
    return 1;
  }
  state::ExportGlobalString(this->mem, str618, real_dest_dir);
  ...
  if (cmd_val->block) {
    ...
    state::ExportGlobalString(this->mem, str619, pwd);
...
void _PrintDirStack(state::DirStack* dir_stack, int style, Str* home_dir) {
  ...
  if (style == WITH_LINE_NUMBERS) {
    ...
    for (ListIter<Str*> it(dir_stack->Iter()); !it.Done(); it.Next(), ++i) {
      ...
      print(fmt144(i, ui::PrettyDir(entry, home_dir)));
    }
  }
  else {
...
int Pushd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt145(dest_dir, posix::strerror(err_num)), cmd_val->arg_spids->index(1));
    return 1;
  }
  this->dir_stack->Push(dest_dir);
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str625));
  state::ExportGlobalString(this->mem, str626, dest_dir);
...
bool _PopDirStack(state::Mem* mem, state::DirStack* dir_stack, ui::ErrorFormatter* errfmt) {
  ...
  if (dest_dir == nullptr) {
    errfmt->Print_(str627);
    return false;
  }
  err_num = pyos::Chdir(dest_dir);
  if (err_num != 0) {
    errfmt->Print_(fmt146(dest_dir, posix::strerror(err_num)));
    return false;
  }
  state::SetGlobalString(mem, str629, dest_dir);
  mem->SetPwd(dest_dir);
  return true;
}
...
int Popd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->arg_spids) > 1) {
    e_usage(fmt147(), cmd_val->arg_spids->index(1));
  }
  if (!_PopDirStack(this->mem, this->dir_stack, this->errfmt)) {
    return 1;
  }
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str631));
  return 0;
}
...
int Dirs::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  home_dir = state::MaybeString(this->mem, str633);
  style = SINGLE_LINE;
  if (arg->l) {
    home_dir = nullptr;
  }
...
int Pwd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup14 = flag_spec::ParseCmdVal(str634, cmd_val);
  attrs = tup14.at0();
  arg_r = tup14.at1();
...
List<Str*>* Help::_Groups() {
  ...
  contents = this->loader->Get(str635);
...
int Help::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str636, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  ...
  try {
    contents = this->loader->Get(fmt148(topic));
  }
  catch (IOError*) {
    this->errfmt->Print_(fmt149(topic), blame_spid);
    return 1;
  }
  print(contents);
  return 0;
...
syntax_asdl::printf_part_t* _FormatStringParser::_ParseFormatStr() {
  ...
  while ((this->token_type == Id::Format_Flag || this->token_type == Id::Format_Zero)) {
    ...
    if (str_contains(str640, flag)) {
      p_die(fmt150(flag), this->cur_token);
    }
  ...
  if ((this->token_type == Id::Format_Type || this->token_type == Id::Format_Time)) {
    ...
    if (str_contains(str642, part->type->val)) {
      p_die(fmt151(), part->type);
    }
    if (maybe_str_equals(part->type->val, str644)) {
      p_die(fmt152(), part->type);
    }
  }
  else {
    if (this->token_type == Id::Unknown_Tok) {
      p_die(fmt153(), this->cur_token);
    }
    else {
        ...
        if (part->tag_() == printf_part_e::Percent) {
          ...
          if (part->width) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt155(width_str), width_spid);
              return 1;
            }
          }
          precision = -1;
          if (part->precision) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt156(precision_str), precision_spid);
              return 1;
            }
          }
          if (arg_index < num_args) {
          ...
          typ = part->type->val;
          if (str_equals(typ, str655)) {
            if (precision >= 0) {
              s = s->slice(0, precision);
            }
          }
          else {
            if (str_equals(typ, str656)) {
              s = qsn::maybe_shell_encode(s);
            }
            else {
              if (str_equals(typ, str657)) {
                ...
                s = str658->join(c_parts);
              }
              else {
                if ((part->type->id == Id::Format_Time or str_contains(str659, typ))) {
                  try {
                    d = to_int(s);
                  }
                  catch (ValueError*) {
                    if ((len(s) >= 1 and str_contains(str660, s->index(0)))) {
                  ...
                  if (part->type->id == Id::Format_Time) {
                    ...
                    if ((d < 0 and str_contains(str664, typ))) {
                      e_die(fmt158(d, typ), part->type->span_id);
                    }
                    if (str_equals(typ, str666)) {
                      s = mylib::octal(d);
                    }
                    else {
                      if (str_equals(typ, str667)) {
                        s = mylib::hex_lower(d);
                      }
                      else {
                        if (str_equals(typ, str668)) {
                          s = mylib::hex_upper(d);
                        }
                        else {
                          s = str(d);
                    ...
                    zero_pad = 0;
                    if ((width >= 0 and list_contains(flags, str669))) {
                      zero_pad = 1;
                    }
                    else {
                    ...
                    if (zero_pad) {
                      negative = str_equals(s->index(0), str670);
                      if (negative) {
                        digits = s->slice(1);
                        sign = str671;
                        if (zero_pad == 1) {
                      ...
                      s = str_concat(sign, digits->rjust(n, str673));
                    }
                  }
                }
                else {
          ...
          if (width >= 0) {
            if (list_contains(flags, str674)) {
              s = s->ljust(width, str675);
            }
            else {
              s = s->rjust(width, str676);
            }
          }
          out->append(s);
        }
...
int Printf::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup1 = flag_spec::ParseCmdVal(str677, cmd_val);
  attrs = tup1.at0();
  arg_r = tup1.at1();
  arg = Alloc<arg_types::printf>(attrs->attrs);
  Tuple2<Str*, int> tup2 = arg_r->ReadRequired2(str678);
  fmt = tup2.at0();
  fmt_spid = tup2.at1();
  ...
  if (dict_contains(this->parse_cache, fmt)) {
    ...
    {  // with
      alloc::ctx_Location ctx(arena, Alloc<source::ArgvWord>(str679, fmt_spid));
...
int Alias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str681, cmd_val);
  arg_r = tup0.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup1 = mylib::split_once(arg, str683);
    name = tup1.at0();
    alias_exp = tup1.at1();
...
int UnAlias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str686, cmd_val);
  arg_r = tup2.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
    e_usage(str687);
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    ...
    if (dict_contains(this->aliases, name)) {
      ...
      this->errfmt->Print_(fmt162(name), cmd_val->arg_spids->index(i));
      status = 1;
    }
  }
  return status;
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->argv) == 1) {
    ...
    for (ListIter<Str*> it(sorted(mapping)); !it.Done(); it.Next()) {
      ...
      code_str = fmt163(name, qsn::maybe_shell_encode(str_val));
      print(code_str);
    }
    return 0;
  }
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  arg = flag_spec::ParseMore(str690, arg_r);
  if (arg->show_options) {
...
int Shopt::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str691, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
...
int Hash::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str693, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
...
Dict<Str*, bool>* _ParseOptSpec(Str* spec_str) {
  ...
  while (true) {
    ...
    if (str_equals(spec_str->index(i), str696)) {
      spec->set(ch, true);
      i += 1;
    }
  }
...
int GetOptsState::_OptInd() {
  int result;
  try {
    result = state::GetInteger(this->mem, str697);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    result = -1;
...
void GetOptsState::IncIndex() {
  state::BuiltinSetString(this->mem, str698, str((this->_optind + 1)));
}

void GetOptsState::SetArg(Str* optarg) {
  StackRoots _roots({&optarg});

  state::BuiltinSetString(this->mem, str699, optarg);
}

void GetOptsState::Fail() {
  state::BuiltinSetString(this->mem, str700, str701);
}
...
Tuple2<int, Str*> _GetOpts(Dict<Str*, bool>* spec, List<Str*>* argv, builtin_pure::GetOptsState* my_state, ui::ErrorFormatter* errfmt) {
  ...
  if (current == nullptr) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str702));
  }
  if ((!current->startswith(str703) or str_equals(current, str704))) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str705));
  }
  ...
  if (!dict_contains(spec, flag_char)) {
    return (Tuple2<int, Str*>(0, str706));
  }
  if (spec->index(flag_char)) {
    if (more_chars) {
      ...
      if (optarg == nullptr) {
        my_state->Fail();
        errfmt->Print_(fmt166(current));
        tmp = Alloc<List<Str*>>();
        for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
          Str* a = it.Value();
          tmp->append(qsn::maybe_shell_encode(a));
        }
        println_stderr(fmt167(str709->join(tmp)));
        return (Tuple2<int, Str*>(0, str710));
      }
    }
    my_state->IncIndex();
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  spec_str = arg_r->ReadRequired(str712);
  Tuple2<Str*, int> tup7 = arg_r->ReadRequired2(str713);
  var_name = tup7.at0();
  var_spid = tup7.at1();
  ...
  if (match::IsValidVarName(var_name)) {
    ...
    throw Alloc<error::Usage>(fmt168(var_name), var_spid);
  }
  return status;
}
...
int Echo::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseLikeEcho(str715, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  if (arg->e) {
    ...
    for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
      ...
      new_argv->append(str716->join(parts));
      if (backslash_c) {
        break;
      }
    }
...
int Module::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseOilCmdVal(str720, cmd_val);
  arg_r = tup11.at1();
  Tuple2<Str*, int> tup12 = arg_r->ReadRequired2(str721);
  name = tup12.at0();
  if (dict_contains(this->modules, name)) {
    if (this->exec_opts->redefine_module()) {
      this->errfmt->StderrLine(fmt169(name));
      return 0;
    }
    else {
      return 1;
...
int Use::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_spid = tup13.at1();
  if (arg == nullptr) {
    throw Alloc<error::Usage>(str723, runtime::NO_SPID);
  }
  arg_r->Next();
  if (str_equals(arg, str724)) {
    ...
    UP_actual = this->mem->GetValue(str726, scope_e::Dynamic);
    if (UP_actual->tag_() == value_e::Str) {
      ...
      if (maybe_str_equals(actual, expected)) {
        ...
        this->errfmt->Print_(fmt170(expected, actual), e_spid);
        return 1;
      }
    }
    else {
      this->errfmt->Print_(fmt171(expected), e_spid);
      return 1;
    }
  }
  if (str_equals(arg, str729)) {
    ...
    for (ListIter<Str*> it(rest); !it.Done(); it.Next()) {
      Str* name = it.Value();
      StackRoots _for({&name    });
      println_stderr(fmt172(name));
    }
    return 0;
  }
  throw Alloc<error::Usage>(str731, arg_spid);
}
...
int Shvar::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseOilCmdVal(str732, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  if (!cmd_val->block) {
    throw Alloc<error::Usage>(str733, runtime::NO_SPID);
  }
  ...
  arg_spids = tup16.at1();
  if (len(args) == 0) {
    throw Alloc<error::Usage>(str734, runtime::NO_SPID);
  }
  i = 0;
  for (ListIter<Str*> it(args); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup17 = mylib::split_once(arg, str735);
    name = tup17.at0();
    s = tup17.at1();
    if (s == nullptr) {
      throw Alloc<error::Usage>(str736, arg_spids->index(i));
    }
...
int CommandEvaluator::_RunAssignBuiltin(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  if (builtin_func == nullptr) {
    e_die(fmt173(cmd_val->argv->index(0)), cmd_val->arg_spids->index(0));
  }
  try {
    try {
      status = builtin_func->Run(cmd_val);
      ...
      this->errfmt->PrefixPrint(e->msg, fmt174(arg0), e->span_id);
      status = 2;
    }
    catch (KeyboardInterrupt*) {
      if (this->exec_opts->interactive()) {
...
void CommandEvaluator::_CheckStatus(int status, syntax_asdl::command_t* node, int blame_spid) {
  ...
  if ((this->exec_opts->errexit() and status != 0)) {
    ...
    throw Alloc<error::ErrExit>(fmt175(status, reason, posix::getpid()), span_id, status);
  }
}
  ...
  switch (arg->tag_()) {
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        filename = val->s;
        if (len(filename) == 0) {
          throw Alloc<error::RedirectEval>(str747, arg_word);
        }
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          t = val->s;
          if (len(t) == 0) {
            throw Alloc<error::RedirectEval>(str748, arg_word);
            return nullptr;
          }
          try {
            if (maybe_str_equals(t, str749)) {
              result->arg = Alloc<redirect_arg::CloseFd>();
            }
            else {
              if (str_equals(t->index(-1), str750)) {
            ...
            throw Alloc<error::RedirectEval>(fmt176(t), arg_word);
            return nullptr;
          }
          return result;
        }
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = Alloc<redirect_arg::HereDoc>(str_concat(val->s, str752));
            return result;
          }
          else {
            throw Alloc<AssertionError>();
...
void CommandEvaluator::_StrictErrExitList(List<syntax_asdl::command_t*>* node_list) {
  ...
  if (len(node_list) > 1) {
    e_die(fmt178(), location::SpanForCommand(node_list->index(0)));
  }
  node = node_list->index(0);
  if (_HasManyStatuses(node)) {
    node_str = ui::CommandType(node);
    e_die(fmt179(node_str), location::SpanForCommand(node));
  }
}
  ...
  switch (node->tag_()) {
    case command_e::Simple: {
      ...
      if (UP_cmd_val->tag_() == cmd_value_e::Argv) {
        ...
        if (node->block) {
          e_die(fmt180(), node->block->spids->index(0));
        }
        cmd_value__Assign* cmd_val = static_cast<cmd_value__Assign*>(UP_cmd_val);
      }
    ...
    case command_e::Pipeline: {
      ...
      if (len(node->stderr_indices)) {
        e_die(fmt181(), node->spids->index(0));
      }
      if (node->negated) {
    ...
    case command_e::ControlFlow: {
      ...
      if (node->arg_word) {
        ...
        if ((len(str_val->s) == 0 and !this->exec_opts->strict_control_flow())) {
          ...
          try {
            ...
            e_die(fmt182(node->token->val, str_val->s), node->arg_word);
          }
        }
      }
      else {
      ...
      if (ok) {
        ...
        if (this->exec_opts->strict_control_flow()) {
          ...
          this->errfmt->PrefixPrint(msg, str764, tok->span_id);
          status = 0;
        }
      }
    }
    ...
    case command_e::ShFunction: {
      ...
      if ((dict_contains(this->procs, node->name) and !this->exec_opts->redefine_proc())) {
        e_die(fmt183(node->name), node->spids->index(1));
      }
    ...
    case command_e::Proc: {
      ...
      if ((dict_contains(this->procs, node->name->val) and !this->exec_opts->redefine_proc())) {
        e_die(fmt184(node->name->val), node->name->span_id);
      }
      defaults = nullptr;
    ...
    {  // with
      ...
      for (ListIter<syntax_asdl::command_t*> it(to_run); !it.Done(); it.Next()) {
        ...
        {  // with
          ...
          {  // with
            dev::ctx_Tracer ctx(this->tracer, str767, nullptr);
...
Tuple2<bool, bool> CommandEvaluator::ExecuteAndCatch(syntax_asdl::command_t* node, int cmd_flags) {
  ...
  try {
    ...
    if ((cmd_flags & RaiseControlFlow)) {
      ...
      if (e->IsReturn()) {
        ...
        this->errfmt->Print_(str768, e->token->span_id);
        is_fatal = true;
        status = 1;
      }
    }
  ...
  if (err) {
    ...
    if ((is_errexit and !this->exec_opts->verbose_errexit())) {
      ...
      ui::PrettyPrintError(err, this->arena, str769);
    }
  }
...
void CommandEvaluator::MaybeRunExitTrap(List<int>* mut_status) {
  ...
  handler = this->traps->get(str770);
  if (handler) {
    {  // with
      dev::ctx_Tracer ctx(this->tracer, str771, nullptr);
    ...
    if (UP_sig->tag_() == proc_sig_e::Closed) {
      ...
      for (ListIter<syntax_asdl::param*> it(sig->params); !it.Done(); it.Next(), ++i) {
        ...
        if (i < n_args) {
          ...
          if (is_out_param) {
            param_name = str_concat(str772, param_name);
            if (!arg_str->startswith(str773)) {
              e_die(fmt185(arg_str));
            }
      ...
      if (sig->rest) {
        ...
        if (n_args > n_params) {
          throw Alloc<TypeError>(fmt187(proc->name, n_params, n_args));
        }
      }
    }
    try {
      ...
      if (e->IsReturn()) {
        ...
        e_die(fmt188(e->token->val), e->token);
      }
    }
    catch (error::FatalRuntime* e) {
      this->dumper->MaybeCollect(this, e);
...
int CommandEvaluator::RunFuncForCompletion(runtime_asdl::Proc* proc, List<Str*>* argv) {
  ...
  try {
    ...
    this->errfmt->Print_(str778, e->token->span_id);
    status = 1;
  }
  return status;
}
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index(i), str780))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index(-2), str782)) {
    ...
    if ((left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse)) {
      var_name = left_token->val->slice(0, -1);
      if (str_equals(close_token->val->index(-2), str783)) {
        op = assign_op_e::PlusEqual;
      }
      else {
        op = assign_op_e::Equal;
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        var_name = left_token->val->slice(0, -1);
        if (str_equals(close_token->val->index(-2), str784)) {
          op = assign_op_e::PlusEqual;
        }
        else {
          op = assign_op_e::Equal;
        ...
        if (span1->line_id == span2->line_id) {
          ...
          throw Alloc<NotImplementedError>(fmt191(span1->line_id, span2->line_id));
        }
        a_parser = parse_ctx->MakeArithParser(code_str);
        src = Alloc<source::Reparsed>(str786, left_token->span_id, close_token->span_id);
        {  // with
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    if (str_equals(left_token->val->index(-2), str788)) {
      p_die(fmt193(), left_token);
    }
    var_name = left_token->val->slice(0, -1);
    n = len(w->parts);
    if (part_offset == n) {
...
void CommandParser::_Eat(int c_id) {
  ...
  msg = fmt199(ui::PrettyId(c_id), ui::PrettyId(actual_id));
  this->_Eat2(c_id, msg);
}
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index(0), str796)) {
    pos = op_val->find(str797);
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    i += 1;
    if (!alias_exp->endswith(str800)) {
      expanded->append(str801);
      break;
    }
  }
  if (len(expanded) == 0) {
  ...
  while (i < n) {
    ...
    expanded->append(str803);
    i += 1;
  }
  code_str = str804->join(expanded);
  line_reader = reader::StringLineReader(code_str, this->arena);
  ...
  if (kind == Kind::ControlFlow) {
    ...
    if (len(suffix_words) == 1) {
      ...
      if (len(suffix_words) == 2) {
        ...
        p_die(fmt210(kw_token->val), suffix_words->index(2));
      }
    }
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if (str_equals(c, str829)) {
      i += 1;
    }
    else {
      if ((str_equals(c, str830) or str_equals(c, str831))) {
        return true;
      }
      else {
        if (str_equals(c, str832)) {
          left_bracket = true;
        }
        else {
          if ((str_equals(c, str833) and left_bracket)) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  ...
  return pyutil::BackslashEscape(s, str835);
}
Str* ERE_META_CHARS = str836;
...
Str* GlobUnescape(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if ((str_equals(c, str837) and i != (n - 1))) {
      i += 1;
      c2 = s->index(i);
...
Str* _REGEX_CHARS_TO_ESCAPE = str844;
...
Str* _PromptEvaluatorCache::Get(Str* name) {
  ...
  if (str_equals(name, str864)) {
    value = this->_GetEuid() == 0 ? str865 : str866;
  }
  else {
    if (str_equals(name, str867)) {
...
Evaluator::Evaluator(Str* lang, parse_lib::ParseContext* parse_ctx, state::Mem* mem) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Evaluator)) {
  ...
  this->parse_ctx = parse_ctx;
  this->mem = mem;
  this->default_prompt = str_concat(lang, str869);
      ...
      if (id_ == Id::PS_Octal3) {
        ...
        if (id_ == Id::PS_LBrace) {
          ...
          if (id_ == Id::PS_RBrace) {
            ...
            if (id_ == Id::PS_Subst) {
              ch = value->slice(1);
              if (str_equals(ch, str872)) {
                r = this->cache->Get(str873);
              }
              else {
                if (str_equals(ch, str874)) {
                  r = this->cache->Get(str875);
                }
                else {
                  if (str_equals(ch, str876)) {
                    hostname = this->cache->Get(str877);
                    Tuple2<Str*, Str*> tup1 = mylib::split_once(hostname, str878);
                    r = tup1.at0();
                  }
                  else {
                    if (str_equals(ch, str879)) {
                      r = this->cache->Get(str880);
                    }
                    else {
                      if (str_equals(ch, str881)) {
                        try {
                          pwd = state::GetString(this->mem, str882);
                          home = state::MaybeString(this->mem, str883);
                          r = ui::PrettyDir(pwd, home);
                        }
                        catch (error::Runtime* e) {
                          r = fmt228(e->UserErrorString());
                        }
                      }
                      else {
                        if (str_equals(ch, str885)) {
                          val = this->mem->GetValue(str886);
                          if (val->tag_() == value_e::Str) {
                            value__Str* str_val = static_cast<value__Str*>(val);
              ...
              ret->append(r->replace(str889, str890));
            }
            else {
              throw Alloc<AssertionError>();
            }
...
Str* Evaluator::EvalPrompt(runtime_asdl::value_t* UP_val) {
  ...
  if (ps1_word == nullptr) {
    ...
    try {
      ...
      ps1_word = word_::ErrorWord(fmt230(e->UserErrorString()));
    }
...
Str* Evaluator::EvalFirstPrompt() {
  ...
  if (str_equals(this->lang, str894)) {
    val = this->mem->GetValue(str895);
    ...
    case lvalue_e::Indexed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          break;
        default: {
          e_die(fmt232(ui::ValType(val)));
        }
      }
      s = word_eval::GetArrayItem(array_val->strs, lval->index);
      if (s == nullptr) {
        val = Alloc<value::Str>(str899);
      }
      else {
        val = Alloc<value::Str>(s);
      }
...
runtime_asdl::lvalue_t* UnsafeArith::ParseLValue(Str* s, int span_id) {
  ...
  {  // with
    alloc::ctx_Location ctx(arena, Alloc<source::ArgvWord>(str902, span_id));
...
int ArithEvaluator::_StringToInteger(Str* s, int span_id) {
  ...
  if (str_contains(s, str910)) {
    ...
    for (StrIter it(digits); !it.Done(); it.Next()) {
          ...
          if (str_equals(ch, str915)) {
            ...
            if (str_equals(ch, str916)) {
              ...
              if (ch->isdigit()) {
                ...
                e_strict(fmt240(digits), span_id);
              }
            }
          }
        }
      ...
      if (digit >= base) {
        e_strict(fmt241(digits, base), span_id);
      }
    ...
    if ((this->exec_opts->eval_unsafe_arith() and this->parse_ctx)) {
      ...
      {  // with
        ...
        try {
          ...
          ui::PrettyPrintError(e, arena);
          e_die(fmt242(), e->span_id);
        }
      }
      if (node2->tag_() == arith_expr_e::Word) {
        e_die(fmt243(s), span_id);
      }
      else {
      ...
      if ((len(s->strip()) == 0 or match::IsValidVarName(s))) {
        e_strict(fmt244(s), span_id);
      }
      else {
        e_die(fmt245(s), span_id);
      }
    }
  }
  return integer;
...
int ArithEvaluator::_ValToIntOrError(runtime_asdl::value_t* val, int span_id) {
  ...
  e_die(fmt247(ui::ValType(val)), span_id);
}
        ...
        if (op_id == Id::Arith_Minus) {
          ...
          if (op_id == Id::Arith_Star) {
            ...
            if (op_id == Id::Arith_Slash) {
              if (rhs == 0) {
                e_die(fmt249(), location::SpanForArithExpr(node->right));
              }
              ret = (lhs / rhs);
            }
            else {
              if (op_id == Id::Arith_Percent) {
                if (rhs == 0) {
                  e_die(fmt250(), location::SpanForArithExpr(node->right));
                }
                ret = (lhs % rhs);
              }
              else {
  ...
  switch (node->tag_()) {
    ...
    case bool_expr_e::Unary: {
      ...
      if (arg_type == bool_arg_type_e::Other) {
        ...
        e_die(fmt252(ui::PrettyId(op_id)));
      }
      throw Alloc<AssertionError>();
    }
      break;
      ...
      if (arg_type == bool_arg_type_e::Str) {
        ...
        if (op_id == Id::BoolBinary_EqualTilde) {
          try {
            ...
            msg = e->message;
            e_die(fmt253(s2, msg, node->right), 2);
          }
          if (matches == nullptr) {
            return false;
          }
        ...
        if (tok->id == Id::VOp1_Comma) {
          ...
          if (tok->id == Id::VOp1_DComma) {
            if (!(str_equals(arg, str954))) {
              e_die(fmt255(ui::PrettyId(tok->id)), tok);
            }
            return s->lower();
          }
          else {
            if (tok->id == Id::VOp1_Caret) {
              if (!(str_equals(arg, str956))) {
                e_die(fmt256(ui::PrettyId(tok->id)), tok);
              }
              if (len(s)) {
              ...
              if (tok->id == Id::VOp1_DCaret) {
                if (!(str_equals(arg, str958))) {
                  e_die(fmt257(ui::PrettyId(tok->id)), tok);
                }
                return s->upper();
              }
              else {
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Slash) {
    try {
      ...
      msg = e->message;
      e_die(fmt259(regex, msg), this->slash_spid);
    }
  }
...
void TdopParser::Eat(int token_type) {
  if (!this->AtToken(token_type)) {
    p_die(fmt263(ui::PrettyId(token_type), ui::PrettyId(this->op_id)), this->cur_word);
  }
  this->Next();
}
      ...
      if ((tok->id == Id::VTest_ColonEquals || tok->id == Id::VTest_Equals)) {
        ...
        if ((tok->id == Id::VTest_ColonQMark || tok->id == Id::VTest_QMark)) {
          if (is_falsey) {
            ...
            e_die(fmt268(error_str), blame_token);
          }
          else {
            return false;
          }
...
runtime_asdl::value_t* AbstractWordEvaluator::_ApplyUnarySuffixOp(runtime_asdl::value_t* val, syntax_asdl::suffix_op__Unary* op) {
  ...
  List<Str*>* strs = nullptr;
  StackRoots _roots({&val, &op, &w, &UP_w, &arg_val, &UP_val, &s, &new_val, &strs});
  ...
  if (op_kind == Kind::VOp1) {
    ...
    arg_val = this->EvalWordToString(op->arg_word, QUOTE_FNMATCH);
    UP_val = val;
    switch (val->tag_()) {
      case value_e::Str: {
        value__Str* val = static_cast<value__Str*>(UP_val);
...
runtime_asdl::value_t* AbstractWordEvaluator::_PatSub(runtime_asdl::value_t* val, syntax_asdl::suffix_op__PatSub* op) {
  ...
  pat_val = this->EvalWordToString(op->pat, QUOTE_FNMATCH);
  if (op->replace) {
...
runtime_asdl::value_t* AbstractWordEvaluator::_ArrayIndex(runtime_asdl::value_t* val, syntax_asdl::braced_var_sub* part, runtime_asdl::VTestPlace* vtest_place) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      ...
      break;
    case value_e::Str: {
      e_die(fmt275(part->token->val), part->token);
    }
      break;
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* array_val = static_cast<value__MaybeStrArray*>(UP_val);
...
void AbstractWordEvaluator::_EvalExtGlob(syntax_asdl::word_part__ExtGlob* part, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  for (ListIter<syntax_asdl::compound_word*> it(part->arms); !it.Done(); it.Next(), ++i) {
    ...
    StackRoots _for({&w  });
    if (i != 0) {
      part_vals->append(Alloc<part_value::String>(str1045, false, false));
    }
    this->_EvalWordToParts(w, part_vals, EXTGLOB_NESTED);
  }
  part_vals->append(Alloc<part_value::String>(str1046, false, false));
}
    ...
    case word_e::Compound: {
      ...
      if (has_extglob) {
        if (to_bool((eval_flags & EXTGLOB_FILES))) {
          ...
          glob_pat = str1052->join(glob_parts);
          fnmatch_pat = str1053->join(fnmatch_parts);
          results = Alloc<List<Str*>>();
      ...
      break;
    case word_e::Empty: {
      part_vals->append(Alloc<part_value::String>(str1055, quoted, !quoted));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, int eval_flags) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return Alloc<value::Str>(str1059);
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  part_vals = Alloc<List<runtime_asdl::part_value_t*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
  ...
  return Alloc<value::Str>(str1060->join(strs));
}
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalForPlugin(syntax_asdl::compound_word* w) {
  ...
  {  // with
    ...
    try {
      ...
      val = Alloc<value::Str>(fmt290(e->UserErrorString()));
    }
    catch (_OSError* e) {
      val = Alloc<value::Str>(fmt291(pyutil::strerror(e)));
    }
    catch (KeyboardInterrupt*) {
      val = Alloc<value::Str>(str1063);
    }
  }
  return val;
}
...
runtime_asdl::value_t* AbstractWordEvaluator::EvalRhsWord(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return Alloc<value::Str>(str1064);
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  if (len(w->parts) == 1) {
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index(-2), str1070)) {
          e_die(fmt293(), w);
        }
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        StackRoots _for({&arg      });
        if ((arg->startswith(str1072) or arg->startswith(str1073))) {
          flags->append(arg);
          flag_spids->append(word_spid);
          if ((str_contains(arg, str1074) or str_contains(arg, str1075))) {
            eval_to_pairs = false;
          }
        }
        else {
...
runtime_asdl::part_value__String* CompletionWordEvaluator::_EvalProcessSub(syntax_asdl::command_sub* cs_part) {
  ...
  return Alloc<part_value::String>(str1080, true, false);
}
...
syntax_asdl::suffix_op__PatSub* WordParser::_ReadPatSubVarOp() {
  ...
  if (this->token_type == Id::Lit_Slash) {
    ...
    this->_Peek();
    if (this->token_type != Id::Right_DollarBrace) {
      p_die(fmt297(ui::PrettyId(this->token_type)), this->cur_token);
    }
          ...
          if (op_kind == Kind::VOp2) {
            if (this->token_type == Id::VOp2_Slash) {
              ...
              if (this->token_type == Id::VOp2_Colon) {
                ...
                p_die(fmt305(str1092), this->cur_token);
              }
            }
          }
          else {
            if (op_kind == Kind::VOp3) {
              if (allow_query) {
                ...
                p_die(fmt306(str1094), this->cur_token);
              }
            }
          }
        }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool is_oil_expr) {
  ...
  while (num_end_tokens < expected_end_tokens) {
    ...
    if ((this->token_kind == Kind::Lit || this->token_kind == Kind::Char)) {
      tok = this->cur_token;
      if ((no_backslashes and str_contains(tok->val, str1099))) {
        p_die(fmt311(), tok);
      }
      if (is_oil_expr) {
...
syntax_asdl::word_part_t* WordParser::_ReadUnquotedLeftParts(bool try_triple_quote, List<bool>* triple_out) {
  ...
  if ((this->token_type == Id::Left_DoubleQuote || this->token_type == Id::Left_DollarDoubleQuote)) {
    ...
    if ((try_triple_quote and len(dq_part->parts) == 0)) {
      if (str_equals(this->lexer->ByteLookAhead(), str1105)) {
  ...
  if ((this->token_type == Id::Left_SingleQuote || this->token_type == Id::Left_RSingleQuote || this->token_type == Id::Left_DollarSingleQuote)) {
    ...
    if ((try_triple_quote and len(sq_part->tokens) == 0)) {
      if (str_equals(this->lexer->ByteLookAhead(), str1106)) {
        this->_Next(lex_mode_e::ShCommand);
        this->_Peek();
  ...
  if ((left_id == Id::Left_DollarParen || left_id == Id::Left_AtParen || left_id == Id::Left_ProcSubIn || left_id == Id::Left_ProcSubOut)) {
    ...
    if ((left_id == Id::Left_Backtick and this->parse_ctx->one_pass_parse)) {
      ...
      if (left_id == Id::Left_Backtick) {
        ...
        right_spid = this->cur_token->span_id;
        code_str = str1114->join(parts);
        arena = this->parse_ctx->arena;
        line_reader = reader::StringLineReader(code_str, arena);
        c_parser = this->parse_ctx->MakeOshParser(line_reader);
        src = Alloc<source::Reparsed>(str1115, left_spid, right_spid);
        {  // with
          alloc::ctx_Location ctx(arena, src);
...
void WordParser::ParseProc(syntax_asdl::command__Proc* node) {
  ...
  if (this->token_type != Id::Lit_Chars) {
    p_die(fmt323(ui::PrettyToken(this->cur_token, this->arena)), this->cur_token);
  }
...
syntax_asdl::arith_expr_t* WordParser::_ReadArithExpr(int end_id) {
  ...
  if ((end_id != Id::Undefined_Tok and cur_id != end_id)) {
    p_die(fmt324(ui::PrettyId(cur_id), ui::PrettyId(end_id)), this->a_parser->cur_word);
  }
  return anode;
}
...
syntax_asdl::command__ForExpr* WordParser::ReadForExpression() {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt327(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
  if (cur_id == Id::Arith_Semi) {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt328(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
            ...
            if (this->token_type == Id::Lit_Dollar) {
              if (!this->parse_opts->parse_dollar()) {
                if ((num_parts == 0 and lex_mode == lex_mode_e::ShCommand)) {
                  ...
                  if (str_equals(next_byte, str1131)) {
                    println_stderr(fmt338(next_byte));
                  }
                }
...
Tuple2<syntax_asdl::word_t*, bool> WordParser::_ReadArithWord() {
  ...
  this->_Peek();
  if (this->token_kind == Kind::Unknown) {
    p_die(fmt343(this->cur_token->val), this->cur_token);
  }
  else {
    if (this->token_kind == Kind::Eof) {
          ...
          if ((this->token_kind == Kind::VSub || this->token_kind == Kind::Lit || this->token_kind == Kind::History || this->token_kind == Kind::Left || this->token_kind == Kind::KW || this->token_kind == Kind::ControlFlow || this->token_kind == Kind::BoolUnary || this->token_kind == Kind::BoolBinary || this->token_kind == Kind::ExtGlob)) {
            if (this->token_type == Id::Lit_Pound) {
              ...
              if (this->token_type == Id::Lit_TPound) {
                ...
                if ((this->parse_opts->parse_raw_string() and (this->token_type == Id::Lit_Chars and maybe_str_equals(this->cur_token->val, str1139)))) {
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1144, false));
    }
      break;
    case word_part_e::AssocArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1145, false));
    }
      break;
    case word_part_e::Literal: {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str1147, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str1148->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
    ...
    case word_part_e::FuncCall: 
    case word_part_e::ExprSub: {
      return (Tuple3<bool, Str*, bool>(false, str1149, false));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() != word_e::Compound) {
    return (Tuple3<bool, Str*, bool>(false, str1150, quoted));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  strs = Alloc<List<Str*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str1151, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str1152->join(strs), quoted));
}
...
syntax_asdl::compound_word* TildeDetect(syntax_asdl::word_t* UP_w) {
  ...
  if ((id_ == Id::Lit_Chars and static_cast<Token*>(part1)->val->startswith(str1154))) {
    new_parts->extend(w->parts->slice(1));
    return Alloc<compound_word>(new_parts);
  }
  return nullptr;
...
void TildeDetectAssign(syntax_asdl::compound_word* w) {
  ...
  for (int i = 0; i < n; ++i) {
    ...
    if ((do_expand and LiteralId(cur) == Id::Lit_TildeLike)) {
      ...
      if (next_part) {
        is_tilde = (LiteralId(next_part) == Id::Lit_Colon or (LiteralId(next_part) == Id::Lit_Chars and static_cast<Token*>(next_part)->val->startswith(str1155)));
      }
      else {
        is_tilde = true;
      }
...
Str* escape(Str* s) {
  ...
  s = s->replace(str1165, str1166);
  s = s->replace(str1167, str1168);
  s = s->replace(str1169, str1170);
  return s;
}
...
Str* join(Str* s1, Str* s2) {
  ...
  if ((s2->startswith(str1173) or len(s1) == 0)) {
    return s2;
  }
  if (s1->endswith(str1174)) {
...
Tuple2<Str*, Str*> _splitext(Str* p, Str* sep, Str* extsep) {
  ...
  return (Tuple2<Str*, Str*>(p, str1177));
}
...
Str* normpath(Str* path) {
  ...
  slash = str1180;
  dot = str1181;
  if (str_equals(path, str1182)) {
    return dot;
  }
  initial_slashes = path->startswith(str1183);
  if ((initial_slashes and (path->startswith(str1184) and !path->startswith(str1185)))) {
    initial_slashes = 2;
  }
  comps = path->split(str1186);
  new_comps = Alloc<List<Str*>>();
  for (ListIter<Str*> it(comps); !it.Done(); it.Next()) {
    Str* comp = it.Value();
    StackRoots _for({&comp  });
    if ((len(comp) == 0 or str_equals(comp, str1187))) {
      continue;
    }
    if ((!(str_equals(comp, str1188)) or ((initial_slashes == 0 and len(new_comps) == 0) or (len(new_comps) and str_equals(new_comps->index(-1), str1189))))) {
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if ((str_contains(str1196, ch) or IsUnprintableLow(ch))) {
        quote = 2;
        break;
      }
    }
  ...
  parts->append(str1199);
  return str_concat(prefix, str1200->join(parts));
}
...
Str* maybe_encode(Str* s, int bit8_display) {
  ...
  parts = Alloc<List<Str*>>();
  parts->append(str1201);
  _encode(s, bit8_display, false, parts);
  parts->append(str1202);
  return str1203->join(parts);
}
...
Str* encode(Str* s, int bit8_display) {
  ...
  parts = Alloc<List<Str*>>();
  parts->append(str1204);
  _encode(s, bit8_display, false, parts);
  parts->append(str1205);
  return str1206->join(parts);
}
...
void _encode_bytes_x(Str* s, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (str_equals(byte, str1207)) {
      part = str1208;
    }
    else {
      if (str_equals(byte, str1209)) {
        part = str1210;
      }
      else {
        if (str_equals(byte, str1211)) {
          part = str1212;
        }
        else {
          if (str_equals(byte, str1213)) {
            part = str1214;
          }
          else {
            if (str_equals(byte, str1215)) {
              part = str1216;
            }
            else {
              if (str_equals(byte, str1217)) {
                part = shell_compat ? str1218 : str1219;
              }
              else {
...
bool _encode_runes(Str* s, int bit8_display, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (typ == Ascii) {
      state = Start;
      if (str_equals(byte, str1223)) {
        out = str1224;
      }
      else {
        if (str_equals(byte, str1225)) {
          out = str1226;
        }
        else {
          if (str_equals(byte, str1227)) {
            out = str1228;
          }
          else {
            if (str_equals(byte, str1229)) {
              out = str1230;
            }
            else {
              if (str_equals(byte, str1231)) {
                ...
                if (str_equals(byte, str1233)) {
                  out = shell_compat ? str1234 : str1235;
                }
                else {
                  if (IsUnprintableLow(byte)) {
...
syntax_asdl::word__String* _StringWordEmitter::ReadWord(types_asdl::lex_mode_t unused_lex_mode) {
  ...
  if (this->i == this->n) {
    w = Alloc<word::String>(Id::Eof_Real, str1236, runtime::NO_SPID);
    return w;
  }
...
syntax_asdl::bool_expr_t* _TwoArgs(builtin_bracket::_StringWordEmitter* w_parser) {
  ...
  w1 = w_parser->Read();
  s0 = w0->s;
  if (maybe_str_equals(s0, str1237)) {
    return Alloc<bool_expr::LogicalNot>(Alloc<bool_expr::WordTest>(w1));
  }
  unary_id = Id::Undefined_Tok;
  if (w0->s->startswith(str1238)) {
    if (maybe_str_equals(s0, str1239)) {
      unary_id = Id::BoolUnary_d;
    }
    else {
      if (maybe_str_equals(s0, str1240)) {
        unary_id = Id::BoolUnary_e;
      }
      else {
        if (maybe_str_equals(s0, str1241)) {
          unary_id = Id::BoolUnary_f;
        }
        else {
          if (maybe_str_equals(s0, str1242)) {
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    ...
    strs = cmd_val->argv;
    if ((!strs or !(str_equals(strs->index(-1), str1251)))) {
      this->errfmt->Print_(str1252, cmd_val->arg_spids->index(0));
      return 2;
    }
    cmd_val->argv->pop();
  ...
  try {
    ...
    if (n == 4) {
      a0 = w_parser->Peek(0);
      if (str_equals(a0, str1254)) {
        w_parser->Read();
        child = _ThreeArgs(w_parser);
        bool_node = Alloc<bool_expr::LogicalNot>(child);
      }
      else {
        if ((str_equals(a0, str1255) and str_equals(w_parser->Peek(3), str1256))) {
          w_parser->Read();
          bool_node = _TwoArgs(w_parser);
        }
        else {
    ...
    this->errfmt->PrettyPrintError(e, str1257);
    return 2;
  }
  ...
  try {
    ...
    this->errfmt->PrettyPrintError(e, str1258);
    return 2;
  }
  status = b ? 0 : 1;
  return status;

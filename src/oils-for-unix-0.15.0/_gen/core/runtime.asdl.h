...
namespace syntax_asdl { class word_t; class ArgList; class command_t; class re_t; class redir_loc_t; class Token; class proc_sig_t; class loc_t; }
...
class cmd_value__Argv : public cmd_value_t {
 public:
  cmd_value__Argv(List<Str*>* argv, List<syntax_asdl::loc_t*>* arg_locs,
  ...
  static cmd_value__Argv* CreateNull(bool alloc_lists = false) { 
    return Alloc<cmd_value__Argv>(alloc_lists ? Alloc<List<Str*>>() : nullptr,
                                  alloc_lists ?
                                  Alloc<List<syntax_asdl::loc_t*>>() : nullptr,
                                  nullptr);
  }
...
class Proc {
 public:
  Proc(Str* name, syntax_asdl::loc_t* name_loc, syntax_asdl::proc_sig_t* sig,
  ...
  static constexpr ObjHeader obj_header() {
    return ObjHeader::AsdlClass(69, 5);
  }

  Str* name;
  syntax_asdl::loc_t* name_loc;

...
main() {
  ...
  mkdir -p \
    ...
    "_build/obj/$compiler-$variant-sh/_gen/oil_lang" \
  ...
  _do_fork=$OILS_PARALLEL_BUILD _compile_one "$compiler" "$variant" "" \
   ...
   _compile_one "$compiler" "$variant" "" \
    _gen/oil_lang/grammar_tables.cc "_build/obj/$compiler-$variant-sh/_gen/oil_lang/grammar_tables.o"
  ...
  link "$compiler" "$variant" "$out" \
    ...
    "_build/obj/$compiler-$variant-sh/_gen/oil_lang/grammar_tables.o" \

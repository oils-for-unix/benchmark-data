...
class word_part__Literal : public word_part_t {
 public:
  word_part__Literal() : tag(static_cast<uint16_t>(word_part_e::Literal)),
                     token(nullptr), spids(new List<int>()) {
  }
  word_part__Literal(Token* token) :
                     tag(static_cast<uint16_t>(word_part_e::Literal)),
...
class word__Empty : public word_t {
 public:
  word__Empty() : tag(static_cast<uint16_t>(word_e::Empty)), spids(new
              List<int>()) {
  }
  uint16_t tag;
  List<int>* spids;
...
class word__BracedTree : public word_t {
 public:
  word__BracedTree() : tag(static_cast<uint16_t>(word_e::BracedTree)),
                   parts(new List<word_part_t*>()), spids(new List<int>()) {
  }
  word__BracedTree(List<word_part_t*>* parts) :
                   tag(static_cast<uint16_t>(word_e::BracedTree)),
                   parts(parts), spids(new List<int>()) {
  }
  uint16_t tag;
...
class word__String : public word_t {
 public:
  ...
  word__String(Id_t id, Str* s) : tag(static_cast<uint16_t>(word_e::String)),
               id(id), s(s), spids(new List<int>()) {
  }
  uint16_t tag;
  Id_t id;
  Str* s;
...
class redir_t {
 ...
 public:
  ...
  hnode_t* _AbbreviatedTree();
  hnode_t* AbbreviatedTree();
  DISALLOW_COPY_AND_ASSIGN(redir_t)
};

class redir__Redir : public redir_t {
 public:
  redir__Redir() : tag(static_cast<uint16_t>(redir_e::Redir)), op(nullptr),
               fd(-1), arg_word(nullptr) {
  }
  redir__Redir(Token* op, int fd, word_t* arg_word) :
               tag(static_cast<uint16_t>(redir_e::Redir)), op(op), fd(fd),
               arg_word(arg_word) {
  }
  uint16_t tag;
  Token* op;
  ...
  DISALLOW_COPY_AND_ASSIGN(redir__Redir)
};

class redir__HereDoc : public redir_t {
 public:
  redir__HereDoc() : tag(static_cast<uint16_t>(redir_e::HereDoc)), op(nullptr),
                 fd(-1), here_begin(nullptr), here_end_span_id(-1),
                 stdin_parts(new List<word_part_t*>()) {
  }
  redir__HereDoc(Token* op, int fd, word_t* here_begin, int here_end_span_id,
                 List<word_part_t*>* stdin_parts) :
                 tag(static_cast<uint16_t>(redir_e::HereDoc)), op(op), fd(fd),
                 here_begin(here_begin), here_end_span_id(here_end_span_id),
  ...
  DISALLOW_COPY_AND_ASSIGN(redir__HereDoc)
};

namespace redir {
  typedef redir__Redir Redir;
  typedef redir__HereDoc HereDoc;
}
...
class command__Simple : public command_t {
 public:
  command__Simple() : tag(static_cast<uint16_t>(command_e::Simple)), words(new
                  List<word_t*>()), redirects(new List<redir_t*>()),
                  more_env(new List<env_pair*>()), block(nullptr), spids(new
                  List<int>()) {
  }
  command__Simple(List<word_t*>* words, List<redir_t*>* redirects,
...
class command__ExpandedAlias : public command_t {
 public:
  command__ExpandedAlias() :
                         ...
                         child(nullptr), redirects(new List<redir_t*>()),
                         more_env(new List<env_pair*>()), spids(new
                         List<int>()) {
  }
  command__ExpandedAlias(command_t* child, List<redir_t*>* redirects,
                         List<env_pair*>* more_env) :
                         tag(static_cast<uint16_t>(command_e::ExpandedAlias)),
...
class command__ShAssignment : public command_t {
 public:
  command__ShAssignment() :
                        ...
                        List<redir_t*>()), spids(new List<int>()) {
  }
  command__ShAssignment(List<assign_pair*>* pairs, List<redir_t*>* redirects) :
                        tag(static_cast<uint16_t>(command_e::ShAssignment)),
...
class command__DoGroup : public command_t {
 public:
  ...
  command__DoGroup(List<command_t*>* children, List<redir_t*>* redirects) :
...
class command__BraceGroup : public command_t {
 public:
  ...
  command__BraceGroup(List<command_t*>* children, List<redir_t*>* redirects) :
...
class command__Subshell : public command_t {
 public:
  command__Subshell() : tag(static_cast<uint16_t>(command_e::Subshell)),
                    command_list(nullptr), redirects(new List<redir_t*>()),
                    spids(new List<int>()) {
  }
  command__Subshell(command_t* command_list, List<redir_t*>* redirects) :
...
class command__DParen : public command_t {
 public:
  command__DParen() : tag(static_cast<uint16_t>(command_e::DParen)),
                  child(nullptr), redirects(new List<redir_t*>()), spids(new
                  List<int>()) {
  }
  command__DParen(arith_expr_t* child, List<redir_t*>* redirects) :
...
class command__DBracket : public command_t {
 public:
  command__DBracket() : tag(static_cast<uint16_t>(command_e::DBracket)),
                    expr(nullptr), redirects(new List<redir_t*>()), spids(new
                    List<int>()) {
  }
  command__DBracket(bool_expr_t* expr, List<redir_t*>* redirects) :
...
class command__ForEach : public command_t {
 public:
  ...
  command__ForEach(Str* iter_name, List<word_t*>* iter_words, bool do_arg_iter,
                   command_t* body, List<redir_t*>* redirects) :
...
class command__ForExpr : public command_t {
 public:
  command__ForExpr() : tag(static_cast<uint16_t>(command_e::ForExpr)),
                   ...
                   body(nullptr), redirects(new List<redir_t*>()), spids(new
                   List<int>()) {
  }
  command__ForExpr(arith_expr_t* init, arith_expr_t* cond, arith_expr_t*
                   update, command_t* body, List<redir_t*>* redirects) :
...
class command__If : public command_t {
 public:
  command__If() : tag(static_cast<uint16_t>(command_e::If)), arms(new
              ...
              redirects(new List<redir_t*>()), spids(new List<int>()) {
  }
  command__If(List<if_arm*>* arms, List<command_t*>* else_action,
              List<redir_t*>* redirects) :
              tag(static_cast<uint16_t>(command_e::If)), arms(arms),
              else_action(else_action), redirects(redirects), spids(new
              List<int>()) {
  }
  uint16_t tag;
  List<if_arm*>* arms;
...
class command__Case : public command_t {
 public:
  ...
  command__Case(word_t* to_match, List<case_arm*>* arms, List<redir_t*>*
...
class printf_part__Percent : public printf_part_t {
 public:
  printf_part__Percent() : tag(static_cast<uint16_t>(printf_part_e::Percent)),
                       flag(nullptr), width(nullptr), precision(nullptr),
                       type(nullptr) {
  }
  printf_part__Percent(Token* flag, Token* width, Token* precision, Token*
                       type) :
...
namespace place_expr_e {
  const int Var = 1;
  const int Subscript = 1019;
  const int Attribute = 1020;
};
...
namespace class_literal_term_e {
  const int PosixClass = 1021;
  const int PerlClass = 1022;
  const int Range = 3;
...
class re__Capture : public re_t {
 public:
  re__Capture() : tag(static_cast<uint16_t>(re_e::Capture)), child(nullptr),
              var_name(nullptr), type(nullptr) {
  }
  re__Capture(re_t* child, Token* var_name, type_expr_t* type) :
...
class Token : public word_t, public re_t {
 public:
  Token() : tag(1001), id(-1), val(new Str("")), span_id(-1) {
  }
  Token(Id_t id, Str* val, int span_id) : tag(1001), id(id), val(val),
        span_id(span_id) {
  }
  uint16_t tag;
  Id_t id;
...
class compound_word : public word_t {
 public:
  compound_word() : tag(1010), parts(new List<word_part_t*>()), spids(new
                List<int>()) {
  }
  compound_word(List<word_part_t*>* parts, List<int>* spids) : tag(1010),
                parts(parts), spids(spids) {
  }
  uint16_t tag;
  List<word_part_t*>* parts;
  List<int>* spids;
...
class assign_pair : public Obj {
 public:
  assign_pair() : tag(1011), lhs(nullptr), op(assign_op_e::Equal),
              rhs(nullptr), spids(new List<int>()) {
  }
  assign_pair(sh_lhs_expr_t* lhs, assign_op_e op, word_t* rhs, List<int>*
              spids) : tag(1011), lhs(lhs), op(op), rhs(rhs), spids(spids) {
  }
  uint16_t tag;
  sh_lhs_expr_t* lhs;
  assign_op_e op;
...
class env_pair : public Obj {
 public:
  env_pair() : tag(1012), name(new Str("")), val(nullptr), spids(new
           List<int>()) {
  }
  env_pair(Str* name, word_t* val, List<int>* spids) : tag(1012), name(name),
           val(val), spids(spids) {
  }
  uint16_t tag;
  Str* name;
...
class case_arm : public Obj {
 public:
  case_arm() : tag(1013), pat_list(new List<word_t*>()), action(new
           List<command_t*>()), spids(new List<int>()) {
  }
  case_arm(List<word_t*>* pat_list, List<command_t*>* action, List<int>* spids)
           : tag(1013), pat_list(pat_list), action(action), spids(spids) {
  }
  uint16_t tag;
...
class if_arm : public Obj {
 public:
  if_arm() : tag(1014), cond(new List<command_t*>()), action(new
         List<command_t*>()), spids(new List<int>()) {
  }
  if_arm(List<command_t*>* cond, List<command_t*>* action, List<int>* spids) :
         tag(1014), cond(cond), action(action), spids(spids) {
  }
  uint16_t tag;
  List<command_t*>* cond;
  List<command_t*>* action;
...
class param : public Obj {
 public:
  param() : tag(1015), name(nullptr), type(nullptr), default_val(nullptr) {
  }
  param(Token* name, type_expr_t* type, expr_t* default_val) : tag(1015),
...
class name_type : public Obj {
 public:
  name_type() : tag(1016), name(nullptr), typ(nullptr) {
  }
  name_type(Token* name, type_expr_t* typ) : tag(1016), name(name), typ(typ) {
  }
  uint16_t tag;
  Token* name;
  type_expr_t* typ;
...
class comprehension : public Obj {
 public:
  comprehension() : tag(1017), lhs(new List<name_type*>()), iter(nullptr),
                cond(nullptr) {
  }
  comprehension(List<name_type*>* lhs, expr_t* iter, expr_t* cond) : tag(1017),
...
class named_arg : public Obj {
 public:
  named_arg() : tag(1018), name(nullptr), value(nullptr) {
  }
  named_arg(Token* name, expr_t* value) : tag(1018), name(name), value(value) {
  }
  uint16_t tag;
  Token* name;
  expr_t* value;
...
class subscript : public place_expr_t, public expr_t {
 public:
  subscript() : tag(1019), obj(nullptr), indices(new List<expr_t*>()) {
  }
  subscript(expr_t* obj, List<expr_t*>* indices) : tag(1019), obj(obj),
            indices(indices) {
  }
  uint16_t tag;
  expr_t* obj;
...
class attribute : public place_expr_t, public expr_t {
 public:
  attribute() : tag(1020), obj(nullptr), op(nullptr), attr(nullptr),
            ctx(expr_context_e::Load) {
  }
  attribute(expr_t* obj, Token* op, Token* attr, expr_context_e ctx) :
            tag(1020), obj(obj), op(op), attr(attr), ctx(ctx) {
  }
  uint16_t tag;
  expr_t* obj;
  Token* op;
...
class posix_class : public class_literal_term_t, public re_t {
 public:
  posix_class() : tag(1021), negated(nullptr), name(new Str("")) {
  }
  posix_class(speck* negated, Str* name) : tag(1021), negated(negated),
              name(name) {
  }
  uint16_t tag;
  speck* negated;
...
class perl_class : public class_literal_term_t, public re_t {
 public:
  perl_class() : tag(1022), negated(nullptr), name(new Str("")) {
  }
  perl_class(speck* negated, Str* name) : tag(1022), negated(negated),
             name(name) {
  }
  uint16_t tag;
  speck* negated;

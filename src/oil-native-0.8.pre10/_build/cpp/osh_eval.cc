...
Str* str47 = new Str("\u001b[0;0m");
Str* str48 = new Str("\u001b[1m");
Str* str49 = new Str("\u001b[4m");
Str* str50 = new Str("\u001b[7m");
Str* str51 = new Str("\u001b[31m");
Str* str52 = new Str("\u001b[32m");
Str* str53 = new Str("\u001b[33m");
Str* str54 = new Str("\u001b[34m");
Str* str55 = new Str("+");
Str* str56 = new Str(" ");
Str* str57 = new Str("PS4");
Str* str58 = new Str("<ERROR: Can't parse PS4: %s>");
Str* str59 = new Str(" ");
Str* str60 = new Str("%s%s%s");
Str* str61 = new Str("+=");
Str* str62 = new Str("=");
Str* str63 = new Str("<_ControlFlow %s>");
Str* str64 = new Str("");
Str* str65 = new Str("main");
Str* str66 = new Str("osh usage error: %s");
Str* str67 = new Str("%s-usage");
Str* str68 = new Str("Oil");
Str* str69 = new Str("main");
Str* str70 = new Str("oil");
Str* str71 = new Str("oil:all");
Str* str72 = new Str("--one-pass-parse requires noexec (-n)");
Str* str73 = new Str("completion");
Str* str74 = new Str("history");
Str* str75 = new Str("");
Str* str76 = new Str("OSH_DEBUG_DIR");
Str* str77 = new Str("%d-osh.log");
Str* str78 = new Str("Writing logs to %r");
Str* str79 = new Str("OSH_HIJACK_SHEBANG");
Str* str80 = new Str("");
Str* str81 = new Str("OSH_CRASH_DUMP_DIR");
Str* str82 = new Str("");
Str* str83 = new Str("");
Str* str84 = new Str("osh: Couldn't open %r: %s");
Str* str85 = new Str("/proc/%d/status");
Str* str86 = new Str("--parser-mem-dump can only be used with -n");
Str* str87 = new Str("/proc/%d/status");
Str* str88 = new Str("can't disable errexit running a function. Maybe wrap the function in a process with the at-splice pattern.");
Str* str89 = new Str("Unhandled SimpleCommand");
Str* str90 = new Str("\n");
Str* str91 = new Str(" \t\n\"'><=;|&(:");
Str* str92 = new Str("/");
Str* str93 = new Str("PATH");
Str* str94 = new Str(":");
Str* str95 = new Str("<ErrExit %s %s>");
Str* str96 = new Str("got invalid option %r");
Str* str97 = new Str("doesn't own option %r (try 'set')");
Str* str98 = new Str("got invalid option %r");
Str* str99 = new Str("doesn't own option %r (try 'shopt')");
Str* str100 = new Str("SHELLOPTS");
Str* str101 = new Str(":");
Str* str102 = new Str("Syntax options must be set at the top level (outside any function)");
Str* str103 = new Str("Warning: set -o verbose not implemented");
Str* str104 = new Str("SHELLOPTS");
Str* str105 = new Str("%s:%s");
Str* str106 = new Str("SHELLOPTS");
Str* str107 = new Str(":");
Str* str108 = new Str(":");
Str* str109 = new Str("SHELLOPTS");
Str* str110 = new Str("oil:basic");
Str* str111 = new Str("oil:all");
Str* str112 = new Str("strict:all");
Str* str113 = new Str("errexit");
Str* str114 = new Str("set %so %s");
Str* str115 = new Str("-");
Str* str116 = new Str("+");
Str* str117 = new Str("got invalid option %r");
Str* str118 = new Str("shopt -%s %s");
Str* str119 = new Str("s");
Str* str120 = new Str("u");
Str* str121 = new Str("<_ArgFrame %s %d at %x>");
Str* str122 = new Str("Can't determine working directory: %s");
Str* str123 = new Str("IFS");
Str* str124 = new Str("UID");
Str* str125 = new Str("EUID");
Str* str126 = new Str("PPID");
Str* str127 = new Str("HOSTNAME");
Str* str128 = new Str("OSTYPE");
Str* str129 = new Str("OPTIND");
Str* str130 = new Str("1");
Str* str131 = new Str("PS4");
Str* str132 = new Str("+ ");
Str* str133 = new Str("COMP_WORDBREAKS");
Str* str134 = new Str("SHELLOPTS");
Str* str135 = new Str("SHELLOPTS");
Str* str136 = new Str("");
Str* str137 = new Str("SHELLOPTS");
Str* str138 = new Str("PWD");
Str* str139 = new Str("PWD");
Str* str140 = new Str("PWD");
Str* str141 = new Str("OIL_VERSION");
Str* str142 = new Str("PWD");
Str* str143 = new Str("");
Str* str144 = new Str("<Mem");
Str* str145 = new Str("  -- %d --");
Str* str146 = new Str("  %s %s");
Str* str147 = new Str(">");
Str* str148 = new Str("\n");
Str* str149 = new Str("\n");
Str* str150 = new Str("Warning: span_id undefined in SetCurrentSpanId");
Str* str151 = new Str("nameref %r is undefined");
Str* str152 = new Str("nameref %r contains invalid variable name %r");
Str* str153 = new Str("%r has already been declared");
Str* str154 = new Str("%r hasn't been declared");
Str* str155 = new Str("nameref cycle: %s");
Str* str156 = new Str(" -> ");
Str* str157 = new Str("Can't assign to readonly value %r");
Str* str158 = new Str("Only strings can be exported");
Str* str159 = new Str("nameref must be a string");
Str* str160 = new Str("Can't assign to readonly array");
Str* str161 = new Str("Can't assign to items in a string");
Str* str162 = new Str("Value of type %s can't be indexed");
Str* str163 = new Str("Can't assign to readonly associative array");
Str* str164 = new Str("ARGV");
Str* str165 = new Str("PIPESTATUS");
Str* str166 = new Str("FUNCNAME");
Str* str167 = new Str("source");
Str* str168 = new Str("BASH_SOURCE");
Str* str169 = new Str("BASH_LINENO");
Str* str170 = new Str("0");
Str* str171 = new Str("LINENO");
Str* str172 = new Str("BASHPID");
Str* str173 = new Str("Can't unset readonly variable %r");
Str* str174 = new Str("%r isn't an array");
Str* str175 = new Str("$%s isn't defined");
Str* str176 = new Str("$%s should be a string");
Str* str177 = new Str("$%s should be a string, got %s");
Str* str178 = new Str("$%s doesn't look like an integer, got %r");
Str* str179 = new Str("EOF");
Str* str180 = new Str("/");
Str* str181 = new Str("~");
Str* str182 = new Str("  ");
Str* str183 = new Str("\n  ");
...
Str* str188 = new Str("~");
Str* str189 = new Str("\n");
Str* str190 = new Str("[ interactive ]");
Str* str191 = new Str("[ -c flag ]");
Str* str192 = new Str("[ stdin%s ]");
Str* str193 = new Str("[ expansion of alias %r ]");
Str* str194 = new Str("[ backticks at ... ]");
Str* str195 = new Str("[ array LValue in %s ]");
Str* str196 = new Str("[ eval at line %d of %s ]");
Str* str197 = new Str("[ trap ]");
Str* str198 = new Str("[ variable ]");
Str* str199 = new Str("%s:%d: %s%s\n");
Str* str200 = new Str("[??? no location ???] %s%s\n");
Str* str201 = new Str("");
Str* str202 = new Str("");
Str* str203 = new Str("");
Str* str204 = new Str("none");
Str* str205 = new Str("AST not printed.");
Str* str206 = new Str("text");
Str* str207 = new Str("abbrev-text");
Str* str208 = new Str("html");
Str* str209 = new Str("abbrev-html");
Str* str210 = new Str("abbrev-");
Str* str211 = new Str("\n");
Str* str212 = new Str("\n");
Str* str213 = new Str("-");
Str* str214 = new Str("_");
Str* str215 = new Str("<_Attributes %s>");
Str* str216 = new Str("<args.Reader %r %d>");
Str* str217 = new Str("expected argument to %r");
Str* str218 = new Str("-");
Str* str219 = new Str("expected integer after %s, got %r");
Str* str220 = new Str("-");
Str* str221 = new Str("got invalid integer for %s: %s");
Str* str222 = new Str("-");
Str* str223 = new Str("expected number after %r, got %r");
Str* str224 = new Str("-");
Str* str225 = new Str("got invalid float for %s: %s");
Str* str226 = new Str("-");
Str* str227 = new Str("got invalid argument %r to %r, expected one of: %s");
Str* str228 = new Str("-");
Str* str229 = new Str("|");
Str* str230 = new Str("0");
Str* str231 = new Str("F");
Str* str232 = new Str("false");
Str* str233 = new Str("False");
Str* str234 = new Str("1");
Str* str235 = new Str("T");
Str* str236 = new Str("true");
Str* str237 = new Str("Talse");
Str* str238 = new Str("got invalid argument to boolean flag: %r");
Str* str239 = new Str("-");
Str* str240 = new Str("-");
Str* str241 = new Str("got invalid option %r");
Str* str242 = new Str("Expected argument for action");
Str* str243 = new Str("Invalid action name %r");
Str* str244 = new Str("--");
Str* str245 = new Str("-");
Str* str246 = new Str("-");
Str* str247 = new Str("doesn't accept flag %s");
Str* str248 = new Str("-");
Str* str249 = new Str("+");
Str* str250 = new Str("+");
Str* str251 = new Str("doesn't accept option %s");
Str* str252 = new Str("+");
Str* str253 = new Str("-");
Str* str254 = new Str("--");
Str* str255 = new Str("--");
Str* str256 = new Str("got invalid flag %r");
Str* str257 = new Str("-");
Str* str258 = new Str("+");
Str* str259 = new Str("got invalid flag %r");
Str* str260 = new Str("-");
Str* str261 = new Str("^--?([a-zA-Z0-9][a-zA-Z0-9\\-]*)(=.*)?$");
Str* str262 = new Str("<LineLexer at pos %d of line %r (id = %d)>");
Str* str263 = new Str("");
Str* str264 = new Str("");
Str* str265 = new Str("");
Str* str266 = new Str("<Trail %s %s %s %s>");
Str* str267 = new Str("");
Str* str268 = new Str("ShAssignment expression can't be nested like this");
Str* str269 = new Str("Here docs aren't allowed in expressions");
Str* str270 = new Str("\n");
Str* str271 = new Str("");
Str* str272 = new Str(" (%s)");
Str* str273 = new Str("Unexpected token in expression mode%s");
Str* str274 = new Str("Syntax error in expression (near %s)");
Str* str275 = new Str("alnum");
Str* str276 = new Str("cntrl");
Str* str277 = new Str("lower");
Str* str278 = new Str("space");
Str* str279 = new Str("alpha");
Str* str280 = new Str("digit");
Str* str281 = new Str("print");
Str* str282 = new Str("upper");
Str* str283 = new Str("blank");
Str* str284 = new Str("graph");
Str* str285 = new Str("punct");
Str* str286 = new Str("xdigit");
Str* str287 = new Str("Range start/end shouldn't have more than one character");
Str* str288 = new Str("Write singleton tuples with tup(), not a trailing comma");
Str* str289 = new Str("testlist_comp");
Str* str290 = new Str("PNode type %d (%s) wasn't handled");
Str* str291 = new Str("Can't assign to this expression");
Str* str292 = new Str("PNode type %d (%s) wasn't handled");
Str* str293 = new Str("TODO");
Str* str294 = new Str("dot");
Str* str295 = new Str("Can't negate this symbol");
Str* str296 = new Str("%r isn't a character class");
Str* str297 = new Str("Can't negate this symbol");
Str* str298 = new Str("%r isn't a character class");
Str* str299 = new Str("%start");
Str* str300 = new Str("%end");
Str* str301 = new Str("dot");
Str* str302 = new Str("Unexpected token %r in regex");
Str* str303 = new Str("%s-%s");
Str* str304 = new Str("ERE can't express code point %d");
Str* str305 = new Str("Perl classes can't be negated in ERE");
Str* str306 = new Str("%s");
Str* str307 = new Str("POSIX classes can't be negated in ERE");
Str* str308 = new Str("[:%s:]");
Str* str309 = new Str(".");
Str* str310 = new Str("^");
Str* str311 = new Str("$");
Str* str312 = new Str("|");
Str* str313 = new Str("POSIX EREs don't have groups without capture, so this node needs () around it.");
Str* str314 = new Str("+");
Str* str315 = new Str("*");
Str* str316 = new Str("?");
...
Str* str318 = new Str("");
Str* str319 = new Str("");
Str* str320 = new Str("{%s,%s}");
Str* str321 = new Str("(");
Str* str322 = new Str(")");
Str* str323 = new Str("[^%s]");
...
Str* str328 = new Str("^");
Str* str329 = new Str("]");
Str* str330 = new Str("The [ operator doesn't apply to this expression");
Str* str331 = new Str("Expected ]]");
Str* str332 = new Str("Unexpected trailing word %s");
Str* str333 = new Str("Invalid argument to unary operator");
Str* str334 = new Str("Expected ), got %s");
Str* str335 = new Str("Unexpected token in boolean expression (%s)");
Str* str336 = new Str("");
Str* str337 = new Str("Expected %d, got %d");
Str* str338 = new Str("Step can't be 0");
Str* str339 = new Str("Invalid step %d for ascending integer range");
Str* str340 = new Str("Invalid step %d for descending integer range");
Str* str341 = new Str("Invalid step %d for ascending character range");
Str* str342 = new Str("Invalid step %d for descending character range");
Str* str343 = new Str("Mismatched cases in character range");
Str* str344 = new Str("");
Str* str345 = new Str("0");
Str* str346 = new Str("0");
Str* str347 = new Str("g");
Str* str348 = new Str("a");
Str* str349 = new Str("A");
Str* str350 = new Str("n");
Str* str351 = new Str("r");
Str* str352 = new Str("x");
Str* str353 = new Str("%s=%s");
Str* str354 = new Str("-");
Str* str355 = new Str("+");
Str* str356 = new Str("-");
Str* str357 = new Str("+");
Str* str358 = new Str("-");
Str* str359 = new Str("+");
Str* str360 = new Str("n");
Str* str361 = new Str("r");
Str* str362 = new Str("x");
Str* str363 = new Str("a");
Str* str364 = new Str("A");
Str* str365 = new Str("-");
Str* str366 = new Str("declare -");
Str* str367 = new Str("");
Str* str368 = new Str(" ");
Str* str369 = new Str("=");
Str* str370 = new Str("=()");
...
Str* str384 = new Str(")");
Str* str385 = new Str("");
Str* str386 = new Str("export_");
Str* str387 = new Str("doesn't accept -f because it's dangerous.  (The code can usually be restructured with 'source')");
Str* str388 = new Str("doesn't accept RHS with -n");
Str* str389 = new Str("Got -a but RHS isn't an array");
Str* str390 = new Str("Got -A but RHS isn't an associative array");
Str* str391 = new Str("readonly");
Str* str392 = new Str("new_var");
Str* str393 = new Str("passed -f without args");
Str* str394 = new Str("declare -f %s");
Str* str395 = new Str("-");
Str* str396 = new Str("-");
Str* str397 = new Str("-");
Str* str398 = new Str("+");
Str* str399 = new Str("+");
Str* str400 = new Str("+");
Str* str401 = new Str("Invalid unset expression");
Str* str402 = new Str("expected a variable name.  shopt -s eval_unsafe_arith allows expressions");
Str* str403 = new Str("unset");
Str* str404 = new Str("Invalid shift argument %r");
Str* str405 = new Str("got too many arguments");
Str* str406 = new Str("eval");
Str* str407 = new Str("requires code string");
Str* str408 = new Str("requires exactly 1 argument");
Str* str409 = new Str(" ");
Str* str410 = new Str("source");
Str* str411 = new Str("missing required argument");
Str* str412 = new Str("source %r failed: %s");
Str* str413 = new Str("command");
Str* str414 = new Str("Can't run assignment builtin recursively");
Str* str415 = new Str("%r isn't a shell builtin");
Str* str416 = new Str("function");
Str* str417 = new Str("alias");
Str* str418 = new Str("builtin");
Str* str419 = new Str("builtin");
Str* str420 = new Str("builtin");
Str* str421 = new Str("keyword");
Str* str422 = new Str("keyword");
Str* str423 = new Str("file");
Str* str424 = new Str("type");
Str* str425 = new Str("type: %r not found");
Str* str426 = new Str("file");
Str* str427 = new Str("file");
Str* str428 = new Str("%s is a %s");
Str* str429 = new Str("function");
Str* str430 = new Str("");
Str* str431 = new Str("read");
Str* str432 = new Str("read -t isn't implemented (except t=0)");
Str* str433 = new Str("");
Str* str434 = new Str("REPLY");
Str* str435 = new Str("REPLY");
Str* str436 = new Str("\u0000");
Str* str437 = new Str("\n");
Str* str438 = new Str("");
Str* str439 = new Str("mapfile");
...
Str* str468 = new Str("help");
Str* str469 = new Str("index");
Str* str470 = new Str("_devbuild/help/_%s");
Str* str471 = new Str("Invalid help index group: %r");
Str* str472 = new Str("_devbuild/help/%s");
Str* str473 = new Str("no help topics match %r");
Str* str474 = new Str("# +");
Str* str475 = new Str("osh printf doesn't support the %r flag");
Str* str476 = new Str("eEfFgG");
Str* str477 = new Str("osh printf doesn't support floating point");
Str* str478 = new Str("c");
Str* str479 = new Str("osh printf doesn't support single characters (bytes)");
Str* str480 = new Str("Invalid printf format character");
Str* str481 = new Str("Expected a printf format character");
Str* str482 = new Str("fsT");
Str* str483 = new Str("printf precision can't be specified with type %r");
Str* str484 = new Str("printf");
Str* str485 = new Str("requires a format string");
Str* str486 = new Str("%");
Str* str487 = new Str("");
Str* str488 = new Str("printf got invalid width %r");
Str* str489 = new Str("0");
Str* str490 = new Str("");
Str* str491 = new Str("printf got invalid precision %r");
Str* str492 = new Str("");
Str* str493 = new Str("s");
Str* str494 = new Str("q");
Str* str495 = new Str("b");
Str* str496 = new Str("");
Str* str497 = new Str("diouxX");
Str* str498 = new Str("'\"");
Str* str499 = new Str("printf expected an integer, got %r");
Str* str500 = new Str("di");
Str* str501 = new Str("ouxX");
Str* str502 = new Str("Can't format negative number %d with %%%s");
Str* str503 = new Str("u");
Str* str504 = new Str("o");
Str* str505 = new Str("x");
Str* str506 = new Str("X");
Str* str507 = new Str("TZ");
Str* str508 = new Str("TZ");
Str* str509 = new Str("-");
Str* str510 = new Str(" ");
Str* str511 = new Str("0");
Str* str512 = new Str("0");
Str* str513 = new Str(" ");
Str* str514 = new Str("");
Str* str515 = new Str("Invalid -v expression");
Str* str516 = new Str("-v expected a variable name.  shopt -s eval_unsafe_arith allows expressions");
Str* str517 = new Str("alias");
Str* str518 = new Str("alias %s=%r");
Str* str519 = new Str("=");
Str* str520 = new Str("No alias named %r");
Str* str521 = new Str("alias %s=%r");
Str* str522 = new Str("unalias");
Str* str523 = new Str("requires an argument");
Str* str524 = new Str("No alias named %r");
Str* str525 = new Str("%s=%s");
Str* str526 = new Str("set");
Str* str527 = new Str("shopt");
Str* str528 = new Str("hash");
Str* str529 = new Str("got extra arguments after -r");
Str* str530 = new Str("hash: %r not found");
Str* str531 = new Str(":");
Str* str532 = new Str("OPTIND");
Str* str533 = new Str("OPTIND");
Str* str534 = new Str("OPTARG");
Str* str535 = new Str("OPTARG");
Str* str536 = new Str("");
Str* str537 = new Str("?");
Str* str538 = new Str("-");
Str* str539 = new Str("-");
Str* str540 = new Str("?");
Str* str541 = new Str("?");
Str* str542 = new Str("getopts: option %r requires an argument.");
Str* str543 = new Str("(getopts argv: %s)");
Str* str544 = new Str(" ");
Str* str545 = new Str("?");
Str* str546 = new Str("");
Str* str547 = new Str("requires an argspec");
Str* str548 = new Str("requires the name of a variable to set");
Str* str549 = new Str("got invalid variable name %r");
Str* str550 = new Str("echo");
Str* str551 = new Str("");
Str* str552 = new Str("takes at most one arg when strict_echo is on (hint: add quotes)");
Str* str553 = new Str(" ");
Str* str554 = new Str("\n");
Str* str555 = new Str("Assignment builtin %r not configured");
Str* str556 = new Str("%r ");
Str* str557 = new Str("");
Str* str558 = new Str("command in ");
Str* str559 = new Str("assignment in ");
Str* str560 = new Str("subshell invoked from ");
Str* str561 = new Str("pipeline invoked from ");
Str* str562 = new Str("");
Str* str563 = new Str("Exiting with status %d (%sPID %d)");
Str* str564 = new Str("Redirect filename can't be empty");
Str* str565 = new Str("Redirect descriptor can't be empty");
Str* str566 = new Str("-");
Str* str567 = new Str("-");
Str* str568 = new Str("Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
Str* str569 = new Str("\n");
Str* str570 = new Str("Unknown redirect op");
Str* str571 = new Str("Unknown redirect type");
Str* str572 = new Str("TODO: trace string for assignment");
Str* str573 = new Str("ShAssignment builtins don't accept blocks");
Str* str574 = new Str("|& isn't supported");
Str* str575 = new Str("Can't append array to string");
Str* str576 = new Str("Can't append string to array");
Str* str577 = new Str("%r expected a number, got %r");
Str* str578 = new Str("Invalid control flow at top level");
Str* str579 = new Str("warning: ");
Str* str580 = new Str("errexit is disabled here, but strict_errexit disallows it with a compound command (%s)");
Str* str581 = new Str("Loop and control flow can't be in different processes");
Str* str582 = new Str("fatal: ");
Str* str583 = new Str("EXIT");
Str* str584 = new Str("Unexpected %r (in function call)");
Str* str585 = new Str("Attempted to exit from completion hook.");
Str* str586 = new Str("Couldn't find terminator for here doc that starts here");
Str* str587 = new Str("\t");
Str* str588 = new Str("Invalid here doc delimiter");
Str* str589 = new Str("+");
Str* str590 = new Str("+");
Str* str591 = new Str("+");
Str* str592 = new Str("%d != %d");
Str* str593 = new Str("Environment binding shouldn't look like an array assignment");
Str* str594 = new Str("+");
Str* str595 = new Str("Expected = in environment binding, got +=");
Str* str596 = new Str("Environment bindings can't contain array literals");
Str* str597 = new Str("Expected word type %s, got %s");
Str* str598 = new Str("{");
Str* str599 = new Str("}");
Str* str600 = new Str("Invalid token after redirect operator");
Str* str601 = new Str(" ");
Str* str602 = new Str(" ");
Str* str603 = new Str("line IDs %d != %d");
Str* str604 = new Str(" ");
Str* str605 = new Str("");
Str* str606 = new Str("Unexpected block");
Str* str607 = new Str("=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
Str* str608 = new Str("name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
Str* str609 = new Str("Unexpected block");
Str* str610 = new Str("Unexpected block");
Str* str611 = new Str("Control flow shouldn't have redirects");
Str* str612 = new Str("Control flow shouldn't have environment bindings");
Str* str613 = new Str("Unexpected argument to %r");
Str* str614 = new Str("Invalid word in for loop");
Str* str615 = new Str("Invalid word after for expression");
Str* str616 = new Str("Loop variable name should be a constant");
Str* str617 = new Str("Invalid loop variable name");
Str* str618 = new Str("Unexpected word after for loop variable");
Str* str619 = new Str("Expected ;; or esac");
Str* str620 = new Str("Unexpected word while parsing compound command");
Str* str621 = new Str("Invalid function name");
Str* str622 = new Str("Expected ) in function definition");
Str* str623 = new Str("Invalid KSH-style function name");
Str* str624 = new Str("Unexpected word when parsing command");
Str* str625 = new Str("Unexpected right brace");
Str* str626 = new Str("Unexpected EOF while parsing command");
Str* str627 = new Str("Invalid word while parsing command");
Str* str628 = new Str("Unexpected word while parsing command line");
Str* str629 = new Str("Unterminated here doc began here");
Str* str630 = new Str("\\");
Str* str631 = new Str("*");
Str* str632 = new Str("?");
Str* str633 = new Str("[");
...
Str* str637 = new Str("\\?*+{}^$.()|");
Str* str638 = new Str("\\");
Str* str639 = new Str("Unexpected escaped character %r");
Str* str640 = new Str("");
Str* str641 = new Str("");
Str* str642 = new Str("Malformed character class; treating as literal");
Str* str643 = new Str("Got unescaped right bracket");
Str* str644 = new Str("Got unescaped trailing backslash");
Str* str645 = new Str(".|^$()+*?[]{}\\");
Str* str646 = new Str("\\");
Str* str647 = new Str("\\");
Str* str648 = new Str("\\[");
...
Str* str660 = new Str("]");
Str* str661 = new Str("");
Str* str662 = new Str("Error expanding glob %r: %s");
Str* str663 = new Str("-");
Str* str664 = new Str("<Error: unbalanced \\[ and \\]> ");
Str* str665 = new Str("$");
Str* str666 = new Str("#");
Str* str667 = new Str("$");
Str* str668 = new Str("hostname");
Str* str669 = new Str("user");
Str* str670 = new Str("$ ");
Str* str671 = new Str("\u0001");
Str* str672 = new Str("\u0002");
Str* str673 = new Str("$");
Str* str674 = new Str("$");
Str* str675 = new Str("u");
Str* str676 = new Str("user");
Str* str677 = new Str("h");
Str* str678 = new Str("hostname");
Str* str679 = new Str(".");
Str* str680 = new Str("H");
Str* str681 = new Str("hostname");
Str* str682 = new Str("w");
Str* str683 = new Str("PWD");
Str* str684 = new Str("HOME");
Str* str685 = new Str("<Error: %s>");
Str* str686 = new Str("W");
Str* str687 = new Str("PWD");
Str* str688 = new Str("<Error: PWD is not a string> ");
Str* str689 = new Str("<Error: \\%s not implemented in $PS1> ");
Str* str690 = new Str("$");
Str* str691 = new Str("\\$");
Str* str692 = new Str("Invalid token %r");
Str* str693 = new Str("");
Str* str694 = new Str("<ERROR: Can't parse PS1: %s>");
Str* str695 = new Str("osh");
Str* str696 = new Str("PS1");
Str* str697 = new Str("PROMPT_COMMAND");
Str* str698 = new Str("Undefined variable %r");
Str* str699 = new Str("Can't use [] on value of type %s");
Str* str700 = new Str("");
Str* str701 = new Str("Can't use [] on value of type %s");
Str* str702 = new Str("");
Str* str703 = new Str("0x");
Str* str704 = new Str("Invalid hex constant %r");
Str* str705 = new Str("0");
Str* str706 = new Str("Invalid octal constant %r");
Str* str707 = new Str("#");
Str* str708 = new Str("#");
Str* str709 = new Str("Invalid base for numeric constant %r");
Str* str710 = new Str("a");
Str* str711 = new Str("A");
Str* str712 = new Str("@");
Str* str713 = new Str("_");
Str* str714 = new Str("Invalid digits for numeric constant %r");
Str* str715 = new Str("Digits %r out of range for base %d");
Str* str716 = new Str("Parse error in recursive arithmetic");
Str* str717 = new Str("Invalid integer constant %r");
Str* str718 = new Str("Invalid integer constant %r");
Str* str719 = new Str("Invalid integer constant %r");
Str* str720 = new Str("Undefined value in arithmetic context");
Str* str721 = new Str("Expected a value convertible to integer, got %s");
Str* str722 = new Str("0");
Str* str723 = new Str("Divide by zero");
Str* str724 = new Str("Divide by zero");
Str* str725 = new Str("Expected array or assoc in index expression, got %s");
Str* str726 = new Str("Divide by zero");
Str* str727 = new Str("Divide by zero");
Str* str728 = new Str("Exponent can't be less than zero");
Str* str729 = new Str("Associative array keys must be strings: $x 'x' \"$x\" etc.");
Str* str730 = new Str("Invalid place to modify");
Str* str731 = new Str("BASH_REMATCH");
Str* str732 = new Str("%s isn't implemented");
Str* str733 = new Str("Invalid regex %r: %s");
Str* str734 = new Str(" \t\n");
Str* str735 = new Str("IFS");
Str* str736 = new Str("IFS shouldn't be an array");
Str* str737 = new Str(" \t\n");
Str* str738 = new Str("IFS");
Str* str739 = new Str(" ");
Str* str740 = new Str("");
Str* str741 = new Str("IFS shouldn't be an array");
Str* str742 = new Str("\\");
Str* str743 = new Str("\\");
Str* str744 = new Str("Invalid transition from %r with %r");
Str* str745 = new Str("\u00ef\u00bf\u00bd");
Str* str746 = new Str("");
Str* str747 = new Str("Incomplete UTF-8 character");
Str* str748 = new Str("Invalid UTF-8 continuation byte");
Str* str749 = new Str("Invalid start of UTF-8 character");
Str* str750 = new Str("");
Str* str751 = new Str("%s can't have an argument");
Str* str752 = new Str("");
Str* str753 = new Str("%s can't have an argument");
Str* str754 = new Str("");
Str* str755 = new Str("%s can't have an argument");
Str* str756 = new Str("");
Str* str757 = new Str("%s can't have an argument");
Str* str758 = new Str("");
Str* str759 = new Str("<_GlobReplacer regex %r r %r>");
Str* str760 = new Str("(%s)");
Str* str761 = new Str("Error matching regex %r: %s");
Str* str762 = new Str("^");
Str* str763 = new Str("$");
Str* str764 = new Str("\r");
Str* str765 = new Str("<INVALID CR>");
Str* str766 = new Str("\n");
Str* str767 = new Str("<INVALID NEWLINE>");
Str* str768 = new Str(" `~!$&*()[]{}\\|;'\"<>?");
Str* str769 = new Str("Left-hand side of this assignment is invalid");
Str* str770 = new Str("Token can't be used in prefix position");
Str* str771 = new Str("Token can't be used in infix position");
Str* str772 = new Str("Parser expected %s, got %s");
Str* str773 = new Str("Unexpected end of input");
Str* str774 = new Str("warning: Invalid backslash escape in C-style string: %r");
Str* str775 = new Str("BASH_SOURCE");
Str* str776 = new Str("FUNCNAME");
Str* str777 = new Str("BASH_LINENO");
Str* str778 = new Str("0");
Str* str779 = new Str("0");
Str* str780 = new Str("");
Str* str781 = new Str("");
Str* str782 = new Str("\\");
Str* str783 = new Str("\\\\");
Str* str784 = new Str("");
Str* str785 = new Str("");
Str* str786 = new Str("The length index of a array slice can't be negative: %d");
Str* str787 = new Str("Can't slice associative arrays");
Str* str788 = new Str("i");
Str* str789 = new Str("e");
Str* str790 = new Str("f");
Str* str791 = new Str("n");
Str* str792 = new Str("u");
Str* str793 = new Str("x");
Str* str794 = new Str("C");
Str* str795 = new Str("");
Str* str796 = new Str("~");
Str* str797 = new Str("HOME");
Str* str798 = new Str("Error expanding tilde (e.g. invalid user)");
Str* str799 = new Str("Can't assign to special variable");
Str* str800 = new Str("unset variable %r");
Str* str801 = new Str("@");
Str* str802 = new Str("*");
Str* str803 = new Str("@");
Str* str804 = new Str("*");
Str* str805 = new Str("warning: ");
Str* str806 = new Str("-1");
Str* str807 = new Str("@");
Str* str808 = new Str("*");
Str* str809 = new Str("[");
Str* str810 = new Str("]");
Str* str811 = new Str("Bad indirect expansion: %r");
Str* str812 = new Str("");
Str* str813 = new Str("warning: ");
Str* str814 = new Str("");
Str* str815 = new Str("\u0001");
Str* str816 = new Str("");
Str* str817 = new Str("\u0002");
Str* str818 = new Str("");
Str* str819 = new Str("Can't use @P on %s");
Str* str820 = new Str(" ");
Str* str821 = new Str("Can't use @Q on %s");
Str* str822 = new Str("a");
Str* str823 = new Str("A");
Str* str824 = new Str("r");
Str* str825 = new Str("x");
Str* str826 = new Str("n");
Str* str827 = new Str("");
Str* str828 = new Str("Var op %r not implemented");
Str* str829 = new Str("Can't index string with @");
Str* str830 = new Str("Can't index string with *");
Str* str831 = new Str("Can't index string %r with integer");
Str* str832 = new Str("");
Str* str833 = new Str("");
Str* str834 = new Str("$");
Str* str835 = new Str("Undefined variable %r");
Str* str836 = new Str("Undefined array %r");
Str* str837 = new Str("Array %r can't be referred to as a scalar (without @ or *)");
Str* str838 = new Str("Illegal array word part (strict_array)");
Str* str839 = new Str(" ");
Str* str840 = new Str("");
Str* str841 = new Str("Array %r can't be referred to as a scalar (without @ or *)");
Str* str842 = new Str("Unexpected array literal");
Str* str843 = new Str("Unexpected associative array literal");
Str* str844 = new Str("|");
Str* str845 = new Str(")");
Str* str846 = new Str("Can't splice %r");
Str* str847 = new Str("");
Str* str848 = new Str("");
Str* str849 = new Str("This word should yield a string, but it contains an array");
Str* str850 = new Str(" ");
Str* str851 = new Str("");
Str* str852 = new Str("<Runtime error: %s>");
Str* str853 = new Str("<I/O error: %s>");
Str* str854 = new Str("<I/O error: %s>");
Str* str855 = new Str("<Ctrl-C>");
Str* str856 = new Str("");
Str* str857 = new Str("");
Str* str858 = new Str("");
Str* str859 = new Str("");
Str* str860 = new Str("");
Str* str861 = new Str("LHS array not allowed in assignment builtin");
Str* str862 = new Str("+");
Str* str863 = new Str("+= not allowed in assignment builtin");
Str* str864 = new Str("-");
Str* str865 = new Str("+");
Str* str866 = new Str("f");
Str* str867 = new Str("F");
Str* str868 = new Str("");
Str* str869 = new Str("=");
Str* str870 = new Str("Invalid variable name %r");
Str* str871 = new Str("__NO_COMMAND_SUB__");
Str* str872 = new Str("__NO_PROCESS_SUB__");
Str* str873 = new Str("Expected : or } in slice");
Str* str874 = new Str("Pattern in ${x/pat/replace} must not be empty");
Str* str875 = new Str("Expected } after replacement string, got %s");
Str* str876 = new Str("Expected } or / to close pattern");
Str* str877 = new Str("Expected ] to close subscript");
Str* str878 = new Str("Expected } to close ${");
Str* str879 = new Str("Expected } to close ${");
Str* str880 = new Str("Expected } to close ${");
Str* str881 = new Str("Unexpected token in ${} (%s)");
Str* str882 = new Str("VOp2");
Str* str883 = new Str("Unexpected token in ${} (%s)");
Str* str884 = new Str("VOp3");
Str* str885 = new Str("Expected } to close ${");
Str* str886 = new Str("Expected } after length expression");
Str* str887 = new Str("Unexpected token in ${}");
Str* str888 = new Str("\\");
Str* str889 = new Str("Strings with backslashes should look like r'\\n' or c'\\n'");
Str* str890 = new Str("Unexpected EOF in single-quoted string that began here");
Str* str891 = new Str("Unexpected EOF reading extended glob that began here");
Str* str892 = new Str("Unexpected EOF reading double-quoted string that began here");
Str* str893 = new Str("Unexpected EOF while looking for closing backtick");
Str* str894 = new Str("");
Str* str895 = new Str("Invalid proc name %s");
Str* str896 = new Str("Unexpected token after arithmetic expression (%s != %s)");
Str* str897 = new Str("Expected second ) to end arith sub");
Str* str898 = new Str("Expected second ) to end arith statement");
Str* str899 = new Str("Expected ; here");
Str* str900 = new Str("Expected ; here");
Str* str901 = new Str("Expected ) to end for loop expression");
Str* str902 = new Str("Expected ( after =");
Str* str903 = new Str("Unexpected token in array literal");
Str* str904 = new Str("Expected associative array pair");
Str* str905 = new Str("Unexpected token after array literal");
Str* str906 = new Str("Unexpected token after array splice");
Str* str907 = new Str("Word has unbalanced { }.  Maybe add a space or quote it like \\{");
Str* str908 = new Str("Unexpected token while parsing arithmetic: %r");
Str* str909 = new Str("Unhandled: %s (%s)");
Str* str910 = new Str("Invalid lex state %s");
Str* str911 = new Str("");
Str* str912 = new Str("");
Str* str913 = new Str("");
Str* str914 = new Str("");
...
Str* str918 = new Str("");
Str* str919 = new Str("");
Str* str920 = new Str("Compound shouldn't be empty");
Str* str921 = new Str("/");
Str* str922 = new Str("/");
Str* str923 = new Str("");
Str* str924 = new Str("EOF");
Str* str925 = new Str("typ");
Str* str926 = new Str("tok");
Str* str927 = new Str("children");
Str* str928 = new Str("-");
Str* str929 = new Str("with %d children");
Str* str930 = new Str("");
Str* str931 = new Str("(PNode %s %s %s)");
Str* str932 = new Str("&");
Str* str933 = new Str("&amp;");
Str* str934 = new Str("<");
Str* str935 = new Str("&lt;");
...
Str* str977 = new Str("\n");
Str* str978 = new Str("\\n");
Str* str979 = new Str("\r");
Str* str980 = new Str("\\r");
Str* str981 = new Str("\t");
Str* str982 = new Str("\\t");
Str* str983 = new Str("\u0000");
Str* str984 = new Str("\\x00");
Str* str985 = new Str("\\0");
Str* str986 = new Str("");
Str* str987 = new Str("");
Str* str988 = new Str("");
Str* str989 = new Str("\\");
...
Str* str993 = new Str("\n");
Str* str994 = new Str("\\n");
Str* str995 = new Str("\r");
Str* str996 = new Str("\\r");
Str* str997 = new Str("\t");
Str* str998 = new Str("\\t");
Str* str999 = new Str("\u0000");
Str* str1000 = new Str("\\x00");
Str* str1001 = new Str("\\0");
Str* str1002 = new Str("");
Str* str1003 = new Str("!");
Str* str1004 = new Str("Expected unary operator, got %r (2 args)");
Str* str1005 = new Str("-a");
Str* str1006 = new Str("-o");
Str* str1007 = new Str("!");
Str* str1008 = new Str("(");
Str* str1009 = new Str(")");
Str* str1010 = new Str("Expected binary operator, got %r (3 args)");
Str* str1011 = new Str("]");
Str* str1012 = new Str("missing closing ]");
Str* str1013 = new Str("!");
Str* str1014 = new Str("(");
Str* str1015 = new Str(")");
Str* str1016 = new Str("(test) ");
Str* str1017 = new Str("(test) ");
...
inline Str* fmt10(Str* a0, Str* a1, Str* a2) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.format_s(a1);
  gBuf.format_s(a2);
...
inline Str* fmt15(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt23(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const(":", 1);
  gBuf.format_s(a1);
...
inline Str* fmt26(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt47(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt48(Str* a0, int a1, Str* a2, Str* a3) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const(":", 1);
  gBuf.format_d(a1);
...
inline Str* fmt83(int a0, int a1) {
  gBuf.reset();
...
inline Str* fmt103(int a0, Str* a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const("  ", 2);
  gBuf.format_s(a1);
...
inline Str* fmt119(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt133(int a0, Str* a1, int a2) {
  gBuf.reset();
...
inline Str* fmt142(int a0, int a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const(" != ", 4);
  gBuf.format_d(a1);
...
inline Str* fmt148(int a0, int a1) {
  gBuf.reset();
...
inline Str* fmt183(Str* a0, int a1) {
  gBuf.reset();
...
inline Str* fmt195(Str* a0, Str* a1, syntax_asdl::word_t* a2) {
  gBuf.reset();
...
inline Str* fmt201(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt205(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt266(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("/", 1);
  gBuf.format_s(a1);
...
void Tracer::OnSimpleCommand(List<Str*>* argv) {
  ...
  cmd = str59->join(tmp);
  println_stderr(fmt10(first_char, prefix, cmd));
}
...
void Tracer::OnShAssignment(runtime_asdl::lvalue_t* lval, syntax_asdl::assign_op_t op, runtime_asdl::value_t* val, int flags, runtime_asdl::scope_t lookup_mode) {
  ...
  first_char = tup1.at0();
  prefix = tup1.at1();
  op_str = op == assign_op_e::PlusEqual ? str61 : str62;
}
...
int Main(Str* lang, args::Reader* arg_r, Dict<Str*, Str*>* environ, bool login_shell, pyutil::_ResourceLoader* loader, void* line_input) {
  ...
  arg_r->Next();
  try {
    attrs = flag_spec::ParseMore(str65, arg_r);
  }
  catch (error::Usage* e) {
    println_stderr(fmt11(e->msg));
    return 2;
  }
  ...
  if (flag->help) {
    help_builtin->Run(MakeBuiltinArgv(new List<Str*>({fmt12(lang)})));
    return 0;
  }
  if (flag->version) {
    pyutil::ShowAppVersion(str68, loader);
    return 0;
  }
  no_str = nullptr;
  ...
  if (arg_r->AtEnd()) {
    ...
    dollar0 = arg_r->Peek();
    frame0 = new state::DebugFrame(dollar0, str69, no_str, state::LINE_ZERO, 0, 0);
  ...
  if (str_equals(lang, str70)) {
    mutable_opts->SetShoptOption(str71, true);
  }
  ...
  comp_arena->PushSource(new source::Unused(str73));
  ...
  hist_arena->PushSource(new source::Unused(str74));
  ...
  my_pid = posix::getpid();
  debug_path = str75;
  debug_dir = environ->get(str76);
  if (flag->debug_file != nullptr) {
    debug_path = flag->debug_file;
  }
  else {
    if (debug_dir != nullptr) {
      debug_path = os_path::join(debug_dir, fmt13(my_pid));
    }
  }
  if (len(debug_path)) {
    throw new NotImplementedError();
  ...
  if (len(debug_path)) {
    println_stderr(fmt14(debug_path));
  }
  interp = environ->get(str79, str80);
  search_path = new state::SearchPath(mem);
  splitter = new split::SplitContext(mem);
  crash_dump_dir = environ->get(str81, str82);
  ...
  if (flag->c != nullptr) {
    ...
    if (flag->i) {
      ...
      if (script_name == nullptr) {
        stdin = mylib::Stdin();
        arena->PushSource(new source::Stdin(str83));
        ...
        try {
          ...
          println_stderr(fmt15(script_name, pyutil::strerror_OS(e)));
          return 1;
        }
...
Str* SearchPath::Lookup(Str* name, bool exec_required) {
  ...
  val = this->mem->GetVar(str93);
  UP_val = val;
  if (val->tag_() == value_e::Str) {
    value__Str* val = static_cast<value__Str*>(UP_val);
    path_list = val->s->split(str94);
  }
  else {
...
MutableOpts::MutableOpts(state::Mem* mem, List<bool>* opt_array, state::_ErrExit* errexit, state::OptHook* opt_hook) {
  ...
  runtime_asdl::value_t* UP_shellopts = this->mem->GetVar(str100);
...
void MutableOpts::SetOption(Str* opt_name, bool b) {
  ...
  UP_val = this->mem->GetVar(str104);
  value__Str* val = static_cast<value__Str*>(UP_val);
  shellopts = val->s;
  if (b) {
    if (!str_contains(shellopts, opt_name)) {
      new_val = new value::Str(fmt23(shellopts, opt_name));
      this->mem->InternalSetGlobal(str106, new_val);
    }
  }
  else {
    if (str_contains(shellopts, opt_name)) {
      names = new List<Str*>();
      for (ListIter<Str*> it(shellopts->split(str107)); !it.Done(); it.Next()) {
        Str* n = it.Value();
        if (!(str_equals(n, opt_name))) {
          names->append(n);
        }
      }
      new_val = new value::Str(str108->join(names));
      this->mem->InternalSetGlobal(str109, new_val);
    }
  }
}
...
void MutableOpts::ShowOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    print(fmt24(b ? str115 : str116, opt_name));
  }
}
...
void MutableOpts::ShowShoptOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    if (index == 0) {
      e_usage(fmt25(opt_name));
    }
    b = this->opt_array->index(index);
    print(fmt26(b ? str119 : str120, opt_name));
  }
}
...
Str* _GetWorkingDir() {
  try {
    ...
    e_die(fmt27(pyutil::strerror_OS(e)));
  }
}
...
void _InitDefaults(state::Mem* mem) {
  SetGlobalString(mem, str123, split::DEFAULT_IFS);
  SetGlobalString(mem, str124, str(posix::getuid()));
  SetGlobalString(mem, str125, str(posix::geteuid()));
  SetGlobalString(mem, str126, str(posix::getppid()));
  SetGlobalString(mem, str127, libc::gethostname());
  SetGlobalString(mem, str128, pyos::OsType());
  SetGlobalString(mem, str129, str130);
  SetGlobalString(mem, str131, str132);
  SetGlobalString(mem, str133, _READLINE_DELIMS);
}
...
void _InitVarsFromEnv(state::Mem* mem, Dict<Str*, Str*>* environ) {
  ...
  val = mem->GetVar(str134);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str135, str136);
  }
  mem->SetVar(new lvalue::Named(str137), nullptr, scope_e::GlobalOnly, SetReadOnly);
  val = mem->GetVar(str138);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str139, _GetWorkingDir());
  }
  mem->SetVar(new lvalue::Named(str140), nullptr, scope_e::GlobalOnly, SetExport);
}
...
void InitMem(state::Mem* mem, Dict<Str*, Str*>* environ, Str* version_str) {
  ...
  SetGlobalString(mem, str141, version_str);
  _InitDefaults(mem);
  _InitVarsFromEnv(mem, environ);
  val = mem->GetVar(str142);
...
Mem::Mem(Str* dollar0, List<Str*>* argv, alloc::Arena* arena, List<state::DebugFrame*>* debug_stack) {
  ...
  this->line_num = new value::Str(str143);
...
void Mem::_DisallowNamerefCycle(Str* name, List<Str*>* ref_trail) {
  ...
  if (list_contains(ref_trail, new_name)) {
    e_die(fmt32(str156->join(ref_trail)));
  }
...
void Mem::SetVar(runtime_asdl::lvalue_t* lval, runtime_asdl::value_t* val, runtime_asdl::scope_t lookup_mode, int flags) {
  ...
  switch (lval->tag_()) {
    ...
    case lvalue_e::Indexed: {
      ...
      e_die(fmt36(ui::ValType(cell->val)), left_spid);
    }
      break;
    case lvalue_e::Keyed: {
...
bool Mem::Unset(runtime_asdl::lvalue_t* lval, runtime_asdl::scope_t lookup_mode, bool strict) {
  ...
  if (cell->readonly) {
    throw new error::Runtime(fmt38(var_name));
  }
  switch (lval->tag_()) {
    case lvalue_e::Named: {
...
Str* GetString(state::Mem* mem, Str* name) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      throw new error::Runtime(fmt40(name));
    }
      break;
    case value_e::Str: {
...
int GetInteger(state::Mem* mem, Str* name) {
  ...
  val = mem->GetVar(name, scope_e::Dynamic);
  if (val->tag_() != value_e::Str) {
    throw new error::Runtime(fmt42(name, ui::ValType(val)));
  }
  s = static_cast<value__Str*>(val)->s;
  try {
    i = to_int(s);
    ...
    throw new error::Runtime(fmt43(name, s));
  }
  return i;
}
...
Str* PrettyDir(Str* dir_name, Str* home_dir) {
  if (home_dir != nullptr) {
    if ((str_equals(dir_name, home_dir) or dir_name->startswith(str_concat(home_dir, str180)))) {
      return str_concat(str181, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    f->write(str_equals(c, str184) ? str185 : str186);
  }
  f->write(str187);
  f->write(str_repeat(str188, (length - 1)));
  f->write(str189);
}
...
void _PrintWithSpanId(Str* prefix, Str* msg, int span_id, alloc::Arena* arena, mylib::Writer* f) {
  ...
  switch (src->tag_()) {
    ...
    case source_e::EvalArg: {
      ...
      source_str = fmt47(line_num, outer_source);
    }
      break;
    case source_e::Trap: {
      source_str = str197;
  ...
  f->write(fmt48(source_str, line_num, prefix, msg));
}
...
void PrettyPrintError(error::_ErrorWithLocation* err, alloc::Arena* arena) {
  PrettyPrintError(err, arena, str201);
}
...
void ErrorFormatter::Print_(Str* msg, int span_id) {
  ...
  _PrintWithOptionalSpanId(str202, msg, span_id, this->arena);
}
...
void PrintAst(syntax_asdl::command_t* node, arg_types::main* flag) {
  ...
  if (maybe_str_equals(flag->ast_format, str204)) {
    println_stderr(str205);
  }
  else {
    f = mylib::Stdout();
    afmt = flag->ast_format;
    if ((maybe_str_equals(afmt, str206) || maybe_str_equals(afmt, str207))) {
      ast_f = fmt::DetectConsoleOutput(f);
    }
    else {
      if ((maybe_str_equals(afmt, str208) || maybe_str_equals(afmt, str209))) {
...
void _Attributes::Set(Str* name, runtime_asdl::value_t* val) {
  name = name->replace(str213, str214);
...
bool SetAttachedBool::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  if (attached_arg != nullptr) {
    if ((str_equals(attached_arg, str230) || str_equals(attached_arg, str231) || str_equals(attached_arg, str232) || str_equals(attached_arg, str233))) {
      b = false;
    }
    else {
      if ((str_equals(attached_arg, str234) || str_equals(attached_arg, str235) || str_equals(attached_arg, str236) || str_equals(attached_arg, str237))) {
        b = true;
      }
      else {
        e_usage(fmt50(attached_arg));
      }
    }
  }
  else {
...
bool SetOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str239);
...
args::_Attributes* Parse(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str244)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if ((arg->startswith(str245) and len(arg) > 1)) {
      n = len(arg);
      for (int i = 1; i < n; ++i) {
        ch = arg->index(i);
        if (list_contains(spec->plus_flags, ch)) {
          out->Set(ch, new value::Str(str246));
          continue;
        }
      ...
      if ((len(spec->plus_flags) and (arg->startswith(str249) and len(arg) > 1))) {
        n = len(arg);
        for (int i = 1; i < n; ++i) {
          ch = arg->index(i);
          if (list_contains(spec->plus_flags, ch)) {
            out->Set(ch, new value::Str(str250));
            continue;
          }
          e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
        }
...
args::_Attributes* ParseLikeEcho(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    chars = arg->slice(1);
    if ((arg->startswith(str253) and len(chars))) {
      done = false;
...
args::_Attributes* ParseMore(flag_spec::_FlagSpecAndMore* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str254)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if (arg->startswith(str255)) {
    ...
    if (((arg->startswith(str257) or arg->startswith(str258)) and len(arg) > 1)) {
      char0 = arg->index(0);
...
int LineLexer::GetSpanIdForEof() {
  ...
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str263, 0);
  }
  else {
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str264, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = new Token(id_, span_id, str265);
      return t;
    }
...
lexer::Lexer* ParseContext::_MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = new lexer::LineLexer(str267, this->arena);
...
int _Classify(grammar::Grammar* gr, syntax_asdl::Token* tok) {
  ...
  type_str = tok->id == Id::Unknown_Tok ? str271 : fmt54(ui::PrettyId(tok->id));
  p_die(fmt55(type_str), tok);
}
...
Tuple2<pnode::PNode*, syntax_asdl::Token*> ExprParser::Parse(lexer::Lexer* lexer, int start_symbol) {
  ...
  try {
    ...
    p_die(fmt56(ui::PrettyId(e->tok->id)), e->tok);
  }
...
List<Str*>* POSIX_CLASSES = new List<Str*>({str275, str276, str277, str278, str279, str280, str281, str282, str283, str284, str285, str286});
Str* RANGE_POINT_TOO_LONG = str287;
int NT_OFFSET = 256;
...
syntax_asdl::expr_t* Transformer::_Tuple(List<pnode::PNode*>* children) {
  ...
  if (n == 2) {
    p_die(fmt57(), children->index(1)->tok);
  }
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw new NotImplementedError(str289);
  }
  if (id0 == Id::Op_LBracket) {
    elts = new List<syntax_asdl::expr_t*>();
    for (int i = 0; i < n; i += 2) {
  ...
  for (int i = 0; i < n; i += 2) {
    ...
    if (tag == expr_e::Var) {
      ...
      if ((tag == place_expr_e::Var || tag == place_expr_e::Subscript || tag == place_expr_e::Attribute)) {
        ...
        p_die(fmt58(), p->tok ? p->tok : nullptr);
      }
    }
  }
  return places;
...
syntax_asdl::re_t* Transformer::_NameInRegex(syntax_asdl::Token* negated_tok, syntax_asdl::Token* tok) {
  ...
  val = tok->val;
  if (maybe_str_equals(val, str294)) {
    if (negated_tok) {
      p_die(fmt59(), tok);
    }
    return tok;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((str_equals(tok->val, str299) || str_equals(tok->val, str300) || str_equals(tok->val, str301))) {
        return tok;
      }
      p_die(fmt63(tok->val), tok);
    }
...
void _ClassLiteralToPosixEre(syntax_asdl::class_literal_term_t* term, List<Str*>* parts) {
  ...
  if (tag == class_literal_term_e::CodePoint) {
    ...
    if (code_point < 128) {
      ...
      e_die(fmt65(code_point), term->spid);
    }
    return ;
  }
  if (tag == class_literal_term_e::PerlClass) {
    ...
    if (term->negated) {
      e_die(fmt66(), term->negated->span_id);
    }
    else {
      pat = fmt67(chars);
    }
  ...
  if (tag == class_literal_term_e::PosixClass) {
    ...
    n = term->name;
    if (term->negated) {
      e_die(fmt68(), term->negated->span_id);
    }
    else {
      pat = fmt69(n);
    }
...
void AsPosixEre(syntax_asdl::re_t* node, List<Str*>* parts) {
  ...
  if (tag == re_e::Repeat) {
    ...
    if (op_tag == re_repeat_e::Num) {
      ...
      parts->append(fmt71(op->times->val));
      return ;
    }
    if (op_tag == re_repeat_e::Range) {
      re_repeat__Range* op = static_cast<re_repeat__Range*>(UP_op);
      lower = op->lower ? op->lower->val : str318;
      upper = op->upper ? op->upper->val : str319;
      parts->append(fmt72(lower, upper));
      return ;
    }
...
syntax_asdl::bool_expr_t* BoolParser::ParseForBuiltin() {
  ...
  if (this->bool_id != Id::Eof_Real) {
    p_die(fmt79(word_::Pretty(this->cur_word)), this->cur_word);
  }
  return node;
}
...
syntax_asdl::bool_expr_t* BoolParser::ParseFactor() {
  ...
  if (this->bool_id == Id::Op_LParen) {
    ...
    if (this->bool_id != Id::Op_RParen) {
      p_die(fmt81(word_::Pretty(this->cur_word)), this->cur_word);
    }
    this->_Next();
    return node;
  }
  p_die(fmt82(ui::PrettyId(this->bool_id)), this->cur_word);
}
...
Str* _RangeParser::_Eat(int token_type) {
  ...
  if (this->token_type != token_type) {
    throw new _NotARange(fmt83(token_type, this->token_type));
  }
  val = this->token_val;
  this->_Next();
  return val;
...
syntax_asdl::word_part__BracedRange* _RangeParser::Parse() {
  ...
  if (this->token_type == Id::Range_Int) {
    ...
    if (start < end) {
      ...
      if (part->step <= 0) {
        p_die(fmt85(part->step), this->span_id);
      }
    }
    else {
      if (start > end) {
    ...
    if (this->token_type == Id::Range_Char) {
      ...
      if (upper1 != upper2) {
        p_die(fmt89(), this->span_id);
      }
    }
    else {
      throw new _NotARange(str344);
    }
  }
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  flag = attrs->attrs;
  tmp_g = flag->get(str347);
  tmp_a = flag->get(str348);
  ...
  flag_A = (tmp_A and tmp_A->tag_() == value_e::Bool) ? static_cast<value__Bool*>(tmp_A)->b : false;
  tmp_n = flag->get(str350);
  tmp_r = flag->get(str351);
  tmp_x = flag->get(str352);
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if ((maybe_str_equals(flag_n, str354) and !cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_n, str355) and cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str356) and !cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str357) and cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str358) and !cell->exported)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str359) and cell->exported)) {
      continue;
    }
    ...
    if (print_flags) {
      ...
      decl->extend(new List<Str*>({str366, str367->join(flags), str368, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(new List<Str*>({str369, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (has_holes) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(new List<Str*>({str372, name, str373, str(i), str374, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(new List<Str*>({str376, str377->join(body), str378}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(new List<Str*>({str380, key_quoted, str381, value_quoted}));
          }
          if (len(body) > 0) {
            decl->extend(new List<Str*>({str382, str383->join(body), str384}));
          }
        }
        else {
          ;  // pass
...
int Export::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r->Next();
  attrs = flag_spec::Parse(str386, arg_r);
...
int Readonly::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = new args::Reader(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str391, arg_r);
...
int NewVar::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  flags = 0;
  if (maybe_str_equals(arg->x, str395)) {
    flags |= state::SetExport;
  }
  if (maybe_str_equals(arg->r, str396)) {
    flags |= state::SetReadOnly;
  }
  if (maybe_str_equals(arg->n, str397)) {
    flags |= state::SetNameref;
  }
  flags_to_clear = 0;
  if (maybe_str_equals(arg->x, str398)) {
    flags |= state::ClearExport;
  }
  if (maybe_str_equals(arg->r, str399)) {
    flags |= state::ClearReadOnly;
  }
  if (maybe_str_equals(arg->n, str400)) {
...
int Unset::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str403, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
...
int Eval::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str406, cmd_val);
  arg_r = tup0.at1();
  if (this->exec_opts->strict_eval_builtin()) {
    Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str407);
    code_str = tup1.at0();
    eval_spid = tup1.at1();
    if (!arg_r->AtEnd()) {
      e_usage(str408);
    ...
    code_str = str409->join(arg_r->Rest());
...
int Source::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str410, cmd_val);
  arg_r = tup2.at1();
  path = arg_r->Peek();
  if (path == nullptr) {
    e_usage(str411);
  ...
  try {
    ...
    this->errfmt->Print_(fmt98(path, pyutil::strerror_OS(e)), cmd_val->arg_spids->index(1));
    return 1;
  }
  try {
    try {
...
int Command::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup3 = flag_spec::ParseCmdVal(str413, cmd_val);
  attrs = tup3.at0();
  arg_r = tup3.at1();
...
int Builtin::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (to_run == consts::NO_INDEX) {
    ...
    if (consts::LookupAssignBuiltin(name) != consts::NO_INDEX) {
      this->errfmt->Print_(str414, span_id);
    }
    else {
      this->errfmt->Print_(fmt99(name), span_id);
    }
    return 1;
  }
...
List<Tuple2<Str*, Str*>*>* _ResolveNames(List<Str*>* names, Dict<Str*, syntax_asdl::command__ShFunction*>* funcs, Dict<Str*, Str*>* aliases, state::SearchPath* search_path) {
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if (dict_contains(funcs, name)) {
      kind = (new Tuple2<Str*, Str*>(str416, name));
    }
    else {
              ...
              if (consts::IsControlFlow(name)) {
                ...
                if (consts::IsKeyword(name)) {
                  ...
                  if (resolved == nullptr) {
                    ...
                    kind = (new Tuple2<Str*, Str*>(str423, resolved));
                  }
                }
              }
            }
...
int Type::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str424, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
  ...
  for (ListIter<Tuple2<Str*, Str*>*> it(r); !it.Done(); it.Next()) {
    ...
    name = tup6->at1();
    if (kind == nullptr) {
      this->errfmt->StderrLine(fmt100(name));
      status = 1;
    }
    else {
      if (arg->t) {
        ...
        if (arg->p) {
          ...
          if (arg->P) {
            ...
            print(fmt101(name, kind));
            if (str_equals(kind, str429)) {
              ;  // pass
            }
          }
        }
...
Tuple2<Str*, bool> ReadLineFromStdin(Str* delim_char) {
  ...
  return (Tuple2<Str*, bool>(str430->join(chars), eof));
}
...
int Read::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str431, cmd_val);
  attrs = tup2.at0();
  arg_r = tup2.at1();
...
int MapFile::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str439, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
  ...
  while (true) {
    ...
    if ((arg->t and line->endswith(str441))) {
      line = line->slice(0, -1);
    }
    lines->append(line);
  }
...
int Cd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt102(real_dest_dir, posix::strerror(err_num)), arg_spid);
    return 1;
  }
...
void _PrintDirStack(state::DirStack* dir_stack, int style, Str* home_dir) {
  ...
  if (style == WITH_LINE_NUMBERS) {
    ...
    for (ListIter<Str*> it(dir_stack->Iter()); !it.Done(); it.Next(), ++i) {
      Str* entry = it.Value();
      print(fmt103(i, ui::PrettyDir(entry, home_dir)));
    }
  }
  else {
...
int Pushd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt104(dest_dir, posix::strerror(err_num)), cmd_val->arg_spids->index(1));
    return 1;
  }
...
bool _PopDirStack(state::Mem* mem, state::DirStack* dir_stack, ui::ErrorFormatter* errfmt) {
  ...
  err_num = pyos::Chdir(dest_dir);
  if (err_num != 0) {
    errfmt->Print_(fmt105(dest_dir, posix::strerror(err_num)));
    return false;
  }
...
int Popd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  if (len(cmd_val->arg_spids) > 1) {
    e_usage(fmt106(), cmd_val->arg_spids->index(1));
  }
...
int Help::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseCmdVal(str467, cmd_val);
  attrs = tup11.at0();
  arg_r = tup11.at1();
  ...
  if (str_equals(topic, str469)) {
    ...
    for (ListIter<Str*> it(groups); !it.Done(); it.Next()) {
      Str* group = it.Value();
      try {
        contents = this->loader->Get(fmt107(group));
      }
      catch (IOError*) {
        this->errfmt->Print_(fmt108(group));
        return 1;
      }
      print(contents);
    }
  ...
  try {
    contents = this->loader->Get(fmt109(topic));
  }
  catch (IOError*) {
    this->errfmt->Print_(fmt110(topic), blame_spid);
    return 1;
  }
  print(contents);
  return 0;
...
syntax_asdl::printf_part_t* _FormatStringParser::_ParseFormatStr() {
  ...
  while ((this->token_type == Id::Format_Flag || this->token_type == Id::Format_Zero)) {
    ...
    if (str_contains(str474, flag)) {
      p_die(fmt111(flag), this->cur_token);
    }
  ...
  if ((this->token_type == Id::Format_Type || this->token_type == Id::Format_Time)) {
    ...
    if (str_contains(str476, part->type->val)) {
      p_die(fmt112(), part->type);
    }
    if (maybe_str_equals(part->type->val, str478)) {
      p_die(fmt113(), part->type);
    }
  }
  else {
    if (this->token_type == Id::Unknown_Tok) {
      p_die(fmt114(), this->cur_token);
    }
    else {
      p_die(fmt115(), this->cur_token);
    }
  }
  if ((part->precision and !str_contains(str482, part->type->val->index(-1)))) {
...
int Printf::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str484, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
  arg = new arg_types::printf(attrs->attrs);
  Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str485);
  fmt = tup1.at0();
  fmt_spid = tup1.at1();
        ...
        if (part->tag_() == printf_part_e::Percent) {
          ...
          if (part->width) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt116(width_str), width_spid);
              return 1;
            }
          }
          precision = -1;
          if (part->precision) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt117(precision_str), precision_spid);
              return 1;
            }
          }
          if (arg_index < num_args) {
          ...
          if (str_equals(typ, str493)) {
            ...
            if (str_equals(typ, str494)) {
              ...
              if (str_equals(typ, str495)) {
                ...
                s = str496->join(c_parts);
              }
              else {
                if ((str_contains(str497, typ) or part->type->id == Id::Format_Time)) {
                  try {
                    d = to_int(s);
                  }
                  catch (ValueError*) {
                    if ((len(s) >= 1 and str_contains(str498, s->index(0)))) {
                      ...
                      if ((part->type->id == Id::Format_Time and (len(s) == 0 and word_spid == runtime::NO_SPID))) {
                        ...
                        this->errfmt->Print_(fmt118(s), blame_spid);
                        return 1;
                      }
                    }
                  }
                  if (str_contains(str500, typ)) {
                    ...
                    if (str_contains(str501, typ)) {
                      if (d < 0) {
                        e_die(fmt119(d, typ), part->type->span_id);
                      }
          ...
          if (width >= 0) {
            if (len(flags)) {
              if (list_contains(flags, str509)) {
                s = s->ljust(width, str510);
              }
              else {
                if (list_contains(flags, str511)) {
...
int Alias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str517, cmd_val);
  arg_r = tup0.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    Tuple2<Str*, Str*> tup1 = mylib::split_once(arg, str519);
    name = tup1.at0();
    alias_exp = tup1.at1();
...
int UnAlias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str522, cmd_val);
  arg_r = tup2.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
    e_usage(str523);
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    ...
    if (dict_contains(this->aliases, name)) {
      ...
      this->errfmt->Print_(fmt125(name), cmd_val->arg_spids->index(i));
      status = 1;
    }
  }
  return status;
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->argv) == 1) {
    ...
    for (ListIter<Str*> it(sorted(mapping)); !it.Done(); it.Next()) {
      ...
      code_str = fmt126(name, qsn::maybe_shell_encode(str_val));
      print(code_str);
    }
    return 0;
  }
  arg_r = new args::Reader(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  arg = flag_spec::ParseMore(str526, arg_r);
  if (arg->show_options) {
...
int Shopt::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str527, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
...
int Hash::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str528, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
...
Dict<Str*, bool>* _ParseOptSpec(Str* spec_str) {
  ...
  while (true) {
    ...
    if (str_equals(spec_str->index(i), str531)) {
      spec->set(ch, true);
      i += 1;
    }
  }
...
int GetOptsState::_OptInd() {
  ...
  try {
    result = state::GetInteger(this->mem, str532);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    result = -1;
...
void GetOptsState::IncIndex() {
  state::SetStringDynamic(this->mem, str533, str((this->_optind + 1)));
}

void GetOptsState::SetArg(Str* optarg) {
  state::SetStringDynamic(this->mem, str534, optarg);
}

void GetOptsState::Fail() {
  state::SetStringDynamic(this->mem, str535, str536);
}
...
Tuple2<int, Str*> _GetOpts(Dict<Str*, bool>* spec, List<Str*>* argv, builtin_pure::GetOptsState* my_state, ui::ErrorFormatter* errfmt) {
  ...
  if (current == nullptr) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str537));
  }
  if ((!current->startswith(str538) or str_equals(current, str539))) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str540));
  }
  ...
  if (!dict_contains(spec, flag_char)) {
    return (Tuple2<int, Str*>(0, str541));
  }
  if (spec->index(flag_char)) {
    if (more_chars) {
      ...
      if (optarg == nullptr) {
        my_state->Fail();
        errfmt->Print_(fmt128(current));
        tmp = new List<Str*>();
        for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
          Str* a = it.Value();
          tmp->append(qsn::maybe_shell_encode(a));
        }
        println_stderr(fmt129(str544->join(tmp)));
        return (Tuple2<int, Str*>(0, str545));
      }
    }
    my_state->IncIndex();
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = new args::Reader(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  spec_str = arg_r->ReadRequired(str547);
  Tuple2<Str*, int> tup7 = arg_r->ReadRequired2(str548);
  var_name = tup7.at0();
  var_spid = tup7.at1();
  ...
  if (match::IsValidVarName(var_name)) {
    ...
    throw new error::Usage(fmt130(var_name), var_spid);
  }
  return status;
}
...
int Echo::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseLikeEcho(str550, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  if (arg->e) {
    ...
    for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
      ...
      new_argv->append(str551->join(parts));
      if (backslash_c) {
        break;
      }
    }
...
int CommandEvaluator::_RunAssignBuiltin(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  if (builtin_func == nullptr) {
    e_die(fmt131(cmd_val->argv->index(0)), cmd_val->arg_spids->index(0));
  }
  try {
    try {
      status = builtin_func->Run(cmd_val);
      ...
      this->errfmt->PrefixPrint(e->msg, fmt132(arg0), e->span_id);
      status = 2;
    }
    catch (KeyboardInterrupt*) {
...
void CommandEvaluator::_CheckStatus(int status, syntax_asdl::command_t* node) {
  ...
  if ((this->exec_opts->errexit() and status != 0)) {
    ...
    throw new error::ErrExit(fmt133(status, reason, posix::getpid()), span_id, status);
  }
}
  ...
  switch (arg->tag_()) {
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        filename = val->s;
        if (len(filename) == 0) {
          throw new error::RedirectEval(str564, arg_word);
        }
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          t = val->s;
          if (len(t) == 0) {
            throw new error::RedirectEval(str565, arg_word);
            return nullptr;
          }
          try {
            if (maybe_str_equals(t, str566)) {
              result->arg = new redirect_arg::CloseFd();
            }
            else {
              if (str_equals(t->index(-1), str567)) {
            ...
            throw new error::RedirectEval(fmt134(t), arg_word);
            return nullptr;
          }
          return result;
        }
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = new redirect_arg::HereDoc(str_concat(val->s, str569));
            return result;
          }
          else {
            throw new AssertionError();
  ...
  switch (node->tag_()) {
    case command_e::Simple: {
      ...
      if (UP_cmd_val->tag_() == cmd_value_e::Argv) {
        ...
        argv = new List<Str*>({str572});
        if (node->block) {
          e_die(fmt135(), node->block->spids->index(0));
        }
      }
    ...
    case command_e::Pipeline: {
      ...
      if (len(node->stderr_indices)) {
        e_die(fmt136(), node->spids->index(0));
      }
      if (node->negated) {
        {  // with
    ...
    case command_e::ControlFlow: {
      ...
      if (node->arg_word) {
        ...
        try {
          ...
          e_die(fmt137(node->token->val, str_val->s), node->arg_word);
        }
      }
      else {
      ...
      if (ok) {
        ...
        if (this->exec_opts->strict_control_flow()) {
          ...
          this->errfmt->PrefixPrint(msg, str579, tok->span_id);
          status = 0;
        }
      }
    }
...
Tuple2<bool, bool> CommandEvaluator::ExecuteAndCatch(syntax_asdl::command_t* node, int cmd_flags) {
  ...
  if (err) {
    ...
    if ((is_errexit and !this->exec_opts->verbose_errexit())) {
      ...
      ui::PrettyPrintError(err, this->arena, str582);
    }
  }
  ...
  {  // with
    ...
    try {
      ...
      if (e->IsReturn()) {
        ...
        e_die(fmt139(e->token->val), e->token);
      }
    }
    catch (error::FatalRuntime* e) {
      this->dumper->MaybeCollect(this, e);
...
int CommandEvaluator::RunFuncForCompletion(syntax_asdl::command__ShFunction* func_node, List<Str*>* argv) {
  ...
  try {
    ...
    this->errfmt->Print_(str585, e->token->span_id);
    status = 1;
  }
  return status;
}
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index(i), str587))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index(-2), str589)) {
    ...
    if ((left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse)) {
      var_name = left_token->val->slice(0, -1);
      if (str_equals(close_token->val->index(-2), str590)) {
        op = assign_op_e::PlusEqual;
      }
      else {
        op = assign_op_e::Equal;
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        var_name = left_token->val->slice(0, -1);
        if (str_equals(close_token->val->index(-2), str591)) {
          op = assign_op_e::PlusEqual;
        }
        else {
          op = assign_op_e::Equal;
        ...
        if (span1->line_id == span2->line_id) {
          ...
          throw new NotImplementedError(fmt142(span1->line_id, span2->line_id));
        }
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    w = tup6->at3();
    if (left_token->id != Id::Lit_VarLike) {
      p_die(fmt143(), left_token);
    }
    if (str_equals(left_token->val->index(-2), str594)) {
      p_die(fmt144(), left_token);
    }
    var_name = left_token->val->slice(0, -1);
    n = len(w->parts);
    if (part_offset == n) {
...
void CommandParser::_Eat(int c_id) {
  ...
  msg = fmt146(ui::PrettyId(c_id), ui::PrettyId(actual_id));
  this->_Eat2(c_id, msg);
}
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index(0), str598)) {
    pos = op_val->find(str599);
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    i += 1;
    if (!alias_exp->endswith(str601)) {
      expanded->append(str602);
      break;
    }
  }
  if (len(expanded) == 0) {
  ...
  while (i < n) {
    ...
    if (span1->line_id == span2->line_id) {
      ...
      throw new NotImplementedError(fmt148(span1->line_id, span2->line_id));
    }
    expanded->append(str604);
    i += 1;
  }
  code_str = str605->join(expanded);
  line_reader = reader::StringLineReader(code_str, this->arena);
  ...
  if (kind == Kind::ControlFlow) {
    ...
    if (len(suffix_words) == 1) {
      ...
      if (len(suffix_words) == 2) {
        ...
        p_die(fmt156(kw_token->val), suffix_words->index(2));
      }
    }
...
syntax_asdl::command__ShFunction* CommandParser::ParseFunctionDef() {
  ...
  if (len(name) == 0) {
    p_die(fmt164(), cur_word);
  }
  this->_Next();
  this->_Peek();
  this->lexer->PushHint(Id::Op_RParen, Id::Right_ShFunction);
  this->_Next();
  this->_Eat2(Id::Right_ShFunction, str622);
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if (str_equals(c, str630)) {
      i += 1;
    }
    else {
      if ((str_equals(c, str631) or str_equals(c, str632))) {
        return true;
      }
      else {
        if (str_equals(c, str633)) {
          left_bracket = true;
        }
        else {
          if ((str_equals(c, str634) and left_bracket)) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  return pyutil::BackslashEscape(s, str636);
}
Str* ERE_META_CHARS = str637;
...
Str* GlobUnescape(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if ((str_equals(c, str638) and i != (n - 1))) {
      i += 1;
      c2 = s->index(i);
  ...
  return str640->join(unescaped);
}

_GlobParser::_GlobParser(match::SimpleLexer* lexer) {
  this->lexer = lexer;
  this->token_type = Id::Undefined_Tok;
  this->token_val = str641;
      ...
      if (tag == glob_part_e::Operator) {
        ...
        if (tag == glob_part_e::CharClass) {
          ...
          for (ListIter<Str*> it(part->strs); !it.Done(); it.Next()) {
            Str* s = it.Value();
            if (str_equals(s, str656)) {
              literal_hyphen = true;
              continue;
            }
            if (str_equals(s, str657)) {
...
int Globber::Expand(Str* arg, List<Str*>* out) {
  ...
  if (n) {
    for (ListIter<Str*> it(results); !it.Done(); it.Next()) {
      Str* name = it.Value();
      if ((name->startswith(str663) and !this->exec_opts->dashglob())) {
        n -= 1;
        continue;
      }
      out->append(name);
...
Str* _PromptEvaluatorCache::Get(Str* name) {
  ...
  if (str_equals(name, str665)) {
    value = this->_GetEuid() == 0 ? str666 : str667;
  }
  else {
    if (str_equals(name, str668)) {
      value = libc::gethostname();
    }
    else {
      if (str_equals(name, str669)) {
...
Evaluator::Evaluator(Str* lang, parse_lib::ParseContext* parse_ctx, state::Mem* mem) {
  ...
  this->parse_ctx = parse_ctx;
  this->mem = mem;
  this->default_prompt = str_concat(lang, str670);
          ...
          if (id_ == Id::PS_RBrace) {
            ...
            if (id_ == Id::PS_Subst) {
              ...
              if (str_equals(ch, str673)) {
                r = this->cache->Get(str674);
              }
              else {
                if (str_equals(ch, str675)) {
                  r = this->cache->Get(str676);
                }
                else {
                  if (str_equals(ch, str677)) {
                    hostname = this->cache->Get(str678);
                    Tuple2<Str*, Str*> tup1 = mylib::split_once(hostname, str679);
                    r = tup1.at0();
                  }
                  else {
                    if (str_equals(ch, str680)) {
                      r = this->cache->Get(str681);
                    }
                    else {
                      if (str_equals(ch, str682)) {
                        try {
                          pwd = state::GetString(this->mem, str683);
                          home = state::MaybeString(this->mem, str684);
                          r = ui::PrettyDir(pwd, home);
                        }
                        catch (error::Runtime* e) {
                          r = fmt173(e->UserErrorString());
                        }
                      }
                      else {
                        if (str_equals(ch, str686)) {
                          val = this->mem->GetVar(str687);
                          if (val->tag_() == value_e::Str) {
                            value__Str* str_val = static_cast<value__Str*>(val);
              ...
              ret->append(r->replace(str690, str691));
            }
            else {
              throw new AssertionError();
            }
...
Str* Evaluator::EvalPrompt(runtime_asdl::value_t* UP_val) {
  ...
  if (ps1_word == nullptr) {
    ...
    try {
      ...
      ps1_word = word_::ErrorWord(fmt175(e->UserErrorString()));
    }
...
Str* Evaluator::EvalFirstPrompt() {
  ...
  if (str_equals(this->lang, str695)) {
    val = this->mem->GetVar(str696);
    ...
    case lvalue_e::Indexed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          break;
        default: {
          e_die(fmt177(ui::ValType(val)));
        }
      }
      s = word_eval::GetArrayItem(array_val->strs, lval->index);
      if (s == nullptr) {
        val = new value::Str(str700);
      }
      else {
        val = new value::Str(s);
      }
    ...
    case lvalue_e::Keyed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::AssocArray: {
          ...
          break;
        default: {
          e_die(fmt178(ui::ValType(val)));
        }
      }
      s = assoc_val->d->get(lval->key);
      if (s == nullptr) {
        val = new value::Str(str702);
      }
      else {
        val = new value::Str(s);
      }
...
int ArithEvaluator::_StringToInteger(Str* s, int span_id) {
  ...
  if (s->startswith(str703)) {
    try {
      integer = to_int(s, 16);
    }
    catch (ValueError*) {
      e_strict(fmt179(s), span_id);
    }
    return integer;
  }
  if (s->startswith(str705)) {
    try {
      integer = to_int(s, 8);
    }
    catch (ValueError*) {
      e_strict(fmt180(s), span_id);
    }
    return integer;
  }
  if (str_contains(s, str707)) {
    Tuple2<Str*, Str*> tup0 = mylib::split_once(s, str708);
    b = tup0.at0();
    digits = tup0.at1();
    try {
      base = to_int(b);
      ...
      e_strict(fmt181(b), span_id);
    }
    integer = 0;
    for (StrIter it(digits); !it.Done(); it.Next()) {
      Str* ch = it.Value();
      if (IsLower(ch)) {
        digit = ((ord(ch) - ord(str710)) + 10);
      }
      else {
        if (IsUpper(ch)) {
          digit = ((ord(ch) - ord(str711)) + 36);
        }
        else {
          if (str_equals(ch, str712)) {
            digit = 62;
          }
          else {
            if (str_equals(ch, str713)) {
              digit = 63;
            }
            else {
              if (ch->isdigit()) {
                ...
                e_strict(fmt182(digits), span_id);
              }
            }
          }
        }
      ...
      if (digit >= base) {
        e_strict(fmt183(digits, base), span_id);
      }
  ...
  try {
    ...
    if ((this->exec_opts->eval_unsafe_arith() and this->parse_ctx)) {
      ...
      if ((len(s->strip()) == 0 or match::IsValidVarName(s))) {
        e_strict(fmt186(s), span_id);
      }
      else {
        e_die(fmt187(s), span_id);
      }
    }
  }
  return integer;
...
int ArithEvaluator::_ValToIntOrError(runtime_asdl::value_t* val, int span_id) {
  ...
  e_die(fmt189(ui::ValType(val)), span_id);
}
  ...
  if (((val->tag_() == value_e::MaybeStrArray || val->tag_() == value_e::AssocArray) and lval->tag_() == lvalue_e::Named)) {
    ...
    if (word_eval::CheckCompatArray(named_lval->name, this->exec_opts)) {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (val->tag_() == value_e::AssocArray) {
          lval = new lvalue::Keyed(named_lval->name, str722);
        }
      }
        ...
        if (op_id == Id::Arith_Minus) {
          ...
          if (op_id == Id::Arith_Star) {
            ...
            if (op_id == Id::Arith_Slash) {
              if (rhs == 0) {
                e_die(fmt191(), location::SpanForArithExpr(node->right));
              }
              ret = (lhs / rhs);
            }
            else {
              if (op_id == Id::Arith_Percent) {
                if (rhs == 0) {
                  e_die(fmt192(), location::SpanForArithExpr(node->right));
                }
                ret = (lhs % rhs);
              }
              else {
...
void BoolEvaluator::_SetRegexMatches(List<Str*>* matches) {
  state::SetGlobalArray(this->mem, str731, matches);
}
  ...
  switch (node->tag_()) {
    ...
    case bool_expr_e::Unary: {
      ...
      if (arg_type == bool_arg_type_e::Other) {
        ...
        e_die(fmt194(ui::PrettyId(op_id)));
      }
      throw new AssertionError();
    }
      break;
      ...
      if (arg_type == bool_arg_type_e::Str) {
        ...
        if (op_id == Id::BoolBinary_EqualTilde) {
          try {
            ...
            msg = e->message;
            e_die(fmt195(s2, msg, node->right), 2);
          }
          if (matches == nullptr) {
            return false;
          }
...
_BaseSplitter::_BaseSplitter(Str* escape_chars) {
  this->escape_chars = str_concat(escape_chars, str742);
}
    ...
    if (i < n) {
      ...
      if (str_contains(ws_chars, c)) {
        ...
        if (str_contains(other_chars, c)) {
          ...
          if ((allow_escape and str_equals(c, str743))) {
...
Str* Utf8Encode(int code) {
  ...
  return str746->join(tmp);
}
Str* INCOMPLETE_CHAR = str747;
Str* INVALID_CONT = str748;
Str* INVALID_START = str749;
            ...
            if (op->op_id == Id::VOp1_Caret) {
              ...
              if (op->op_id == Id::VOp1_DCaret) {
                if (!(str_equals(arg, str756))) {
                  e_die(fmt199(ui::PrettyId(op->op_id)));
                }
                return s->upper();
              }
              else {
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Slash) {
    try {
      ...
      msg = e->message;
      e_die(fmt201(regex, msg), this->slash_spid);
    }
  }
  if (op->replace_mode == Id::Lit_Pound) {
    regex = str_concat(str762, regex);
  }
  else {
    if (op->replace_mode == Id::Lit_Percent) {
      regex = str_concat(regex, str763);
    }
  }
...
Str* ShellQuoteB(Str* s) {
  s = s->replace(str764, str765)->replace(str766, str767);
  return pyutil::BackslashEscape(s, str768);
}
...
void TdopParser::Eat(int token_type) {
  if (!this->AtToken(token_type)) {
    p_die(fmt205(ui::PrettyId(token_type), ui::PrettyId(this->op_id)), this->cur_word);
  }
  this->Next();
}
...
using runtime_asdl::scope_e;
List<Str*>* _STRING_AND_ARRAY = new List<Str*>({str775, str776, str777});
...
runtime_asdl::value_t* ResolveCompatArray(runtime_asdl::value_t* val) {
  ...
  if (val->tag_() == value_e::MaybeStrArray) {
    ...
    if (val->tag_() == value_e::AssocArray) {
      value__AssocArray* assoc_val = static_cast<value__AssocArray*>(val);
      s = dict_contains(assoc_val->d, str778) ? assoc_val->d->index(str779) : nullptr;
    }
    else {
      throw new AssertionError();
    }
...
Str* _BackslashEscape(Str* s) {
  return s->replace(str782, str783);
}
...
runtime_asdl::part_value_t* _ValueToPartValue(runtime_asdl::value_t* val, bool quoted) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      return new part_value::String(str784, quoted, !quoted);
    }
      break;
    case value_e::Str: {
      value__Str* val = static_cast<value__Str*>(UP_val);
...
Str* TildeEvaluator::Eval(syntax_asdl::Token* token) {
  ...
  if (maybe_str_equals(token->val, str796)) {
    val = this->mem->GetVar(str797);
    UP_val = val;
    if (val->tag_() == value_e::Str) {
      value__Str* val = static_cast<value__Str*>(UP_val);
      return val->s;
      ...
      if ((op->op_id == Id::VTest_ColonEquals || op->op_id == Id::VTest_Equals)) {
        ...
        if ((op->op_id == Id::VTest_ColonQMark || op->op_id == Id::VTest_QMark)) {
          if (is_falsey) {
            ...
            e_die(fmt211(error_str), blame_token);
          }
          else {
            return false;
          }
...
runtime_asdl::value_t* AbstractWordEvaluator::_EvalIndirectArrayExpansion(Str* name, Str* index) {
  ...
  switch (val->tag_()) {
    ...
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* val = static_cast<value__MaybeStrArray*>(UP_val);
      if ((str_equals(index, str801) || str_equals(index, str802))) {
    ...
    case value_e::AssocArray: {
      value__AssocArray* val = static_cast<value__AssocArray*>(UP_val);
      if ((str_equals(index, str803) || str_equals(index, str804))) {
        throw new NotImplementedError();
      }
      s = val->d->get(index);
      if (s != nullptr) {
      ...
      case value_e::Str: {
        ...
        try {
          ...
          if (this->exec_opts->strict_word_eval()) {
            ...
            this->errfmt->PrettyPrintError(e, str805);
            return new value::Str(str806);
          }
        }
      }
        break;
    ...
    if (op_id == Id::VSub_Bang) {
      ...
      switch (val->tag_()) {
        case value_e::Str: {
          ...
          if ((maybe_str_equals(val->s, str807) || maybe_str_equals(val->s, str808))) {
            return new value::MaybeStrArray(this->mem->GetArgv());
          }
          i = val->s->find(str809);
          if ((i >= 0 and str_equals(val->s->index(-1), str810))) {
...
runtime_asdl::value_t* AbstractWordEvaluator::_Slice(runtime_asdl::value_t* val, syntax_asdl::suffix_op__Slice* op, Str* var_name, syntax_asdl::braced_var_sub* part) {
  ...
  try {
    ...
    if (this->exec_opts->strict_word_eval()) {
      ...
      this->errfmt->PrettyPrintError(e, str813);
      switch (val->tag_()) {
        case value_e::Str: {
          val = new value::Str(str814);
        }
          break;
        case value_e::MaybeStrArray: {
  ...
  if (op_id == Id::VOp0_P) {
    switch (val->tag_()) {
      case value_e::Str: {
        ...
        p = prompt->replace(str815, str816)->replace(str817, str818);
    ...
    if (op_id == Id::VOp0_Q) {
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          result = new value::Str(str820->join(tmp));
        }
          break;
        default: {
      ...
      if (op_id == Id::VOp0_a) {
        ...
        result = new value::Str(str827->join(chars));
      }
      else {
        e_die(fmt215(op->val), op);
      }
    }
  }
...
Tuple2<runtime_asdl::value_t*, runtime_asdl::a_index_t*> AbstractWordEvaluator::_ArrayIndex(runtime_asdl::value_t* val, syntax_asdl::braced_var_sub* part) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      ...
      break;
    case value_e::Str: {
      e_die(fmt218(part->token->val), part->token);
    }
      break;
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* array_val = static_cast<value__MaybeStrArray*>(UP_val);
...
void AbstractWordEvaluator::_EvalDoubleQuoted(List<syntax_asdl::word_part_t*>* parts, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  if (len(parts) == 0) {
    v = new part_value::String(str832, true, false);
    part_vals->append(v);
    return ;
  }
...
runtime_asdl::value_t* AbstractWordEvaluator::_EmptyStrOrError(runtime_asdl::value_t* val, syntax_asdl::Token* token) {
  ...
  if (!this->exec_opts->nounset()) {
    return new value::Str(str833);
  }
  name = token->val->startswith(str834) ? token->val->slice(1) : token->val;
  e_die(fmt219(name), token);
}

runtime_asdl::value_t* AbstractWordEvaluator::_EmptyMaybeStrArrayOrError(syntax_asdl::Token* token) {
  if (this->exec_opts->nounset()) {
    e_die(fmt220(token->val), token);
  }
  else {
  ...
  switch (part->tag_()) {
    ...
    case word_part_e::ExtGlob: {
      ...
      for (ListIter<syntax_asdl::word_t*> it(part->arms); !it.Done(); it.Next(), ++i) {
        syntax_asdl::word_t* w = it.Value();
        if (i != 0) {
          part_vals->append(new part_value::String(str844, false, false));
        }
        this->_EvalWordToParts(w, false, part_vals);
      }
      part_vals->append(new part_value::String(str845, false, false));
    }
      break;
...
void AbstractWordEvaluator::_EvalWordToParts(syntax_asdl::word_t* w, bool quoted, List<runtime_asdl::part_value_t*>* part_vals, bool is_subst) {
  ...
  switch (w->tag_()) {
    case word_e::Compound: {
      ...
      break;
    case word_e::Empty: {
      part_vals->append(new part_value::String(str847, quoted, !quoted));
    }
      break;
    default: {
      throw new AssertionError();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, runtime_asdl::quote_t quote_kind) {
  ...
  return new value::Str(str851->join(strs));
}
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalForPlugin(syntax_asdl::compound_word* w) {
  ...
  {  // with
    ...
    try {
      ...
      val = new value::Str(fmt228(e->UserErrorString()));
    }
    catch (OSError* e) {
      val = new value::Str(fmt229(pyutil::strerror_OS(e)));
    }
    catch (IOError* e) {
      val = new value::Str(fmt230(pyutil::strerror_IO(e)));
    }
    catch (KeyboardInterrupt*) {
      val = new value::Str(str855);
    }
  }
  return val;
}
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index(-2), str862)) {
          e_die(fmt232(), w);
        }
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        if ((arg->startswith(str864) or arg->startswith(str865))) {
          flags->append(arg);
          flag_spids->append(word_spid);
          if ((str_contains(arg, str866) or str_contains(arg, str867))) {
            eval_to_pairs = false;
          }
        }
        else {
...
syntax_asdl::suffix_op__PatSub* WordParser::_ReadPatSubVarOp() {
  ...
  if (this->token_type == Id::Lit_Slash) {
    ...
    this->_Peek();
    if (this->token_type != Id::Right_DollarBrace) {
      p_die(fmt236(ui::PrettyId(this->token_type)), this->cur_token);
    }
        ...
        if (op_kind == Kind::VOp2) {
          ...
          if (op_kind == Kind::VOp3) {
            if (allow_query) {
              ...
              p_die(fmt243(str884), this->cur_token);
            }
          }
        }
      }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool no_backslashes) {
  ...
  while (!done) {
    ...
    if ((this->token_kind == Kind::Lit || this->token_kind == Kind::Char)) {
      tok = this->cur_token;
      if ((no_backslashes and str_contains(tok->val, str888))) {
        p_die(fmt247(), tok);
      }
      tokens->append(tok);
    }
...
void WordParser::ParseProc(syntax_asdl::command__Proc* node) {
  ...
  if (this->token_type != Id::Lit_Chars) {
    p_die(fmt252(ui::PrettyToken(this->cur_token, this->arena)), this->cur_token);
  }
...
syntax_asdl::arith_expr_t* WordParser::_ReadArithExpr(int end_id) {
  ...
  if ((end_id != Id::Undefined_Tok and cur_id != end_id)) {
    p_die(fmt253(ui::PrettyId(cur_id), ui::PrettyId(end_id)), this->a_parser->cur_word);
  }
  return anode;
}
...
syntax_asdl::command__ForExpr* WordParser::ReadForExpression() {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt257(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
...
Tuple2<syntax_asdl::word_t*, bool> WordParser::_ReadArithWord() {
  ...
  if (this->token_kind == Kind::Unknown) {
    p_die(fmt265(this->cur_token->val), this->cur_token);
  }
  else {
    if (this->token_kind == Kind::Eof) {
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str911, false));
    }
      break;
    case word_part_e::AssocArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str912, false));
    }
      break;
    case word_part_e::Literal: {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str914, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str915->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
    ...
    case word_part_e::ExtGlob: 
    case word_part_e::Splice: {
      return (Tuple3<bool, Str*, bool>(false, str916, false));
    }
      break;
    default: {
      throw new AssertionError();
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() != word_e::Compound) {
    return (Tuple3<bool, Str*, bool>(false, str917, quoted));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  strs = new List<Str*>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str918, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str919->join(strs), quoted));
}
...
syntax_asdl::compound_word* TildeDetect(syntax_asdl::word_t* UP_w) {
  ...
  if ((id_ == Id::Lit_Chars and static_cast<Token*>(part1)->val->startswith(str921))) {
    new_parts->extend(w->parts->slice(1));
    return new compound_word(new_parts);
  }
  return nullptr;
...
void TildeDetectAssign(syntax_asdl::compound_word* w) {
  ...
  for (int i = 0; i < n; ++i) {
    ...
    if ((do_expand and LiteralId(cur) == Id::Lit_TildeLike)) {
      ...
      if (next_part) {
        is_tilde = (LiteralId(next_part) == Id::Lit_Colon or (LiteralId(next_part) == Id::Lit_Chars and static_cast<Token*>(next_part)->val->startswith(str922)));
      }
      else {
        is_tilde = true;
      }
...
Str* join(Str* s1, Str* s2) {
  if ((s2->startswith(str940) or len(s1) == 0)) {
    return s2;
  }
  if (s1->endswith(str941)) {
...
Tuple2<Str*, Str*> split(Str* p) {
  ...
  head = p->slice(0, i);
  tail = p->slice(i);
  if ((len(head) and !(str_equals(head, str_repeat(str944, len(head)))))) {
    head = head->rstrip(str945);
  }
...
Tuple2<Str*, Str*> _splitext(Str* p, Str* sep, Str* extsep) {
  ...
  return (Tuple2<Str*, Str*>(p, str946));
}
...
Str* dirname(Str* p) {
  ...
  i = (p->rfind(str948) + 1);
  head = p->slice(0, i);
  if ((head and !(str_equals(head, str_repeat(str949, len(head)))))) {
    head = head->rstrip(str950);
  }
  return head;
}
...
Str* normpath(Str* path) {
  ...
  slash = str951;
  dot = str952;
  if (str_equals(path, str953)) {
    return dot;
  }
  initial_slashes = path->startswith(str954);
  if ((initial_slashes and (path->startswith(str955) and !path->startswith(str956)))) {
    initial_slashes = 2;
  }
  comps = path->split(str957);
  new_comps = new List<Str*>();
  for (ListIter<Str*> it(comps); !it.Done(); it.Next()) {
    Str* comp = it.Value();
    if ((len(comp) == 0 or str_equals(comp, str958))) {
      continue;
    }
    if ((!(str_equals(comp, str959)) or ((initial_slashes == 0 and len(new_comps) == 0) or (len(new_comps) and str_equals(new_comps->index(-1), str960))))) {
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if ((str_contains(str962, ch) or IsUnprintableLow(ch))) {
        quote = 2;
        break;
      }
    }
  ...
  parts->append(str965);
  return str_concat(prefix, str966->join(parts));
}
...
void _encode_bytes_x(Str* s, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (str_equals(byte, str973)) {
      ...
      if (str_equals(byte, str975)) {
        part = str976;
      }
      else {
        if (str_equals(byte, str977)) {
          part = str978;
        }
        else {
          if (str_equals(byte, str979)) {
            part = str980;
          }
          else {
            if (str_equals(byte, str981)) {
              part = str982;
            }
            else {
              if (str_equals(byte, str983)) {
                part = shell_compat ? str984 : str985;
              }
              else {
...
bool _encode_runes(Str* s, int bit8_display, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (typ == Ascii) {
      state = Start;
      if (str_equals(byte, str989)) {
        out = str990;
      }
      else {
        if (str_equals(byte, str991)) {
          out = str992;
        }
        else {
          if (str_equals(byte, str993)) {
            out = str994;
          }
          else {
            if (str_equals(byte, str995)) {
              out = str996;
            }
            else {
              if (str_equals(byte, str997)) {
                out = str998;
              }
              else {
                if (str_equals(byte, str999)) {
                  out = shell_compat ? str1000 : str1001;
                }
                else {
                  if (IsUnprintableLow(byte)) {
...
syntax_asdl::word__String* _StringWordEmitter::ReadWord(types_asdl::lex_mode_t unused_lex_mode) {
  ...
  if (this->i == this->n) {
    w = new word::String(Id::Eof_Real, str1002, runtime::NO_SPID);
    return w;
  }
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    strs = cmd_val->argv;
    if ((!strs or !(str_equals(strs->index(-1), str1011)))) {
      this->errfmt->Print_(str1012, cmd_val->arg_spids->index(0));
      return 2;
    }
    cmd_val->argv->pop();
  ...
  try {
    ...
    if (n == 4) {
      a0 = w_parser->Peek(0);
      if (str_equals(a0, str1013)) {
        w_parser->Read();
        child = _ThreeArgs(w_parser);
        bool_node = new bool_expr::LogicalNot(child);
      }
      else {
        if ((str_equals(a0, str1014) and str_equals(w_parser->Peek(3), str1015))) {
          w_parser->Read();
          bool_node = _TwoArgs(w_parser);
        }
        else {
    ...
    this->errfmt->PrettyPrintError(e, str1016);
    return 2;
  }
  ...
  try {
    ...
    this->errfmt->PrettyPrintError(e, str1017);
    return 2;
  }
  status = b ? 0 : 1;
  return status;

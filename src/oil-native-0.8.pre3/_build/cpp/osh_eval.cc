...
Str* str107 = new Str("");
Str* str108 = new Str("<Mem");
Str* str109 = new Str("  -- %d --");
Str* str110 = new Str("  %s %s");
Str* str111 = new Str(">");
Str* str112 = new Str("\n");
Str* str113 = new Str("\n");
Str* str114 = new Str("Warning: span_id undefined in SetCurrentSpanId");
Str* str115 = new Str("nameref %r is undefined");
Str* str116 = new Str("nameref %r contains invalid variable name %r");
Str* str117 = new Str("%r has already been declared");
Str* str118 = new Str("%r hasn't been declared");
Str* str119 = new Str("nameref cycle: %s");
Str* str120 = new Str(" -> ");
Str* str121 = new Str("Can't assign to readonly value %r");
Str* str122 = new Str("Only strings can be exported");
Str* str123 = new Str("nameref must be a string");
Str* str124 = new Str("Can't assign to readonly array");
Str* str125 = new Str("Can't assign to items in a string");
Str* str126 = new Str("Object of type %s can't be indexed");
Str* str127 = new Str("Can't assign to readonly associative array");
Str* str128 = new Str("ARGV");
Str* str129 = new Str("PIPESTATUS");
Str* str130 = new Str("FUNCNAME");
Str* str131 = new Str("source");
Str* str132 = new Str("BASH_SOURCE");
Str* str133 = new Str("BASH_LINENO");
Str* str134 = new Str("0");
Str* str135 = new Str("LINENO");
Str* str136 = new Str("EOF");
Str* str137 = new Str("/");
Str* str138 = new Str("~");
Str* str139 = new Str("  ");
Str* str140 = new Str("\n  ");
...
Str* str145 = new Str("~");
Str* str146 = new Str("\n");
Str* str147 = new Str("[ interactive ]");
Str* str148 = new Str("[ -c flag ]");
Str* str149 = new Str("[ stdin%s ]");
Str* str150 = new Str("[ expansion of alias %r ]");
Str* str151 = new Str("[ backticks at ... ]");
Str* str152 = new Str("[ array LValue in %s ]");
Str* str153 = new Str("[ eval at line %d of %s ]");
Str* str154 = new Str("[ trap ]");
Str* str155 = new Str("%s:%d: %s%s\n");
Str* str156 = new Str("[??? no location ???] %s%s\n");
Str* str157 = new Str("");
Str* str158 = new Str("");
Str* str159 = new Str("<LineLexer at pos %d of line %r (id = %d)>");
Str* str160 = new Str("");
Str* str161 = new Str("");
Str* str162 = new Str("");
Str* str163 = new Str("<Trail %s %s %s %s>");
Str* str164 = new Str("");
Str* str165 = new Str("ShAssignment expression can't be nested like this");
Str* str166 = new Str("Here docs aren't allowed in expressions");
Str* str167 = new Str("  ");
Str* str168 = new Str("-");
Str* str169 = new Str("%s%d %s %s\n");
Str* str170 = new Str("");
Str* str171 = new Str(" (%s)");
Str* str172 = new Str("Unexpected token in expression mode%s");
Str* str173 = new Str("Syntax error in expression");
Str* str174 = new Str("alnum");
Str* str175 = new Str("cntrl");
Str* str176 = new Str("lower");
Str* str177 = new Str("space");
Str* str178 = new Str("alpha");
Str* str179 = new Str("digit");
Str* str180 = new Str("print");
Str* str181 = new Str("upper");
Str* str182 = new Str("blank");
Str* str183 = new Str("graph");
Str* str184 = new Str("punct");
Str* str185 = new Str("xdigit");
Str* str186 = new Str("Range start/end shouldn't have more than one character");
Str* str187 = new Str("Write singleton tuples with tup(), not a trailing comma");
Str* str188 = new Str("testlist_comp");
Str* str189 = new Str("PNode type %d (%s) wasn't handled");
Str* str190 = new Str("Can't assign to this expression");
Str* str191 = new Str("PNode type %d (%s) wasn't handled");
Str* str192 = new Str("TODO");
Str* str193 = new Str("dot");
Str* str194 = new Str("Can't negate this symbol");
Str* str195 = new Str("%r isn't a character class");
Str* str196 = new Str("Can't negate this symbol");
Str* str197 = new Str("%r isn't a character class");
Str* str198 = new Str("%start");
Str* str199 = new Str("%end");
Str* str200 = new Str("dot");
Str* str201 = new Str("Unexpected token %r in regex");
Str* str202 = new Str("This value can't be assigned to");
Str* str203 = new Str("This value can't be assigned to");
Str* str204 = new Str("The [ operator doesn't apply to this expression");
...
Str* str233 = new Str("{");
Str* str234 = new Str("}");
Str* str235 = new Str("Invalid token after redirect operator");
Str* str236 = new Str(" ");
Str* str237 = new Str(" ");
Str* str238 = new Str("line IDs %d != %d");
Str* str239 = new Str(" ");
Str* str240 = new Str("");
Str* str241 = new Str("Unexpected block");
Str* str242 = new Str("=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
Str* str243 = new Str("name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
Str* str244 = new Str("Unexpected block");
Str* str245 = new Str("Unexpected block");
Str* str246 = new Str("Control flow shouldn't have redirects");
Str* str247 = new Str("Control flow shouldn't have environment bindings");
Str* str248 = new Str("Unexpected argument to %r");
Str* str249 = new Str("Invalid word in for loop");
Str* str250 = new Str("Invalid word after for expression");
Str* str251 = new Str("Loop variable name should be a constant");
Str* str252 = new Str("Invalid loop variable name");
Str* str253 = new Str("Unexpected word after for loop variable");
Str* str254 = new Str("Expected ;; or esac");
Str* str255 = new Str("Unexpected word while parsing compound command");
Str* str256 = new Str("Invalid function name");
Str* str257 = new Str("Expected ) in function definition");
Str* str258 = new Str("Invalid KSH-style function name");
Str* str259 = new Str("Unexpected word when parsing command");
Str* str260 = new Str("Unexpected right brace");
Str* str261 = new Str("Unexpected EOF while parsing command");
Str* str262 = new Str("Invalid word while parsing command");
Str* str263 = new Str("Unexpected word while parsing command line");
Str* str264 = new Str("Unterminated here doc began here");
Str* str265 = new Str("\\");
Str* str266 = new Str("*");
Str* str267 = new Str("?");
Str* str268 = new Str("[");
...
Str* str272 = new Str("\\?*+{}^$.()|");
Str* str273 = new Str("\\");
Str* str274 = new Str("Unexpected escaped character %r");
Str* str275 = new Str("");
Str* str276 = new Str("");
Str* str277 = new Str("Malformed character class; treating as literal");
Str* str278 = new Str("Got unescaped right bracket");
Str* str279 = new Str("Got unescaped trailing backslash");
Str* str280 = new Str(".|^$()+*?[]{}\\");
Str* str281 = new Str("\\");
Str* str282 = new Str("\\");
Str* str283 = new Str("\\[");
...
Str* str290 = new Str("]");
Str* str291 = new Str("");
Str* str292 = new Str("Error expanding glob %r: %s");
Str* str293 = new Str("-");
Str* str294 = new Str("0x");
Str* str295 = new Str("Invalid hex constant %r");
Str* str296 = new Str("0");
Str* str297 = new Str("Invalid octal constant %r");
Str* str298 = new Str("#");
Str* str299 = new Str("#");
Str* str300 = new Str("Invalid base for numeric constant %r");
Str* str301 = new Str("a");
Str* str302 = new Str("z");
Str* str303 = new Str("a");
Str* str304 = new Str("A");
Str* str305 = new Str("Z");
Str* str306 = new Str("A");
Str* str307 = new Str("@");
Str* str308 = new Str("_");
Str* str309 = new Str("Invalid digits for numeric constant %r");
Str* str310 = new Str("Digits %r out of range for base %d");
Str* str311 = new Str("Invalid integer constant %r");
Str* str312 = new Str("Undefined variable %r");
Str* str313 = new Str("Can't assign to characters of string %r");
Str* str314 = new Str("Undefined variable can't be indexed");
Str* str315 = new Str("");
Str* str316 = new Str("");
Str* str317 = new Str("");
Str* str318 = new Str("Undefined value in arithmetic context");
Str* str319 = new Str("Expected a value convertible to integer, got %s");
Str* str320 = new Str("Can't use assignment like ++ or += on arrays");
Str* str321 = new Str("Divide by zero");
Str* str322 = new Str("Divide by zero");
Str* str323 = new Str("Expected array or assoc in index expression, got %s");
Str* str324 = new Str("Divide by zero");
Str* str325 = new Str("Divide by zero");
Str* str326 = new Str("Exponent can't be less than zero");
Str* str327 = new Str("Associative array keys must be strings: $x 'x' \"$x\" etc.");
...
Str* str385 = new Str(" `~!$&*()[]{}\\|;'\"<>?");
Str* str386 = new Str("DUMMY_parse_unimplemented");
Str* str387 = new Str("DUMMY_parse_unimplemented");
Str* str388 = new Str("Token can't be used in prefix position");
Str* str389 = new Str("Token can't be used in infix position");
Str* str390 = new Str("Left-hand side of this assignment is invalid");
Str* str391 = new Str("Parser expected %s, got %s");
Str* str392 = new Str("Unexpected end of input");
Str* str393 = new Str("Invalid token %s");
Str* str394 = new Str("warning: Invalid backslash escape in C-style string");
Str* str395 = new Str("BASH_SOURCE");
Str* str396 = new Str("FUNCNAME");
Str* str397 = new Str("BASH_LINENO");
Str* str398 = new Str("");
Str* str399 = new Str("");
Str* str400 = new Str("\\");
Str* str401 = new Str("\\\\");
Str* str402 = new Str("");
Str* str403 = new Str("The start index of a string slice can't be negative: %d");
Str* str404 = new Str("The length of a string slice can't be negative: %d");
Str* str405 = new Str("The length index of a array slice can't be negative: %d");
Str* str406 = new Str("Can't slice associative arrays");
Str* str407 = new Str("i");
Str* str408 = new Str("e");
Str* str409 = new Str("u");
Str* str410 = new Str("x");
Str* str411 = new Str("n");
Str* str412 = new Str("");
Str* str413 = new Str("~");
Str* str414 = new Str("HOME");
Str* str415 = new Str("@");
Str* str416 = new Str("*");
Str* str417 = new Str("@");
Str* str418 = new Str("*");
Str* str419 = new Str("warning: ");
Str* str420 = new Str("-1");
Str* str421 = new Str("@");
Str* str422 = new Str("*");
Str* str423 = new Str("[");
Str* str424 = new Str("]");
Str* str425 = new Str("Bad indirect expansion: %r");
Str* str426 = new Str("");
Str* str427 = new Str("");
Str* str428 = new Str("Undefined variable");
Str* str429 = new Str("$");
Str* str430 = new Str("Undefined variable %r");
Str* str431 = new Str("");
Str* str432 = new Str("Undefined array %r");
Str* str433 = new Str("Can't index string with @");
Str* str434 = new Str("Can't index string with *");
Str* str435 = new Str("Can't index string %r with integer");
Str* str436 = new Str("Array %r can't be referred to as a scalar (without @ or *)");
Str* str437 = new Str("\u0001");
Str* str438 = new Str("");
Str* str439 = new Str("\u0002");
Str* str440 = new Str("");
Str* str441 = new Str("Can't assign to special variable");
Str* str442 = new Str("unset variable %r");
Str* str443 = new Str("");
Str* str444 = new Str("warning: ");
Str* str445 = new Str("");
Str* str446 = new Str("Illegal array word part (strict_array)");
Str* str447 = new Str(" ");
Str* str448 = new Str("");
Str* str449 = new Str("Array %r can't be referred to as a scalar (without @ or *)");
Str* str450 = new Str("Unexpected array literal");
Str* str451 = new Str("Unexpected associative array literal");
Str* str452 = new Str("|");
Str* str453 = new Str(")");
Str* str454 = new Str("Can't splice %r");
Str* str455 = new Str("");
Str* str456 = new Str("");
Str* str457 = new Str("This word should yield a string, but it contains an array");
Str* str458 = new Str(" ");
Str* str459 = new Str("");
Str* str460 = new Str("<Runtime error: %s>");
Str* str461 = new Str("<I/O error: %s>");
Str* str462 = new Str("<I/O error: %s>");
Str* str463 = new Str("<Ctrl-C>");
Str* str464 = new Str("");
Str* str465 = new Str("");
Str* str466 = new Str("");
Str* str467 = new Str("");
Str* str468 = new Str("");
Str* str469 = new Str("LHS array not allowed in assignment builtin");
Str* str470 = new Str("+");
Str* str471 = new Str("+= not allowed in assignment builtin");
Str* str472 = new Str("-");
Str* str473 = new Str("+");
Str* str474 = new Str("");
Str* str475 = new Str("=");
Str* str476 = new Str("Invalid variable name %r");
Str* str477 = new Str("__NO_COMMAND_SUB__");
Str* str478 = new Str("__NO_PROCESS_SUB__");
Str* str479 = new Str("Expected : or } in slice");
Str* str480 = new Str("/");
Str* str481 = new Str("Pattern in ${x/pat/replace} must not be empty");
Str* str482 = new Str("Expected } after replacement string, got %s");
Str* str483 = new Str("Expected } or / to close pattern");
Str* str484 = new Str("Expected ] to close subscript");
Str* str485 = new Str("Expected } to close ${");
Str* str486 = new Str("Expected } to close ${");
Str* str487 = new Str("Expected } to close ${");
Str* str488 = new Str("Unexpected token in ${} (%s)");
Str* str489 = new Str("VOp2");
Str* str490 = new Str("Unexpected token in ${} (%s)");
Str* str491 = new Str("VOp3");
Str* str492 = new Str("Expected } to close ${");
Str* str493 = new Str("Expected } after length expression");
Str* str494 = new Str("Unexpected token in ${}");
Str* str495 = new Str("\\");
Str* str496 = new Str("Strings with backslashes should look like r'\\n' or c'\\n'");
Str* str497 = new Str("Unexpected EOF in single-quoted string that began here");
Str* str498 = new Str("Unexpected EOF reading extended glob that began here");
Str* str499 = new Str("Unexpected EOF reading double-quoted string that began here");
Str* str500 = new Str("Unexpected EOF while looking for closing backtick");
Str* str501 = new Str("");
Str* str502 = new Str("Invalid proc name %s");
Str* str503 = new Str("Expected first ) to end arith sub");
Str* str504 = new Str("Expected second ) to end arith sub");
Str* str505 = new Str("Expected first ) to end arith statement");
Str* str506 = new Str("Expected second ) to end arith statement");
Str* str507 = new Str("Expected ) to end for loop expression");
Str* str508 = new Str("Expected ( after =");
Str* str509 = new Str("Unexpected token in array literal");
Str* str510 = new Str("Expected associative array pair");
Str* str511 = new Str("Unexpected token after array literal");
Str* str512 = new Str("Unexpected token after array splice");
Str* str513 = new Str("Word has unbalanced { }.  Maybe add a space or quote it like \\{");
Str* str514 = new Str("Unexpected token in arithmetic context");
Str* str515 = new Str("Unhandled: %s (%s)");
Str* str516 = new Str("Invalid lex state %s");
Str* str517 = new Str("");
Str* str518 = new Str("");
Str* str519 = new Str("");
Str* str520 = new Str("");
...
Str* str524 = new Str("");
Str* str525 = new Str("");
Str* str526 = new Str("Compound shouldn't be empty");
Str* str527 = new Str("/");
Str* str528 = new Str("");
Str* str529 = new Str("EOF");
Str* str530 = new Str("typ");
Str* str531 = new Str("tok");
Str* str532 = new Str("children");
Str* str533 = new Str("-");
Str* str534 = new Str("with %d children");
Str* str535 = new Str("");
Str* str536 = new Str("(PNode %s %s %s)");
Str* str537 = new Str("&");
Str* str538 = new Str("&amp;");
Str* str539 = new Str("<");
Str* str540 = new Str("&lt;");
...
Str* fmt109(Str* a0, syntax_asdl::word_t* a1) {
  gBuf.reset();
...
syntax_asdl::sh_lhs_expr_t* ToLValue(syntax_asdl::arith_expr_t* node, bool parse_unimplemented);
...
Mem::Mem(Str* dollar0, List<Str*>* argv, alloc::Arena* arena, List<state::DebugFrame*>* debug_stack) {
  ...
  this->line_num = new value::Str(str107);
...
void Mem::_DisallowNamerefCycle(Str* name, List<Str*>* ref_trail) {
  ...
  if (list_contains(ref_trail, new_name)) {
    e_die(fmt22(str120->join(ref_trail)));
  }
...
Str* PrettyDir(Str* dir_name, runtime_asdl::value_t* UP_home_dir) {
  ...
  if (UP_home_dir and UP_home_dir->tag_() == value_e::Str) {
    ...
    if (dir_name == home_dir or dir_name->startswith(str_concat(home_dir, str137))) {
      return str_concat(str138, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    f->write(str_equals(c, str141) ? str142 : str143);
  }
  f->write(str144);
  f->write(str_repeat(str145, length - 1));
  f->write(str146);
}
...
void PrettyPrintError(error::_ErrorWithLocation* err, alloc::Arena* arena) {
  PrettyPrintError(err, arena, str157);
}
...
int LineLexer::GetSpanIdForEof() {
  ...
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str160, 0);
  }
  else {
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str161, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = new Token(id_, span_id, str162);
      return t;
    }
...
lexer::Lexer* ParseContext::_MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = new lexer::LineLexer(str164, this->arena);
...
int _Classify(grammar::Grammar* gr, syntax_asdl::Token* tok) {
  ...
  type_str = tok->id == Id::Unknown_Tok ? str170 : fmt37(ui::PrettyId(tok->id));
...
Tuple2<pnode::PNode*, syntax_asdl::Token*> ExprParser::Parse(lexer::Lexer* lexer, int start_symbol) {
  ...
  try {
    ...
    throw new error::Parse(str173, e->tok);
  }
...
List<Str*>* POSIX_CLASSES = new List<Str*>({str174, str175, str176, str177, str178, str179, str180, str181, str182, str183, str184, str185});
Str* RANGE_POINT_TOO_LONG = str186;
int NT_OFFSET = 256;
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw new NotImplementedError(str188);
  }
  if (id0 == Id::Op_LBracket) {
    elts = new List<syntax_asdl::expr_t*>();
    for (int i = 0; i < n; i += 2) {
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((tok->val == str198 || tok->val == str199 || tok->val == str200)) {
        return tok;
      }
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index(0), str233)) {
    pos = op_val->find(str234);
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    expanded->append(str239);
    i += 1;
  }
  code_str = str240->join(expanded);
  line_reader = reader::StringLineReader(code_str, this->arena);
...
syntax_asdl::command__ShFunction* CommandParser::ParseFunctionDef() {
  ...
  this->_Next();
  this->_Eat2(Id::Right_ShFunction, str257);
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if (str_equals(c, str265)) {
      i += 1;
    }
    else {
      if (str_equals(c, str266) or str_equals(c, str267)) {
        return true;
      }
      else {
        if (str_equals(c, str268)) {
          left_bracket = true;
        }
        else {
          if (str_equals(c, str269) and left_bracket) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  return util::BackslashEscape(s, str271);
}
Str* ERE_META_CHARS = str272;
...
Str* GlobUnescape(Str* s) {
  ...
  return str275->join(unescaped);
}

_GlobParser::_GlobParser(match::SimpleLexer* lexer) {
  this->lexer = lexer;
  this->token_type = Id::Undefined_Tok;
  this->token_val = str276;
...
int Globber::Expand(Str* arg, List<Str*>* out) {
  ...
  if (n) {
    for (ListIter<Str*> it(results); !it.Done(); it.Next()) {
      Str* name = it.Value();
      if (name->startswith(str293) and !this->exec_opts->dashglob()) {
        n -= 1;
        continue;
      }
      out->append(name);
...
int _StringToInteger(Str* s, int span_id) {
  ...
  if (s->startswith(str294)) {
    try {
      ...
      e_strict(fmt94(s), span_id);
    }
    return integer;
  }
  if (s->startswith(str296)) {
    try {
      integer = to_int(s, 8);
    }
    catch (ValueError*) {
      e_strict(fmt95(s), span_id);
    }
    return integer;
  }
  if (str_contains(s, str298)) {
    parts = s->split(str299, 1);
    b = parts->index(0);
    ...
    try {
      ...
      e_strict(fmt96(b), span_id);
    }
    integer = 0;
    n = 1;
    for (StrIter it(digits); !it.Done(); it.Next()) {
      Str* ch = it.Value();
      if (str301 <= ch and ch <= str302) {
        digit = ord(ch) - ord(str303) + 10;
      }
      else {
        if (str304 <= ch and ch <= str305) {
          digit = ord(ch) - ord(str306) + 36;
        }
        else {
          if (str_equals(ch, str307)) {
            digit = 62;
          }
          else {
            if (str_equals(ch, str308)) {
              digit = 63;
            }
            else {
              if (ch->isdigit()) {
      ...
      if (digit >= base) {
        e_strict(fmt98(digits, base), span_id);
      }
      integer += digit * n;
      n *= base;
    }
...
int ArithEvaluator::_ValToIntOrError(runtime_asdl::value_t* val, int span_id) {
  ...
  e_die(fmt103(ui::ValType(val)), span_id);
}
          ...
          if (op_id == Id::Arith_Star) {
            ...
            if (op_id == Id::Arith_Slash) {
              ...
              if (op_id == Id::Arith_Percent) {
                if (rhs == 0) {
                  e_die(fmt106(), location::SpanForArithExpr(node->right));
                }
                ret = lhs % rhs;
              }
              else {
  ...
  switch (node->tag_()) {
    ...
    case bool_expr_e::Unary: {
      ...
      if (arg_type == bool_arg_type_e::Other) {
        ...
        e_die(fmt108(ui::PrettyId(op_id)));
      }
      throw new AssertionError();
    }
      break;
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Slash) {
    try {
      ...
      msg = e->message;
      e_die(fmt115(regex, msg), this->slash_spid);
    }
  }
...
syntax_asdl::sh_lhs_expr_t* ToLValue(syntax_asdl::arith_expr_t* node, bool parse_unimplemented) {
  ...
  syntax_asdl::arith_expr_t* UP_left;
  ...
  switch (node->tag_()) {
    ...
    case arith_expr_e::ArithWord: {
      if (parse_unimplemented) {
        arith_expr__ArithWord* node = static_cast<arith_expr__ArithWord*>(UP_node);
        return new sh_lhs_expr::Name(str386);
      }
    }
      break;
    case arith_expr_e::Binary: {
      ...
      if (node->op_id == Id::Arith_LBracket) {
        ...
        if (node->left->tag_() == arith_expr_e::VarRef) {
          arith_expr__VarRef* left = static_cast<arith_expr__VarRef*>(UP_left);
        ...
        if (parse_unimplemented and node->left->tag_() == arith_expr_e::ArithWord) {
          return new sh_lhs_expr::IndexedName(str387, node->right);
        }
      }
    }
      break;
...
void TdopParser::Eat(int token_type) {
  if (!this->AtToken(token_type)) {
    p_die(fmt119(ui::PrettyId(token_type), ui::PrettyId(this->op_id)), this->cur_word);
  }
  this->Next();
}
...
using runtime_asdl::quote_e;
using runtime_asdl::quote_t;
List<Str*>* _STRING_AND_ARRAY = new List<Str*>({str395, str396, str397});
...
Str* _BackslashEscape(Str* s) {
  return s->replace(str400, str401);
}
...
runtime_asdl::value_t* _PerformSlice(runtime_asdl::value_t* val, int begin, int length, bool has_length, syntax_asdl::braced_var_sub* part, runtime_asdl::value__Str* arg0_val) {
  ...
  switch (val->tag_()) {
    case value_e::Str: {
      ...
      s = val->s;
      if (begin < 0) {
        e_strict(fmt121(begin), part);
      }
      byte_begin = string_ops::AdvanceUtf8Chars(s, begin, 0);
      if (has_length) {
        if (length < 0) {
          e_strict(fmt122(length), part);
        }
    ...
    case value_e::MaybeStrArray: {
      ...
      if (has_length and length < 0) {
        e_die(fmt123(length), part);
      }
      strs = new List<Str*>();
      if (arg0_val != nullptr) {
        if (begin == 0) {
          if (!has_length or length > 0) {
      ...
      case value_e::Str: {
        ...
        try {
          ...
          if (this->exec_opts->strict_word_eval()) {
            ...
            this->errfmt->PrettyPrintError(e, str419);
            return new value::Str(str420);
          }
        }
      }
        break;
    ...
    if (op_id == Id::VSub_Bang) {
      ...
      switch (val->tag_()) {
        case value_e::Str: {
          ...
          if ((val->s == str421 || val->s == str422)) {
            return new value::MaybeStrArray(this->mem->GetArgv());
          }
          i = val->s->find(str423);
          if (i >= 0 and str_equals(val->s->index(-1), str424)) {
...
void AbstractWordEvaluator::_EvalDoubleQuoted(List<syntax_asdl::word_part_t*>* parts, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  if (len(parts) == 0) {
    v = new part_value::String(str426, true, false);
    part_vals->append(v);
    return ;
  }
...
runtime_asdl::value__Str* AbstractWordEvaluator::_BashArrayCompat(runtime_asdl::value__MaybeStrArray* val) {
  ...
  s = val->strs ? val->strs->index(0) : str427;
  ...
  if (val->tag_() == value_e::Undef) {
    if (this->exec_opts->nounset()) {
      if (token == nullptr) {
        ...
        name = token->val->startswith(str429) ? token->val->slice(1) : token->val;
        e_die(fmt126(name), token);
      }
    }
    else {
      return new value::Str(str431);
    }
  }
  else {
    return val;
...
void AbstractWordEvaluator::_EvalBracedVarSub(syntax_asdl::braced_var_sub* part, List<runtime_asdl::part_value_t*>* part_vals, bool quoted) {
      ...
      case bracket_op_e::ArrayIndex: {
        ...
        switch (val->tag_()) {
          case value_e::Undef: {
            ...
            break;
          case value_e::Str: {
            e_die(fmt130(part->token->val), part->token);
          }
            break;
          case value_e::MaybeStrArray: {
            value__MaybeStrArray* array_val = static_cast<value__MaybeStrArray*>(UP_val);
  ...
  if (part->suffix_op and !suffix_processed) {
    op = part->suffix_op;
    UP_op = op;
    switch (op->tag_()) {
      case suffix_op_e::Nullary: {
        ...
        if (op->op_id == Id::VOp0_P) {
          ...
          p = prompt->replace(str437, str438)->replace(str439, str440);
          val = new value::Str(p);
        }
        else {
          ...
          if (effect == effect_e::SpliceParts) {
            ...
            if (effect == effect_e::SpliceAndAssign) {
              if (var_name == nullptr) {
                ...
                state::SetStringDynamic(this->mem, var_name, rhs_str);
              }
              return ;
            }
            else {
              if (effect == effect_e::Error) {
                ...
                e_die(fmt132(error_str), part->token);
              }
              else {
                ;  // pass
              }
      ...
      case suffix_op_e::Slice: {
        ...
        try {
          ...
          if (this->exec_opts->strict_word_eval()) {
            ...
            this->errfmt->PrettyPrintError(e, str444);
            switch (val->tag_()) {
              case value_e::Str: {
                val = new value::Str(str445);
              }
                break;
              case value_e::MaybeStrArray: {
  ...
  switch (part->tag_()) {
    ...
    case word_part_e::ExtGlob: {
      ...
      for (ListIter<syntax_asdl::word_t*> it(part->arms); !it.Done(); it.Next(), ++i) {
        syntax_asdl::word_t* w = it.Value();
        if (i != 0) {
          part_vals->append(new part_value::String(str452, false, false));
        }
        this->_EvalWordToParts(w, false, part_vals);
      }
      part_vals->append(new part_value::String(str453, false, false));
    }
      break;
...
void AbstractWordEvaluator::_EvalWordToParts(syntax_asdl::word_t* w, bool quoted, List<runtime_asdl::part_value_t*>* part_vals, bool is_subst) {
  ...
  switch (w->tag_()) {
    case word_e::Compound: {
      ...
      break;
    case word_e::Empty: {
      part_vals->append(new part_value::String(str455, quoted, !quoted));
    }
      break;
    default: {
      throw new AssertionError();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, runtime_asdl::quote_t quote_kind) {
  ...
  return new value::Str(str459->join(strs));
}
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalForPlugin(syntax_asdl::compound_word* w) {
  ...
  try {
    try {
      ...
      val = new value::Str(fmt139(e->UserErrorString()));
    }
    catch (OSError* e) {
      val = new value::Str(fmt140(pyutil::strerror_OS(e)));
    }
    catch (IOError* e) {
      val = new value::Str(fmt141(pyutil::strerror_IO(e)));
    }
    catch (KeyboardInterrupt*) {
      val = new value::Str(str463);
    }
  }
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index(-2), str470)) {
          e_die(fmt143(), w);
        }
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        if (arg->startswith(str472) or arg->startswith(str473)) {
          flags->append(arg);
...
syntax_asdl::suffix_op__PatSub* WordParser::_ReadPatSubVarOp(types_asdl::lex_mode_t lex_mode) {
  ...
  if (len(pat->parts) == 1) {
    ...
    s = tup0.at1();
    quoted = tup0.at2();
    if (ok and str_equals(s, str480) and !quoted) {
      this->_Next(lex_mode);
      this->_Peek();
  ...
  if (this->token_type == Id::Lit_Slash) {
    ...
    this->_Peek();
    if (this->token_type != Id::Right_DollarBrace) {
      p_die(fmt147(ui::PrettyId(this->token_type)), this->cur_token);
    }
        ...
        if (op_kind == Kind::VOp2) {
          if (this->token_type == Id::VOp2_Slash) {
            ...
            if (this->token_type == Id::VOp2_Colon) {
              ...
              p_die(fmt153(str489), this->cur_token);
            }
          }
        }
        else {
          if (op_kind == Kind::VOp3) {
            if (allow_query) {
              ...
              p_die(fmt154(str491), this->cur_token);
            }
          }
        }
      }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool no_backslashes) {
  ...
  while (!done) {
    ...
    if ((this->token_kind == Kind::Lit || this->token_kind == Kind::Char)) {
      tok = this->cur_token;
      if (no_backslashes and str_contains(tok->val, str495)) {
        p_die(fmt158(), tok);
      }
      tokens->append(tok);
    }
...
void WordParser::ParseProc(syntax_asdl::command__Proc* node) {
  ...
  if (this->token_type != Id::Lit_Chars) {
    p_die(fmt163(ui::PrettyToken(this->cur_token, this->arena)), this->cur_token);
  }
  ...
  switch (part->tag_()) {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str520, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str521->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
    ...
    case word_part_e::ExtGlob: 
    case word_part_e::Splice: {
      return (Tuple3<bool, Str*, bool>(false, str522, false));
    }
      break;
    default: {
      throw new AssertionError();
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() != word_e::Compound) {
    return (Tuple3<bool, Str*, bool>(false, str523, quoted));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  strs = new List<Str*>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str524, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str525->join(strs), quoted));
}
...
Str* escape(Str* s) {
  s = s->replace(str537, str538);
  s = s->replace(str539, str540);
  s = s->replace(str541, str542);
  return s;
}

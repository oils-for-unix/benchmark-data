...
namespace Id {
  ...
  const int BoolUnary_z = 298;
  const int BoolUnary_n = 299;
  const int BoolUnary_o = 300;
  const int BoolUnary_t = 301;
  const int BoolUnary_v = 302;
  const int BoolUnary_R = 303;
  const int BoolUnary_a = 304;
  const int BoolUnary_b = 305;
  const int BoolUnary_c = 306;
  const int BoolUnary_d = 307;
  const int BoolUnary_e = 308;
  const int BoolUnary_f = 309;
  const int BoolUnary_g = 310;
  const int BoolUnary_h = 311;
  const int BoolUnary_k = 312;
  const int BoolUnary_L = 313;
  const int BoolUnary_p = 314;
  const int BoolUnary_r = 315;
  const int BoolUnary_s = 316;
  const int BoolUnary_S = 317;
  const int BoolUnary_u = 318;
  const int BoolUnary_w = 319;
  const int BoolUnary_x = 320;
  const int BoolUnary_O = 321;
  const int BoolUnary_G = 322;
  const int BoolUnary_N = 323;
  const int BoolBinary_GlobEqual = 324;
  const int BoolBinary_GlobDEqual = 325;
  const int BoolBinary_GlobNEqual = 326;
  const int BoolBinary_EqualTilde = 327;
  const int BoolBinary_ef = 328;
  const int BoolBinary_nt = 329;
  const int BoolBinary_ot = 330;
  const int BoolBinary_eq = 331;
  const int BoolBinary_ne = 332;
  const int BoolBinary_gt = 333;
  const int BoolBinary_ge = 334;
  const int BoolBinary_lt = 335;
  const int BoolBinary_le = 336;
  const int BoolBinary_Equal = 337;
  const int BoolBinary_DEqual = 338;
  const int BoolBinary_NEqual = 339;

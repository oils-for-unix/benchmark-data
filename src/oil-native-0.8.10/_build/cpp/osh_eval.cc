...
GLOBAL_STR(str302, "[ headless ]");
GLOBAL_STR(str303, "[ -c flag ]");
GLOBAL_STR(str304, "[ stdin%s ]");
GLOBAL_STR(str305, "[ expansion of alias %r ]");
GLOBAL_STR(str306, "[ backticks at ... ]");
GLOBAL_STR(str307, "[ array LValue in %s ]");
GLOBAL_STR(str308, "[ eval at line %d of %s ]");
GLOBAL_STR(str309, "[ trap ]");
GLOBAL_STR(str310, "[ variable ]");
GLOBAL_STR(str311, "%s:%d: %s%s\n");
GLOBAL_STR(str312, "[??? no location ???] %s%s\n");
GLOBAL_STR(str313, "");
GLOBAL_STR(str314, "");
GLOBAL_STR(str315, "");
GLOBAL_STR(str316, "none");
GLOBAL_STR(str317, "AST not printed.");
GLOBAL_STR(str318, "text");
GLOBAL_STR(str319, "abbrev-text");
GLOBAL_STR(str320, "html");
GLOBAL_STR(str321, "abbrev-html");
GLOBAL_STR(str322, "abbrev-");
GLOBAL_STR(str323, "\n");
GLOBAL_STR(str324, "\n");
GLOBAL_STR(str325, "-");
GLOBAL_STR(str326, "_");
GLOBAL_STR(str327, "<_Attributes %s>");
GLOBAL_STR(str328, "<args.Reader %r %d>");
GLOBAL_STR(str329, "expected argument to %r");
GLOBAL_STR(str330, "-");
GLOBAL_STR(str331, "expected integer after %s, got %r");
GLOBAL_STR(str332, "-");
GLOBAL_STR(str333, "got invalid integer for %s: %s");
GLOBAL_STR(str334, "-");
GLOBAL_STR(str335, "expected number after %r, got %r");
GLOBAL_STR(str336, "-");
GLOBAL_STR(str337, "got invalid float for %s: %s");
GLOBAL_STR(str338, "-");
GLOBAL_STR(str339, "got invalid argument %r to %r, expected one of: %s");
GLOBAL_STR(str340, "-");
GLOBAL_STR(str341, "|");
GLOBAL_STR(str342, "0");
GLOBAL_STR(str343, "F");
...
GLOBAL_STR(str346, "1");
GLOBAL_STR(str347, "T");
GLOBAL_STR(str348, "true");
GLOBAL_STR(str349, "Talse");
GLOBAL_STR(str350, "got invalid argument to boolean flag: %r");
GLOBAL_STR(str351, "-");
GLOBAL_STR(str352, "-");
GLOBAL_STR(str353, "got invalid option %r");
GLOBAL_STR(str354, "Expected argument for action");
GLOBAL_STR(str355, "Invalid action name %r");
GLOBAL_STR(str356, "--");
GLOBAL_STR(str357, "--");
GLOBAL_STR(str358, "got invalid flag %r");
GLOBAL_STR(str359, "-");
GLOBAL_STR(str360, "0");
GLOBAL_STR(str361, "Z");
GLOBAL_STR(str362, "-");
GLOBAL_STR(str363, "doesn't accept flag %s");
GLOBAL_STR(str364, "-");
GLOBAL_STR(str365, "+");
GLOBAL_STR(str366, "+");
GLOBAL_STR(str367, "doesn't accept option %s");
GLOBAL_STR(str368, "+");
GLOBAL_STR(str369, "-");
GLOBAL_STR(str370, "--");
GLOBAL_STR(str371, "--");
GLOBAL_STR(str372, "got invalid flag %r");
GLOBAL_STR(str373, "-");
GLOBAL_STR(str374, "+");
GLOBAL_STR(str375, "got invalid flag %r");
GLOBAL_STR(str376, "-");
GLOBAL_STR(str377, "^--?([a-zA-Z0-9][a-zA-Z0-9\\-]*)(=.*)?$");
GLOBAL_STR(str378, "<LineLexer at pos %d of line %r (id = %d)>");
GLOBAL_STR(str379, "");
GLOBAL_STR(str380, "");
GLOBAL_STR(str381, "");
GLOBAL_STR(str382, "");
GLOBAL_STR(str383, "<Trail %s %s %s %s>");
GLOBAL_STR(str384, "");
GLOBAL_STR(str385, "ShAssignment expression can't be nested like this");
GLOBAL_STR(str386, "Here docs aren't allowed in expressions");
GLOBAL_STR(str387, "\n");
GLOBAL_STR(str388, "");
GLOBAL_STR(str389, " (%s)");
GLOBAL_STR(str390, "Unexpected token in expression mode%s");
GLOBAL_STR(str391, "Syntax error in expression (near %s)");
GLOBAL_STR(str392, "alnum");
GLOBAL_STR(str393, "cntrl");
GLOBAL_STR(str394, "lower");
GLOBAL_STR(str395, "space");
GLOBAL_STR(str396, "alpha");
GLOBAL_STR(str397, "digit");
GLOBAL_STR(str398, "print");
GLOBAL_STR(str399, "upper");
GLOBAL_STR(str400, "blank");
GLOBAL_STR(str401, "graph");
GLOBAL_STR(str402, "punct");
GLOBAL_STR(str403, "xdigit");
GLOBAL_STR(str404, "Range start/end shouldn't have more than one character");
GLOBAL_STR(str405, "Write singleton tuples with tup(), not a trailing comma");
GLOBAL_STR(str406, "testlist_comp");
GLOBAL_STR(str407, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str408, "Can't assign to this expression");
GLOBAL_STR(str409, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str410, "TODO");
GLOBAL_STR(str411, "dot");
GLOBAL_STR(str412, "Can't negate this symbol");
GLOBAL_STR(str413, "%r isn't a character class");
GLOBAL_STR(str414, "Can't negate this symbol");
GLOBAL_STR(str415, "%r isn't a character class");
GLOBAL_STR(str416, "%start");
GLOBAL_STR(str417, "%end");
GLOBAL_STR(str418, "dot");
GLOBAL_STR(str419, "Unexpected token %r in regex");
GLOBAL_STR(str420, "%s-%s");
GLOBAL_STR(str421, "ERE can't express code point %d");
GLOBAL_STR(str422, "Perl classes can't be negated in ERE");
GLOBAL_STR(str423, "%s");
GLOBAL_STR(str424, "POSIX classes can't be negated in ERE");
GLOBAL_STR(str425, "[:%s:]");
GLOBAL_STR(str426, ".");
GLOBAL_STR(str427, "^");
GLOBAL_STR(str428, "$");
GLOBAL_STR(str429, "|");
GLOBAL_STR(str430, "POSIX EREs don't have groups without capture, so this node needs () around it.");
GLOBAL_STR(str431, "+");
GLOBAL_STR(str432, "*");
GLOBAL_STR(str433, "?");
GLOBAL_STR(str434, "{%s}");
...
GLOBAL_STR(str445, "^");
GLOBAL_STR(str446, "]");
GLOBAL_STR(str447, "The [ operator doesn't apply to this expression");
GLOBAL_STR(str448, "Expected ]]");
GLOBAL_STR(str449, "Unexpected trailing word %s");
GLOBAL_STR(str450, "Invalid argument to unary operator");
GLOBAL_STR(str451, "Expected ), got %s");
GLOBAL_STR(str452, "Unexpected token in boolean expression (%s)");
GLOBAL_STR(str453, "");
GLOBAL_STR(str454, "Expected %d, got %d");
GLOBAL_STR(str455, "Step can't be 0");
GLOBAL_STR(str456, "Invalid step %d for ascending integer range");
GLOBAL_STR(str457, "Invalid step %d for descending integer range");
GLOBAL_STR(str458, "Invalid step %d for ascending character range");
GLOBAL_STR(str459, "Invalid step %d for descending character range");
GLOBAL_STR(str460, "Mismatched cases in character range");
GLOBAL_STR(str461, "");
GLOBAL_STR(str462, "0");
GLOBAL_STR(str463, "0");
GLOBAL_STR(str464, "g");
...
GLOBAL_STR(str501, ")");
GLOBAL_STR(str502, "");
GLOBAL_STR(str503, "export_");
GLOBAL_STR(str504, "doesn't accept -f because it's dangerous.  (The code can usually be restructured with 'source')");
GLOBAL_STR(str505, "doesn't accept RHS with -n");
GLOBAL_STR(str506, "Got -a but RHS isn't an array");
GLOBAL_STR(str507, "Got -A but RHS isn't an associative array");
GLOBAL_STR(str508, "readonly");
GLOBAL_STR(str509, "new_var");
GLOBAL_STR(str510, "with -f expects function names");
GLOBAL_STR(str511, "declare -f %s");
GLOBAL_STR(str512, "-");
GLOBAL_STR(str513, "-");
GLOBAL_STR(str514, "-");
GLOBAL_STR(str515, "+");
GLOBAL_STR(str516, "+");
GLOBAL_STR(str517, "+");
GLOBAL_STR(str518, "Invalid unset expression");
GLOBAL_STR(str519, "expected a variable name.  shopt -s eval_unsafe_arith allows expressions");
GLOBAL_STR(str520, "unset");
GLOBAL_STR(str521, "Invalid shift argument %r");
GLOBAL_STR(str522, "got too many arguments");
GLOBAL_STR(str523, "eval");
GLOBAL_STR(str524, "requires code string");
GLOBAL_STR(str525, "requires exactly 1 argument");
GLOBAL_STR(str526, " ");
GLOBAL_STR(str527, "eval");
GLOBAL_STR(str528, "source");
GLOBAL_STR(str529, "missing required argument");
GLOBAL_STR(str530, "source %r failed: %s");
GLOBAL_STR(str531, "source");
GLOBAL_STR(str532, "command");
GLOBAL_STR(str533, "Can't run assignment builtin recursively");
GLOBAL_STR(str534, "%r isn't a shell builtin");
GLOBAL_STR(str535, "sigpipe");
...
GLOBAL_STR(str584, ":");
GLOBAL_STR(str585, "\n");
GLOBAL_STR(str586, "cd");
GLOBAL_STR(str587, "HOME");
GLOBAL_STR(str588, "HOME");
GLOBAL_STR(str589, "-");
GLOBAL_STR(str590, "OLDPWD");
GLOBAL_STR(str591, "PWD");
GLOBAL_STR(str592, "cd %r: %s");
GLOBAL_STR(str593, "PWD");
GLOBAL_STR(str594, "OLDPWD");
GLOBAL_STR(str595, "%2d  %s");
GLOBAL_STR(str596, " ");
GLOBAL_STR(str597, "pushd: no other directory");
GLOBAL_STR(str598, "got too many arguments");
GLOBAL_STR(str599, "pushd: %r: %s");
GLOBAL_STR(str600, "HOME");
GLOBAL_STR(str601, "PWD");
GLOBAL_STR(str602, "popd: directory stack is empty");
GLOBAL_STR(str603, "popd: %r: %s");
GLOBAL_STR(str604, "PWD");
GLOBAL_STR(str605, "got extra argument");
GLOBAL_STR(str606, "HOME");
GLOBAL_STR(str607, "dirs");
GLOBAL_STR(str608, "HOME");
GLOBAL_STR(str609, "pwd");
GLOBAL_STR(str610, "_devbuild/help/groups.txt");
GLOBAL_STR(str611, "help");
GLOBAL_STR(str612, "help");
GLOBAL_STR(str613, "_devbuild/help/%s");
GLOBAL_STR(str614, "no help topics match %r");
GLOBAL_STR(str615, "# +");
GLOBAL_STR(str616, "osh printf doesn't support the %r flag");
GLOBAL_STR(str617, "eEfFgG");
GLOBAL_STR(str618, "osh printf doesn't support floating point");
GLOBAL_STR(str619, "c");
GLOBAL_STR(str620, "osh printf doesn't support single characters (bytes)");
GLOBAL_STR(str621, "Invalid printf format character");
GLOBAL_STR(str622, "Expected a printf format character");
GLOBAL_STR(str623, "%");
GLOBAL_STR(str624, "");
GLOBAL_STR(str625, "printf got invalid width %r");
GLOBAL_STR(str626, "0");
GLOBAL_STR(str627, "");
GLOBAL_STR(str628, "printf got invalid precision %r");
GLOBAL_STR(str629, "");
GLOBAL_STR(str630, "s");
GLOBAL_STR(str631, "q");
GLOBAL_STR(str632, "b");
GLOBAL_STR(str633, "");
GLOBAL_STR(str634, "diouxX");
GLOBAL_STR(str635, "'\"");
GLOBAL_STR(str636, "printf expected an integer, got %r");
GLOBAL_STR(str637, "TZ");
GLOBAL_STR(str638, "TZ");
GLOBAL_STR(str639, "ouxX");
GLOBAL_STR(str640, "Can't format negative number %d with %%%s");
GLOBAL_STR(str641, "o");
GLOBAL_STR(str642, "x");
GLOBAL_STR(str643, "X");
GLOBAL_STR(str644, "0");
...
GLOBAL_STR(str650, " ");
GLOBAL_STR(str651, " ");
GLOBAL_STR(str652, "printf");
GLOBAL_STR(str653, "requires a format string");
GLOBAL_STR(str654, "");
...
void PrettyPrintError(error::_ErrorWithLocation* err, alloc::Arena* arena) {
  PrettyPrintError(err, arena, str313);
}
...
void ErrorFormatter::Print_(Str* msg, int span_id) {
  ...
  _PrintWithOptionalSpanId(str314, msg, span_id, this->arena);
}
...
void PrintAst(syntax_asdl::command_t* node, arg_types::main* flag) {
  ...
  if (maybe_str_equals(flag->ast_format, str316)) {
    println_stderr(str317);
  }
  else {
    f = mylib::Stdout();
    afmt = flag->ast_format;
    if ((maybe_str_equals(afmt, str318) || maybe_str_equals(afmt, str319))) {
      ast_f = fmt::DetectConsoleOutput(f);
    }
    else {
      if ((maybe_str_equals(afmt, str320) || maybe_str_equals(afmt, str321))) {
...
void _Attributes::Set(Str* name, runtime_asdl::value_t* val) {
  ...
  name = name->replace(str325, str326);
...
bool SetAttachedBool::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  if (attached_arg != nullptr) {
    if ((str_equals(attached_arg, str342) || str_equals(attached_arg, str343) || str_equals(attached_arg, str344) || str_equals(attached_arg, str345))) {
      b = false;
    }
    else {
      if ((str_equals(attached_arg, str346) || str_equals(attached_arg, str347) || str_equals(attached_arg, str348) || str_equals(attached_arg, str349))) {
        b = true;
      }
      else {
...
args::_Attributes* Parse(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str356)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if ((len(spec->actions_long) and arg->startswith(str357))) {
      ...
      if ((arg->startswith(str359) and len(arg) > 1)) {
        n = len(arg);
        for (int i = 1; i < n; ++i) {
          ch = arg->index(i);
          if (str_equals(ch, str360)) {
            ch = str361;
          }
          if (list_contains(spec->plus_flags, ch)) {
            out->Set(ch, Alloc<value::Str>(str362));
            continue;
          }
        ...
        if ((len(spec->plus_flags) and (arg->startswith(str365) and len(arg) > 1))) {
          n = len(arg);
          for (int i = 1; i < n; ++i) {
            ch = arg->index(i);
            if (list_contains(spec->plus_flags, ch)) {
              out->Set(ch, Alloc<value::Str>(str366));
              continue;
            }
            e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
          }
...
args::_Attributes* ParseLikeEcho(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    chars = arg->slice(1);
    if ((arg->startswith(str369) and len(chars))) {
      done = false;
...
args::_Attributes* ParseMore(flag_spec::_FlagSpecAndMore* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str370)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if (arg->startswith(str371)) {
      action = spec->actions_long->get(arg->slice(2));
      if (action == nullptr) {
        e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
      }
    ...
    if (((arg->startswith(str373) or arg->startswith(str374)) and len(arg) > 1)) {
      char0 = arg->index(0);
...
int LineLexer::GetSpanIdForEof() {
  int line_id;
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str379, 0);
  }
  else {
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str381, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = Alloc<Token>(id_, span_id, str382);
      return t;
    }
...
lexer::Lexer* ParseContext::_MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = Alloc<lexer::LineLexer>(str384, this->arena);
...
int _Classify(grammar::Grammar* gr, syntax_asdl::Token* tok) {
  ...
  type_str = tok->id == Id::Unknown_Tok ? str388 : fmt84(ui::PrettyId(tok->id));
...
GLOBAL_LIST(Str*, 12, POSIX_CLASSES, {str392 COMMA str393 COMMA str394 COMMA str395 COMMA str396 COMMA str397 COMMA str398 COMMA str399 COMMA str400 COMMA str401 COMMA str402 COMMA str403});
Str* RANGE_POINT_TOO_LONG = str404;
int NT_OFFSET = 256;
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw Alloc<NotImplementedError>(str406);
  }
  if (id0 == Id::Op_LBracket) {
    elts = Alloc<List<syntax_asdl::expr_t*>>();
    for (int i = 0; i < n; i += 2) {
...
syntax_asdl::re_t* Transformer::_NameInRegex(syntax_asdl::Token* negated_tok, syntax_asdl::Token* tok) {
  ...
  val = tok->val;
  if (maybe_str_equals(val, str411)) {
    if (negated_tok) {
      p_die(fmt89(), tok);
    }
    return tok;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((str_equals(tok->val, str416) || str_equals(tok->val, str417) || str_equals(tok->val, str418))) {
        return tok;
      }
...
void AsPosixEre(syntax_asdl::re_t* node, List<Str*>* parts) {
  ...
  if (tag == re_e::Repeat) {
    ...
    if (op_tag == re_repeat_e::Range) {
      ...
      lower = op->lower ? op->lower->val : str435;
      upper = op->upper ? op->upper->val : str436;
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  flag_A = (tmp_A and tmp_A->tag_() == value_e::Bool) ? static_cast<value__Bool*>(tmp_A)->b : false;
  tmp_n = flag->get(str467);
  tmp_r = flag->get(str468);
  tmp_x = flag->get(str469);
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if (print_flags) {
      ...
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str483, str484->join(flags), str485, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str486, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (has_holes) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str489, name, str490, str(i), str491, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str493, str494->join(body), str495}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str497, key_quoted, str498, value_quoted}));
          }
          if (len(body) > 0) {
            decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str499, str500->join(body), str501}));
          }
        }
        else {
          ;  // pass
...
int Export::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r->Next();
  attrs = flag_spec::Parse(str503, arg_r);
...
int NewVar::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  flags = 0;
  if (maybe_str_equals(arg->x, str512)) {
    flags |= state::SetExport;
  }
  if (maybe_str_equals(arg->r, str513)) {
    flags |= state::SetReadOnly;
  }
  if (maybe_str_equals(arg->n, str514)) {
    flags |= state::SetNameref;
  }
  flags_to_clear = 0;
  if (maybe_str_equals(arg->x, str515)) {
    flags |= state::ClearExport;
  }
  if (maybe_str_equals(arg->r, str516)) {
    flags |= state::ClearReadOnly;
  }
  if (maybe_str_equals(arg->n, str517)) {
...
int Unset::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str520, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
...
int Eval::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str523, cmd_val);
  arg_r = tup0.at1();
  if (this->exec_opts->simple_eval_builtin()) {
    Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str524);
    code_str = tup1.at0();
    eval_spid = tup1.at1();
    if (!arg_r->AtEnd()) {
      e_usage(str525);
    ...
    code_str = str526->join(arg_r->Rest());
  ...
  {  // with
    dev::ctx_Tracer ctx(this->tracer, str527, nullptr);
...
int Source::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str528, cmd_val);
  arg_r = tup2.at1();
  path = arg_r->Peek();
  if (path == nullptr) {
    e_usage(str529);
  ...
  try {
    try {
      ...
      c_parser = this->parse_ctx->MakeOshParser(line_reader);
      {  // with
        dev::ctx_Tracer ctx(this->tracer, str531, cmd_val->argv);
...
int Command::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup3 = flag_spec::ParseCmdVal(str532, cmd_val);
  attrs = tup3.at0();
  arg_r = tup3.at1();
...
int Builtin::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (to_run == consts::NO_INDEX) {
    ...
    if (consts::LookupAssignBuiltin(name) != consts::NO_INDEX) {
      this->errfmt->Print_(str533, span_id);
    }
    else {
...
int _AdjustStatus(Str* status_ok, int status) {
  ...
  if ((str_equals(status_ok->lower(), str535) and status == 141)) {
    status = 0;
  }
  return status;
}
...
int MapFile::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseCmdVal(str582, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  while (true) {
    ...
    if ((arg->t and line->endswith(str585))) {
      line = line->slice(0, -1);
    }
    lines->append(line);
  }
...
int Cd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseCmdVal(str586, cmd_val);
  attrs = tup11.at0();
  arg_r = tup11.at1();
  ...
  arg_spid = tup12.at1();
  if (dest_dir == nullptr) {
    val = this->mem->GetValue(str587);
    try {
      dest_dir = state::GetString(this->mem, str588);
    }
    catch (error::Runtime* e) {
  ...
  if (str_equals(dest_dir, str589)) {
    try {
      dest_dir = state::GetString(this->mem, str590);
      print(dest_dir);
    }
    catch (error::Runtime* e) {
      this->errfmt->Print_(e->UserErrorString());
  ...
  try {
    pwd = state::GetString(this->mem, str591);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    return 1;
  ...
  state::ExportGlobalString(this->mem, str593, real_dest_dir);
  ...
  if (cmd_val->block) {
    ...
    state::ExportGlobalString(this->mem, str594, pwd);
...
int Pushd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str600));
  state::ExportGlobalString(this->mem, str601, dest_dir);
...
bool _PopDirStack(state::Mem* mem, state::DirStack* dir_stack, ui::ErrorFormatter* errfmt) {
  ...
  state::SetGlobalString(mem, str604, dest_dir);
  mem->SetPwd(dest_dir);
  return true;
}
...
int Popd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str606));
  return 0;
}
...
int Dirs::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup13 = flag_spec::ParseCmdVal(str607, cmd_val);
  attrs = tup13.at0();
  arg_r = tup13.at1();
  arg = Alloc<arg_types::dirs>(attrs->attrs);
  home_dir = state::MaybeString(this->mem, str608);
  style = SINGLE_LINE;
  if (arg->l) {
    home_dir = nullptr;
  }
...
int Pwd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup14 = flag_spec::ParseCmdVal(str609, cmd_val);
  attrs = tup14.at0();
  arg_r = tup14.at1();
...
List<Str*>* Help::_Groups() {
  ...
  contents = this->loader->Get(str610);
...
int Help::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str611, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
...
syntax_asdl::printf_part_t* _FormatStringParser::_ParseFormatStr() {
  ...
  if ((this->token_type == Id::Format_Type || this->token_type == Id::Format_Time)) {
    ...
    if (str_contains(str617, part->type->val)) {
      p_die(fmt142(), part->type);
    }
    if (maybe_str_equals(part->type->val, str619)) {
          ...
          if (str_equals(typ, str630)) {
            ...
            if (str_equals(typ, str631)) {
              ...
              if (str_equals(typ, str632)) {
                ...
                s = str633->join(c_parts);
              }
              else {
                if ((part->type->id == Id::Format_Time or str_contains(str634, typ))) {
                  try {
                    d = to_int(s);
                  }
                  catch (ValueError*) {
                    if ((len(s) >= 1 and str_contains(str635, s->index(0)))) {
                  ...
                  if (part->type->id == Id::Format_Time) {
                    ...
                    if ((d < 0 and str_contains(str639, typ))) {
                    ...
                    zero_pad = 0;
                    if ((width >= 0 and list_contains(flags, str644))) {
                      zero_pad = 1;
                    }
                    else {
                    ...
                    if (zero_pad) {
                      negative = str_equals(s->index(0), str645);
                      if (negative) {
                        digits = s->slice(1);
                        sign = str646;
                        if (zero_pad == 1) {
                      ...
                      s = str_concat(sign, digits->rjust(n, str648));
                    }
                  }
                }
                else {
...
int Printf::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup1 = flag_spec::ParseCmdVal(str652, cmd_val);
  attrs = tup1.at0();
  arg_r = tup1.at1();
  arg = Alloc<arg_types::printf>(attrs->attrs);
  Tuple2<Str*, int> tup2 = arg_r->ReadRequired2(str653);
  fmt = tup2.at0();
  fmt_spid = tup2.at1();

...
List<int>* STRICT_ALL = new List<int>({1, 23, 2, 22, 3, 24, 25, 26, 27, 28, 32, 29, 31, 30});
List<int>* OIL_BASIC = new List<int>({41, 39, 1, 40, 23, 2, 22, 33, 34, 35, 37, 36, 3, 42, 38, 24, 25, 26, 27, 28, 32, 29, 31, 30, 43});
List<int>* OIL_ALL = new List<int>({41, 39, 1, 40, 23, 2, 22, 51, 33, 46, 47, 48, 34, 49, 45, 50, 35, 44, 37, 36, 3, 42, 52, 53, 54, 38, 24, 25, 26, 27, 28, 32, 29, 31, 30, 43});
List<int>* DEFAULT_TRUE = new List<int>({20, 39, 21, 40, 13, 47, 48, 49, 50, 19});
List<int>* PARSE_OPTION_NUMS = new List<int>({40, 51, 33, 46, 47, 48, 34, 49, 17, 45, 50, 35, 44, 55, 37, 36});
List<int>* SHOPT_OPTION_NUMS = new List<int>({20, 61, 62, 63, 64, 65, 66, 67, 60, 41, 18, 68, 39, 69, 70, 71, 21, 16, 72, 40, 73, 15, 74, 14, 75, 76, 77, 78, 58, 79, 80, 59, 81, 23, 82, 56, 83, 84, 85, 86, 87, 88, 89, 90, 22, 51, 33, 46, 47, 48, 34, 49, 17, 45, 50, 35, 44, 55, 37, 36, 42, 57, 91, 92, 93, 94, 52, 53, 54, 38, 95, 24, 25, 26, 27, 28, 32, 29, 31, 30, 19, 96, 43});
List<int>* SET_OPTION_NUMS = new List<int>({11, 1, 13, 8, 4, 7, 2, 3, 9, 6, 10, 5});
List<int>* VISIBLE_SHOPT_NUMS = new List<int>({20, 41, 18, 39, 21, 16, 40, 15, 14, 23, 22, 51, 33, 46, 47, 48, 34, 49, 17, 45, 50, 35, 44, 55, 37, 36, 42, 52, 53, 54, 38, 24, 25, 26, 27, 28, 32, 29, 31, 30, 19, 43});

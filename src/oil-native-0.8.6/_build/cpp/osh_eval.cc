...
GLOBAL_STR(str56, "");
GLOBAL_STR(str57, "${X_indent}${X_punct}${X_tag} ");
GLOBAL_STR(str58, "+ ");
GLOBAL_STR(str59, "PS4");
GLOBAL_STR(str60, "<ERROR: Can't parse PS4: %s>");
GLOBAL_STR(str61, " ");
GLOBAL_STR(str62, " ");
GLOBAL_STR(str63, "|");
GLOBAL_STR(str64, "process %d\n");
GLOBAL_STR(str65, ".");
GLOBAL_STR(str66, "process %d (status %d)\n");
GLOBAL_STR(str67, "  ");
GLOBAL_STR(str68, ">");
GLOBAL_STR(str69, "\n");
GLOBAL_STR(str70, "<");
...
GLOBAL_STR(str85, "\n");
GLOBAL_STR(str86, "?");
GLOBAL_STR(str87, "%s[%d]");
GLOBAL_STR(str88, "%s[%s]");
GLOBAL_STR(str89, "+=");
GLOBAL_STR(str90, "=");
GLOBAL_STR(str91, "\n");
GLOBAL_STR(str92, " ");
...
GLOBAL_STR(str95, " ...");
GLOBAL_STR(str96, "\n");
GLOBAL_STR(str97, "<_ControlFlow %s>");
GLOBAL_STR(str98, "Invalid control flow %r in pipeline / subshell / background");
GLOBAL_STR(str99, "%r ");
GLOBAL_STR(str100, "");
GLOBAL_STR(str101, "Command evaluated to an empty argv array");
GLOBAL_STR(str102, "Can't run assignment builtin recursively");
GLOBAL_STR(str103, "errexit was disabled for this construct");
GLOBAL_STR(str104, "");
GLOBAL_STR(str105, "Can't run a proc while errexit is disabled. Use 'run' or wrap it in a process with $0 myproc");
GLOBAL_STR(str106, "proc %s");
GLOBAL_STR(str107, "Unexpected block passed to external command %r");
GLOBAL_STR(str108, "%r not found");
GLOBAL_STR(str109, "[%%%d] Started Pipeline with PID %d");
GLOBAL_STR(str110, "[%%%d] Started PID %d");
GLOBAL_STR(str111, "Command subs not allowed here because status wouldn't be checked (strict_errexit).");
GLOBAL_STR(str112, "__cat");
GLOBAL_STR(str113, "Command sub exited with status %d (%s)");
GLOBAL_STR(str114, "");
GLOBAL_STR(str115, "\n");
GLOBAL_STR(str116, "/dev/fd/%d");
GLOBAL_STR(str117, "/dev/fd/%d");
GLOBAL_STR(str118, "<_FdFrame %s>");
GLOBAL_STR(str119, "r");
GLOBAL_STR(str120, "%d: %s");
GLOBAL_STR(str121, "%d: %s");
GLOBAL_STR(str122, "%d: %s");
GLOBAL_STR(str123, "Can't open %r: %s");
GLOBAL_STR(str124, "Error closing descriptor %d: %s");
GLOBAL_STR(str125, "dup2(%d, %d) error: %s");
GLOBAL_STR(str126, "<StdinFromPipe %d %d>");
GLOBAL_STR(str127, "<StdoutToPipe %d %d>");
GLOBAL_STR(str128, "/bin/sh");
GLOBAL_STR(str129, "/bin/sh");
GLOBAL_STR(str130, "Can't execute %r: %s");
GLOBAL_STR(str131, "[process] %s");
GLOBAL_STR(str132, " ");
GLOBAL_STR(str133, "[subprog] %s");
GLOBAL_STR(str134, "");
GLOBAL_STR(str135, "osh I/O error: %s");
GLOBAL_STR(str136, "[here doc writer]");
GLOBAL_STR(str137, "<Process %s>");
GLOBAL_STR(str138, "Fatal error in posix.fork()");
GLOBAL_STR(str139, "<Pipeline %s>");
GLOBAL_STR(str140, " ");
GLOBAL_STR(str141, "JobState MaybeRemove %d");
GLOBAL_STR(str142, "osh: PID %d stopped, but osh didn't start it");
GLOBAL_STR(str143, "");
GLOBAL_STR(str144, "");
GLOBAL_STR(str145, "[PID %d] Stopped");
GLOBAL_STR(str146, "");
GLOBAL_STR(str147, "main");
GLOBAL_STR(str148, "osh usage error: %s");
GLOBAL_STR(str149, "%s-usage");
GLOBAL_STR(str150, "Oil");
GLOBAL_STR(str151, "main");
GLOBAL_STR(str152, "oil");
GLOBAL_STR(str153, "oil:all");
GLOBAL_STR(str154, "--one-pass-parse requires noexec (-n)");
GLOBAL_STR(str155, "completion");
GLOBAL_STR(str156, "history");
GLOBAL_STR(str157, "");
GLOBAL_STR(str158, "OSH_DEBUG_DIR");
GLOBAL_STR(str159, "%d-osh.log");
GLOBAL_STR(str160, "Writing logs to %r");
GLOBAL_STR(str161, "OSH_HIJACK_SHEBANG");
GLOBAL_STR(str162, "");
GLOBAL_STR(str163, "OSH_CRASH_DUMP_DIR");
GLOBAL_STR(str164, "");
GLOBAL_STR(str165, "");
GLOBAL_STR(str166, "osh: Couldn't open %r: %s");
GLOBAL_STR(str167, "/proc/%d/status");
GLOBAL_STR(str168, "--parser-mem-dump can only be used with -n");
GLOBAL_STR(str169, "/proc/%d/status");
GLOBAL_STR(str170, "Can't run a proc while errexit is disabled. Use 'catch' or wrap it in a process with $0 myproc");
GLOBAL_STR(str171, "Unhandled SimpleCommand");
GLOBAL_STR(str172, "\n");
GLOBAL_STR(str173, " \t\n\"'><=;|&(:");
GLOBAL_STR(str174, "/");
GLOBAL_STR(str175, "PATH");
GLOBAL_STR(str176, ":");
GLOBAL_STR(str177, "got invalid option %r");
GLOBAL_STR(str178, "got invalid option %r");
GLOBAL_STR(str179, "doesn't own option %r (try 'shopt')");
GLOBAL_STR(str180, "SHELLOPTS");
GLOBAL_STR(str181, ":");
GLOBAL_STR(str182, "Syntax options must be set at the top level (outside any function)");
GLOBAL_STR(str183, "Warning: set -o verbose not implemented");
GLOBAL_STR(str184, "SHELLOPTS");
GLOBAL_STR(str185, "%s:%s");
GLOBAL_STR(str186, "SHELLOPTS");
GLOBAL_STR(str187, ":");
GLOBAL_STR(str188, ":");
GLOBAL_STR(str189, "SHELLOPTS");
GLOBAL_STR(str190, "oil:basic");
GLOBAL_STR(str191, "oil:all");
GLOBAL_STR(str192, "strict:all");
GLOBAL_STR(str193, "set %so %s");
GLOBAL_STR(str194, "-");
GLOBAL_STR(str195, "+");
GLOBAL_STR(str196, "oil:basic");
GLOBAL_STR(str197, "oil:all");
GLOBAL_STR(str198, "strict:all");
GLOBAL_STR(str199, "got invalid option %r");
GLOBAL_STR(str200, "shopt -%s %s");
GLOBAL_STR(str201, "s");
GLOBAL_STR(str202, "u");
GLOBAL_STR(str203, "<_ArgFrame %s %d at %x>");
GLOBAL_STR(str204, "Can't determine working directory: %s");
GLOBAL_STR(str205, "IFS");
GLOBAL_STR(str206, "UID");
GLOBAL_STR(str207, "EUID");
GLOBAL_STR(str208, "PPID");
GLOBAL_STR(str209, "HOSTNAME");
GLOBAL_STR(str210, "OSTYPE");
GLOBAL_STR(str211, "OPTIND");
GLOBAL_STR(str212, "1");
GLOBAL_STR(str213, "PS4");
GLOBAL_STR(str214, "+ ");
GLOBAL_STR(str215, "COMP_WORDBREAKS");
GLOBAL_STR(str216, "SHELLOPTS");
GLOBAL_STR(str217, "SHELLOPTS");
GLOBAL_STR(str218, "");
GLOBAL_STR(str219, "SHELLOPTS");
GLOBAL_STR(str220, "PWD");
GLOBAL_STR(str221, "PWD");
GLOBAL_STR(str222, "PWD");
GLOBAL_STR(str223, "OIL_VERSION");
GLOBAL_STR(str224, "PWD");
GLOBAL_STR(str225, "");
GLOBAL_STR(str226, "<Mem");
GLOBAL_STR(str227, "  -- %d --");
GLOBAL_STR(str228, "  %s %s");
GLOBAL_STR(str229, ">");
GLOBAL_STR(str230, "\n");
GLOBAL_STR(str231, "\n");
GLOBAL_STR(str232, "Warning: span_id undefined in SetCurrentSpanId");
GLOBAL_STR(str233, "setref requires a nameref (:out param), got %r");
GLOBAL_STR(str234, "nameref %r is undefined");
GLOBAL_STR(str235, "nameref %r contains invalid variable name %r");
GLOBAL_STR(str236, "nameref cycle: %s");
GLOBAL_STR(str237, " -> ");
GLOBAL_STR(str238, "__");
GLOBAL_STR(str239, "Can't assign to readonly value %r");
GLOBAL_STR(str240, "Only strings can be exported");
GLOBAL_STR(str241, "nameref must be a string");
GLOBAL_STR(str242, "Can't assign to readonly array");
GLOBAL_STR(str243, "Can't assign to items in a string");
GLOBAL_STR(str244, "Value of type %s can't be indexed");
GLOBAL_STR(str245, "Can't assign to readonly associative array");
GLOBAL_STR(str246, "ARGV");
GLOBAL_STR(str247, "_status");
GLOBAL_STR(str248, "PIPESTATUS");
GLOBAL_STR(str249, "_pipeline_status");
GLOBAL_STR(str250, "_process_sub_status");
GLOBAL_STR(str251, "FUNCNAME");
GLOBAL_STR(str252, "source");
GLOBAL_STR(str253, "BASH_SOURCE");
GLOBAL_STR(str254, "BASH_LINENO");
GLOBAL_STR(str255, "0");
GLOBAL_STR(str256, "LINENO");
GLOBAL_STR(str257, "BASHPID");
GLOBAL_STR(str258, "Can't unset readonly variable %r");
GLOBAL_STR(str259, "%r isn't an array");
GLOBAL_STR(str260, "$%s isn't defined");
GLOBAL_STR(str261, "$%s should be a string");
GLOBAL_STR(str262, "$%s should be a string, got %s");
GLOBAL_STR(str263, "$%s doesn't look like an integer, got %r");
GLOBAL_STR(str264, "EOF");
GLOBAL_STR(str265, "/");
GLOBAL_STR(str266, "~");
GLOBAL_STR(str267, "  ");
GLOBAL_STR(str268, "\n  ");
...
GLOBAL_STR(str273, "~");
GLOBAL_STR(str274, "\n");
GLOBAL_STR(str275, "[ interactive ]");
GLOBAL_STR(str276, "[ -c flag ]");
GLOBAL_STR(str277, "[ stdin%s ]");
GLOBAL_STR(str278, "[ expansion of alias %r ]");
GLOBAL_STR(str279, "[ backticks at ... ]");
GLOBAL_STR(str280, "[ array LValue in %s ]");
GLOBAL_STR(str281, "[ eval at line %d of %s ]");
GLOBAL_STR(str282, "[ trap ]");
GLOBAL_STR(str283, "[ variable ]");
GLOBAL_STR(str284, "%s:%d: %s%s\n");
GLOBAL_STR(str285, "[??? no location ???] %s%s\n");
GLOBAL_STR(str286, "");
GLOBAL_STR(str287, "");
GLOBAL_STR(str288, "");
GLOBAL_STR(str289, "none");
GLOBAL_STR(str290, "AST not printed.");
GLOBAL_STR(str291, "text");
GLOBAL_STR(str292, "abbrev-text");
GLOBAL_STR(str293, "html");
GLOBAL_STR(str294, "abbrev-html");
GLOBAL_STR(str295, "abbrev-");
GLOBAL_STR(str296, "\n");
GLOBAL_STR(str297, "\n");
GLOBAL_STR(str298, "-");
GLOBAL_STR(str299, "_");
GLOBAL_STR(str300, "<_Attributes %s>");
GLOBAL_STR(str301, "<args.Reader %r %d>");
GLOBAL_STR(str302, "expected argument to %r");
GLOBAL_STR(str303, "-");
GLOBAL_STR(str304, "expected integer after %s, got %r");
GLOBAL_STR(str305, "-");
GLOBAL_STR(str306, "got invalid integer for %s: %s");
GLOBAL_STR(str307, "-");
GLOBAL_STR(str308, "expected number after %r, got %r");
GLOBAL_STR(str309, "-");
GLOBAL_STR(str310, "got invalid float for %s: %s");
GLOBAL_STR(str311, "-");
GLOBAL_STR(str312, "got invalid argument %r to %r, expected one of: %s");
GLOBAL_STR(str313, "-");
GLOBAL_STR(str314, "|");
GLOBAL_STR(str315, "0");
GLOBAL_STR(str316, "F");
GLOBAL_STR(str317, "false");
GLOBAL_STR(str318, "False");
GLOBAL_STR(str319, "1");
GLOBAL_STR(str320, "T");
GLOBAL_STR(str321, "true");
GLOBAL_STR(str322, "Talse");
GLOBAL_STR(str323, "got invalid argument to boolean flag: %r");
GLOBAL_STR(str324, "-");
GLOBAL_STR(str325, "-");
GLOBAL_STR(str326, "got invalid option %r");
GLOBAL_STR(str327, "Expected argument for action");
GLOBAL_STR(str328, "Invalid action name %r");
GLOBAL_STR(str329, "--");
GLOBAL_STR(str330, "--");
GLOBAL_STR(str331, "got invalid flag %r");
GLOBAL_STR(str332, "-");
GLOBAL_STR(str333, "0");
GLOBAL_STR(str334, "Z");
GLOBAL_STR(str335, "-");
GLOBAL_STR(str336, "doesn't accept flag %s");
GLOBAL_STR(str337, "-");
GLOBAL_STR(str338, "+");
GLOBAL_STR(str339, "+");
GLOBAL_STR(str340, "doesn't accept option %s");
GLOBAL_STR(str341, "+");
GLOBAL_STR(str342, "-");
GLOBAL_STR(str343, "--");
GLOBAL_STR(str344, "--");
GLOBAL_STR(str345, "got invalid flag %r");
GLOBAL_STR(str346, "-");
GLOBAL_STR(str347, "+");
GLOBAL_STR(str348, "got invalid flag %r");
GLOBAL_STR(str349, "-");
GLOBAL_STR(str350, "^--?([a-zA-Z0-9][a-zA-Z0-9\\-]*)(=.*)?$");
GLOBAL_STR(str351, "<LineLexer at pos %d of line %r (id = %d)>");
GLOBAL_STR(str352, "");
GLOBAL_STR(str353, "");
GLOBAL_STR(str354, "");
GLOBAL_STR(str355, "");
GLOBAL_STR(str356, "<Trail %s %s %s %s>");
GLOBAL_STR(str357, "");
GLOBAL_STR(str358, "ShAssignment expression can't be nested like this");
GLOBAL_STR(str359, "Here docs aren't allowed in expressions");
GLOBAL_STR(str360, "\n");
GLOBAL_STR(str361, "");
GLOBAL_STR(str362, " (%s)");
GLOBAL_STR(str363, "Unexpected token in expression mode%s");
GLOBAL_STR(str364, "Syntax error in expression (near %s)");
GLOBAL_STR(str365, "alnum");
GLOBAL_STR(str366, "cntrl");
GLOBAL_STR(str367, "lower");
GLOBAL_STR(str368, "space");
GLOBAL_STR(str369, "alpha");
GLOBAL_STR(str370, "digit");
GLOBAL_STR(str371, "print");
GLOBAL_STR(str372, "upper");
GLOBAL_STR(str373, "blank");
GLOBAL_STR(str374, "graph");
GLOBAL_STR(str375, "punct");
GLOBAL_STR(str376, "xdigit");
GLOBAL_STR(str377, "Range start/end shouldn't have more than one character");
GLOBAL_STR(str378, "Write singleton tuples with tup(), not a trailing comma");
GLOBAL_STR(str379, "testlist_comp");
GLOBAL_STR(str380, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str381, "Can't assign to this expression");
GLOBAL_STR(str382, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str383, "TODO");
GLOBAL_STR(str384, "dot");
GLOBAL_STR(str385, "Can't negate this symbol");
GLOBAL_STR(str386, "%r isn't a character class");
GLOBAL_STR(str387, "Can't negate this symbol");
GLOBAL_STR(str388, "%r isn't a character class");
GLOBAL_STR(str389, "%start");
GLOBAL_STR(str390, "%end");
GLOBAL_STR(str391, "dot");
GLOBAL_STR(str392, "Unexpected token %r in regex");
GLOBAL_STR(str393, "%s-%s");
GLOBAL_STR(str394, "ERE can't express code point %d");
GLOBAL_STR(str395, "Perl classes can't be negated in ERE");
GLOBAL_STR(str396, "%s");
GLOBAL_STR(str397, "POSIX classes can't be negated in ERE");
GLOBAL_STR(str398, "[:%s:]");
GLOBAL_STR(str399, ".");
GLOBAL_STR(str400, "^");
GLOBAL_STR(str401, "$");
GLOBAL_STR(str402, "|");
GLOBAL_STR(str403, "POSIX EREs don't have groups without capture, so this node needs () around it.");
GLOBAL_STR(str404, "+");
GLOBAL_STR(str405, "*");
GLOBAL_STR(str406, "?");
GLOBAL_STR(str407, "{%s}");
...
GLOBAL_STR(str418, "^");
GLOBAL_STR(str419, "]");
GLOBAL_STR(str420, "The [ operator doesn't apply to this expression");
GLOBAL_STR(str421, "Expected ]]");
GLOBAL_STR(str422, "Unexpected trailing word %s");
GLOBAL_STR(str423, "Invalid argument to unary operator");
GLOBAL_STR(str424, "Expected ), got %s");
GLOBAL_STR(str425, "Unexpected token in boolean expression (%s)");
GLOBAL_STR(str426, "");
GLOBAL_STR(str427, "Expected %d, got %d");
GLOBAL_STR(str428, "Step can't be 0");
GLOBAL_STR(str429, "Invalid step %d for ascending integer range");
GLOBAL_STR(str430, "Invalid step %d for descending integer range");
GLOBAL_STR(str431, "Invalid step %d for ascending character range");
GLOBAL_STR(str432, "Invalid step %d for descending character range");
GLOBAL_STR(str433, "Mismatched cases in character range");
GLOBAL_STR(str434, "");
GLOBAL_STR(str435, "0");
GLOBAL_STR(str436, "0");
GLOBAL_STR(str437, "g");
...
GLOBAL_STR(str474, ")");
GLOBAL_STR(str475, "");
GLOBAL_STR(str476, "export_");
GLOBAL_STR(str477, "doesn't accept -f because it's dangerous.  (The code can usually be restructured with 'source')");
GLOBAL_STR(str478, "doesn't accept RHS with -n");
GLOBAL_STR(str479, "Got -a but RHS isn't an array");
GLOBAL_STR(str480, "Got -A but RHS isn't an associative array");
GLOBAL_STR(str481, "readonly");
GLOBAL_STR(str482, "new_var");
GLOBAL_STR(str483, "with -f expects function names");
GLOBAL_STR(str484, "declare -f %s");
GLOBAL_STR(str485, "-");
GLOBAL_STR(str486, "-");
GLOBAL_STR(str487, "-");
GLOBAL_STR(str488, "+");
GLOBAL_STR(str489, "+");
GLOBAL_STR(str490, "+");
GLOBAL_STR(str491, "Invalid unset expression");
GLOBAL_STR(str492, "expected a variable name.  shopt -s eval_unsafe_arith allows expressions");
GLOBAL_STR(str493, "unset");
GLOBAL_STR(str494, "Invalid shift argument %r");
GLOBAL_STR(str495, "got too many arguments");
GLOBAL_STR(str496, "eval");
GLOBAL_STR(str497, "requires code string");
GLOBAL_STR(str498, "requires exactly 1 argument");
GLOBAL_STR(str499, " ");
GLOBAL_STR(str500, "source");
GLOBAL_STR(str501, "missing required argument");
GLOBAL_STR(str502, "source %r failed: %s");
GLOBAL_STR(str503, "command");
GLOBAL_STR(str504, "Can't run assignment builtin recursively");
GLOBAL_STR(str505, "%r isn't a shell builtin");
GLOBAL_STR(str506, "sigpipe");
GLOBAL_STR(str507, "run");
GLOBAL_STR(str508, "'Run' expected a command to run");
GLOBAL_STR(str509, "(original failure)");
GLOBAL_STR(str510, "");
GLOBAL_STR(str511, "fatal: status %d when --allow-status-01");
GLOBAL_STR(str512, ":");
GLOBAL_STR(str513, "function");
GLOBAL_STR(str514, "alias");
GLOBAL_STR(str515, "builtin");
GLOBAL_STR(str516, "builtin");
GLOBAL_STR(str517, "builtin");
GLOBAL_STR(str518, "keyword");
GLOBAL_STR(str519, "keyword");
GLOBAL_STR(str520, "file");
GLOBAL_STR(str521, "type");
GLOBAL_STR(str522, "type: %r not found");
GLOBAL_STR(str523, "file");
GLOBAL_STR(str524, "file");
GLOBAL_STR(str525, "%s is a %s");
GLOBAL_STR(str526, "function");
GLOBAL_STR(str527, "");
GLOBAL_STR(str528, "\n");
GLOBAL_STR(str529, "");
GLOBAL_STR(str530, "");
...
GLOBAL_STR(str534, "");
GLOBAL_STR(str535, "");
GLOBAL_STR(str536, "read");
GLOBAL_STR(str537, "_line");
GLOBAL_STR(str538, ":");
GLOBAL_STR(str539, "got extra argument");
GLOBAL_STR(str540, "--qsn can only be used with --line");
GLOBAL_STR(str541, "_all");
GLOBAL_STR(str542, ":");
GLOBAL_STR(str543, "got extra argument");
GLOBAL_STR(str544, "--qsn not implemented yet");
GLOBAL_STR(str545, "read -t isn't implemented (except t=0)");
GLOBAL_STR(str546, "");
GLOBAL_STR(str547, "REPLY");
GLOBAL_STR(str548, "REPLY");
GLOBAL_STR(str549, "\u0000");
GLOBAL_STR(str550, "\u0000");
GLOBAL_STR(str551, "\n");
GLOBAL_STR(str552, "");
GLOBAL_STR(str553, "mapfile");
GLOBAL_STR(str554, "MAPFILE");
GLOBAL_STR(str555, ":");
GLOBAL_STR(str556, "\n");
GLOBAL_STR(str557, "cd");
GLOBAL_STR(str558, "HOME");
GLOBAL_STR(str559, "HOME");
GLOBAL_STR(str560, "-");
GLOBAL_STR(str561, "OLDPWD");
GLOBAL_STR(str562, "PWD");
GLOBAL_STR(str563, "cd %r: %s");
GLOBAL_STR(str564, "PWD");
GLOBAL_STR(str565, "OLDPWD");
GLOBAL_STR(str566, "%2d  %s");
GLOBAL_STR(str567, " ");
GLOBAL_STR(str568, "pushd: no other directory");
GLOBAL_STR(str569, "got too many arguments");
GLOBAL_STR(str570, "pushd: %r: %s");
GLOBAL_STR(str571, "HOME");
GLOBAL_STR(str572, "PWD");
GLOBAL_STR(str573, "popd: directory stack is empty");
GLOBAL_STR(str574, "popd: %r: %s");
GLOBAL_STR(str575, "PWD");
GLOBAL_STR(str576, "got extra argument");
GLOBAL_STR(str577, "HOME");
GLOBAL_STR(str578, "dirs");
GLOBAL_STR(str579, "HOME");
GLOBAL_STR(str580, "pwd");
GLOBAL_STR(str581, "_devbuild/help/groups.txt");
GLOBAL_STR(str582, "help");
GLOBAL_STR(str583, "help");
GLOBAL_STR(str584, "_devbuild/help/%s");
GLOBAL_STR(str585, "no help topics match %r");
GLOBAL_STR(str586, "# +");
GLOBAL_STR(str587, "osh printf doesn't support the %r flag");
GLOBAL_STR(str588, "eEfFgG");
GLOBAL_STR(str589, "osh printf doesn't support floating point");
GLOBAL_STR(str590, "c");
GLOBAL_STR(str591, "osh printf doesn't support single characters (bytes)");
GLOBAL_STR(str592, "Invalid printf format character");
GLOBAL_STR(str593, "Expected a printf format character");
GLOBAL_STR(str594, "fsT");
GLOBAL_STR(str595, "printf precision can't be specified with type %r");
GLOBAL_STR(str596, "printf");
GLOBAL_STR(str597, "requires a format string");
GLOBAL_STR(str598, "%");
GLOBAL_STR(str599, "");
GLOBAL_STR(str600, "printf got invalid width %r");
GLOBAL_STR(str601, "0");
GLOBAL_STR(str602, "");
GLOBAL_STR(str603, "printf got invalid precision %r");
GLOBAL_STR(str604, "");
GLOBAL_STR(str605, "s");
GLOBAL_STR(str606, "q");
GLOBAL_STR(str607, "b");
GLOBAL_STR(str608, "");
GLOBAL_STR(str609, "diouxX");
GLOBAL_STR(str610, "'\"");
GLOBAL_STR(str611, "printf expected an integer, got %r");
GLOBAL_STR(str612, "di");
GLOBAL_STR(str613, "ouxX");
GLOBAL_STR(str614, "Can't format negative number %d with %%%s");
GLOBAL_STR(str615, "u");
GLOBAL_STR(str616, "o");
GLOBAL_STR(str617, "x");
GLOBAL_STR(str618, "X");
GLOBAL_STR(str619, "TZ");
GLOBAL_STR(str620, "TZ");
GLOBAL_STR(str621, "-");
GLOBAL_STR(str622, " ");
GLOBAL_STR(str623, "0");
GLOBAL_STR(str624, "0");
GLOBAL_STR(str625, " ");
GLOBAL_STR(str626, "");
GLOBAL_STR(str627, "Invalid -v expression");
GLOBAL_STR(str628, "-v expected a variable name.  shopt -s eval_unsafe_arith allows expressions");
GLOBAL_STR(str629, "alias");
GLOBAL_STR(str630, "alias %s=%r");
GLOBAL_STR(str631, "=");
GLOBAL_STR(str632, "No alias named %r");
GLOBAL_STR(str633, "alias %s=%r");
GLOBAL_STR(str634, "unalias");
GLOBAL_STR(str635, "requires an argument");
GLOBAL_STR(str636, "No alias named %r");
GLOBAL_STR(str637, "%s=%s");
GLOBAL_STR(str638, "set");
GLOBAL_STR(str639, "shopt");
GLOBAL_STR(str640, "got invalid option %r");
GLOBAL_STR(str641, "hash");
GLOBAL_STR(str642, "got extra arguments after -r");
GLOBAL_STR(str643, "hash: %r not found");
GLOBAL_STR(str644, ":");
GLOBAL_STR(str645, "OPTIND");
GLOBAL_STR(str646, "OPTIND");
GLOBAL_STR(str647, "OPTARG");
GLOBAL_STR(str648, "OPTARG");
GLOBAL_STR(str649, "");
GLOBAL_STR(str650, "?");
GLOBAL_STR(str651, "-");
GLOBAL_STR(str652, "-");
GLOBAL_STR(str653, "?");
GLOBAL_STR(str654, "?");
GLOBAL_STR(str655, "getopts: option %r requires an argument.");
GLOBAL_STR(str656, "(getopts argv: %s)");
GLOBAL_STR(str657, " ");
GLOBAL_STR(str658, "?");
GLOBAL_STR(str659, "");
GLOBAL_STR(str660, "requires an argspec");
GLOBAL_STR(str661, "requires the name of a variable to set");
GLOBAL_STR(str662, "got invalid variable name %r");
GLOBAL_STR(str663, "echo");
GLOBAL_STR(str664, "");
GLOBAL_STR(str665, "takes at most one arg when simple_echo is on (hint: add quotes)");
GLOBAL_STR(str666, " ");
GLOBAL_STR(str667, "\n");
GLOBAL_STR(str668, "Assignment builtin %r not configured");
GLOBAL_STR(str669, "%r ");
GLOBAL_STR(str670, "");
GLOBAL_STR(str671, "command in ");
GLOBAL_STR(str672, "assignment in ");
GLOBAL_STR(str673, "subshell invoked from ");
GLOBAL_STR(str674, "pipeline invoked from ");
GLOBAL_STR(str675, "");
GLOBAL_STR(str676, "Exiting with status %d (%sPID %d)");
GLOBAL_STR(str677, "Redirect filename can't be empty");
GLOBAL_STR(str678, "Redirect descriptor can't be empty");
GLOBAL_STR(str679, "-");
GLOBAL_STR(str680, "-");
GLOBAL_STR(str681, "Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
GLOBAL_STR(str682, "\n");
GLOBAL_STR(str683, "Unknown redirect op");
GLOBAL_STR(str684, "Unknown redirect type");
GLOBAL_STR(str685, "strict_errexit only allows simple commands (got %s). Hint: use 'run'.");
GLOBAL_STR(str686, "strict_errexit only allows a single command.  Hint: use \"run\".");
GLOBAL_STR(str687, "strict_errexit only allows simple commands (got %s). Hint: use 'run'.");
GLOBAL_STR(str688, "ShAssignment builtins don't accept blocks");
GLOBAL_STR(str689, "|& isn't supported");
GLOBAL_STR(str690, "Can't append array to string");
GLOBAL_STR(str691, "Can't append string to array");
GLOBAL_STR(str692, "%r expected a number, got %r");
GLOBAL_STR(str693, "Invalid control flow at top level");
GLOBAL_STR(str694, "warning: ");
GLOBAL_STR(str695, "Loop and control flow can't be in different processes");
GLOBAL_STR(str696, "fatal: ");
GLOBAL_STR(str697, "EXIT");
GLOBAL_STR(str698, "__");
GLOBAL_STR(str699, ":");
GLOBAL_STR(str700, "Invalid argument %r.  Expected a name starting with :");
GLOBAL_STR(str701, "No value provided for param %r");
GLOBAL_STR(str702, "proc %r expected %d arguments, but got %d");
GLOBAL_STR(str703, "Unexpected %r (in function call)");
GLOBAL_STR(str704, "Attempted to exit from completion hook.");
GLOBAL_STR(str705, "Couldn't find terminator for here doc that starts here");
GLOBAL_STR(str706, "\t");
GLOBAL_STR(str707, "Invalid here doc delimiter");
GLOBAL_STR(str708, "+");
GLOBAL_STR(str709, "+");
GLOBAL_STR(str710, "+");
GLOBAL_STR(str711, "%d != %d");
GLOBAL_STR(str712, "Environment binding shouldn't look like an array assignment");
GLOBAL_STR(str713, "+");
GLOBAL_STR(str714, "Expected = in environment binding, got +=");
GLOBAL_STR(str715, "Environment bindings can't contain array literals");
GLOBAL_STR(str716, "procs can't contain other procs or functions");
GLOBAL_STR(str717, "%r was already declared");
GLOBAL_STR(str718, "%r hasn't been declared");
GLOBAL_STR(str719, "Can't modify constant %r");
GLOBAL_STR(str720, "Expected word type %s, got %s");
GLOBAL_STR(str721, "{");
GLOBAL_STR(str722, "}");
GLOBAL_STR(str723, "Invalid token after redirect operator");
GLOBAL_STR(str724, "TODO: Parse Redirect");
GLOBAL_STR(str725, " ");
GLOBAL_STR(str726, " ");
GLOBAL_STR(str727, "line IDs %d != %d");
GLOBAL_STR(str728, " ");
GLOBAL_STR(str729, "");
GLOBAL_STR(str730, "Unexpected block");
GLOBAL_STR(str731, "=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
GLOBAL_STR(str732, "name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
GLOBAL_STR(str733, "Unexpected block");
GLOBAL_STR(str734, "Unexpected block");
GLOBAL_STR(str735, "Control flow shouldn't have redirects");
GLOBAL_STR(str736, "Control flow shouldn't have environment bindings");
GLOBAL_STR(str737, "Unexpected argument to %r");
GLOBAL_STR(str738, "Invalid word in for loop");
GLOBAL_STR(str739, "Invalid word after for expression");
GLOBAL_STR(str740, "Loop variable name should be a constant");
GLOBAL_STR(str741, "Invalid loop variable name");
GLOBAL_STR(str742, "Unexpected word after for loop variable");
GLOBAL_STR(str743, "Expected ;; or esac");
GLOBAL_STR(str744, "Unexpected word while parsing compound command");
GLOBAL_STR(str745, "Invalid function name");
GLOBAL_STR(str746, "Expected ) in function definition");
GLOBAL_STR(str747, "Invalid KSH-style function name");
GLOBAL_STR(str748, "Unexpected word when parsing command");
GLOBAL_STR(str749, "Unexpected right brace");
GLOBAL_STR(str750, "Unexpected EOF while parsing command");
GLOBAL_STR(str751, "Invalid word while parsing command");
GLOBAL_STR(str752, "Unexpected word while parsing command line");
GLOBAL_STR(str753, "Unterminated here doc began here");
GLOBAL_STR(str754, "\\");
GLOBAL_STR(str755, "*");
GLOBAL_STR(str756, "?");
GLOBAL_STR(str757, "[");
...
GLOBAL_STR(str761, "\\?*+{}^$.()|");
GLOBAL_STR(str762, "\\");
GLOBAL_STR(str763, "Unexpected escaped character %r");
GLOBAL_STR(str764, "");
GLOBAL_STR(str765, "");
GLOBAL_STR(str766, "Malformed character class; treating as literal");
GLOBAL_STR(str767, "Got unescaped right bracket");
GLOBAL_STR(str768, "Got unescaped trailing backslash");
GLOBAL_STR(str769, ".|^$()+*?[]{}\\");
GLOBAL_STR(str770, "\\");
GLOBAL_STR(str771, "\\");
GLOBAL_STR(str772, "\\[");
...
GLOBAL_STR(str784, "]");
GLOBAL_STR(str785, "");
GLOBAL_STR(str786, "Error expanding glob %r: %s");
GLOBAL_STR(str787, "-");
GLOBAL_STR(str788, "<Error: unbalanced \\[ and \\]> ");
GLOBAL_STR(str789, "$");
GLOBAL_STR(str790, "#");
GLOBAL_STR(str791, "$");
GLOBAL_STR(str792, "hostname");
GLOBAL_STR(str793, "user");
GLOBAL_STR(str794, "$ ");
GLOBAL_STR(str795, "\u0001");
GLOBAL_STR(str796, "\u0002");
GLOBAL_STR(str797, "$");
GLOBAL_STR(str798, "$");
GLOBAL_STR(str799, "u");
GLOBAL_STR(str800, "user");
GLOBAL_STR(str801, "h");
GLOBAL_STR(str802, "hostname");
GLOBAL_STR(str803, ".");
GLOBAL_STR(str804, "H");
GLOBAL_STR(str805, "hostname");
GLOBAL_STR(str806, "w");
GLOBAL_STR(str807, "PWD");
GLOBAL_STR(str808, "HOME");
GLOBAL_STR(str809, "<Error: %s>");
GLOBAL_STR(str810, "W");
GLOBAL_STR(str811, "PWD");
GLOBAL_STR(str812, "<Error: PWD is not a string> ");
GLOBAL_STR(str813, "<Error: \\%s not implemented in $PS1> ");
GLOBAL_STR(str814, "$");
GLOBAL_STR(str815, "\\$");
GLOBAL_STR(str816, "Invalid token %r");
GLOBAL_STR(str817, "");
GLOBAL_STR(str818, "<ERROR: Can't parse PS1: %s>");
GLOBAL_STR(str819, "osh");
GLOBAL_STR(str820, "PS1");
GLOBAL_STR(str821, "PROMPT_COMMAND");
GLOBAL_STR(str822, "Undefined variable %r");
GLOBAL_STR(str823, "Can't use [] on value of type %s");
GLOBAL_STR(str824, "");
GLOBAL_STR(str825, "Can't use [] on value of type %s");
GLOBAL_STR(str826, "");
GLOBAL_STR(str827, "0x");
GLOBAL_STR(str828, "Invalid hex constant %r");
GLOBAL_STR(str829, "0");
GLOBAL_STR(str830, "Invalid octal constant %r");
GLOBAL_STR(str831, "#");
GLOBAL_STR(str832, "#");
GLOBAL_STR(str833, "Invalid base for numeric constant %r");
GLOBAL_STR(str834, "a");
GLOBAL_STR(str835, "A");
GLOBAL_STR(str836, "@");
GLOBAL_STR(str837, "_");
GLOBAL_STR(str838, "Invalid digits for numeric constant %r");
GLOBAL_STR(str839, "Digits %r out of range for base %d");
GLOBAL_STR(str840, "Parse error in recursive arithmetic");
GLOBAL_STR(str841, "Invalid integer constant %r");
GLOBAL_STR(str842, "Invalid integer constant %r");
GLOBAL_STR(str843, "Invalid integer constant %r");
GLOBAL_STR(str844, "Undefined value in arithmetic context");
GLOBAL_STR(str845, "Expected a value convertible to integer, got %s");
GLOBAL_STR(str846, "0");
GLOBAL_STR(str847, "Divide by zero");
GLOBAL_STR(str848, "Divide by zero");
GLOBAL_STR(str849, "Expected array or assoc in index expression, got %s");
GLOBAL_STR(str850, "Divide by zero");
GLOBAL_STR(str851, "Divide by zero");
GLOBAL_STR(str852, "Exponent can't be less than zero");
GLOBAL_STR(str853, "Associative array keys must be strings: $x 'x' \"$x\" etc.");
GLOBAL_STR(str854, "Invalid place to modify");
GLOBAL_STR(str855, "BASH_REMATCH");
GLOBAL_STR(str856, "%s isn't implemented");
GLOBAL_STR(str857, "Invalid regex %r: %s");
GLOBAL_STR(str858, " \t\n");
GLOBAL_STR(str859, "IFS");
GLOBAL_STR(str860, "IFS shouldn't be an array");
GLOBAL_STR(str861, " \t\n");
GLOBAL_STR(str862, "IFS");
GLOBAL_STR(str863, " ");
GLOBAL_STR(str864, "");
GLOBAL_STR(str865, "IFS shouldn't be an array");
GLOBAL_STR(str866, "\\");
GLOBAL_STR(str867, "\\");
GLOBAL_STR(str868, "Invalid transition from %r with %r");
GLOBAL_STR(str869, "\u00ef\u00bf\u00bd");
GLOBAL_STR(str870, "");
GLOBAL_STR(str871, "Incomplete UTF-8 character");
GLOBAL_STR(str872, "Invalid UTF-8 continuation byte");
GLOBAL_STR(str873, "Invalid start of UTF-8 character");
GLOBAL_STR(str874, "");
GLOBAL_STR(str875, "%s can't have an argument");
GLOBAL_STR(str876, "");
GLOBAL_STR(str877, "%s can't have an argument");
GLOBAL_STR(str878, "");
GLOBAL_STR(str879, "%s can't have an argument");
GLOBAL_STR(str880, "");
GLOBAL_STR(str881, "%s can't have an argument");
GLOBAL_STR(str882, "");
GLOBAL_STR(str883, "<_GlobReplacer regex %r r %r>");
GLOBAL_STR(str884, "(%s)");
GLOBAL_STR(str885, "Error matching regex %r: %s");
GLOBAL_STR(str886, "^");
GLOBAL_STR(str887, "$");
GLOBAL_STR(str888, "\r");
GLOBAL_STR(str889, "<INVALID CR>");
GLOBAL_STR(str890, "\n");
GLOBAL_STR(str891, "<INVALID NEWLINE>");
GLOBAL_STR(str892, " `~!$&*()[]{}\\|;'\"<>?");
GLOBAL_STR(str893, "Left-hand side of this assignment is invalid");
GLOBAL_STR(str894, "Token can't be used in prefix position");
GLOBAL_STR(str895, "Token can't be used in infix position");
GLOBAL_STR(str896, "Parser expected %s, got %s");
GLOBAL_STR(str897, "Unexpected end of input");
GLOBAL_STR(str898, "");
GLOBAL_STR(str899, "");
GLOBAL_STR(str900, "BASH_SOURCE");
GLOBAL_STR(str901, "FUNCNAME");
GLOBAL_STR(str902, "BASH_LINENO");
GLOBAL_STR(str903, "0");
GLOBAL_STR(str904, "0");
GLOBAL_STR(str905, "\\");
GLOBAL_STR(str906, "\\\\");
GLOBAL_STR(str907, "");
GLOBAL_STR(str908, "");
GLOBAL_STR(str909, "The length index of a array slice can't be negative: %d");
GLOBAL_STR(str910, "Can't slice associative arrays");
GLOBAL_STR(str911, "i");
GLOBAL_STR(str912, "e");
GLOBAL_STR(str913, "f");
GLOBAL_STR(str914, "n");
...
GLOBAL_STR(str918, "");
GLOBAL_STR(str919, "~");
GLOBAL_STR(str920, "HOME");
GLOBAL_STR(str921, "Error expanding tilde (e.g. invalid user)");
GLOBAL_STR(str922, "Can't assign to special variable");
GLOBAL_STR(str923, "unset variable %r");
GLOBAL_STR(str924, "@");
GLOBAL_STR(str925, "*");
GLOBAL_STR(str926, "@");
GLOBAL_STR(str927, "*");
GLOBAL_STR(str928, "warning: ");
GLOBAL_STR(str929, "-1");
GLOBAL_STR(str930, "@");
GLOBAL_STR(str931, "*");
GLOBAL_STR(str932, "[");
GLOBAL_STR(str933, "]");
GLOBAL_STR(str934, "Bad indirect expansion: %r");
GLOBAL_STR(str935, "");
GLOBAL_STR(str936, "warning: ");
GLOBAL_STR(str937, "");
GLOBAL_STR(str938, "\u0001");
GLOBAL_STR(str939, "");
GLOBAL_STR(str940, "\u0002");
GLOBAL_STR(str941, "");
GLOBAL_STR(str942, "Can't use @P on %s");
GLOBAL_STR(str943, " ");
GLOBAL_STR(str944, "Can't use @Q on %s");
GLOBAL_STR(str945, "a");
GLOBAL_STR(str946, "A");
GLOBAL_STR(str947, "r");
GLOBAL_STR(str948, "x");
GLOBAL_STR(str949, "n");
GLOBAL_STR(str950, "");
GLOBAL_STR(str951, "Var op %r not implemented");
GLOBAL_STR(str952, "Can't index string with @");
GLOBAL_STR(str953, "Can't index string with *");
GLOBAL_STR(str954, "Can't index string %r with integer");
GLOBAL_STR(str955, "");
GLOBAL_STR(str956, "");
GLOBAL_STR(str957, "$");
GLOBAL_STR(str958, "Undefined variable %r");
GLOBAL_STR(str959, "Undefined array %r");
GLOBAL_STR(str960, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str961, "Illegal array word part (strict_array)");
GLOBAL_STR(str962, " ");
GLOBAL_STR(str963, "");
GLOBAL_STR(str964, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str965, "Unexpected array literal");
GLOBAL_STR(str966, "Unexpected associative array literal");
GLOBAL_STR(str967, "@(");
GLOBAL_STR(str968, "|");
GLOBAL_STR(str969, ")");
GLOBAL_STR(str970, "Can't splice %r");
GLOBAL_STR(str971, "");
GLOBAL_STR(str972, "");
GLOBAL_STR(str973, "This word should yield a string, but it contains an array");
GLOBAL_STR(str974, " ");
GLOBAL_STR(str975, "");
GLOBAL_STR(str976, "<Runtime error: %s>");
GLOBAL_STR(str977, "<I/O error: %s>");
GLOBAL_STR(str978, "<Ctrl-C>");
GLOBAL_STR(str979, "");
GLOBAL_STR(str980, "");
GLOBAL_STR(str981, "");
GLOBAL_STR(str982, "");
GLOBAL_STR(str983, "");
GLOBAL_STR(str984, "LHS array not allowed in assignment builtin");
GLOBAL_STR(str985, "+");
GLOBAL_STR(str986, "+= not allowed in assignment builtin");
GLOBAL_STR(str987, "-");
GLOBAL_STR(str988, "+");
GLOBAL_STR(str989, "f");
GLOBAL_STR(str990, "F");
GLOBAL_STR(str991, "");
GLOBAL_STR(str992, "=");
GLOBAL_STR(str993, "Invalid variable name %r");
GLOBAL_STR(str994, "__NO_COMMAND_SUB__");
GLOBAL_STR(str995, "__NO_PROCESS_SUB__");
GLOBAL_STR(str996, "Expected : or } in slice");
GLOBAL_STR(str997, "Pattern in ${x/pat/replace} must not be empty");
GLOBAL_STR(str998, "Expected } after replacement string, got %s");
GLOBAL_STR(str999, "Expected } or / to close pattern");
GLOBAL_STR(str1000, "Expected ] to close subscript");
GLOBAL_STR(str1001, "Expected } to close ${");
GLOBAL_STR(str1002, "Expected } to close ${");
GLOBAL_STR(str1003, "Expected } to close ${");
GLOBAL_STR(str1004, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1005, "VOp2");
GLOBAL_STR(str1006, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1007, "VOp3");
GLOBAL_STR(str1008, "Expected } to close ${");
GLOBAL_STR(str1009, "Expected } after length expression");
GLOBAL_STR(str1010, "Unexpected token in ${}");
GLOBAL_STR(str1011, "\\");
GLOBAL_STR(str1012, "Strings with backslashes should look like r'\\n' or c'\\n'");
GLOBAL_STR(str1013, "Use \\xhh or \\u{...} instead of octal escapes in Oil strings");
GLOBAL_STR(str1014, "Invalid hex escape in Oil string (must be \\xHH)");
GLOBAL_STR(str1015, "Invalid char escape in C-style string literal");
GLOBAL_STR(str1016, "Unexpected EOF in single-quoted string that began here");
GLOBAL_STR(str1017, "Unexpected EOF reading extended glob that began here");
GLOBAL_STR(str1018, "Invalid char escape in double quoted string");
GLOBAL_STR(str1019, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1020, "Invalid backtick: use $(cmd) or \\` in Oil strings");
GLOBAL_STR(str1021, "Unexpected EOF reading double-quoted string that began here");
GLOBAL_STR(str1022, "Use $(cmd) instead of backticks (parse_backticks)");
GLOBAL_STR(str1023, "Unexpected EOF while looking for closing backtick");
GLOBAL_STR(str1024, "");
GLOBAL_STR(str1025, "Invalid proc name %s");
GLOBAL_STR(str1026, "Unexpected token after arithmetic expression (%s != %s)");
GLOBAL_STR(str1027, "Expected second ) to end arith sub");
GLOBAL_STR(str1028, "Expected second ) to end arith statement");
GLOBAL_STR(str1029, "Expected ; here");
GLOBAL_STR(str1030, "Expected ; here");
GLOBAL_STR(str1031, "Expected ) to end for loop expression");
GLOBAL_STR(str1032, "Expected ( after =");
GLOBAL_STR(str1033, "Unexpected token in array literal");
GLOBAL_STR(str1034, "Expected associative array pair");
GLOBAL_STR(str1035, "Invalid char escape (parse_backslash)");
GLOBAL_STR(str1036, "Unexpected token after array literal");
GLOBAL_STR(str1037, "Unexpected token after array splice");
GLOBAL_STR(str1038, "Literal @ starting a word must be quoted (parse_at_all)");
GLOBAL_STR(str1039, "/");
GLOBAL_STR(str1040, "next_byte %r");
GLOBAL_STR(str1041, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1042, "Unexpected token after @()");
GLOBAL_STR(str1043, "id = %s");
GLOBAL_STR(str1044, "id = %s");
GLOBAL_STR(str1045, "Word has unbalanced { }.  Maybe add a space or quote it like \\{");
GLOBAL_STR(str1046, "Unexpected token while parsing arithmetic: %r");
GLOBAL_STR(str1047, "Unhandled: %s (%s)");
GLOBAL_STR(str1048, "Invalid lex state %s");
GLOBAL_STR(str1049, "");
GLOBAL_STR(str1050, "");
GLOBAL_STR(str1051, "");
GLOBAL_STR(str1052, "");
...
GLOBAL_STR(str1056, "");
GLOBAL_STR(str1057, "");
GLOBAL_STR(str1058, "Compound shouldn't be empty");
GLOBAL_STR(str1059, "/");
GLOBAL_STR(str1060, "/");
GLOBAL_STR(str1061, "");
GLOBAL_STR(str1062, "EOF");
GLOBAL_STR(str1063, "typ");
GLOBAL_STR(str1064, "tok");
GLOBAL_STR(str1065, "children");
GLOBAL_STR(str1066, "-");
GLOBAL_STR(str1067, "with %d children");
GLOBAL_STR(str1068, "");
GLOBAL_STR(str1069, "(PNode %s %s %s)");
GLOBAL_STR(str1070, "&");
GLOBAL_STR(str1071, "&amp;");
GLOBAL_STR(str1072, "<");
GLOBAL_STR(str1073, "&lt;");
...
GLOBAL_STR(str1099, "/");
GLOBAL_STR(str1100, " \n\r\t");
GLOBAL_STR(str1101, "Unexpected token in QSN string");
GLOBAL_STR(str1102, "Expected closing single quote in QSN string");
GLOBAL_STR(str1103, "Unexpected data after closing quote");
GLOBAL_STR(str1104, "Unexpected token after QSN string");
GLOBAL_STR(str1105, "\\'\r\n\t\u0000");
GLOBAL_STR(str1106, "$'");
GLOBAL_STR(str1107, "'");
GLOBAL_STR(str1108, "'");
...
GLOBAL_STR(str1120, "\n");
GLOBAL_STR(str1121, "\\n");
GLOBAL_STR(str1122, "\r");
GLOBAL_STR(str1123, "\\r");
GLOBAL_STR(str1124, "\t");
GLOBAL_STR(str1125, "\\t");
GLOBAL_STR(str1126, "\u0000");
GLOBAL_STR(str1127, "\\x00");
GLOBAL_STR(str1128, "\\0");
GLOBAL_STR(str1129, "");
GLOBAL_STR(str1130, "");
GLOBAL_STR(str1131, "");
GLOBAL_STR(str1132, "\\");
...
GLOBAL_STR(str1136, "\n");
GLOBAL_STR(str1137, "\\n");
GLOBAL_STR(str1138, "\r");
GLOBAL_STR(str1139, "\\r");
GLOBAL_STR(str1140, "\t");
GLOBAL_STR(str1141, "\\t");
GLOBAL_STR(str1142, "\u0000");
GLOBAL_STR(str1143, "\\x00");
GLOBAL_STR(str1144, "\\0");
GLOBAL_STR(str1145, "");
GLOBAL_STR(str1146, "!");
GLOBAL_STR(str1147, "--");
GLOBAL_STR(str1148, "--dir");
GLOBAL_STR(str1149, "--exists");
GLOBAL_STR(str1150, "--file");
GLOBAL_STR(str1151, "--symlink");
GLOBAL_STR(str1152, "Expected unary operator, got %r (2 args)");
GLOBAL_STR(str1153, "-a");
GLOBAL_STR(str1154, "-o");
GLOBAL_STR(str1155, "!");
GLOBAL_STR(str1156, "(");
GLOBAL_STR(str1157, ")");
GLOBAL_STR(str1158, "Expected binary operator, got %r (3 args)");
GLOBAL_STR(str1159, "should be invoked as 'test' (simple_test_builtin)");
GLOBAL_STR(str1160, "]");
GLOBAL_STR(str1161, "missing closing ]");
GLOBAL_STR(str1162, "should only have 3 arguments or fewer (simple_test_builtin)");
GLOBAL_STR(str1163, "!");
GLOBAL_STR(str1164, "(");
GLOBAL_STR(str1165, ")");
GLOBAL_STR(str1166, "(test) ");
GLOBAL_STR(str1167, "(test) ");
...
class ctx_Tracer : public gc_heap::Obj {
 public:
  ctx_Tracer(dev::Tracer* tracer, Str* desc);
  ~ctx_Tracer();
...
class Tracer : public gc_heap::Obj {
 public:
  ...
  Str* _EvalPS4();
  mylib::BufWriter* _TraceBegin();
  mylib::BufWriter* _TraceBegin2(Str* ch);
  void OnProcessStart(int pid);
  void OnProcessEnd(int pid, int status);
  void SetProcess(int pid);
  void Push(Str* desc);
  void Pop(Str* desc);
  void _Value(runtime_asdl::value_t* val, mylib::BufWriter* buf);
...
inline Str* fmt10(int a0, int a1) {
  gBuf.reset();
  gBuf.write_const("process ", 8);
  gBuf.format_d(a0);
...
inline Str* fmt11(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.write_const("[", 1);
  gBuf.format_s(a0);
  gBuf.write_const("]=", 2);
...
inline Str* fmt13(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("[", 1);
  gBuf.format_s(a1);
...
inline Str* fmt21(int a0, int a1) {
  gBuf.reset();
  gBuf.write_const("[", 1);
  gBuf.write_const("%", 1);
  gBuf.format_d(a0);
...
inline Str* fmt22(int a0, int a1) {
  gBuf.reset();
  gBuf.write_const("[", 1);
  gBuf.write_const("%", 1);
  gBuf.format_d(a0);
...
class FdState : public gc_heap::Obj {
 public:
  FdState(ui::ErrorFormatter* errfmt, process::JobState* job_state, state::Mem* mem, dev::Tracer* tracer);
...
inline Str* fmt26(int a0, Str* a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const(": ", 2);
  gBuf.format_s(a1);
...
inline Str* fmt29(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt30(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt31(int a0, int a1, Str* a2) {
  gBuf.reset();
...
inline Str* fmt32(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt53(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt57(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.write_const("nameref ", 8);
  gBuf.format_r(a0);
...
inline Str* fmt73(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt74(Str* a0, int a1, Str* a2, Str* a3) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const(":", 1);
  gBuf.format_d(a1);
...
inline Str* fmt90(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("-", 1);
  gBuf.format_s(a1);
...
inline Str* fmt98(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.write_const("{", 1);
  gBuf.format_s(a0);
  gBuf.write_const(",", 1);
...
inline Str* fmt109(int a0, int a1) {
  gBuf.reset();
...
inline Str* fmt131(int a0, Str* a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const("  ", 2);
  gBuf.format_s(a1);
...
inline Str* fmt132(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt133(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt145(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt150(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.write_const("alias ", 6);
  gBuf.format_s(a0);
  gBuf.write_const("=", 1);
...
inline Str* fmt160(int a0, Str* a1, int a2) {
  gBuf.reset();
...
inline Str* fmt167(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_r(a0);
...
inline Str* fmt170(Str* a0, int a1, int a2) {
  gBuf.reset();
  gBuf.write_const("proc ", 5);
  gBuf.format_r(a0);
...
inline Str* fmt174(int a0, int a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const(" != ", 4);
  gBuf.format_d(a1);
...
inline Str* fmt178() {
  gBuf.reset();
  gBuf.write_const("procs can't contain other procs or functions", 44);
  return gBuf.getvalue();
}
...
inline Str* fmt185(int a0, int a1) {
  gBuf.reset();
...
inline Str* fmt209(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt220(Str* a0, int a1) {
  gBuf.reset();
...
inline Str* fmt232(Str* a0, Str* a1, syntax_asdl::word_t* a2) {
  gBuf.reset();
...
inline Str* fmt242(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt295(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt315(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("/", 1);
  gBuf.format_s(a1);
...
ctx_Tracer::ctx_Tracer(dev::Tracer* tracer, Str* desc) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(ctx_Tracer)) {
  tracer->Push(desc);
  this->tracer = tracer;
  this->desc = desc;
}
...
Tracer::Tracer(parse_lib::ParseContext* parse_ctx, optview::Exec* exec_opts, state::MutableOpts* mutable_opts, state::Mem* mem, util::_DebugFile* f) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Tracer)) {
  ...
  this->ind = 0;
  this->indents = Alloc<List<Str*>>(std::initializer_list<Str*>{str56});
  this->pid = -1;
...
Str* Tracer::_EvalPS4() {
  ...
  StackRoots _roots({&ps4, &val, &ps4_word, &w_parser, &prefix});

  ps4 = str57;
  ps4 = str58;
  val = this->mem->GetValue(str59);
  ...
  catch (std::exception) { }  return prefix->s;
}

mylib::BufWriter* Tracer::_TraceBegin() {
  Str* prefix = nullptr;
  ...
  prefix = this->_EvalPS4();
  buf = Alloc<mylib::BufWriter>();
  if (this->exec_opts->xtrace_rich()) {
    buf->write(this->indents->index(this->ind));
  }
  buf->write(prefix);
  if (this->pid != -1) {
    buf->write(str(this->pid));
    buf->write(str61);
  }
  return buf;
}

mylib::BufWriter* Tracer::_TraceBegin2(Str* ch) {
  mylib::BufWriter* buf = nullptr;
  StackRoots _roots({&ch, &buf});
...
void Tracer::OnProcessStart(int pid) {
  mylib::BufWriter* buf = nullptr;
  StackRoots _roots({&buf});

  buf = this->_TraceBegin2(str63);
  if (!buf) {
    return ;
  }
  buf->write(fmt9(pid));
...
void Tracer::OnProcessEnd(int pid, int status) {
  ...
  buf = this->_TraceBegin2(str65);
  if (!buf) {
    return ;
  }
  buf->write(fmt10(pid, status));
  this->f->write(buf->getvalue());
}
...
void Tracer::Push(Str* desc) {
  mylib::BufWriter* buf = nullptr;
  StackRoots _roots({&desc, &buf});

  this->ind += 1;
  if (this->ind >= len(this->indents)) {
    this->indents->append(str_repeat(str67, this->ind));
  }
  buf = this->_TraceBegin2(str68);
  if (!buf) {
    return ;
  }
  buf->write(desc);
...
void Tracer::Pop(Str* desc) {
  mylib::BufWriter* buf = nullptr;
  StackRoots _roots({&desc, &buf});

  buf = this->_TraceBegin2(str70);
  if (!buf) {
    return ;
  }
  buf->write(desc);
...
void Tracer::_Value(runtime_asdl::value_t* val, mylib::BufWriter* buf) {
  Str* result = nullptr;
  ...
  switch (val->tag_()) {
    ...
    case value_e::MaybeStrArray: {
      ...
      parts = Alloc<List<Str*>>(std::initializer_list<Str*>{str73});
      ...
      parts->append(str74);
      result = str75->join(parts);
    }
      break;
    case value_e::AssocArray: {
      value__AssocArray* val = static_cast<value__AssocArray*>(UP_val);
      parts = Alloc<List<Str*>>(std::initializer_list<Str*>{str76});
      for (DictIter<Str*, Str*> it(val->d); !it.Done(); it.Next()) {
        Str* k = it.Key();
        Str* v = it.Value();
        parts->append(fmt11(qsn::maybe_shell_encode(k), qsn::maybe_shell_encode(v)));
      }
      parts->append(str78);
      result = str79->join(parts);
    }
      break;
  }
  buf->write(result);
...
void Tracer::OnSimpleCommand(List<Str*>* argv) {
  ...
  StackRoots _roots({&argv, &buf, &tmp});

  buf = this->_TraceBegin();
  if (!buf) {
    return ;
  }
  tmp = Alloc<List<Str*>>();
...
void Tracer::OnAssignBuiltin(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  for (ListIter<Str*> it(cmd_val->argv); !it.Done(); it.Next()) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    buf->write(arg);
    buf->write(str82);
...
void Tracer::OnShAssignment(runtime_asdl::lvalue_t* lval, syntax_asdl::assign_op_t op, runtime_asdl::value_t* val, int flags, runtime_asdl::scope_t which_scopes) {
  ...
  Str* op_str = nullptr;
  StackRoots _roots({&lval, &val, &buf, &left, &UP_lval, &op_str});
  ...
  switch (lval->tag_()) {
    ...
    case lvalue_e::Indexed: {
      ...
      left = fmt12(lval->name, lval->index);
    }
      break;
    case lvalue_e::Keyed: {
      lvalue__Keyed* lval = static_cast<lvalue__Keyed*>(UP_lval);
      left = fmt13(lval->name, qsn::maybe_shell_encode(lval->key));
    }
      break;
  }
  buf->write(left);
  op_str = op == assign_op_e::PlusEqual ? str89 : str90;
  buf->write(op_str);
  this->_Value(val, buf);
  buf->write(str91);
  this->f->write(buf->getvalue());
...
void Tracer::PrintSourceCode(int left_spid, int right_spid, alloc::Arena* arena) {
  ...
  if (left_span->line_id == right_span->line_id) {
    ...
    line = arena->GetLine(left_span->line_id);
    end = line->endswith(str94) ? -1 : len(line);
    buf->write(line->slice(start, end));
    buf->write(str95);
  }
  buf->write(str96);
...
process::Process* ShellExecutor::_MakeProcess(syntax_asdl::command_t* node, bool inherit_errexit) {
  ...
  if (node->tag_() == command_e::ControlFlow) {
    ...
    if (node->token->id != Id::ControlFlow_Exit) {
      e_die(fmt14(node->token->val), node->token);
    }
  }
...
int ShellExecutor::RunBuiltin(int builtin_id, runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  try {
    try {
      ...
      this->errfmt->PrefixPrint(e->msg, fmt15(arg0), e->span_id);
      status = 2;
    }
    catch (KeyboardInterrupt*) {
...
int ShellExecutor::RunSimpleCommand(runtime_asdl::cmd_value__Argv* cmd_val, bool do_fork, bool call_procs) {
  ...
  if (builtin_id != consts::NO_INDEX) {
    this->errfmt->Print_(str102, span_id);
    return 1;
  }
  ...
  if (call_procs) {
    ...
    if (proc_node != nullptr) {
      if ((this->exec_opts->strict_errexit() and this->mutable_opts->ErrExitIsDisabled())) {
        this->errfmt->Print_(str103, this->mutable_opts->ErrExitSpanId());
        this->errfmt->StderrLine(str104);
        e_die(fmt17(), span_id);
      }
      {  // with
        dev::ctx_Tracer ctx(this->tracer, fmt18(arg0));
  ...
  if (cmd_val->block) {
    e_die(fmt19(arg0), cmd_val->block->spids->index(0));
  }
  argv0_path = this->search_path->CachedLookup(arg0);
  if (argv0_path == nullptr) {
    this->errfmt->Print_(fmt20(arg0), span_id);
    return 127;
  }
  if (do_fork) {
...
int ShellExecutor::RunBackgroundJob(syntax_asdl::command_t* node) {
  ...
  if (UP_node->tag_() == command_e::Pipeline) {
    ...
    println_stderr(fmt21(job_id, last_pid));
  }
  else {
    ...
    println_stderr(fmt22(job_id, pid));
  }
  return 0;
}
...
Str* ShellExecutor::RunCommandSub(syntax_asdl::command_sub* cs_part) {
  ...
  if (node->tag_() == command_e::Simple) {
    ...
    if ((len(simple->words) == 0 and (len(simple->redirects) == 1 and simple->redirects->index(0)->op->id == Id::Redir_Less))) {
      tok = Alloc<Token>(Id::Lit_Chars, runtime::NO_SPID, str112);
  ...
  if (this->exec_opts->command_sub_errexit()) {
    if (status != 0) {
      throw Alloc<error::ErrExit>(fmt23(status, ui::CommandType(node)), cs_part->left_token->span_id, status);
    }
  }
  else {
  ...
  return str114->join(chunks)->rstrip(str115);
}
...
FdState::FdState(ui::ErrorFormatter* errfmt, process::JobState* job_state, state::Mem* mem, dev::Tracer* tracer) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(FdState)) {
  this->errfmt = errfmt;
  this->job_state = job_state;
...
mylib::LineReader* FdState::Open(Str* path) {
  ...
  return this->_Open(path, str119, fd_mode);
}
...
int FdState::_PushDup(int fd1, syntax_asdl::redir_loc_t* loc) {
  ...
  if (loc->tag_() == redir_loc_e::VarName) {
    ...
    try {
      ...
      if (e->errno == errno_::EBADF) {
        this->errfmt->Print_(fmt26(fd1, pyutil::strerror(e)));
        return NO_FD;
      }
      else {
        throw ;
    ...
    if (loc->tag_() == redir_loc_e::Fd) {
      ...
      try {
        ...
        this->errfmt->Print_(fmt27(fd1, pyutil::strerror(e)));
        throw ;
      }
      ...
      try {
        ...
        this->errfmt->Print_(fmt28(fd1, pyutil::strerror(e)));
        if (need_restore) {
...
void FdState::_ApplyRedirect(runtime_asdl::redirect* r, process::Waiter* waiter) {
  ...
  StackRoots _roots({&r, &waiter, &arg, &UP_arg, &UP_loc, &thunk, &here_proc});
  ...
  switch (arg->tag_()) {
    case redirect_arg_e::Path: {
      ...
      try {
        ...
        this->errfmt->Print_(fmt29(arg->filename, pyutil::strerror(e)), r->op_spid);
        throw ;
      }
...
bool FdState::Push(List<runtime_asdl::redirect*>* redirects, process::Waiter* waiter) {
  ...
  StackRoots _roots({&redirects, &waiter, &new_frame});
  ...
  for (ReverseListIter<process::_RedirFrame*> it(frame->saved); !it.Done(); it.Next()) {
    ...
    if (rf->saved_fd == NO_FD) {
      try {
        ...
        println_stderr(fmt30(rf->orig_fd, pyutil::strerror(e)));
        throw ;
      }
    }
    else {
      try {
        ...
        println_stderr(fmt31(rf->saved_fd, rf->orig_fd, pyutil::strerror(e)));
        throw ;
      }
      posix::close(rf->saved_fd);
    }
...
void ExternalProgram::_Exec(Str* argv0_path, List<Str*>* argv, int argv0_spid, Dict<Str*, Str*>* environ, bool should_retry) {
  ...
  try {
    ...
    if ((e->errno == errno_::ENOEXEC and should_retry)) {
      new_argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str128, argv0_path});
      new_argv->extend(argv->slice(1));
      this->_Exec(str129, new_argv, argv0_spid, environ, false);
    }
    this->errfmt->Print_(fmt32(argv0_path, pyutil::strerror(e)), argv0_spid);
...
Str* SubProgramThunk::DisplayLine() {
  return fmt34(ui::CommandType(this->node));
}
...
void SubProgramThunk::Run() {
  ...
  try {
    ...
    println_stderr(fmt35(pyutil::strerror(e)));
    status = 2;
  }
  exit(status);
}
...
int Process::Start() {
  ...
  pid = posix::fork();
  if (pid < 0) {
    throw Alloc<RuntimeError>(str138);
  }
  else {
    if (pid == 0) {
  ...
  this->tracer->OnProcessStart(pid);
  this->pid = pid;
...
int Process::Wait(process::Waiter* waiter) {
  ...
  this->tracer->OnProcessEnd(this->pid, this->status);
  return this->status;
}
...
runtime_asdl::job_status_t* Pipeline::JobWait(process::Waiter* waiter) {
  ...
  StackRoots _roots({&waiter, &pipe_status});
  ...
  if (WIFSIGNALED(status)) {
    ...
    if (WIFEXITED(status)) {
      ...
      if (WIFSTOPPED(status)) {
        println_stderr(str144);
        println_stderr(fmt38(pid));
...
runtime_asdl::cmd_value__Argv* MakeBuiltinArgv(List<Str*>* argv1) {
  ...
  argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str146});
  argv->extend(argv1);
...
void AddPure(Dict<int, vm::_Builtin*>* b, state::Mem* mem, Dict<Str*, runtime_asdl::Proc*>* procs, state::MutableOpts* mutable_opts, Dict<Str*, Str*>* aliases, state::SearchPath* search_path, ui::ErrorFormatter* errfmt) {
  ...
  StackRoots _roots({&b, &mem, &procs, &mutable_opts, &aliases, &search_path, &errfmt, &true_});
...
int Main(Str* lang, args::Reader* arg_r, Dict<Str*, Str*>* environ, bool login_shell, pyutil::_ResourceLoader* loader, void* line_input) {
  ...
  StackRoots _roots({&lang, &arg_r, &environ, &loader, &line_input, &argv0, &attrs, &flag, &arena, &errfmt, &help_builtin, &no_str, &debug_stack, &dollar0, &frame0, &frame1, &script_name, &mem, &opt_hook, &parse_opts, &exec_opts, &mutable_opts, &version_str, &procs, &aliases, &oil_grammar, &parse_ctx, &comp_arena, &trail1, &comp_ctx, &hist_arena, &trail2, &hist_ctx, &cmd_deps, &debug_path, &debug_dir, &debug_f, &trace_f, &tracer, &job_state, &fd_state, &waiter, &interp, &search_path, &ext_prog, &splitter, &crash_dump_dir, &dir_stack, &builtins, &arith_ev, &bool_ev, &expr_ev, &word_ev, &assign_b, &cmd_ev, &shell_ex, &prompt_ev, &line_reader, &stdin, &f, &c_parser, &node, &input_path, &box});

  argv0 = arg_r->Peek();
  arg_r->Next();
  try {
    attrs = flag_spec::ParseMore(str147, arg_r);
  }
  catch (error::Usage* e) {
    println_stderr(fmt39(e->msg));
    return 2;
  }
  ...
  if (flag->help) {
    help_builtin->Run(MakeBuiltinArgv(Alloc<List<Str*>>(std::initializer_list<Str*>{fmt40(lang)})));
    return 0;
  }
  if (flag->version) {
    pyutil::ShowAppVersion(str150, loader);
    return 0;
  }
  no_str = nullptr;
  ...
  if (arg_r->AtEnd()) {
    ...
    dollar0 = arg_r->Peek();
    frame0 = Alloc<state::DebugFrame>(dollar0, str151, no_str, state::LINE_ZERO, 0, 0);
  ...
  if (str_equals(lang, str152)) {
    mutable_opts->SetShoptOption(str153, true);
  }
  ...
  comp_arena->PushSource(Alloc<source::Unused>(str155));
  ...
  hist_arena->PushSource(Alloc<source::Unused>(str156));
  ...
  my_pid = posix::getpid();
  debug_path = str157;
  debug_dir = environ->get(str158);
  if (flag->debug_file != nullptr) {
    debug_path = flag->debug_file;
  }
  else {
    if (debug_dir != nullptr) {
      debug_path = os_path::join(debug_dir, fmt41(my_pid));
    }
  }
  if (len(debug_path)) {
    throw Alloc<NotImplementedError>();
  ...
  if (len(debug_path)) {
    println_stderr(fmt42(debug_path));
  }
  ...
  fd_state = Alloc<process::FdState>(errfmt, job_state, mem, tracer);
  waiter = Alloc<process::Waiter>(job_state, exec_opts);
  interp = environ->get(str161, str162);
  ...
  crash_dump_dir = environ->get(str163, str164);
  ...
  if (flag->c != nullptr) {
    ...
    if (flag->i) {
      ...
      if (script_name == nullptr) {
        stdin = mylib::Stdin();
        arena->PushSource(Alloc<source::Stdin>(str165));
        ...
        try {
          ...
          println_stderr(fmt43(script_name, pyutil::strerror(e)));
          return 1;
        }
...
Str* SearchPath::Lookup(Str* name, bool exec_required) {
  ...
  val = this->mem->GetValue(str175);
  UP_val = val;
  if (val->tag_() == value_e::Str) {
    value__Str* val = static_cast<value__Str*>(UP_val);
    path_list = val->s->split(str176);
  }
  else {
...
void MutableOpts::Init() {
  ...
  UP_shellopts = this->mem->GetValue(str180);
...
void MutableOpts::SetOption(Str* opt_name, bool b) {
  ...
  UP_val = this->mem->GetValue(str184);
  value__Str* val = static_cast<value__Str*>(UP_val);
  shellopts = val->s;
  if (b) {
    if (!str_contains(shellopts, opt_name)) {
      new_val = Alloc<value::Str>(fmt50(shellopts, opt_name));
      this->mem->InternalSetGlobal(str186, new_val);
    }
  }
  else {
    if (str_contains(shellopts, opt_name)) {
      names = Alloc<List<Str*>>();
      for (ListIter<Str*> it(shellopts->split(str187)); !it.Done(); it.Next()) {
        Str* n = it.Value();
        if (!(str_equals(n, opt_name))) {
          names->append(n);
        }
      }
      new_val = Alloc<value::Str>(str188->join(names));
      this->mem->InternalSetGlobal(str189, new_val);
    }
  }
}
...
void MutableOpts::SetShoptOption(Str* opt_name, bool b) {
  ...
  if (str_equals(opt_name, str190)) {
    this->_SetGroup(consts::OIL_BASIC, b);
    return ;
  }
  if (str_equals(opt_name, str191)) {
    this->_SetGroup(consts::OIL_ALL, b);
    return ;
  }
  if (str_equals(opt_name, str192)) {
...
void MutableOpts::ShowOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    b = this->Get(opt_num);
    print(fmt51(b ? str194 : str195, opt_name));
  }
}
...
void MutableOpts::ShowShoptOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<int> it(opt_nums); !it.Done(); it.Next()) {
    ...
    print(fmt53(b ? str201 : str202, consts::OptionName(opt_num)));
  }
}
...
void _InitDefaults(state::Mem* mem) {
  ...
  SetGlobalString(mem, str205, split::DEFAULT_IFS);
  SetGlobalString(mem, str206, str(posix::getuid()));
  SetGlobalString(mem, str207, str(posix::geteuid()));
  SetGlobalString(mem, str208, str(posix::getppid()));
  SetGlobalString(mem, str209, libc::gethostname());
  SetGlobalString(mem, str210, pyos::OsType());
  SetGlobalString(mem, str211, str212);
  SetGlobalString(mem, str213, str214);
  SetGlobalString(mem, str215, _READLINE_DELIMS);
}
...
void _InitVarsFromEnv(state::Mem* mem, Dict<Str*, Str*>* environ) {
  ...
  val = mem->GetValue(str216);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str217, str218);
  }
  mem->SetValue(Alloc<lvalue::Named>(str219), nullptr, scope_e::GlobalOnly, SetReadOnly);
  val = mem->GetValue(str220);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str221, _GetWorkingDir());
  }
  mem->SetValue(Alloc<lvalue::Named>(str222), nullptr, scope_e::GlobalOnly, SetExport);
}
...
void InitMem(state::Mem* mem, Dict<Str*, Str*>* environ, Str* version_str) {
  ...
  SetGlobalString(mem, str223, version_str);
  _InitDefaults(mem);
  _InitVarsFromEnv(mem, environ);
  val = mem->GetValue(str224);
...
Mem::Mem(Str* dollar0, List<Str*>* argv, alloc::Arena* arena, List<state::DebugFrame*>* debug_stack) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Mem)) {
  ...
  this->line_num = Alloc<value::Str>(str225);
...
Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> Mem::_ResolveNameOrRef(Str* name, runtime_asdl::scope_t which_scopes, bool ref_required) {
  ...
  StackRoots _roots({&name, &cell, &name_map, &val, &UP_val, &new_name, &cell_name});
...
void Mem::_DisallowNamerefCycle(Str* name, runtime_asdl::scope_t which_scopes, List<Str*>* ref_trail) {
  ...
  runtime_asdl::value_t* val = nullptr;
  Str* new_name = nullptr;
  StackRoots _roots({&name, &ref_trail, &cell, &val, &new_name});
  ...
  if (list_contains(ref_trail, new_name)) {
    e_die(fmt58(str237->join(ref_trail)));
  }
...
void Mem::SetValue(runtime_asdl::lvalue_t* lval, runtime_asdl::value_t* val, runtime_asdl::scope_t which_scopes, int flags) {
  ...
  Dict<Str*, runtime_asdl::cell*>* name_map = nullptr;
  Str* cell_name = nullptr;
  List<Str*>* ref_trail = nullptr;
  int left_spid;
  runtime_asdl::value_t* UP_cell_val = nullptr;
  List<Str*>* strs = nullptr;
  int n;
  int index;
  StackRoots _roots({&lval, &val, &UP_lval, &cell, &name_map, &cell_name, &ref_trail, &UP_cell_val, &strs});
  ...
  switch (lval->tag_()) {
    case lvalue_e::Named: {
      ...
      if (keyword_id == Id::KW_SetRef) {
        lval->name = str_concat(str238, lval->name);
      }
    ...
    case lvalue_e::Indexed: {
      ...
      e_die(fmt62(ui::ValType(cell->val)), left_spid);
    }
      break;
    case lvalue_e::Keyed: {
      lvalue__Keyed* lval = static_cast<lvalue__Keyed*>(UP_lval);
...
runtime_asdl::value_t* Mem::GetValue(Str* name, runtime_asdl::scope_t which_scopes) {
  ...
  if (str_equals(name, str246)) {
    return Alloc<value::MaybeStrArray>(this->GetArgv());
  }
  if (str_equals(name, str247)) {
    return Alloc<value::Str>(str(this->last_status->index(-1)));
  }
  if ((str_equals(name, str248) || str_equals(name, str249))) {
    return Alloc<value::MaybeStrArray>();
  }
  if (str_equals(name, str250)) {
    return Alloc<value::MaybeStrArray>();
  }
  if (str_equals(name, str251)) {
    strs = Alloc<List<Str*>>();
...
bool Mem::Unset(runtime_asdl::lvalue_t* lval, bool strict) {
  ...
  if (cell->readonly) {
    throw Alloc<error::Runtime>(fmt64(var_name));
  }
  switch (lval->tag_()) {
    case lvalue_e::Named: {
    ...
    case lvalue_e::Indexed: {
      ...
      if (val->tag_() != value_e::MaybeStrArray) {
        throw Alloc<error::Runtime>(fmt65(var_name));
      }
      value__MaybeStrArray* val = static_cast<value__MaybeStrArray*>(UP_val);
      strs = val->strs;
      n = len(strs);
...
Str* GetString(state::Mem* mem, Str* name) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      throw Alloc<error::Runtime>(fmt66(name));
    }
      break;
    case value_e::Str: {
      ...
      break;
    default: {
      throw Alloc<error::Runtime>(fmt67(name));
    }
  }
}
...
int GetInteger(state::Mem* mem, Str* name) {
  ...
  val = mem->GetValue(name);
  if (val->tag_() != value_e::Str) {
    throw Alloc<error::Runtime>(fmt68(name, ui::ValType(val)));
  }
  ...
  try {
    ...
    throw Alloc<error::Runtime>(fmt69(name, s));
  }
  return i;
}
...
Str* PrettyDir(Str* dir_name, Str* home_dir) {
  ...
  if (home_dir != nullptr) {
    if ((str_equals(dir_name, home_dir) or dir_name->startswith(str_concat(home_dir, str265)))) {
      return str_concat(str266, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    StackRoots _for({&c  });
    f->write(str_equals(c, str269) ? str270 : str271);
  }
  f->write(str272);
  f->write(str_repeat(str273, (length - 1)));
  f->write(str274);
}
...
void _PrintWithSpanId(Str* prefix, Str* msg, int span_id, alloc::Arena* arena, mylib::Writer* f) {
  ...
  switch (src->tag_()) {
    ...
    case source_e::EvalArg: {
      ...
      source_str = fmt73(line_num, outer_source);
    }
      break;
    case source_e::Trap: {
      source_str = str282;
  ...
  f->write(fmt74(source_str, line_num, prefix, msg));
}
...
void PrettyPrintError(error::_ErrorWithLocation* err, alloc::Arena* arena) {
  PrettyPrintError(err, arena, str286);
}
...
void ErrorFormatter::Print_(Str* msg, int span_id) {
  ...
  _PrintWithOptionalSpanId(str287, msg, span_id, this->arena);
}
...
void PrintAst(syntax_asdl::command_t* node, arg_types::main* flag) {
  ...
  if (maybe_str_equals(flag->ast_format, str289)) {
    println_stderr(str290);
  }
  else {
    f = mylib::Stdout();
    afmt = flag->ast_format;
    if ((maybe_str_equals(afmt, str291) || maybe_str_equals(afmt, str292))) {
      ast_f = fmt::DetectConsoleOutput(f);
    }
    else {
      if ((maybe_str_equals(afmt, str293) || maybe_str_equals(afmt, str294))) {
...
void _Attributes::Set(Str* name, runtime_asdl::value_t* val) {
  ...
  name = name->replace(str298, str299);
...
bool SetAttachedBool::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  if (attached_arg != nullptr) {
    if ((str_equals(attached_arg, str315) || str_equals(attached_arg, str316) || str_equals(attached_arg, str317) || str_equals(attached_arg, str318))) {
      b = false;
    }
    else {
      if ((str_equals(attached_arg, str319) || str_equals(attached_arg, str320) || str_equals(attached_arg, str321) || str_equals(attached_arg, str322))) {
        b = true;
      }
      else {
        e_usage(fmt76(attached_arg));
      }
    }
  }
  else {
...
bool SetOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str324);
...
bool SetNamedOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str325);
  arg_r->Next();
  arg = arg_r->Peek();
  if (arg == nullptr) {
...
args::_Attributes* Parse(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str329)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if ((len(spec->actions_long) and arg->startswith(str330))) {
      ...
      if ((arg->startswith(str332) and len(arg) > 1)) {
        n = len(arg);
        for (int i = 1; i < n; ++i) {
          ch = arg->index(i);
          if (str_equals(ch, str333)) {
            ch = str334;
          }
          if (list_contains(spec->plus_flags, ch)) {
            out->Set(ch, Alloc<value::Str>(str335));
            continue;
          }
        ...
        if ((len(spec->plus_flags) and (arg->startswith(str338) and len(arg) > 1))) {
          n = len(arg);
          for (int i = 1; i < n; ++i) {
            ch = arg->index(i);
            if (list_contains(spec->plus_flags, ch)) {
              out->Set(ch, Alloc<value::Str>(str339));
              continue;
            }
            e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
          }
...
args::_Attributes* ParseLikeEcho(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    chars = arg->slice(1);
    if ((arg->startswith(str342) and len(chars))) {
      done = false;
...
args::_Attributes* ParseMore(flag_spec::_FlagSpecAndMore* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str343)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if (arg->startswith(str344)) {
      action = spec->actions_long->get(arg->slice(2));
      if (action == nullptr) {
        e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
      }
    ...
    if (((arg->startswith(str346) or arg->startswith(str347)) and len(arg) > 1)) {
      char0 = arg->index(0);
...
int LineLexer::GetSpanIdForEof() {
  int line_id;
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str352, 0);
  }
  else {
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str354, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = Alloc<Token>(id_, span_id, str355);
      return t;
    }
...
lexer::Lexer* ParseContext::_MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = Alloc<lexer::LineLexer>(str357, this->arena);
...
int _Classify(grammar::Grammar* gr, syntax_asdl::Token* tok) {
  ...
  type_str = tok->id == Id::Unknown_Tok ? str361 : fmt80(ui::PrettyId(tok->id));
  p_die(fmt81(type_str), tok);
}
...
Tuple2<pnode::PNode*, syntax_asdl::Token*> ExprParser::Parse(lexer::Lexer* lexer, int start_symbol) {
  ...
  try {
    ...
    p_die(fmt82(ui::PrettyId(e->tok->id)), e->tok);
  }
...
GLOBAL_LIST(Str*, 12, POSIX_CLASSES, {str365 COMMA str366 COMMA str367 COMMA str368 COMMA str369 COMMA str370 COMMA str371 COMMA str372 COMMA str373 COMMA str374 COMMA str375 COMMA str376});
Str* RANGE_POINT_TOO_LONG = str377;
int NT_OFFSET = 256;
...
syntax_asdl::expr_t* Transformer::_Tuple(List<pnode::PNode*>* children) {
  ...
  if (n == 2) {
    p_die(fmt83(), children->index(1)->tok);
  }
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw Alloc<NotImplementedError>(str379);
  }
  if (id0 == Id::Op_LBracket) {
    elts = Alloc<List<syntax_asdl::expr_t*>>();
    for (int i = 0; i < n; i += 2) {
  ...
  for (int i = 0; i < n; i += 2) {
    ...
    if (tag == expr_e::Var) {
      ...
      if ((tag == place_expr_e::Var || tag == place_expr_e::Subscript || tag == place_expr_e::Attribute)) {
        ...
        p_die(fmt84(), p->tok ? p->tok : nullptr);
      }
    }
  }
  return places;
...
syntax_asdl::re_t* Transformer::_NameInRegex(syntax_asdl::Token* negated_tok, syntax_asdl::Token* tok) {
  ...
  val = tok->val;
  if (maybe_str_equals(val, str384)) {
    if (negated_tok) {
      p_die(fmt85(), tok);
    }
    return tok;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((str_equals(tok->val, str389) || str_equals(tok->val, str390) || str_equals(tok->val, str391))) {
        return tok;
      }
      p_die(fmt89(tok->val), tok);
    }
...
void _ClassLiteralToPosixEre(syntax_asdl::class_literal_term_t* term, List<Str*>* parts) {
  ...
  if (tag == class_literal_term_e::CodePoint) {
    ...
    if (code_point < 128) {
      ...
      e_die(fmt91(code_point), term->spid);
    }
    return ;
  }
  if (tag == class_literal_term_e::PerlClass) {
    ...
    if (term->negated) {
      e_die(fmt92(), term->negated->span_id);
    }
    else {
      pat = fmt93(chars);
    }
  ...
  if (tag == class_literal_term_e::PosixClass) {
    ...
    n = term->name;
    if (term->negated) {
      e_die(fmt94(), term->negated->span_id);
    }
    else {
      pat = fmt95(n);
    }
...
void AsPosixEre(syntax_asdl::re_t* node, List<Str*>* parts) {
  ...
  if (tag == re_e::Repeat) {
    ...
    if (op_tag == re_repeat_e::Num) {
      ...
      parts->append(fmt97(op->times->val));
      return ;
    }
    if (op_tag == re_repeat_e::Range) {
      re_repeat__Range* op = static_cast<re_repeat__Range*>(UP_op);
      lower = op->lower ? op->lower->val : str408;
      upper = op->upper ? op->upper->val : str409;
      parts->append(fmt98(lower, upper));
      return ;
    }
...
syntax_asdl::bool_expr_t* BoolParser::ParseForBuiltin() {
  ...
  if (this->bool_id != Id::Eof_Real) {
    p_die(fmt105(word_::Pretty(this->cur_word)), this->cur_word);
  }
  return node;
}
...
syntax_asdl::bool_expr_t* BoolParser::ParseFactor() {
  ...
  if (this->bool_id == Id::Op_LParen) {
    ...
    if (this->bool_id != Id::Op_RParen) {
      p_die(fmt107(word_::Pretty(this->cur_word)), this->cur_word);
    }
    this->_Next();
    return node;
  }
  p_die(fmt108(ui::PrettyId(this->bool_id)), this->cur_word);
}
...
Str* _RangeParser::_Eat(int token_type) {
  ...
  if (this->token_type != token_type) {
    throw Alloc<_NotARange>(fmt109(token_type, this->token_type));
  }
  val = this->token_val;
  this->_Next();
  return val;
  ...
  if (this->token_type == Id::Range_Int) {
    ...
    if (start < end) {
      ...
      if (start > end) {
        ...
        if (part->step >= 0) {
          p_die(fmt112(part->step), this->span_id);
        }
      }
      else {
        part->step = 1;
    ...
    if (this->token_type == Id::Range_Char) {
      ...
      if (start_num < end_num) {
        ...
        if (part->step <= 0) {
          p_die(fmt113(part->step), this->span_id);
        }
      }
      else {
        if (start_num > end_num) {
          ...
          if (part->step >= 0) {
            p_die(fmt114(part->step), this->span_id);
          }
        }
        else {
          part->step = 1;
      ...
      if (upper1 != upper2) {
        p_die(fmt115(), this->span_id);
      }
    }
    else {
      throw Alloc<_NotARange>(str434);
    }
  }
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  flag = attrs->attrs;
  tmp_g = flag->get(str437);
  tmp_a = flag->get(str438);
  tmp_A = flag->get(str439);
  ...
  flag_A = (tmp_A and tmp_A->tag_() == value_e::Bool) ? static_cast<value__Bool*>(tmp_A)->b : false;
  tmp_n = flag->get(str440);
  tmp_r = flag->get(str441);
  tmp_x = flag->get(str442);
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if ((maybe_str_equals(flag_n, str444) and !cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_n, str445) and cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str446) and !cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str447) and cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str448) and !cell->exported)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str449) and cell->exported)) {
      continue;
    }
    ...
    if (print_flags) {
      ...
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str456, str457->join(flags), str458, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str459, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (has_holes) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str462, name, str463, str(i), str464, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str466, str467->join(body), str468}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str470, key_quoted, str471, value_quoted}));
          }
          if (len(body) > 0) {
            decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str472, str473->join(body), str474}));
          }
        }
        else {
          ;  // pass
...
int Export::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r->Next();
  attrs = flag_spec::Parse(str476, arg_r);
...
int Readonly::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str481, arg_r);
...
int NewVar::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str482, arg_r);
  ...
  flags = 0;
  if (maybe_str_equals(arg->x, str485)) {
    flags |= state::SetExport;
  }
  if (maybe_str_equals(arg->r, str486)) {
    flags |= state::SetReadOnly;
  }
  if (maybe_str_equals(arg->n, str487)) {
    flags |= state::SetNameref;
  }
  flags_to_clear = 0;
  if (maybe_str_equals(arg->x, str488)) {
    flags |= state::ClearExport;
  }
  if (maybe_str_equals(arg->r, str489)) {
    flags |= state::ClearReadOnly;
  }
  if (maybe_str_equals(arg->n, str490)) {
...
bool Unset::_UnsetVar(Str* arg, int spid, bool proc_fallback) {
  ...
  bool found;
  StackRoots _roots({&arg, &arena, &a_parser, &anode, &lval});
...
int Unset::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str493, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
...
int Eval::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str496, cmd_val);
  arg_r = tup0.at1();
  if (this->exec_opts->simple_eval_builtin()) {
    Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str497);
    code_str = tup1.at0();
    eval_spid = tup1.at1();
    if (!arg_r->AtEnd()) {
      e_usage(str498);
    ...
    code_str = str499->join(arg_r->Rest());
...
int Source::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str500, cmd_val);
  arg_r = tup2.at1();
  path = arg_r->Peek();
  if (path == nullptr) {
    e_usage(str501);
  ...
  try {
    ...
    this->errfmt->Print_(fmt124(path, pyutil::strerror(e)), cmd_val->arg_spids->index(1));
    return 1;
  }
  try {
    try {
...
int Command::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup3 = flag_spec::ParseCmdVal(str503, cmd_val);
  attrs = tup3.at0();
  arg_r = tup3.at1();
...
int Builtin::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (to_run == consts::NO_INDEX) {
    ...
    if (consts::LookupAssignBuiltin(name) != consts::NO_INDEX) {
      this->errfmt->Print_(str504, span_id);
    }
    else {
      this->errfmt->Print_(fmt125(name), span_id);
    }
    return 1;
  }
...
int _AdjustStatus(Str* status_ok, int status) {
  StackRoots _roots({&status_ok});

  if ((str_equals(status_ok->lower(), str506) and status == 141)) {
    status = 0;
  }
  return status;
}
...
int Run_::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseOilCmdVal(str507, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
  ...
  if ((arg->allow_status_01 and (status != 0 && status != 1))) {
    if (failure_spid != runtime::NO_SPID) {
      this->errfmt->Print_(str509, failure_spid);
      this->errfmt->StderrLine(str510);
    }
    throw Alloc<error::ErrExit>(fmt127(status), spids->index(0), status);
  }
  if (arg->assign_status != nullptr) {
    var_name = arg->assign_status;
    if (var_name->startswith(str512)) {
...
List<Tuple2<Str*, Str*>*>* _ResolveNames(List<Str*>* names, Dict<Str*, runtime_asdl::Proc*>* funcs, Dict<Str*, Str*>* aliases, state::SearchPath* search_path) {
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if (dict_contains(funcs, name)) {
      kind = (Alloc<Tuple2<Str*, Str*>>(str513, name));
    }
    else {
      if (dict_contains(aliases, name)) {
        kind = (Alloc<Tuple2<Str*, Str*>>(str514, name));
      }
      else {
        if (consts::LookupNormalBuiltin(name) != 0) {
          kind = (Alloc<Tuple2<Str*, Str*>>(str515, name));
        }
        else {
          if (consts::LookupSpecialBuiltin(name) != 0) {
            kind = (Alloc<Tuple2<Str*, Str*>>(str516, name));
          }
          else {
            if (consts::LookupAssignBuiltin(name) != 0) {
              kind = (Alloc<Tuple2<Str*, Str*>>(str517, name));
            }
            else {
              if (consts::IsControlFlow(name)) {
                kind = (Alloc<Tuple2<Str*, Str*>>(str518, name));
              }
              else {
                if (consts::IsKeyword(name)) {
                  kind = (Alloc<Tuple2<Str*, Str*>>(str519, name));
                }
                else {
                  ...
                  if (resolved == nullptr) {
                    ...
                    kind = (Alloc<Tuple2<Str*, Str*>>(str520, resolved));
                  }
                }
              }
            }
...
int Type::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup7 = flag_spec::ParseCmdVal(str521, cmd_val);
  attrs = tup7.at0();
  arg_r = tup7.at1();
  ...
  for (ListIter<Tuple2<Str*, Str*>*> it(r); !it.Done(); it.Next()) {
    ...
    name = tup8->at1();
    if (kind == nullptr) {
      this->errfmt->StderrLine(fmt128(name));
      status = 1;
    }
    else {
      if (arg->t) {
        ...
        if (arg->p) {
          if (str_equals(kind, str523)) {
            print(name);
          }
        }
        else {
          if (arg->P) {
            if (str_equals(kind, str524)) {
              print(name);
            }
            else {
            ...
            print(fmt129(name, kind));
            if (str_equals(kind, str526)) {
              ;  // pass
            }
          }
        }
...
Tuple2<Str*, bool> _ReadUntilDelim(Str* delim_char) {
  ...
  return (Tuple2<Str*, bool>(str527->join(chars), eof));
}
...
Str* _ReadLine() {
  ...
  while (true) {
    ...
    chars->append(c);
    if (str_equals(c, str528)) {
      break;
    }
  }
  return str529->join(chars);
}
...
int Read::_Line(arg_types::read* arg, Str* var_name) {
  ...
  if (!arg->with_eol) {
    if (line->endswith(str531)) {
      line = line->slice(0, -2);
    }
    else {
      if (line->endswith(str532)) {
        line = line->slice(0, -1);
      }
    }
  }
  if ((arg->q and line->startswith(str533))) {
    arena = this->parse_ctx->arena;
    line_reader = reader::StringLineReader(line, arena);
    lexer = this->parse_ctx->_MakeLexer(line_reader);
    try {
      {  // with
        alloc::ctx_Location ctx(arena, Alloc<source::Stdin>(str534));
...
int Read::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str536, cmd_val);
  attrs = tup2.at0();
  arg_r = tup2.at1();
  ...
  if (arg->line) {
    ...
    next_spid = tup4.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str539, next_spid);
    }
  ...
  if (arg->all) {
    ...
    next_spid = tup6.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str543, next_spid);
    }
...
int Read::_Read(arg_types::read* arg, List<Str*>* names) {
  ...
  int num_parts;
  StackRoots _roots({&arg, &names, &name, &s, &delim_char, &parts, &line, &spans, &entries});
...
int MapFile::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseCmdVal(str553, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  while (true) {
    ...
    if ((arg->t and line->endswith(str556))) {
      line = line->slice(0, -1);
    }
    lines->append(line);
  }
...
int Cd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  int err_num;
  Dict<Str*, runtime_asdl::cell*>* unused = nullptr;
  StackRoots _roots({&cmd_val, &attrs, &arg_r, &arg, &dest_dir, &val, &pwd, &abspath, &real_dest_dir, &unused});

  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseCmdVal(str557, cmd_val);
  attrs = tup11.at0();
  arg_r = tup11.at1();
  ...
  arg_spid = tup12.at1();
  if (dest_dir == nullptr) {
    val = this->mem->GetValue(str558);
    try {
      dest_dir = state::GetString(this->mem, str559);
    }
    catch (error::Runtime* e) {
  ...
  if (str_equals(dest_dir, str560)) {
    try {
      dest_dir = state::GetString(this->mem, str561);
      print(dest_dir);
    }
    catch (error::Runtime* e) {
      this->errfmt->Print_(e->UserErrorString());
  ...
  try {
    pwd = state::GetString(this->mem, str562);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    return 1;
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt130(real_dest_dir, posix::strerror(err_num)), arg_spid);
    return 1;
  }
  state::ExportGlobalString(this->mem, str564, real_dest_dir);
  ...
  if (cmd_val->block) {
    ...
    state::ExportGlobalString(this->mem, str565, pwd);
...
void _PrintDirStack(state::DirStack* dir_stack, int style, Str* home_dir) {
  ...
  if (style == WITH_LINE_NUMBERS) {
    ...
    for (ListIter<Str*> it(dir_stack->Iter()); !it.Done(); it.Next(), ++i) {
      ...
      print(fmt131(i, ui::PrettyDir(entry, home_dir)));
    }
  }
  else {
...
int Pushd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt132(dest_dir, posix::strerror(err_num)), cmd_val->arg_spids->index(1));
    return 1;
  }
  this->dir_stack->Push(dest_dir);
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str571));
  state::ExportGlobalString(this->mem, str572, dest_dir);
...
bool _PopDirStack(state::Mem* mem, state::DirStack* dir_stack, ui::ErrorFormatter* errfmt) {
  ...
  if (dest_dir == nullptr) {
    errfmt->Print_(str573);
    return false;
  }
  err_num = pyos::Chdir(dest_dir);
  if (err_num != 0) {
    errfmt->Print_(fmt133(dest_dir, posix::strerror(err_num)));
    return false;
  }
  state::SetGlobalString(mem, str575, dest_dir);
  mem->SetPwd(dest_dir);
  return true;
}
...
int Popd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->arg_spids) > 1) {
    e_usage(fmt134(), cmd_val->arg_spids->index(1));
  }
  if (!_PopDirStack(this->mem, this->dir_stack, this->errfmt)) {
    return 1;
  }
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str577));
  return 0;
}
...
int Dirs::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup13 = flag_spec::ParseCmdVal(str578, cmd_val);
  attrs = tup13.at0();
  arg_r = tup13.at1();
  arg = Alloc<arg_types::dirs>(attrs->attrs);
  home_dir = state::MaybeString(this->mem, str579);
  style = SINGLE_LINE;
  if (arg->l) {
    home_dir = nullptr;
  }
...
int Pwd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup14 = flag_spec::ParseCmdVal(str580, cmd_val);
  attrs = tup14.at0();
  arg_r = tup14.at1();
...
List<Str*>* Help::_Groups() {
  ...
  contents = this->loader->Get(str581);
...
int Help::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str582, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  ...
  try {
    contents = this->loader->Get(fmt135(topic));
  }
  catch (IOError*) {
    this->errfmt->Print_(fmt136(topic), blame_spid);
    return 1;
  }
  print(contents);
  return 0;
...
syntax_asdl::printf_part_t* _FormatStringParser::_ParseFormatStr() {
  ...
  while ((this->token_type == Id::Format_Flag || this->token_type == Id::Format_Zero)) {
    ...
    if (str_contains(str586, flag)) {
      p_die(fmt137(flag), this->cur_token);
    }
  ...
  if ((this->token_type == Id::Format_Type || this->token_type == Id::Format_Time)) {
    ...
    if (str_contains(str588, part->type->val)) {
      p_die(fmt138(), part->type);
    }
    if (maybe_str_equals(part->type->val, str590)) {
      p_die(fmt139(), part->type);
    }
  }
  else {
    if (this->token_type == Id::Unknown_Tok) {
      p_die(fmt140(), this->cur_token);
    }
    else {
      p_die(fmt141(), this->cur_token);
    }
  }
  if ((part->precision and !str_contains(str594, part->type->val->index(-1)))) {
...
int Printf::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  syntax_asdl::arith_expr_t* anode = nullptr;
  runtime_asdl::lvalue_t* lval = nullptr;
  StackRoots _roots({&cmd_val, &attrs, &arg_r, &arg, &fmt, &varargs, &spids, &arena, &parts, &line_reader, &lexer, &parser, &out, &UP_part, &token, &s, &flags, &width_str, &precision_str, &typ, &c_parts, &lex, &tok_val, &tok, &p, &tzcell, &result, &a_parser, &anode, &lval});

  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str596, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
  arg = Alloc<arg_types::printf>(attrs->attrs);
  Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str597);
  fmt = tup1.at0();
  fmt_spid = tup1.at1();
        ...
        if (part->tag_() == printf_part_e::Percent) {
          ...
          if (part->width) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt142(width_str), width_spid);
              return 1;
            }
          }
          precision = -1;
          if (part->precision) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt143(precision_str), precision_spid);
              return 1;
            }
          }
          if (arg_index < num_args) {
          ...
          typ = part->type->val;
          if (str_equals(typ, str605)) {
            if (precision >= 0) {
              s = s->slice(0, precision);
            }
          }
          else {
            if (str_equals(typ, str606)) {
              s = qsn::maybe_shell_encode(s);
            }
            else {
              if (str_equals(typ, str607)) {
                ...
                s = str608->join(c_parts);
              }
              else {
                if ((str_contains(str609, typ) or part->type->id == Id::Format_Time)) {
                  try {
                    d = to_int(s);
                  }
                  catch (ValueError*) {
                    if ((len(s) >= 1 and str_contains(str610, s->index(0)))) {
                      ...
                      if ((part->type->id == Id::Format_Time and (len(s) == 0 and word_spid == runtime::NO_SPID))) {
                        ...
                        this->errfmt->Print_(fmt144(s), blame_spid);
                        return 1;
                      }
                    }
                  }
                  if (str_contains(str612, typ)) {
                    s = str(d);
                  }
                  else {
                    if (str_contains(str613, typ)) {
                      if (d < 0) {
                        e_die(fmt145(d, typ), part->type->span_id);
                      }
                      if (str_equals(typ, str615)) {
                        s = str(d);
                      }
                      else {
                        if (str_equals(typ, str616)) {
                          s = mylib::octal(d);
                        }
                        else {
                          if (str_equals(typ, str617)) {
                            s = mylib::hex_lower(d);
                          }
                          else {
                            if (str_equals(typ, str618)) {
                              s = mylib::hex_upper(d);
                            }
                          }
                        }
          ...
          if (width >= 0) {
            if (len(flags)) {
              if (list_contains(flags, str621)) {
                s = s->ljust(width, str622);
              }
              else {
                if (list_contains(flags, str623)) {
                  s = s->rjust(width, str624);
                }
                else {
                  ;  // pass
                }
...
int Alias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str629, cmd_val);
  arg_r = tup0.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup1 = mylib::split_once(arg, str631);
    name = tup1.at0();
    alias_exp = tup1.at1();
    if (alias_exp == nullptr) {
      alias_exp = this->aliases->get(name);
      if (alias_exp == nullptr) {
        this->errfmt->Print_(fmt149(name), cmd_val->arg_spids->index(i));
        status = 1;
      }
      else {
        print(fmt150(name, alias_exp));
      }
    }
    else {
...
int UnAlias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str634, cmd_val);
  arg_r = tup2.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
    e_usage(str635);
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    ...
    if (dict_contains(this->aliases, name)) {
      ...
      this->errfmt->Print_(fmt151(name), cmd_val->arg_spids->index(i));
      status = 1;
    }
  }
  return status;
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->argv) == 1) {
    ...
    for (ListIter<Str*> it(sorted(mapping)); !it.Done(); it.Next()) {
      ...
      code_str = fmt152(name, qsn::maybe_shell_encode(str_val));
      print(code_str);
    }
    return 0;
  }
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  arg = flag_spec::ParseMore(str638, arg_r);
  if (arg->show_options) {
...
int Shopt::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  List<int>* opt_nums = nullptr;
  Dict<Str*, runtime_asdl::cell*>* unused = nullptr;
  StackRoots _roots({&cmd_val, &attrs, &arg_r, &arg, &opt_names, &opt_nums, &unused});

  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str639, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
...
int Hash::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str641, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
...
Dict<Str*, bool>* _ParseOptSpec(Str* spec_str) {
  ...
  while (true) {
    ...
    if (str_equals(spec_str->index(i), str644)) {
      spec->set(ch, true);
      i += 1;
    }
  }
...
int GetOptsState::_OptInd() {
  int result;
  try {
    result = state::GetInteger(this->mem, str645);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    result = -1;
...
void GetOptsState::IncIndex() {
  state::SetRefString(this->mem, str646, str((this->_optind + 1)));
}

void GetOptsState::SetArg(Str* optarg) {
  StackRoots _roots({&optarg});

  state::SetRefString(this->mem, str647, optarg);
}

void GetOptsState::Fail() {
  state::SetRefString(this->mem, str648, str649);
}
...
Tuple2<int, Str*> _GetOpts(Dict<Str*, bool>* spec, List<Str*>* argv, builtin_pure::GetOptsState* my_state, ui::ErrorFormatter* errfmt) {
  ...
  if (current == nullptr) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str650));
  }
  if ((!current->startswith(str651) or str_equals(current, str652))) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str653));
  }
  ...
  if (!dict_contains(spec, flag_char)) {
    return (Tuple2<int, Str*>(0, str654));
  }
  if (spec->index(flag_char)) {
    if (more_chars) {
      ...
      if (optarg == nullptr) {
        my_state->Fail();
        errfmt->Print_(fmt155(current));
        tmp = Alloc<List<Str*>>();
        for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
          Str* a = it.Value();
          tmp->append(qsn::maybe_shell_encode(a));
        }
        println_stderr(fmt156(str657->join(tmp)));
        return (Tuple2<int, Str*>(0, str658));
      }
    }
    my_state->IncIndex();
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  spec_str = arg_r->ReadRequired(str660);
  Tuple2<Str*, int> tup7 = arg_r->ReadRequired2(str661);
  var_name = tup7.at0();
  var_spid = tup7.at1();
  ...
  if (match::IsValidVarName(var_name)) {
    ...
    throw Alloc<error::Usage>(fmt157(var_name), var_spid);
  }
  return status;
}
...
int Echo::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseLikeEcho(str663, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  if (arg->e) {
    ...
    for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
      ...
      new_argv->append(str664->join(parts));
      if (backslash_c) {
        break;
      }
    }
...
int CommandEvaluator::_RunAssignBuiltin(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  if (builtin_func == nullptr) {
    e_die(fmt158(cmd_val->argv->index(0)), cmd_val->arg_spids->index(0));
  }
  try {
    try {
      status = builtin_func->Run(cmd_val);
      ...
      this->errfmt->PrefixPrint(e->msg, fmt159(arg0), e->span_id);
      status = 2;
    }
    catch (KeyboardInterrupt*) {
      if (this->exec_opts->interactive()) {
...
void CommandEvaluator::_CheckStatus(int status, syntax_asdl::command_t* node, int blame_spid) {
  ...
  if ((this->exec_opts->errexit() and status != 0)) {
    ...
    throw Alloc<error::ErrExit>(fmt160(status, reason, posix::getpid()), span_id, status);
  }
}
  ...
  switch (arg->tag_()) {
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        filename = val->s;
        if (len(filename) == 0) {
          throw Alloc<error::RedirectEval>(str677, arg_word);
        }
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          t = val->s;
          if (len(t) == 0) {
            throw Alloc<error::RedirectEval>(str678, arg_word);
            return nullptr;
          }
          try {
            if (maybe_str_equals(t, str679)) {
              result->arg = Alloc<redirect_arg::CloseFd>();
            }
            else {
              if (str_equals(t->index(-1), str680)) {
            ...
            throw Alloc<error::RedirectEval>(fmt161(t), arg_word);
            return nullptr;
          }
          return result;
        }
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = Alloc<redirect_arg::HereDoc>(str_concat(val->s, str682));
            return result;
          }
          else {
            throw Alloc<AssertionError>();
...
void CommandEvaluator::_StrictErrExit(syntax_asdl::command_t* node) {
  ...
  if (_HasManyStatuses(node)) {
    ...
    e_die(fmt162(node_str), location::SpanForCommand(node));
  }
}
...
void CommandEvaluator::_StrictErrExitList(List<syntax_asdl::command_t*>* node_list) {
  ...
  if (len(node_list) > 1) {
    e_die(fmt163(), location::SpanForCommand(node_list->index(0)));
  }
  node = node_list->index(0);
  if (_HasManyStatuses(node)) {
    node_str = ui::CommandType(node);
    e_die(fmt164(node_str), location::SpanForCommand(node));
  }
}
  ...
  switch (node->tag_()) {
    case command_e::Simple: {
      ...
      if (UP_cmd_val->tag_() == cmd_value_e::Argv) {
        ...
        if (node->block) {
          e_die(fmt165(), node->block->spids->index(0));
        }
        cmd_value__Assign* cmd_val = static_cast<cmd_value__Assign*>(UP_cmd_val);
      }
    ...
    case command_e::Pipeline: {
      ...
      if (len(node->stderr_indices)) {
        e_die(fmt166(), node->spids->index(0));
      }
      if (node->negated) {
    ...
    case command_e::ControlFlow: {
      ...
      if (node->arg_word) {
        ...
        try {
          ...
          e_die(fmt167(node->token->val, str_val->s), node->arg_word);
        }
      }
      else {
      ...
      if (ok) {
        ...
        if (this->exec_opts->strict_control_flow()) {
          ...
          this->errfmt->PrefixPrint(msg, str694, tok->span_id);
          status = 0;
        }
      }
    }
...
Tuple2<bool, bool> CommandEvaluator::ExecuteAndCatch(syntax_asdl::command_t* node, int cmd_flags) {
  ...
  try {
    ...
    if ((cmd_flags & IsEvalSource)) {
      ...
      if (e->IsReturn()) {
        ...
        is_eval = false;
        this->errfmt->Print_(str695, e->token->span_id);
        is_fatal = true;
        status = 1;
      }
    }
  ...
  if (err) {
    ...
    if ((is_errexit and !this->exec_opts->verbose_errexit())) {
      ...
      ui::PrettyPrintError(err, this->arena, str696);
    }
  }
    ...
    if (UP_sig->tag_() == proc_sig_e::Closed) {
      ...
      for (ListIter<syntax_asdl::param*> it(sig->params); !it.Done(); it.Next(), ++i) {
        ...
        if (i < n_args) {
          ...
          if (is_out_param) {
            param_name = str_concat(str698, param_name);
            if (!arg_str->startswith(str699)) {
              e_die(fmt168(arg_str));
            }
      ...
      if (sig->rest) {
        ...
        if (n_args > n_params) {
          throw Alloc<TypeError>(fmt170(proc->name, n_params, n_args));
        }
      }
    }
    try {
      ...
      if (e->IsReturn()) {
        ...
        e_die(fmt171(e->token->val), e->token);
      }
    }
    catch (error::FatalRuntime* e) {
      this->dumper->MaybeCollect(this, e);
...
int CommandEvaluator::RunFuncForCompletion(runtime_asdl::Proc* proc, List<Str*>* argv) {
  ...
  try {
    ...
    this->errfmt->Print_(str704, e->token->span_id);
    status = 1;
  }
  return status;
}
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index(i), str706))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index(-2), str708)) {
    ...
    if ((left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse)) {
      var_name = left_token->val->slice(0, -1);
      if (str_equals(close_token->val->index(-2), str709)) {
        op = assign_op_e::PlusEqual;
      }
      else {
        op = assign_op_e::Equal;
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        var_name = left_token->val->slice(0, -1);
        if (str_equals(close_token->val->index(-2), str710)) {
          op = assign_op_e::PlusEqual;
        }
        else {
          op = assign_op_e::Equal;
        ...
        if (span1->line_id == span2->line_id) {
          ...
          throw Alloc<NotImplementedError>(fmt174(span1->line_id, span2->line_id));
        }
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    w = tup6->at3();
    if (left_token->id != Id::Lit_VarLike) {
      p_die(fmt175(), left_token);
    }
    if (str_equals(left_token->val->index(-2), str713)) {
...
VarChecker::VarChecker() : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(VarChecker)) {
  this->tokens = Alloc<List<syntax_asdl::Token*>>();
  this->names = Alloc<List<Dict<Str*, int>*>>(std::initializer_list<Dict<Str*, int>*>{Alloc<Dict<Str*, int>>()});
}
...
void VarChecker::Check(int keyword_id, syntax_asdl::Token* name_tok) {
  ...
  if ((keyword_id == Id::KW_Const || keyword_id == Id::KW_Var)) {
    if (dict_contains(top, name)) {
      p_die(fmt179(name), name_tok);
    }
    else {
      top->set(name, keyword_id);
    }
  }
  if ((keyword_id == Id::KW_Set || keyword_id == Id::KW_SetLocal)) {
    if (!dict_contains(top, name)) {
      p_die(fmt180(name), name_tok);
    }
  }
  if ((keyword_id == Id::KW_Set || keyword_id == Id::KW_SetLocal || keyword_id == Id::KW_SetVar)) {
    if ((dict_contains(top, name) and top->index(name) == Id::KW_Const)) {
      p_die(fmt181(name), name_tok);
    }
  }
}
...
void CommandParser::_Eat(int c_id) {
  ...
  msg = fmt182(ui::PrettyId(c_id), ui::PrettyId(actual_id));
  this->_Eat2(c_id, msg);
}
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index(0), str721)) {
    pos = op_val->find(str722);
...
Tuple3<List<syntax_asdl::redir*>*, List<syntax_asdl::compound_word*>*, syntax_asdl::BraceGroup*> CommandParser::_ScanSimpleCommand() {
  ...
  StackRoots _roots({&redirects, &words, &block, &node, &blame_tok});
      ...
      if (this->c_kind == Kind::Word) {
        if (this->parse_opts->parse_brace()) {
          if (this->c_id == Id::Lit_LBrace) {
            if (this->allow_block) {
              blame_tok = _KeywordToken(this->cur_word);
              {  // with
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    i += 1;
    if (!alias_exp->endswith(str725)) {
      expanded->append(str726);
      break;
    }
  }
  if (len(expanded) == 0) {
  ...
  while (i < n) {
    ...
    if (span1->line_id == span2->line_id) {
      ...
      throw Alloc<NotImplementedError>(fmt185(span1->line_id, span2->line_id));
    }
    expanded->append(str728);
    i += 1;
  }
  code_str = str729->join(expanded);
  line_reader = reader::StringLineReader(code_str, this->arena);
  ...
  if (kind == Kind::ControlFlow) {
    ...
    if (len(suffix_words) == 1) {
      ...
      if (len(suffix_words) == 2) {
        ...
        p_die(fmt193(kw_token->val), suffix_words->index(2));
      }
    }
...
syntax_asdl::command_t* CommandParser::ParseCompoundCommand() {
  ...
  syntax_asdl::command__PlaceMutation* n10 = nullptr;
  StackRoots _roots({&n1, &n2, &keyword, &n3, &n4, &n5, &n6, &n7, &kw_token, &n8, &n9, &n10});
  ...
  if ((this->parse_opts->parse_set() and this->c_id == Id::KW_Set)) {
    kw_token = word_::LiteralToken(this->cur_word);
    this->_Next();
    n10 = this->w_parser->ParsePlaceMutation(kw_token, this->var_checker);
    return n10;
  }
...
syntax_asdl::command__ShFunction* CommandParser::ParseFunctionDef() {
  ...
  this->_Next();
  this->_Eat2(Id::Right_ShFunction, str746);
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if (str_equals(c, str754)) {
      i += 1;
    }
    else {
      if ((str_equals(c, str755) or str_equals(c, str756))) {
        return true;
      }
      else {
        if (str_equals(c, str757)) {
          left_bracket = true;
        }
        else {
          if ((str_equals(c, str758) and left_bracket)) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  ...
  return pyutil::BackslashEscape(s, str760);
}
Str* ERE_META_CHARS = str761;
...
Str* GlobUnescape(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if ((str_equals(c, str762) and i != (n - 1))) {
      i += 1;
      c2 = s->index(i);
      ...
      if (tag == glob_part_e::Operator) {
        ...
        if (tag == glob_part_e::CharClass) {
          ...
          for (ListIter<Str*> it(part->strs); !it.Done(); it.Next()) {
            Str* s = it.Value();
            StackRoots _for({&s          });
            if (str_equals(s, str780)) {
              literal_hyphen = true;
              continue;
            }
            if (str_equals(s, str781)) {
...
int Globber::Expand(Str* arg, List<Str*>* out) {
  ...
  if (n) {
    for (ListIter<Str*> it(results); !it.Done(); it.Next()) {
      Str* name = it.Value();
      StackRoots _for({&name    });
      if ((name->startswith(str787) and !this->exec_opts->dashglob())) {
        n -= 1;
        continue;
      }
      out->append(name);
...
Str* _PromptEvaluatorCache::Get(Str* name) {
  ...
  if (str_equals(name, str789)) {
    value = this->_GetEuid() == 0 ? str790 : str791;
  }
  else {
    if (str_equals(name, str792)) {
      value = libc::gethostname();
    }
    else {
      if (str_equals(name, str793)) {
...
Evaluator::Evaluator(Str* lang, parse_lib::ParseContext* parse_ctx, state::Mem* mem) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Evaluator)) {
  ...
  this->parse_ctx = parse_ctx;
  this->mem = mem;
  this->default_prompt = str_concat(lang, str794);
      ...
      if (id_ == Id::PS_Octal3) {
        ...
        if (id_ == Id::PS_LBrace) {
          ...
          if (id_ == Id::PS_RBrace) {
            ...
            if (id_ == Id::PS_Subst) {
              ch = value->slice(1);
              if (str_equals(ch, str797)) {
                r = this->cache->Get(str798);
              }
              else {
                if (str_equals(ch, str799)) {
                  r = this->cache->Get(str800);
                }
                else {
                  if (str_equals(ch, str801)) {
                    hostname = this->cache->Get(str802);
                    Tuple2<Str*, Str*> tup1 = mylib::split_once(hostname, str803);
                    r = tup1.at0();
                  }
                  else {
                    if (str_equals(ch, str804)) {
                      r = this->cache->Get(str805);
                    }
                    else {
                      if (str_equals(ch, str806)) {
                        try {
                          pwd = state::GetString(this->mem, str807);
                          home = state::MaybeString(this->mem, str808);
                          r = ui::PrettyDir(pwd, home);
                        }
                        catch (error::Runtime* e) {
                          r = fmt210(e->UserErrorString());
                        }
                      }
                      else {
                        if (str_equals(ch, str810)) {
                          val = this->mem->GetValue(str811);
                          if (val->tag_() == value_e::Str) {
                            value__Str* str_val = static_cast<value__Str*>(val);
              ...
              ret->append(r->replace(str814, str815));
            }
            else {
              throw Alloc<AssertionError>();
            }
...
Str* Evaluator::EvalPrompt(runtime_asdl::value_t* UP_val) {
  ...
  if (ps1_word == nullptr) {
    ...
    try {
      ...
      ps1_word = word_::ErrorWord(fmt212(e->UserErrorString()));
    }
...
Str* Evaluator::EvalFirstPrompt() {
  ...
  if (str_equals(this->lang, str819)) {
    val = this->mem->GetValue(str820);
    ...
    case lvalue_e::Indexed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          break;
        default: {
          e_die(fmt214(ui::ValType(val)));
        }
      }
      s = word_eval::GetArrayItem(array_val->strs, lval->index);
      if (s == nullptr) {
        val = Alloc<value::Str>(str824);
      }
      else {
        val = Alloc<value::Str>(s);
      }
    ...
    case lvalue_e::Keyed: {
      ...
      switch (val->tag_()) {
        ...
        case value_e::AssocArray: {
          ...
          break;
        default: {
          e_die(fmt215(ui::ValType(val)));
        }
      }
      s = assoc_val->d->get(lval->key);
      if (s == nullptr) {
        val = Alloc<value::Str>(str826);
      }
      else {
        val = Alloc<value::Str>(s);
      }
...
int ArithEvaluator::_StringToInteger(Str* s, int span_id) {
  ...
  if (s->startswith(str829)) {
    try {
      integer = to_int(s, 8);
    }
    catch (ValueError*) {
      e_strict(fmt217(s), span_id);
    }
    return integer;
  }
  if (str_contains(s, str831)) {
    Tuple2<Str*, Str*> tup0 = mylib::split_once(s, str832);
    b = tup0.at0();
    digits = tup0.at1();
    try {
      base = to_int(b);
    ...
    for (StrIter it(digits); !it.Done(); it.Next()) {
      ...
      StackRoots _for({&ch    });
      if (IsLower(ch)) {
        digit = ((ord(ch) - ord(str834)) + 10);
      }
      else {
        if (IsUpper(ch)) {
          digit = ((ord(ch) - ord(str835)) + 36);
        }
        else {
          if (str_equals(ch, str836)) {
            digit = 62;
          }
          else {
            if (str_equals(ch, str837)) {
              digit = 63;
            }
            else {
              if (ch->isdigit()) {
                ...
                e_strict(fmt219(digits), span_id);
              }
            }
          }
        }
      ...
      if (digit >= base) {
        e_strict(fmt220(digits, base), span_id);
      }
    ...
    if ((this->exec_opts->eval_unsafe_arith() and this->parse_ctx)) {
      ...
      {  // with
        ...
        try {
          ...
          ui::PrettyPrintError(e, arena);
          e_die(fmt221(), e->span_id);
        }
      }
      if (node2->tag_() == arith_expr_e::Word) {
        e_die(fmt222(s), span_id);
      }
      else {
      ...
      if ((len(s->strip()) == 0 or match::IsValidVarName(s))) {
        e_strict(fmt223(s), span_id);
      }
      else {
        e_die(fmt224(s), span_id);
      }
    }
  }
  return integer;
...
int ArithEvaluator::_ValToIntOrError(runtime_asdl::value_t* val, int span_id) {
  ...
  e_die(fmt226(ui::ValType(val)), span_id);
}
  ...
  if (((val->tag_() == value_e::MaybeStrArray || val->tag_() == value_e::AssocArray) and lval->tag_() == lvalue_e::Named)) {
    ...
    if (word_eval::CheckCompatArray(named_lval->name, this->exec_opts)) {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (val->tag_() == value_e::AssocArray) {
          lval = Alloc<lvalue::Keyed>(named_lval->name, str846);
        }
      }
        ...
        if (op_id == Id::Arith_Minus) {
          ...
          if (op_id == Id::Arith_Star) {
            ...
            if (op_id == Id::Arith_Slash) {
              if (rhs == 0) {
                e_die(fmt228(), location::SpanForArithExpr(node->right));
              }
              ret = (lhs / rhs);
            }
            else {
              if (op_id == Id::Arith_Percent) {
                if (rhs == 0) {
                  e_die(fmt229(), location::SpanForArithExpr(node->right));
                }
                ret = (lhs % rhs);
              }
              else {
...
void BoolEvaluator::_SetRegexMatches(List<Str*>* matches) {
  ...
  state::SetGlobalArray(this->mem, str855, matches);
}
  ...
  switch (node->tag_()) {
    ...
    case bool_expr_e::Unary: {
      ...
      if (arg_type == bool_arg_type_e::Other) {
        ...
        e_die(fmt231(ui::PrettyId(op_id)));
      }
      throw Alloc<AssertionError>();
    }
      break;
      ...
      if (arg_type == bool_arg_type_e::Str) {
        ...
        if (op_id == Id::BoolBinary_EqualTilde) {
          try {
            ...
            msg = e->message;
            e_die(fmt232(s2, msg, node->right), 2);
          }
          if (matches == nullptr) {
            return false;
          }
...
_BaseSplitter::_BaseSplitter(Str* escape_chars) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(_BaseSplitter)) {
  this->escape_chars = str_concat(escape_chars, str866);
}
    ...
    if (i < n) {
      ...
      if (str_contains(ws_chars, c)) {
        ...
        if (str_contains(other_chars, c)) {
          ...
          if ((allow_escape and str_equals(c, str867))) {
...
Str* Utf8Encode(int code) {
  ...
  return str870->join(tmp);
}
Str* INCOMPLETE_CHAR = str871;
Str* INVALID_CONT = str872;
Str* INVALID_START = str873;
    ...
    if ((op->op_id == Id::VOp1_Pound || op->op_id == Id::VOp1_DPound)) {
      ...
      if ((op->op_id == Id::VOp1_Percent || op->op_id == Id::VOp1_DPercent)) {
        ...
        if (op->op_id == Id::VOp1_Comma) {
          if (!(str_equals(arg, str874))) {
            e_die(fmt233(ui::PrettyId(op->op_id)));
          }
          if (len(s)) {
          ...
          if (op->op_id == Id::VOp1_DComma) {
            if (!(str_equals(arg, str876))) {
              e_die(fmt234(ui::PrettyId(op->op_id)));
            }
            return s->lower();
          }
          else {
            if (op->op_id == Id::VOp1_Caret) {
              if (!(str_equals(arg, str878))) {
                e_die(fmt235(ui::PrettyId(op->op_id)));
              }
              if (len(s)) {
              ...
              if (op->op_id == Id::VOp1_DCaret) {
                if (!(str_equals(arg, str880))) {
                  e_die(fmt236(ui::PrettyId(op->op_id)));
                }
                return s->upper();
              }
              else {
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Slash) {
    try {
      ...
      msg = e->message;
      e_die(fmt238(regex, msg), this->slash_spid);
    }
  }
  if (op->replace_mode == Id::Lit_Pound) {
    regex = str_concat(str886, regex);
  }
  else {
    if (op->replace_mode == Id::Lit_Percent) {
      regex = str_concat(regex, str887);
    }
  }
...
Str* ShellQuoteB(Str* s) {
  ...
  s = s->replace(str888, str889)->replace(str890, str891);
  return pyutil::BackslashEscape(s, str892);
}
...
void TdopParser::Eat(int token_type) {
  if (!this->AtToken(token_type)) {
    p_die(fmt242(ui::PrettyId(token_type), ui::PrettyId(this->op_id)), this->cur_word);
  }
  this->Next();
}
...
GLOBAL_LIST(Str*, 3, _STRING_AND_ARRAY, {str900 COMMA str901 COMMA str902});
...
bool CheckCompatArray(Str* var_name, optview::Exec* opts, bool is_plain_var_sub) {
  StackRoots _roots({&var_name, &opts});
...
runtime_asdl::value_t* ResolveCompatArray(runtime_asdl::value_t* val) {
  ...
  if (val->tag_() == value_e::MaybeStrArray) {
    ...
    if (val->tag_() == value_e::AssocArray) {
      value__AssocArray* assoc_val = static_cast<value__AssocArray*>(val);
      s = dict_contains(assoc_val->d, str903) ? assoc_val->d->index(str904) : nullptr;
    }
    else {
      throw Alloc<AssertionError>();
    }
...
Str* _BackslashEscape(Str* s) {
  ...
  return s->replace(str905, str906);
}
...
runtime_asdl::part_value_t* _ValueToPartValue(runtime_asdl::value_t* val, bool quoted) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      return Alloc<part_value::String>(str907, quoted, !quoted);
    }
      break;
    case value_e::Str: {
      value__Str* val = static_cast<value__Str*>(UP_val);
...
Str* TildeEvaluator::Eval(syntax_asdl::Token* token) {
  ...
  if (maybe_str_equals(token->val, str919)) {
...
bool AbstractWordEvaluator::_ApplyTestOp(runtime_asdl::value_t* val, syntax_asdl::suffix_op__Unary* op, bool quoted, List<runtime_asdl::part_value_t*>* part_vals, Str* var_name, runtime_asdl::a_index_t* var_index, syntax_asdl::Token* blame_token) {
  ...
  StackRoots _roots({&val, &op, &part_vals, &var_name, &var_index, &blame_token, &UP_val, &assign_part_vals, &rhs_str, &lval, &UP_var_index, &error_part_vals, &error_str});
      ...
      if ((op->op_id == Id::VTest_ColonEquals || op->op_id == Id::VTest_Equals)) {
        ...
        if ((op->op_id == Id::VTest_ColonQMark || op->op_id == Id::VTest_QMark)) {
          if (is_falsey) {
            ...
            e_die(fmt247(error_str), blame_token);
          }
          else {
            return false;
          }
...
runtime_asdl::value_t* AbstractWordEvaluator::_EvalIndirectArrayExpansion(Str* name, Str* index) {
  ...
  int index_num;
  Str* s = nullptr;
  StackRoots _roots({&name, &index, &val, &UP_val, &s});
  ...
  switch (val->tag_()) {
    ...
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* val = static_cast<value__MaybeStrArray*>(UP_val);
      if ((str_equals(index, str924) || str_equals(index, str925))) {
    ...
    case value_e::AssocArray: {
      value__AssocArray* val = static_cast<value__AssocArray*>(UP_val);
      if ((str_equals(index, str926) || str_equals(index, str927))) {
        throw Alloc<NotImplementedError>();
      }
      s = val->d->get(index);
      if (s != nullptr) {
...
runtime_asdl::value_t* AbstractWordEvaluator::_ApplyPrefixOp(runtime_asdl::value_t* val, syntax_asdl::speck* prefix_op, syntax_asdl::Token* token) {
  ...
  StackRoots _roots({&val, &prefix_op, &token, &UP_val, &name, &index, &result, &indices});
      ...
      case value_e::Str: {
        ...
        try {
          ...
          if (this->exec_opts->strict_word_eval()) {
            ...
            this->errfmt->PrettyPrintError(e, str928);
            return Alloc<value::Str>(str929);
          }
        }
      }
        break;
    ...
    if (op_id == Id::VSub_Bang) {
      ...
      switch (val->tag_()) {
        case value_e::Str: {
          ...
          if ((maybe_str_equals(val->s, str930) || maybe_str_equals(val->s, str931))) {
            return Alloc<value::MaybeStrArray>(this->mem->GetArgv());
          }
          i = val->s->find(str932);
          if ((i >= 0 and str_equals(val->s->index(-1), str933))) {
...
runtime_asdl::value_t* AbstractWordEvaluator::_Slice(runtime_asdl::value_t* val, syntax_asdl::suffix_op__Slice* op, Str* var_name, syntax_asdl::braced_var_sub* part) {
  ...
  try {
    ...
    if (this->exec_opts->strict_word_eval()) {
      ...
      this->errfmt->PrettyPrintError(e, str936);
      switch (val->tag_()) {
        case value_e::Str: {
  ...
  if (op_id == Id::VOp0_P) {
    switch (val->tag_()) {
      case value_e::Str: {
        ...
        p = prompt->replace(str938, str939)->replace(str940, str941);
        result = Alloc<value::Str>(p);
      }
        break;
      default: {
        e_die(fmt249(ui::ValType(val)));
      }
    }
  }
  else {
    if (op_id == Id::VOp0_Q) {
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          result = Alloc<value::Str>(str943->join(tmp));
        }
          break;
        default: {
          e_die(fmt250(ui::ValType(val)));
        }
      }
    }
    else {
      if (op_id == Id::VOp0_a) {
        ...
        result = Alloc<value::Str>(str950->join(chars));
      }
      else {
        e_die(fmt251(op->val), op);
      }
    }
  }
...
Tuple2<runtime_asdl::value_t*, bool> AbstractWordEvaluator::_WholeArray(runtime_asdl::value_t* val, syntax_asdl::braced_var_sub* part, bool quoted) {
  ...
  bool maybe_decay_array;
  runtime_asdl::value_t* UP_val = nullptr;
  StackRoots _roots({&val, &part, &UP_val});
...
Tuple2<runtime_asdl::value_t*, runtime_asdl::a_index_t*> AbstractWordEvaluator::_ArrayIndex(runtime_asdl::value_t* val, syntax_asdl::braced_var_sub* part) {
  ...
  Str* s = nullptr;
  Str* key = nullptr;
  StackRoots _roots({&val, &part, &var_index, &anode, &UP_val, &s, &key});
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      ...
      break;
    case value_e::Str: {
      e_die(fmt254(part->token->val), part->token);
    }
      break;
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* array_val = static_cast<value__MaybeStrArray*>(UP_val);
...
void AbstractWordEvaluator::_EvalDoubleQuoted(List<syntax_asdl::word_part_t*>* parts, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  if (len(parts) == 0) {
    v = Alloc<part_value::String>(str955, true, false);
    part_vals->append(v);
    return ;
  }
...
runtime_asdl::value_t* AbstractWordEvaluator::_EmptyStrOrError(runtime_asdl::value_t* val, syntax_asdl::Token* token) {
  ...
  if (!this->exec_opts->nounset()) {
    return Alloc<value::Str>(str956);
  }
  name = token->val->startswith(str957) ? token->val->slice(1) : token->val;
  e_die(fmt255(name), token);
}
...
void AbstractWordEvaluator::_EvalBracedVarSub(syntax_asdl::braced_var_sub* part, List<runtime_asdl::part_value_t*>* part_vals, bool quoted) {
  ...
  syntax_asdl::suffix_op_t* tmp = nullptr;
  bool undef_check;
  ...
  StackRoots _roots({&part, &part_vals, &var_name, &names, &sep, &val, &var_index, &bracket_op, &UP_bracket_op, &tmp, &suffix_op, &UP_op, &op, &UP_val, &part_val});
...
void AbstractWordEvaluator::_EvalSimpleVarSub(syntax_asdl::Token* token, List<runtime_asdl::part_value_t*>* part_vals, bool quoted) {
  ...
  StackRoots _roots({&token, &part_vals, &var_name, &val, &UP_val, &v});
  ...
  switch (part->tag_()) {
    ...
    case word_part_e::ExtGlob: {
      ...
      for (ListIter<syntax_asdl::compound_word*> it(part->arms); !it.Done(); it.Next(), ++i) {
        ...
        StackRoots _for({&w      });
        if (i != 0) {
          part_vals->append(Alloc<part_value::String>(str968, false, false));
        }
        this->_EvalWordToParts(w, false, part_vals);
      }
      part_vals->append(Alloc<part_value::String>(str969, false, false));
    }
      break;
...
void AbstractWordEvaluator::_EvalWordToParts(syntax_asdl::word_t* w, bool quoted, List<runtime_asdl::part_value_t*>* part_vals, bool is_subst) {
  ...
  switch (w->tag_()) {
    case word_e::Compound: {
      ...
      break;
    case word_e::Empty: {
      part_vals->append(Alloc<part_value::String>(str971, quoted, !quoted));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, runtime_asdl::quote_t quote_kind) {
  ...
  return Alloc<value::Str>(str975->join(strs));
}
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalForPlugin(syntax_asdl::compound_word* w) {
  ...
  {  // with
    ...
    try {
      ...
      val = Alloc<value::Str>(fmt264(e->UserErrorString()));
    }
    catch (_OSError* e) {
      val = Alloc<value::Str>(fmt265(pyutil::strerror(e)));
    }
    catch (KeyboardInterrupt*) {
      val = Alloc<value::Str>(str978);
    }
  }
  return val;
}
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index(-2), str985)) {
          e_die(fmt267(), w);
        }
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        StackRoots _for({&arg      });
        if ((arg->startswith(str987) or arg->startswith(str988))) {
          flags->append(arg);
          flag_spids->append(word_spid);
          if ((str_contains(arg, str989) or str_contains(arg, str990))) {
            eval_to_pairs = false;
          }
        }
        else {
...
runtime_asdl::part_value__String* CompletionWordEvaluator::_EvalProcessSub(syntax_asdl::command_sub* cs_part) {
  ...
  return Alloc<part_value::String>(str995, true, false);
}
...
syntax_asdl::suffix_op__PatSub* WordParser::_ReadPatSubVarOp() {
  ...
  if (this->token_type == Id::Lit_Slash) {
    ...
    this->_Peek();
    if (this->token_type != Id::Right_DollarBrace) {
      p_die(fmt271(ui::PrettyId(this->token_type)), this->cur_token);
    }
...
syntax_asdl::braced_var_sub* WordParser::_ParseVarExpr(types_asdl::lex_mode_t arg_lex_mode, bool allow_query) {
  ...
  StackRoots _roots({&part, &arg_word, &patsub_op, &temp});
        ...
        if (op_kind == Kind::VOp2) {
          if (this->token_type == Id::VOp2_Slash) {
            ...
            if (this->token_type == Id::VOp2_Colon) {
              ...
              p_die(fmt277(str1005), this->cur_token);
            }
          }
        }
        else {
          if (op_kind == Kind::VOp3) {
            if (allow_query) {
              ...
              p_die(fmt278(str1007), this->cur_token);
            }
          }
        }
      }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool is_oil_expr) {
  ...
  while (!done) {
    ...
    if ((this->token_kind == Kind::Lit || this->token_kind == Kind::Char)) {
      tok = this->cur_token;
      if ((no_backslashes and str_contains(tok->val, str1011))) {
        p_die(fmt282(), tok);
      }
      if (is_oil_expr) {
...
void WordParser::_ReadLikeDQ(syntax_asdl::Token* left_dq_token, bool is_oil_expr, List<syntax_asdl::word_part_t*>* out_parts) {
  bool done;
  syntax_asdl::word_part_t* part = nullptr;
  StackRoots _roots({&left_dq_token, &out_parts, &part});
...
void WordParser::ParseProc(syntax_asdl::command__Proc* node) {
  ...
  if (this->token_type != Id::Lit_Chars) {
    p_die(fmt294(ui::PrettyToken(this->cur_token, this->arena)), this->cur_token);
  }
...
syntax_asdl::arith_expr_t* WordParser::_ReadArithExpr(int end_id) {
  ...
  if ((end_id != Id::Undefined_Tok and cur_id != end_id)) {
    p_die(fmt295(ui::PrettyId(cur_id), ui::PrettyId(end_id)), this->a_parser->cur_word);
  }
  return anode;
}
...
syntax_asdl::command__ForExpr* WordParser::ReadForExpression() {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt298(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
  if (cur_id == Id::Arith_Semi) {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt299(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
            ...
            if (this->token_type == Id::Lit_Dollar) {
              if (!this->parse_opts->parse_dollar()) {
                if ((num_parts == 0 and lex_mode == lex_mode_e::ShCommand)) {
                  ...
                  if (str_equals(next_byte, str1039)) {
                    println_stderr(fmt308(next_byte));
                  }
                }
                p_die(fmt309(), this->cur_token);
              }
            }
          }
        }
...
Tuple2<syntax_asdl::word_t*, bool> WordParser::_ReadArithWord() {
  ...
  this->_Peek();
  if (this->token_kind == Kind::Unknown) {
    p_die(fmt314(this->cur_token->val), this->cur_token);
  }
  else {
    if (this->token_kind == Kind::Eof) {
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1049, false));
    }
      break;
    case word_part_e::AssocArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1050, false));
    }
      break;
    case word_part_e::Literal: {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str1052, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str1053->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
    ...
    case word_part_e::ExtGlob: 
    case word_part_e::Splice: {
      return (Tuple3<bool, Str*, bool>(false, str1054, false));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() != word_e::Compound) {
    return (Tuple3<bool, Str*, bool>(false, str1055, quoted));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  strs = Alloc<List<Str*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str1056, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str1057->join(strs), quoted));
}
...
syntax_asdl::compound_word* TildeDetect(syntax_asdl::word_t* UP_w) {
  ...
  if ((id_ == Id::Lit_Chars and static_cast<Token*>(part1)->val->startswith(str1059))) {
    new_parts->extend(w->parts->slice(1));
    return Alloc<compound_word>(new_parts);
  }
  return nullptr;
...
void TildeDetectAssign(syntax_asdl::compound_word* w) {
  ...
  for (int i = 0; i < n; ++i) {
    ...
    if ((do_expand and LiteralId(cur) == Id::Lit_TildeLike)) {
      ...
      if (next_part) {
        is_tilde = (LiteralId(next_part) == Id::Lit_Colon or (LiteralId(next_part) == Id::Lit_Chars and static_cast<Token*>(next_part)->val->startswith(str1060)));
      }
      else {
        is_tilde = true;
      }
...
Str* escape(Str* s) {
  ...
  s = s->replace(str1070, str1071);
  s = s->replace(str1072, str1073);
  s = s->replace(str1074, str1075);
  return s;
}
...
Str* join(Str* s1, Str* s2) {
  ...
  if ((s2->startswith(str1078) or len(s1) == 0)) {
    return s2;
  }
  if (s1->endswith(str1079)) {
...
Tuple2<Str*, Str*> split(Str* p) {
  ...
  head = p->slice(0, i);
  tail = p->slice(i);
  if ((len(head) and !(str_equals(head, str_repeat(str1082, len(head)))))) {
    head = head->rstrip(str1083);
  }
...
Tuple2<Str*, Str*> _splitext(Str* p, Str* sep, Str* extsep) {
  ...
  return (Tuple2<Str*, Str*>(p, str1084));
}
...
Str* dirname(Str* p) {
  ...
  i = (p->rfind(str1086) + 1);
  head = p->slice(0, i);
  if ((head and !(str_equals(head, str_repeat(str1087, len(head)))))) {
    head = head->rstrip(str1088);
  }
  return head;
}
...
Str* normpath(Str* path) {
  ...
  slash = str1089;
  dot = str1090;
  if (str_equals(path, str1091)) {
    return dot;
  }
  initial_slashes = path->startswith(str1092);
  if ((initial_slashes and (path->startswith(str1093) and !path->startswith(str1094)))) {
    initial_slashes = 2;
  }
  comps = path->split(str1095);
  new_comps = Alloc<List<Str*>>();
  for (ListIter<Str*> it(comps); !it.Done(); it.Next()) {
    Str* comp = it.Value();
    StackRoots _for({&comp  });
    if ((len(comp) == 0 or str_equals(comp, str1096))) {
      continue;
    }
    if ((!(str_equals(comp, str1097)) or ((initial_slashes == 0 and len(new_comps) == 0) or (len(new_comps) and str_equals(new_comps->index(-1), str1098))))) {
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if ((str_contains(str1105, ch) or IsUnprintableLow(ch))) {
        quote = 2;
        break;
      }
    }
  ...
  parts->append(str1108);
  return str_concat(prefix, str1109->join(parts));
}
...
Str* maybe_encode(Str* s, int bit8_display) {
  ...
  parts = Alloc<List<Str*>>();
  parts->append(str1110);
  _encode(s, bit8_display, false, parts);
  parts->append(str1111);
  return str1112->join(parts);
}
...
Str* encode(Str* s, int bit8_display) {
  ...
  parts = Alloc<List<Str*>>();
  parts->append(str1113);
  _encode(s, bit8_display, false, parts);
  parts->append(str1114);
  return str1115->join(parts);
}
...
void _encode_bytes_x(Str* s, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (str_equals(byte, str1116)) {
      part = str1117;
    }
    else {
      if (str_equals(byte, str1118)) {
        part = str1119;
      }
      else {
        if (str_equals(byte, str1120)) {
          part = str1121;
        }
        else {
          if (str_equals(byte, str1122)) {
            part = str1123;
          }
          else {
            if (str_equals(byte, str1124)) {
              part = str1125;
            }
            else {
              if (str_equals(byte, str1126)) {
                part = shell_compat ? str1127 : str1128;
              }
              else {
...
bool _encode_runes(Str* s, int bit8_display, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (typ == Ascii) {
      state = Start;
      if (str_equals(byte, str1132)) {
        out = str1133;
      }
      else {
        if (str_equals(byte, str1134)) {
          out = str1135;
        }
        else {
          if (str_equals(byte, str1136)) {
            out = str1137;
          }
          else {
            if (str_equals(byte, str1138)) {
              out = str1139;
            }
            else {
              if (str_equals(byte, str1140)) {
                out = str1141;
              }
              else {
                if (str_equals(byte, str1142)) {
                  out = shell_compat ? str1143 : str1144;
                }
                else {
                  if (IsUnprintableLow(byte)) {
...
syntax_asdl::word__String* _StringWordEmitter::ReadWord(types_asdl::lex_mode_t unused_lex_mode) {
  ...
  if (this->i == this->n) {
    w = Alloc<word::String>(Id::Eof_Real, str1145, runtime::NO_SPID);
    return w;
  }
...
syntax_asdl::bool_expr_t* _TwoArgs(builtin_bracket::_StringWordEmitter* w_parser) {
  ...
  w1 = w_parser->Read();
  s0 = w0->s;
  if (maybe_str_equals(s0, str1146)) {
    return Alloc<bool_expr::LogicalNot>(Alloc<bool_expr::WordTest>(w1));
  }
  unary_id = Id::Undefined_Tok;
  if (w0->s->startswith(str1147)) {
    if (maybe_str_equals(s0, str1148)) {
      unary_id = Id::BoolUnary_d;
    }
    else {
      if (maybe_str_equals(s0, str1149)) {
        unary_id = Id::BoolUnary_e;
      }
      else {
        if (maybe_str_equals(s0, str1150)) {
          unary_id = Id::BoolUnary_f;
        }
        else {
          if (maybe_str_equals(s0, str1151)) {
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    ...
    strs = cmd_val->argv;
    if ((!strs or !(str_equals(strs->index(-1), str1160)))) {
      this->errfmt->Print_(str1161, cmd_val->arg_spids->index(0));
      return 2;
    }
    cmd_val->argv->pop();
  ...
  try {
    ...
    if (n == 4) {
      a0 = w_parser->Peek(0);
      if (str_equals(a0, str1163)) {
        w_parser->Read();
        child = _ThreeArgs(w_parser);
        bool_node = Alloc<bool_expr::LogicalNot>(child);
      }
      else {
        if ((str_equals(a0, str1164) and str_equals(w_parser->Peek(3), str1165))) {
          w_parser->Read();
          bool_node = _TwoArgs(w_parser);
        }
        else {
    ...
    this->errfmt->PrettyPrintError(e, str1166);
    return 2;
  }
  ...
  try {
    ...
    this->errfmt->PrettyPrintError(e, str1167);
    return 2;
  }
  status = b ? 0 : 1;
  return status;

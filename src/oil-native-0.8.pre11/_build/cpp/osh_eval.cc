...
FdState::FdState(ui::ErrorFormatter* errfmt, process::JobState* job_state, state::Mem* mem) {
  this->errfmt = errfmt;
  this->job_state = job_state;
...
Waiter::Waiter(process::JobState* job_state, optview::Exec* exec_opts) {
  this->job_state = job_state;
  this->exec_opts = exec_opts;
...
ctx_ErrExit::ctx_ErrExit(state::MutableOpts* mutable_opts, int span_id) {
...
ctx_Call::ctx_Call(state::Mem* mem, Str* func_name, int def_spid, List<Str*>* argv) {
...
ctx_Status::ctx_Status(state::Mem* mem) {

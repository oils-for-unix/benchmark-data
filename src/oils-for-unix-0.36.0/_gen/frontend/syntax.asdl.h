...
class Mutation : public command_t, public b_command_t {
 public:
  ...
  static constexpr ObjHeader obj_header() {
    return ObjHeader::AsdlClass(93, 4);
  }
...
class ShFunction : public command_t {
 public:
  ...
  static constexpr ObjHeader obj_header() {
    return ObjHeader::AsdlClass(95, 5);
  }
...
class Attribute : public y_lhs_t, public expr_t {
 public:
  ...
  static constexpr ObjHeader obj_header() {
    return ObjHeader::AsdlClass(101, 4);
  }
...
public re_t {
 public:
  ...
  static constexpr ObjHeader obj_header() {
    return ObjHeader::AsdlClass(102, 2);
  }
...
class CharCode : public class_literal_term_t, public char_class_term_t {
 public:
  ...
  static constexpr ObjHeader obj_header() {
    return ObjHeader::AsdlClass(104, 1);
  }

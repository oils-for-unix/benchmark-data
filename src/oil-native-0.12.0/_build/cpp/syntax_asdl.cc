...
hnode_t* class_literal_term__ByteSet::PrettyTree() {
  hnode__Record* out_node =
runtime::NewRecord(StrFromC("class_literal_term.ByteSet"));
  List<field*>* L = out_node->fields;

  hnode_t* x0 = runtime::NewLeaf(this->bytes, color_e::StringConst);
  L->append(new field(StrFromC("bytes"), x0));
...
hnode_t* class_literal_term__CodePoint::PrettyTree() {
  hnode__Record* out_node =
runtime::NewRecord(StrFromC("class_literal_term.CodePoint"));
  List<field*>* L = out_node->fields;
...
hnode_t* re__ClassLiteral::PrettyTree() {
  hnode__Record* out_node = runtime::NewRecord(StrFromC("re.ClassLiteral"));
  List<field*>* L = out_node->fields;

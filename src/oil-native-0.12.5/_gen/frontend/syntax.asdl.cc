...
hnode_t* source__ArgvWord::PrettyTree() {
  ...
  hnode_t* x1 = Alloc<hnode__Leaf>(str(this->span_id), color_e::OtherConst);
  L->append(Alloc<field>(StrFromC("span_id"), x1));
...
hnode_t* source__Alias::PrettyTree() {
  ...
  hnode_t* x1 = Alloc<hnode__Leaf>(str(this->argv0_spid), color_e::OtherConst);
  L->append(Alloc<field>(StrFromC("argv0_spid"), x1));
...
hnode_t* source__Reparsed::PrettyTree() {
  ...
  hnode_t* x1 = Alloc<hnode__Leaf>(str(this->left_spid), color_e::OtherConst);
  L->append(Alloc<field>(StrFromC("left_spid"), x1));

  hnode_t* x2 = Alloc<hnode__Leaf>(str(this->right_spid), color_e::OtherConst);
  L->append(Alloc<field>(StrFromC("right_spid"), x2));
...
hnode_t* line_span::PrettyTree() {
  ...
  hnode_t* x0 = Alloc<hnode__Leaf>(str(this->line_id), color_e::OtherConst);
  L->append(Alloc<field>(StrFromC("line_id"), x0));
...
hnode_t* double_quoted::PrettyTree() {
  ...
  hnode_t* x2 = Alloc<hnode__Leaf>(this->multiline ? runtime::TRUE_STR :
                                   runtime::FALSE_STR, color_e::OtherConst);
  L->append(Alloc<field>(StrFromC("multiline"), x2));
...
hnode_t* ArgList::PrettyTree() {
  ...
  if (this->positional && len(this->positional)) {  // ArrayType
    ...
    L->append(Alloc<field>(StrFromC("positional"), x0));
  }
  ...
  if (this->named && len(this->named)) {  // ArrayType
    ...
    L->append(Alloc<field>(StrFromC("named"), x1));
  }
...
hnode_t* BraceGroup::PrettyTree() {
  ...
  if (this->doc_token) {  // MaybeType
    ...
    L->append(Alloc<field>(StrFromC("doc_token"), x0));
  }
...
hnode_t* command__Simple::PrettyTree() {
  ...
  if (this->spids && len(this->spids)) {  // ArrayType
    hnode__Array* x6 = Alloc<hnode__Array>(NewList<hnode_t*>());
    for (ListIter<int> it(this->spids); !it.Done(); it.Next()) {
      int i6 = it.Value();
...
hnode_t* command__ForExpr::PrettyTree() {
  ...
  if (this->spids && len(this->spids)) {  // ArrayType
    hnode__Array* x5 = Alloc<hnode__Array>(NewList<hnode_t*>());
    for (ListIter<int> it(this->spids); !it.Done(); it.Next()) {
      int i5 = it.Value();
...
hnode_t* command__Func::PrettyTree() {
  ...
  if (this->spids && len(this->spids)) {  // ArrayType
    hnode__Array* x7 = Alloc<hnode__Array>(NewList<hnode_t*>());
    for (ListIter<int> it(this->spids); !it.Done(); it.Next()) {
      int i7 = it.Value();

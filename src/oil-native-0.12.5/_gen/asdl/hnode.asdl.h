...
class hnode__Record : public hnode_t {
 public:
  hnode__Record() : type_tag_(static_cast<uint16_t>(hnode_e::Record)),
                node_type(StrFromC("")), fields(NewList<field*>()),
                abbrev(false), left(StrFromC("")), right(StrFromC("")),
...
class hnode__Leaf : public hnode_t {
 public:
  hnode__Leaf() : type_tag_(static_cast<uint16_t>(hnode_e::Leaf)),
              s(StrFromC("")), color(color_e::TypeName) {
  }
...
class field {
 public:
  field() : type_tag_(200), name(StrFromC("")), val(nullptr) {
  }

...
GLOBAL_STR(gVersion, "0.22.0");

GLOBAL_LIST(STRICT_ALL, int, 9, {28 COMMA 29 COMMA 30 COMMA 31 COMMA 32 COMMA 36 COMMA 33 COMMA 35 COMMA 34});
GLOBAL_LIST(YSH_UPGRADE, int, 23, {48 COMMA 47 COMMA 1 COMMA 4 COMMA 2 COMMA 5 COMMA 37 COMMA 40 COMMA 41 COMMA 42 COMMA 39 COMMA 43 COMMA 38 COMMA 45 COMMA 44 COMMA 3 COMMA 49 COMMA 53 COMMA 52 COMMA 46 COMMA 6 COMMA 51 COMMA 50});
GLOBAL_LIST(YSH_ALL, int, 45, {48 COMMA 47 COMMA 1 COMMA 66 COMMA 4 COMMA 2 COMMA 5 COMMA 37 COMMA 54 COMMA 55 COMMA 56 COMMA 62 COMMA 40 COMMA 41 COMMA 61 COMMA 57 COMMA 60 COMMA 42 COMMA 39 COMMA 58 COMMA 43 COMMA 38 COMMA 59 COMMA 45 COMMA 44 COMMA 3 COMMA 49 COMMA 53 COMMA 52 COMMA 63 COMMA 64 COMMA 65 COMMA 46 COMMA 28 COMMA 29 COMMA 30 COMMA 31 COMMA 32 COMMA 36 COMMA 33 COMMA 35 COMMA 34 COMMA 6 COMMA 51 COMMA 50});
GLOBAL_LIST(DEFAULT_TRUE, int, 16, {21 COMMA 22 COMMA 47 COMMA 23 COMMA 66 COMMA 16 COMMA 55 COMMA 56 COMMA 62 COMMA 61 COMMA 57 COMMA 60 COMMA 58 COMMA 59 COMMA 53 COMMA 51});
GLOBAL_LIST(PARSE_OPTION_NUMS, int, 19, {66 COMMA 37 COMMA 54 COMMA 55 COMMA 56 COMMA 62 COMMA 40 COMMA 41 COMMA 61 COMMA 57 COMMA 60 COMMA 42 COMMA 39 COMMA 58 COMMA 43 COMMA 38 COMMA 59 COMMA 45 COMMA 44});
GLOBAL_LIST(SHOPT_OPTION_NUMS, int, 93, {21 COMMA 22 COMMA 27 COMMA 26 COMMA 25 COMMA 72 COMMA 73 COMMA 74 COMMA 75 COMMA 76 COMMA 77 COMMA 78 COMMA 71 COMMA 48 COMMA 79 COMMA 47 COMMA 80 COMMA 81 COMMA 82 COMMA 23 COMMA 20 COMMA 83 COMMA 66 COMMA 84 COMMA 18 COMMA 85 COMMA 17 COMMA 86 COMMA 87 COMMA 88 COMMA 89 COMMA 69 COMMA 90 COMMA 91 COMMA 70 COMMA 92 COMMA 4 COMMA 93 COMMA 67 COMMA 94 COMMA 95 COMMA 96 COMMA 97 COMMA 98 COMMA 99 COMMA 100 COMMA 19 COMMA 5 COMMA 37 COMMA 54 COMMA 55 COMMA 56 COMMA 62 COMMA 40 COMMA 41 COMMA 61 COMMA 57 COMMA 60 COMMA 42 COMMA 39 COMMA 58 COMMA 43 COMMA 38 COMMA 59 COMMA 45 COMMA 44 COMMA 49 COMMA 68 COMMA 101 COMMA 102 COMMA 24 COMMA 53 COMMA 103 COMMA 104 COMMA 52 COMMA 63 COMMA 64 COMMA 65 COMMA 46 COMMA 105 COMMA 28 COMMA 29 COMMA 30 COMMA 31 COMMA 32 COMMA 36 COMMA 33 COMMA 35 COMMA 34 COMMA 6 COMMA 106 COMMA 51 COMMA 50});
...
GLOBAL_LIST(VISIBLE_SHOPT_NUMS, int, 53, {21 COMMA 22 COMMA 27 COMMA 26 COMMA 25 COMMA 48 COMMA 47 COMMA 23 COMMA 20 COMMA 66 COMMA 18 COMMA 17 COMMA 4 COMMA 19 COMMA 5 COMMA 37 COMMA 54 COMMA 55 COMMA 56 COMMA 62 COMMA 40 COMMA 41 COMMA 61 COMMA 57 COMMA 60 COMMA 42 COMMA 39 COMMA 58 COMMA 43 COMMA 38 COMMA 59 COMMA 45 COMMA 44 COMMA 49 COMMA 24 COMMA 53 COMMA 52 COMMA 63 COMMA 64 COMMA 65 COMMA 46 COMMA 28 COMMA 29 COMMA 30 COMMA 31 COMMA 32 COMMA 36 COMMA 33 COMMA 35 COMMA 34 COMMA 6 COMMA 51 COMMA 50});
...
option_asdl::option_t OptionNum(BigStr* s) {
  ...
  case '_':
    ...
    if (length == 14 && memcmp("_no_debug_trap", data, 14) == 0) return 27;
    break;
  case 'a':
    if (length == 17 && memcmp("assoc_expand_once", data, 17) == 0) return 72;
    if (length == 6 && memcmp("autocd", data, 6) == 0) return 73;
    break;
  case 'c':
    if (length == 19 && memcmp("command_sub_errexit", data, 19) == 0) return 48;
    if (length == 7 && memcmp("cmdhist", data, 7) == 0) return 71;
    if (length == 11 && memcmp("cdable_vars", data, 11) == 0) return 74;
    if (length == 7 && memcmp("cdspell", data, 7) == 0) return 75;
    if (length == 9 && memcmp("checkhash", data, 9) == 0) return 76;
    if (length == 9 && memcmp("checkjobs", data, 9) == 0) return 77;
    if (length == 12 && memcmp("checkwinsize", data, 12) == 0) return 78;
    if (length == 18 && memcmp("complete_fullquote", data, 18) == 0) return 79;
    break;
  case 'd':
    if (length == 13 && memcmp("dynamic_scope", data, 13) == 0) return 23;
    if (length == 8 && memcmp("dashglob", data, 8) == 0) return 47;
    if (length == 9 && memcmp("direxpand", data, 9) == 0) return 80;
    if (length == 8 && memcmp("dirspell", data, 8) == 0) return 81;
    if (length == 7 && memcmp("dotglob", data, 7) == 0) return 82;
    break;
  case 'e':
    ...
    if (length == 14 && memcmp("expand_aliases", data, 14) == 0) return 66;
    if (length == 8 && memcmp("execfail", data, 8) == 0) return 83;
    if (length == 8 && memcmp("extdebug", data, 8) == 0) return 84;
    if (length == 8 && memcmp("extquote", data, 8) == 0) return 85;
    break;
  case 'f':
    if (length == 8 && memcmp("failglob", data, 8) == 0) return 17;
    if (length == 13 && memcmp("force_fignore", data, 13) == 0) return 86;
    break;
  case 'g':
    if (length == 15 && memcmp("globasciiranges", data, 15) == 0) return 87;
    if (length == 8 && memcmp("globstar", data, 8) == 0) return 88;
    if (length == 10 && memcmp("gnu_errfmt", data, 10) == 0) return 89;
    break;
  case 'h':
    if (length == 7 && memcmp("hashall", data, 7) == 0) return 16;
    if (length == 10 && memcmp("histappend", data, 10) == 0) return 69;
    if (length == 12 && memcmp("hostcomplete", data, 12) == 0) return 70;
    if (length == 10 && memcmp("histreedit", data, 10) == 0) return 90;
    if (length == 10 && memcmp("histverify", data, 10) == 0) return 91;
    if (length == 9 && memcmp("huponexit", data, 9) == 0) return 92;
    break;
  case 'i':
    if (length == 15 && memcmp("inherit_errexit", data, 15) == 0) return 4;
    if (length == 11 && memcmp("interactive", data, 11) == 0) return 15;
    if (length == 20 && memcmp("interactive_comments", data, 20) == 0) return 93;
    break;
  case 'l':
    if (length == 8 && memcmp("lastpipe", data, 8) == 0) return 67;
    if (length == 7 && memcmp("lithist", data, 7) == 0) return 94;
    if (length == 16 && memcmp("localvar_inherit", data, 16) == 0) return 95;
    if (length == 14 && memcmp("localvar_unset", data, 14) == 0) return 96;
    if (length == 11 && memcmp("login_shell", data, 11) == 0) return 97;
    break;
  case 'm':
    if (length == 8 && memcmp("mailwarn", data, 8) == 0) return 98;
    break;
  case 'n':
    ...
    if (length == 23 && memcmp("no_empty_cmd_completion", data, 23) == 0) return 99;
    if (length == 10 && memcmp("nocaseglob", data, 10) == 0) return 100;
    break;
  case 'p':
    if (length == 8 && memcmp("pipefail", data, 8) == 0) return 3;
    if (length == 5 && memcmp("posix", data, 5) == 0) return 12;
    if (length == 8 && memcmp("parse_at", data, 8) == 0) return 37;
    if (length == 10 && memcmp("parse_proc", data, 10) == 0) return 38;
    if (length == 10 && memcmp("parse_func", data, 10) == 0) return 39;
    if (length == 11 && memcmp("parse_brace", data, 11) == 0) return 40;
    if (length == 13 && memcmp("parse_bracket", data, 13) == 0) return 41;
    if (length == 12 && memcmp("parse_equals", data, 12) == 0) return 42;
    if (length == 11 && memcmp("parse_paren", data, 11) == 0) return 43;
    if (length == 16 && memcmp("parse_ysh_string", data, 16) == 0) return 44;
    if (length == 18 && memcmp("parse_triple_quote", data, 18) == 0) return 45;
    ...
    if (length == 14 && memcmp("parse_dbracket", data, 14) == 0) return 61;
    if (length == 15 && memcmp("parse_bare_word", data, 15) == 0) return 62;
    if (length == 8 && memcmp("progcomp", data, 8) == 0) return 68;
    if (length == 14 && memcmp("progcomp_alias", data, 14) == 0) return 101;
    if (length == 10 && memcmp("promptvars", data, 10) == 0) return 102;
    break;
  case 'r':
    if (length == 15 && memcmp("redefine_module", data, 15) == 0) return 24;
    if (length == 18 && memcmp("redefine_proc_func", data, 18) == 0) return 53;
    if (length == 16 && memcmp("restricted_shell", data, 16) == 0) return 103;
    break;
  case 's':
    if (length == 11 && memcmp("strict_argv", data, 11) == 0) return 28;
    if (length == 12 && memcmp("strict_arith", data, 12) == 0) return 29;
    if (length == 12 && memcmp("strict_array", data, 12) == 0) return 30;
    if (length == 19 && memcmp("strict_control_flow", data, 19) == 0) return 31;
    if (length == 14 && memcmp("strict_errexit", data, 14) == 0) return 32;
    if (length == 14 && memcmp("strict_nameref", data, 14) == 0) return 33;
    if (length == 16 && memcmp("strict_word_eval", data, 16) == 0) return 34;
    if (length == 12 && memcmp("strict_tilde", data, 12) == 0) return 35;
    if (length == 11 && memcmp("strict_glob", data, 11) == 0) return 36;
    if (length == 16 && memcmp("simple_word_eval", data, 16) == 0) return 46;
    if (length == 17 && memcmp("sigpipe_status_ok", data, 17) == 0) return 52;
    if (length == 11 && memcmp("simple_echo", data, 11) == 0) return 63;
    if (length == 19 && memcmp("simple_eval_builtin", data, 19) == 0) return 64;
    if (length == 19 && memcmp("simple_test_builtin", data, 19) == 0) return 65;
    if (length == 13 && memcmp("shift_verbose", data, 13) == 0) return 104;
    if (length == 10 && memcmp("sourcepath", data, 10) == 0) return 105;
    break;
  case 'v':
  ...
  case 'x':
    ...
    if (length == 8 && memcmp("xpg_echo", data, 8) == 0) return 106;
    break;
  }
...
builtin_t LookupNormalBuiltin(BigStr* s) {
  ...
  switch (data[0]) {
  case '[':
    if (length == 1 && memcmp("[", data, 1) == 0) return 69;
    break;
  case '_':
    if (length == 5 && memcmp("__cat", data, 5) == 0) return 72;
    break;
  case 'a':
  ...
  case 'b':
    ...
    if (length == 10 && memcmp("boolstatus", data, 10) == 0) return 67;
    break;
  case 'c':
    ...
    if (length == 3 && memcmp("ctx", data, 3) == 0) return 65;
    break;
  case 'd':
  ...
  case 'f':
    ...
    if (length == 4 && memcmp("fork", data, 4) == 0) return 61;
    if (length == 8 && memcmp("forkwait", data, 8) == 0) return 62;
    if (length == 5 && memcmp("fopen", data, 5) == 0) return 63;
    break;
  case 'g':
  ...
  case 'h':
    ...
    if (length == 3 && memcmp("hay", data, 3) == 0) return 56;
    if (length == 7 && memcmp("haynode", data, 7) == 0) return 57;
    break;
  case 'i':
    if (length == 7 && memcmp("is-main", data, 7) == 0) return 71;
    break;
  case 'j':
    if (length == 4 && memcmp("jobs", data, 4) == 0) return 33;
    if (length == 4 && memcmp("json", data, 4) == 0) return 53;
    if (length == 5 && memcmp("json8", data, 5) == 0) return 54;
    break;
  case 'm':
    if (length == 7 && memcmp("mapfile", data, 7) == 0) return 22;
    if (length == 6 && memcmp("module", data, 6) == 0) return 58;
    break;
  case 'p':
    ...
    if (length == 2 && memcmp("pp", data, 2) == 0) return 55;
    if (length == 14 && memcmp("push-registers", data, 14) == 0) return 70;
    break;
  case 'r':
    if (length == 4 && memcmp("read", data, 4) == 0) return 19;
    if (length == 9 && memcmp("readarray", data, 9) == 0) return 23;
    if (length == 7 && memcmp("runproc", data, 7) == 0) return 66;
    break;
  case 's':
    if (length == 6 && memcmp("source", data, 6) == 0) return 29;
    if (length == 5 && memcmp("shopt", data, 5) == 0) return 36;
    if (length == 5 && memcmp("shvar", data, 5) == 0) return 64;
    break;
  case 't':
    ...
    if (length == 4 && memcmp("test", data, 4) == 0) return 68;
    break;
  case 'u':
...
GLOBAL_STR(kOptionName_12, "posix");
GLOBAL_STR(kOptionName_13, "vi");
GLOBAL_STR(kOptionName_14, "emacs");
GLOBAL_STR(kOptionName_15, "interactive");
GLOBAL_STR(kOptionName_16, "hashall");
GLOBAL_STR(kOptionName_17, "failglob");
GLOBAL_STR(kOptionName_18, "extglob");
GLOBAL_STR(kOptionName_19, "nocasematch");
GLOBAL_STR(kOptionName_20, "eval_unsafe_arith");
GLOBAL_STR(kOptionName_21, "_allow_command_sub");
GLOBAL_STR(kOptionName_22, "_allow_process_sub");
GLOBAL_STR(kOptionName_23, "dynamic_scope");
GLOBAL_STR(kOptionName_24, "redefine_module");
GLOBAL_STR(kOptionName_25, "_running_trap");
GLOBAL_STR(kOptionName_26, "_running_hay");
GLOBAL_STR(kOptionName_27, "_no_debug_trap");
GLOBAL_STR(kOptionName_28, "strict_argv");
GLOBAL_STR(kOptionName_29, "strict_arith");
GLOBAL_STR(kOptionName_30, "strict_array");
GLOBAL_STR(kOptionName_31, "strict_control_flow");
GLOBAL_STR(kOptionName_32, "strict_errexit");
GLOBAL_STR(kOptionName_33, "strict_nameref");
GLOBAL_STR(kOptionName_34, "strict_word_eval");
GLOBAL_STR(kOptionName_35, "strict_tilde");
GLOBAL_STR(kOptionName_36, "strict_glob");
GLOBAL_STR(kOptionName_37, "parse_at");
GLOBAL_STR(kOptionName_38, "parse_proc");
GLOBAL_STR(kOptionName_39, "parse_func");
GLOBAL_STR(kOptionName_40, "parse_brace");
GLOBAL_STR(kOptionName_41, "parse_bracket");
GLOBAL_STR(kOptionName_42, "parse_equals");
GLOBAL_STR(kOptionName_43, "parse_paren");
GLOBAL_STR(kOptionName_44, "parse_ysh_string");
GLOBAL_STR(kOptionName_45, "parse_triple_quote");
GLOBAL_STR(kOptionName_46, "simple_word_eval");
GLOBAL_STR(kOptionName_47, "dashglob");
GLOBAL_STR(kOptionName_48, "command_sub_errexit");
GLOBAL_STR(kOptionName_49, "process_sub_fail");
GLOBAL_STR(kOptionName_50, "xtrace_rich");
GLOBAL_STR(kOptionName_51, "xtrace_details");
GLOBAL_STR(kOptionName_52, "sigpipe_status_ok");
GLOBAL_STR(kOptionName_53, "redefine_proc_func");
GLOBAL_STR(kOptionName_54, "parse_at_all");
GLOBAL_STR(kOptionName_55, "parse_backslash");
GLOBAL_STR(kOptionName_56, "parse_backticks");
GLOBAL_STR(kOptionName_57, "parse_dollar");
GLOBAL_STR(kOptionName_58, "parse_ignored");
GLOBAL_STR(kOptionName_59, "parse_sh_arith");
GLOBAL_STR(kOptionName_60, "parse_dparen");
GLOBAL_STR(kOptionName_61, "parse_dbracket");
GLOBAL_STR(kOptionName_62, "parse_bare_word");
GLOBAL_STR(kOptionName_63, "simple_echo");
GLOBAL_STR(kOptionName_64, "simple_eval_builtin");
GLOBAL_STR(kOptionName_65, "simple_test_builtin");
GLOBAL_STR(kOptionName_66, "expand_aliases");
GLOBAL_STR(kOptionName_67, "lastpipe");
GLOBAL_STR(kOptionName_68, "progcomp");
GLOBAL_STR(kOptionName_69, "histappend");
GLOBAL_STR(kOptionName_70, "hostcomplete");
GLOBAL_STR(kOptionName_71, "cmdhist");
GLOBAL_STR(kOptionName_72, "assoc_expand_once");
GLOBAL_STR(kOptionName_73, "autocd");
GLOBAL_STR(kOptionName_74, "cdable_vars");
GLOBAL_STR(kOptionName_75, "cdspell");
GLOBAL_STR(kOptionName_76, "checkhash");
GLOBAL_STR(kOptionName_77, "checkjobs");
GLOBAL_STR(kOptionName_78, "checkwinsize");
GLOBAL_STR(kOptionName_79, "complete_fullquote");
GLOBAL_STR(kOptionName_80, "direxpand");
GLOBAL_STR(kOptionName_81, "dirspell");
GLOBAL_STR(kOptionName_82, "dotglob");
GLOBAL_STR(kOptionName_83, "execfail");
GLOBAL_STR(kOptionName_84, "extdebug");
GLOBAL_STR(kOptionName_85, "extquote");
GLOBAL_STR(kOptionName_86, "force_fignore");
GLOBAL_STR(kOptionName_87, "globasciiranges");
GLOBAL_STR(kOptionName_88, "globstar");
GLOBAL_STR(kOptionName_89, "gnu_errfmt");
GLOBAL_STR(kOptionName_90, "histreedit");
GLOBAL_STR(kOptionName_91, "histverify");
GLOBAL_STR(kOptionName_92, "huponexit");
GLOBAL_STR(kOptionName_93, "interactive_comments");
GLOBAL_STR(kOptionName_94, "lithist");
GLOBAL_STR(kOptionName_95, "localvar_inherit");
GLOBAL_STR(kOptionName_96, "localvar_unset");
GLOBAL_STR(kOptionName_97, "login_shell");
GLOBAL_STR(kOptionName_98, "mailwarn");
GLOBAL_STR(kOptionName_99, "no_empty_cmd_completion");
GLOBAL_STR(kOptionName_100, "nocaseglob");
GLOBAL_STR(kOptionName_101, "progcomp_alias");
GLOBAL_STR(kOptionName_102, "promptvars");
GLOBAL_STR(kOptionName_103, "restricted_shell");
GLOBAL_STR(kOptionName_104, "shift_verbose");
GLOBAL_STR(kOptionName_105, "sourcepath");
GLOBAL_STR(kOptionName_106, "xpg_echo");
...
GLOBAL_STR(kSHOPT_OPTION_NAMES_3, "_running_hay");
GLOBAL_STR(kSHOPT_OPTION_NAMES_4, "_running_trap");
GLOBAL_STR(kSHOPT_OPTION_NAMES_5, "assoc_expand_once");
GLOBAL_STR(kSHOPT_OPTION_NAMES_6, "autocd");
GLOBAL_STR(kSHOPT_OPTION_NAMES_7, "cdable_vars");
GLOBAL_STR(kSHOPT_OPTION_NAMES_8, "cdspell");
GLOBAL_STR(kSHOPT_OPTION_NAMES_9, "checkhash");
GLOBAL_STR(kSHOPT_OPTION_NAMES_10, "checkjobs");
GLOBAL_STR(kSHOPT_OPTION_NAMES_11, "checkwinsize");
GLOBAL_STR(kSHOPT_OPTION_NAMES_12, "cmdhist");
GLOBAL_STR(kSHOPT_OPTION_NAMES_13, "command_sub_errexit");
GLOBAL_STR(kSHOPT_OPTION_NAMES_14, "complete_fullquote");
GLOBAL_STR(kSHOPT_OPTION_NAMES_15, "dashglob");
...
GLOBAL_STR(kSHOPT_OPTION_NAMES_20, "eval_unsafe_arith");
GLOBAL_STR(kSHOPT_OPTION_NAMES_21, "execfail");
GLOBAL_STR(kSHOPT_OPTION_NAMES_22, "expand_aliases");
GLOBAL_STR(kSHOPT_OPTION_NAMES_23, "extdebug");
GLOBAL_STR(kSHOPT_OPTION_NAMES_24, "extglob");
GLOBAL_STR(kSHOPT_OPTION_NAMES_25, "extquote");
GLOBAL_STR(kSHOPT_OPTION_NAMES_26, "failglob");
GLOBAL_STR(kSHOPT_OPTION_NAMES_27, "force_fignore");
GLOBAL_STR(kSHOPT_OPTION_NAMES_28, "globasciiranges");
GLOBAL_STR(kSHOPT_OPTION_NAMES_29, "globstar");
GLOBAL_STR(kSHOPT_OPTION_NAMES_30, "gnu_errfmt");
GLOBAL_STR(kSHOPT_OPTION_NAMES_31, "histappend");
GLOBAL_STR(kSHOPT_OPTION_NAMES_32, "histreedit");
GLOBAL_STR(kSHOPT_OPTION_NAMES_33, "histverify");
GLOBAL_STR(kSHOPT_OPTION_NAMES_34, "hostcomplete");
GLOBAL_STR(kSHOPT_OPTION_NAMES_35, "huponexit");
GLOBAL_STR(kSHOPT_OPTION_NAMES_36, "inherit_errexit");
GLOBAL_STR(kSHOPT_OPTION_NAMES_37, "interactive_comments");
GLOBAL_STR(kSHOPT_OPTION_NAMES_38, "lastpipe");
GLOBAL_STR(kSHOPT_OPTION_NAMES_39, "lithist");
GLOBAL_STR(kSHOPT_OPTION_NAMES_40, "localvar_inherit");
GLOBAL_STR(kSHOPT_OPTION_NAMES_41, "localvar_unset");
GLOBAL_STR(kSHOPT_OPTION_NAMES_42, "login_shell");
GLOBAL_STR(kSHOPT_OPTION_NAMES_43, "mailwarn");
GLOBAL_STR(kSHOPT_OPTION_NAMES_44, "no_empty_cmd_completion");
GLOBAL_STR(kSHOPT_OPTION_NAMES_45, "nocaseglob");
GLOBAL_STR(kSHOPT_OPTION_NAMES_46, "nocasematch");
GLOBAL_STR(kSHOPT_OPTION_NAMES_47, "nullglob");
GLOBAL_STR(kSHOPT_OPTION_NAMES_48, "parse_at");
GLOBAL_STR(kSHOPT_OPTION_NAMES_49, "parse_at_all");
GLOBAL_STR(kSHOPT_OPTION_NAMES_50, "parse_backslash");
GLOBAL_STR(kSHOPT_OPTION_NAMES_51, "parse_backticks");
GLOBAL_STR(kSHOPT_OPTION_NAMES_52, "parse_bare_word");
GLOBAL_STR(kSHOPT_OPTION_NAMES_53, "parse_brace");
GLOBAL_STR(kSHOPT_OPTION_NAMES_54, "parse_bracket");
GLOBAL_STR(kSHOPT_OPTION_NAMES_55, "parse_dbracket");
GLOBAL_STR(kSHOPT_OPTION_NAMES_56, "parse_dollar");
GLOBAL_STR(kSHOPT_OPTION_NAMES_57, "parse_dparen");
GLOBAL_STR(kSHOPT_OPTION_NAMES_58, "parse_equals");
GLOBAL_STR(kSHOPT_OPTION_NAMES_59, "parse_func");
GLOBAL_STR(kSHOPT_OPTION_NAMES_60, "parse_ignored");
GLOBAL_STR(kSHOPT_OPTION_NAMES_61, "parse_paren");
GLOBAL_STR(kSHOPT_OPTION_NAMES_62, "parse_proc");
GLOBAL_STR(kSHOPT_OPTION_NAMES_63, "parse_sh_arith");
GLOBAL_STR(kSHOPT_OPTION_NAMES_64, "parse_triple_quote");
GLOBAL_STR(kSHOPT_OPTION_NAMES_65, "parse_ysh_string");
GLOBAL_STR(kSHOPT_OPTION_NAMES_66, "process_sub_fail");
GLOBAL_STR(kSHOPT_OPTION_NAMES_67, "progcomp");
GLOBAL_STR(kSHOPT_OPTION_NAMES_68, "progcomp_alias");
GLOBAL_STR(kSHOPT_OPTION_NAMES_69, "promptvars");
GLOBAL_STR(kSHOPT_OPTION_NAMES_70, "redefine_module");
GLOBAL_STR(kSHOPT_OPTION_NAMES_71, "redefine_proc_func");
GLOBAL_STR(kSHOPT_OPTION_NAMES_72, "restricted_shell");
GLOBAL_STR(kSHOPT_OPTION_NAMES_73, "shift_verbose");
GLOBAL_STR(kSHOPT_OPTION_NAMES_74, "sigpipe_status_ok");
GLOBAL_STR(kSHOPT_OPTION_NAMES_75, "simple_echo");
GLOBAL_STR(kSHOPT_OPTION_NAMES_76, "simple_eval_builtin");
GLOBAL_STR(kSHOPT_OPTION_NAMES_77, "simple_test_builtin");
GLOBAL_STR(kSHOPT_OPTION_NAMES_78, "simple_word_eval");
GLOBAL_STR(kSHOPT_OPTION_NAMES_79, "sourcepath");
GLOBAL_STR(kSHOPT_OPTION_NAMES_80, "strict_argv");
GLOBAL_STR(kSHOPT_OPTION_NAMES_81, "strict_arith");
GLOBAL_STR(kSHOPT_OPTION_NAMES_82, "strict_array");
GLOBAL_STR(kSHOPT_OPTION_NAMES_83, "strict_control_flow");
GLOBAL_STR(kSHOPT_OPTION_NAMES_84, "strict_errexit");
GLOBAL_STR(kSHOPT_OPTION_NAMES_85, "strict_glob");
GLOBAL_STR(kSHOPT_OPTION_NAMES_86, "strict_nameref");
GLOBAL_STR(kSHOPT_OPTION_NAMES_87, "strict_tilde");
GLOBAL_STR(kSHOPT_OPTION_NAMES_88, "strict_word_eval");
GLOBAL_STR(kSHOPT_OPTION_NAMES_89, "verbose_errexit");
GLOBAL_STR(kSHOPT_OPTION_NAMES_90, "xpg_echo");
GLOBAL_STR(kSHOPT_OPTION_NAMES_91, "xtrace_details");
GLOBAL_STR(kSHOPT_OPTION_NAMES_92, "xtrace_rich");
GLOBAL_LIST(SHOPT_OPTION_NAMES, BigStr*, 93, {kSHOPT_OPTION_NAMES_0 COMMA kSHOPT_OPTION_NAMES_1 COMMA kSHOPT_OPTION_NAMES_2 COMMA kSHOPT_OPTION_NAMES_3 COMMA kSHOPT_OPTION_NAMES_4 COMMA kSHOPT_OPTION_NAMES_5 COMMA kSHOPT_OPTION_NAMES_6 COMMA kSHOPT_OPTION_NAMES_7 COMMA kSHOPT_OPTION_NAMES_8 COMMA kSHOPT_OPTION_NAMES_9 COMMA kSHOPT_OPTION_NAMES_10 COMMA kSHOPT_OPTION_NAMES_11 COMMA kSHOPT_OPTION_NAMES_12 COMMA kSHOPT_OPTION_NAMES_13 COMMA kSHOPT_OPTION_NAMES_14 COMMA kSHOPT_OPTION_NAMES_15 COMMA kSHOPT_OPTION_NAMES_16 COMMA kSHOPT_OPTION_NAMES_17 COMMA kSHOPT_OPTION_NAMES_18 COMMA kSHOPT_OPTION_NAMES_19 COMMA kSHOPT_OPTION_NAMES_20 COMMA kSHOPT_OPTION_NAMES_21 COMMA kSHOPT_OPTION_NAMES_22 COMMA kSHOPT_OPTION_NAMES_23 COMMA kSHOPT_OPTION_NAMES_24 COMMA kSHOPT_OPTION_NAMES_25 COMMA kSHOPT_OPTION_NAMES_26 COMMA kSHOPT_OPTION_NAMES_27 COMMA kSHOPT_OPTION_NAMES_28 COMMA kSHOPT_OPTION_NAMES_29 COMMA kSHOPT_OPTION_NAMES_30 COMMA kSHOPT_OPTION_NAMES_31 COMMA kSHOPT_OPTION_NAMES_32 COMMA kSHOPT_OPTION_NAMES_33 COMMA kSHOPT_OPTION_NAMES_34 COMMA kSHOPT_OPTION_NAMES_35 COMMA kSHOPT_OPTION_NAMES_36 COMMA kSHOPT_OPTION_NAMES_37 COMMA kSHOPT_OPTION_NAMES_38 COMMA kSHOPT_OPTION_NAMES_39 COMMA kSHOPT_OPTION_NAMES_40 COMMA kSHOPT_OPTION_NAMES_41 COMMA kSHOPT_OPTION_NAMES_42 COMMA kSHOPT_OPTION_NAMES_43 COMMA kSHOPT_OPTION_NAMES_44 COMMA kSHOPT_OPTION_NAMES_45 COMMA kSHOPT_OPTION_NAMES_46 COMMA kSHOPT_OPTION_NAMES_47 COMMA kSHOPT_OPTION_NAMES_48 COMMA kSHOPT_OPTION_NAMES_49 COMMA kSHOPT_OPTION_NAMES_50 COMMA kSHOPT_OPTION_NAMES_51 COMMA kSHOPT_OPTION_NAMES_52 COMMA kSHOPT_OPTION_NAMES_53 COMMA kSHOPT_OPTION_NAMES_54 COMMA kSHOPT_OPTION_NAMES_55 COMMA kSHOPT_OPTION_NAMES_56 COMMA kSHOPT_OPTION_NAMES_57 COMMA kSHOPT_OPTION_NAMES_58 COMMA kSHOPT_OPTION_NAMES_59 COMMA kSHOPT_OPTION_NAMES_60 COMMA kSHOPT_OPTION_NAMES_61 COMMA kSHOPT_OPTION_NAMES_62 COMMA kSHOPT_OPTION_NAMES_63 COMMA kSHOPT_OPTION_NAMES_64 COMMA kSHOPT_OPTION_NAMES_65 COMMA kSHOPT_OPTION_NAMES_66 COMMA kSHOPT_OPTION_NAMES_67 COMMA kSHOPT_OPTION_NAMES_68 COMMA kSHOPT_OPTION_NAMES_69 COMMA kSHOPT_OPTION_NAMES_70 COMMA kSHOPT_OPTION_NAMES_71 COMMA kSHOPT_OPTION_NAMES_72 COMMA kSHOPT_OPTION_NAMES_73 COMMA kSHOPT_OPTION_NAMES_74 COMMA kSHOPT_OPTION_NAMES_75 COMMA kSHOPT_OPTION_NAMES_76 COMMA kSHOPT_OPTION_NAMES_77 COMMA kSHOPT_OPTION_NAMES_78 COMMA kSHOPT_OPTION_NAMES_79 COMMA kSHOPT_OPTION_NAMES_80 COMMA kSHOPT_OPTION_NAMES_81 COMMA kSHOPT_OPTION_NAMES_82 COMMA kSHOPT_OPTION_NAMES_83 COMMA kSHOPT_OPTION_NAMES_84 COMMA kSHOPT_OPTION_NAMES_85 COMMA kSHOPT_OPTION_NAMES_86 COMMA kSHOPT_OPTION_NAMES_87 COMMA kSHOPT_OPTION_NAMES_88 COMMA kSHOPT_OPTION_NAMES_89 COMMA kSHOPT_OPTION_NAMES_90 COMMA kSHOPT_OPTION_NAMES_91 COMMA kSHOPT_OPTION_NAMES_92});

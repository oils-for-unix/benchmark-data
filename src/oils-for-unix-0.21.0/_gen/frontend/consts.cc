...
GLOBAL_STR(gVersion, "0.21.0");

GLOBAL_LIST(STRICT_ALL, int, 9, {28 COMMA 29 COMMA 30 COMMA 31 COMMA 32 COMMA 36 COMMA 33 COMMA 35 COMMA 34});
GLOBAL_LIST(YSH_UPGRADE, int, 24, {49 COMMA 47 COMMA 1 COMMA 48 COMMA 4 COMMA 2 COMMA 5 COMMA 37 COMMA 40 COMMA 41 COMMA 42 COMMA 39 COMMA 43 COMMA 38 COMMA 45 COMMA 44 COMMA 3 COMMA 50 COMMA 54 COMMA 53 COMMA 46 COMMA 6 COMMA 52 COMMA 51});
GLOBAL_LIST(YSH_ALL, int, 44, {49 COMMA 47 COMMA 1 COMMA 48 COMMA 4 COMMA 2 COMMA 5 COMMA 37 COMMA 55 COMMA 56 COMMA 57 COMMA 62 COMMA 40 COMMA 41 COMMA 58 COMMA 61 COMMA 42 COMMA 39 COMMA 59 COMMA 43 COMMA 38 COMMA 60 COMMA 45 COMMA 44 COMMA 3 COMMA 50 COMMA 54 COMMA 53 COMMA 63 COMMA 64 COMMA 65 COMMA 46 COMMA 28 COMMA 29 COMMA 30 COMMA 31 COMMA 32 COMMA 36 COMMA 33 COMMA 35 COMMA 34 COMMA 6 COMMA 52 COMMA 51});
GLOBAL_LIST(DEFAULT_TRUE, int, 15, {21 COMMA 22 COMMA 47 COMMA 23 COMMA 48 COMMA 16 COMMA 56 COMMA 57 COMMA 62 COMMA 58 COMMA 61 COMMA 59 COMMA 60 COMMA 54 COMMA 52});
GLOBAL_LIST(PARSE_OPTION_NUMS, int, 18, {48 COMMA 37 COMMA 55 COMMA 56 COMMA 57 COMMA 62 COMMA 40 COMMA 41 COMMA 58 COMMA 61 COMMA 42 COMMA 39 COMMA 59 COMMA 43 COMMA 38 COMMA 60 COMMA 45 COMMA 44});
GLOBAL_LIST(SHOPT_OPTION_NUMS, int, 92, {21 COMMA 22 COMMA 27 COMMA 26 COMMA 25 COMMA 71 COMMA 72 COMMA 73 COMMA 74 COMMA 75 COMMA 76 COMMA 77 COMMA 70 COMMA 49 COMMA 78 COMMA 47 COMMA 79 COMMA 80 COMMA 81 COMMA 23 COMMA 20 COMMA 82 COMMA 48 COMMA 83 COMMA 18 COMMA 84 COMMA 17 COMMA 85 COMMA 86 COMMA 87 COMMA 88 COMMA 68 COMMA 89 COMMA 90 COMMA 69 COMMA 91 COMMA 4 COMMA 92 COMMA 66 COMMA 93 COMMA 94 COMMA 95 COMMA 96 COMMA 97 COMMA 98 COMMA 99 COMMA 19 COMMA 5 COMMA 37 COMMA 55 COMMA 56 COMMA 57 COMMA 62 COMMA 40 COMMA 41 COMMA 58 COMMA 61 COMMA 42 COMMA 39 COMMA 59 COMMA 43 COMMA 38 COMMA 60 COMMA 45 COMMA 44 COMMA 50 COMMA 67 COMMA 100 COMMA 101 COMMA 24 COMMA 54 COMMA 102 COMMA 103 COMMA 53 COMMA 63 COMMA 64 COMMA 65 COMMA 46 COMMA 104 COMMA 28 COMMA 29 COMMA 30 COMMA 31 COMMA 32 COMMA 36 COMMA 33 COMMA 35 COMMA 34 COMMA 6 COMMA 105 COMMA 52 COMMA 51});
...
GLOBAL_LIST(VISIBLE_SHOPT_NUMS, int, 52, {21 COMMA 22 COMMA 27 COMMA 26 COMMA 25 COMMA 49 COMMA 47 COMMA 23 COMMA 20 COMMA 48 COMMA 18 COMMA 17 COMMA 4 COMMA 19 COMMA 5 COMMA 37 COMMA 55 COMMA 56 COMMA 57 COMMA 62 COMMA 40 COMMA 41 COMMA 58 COMMA 61 COMMA 42 COMMA 39 COMMA 59 COMMA 43 COMMA 38 COMMA 60 COMMA 45 COMMA 44 COMMA 50 COMMA 24 COMMA 54 COMMA 53 COMMA 63 COMMA 64 COMMA 65 COMMA 46 COMMA 28 COMMA 29 COMMA 30 COMMA 31 COMMA 32 COMMA 36 COMMA 33 COMMA 35 COMMA 34 COMMA 6 COMMA 52 COMMA 51});
...
Kind GetKind(id_kind_asdl::Id_t id) {
  ...
  case Id::Ignored_HereTabs: return Kind::Ignored;
...
option_asdl::option_t OptionNum(BigStr* s) {
  ...
  case 'a':
    ...
    break;
  case 'c':
    if (length == 19 && memcmp("command_sub_errexit", data, 19) == 0) return 49;
  ...
  case 'e':
    ...
    if (length == 14 && memcmp("expand_aliases", data, 14) == 0) return 48;
  ...
  case 'p':
    ...
    if (length == 16 && memcmp("process_sub_fail", data, 16) == 0) return 50;
    if (length == 12 && memcmp("parse_at_all", data, 12) == 0) return 55;
    if (length == 15 && memcmp("parse_backslash", data, 15) == 0) return 56;
    if (length == 15 && memcmp("parse_backticks", data, 15) == 0) return 57;
    if (length == 12 && memcmp("parse_dollar", data, 12) == 0) return 58;
    if (length == 13 && memcmp("parse_ignored", data, 13) == 0) return 59;
    if (length == 14 && memcmp("parse_sh_arith", data, 14) == 0) return 60;
    if (length == 12 && memcmp("parse_dparen", data, 12) == 0) return 61;
  ...
  case 'r':
    ...
    if (length == 18 && memcmp("redefine_proc_func", data, 18) == 0) return 54;
  ...
  case 's':
    ...
    if (length == 17 && memcmp("sigpipe_status_ok", data, 17) == 0) return 53;
  ...
  case 'x':
    ...
    if (length == 11 && memcmp("xtrace_rich", data, 11) == 0) return 51;
    if (length == 14 && memcmp("xtrace_details", data, 14) == 0) return 52;
...
builtin_t LookupNormalBuiltin(BigStr* s) {
  ...
  switch (data[0]) {
  case '[':
    if (length == 1 && memcmp("[", data, 1) == 0) return 68;
    break;
  case '_':
    if (length == 5 && memcmp("__cat", data, 5) == 0) return 71;
    break;
  case 'a':
  ...
  case 'b':
    ...
    if (length == 10 && memcmp("boolstatus", data, 10) == 0) return 66;
    break;
  case 'c':
    ...
    if (length == 3 && memcmp("ctx", data, 3) == 0) return 64;
    break;
  case 'd':
  ...
  case 'h':
    ...
    break;
  case 'i':
    if (length == 7 && memcmp("is-main", data, 7) == 0) return 70;
    break;
  case 'j':
    if (length == 4 && memcmp("jobs", data, 4) == 0) return 32;
    if (length == 4 && memcmp("json", data, 4) == 0) return 52;
    if (length == 5 && memcmp("json8", data, 5) == 0) return 53;
    break;
  case 'm':
  ...
  case 'p':
    ...
    if (length == 14 && memcmp("push-registers", data, 14) == 0) return 69;
    break;
  case 'r':
    if (length == 4 && memcmp("read", data, 4) == 0) return 19;
    if (length == 9 && memcmp("readarray", data, 9) == 0) return 23;
    if (length == 7 && memcmp("runproc", data, 7) == 0) return 65;
    break;
  case 's':
  ...
  case 't':
    ...
    if (length == 4 && memcmp("test", data, 4) == 0) return 67;
    break;
  case 'u':
...
GLOBAL_STR(kControlFlowName_306, "break");
GLOBAL_STR(kControlFlowName_307, "continue");
GLOBAL_STR(kControlFlowName_308, "return");
GLOBAL_STR(kControlFlowName_309, "exit");

BigStr* ControlFlowName(int i) {
  switch (i) {
  case 306:
    return kControlFlowName_306;
    break;
  case 307:
    return kControlFlowName_307;
    break;
  case 308:
    return kControlFlowName_308;
    break;
  case 309:
    return kControlFlowName_309;
    break;
  default:
    FAIL(kShouldNotGetHere);
  }
...
GLOBAL_STR(kOptionName_48, "expand_aliases");
GLOBAL_STR(kOptionName_49, "command_sub_errexit");
GLOBAL_STR(kOptionName_50, "process_sub_fail");
GLOBAL_STR(kOptionName_51, "xtrace_rich");
GLOBAL_STR(kOptionName_52, "xtrace_details");
GLOBAL_STR(kOptionName_53, "sigpipe_status_ok");
GLOBAL_STR(kOptionName_54, "redefine_proc_func");
GLOBAL_STR(kOptionName_55, "parse_at_all");
GLOBAL_STR(kOptionName_56, "parse_backslash");
GLOBAL_STR(kOptionName_57, "parse_backticks");
GLOBAL_STR(kOptionName_58, "parse_dollar");
GLOBAL_STR(kOptionName_59, "parse_ignored");
GLOBAL_STR(kOptionName_60, "parse_sh_arith");
GLOBAL_STR(kOptionName_61, "parse_dparen");
...
GLOBAL_STR(kOptionName_66, "lastpipe");
GLOBAL_STR(kOptionName_67, "progcomp");
GLOBAL_STR(kOptionName_68, "histappend");
GLOBAL_STR(kOptionName_69, "hostcomplete");
GLOBAL_STR(kOptionName_70, "cmdhist");
GLOBAL_STR(kOptionName_71, "assoc_expand_once");
GLOBAL_STR(kOptionName_72, "autocd");
GLOBAL_STR(kOptionName_73, "cdable_vars");
GLOBAL_STR(kOptionName_74, "cdspell");
GLOBAL_STR(kOptionName_75, "checkhash");
GLOBAL_STR(kOptionName_76, "checkjobs");
GLOBAL_STR(kOptionName_77, "checkwinsize");
GLOBAL_STR(kOptionName_78, "complete_fullquote");
GLOBAL_STR(kOptionName_79, "direxpand");
GLOBAL_STR(kOptionName_80, "dirspell");
GLOBAL_STR(kOptionName_81, "dotglob");
GLOBAL_STR(kOptionName_82, "execfail");
GLOBAL_STR(kOptionName_83, "extdebug");
GLOBAL_STR(kOptionName_84, "extquote");
GLOBAL_STR(kOptionName_85, "force_fignore");
GLOBAL_STR(kOptionName_86, "globasciiranges");
GLOBAL_STR(kOptionName_87, "globstar");
GLOBAL_STR(kOptionName_88, "gnu_errfmt");
GLOBAL_STR(kOptionName_89, "histreedit");
GLOBAL_STR(kOptionName_90, "histverify");
GLOBAL_STR(kOptionName_91, "huponexit");
GLOBAL_STR(kOptionName_92, "interactive_comments");
GLOBAL_STR(kOptionName_93, "lithist");
GLOBAL_STR(kOptionName_94, "localvar_inherit");
GLOBAL_STR(kOptionName_95, "localvar_unset");
GLOBAL_STR(kOptionName_96, "login_shell");
GLOBAL_STR(kOptionName_97, "mailwarn");
GLOBAL_STR(kOptionName_98, "no_empty_cmd_completion");
GLOBAL_STR(kOptionName_99, "nocaseglob");
GLOBAL_STR(kOptionName_100, "progcomp_alias");
GLOBAL_STR(kOptionName_101, "promptvars");
GLOBAL_STR(kOptionName_102, "restricted_shell");
GLOBAL_STR(kOptionName_103, "shift_verbose");
GLOBAL_STR(kOptionName_104, "sourcepath");
GLOBAL_STR(kOptionName_105, "xpg_echo");
...
GLOBAL_STR(kBUILTIN_NAMES_52, "json8");
...
GLOBAL_STR(kSHOPT_OPTION_NAMES_55, "parse_dollar");
GLOBAL_STR(kSHOPT_OPTION_NAMES_56, "parse_dparen");
GLOBAL_STR(kSHOPT_OPTION_NAMES_57, "parse_equals");
GLOBAL_STR(kSHOPT_OPTION_NAMES_58, "parse_func");
GLOBAL_STR(kSHOPT_OPTION_NAMES_59, "parse_ignored");
GLOBAL_STR(kSHOPT_OPTION_NAMES_60, "parse_paren");
GLOBAL_STR(kSHOPT_OPTION_NAMES_61, "parse_proc");
GLOBAL_STR(kSHOPT_OPTION_NAMES_62, "parse_sh_arith");
GLOBAL_STR(kSHOPT_OPTION_NAMES_63, "parse_triple_quote");
GLOBAL_STR(kSHOPT_OPTION_NAMES_64, "parse_ysh_string");

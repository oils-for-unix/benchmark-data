...
word_t, public re_t {
 public:
  ...
  static Token* CreateNull(bool alloc_lists = false) { 
    return Alloc<Token>(-1, -1, -1, -1, nullptr, nullptr);
  }
...
class NameTok : public word_part_t, public arith_expr_t, public y_lhs_t, public
expr_t {
 public:
  NameTok(Token* left, BigStr* var_name)
      : left(left),
        var_name(var_name) {
  }

  static NameTok* CreateNull(bool alloc_lists = false) { 
    return Alloc<NameTok>(nullptr, kEmptyString);
  }
  ...
  DISALLOW_COPY_AND_ASSIGN(NameTok)
};

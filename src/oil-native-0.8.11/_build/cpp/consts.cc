...
List<int>* OIL_BASIC = new List<int>({42, 40, 1, 41, 24, 2, 23, 34, 35, 36, 38, 37, 3, 43, 46, 39, 25, 26, 27, 28, 29, 33, 30, 32, 31, 45, 44});
List<int>* OIL_ALL = new List<int>({42, 40, 1, 41, 24, 2, 23, 53, 34, 48, 49, 50, 35, 51, 47, 52, 36, 38, 37, 3, 43, 46, 54, 55, 56, 39, 25, 26, 27, 28, 29, 33, 30, 32, 31, 45, 44});
List<int>* DEFAULT_TRUE = new List<int>({20, 40, 21, 41, 13, 49, 50, 51, 52, 19, 45});
List<int>* PARSE_OPTION_NUMS = new List<int>({41, 53, 34, 48, 49, 50, 35, 51, 17, 47, 52, 36, 57, 38, 37});
List<int>* SHOPT_OPTION_NUMS = new List<int>({22, 20, 63, 64, 65, 66, 67, 68, 69, 62, 42, 18, 70, 40, 71, 72, 73, 21, 16, 74, 41, 75, 15, 76, 14, 77, 78, 79, 80, 60, 81, 82, 61, 83, 24, 84, 58, 85, 86, 87, 88, 89, 90, 91, 92, 23, 53, 34, 48, 49, 50, 35, 51, 17, 47, 52, 36, 57, 38, 37, 43, 59, 93, 94, 95, 96, 46, 54, 55, 56, 39, 97, 25, 26, 27, 28, 29, 33, 30, 32, 31, 19, 98, 45, 44});
List<int>* SET_OPTION_NUMS = new List<int>({11, 1, 13, 8, 4, 7, 2, 3, 9, 6, 10, 5});
List<int>* VISIBLE_SHOPT_NUMS = new List<int>({22, 20, 42, 18, 40, 21, 16, 41, 15, 14, 24, 23, 53, 34, 48, 49, 50, 35, 51, 17, 47, 52, 36, 57, 38, 37, 43, 46, 54, 55, 56, 39, 25, 26, 27, 28, 29, 33, 30, 32, 31, 19, 45, 44});
...
builtin_t LookupNormalBuiltin(Str* s) {
  ...
  case '[':
    ...
    break;
  case '_':
    if (len == 5 && memcmp("__cat", data, 5) == 0) return 61;
    break;
  case 'a':
  ...
  case 'p':
    ...
    if (len == 14 && memcmp("push-registers", data, 14) == 0) return 60;
    break;
  case 'r':

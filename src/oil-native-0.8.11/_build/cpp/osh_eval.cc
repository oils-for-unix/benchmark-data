...
GLOBAL_STR(str259, "setref requires a nameref (:out param)");
...
GLOBAL_STR(str277, "BASH_REMATCH");
GLOBAL_STR(str278, "FUNCNAME");
GLOBAL_STR(str279, "source");
GLOBAL_STR(str280, "BASH_SOURCE");
GLOBAL_STR(str281, "BASH_LINENO");
GLOBAL_STR(str282, "0");
GLOBAL_STR(str283, "LINENO");
GLOBAL_STR(str284, "BASHPID");
GLOBAL_STR(str285, "Can't unset readonly variable %r");
GLOBAL_STR(str286, "%r isn't an array");
GLOBAL_STR(str287, "$%s isn't defined");
GLOBAL_STR(str288, "$%s should be a string");
GLOBAL_STR(str289, "$%s should be a string, got %s");
GLOBAL_STR(str290, "$%s doesn't look like an integer, got %r");
GLOBAL_STR(str291, "EOF");
GLOBAL_STR(str292, "/");
GLOBAL_STR(str293, "~");
GLOBAL_STR(str294, "  ");
GLOBAL_STR(str295, "\n  ");
...
GLOBAL_STR(str300, "~");
GLOBAL_STR(str301, "\n");
GLOBAL_STR(str302, "[ interactive ]");
GLOBAL_STR(str303, "[ headless ]");
GLOBAL_STR(str304, "[ -c flag ]");
GLOBAL_STR(str305, "[ stdin%s ]");
GLOBAL_STR(str306, "[ expansion of alias %r ]");
GLOBAL_STR(str307, "[ backticks at ... ]");
GLOBAL_STR(str308, "[ array LValue in %s ]");
GLOBAL_STR(str309, "[ eval at line %d of %s ]");
GLOBAL_STR(str310, "[ trap ]");
GLOBAL_STR(str311, "[ variable ]");
GLOBAL_STR(str312, "%s:%d: %s%s\n");
GLOBAL_STR(str313, "[??? no location ???] %s%s\n");
GLOBAL_STR(str314, "");
GLOBAL_STR(str315, "");
GLOBAL_STR(str316, "");
GLOBAL_STR(str317, "none");
GLOBAL_STR(str318, "AST not printed.");
GLOBAL_STR(str319, "text");
GLOBAL_STR(str320, "abbrev-text");
GLOBAL_STR(str321, "html");
GLOBAL_STR(str322, "abbrev-html");
GLOBAL_STR(str323, "abbrev-");
GLOBAL_STR(str324, "\n");
GLOBAL_STR(str325, "\n");
GLOBAL_STR(str326, "-");
GLOBAL_STR(str327, "_");
GLOBAL_STR(str328, "<_Attributes %s>");
GLOBAL_STR(str329, "<args.Reader %r %d>");
GLOBAL_STR(str330, "expected argument to %r");
GLOBAL_STR(str331, "-");
GLOBAL_STR(str332, "expected integer after %s, got %r");
GLOBAL_STR(str333, "-");
GLOBAL_STR(str334, "got invalid integer for %s: %s");
GLOBAL_STR(str335, "-");
GLOBAL_STR(str336, "expected number after %r, got %r");
GLOBAL_STR(str337, "-");
GLOBAL_STR(str338, "got invalid float for %s: %s");
GLOBAL_STR(str339, "-");
GLOBAL_STR(str340, "got invalid argument %r to %r, expected one of: %s");
GLOBAL_STR(str341, "-");
GLOBAL_STR(str342, "|");
GLOBAL_STR(str343, "0");
GLOBAL_STR(str344, "F");
GLOBAL_STR(str345, "false");
GLOBAL_STR(str346, "False");
GLOBAL_STR(str347, "1");
GLOBAL_STR(str348, "T");
GLOBAL_STR(str349, "true");
GLOBAL_STR(str350, "Talse");
GLOBAL_STR(str351, "got invalid argument to boolean flag: %r");
GLOBAL_STR(str352, "-");
GLOBAL_STR(str353, "-");
GLOBAL_STR(str354, "got invalid option %r");
GLOBAL_STR(str355, "Expected argument for action");
GLOBAL_STR(str356, "Invalid action name %r");
GLOBAL_STR(str357, "--");
GLOBAL_STR(str358, "--");
GLOBAL_STR(str359, "got invalid flag %r");
GLOBAL_STR(str360, "-");
GLOBAL_STR(str361, "0");
GLOBAL_STR(str362, "Z");
GLOBAL_STR(str363, "-");
GLOBAL_STR(str364, "doesn't accept flag %s");
GLOBAL_STR(str365, "-");
GLOBAL_STR(str366, "+");
GLOBAL_STR(str367, "+");
GLOBAL_STR(str368, "doesn't accept option %s");
GLOBAL_STR(str369, "+");
GLOBAL_STR(str370, "-");
GLOBAL_STR(str371, "--");
GLOBAL_STR(str372, "--");
GLOBAL_STR(str373, "got invalid flag %r");
GLOBAL_STR(str374, "-");
GLOBAL_STR(str375, "+");
GLOBAL_STR(str376, "got invalid flag %r");
GLOBAL_STR(str377, "-");
GLOBAL_STR(str378, "^--?([a-zA-Z0-9][a-zA-Z0-9\\-]*)(=.*)?$");
GLOBAL_STR(str379, "<LineLexer at pos %d of line %r (id = %d)>");
GLOBAL_STR(str380, "");
GLOBAL_STR(str381, "");
GLOBAL_STR(str382, "");
GLOBAL_STR(str383, "");
GLOBAL_STR(str384, "<Trail %s %s %s %s>");
GLOBAL_STR(str385, "");
GLOBAL_STR(str386, "ShAssignment expression can't be nested like this");
GLOBAL_STR(str387, "Here docs aren't allowed in expressions");
GLOBAL_STR(str388, "\n");
GLOBAL_STR(str389, "");
GLOBAL_STR(str390, " (%s)");
GLOBAL_STR(str391, "Unexpected token in expression mode%s");
GLOBAL_STR(str392, "Syntax error in expression (near %s)");
GLOBAL_STR(str393, "alnum");
GLOBAL_STR(str394, "cntrl");
GLOBAL_STR(str395, "lower");
GLOBAL_STR(str396, "space");
GLOBAL_STR(str397, "alpha");
GLOBAL_STR(str398, "digit");
GLOBAL_STR(str399, "print");
GLOBAL_STR(str400, "upper");
GLOBAL_STR(str401, "blank");
GLOBAL_STR(str402, "graph");
GLOBAL_STR(str403, "punct");
GLOBAL_STR(str404, "xdigit");
GLOBAL_STR(str405, "Range start/end shouldn't have more than one character");
GLOBAL_STR(str406, "Write singleton tuples with tup(), not a trailing comma");
GLOBAL_STR(str407, "testlist_comp");
GLOBAL_STR(str408, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str409, "Can't assign to this expression");
GLOBAL_STR(str410, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str411, "TODO");
GLOBAL_STR(str412, "dot");
GLOBAL_STR(str413, "Can't negate this symbol");
GLOBAL_STR(str414, "%r isn't a character class");
GLOBAL_STR(str415, "Can't negate this symbol");
GLOBAL_STR(str416, "%r isn't a character class");
GLOBAL_STR(str417, "%start");
GLOBAL_STR(str418, "%end");
GLOBAL_STR(str419, "dot");
GLOBAL_STR(str420, "Unexpected token %r in regex");
GLOBAL_STR(str421, "%s-%s");
GLOBAL_STR(str422, "ERE can't express code point %d");
GLOBAL_STR(str423, "Perl classes can't be negated in ERE");
GLOBAL_STR(str424, "%s");
GLOBAL_STR(str425, "POSIX classes can't be negated in ERE");
GLOBAL_STR(str426, "[:%s:]");
GLOBAL_STR(str427, ".");
GLOBAL_STR(str428, "^");
GLOBAL_STR(str429, "$");
GLOBAL_STR(str430, "|");
GLOBAL_STR(str431, "POSIX EREs don't have groups without capture, so this node needs () around it.");
GLOBAL_STR(str432, "+");
GLOBAL_STR(str433, "*");
GLOBAL_STR(str434, "?");
GLOBAL_STR(str435, "{%s}");
...
GLOBAL_STR(str446, "^");
GLOBAL_STR(str447, "]");
GLOBAL_STR(str448, "The [ operator doesn't apply to this expression");
GLOBAL_STR(str449, "Expected ]]");
GLOBAL_STR(str450, "Unexpected trailing word %s");
GLOBAL_STR(str451, "Invalid argument to unary operator");
GLOBAL_STR(str452, "Expected ), got %s");
GLOBAL_STR(str453, "Unexpected token in boolean expression (%s)");
GLOBAL_STR(str454, "");
GLOBAL_STR(str455, "Expected %d, got %d");
GLOBAL_STR(str456, "Step can't be 0");
GLOBAL_STR(str457, "Invalid step %d for ascending integer range");
GLOBAL_STR(str458, "Invalid step %d for descending integer range");
GLOBAL_STR(str459, "Invalid step %d for ascending character range");
GLOBAL_STR(str460, "Invalid step %d for descending character range");
GLOBAL_STR(str461, "Mismatched cases in character range");
GLOBAL_STR(str462, "");
GLOBAL_STR(str463, "0");
GLOBAL_STR(str464, "0");
GLOBAL_STR(str465, "g");
...
GLOBAL_STR(str502, ")");
GLOBAL_STR(str503, "");
GLOBAL_STR(str504, "export_");
GLOBAL_STR(str505, "doesn't accept -f because it's dangerous.  (The code can usually be restructured with 'source')");
GLOBAL_STR(str506, "doesn't accept RHS with -n");
GLOBAL_STR(str507, "Got -a but RHS isn't an array");
GLOBAL_STR(str508, "Got -A but RHS isn't an associative array");
GLOBAL_STR(str509, "readonly");
GLOBAL_STR(str510, "new_var");
GLOBAL_STR(str511, "with -f expects function names");
GLOBAL_STR(str512, "declare -f %s");
GLOBAL_STR(str513, "-");
GLOBAL_STR(str514, "-");
GLOBAL_STR(str515, "-");
GLOBAL_STR(str516, "+");
GLOBAL_STR(str517, "+");
GLOBAL_STR(str518, "+");
GLOBAL_STR(str519, "Invalid unset expression");
GLOBAL_STR(str520, "expected a variable name.  shopt -s eval_unsafe_arith allows expressions");
GLOBAL_STR(str521, "unset");
GLOBAL_STR(str522, "Invalid shift argument %r");
GLOBAL_STR(str523, "got too many arguments");
GLOBAL_STR(str524, "eval");
GLOBAL_STR(str525, "requires code string");
GLOBAL_STR(str526, "requires exactly 1 argument");
GLOBAL_STR(str527, " ");
GLOBAL_STR(str528, "eval");
GLOBAL_STR(str529, "source");
GLOBAL_STR(str530, "missing required argument");
GLOBAL_STR(str531, "source %r failed: %s");
GLOBAL_STR(str532, "source");
GLOBAL_STR(str533, "command");
GLOBAL_STR(str534, "Can't run assignment builtin recursively");
GLOBAL_STR(str535, "%r isn't a shell builtin");
GLOBAL_STR(str536, "run");
GLOBAL_STR(str537, "'run' expected a command to run");
GLOBAL_STR(str538, "(original failure)");
GLOBAL_STR(str539, "");
GLOBAL_STR(str540, "fatal: status %d when --allow-status-01");
GLOBAL_STR(str541, ":");
GLOBAL_STR(str542, "function");
GLOBAL_STR(str543, "alias");
GLOBAL_STR(str544, "builtin");
GLOBAL_STR(str545, "builtin");
GLOBAL_STR(str546, "builtin");
GLOBAL_STR(str547, "keyword");
GLOBAL_STR(str548, "keyword");
GLOBAL_STR(str549, "file");
GLOBAL_STR(str550, "type");
GLOBAL_STR(str551, "type: %r not found");
GLOBAL_STR(str552, "file");
GLOBAL_STR(str553, "file");
GLOBAL_STR(str554, "%s is a %s");
GLOBAL_STR(str555, "function");
GLOBAL_STR(str556, "");
GLOBAL_STR(str557, "\n");
GLOBAL_STR(str558, "");
GLOBAL_STR(str559, "");
...
GLOBAL_STR(str563, "");
GLOBAL_STR(str564, "");
GLOBAL_STR(str565, "read");
GLOBAL_STR(str566, "_line");
GLOBAL_STR(str567, ":");
GLOBAL_STR(str568, "got extra argument");
GLOBAL_STR(str569, "--qsn can only be used with --line");
GLOBAL_STR(str570, "_all");
GLOBAL_STR(str571, ":");
GLOBAL_STR(str572, "got extra argument");
GLOBAL_STR(str573, "--qsn not implemented yet");
GLOBAL_STR(str574, "read -t isn't implemented (except t=0)");
GLOBAL_STR(str575, "");
GLOBAL_STR(str576, "REPLY");
GLOBAL_STR(str577, "REPLY");
GLOBAL_STR(str578, "\u0000");
GLOBAL_STR(str579, "\u0000");
GLOBAL_STR(str580, "\n");
GLOBAL_STR(str581, "");
GLOBAL_STR(str582, ":");
GLOBAL_STR(str583, "mapfile");
GLOBAL_STR(str584, "MAPFILE");
GLOBAL_STR(str585, ":");
GLOBAL_STR(str586, "\n");
GLOBAL_STR(str587, "cd");
GLOBAL_STR(str588, "HOME");
GLOBAL_STR(str589, "HOME");
GLOBAL_STR(str590, "-");
GLOBAL_STR(str591, "OLDPWD");
GLOBAL_STR(str592, "PWD");
GLOBAL_STR(str593, "cd %r: %s");
GLOBAL_STR(str594, "PWD");
GLOBAL_STR(str595, "OLDPWD");
GLOBAL_STR(str596, "%2d  %s");
GLOBAL_STR(str597, " ");
GLOBAL_STR(str598, "pushd: no other directory");
GLOBAL_STR(str599, "got too many arguments");
GLOBAL_STR(str600, "pushd: %r: %s");
GLOBAL_STR(str601, "HOME");
GLOBAL_STR(str602, "PWD");
GLOBAL_STR(str603, "popd: directory stack is empty");
GLOBAL_STR(str604, "popd: %r: %s");
GLOBAL_STR(str605, "PWD");
GLOBAL_STR(str606, "got extra argument");
GLOBAL_STR(str607, "HOME");
GLOBAL_STR(str608, "dirs");
GLOBAL_STR(str609, "HOME");
GLOBAL_STR(str610, "pwd");
GLOBAL_STR(str611, "_devbuild/help/groups.txt");
GLOBAL_STR(str612, "help");
GLOBAL_STR(str613, "help");
GLOBAL_STR(str614, "_devbuild/help/%s");
GLOBAL_STR(str615, "no help topics match %r");
GLOBAL_STR(str616, "# +");
GLOBAL_STR(str617, "osh printf doesn't support the %r flag");
GLOBAL_STR(str618, "eEfFgG");
GLOBAL_STR(str619, "osh printf doesn't support floating point");
GLOBAL_STR(str620, "c");
GLOBAL_STR(str621, "osh printf doesn't support single characters (bytes)");
GLOBAL_STR(str622, "Invalid printf format character");
GLOBAL_STR(str623, "Expected a printf format character");
GLOBAL_STR(str624, "%");
GLOBAL_STR(str625, "");
GLOBAL_STR(str626, "printf got invalid width %r");
GLOBAL_STR(str627, "0");
GLOBAL_STR(str628, "");
GLOBAL_STR(str629, "printf got invalid precision %r");
GLOBAL_STR(str630, "");
GLOBAL_STR(str631, "s");
GLOBAL_STR(str632, "q");
GLOBAL_STR(str633, "b");
GLOBAL_STR(str634, "");
GLOBAL_STR(str635, "diouxX");
GLOBAL_STR(str636, "'\"");
GLOBAL_STR(str637, "printf expected an integer, got %r");
GLOBAL_STR(str638, "TZ");
GLOBAL_STR(str639, "TZ");
GLOBAL_STR(str640, "ouxX");
GLOBAL_STR(str641, "Can't format negative number %d with %%%s");
GLOBAL_STR(str642, "o");
GLOBAL_STR(str643, "x");
GLOBAL_STR(str644, "X");
GLOBAL_STR(str645, "0");
...
GLOBAL_STR(str651, " ");
GLOBAL_STR(str652, " ");
GLOBAL_STR(str653, "printf");
GLOBAL_STR(str654, "requires a format string");
GLOBAL_STR(str655, "");
GLOBAL_STR(str656, "Invalid -v expression");
GLOBAL_STR(str657, "-v expected a variable name.  shopt -s eval_unsafe_arith allows expressions");
GLOBAL_STR(str658, "alias");
GLOBAL_STR(str659, "alias %s=%r");
GLOBAL_STR(str660, "=");
GLOBAL_STR(str661, "No alias named %r");
GLOBAL_STR(str662, "alias %s=%r");
GLOBAL_STR(str663, "unalias");
GLOBAL_STR(str664, "requires an argument");
GLOBAL_STR(str665, "No alias named %r");
GLOBAL_STR(str666, "%s=%s");
GLOBAL_STR(str667, "set");
GLOBAL_STR(str668, "shopt");
GLOBAL_STR(str669, "got invalid option %r");
GLOBAL_STR(str670, "hash");
GLOBAL_STR(str671, "got extra arguments after -r");
GLOBAL_STR(str672, "hash: %r not found");
GLOBAL_STR(str673, ":");
GLOBAL_STR(str674, "OPTIND");
GLOBAL_STR(str675, "OPTIND");
GLOBAL_STR(str676, "OPTARG");
GLOBAL_STR(str677, "OPTARG");
GLOBAL_STR(str678, "");
GLOBAL_STR(str679, "?");
GLOBAL_STR(str680, "-");
GLOBAL_STR(str681, "-");
GLOBAL_STR(str682, "?");
GLOBAL_STR(str683, "?");
GLOBAL_STR(str684, "getopts: option %r requires an argument.");
GLOBAL_STR(str685, "(getopts argv: %s)");
GLOBAL_STR(str686, " ");
GLOBAL_STR(str687, "?");
GLOBAL_STR(str688, "");
GLOBAL_STR(str689, "requires an argspec");
GLOBAL_STR(str690, "requires the name of a variable to set");
GLOBAL_STR(str691, "got invalid variable name %r");
GLOBAL_STR(str692, "echo");
GLOBAL_STR(str693, "");
GLOBAL_STR(str694, "takes at most one arg when simple_echo is on (hint: add quotes)");
GLOBAL_STR(str695, " ");
GLOBAL_STR(str696, "\n");
GLOBAL_STR(str697, "Assignment builtin %r not configured");
GLOBAL_STR(str698, "%r ");
GLOBAL_STR(str699, "");
GLOBAL_STR(str700, "command in ");
GLOBAL_STR(str701, "assignment in ");
GLOBAL_STR(str702, "subshell invoked from ");
GLOBAL_STR(str703, "pipeline invoked from ");
GLOBAL_STR(str704, "");
GLOBAL_STR(str705, "Exiting with status %d (%sPID %d)");
GLOBAL_STR(str706, "Redirect filename can't be empty");
GLOBAL_STR(str707, "Redirect descriptor can't be empty");
GLOBAL_STR(str708, "-");
GLOBAL_STR(str709, "-");
GLOBAL_STR(str710, "Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
GLOBAL_STR(str711, "\n");
GLOBAL_STR(str712, "Unknown redirect op");
GLOBAL_STR(str713, "Unknown redirect type");
GLOBAL_STR(str714, "strict_errexit only allows simple commands (got %s). Hint: use 'run'.");
GLOBAL_STR(str715, "strict_errexit only allows a single command.  Hint: use \"run\".");
GLOBAL_STR(str716, "strict_errexit only allows simple commands (got %s). Hint: use 'run'.");
GLOBAL_STR(str717, "ShAssignment builtins don't accept blocks");
GLOBAL_STR(str718, "|& isn't supported");
GLOBAL_STR(str719, "Can't append array to string");
GLOBAL_STR(str720, "Can't append string to array");
GLOBAL_STR(str721, "%r expected a number, got %r");
GLOBAL_STR(str722, "Invalid control flow at top level");
GLOBAL_STR(str723, "warning: ");
GLOBAL_STR(str724, "trap");
GLOBAL_STR(str725, "Loop and control flow can't be in different processes");
GLOBAL_STR(str726, "fatal: ");
GLOBAL_STR(str727, "EXIT");
GLOBAL_STR(str728, "trap EXIT");
GLOBAL_STR(str729, "__");
GLOBAL_STR(str730, ":");
GLOBAL_STR(str731, "Invalid argument %r.  Expected a name starting with :");
GLOBAL_STR(str732, "No value provided for param %r");
GLOBAL_STR(str733, "proc %r expected %d arguments, but got %d");
GLOBAL_STR(str734, "Unexpected %r (in function call)");
GLOBAL_STR(str735, "Attempted to exit from completion hook.");
GLOBAL_STR(str736, "Couldn't find terminator for here doc that starts here");
GLOBAL_STR(str737, "\t");
GLOBAL_STR(str738, "Invalid here doc delimiter");
GLOBAL_STR(str739, "+");
GLOBAL_STR(str740, "+");
GLOBAL_STR(str741, "+");
GLOBAL_STR(str742, "%d != %d");
GLOBAL_STR(str743, "Environment binding shouldn't look like an array assignment");
GLOBAL_STR(str744, "+");
GLOBAL_STR(str745, "Expected = in environment binding, got +=");
GLOBAL_STR(str746, "Environment bindings can't contain array literals");
GLOBAL_STR(str747, "procs should defined be at the top level");
GLOBAL_STR(str748, "%r was already declared");
GLOBAL_STR(str749, "%r hasn't been declared");
GLOBAL_STR(str750, "Can't modify constant %r");
GLOBAL_STR(str751, "Expected word type %s, got %s");
GLOBAL_STR(str752, "{");
GLOBAL_STR(str753, "}");
GLOBAL_STR(str754, "Invalid token after redirect operator");
GLOBAL_STR(str755, "TODO: Parse Redirect");
GLOBAL_STR(str756, " ");
GLOBAL_STR(str757, " ");
GLOBAL_STR(str758, "line IDs %d != %d");
GLOBAL_STR(str759, " ");
GLOBAL_STR(str760, "");
GLOBAL_STR(str761, "Unexpected block");
GLOBAL_STR(str762, "=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
GLOBAL_STR(str763, "name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
GLOBAL_STR(str764, "Unexpected block");
GLOBAL_STR(str765, "Unexpected block");
GLOBAL_STR(str766, "Control flow shouldn't have redirects");
GLOBAL_STR(str767, "Control flow shouldn't have environment bindings");
GLOBAL_STR(str768, "Unexpected argument to %r");
GLOBAL_STR(str769, "Invalid word in for loop");
GLOBAL_STR(str770, "Invalid word after for expression");
GLOBAL_STR(str771, "Loop variable name should be a constant");
GLOBAL_STR(str772, "Invalid loop variable name");
GLOBAL_STR(str773, "Unexpected word after for loop variable");
GLOBAL_STR(str774, "Expected ;; or esac");
GLOBAL_STR(str775, "Unexpected word while parsing compound command");
GLOBAL_STR(str776, "Invalid function name");
GLOBAL_STR(str777, "Expected ) in function definition");
GLOBAL_STR(str778, "Invalid KSH-style function name");
GLOBAL_STR(str779, "Unexpected word when parsing command");
GLOBAL_STR(str780, "Unexpected right brace");
GLOBAL_STR(str781, "Unexpected EOF while parsing command");
GLOBAL_STR(str782, "Invalid word while parsing command");
GLOBAL_STR(str783, "Unexpected word while parsing command line");
GLOBAL_STR(str784, "Unterminated here doc began here");
GLOBAL_STR(str785, "\\");
GLOBAL_STR(str786, "*");
GLOBAL_STR(str787, "?");
GLOBAL_STR(str788, "[");
...
GLOBAL_STR(str792, "\\?*+{}^$.()|");
GLOBAL_STR(str793, "\\");
GLOBAL_STR(str794, "Unexpected escaped character %r");
GLOBAL_STR(str795, "");
GLOBAL_STR(str796, "");
GLOBAL_STR(str797, "Malformed character class; treating as literal");
GLOBAL_STR(str798, "Got unescaped right bracket");
GLOBAL_STR(str799, "Got unescaped trailing backslash");
GLOBAL_STR(str800, ".|^$()+*?[]{}\\");
GLOBAL_STR(str801, "\\");
GLOBAL_STR(str802, "\\");
GLOBAL_STR(str803, "\\[");
...
GLOBAL_STR(str815, "]");
GLOBAL_STR(str816, "");
GLOBAL_STR(str817, "Error expanding glob %r: %s");
GLOBAL_STR(str818, "-");
GLOBAL_STR(str819, "<Error: unbalanced \\[ and \\]> ");
GLOBAL_STR(str820, "$");
GLOBAL_STR(str821, "#");
GLOBAL_STR(str822, "$");
GLOBAL_STR(str823, "hostname");
GLOBAL_STR(str824, "user");
GLOBAL_STR(str825, "$ ");
GLOBAL_STR(str826, "\u0001");
GLOBAL_STR(str827, "\u0002");
GLOBAL_STR(str828, "$");
GLOBAL_STR(str829, "$");
GLOBAL_STR(str830, "u");
GLOBAL_STR(str831, "user");
GLOBAL_STR(str832, "h");
GLOBAL_STR(str833, "hostname");
GLOBAL_STR(str834, ".");
GLOBAL_STR(str835, "H");
GLOBAL_STR(str836, "hostname");
GLOBAL_STR(str837, "w");
GLOBAL_STR(str838, "PWD");
GLOBAL_STR(str839, "HOME");
GLOBAL_STR(str840, "<Error: %s>");
GLOBAL_STR(str841, "W");
GLOBAL_STR(str842, "PWD");
GLOBAL_STR(str843, "<Error: PWD is not a string> ");
GLOBAL_STR(str844, "<Error: \\%s not implemented in $PS1> ");
GLOBAL_STR(str845, "$");
GLOBAL_STR(str846, "\\$");
GLOBAL_STR(str847, "Invalid token %r");
GLOBAL_STR(str848, "");
GLOBAL_STR(str849, "<ERROR: Can't parse PS1: %s>");
GLOBAL_STR(str850, "osh");
GLOBAL_STR(str851, "PS1");
GLOBAL_STR(str852, "PROMPT_COMMAND");
GLOBAL_STR(str853, "Undefined variable %r");
GLOBAL_STR(str854, "Can't use [] on value of type %s");
GLOBAL_STR(str855, "");
GLOBAL_STR(str856, "Can't use [] on value of type %s");
GLOBAL_STR(str857, "");
GLOBAL_STR(str858, "0x");
GLOBAL_STR(str859, "Invalid hex constant %r");
GLOBAL_STR(str860, "0");
GLOBAL_STR(str861, "Invalid octal constant %r");
GLOBAL_STR(str862, "#");
GLOBAL_STR(str863, "#");
GLOBAL_STR(str864, "Invalid base for numeric constant %r");
GLOBAL_STR(str865, "a");
GLOBAL_STR(str866, "A");
GLOBAL_STR(str867, "@");
GLOBAL_STR(str868, "_");
GLOBAL_STR(str869, "Invalid digits for numeric constant %r");
GLOBAL_STR(str870, "Digits %r out of range for base %d");
GLOBAL_STR(str871, "Parse error in recursive arithmetic");
GLOBAL_STR(str872, "Invalid integer constant %r");
GLOBAL_STR(str873, "Invalid integer constant %r");
GLOBAL_STR(str874, "Invalid integer constant %r");
GLOBAL_STR(str875, "Undefined value in arithmetic context");
GLOBAL_STR(str876, "Expected a value convertible to integer, got %s");
GLOBAL_STR(str877, "0");
GLOBAL_STR(str878, "Divide by zero");
GLOBAL_STR(str879, "Divide by zero");
GLOBAL_STR(str880, "Expected array or assoc in index expression, got %s");
GLOBAL_STR(str881, "Divide by zero");
GLOBAL_STR(str882, "Divide by zero");
GLOBAL_STR(str883, "Exponent can't be less than zero");
GLOBAL_STR(str884, "Associative array keys must be strings: $x 'x' \"$x\" etc.");
GLOBAL_STR(str885, "Invalid place to modify");
...
inline Str* fmt76(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt77(Str* a0, int a1, Str* a2, Str* a3) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const(":", 1);
  gBuf.format_d(a1);
...
inline Str* fmt101(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.write_const("{", 1);
  gBuf.format_s(a0);
  gBuf.write_const(",", 1);
...
inline Str* fmt112(int a0, int a1) {
  gBuf.reset();
...
inline Str* fmt134(int a0, Str* a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const("  ", 2);
  gBuf.format_s(a1);
...
inline Str* fmt148(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt163(int a0, Str* a1, int a2) {
  gBuf.reset();
...
inline Str* fmt173(Str* a0, int a1, int a2) {
  gBuf.reset();
...
inline Str* fmt177(int a0, int a1) {
  gBuf.reset();
  gBuf.format_d(a0);
  gBuf.write_const(" != ", 4);
  gBuf.format_d(a1);
...
inline Str* fmt181() {
  gBuf.reset();
  gBuf.write_const("procs should defined be at the top level", 40);
  return gBuf.getvalue();
}
...
inline Str* fmt188(int a0, int a1) {
  gBuf.reset();
...
inline Str* fmt212(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt223(Str* a0, int a1) {
  gBuf.reset();
...
inline Str* fmt235(Str* a0, Str* a1, syntax_asdl::word_t* a2) {
  gBuf.reset();
...
inline Str* fmt241(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt245(Str* a0, Str* a1) {
  gBuf.reset();
...
Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> Mem::_ResolveNameOrRef(Str* name, runtime_asdl::scope_t which_scopes, bool ref_required) {
  ...
  which_scopes = ref_required ? scope_e::Parent : scope_e::Dynamic;
...
void Mem::_DisallowNamerefCycle(Str* name, runtime_asdl::scope_t which_scopes, List<Str*>* ref_trail) {
  ...
  if (list_contains(ref_trail, new_name)) {
    e_die(fmt61(str263->join(ref_trail)));
  }
...
void Mem::SetValue(runtime_asdl::lvalue_t* lval, runtime_asdl::value_t* val, runtime_asdl::scope_t which_scopes, int flags) {
  ...
  switch (lval->tag_()) {
    ...
    case lvalue_e::Indexed: {
      ...
      e_die(fmt65(ui::ValType(cell->val)), left_spid);
    }
      break;
    case lvalue_e::Keyed: {
      lvalue__Keyed* lval = static_cast<lvalue__Keyed*>(UP_lval);
...
bool Mem::Unset(runtime_asdl::lvalue_t* lval, bool strict) {
  ...
  Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> tup10 = this->_ResolveNameOrRef(var_name, this->ScopesForWriting());
  cell = tup10.at0();
  name_map = tup10.at1();
  cell_name = tup10.at2();
  if (!cell) {
  ...
  if (cell->readonly) {
    throw Alloc<error::Runtime>(fmt67(var_name));
  }
  switch (lval->tag_()) {
    case lvalue_e::Named: {
...
Str* GetString(state::Mem* mem, Str* name) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      throw Alloc<error::Runtime>(fmt69(name));
    }
      break;
    case value_e::Str: {
...
int GetInteger(state::Mem* mem, Str* name) {
  ...
  val = mem->GetValue(name);
  if (val->tag_() != value_e::Str) {
    throw Alloc<error::Runtime>(fmt71(name, ui::ValType(val)));
  }
  ...
  try {
    ...
    throw Alloc<error::Runtime>(fmt72(name, s));
  }
  return i;
}
...
Str* PrettyDir(Str* dir_name, Str* home_dir) {
  ...
  if (home_dir != nullptr) {
    if ((str_equals(dir_name, home_dir) or dir_name->startswith(str_concat(home_dir, str292)))) {
      return str_concat(str293, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    StackRoots _for({&c  });
    f->write(str_equals(c, str296) ? str297 : str298);
  }
  f->write(str299);
  f->write(str_repeat(str300, (length - 1)));
  f->write(str301);
}
...
void _PrintWithSpanId(Str* prefix, Str* msg, int span_id, alloc::Arena* arena, mylib::Writer* f) {
  ...
  switch (src->tag_()) {
    ...
    case source_e::EvalArg: {
      ...
      source_str = fmt76(line_num, outer_source);
    }
      break;
    case source_e::Trap: {
      source_str = str310;
  ...
  f->write(fmt77(source_str, line_num, prefix, msg));
}
...
void PrettyPrintError(error::_ErrorWithLocation* err, alloc::Arena* arena) {
  PrettyPrintError(err, arena, str314);
}
...
void ErrorFormatter::Print_(Str* msg, int span_id) {
  ...
  _PrintWithOptionalSpanId(str315, msg, span_id, this->arena);
}
...
void PrintAst(syntax_asdl::command_t* node, arg_types::main* flag) {
  ...
  if (maybe_str_equals(flag->ast_format, str317)) {
    println_stderr(str318);
  }
  else {
    f = mylib::Stdout();
    ...
    if ((maybe_str_equals(afmt, str319) || maybe_str_equals(afmt, str320))) {
      ...
      if ((maybe_str_equals(afmt, str321) || maybe_str_equals(afmt, str322))) {
...
void _Attributes::Set(Str* name, runtime_asdl::value_t* val) {
  ...
  name = name->replace(str326, str327);
...
bool SetAttachedBool::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  if (attached_arg != nullptr) {
    if ((str_equals(attached_arg, str343) || str_equals(attached_arg, str344) || str_equals(attached_arg, str345) || str_equals(attached_arg, str346))) {
      b = false;
    }
    else {
      if ((str_equals(attached_arg, str347) || str_equals(attached_arg, str348) || str_equals(attached_arg, str349) || str_equals(attached_arg, str350))) {
        b = true;
      }
      else {
        e_usage(fmt79(attached_arg));
      }
    }
  }
  else {
...
bool SetOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str352);
...
bool SetNamedOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str353);
  arg_r->Next();
  arg = arg_r->Peek();
  if (arg == nullptr) {
...
args::_Attributes* Parse(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str357)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if ((len(spec->actions_long) and arg->startswith(str358))) {
      ...
      if ((arg->startswith(str360) and len(arg) > 1)) {
        n = len(arg);
        for (int i = 1; i < n; ++i) {
          ch = arg->index(i);
          if (str_equals(ch, str361)) {
            ch = str362;
          }
          if (list_contains(spec->plus_flags, ch)) {
            out->Set(ch, Alloc<value::Str>(str363));
            continue;
          }
        ...
        if ((len(spec->plus_flags) and (arg->startswith(str366) and len(arg) > 1))) {
          n = len(arg);
          for (int i = 1; i < n; ++i) {
            ch = arg->index(i);
            if (list_contains(spec->plus_flags, ch)) {
              out->Set(ch, Alloc<value::Str>(str367));
              continue;
            }
            e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
          }
...
args::_Attributes* ParseLikeEcho(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    chars = arg->slice(1);
    if ((arg->startswith(str370) and len(chars))) {
      done = false;
...
args::_Attributes* ParseMore(flag_spec::_FlagSpecAndMore* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str371)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if (arg->startswith(str372)) {
      action = spec->actions_long->get(arg->slice(2));
      if (action == nullptr) {
        e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
      }
    ...
    if (((arg->startswith(str374) or arg->startswith(str375)) and len(arg) > 1)) {
      char0 = arg->index(0);
...
int LineLexer::GetSpanIdForEof() {
  int line_id;
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str380, 0);
  }
  else {
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str382, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = Alloc<Token>(id_, span_id, str383);
      return t;
    }
...
lexer::Lexer* ParseContext::_MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = Alloc<lexer::LineLexer>(str385, this->arena);
...
int _Classify(grammar::Grammar* gr, syntax_asdl::Token* tok) {
  ...
  type_str = tok->id == Id::Unknown_Tok ? str389 : fmt83(ui::PrettyId(tok->id));
  p_die(fmt84(type_str), tok);
}
...
Tuple2<pnode::PNode*, syntax_asdl::Token*> ExprParser::Parse(lexer::Lexer* lexer, int start_symbol) {
  ...
  try {
    ...
    p_die(fmt85(ui::PrettyId(e->tok->id)), e->tok);
  }
...
GLOBAL_LIST(Str*, 12, POSIX_CLASSES, {str393 COMMA str394 COMMA str395 COMMA str396 COMMA str397 COMMA str398 COMMA str399 COMMA str400 COMMA str401 COMMA str402 COMMA str403 COMMA str404});
Str* RANGE_POINT_TOO_LONG = str405;
int NT_OFFSET = 256;
...
syntax_asdl::expr_t* Transformer::_Tuple(List<pnode::PNode*>* children) {
  ...
  if (n == 2) {
    p_die(fmt86(), children->index(1)->tok);
  }
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw Alloc<NotImplementedError>(str407);
  }
  if (id0 == Id::Op_LBracket) {
    elts = Alloc<List<syntax_asdl::expr_t*>>();
    for (int i = 0; i < n; i += 2) {
  ...
  for (int i = 0; i < n; i += 2) {
    ...
    if (tag == expr_e::Var) {
      ...
      if ((tag == place_expr_e::Var || tag == place_expr_e::Subscript || tag == place_expr_e::Attribute)) {
        ...
        p_die(fmt87(), p->tok ? p->tok : nullptr);
      }
    }
  }
  return places;
...
syntax_asdl::re_t* Transformer::_NameInRegex(syntax_asdl::Token* negated_tok, syntax_asdl::Token* tok) {
  ...
  val = tok->val;
  if (maybe_str_equals(val, str412)) {
    if (negated_tok) {
      p_die(fmt88(), tok);
    }
    return tok;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((str_equals(tok->val, str417) || str_equals(tok->val, str418) || str_equals(tok->val, str419))) {
        return tok;
      }
      p_die(fmt92(tok->val), tok);
    }
...
void _ClassLiteralToPosixEre(syntax_asdl::class_literal_term_t* term, List<Str*>* parts) {
  ...
  if (tag == class_literal_term_e::CodePoint) {
    ...
    if (code_point < 128) {
      ...
      e_die(fmt94(code_point), term->spid);
    }
    return ;
  }
  if (tag == class_literal_term_e::PerlClass) {
    ...
    if (term->negated) {
      e_die(fmt95(), term->negated->span_id);
    }
    else {
      pat = fmt96(chars);
    }
  ...
  if (tag == class_literal_term_e::PosixClass) {
    ...
    n = term->name;
    if (term->negated) {
      e_die(fmt97(), term->negated->span_id);
    }
    else {
      pat = fmt98(n);
    }
...
void AsPosixEre(syntax_asdl::re_t* node, List<Str*>* parts) {
  ...
  if (tag == re_e::Repeat) {
    ...
    if (op_tag == re_repeat_e::Num) {
      ...
      parts->append(fmt100(op->times->val));
      return ;
    }
    if (op_tag == re_repeat_e::Range) {
      re_repeat__Range* op = static_cast<re_repeat__Range*>(UP_op);
      lower = op->lower ? op->lower->val : str436;
      upper = op->upper ? op->upper->val : str437;
      parts->append(fmt101(lower, upper));
      return ;
    }
...
syntax_asdl::bool_expr_t* BoolParser::ParseForBuiltin() {
  ...
  if (this->bool_id != Id::Eof_Real) {
    p_die(fmt108(word_::Pretty(this->cur_word)), this->cur_word);
  }
  return node;
}
...
syntax_asdl::bool_expr_t* BoolParser::ParseFactor() {
  ...
  if (this->bool_id == Id::Op_LParen) {
    ...
    if (this->bool_id != Id::Op_RParen) {
      p_die(fmt110(word_::Pretty(this->cur_word)), this->cur_word);
    }
    this->_Next();
    return node;
  }
  p_die(fmt111(ui::PrettyId(this->bool_id)), this->cur_word);
}
...
Str* _RangeParser::_Eat(int token_type) {
  ...
  if (this->token_type != token_type) {
    throw Alloc<_NotARange>(fmt112(token_type, this->token_type));
  }
  val = this->token_val;
  this->_Next();
  return val;
...
syntax_asdl::word_part__BracedRange* _RangeParser::Parse() {
  ...
  if (this->token_type == Id::Range_Int) {
    ...
    if (this->token_type == Id::Range_Char) {
      ...
      if (upper1 != upper2) {
        p_die(fmt118(), this->span_id);
      }
    }
    else {
      throw Alloc<_NotARange>(str462);
    }
  }
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  flag = attrs->attrs;
  tmp_g = flag->get(str465);
  tmp_a = flag->get(str466);
  tmp_A = flag->get(str467);
  ...
  flag_A = (tmp_A and tmp_A->tag_() == value_e::Bool) ? static_cast<value__Bool*>(tmp_A)->b : false;
  tmp_n = flag->get(str468);
  tmp_r = flag->get(str469);
  tmp_x = flag->get(str470);
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if ((maybe_str_equals(flag_n, str472) and !cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_n, str473) and cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str474) and !cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str475) and cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str476) and !cell->exported)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str477) and cell->exported)) {
      continue;
    }
    ...
    if (print_flags) {
      ...
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str484, str485->join(flags), str486, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str487, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (has_holes) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str490, name, str491, str(i), str492, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str494, str495->join(body), str496}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str498, key_quoted, str499, value_quoted}));
          }
          if (len(body) > 0) {
            decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str500, str501->join(body), str502}));
          }
        }
        else {
          ;  // pass
...
int Export::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r->Next();
  attrs = flag_spec::Parse(str504, arg_r);
...
int Readonly::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str509, arg_r);
...
int NewVar::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  attrs = flag_spec::Parse(str510, arg_r);
  ...
  flags = 0;
  if (maybe_str_equals(arg->x, str513)) {
    flags |= state::SetExport;
  }
  if (maybe_str_equals(arg->r, str514)) {
    flags |= state::SetReadOnly;
  }
  if (maybe_str_equals(arg->n, str515)) {
    flags |= state::SetNameref;
  }
  flags_to_clear = 0;
  if (maybe_str_equals(arg->x, str516)) {
    flags |= state::ClearExport;
  }
  if (maybe_str_equals(arg->r, str517)) {
    flags |= state::ClearReadOnly;
  }
  if (maybe_str_equals(arg->n, str518)) {
...
int Unset::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str521, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
...
int Eval::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str524, cmd_val);
  arg_r = tup0.at1();
  if (this->exec_opts->simple_eval_builtin()) {
    Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str525);
    code_str = tup1.at0();
    eval_spid = tup1.at1();
    if (!arg_r->AtEnd()) {
      e_usage(str526);
    ...
    code_str = str527->join(arg_r->Rest());
  ...
  {  // with
    dev::ctx_Tracer ctx(this->tracer, str528, nullptr);
...
int Source::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str529, cmd_val);
  arg_r = tup2.at1();
  path = arg_r->Peek();
  if (path == nullptr) {
    e_usage(str530);
  ...
  try {
    ...
    this->errfmt->Print_(fmt127(path, pyutil::strerror(e)), cmd_val->arg_spids->index(1));
    return 1;
  }
  try {
    try {
      ...
      c_parser = this->parse_ctx->MakeOshParser(line_reader);
      {  // with
        dev::ctx_Tracer ctx(this->tracer, str532, cmd_val->argv);
...
int Command::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup3 = flag_spec::ParseCmdVal(str533, cmd_val);
  attrs = tup3.at0();
  arg_r = tup3.at1();
...
int Builtin::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (to_run == consts::NO_INDEX) {
    ...
    if (consts::LookupAssignBuiltin(name) != consts::NO_INDEX) {
      this->errfmt->Print_(str534, span_id);
    }
    else {
      this->errfmt->Print_(fmt128(name), span_id);
    }
    return 1;
  }
...
int Run_::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseOilCmdVal(str536, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
  ...
  if ((arg->allow_status_01 and (status != 0 && status != 1))) {
    if (failure_spid != runtime::NO_SPID) {
      this->errfmt->Print_(str538, failure_spid);
      this->errfmt->StderrLine(str539);
    }
    throw Alloc<error::ErrExit>(fmt130(status), spids->index(0), status);
  }
  if (arg->assign_status != nullptr) {
    var_name = arg->assign_status;
    if (var_name->startswith(str541)) {
            ...
            if (consts::LookupAssignBuiltin(name) != 0) {
              ...
              if (consts::IsControlFlow(name)) {
                ...
                if (consts::IsKeyword(name)) {
                  kind = (Alloc<Tuple2<Str*, Str*>>(str548, name));
                }
                else {
                  ...
                  if (resolved == nullptr) {
                    ...
                    kind = (Alloc<Tuple2<Str*, Str*>>(str549, resolved));
                  }
                }
              }
            }
...
int Type::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup7 = flag_spec::ParseCmdVal(str550, cmd_val);
  attrs = tup7.at0();
  arg_r = tup7.at1();
  ...
  for (ListIter<Tuple2<Str*, Str*>*> it(r); !it.Done(); it.Next()) {
    ...
    name = tup8->at1();
    if (kind == nullptr) {
      this->errfmt->StderrLine(fmt131(name));
      status = 1;
    }
    else {
      if (arg->t) {
        ...
        if (arg->p) {
          ...
          if (arg->P) {
            ...
            print(fmt132(name, kind));
            if (str_equals(kind, str555)) {
              ;  // pass
            }
          }
        }
...
Tuple2<Str*, bool> _ReadUntilDelim(Str* delim_char) {
  ...
  return (Tuple2<Str*, bool>(str556->join(chars), eof));
}
...
Str* _ReadLine() {
  ...
  while (true) {
    ...
    chars->append(c);
    if (str_equals(c, str557)) {
      break;
    }
  }
  return str558->join(chars);
}
...
int Read::_Line(arg_types::read* arg, Str* var_name) {
  ...
  if (!arg->with_eol) {
    if (line->endswith(str560)) {
      ...
      if (line->endswith(str561)) {
        line = line->slice(0, -1);
      }
    }
  }
  if ((arg->q and line->startswith(str562))) {
    arena = this->parse_ctx->arena;
    line_reader = reader::StringLineReader(line, arena);
    lexer = this->parse_ctx->_MakeLexer(line_reader);
    try {
      {  // with
        alloc::ctx_Location ctx(arena, Alloc<source::Stdin>(str563));
...
int Read::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (arg->line) {
    ...
    next_spid = tup4.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str568, next_spid);
    }
  ...
  if (arg->all) {
    ...
    next_spid = tup6.at1();
    if (next_arg != nullptr) {
      throw Alloc<error::Usage>(str572, next_spid);
    }
...
int MapFile::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseCmdVal(str583, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  while (true) {
    ...
    if ((arg->t and line->endswith(str586))) {
      line = line->slice(0, -1);
    }
    lines->append(line);
  }
...
int Cd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseCmdVal(str587, cmd_val);
  attrs = tup11.at0();
  arg_r = tup11.at1();
  ...
  if (str_equals(dest_dir, str590)) {
    try {
      dest_dir = state::GetString(this->mem, str591);
      print(dest_dir);
    }
    catch (error::Runtime* e) {
      this->errfmt->Print_(e->UserErrorString());
  ...
  try {
    pwd = state::GetString(this->mem, str592);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    return 1;
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt133(real_dest_dir, posix::strerror(err_num)), arg_spid);
    return 1;
  }
  state::ExportGlobalString(this->mem, str594, real_dest_dir);
  ...
  if (cmd_val->block) {
    ...
    state::ExportGlobalString(this->mem, str595, pwd);
...
void _PrintDirStack(state::DirStack* dir_stack, int style, Str* home_dir) {
  ...
  if (style == WITH_LINE_NUMBERS) {
    ...
    for (ListIter<Str*> it(dir_stack->Iter()); !it.Done(); it.Next(), ++i) {
      ...
      print(fmt134(i, ui::PrettyDir(entry, home_dir)));
    }
  }
  else {
...
int Pushd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (err_num != 0) {
    this->errfmt->Print_(fmt135(dest_dir, posix::strerror(err_num)), cmd_val->arg_spids->index(1));
    return 1;
  }
  this->dir_stack->Push(dest_dir);
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str601));
  state::ExportGlobalString(this->mem, str602, dest_dir);
...
bool _PopDirStack(state::Mem* mem, state::DirStack* dir_stack, ui::ErrorFormatter* errfmt) {
  ...
  if (dest_dir == nullptr) {
    errfmt->Print_(str603);
    return false;
  }
  err_num = pyos::Chdir(dest_dir);
  if (err_num != 0) {
    errfmt->Print_(fmt136(dest_dir, posix::strerror(err_num)));
    return false;
  }
  state::SetGlobalString(mem, str605, dest_dir);
  mem->SetPwd(dest_dir);
  return true;
}
...
int Popd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->arg_spids) > 1) {
    e_usage(fmt137(), cmd_val->arg_spids->index(1));
  }
  if (!_PopDirStack(this->mem, this->dir_stack, this->errfmt)) {
    return 1;
  }
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str607));
  return 0;
}
...
int Dirs::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  home_dir = state::MaybeString(this->mem, str609);
  style = SINGLE_LINE;
  if (arg->l) {
    home_dir = nullptr;
  }
...
int Pwd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup14 = flag_spec::ParseCmdVal(str610, cmd_val);
  attrs = tup14.at0();
  arg_r = tup14.at1();
...
List<Str*>* Help::_Groups() {
  ...
  contents = this->loader->Get(str611);
...
int Help::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str612, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  ...
  try {
    contents = this->loader->Get(fmt138(topic));
  }
  catch (IOError*) {
    this->errfmt->Print_(fmt139(topic), blame_spid);
    return 1;
  }
  print(contents);
  return 0;
...
syntax_asdl::printf_part_t* _FormatStringParser::_ParseFormatStr() {
  ...
  while ((this->token_type == Id::Format_Flag || this->token_type == Id::Format_Zero)) {
    ...
    if (str_contains(str616, flag)) {
      p_die(fmt140(flag), this->cur_token);
    }
  ...
  if ((this->token_type == Id::Format_Type || this->token_type == Id::Format_Time)) {
    ...
    if (str_contains(str618, part->type->val)) {
      p_die(fmt141(), part->type);
    }
    if (maybe_str_equals(part->type->val, str620)) {
      p_die(fmt142(), part->type);
    }
  }
  else {
    if (this->token_type == Id::Unknown_Tok) {
      p_die(fmt143(), this->cur_token);
    }
    else {
        ...
        if (part->tag_() == printf_part_e::Percent) {
          ...
          if (part->width) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt145(width_str), width_spid);
              return 1;
            }
          }
          precision = -1;
          if (part->precision) {
            ...
            try {
              ...
              this->errfmt->Print_(fmt146(precision_str), precision_spid);
              return 1;
            }
          }
          if (arg_index < num_args) {
          ...
          if (str_equals(typ, str631)) {
            ...
            if (str_equals(typ, str632)) {
              ...
              if (str_equals(typ, str633)) {
                ...
                s = str634->join(c_parts);
              }
              else {
                if ((part->type->id == Id::Format_Time or str_contains(str635, typ))) {
                  try {
                    d = to_int(s);
                  }
                  catch (ValueError*) {
                    if ((len(s) >= 1 and str_contains(str636, s->index(0)))) {
                  ...
                  if (part->type->id == Id::Format_Time) {
                    ...
                    if ((d < 0 and str_contains(str640, typ))) {
                      e_die(fmt148(d, typ), part->type->span_id);
                    }
                    ...
                    zero_pad = 0;
                    if ((width >= 0 and list_contains(flags, str645))) {
                      zero_pad = 1;
                    }
                    else {
                    ...
                    if (zero_pad) {
                      negative = str_equals(s->index(0), str646);
                      if (negative) {
                        digits = s->slice(1);
                        sign = str647;
                        if (zero_pad == 1) {
                      ...
                      s = str_concat(sign, digits->rjust(n, str649));
                    }
                  }
                }
                else {
          ...
          if (width >= 0) {
            if (list_contains(flags, str650)) {
              s = s->ljust(width, str651);
            }
            else {
...
int Printf::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup1 = flag_spec::ParseCmdVal(str653, cmd_val);
  attrs = tup1.at0();
  arg_r = tup1.at1();
  arg = Alloc<arg_types::printf>(attrs->attrs);
  Tuple2<Str*, int> tup2 = arg_r->ReadRequired2(str654);
  fmt = tup2.at0();
  fmt_spid = tup2.at1();
...
int Alias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str658, cmd_val);
  arg_r = tup0.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup1 = mylib::split_once(arg, str660);
    name = tup1.at0();
    alias_exp = tup1.at1();
    if (alias_exp == nullptr) {
      alias_exp = this->aliases->get(name);
      if (alias_exp == nullptr) {
        this->errfmt->Print_(fmt152(name), cmd_val->arg_spids->index(i));
        status = 1;
      }
      else {
        print(fmt153(name, alias_exp));
      }
    }
    else {
...
int UnAlias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str663, cmd_val);
  arg_r = tup2.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
    e_usage(str664);
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    ...
    if (dict_contains(this->aliases, name)) {
      ...
      this->errfmt->Print_(fmt154(name), cmd_val->arg_spids->index(i));
      status = 1;
    }
  }
  return status;
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (len(cmd_val->argv) == 1) {
    ...
    for (ListIter<Str*> it(sorted(mapping)); !it.Done(); it.Next()) {
      ...
      code_str = fmt155(name, qsn::maybe_shell_encode(str_val));
      print(code_str);
    }
    return 0;
  }
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  arg = flag_spec::ParseMore(str667, arg_r);
  if (arg->show_options) {
...
int Shopt::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str668, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
...
int Hash::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str670, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
...
Dict<Str*, bool>* _ParseOptSpec(Str* spec_str) {
  ...
  while (true) {
    ...
    if (str_equals(spec_str->index(i), str673)) {
      spec->set(ch, true);
      i += 1;
    }
  }
...
int GetOptsState::_OptInd() {
  int result;
  try {
    result = state::GetInteger(this->mem, str674);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    result = -1;
...
void GetOptsState::IncIndex() {
  state::BuiltinSetString(this->mem, str675, str((this->_optind + 1)));
}

void GetOptsState::SetArg(Str* optarg) {
  StackRoots _roots({&optarg});

  state::BuiltinSetString(this->mem, str676, optarg);
}

void GetOptsState::Fail() {
  state::BuiltinSetString(this->mem, str677, str678);
}
...
Tuple2<int, Str*> _GetOpts(Dict<Str*, bool>* spec, List<Str*>* argv, builtin_pure::GetOptsState* my_state, ui::ErrorFormatter* errfmt) {
  ...
  if (current == nullptr) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str679));
  }
  if ((!current->startswith(str680) or str_equals(current, str681))) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str682));
  }
  ...
  if (!dict_contains(spec, flag_char)) {
    return (Tuple2<int, Str*>(0, str683));
  }
  if (spec->index(flag_char)) {
    if (more_chars) {
      ...
      if (optarg == nullptr) {
        my_state->Fail();
        errfmt->Print_(fmt158(current));
        tmp = Alloc<List<Str*>>();
        for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
          Str* a = it.Value();
          tmp->append(qsn::maybe_shell_encode(a));
        }
        println_stderr(fmt159(str686->join(tmp)));
        return (Tuple2<int, Str*>(0, str687));
      }
    }
    my_state->IncIndex();
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  spec_str = arg_r->ReadRequired(str689);
  Tuple2<Str*, int> tup7 = arg_r->ReadRequired2(str690);
  var_name = tup7.at0();
  var_spid = tup7.at1();
  ...
  if (match::IsValidVarName(var_name)) {
    ...
    throw Alloc<error::Usage>(fmt160(var_name), var_spid);
  }
  return status;
}
...
int Echo::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseLikeEcho(str692, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  if (arg->e) {
    ...
    for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
      ...
      new_argv->append(str693->join(parts));
      if (backslash_c) {
        break;
      }
    }
...
int CommandEvaluator::_RunAssignBuiltin(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  if (builtin_func == nullptr) {
    e_die(fmt161(cmd_val->argv->index(0)), cmd_val->arg_spids->index(0));
  }
  try {
    try {
      status = builtin_func->Run(cmd_val);
      ...
      this->errfmt->PrefixPrint(e->msg, fmt162(arg0), e->span_id);
      status = 2;
    }
    catch (KeyboardInterrupt*) {
      if (this->exec_opts->interactive()) {
...
void CommandEvaluator::_CheckStatus(int status, syntax_asdl::command_t* node, int blame_spid) {
  ...
  if ((this->exec_opts->errexit() and status != 0)) {
    ...
    throw Alloc<error::ErrExit>(fmt163(status, reason, posix::getpid()), span_id, status);
  }
}
    ...
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          t = val->s;
          if (len(t) == 0) {
            throw Alloc<error::RedirectEval>(str707, arg_word);
            return nullptr;
          }
          try {
            if (maybe_str_equals(t, str708)) {
              result->arg = Alloc<redirect_arg::CloseFd>();
            }
            else {
              if (str_equals(t->index(-1), str709)) {
            ...
            throw Alloc<error::RedirectEval>(fmt164(t), arg_word);
            return nullptr;
          }
          return result;
        }
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = Alloc<redirect_arg::HereDoc>(str_concat(val->s, str711));
            return result;
          }
          else {
            throw Alloc<AssertionError>();
...
void CommandEvaluator::_StrictErrExit(syntax_asdl::command_t* node) {
  ...
  if (_HasManyStatuses(node)) {
    ...
    e_die(fmt165(node_str), location::SpanForCommand(node));
  }
}
...
void CommandEvaluator::_StrictErrExitList(List<syntax_asdl::command_t*>* node_list) {
  ...
  if (len(node_list) > 1) {
    e_die(fmt166(), location::SpanForCommand(node_list->index(0)));
  }
  node = node_list->index(0);
  if (_HasManyStatuses(node)) {
    node_str = ui::CommandType(node);
    e_die(fmt167(node_str), location::SpanForCommand(node));
  }
}
  ...
  switch (node->tag_()) {
    case command_e::Simple: {
      ...
      if (UP_cmd_val->tag_() == cmd_value_e::Argv) {
        ...
        if (node->block) {
          e_die(fmt168(), node->block->spids->index(0));
        }
        cmd_value__Assign* cmd_val = static_cast<cmd_value__Assign*>(UP_cmd_val);
      }
    ...
    case command_e::Pipeline: {
      ...
      if (len(node->stderr_indices)) {
        e_die(fmt169(), node->spids->index(0));
      }
      if (node->negated) {
    ...
    case command_e::ControlFlow: {
      ...
      if (node->arg_word) {
        ...
        if ((len(str_val->s) == 0 and !this->exec_opts->strict_control_flow())) {
          ...
          try {
            ...
            e_die(fmt170(node->token->val, str_val->s), node->arg_word);
          }
        }
      }
      else {
      ...
      if (ok) {
        ...
        if (this->exec_opts->strict_control_flow()) {
          ...
          this->errfmt->PrefixPrint(msg, str723, tok->span_id);
          status = 0;
        }
      }
    }
    ...
    {  // with
      ...
      for (ListIter<syntax_asdl::command_t*> it(to_run); !it.Done(); it.Next()) {
        ...
        {  // with
          ...
          {  // with
            dev::ctx_Tracer ctx(this->tracer, str724, nullptr);
...
Tuple2<bool, bool> CommandEvaluator::ExecuteAndCatch(syntax_asdl::command_t* node, int cmd_flags) {
  ...
  try {
    ...
    if ((cmd_flags & RaiseControlFlow)) {
      ...
      if (e->IsReturn()) {
        ...
        this->errfmt->Print_(str725, e->token->span_id);
        is_fatal = true;
        status = 1;
      }
    }
  ...
  if (err) {
    ...
    if ((is_errexit and !this->exec_opts->verbose_errexit())) {
      ...
      ui::PrettyPrintError(err, this->arena, str726);
    }
  }
...
void CommandEvaluator::MaybeRunExitTrap(List<int>* mut_status) {
  ...
  handler = this->traps->get(str727);
  if (handler) {
    {  // with
      dev::ctx_Tracer ctx(this->tracer, str728, nullptr);
    ...
    if (UP_sig->tag_() == proc_sig_e::Closed) {
      ...
      for (ListIter<syntax_asdl::param*> it(sig->params); !it.Done(); it.Next(), ++i) {
        ...
        if (i < n_args) {
          ...
          if (is_out_param) {
            param_name = str_concat(str729, param_name);
            if (!arg_str->startswith(str730)) {
              e_die(fmt171(arg_str));
            }
      ...
      if (sig->rest) {
        ...
        if (n_args > n_params) {
          throw Alloc<TypeError>(fmt173(proc->name, n_params, n_args));
        }
      }
    }
    try {
      ...
      if (e->IsReturn()) {
        ...
        e_die(fmt174(e->token->val), e->token);
      }
    }
    catch (error::FatalRuntime* e) {
      this->dumper->MaybeCollect(this, e);
...
int CommandEvaluator::RunFuncForCompletion(runtime_asdl::Proc* proc, List<Str*>* argv) {
  ...
  try {
    ...
    this->errfmt->Print_(str735, e->token->span_id);
    status = 1;
  }
  return status;
}
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index(i), str737))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index(-2), str739)) {
    ...
    if ((left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse)) {
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        var_name = left_token->val->slice(0, -1);
        if (str_equals(close_token->val->index(-2), str741)) {
          op = assign_op_e::PlusEqual;
        }
        else {
          op = assign_op_e::Equal;
        ...
        if (span1->line_id == span2->line_id) {
          ...
          throw Alloc<NotImplementedError>(fmt177(span1->line_id, span2->line_id));
        }
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    w = tup6->at3();
    if (left_token->id != Id::Lit_VarLike) {
      p_die(fmt178(), left_token);
    }
    if (str_equals(left_token->val->index(-2), str744)) {
...
void VarChecker::Push(syntax_asdl::Token* blame_tok) {
  ...
  if ((len(this->tokens) != 0 and blame_tok->id == Id::KW_Proc)) {
    p_die(fmt181(), blame_tok);
  }
...
void CommandParser::_Eat(int c_id) {
  ...
  msg = fmt185(ui::PrettyId(c_id), ui::PrettyId(actual_id));
  this->_Eat2(c_id, msg);
}
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index(0), str752)) {
    pos = op_val->find(str753);
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    if (span1->line_id == span2->line_id) {
      ...
      throw Alloc<NotImplementedError>(fmt188(span1->line_id, span2->line_id));
    }
    expanded->append(str759);
    i += 1;
  }
  code_str = str760->join(expanded);
  line_reader = reader::StringLineReader(code_str, this->arena);
  ...
  if (kind == Kind::ControlFlow) {
    ...
    if (len(suffix_words) == 1) {
      ...
      if (len(suffix_words) == 2) {
        ...
        p_die(fmt196(kw_token->val), suffix_words->index(2));
      }
    }
...
syntax_asdl::command__ShFunction* CommandParser::ParseFunctionDef() {
  ...
  this->_Next();
  this->_Eat2(Id::Right_ShFunction, str777);
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if (str_equals(c, str785)) {
      i += 1;
    }
    else {
      if ((str_equals(c, str786) or str_equals(c, str787))) {
        return true;
      }
      else {
        if (str_equals(c, str788)) {
          left_bracket = true;
        }
        else {
          if ((str_equals(c, str789) and left_bracket)) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  ...
  return pyutil::BackslashEscape(s, str791);
}
Str* ERE_META_CHARS = str792;
...
Str* GlobUnescape(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if ((str_equals(c, str793) and i != (n - 1))) {
      i += 1;
      c2 = s->index(i);
...
int Globber::Expand(Str* arg, List<Str*>* out) {
  ...
  if (n) {
    for (ListIter<Str*> it(results); !it.Done(); it.Next()) {
      Str* name = it.Value();
      StackRoots _for({&name    });
      if ((name->startswith(str818) and !this->exec_opts->dashglob())) {
        n -= 1;
        continue;
      }
      out->append(name);
...
Str* _PromptEvaluatorCache::Get(Str* name) {
  ...
  if (str_equals(name, str820)) {
    value = this->_GetEuid() == 0 ? str821 : str822;
  }
  else {
...
Evaluator::Evaluator(Str* lang, parse_lib::ParseContext* parse_ctx, state::Mem* mem) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Evaluator)) {
  ...
  this->parse_ctx = parse_ctx;
  this->mem = mem;
  this->default_prompt = str_concat(lang, str825);
            ...
            if (id_ == Id::PS_Subst) {
              ...
              if (str_equals(ch, str828)) {
                ...
                if (str_equals(ch, str830)) {
                  r = this->cache->Get(str831);
                }
                else {
                  if (str_equals(ch, str832)) {
                    hostname = this->cache->Get(str833);
                    Tuple2<Str*, Str*> tup1 = mylib::split_once(hostname, str834);
                    r = tup1.at0();
                  }
                  else {
                    if (str_equals(ch, str835)) {
                      r = this->cache->Get(str836);
                    }
                    else {
                      if (str_equals(ch, str837)) {
                        try {
                          pwd = state::GetString(this->mem, str838);
                          home = state::MaybeString(this->mem, str839);
                          r = ui::PrettyDir(pwd, home);
                        }
                        catch (error::Runtime* e) {
                          r = fmt213(e->UserErrorString());
                        }
                      }
                      else {
                        if (str_equals(ch, str841)) {
                          val = this->mem->GetValue(str842);
                          if (val->tag_() == value_e::Str) {
                            value__Str* str_val = static_cast<value__Str*>(val);
              ...
              ret->append(r->replace(str845, str846));
            }
            else {
              throw Alloc<AssertionError>();
            }
...
Str* Evaluator::EvalPrompt(runtime_asdl::value_t* UP_val) {
  ...
  if (ps1_word == nullptr) {
    ...
    try {
      ...
      ps1_word = word_::ErrorWord(fmt215(e->UserErrorString()));
    }
...
Str* Evaluator::EvalFirstPrompt() {
  ...
  if (str_equals(this->lang, str850)) {
...
int ArithEvaluator::_StringToInteger(Str* s, int span_id) {
  ...
  if (s->startswith(str858)) {
    try {
      ...
      e_strict(fmt219(s), span_id);
    }
    return integer;
  }
  if (s->startswith(str860)) {
    try {
      integer = to_int(s, 8);
    }
    catch (ValueError*) {
  ...
  if (str_contains(s, str862)) {
    Tuple2<Str*, Str*> tup0 = mylib::split_once(s, str863);
    b = tup0.at0();
    digits = tup0.at1();
    try {
      base = to_int(b);
    ...
    for (StrIter it(digits); !it.Done(); it.Next()) {
      ...
      StackRoots _for({&ch    });
      if (IsLower(ch)) {
        digit = ((ord(ch) - ord(str865)) + 10);
      }
      else {
        if (IsUpper(ch)) {
          digit = ((ord(ch) - ord(str866)) + 36);
        }
        else {
          if (str_equals(ch, str867)) {
            ...
            if (str_equals(ch, str868)) {
              ...
              if (ch->isdigit()) {
                ...
                e_strict(fmt222(digits), span_id);
              }
            }
          }
        }
      ...
      if (digit >= base) {
        e_strict(fmt223(digits, base), span_id);
      }
    ...
    if ((this->exec_opts->eval_unsafe_arith() and this->parse_ctx)) {
      ...
      {  // with
        ...
        try {
          ...
          ui::PrettyPrintError(e, arena);
          e_die(fmt224(), e->span_id);
        }
      }
      if (node2->tag_() == arith_expr_e::Word) {
        e_die(fmt225(s), span_id);
      }
      else {
      ...
      if ((len(s->strip()) == 0 or match::IsValidVarName(s))) {
        e_strict(fmt226(s), span_id);
      }
      else {
        e_die(fmt227(s), span_id);
      }
    }
  }
  return integer;
...
int ArithEvaluator::_ValToIntOrError(runtime_asdl::value_t* val, int span_id) {
  ...
  e_die(fmt229(ui::ValType(val)), span_id);
}
  ...
  if (((val->tag_() == value_e::MaybeStrArray || val->tag_() == value_e::AssocArray) and lval->tag_() == lvalue_e::Named)) {
    ...
    if (word_eval::CheckCompatArray(named_lval->name, this->exec_opts)) {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (val->tag_() == value_e::AssocArray) {
          lval = Alloc<lvalue::Keyed>(named_lval->name, str877);
        }
      }
        ...
        if (op_id == Id::Arith_Minus) {
          ...
          if (op_id == Id::Arith_Star) {
            ...
            if (op_id == Id::Arith_Slash) {
              if (rhs == 0) {
                e_die(fmt231(), location::SpanForArithExpr(node->right));
              }
              ret = (lhs / rhs);
            }
            else {
  ...
  switch (node->tag_()) {
    ...
    case bool_expr_e::Unary: {
      ...
      if (arg_type == bool_arg_type_e::Other) {
        ...
        e_die(fmt234(ui::PrettyId(op_id)));
      }
      throw Alloc<AssertionError>();
    }
      break;
      ...
      if (arg_type == bool_arg_type_e::Str) {
        ...
        if (op_id == Id::BoolBinary_EqualTilde) {
          try {
            ...
            msg = e->message;
            e_die(fmt235(s2, msg, node->right), 2);
          }
          if (matches == nullptr) {
            return false;
          }
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Slash) {
    try {
      ...
      msg = e->message;
      e_die(fmt241(regex, msg), this->slash_spid);
    }
  }
...
void TdopParser::Eat(int token_type) {
  if (!this->AtToken(token_type)) {
    p_die(fmt245(ui::PrettyId(token_type), ui::PrettyId(this->op_id)), this->cur_word);
  }
  this->Next();
}
      ...
      if ((op->op_id == Id::VTest_ColonEquals || op->op_id == Id::VTest_Equals)) {
        ...
        if ((op->op_id == Id::VTest_ColonQMark || op->op_id == Id::VTest_QMark)) {
          if (is_falsey) {
            ...
            e_die(fmt250(error_str), blame_token);
          }
          else {
            return false;
          }
...
Tuple2<runtime_asdl::value_t*, runtime_asdl::a_index_t*> AbstractWordEvaluator::_ArrayIndex(runtime_asdl::value_t* val, syntax_asdl::braced_var_sub* part) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      ...
      break;
    case value_e::Str: {
      e_die(fmt257(part->token->val), part->token);
    }
      break;
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* array_val = static_cast<value__MaybeStrArray*>(UP_val);
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalForPlugin(syntax_asdl::compound_word* w) {
  ...
  {  // with
    ...
    try {
      ...
      val = Alloc<value::Str>(fmt267(e->UserErrorString()));
    }
    catch (_OSError* e) {
      val = Alloc<value::Str>(fmt268(pyutil::strerror(e)));
    }
    catch (KeyboardInterrupt*) {
...
syntax_asdl::suffix_op__PatSub* WordParser::_ReadPatSubVarOp() {
  ...
  if (this->token_type == Id::Lit_Slash) {
    ...
    this->_Peek();
    if (this->token_type != Id::Right_DollarBrace) {
      p_die(fmt274(ui::PrettyId(this->token_type)), this->cur_token);
    }
        ...
        if (op_kind == Kind::VOp2) {
          if (this->token_type == Id::VOp2_Slash) {
            ...
            if (this->token_type == Id::VOp2_Colon) {
              ...
              p_die(fmt280(str1035), this->cur_token);
            }
          }
        }
        else {
          if (op_kind == Kind::VOp3) {
            if (allow_query) {
              ...
              p_die(fmt281(str1037), this->cur_token);
            }
          }
        }
      }
...
void WordParser::ParseProc(syntax_asdl::command__Proc* node) {
  ...
  if (this->token_type != Id::Lit_Chars) {
    p_die(fmt297(ui::PrettyToken(this->cur_token, this->arena)), this->cur_token);
  }
...
syntax_asdl::arith_expr_t* WordParser::_ReadArithExpr(int end_id) {
  ...
  if ((end_id != Id::Undefined_Tok and cur_id != end_id)) {
    p_die(fmt298(ui::PrettyId(cur_id), ui::PrettyId(end_id)), this->a_parser->cur_word);
  }
  return anode;
}
...
syntax_asdl::command__ForExpr* WordParser::ReadForExpression() {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt301(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
  if (cur_id == Id::Arith_Semi) {
              ...
              if (!this->parse_opts->parse_dollar()) {
                if ((num_parts == 0 and lex_mode == lex_mode_e::ShCommand)) {
                  ...
                  if (str_equals(next_byte, str1069)) {
                    println_stderr(fmt311(next_byte));
                  }
                }
              ...
              if ((this->parse_opts->parse_triple_quoted() and (lex_mode == lex_mode_e::ShCommand and num_parts == 0))) {
                if ((part->tag_() == word_part_e::SingleQuoted and len(static_cast<single_quoted*>(part)->tokens) == 0)) {
                  ...
                  if (next_id == Id::Left_SingleQuote) {
                    println_stderr(fmt314(ui::PrettyId(next_id)));
                  }
                }
...
Tuple2<syntax_asdl::word_t*, bool> WordParser::_ReadArithWord() {
  ...
  this->_Peek();
  if (this->token_kind == Kind::Unknown) {
    p_die(fmt317(this->cur_token->val), this->cur_token);
  }
  else {
    if (this->token_kind == Kind::Eof) {

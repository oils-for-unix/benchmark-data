...
GLOBAL_STR(str136, "Command sub exited with status %d (%s)");
GLOBAL_STR(str137, "");
GLOBAL_STR(str138, "\n");
...
GLOBAL_STR(str202, "JobState MaybeRemove %d");
GLOBAL_STR(str203, "osh: PID %d stopped, but osh didn't start it");
GLOBAL_STR(str204, "");
GLOBAL_STR(str205, "");
GLOBAL_STR(str206, "[PID %d] Stopped");
GLOBAL_STR(str207, "");
GLOBAL_STR(str208, "main");
GLOBAL_STR(str209, "osh usage error: %s");
GLOBAL_STR(str210, "%s-usage");
GLOBAL_STR(str211, "Oil");
GLOBAL_STR(str212, "main");
GLOBAL_STR(str213, "oil");
GLOBAL_STR(str214, "oil:all");
GLOBAL_STR(str215, "--one-pass-parse requires noexec (-n)");
GLOBAL_STR(str216, "completion");
GLOBAL_STR(str217, "history");
GLOBAL_STR(str218, "");
GLOBAL_STR(str219, "OSH_DEBUG_DIR");
GLOBAL_STR(str220, "%d-osh.log");
GLOBAL_STR(str221, "Writing logs to %r");
GLOBAL_STR(str222, "OSH_HIJACK_SHEBANG");
GLOBAL_STR(str223, "");
GLOBAL_STR(str224, "OSH_CRASH_DUMP_DIR");
GLOBAL_STR(str225, "");
GLOBAL_STR(str226, "");
GLOBAL_STR(str227, "osh: Couldn't open %r: %s");
GLOBAL_STR(str228, "/proc/%d/status");
GLOBAL_STR(str229, "--parser-mem-dump can only be used with -n");
GLOBAL_STR(str230, "/proc/%d/status");
GLOBAL_STR(str231, " \t\n\"'><=;|&(:");
GLOBAL_STR(str232, "/");
GLOBAL_STR(str233, "PATH");
GLOBAL_STR(str234, ":");
GLOBAL_STR(str235, "got invalid option %r");
GLOBAL_STR(str236, "got invalid option %r");
GLOBAL_STR(str237, "invalid option %r (try -O or shopt)");
GLOBAL_STR(str238, "SHELLOPTS");
GLOBAL_STR(str239, ":");
GLOBAL_STR(str240, "Syntax options must be set at the top level (outside any function)");
GLOBAL_STR(str241, "Warning: set -o verbose not implemented");
GLOBAL_STR(str242, "SHELLOPTS");
GLOBAL_STR(str243, "%s:%s");
GLOBAL_STR(str244, "SHELLOPTS");
GLOBAL_STR(str245, ":");
GLOBAL_STR(str246, ":");
GLOBAL_STR(str247, "SHELLOPTS");
GLOBAL_STR(str248, "oil:basic");
GLOBAL_STR(str249, "oil:all");
GLOBAL_STR(str250, "strict:all");
GLOBAL_STR(str251, "set %so %s");
GLOBAL_STR(str252, "-");
GLOBAL_STR(str253, "+");
GLOBAL_STR(str254, "oil:basic");
GLOBAL_STR(str255, "oil:all");
GLOBAL_STR(str256, "strict:all");
GLOBAL_STR(str257, "got invalid option %r");
GLOBAL_STR(str258, "shopt -%s %s");
GLOBAL_STR(str259, "s");
GLOBAL_STR(str260, "u");
GLOBAL_STR(str261, "<_ArgFrame %s %d at %x>");
GLOBAL_STR(str262, "Can't determine working directory: %s");
GLOBAL_STR(str263, "IFS");
GLOBAL_STR(str264, "UID");
GLOBAL_STR(str265, "EUID");
GLOBAL_STR(str266, "PPID");
GLOBAL_STR(str267, "HOSTNAME");
GLOBAL_STR(str268, "OSTYPE");
GLOBAL_STR(str269, "OPTIND");
GLOBAL_STR(str270, "1");
GLOBAL_STR(str271, "PS4");
GLOBAL_STR(str272, "${SHX_indent}${SHX_punct}${SHX_pid_str} ");
GLOBAL_STR(str273, "COMP_WORDBREAKS");
...
GLOBAL_STR(str281, "OIL_VERSION");
GLOBAL_STR(str282, "PWD");
GLOBAL_STR(str283, "PS1");
GLOBAL_STR(str284, "PS1");
GLOBAL_STR(str285, "\\s-\\v\\$ ");
GLOBAL_STR(str286, "");
GLOBAL_STR(str287, "<Mem");
GLOBAL_STR(str288, "  -- %d --");
GLOBAL_STR(str289, "  %s %s");
GLOBAL_STR(str290, ">");
GLOBAL_STR(str291, "\n");
GLOBAL_STR(str292, "\n");
GLOBAL_STR(str293, "Warning: span_id undefined in SetCurrentSpanId");
GLOBAL_STR(str294, "setref requires a nameref (:out param)");
GLOBAL_STR(str295, "nameref %r is undefined");
GLOBAL_STR(str296, "nameref %r contains invalid variable name %r");
GLOBAL_STR(str297, "Circular nameref %s");
GLOBAL_STR(str298, " -> ");
GLOBAL_STR(str299, "__");
GLOBAL_STR(str300, "Can't assign to readonly value %r");
GLOBAL_STR(str301, "Only strings can be exported");
GLOBAL_STR(str302, "nameref must be a string");
GLOBAL_STR(str303, "Can't assign to readonly array");
GLOBAL_STR(str304, "Can't assign to items in a string");
GLOBAL_STR(str305, "Value of type %s can't be indexed");
GLOBAL_STR(str306, "Can't assign to readonly associative array");
GLOBAL_STR(str307, "ARGV");
GLOBAL_STR(str308, "_status");
GLOBAL_STR(str309, "_this_dir");
GLOBAL_STR(str310, "PIPESTATUS");
GLOBAL_STR(str311, "_pipeline_status");
GLOBAL_STR(str312, "_process_sub_status");
GLOBAL_STR(str313, "BASH_REMATCH");
GLOBAL_STR(str314, "FUNCNAME");
GLOBAL_STR(str315, "source");
GLOBAL_STR(str316, "BASH_SOURCE");
GLOBAL_STR(str317, "BASH_LINENO");
GLOBAL_STR(str318, "0");
GLOBAL_STR(str319, "LINENO");
GLOBAL_STR(str320, "BASHPID");
GLOBAL_STR(str321, "Can't unset readonly variable %r");
GLOBAL_STR(str322, "%r isn't an array");
GLOBAL_STR(str323, "$%s isn't defined");
GLOBAL_STR(str324, "$%s should be a string");
GLOBAL_STR(str325, "$%s should be a string, got %s");
GLOBAL_STR(str326, "$%s doesn't look like an integer, got %r");
GLOBAL_STR(str327, "EOF");
GLOBAL_STR(str328, "/");
GLOBAL_STR(str329, "~");
GLOBAL_STR(str330, "  ");
GLOBAL_STR(str331, "\n  ");
...
GLOBAL_STR(str336, "~");
GLOBAL_STR(str337, "\n");
GLOBAL_STR(str338, "[ interactive ]");
GLOBAL_STR(str339, "[ headless ]");
GLOBAL_STR(str340, "[ -c flag ]");
GLOBAL_STR(str341, "[ stdin%s ]");
GLOBAL_STR(str342, "[ %s word at ? ]");
GLOBAL_STR(str343, "[ %s word at line %d of %s ]");
GLOBAL_STR(str344, "?");
GLOBAL_STR(str345, "[ var %s ]");
GLOBAL_STR(str346, "[ expansion of alias %r ]");
GLOBAL_STR(str347, "[ %s in %s ]");
GLOBAL_STR(str348, "%s:%d: %s%s\n");
GLOBAL_STR(str349, "[??? no location ???] %s%s\n");
GLOBAL_STR(str350, "");
GLOBAL_STR(str351, "");
GLOBAL_STR(str352, "");
GLOBAL_STR(str353, "none");
GLOBAL_STR(str354, "AST not printed.");
GLOBAL_STR(str355, "text");
GLOBAL_STR(str356, "abbrev-text");
GLOBAL_STR(str357, "html");
GLOBAL_STR(str358, "abbrev-html");
GLOBAL_STR(str359, "abbrev-");
GLOBAL_STR(str360, "\n");
GLOBAL_STR(str361, "\n");
GLOBAL_STR(str362, "-");
GLOBAL_STR(str363, "_");
GLOBAL_STR(str364, "<_Attributes %s>");
GLOBAL_STR(str365, "<args.Reader %r %d>");
GLOBAL_STR(str366, "expected argument to %r");
GLOBAL_STR(str367, "-");
GLOBAL_STR(str368, "expected integer after %s, got %r");
GLOBAL_STR(str369, "-");
GLOBAL_STR(str370, "got invalid integer for %s: %s");
GLOBAL_STR(str371, "-");
GLOBAL_STR(str372, "expected number after %r, got %r");
GLOBAL_STR(str373, "-");
GLOBAL_STR(str374, "got invalid float for %s: %s");
GLOBAL_STR(str375, "-");
GLOBAL_STR(str376, "got invalid argument %r to %r, expected one of: %s");
GLOBAL_STR(str377, "-");
GLOBAL_STR(str378, "|");
GLOBAL_STR(str379, "0");
GLOBAL_STR(str380, "F");
GLOBAL_STR(str381, "false");
GLOBAL_STR(str382, "False");
GLOBAL_STR(str383, "1");
GLOBAL_STR(str384, "T");
GLOBAL_STR(str385, "true");
GLOBAL_STR(str386, "Talse");
GLOBAL_STR(str387, "got invalid argument to boolean flag: %r");
GLOBAL_STR(str388, "-");
GLOBAL_STR(str389, "-");
GLOBAL_STR(str390, "Invalid option %r");
GLOBAL_STR(str391, "Expected argument for action");
GLOBAL_STR(str392, "Invalid action name %r");
GLOBAL_STR(str393, "--");
GLOBAL_STR(str394, "--");
GLOBAL_STR(str395, "=");
...
GLOBAL_STR(str399, "Z");
GLOBAL_STR(str400, "-");
GLOBAL_STR(str401, "doesn't accept flag %s");
GLOBAL_STR(str402, "-");
GLOBAL_STR(str403, "+");
GLOBAL_STR(str404, "+");
GLOBAL_STR(str405, "doesn't accept option %s");
GLOBAL_STR(str406, "+");
GLOBAL_STR(str407, "-");
GLOBAL_STR(str408, "--");
GLOBAL_STR(str409, "--");
GLOBAL_STR(str410, "got invalid flag %r");
GLOBAL_STR(str411, "-");
GLOBAL_STR(str412, "+");
GLOBAL_STR(str413, "got invalid flag %r");
GLOBAL_STR(str414, "-");
GLOBAL_STR(str415, "<LineLexer at pos %d of line %r (id = %d)>");
GLOBAL_STR(str416, "");
GLOBAL_STR(str417, "");
GLOBAL_STR(str418, "");
GLOBAL_STR(str419, "");
GLOBAL_STR(str420, "<Trail %s %s %s %s>");
GLOBAL_STR(str421, "");
GLOBAL_STR(str422, "Here docs aren't allowed in expressions");
GLOBAL_STR(str423, "\n");
GLOBAL_STR(str424, "Expected an expression");
GLOBAL_STR(str425, "Expected an expression");
GLOBAL_STR(str426, "Too many typed args (expected one expression)");
GLOBAL_STR(str427, "Expected block argument");
GLOBAL_STR(str428, "Too many typed args (expected one block)");
GLOBAL_STR(str429, "");
GLOBAL_STR(str430, " (%s)");
GLOBAL_STR(str431, "Unexpected token in expression mode%s");
GLOBAL_STR(str432, "Syntax error in expression (near %s)");
GLOBAL_STR(str433, "alnum");
GLOBAL_STR(str434, "cntrl");
GLOBAL_STR(str435, "lower");
GLOBAL_STR(str436, "space");
GLOBAL_STR(str437, "alpha");
GLOBAL_STR(str438, "digit");
GLOBAL_STR(str439, "print");
GLOBAL_STR(str440, "upper");
GLOBAL_STR(str441, "blank");
GLOBAL_STR(str442, "graph");
GLOBAL_STR(str443, "punct");
GLOBAL_STR(str444, "xdigit");
GLOBAL_STR(str445, "Range start/end shouldn't have more than one character");
GLOBAL_STR(str446, "Write singleton tuples with tup(), not a trailing comma");
GLOBAL_STR(str447, "testlist_comp");
GLOBAL_STR(str448, "obj.field isn't valid, but obj.method() is");
GLOBAL_STR(str449, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str450, "Can't assign to this expression");
GLOBAL_STR(str451, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str452, "Expr");
GLOBAL_STR(str453, "Block");
GLOBAL_STR(str454, "proc param types should be Expr or Block");
GLOBAL_STR(str455, "TODO");
GLOBAL_STR(str456, "dot");
GLOBAL_STR(str457, "Can't negate this symbol");
GLOBAL_STR(str458, "%r isn't a character class");
GLOBAL_STR(str459, "Can't negate this symbol");
GLOBAL_STR(str460, "%r isn't a character class");
GLOBAL_STR(str461, "%start");
GLOBAL_STR(str462, "%end");
GLOBAL_STR(str463, "dot");
GLOBAL_STR(str464, "Unexpected token %r in regex");
GLOBAL_STR(str465, "%s-%s");
GLOBAL_STR(str466, "ERE can't express code point %d");
GLOBAL_STR(str467, "Perl classes can't be negated in ERE");
GLOBAL_STR(str468, "%s");
GLOBAL_STR(str469, "POSIX classes can't be negated in ERE");
GLOBAL_STR(str470, "[:%s:]");
GLOBAL_STR(str471, ".");
GLOBAL_STR(str472, "^");
GLOBAL_STR(str473, "$");
GLOBAL_STR(str474, "|");
GLOBAL_STR(str475, "POSIX EREs don't have groups without capture, so this node needs () around it.");
GLOBAL_STR(str476, "+");
GLOBAL_STR(str477, "*");
GLOBAL_STR(str478, "?");
GLOBAL_STR(str479, "{%s}");
...
GLOBAL_STR(str490, "^");
GLOBAL_STR(str491, "]");
GLOBAL_STR(str492, "The [ operator doesn't apply to this expression");
GLOBAL_STR(str493, "Expected ]]");
GLOBAL_STR(str494, "Unexpected trailing word %s");
GLOBAL_STR(str495, "Invalid argument to unary operator");
GLOBAL_STR(str496, "Expected ), got %s");
GLOBAL_STR(str497, "Unexpected token in boolean expression (%s)");
GLOBAL_STR(str498, "");
GLOBAL_STR(str499, "Expected %d, got %d");
GLOBAL_STR(str500, "Step can't be 0");
GLOBAL_STR(str501, "Invalid step %d for ascending integer range");
GLOBAL_STR(str502, "Invalid step %d for descending integer range");
GLOBAL_STR(str503, "Invalid step %d for ascending character range");
GLOBAL_STR(str504, "Invalid step %d for descending character range");
GLOBAL_STR(str505, "Mismatched cases in character range");
GLOBAL_STR(str506, "");
GLOBAL_STR(str507, "0");
GLOBAL_STR(str508, "0");
GLOBAL_STR(str509, "g");
...
GLOBAL_STR(str546, ")");
GLOBAL_STR(str547, "");
GLOBAL_STR(str548, "export_");
GLOBAL_STR(str549, "doesn't accept -f because it's dangerous.  (The code can usually be restructured with 'source')");
GLOBAL_STR(str550, "doesn't accept RHS with -n");
GLOBAL_STR(str551, "Got -a but RHS isn't an array");
GLOBAL_STR(str552, "Got -A but RHS isn't an associative array");
GLOBAL_STR(str553, "readonly");
GLOBAL_STR(str554, "new_var");
GLOBAL_STR(str555, "with -f expects function names");
GLOBAL_STR(str556, "declare -f %s");
GLOBAL_STR(str557, "-");
GLOBAL_STR(str558, "-");
GLOBAL_STR(str559, "-");
GLOBAL_STR(str560, "+");
GLOBAL_STR(str561, "+");
GLOBAL_STR(str562, "+");
GLOBAL_STR(str563, "unset");
GLOBAL_STR(str564, "Invalid shift argument %r");
GLOBAL_STR(str565, "got too many arguments");
GLOBAL_STR(str566, "eval");
GLOBAL_STR(str567, "requires code string");
GLOBAL_STR(str568, "requires exactly 1 argument");
GLOBAL_STR(str569, " ");
GLOBAL_STR(str570, "eval");
GLOBAL_STR(str571, "eval");
GLOBAL_STR(str572, "source");
GLOBAL_STR(str573, "missing required argument");
GLOBAL_STR(str574, "source %r failed: %s");
GLOBAL_STR(str575, "source");
GLOBAL_STR(str576, "command");
GLOBAL_STR(str577, "Can't run assignment builtin recursively");
GLOBAL_STR(str578, "%r isn't a shell builtin");
GLOBAL_STR(str579, "runproc");
GLOBAL_STR(str580, "requires arguments");
GLOBAL_STR(str581, "runproc: no proc named %r");
GLOBAL_STR(str582, "try_");
GLOBAL_STR(str583, "'try' expected a command to run");
GLOBAL_STR(str584, "(original failure)");
GLOBAL_STR(str585, "");
GLOBAL_STR(str586, "fatal: status %d when --allow-status-01");
GLOBAL_STR(str587, ":");
GLOBAL_STR(str588, "function");
GLOBAL_STR(str589, "alias");
GLOBAL_STR(str590, "builtin");
GLOBAL_STR(str591, "builtin");
GLOBAL_STR(str592, "builtin");
GLOBAL_STR(str593, "keyword");
GLOBAL_STR(str594, "keyword");
GLOBAL_STR(str595, "file");
GLOBAL_STR(str596, "type");
GLOBAL_STR(str597, "type: %r not found");
GLOBAL_STR(str598, "file");
GLOBAL_STR(str599, "file");
GLOBAL_STR(str600, "%s is a %s");
GLOBAL_STR(str601, "function");
GLOBAL_STR(str602, "osh I/O error: %s");
GLOBAL_STR(str603, "");
GLOBAL_STR(str604, "osh I/O error: %s");
GLOBAL_STR(str605, "osh I/O error: %s");
GLOBAL_STR(str606, "osh I/O error: %s");
GLOBAL_STR(str607, "");
GLOBAL_STR(str608, "\r\n");
GLOBAL_STR(str609, "\n");
GLOBAL_STR(str610, "'");
...
GLOBAL_STR(str629, ":");
GLOBAL_STR(str630, "\n");
GLOBAL_STR(str631, "cd");
GLOBAL_STR(str632, "HOME");
GLOBAL_STR(str633, "HOME");
GLOBAL_STR(str634, "-");
GLOBAL_STR(str635, "OLDPWD");
GLOBAL_STR(str636, "PWD");
GLOBAL_STR(str637, "cd %r: %s");
GLOBAL_STR(str638, "PWD");
GLOBAL_STR(str639, "OLDPWD");
GLOBAL_STR(str640, "%2d  %s");
GLOBAL_STR(str641, " ");
GLOBAL_STR(str642, "pushd: no other directory");
GLOBAL_STR(str643, "got too many arguments");
GLOBAL_STR(str644, "pushd: %r: %s");
GLOBAL_STR(str645, "HOME");
GLOBAL_STR(str646, "PWD");
GLOBAL_STR(str647, "popd: directory stack is empty");
GLOBAL_STR(str648, "popd: %r: %s");
GLOBAL_STR(str649, "PWD");
GLOBAL_STR(str650, "got extra argument");
GLOBAL_STR(str651, "HOME");
GLOBAL_STR(str652, "dirs");
GLOBAL_STR(str653, "HOME");
GLOBAL_STR(str654, "pwd");
GLOBAL_STR(str655, "_devbuild/help/groups.txt");
GLOBAL_STR(str656, "help");
GLOBAL_STR(str657, "help");
GLOBAL_STR(str658, "_devbuild/help/%s");
GLOBAL_STR(str659, "no help topics match %r");
GLOBAL_STR(str660, "osh I/O error: %s");
GLOBAL_STR(str661, "# +");
GLOBAL_STR(str662, "osh printf doesn't support the %r flag");
GLOBAL_STR(str663, "eEfFgG");
GLOBAL_STR(str664, "osh printf doesn't support floating point");
GLOBAL_STR(str665, "c");
GLOBAL_STR(str666, "osh printf doesn't support single characters (bytes)");
GLOBAL_STR(str667, "Invalid printf format character");
GLOBAL_STR(str668, "Expected a printf format character");
GLOBAL_STR(str669, "%");
GLOBAL_STR(str670, "");
GLOBAL_STR(str671, "printf got invalid width %r");
GLOBAL_STR(str672, "0");
GLOBAL_STR(str673, "");
GLOBAL_STR(str674, "printf got invalid precision %r");
GLOBAL_STR(str675, "");
GLOBAL_STR(str676, "s");
GLOBAL_STR(str677, "q");
GLOBAL_STR(str678, "b");
GLOBAL_STR(str679, "");
GLOBAL_STR(str680, "diouxX");
GLOBAL_STR(str681, "'\"");
GLOBAL_STR(str682, "printf expected an integer, got %r");
GLOBAL_STR(str683, "TZ");
GLOBAL_STR(str684, "TZ");
GLOBAL_STR(str685, "ouxX");
GLOBAL_STR(str686, "Can't format negative number %d with %%%s");
GLOBAL_STR(str687, "o");
GLOBAL_STR(str688, "x");
GLOBAL_STR(str689, "X");
GLOBAL_STR(str690, "0");
...
GLOBAL_STR(str696, " ");
GLOBAL_STR(str697, " ");
GLOBAL_STR(str698, "printf");
GLOBAL_STR(str699, "requires a format string");
GLOBAL_STR(str700, "printf");
GLOBAL_STR(str701, "");
GLOBAL_STR(str702, "alias");
GLOBAL_STR(str703, "alias %s=%r");
GLOBAL_STR(str704, "=");
GLOBAL_STR(str705, "No alias named %r");
GLOBAL_STR(str706, "alias %s=%r");
GLOBAL_STR(str707, "unalias");
GLOBAL_STR(str708, "requires an argument");
GLOBAL_STR(str709, "No alias named %r");
GLOBAL_STR(str710, "%s=%s");
GLOBAL_STR(str711, "set");
GLOBAL_STR(str712, "shopt");
GLOBAL_STR(str713, "got invalid option %r");
GLOBAL_STR(str714, "hash");
GLOBAL_STR(str715, "got extra arguments after -r");
GLOBAL_STR(str716, "hash: %r not found");
GLOBAL_STR(str717, ":");
GLOBAL_STR(str718, "OPTIND");
GLOBAL_STR(str719, "OPTIND");
GLOBAL_STR(str720, "OPTARG");
...
GLOBAL_STR(str726, "?");
GLOBAL_STR(str727, "?");
GLOBAL_STR(str728, "getopts: option %r requires an argument.");
GLOBAL_STR(str729, "(getopts argv: %s)");
GLOBAL_STR(str730, " ");
GLOBAL_STR(str731, "?");
GLOBAL_STR(str732, "");
GLOBAL_STR(str733, "requires an argspec");
GLOBAL_STR(str734, "requires the name of a variable to set");
GLOBAL_STR(str735, "got invalid variable name %r");
GLOBAL_STR(str736, "echo");
GLOBAL_STR(str737, "");
GLOBAL_STR(str738, "takes at most one arg when simple_echo is on (hint: add quotes)");
GLOBAL_STR(str739, " ");
GLOBAL_STR(str740, "\n");
GLOBAL_STR(str741, "module");
GLOBAL_STR(str742, "requires a name");
GLOBAL_STR(str743, "[oil -i] Reloading module %r");
GLOBAL_STR(str744, "expected 'bin' or 'dialect'");
GLOBAL_STR(str745, "dialect");
GLOBAL_STR(str746, "expected dialect name");
GLOBAL_STR(str747, "_DIALECT");
GLOBAL_STR(str748, "Expected dialect %r, got %r");
GLOBAL_STR(str749, "Expected dialect %r");
GLOBAL_STR(str750, "bin");
GLOBAL_STR(str751, "bin %s");
GLOBAL_STR(str752, "expected 'bin' or 'dialect'");
GLOBAL_STR(str753, "shvar");
GLOBAL_STR(str754, "expected a block");
GLOBAL_STR(str755, "Expected name=value");
GLOBAL_STR(str756, "=");
GLOBAL_STR(str757, "Expected name=value");
GLOBAL_STR(str758, "expected a block");
GLOBAL_STR(str759, "Assignment builtin %r not configured");
GLOBAL_STR(str760, "%r ");
GLOBAL_STR(str761, "");
GLOBAL_STR(str762, "command in ");
GLOBAL_STR(str763, "assignment in ");
GLOBAL_STR(str764, "subshell invoked from ");
GLOBAL_STR(str765, "pipeline invoked from ");
GLOBAL_STR(str766, "");
GLOBAL_STR(str767, "Exiting with status %d (%sPID %d)");
GLOBAL_STR(str768, "Redirect filename can't be empty");
GLOBAL_STR(str769, "Redirect descriptor can't be empty");
GLOBAL_STR(str770, "-");
GLOBAL_STR(str771, "-");
GLOBAL_STR(str772, "Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
GLOBAL_STR(str773, "\n");
GLOBAL_STR(str774, "Unknown redirect op");
GLOBAL_STR(str775, "Unknown redirect type");
GLOBAL_STR(str776, "strict_errexit only allows simple commands (got %s). Hint: use 'try'.");
GLOBAL_STR(str777, "strict_errexit only allows a single command.  Hint: use \"run\".");
GLOBAL_STR(str778, "strict_errexit only allows simple commands (got %s). Hint: use 'try'.");
GLOBAL_STR(str779, "ShAssignment builtins don't accept blocks");
GLOBAL_STR(str780, "|& isn't supported");
GLOBAL_STR(str781, "Can't append array to string");
GLOBAL_STR(str782, "Can't append string to array");
...
GLOBAL_STR(str789, "Loop and control flow can't be in different processes");
GLOBAL_STR(str790, "fatal: ");
GLOBAL_STR(str791, "EXIT");
GLOBAL_STR(str792, "trap EXIT");
GLOBAL_STR(str793, "__");
GLOBAL_STR(str794, ":");
GLOBAL_STR(str795, "Invalid argument %r.  Expected a name starting with :");
GLOBAL_STR(str796, "No value provided for param %r");
GLOBAL_STR(str797, "proc %r expected %d arguments, but got %d");
GLOBAL_STR(str798, "Unexpected %r (in function call)");
GLOBAL_STR(str799, "Attempted to exit from completion hook.");
GLOBAL_STR(str800, "Couldn't find terminator for here doc that starts here");
GLOBAL_STR(str801, "\t");
GLOBAL_STR(str802, "Invalid here doc delimiter");
GLOBAL_STR(str803, "+");
GLOBAL_STR(str804, "+");
GLOBAL_STR(str805, "+");
GLOBAL_STR(str806, "%d != %d");
GLOBAL_STR(str807, "array place");
GLOBAL_STR(str808, "Environment binding shouldn't look like an array assignment");
GLOBAL_STR(str809, "+");
GLOBAL_STR(str810, "Expected = in environment binding, got +=");
GLOBAL_STR(str811, "Environment bindings can't contain array literals");
GLOBAL_STR(str812, "procs and shell functions can't be nested");
GLOBAL_STR(str813, "%r was already declared");
GLOBAL_STR(str814, "%r hasn't been declared");
GLOBAL_STR(str815, "Can't modify constant %r");
GLOBAL_STR(str816, "Expected word type %s, got %s");
GLOBAL_STR(str817, "{");
GLOBAL_STR(str818, "}");
GLOBAL_STR(str819, "Invalid token after redirect operator");
GLOBAL_STR(str820, "Space required before (");
GLOBAL_STR(str821, "Unexpected left paren (might need a space before it)");
GLOBAL_STR(str822, "Empty arg list not allowed");
GLOBAL_STR(str823, "TODO: Parse Redirect");
GLOBAL_STR(str824, " ");
GLOBAL_STR(str825, " ");
GLOBAL_STR(str826, "line IDs %d != %d");
GLOBAL_STR(str827, " ");
GLOBAL_STR(str828, "");
GLOBAL_STR(str829, "Unexpected typed args");
GLOBAL_STR(str830, "=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
GLOBAL_STR(str831, "name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
GLOBAL_STR(str832, "Unexpected typed args");
GLOBAL_STR(str833, "Unexpected typed args");
GLOBAL_STR(str834, "Control flow shouldn't have redirects");
GLOBAL_STR(str835, "Control flow shouldn't have environment bindings");
GLOBAL_STR(str836, "Unexpected argument to %r");
GLOBAL_STR(str837, "Invalid word in for loop");
GLOBAL_STR(str838, "Invalid word after for expression");
GLOBAL_STR(str839, "Loop variable name should be a constant");
GLOBAL_STR(str840, "Invalid loop variable name");
GLOBAL_STR(str841, "Unexpected word after for loop variable");
GLOBAL_STR(str842, "Expected ;; or esac");
GLOBAL_STR(str843, "Unexpected word while parsing compound command");
GLOBAL_STR(str844, "Invalid function name");
GLOBAL_STR(str845, "Expected ) in function definition");
GLOBAL_STR(str846, "Invalid KSH-style function name");
GLOBAL_STR(str847, "Unexpected word when parsing command");
GLOBAL_STR(str848, "Unexpected right brace");
GLOBAL_STR(str849, "Unexpected EOF while parsing command");
GLOBAL_STR(str850, "Invalid word while parsing command");
GLOBAL_STR(str851, "Invalid word while parsing command line");
GLOBAL_STR(str852, "Invalid word while parsing command list");
GLOBAL_STR(str853, "Unterminated here doc began here");
GLOBAL_STR(str854, "\\");
GLOBAL_STR(str855, "*");
GLOBAL_STR(str856, "?");
GLOBAL_STR(str857, "[");
...
GLOBAL_STR(str861, "\\?*+{}^$.()|");
GLOBAL_STR(str862, "\\");
GLOBAL_STR(str863, "Unexpected escaped character %r");
GLOBAL_STR(str864, "");
GLOBAL_STR(str865, "");
GLOBAL_STR(str866, "Malformed character class; treating as literal");
GLOBAL_STR(str867, "Got unescaped right bracket");
GLOBAL_STR(str868, "Got unescaped trailing backslash");
GLOBAL_STR(str869, ".|^$()+*?[]{}\\");
GLOBAL_STR(str870, "\\");
GLOBAL_STR(str871, "\\");
GLOBAL_STR(str872, "\\[");
...
GLOBAL_STR(str884, "]");
GLOBAL_STR(str885, "");
GLOBAL_STR(str886, "Error expanding glob %r: %s");
GLOBAL_STR(str887, "-");
GLOBAL_STR(str888, "<Error: unbalanced \\[ and \\]> ");
GLOBAL_STR(str889, "$");
GLOBAL_STR(str890, "#");
GLOBAL_STR(str891, "$");
GLOBAL_STR(str892, "hostname");
GLOBAL_STR(str893, "user");
GLOBAL_STR(str894, "\u0001");
GLOBAL_STR(str895, "\u0002");
GLOBAL_STR(str896, "$");
GLOBAL_STR(str897, "$");
GLOBAL_STR(str898, "u");
GLOBAL_STR(str899, "user");
GLOBAL_STR(str900, "h");
GLOBAL_STR(str901, "hostname");
GLOBAL_STR(str902, ".");
GLOBAL_STR(str903, "H");
GLOBAL_STR(str904, "hostname");
GLOBAL_STR(str905, "s");
GLOBAL_STR(str906, "v");
GLOBAL_STR(str907, "A");
GLOBAL_STR(str908, "%H:%M");
GLOBAL_STR(str909, "D");
GLOBAL_STR(str910, "%X");
GLOBAL_STR(str911, "w");
GLOBAL_STR(str912, "PWD");
GLOBAL_STR(str913, "HOME");
GLOBAL_STR(str914, "<Error: %s>");
GLOBAL_STR(str915, "W");
GLOBAL_STR(str916, "PWD");
GLOBAL_STR(str917, "<Error: PWD is not a string> ");
GLOBAL_STR(str918, "<Error: \\%s not implemented in $PS1> ");
GLOBAL_STR(str919, "$");
GLOBAL_STR(str920, "\\$");
GLOBAL_STR(str921, "Invalid token %r");
GLOBAL_STR(str922, "");
GLOBAL_STR(str923, "");
GLOBAL_STR(str924, "<ERROR: Can't parse PS1: %s>");
GLOBAL_STR(str925, "osh");
GLOBAL_STR(str926, "PS1");
GLOBAL_STR(str927, "$ ");
GLOBAL_STR(str928, "PROMPT_COMMAND");
GLOBAL_STR(str929, "Undefined variable %r");
GLOBAL_STR(str930, "Can't use [] on value of type %s");
GLOBAL_STR(str931, "");
GLOBAL_STR(str932, "Can't use [] on value of type %s");
GLOBAL_STR(str933, "");
GLOBAL_STR(str934, "dynamic place");
GLOBAL_STR(str935, "got invalid place expression");
GLOBAL_STR(str936, "expected a var name.  shopt -s eval_unsafe_arith allows a[i]");
GLOBAL_STR(str937, "Invalid var ref");
GLOBAL_STR(str938, "0x");
GLOBAL_STR(str939, "Invalid hex constant %r");
GLOBAL_STR(str940, "0");
GLOBAL_STR(str941, "Invalid octal constant %r");
GLOBAL_STR(str942, "#");
GLOBAL_STR(str943, "#");
GLOBAL_STR(str944, "Invalid base for numeric constant %r");
GLOBAL_STR(str945, "a");
GLOBAL_STR(str946, "A");
GLOBAL_STR(str947, "@");
GLOBAL_STR(str948, "_");
GLOBAL_STR(str949, "Invalid digits for numeric constant %r");
GLOBAL_STR(str950, "Digits %r out of range for base %d");
GLOBAL_STR(str951, "Parse error in recursive arithmetic");
GLOBAL_STR(str952, "Invalid integer constant %r");
GLOBAL_STR(str953, "Invalid integer constant %r");
GLOBAL_STR(str954, "Invalid integer constant %r");
GLOBAL_STR(str955, "Undefined value in arithmetic context");
GLOBAL_STR(str956, "Expected a value convertible to integer, got %s");
GLOBAL_STR(str957, "0");
GLOBAL_STR(str958, "Divide by zero");
GLOBAL_STR(str959, "Divide by zero");
GLOBAL_STR(str960, "Expected array or assoc in index expression, got %s");
GLOBAL_STR(str961, "Divide by zero");
GLOBAL_STR(str962, "Divide by zero");
GLOBAL_STR(str963, "Exponent can't be less than zero");
GLOBAL_STR(str964, "Associative array keys must be strings: $x 'x' \"$x\" etc.");
GLOBAL_STR(str965, "Invalid place to modify");
GLOBAL_STR(str966, "%s isn't implemented");
GLOBAL_STR(str967, "Invalid regex %r: %s");
GLOBAL_STR(str968, " \t\n");
GLOBAL_STR(str969, "IFS");
GLOBAL_STR(str970, "IFS shouldn't be an array");
GLOBAL_STR(str971, " \t\n");
...
GLOBAL_STR(str976, "\\");
GLOBAL_STR(str977, "\\");
GLOBAL_STR(str978, "Invalid transition from %r with %r");
GLOBAL_STR(str979, "\u00ef\u00bf\u00bd");
GLOBAL_STR(str980, "");
GLOBAL_STR(str981, "Incomplete UTF-8 character");
GLOBAL_STR(str982, "Invalid UTF-8 continuation byte");
GLOBAL_STR(str983, "Invalid start of UTF-8 character");
GLOBAL_STR(str984, "");
GLOBAL_STR(str985, "%s can't have an argument");
GLOBAL_STR(str986, "");
...
GLOBAL_STR(str992, "");
GLOBAL_STR(str993, "<_GlobReplacer regex %r r %r>");
GLOBAL_STR(str994, "(%s)");
GLOBAL_STR(str995, "Error matching regex %r: %s");
GLOBAL_STR(str996, "^");
GLOBAL_STR(str997, "$");
GLOBAL_STR(str998, "\r");
GLOBAL_STR(str999, "<INVALID CR>");
GLOBAL_STR(str1000, "\n");
GLOBAL_STR(str1001, "<INVALID NEWLINE>");
GLOBAL_STR(str1002, " `~!$&*()[]{}\\|;'\"<>?");
GLOBAL_STR(str1003, "Left-hand side of this assignment is invalid");
GLOBAL_STR(str1004, "Token can't be used in prefix position");
GLOBAL_STR(str1005, "Token can't be used in infix position");
GLOBAL_STR(str1006, "Parser expected %s, got %s");
GLOBAL_STR(str1007, "Unexpected end of input");
GLOBAL_STR(str1008, "");
GLOBAL_STR(str1009, "");
GLOBAL_STR(str1010, " \t");
GLOBAL_STR(str1011, "\n");
...
GLOBAL_STR(str1013, "\n");
GLOBAL_STR(str1014, "\n");
GLOBAL_STR(str1015, "BASH_SOURCE");
GLOBAL_STR(str1016, "FUNCNAME");
GLOBAL_STR(str1017, "BASH_LINENO");
GLOBAL_STR(str1018, "0");
GLOBAL_STR(str1019, "0");
GLOBAL_STR(str1020, "\\");
GLOBAL_STR(str1021, "\\\\");
GLOBAL_STR(str1022, "");
GLOBAL_STR(str1023, "");
GLOBAL_STR(str1024, "The length index of a array slice can't be negative: %d");
GLOBAL_STR(str1025, "Can't slice associative arrays");
GLOBAL_STR(str1026, "i");
GLOBAL_STR(str1027, "e");
GLOBAL_STR(str1028, "f");
GLOBAL_STR(str1029, "n");
GLOBAL_STR(str1030, "u");
GLOBAL_STR(str1031, "x");
GLOBAL_STR(str1032, "C");
GLOBAL_STR(str1033, "");
GLOBAL_STR(str1034, "~");
GLOBAL_STR(str1035, "HOME");
GLOBAL_STR(str1036, "Error expanding tilde (e.g. invalid user)");
GLOBAL_STR(str1037, "Can't assign to special variable");
GLOBAL_STR(str1038, "unset variable %r");
GLOBAL_STR(str1039, "warning: ");
GLOBAL_STR(str1040, "-1");
GLOBAL_STR(str1041, "a[i] not allowed without shopt -s eval_unsafe_arith");
GLOBAL_STR(str1042, "Indirect expansion of array");
GLOBAL_STR(str1043, "Indirect expansion of assoc array");
GLOBAL_STR(str1044, "extended globs not supported in ${x//GLOB/}");
GLOBAL_STR(str1045, "");
GLOBAL_STR(str1046, "warning: ");
GLOBAL_STR(str1047, "");
GLOBAL_STR(str1048, "\u0001");
GLOBAL_STR(str1049, "");
GLOBAL_STR(str1050, "\u0002");
GLOBAL_STR(str1051, "");
GLOBAL_STR(str1052, "Can't use @P on %s");
GLOBAL_STR(str1053, " ");
GLOBAL_STR(str1054, "Can't use @Q on %s");
GLOBAL_STR(str1055, "a");
GLOBAL_STR(str1056, "A");
GLOBAL_STR(str1057, "r");
GLOBAL_STR(str1058, "x");
GLOBAL_STR(str1059, "n");
GLOBAL_STR(str1060, "");
GLOBAL_STR(str1061, "Var op %r not implemented");
GLOBAL_STR(str1062, "Can't index string with @");
GLOBAL_STR(str1063, "Can't index string with *");
GLOBAL_STR(str1064, "Can't index string %r with integer");
GLOBAL_STR(str1065, "");
GLOBAL_STR(str1066, "");
GLOBAL_STR(str1067, "$");
GLOBAL_STR(str1068, "Undefined variable %r");
GLOBAL_STR(str1069, "Undefined array %r");
GLOBAL_STR(str1070, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str1071, "Test operation not allowed with ${!array[@]}");
GLOBAL_STR(str1072, "Not implemented");
GLOBAL_STR(str1073, "Illegal array word part (strict_array)");
GLOBAL_STR(str1074, " ");
GLOBAL_STR(str1075, "");
...
GLOBAL_STR(str1078, "|");
GLOBAL_STR(str1079, ")");
GLOBAL_STR(str1080, "Extended globs and arrays can't appear in the same word");
GLOBAL_STR(str1081, "*");
GLOBAL_STR(str1082, "Unexpected array literal");
GLOBAL_STR(str1083, "Unexpected associative array literal");
GLOBAL_STR(str1084, "Can't splice %r");
GLOBAL_STR(str1085, "");
GLOBAL_STR(str1086, "");
GLOBAL_STR(str1087, "Extended glob not allowed in this word");
GLOBAL_STR(str1088, "");
GLOBAL_STR(str1089, "This word should yield a string, but it contains an array");
GLOBAL_STR(str1090, " ");
GLOBAL_STR(str1091, "extended glob not allowed in this word");
GLOBAL_STR(str1092, "");
GLOBAL_STR(str1093, "");
GLOBAL_STR(str1094, "");
GLOBAL_STR(str1095, "");
GLOBAL_STR(str1096, "<Runtime error: %s>");
GLOBAL_STR(str1097, "<I/O error: %s>");
GLOBAL_STR(str1098, "<Ctrl-C>");
GLOBAL_STR(str1099, "");
GLOBAL_STR(str1100, "");
GLOBAL_STR(str1101, "");
GLOBAL_STR(str1102, "");
GLOBAL_STR(str1103, "");
GLOBAL_STR(str1104, "LHS array not allowed in assignment builtin");
GLOBAL_STR(str1105, "+");
GLOBAL_STR(str1106, "+= not allowed in assignment builtin");
GLOBAL_STR(str1107, "-");
GLOBAL_STR(str1108, "+");
GLOBAL_STR(str1109, "f");
GLOBAL_STR(str1110, "F");
GLOBAL_STR(str1111, "");
GLOBAL_STR(str1112, "=");
GLOBAL_STR(str1113, "Invalid variable name %r");
GLOBAL_STR(str1114, "__NO_COMMAND_SUB__");
GLOBAL_STR(str1115, "__NO_PROCESS_SUB__");
GLOBAL_STR(str1116, "Expected : or } in slice");
GLOBAL_STR(str1117, "Pattern in ${x/pat/replace} must not be empty");
GLOBAL_STR(str1118, "Expected } after replacement string, got %s");
GLOBAL_STR(str1119, "Expected } or / to close pattern");
GLOBAL_STR(str1120, "Expected ] to close subscript");
GLOBAL_STR(str1121, "Expected } to close ${");
GLOBAL_STR(str1122, "Expected } to close ${");
GLOBAL_STR(str1123, "Expected a constant argument");
GLOBAL_STR(str1124, "Expected } to close ${");
GLOBAL_STR(str1125, "Expected } to close ${");
GLOBAL_STR(str1126, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1127, "VOp2");
GLOBAL_STR(str1128, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1129, "VOp3");
GLOBAL_STR(str1130, "Expected } to close ${");
GLOBAL_STR(str1131, "Expected } after length expression");
GLOBAL_STR(str1132, "TODO: ${.myproc builtin sub}");
GLOBAL_STR(str1133, "Unexpected token in ${}");
GLOBAL_STR(str1134, "\\");
GLOBAL_STR(str1135, "Strings with backslashes should look like r'\\n' or $'\\n'");
GLOBAL_STR(str1136, "Use \\xhh or \\u{...} instead of octal escapes in Oil strings");
GLOBAL_STR(str1137, "Invalid hex escape in Oil string (must be \\xHH)");
GLOBAL_STR(str1138, "Invalid char escape in C-style string literal");
GLOBAL_STR(str1139, "Unexpected EOF in single-quoted string that began here");
GLOBAL_STR(str1140, "\"");
GLOBAL_STR(str1141, "'");
GLOBAL_STR(str1142, "Unexpected EOF reading extended glob that began here");
GLOBAL_STR(str1143, "Invalid char escape in double quoted string");
GLOBAL_STR(str1144, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1145, "Invalid backtick: use $(cmd) or \\` in Oil strings");
GLOBAL_STR(str1146, "Unexpected EOF reading double-quoted string that began here");
GLOBAL_STR(str1147, "Use $(cmd) instead of backticks (parse_backticks)");
GLOBAL_STR(str1148, "Unexpected EOF while looking for closing backtick");
GLOBAL_STR(str1149, "");
GLOBAL_STR(str1150, "backticks");
GLOBAL_STR(str1151, "Invalid proc name %s");
GLOBAL_STR(str1152, "Unexpected token after arithmetic expression (%s != %s)");
GLOBAL_STR(str1153, "Expected second ) to end arith sub");
GLOBAL_STR(str1154, "Expected second ) to end arith statement");
GLOBAL_STR(str1155, "Expected ; here");
GLOBAL_STR(str1156, "Expected ; here");
GLOBAL_STR(str1157, "Expected ) to end for loop expression");
GLOBAL_STR(str1158, "Expected ( after =");
GLOBAL_STR(str1159, "Unexpected token in array literal");
GLOBAL_STR(str1160, "Expected associative array pair");
GLOBAL_STR(str1161, "Invalid char escape (parse_backslash)");
GLOBAL_STR(str1162, "Unexpected token after array literal");
GLOBAL_STR(str1163, "Unexpected token after array splice");
GLOBAL_STR(str1164, "TODO: @{.myproc builtin sub}");
GLOBAL_STR(str1165, "Literal @ starting a word must be quoted (parse_at_all)");
GLOBAL_STR(str1166, "/");
GLOBAL_STR(str1167, "next_byte %r");
GLOBAL_STR(str1168, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1169, "Unexpected token after @()");
GLOBAL_STR(str1170, "Word has unbalanced { }.  Maybe add a space or quote it like \\{");
GLOBAL_STR(str1171, "Unexpected parts after triple quoted string");
GLOBAL_STR(str1172, "Unexpected token while parsing arithmetic: %r");
GLOBAL_STR(str1173, "Invalid blank line in multiline mode");
GLOBAL_STR(str1174, "r");
GLOBAL_STR(str1175, "Unhandled: %s (%s)");
GLOBAL_STR(str1176, "Invalid var ref");
GLOBAL_STR(str1177, "Expected end of var ref");
GLOBAL_STR(str1178, "Invalid lex state %s");
GLOBAL_STR(str1179, "");
GLOBAL_STR(str1180, "");
GLOBAL_STR(str1181, "");
GLOBAL_STR(str1182, "");
...
GLOBAL_STR(str1186, "");
GLOBAL_STR(str1187, "");
GLOBAL_STR(str1188, "Compound shouldn't be empty");
GLOBAL_STR(str1189, "/");
GLOBAL_STR(str1190, "/");
GLOBAL_STR(str1191, "");
GLOBAL_STR(str1192, "EOF");
GLOBAL_STR(str1193, "typ");
GLOBAL_STR(str1194, "tok");
GLOBAL_STR(str1195, "children");
GLOBAL_STR(str1196, "-");
GLOBAL_STR(str1197, "with %d children");
GLOBAL_STR(str1198, "");
GLOBAL_STR(str1199, "(PNode %s %s %s)");
GLOBAL_STR(str1200, "&");
GLOBAL_STR(str1201, "&amp;");
GLOBAL_STR(str1202, "<");
GLOBAL_STR(str1203, "&lt;");
...
GLOBAL_STR(str1225, "/");
GLOBAL_STR(str1226, " \n\r\t");
GLOBAL_STR(str1227, "Unexpected token in QSN string");
GLOBAL_STR(str1228, "Expected closing single quote in QSN string");
GLOBAL_STR(str1229, "Unexpected data after closing quote");
GLOBAL_STR(str1230, "Unexpected token after QSN string");
GLOBAL_STR(str1231, "\\'\r\n\t\u0000");
GLOBAL_STR(str1232, "$'");
GLOBAL_STR(str1233, "'");
GLOBAL_STR(str1234, "'");
...
GLOBAL_STR(str1246, "\n");
GLOBAL_STR(str1247, "\\n");
GLOBAL_STR(str1248, "\r");
GLOBAL_STR(str1249, "\\r");
GLOBAL_STR(str1250, "\t");
GLOBAL_STR(str1251, "\\t");
GLOBAL_STR(str1252, "\u0000");
GLOBAL_STR(str1253, "\\x00");
GLOBAL_STR(str1254, "\\0");
GLOBAL_STR(str1255, "");
GLOBAL_STR(str1256, "");
GLOBAL_STR(str1257, "");
GLOBAL_STR(str1258, "\\");
...
GLOBAL_STR(str1262, "\n");
GLOBAL_STR(str1263, "\\n");
GLOBAL_STR(str1264, "\r");
GLOBAL_STR(str1265, "\\r");
GLOBAL_STR(str1266, "\t");
GLOBAL_STR(str1267, "\\t");
GLOBAL_STR(str1268, "\u0000");
GLOBAL_STR(str1269, "\\x00");
GLOBAL_STR(str1270, "\\0");
GLOBAL_STR(str1271, "");
GLOBAL_STR(str1272, "!");
GLOBAL_STR(str1273, "--");
GLOBAL_STR(str1274, "--dir");
GLOBAL_STR(str1275, "--exists");
GLOBAL_STR(str1276, "--file");
GLOBAL_STR(str1277, "--symlink");
GLOBAL_STR(str1278, "Expected unary operator, got %r (2 args)");
GLOBAL_STR(str1279, "-a");
GLOBAL_STR(str1280, "-o");
GLOBAL_STR(str1281, "!");
GLOBAL_STR(str1282, "(");
GLOBAL_STR(str1283, ")");
GLOBAL_STR(str1284, "Expected binary operator, got %r (3 args)");
GLOBAL_STR(str1285, "should be invoked as 'test' (simple_test_builtin)");
GLOBAL_STR(str1286, "]");
GLOBAL_STR(str1287, "missing closing ]");
GLOBAL_STR(str1288, "should only have 3 arguments or fewer (simple_test_builtin)");
GLOBAL_STR(str1289, "!");
GLOBAL_STR(str1290, "(");
GLOBAL_STR(str1291, ")");
GLOBAL_STR(str1292, "(test) ");
GLOBAL_STR(str1293, "(test) ");
...
inline Str* fmt28(int a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt68(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt88(Str* a0, int a1, Str* a2) {
  gBuf.reset();
  gBuf.write_const("[ ", 2);
  gBuf.format_s(a0);
...
inline Str* fmt93(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt114(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("-", 1);
  gBuf.format_s(a1);
...
inline Str* fmt133(int a0, int a1) {
  gBuf.reset();
...
class Read : public vm::_Builtin {
 public:
  Read(split::SplitContext* splitter, state::Mem* mem, parse_lib::ParseContext* parse_ctx, cmd_eval::CommandEvaluator* cmd_ev);
...
inline Str* fmt190(int a0, Str* a1, int a2) {
  gBuf.reset();
...
class Globber : public gc_heap::Obj {
 public:
  ...
  void ExpandExtended(Str* glob_pat, Str* fnmatch_pat, List<Str*>* out);
...
inline Str* fmt272(Str* a0, Str* a1, syntax_asdl::word_t* a2) {
  gBuf.reset();
...
inline Str* fmt278(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt282(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt344(Str* a0, Str* a1) {
  gBuf.reset();
...
inline Str* fmt367(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("/", 1);
  gBuf.format_s(a1);
...
Str* ShellExecutor::RunCommandSub(syntax_asdl::command_sub* cs_part) {
  ...
  int err_num;
  int status;
  StackRoots _roots({&cs_part, &node, &tok, &cat_word, &p, &chunks});
  ...
  if (this->exec_opts->command_sub_errexit()) {
    if (status != 0) {
      throw Alloc<error::ErrExit>(fmt28(status, ui::CommandType(node)), cs_part->left_token->span_id, status);
    }
  }
  else {
...
int Main(Str* lang, args::Reader* arg_r, Dict<Str*, Str*>* environ, bool login_shell, pyutil::_ResourceLoader* loader, void* line_input) {
  ...
  builtins->set(builtin_i::read, Alloc<builtin_misc::Read>(splitter, mem, parse_ctx, cmd_ev));
  ...
  if (WIFSIGNALED(status)) {
    ...
    if (WIFEXITED(status)) {
      ...
      if (WIFSTOPPED(status)) {
        println_stderr(str205);
        println_stderr(fmt56(pid));
...
runtime_asdl::cmd_value__Argv* MakeBuiltinArgv(List<Str*>* argv1) {
  ...
  argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str207});
  argv->extend(argv1);
  return Alloc<cmd_value::Argv>(argv, list_repeat(runtime::NO_SPID, len(argv)), nullptr);
}
...
int Main(Str* lang, args::Reader* arg_r, Dict<Str*, Str*>* environ, bool login_shell, pyutil::_ResourceLoader* loader, void* line_input) {
  ...
  arg_r->Next();
  try {
    attrs = flag_spec::ParseMore(str208, arg_r);
  }
  catch (error::Usage* e) {
    println_stderr(fmt57(e->msg));
    return 2;
  }
  flag = Alloc<arg_types::main>(attrs->attrs);
  arena = Alloc<alloc::Arena>();
  ...
  help_builtin = Alloc<builtin_misc::Help>(loader, errfmt);
  if (flag->help) {
    help_builtin->Run(MakeBuiltinArgv(Alloc<List<Str*>>(std::initializer_list<Str*>{fmt58(lang)})));
    return 0;
  }
  if (flag->version) {
    pyutil::ShowAppVersion(str211, loader);
    return 0;
  }
  no_str = nullptr;
  debug_stack = Alloc<List<state::DebugFrame*>>();
  if (arg_r->AtEnd()) {
    ...
    dollar0 = arg_r->Peek();
    frame0 = Alloc<state::DebugFrame>(dollar0, str212, no_str, state::LINE_ZERO, 0, 0);
    debug_stack->append(frame0);
  }
  frame1 = Alloc<state::DebugFrame>(no_str, no_str, no_str, runtime::NO_SPID, 0, 0);
  debug_stack->append(frame1);
  ...
  if (str_equals(lang, str213)) {
    mutable_opts->SetShoptOption(str214, true);
  }
  builtin_pure::SetShellOpts(mutable_opts, attrs->opt_changes, attrs->shopt_changes);
  aliases = Alloc<Dict<Str*, Str*>>();
  oil_grammar = nullptr;
  ...
  parse_ctx->Init_OnePassParse(flag->one_pass_parse);
  comp_arena = Alloc<alloc::Arena>();
  comp_arena->PushSource(Alloc<source::Unused>(str216));
  trail1 = Alloc<parse_lib::Trail>();
  comp_ctx = Alloc<parse_lib::ParseContext>(comp_arena, parse_opts, aliases, oil_grammar);
  comp_ctx->Init_Trail(trail1);
  comp_ctx->Init_OnePassParse(true);
  hist_arena = Alloc<alloc::Arena>();
  hist_arena->PushSource(Alloc<source::Unused>(str217));
  trail2 = Alloc<parse_lib::Trail>();
  hist_ctx = Alloc<parse_lib::ParseContext>(hist_arena, parse_opts, aliases, oil_grammar);
  hist_ctx->Init_Trail(trail2);
  cmd_deps = Alloc<cmd_eval::Deps>();
  ...
  my_pid = posix::getpid();
  debug_path = str218;
  debug_dir = environ->get(str219);
  if (flag->debug_file != nullptr) {
    debug_path = flag->debug_file;
  }
  else {
    if (debug_dir != nullptr) {
      debug_path = os_path::join(debug_dir, fmt59(my_pid));
    }
  }
  if (len(debug_path)) {
    throw Alloc<NotImplementedError>();
  ...
  cmd_deps->debug_f = debug_f;
  if (len(debug_path)) {
    println_stderr(fmt60(debug_path));
  }
  if (flag->xtrace_to_debug_file) {
    trace_f = debug_f;
  }
  ...
  waiter = Alloc<process::Waiter>(job_state, exec_opts, sig_state, tracer);
  fd_state->waiter = waiter;
  interp = environ->get(str222, str223);
  search_path = Alloc<state::SearchPath>(mem);
  ext_prog = Alloc<process::ExternalProgram>(interp, fd_state, errfmt, debug_f);
  splitter = Alloc<split::SplitContext>(mem);
  crash_dump_dir = environ->get(str224, str225);
  cmd_deps->dumper = Alloc<dev::CrashDumper>(crash_dump_dir);
  dir_stack = Alloc<state::DirStack>();
  builtins = Alloc<Dict<int, vm::_Builtin*>>();
  modules = Alloc<Dict<Str*, bool>>();
  ...
  if (flag->c != nullptr) {
    ...
    if (flag->i) {
      ...
      if (script_name == nullptr) {
        stdin = mylib::Stdin();
        arena->PushSource(Alloc<source::Stdin>(str226));
        line_reader = Alloc<reader::FileLineReader>(stdin, arena);
      }
      else {
        arena->PushSource(Alloc<source::MainFile>(script_name));
        try {
          ...
          println_stderr(fmt61(script_name, pyutil::strerror(e)));
          return 1;
        }
        line_reader = Alloc<reader::FileLineReader>(f, arena);
      }
...
Str* SearchPath::Lookup(Str* name, bool exec_required) {
  ...
  val = this->mem->GetValue(str233);
  UP_val = val;
  if (val->tag_() == value_e::Str) {
    value__Str* val = static_cast<value__Str*>(UP_val);
    path_list = val->s->split(str234);
  }
  else {
...
void MutableOpts::Init() {
  ...
  UP_shellopts = this->mem->GetValue(str238);
...
void MutableOpts::SetOption(Str* opt_name, bool b) {
  ...
  UP_val = this->mem->GetValue(str242);
  value__Str* val = static_cast<value__Str*>(UP_val);
  shellopts = val->s;
  if (b) {
    if (!str_contains(shellopts, opt_name)) {
      new_val = Alloc<value::Str>(fmt67(shellopts, opt_name));
      this->mem->InternalSetGlobal(str244, new_val);
    }
  }
  else {
    if (str_contains(shellopts, opt_name)) {
      names = Alloc<List<Str*>>();
      for (ListIter<Str*> it(shellopts->split(str245)); !it.Done(); it.Next()) {
        Str* n = it.Value();
        if (!(str_equals(n, opt_name))) {
          names->append(n);
        }
      }
      new_val = Alloc<value::Str>(str246->join(names));
      this->mem->InternalSetGlobal(str247, new_val);
    }
  }
}
...
void MutableOpts::ShowOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    b = this->Get(opt_num);
    print(fmt68(b ? str252 : str253, opt_name));
  }
}
...
void MutableOpts::ShowShoptOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<int> it(opt_nums); !it.Done(); it.Next()) {
    ...
    print(fmt70(b ? str259 : str260, consts::OptionName(opt_num)));
  }
}
...
void _InitDefaults(state::Mem* mem) {
  ...
  SetGlobalString(mem, str263, split::DEFAULT_IFS);
  SetGlobalString(mem, str264, str(posix::getuid()));
  SetGlobalString(mem, str265, str(posix::geteuid()));
  SetGlobalString(mem, str266, str(posix::getppid()));
  SetGlobalString(mem, str267, libc::gethostname());
  SetGlobalString(mem, str268, pyos::OsType());
  SetGlobalString(mem, str269, str270);
  SetGlobalString(mem, str271, str272);
  SetGlobalString(mem, str273, _READLINE_DELIMS);
}
...
void _InitVarsFromEnv(state::Mem* mem, Dict<Str*, Str*>* environ) {
  ...
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str275, str276);
  }
  mem->SetValue(Alloc<lvalue::Named>(str277), nullptr, scope_e::GlobalOnly, SetReadOnly);
  val = mem->GetValue(str278);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str279, _GetWorkingDir());
  }
  mem->SetValue(Alloc<lvalue::Named>(str280), nullptr, scope_e::GlobalOnly, SetExport);
}
...
void InitMem(state::Mem* mem, Dict<Str*, Str*>* environ, Str* version_str) {
  ...
  SetGlobalString(mem, str281, version_str);
  _InitDefaults(mem);
  _InitVarsFromEnv(mem, environ);
  val = mem->GetValue(str282);
...
void InitInteractive(state::Mem* mem) {
  ...
  if (mem->GetValue(str283)->tag_() == value_e::Undef) {
...
Mem::Mem(Str* dollar0, List<Str*>* argv, alloc::Arena* arena, List<state::DebugFrame*>* debug_stack) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Mem)) {
  ...
  this->line_num = Alloc<value::Str>(str286);
...
Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> Mem::_ResolveNameOrRef(Str* name, runtime_asdl::scope_t which_scopes, bool is_setref, List<Str*>* ref_trail) {
  ...
  if (ref_trail == nullptr) {
    ...
    if (list_contains(ref_trail, new_name)) {
      e_die(fmt74(str298->join(ref_trail)));
    }
  }
  ...
  switch (lval->tag_()) {
    case lvalue_e::Named: {
      ...
      if (keyword_id == Id::KW_SetRef) {
        lval->name = str_concat(str299, lval->name);
      }
    ...
    case lvalue_e::Indexed: {
      ...
      e_die(fmt78(ui::ValType(cell->val)), left_spid);
    }
      break;
    case lvalue_e::Keyed: {
      lvalue__Keyed* lval = static_cast<lvalue__Keyed*>(UP_lval);
...
runtime_asdl::value_t* Mem::GetValue(Str* name, runtime_asdl::scope_t which_scopes) {
  ...
  if ((str_equals(name, str310) || str_equals(name, str311))) {
  ...
  switch (lval->tag_()) {
    ...
    case lvalue_e::Indexed: {
      ...
      if (val->tag_() != value_e::MaybeStrArray) {
        throw Alloc<error::Runtime>(fmt81(var_name));
      }
      value__MaybeStrArray* val = static_cast<value__MaybeStrArray*>(UP_val);
      strs = val->strs;
      n = len(strs);
...
Str* GetString(state::Mem* mem, Str* name) {
  ...
  switch (val->tag_()) {
    ...
    case value_e::Str: {
      ...
      break;
    default: {
      throw Alloc<error::Runtime>(fmt83(name));
    }
  }
}
...
int GetInteger(state::Mem* mem, Str* name) {
  ...
  val = mem->GetValue(name);
  if (val->tag_() != value_e::Str) {
    throw Alloc<error::Runtime>(fmt84(name, ui::ValType(val)));
  }
  ...
  try {
    ...
    throw Alloc<error::Runtime>(fmt85(name, s));
  }
  return i;
}
...
Str* PrettyDir(Str* dir_name, Str* home_dir) {
  ...
  if (home_dir != nullptr) {
    if ((str_equals(dir_name, home_dir) or dir_name->startswith(str_concat(home_dir, str328)))) {
      return str_concat(str329, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    StackRoots _for({&c  });
    f->write(str_equals(c, str332) ? str333 : str334);
  }
  f->write(str335);
  f->write(str_repeat(str336, (length - 1)));
  f->write(str337);
}
...
Str* GetLineSourceString(alloc::Arena* arena, int line_id, bool quote_filename) {
  ...
  StackRoots _roots({&arena, &src, &UP_src, &s, &span, &outer_source, &var_name, &span2});
  ...
  switch (src->tag_()) {
    ...
    case source_e::ArgvWord: {
      ...
      if (src->span_id == runtime::NO_SPID) {
        ...
        s = fmt88(src->what, line_num, outer_source);
      }
    }
      break;
    case source_e::Variable: {
      source__Variable* src = static_cast<source__Variable*>(UP_src);
      var_name = src->var_name != nullptr ? src->var_name : str344;
      s = fmt89(var_name);
    }
      break;
    case source_e::Alias: {
...
void PrettyPrintError(error::_ErrorWithLocation* err, alloc::Arena* arena) {
  PrettyPrintError(err, arena, str350);
}
...
void ErrorFormatter::Print_(Str* msg, int span_id) {
  ...
  _PrintWithOptionalSpanId(str351, msg, span_id, this->arena);
}
...
void PrintAst(syntax_asdl::command_t* node, arg_types::main* flag) {
  ...
  if (maybe_str_equals(flag->ast_format, str353)) {
    println_stderr(str354);
  }
  else {
    f = mylib::Stdout();
    afmt = flag->ast_format;
    if ((maybe_str_equals(afmt, str355) || maybe_str_equals(afmt, str356))) {
...
void _Attributes::Set(Str* name, runtime_asdl::value_t* val) {
  ...
  name = name->replace(str362, str363);
...
bool SetAttachedBool::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  if (attached_arg != nullptr) {
    if ((str_equals(attached_arg, str379) || str_equals(attached_arg, str380) || str_equals(attached_arg, str381) || str_equals(attached_arg, str382))) {
      b = false;
    }
    else {
...
bool SetOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str388);
...
bool SetNamedOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str389);
  arg_r->Next();
  arg = arg_r->Peek();
  if (arg == nullptr) {
...
args::_Attributes* Parse(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str393)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if ((len(spec->actions_long) and arg->startswith(str394))) {
      pos = arg->find(str395, 2);
      if (pos == -1) {
        suffix = nullptr;
      ...
      if ((arg->startswith(str397) and len(arg) > 1)) {
        n = len(arg);
        for (int i = 1; i < n; ++i) {
          ch = arg->index(i);
          if (str_equals(ch, str398)) {
            ch = str399;
          }
          if (list_contains(spec->plus_flags, ch)) {
            out->Set(ch, Alloc<value::Str>(str400));
            continue;
          }
        ...
        if ((len(spec->plus_flags) and (arg->startswith(str403) and len(arg) > 1))) {
          n = len(arg);
          for (int i = 1; i < n; ++i) {
            ch = arg->index(i);
            if (list_contains(spec->plus_flags, ch)) {
...
args::_Attributes* ParseLikeEcho(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    chars = arg->slice(1);
    if ((arg->startswith(str407) and len(chars))) {
      done = false;
...
args::_Attributes* ParseMore(flag_spec::_FlagSpecAndMore* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str408)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if (arg->startswith(str409)) {
    ...
    if (((arg->startswith(str411) or arg->startswith(str412)) and len(arg) > 1)) {
      char0 = arg->index(0);
...
int LineLexer::GetSpanIdForEof() {
  int line_id;
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str416, 0);
  }
  else {
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str418, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = Alloc<Token>(id_, span_id, str419);
      return t;
    }
...
lexer::Lexer* ParseContext::MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = Alloc<lexer::LineLexer>(str421, this->arena);
    ...
    if (n == 1) {
      ...
      switch (arg->tag_()) {
        ...
        case expr_e::CommandSub: {
          ...
          break;
        default: {
          e_usage(fmt100(), arg_list->spids->index(0));
        }
      }
    }
    else {
...
int _Classify(grammar::Grammar* gr, syntax_asdl::Token* tok) {
  ...
  type_str = tok->id == Id::Unknown_Tok ? str429 : fmt102(ui::PrettyId(tok->id));
  p_die(fmt103(type_str), tok);
}
...
Tuple2<pnode::PNode*, syntax_asdl::Token*> ExprParser::Parse(lexer::Lexer* lexer, int start_symbol) {
  ...
  try {
    ...
    p_die(fmt104(ui::PrettyId(e->tok->id)), e->tok);
  }
...
GLOBAL_LIST(Str*, 12, POSIX_CLASSES, {str433 COMMA str434 COMMA str435 COMMA str436 COMMA str437 COMMA str438 COMMA str439 COMMA str440 COMMA str441 COMMA str442 COMMA str443 COMMA str444});
Str* RANGE_POINT_TOO_LONG = str445;
int NT_OFFSET = 256;
...
syntax_asdl::expr_t* Transformer::_Tuple(List<pnode::PNode*>* children) {
  ...
  if (n == 2) {
    p_die(fmt105(), children->index(1)->tok);
  }
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw Alloc<NotImplementedError>(str447);
  }
  if (id0 == Id::Op_LBracket) {
    elts = Alloc<List<syntax_asdl::expr_t*>>();
    for (int i = 0; i < n; i += 2) {
  ...
  for (int i = 0; i < n; i += 2) {
    ...
    if (tag == expr_e::Var) {
      ...
      if ((tag == place_expr_e::Var || tag == place_expr_e::Subscript || tag == place_expr_e::Attribute)) {
        ...
        p_die(fmt107(), p->tok ? p->tok : nullptr);
      }
    }
  }
  return places;
  ...
  while (i < n) {
    ...
    if ((prefix and prefix->id == Id::Expr_At)) {
      ...
      if (typ == nullptr) {
        ...
        if ((typ->val != str452 && typ->val != str453)) {
          p_die(fmt108(), typ);
        }
...
syntax_asdl::re_t* Transformer::_NameInRegex(syntax_asdl::Token* negated_tok, syntax_asdl::Token* tok) {
  ...
  val = tok->val;
  if (maybe_str_equals(val, str456)) {
    if (negated_tok) {
      p_die(fmt109(), tok);
    }
    return tok;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((str_equals(tok->val, str461) || str_equals(tok->val, str462) || str_equals(tok->val, str463))) {
        return tok;
      }
      p_die(fmt113(tok->val), tok);
    }
...
void _ClassLiteralToPosixEre(syntax_asdl::class_literal_term_t* term, List<Str*>* parts) {
  ...
  if (tag == class_literal_term_e::CodePoint) {
    ...
    if (code_point < 128) {
      ...
      e_die(fmt115(code_point), term->spid);
    }
    return ;
  }
  if (tag == class_literal_term_e::PerlClass) {
    ...
    if (term->negated) {
      e_die(fmt116(), term->negated->span_id);
    }
    else {
      pat = fmt117(chars);
    }
...
void AsPosixEre(syntax_asdl::re_t* node, List<Str*>* parts) {
  ...
  if (tag == re_e::Repeat) {
    ...
    if (op_tag == re_repeat_e::Num) {
      ...
      parts->append(fmt121(op->times->val));
      return ;
    }
    if (op_tag == re_repeat_e::Range) {
      re_repeat__Range* op = static_cast<re_repeat__Range*>(UP_op);
      lower = op->lower ? op->lower->val : str480;
      upper = op->upper ? op->upper->val : str481;
      parts->append(fmt122(lower, upper));
      return ;
    }
...
syntax_asdl::bool_expr_t* BoolParser::ParseForBuiltin() {
  ...
  if (this->bool_id != Id::Eof_Real) {
    p_die(fmt129(word_::Pretty(this->cur_word)), this->cur_word);
  }
  return node;
}
...
syntax_asdl::bool_expr_t* BoolParser::ParseFactor() {
  ...
  p_die(fmt132(ui::PrettyId(this->bool_id)), this->cur_word);
}
...
Str* _RangeParser::_Eat(int token_type) {
  ...
  if (this->token_type != token_type) {
    throw Alloc<_NotARange>(fmt133(token_type, this->token_type));
  }
  val = this->token_val;
  this->_Next();
  return val;
...
syntax_asdl::word_part__BracedRange* _RangeParser::Parse() {
  ...
  if (this->token_type == Id::Range_Int) {
    ...
    if (start < end) {
      ...
      if (part->step <= 0) {
        p_die(fmt135(part->step), this->span_id);
      }
    }
    else {
      if (start > end) {
        ...
        if (part->step >= 0) {
          p_die(fmt136(part->step), this->span_id);
        }
      }
      else {
        part->step = 1;
    ...
    if (this->token_type == Id::Range_Char) {
      ...
      if (upper1 != upper2) {
        p_die(fmt139(), this->span_id);
      }
    }
    else {
      throw Alloc<_NotARange>(str506);
    }
  }
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  flag = attrs->attrs;
  tmp_g = flag->get(str509);
  tmp_a = flag->get(str510);
  tmp_A = flag->get(str511);
  ...
  flag_A = (tmp_A and tmp_A->tag_() == value_e::Bool) ? static_cast<value__Bool*>(tmp_A)->b : false;
  tmp_n = flag->get(str512);
  tmp_r = flag->get(str513);
  tmp_x = flag->get(str514);
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if ((maybe_str_equals(flag_n, str516) and !cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_n, str517) and cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str518) and !cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str519) and cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str520) and !cell->exported)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str521) and cell->exported)) {
      continue;
    }
    ...
    if (print_flags) {
      ...
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str528, str529->join(flags), str530, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str531, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (has_holes) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str534, name, str535, str(i), str536, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str538, str539->join(body), str540}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str542, key_quoted, str543, value_quoted}));
          }
          if (len(body) > 0) {
...
int Export::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r->Next();
  attrs = flag_spec::Parse(str548, arg_r);
...
int NewVar::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  flags = 0;
  if (maybe_str_equals(arg->x, str557)) {
    flags |= state::SetExport;
  }
  if (maybe_str_equals(arg->r, str558)) {
    flags |= state::SetReadOnly;
  }
  if (maybe_str_equals(arg->n, str559)) {
...
int Eval::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->exec_opts->simple_eval_builtin()) {
    Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str567);
    code_str = tup1.at0();
    eval_spid = tup1.at1();
    if (!arg_r->AtEnd()) {
      e_usage(str568);
    ...
    code_str = str569->join(arg_r->Rest());
    eval_spid = cmd_val->arg_spids->index(0);
  }
  line_reader = reader::StringLineReader(code_str, this->arena);
  c_parser = this->parse_ctx->MakeOshParser(line_reader);
  src = Alloc<source::ArgvWord>(str570, eval_spid);
  {  // with
    dev::ctx_Tracer ctx(this->tracer, str571, nullptr);
...
int Source::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str572, cmd_val);
  arg_r = tup2.at1();
  path = arg_r->Peek();
  if (path == nullptr) {
    e_usage(str573);
  ...
  try {
    ...
    this->errfmt->Print_(fmt146(path, pyutil::strerror(e)), cmd_val->arg_spids->index(1));
    return 1;
  }
  try {
    try {
      ...
      c_parser = this->parse_ctx->MakeOshParser(line_reader);
      {  // with
        dev::ctx_Tracer ctx(this->tracer, str575, cmd_val->argv);
...
int Command::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup3 = flag_spec::ParseCmdVal(str576, cmd_val);
  attrs = tup3.at0();
  arg_r = tup3.at1();
...
int Builtin::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (to_run == consts::NO_INDEX) {
    ...
    if (consts::LookupAssignBuiltin(name) != consts::NO_INDEX) {
      this->errfmt->Print_(str577, span_id);
    }
    else {
      this->errfmt->Print_(fmt147(name), span_id);
    }
    return 1;
  }
...
int RunProc::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str579, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
  ...
  spids = tup6.at1();
  if (len(argv) == 0) {
    throw Alloc<error::Usage>(str580, runtime::NO_SPID);
  }
  name = argv->index(0);
  if (!dict_contains(this->procs, name)) {
    this->errfmt->StderrLine(fmt148(name));
    return 1;
  }
...
int Try::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup7 = flag_spec::ParseCmdVal(str582, cmd_val);
  attrs = tup7.at0();
  arg_r = tup7.at1();
  ...
  if ((arg->allow_status_01 and (status != 0 && status != 1))) {
    if (failure_spid != runtime::NO_SPID) {
      this->errfmt->Print_(str584, failure_spid);
      this->errfmt->StderrLine(str585);
    }
    throw Alloc<error::ErrExit>(fmt150(status), spids->index(0), status);
  }
  if (arg->assign != nullptr) {
    var_name = arg->assign;
    if (var_name->startswith(str587)) {
...
List<Tuple2<Str*, Str*>*>* _ResolveNames(List<Str*>* names, Dict<Str*, runtime_asdl::Proc*>* funcs, Dict<Str*, Str*>* aliases, state::SearchPath* search_path) {
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if (dict_contains(funcs, name)) {
      kind = (Alloc<Tuple2<Str*, Str*>>(str588, name));
    }
    else {
      if (dict_contains(aliases, name)) {
        kind = (Alloc<Tuple2<Str*, Str*>>(str589, name));
      }
      else {
        if (consts::LookupNormalBuiltin(name) != 0) {
          kind = (Alloc<Tuple2<Str*, Str*>>(str590, name));
        }
        else {
              ...
              if (consts::IsControlFlow(name)) {
                ...
                if (consts::IsKeyword(name)) {
                  ...
                  if (resolved == nullptr) {
                    ...
                    kind = (Alloc<Tuple2<Str*, Str*>>(str595, resolved));
                  }
                }
              }
            }
...
int Type::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseCmdVal(str596, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  for (ListIter<Tuple2<Str*, Str*>*> it(r); !it.Done(); it.Next()) {
    ...
    if (kind == nullptr) {
      if (!arg->t) {
        this->errfmt->StderrLine(fmt151(name));
      }
      status = 1;
    }
    else {
      if (arg->t) {
        ...
        if (arg->p) {
          if (str_equals(kind, str598)) {
            print(name);
          }
        }
        else {
          if (arg->P) {
            if (str_equals(kind, str599)) {
              print(name);
            }
            else {
  ...
  while (bytes_left > 0) {
    ...
    if (n < 0) {
      if (err_num == EINTR) {
        ...
        e_die(fmt153(posix::strerror(err_num)), 2);
      }
    }
    else {
      if (n == 0) {
  ...
  while (true) {
    ...
    if (ch < 0) {
      if (err_num == EINTR) {
        ...
        e_die(fmt154(posix::strerror(err_num)), 2);
      }
    }
    else {
  ...
  while (true) {
    ...
    if (ch < 0) {
      if (err_num == EINTR) {
        ...
        e_die(fmt155(posix::strerror(err_num)), 2);
      }
    }
    else {
      if (ch == pyos::EOF_SENTINEL) {
  ...
  while (true) {
    ...
    if (n < 0) {
      if (err_num == EINTR) {
        ...
        e_die(fmt156(posix::strerror(err_num)), 2);
      }
    }
    else {
      if (n == 0) {
...
Read::Read(split::SplitContext* splitter, state::Mem* mem, parse_lib::ParseContext* parse_ctx, cmd_eval::CommandEvaluator* cmd_ev) {
...
int MapFile::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  while (true) {
    ...
    if ((arg->t and line->endswith(str630))) {
      line = line->slice(0, -1);
    }
    lines->append(line);
  }
...
int Cd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str631, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  ...
  arg_spid = tup16.at1();
  if (dest_dir == nullptr) {
    val = this->mem->GetValue(str632);
    try {
      dest_dir = state::GetString(this->mem, str633);
    }
    catch (error::Runtime* e) {
  ...
  if (str_equals(dest_dir, str634)) {
    try {
      dest_dir = state::GetString(this->mem, str635);
      print(dest_dir);
    }
    catch (error::Runtime* e) {
      this->errfmt->Print_(e->UserErrorString());
  ...
  try {
    pwd = state::GetString(this->mem, str636);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    return 1;
  ...
  state::ExportGlobalString(this->mem, str638, real_dest_dir);
  ...
  if (block) {
    ...
    state::ExportGlobalString(this->mem, str639, pwd);
...
int Pushd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  state::ExportGlobalString(this->mem, str646, dest_dir);
...
bool _PopDirStack(state::Mem* mem, state::DirStack* dir_stack, ui::ErrorFormatter* errfmt) {
  ...
  state::SetGlobalString(mem, str649, dest_dir);
  mem->SetPwd(dest_dir);
  return true;
}
...
int Popd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  _PrintDirStack(this->dir_stack, SINGLE_LINE, state::MaybeString(this->mem, str651));
  return 0;
}
...
int Dirs::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup17 = flag_spec::ParseCmdVal(str652, cmd_val);
  attrs = tup17.at0();
  arg_r = tup17.at1();
  arg = Alloc<arg_types::dirs>(attrs->attrs);
  home_dir = state::MaybeString(this->mem, str653);
  style = SINGLE_LINE;
  if (arg->l) {
    home_dir = nullptr;
  }
...
int Pwd::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup18 = flag_spec::ParseCmdVal(str654, cmd_val);
  attrs = tup18.at0();
  arg_r = tup18.at1();
...
List<Str*>* Help::_Groups() {
  ...
  contents = this->loader->Get(str655);
...
int Help::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup19 = flag_spec::ParseCmdVal(str656, cmd_val);
  attrs = tup19.at0();
  arg_r = tup19.at1();
...
syntax_asdl::printf_part_t* _FormatStringParser::_ParseFormatStr() {
  ...
  if ((this->token_type == Id::Format_Type || this->token_type == Id::Format_Time)) {
    ...
    if (str_contains(str663, part->type->val)) {
      p_die(fmt166(), part->type);
    }
    if (maybe_str_equals(part->type->val, str665)) {
    ...
    for (ListIter<syntax_asdl::printf_part_t*> it(parts); !it.Done(); it.Next()) {
      ...
      if (part->tag_() == printf_part_e::Literal) {
        ...
        if (part->tag_() == printf_part_e::Percent) {
          ...
          if (str_equals(typ, str676)) {
            ...
            if (str_equals(typ, str677)) {
              ...
              if (str_equals(typ, str678)) {
                ...
                s = str679->join(c_parts);
              }
              else {
                if ((part->type->id == Id::Format_Time or str_contains(str680, typ))) {
                  try {
                    d = to_int(s);
                  }
                  catch (ValueError*) {
                    if ((len(s) >= 1 and str_contains(str681, s->index(0)))) {
                  ...
                  if (part->type->id == Id::Format_Time) {
                    ...
                    if ((d < 0 and str_contains(str685, typ))) {
                    ...
                    zero_pad = 0;
                    if ((width >= 0 and list_contains(flags, str690))) {
                      zero_pad = 1;
                    }
                    else {
                    ...
                    if (zero_pad) {
                      negative = str_equals(s->index(0), str691);
                      if (negative) {
                        digits = s->slice(1);
                        sign = str692;
                        if (zero_pad == 1) {
                      ...
                      s = str_concat(sign, digits->rjust(n, str694));
                    }
                  }
                }
                else {
          ...
          if (width >= 0) {
            if (list_contains(flags, str695)) {
              s = s->ljust(width, str696);
            }
            else {
              s = s->rjust(width, str697);
            }
          }
          out->append(s);
        }
...
int Printf::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup1 = flag_spec::ParseCmdVal(str698, cmd_val);
  attrs = tup1.at0();
  arg_r = tup1.at1();
  arg = Alloc<arg_types::printf>(attrs->attrs);
  Tuple2<Str*, int> tup2 = arg_r->ReadRequired2(str699);
  fmt = tup2.at0();
  fmt_spid = tup2.at1();
  ...
  if (dict_contains(this->parse_cache, fmt)) {
    ...
    {  // with
      alloc::ctx_Location ctx(arena, Alloc<source::ArgvWord>(str700, fmt_spid));
...
int Alias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str702, cmd_val);
  arg_r = tup0.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup1 = mylib::split_once(arg, str704);
    name = tup1.at0();
    alias_exp = tup1.at1();
...
int UnAlias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str707, cmd_val);
  arg_r = tup2.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
    e_usage(str708);
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  arg = flag_spec::ParseMore(str711, arg_r);
  if (arg->show_options) {
...
int Shopt::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str712, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
...
int Hash::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str714, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
...
Dict<Str*, bool>* _ParseOptSpec(Str* spec_str) {
  ...
  while (true) {
    ...
    if (str_equals(spec_str->index(i), str717)) {
      spec->set(ch, true);
      i += 1;
    }
  }
...
int GetOptsState::_OptInd() {
  int result;
  try {
    result = state::GetInteger(this->mem, str718);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    result = -1;
...
void GetOptsState::IncIndex() {
  state::BuiltinSetString(this->mem, str719, str((this->_optind + 1)));
}

void GetOptsState::SetArg(Str* optarg) {
  StackRoots _roots({&optarg});

  state::BuiltinSetString(this->mem, str720, optarg);
}

void GetOptsState::Fail() {
  state::BuiltinSetString(this->mem, str721, str722);
}
...
Tuple2<int, Str*> _GetOpts(Dict<Str*, bool>* spec, List<Str*>* argv, builtin_pure::GetOptsState* my_state, ui::ErrorFormatter* errfmt) {
  ...
  if (current == nullptr) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str723));
  }
  if ((!current->startswith(str724) or str_equals(current, str725))) {
    my_state->Fail();
  ...
  if (!dict_contains(spec, flag_char)) {
    return (Tuple2<int, Str*>(0, str727));
  }
  if (spec->index(flag_char)) {
    if (more_chars) {
      ...
      if (optarg == nullptr) {
        ...
        println_stderr(fmt182(str730->join(tmp)));
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  spec_str = arg_r->ReadRequired(str733);
  Tuple2<Str*, int> tup7 = arg_r->ReadRequired2(str734);
  var_name = tup7.at0();
  var_spid = tup7.at1();
...
int Echo::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseLikeEcho(str736, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  if (arg->e) {
    ...
    for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
      ...
      new_argv->append(str737->join(parts));
      if (backslash_c) {
        break;
      }
    }
...
int Module::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseCmdVal(str741, cmd_val);
  arg_r = tup11.at1();
  Tuple2<Str*, int> tup12 = arg_r->ReadRequired2(str742);
  name = tup12.at0();
  if (dict_contains(this->modules, name)) {
    if (this->exec_opts->redefine_module()) {
      this->errfmt->StderrLine(fmt184(name));
      return 0;
    }
    else {
      return 1;
...
int Use::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_spid = tup13.at1();
  if (arg == nullptr) {
    throw Alloc<error::Usage>(str744, runtime::NO_SPID);
  }
  arg_r->Next();
  if (str_equals(arg, str745)) {
    Tuple2<Str*, int> tup14 = arg_r->Peek2();
    expected = tup14.at0();
    e_spid = tup14.at1();
    if (expected == nullptr) {
      throw Alloc<error::Usage>(str746, runtime::NO_SPID);
    }
    UP_actual = this->mem->GetValue(str747, scope_e::Dynamic);
  ...
  throw Alloc<error::Usage>(str752, arg_spid);
}
...
int Shvar::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseCmdVal(str753, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  block = typed_args::GetOneBlock(cmd_val->typed_args);
  if (!block) {
    throw Alloc<error::Usage>(str754, runtime::NO_SPID);
  }
  ...
  for (ListIter<Str*> it(args); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup17 = mylib::split_once(arg, str756);
    name = tup17.at0();
    s = tup17.at1();
    if (s == nullptr) {
      throw Alloc<error::Usage>(str757, arg_spids->index(i));
    }
...
void CommandEvaluator::_CheckStatus(int status, syntax_asdl::command_t* node, int blame_spid) {
  ...
  if ((this->exec_opts->errexit() and status != 0)) {
    ...
    throw Alloc<error::ErrExit>(fmt190(status, reason, posix::getpid()), span_id, status);
  }
}
  ...
  switch (arg->tag_()) {
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        filename = val->s;
        if (len(filename) == 0) {
          throw Alloc<error::RedirectEval>(str768, arg_word);
        }
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          t = val->s;
          if (len(t) == 0) {
            throw Alloc<error::RedirectEval>(str769, arg_word);
            return nullptr;
          }
          try {
            if (maybe_str_equals(t, str770)) {
              result->arg = Alloc<redirect_arg::CloseFd>();
            }
            else {
              if (str_equals(t->index(-1), str771)) {
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = Alloc<redirect_arg::HereDoc>(str_concat(val->s, str773));
            return result;
          }
          else {
            throw Alloc<AssertionError>();
...
Tuple2<int, bool> CommandEvaluator::_Dispatch(syntax_asdl::command_t* node, runtime_asdl::CompoundStatus* pipeline_st) {
  ...
  double e_user;
  double e_sys;
  StackRoots _roots({&node, &pipeline_st, &UP_node, &words, &cmd_val, &UP_cmd_val, &typed_args, &block_expr, &val, &lval, &old_val, &UP_old_val, &UP_val, &strs, &tok, &str_val, &msg, &left, &child, &iter_name, &iter_list, &init, &for_cond, &body, &update, &defaults, &to_match, &pat_val});
...
int CommandEvaluator::_Execute(syntax_asdl::command_t* node) {
  ...
  int i;
  StackRoots _roots({&node, &pipeline_st, &process_sub_st, &redirects, &codes});
...
Tuple2<bool, bool> CommandEvaluator::ExecuteAndCatch(syntax_asdl::command_t* node, int cmd_flags) {
  ...
  try {
    ...
    if ((cmd_flags & RaiseControlFlow)) {
      ...
      if (e->IsReturn()) {
        ...
        this->errfmt->Print_(str789, e->token->span_id);
        is_fatal = true;
        status = 1;
      }
    }
  ...
  if (err) {
    ...
    if ((is_errexit and !this->exec_opts->verbose_errexit())) {
      ...
      ui::PrettyPrintError(err, this->arena, str790);
    }
  }
...
void CommandEvaluator::MaybeRunExitTrap(List<int>* mut_status) {
  ...
  handler = this->traps->get(str791);
  if (handler) {
    {  // with
      dev::ctx_Tracer ctx(this->tracer, str792, nullptr);
    ...
    if (UP_sig->tag_() == proc_sig_e::Closed) {
      ...
      for (ListIter<syntax_asdl::UntypedParam*> it(sig->untyped); !it.Done(); it.Next(), ++i) {
        ...
        if (i < n_args) {
          ...
          if (is_out_param) {
            param_name = str_concat(str793, param_name);
            if (!arg_str->startswith(str794)) {
...
int CommandEvaluator::RunFuncForCompletion(runtime_asdl::Proc* proc, List<Str*>* argv) {
  ...
  try {
    ...
    this->errfmt->Print_(str799, e->token->span_id);
    status = 1;
  }
  return status;
}
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index(i), str801))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index(-2), str803)) {
    ...
    if ((left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse)) {
      var_name = left_token->val->slice(0, -1);
      if (str_equals(close_token->val->index(-2), str804)) {
        op = assign_op_e::PlusEqual;
      }
      else {
        op = assign_op_e::Equal;
      ...
      if (left_token->id == Id::Lit_ArrayLhsOpen) {
        ...
        src = Alloc<source::Reparsed>(str807, left_token->span_id, close_token->span_id);
        {  // with
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    if (str_equals(left_token->val->index(-2), str809)) {
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index(0), str817)) {
    pos = op_val->find(str818);
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    i += 1;
    if (!alias_exp->endswith(str824)) {
      expanded->append(str825);
      break;
    }
  }
  if (len(expanded) == 0) {
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if (str_equals(c, str854)) {
      i += 1;
    }
    else {
      if ((str_equals(c, str855) or str_equals(c, str856))) {
        return true;
      }
      else {
        if (str_equals(c, str857)) {
          left_bracket = true;
        }
        else {
          if ((str_equals(c, str858) and left_bracket)) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  ...
  return pyutil::BackslashEscape(s, str860);
}
Str* ERE_META_CHARS = str861;
...
Str* GlobUnescape(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if ((str_equals(c, str862) and i != (n - 1))) {
      i += 1;
      c2 = s->index(i);
...
Str* _REGEX_CHARS_TO_ESCAPE = str869;
...
void Globber::ExpandExtended(Str* glob_pat, Str* fnmatch_pat, List<Str*>* out) {
  List<Str*>* tmp = nullptr;
  int n;
...
Str* _PromptEvaluatorCache::Get(Str* name) {
  ...
  if (str_equals(name, str889)) {
    value = this->_GetEuid() == 0 ? str890 : str891;
  }
  else {
    if (str_equals(name, str892)) {
      ...
      if (id_ == Id::PS_Octal3) {
        ...
        if (id_ == Id::PS_LBrace) {
          ...
          if (id_ == Id::PS_RBrace) {
            ...
            if (id_ == Id::PS_Subst) {
              ch = value->index(1);
              if (str_equals(ch, str896)) {
                r = this->cache->Get(str897);
              }
              else {
                if (str_equals(ch, str898)) {
                  ...
                  if (str_equals(ch, str900)) {
                    hostname = this->cache->Get(str901);
                    Tuple2<Str*, Str*> tup1 = mylib::split_once(hostname, str902);
                    r = tup1.at0();
                  }
                  else {
                    if (str_equals(ch, str903)) {
                      r = this->cache->Get(str904);
                    }
                    else {
                      if (str_equals(ch, str905)) {
                        ...
                        if (str_equals(ch, str906)) {
                          ...
                          if (str_equals(ch, str907)) {
                            now = time_::time();
                            r = time_::strftime(str908, time_::localtime(now));
                          }
                          else {
                            if (str_equals(ch, str909)) {
                              ...
                              if (str_equals(ch, str911)) {
                                try {
                                  pwd = state::GetString(this->mem, str912);
                                  home = state::MaybeString(this->mem, str913);
              ...
              ret->append(r->replace(str919, str920));
            }
            else {
              throw Alloc<AssertionError>();
            }
...
Str* Evaluator::EvalFirstPrompt() {
  ...
  if (str_equals(this->lang, str925)) {
    val = this->mem->GetValue(str926);
    return this->EvalPrompt(val);
  }
  else {
    return str_concat(this->lang, str927);
  }
}
Str* PROMPT_COMMAND = str928;
...
runtime_asdl::lvalue_t* UnsafeArith::ParseLValue(Str* s, int span_id) {
  ...
  {  // with
    alloc::ctx_Location ctx(arena, Alloc<source::ArgvWord>(str934, span_id));
...
int ArithEvaluator::_StringToInteger(Str* s, int span_id) {
  ...
  if (str_contains(s, str942)) {
    Tuple2<Str*, Str*> tup0 = mylib::split_once(s, str943);
    b = tup0.at0();
    digits = tup0.at1();
    try {
      base = to_int(b);
    ...
    for (StrIter it(digits); !it.Done(); it.Next()) {
      ...
      StackRoots _for({&ch    });
      if (IsLower(ch)) {
        digit = ((ord(ch) - ord(str945)) + 10);
      }
      else {
        if (IsUpper(ch)) {
          digit = ((ord(ch) - ord(str946)) + 36);
        }
        else {
          if (str_equals(ch, str947)) {
            digit = 62;
          }
          else {
  ...
  if (((val->tag_() == value_e::MaybeStrArray || val->tag_() == value_e::AssocArray) and lval->tag_() == lvalue_e::Named)) {
    ...
    if (word_eval::ShouldArrayDecay(named_lval->name, this->exec_opts)) {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (val->tag_() == value_e::AssocArray) {
          lval = Alloc<lvalue::Keyed>(named_lval->name, str957);
        }
      }
        ...
        if (op_id == Id::Arith_Minus) {
          ...
          if (op_id == Id::Arith_Star) {
            ...
            if (op_id == Id::Arith_Slash) {
              if (rhs == 0) {
                e_die(fmt268(), location::SpanForArithExpr(node->right));
              }
              ret = (lhs / rhs);
            }
            else {
  ...
  switch (node->tag_()) {
    ...
    case bool_expr_e::Unary: {
      ...
      if (arg_type == bool_arg_type_e::Other) {
        ...
        e_die(fmt271(ui::PrettyId(op_id)));
      }
      throw Alloc<AssertionError>();
    }
      break;
      ...
      if (arg_type == bool_arg_type_e::Str) {
        ...
        if (op_id == Id::BoolBinary_EqualTilde) {
          try {
            ...
            msg = e->message;
            e_die(fmt272(s2, msg, node->right), 2);
          }
          if (matches == nullptr) {
            return false;
          }
...
split::IfsSplitter* SplitContext::_GetSplitter(Str* ifs) {
  ...
  if (ifs == nullptr) {
    val = this->mem->GetValue(str969, scope_e::Dynamic);
    UP_val = val;
    switch (val->tag_()) {
      case value_e::Undef: {
        ifs = DEFAULT_IFS;
...
_BaseSplitter::_BaseSplitter(Str* escape_chars) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(_BaseSplitter)) {
  this->escape_chars = str_concat(escape_chars, str976);
}
    ...
    if (i < n) {
      ...
      if (str_contains(ws_chars, c)) {
        ...
        if (str_contains(other_chars, c)) {
          ...
          if ((allow_escape and str_equals(c, str977))) {
...
Str* Utf8Encode(int code) {
  ...
  return str980->join(tmp);
}
Str* INCOMPLETE_CHAR = str981;
Str* INVALID_CONT = str982;
Str* INVALID_START = str983;
    ...
    if ((tok->id == Id::VOp1_Pound || tok->id == Id::VOp1_DPound)) {
      ...
      if ((tok->id == Id::VOp1_Percent || tok->id == Id::VOp1_DPercent)) {
        ...
        if (tok->id == Id::VOp1_Comma) {
          if (!(str_equals(arg, str984))) {
            e_die(fmt273(ui::PrettyId(tok->id)), tok);
          }
          if (len(s)) {
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Slash) {
    try {
      ...
      msg = e->message;
      e_die(fmt278(regex, msg), this->slash_spid);
    }
  }
  if (op->replace_mode == Id::Lit_Pound) {
    regex = str_concat(str996, regex);
  }
  else {
    if (op->replace_mode == Id::Lit_Percent) {
      regex = str_concat(regex, str997);
    }
  }
...
Str* ShellQuoteB(Str* s) {
  ...
  s = s->replace(str998, str999)->replace(str1000, str1001);
  return pyutil::BackslashEscape(s, str1002);
}
...
void TdopParser::Eat(int token_type) {
  if (!this->AtToken(token_type)) {
    p_die(fmt282(ui::PrettyId(token_type), ui::PrettyId(this->op_id)), this->cur_word);
  }
  this->Next();
}
...
int QUOTE_ERE = (1 << 6);
GLOBAL_LIST(Str*, 3, _STRING_AND_ARRAY, {str1015 COMMA str1016 COMMA str1017});
...
runtime_asdl::value_t* DecayArray(runtime_asdl::value_t* val) {
  ...
  if (val->tag_() == value_e::MaybeStrArray) {
    ...
    if (val->tag_() == value_e::AssocArray) {
      value__AssocArray* assoc_val = static_cast<value__AssocArray*>(val);
      s = dict_contains(assoc_val->d, str1018) ? assoc_val->d->index(str1019) : nullptr;
    }
    else {
      throw Alloc<AssertionError>();
    }
...
Str* _BackslashEscape(Str* s) {
  ...
  return s->replace(str1020, str1021);
}
...
runtime_asdl::part_value_t* _ValueToPartValue(runtime_asdl::value_t* val, bool quoted) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      return Alloc<part_value::String>(str1022, quoted, !quoted);
    }
      break;
    case value_e::Str: {
      value__Str* val = static_cast<value__Str*>(UP_val);
...
Str* _GetDollarHyphen(optview::Exec* exec_opts) {
  ...
  if (exec_opts->errexit()) {
    chars->append(str1027);
  }
  if (exec_opts->noglob()) {
    chars->append(str1028);
  }
  if (exec_opts->noexec()) {
    chars->append(str1029);
  }
  if (exec_opts->nounset()) {
    chars->append(str1030);
  }
  if (exec_opts->xtrace()) {
...
Str* TildeEvaluator::Eval(syntax_asdl::Token* token) {
  ...
  if (maybe_str_equals(token->val, str1034)) {
    val = this->mem->GetValue(str1035);
    UP_val = val;
    if (val->tag_() == value_e::Str) {
      value__Str* val = static_cast<value__Str*>(UP_val);
      return val->s;
      ...
      if ((tok->id == Id::VTest_ColonEquals || tok->id == Id::VTest_Equals)) {
        ...
        if ((tok->id == Id::VTest_ColonQMark || tok->id == Id::VTest_QMark)) {
          if (is_falsey) {
            ...
            e_die(fmt287(error_str), blame_token);
          }
          else {
            return false;
          }
    ...
    case value_e::Str: {
      ...
      try {
        ...
        if (this->exec_opts->strict_word_eval()) {
          ...
          this->errfmt->PrettyPrintError(e, str1039);
          return Alloc<value::Str>(str1040);
        }
      }
    }
      break;
...
runtime_asdl::value_t* AbstractWordEvaluator::_Slice(runtime_asdl::value_t* val, syntax_asdl::suffix_op__Slice* op, Str* var_name, syntax_asdl::braced_var_sub* part) {
  ...
  try {
    ...
    if (this->exec_opts->strict_word_eval()) {
      ...
      this->errfmt->PrettyPrintError(e, str1046);
      switch (val->tag_()) {
        case value_e::Str: {
          val = Alloc<value::Str>(str1047);
        }
          break;
        case value_e::MaybeStrArray: {
  ...
  if (op_id == Id::VOp0_P) {
    switch (val->tag_()) {
      case value_e::Str: {
        ...
        p = prompt->replace(str1048, str1049)->replace(str1050, str1051);
        result = Alloc<value::Str>(p);
      }
        break;
      default: {
        e_die(fmt290(ui::ValType(val)));
      }
    }
  }
  else {
    if (op_id == Id::VOp0_Q) {
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          result = Alloc<value::Str>(str1053->join(tmp));
        }
          break;
        default: {
          e_die(fmt291(ui::ValType(val)));
        }
      }
    }
    else {
      if (op_id == Id::VOp0_a) {
        ...
        switch (val->tag_()) {
          case value_e::MaybeStrArray: {
            chars->append(str1055);
          }
            break;
          case value_e::AssocArray: {
            chars->append(str1056);
          }
            break;
        }
        if (var_name != nullptr) {
          ...
          if (cell) {
            if (cell->readonly) {
              chars->append(str1057);
            }
            if (cell->exported) {
              chars->append(str1058);
            }
            if (cell->nameref) {
              chars->append(str1059);
            }
          }
        }
        result = Alloc<value::Str>(str1060->join(chars));
      }
      else {
        e_die(fmt292(op->val), op);
      }
    }
  }
...
runtime_asdl::value_t* AbstractWordEvaluator::_ArrayIndex(runtime_asdl::value_t* val, syntax_asdl::braced_var_sub* part, runtime_asdl::VTestPlace* vtest_place) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      ...
      break;
    case value_e::Str: {
      e_die(fmt295(part->token->val), part->token);
    }
      break;
    case value_e::MaybeStrArray: {
      value__MaybeStrArray* array_val = static_cast<value__MaybeStrArray*>(UP_val);
...
void AbstractWordEvaluator::_EvalDoubleQuoted(List<syntax_asdl::word_part_t*>* parts, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  if (len(parts) == 0) {
    v = Alloc<part_value::String>(str1065, true, false);
    part_vals->append(v);
    return ;
  }
  for (ListIter<syntax_asdl::word_part_t*> it(parts); !it.Done(); it.Next()) {
...
runtime_asdl::value_t* AbstractWordEvaluator::_EmptyStrOrError(runtime_asdl::value_t* val, syntax_asdl::Token* token) {
  ...
  if (!this->exec_opts->nounset()) {
    return Alloc<value::Str>(str1066);
  }
  name = token->val->startswith(str1067) ? token->val->slice(1) : token->val;
  e_die(fmt296(name), token);
}
...
void AbstractWordEvaluator::_EvalExtGlob(syntax_asdl::word_part__ExtGlob* part, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  for (ListIter<syntax_asdl::compound_word*> it(part->arms); !it.Done(); it.Next(), ++i) {
    ...
    StackRoots _for({&w  });
    if (i != 0) {
      part_vals->append(Alloc<part_value::String>(str1078, false, false));
    }
    this->_EvalWordToParts(w, part_vals, EXTGLOB_NESTED);
  }
  part_vals->append(Alloc<part_value::String>(str1079, false, false));
}
    ...
    case word_e::Compound: {
      ...
      if (has_extglob) {
        if (to_bool((eval_flags & EXTGLOB_FILES))) {
          ...
          glob_pat = str1085->join(glob_parts);
          fnmatch_pat = str1086->join(fnmatch_parts);
          results = Alloc<List<Str*>>();
          this->globber->ExpandExtended(glob_pat, fnmatch_pat, results);
      ...
      break;
    case word_e::Empty: {
      part_vals->append(Alloc<part_value::String>(str1088, quoted, !quoted));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, int eval_flags) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return Alloc<value::Str>(str1092);
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  part_vals = Alloc<List<runtime_asdl::part_value_t*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
  ...
  return Alloc<value::Str>(str1093->join(strs));
}
...
Tuple2<runtime_asdl::value__Str*, bool> AbstractWordEvaluator::EvalWordToPattern(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() == word_e::Empty) {
    return (Tuple2<runtime_asdl::value__Str*, bool>(Alloc<value::Str>(str1094), false));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  has_extglob = false;
  part_vals = Alloc<List<runtime_asdl::part_value_t*>>();
  ...
  return (Tuple2<runtime_asdl::value__Str*, bool>(Alloc<value::Str>(str1095->join(strs)), has_extglob));
}
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalForPlugin(syntax_asdl::compound_word* w) {
  ...
  {  // with
    ...
    try {
      ...
      val = Alloc<value::Str>(fmt310(e->UserErrorString()));
    }
    catch (_OSError* e) {
      val = Alloc<value::Str>(fmt311(pyutil::strerror(e)));
    }
    catch (KeyboardInterrupt*) {
      val = Alloc<value::Str>(str1098);
    }
  }
  return val;
}
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index(-2), str1105)) {
          e_die(fmt313(), w);
        }
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        StackRoots _for({&arg      });
        if ((arg->startswith(str1107) or arg->startswith(str1108))) {
          flags->append(arg);
          flag_spids->append(word_spid);
          if ((str_contains(arg, str1109) or str_contains(arg, str1110))) {
            eval_to_pairs = false;
          }
        }
        else {
          if (eval_to_pairs) {
            Tuple2<Str*, runtime_asdl::value__Str*> tup10 = _SplitAssignArg(arg, w);
            left = tup10.at0();
            right = tup10.at1();
            arg2 = Alloc<assign_arg>(left, right, word_spid);
            assign_args->append(arg2);
...
runtime_asdl::part_value__String* CompletionWordEvaluator::_EvalProcessSub(syntax_asdl::command_sub* cs_part) {
  ...
  return Alloc<part_value::String>(str1115, true, false);
}
...
syntax_asdl::suffix_op__PatSub* WordParser::_ReadPatSubVarOp() {
  ...
  if (this->token_type == Id::Lit_Slash) {
    ...
    this->_Peek();
    if (this->token_type != Id::Right_DollarBrace) {
      p_die(fmt317(ui::PrettyId(this->token_type)), this->cur_token);
    }
          ...
          if (op_kind == Kind::VOp2) {
            if (this->token_type == Id::VOp2_Slash) {
              ...
              if (this->token_type == Id::VOp2_Colon) {
                ...
                p_die(fmt325(str1127), this->cur_token);
              }
            }
          }
          else {
            if (op_kind == Kind::VOp3) {
              if (allow_query) {
                ...
                p_die(fmt326(str1129), this->cur_token);
              }
            }
          }
        }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool is_oil_expr) {
  ...
  while (num_end_tokens < expected_end_tokens) {
    ...
    if ((this->token_kind == Kind::Lit || this->token_kind == Kind::Char)) {
      tok = this->cur_token;
      if ((no_backslashes and str_contains(tok->val, str1134))) {
        p_die(fmt331(), tok);
      }
      if (is_oil_expr) {
...
syntax_asdl::word_part_t* WordParser::_ReadUnquotedLeftParts(bool try_triple_quote, List<bool>* triple_out) {
  ...
  if ((this->token_type == Id::Left_DoubleQuote || this->token_type == Id::Left_DollarDoubleQuote)) {
    ...
    if ((try_triple_quote and len(dq_part->parts) == 0)) {
      if (str_equals(this->lexer->ByteLookAhead(), str1140)) {
  ...
  if ((this->token_type == Id::Left_SingleQuote || this->token_type == Id::Left_RSingleQuote || this->token_type == Id::Left_DollarSingleQuote)) {
    ...
    if ((try_triple_quote and len(sq_part->tokens) == 0)) {
      if (str_equals(this->lexer->ByteLookAhead(), str1141)) {
        this->_Next(lex_mode_e::ShCommand);
        this->_Peek();
  ...
  if ((left_id == Id::Left_DollarParen || left_id == Id::Left_AtParen || left_id == Id::Left_ProcSubIn || left_id == Id::Left_ProcSubOut)) {
    ...
    if ((left_id == Id::Left_Backtick and this->parse_ctx->one_pass_parse)) {
      ...
      if (left_id == Id::Left_Backtick) {
        ...
        right_spid = this->cur_token->span_id;
        code_str = str1149->join(parts);
        arena = this->parse_ctx->arena;
        line_reader = reader::StringLineReader(code_str, arena);
        c_parser = this->parse_ctx->MakeOshParser(line_reader);
        src = Alloc<source::Reparsed>(str1150, left_spid, right_spid);
        {  // with
          alloc::ctx_Location ctx(arena, src);
...
void WordParser::ParseProc(syntax_asdl::command__Proc* node) {
  ...
  if (this->token_type != Id::Lit_Chars) {
    p_die(fmt343(ui::PrettyToken(this->cur_token, this->arena)), this->cur_token);
  }
...
syntax_asdl::arith_expr_t* WordParser::_ReadArithExpr(int end_id) {
  ...
  if ((end_id != Id::Undefined_Tok and cur_id != end_id)) {
    p_die(fmt344(ui::PrettyId(cur_id), ui::PrettyId(end_id)), this->a_parser->cur_word);
  }
  return anode;
}
...
syntax_asdl::command__ForExpr* WordParser::ReadForExpression() {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt347(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
  if (cur_id == Id::Arith_Semi) {
  ...
  this->_NextNonSpace();
  if (cur_id != Id::Arith_Semi) {
    p_die(fmt348(), this->a_parser->cur_word);
  }
  this->_Peek();
  cur_id = this->token_type;
            ...
            if (this->token_type == Id::Lit_Dollar) {
              if (!this->parse_opts->parse_dollar()) {
                if ((num_parts == 0 and lex_mode == lex_mode_e::ShCommand)) {
                  ...
                  if (str_equals(next_byte, str1166)) {
                    println_stderr(fmt358(next_byte));
                  }
                }
...
Tuple2<syntax_asdl::word_t*, bool> WordParser::_ReadArithWord() {
  ...
  this->_Peek();
  if (this->token_kind == Kind::Unknown) {
    p_die(fmt363(this->cur_token->val), this->cur_token);
  }
  else {
    if (this->token_kind == Kind::Eof) {
          ...
          if ((this->token_kind == Kind::VSub || this->token_kind == Kind::Lit || this->token_kind == Kind::History || this->token_kind == Kind::Left || this->token_kind == Kind::KW || this->token_kind == Kind::ControlFlow || this->token_kind == Kind::BoolUnary || this->token_kind == Kind::BoolBinary || this->token_kind == Kind::ExtGlob)) {
            if (this->token_type == Id::Lit_Pound) {
              ...
              if (this->token_type == Id::Lit_TPound) {
                ...
                if ((this->parse_opts->parse_raw_string() and (this->token_type == Id::Lit_Chars and maybe_str_equals(this->cur_token->val, str1174)))) {
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1179, false));
    }
      break;
    case word_part_e::AssocArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1180, false));
    }
      break;
    case word_part_e::Literal: {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str1182, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str1183->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() != word_e::Compound) {
    return (Tuple3<bool, Str*, bool>(false, str1185, quoted));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  strs = Alloc<List<Str*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str1186, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str1187->join(strs), quoted));
}
...
syntax_asdl::compound_word* TildeDetect(syntax_asdl::word_t* UP_w) {
  ...
  if ((id_ == Id::Lit_Chars and static_cast<Token*>(part1)->val->startswith(str1189))) {
    new_parts->extend(w->parts->slice(1));
    return Alloc<compound_word>(new_parts);
  }
  return nullptr;
...
void TildeDetectAssign(syntax_asdl::compound_word* w) {
  ...
  for (int i = 0; i < n; ++i) {
    ...
    if ((do_expand and LiteralId(cur) == Id::Lit_TildeLike)) {
      ...
      if (next_part) {
        is_tilde = (LiteralId(next_part) == Id::Lit_Colon or (LiteralId(next_part) == Id::Lit_Chars and static_cast<Token*>(next_part)->val->startswith(str1190)));
      }
      else {
        is_tilde = true;
      }
...
Str* escape(Str* s) {
  ...
  s = s->replace(str1200, str1201);
  s = s->replace(str1202, str1203);
  s = s->replace(str1204, str1205);
  return s;
}
...
Str* join(Str* s1, Str* s2) {
  ...
  if ((s2->startswith(str1208) or len(s1) == 0)) {
    return s2;
  }
  if (s1->endswith(str1209)) {
...
Tuple2<Str*, Str*> _splitext(Str* p, Str* sep, Str* extsep) {
  ...
  return (Tuple2<Str*, Str*>(p, str1212));
}
...
Str* normpath(Str* path) {
  ...
  slash = str1215;
  dot = str1216;
  if (str_equals(path, str1217)) {
    return dot;
  }
  initial_slashes = path->startswith(str1218);
  if ((initial_slashes and (path->startswith(str1219) and !path->startswith(str1220)))) {
    initial_slashes = 2;
  }
  comps = path->split(str1221);
  new_comps = Alloc<List<Str*>>();
  for (ListIter<Str*> it(comps); !it.Done(); it.Next()) {
    Str* comp = it.Value();
    StackRoots _for({&comp  });
    if ((len(comp) == 0 or str_equals(comp, str1222))) {
      continue;
    }
    if ((!(str_equals(comp, str1223)) or ((initial_slashes == 0 and len(new_comps) == 0) or (len(new_comps) and str_equals(new_comps->index(-1), str1224))))) {
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if ((str_contains(str1231, ch) or IsUnprintableLow(ch))) {
        quote = 2;
        break;
      }
    }
  ...
  parts->append(str1234);
  return str_concat(prefix, str1235->join(parts));
}
...
Str* maybe_encode(Str* s, int bit8_display) {
  ...
  parts = Alloc<List<Str*>>();
  parts->append(str1236);
  _encode(s, bit8_display, false, parts);
  parts->append(str1237);
  return str1238->join(parts);
}
...
void _encode_bytes_x(Str* s, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (str_equals(byte, str1242)) {
      part = str1243;
    }
    else {
      if (str_equals(byte, str1244)) {
        part = str1245;
      }
      else {
        if (str_equals(byte, str1246)) {
          part = str1247;
        }
        else {
          if (str_equals(byte, str1248)) {
            ...
            if (str_equals(byte, str1250)) {
              ...
              if (str_equals(byte, str1252)) {
                part = shell_compat ? str1253 : str1254;
              }
              else {
            ...
            if (str_equals(byte, str1264)) {
              ...
              if (str_equals(byte, str1266)) {
                ...
                if (str_equals(byte, str1268)) {
                  out = shell_compat ? str1269 : str1270;
                }
                else {
                  if (IsUnprintableLow(byte)) {
...
syntax_asdl::word__String* _StringWordEmitter::ReadWord(types_asdl::lex_mode_t unused_lex_mode) {
  ...
  if (this->i == this->n) {
    w = Alloc<word::String>(Id::Eof_Real, str1271, runtime::NO_SPID);
    return w;
  }
...
syntax_asdl::bool_expr_t* _TwoArgs(builtin_bracket::_StringWordEmitter* w_parser) {
  ...
  w1 = w_parser->Read();
  s0 = w0->s;
  if (maybe_str_equals(s0, str1272)) {
    return Alloc<bool_expr::LogicalNot>(Alloc<bool_expr::WordTest>(w1));
  }
  unary_id = Id::Undefined_Tok;
  if (w0->s->startswith(str1273)) {
    if (maybe_str_equals(s0, str1274)) {
      unary_id = Id::BoolUnary_d;
    }
    else {
      if (maybe_str_equals(s0, str1275)) {
        unary_id = Id::BoolUnary_e;
      }
      else {
        if (maybe_str_equals(s0, str1276)) {
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    ...
    strs = cmd_val->argv;
    if ((!strs or !(str_equals(strs->index(-1), str1286)))) {
      this->errfmt->Print_(str1287, cmd_val->arg_spids->index(0));
      return 2;
    }
    cmd_val->argv->pop();
  ...
  try {
    ...
    if (n == 4) {
      a0 = w_parser->Peek(0);
      if (str_equals(a0, str1289)) {
        w_parser->Read();
        child = _ThreeArgs(w_parser);
        bool_node = Alloc<bool_expr::LogicalNot>(child);
      }
      else {
        if ((str_equals(a0, str1290) and str_equals(w_parser->Peek(3), str1291))) {
          w_parser->Read();
          bool_node = _TwoArgs(w_parser);
        }
        else {
    ...
    this->errfmt->PrettyPrintError(e, str1292);
    return 2;
  }
  ...
  try {
    ...
    this->errfmt->PrettyPrintError(e, str1293);
    return 2;
  }
  status = b ? 0 : 1;
  return status;

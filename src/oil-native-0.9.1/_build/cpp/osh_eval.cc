...
GLOBAL_STR(str44, "-c flag");
GLOBAL_STR(str45, "\u001b[0;0m");
GLOBAL_STR(str46, "\u001b[1m");
GLOBAL_STR(str47, "\u001b[4m");
GLOBAL_STR(str48, "\u001b[7m");
GLOBAL_STR(str49, "\u001b[31m");
GLOBAL_STR(str50, "\u001b[32m");
GLOBAL_STR(str51, "\u001b[33m");
GLOBAL_STR(str52, "\u001b[34m");
GLOBAL_STR(str53, "proc");
GLOBAL_STR(str54, "source");
GLOBAL_STR(str55, "?");
GLOBAL_STR(str56, "(");
GLOBAL_STR(str57, ")");
GLOBAL_STR(str58, " ");
GLOBAL_STR(str59, "(");
GLOBAL_STR(str60, "[%s]=%s");
GLOBAL_STR(str61, ")");
GLOBAL_STR(str62, " ");
GLOBAL_STR(str63, " ");
GLOBAL_STR(str64, "\n");
...
GLOBAL_STR(str67, "");
GLOBAL_STR(str68, "");
GLOBAL_STR(str69, "SHX_indent");
GLOBAL_STR(str70, "SHX_punct");
GLOBAL_STR(str71, "SHX_pid_str");
GLOBAL_STR(str72, "PS4");
GLOBAL_STR(str73, "");
GLOBAL_STR(str74, "<ERROR: Can't parse PS4: %s>");
GLOBAL_STR(str75, "");
GLOBAL_STR(str76, "  ");
GLOBAL_STR(str77, "+");
GLOBAL_STR(str78, "|");
GLOBAL_STR(str79, "command %d:");
GLOBAL_STR(str80, "forkwait %d\n");
GLOBAL_STR(str81, "command sub %d\n");
GLOBAL_STR(str82, "proc sub %d\n");
GLOBAL_STR(str83, "here doc %d\n");
GLOBAL_STR(str84, "fork %d\n");
GLOBAL_STR(str85, "part %d\n");
GLOBAL_STR(str86, ";");
GLOBAL_STR(str87, "process %d: status %d\n");
GLOBAL_STR(str88, " %d");
GLOBAL_STR(str89, ">");
GLOBAL_STR(str90, "proc");
GLOBAL_STR(str91, "source");
GLOBAL_STR(str92, "wait");
GLOBAL_STR(str93, "\n");
GLOBAL_STR(str94, "<");
GLOBAL_STR(str95, " ");
GLOBAL_STR(str96, "\n");
...
GLOBAL_STR(str98, "\n");
GLOBAL_STR(str99, ".");
GLOBAL_STR(str100, "exec");
GLOBAL_STR(str101, ".");
GLOBAL_STR(str102, "builtin");
GLOBAL_STR(str103, " ");
GLOBAL_STR(str104, "\n");
GLOBAL_STR(str105, " ");
GLOBAL_STR(str106, " ");
...
GLOBAL_STR(str108, "\n");
GLOBAL_STR(str109, "?");
GLOBAL_STR(str110, "%s[%d]");
GLOBAL_STR(str111, "%s[%s]");
GLOBAL_STR(str112, "+=");
GLOBAL_STR(str113, "=");
GLOBAL_STR(str114, "\n");
GLOBAL_STR(str115, "+");
...
GLOBAL_STR(str119, " ...");
GLOBAL_STR(str120, "\n");
GLOBAL_STR(str121, "<_ControlFlow %s>");
GLOBAL_STR(str122, "Invalid control flow %r in pipeline / subshell / background");
GLOBAL_STR(str123, "%r ");
GLOBAL_STR(str124, "");
...
GLOBAL_STR(str131, "Unexpected block passed to external command %r");
GLOBAL_STR(str132, "%r not found");
GLOBAL_STR(str133, "pipeline");
GLOBAL_STR(str134, "Command subs not allowed here because status wouldn't be checked (strict_errexit).");
GLOBAL_STR(str135, "__cat");
...
GLOBAL_STR(str187, "<Process %s>");
GLOBAL_STR(str188, "Fatal error in posix.fork()");
GLOBAL_STR(str189, "<Pipeline %s>");
GLOBAL_STR(str190, " ");
GLOBAL_STR(str191, "JobState MaybeRemove %d");
GLOBAL_STR(str192, "osh: PID %d stopped, but osh didn't start it");
GLOBAL_STR(str193, "");
GLOBAL_STR(str194, "");
GLOBAL_STR(str195, "[PID %d] Stopped");
GLOBAL_STR(str196, "");
GLOBAL_STR(str197, "main");
GLOBAL_STR(str198, "osh usage error: %s");
GLOBAL_STR(str199, "%s-usage");
GLOBAL_STR(str200, "Oil");
GLOBAL_STR(str201, "main");
GLOBAL_STR(str202, "oil");
GLOBAL_STR(str203, "oil:all");
GLOBAL_STR(str204, "--one-pass-parse requires noexec (-n)");
GLOBAL_STR(str205, "completion");
GLOBAL_STR(str206, "history");
GLOBAL_STR(str207, "");
GLOBAL_STR(str208, "OSH_DEBUG_DIR");
GLOBAL_STR(str209, "%d-osh.log");
GLOBAL_STR(str210, "Writing logs to %r");
GLOBAL_STR(str211, "OSH_HIJACK_SHEBANG");
GLOBAL_STR(str212, "");
GLOBAL_STR(str213, "OSH_CRASH_DUMP_DIR");
GLOBAL_STR(str214, "");
GLOBAL_STR(str215, "");
GLOBAL_STR(str216, "osh: Couldn't open %r: %s");
GLOBAL_STR(str217, "/proc/%d/status");
GLOBAL_STR(str218, "--parser-mem-dump can only be used with -n");
GLOBAL_STR(str219, "/proc/%d/status");
GLOBAL_STR(str220, " \t\n\"'><=;|&(:");
GLOBAL_STR(str221, "/");
GLOBAL_STR(str222, "PATH");
GLOBAL_STR(str223, ":");
GLOBAL_STR(str224, "got invalid option %r");
GLOBAL_STR(str225, "got invalid option %r");
GLOBAL_STR(str226, "doesn't own option %r (try 'shopt')");
GLOBAL_STR(str227, "SHELLOPTS");
GLOBAL_STR(str228, ":");
GLOBAL_STR(str229, "Syntax options must be set at the top level (outside any function)");
GLOBAL_STR(str230, "Warning: set -o verbose not implemented");
GLOBAL_STR(str231, "SHELLOPTS");
GLOBAL_STR(str232, "%s:%s");
GLOBAL_STR(str233, "SHELLOPTS");
GLOBAL_STR(str234, ":");
GLOBAL_STR(str235, ":");
GLOBAL_STR(str236, "SHELLOPTS");
GLOBAL_STR(str237, "oil:basic");
GLOBAL_STR(str238, "oil:all");
GLOBAL_STR(str239, "strict:all");
GLOBAL_STR(str240, "set %so %s");
GLOBAL_STR(str241, "-");
GLOBAL_STR(str242, "+");
GLOBAL_STR(str243, "oil:basic");
GLOBAL_STR(str244, "oil:all");
GLOBAL_STR(str245, "strict:all");
GLOBAL_STR(str246, "got invalid option %r");
GLOBAL_STR(str247, "shopt -%s %s");
GLOBAL_STR(str248, "s");
GLOBAL_STR(str249, "u");
GLOBAL_STR(str250, "<_ArgFrame %s %d at %x>");
GLOBAL_STR(str251, "Can't determine working directory: %s");
GLOBAL_STR(str252, "IFS");
GLOBAL_STR(str253, "UID");
GLOBAL_STR(str254, "EUID");
GLOBAL_STR(str255, "PPID");
GLOBAL_STR(str256, "HOSTNAME");
GLOBAL_STR(str257, "OSTYPE");
GLOBAL_STR(str258, "OPTIND");
GLOBAL_STR(str259, "1");
GLOBAL_STR(str260, "PS4");
GLOBAL_STR(str261, "${SHX_indent}${SHX_punct}${SHX_pid_str} ");
GLOBAL_STR(str262, "COMP_WORDBREAKS");
GLOBAL_STR(str263, "SHELLOPTS");
GLOBAL_STR(str264, "SHELLOPTS");
GLOBAL_STR(str265, "");
GLOBAL_STR(str266, "SHELLOPTS");
GLOBAL_STR(str267, "PWD");
GLOBAL_STR(str268, "PWD");
GLOBAL_STR(str269, "PWD");
GLOBAL_STR(str270, "OIL_VERSION");
GLOBAL_STR(str271, "PWD");
GLOBAL_STR(str272, "");
GLOBAL_STR(str273, "<Mem");
GLOBAL_STR(str274, "  -- %d --");
GLOBAL_STR(str275, "  %s %s");
GLOBAL_STR(str276, ">");
GLOBAL_STR(str277, "\n");
GLOBAL_STR(str278, "\n");
GLOBAL_STR(str279, "Warning: span_id undefined in SetCurrentSpanId");
GLOBAL_STR(str280, "setref requires a nameref (:out param)");
GLOBAL_STR(str281, "nameref %r is undefined");
GLOBAL_STR(str282, "nameref %r contains invalid variable name %r");
GLOBAL_STR(str283, "Circular nameref %s");
GLOBAL_STR(str284, " -> ");
GLOBAL_STR(str285, "__");
GLOBAL_STR(str286, "Can't assign to readonly value %r");
GLOBAL_STR(str287, "Only strings can be exported");
GLOBAL_STR(str288, "nameref must be a string");
GLOBAL_STR(str289, "Can't assign to readonly array");
GLOBAL_STR(str290, "Can't assign to items in a string");
GLOBAL_STR(str291, "Value of type %s can't be indexed");
GLOBAL_STR(str292, "Can't assign to readonly associative array");
GLOBAL_STR(str293, "ARGV");
GLOBAL_STR(str294, "_status");
GLOBAL_STR(str295, "_this_dir");
GLOBAL_STR(str296, "PIPESTATUS");
GLOBAL_STR(str297, "_pipeline_status");
GLOBAL_STR(str298, "_process_sub_status");
GLOBAL_STR(str299, "BASH_REMATCH");
GLOBAL_STR(str300, "FUNCNAME");
GLOBAL_STR(str301, "source");
GLOBAL_STR(str302, "BASH_SOURCE");
GLOBAL_STR(str303, "BASH_LINENO");
GLOBAL_STR(str304, "0");
GLOBAL_STR(str305, "LINENO");
GLOBAL_STR(str306, "BASHPID");
GLOBAL_STR(str307, "Can't unset readonly variable %r");
GLOBAL_STR(str308, "%r isn't an array");
GLOBAL_STR(str309, "$%s isn't defined");
GLOBAL_STR(str310, "$%s should be a string");
GLOBAL_STR(str311, "$%s should be a string, got %s");
GLOBAL_STR(str312, "$%s doesn't look like an integer, got %r");
GLOBAL_STR(str313, "EOF");
GLOBAL_STR(str314, "/");
GLOBAL_STR(str315, "~");
GLOBAL_STR(str316, "  ");
GLOBAL_STR(str317, "\n  ");
...
GLOBAL_STR(str322, "~");
GLOBAL_STR(str323, "\n");
GLOBAL_STR(str324, "[ interactive ]");
GLOBAL_STR(str325, "[ headless ]");
GLOBAL_STR(str326, "[ -c flag ]");
GLOBAL_STR(str327, "[ stdin%s ]");
GLOBAL_STR(str328, "[ expansion of alias %r ]");
GLOBAL_STR(str329, "[ backticks at ... ]");
GLOBAL_STR(str330, "[ array LValue in %s ]");
GLOBAL_STR(str331, "[ eval at line %d of %s ]");
GLOBAL_STR(str332, "[ trap ]");
GLOBAL_STR(str333, "[ variable ]");
GLOBAL_STR(str334, "%s:%d: %s%s\n");
GLOBAL_STR(str335, "[??? no location ???] %s%s\n");
GLOBAL_STR(str336, "");
GLOBAL_STR(str337, "");
GLOBAL_STR(str338, "");
GLOBAL_STR(str339, "none");
GLOBAL_STR(str340, "AST not printed.");
GLOBAL_STR(str341, "text");
GLOBAL_STR(str342, "abbrev-text");
GLOBAL_STR(str343, "html");
GLOBAL_STR(str344, "abbrev-html");
GLOBAL_STR(str345, "abbrev-");
GLOBAL_STR(str346, "\n");
GLOBAL_STR(str347, "\n");
GLOBAL_STR(str348, "-");
GLOBAL_STR(str349, "_");
GLOBAL_STR(str350, "<_Attributes %s>");
GLOBAL_STR(str351, "<args.Reader %r %d>");
GLOBAL_STR(str352, "expected argument to %r");
GLOBAL_STR(str353, "-");
GLOBAL_STR(str354, "expected integer after %s, got %r");
GLOBAL_STR(str355, "-");
GLOBAL_STR(str356, "got invalid integer for %s: %s");
GLOBAL_STR(str357, "-");
GLOBAL_STR(str358, "expected number after %r, got %r");
GLOBAL_STR(str359, "-");
GLOBAL_STR(str360, "got invalid float for %s: %s");
GLOBAL_STR(str361, "-");
GLOBAL_STR(str362, "got invalid argument %r to %r, expected one of: %s");
GLOBAL_STR(str363, "-");
GLOBAL_STR(str364, "|");
GLOBAL_STR(str365, "0");
GLOBAL_STR(str366, "F");
GLOBAL_STR(str367, "false");
GLOBAL_STR(str368, "False");
GLOBAL_STR(str369, "1");
GLOBAL_STR(str370, "T");
GLOBAL_STR(str371, "true");
GLOBAL_STR(str372, "Talse");
GLOBAL_STR(str373, "got invalid argument to boolean flag: %r");
GLOBAL_STR(str374, "-");
GLOBAL_STR(str375, "-");
GLOBAL_STR(str376, "Invalid option %r");
GLOBAL_STR(str377, "Expected argument for action");
GLOBAL_STR(str378, "Invalid action name %r");
GLOBAL_STR(str379, "--");
GLOBAL_STR(str380, "--");
GLOBAL_STR(str381, "got invalid flag %r");
GLOBAL_STR(str382, "-");
GLOBAL_STR(str383, "0");
GLOBAL_STR(str384, "Z");
GLOBAL_STR(str385, "-");
GLOBAL_STR(str386, "doesn't accept flag %s");
GLOBAL_STR(str387, "-");
GLOBAL_STR(str388, "+");
GLOBAL_STR(str389, "+");
GLOBAL_STR(str390, "doesn't accept option %s");
GLOBAL_STR(str391, "+");
GLOBAL_STR(str392, "-");
GLOBAL_STR(str393, "--");
GLOBAL_STR(str394, "--");
...
GLOBAL_STR(str399, "-");
GLOBAL_STR(str400, "^--?([a-zA-Z0-9][a-zA-Z0-9\\-]*)(=.*)?$");
GLOBAL_STR(str401, "<LineLexer at pos %d of line %r (id = %d)>");
GLOBAL_STR(str402, "");
GLOBAL_STR(str403, "");
GLOBAL_STR(str404, "");
GLOBAL_STR(str405, "");
GLOBAL_STR(str406, "<Trail %s %s %s %s>");
GLOBAL_STR(str407, "");
GLOBAL_STR(str408, "ShAssignment expression can't be nested like this");
GLOBAL_STR(str409, "Here docs aren't allowed in expressions");
GLOBAL_STR(str410, "\n");
GLOBAL_STR(str411, "");
GLOBAL_STR(str412, " (%s)");
GLOBAL_STR(str413, "Unexpected token in expression mode%s");
GLOBAL_STR(str414, "Syntax error in expression (near %s)");
GLOBAL_STR(str415, "alnum");
GLOBAL_STR(str416, "cntrl");
GLOBAL_STR(str417, "lower");
GLOBAL_STR(str418, "space");
GLOBAL_STR(str419, "alpha");
GLOBAL_STR(str420, "digit");
GLOBAL_STR(str421, "print");
GLOBAL_STR(str422, "upper");
GLOBAL_STR(str423, "blank");
GLOBAL_STR(str424, "graph");
GLOBAL_STR(str425, "punct");
GLOBAL_STR(str426, "xdigit");
GLOBAL_STR(str427, "Range start/end shouldn't have more than one character");
GLOBAL_STR(str428, "Write singleton tuples with tup(), not a trailing comma");
GLOBAL_STR(str429, "testlist_comp");
GLOBAL_STR(str430, "obj.field isn't valid, but obj.method() is");
GLOBAL_STR(str431, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str432, "Can't assign to this expression");
GLOBAL_STR(str433, "PNode type %d (%s) wasn't handled");
GLOBAL_STR(str434, "TODO");
GLOBAL_STR(str435, "dot");
GLOBAL_STR(str436, "Can't negate this symbol");
GLOBAL_STR(str437, "%r isn't a character class");
GLOBAL_STR(str438, "Can't negate this symbol");
GLOBAL_STR(str439, "%r isn't a character class");
GLOBAL_STR(str440, "%start");
GLOBAL_STR(str441, "%end");
GLOBAL_STR(str442, "dot");
GLOBAL_STR(str443, "Unexpected token %r in regex");
GLOBAL_STR(str444, "%s-%s");
GLOBAL_STR(str445, "ERE can't express code point %d");
GLOBAL_STR(str446, "Perl classes can't be negated in ERE");
GLOBAL_STR(str447, "%s");
GLOBAL_STR(str448, "POSIX classes can't be negated in ERE");
GLOBAL_STR(str449, "[:%s:]");
GLOBAL_STR(str450, ".");
GLOBAL_STR(str451, "^");
GLOBAL_STR(str452, "$");
GLOBAL_STR(str453, "|");
GLOBAL_STR(str454, "POSIX EREs don't have groups without capture, so this node needs () around it.");
GLOBAL_STR(str455, "+");
GLOBAL_STR(str456, "*");
GLOBAL_STR(str457, "?");
GLOBAL_STR(str458, "{%s}");
...
GLOBAL_STR(str469, "^");
GLOBAL_STR(str470, "]");
GLOBAL_STR(str471, "The [ operator doesn't apply to this expression");
GLOBAL_STR(str472, "Expected ]]");
GLOBAL_STR(str473, "Unexpected trailing word %s");
GLOBAL_STR(str474, "Invalid argument to unary operator");
GLOBAL_STR(str475, "Expected ), got %s");
GLOBAL_STR(str476, "Unexpected token in boolean expression (%s)");
GLOBAL_STR(str477, "");
GLOBAL_STR(str478, "Expected %d, got %d");
GLOBAL_STR(str479, "Step can't be 0");
GLOBAL_STR(str480, "Invalid step %d for ascending integer range");
GLOBAL_STR(str481, "Invalid step %d for descending integer range");
GLOBAL_STR(str482, "Invalid step %d for ascending character range");
GLOBAL_STR(str483, "Invalid step %d for descending character range");
GLOBAL_STR(str484, "Mismatched cases in character range");
GLOBAL_STR(str485, "");
GLOBAL_STR(str486, "0");
GLOBAL_STR(str487, "0");
GLOBAL_STR(str488, "g");
...
GLOBAL_STR(str525, ")");
GLOBAL_STR(str526, "");
GLOBAL_STR(str527, "export_");
GLOBAL_STR(str528, "doesn't accept -f because it's dangerous.  (The code can usually be restructured with 'source')");
GLOBAL_STR(str529, "doesn't accept RHS with -n");
GLOBAL_STR(str530, "Got -a but RHS isn't an array");
GLOBAL_STR(str531, "Got -A but RHS isn't an associative array");
GLOBAL_STR(str532, "readonly");
GLOBAL_STR(str533, "new_var");
GLOBAL_STR(str534, "with -f expects function names");
GLOBAL_STR(str535, "declare -f %s");
GLOBAL_STR(str536, "-");
GLOBAL_STR(str537, "-");
GLOBAL_STR(str538, "-");
GLOBAL_STR(str539, "+");
GLOBAL_STR(str540, "+");
GLOBAL_STR(str541, "+");
GLOBAL_STR(str542, "unset");
GLOBAL_STR(str543, "Invalid shift argument %r");
GLOBAL_STR(str544, "got too many arguments");
GLOBAL_STR(str545, "eval");
GLOBAL_STR(str546, "requires code string");
GLOBAL_STR(str547, "requires exactly 1 argument");
GLOBAL_STR(str548, " ");
...
GLOBAL_STR(str679, "");
GLOBAL_STR(str680, "alias");
GLOBAL_STR(str681, "alias %s=%r");
GLOBAL_STR(str682, "=");
GLOBAL_STR(str683, "No alias named %r");
GLOBAL_STR(str684, "alias %s=%r");
GLOBAL_STR(str685, "unalias");
GLOBAL_STR(str686, "requires an argument");
GLOBAL_STR(str687, "No alias named %r");
GLOBAL_STR(str688, "%s=%s");
GLOBAL_STR(str689, "set");
GLOBAL_STR(str690, "shopt");
GLOBAL_STR(str691, "got invalid option %r");
GLOBAL_STR(str692, "hash");
GLOBAL_STR(str693, "got extra arguments after -r");
GLOBAL_STR(str694, "hash: %r not found");
GLOBAL_STR(str695, ":");
GLOBAL_STR(str696, "OPTIND");
GLOBAL_STR(str697, "OPTIND");
GLOBAL_STR(str698, "OPTARG");
...
GLOBAL_STR(str704, "?");
GLOBAL_STR(str705, "?");
GLOBAL_STR(str706, "getopts: option %r requires an argument.");
GLOBAL_STR(str707, "(getopts argv: %s)");
GLOBAL_STR(str708, " ");
GLOBAL_STR(str709, "?");
GLOBAL_STR(str710, "");
GLOBAL_STR(str711, "requires an argspec");
GLOBAL_STR(str712, "requires the name of a variable to set");
GLOBAL_STR(str713, "got invalid variable name %r");
GLOBAL_STR(str714, "echo");
GLOBAL_STR(str715, "");
GLOBAL_STR(str716, "takes at most one arg when simple_echo is on (hint: add quotes)");
GLOBAL_STR(str717, " ");
GLOBAL_STR(str718, "\n");
GLOBAL_STR(str719, "module");
GLOBAL_STR(str720, "requires a name");
GLOBAL_STR(str721, "[oil -i] Reloading module %r");
GLOBAL_STR(str722, "expected 'bin' or 'dialect'");
GLOBAL_STR(str723, "dialect");
GLOBAL_STR(str724, "expected dialect name");
GLOBAL_STR(str725, "_DIALECT");
GLOBAL_STR(str726, "Expected dialect %r, got %r");
GLOBAL_STR(str727, "Expected dialect %r");
GLOBAL_STR(str728, "bin");
GLOBAL_STR(str729, "bin %s");
GLOBAL_STR(str730, "expected 'bin' or 'dialect'");
GLOBAL_STR(str731, "shvar");
GLOBAL_STR(str732, "expected a block");
GLOBAL_STR(str733, "Expected name=value");
GLOBAL_STR(str734, "=");
GLOBAL_STR(str735, "Expected name=value");
GLOBAL_STR(str736, "expected a block");
GLOBAL_STR(str737, "Assignment builtin %r not configured");
GLOBAL_STR(str738, "%r ");
GLOBAL_STR(str739, "");
GLOBAL_STR(str740, "command in ");
GLOBAL_STR(str741, "assignment in ");
GLOBAL_STR(str742, "subshell invoked from ");
GLOBAL_STR(str743, "pipeline invoked from ");
GLOBAL_STR(str744, "");
GLOBAL_STR(str745, "Exiting with status %d (%sPID %d)");
GLOBAL_STR(str746, "Redirect filename can't be empty");
GLOBAL_STR(str747, "Redirect descriptor can't be empty");
GLOBAL_STR(str748, "-");
GLOBAL_STR(str749, "-");
GLOBAL_STR(str750, "Invalid descriptor %r.  Expected D, -, or D- where D is an integer");
GLOBAL_STR(str751, "\n");
GLOBAL_STR(str752, "Unknown redirect op");
GLOBAL_STR(str753, "Unknown redirect type");
GLOBAL_STR(str754, "strict_errexit only allows simple commands (got %s). Hint: use 'try'.");
GLOBAL_STR(str755, "strict_errexit only allows a single command.  Hint: use \"run\".");
GLOBAL_STR(str756, "strict_errexit only allows simple commands (got %s). Hint: use 'try'.");
GLOBAL_STR(str757, "ShAssignment builtins don't accept blocks");
GLOBAL_STR(str758, "|& isn't supported");
GLOBAL_STR(str759, "Can't append array to string");
GLOBAL_STR(str760, "Can't append string to array");
GLOBAL_STR(str761, "%r expected a number, got %r");
GLOBAL_STR(str762, "Invalid control flow at top level");
GLOBAL_STR(str763, "warning: ");
GLOBAL_STR(str764, "Function %s was already defined (redefine_proc)");
GLOBAL_STR(str765, "Proc %s was already defined (redefine_proc)");
GLOBAL_STR(str766, "trap");
GLOBAL_STR(str767, "Loop and control flow can't be in different processes");
GLOBAL_STR(str768, "fatal: ");
GLOBAL_STR(str769, "EXIT");
GLOBAL_STR(str770, "trap EXIT");
GLOBAL_STR(str771, "__");
GLOBAL_STR(str772, ":");
GLOBAL_STR(str773, "Invalid argument %r.  Expected a name starting with :");
GLOBAL_STR(str774, "No value provided for param %r");
GLOBAL_STR(str775, "proc %r expected %d arguments, but got %d");
GLOBAL_STR(str776, "Unexpected %r (in function call)");
GLOBAL_STR(str777, "Attempted to exit from completion hook.");
GLOBAL_STR(str778, "Couldn't find terminator for here doc that starts here");
GLOBAL_STR(str779, "\t");
GLOBAL_STR(str780, "Invalid here doc delimiter");
GLOBAL_STR(str781, "+");
GLOBAL_STR(str782, "+");
GLOBAL_STR(str783, "+");
GLOBAL_STR(str784, "%d != %d");
GLOBAL_STR(str785, "Environment binding shouldn't look like an array assignment");
GLOBAL_STR(str786, "+");
GLOBAL_STR(str787, "Expected = in environment binding, got +=");
GLOBAL_STR(str788, "Environment bindings can't contain array literals");
GLOBAL_STR(str789, "procs and shell functions can't be nested");
GLOBAL_STR(str790, "%r was already declared");
GLOBAL_STR(str791, "%r hasn't been declared");
GLOBAL_STR(str792, "Can't modify constant %r");
GLOBAL_STR(str793, "Expected word type %s, got %s");
GLOBAL_STR(str794, "{");
GLOBAL_STR(str795, "}");
GLOBAL_STR(str796, "Invalid token after redirect operator");
GLOBAL_STR(str797, "TODO: Parse Redirect");
GLOBAL_STR(str798, " ");
GLOBAL_STR(str799, " ");
GLOBAL_STR(str800, "line IDs %d != %d");
GLOBAL_STR(str801, " ");
GLOBAL_STR(str802, "");
GLOBAL_STR(str803, "Unexpected block");
GLOBAL_STR(str804, "=word isn't allowed when shopt 'parse_equals' is on.\nHint: add a space after = to pretty print an expression");
GLOBAL_STR(str805, "name=val isn't allowed when shopt 'parse_equals' is on.\nHint: add 'env' before it, or spaces around =");
GLOBAL_STR(str806, "Unexpected block");
GLOBAL_STR(str807, "Unexpected block");
GLOBAL_STR(str808, "Control flow shouldn't have redirects");
GLOBAL_STR(str809, "Control flow shouldn't have environment bindings");
GLOBAL_STR(str810, "Unexpected argument to %r");
GLOBAL_STR(str811, "Invalid word in for loop");
GLOBAL_STR(str812, "Invalid word after for expression");
GLOBAL_STR(str813, "Loop variable name should be a constant");
GLOBAL_STR(str814, "Invalid loop variable name");
GLOBAL_STR(str815, "Unexpected word after for loop variable");
GLOBAL_STR(str816, "Expected ;; or esac");
GLOBAL_STR(str817, "Unexpected word while parsing compound command");
GLOBAL_STR(str818, "Invalid function name");
GLOBAL_STR(str819, "Expected ) in function definition");
GLOBAL_STR(str820, "Invalid KSH-style function name");
GLOBAL_STR(str821, "Unexpected word when parsing command");
GLOBAL_STR(str822, "Unexpected right brace");
GLOBAL_STR(str823, "Unexpected EOF while parsing command");
GLOBAL_STR(str824, "Invalid word while parsing command");
GLOBAL_STR(str825, "Unexpected word while parsing command line");
GLOBAL_STR(str826, "Unterminated here doc began here");
GLOBAL_STR(str827, "\\");
GLOBAL_STR(str828, "*");
GLOBAL_STR(str829, "?");
GLOBAL_STR(str830, "[");
...
GLOBAL_STR(str834, "\\?*+{}^$.()|");
GLOBAL_STR(str835, "\\");
GLOBAL_STR(str836, "Unexpected escaped character %r");
GLOBAL_STR(str837, "");
GLOBAL_STR(str838, "");
GLOBAL_STR(str839, "Malformed character class; treating as literal");
GLOBAL_STR(str840, "Got unescaped right bracket");
GLOBAL_STR(str841, "Got unescaped trailing backslash");
GLOBAL_STR(str842, ".|^$()+*?[]{}\\");
GLOBAL_STR(str843, "\\");
GLOBAL_STR(str844, "\\");
GLOBAL_STR(str845, "\\[");
...
GLOBAL_STR(str857, "]");
GLOBAL_STR(str858, "");
GLOBAL_STR(str859, "Error expanding glob %r: %s");
GLOBAL_STR(str860, "-");
GLOBAL_STR(str861, "<Error: unbalanced \\[ and \\]> ");
GLOBAL_STR(str862, "$");
GLOBAL_STR(str863, "#");
GLOBAL_STR(str864, "$");
GLOBAL_STR(str865, "hostname");
GLOBAL_STR(str866, "user");
GLOBAL_STR(str867, "$ ");
GLOBAL_STR(str868, "\u0001");
GLOBAL_STR(str869, "\u0002");
GLOBAL_STR(str870, "$");
GLOBAL_STR(str871, "$");
GLOBAL_STR(str872, "u");
GLOBAL_STR(str873, "user");
GLOBAL_STR(str874, "h");
GLOBAL_STR(str875, "hostname");
GLOBAL_STR(str876, ".");
GLOBAL_STR(str877, "H");
GLOBAL_STR(str878, "hostname");
GLOBAL_STR(str879, "w");
GLOBAL_STR(str880, "PWD");
GLOBAL_STR(str881, "HOME");
GLOBAL_STR(str882, "<Error: %s>");
GLOBAL_STR(str883, "W");
GLOBAL_STR(str884, "PWD");
GLOBAL_STR(str885, "<Error: PWD is not a string> ");
GLOBAL_STR(str886, "<Error: \\%s not implemented in $PS1> ");
GLOBAL_STR(str887, "$");
GLOBAL_STR(str888, "\\$");
GLOBAL_STR(str889, "Invalid token %r");
GLOBAL_STR(str890, "");
GLOBAL_STR(str891, "<ERROR: Can't parse PS1: %s>");
GLOBAL_STR(str892, "osh");
GLOBAL_STR(str893, "PS1");
GLOBAL_STR(str894, "PROMPT_COMMAND");
GLOBAL_STR(str895, "Undefined variable %r");
GLOBAL_STR(str896, "Can't use [] on value of type %s");
GLOBAL_STR(str897, "");
GLOBAL_STR(str898, "Can't use [] on value of type %s");
GLOBAL_STR(str899, "");
GLOBAL_STR(str900, "got invalid place expression");
GLOBAL_STR(str901, "expected a var name.  shopt -s eval_unsafe_arith allows a[i]");
GLOBAL_STR(str902, "Invalid var ref");
GLOBAL_STR(str903, "0x");
GLOBAL_STR(str904, "Invalid hex constant %r");
GLOBAL_STR(str905, "0");
GLOBAL_STR(str906, "Invalid octal constant %r");
GLOBAL_STR(str907, "#");
GLOBAL_STR(str908, "#");
GLOBAL_STR(str909, "Invalid base for numeric constant %r");
GLOBAL_STR(str910, "a");
GLOBAL_STR(str911, "A");
GLOBAL_STR(str912, "@");
GLOBAL_STR(str913, "_");
GLOBAL_STR(str914, "Invalid digits for numeric constant %r");
GLOBAL_STR(str915, "Digits %r out of range for base %d");
GLOBAL_STR(str916, "Parse error in recursive arithmetic");
GLOBAL_STR(str917, "Invalid integer constant %r");
GLOBAL_STR(str918, "Invalid integer constant %r");
GLOBAL_STR(str919, "Invalid integer constant %r");
GLOBAL_STR(str920, "Undefined value in arithmetic context");
GLOBAL_STR(str921, "Expected a value convertible to integer, got %s");
GLOBAL_STR(str922, "0");
GLOBAL_STR(str923, "Divide by zero");
GLOBAL_STR(str924, "Divide by zero");
GLOBAL_STR(str925, "Expected array or assoc in index expression, got %s");
GLOBAL_STR(str926, "Divide by zero");
GLOBAL_STR(str927, "Divide by zero");
GLOBAL_STR(str928, "Exponent can't be less than zero");
GLOBAL_STR(str929, "Associative array keys must be strings: $x 'x' \"$x\" etc.");
GLOBAL_STR(str930, "Invalid place to modify");
GLOBAL_STR(str931, "%s isn't implemented");
GLOBAL_STR(str932, "Invalid regex %r: %s");
GLOBAL_STR(str933, " \t\n");
GLOBAL_STR(str934, "IFS");
GLOBAL_STR(str935, "IFS shouldn't be an array");
GLOBAL_STR(str936, " \t\n");
GLOBAL_STR(str937, "IFS");
GLOBAL_STR(str938, " ");
GLOBAL_STR(str939, "");
GLOBAL_STR(str940, "IFS shouldn't be an array");
GLOBAL_STR(str941, "\\");
GLOBAL_STR(str942, "\\");
GLOBAL_STR(str943, "Invalid transition from %r with %r");
GLOBAL_STR(str944, "\u00ef\u00bf\u00bd");
GLOBAL_STR(str945, "");
GLOBAL_STR(str946, "Incomplete UTF-8 character");
GLOBAL_STR(str947, "Invalid UTF-8 continuation byte");
GLOBAL_STR(str948, "Invalid start of UTF-8 character");
GLOBAL_STR(str949, "");
GLOBAL_STR(str950, "%s can't have an argument");
GLOBAL_STR(str951, "");
GLOBAL_STR(str952, "%s can't have an argument");
GLOBAL_STR(str953, "");
GLOBAL_STR(str954, "%s can't have an argument");
GLOBAL_STR(str955, "");
GLOBAL_STR(str956, "%s can't have an argument");
GLOBAL_STR(str957, "");
GLOBAL_STR(str958, "<_GlobReplacer regex %r r %r>");
GLOBAL_STR(str959, "(%s)");
GLOBAL_STR(str960, "Error matching regex %r: %s");
GLOBAL_STR(str961, "^");
GLOBAL_STR(str962, "$");
GLOBAL_STR(str963, "\r");
GLOBAL_STR(str964, "<INVALID CR>");
GLOBAL_STR(str965, "\n");
GLOBAL_STR(str966, "<INVALID NEWLINE>");
GLOBAL_STR(str967, " `~!$&*()[]{}\\|;'\"<>?");
GLOBAL_STR(str968, "Left-hand side of this assignment is invalid");
GLOBAL_STR(str969, "Token can't be used in prefix position");
GLOBAL_STR(str970, "Token can't be used in infix position");
GLOBAL_STR(str971, "Parser expected %s, got %s");
GLOBAL_STR(str972, "Unexpected end of input");
GLOBAL_STR(str973, "");
GLOBAL_STR(str974, "");
GLOBAL_STR(str975, " \t");
GLOBAL_STR(str976, "\n");
...
GLOBAL_STR(str978, "\n");
GLOBAL_STR(str979, "\n");
GLOBAL_STR(str980, "BASH_SOURCE");
GLOBAL_STR(str981, "FUNCNAME");
GLOBAL_STR(str982, "BASH_LINENO");
GLOBAL_STR(str983, "0");
GLOBAL_STR(str984, "0");
GLOBAL_STR(str985, "\\");
GLOBAL_STR(str986, "\\\\");
GLOBAL_STR(str987, "");
GLOBAL_STR(str988, "");
GLOBAL_STR(str989, "The length index of a array slice can't be negative: %d");
GLOBAL_STR(str990, "Can't slice associative arrays");
GLOBAL_STR(str991, "i");
GLOBAL_STR(str992, "e");
GLOBAL_STR(str993, "f");
GLOBAL_STR(str994, "n");
...
GLOBAL_STR(str998, "");
GLOBAL_STR(str999, "~");
GLOBAL_STR(str1000, "HOME");
GLOBAL_STR(str1001, "Error expanding tilde (e.g. invalid user)");
GLOBAL_STR(str1002, "Can't assign to special variable");
GLOBAL_STR(str1003, "unset variable %r");
GLOBAL_STR(str1004, "warning: ");
GLOBAL_STR(str1005, "-1");
GLOBAL_STR(str1006, "a[i] not allowed without shopt -s eval_unsafe_arith");
GLOBAL_STR(str1007, "Indirect expansion of array");
GLOBAL_STR(str1008, "Indirect expansion of assoc array");
GLOBAL_STR(str1009, "");
GLOBAL_STR(str1010, "warning: ");
GLOBAL_STR(str1011, "");
GLOBAL_STR(str1012, "\u0001");
GLOBAL_STR(str1013, "");
GLOBAL_STR(str1014, "\u0002");
GLOBAL_STR(str1015, "");
GLOBAL_STR(str1016, "Can't use @P on %s");
GLOBAL_STR(str1017, " ");
GLOBAL_STR(str1018, "Can't use @Q on %s");
GLOBAL_STR(str1019, "a");
GLOBAL_STR(str1020, "A");
GLOBAL_STR(str1021, "r");
GLOBAL_STR(str1022, "x");
GLOBAL_STR(str1023, "n");
GLOBAL_STR(str1024, "");
GLOBAL_STR(str1025, "Var op %r not implemented");
GLOBAL_STR(str1026, "Can't index string with @");
GLOBAL_STR(str1027, "Can't index string with *");
GLOBAL_STR(str1028, "Can't index string %r with integer");
GLOBAL_STR(str1029, "");
GLOBAL_STR(str1030, "");
GLOBAL_STR(str1031, "$");
GLOBAL_STR(str1032, "Undefined variable %r");
GLOBAL_STR(str1033, "Undefined array %r");
GLOBAL_STR(str1034, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str1035, "Test operation not allowed with ${!array[@]}");
GLOBAL_STR(str1036, "Not implemented");
GLOBAL_STR(str1037, "Illegal array word part (strict_array)");
GLOBAL_STR(str1038, " ");
GLOBAL_STR(str1039, "");
GLOBAL_STR(str1040, "Array %r can't be referred to as a scalar (without @ or *)");
GLOBAL_STR(str1041, "Unexpected array literal");
GLOBAL_STR(str1042, "Unexpected associative array literal");
GLOBAL_STR(str1043, "@(");
GLOBAL_STR(str1044, "|");
GLOBAL_STR(str1045, ")");
GLOBAL_STR(str1046, "Can't splice %r");
GLOBAL_STR(str1047, "");
GLOBAL_STR(str1048, "");
GLOBAL_STR(str1049, "This word should yield a string, but it contains an array");
GLOBAL_STR(str1050, " ");
GLOBAL_STR(str1051, "");
GLOBAL_STR(str1052, "<Runtime error: %s>");
GLOBAL_STR(str1053, "<I/O error: %s>");
GLOBAL_STR(str1054, "<Ctrl-C>");
GLOBAL_STR(str1055, "");
GLOBAL_STR(str1056, "");
GLOBAL_STR(str1057, "");
GLOBAL_STR(str1058, "");
GLOBAL_STR(str1059, "");
GLOBAL_STR(str1060, "LHS array not allowed in assignment builtin");
GLOBAL_STR(str1061, "+");
GLOBAL_STR(str1062, "+= not allowed in assignment builtin");
GLOBAL_STR(str1063, "-");
GLOBAL_STR(str1064, "+");
GLOBAL_STR(str1065, "f");
GLOBAL_STR(str1066, "F");
GLOBAL_STR(str1067, "");
GLOBAL_STR(str1068, "=");
GLOBAL_STR(str1069, "Invalid variable name %r");
GLOBAL_STR(str1070, "__NO_COMMAND_SUB__");
GLOBAL_STR(str1071, "__NO_PROCESS_SUB__");
GLOBAL_STR(str1072, "Expected : or } in slice");
GLOBAL_STR(str1073, "Pattern in ${x/pat/replace} must not be empty");
GLOBAL_STR(str1074, "Expected } after replacement string, got %s");
GLOBAL_STR(str1075, "Expected } or / to close pattern");
GLOBAL_STR(str1076, "Expected ] to close subscript");
GLOBAL_STR(str1077, "Expected } to close ${");
GLOBAL_STR(str1078, "Expected } to close ${");
GLOBAL_STR(str1079, "Expected a constant argument");
GLOBAL_STR(str1080, "Expected } to close ${");
GLOBAL_STR(str1081, "Expected } to close ${");
GLOBAL_STR(str1082, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1083, "VOp2");
GLOBAL_STR(str1084, "Unexpected token in ${} (%s)");
GLOBAL_STR(str1085, "VOp3");
GLOBAL_STR(str1086, "Expected } to close ${");
GLOBAL_STR(str1087, "Expected } after length expression");
GLOBAL_STR(str1088, "TODO: ${.myproc builtin sub}");
GLOBAL_STR(str1089, "Unexpected token in ${}");
GLOBAL_STR(str1090, "\\");
GLOBAL_STR(str1091, "Strings with backslashes should look like r'\\n' or $'\\n'");
GLOBAL_STR(str1092, "Use \\xhh or \\u{...} instead of octal escapes in Oil strings");
GLOBAL_STR(str1093, "Invalid hex escape in Oil string (must be \\xHH)");
GLOBAL_STR(str1094, "Invalid char escape in C-style string literal");
GLOBAL_STR(str1095, "Unexpected EOF in single-quoted string that began here");
GLOBAL_STR(str1096, "\"");
GLOBAL_STR(str1097, "'");
GLOBAL_STR(str1098, "Unexpected EOF reading extended glob that began here");
GLOBAL_STR(str1099, "Invalid char escape in double quoted string");
GLOBAL_STR(str1100, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1101, "Invalid backtick: use $(cmd) or \\` in Oil strings");
GLOBAL_STR(str1102, "Unexpected EOF reading double-quoted string that began here");
GLOBAL_STR(str1103, "Use $(cmd) instead of backticks (parse_backticks)");
GLOBAL_STR(str1104, "Unexpected EOF while looking for closing backtick");
GLOBAL_STR(str1105, "");
GLOBAL_STR(str1106, "Invalid proc name %s");
GLOBAL_STR(str1107, "Unexpected token after arithmetic expression (%s != %s)");
GLOBAL_STR(str1108, "Expected second ) to end arith sub");
GLOBAL_STR(str1109, "Expected second ) to end arith statement");
GLOBAL_STR(str1110, "Expected ; here");
GLOBAL_STR(str1111, "Expected ; here");
GLOBAL_STR(str1112, "Expected ) to end for loop expression");
GLOBAL_STR(str1113, "Expected ( after =");
GLOBAL_STR(str1114, "Unexpected token in array literal");
GLOBAL_STR(str1115, "Expected associative array pair");
GLOBAL_STR(str1116, "Invalid char escape (parse_backslash)");
GLOBAL_STR(str1117, "Unexpected token after array literal");
GLOBAL_STR(str1118, "Unexpected token after array splice");
GLOBAL_STR(str1119, "Literal @ starting a word must be quoted (parse_at_all)");
GLOBAL_STR(str1120, "/");
GLOBAL_STR(str1121, "next_byte %r");
GLOBAL_STR(str1122, "Literal $ should be quoted like \\$");
GLOBAL_STR(str1123, "Unexpected token after @()");
GLOBAL_STR(str1124, "Word has unbalanced { }.  Maybe add a space or quote it like \\{");
GLOBAL_STR(str1125, "Unexpected parts after triple quoted string");
GLOBAL_STR(str1126, "Unexpected token while parsing arithmetic: %r");
GLOBAL_STR(str1127, "r");
GLOBAL_STR(str1128, "Unhandled: %s (%s)");
GLOBAL_STR(str1129, "Invalid var ref");
GLOBAL_STR(str1130, "Expected end of var ref");
GLOBAL_STR(str1131, "Invalid lex state %s");
GLOBAL_STR(str1132, "");
GLOBAL_STR(str1133, "");
GLOBAL_STR(str1134, "");
GLOBAL_STR(str1135, "");
...
GLOBAL_STR(str1139, "");
GLOBAL_STR(str1140, "");
GLOBAL_STR(str1141, "Compound shouldn't be empty");
GLOBAL_STR(str1142, "/");
GLOBAL_STR(str1143, "/");
GLOBAL_STR(str1144, "");
GLOBAL_STR(str1145, "EOF");
GLOBAL_STR(str1146, "typ");
GLOBAL_STR(str1147, "tok");
GLOBAL_STR(str1148, "children");
GLOBAL_STR(str1149, "-");
GLOBAL_STR(str1150, "with %d children");
GLOBAL_STR(str1151, "");
GLOBAL_STR(str1152, "(PNode %s %s %s)");
GLOBAL_STR(str1153, "&");
GLOBAL_STR(str1154, "&amp;");
GLOBAL_STR(str1155, "<");
GLOBAL_STR(str1156, "&lt;");
...
GLOBAL_STR(str1178, "/");
GLOBAL_STR(str1179, " \n\r\t");
GLOBAL_STR(str1180, "Unexpected token in QSN string");
GLOBAL_STR(str1181, "Expected closing single quote in QSN string");
GLOBAL_STR(str1182, "Unexpected data after closing quote");
GLOBAL_STR(str1183, "Unexpected token after QSN string");
GLOBAL_STR(str1184, "\\'\r\n\t\u0000");
GLOBAL_STR(str1185, "$'");
GLOBAL_STR(str1186, "'");
GLOBAL_STR(str1187, "'");
...
GLOBAL_STR(str1199, "\n");
GLOBAL_STR(str1200, "\\n");
GLOBAL_STR(str1201, "\r");
GLOBAL_STR(str1202, "\\r");
GLOBAL_STR(str1203, "\t");
GLOBAL_STR(str1204, "\\t");
GLOBAL_STR(str1205, "\u0000");
GLOBAL_STR(str1206, "\\x00");
GLOBAL_STR(str1207, "\\0");
GLOBAL_STR(str1208, "");
GLOBAL_STR(str1209, "");
GLOBAL_STR(str1210, "");
GLOBAL_STR(str1211, "\\");
...
GLOBAL_STR(str1215, "\n");
GLOBAL_STR(str1216, "\\n");
GLOBAL_STR(str1217, "\r");
GLOBAL_STR(str1218, "\\r");
GLOBAL_STR(str1219, "\t");
GLOBAL_STR(str1220, "\\t");
GLOBAL_STR(str1221, "\u0000");
GLOBAL_STR(str1222, "\\x00");
GLOBAL_STR(str1223, "\\0");
GLOBAL_STR(str1224, "");
GLOBAL_STR(str1225, "!");
GLOBAL_STR(str1226, "--");
GLOBAL_STR(str1227, "--dir");
GLOBAL_STR(str1228, "--exists");
GLOBAL_STR(str1229, "--file");
GLOBAL_STR(str1230, "--symlink");
GLOBAL_STR(str1231, "Expected unary operator, got %r (2 args)");
GLOBAL_STR(str1232, "-a");
GLOBAL_STR(str1233, "-o");
GLOBAL_STR(str1234, "!");
GLOBAL_STR(str1235, "(");
GLOBAL_STR(str1236, ")");
GLOBAL_STR(str1237, "Expected binary operator, got %r (3 args)");
GLOBAL_STR(str1238, "should be invoked as 'test' (simple_test_builtin)");
GLOBAL_STR(str1239, "]");
GLOBAL_STR(str1240, "missing closing ]");
GLOBAL_STR(str1241, "should only have 3 arguments or fewer (simple_test_builtin)");
GLOBAL_STR(str1242, "!");
GLOBAL_STR(str1243, "(");
GLOBAL_STR(str1244, ")");
GLOBAL_STR(str1245, "(test) ");
GLOBAL_STR(str1246, "(test) ");
...
void _PrintShValue(runtime_asdl::value_t* val, mylib::BufWriter* buf) {
  ...
  switch (val->tag_()) {
    ...
    case value_e::MaybeStrArray: {
      ...
      parts = Alloc<List<Str*>>(std::initializer_list<Str*>{str56});
...
Tracer::Tracer(parse_lib::ParseContext* parse_ctx, optview::Exec* exec_opts, state::MutableOpts* mutable_opts, state::Mem* mem, util::_DebugFile* f) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Tracer)) {
  ...
  this->ind = 0;
  this->indents = Alloc<List<Str*>>(std::initializer_list<Str*>{str65});
  this->parse_cache = Alloc<Dict<Str*, syntax_asdl::compound_word*>>();
  this->val_indent = Alloc<value::Str>(str66);
  this->val_punct = Alloc<value::Str>(str67);
  this->val_pid_str = Alloc<value::Str>(str68);
  this->lval_indent = Alloc<lvalue::Named>(str69);
  this->lval_punct = Alloc<lvalue::Named>(str70);
  this->lval_pid_str = Alloc<lvalue::Named>(str71);
}
...
void Tracer::_Inc() {
  ...
  if (this->ind >= len(this->indents)) {
    this->indents->append(str_repeat(str76, this->ind));
  }
}
...
void Tracer::OnProcessStart(int pid, runtime_asdl::trace_t* why) {
  ...
  buf = this->_RichTraceBegin(str78);
  if (!buf) {
    return ;
  }
  UP_why = why;
...
void Tracer::OnProcessEnd(int pid, int status) {
  ...
  buf = this->_RichTraceBegin(str86);
  if (!buf) {
    return ;
  }
...
void Tracer::PopMessage(Str* label, Str* arg) {
  ...
  this->_Dec();
  buf = this->_RichTraceBegin(str94);
  if (buf) {
    buf->write(label);
    if (arg != nullptr) {
      buf->write(str95);
...
void Tracer::OnExec(List<Str*>* argv) {
  ...
  buf = this->_RichTraceBegin(str99);
  if (!buf) {
    return ;
  }
  buf->write(str100);
...
void Tracer::OnBuiltin(int builtin_id, List<Str*>* argv) {
  ...
  buf = this->_RichTraceBegin(str101);
  if (!buf) {
    return ;
  }
  buf->write(str102);
...
void Tracer::OnShAssignment(runtime_asdl::lvalue_t* lval, syntax_asdl::assign_op_t op, runtime_asdl::value_t* val, int flags, runtime_asdl::scope_t which_scopes) {
  ...
  buf->write(left);
  buf->write(op == assign_op_e::PlusEqual ? str112 : str113);
...
void Tracer::PrintSourceCode(int left_spid, int right_spid, alloc::Arena* arena) {
  ...
  if (left_span->line_id == right_span->line_id) {
    ...
    line = arena->GetLine(left_span->line_id);
    end = line->endswith(str118) ? -1 : len(line);
    buf->write(line->slice(start, end));
    buf->write(str119);
  }
  buf->write(str120);
...
int ShellExecutor::RunSimpleCommand(runtime_asdl::cmd_value__Argv* cmd_val, bool do_fork, bool call_procs) {
  ...
  if (builtin_id != consts::NO_INDEX) {
    this->errfmt->Print_(str126, span_id);
    return 1;
  }
...
void ShellExecutor::RunPipeline(syntax_asdl::command__Pipeline* node, runtime_asdl::CompoundStatus* status_out) {
  ...
  {  // with
    dev::ctx_Tracer ctx(this->tracer, str133, nullptr);
...
Str* ShellExecutor::RunCommandSub(syntax_asdl::command_sub* cs_part) {
  ...
  if (node->tag_() == command_e::Simple) {
    ...
    if ((len(simple->words) == 0 and (len(simple->redirects) == 1 and simple->redirects->index(0)->op->id == Id::Redir_Less))) {
      tok = Alloc<Token>(Id::Lit_Chars, runtime::NO_SPID, str135);
...
int Process::Start(runtime_asdl::trace_t* why) {
  ...
  pid = posix::fork();
  if (pid < 0) {
    throw Alloc<RuntimeError>(str188);
  }
  else {
    if (pid == 0) {
...
runtime_asdl::cmd_value__Argv* MakeBuiltinArgv(List<Str*>* argv1) {
  ...
  argv = Alloc<List<Str*>>(std::initializer_list<Str*>{str196});
  argv->extend(argv1);
  return Alloc<cmd_value::Argv>(argv, list_repeat(runtime::NO_SPID, len(argv)), nullptr);
}
...
int Main(Str* lang, args::Reader* arg_r, Dict<Str*, Str*>* environ, bool login_shell, pyutil::_ResourceLoader* loader, void* line_input) {
  ...
  arg_r->Next();
  try {
    attrs = flag_spec::ParseMore(str197, arg_r);
  }
  catch (error::Usage* e) {
  ...
  if (flag->version) {
    pyutil::ShowAppVersion(str200, loader);
    return 0;
  }
  no_str = nullptr;
  debug_stack = Alloc<List<state::DebugFrame*>>();
  if (arg_r->AtEnd()) {
    ...
    dollar0 = arg_r->Peek();
    frame0 = Alloc<state::DebugFrame>(dollar0, str201, no_str, state::LINE_ZERO, 0, 0);
    debug_stack->append(frame0);
  }
  frame1 = Alloc<state::DebugFrame>(no_str, no_str, no_str, runtime::NO_SPID, 0, 0);
  debug_stack->append(frame1);
  ...
  if (str_equals(lang, str202)) {
    mutable_opts->SetShoptOption(str203, true);
  }
  builtin_pure::SetShellOpts(mutable_opts, attrs->opt_changes, attrs->shopt_changes);
  aliases = Alloc<Dict<Str*, Str*>>();
  oil_grammar = nullptr;
  ...
  parse_ctx->Init_OnePassParse(flag->one_pass_parse);
  comp_arena = Alloc<alloc::Arena>();
  comp_arena->PushSource(Alloc<source::Unused>(str205));
  trail1 = Alloc<parse_lib::Trail>();
  comp_ctx = Alloc<parse_lib::ParseContext>(comp_arena, parse_opts, aliases, oil_grammar);
  comp_ctx->Init_Trail(trail1);
  comp_ctx->Init_OnePassParse(true);
  hist_arena = Alloc<alloc::Arena>();
  hist_arena->PushSource(Alloc<source::Unused>(str206));
  trail2 = Alloc<parse_lib::Trail>();
  hist_ctx = Alloc<parse_lib::ParseContext>(hist_arena, parse_opts, aliases, oil_grammar);
  hist_ctx->Init_Trail(trail2);
  cmd_deps = Alloc<cmd_eval::Deps>();
  ...
  waiter = Alloc<process::Waiter>(job_state, exec_opts, sig_state, tracer);
  fd_state->waiter = waiter;
  interp = environ->get(str211, str212);
  search_path = Alloc<state::SearchPath>(mem);
  ext_prog = Alloc<process::ExternalProgram>(interp, fd_state, errfmt, debug_f);
  splitter = Alloc<split::SplitContext>(mem);
  crash_dump_dir = environ->get(str213, str214);
  cmd_deps->dumper = Alloc<dev::CrashDumper>(crash_dump_dir);
  dir_stack = Alloc<state::DirStack>();
  builtins = Alloc<Dict<int, vm::_Builtin*>>();
  modules = Alloc<Dict<Str*, bool>>();
  ...
  if (flag->c != nullptr) {
    ...
    if (flag->i) {
      ...
      if (script_name == nullptr) {
        stdin = mylib::Stdin();
        arena->PushSource(Alloc<source::Stdin>(str215));
        line_reader = Alloc<reader::FileLineReader>(stdin, arena);
      }
      else {
        arena->PushSource(Alloc<source::MainFile>(script_name));
...
Str* SearchPath::Lookup(Str* name, bool exec_required) {
  ...
  val = this->mem->GetValue(str222);
  UP_val = val;
  if (val->tag_() == value_e::Str) {
    value__Str* val = static_cast<value__Str*>(UP_val);
    path_list = val->s->split(str223);
  }
  else {
...
void MutableOpts::Init() {
  ...
  UP_shellopts = this->mem->GetValue(str227);
...
void MutableOpts::SetOption(Str* opt_name, bool b) {
  ...
  UP_val = this->mem->GetValue(str231);
  value__Str* val = static_cast<value__Str*>(UP_val);
  shellopts = val->s;
  if (b) {
    if (!str_contains(shellopts, opt_name)) {
      new_val = Alloc<value::Str>(fmt61(shellopts, opt_name));
      this->mem->InternalSetGlobal(str233, new_val);
    }
  }
  else {
    if (str_contains(shellopts, opt_name)) {
      names = Alloc<List<Str*>>();
      for (ListIter<Str*> it(shellopts->split(str234)); !it.Done(); it.Next()) {
        Str* n = it.Value();
        if (!(str_equals(n, opt_name))) {
          names->append(n);
        }
      }
      new_val = Alloc<value::Str>(str235->join(names));
...
void MutableOpts::ShowOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<Str*> it(opt_names); !it.Done(); it.Next()) {
    ...
    b = this->Get(opt_num);
    print(fmt62(b ? str241 : str242, opt_name));
  }
}
...
void MutableOpts::ShowShoptOptions(List<Str*>* opt_names) {
  ...
  for (ListIter<int> it(opt_nums); !it.Done(); it.Next()) {
    ...
    print(fmt64(b ? str248 : str249, consts::OptionName(opt_num)));
  }
}
...
void _InitDefaults(state::Mem* mem) {
  ...
  SetGlobalString(mem, str252, split::DEFAULT_IFS);
  SetGlobalString(mem, str253, str(posix::getuid()));
  SetGlobalString(mem, str254, str(posix::geteuid()));
  SetGlobalString(mem, str255, str(posix::getppid()));
  SetGlobalString(mem, str256, libc::gethostname());
  SetGlobalString(mem, str257, pyos::OsType());
  SetGlobalString(mem, str258, str259);
  SetGlobalString(mem, str260, str261);
  SetGlobalString(mem, str262, _READLINE_DELIMS);
}
...
void _InitVarsFromEnv(state::Mem* mem, Dict<Str*, Str*>* environ) {
  ...
  val = mem->GetValue(str263);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str264, str265);
  }
  mem->SetValue(Alloc<lvalue::Named>(str266), nullptr, scope_e::GlobalOnly, SetReadOnly);
  val = mem->GetValue(str267);
  if (val->tag_() == value_e::Undef) {
    SetGlobalString(mem, str268, _GetWorkingDir());
  }
  mem->SetValue(Alloc<lvalue::Named>(str269), nullptr, scope_e::GlobalOnly, SetExport);
}
...
void InitMem(state::Mem* mem, Dict<Str*, Str*>* environ, Str* version_str) {
  ...
  SetGlobalString(mem, str270, version_str);
  _InitDefaults(mem);
  _InitVarsFromEnv(mem, environ);
  val = mem->GetValue(str271);
...
Mem::Mem(Str* dollar0, List<Str*>* argv, alloc::Arena* arena, List<state::DebugFrame*>* debug_stack) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Mem)) {
  ...
  this->line_num = Alloc<value::Str>(str272);
...
Tuple3<runtime_asdl::cell*, Dict<Str*, runtime_asdl::cell*>*, Str*> Mem::_ResolveNameOrRef(Str* name, runtime_asdl::scope_t which_scopes, bool is_setref, List<Str*>* ref_trail) {
  ...
  if (ref_trail == nullptr) {
    ...
    if (list_contains(ref_trail, new_name)) {
      e_die(fmt68(str284->join(ref_trail)));
    }
  }
  ...
  switch (lval->tag_()) {
    case lvalue_e::Named: {
      ...
      if (keyword_id == Id::KW_SetRef) {
        lval->name = str_concat(str285, lval->name);
      }
...
runtime_asdl::value_t* Mem::GetValue(Str* name, runtime_asdl::scope_t which_scopes) {
  ...
  if ((str_equals(name, str296) || str_equals(name, str297))) {
...
Str* PrettyDir(Str* dir_name, Str* home_dir) {
  ...
  if (home_dir != nullptr) {
    if ((str_equals(dir_name, home_dir) or dir_name->startswith(str_concat(home_dir, str314)))) {
      return str_concat(str315, dir_name->slice(len(home_dir)));
    }
  }
  return dir_name;
}
...
void _PrintCodeExcerpt(Str* line, int col, int length, mylib::Writer* f) {
  ...
  for (StrIter it(line->slice(0, col)); !it.Done(); it.Next()) {
    Str* c = it.Value();
    StackRoots _for({&c  });
    f->write(str_equals(c, str318) ? str319 : str320);
  }
  f->write(str321);
  f->write(str_repeat(str322, (length - 1)));
  f->write(str323);
}
...
void PrettyPrintError(error::_ErrorWithLocation* err, alloc::Arena* arena) {
  PrettyPrintError(err, arena, str336);
}
...
void ErrorFormatter::Print_(Str* msg, int span_id) {
  ...
  _PrintWithOptionalSpanId(str337, msg, span_id, this->arena);
}
...
void PrintAst(syntax_asdl::command_t* node, arg_types::main* flag) {
  ...
  if (maybe_str_equals(flag->ast_format, str339)) {
    println_stderr(str340);
  }
  else {
    f = mylib::Stdout();
    afmt = flag->ast_format;
    if ((maybe_str_equals(afmt, str341) || maybe_str_equals(afmt, str342))) {
      ast_f = fmt::DetectConsoleOutput(f);
    }
    else {
      if ((maybe_str_equals(afmt, str343) || maybe_str_equals(afmt, str344))) {
...
void _Attributes::Set(Str* name, runtime_asdl::value_t* val) {
  ...
  name = name->replace(str348, str349);
...
bool SetAttachedBool::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  if (attached_arg != nullptr) {
    if ((str_equals(attached_arg, str365) || str_equals(attached_arg, str366) || str_equals(attached_arg, str367) || str_equals(attached_arg, str368))) {
      ...
      if ((str_equals(attached_arg, str369) || str_equals(attached_arg, str370) || str_equals(attached_arg, str371) || str_equals(attached_arg, str372))) {
        b = true;
      }
      else {
...
bool SetNamedOption::OnMatch(Str* attached_arg, args::Reader* arg_r, args::_Attributes* out) {
  ...
  b = maybe_str_equals(attached_arg, str375);
  arg_r->Next();
  arg = arg_r->Peek();
  if (arg == nullptr) {
...
args::_Attributes* Parse(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    if (maybe_str_equals(arg, str379)) {
      out->saw_double_dash = true;
      arg_r->Next();
      break;
    }
    if ((len(spec->actions_long) and arg->startswith(str380))) {
      ...
      if ((arg->startswith(str382) and len(arg) > 1)) {
        n = len(arg);
        for (int i = 1; i < n; ++i) {
          ch = arg->index(i);
          if (str_equals(ch, str383)) {
            ch = str384;
          }
          if (list_contains(spec->plus_flags, ch)) {
            out->Set(ch, Alloc<value::Str>(str385));
            continue;
          }
        ...
        if ((len(spec->plus_flags) and (arg->startswith(str388) and len(arg) > 1))) {
          n = len(arg);
          for (int i = 1; i < n; ++i) {
            ch = arg->index(i);
            if (list_contains(spec->plus_flags, ch)) {
              out->Set(ch, Alloc<value::Str>(str389));
              continue;
            }
            e_usage(dynamic_fmt_dummy(), arg_r->SpanId());
          }
...
args::_Attributes* ParseLikeEcho(flag_spec::_FlagSpec* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    arg = arg_r->Peek();
    chars = arg->slice(1);
    if ((arg->startswith(str392) and len(chars))) {
      done = false;
...
args::_Attributes* ParseMore(flag_spec::_FlagSpecAndMore* spec, args::Reader* arg_r) {
  ...
  while (!arg_r->AtEnd()) {
    ...
    if (((arg->startswith(str396) or arg->startswith(str397)) and len(arg) > 1)) {
      char0 = arg->index(0);
...
int LineLexer::GetSpanIdForEof() {
  int line_id;
  if (this->line_id == -1) {
    line_id = this->arena->AddLine(str402, 0);
  }
  else {
...
void Lexer::ResetInputObjects() {
  this->line_lexer->Reset(str404, -1, 0);
}
...
syntax_asdl::Token* Lexer::_Read(types_asdl::lex_mode_t lex_mode) {
  ...
  if (t->id == Id::Eol_Tok) {
    ...
    if (line == nullptr) {
      ...
      t = Alloc<Token>(id_, span_id, str405);
      return t;
    }
...
lexer::Lexer* ParseContext::MakeLexer(reader::_Reader* line_reader) {
  ...
  line_lexer = Alloc<lexer::LineLexer>(str407, this->arena);
...
int _Classify(grammar::Grammar* gr, syntax_asdl::Token* tok) {
  ...
  type_str = tok->id == Id::Unknown_Tok ? str411 : fmt91(ui::PrettyId(tok->id));
...
GLOBAL_LIST(Str*, 12, POSIX_CLASSES, {str415 COMMA str416 COMMA str417 COMMA str418 COMMA str419 COMMA str420 COMMA str421 COMMA str422 COMMA str423 COMMA str424 COMMA str425 COMMA str426});
Str* RANGE_POINT_TOO_LONG = str427;
int NT_OFFSET = 256;
...
syntax_asdl::expr_t* Transformer::_TestlistComp(pnode::PNode* p_node, int id0) {
  ...
  if (id0 == Id::Op_LParen) {
    ...
    throw Alloc<NotImplementedError>(str429);
  }
  if (id0 == Id::Op_LBracket) {
    elts = Alloc<List<syntax_asdl::expr_t*>>();
    for (int i = 0; i < n; i += 2) {
...
syntax_asdl::re_t* Transformer::_NameInRegex(syntax_asdl::Token* negated_tok, syntax_asdl::Token* tok) {
  ...
  val = tok->val;
  if (maybe_str_equals(val, str435)) {
    if (negated_tok) {
      p_die(fmt97(), tok);
    }
    return tok;
...
syntax_asdl::re_t* Transformer::_ReAtom(pnode::PNode* p_atom) {
  ...
  if (ISNONTERMINAL(typ)) {
    ...
    if (tok->id == Id::Expr_Symbol) {
      if ((str_equals(tok->val, str440) || str_equals(tok->val, str441) || str_equals(tok->val, str442))) {
        return tok;
      }
...
void AsPosixEre(syntax_asdl::re_t* node, List<Str*>* parts) {
  ...
  if (tag == re_e::Repeat) {
    ...
    if (op_tag == re_repeat_e::Range) {
      ...
      lower = op->lower ? op->lower->val : str459;
      upper = op->upper ? op->upper->val : str460;
...
int _PrintVariables(state::Mem* mem, runtime_asdl::cmd_value__Assign* cmd_val, args::_Attributes* attrs, bool print_flags, int builtin) {
  ...
  flag = attrs->attrs;
  tmp_g = flag->get(str488);
  tmp_a = flag->get(str489);
  tmp_A = flag->get(str490);
  ...
  flag_A = (tmp_A and tmp_A->tag_() == value_e::Bool) ? static_cast<value__Bool*>(tmp_A)->b : false;
  tmp_n = flag->get(str491);
  tmp_r = flag->get(str492);
  tmp_x = flag->get(str493);
  ...
  for (ListIter<Str*> it(names); !it.Done(); it.Next()) {
    ...
    if ((maybe_str_equals(flag_n, str496) and cell->nameref)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str497) and !cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_r, str498) and cell->readonly)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str499) and !cell->exported)) {
      continue;
    }
    if ((maybe_str_equals(flag_x, str500) and cell->exported)) {
      continue;
    }
    ...
    if (print_flags) {
      ...
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str507, str508->join(flags), str509, name}));
    }
    else {
      decl->append(name);
    }
    if (val->tag_() == value_e::Str) {
      value__Str* str_val = static_cast<value__Str*>(val);
      decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str510, qsn::maybe_shell_encode(str_val->s)}));
    }
    else {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (has_holes) {
          ...
          for (ListIter<Str*> it(array_val->strs); !it.Done(); it.Next(), ++i) {
            ...
            if (element != nullptr) {
              ...
              decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str513, name, str514, str(i), str515, qsn::maybe_shell_encode(element)}));
            }
          }
        }
        else {
          ...
          decl->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str517, str518->join(body), str519}));
        }
      }
      else {
        if (val->tag_() == value_e::AssocArray) {
          ...
          for (ListIter<Str*> it(sorted(assoc_val->d)); !it.Done(); it.Next()) {
            ...
            body->extend(Alloc<List<Str*>>(std::initializer_list<Str*>{str521, key_quoted, str522, value_quoted}));
          }
          if (len(body) > 0) {
...
int Export::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  arg_r->Next();
  attrs = flag_spec::Parse(str527, arg_r);
...
int NewVar::Run(runtime_asdl::cmd_value__Assign* cmd_val) {
  ...
  flags = 0;
  if (maybe_str_equals(arg->x, str536)) {
    flags |= state::SetExport;
  }
  if (maybe_str_equals(arg->r, str537)) {
    flags |= state::SetReadOnly;
  }
  if (maybe_str_equals(arg->n, str538)) {
...
int Unset::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str542, cmd_val);
  attrs = tup0.at0();
  arg_r = tup0.at1();
...
int Eval::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->exec_opts->simple_eval_builtin()) {
    Tuple2<Str*, int> tup1 = arg_r->ReadRequired2(str546);
    code_str = tup1.at0();
    eval_spid = tup1.at1();
    if (!arg_r->AtEnd()) {
      e_usage(str547);
    ...
    code_str = str548->join(arg_r->Rest());
...
int Alias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup0 = flag_spec::ParseCmdVal(str680, cmd_val);
  arg_r = tup0.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
  ...
  for (ListIter<Str*> it(argv); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup1 = mylib::split_once(arg, str682);
    name = tup1.at0();
    alias_exp = tup1.at1();
...
int UnAlias::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup2 = flag_spec::ParseCmdVal(str685, cmd_val);
  arg_r = tup2.at1();
  argv = arg_r->Rest();
  if (len(argv) == 0) {
    e_usage(str686);
...
int Set::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  arg = flag_spec::ParseMore(str689, arg_r);
  if (arg->show_options) {
...
int Shopt::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup5 = flag_spec::ParseCmdVal(str690, cmd_val);
  attrs = tup5.at0();
  arg_r = tup5.at1();
...
int Hash::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup6 = flag_spec::ParseCmdVal(str692, cmd_val);
  attrs = tup6.at0();
  arg_r = tup6.at1();
...
Dict<Str*, bool>* _ParseOptSpec(Str* spec_str) {
  ...
  while (true) {
    ...
    if (str_equals(spec_str->index(i), str695)) {
      spec->set(ch, true);
      i += 1;
    }
  }
...
int GetOptsState::_OptInd() {
  int result;
  try {
    result = state::GetInteger(this->mem, str696);
  }
  catch (error::Runtime* e) {
    this->errfmt->Print_(e->UserErrorString());
    result = -1;
...
void GetOptsState::IncIndex() {
  state::BuiltinSetString(this->mem, str697, str((this->_optind + 1)));
}

void GetOptsState::SetArg(Str* optarg) {
  StackRoots _roots({&optarg});

  state::BuiltinSetString(this->mem, str698, optarg);
}

void GetOptsState::Fail() {
  state::BuiltinSetString(this->mem, str699, str700);
}
...
Tuple2<int, Str*> _GetOpts(Dict<Str*, bool>* spec, List<Str*>* argv, builtin_pure::GetOptsState* my_state, ui::ErrorFormatter* errfmt) {
  ...
  if (current == nullptr) {
    my_state->Fail();
    return (Tuple2<int, Str*>(1, str701));
  }
  if ((!current->startswith(str702) or str_equals(current, str703))) {
    my_state->Fail();
  ...
  if (!dict_contains(spec, flag_char)) {
    return (Tuple2<int, Str*>(0, str705));
  }
  if (spec->index(flag_char)) {
    if (more_chars) {
      ...
      if (optarg == nullptr) {
        ...
        println_stderr(fmt165(str708->join(tmp)));
        return (Tuple2<int, Str*>(0, str709));
      }
    }
    my_state->IncIndex();
...
int GetOpts::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_r = Alloc<args::Reader>(cmd_val->argv, cmd_val->arg_spids);
  arg_r->Next();
  spec_str = arg_r->ReadRequired(str711);
  Tuple2<Str*, int> tup7 = arg_r->ReadRequired2(str712);
  var_name = tup7.at0();
  var_spid = tup7.at1();
...
int Echo::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup9 = flag_spec::ParseLikeEcho(str714, cmd_val);
  attrs = tup9.at0();
  arg_r = tup9.at1();
  ...
  if (arg->e) {
    ...
    for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
      ...
      new_argv->append(str715->join(parts));
      if (backslash_c) {
        break;
      }
    }
...
int Module::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup11 = flag_spec::ParseOilCmdVal(str719, cmd_val);
  arg_r = tup11.at1();
  Tuple2<Str*, int> tup12 = arg_r->ReadRequired2(str720);
  name = tup12.at0();
...
int Use::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  arg_spid = tup13.at1();
  if (arg == nullptr) {
    throw Alloc<error::Usage>(str722, runtime::NO_SPID);
  }
  arg_r->Next();
  if (str_equals(arg, str723)) {
    Tuple2<Str*, int> tup14 = arg_r->Peek2();
    expected = tup14.at0();
    e_spid = tup14.at1();
    if (expected == nullptr) {
      throw Alloc<error::Usage>(str724, runtime::NO_SPID);
    }
    UP_actual = this->mem->GetValue(str725, scope_e::Dynamic);
  ...
  throw Alloc<error::Usage>(str730, arg_spid);
}
...
int Shvar::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  Tuple2<args::_Attributes*, args::Reader*> tup15 = flag_spec::ParseOilCmdVal(str731, cmd_val);
  attrs = tup15.at0();
  arg_r = tup15.at1();
  if (!cmd_val->block) {
    throw Alloc<error::Usage>(str732, runtime::NO_SPID);
  }
  ...
  for (ListIter<Str*> it(args); !it.Done(); it.Next(), ++i) {
    Str* arg = it.Value();
    StackRoots _for({&arg  });
    Tuple2<Str*, Str*> tup17 = mylib::split_once(arg, str734);
    name = tup17.at0();
    s = tup17.at1();
    if (s == nullptr) {
      throw Alloc<error::Usage>(str735, arg_spids->index(i));
    }
  ...
  switch (arg->tag_()) {
    case redir_param_e::Word: {
      ...
      if (redir_type == redir_arg_type_e::Path) {
        ...
        filename = val->s;
        if (len(filename) == 0) {
          throw Alloc<error::RedirectEval>(str746, arg_word);
        }
        ...
        if (redir_type == redir_arg_type_e::Desc) {
          ...
          try {
            if (maybe_str_equals(t, str748)) {
              result->arg = Alloc<redirect_arg::CloseFd>();
            }
            else {
              if (str_equals(t->index(-1), str749)) {
          ...
          if (redir_type == redir_arg_type_e::Here) {
            val = this->word_ev->EvalWordToString(arg_word);
            result->arg = Alloc<redirect_arg::HereDoc>(str_concat(val->s, str751));
            return result;
          }
          else {
            throw Alloc<AssertionError>();
    ...
    case command_e::ControlFlow: {
      ...
      if (ok) {
        ...
        if (this->exec_opts->strict_control_flow()) {
          ...
          this->errfmt->PrefixPrint(msg, str763, tok->span_id);
          status = 0;
        }
      }
    }
    ...
    {  // with
      ...
      for (ListIter<syntax_asdl::command_t*> it(to_run); !it.Done(); it.Next()) {
        ...
        {  // with
          ...
          {  // with
            dev::ctx_Tracer ctx(this->tracer, str766, nullptr);
...
Tuple2<bool, bool> CommandEvaluator::ExecuteAndCatch(syntax_asdl::command_t* node, int cmd_flags) {
  ...
  try {
    ...
    if ((cmd_flags & RaiseControlFlow)) {
      ...
      if (e->IsReturn()) {
        ...
        this->errfmt->Print_(str767, e->token->span_id);
        is_fatal = true;
        status = 1;
      }
    }
  ...
  if (err) {
    ...
    if ((is_errexit and !this->exec_opts->verbose_errexit())) {
      ...
      ui::PrettyPrintError(err, this->arena, str768);
    }
  }
...
void CommandEvaluator::MaybeRunExitTrap(List<int>* mut_status) {
  ...
  handler = this->traps->get(str769);
  if (handler) {
    {  // with
      dev::ctx_Tracer ctx(this->tracer, str770, nullptr);
    ...
    if (UP_sig->tag_() == proc_sig_e::Closed) {
      ...
      for (ListIter<syntax_asdl::param*> it(sig->params); !it.Done(); it.Next(), ++i) {
        ...
        if (i < n_args) {
          ...
          if (is_out_param) {
            param_name = str_concat(str771, param_name);
            if (!arg_str->startswith(str772)) {
...
Tuple2<List<Tuple3<int, Str*, int>*>*, Tuple3<int, Str*, int>*> _ReadHereLines(reader::_Reader* line_reader, syntax_asdl::redir* h, Str* delimiter) {
  ...
  while (true) {
    ...
    if (strip_leading_tabs) {
      ...
      i = 0;
      while (i < n) {
        if (!(str_equals(line->index(i), str779))) {
          break;
        }
        i += 1;
      }
...
syntax_asdl::assign_pair* _MakeAssignPair(parse_lib::ParseContext* parse_ctx, Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>* preparsed, alloc::Arena* arena) {
  ...
  if (left_token->id == Id::Lit_VarLike) {
    if (str_equals(left_token->val->index(-2), str781)) {
    ...
    if ((left_token->id == Id::Lit_ArrayLhsOpen and parse_ctx->one_pass_parse)) {
      var_name = left_token->val->slice(0, -1);
      if (str_equals(close_token->val->index(-2), str782)) {
        op = assign_op_e::PlusEqual;
      }
      else {
        op = assign_op_e::Equal;
...
void _AppendMoreEnv(List<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*>* preparsed_list, List<syntax_asdl::env_pair*>* more_env) {
  ...
  for (ListIter<Tuple4<syntax_asdl::Token*, syntax_asdl::Token*, int, syntax_asdl::compound_word*>*> it(preparsed_list); !it.Done(); it.Next()) {
    ...
    if (str_equals(left_token->val->index(-2), str786)) {
...
syntax_asdl::redir* CommandParser::ParseRedirect() {
  ...
  op_val = op_tok->val;
  if (str_equals(op_val->index(0), str794)) {
    pos = op_val->find(str795);
...
syntax_asdl::command_t* CommandParser::_MaybeExpandAliases(List<syntax_asdl::compound_word*>* words) {
  ...
  while (i < n) {
    ...
    i += 1;
    if (!alias_exp->endswith(str798)) {
      expanded->append(str799);
      break;
    }
  }
  if (len(expanded) == 0) {
...
syntax_asdl::command__ShFunction* CommandParser::ParseFunctionDef() {
  ...
  this->_Next();
  this->_Eat2(Id::Right_ShFunction, str819);
...
syntax_asdl::command_t* CommandParser::ParseAndOr() {
  ...
  StackRoots _roots({&first_word_tok, &child, &ops, &op_spids, &children, &node});
...
bool LooksLikeGlob(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if (str_equals(c, str827)) {
      i += 1;
    }
    else {
      if ((str_equals(c, str828) or str_equals(c, str829))) {
        return true;
      }
      else {
        if (str_equals(c, str830)) {
          ...
          if ((str_equals(c, str831) and left_bracket)) {
            return true;
          }
        }
      }
...
Str* EreCharClassEscape(Str* s) {
  ...
  return pyutil::BackslashEscape(s, str833);
}
Str* ERE_META_CHARS = str834;
...
Str* GlobUnescape(Str* s) {
  ...
  while (i < n) {
    c = s->index(i);
    if ((str_equals(c, str835) and i != (n - 1))) {
      i += 1;
      c2 = s->index(i);
...
Str* _REGEX_CHARS_TO_ESCAPE = str842;
      ...
      if (tag == glob_part_e::Operator) {
        ...
        if (tag == glob_part_e::CharClass) {
          ...
          for (ListIter<Str*> it(part->strs); !it.Done(); it.Next()) {
            Str* s = it.Value();
            StackRoots _for({&s          });
            if (str_equals(s, str853)) {
              literal_hyphen = true;
              continue;
            }
            if (str_equals(s, str854)) {
...
int Globber::Expand(Str* arg, List<Str*>* out) {
  ...
  if (n) {
    for (ListIter<Str*> it(results); !it.Done(); it.Next()) {
      Str* name = it.Value();
      StackRoots _for({&name    });
      if ((name->startswith(str860) and !this->exec_opts->dashglob())) {
        n -= 1;
        continue;
      }
      out->append(name);
...
Str* _PromptEvaluatorCache::Get(Str* name) {
  ...
  if (str_equals(name, str862)) {
    value = this->_GetEuid() == 0 ? str863 : str864;
  }
  else {
...
Evaluator::Evaluator(Str* lang, parse_lib::ParseContext* parse_ctx, state::Mem* mem) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(Evaluator)) {
  ...
  this->parse_ctx = parse_ctx;
  this->mem = mem;
  this->default_prompt = str_concat(lang, str867);
      ...
      if (id_ == Id::PS_Octal3) {
        ...
        if (id_ == Id::PS_LBrace) {
          ...
          if (id_ == Id::PS_RBrace) {
            ...
            if (id_ == Id::PS_Subst) {
              ch = value->slice(1);
              if (str_equals(ch, str870)) {
                r = this->cache->Get(str871);
              }
              else {
                if (str_equals(ch, str872)) {
                  ...
                  if (str_equals(ch, str874)) {
                    hostname = this->cache->Get(str875);
                    Tuple2<Str*, Str*> tup1 = mylib::split_once(hostname, str876);
                    r = tup1.at0();
                  }
                  else {
                    if (str_equals(ch, str877)) {
                      r = this->cache->Get(str878);
                    }
                    else {
                      if (str_equals(ch, str879)) {
                        try {
                          pwd = state::GetString(this->mem, str880);
                          home = state::MaybeString(this->mem, str881);
              ...
              ret->append(r->replace(str887, str888));
            }
            else {
              throw Alloc<AssertionError>();
            }
...
Str* Evaluator::EvalFirstPrompt() {
  ...
  if (str_equals(this->lang, str892)) {
    val = this->mem->GetValue(str893);
...
int ArithEvaluator::_StringToInteger(Str* s, int span_id) {
  ...
  if (str_contains(s, str907)) {
    Tuple2<Str*, Str*> tup0 = mylib::split_once(s, str908);
    b = tup0.at0();
    digits = tup0.at1();
    try {
      base = to_int(b);
    ...
    for (StrIter it(digits); !it.Done(); it.Next()) {
      ...
      StackRoots _for({&ch    });
      if (IsLower(ch)) {
        digit = ((ord(ch) - ord(str910)) + 10);
      }
      else {
        if (IsUpper(ch)) {
          digit = ((ord(ch) - ord(str911)) + 36);
        }
        else {
  ...
  if (((val->tag_() == value_e::MaybeStrArray || val->tag_() == value_e::AssocArray) and lval->tag_() == lvalue_e::Named)) {
    ...
    if (word_eval::ShouldArrayDecay(named_lval->name, this->exec_opts)) {
      if (val->tag_() == value_e::MaybeStrArray) {
        ...
        if (val->tag_() == value_e::AssocArray) {
          lval = Alloc<lvalue::Keyed>(named_lval->name, str922);
        }
      }
...
split::IfsSplitter* SplitContext::_GetSplitter(Str* ifs) {
  ...
  if (ifs == nullptr) {
    val = this->mem->GetValue(str934, scope_e::Dynamic);
    UP_val = val;
    switch (val->tag_()) {
      case value_e::Undef: {
        ifs = DEFAULT_IFS;
...
_BaseSplitter::_BaseSplitter(Str* escape_chars) : gc_heap::Obj(Tag::FixedSize, kZeroMask, sizeof(_BaseSplitter)) {
  this->escape_chars = str_concat(escape_chars, str941);
}
    ...
    if (i < n) {
      ...
      if (str_contains(ws_chars, c)) {
        ...
        if (str_contains(other_chars, c)) {
          ...
          if ((allow_escape and str_equals(c, str942))) {
...
Str* Utf8Encode(int code) {
  ...
  return str945->join(tmp);
}
Str* INCOMPLETE_CHAR = str946;
Str* INVALID_CONT = str947;
Str* INVALID_START = str948;
...
Str* GlobReplacer::Replace(Str* s, syntax_asdl::suffix_op__PatSub* op) {
  ...
  if (op->replace_mode == Id::Lit_Pound) {
    regex = str_concat(str961, regex);
  }
  else {
    if (op->replace_mode == Id::Lit_Percent) {
      regex = str_concat(regex, str962);
    }
  }
...
Str* ShellQuoteB(Str* s) {
  ...
  s = s->replace(str963, str964)->replace(str965, str966);
  return pyutil::BackslashEscape(s, str967);
}
...
GLOBAL_LIST(Str*, 3, _STRING_AND_ARRAY, {str980 COMMA str981 COMMA str982});
...
runtime_asdl::value_t* DecayArray(runtime_asdl::value_t* val) {
  ...
  if (val->tag_() == value_e::MaybeStrArray) {
    ...
    if (val->tag_() == value_e::AssocArray) {
      value__AssocArray* assoc_val = static_cast<value__AssocArray*>(val);
      s = dict_contains(assoc_val->d, str983) ? assoc_val->d->index(str984) : nullptr;
    }
    else {
      throw Alloc<AssertionError>();
    }
...
Str* _BackslashEscape(Str* s) {
  ...
  return s->replace(str985, str986);
}
...
runtime_asdl::part_value_t* _ValueToPartValue(runtime_asdl::value_t* val, bool quoted) {
  ...
  switch (val->tag_()) {
    case value_e::Undef: {
      return Alloc<part_value::String>(str987, quoted, !quoted);
    }
      break;
    case value_e::Str: {
      value__Str* val = static_cast<value__Str*>(UP_val);
...
Str* TildeEvaluator::Eval(syntax_asdl::Token* token) {
  ...
  if (maybe_str_equals(token->val, str999)) {
    val = this->mem->GetValue(str1000);
    UP_val = val;
    if (val->tag_() == value_e::Str) {
      value__Str* val = static_cast<value__Str*>(UP_val);
      return val->s;
    ...
    case value_e::Str: {
      ...
      try {
        ...
        if (this->exec_opts->strict_word_eval()) {
          ...
          this->errfmt->PrettyPrintError(e, str1004);
          return Alloc<value::Str>(str1005);
        }
      }
    }
      break;
...
runtime_asdl::value_t* AbstractWordEvaluator::_Slice(runtime_asdl::value_t* val, syntax_asdl::suffix_op__Slice* op, Str* var_name, syntax_asdl::braced_var_sub* part) {
  ...
  try {
    ...
    if (this->exec_opts->strict_word_eval()) {
      ...
      this->errfmt->PrettyPrintError(e, str1010);
      switch (val->tag_()) {
        case value_e::Str: {
          val = Alloc<value::Str>(str1011);
        }
          break;
        case value_e::MaybeStrArray: {
  ...
  if (op_id == Id::VOp0_P) {
    switch (val->tag_()) {
      case value_e::Str: {
        ...
        p = prompt->replace(str1012, str1013)->replace(str1014, str1015);
    ...
    if (op_id == Id::VOp0_Q) {
      switch (val->tag_()) {
        ...
        case value_e::MaybeStrArray: {
          ...
          result = Alloc<value::Str>(str1017->join(tmp));
        }
          break;
        default: {
      ...
      if (op_id == Id::VOp0_a) {
        ...
        result = Alloc<value::Str>(str1024->join(chars));
      }
      else {
...
void AbstractWordEvaluator::_EvalDoubleQuoted(List<syntax_asdl::word_part_t*>* parts, List<runtime_asdl::part_value_t*>* part_vals) {
  ...
  if (len(parts) == 0) {
    v = Alloc<part_value::String>(str1029, true, false);
    part_vals->append(v);
    return ;
  }
  for (ListIter<syntax_asdl::word_part_t*> it(parts); !it.Done(); it.Next()) {
...
runtime_asdl::value_t* AbstractWordEvaluator::_EmptyStrOrError(runtime_asdl::value_t* val, syntax_asdl::Token* token) {
  ...
  if (!this->exec_opts->nounset()) {
    return Alloc<value::Str>(str1030);
  }
  name = token->val->startswith(str1031) ? token->val->slice(1) : token->val;
  ...
  switch (part->tag_()) {
    ...
    case word_part_e::ExtGlob: {
      ...
      for (ListIter<syntax_asdl::compound_word*> it(part->arms); !it.Done(); it.Next(), ++i) {
        ...
        StackRoots _for({&w      });
        if (i != 0) {
          part_vals->append(Alloc<part_value::String>(str1044, false, false));
        }
...
void AbstractWordEvaluator::_EvalWordToParts(syntax_asdl::word_t* w, bool quoted, List<runtime_asdl::part_value_t*>* part_vals, bool is_subst) {
  ...
  switch (w->tag_()) {
    case word_e::Compound: {
      ...
      break;
    case word_e::Empty: {
      part_vals->append(Alloc<part_value::String>(str1047, quoted, !quoted));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
runtime_asdl::value__Str* AbstractWordEvaluator::EvalWordToString(syntax_asdl::word_t* UP_w, runtime_asdl::quote_t quote_kind) {
  ...
  return Alloc<value::Str>(str1051->join(strs));
}
  ...
  for (int i = 1; i < n; ++i) {
    ...
    if (started_pairs) {
      ...
      if (left_token) {
        ...
        if (str_equals(tok_val->index(-2), str1061)) {
          e_die(fmt287(), w);
        }
      ...
      for (ListIter<Str*> it(argv); !it.Done(); it.Next()) {
        Str* arg = it.Value();
        StackRoots _for({&arg      });
        if ((arg->startswith(str1063) or arg->startswith(str1064))) {
          flags->append(arg);
          flag_spids->append(word_spid);
          if ((str_contains(arg, str1065) or str_contains(arg, str1066))) {
            eval_to_pairs = false;
          }
        }
        else {
...
runtime_asdl::part_value__String* CompletionWordEvaluator::_EvalProcessSub(syntax_asdl::command_sub* cs_part) {
  ...
  return Alloc<part_value::String>(str1071, true, false);
}
          ...
          if (op_kind == Kind::VOp2) {
            if (this->token_type == Id::VOp2_Slash) {
              ...
              if (this->token_type == Id::VOp2_Colon) {
                ...
                p_die(fmt299(str1083), this->cur_token);
              }
            }
          }
          else {
            if (op_kind == Kind::VOp3) {
              if (allow_query) {
                ...
                p_die(fmt300(str1085), this->cur_token);
              }
            }
          }
        }
...
syntax_asdl::Token* WordParser::ReadSingleQuoted(types_asdl::lex_mode_t lex_mode, syntax_asdl::Token* left_token, List<syntax_asdl::Token*>* tokens, bool is_oil_expr) {
  ...
  while (num_end_tokens < expected_end_tokens) {
    ...
    if ((this->token_kind == Kind::Lit || this->token_kind == Kind::Char)) {
      tok = this->cur_token;
      if ((no_backslashes and str_contains(tok->val, str1090))) {
        p_die(fmt305(), tok);
      }
      if (is_oil_expr) {
...
syntax_asdl::word_part_t* WordParser::_ReadUnquotedLeftParts(bool try_triple_quote, List<bool>* triple_out) {
  ...
  if ((this->token_type == Id::Left_DoubleQuote || this->token_type == Id::Left_DollarDoubleQuote)) {
    ...
    if ((try_triple_quote and len(dq_part->parts) == 0)) {
      if (str_equals(this->lexer->ByteLookAhead(), str1096)) {
  ...
  if ((this->token_type == Id::Left_SingleQuote || this->token_type == Id::Left_RSingleQuote || this->token_type == Id::Left_DollarSingleQuote)) {
    ...
    if ((try_triple_quote and len(sq_part->tokens) == 0)) {
      if (str_equals(this->lexer->ByteLookAhead(), str1097)) {
        this->_Next(lex_mode_e::ShCommand);
        this->_Peek();
            ...
            if (this->token_type == Id::Lit_Dollar) {
              if (!this->parse_opts->parse_dollar()) {
                if ((num_parts == 0 and lex_mode == lex_mode_e::ShCommand)) {
                  ...
                  if (str_equals(next_byte, str1120)) {
          ...
          if ((this->token_kind == Kind::VSub || this->token_kind == Kind::Lit || this->token_kind == Kind::History || this->token_kind == Kind::Left || this->token_kind == Kind::KW || this->token_kind == Kind::ControlFlow || this->token_kind == Kind::BoolUnary || this->token_kind == Kind::BoolBinary || this->token_kind == Kind::ExtGlob)) {
            if (this->token_type == Id::Lit_Pound) {
              ...
              if (this->token_type == Id::Lit_TPound) {
                ...
                if ((this->parse_opts->parse_raw_string() and (this->token_type == Id::Lit_Chars and maybe_str_equals(this->cur_token->val, str1127)))) {
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1132, false));
    }
      break;
    case word_part_e::AssocArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1133, false));
    }
      break;
    case word_part_e::Literal: {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str1135, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str1136->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
    ...
    case word_part_e::ExtGlob: 
    case word_part_e::Splice: {
      return (Tuple3<bool, Str*, bool>(false, str1137, false));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  if (UP_w->tag_() != word_e::Compound) {
    return (Tuple3<bool, Str*, bool>(false, str1138, quoted));
  }
  compound_word* w = static_cast<compound_word*>(UP_w);
  strs = Alloc<List<Str*>>();
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str1139, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str1140->join(strs), quoted));
}
...
syntax_asdl::compound_word* TildeDetect(syntax_asdl::word_t* UP_w) {
  ...
  if ((id_ == Id::Lit_Chars and static_cast<Token*>(part1)->val->startswith(str1142))) {
    new_parts->extend(w->parts->slice(1));
    return Alloc<compound_word>(new_parts);
  }
  return nullptr;
...
void TildeDetectAssign(syntax_asdl::compound_word* w) {
  ...
  for (int i = 0; i < n; ++i) {
    ...
    if ((do_expand and LiteralId(cur) == Id::Lit_TildeLike)) {
      ...
      if (next_part) {
        is_tilde = (LiteralId(next_part) == Id::Lit_Colon or (LiteralId(next_part) == Id::Lit_Chars and static_cast<Token*>(next_part)->val->startswith(str1143)));
      }
      else {
        is_tilde = true;
      }
...
Str* escape(Str* s) {
  ...
  s = s->replace(str1153, str1154);
  s = s->replace(str1155, str1156);
  s = s->replace(str1157, str1158);
  return s;
}
...
Str* join(Str* s1, Str* s2) {
  ...
  if ((s2->startswith(str1161) or len(s1) == 0)) {
    return s2;
  }
  if (s1->endswith(str1162)) {
...
Tuple2<Str*, Str*> _splitext(Str* p, Str* sep, Str* extsep) {
  ...
  return (Tuple2<Str*, Str*>(p, str1165));
}
...
Str* normpath(Str* path) {
  ...
  slash = str1168;
  dot = str1169;
  if (str_equals(path, str1170)) {
    return dot;
  }
  initial_slashes = path->startswith(str1171);
  if ((initial_slashes and (path->startswith(str1172) and !path->startswith(str1173)))) {
    initial_slashes = 2;
  }
  comps = path->split(str1174);
  new_comps = Alloc<List<Str*>>();
  for (ListIter<Str*> it(comps); !it.Done(); it.Next()) {
    Str* comp = it.Value();
    StackRoots _for({&comp  });
    if ((len(comp) == 0 or str_equals(comp, str1175))) {
      continue;
    }
    if ((!(str_equals(comp, str1176)) or ((initial_slashes == 0 and len(new_comps) == 0) or (len(new_comps) and str_equals(new_comps->index(-1), str1177))))) {
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if ((str_contains(str1184, ch) or IsUnprintableLow(ch))) {
        quote = 2;
        break;
      }
    }
  ...
  parts->append(str1187);
  return str_concat(prefix, str1188->join(parts));
}
...
void _encode_bytes_x(Str* s, bool shell_compat, List<Str*>* parts) {
  ...
  for (StrIter it(s); !it.Done(); it.Next()) {
    ...
    if (str_equals(byte, str1195)) {
      part = str1196;
    }
    else {
      if (str_equals(byte, str1197)) {
        part = str1198;
      }
      else {
        if (str_equals(byte, str1199)) {
          part = str1200;
        }
        else {
          if (str_equals(byte, str1201)) {
            part = str1202;
          }
          else {
            if (str_equals(byte, str1203)) {
              part = str1204;
            }
            else {
              if (str_equals(byte, str1205)) {
                part = shell_compat ? str1206 : str1207;
              }
              else {
        ...
        if (str_equals(byte, str1213)) {
          ...
          if (str_equals(byte, str1215)) {
            ...
            if (str_equals(byte, str1217)) {
              ...
              if (str_equals(byte, str1219)) {
                out = str1220;
              }
              else {
                if (str_equals(byte, str1221)) {
                  out = shell_compat ? str1222 : str1223;
                }
                else {
                  if (IsUnprintableLow(byte)) {
...
syntax_asdl::word__String* _StringWordEmitter::ReadWord(types_asdl::lex_mode_t unused_lex_mode) {
  ...
  if (this->i == this->n) {
    w = Alloc<word::String>(Id::Eof_Real, str1224, runtime::NO_SPID);
    return w;
  }
...
syntax_asdl::bool_expr_t* _TwoArgs(builtin_bracket::_StringWordEmitter* w_parser) {
  ...
  w1 = w_parser->Read();
  s0 = w0->s;
  if (maybe_str_equals(s0, str1225)) {
    return Alloc<bool_expr::LogicalNot>(Alloc<bool_expr::WordTest>(w1));
  }
  unary_id = Id::Undefined_Tok;
  if (w0->s->startswith(str1226)) {
    if (maybe_str_equals(s0, str1227)) {
      ...
      if (maybe_str_equals(s0, str1228)) {
        ...
        if (maybe_str_equals(s0, str1229)) {
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    ...
    strs = cmd_val->argv;
    if ((!strs or !(str_equals(strs->index(-1), str1239)))) {
      this->errfmt->Print_(str1240, cmd_val->arg_spids->index(0));
      return 2;
    }
    cmd_val->argv->pop();
  ...
  try {
    ...
    if (n == 4) {
      a0 = w_parser->Peek(0);
      if (str_equals(a0, str1242)) {
        w_parser->Read();
        child = _ThreeArgs(w_parser);
        bool_node = Alloc<bool_expr::LogicalNot>(child);
      }
      else {
        if ((str_equals(a0, str1243) and str_equals(w_parser->Peek(3), str1244))) {
          w_parser->Read();
          bool_node = _TwoArgs(w_parser);
        }
        else {
    ...
    this->errfmt->PrettyPrintError(e, str1245);
    return 2;
  }
  ...
  try {
    ...
    this->errfmt->PrettyPrintError(e, str1246);
    return 2;
  }
  status = b ? 0 : 1;
  return status;

...
GLOBAL_STR(str1127, "Invalid blank line in multiline mode");
GLOBAL_STR(str1128, "r");
GLOBAL_STR(str1129, "Unhandled: %s (%s)");
GLOBAL_STR(str1130, "Invalid var ref");
GLOBAL_STR(str1131, "Expected end of var ref");
GLOBAL_STR(str1132, "Invalid lex state %s");
GLOBAL_STR(str1133, "");
GLOBAL_STR(str1134, "");
GLOBAL_STR(str1135, "");
GLOBAL_STR(str1136, "");
...
GLOBAL_STR(str1140, "");
GLOBAL_STR(str1141, "");
GLOBAL_STR(str1142, "Compound shouldn't be empty");
GLOBAL_STR(str1143, "/");
GLOBAL_STR(str1144, "/");
GLOBAL_STR(str1145, "");
GLOBAL_STR(str1146, "EOF");
GLOBAL_STR(str1147, "typ");
GLOBAL_STR(str1148, "tok");
GLOBAL_STR(str1149, "children");
GLOBAL_STR(str1150, "-");
GLOBAL_STR(str1151, "with %d children");
GLOBAL_STR(str1152, "");
GLOBAL_STR(str1153, "(PNode %s %s %s)");
GLOBAL_STR(str1154, "&");
GLOBAL_STR(str1155, "&amp;");
GLOBAL_STR(str1156, "<");
GLOBAL_STR(str1157, "&lt;");
...
GLOBAL_STR(str1179, "/");
GLOBAL_STR(str1180, " \n\r\t");
GLOBAL_STR(str1181, "Unexpected token in QSN string");
GLOBAL_STR(str1182, "Expected closing single quote in QSN string");
GLOBAL_STR(str1183, "Unexpected data after closing quote");
GLOBAL_STR(str1184, "Unexpected token after QSN string");
GLOBAL_STR(str1185, "\\'\r\n\t\u0000");
GLOBAL_STR(str1186, "$'");
GLOBAL_STR(str1187, "'");
GLOBAL_STR(str1188, "'");
...
GLOBAL_STR(str1203, "\\r");
GLOBAL_STR(str1204, "\t");
GLOBAL_STR(str1205, "\\t");
GLOBAL_STR(str1206, "\u0000");
GLOBAL_STR(str1207, "\\x00");
GLOBAL_STR(str1208, "\\0");
GLOBAL_STR(str1209, "");
GLOBAL_STR(str1210, "");
GLOBAL_STR(str1211, "");
GLOBAL_STR(str1212, "\\");
...
GLOBAL_STR(str1219, "\\r");
GLOBAL_STR(str1220, "\t");
GLOBAL_STR(str1221, "\\t");
GLOBAL_STR(str1222, "\u0000");
GLOBAL_STR(str1223, "\\x00");
GLOBAL_STR(str1224, "\\0");
GLOBAL_STR(str1225, "");
GLOBAL_STR(str1226, "!");
GLOBAL_STR(str1227, "--");
GLOBAL_STR(str1228, "--dir");
GLOBAL_STR(str1229, "--exists");
GLOBAL_STR(str1230, "--file");
GLOBAL_STR(str1231, "--symlink");
GLOBAL_STR(str1232, "Expected unary operator, got %r (2 args)");
GLOBAL_STR(str1233, "-a");
GLOBAL_STR(str1234, "-o");
GLOBAL_STR(str1235, "!");
GLOBAL_STR(str1236, "(");
GLOBAL_STR(str1237, ")");
GLOBAL_STR(str1238, "Expected binary operator, got %r (3 args)");
GLOBAL_STR(str1239, "should be invoked as 'test' (simple_test_builtin)");
GLOBAL_STR(str1240, "]");
GLOBAL_STR(str1241, "missing closing ]");
GLOBAL_STR(str1242, "should only have 3 arguments or fewer (simple_test_builtin)");
GLOBAL_STR(str1243, "!");
GLOBAL_STR(str1244, "(");
GLOBAL_STR(str1245, ")");
GLOBAL_STR(str1246, "(test) ");
GLOBAL_STR(str1247, "(test) ");
...
inline Str* fmt340(Str* a0, Str* a1) {
  gBuf.reset();
  gBuf.format_s(a0);
  gBuf.write_const("/", 1);
  gBuf.format_s(a1);
          ...
          if ((this->token_kind == Kind::VSub || this->token_kind == Kind::Lit || this->token_kind == Kind::History || this->token_kind == Kind::Left || this->token_kind == Kind::KW || this->token_kind == Kind::ControlFlow || this->token_kind == Kind::BoolUnary || this->token_kind == Kind::BoolBinary || this->token_kind == Kind::ExtGlob)) {
            if (this->token_type == Id::Lit_Pound) {
              ...
              if (this->token_type == Id::Lit_TPound) {
                ...
                if ((this->parse_opts->parse_raw_string() and (this->token_type == Id::Lit_Chars and maybe_str_equals(this->cur_token->val, str1128)))) {
...
Tuple3<bool, Str*, bool> _EvalWordPart(syntax_asdl::word_part_t* part) {
  ...
  switch (part->tag_()) {
    case word_part_e::ShArrayLiteral: {
      ...
      break;
    case word_part_e::AssocArrayLiteral: {
      return (Tuple3<bool, Str*, bool>(false, str1134, false));
    }
      break;
    case word_part_e::Literal: {
    ...
    case word_part_e::DoubleQuoted: {
      ...
      for (ListIter<syntax_asdl::word_part_t*> it(part->parts); !it.Done(); it.Next()) {
        ...
        s = tup0.at1();
        if (!ok) {
          return (Tuple3<bool, Str*, bool>(false, str1136, true));
        }
        strs->append(s);
      }
      return (Tuple3<bool, Str*, bool>(true, str1137->join(strs), true));
    }
      break;
    case word_part_e::CommandSub: 
    case word_part_e::SimpleVarSub: 
    ...
    case word_part_e::ExtGlob: 
    case word_part_e::Splice: {
      return (Tuple3<bool, Str*, bool>(false, str1138, false));
    }
      break;
    default: {
      throw Alloc<AssertionError>();
...
Tuple3<bool, Str*, bool> StaticEval(syntax_asdl::word_t* UP_w) {
  ...
  for (ListIter<syntax_asdl::word_part_t*> it(w->parts); !it.Done(); it.Next()) {
    ...
    q = tup1.at2();
    if (!ok) {
      return (Tuple3<bool, Str*, bool>(false, str1140, quoted));
    }
    if (q) {
      quoted = true;
    }
  ...
  return (Tuple3<bool, Str*, bool>(true, str1141->join(strs), quoted));
}
...
syntax_asdl::compound_word* TildeDetect(syntax_asdl::word_t* UP_w) {
  ...
  if ((id_ == Id::Lit_Chars and static_cast<Token*>(part1)->val->startswith(str1143))) {
    new_parts->extend(w->parts->slice(1));
    return Alloc<compound_word>(new_parts);
  }
  return nullptr;
...
void TildeDetectAssign(syntax_asdl::compound_word* w) {
  ...
  for (int i = 0; i < n; ++i) {
    ...
    if ((do_expand and LiteralId(cur) == Id::Lit_TildeLike)) {
      ...
      if (next_part) {
        is_tilde = (LiteralId(next_part) == Id::Lit_Colon or (LiteralId(next_part) == Id::Lit_Chars and static_cast<Token*>(next_part)->val->startswith(str1144)));
      }
      else {
        is_tilde = true;
      }
...
Str* join(Str* s1, Str* s2) {
  ...
  if ((s2->startswith(str1162) or len(s1) == 0)) {
    return s2;
  }
  if (s1->endswith(str1163)) {
...
Tuple2<Str*, Str*> _splitext(Str* p, Str* sep, Str* extsep) {
  ...
  return (Tuple2<Str*, Str*>(p, str1166));
}
...
Str* normpath(Str* path) {
  ...
  slash = str1169;
  dot = str1170;
  if (str_equals(path, str1171)) {
    return dot;
  }
  initial_slashes = path->startswith(str1172);
  if ((initial_slashes and (path->startswith(str1173) and !path->startswith(str1174)))) {
    initial_slashes = 2;
  }
  comps = path->split(str1175);
  new_comps = Alloc<List<Str*>>();
  for (ListIter<Str*> it(comps); !it.Done(); it.Next()) {
    Str* comp = it.Value();
    StackRoots _for({&comp  });
    if ((len(comp) == 0 or str_equals(comp, str1176))) {
      continue;
    }
    if ((!(str_equals(comp, str1177)) or ((initial_slashes == 0 and len(new_comps) == 0) or (len(new_comps) and str_equals(new_comps->index(-1), str1178))))) {
...
Str* maybe_shell_encode(Str* s, int flags) {
  ...
  if (len(s) == 0) {
    ...
    for (StrIter it(s); !it.Done(); it.Next()) {
      ...
      quote = 1;
      if ((str_contains(str1185, ch) or IsUnprintableLow(ch))) {
        quote = 2;
        break;
      }
    }
  ...
  parts->append(str1188);
  return str_concat(prefix, str1189->join(parts));
}
...
Str* maybe_encode(Str* s, int bit8_display) {
  ...
  parts->append(str1191);
  return str1192->join(parts);
}
...
Str* encode(Str* s, int bit8_display) {
  ...
  _encode(s, bit8_display, false, parts);
  parts->append(str1194);
  return str1195->join(parts);
}
          ...
          if (str_equals(byte, str1202)) {
            ...
            if (str_equals(byte, str1204)) {
              ...
              if (str_equals(byte, str1206)) {
                part = shell_compat ? str1207 : str1208;
              }
              else {
            ...
            if (str_equals(byte, str1218)) {
              ...
              if (str_equals(byte, str1220)) {
                ...
                if (str_equals(byte, str1222)) {
                  out = shell_compat ? str1223 : str1224;
                }
                else {
                  if (IsUnprintableLow(byte)) {
...
syntax_asdl::word__String* _StringWordEmitter::ReadWord(types_asdl::lex_mode_t unused_lex_mode) {
  ...
  if (this->i == this->n) {
    w = Alloc<word::String>(Id::Eof_Real, str1225, runtime::NO_SPID);
    return w;
  }
...
syntax_asdl::bool_expr_t* _ThreeArgs(builtin_bracket::_StringWordEmitter* w_parser) {
  ...
  if (maybe_str_equals(w1->s, str1234)) {
    return Alloc<bool_expr::LogicalOr>(Alloc<bool_expr::WordTest>(w0), Alloc<bool_expr::WordTest>(w2));
  }
  if (maybe_str_equals(w0->s, str1235)) {
    w_parser->Rewind(2);
    child = _TwoArgs(w_parser);
    return Alloc<bool_expr::LogicalNot>(child);
  }
  if ((maybe_str_equals(w0->s, str1236) and maybe_str_equals(w2->s, str1237))) {
    return Alloc<bool_expr::WordTest>(w1);
  }
  p_die(fmt346(w1->s), w1);
}
...
int Test::Run(runtime_asdl::cmd_value__Argv* cmd_val) {
  ...
  if (this->need_right_bracket) {
    ...
    strs = cmd_val->argv;
    if ((!strs or !(str_equals(strs->index(-1), str1240)))) {
      this->errfmt->Print_(str1241, cmd_val->arg_spids->index(0));
      return 2;
    }
    cmd_val->argv->pop();
  ...
  try {
    ...
    if (n == 4) {
      a0 = w_parser->Peek(0);
      if (str_equals(a0, str1243)) {
        w_parser->Read();
        child = _ThreeArgs(w_parser);
        bool_node = Alloc<bool_expr::LogicalNot>(child);
      }
      else {
        if ((str_equals(a0, str1244) and str_equals(w_parser->Peek(3), str1245))) {
          w_parser->Read();
          bool_node = _TwoArgs(w_parser);
        }
        else {
  ...
  try {
    ...
    this->errfmt->PrettyPrintError(e, str1247);
    return 2;
  }
  status = b ? 0 : 1;
  return status;
